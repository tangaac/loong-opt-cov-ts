...
cmake $LLVM_TEST_SUITE_DIR -Wno-dev -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -G Ninja \
	-DCMAKE_C_FLAGS_RELEASE="-fuse-ld=mold -save-temps=obj -w -Wno-unused-command-line-argument -DNDEBUG -O3 -Qn -Wno-builtin-macro-redefined"  \
	-DCMAKE_CXX_FLAGS_RELEASE="-fuse-ld=mold -save-temps=obj -w -Wno-unused-command-line-argument -DNDEBUG -O3 -Qn -Wno-builtin-macro-redefined"
ninja
