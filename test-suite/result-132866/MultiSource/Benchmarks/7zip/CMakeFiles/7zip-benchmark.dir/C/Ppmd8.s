...
# %bb.24:                               # %middle.block
	...
	vld	$vr3, $a7, %pc_lo12(.LCPI7_1)
	ld.d	$s3, $sp, 0                     # 8-byte Folded Reload
	vld	$vr4, $s3, %pc_lo12(.LCPI7_2)
	vor.v	$vr1, $vr2, $vr1
	vshuf.b	$vr2, $vr0, $vr1, $vr3
	vor.v	$vr1, $vr1, $vr2
	vshuf.b	$vr2, $vr0, $vr1, $vr4
	vor.v	$vr1, $vr1, $vr2
