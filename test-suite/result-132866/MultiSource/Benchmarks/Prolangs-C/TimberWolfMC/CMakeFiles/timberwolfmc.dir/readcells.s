...
.LBB0_61:                               #   in Loop: Header=BB0_5 Depth=1
	...
	ori	$a2, $zero, 2
	blt	$a1, $a2, .LBB0_64
# %bb.62:                               # %.lr.ph1073.peel.next.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	addi.d	$a1, $a0, 20
	ori	$a2, $zero, 1
	move	$s3, $s0
...
.LBB0_76:                               #   in Loop: Header=BB0_77 Depth=2
	...
	addi.d	$a4, $a4, 8
	beq	$a2, $a5, .LBB0_94
.LBB0_77:                               #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bgeu	$a5, $a0, .LBB0_75
...
.LBB0_94:                               # %.preheader941
	...
	ori	$a2, $zero, 2
	blt	$a0, $a2, .LBB0_111
# %bb.95:                               # %.lr.ph1035.peel.next.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	addi.d	$a0, $a1, 20
	ori	$a2, $zero, 1
	move	$s3, $s0
...
# %bb.103:                              #   in Loop: Header=BB0_5 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_3
# %bb.104:                              # %.peel.next1219.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	ori	$s6, $zero, 1
	.p2align	4, , 16
.LBB0_105:                              # %.peel.next1219
                                        #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
...
.LBB0_132:                              # %.lr.ph1051
	...
	addi.d	$a3, $a3, 28
	.p2align	4, , 16
.LBB0_133:                              #   Parent Loop BB0_5 Depth=1
...
# %bb.138:                              #   in Loop: Header=BB0_5 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_3
# %bb.139:                              # %.peel.next1179.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	ori	$s6, $zero, 1
	.p2align	4, , 16
.LBB0_140:                              # %.peel.next1179
                                        #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
...
.LBB0_147:                              #   in Loop: Header=BB0_5 Depth=1
	...
	ld.d	$t0, $sp, 104                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_148:                              #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bgeu	$a2, $a0, .LBB0_175
...
# %bb.160:                              # %.lr.ph984
	...
	ori	$a3, $zero, 2
	.p2align	4, , 16
.LBB0_161:                              #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$a3, $a0, -8
	ld.w	$a2, $sp, 1388
	st.w	$a2, $a0, -4
...
# %bb.168:                              # %.lr.ph988
	...
	addi.d	$a2, $a0, 1
	.p2align	4, , 16
.LBB0_169:                              #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$s3, $a1, -4
	ld.w	$a0, $sp, 1388
	st.w	$a0, $a1, 0
...
.LBB0_182:                              # %scalar.ph
	...
	addi.d	$a1, $a1, 44
	bnez	$a2, .LBB0_182
.LBB0_183:                              # %.preheader946
                                        #   in Loop: Header=BB0_5 Depth=1
	blt	$a0, $s3, .LBB0_110
# %bb.184:                              # %.lr.ph995.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$s6, $zero
	.p2align	4, , 16
.LBB0_185:                              # %.lr.ph995
