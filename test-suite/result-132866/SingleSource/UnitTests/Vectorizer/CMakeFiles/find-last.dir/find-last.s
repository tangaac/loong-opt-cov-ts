...
.LBB77_6:                               # %vec.epilog.ph
	...
	pcalau12i	$a7, %pc_hi20(.LCPI77_1)
	vld	$vr1, $a7, %pc_lo12(.LCPI77_1)
	move	$a7, $a3
	bstrins.d	$a7, $a6, 2, 0
	vreplgr2vr.h	$vr0, $t1
	vreplgr2vr.h	$vr2, $t0
...
.LBB77_10:                              # %vector.ph
	...
	move	$t0, $a3
	bstrins.d	$t0, $t1, 3, 0
	pcalau12i	$t1, %pc_hi20(.LCPI77_0)
	vld	$vr0, $t1, %pc_lo12(.LCPI77_0)
	addi.d	$t1, $a1, 22
	vreplgr2vr.h	$vr1, $a4
	addi.d	$t2, $a2, 22
	move	$t3, $a5
...
.LBB89_4:                               # %vec.epilog.ph
	...
	move	$t2, $a3
	bstrins.d	$t2, $zero, 2, 0
	pcalau12i	$a7, %pc_hi20(.LCPI89_1)
	vld	$vr1, $a7, %pc_lo12(.LCPI89_1)
	move	$a7, $a3
	bstrins.d	$a7, $a6, 2, 0
	vreplgr2vr.h	$vr0, $t1
	vreplgr2vr.h	$vr2, $t0
...
.LBB89_7:                               # %vector.ph
	...
	move	$t0, $a3
	bstrins.d	$t0, $a7, 3, 0
	pcalau12i	$a7, %pc_hi20(.LCPI89_0)
	vld	$vr0, $a7, %pc_lo12(.LCPI89_0)
	addi.d	$a7, $a1, 22
	vreplgr2vr.h	$vr1, $a4
	addi.d	$t1, $a2, 22
	move	$t2, $a5
...
.LBB101_5:                              # %vec.epilog.ph
	...
	move	$t2, $a3
	bstrins.d	$t2, $zero, 2, 0
	pcalau12i	$a7, %pc_hi20(.LCPI101_1)
	vld	$vr1, $a7, %pc_lo12(.LCPI101_1)
	move	$a7, $a3
	bstrins.d	$a7, $a6, 2, 0
	vreplgr2vr.h	$vr0, $t1
	vreplgr2vr.h	$vr2, $t0
...
.LBB101_8:                              # %vector.ph
	...
	move	$t0, $a3
	bstrins.d	$t0, $a7, 3, 0
	pcalau12i	$a7, %pc_hi20(.LCPI101_0)
	vld	$vr0, $a7, %pc_lo12(.LCPI101_0)
	addi.d	$a7, $a1, 22
	vreplgr2vr.h	$vr1, $a4
	addi.d	$t1, $a2, 22
	move	$t2, $a5
...
.LBB113_5:                              # %vec.epilog.ph
	...
	move	$t2, $a3
	bstrins.d	$t2, $zero, 2, 0
	pcalau12i	$a7, %pc_hi20(.LCPI113_1)
	vld	$vr1, $a7, %pc_lo12(.LCPI113_1)
	move	$a7, $a3
	bstrins.d	$a7, $a6, 2, 0
	vreplgr2vr.h	$vr0, $t1
	vreplgr2vr.h	$vr2, $t0
...
.LBB113_8:                              # %vector.ph
	...
	move	$t0, $a3
	bstrins.d	$t0, $a7, 3, 0
	pcalau12i	$a7, %pc_hi20(.LCPI113_0)
	vld	$vr0, $a7, %pc_lo12(.LCPI113_0)
	addi.d	$a7, $a1, 22
	vreplgr2vr.h	$vr1, $a4
	addi.d	$t1, $a2, 22
	move	$t2, $a5
