...
# %bb.22:                               #   in Loop: Header=BB1_5 Depth=2
	bnez	$s5, .LBB1_31
.LBB1_23:                               # %.preheader235.preheader.peel
                                        #   in Loop: Header=BB1_5 Depth=2
	ld.w	$a1, $sp, 144
	ld.d	$a2, $sp, 136
	ld.bu	$a0, $s3, 0
...
.LBB1_43:                               #   in Loop: Header=BB1_5 Depth=2
	...
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	blt	$s6, $a0, .LBB1_46
# %bb.44:                               #   in Loop: Header=BB1_5 Depth=2
	beqz	$s2, .LBB1_46
# %bb.45:                               #   in Loop: Header=BB1_5 Depth=2
	...
	ld.d	$a7, $sp, 128                   # 8-byte Folded Reload
	b	.LBB1_52
.LBB1_46:                               # %.preheader235.preheader
                                        #   in Loop: Header=BB1_5 Depth=2
	ld.w	$a1, $sp, 144
	ld.d	$a2, $sp, 136
	ld.bu	$a0, $s3, 0
...
.LBB5_39:                               # %vector.body173
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB5_39
# %bb.40:                               # %middle.block178
	beq	$a3, $s0, .LBB5_43
.LBB5_41:                               # %scalar.ph168.preheader
	slli.d	$a3, $fp, 3
	sub.d	$a1, $a3, $a1
	add.d	$a1, $a2, $a1
	alsl.d	$a2, $fp, $a0, 3
...
# %bb.49:                               # %middle.block194
	...
	sltu	$a5, $zero, $a5
	beq	$a4, $a3, .LBB5_52
.LBB5_50:                               # %scalar.ph181.preheader
	alsl.d	$a6, $a4, $a1, 3
	alsl.d	$a2, $a4, $a2, 3
	sub.d	$a3, $a3, $a4
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB5_51:                               # %scalar.ph181
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a2, 0
	ld.d	$t0, $a6, 0
	xor	$a7, $a7, $t0
...
# %bb.0:
	...
	ld.d	$s6, $a4, %got_pc_lo12(dec_picture)
	ldptr.w	$a4, $a2, 6068
	st.w	$a3, $s3, 176
	ori	$a3, $zero, 2
	st.d	$a0, $s6, 0
...
.LBB19_28:                              # %vec.epilog.scalar.ph251
	...
	b	.LBB19_24
	.p2align	4, , 16
.LBB19_29:                              # %vector.memcheck224
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $fp, $t7
	move	$s0, $zero
	bltu	$s1, $t5, .LBB19_27
# %bb.30:                               # %vector.memcheck224
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $t7, $t6
	bltu	$s1, $t5, .LBB19_27
# %bb.31:                               # %vector.memcheck224
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $t8, $t7
	bltu	$s1, $t5, .LBB19_27
# %bb.32:                               # %vector.memcheck224
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $fp, $t6
	bltu	$s1, $t5, .LBB19_27
# %bb.33:                               # %vector.memcheck224
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $fp, $t8
	bltu	$s1, $t5, .LBB19_27
# %bb.34:                               # %vector.main.loop.iter.check237
                                        #   in Loop: Header=BB19_25 Depth=1
	bgeu	$a0, $t5, .LBB19_39
# %bb.35:                               #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $zero
.LBB19_36:                              # %vec.epilog.ph252
                                        #   in Loop: Header=BB19_25 Depth=1
	add.d	$s0, $t3, $s4
	alsl.d	$s1, $s4, $fp, 1
	alsl.d	$s2, $s4, $t8, 1
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB19_37:                              # %vec.epilog.vector.body258
                                        #   Parent Loop BB19_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB19_37
# %bb.38:                               # %vec.epilog.middle.block263
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s0, $t2
	beq	$t2, $a3, .LBB19_24
	b	.LBB19_27
.LBB19_39:                              # %vector.body241.preheader
                                        #   in Loop: Header=BB19_25 Depth=1
	addi.d	$s0, $t6, 16
	addi.d	$s1, $fp, 16
	addi.d	$s2, $t7, 16
...
.LBB19_40:                              # %vector.body241
	...
	addi.d	$s3, $s3, 32
	bnez	$s4, .LBB19_40
# %bb.41:                               # %middle.block248
                                        #   in Loop: Header=BB19_25 Depth=1
	beq	$t0, $a3, .LBB19_24
# %bb.42:                               # %vec.epilog.iter.check253
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $t0
	move	$s0, $t0
	beqz	$t1, .LBB19_27
...
.LBB19_50:                              # %.lr.ph.us
	...
	ori	$a1, $zero, 1
	bstrins.d	$a1, $a5, 31, 2
	ori	$a2, $zero, 2
	bstrins.d	$a2, $a5, 31, 2
	ori	$a3, $zero, 3
...
# %bb.6:                                # %.split.us
	...
	pcalau12i	$a1, %got_pc_hi20(subblk_offset_x)
	ld.d	$a1, $a1, %got_pc_lo12(subblk_offset_x)
