...
# %bb.0:                                # %_ZN9benchmark5State13StateIteratorC2EPS0_.exit
	...
	jirl	$ra, $ra, 0
	vld	$vr15, $sp, 0                   # 16-byte Folded Reload
...
# %bb.6:                                #   in Loop: Header=BB0_5 Depth=1
	...
	b	.LBB0_10
	.p2align	4, , 16
.LBB0_7:                                # %vector.body94.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a7, $a5
	move	$t0, $a4
	move	$t1, $a2
	.p2align	4, , 16
.LBB0_8:                                # %vector.body94
...
.LBB0_16:                               # %vector.body
	...
	vfcmp.clt.d	$vr10, $vr10, $vr1
	vbitsel.v	$vr11, $vr8, $vr6, $vr10
...
.LBB0_20:                               # %middle.block
	...
	move	$t3, $a3
	beq	$a0, $a3, .LBB0_4
.LBB0_21:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.us.preheader102"
                                        #   in Loop: Header=BB0_5 Depth=1
	alsl.d	$a7, $t3, $s2, 3
	alsl.d	$t0, $t3, $s4, 3
	alsl.d	$t1, $t3, $s3, 3
...
# %bb.6:                                #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_10
	.p2align	4, , 16
.LBB1_7:                                # %vector.body285.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
...
# %bb.19:                               # %call.sqrt
	...
	vst	$vr19, $sp, 48                  # 16-byte Folded Spill
	vst	$vr20, $sp, 32                  # 16-byte Folded Spill
	...
	vldi	$vr21, -912
	vld	$vr20, $sp, 32                  # 16-byte Folded Reload
	vld	$vr19, $sp, 48                  # 16-byte Folded Reload
	vldi	$vr18, -872
	vldi	$vr17, -996
	vldi	$vr16, -864
	vldi	$vr15, -1016
...
# %bb.21:                               #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_25
	.p2align	4, , 16
.LBB1_22:                               # %vector.body259.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
	move	$a0, $t6
	move	$a1, $t8
	move	$a2, $a7
...
.LBB1_23:                               # %vector.body259
	...
	addi.d	$a0, $a0, 16
	bnez	$a6, .LBB1_23
# %bb.24:                               # %middle.block268
                                        #   in Loop: Header=BB1_4 Depth=1
	ld.d	$a0, $sp, 304                   # 8-byte Folded Reload
	move	$a6, $a0
	beq	$s7, $a0, .LBB1_27
.LBB1_25:                               # %"_Z6forallIZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateEE3$_1Ev9simd_execiiT_.exit.preheader302"
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a0, $a6, $t1, 3
	alsl.d	$a1, $a6, $t4, 3
	alsl.d	$a2, $a6, $t2, 3
...
.LBB1_30:                               # %vector.body
	...
	vfcmp.clt.d	$vr2, $vr2, $vr10
	vfcmp.clt.d	$vr3, $vr3, $vr10
	vbitsel.v	$vr0, $vr0, $vr20, $vr2
	vbitsel.v	$vr1, $vr1, $vr20, $vr3
...
# %bb.31:                               # %middle.block
	...
	move	$a2, $a0
	beq	$s7, $a0, .LBB1_34
.LBB1_32:                               # %"_ZZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateEENK3$_3clEi.exit.preheader301"
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a0, $a2, $t6, 3
	alsl.d	$a1, $a2, $t3, 3
	sub.d	$a2, $s7, $a2
...
# %bb.4:                                # %.lr.ph.us.preheader
	...
	vld	$vr1, $t2, %pc_lo12(.LCPI3_1)
	pcalau12i	$t2, %pc_hi20(.LCPI3_2)
	vld	$vr2, $t2, %pc_lo12(.LCPI3_2)
	pcalau12i	$t2, %pc_hi20(.LCPI3_3)
	fld.d	$fa3, $t2, %pc_lo12(.LCPI3_3)
	vldi	$vr4, -928
...
.LBB3_6:                                #   Parent Loop BB3_5 Depth=1
	...
	vldx	$vr12, $s2, $t4
	fldx.d	$fa7, $s2, $t4
	vpackod.d	$vr13, $vr11, $vr10
	vori.b	$vr14, $vr0, 0
	vshuf.d	$vr14, $vr8, $vr10
	vfadd.d	$vr13, $vr13, $vr14
	vpackev.d	$vr8, $vr8, $vr12
	vfsub.d	$vr8, $vr13, $vr8
	vori.b	$vr13, $vr1, 0
	vshuf.d	$vr13, $vr11, $vr12
	...
	fldx.d	$ft8, $t0, $t4
	fldx.d	$ft10, $s4, $t4
	vpackod.d	$vr19, $vr14, $vr12
	vpackod.d	$vr20, $vr15, $vr10
	vfadd.d	$vr19, $vr19, $vr20
	vpackev.d	$vr10, $vr15, $vr10
	vfsub.d	$vr10, $vr19, $vr10
	vpackev.d	$vr12, $vr14, $vr12
	vfsub.d	$vr10, $vr10, $vr12
	vpackod.d	$vr12, $vr15, $vr17
	vori.b	$vr20, $vr1, 0
	vshuf.d	$vr20, $vr15, $vr11
	vfadd.d	$vr12, $vr12, $vr20
	vpackev.d	$vr11, $vr14, $vr11
	vfsub.d	$vr11, $vr12, $vr11
	vori.b	$vr12, $vr0, 0
	vshuf.d	$vr12, $vr14, $vr17
	...
	vfmul.d	$vr9, $vr10, $vr13
	vfmadd.d	$vr8, $vr11, $vr8, $vr9
	vreplvei.d	$vr9, $vr12, 0
	vfmul.d	$vr8, $vr9, $vr8
	vreplvei.d	$vr9, $vr19, 1
	fadd.d	$ft1, $ft1, $ft8
	fadd.d	$ft1, $ft1, $ft10
	vreplvei.d	$vr10, $vr19, 0
	fadd.d	$fa6, $ft2, $fa6
	fadd.d	$fa6, $fa6, $fa7
	fdiv.d	$fa6, $ft1, $fa6
...
.LBB6_32:                               # %vector.body104
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB6_32
# %bb.33:                               # %middle.block111
                                        #   in Loop: Header=BB6_29 Depth=1
	move	$t3, $a4
	beq	$a3, $a2, .LBB6_28
.LBB6_34:                               # %scalar.ph96.preheader
                                        #   in Loop: Header=BB6_29 Depth=1
	alsl.d	$t1, $a0, $s0, 2
	sub.d	$t2, $s3, $t3
	add.d	$t3, $t3, $a6
