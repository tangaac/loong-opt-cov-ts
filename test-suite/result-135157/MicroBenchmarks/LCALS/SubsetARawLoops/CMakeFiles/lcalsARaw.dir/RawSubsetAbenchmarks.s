...
# %bb.6:                                #   in Loop: Header=BB0_5 Depth=1
	...
	b	.LBB0_10
	.p2align	4, , 16
.LBB0_7:                                # %vector.body107.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a7, $a5
	move	$t0, $a4
	move	$t1, $a2
	.p2align	4, , 16
.LBB0_8:                                # %vector.body107
	...
	addi.d	$a7, $a7, 32
	bnez	$t1, .LBB0_8
# %bb.9:                                # %middle.block112
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$t1, $a2
	beq	$a0, $a2, .LBB0_12
.LBB0_10:                               # %scalar.ph100.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	alsl.d	$a7, $t1, $s1, 3
	alsl.d	$t0, $t1, $s2, 3
	sub.d	$t1, $a0, $t1
	.p2align	4, , 16
.LBB0_11:                               # %scalar.ph100
                                        #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$ft0, $a7, 0
	fadd.d	$ft0, $ft0, $fa4
...
.LBB0_20:                               # %middle.block
	...
	move	$t3, $a3
	beq	$a0, $a3, .LBB0_4
.LBB0_21:                               # %..preheader_crit_edge.us.us.preheader115
                                        #   in Loop: Header=BB0_5 Depth=1
	alsl.d	$a7, $t3, $s2, 3
	alsl.d	$t0, $t3, $s4, 3
	alsl.d	$t1, $t3, $s3, 3
...
# %bb.6:                                #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_10
	.p2align	4, , 16
.LBB1_7:                                # %vector.body321.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
...
# %bb.21:                               #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_25
	.p2align	4, , 16
.LBB1_22:                               # %vector.body295.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
	move	$a0, $t5
	move	$a1, $t7
	move	$a2, $ra
