...
# %bb.1:                                # %.lr.ph.i
	...
	bltu	$a2, $a6, .LBB0_4
# %bb.2:                                # %vector.memcheck86
	addi.d	$a7, $a0, 1212
	add.d	$a6, $a0, $a4
	addi.d	$a6, $a6, 1342
	addi.d	$t0, $a0, 1342
	bgeu	$a7, $a6, .LBB0_25
# %bb.3:                                # %vector.memcheck86
	alsl.d	$a6, $a4, $a0, 1
	addi.d	$a6, $a6, 1212
	bgeu	$t0, $a6, .LBB0_25
.LBB0_4:
	move	$a6, $zero
.LBB0_5:                                # %scalar.ph92.preheader
	slli.d	$a7, $a6, 1
	addi.d	$a7, $a7, 1212
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
...
.LBB0_12:
	move	$a5, $zero
.LBB0_13:                               # %scalar.ph109.preheader
	slli.d	$a6, $a5, 1
	addi.d	$a6, $a6, 1416
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB0_14:                               # %scalar.ph109
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$a4, $a0, $a6
	add.d	$a7, $a0, $a5
	st.b	$a5, $a7, 1546
...
# %bb.17:                               # %.lr.ph.i.2
	...
	bstrpick.d	$a3, $a4, 31, 0
	bltu	$a2, $a5, .LBB0_20
# %bb.18:                               # %vector.memcheck126
	addi.d	$a5, $a0, 1620
	add.d	$a2, $a0, $a3
	addi.d	$a2, $a2, 1750
	addi.d	$a6, $a0, 1750
	bgeu	$a5, $a2, .LBB0_31
# %bb.19:                               # %vector.memcheck126
	alsl.d	$a2, $a3, $a0, 1
	addi.d	$a2, $a2, 1620
	bgeu	$a6, $a2, .LBB0_31
.LBB0_20:
	move	$a2, $zero
.LBB0_21:                               # %scalar.ph132.preheader
	slli.d	$a1, $a2, 1
	addi.d	$a1, $a1, 1620
	sub.d	$a4, $a4, $a2
	.p2align	4, , 16
.LBB0_22:                               # %scalar.ph132
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$a4, $a0, $a1
	add.d	$a5, $a0, $a2
	st.b	$a2, $a5, 1750
...
.LBB0_26:                               # %vector.body94
	...
	addi.d	$a7, $a7, 16
	bnez	$t1, .LBB0_26
# %bb.27:                               # %middle.block101
	beq	$a6, $a4, .LBB0_8
	b	.LBB0_5
.LBB0_28:                               # %vector.ph111
	andi	$a5, $a3, 56
...
.LBB2_37:                               # %vector.body102
	...
	addi.d	$a6, $a6, -8
	bnez	$a7, .LBB2_37
# %bb.38:                               # %middle.block111
	beq	$a1, $a2, .LBB2_41
.LBB2_39:                               # %scalar.ph97.preheader
	addi.d	$a1, $a3, 1
	alsl.d	$a2, $a3, $fp, 1
	addi.d	$a2, $a2, 8
	.p2align	4, , 16
