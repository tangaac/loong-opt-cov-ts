	...
	.p2align	4, 0x0                          # -- Begin function stencil_calc
.LCPI0_0:
	.dword	1                               # 0x1
	.dword	2                               # 0x2
	.text
...
# %bb.8:                                # %.preheader252.lr.ph.split.split
	...
	vld	$vr6, $fp, -240                 # 16-byte Folded Reload
	vldi	$vr7, -996
	b	.LBB0_10
	.p2align	4, , 16
.LBB0_9:                                # %._crit_edge294.split
	...
	add.d	$a4, $a4, $a0
	ld.d	$t1, $fp, -128                  # 8-byte Folded Reload
	add.d	$t1, $t1, $a0
...
.LBB0_21:                               # %.preheader251
	...
	ldx.d	$a0, $a1, $a0
	addi.d	$s1, $a0, 8
	ld.d	$s4, $fp, -272                  # 8-byte Folded Reload
	st.d	$s2, $fp, -160                  # 8-byte Folded Spill
	move	$a2, $t1
	.p2align	4, , 16
.LBB0_22:                               # %.preheader
                                        #   Parent Loop BB0_4 Depth=1
...
# %bb.23:                               # %._crit_edge306.split
	...
	addi.d	$a1, $a1, 1
	ld.d	$a0, $fp, -136                  # 8-byte Folded Reload
	ld.d	$s2, $fp, -160                  # 8-byte Folded Reload
	add.d	$s2, $s2, $a0
...
# %bb.25:                               # %.lr.ph
	...
	mul.d	$a7, $a0, $a1
	slli.d	$t4, $a7, 3
	st.d	$t0, $fp, -144                  # 8-byte Folded Spill
	add.d	$a1, $a1, $t0
	slli.d	$a1, $a1, 3
	addi.d	$a1, $a1, -8
	mul.d	$a1, $a1, $a0
...
# %bb.31:                               # %.preheader260.lr.ph.split.split
	...
	move	$a1, $zero
	ori	$a2, $zero, 1
	ld.d	$t0, $fp, -368                  # 8-byte Folded Reload
...
.LBB0_32:                               # %._crit_edge270.split
	...
	ld.d	$t7, $fp, -216                  # 8-byte Folded Reload
	add.d	$t7, $t7, $t4
	ld.d	$t0, $fp, -208                  # 8-byte Folded Reload
	add.d	$t0, $t0, $t4
...
.LBB0_33:                               # %.preheader260
	...
	ld.d	$a1, $a1, 8
	ld.d	$s2, $a4, 0
	st.d	$a4, $fp, -112                  # 8-byte Folded Spill
	ld.d	$t8, $a4, 8
	ld.d	$ra, $a2, 0
	st.d	$a2, $fp, -120                  # 8-byte Folded Spill
	ld.d	$t2, $a2, 8
	ld.d	$a3, $a1, 0
	st.d	$a1, $fp, -128                  # 8-byte Folded Spill
	ld.d	$t3, $a1, 8
	...
	add.d	$t5, $a1, $a0
	st.d	$t0, $fp, -208                  # 8-byte Folded Spill
	st.d	$t7, $fp, -216                  # 8-byte Folded Spill
	ori	$a0, $zero, 1
	b	.LBB0_35
	.p2align	4, , 16
.LBB0_34:                               # %._crit_edge
...
.LBB0_35:                               # %.preheader258
	...
	ldx.d	$t2, $a6, $a4
	ld.d	$a6, $fp, -128                  # 8-byte Folded Reload
	ldx.d	$t3, $a6, $a4
	fld.d	$fa0, $t8, 0
	fld.d	$fa1, $t8, 8
	fld.d	$fa2, $t2, 0
...
.LBB0_37:                               # %scalar.ph.preheader
	...
	addi.d	$s6, $a2, 8
	addi.d	$s7, $t2, 8
	ld.d	$a7, $fp, -152                  # 8-byte Folded Reload
	sub.d	$s3, $a7, $s3
	addi.d	$s8, $t3, 8
	addi.d	$a7, $a5, 8
	addi.d	$a3, $a3, 8
...
.LBB0_49:                               # %vector.body
	...
	vpackod.d	$vr24, $vr23, $vr12
	vld	$vr12, $t6, %pc_lo12(.LCPI0_0)
	vldx	$vr18, $a6, $s3
	vfadd.d	$vr16, $vr16, $vr17
	vfadd.d	$vr16, $vr16, $vr19
	vpackod.d	$vr17, $vr22, $vr14
	vori.b	$vr14, $vr12, 0
	vshuf.d	$vr14, $vr18, $vr22
	vfadd.d	$vr16, $vr16, $vr17
	vldx	$vr17, $a4, $s3
	vfadd.d	$vr16, $vr16, $vr14
	vfadd.d	$vr16, $vr16, $vr18
	vpackod.d	$vr13, $vr20, $vr13
	vori.b	$vr22, $vr12, 0
	vshuf.d	$vr22, $vr17, $vr20
	vfadd.d	$vr13, $vr16, $vr13
	vfadd.d	$vr13, $vr13, $vr22
	add.d	$t6, $ra, $s3
	vldx	$vr19, $ra, $s3
	vld	$vr20, $t6, 8
	vld	$vr21, $t6, 16
	...
	vpackod.d	$vr7, $vr15, $vr7
	vori.b	$vr20, $vr12, 0
	vshuf.d	$vr20, $vr16, $vr15
	vfadd.d	$vr7, $vr19, $vr7
	vldx	$vr19, $s6, $s3
	vfadd.d	$vr7, $vr7, $vr20
	vfadd.d	$vr7, $vr7, $vr16
	vpackod.d	$vr9, $vr11, $vr9
	vori.b	$vr15, $vr12, 0
	vshuf.d	$vr15, $vr19, $vr11
	add.d	$t6, $a3, $s3
	vldx	$vr11, $a3, $s3
	vld	$vr21, $t6, 8
	vfadd.d	$vr7, $vr7, $vr9
	...
	vld	$vr9, $t6, 16
	vfadd.d	$vr11, $vr11, $vr21
	vldx	$vr21, $s8, $s3
	vfadd.d	$vr7, $vr7, $vr19
	vfadd.d	$vr9, $vr11, $vr9
	vpackod.d	$vr6, $vr10, $vr6
	vori.b	$vr11, $vr12, 0
	vshuf.d	$vr11, $vr21, $vr10
	vldx	$vr23, $s7, $s3
	vfadd.d	$vr6, $vr9, $vr6
	vfadd.d	$vr6, $vr6, $vr11
	vfadd.d	$vr6, $vr6, $vr21
	vshuf.d	$vr12, $vr23, $vr8
	vfadd.d	$vr6, $vr6, $vr24
	vfadd.d	$vr6, $vr6, $vr12
	vfadd.d	$vr6, $vr6, $vr23
	vfadd.d	$vr7, $vr13, $vr7
	vfadd.d	$vr6, $vr7, $vr6
	vreplgr2vr.d	$vr7, $s1
	vfdiv.d	$vr6, $vr6, $vr7
	vstx	$vr6, $t7, $s3
...
# %bb.51:                               #   in Loop: Header=BB0_35 Depth=3
	vreplvei.d	$vr12, $vr23, 1
	vreplvei.d	$vr13, $vr23, 0
	vreplvei.d	$vr6, $vr21, 1
	vreplvei.d	$vr9, $vr21, 0
	vreplvei.d	$vr14, $vr19, 1
	vreplvei.d	$vr15, $vr19, 0
	...
	ld.d	$s3, $fp, -184                  # 8-byte Folded Reload
	b	.LBB0_37
	.p2align	4, , 16
.LBB0_52:                               # %.preheader261
                                        #   in Loop: Header=BB0_27 Depth=1
	ld.d	$t3, $fp, -160                  # 8-byte Folded Reload
...
# %bb.53:                               # %.preheader259.lr.ph.split.split
	...
	move	$s5, $zero
	ori	$s6, $zero, 1
	ld.d	$s7, $fp, -256                  # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_54:                               # %.preheader259
	...
	ldx.d	$a0, $a1, $a0
	addi.d	$s8, $a0, 8
	ld.d	$s3, $fp, -272                  # 8-byte Folded Reload
	move	$s2, $s7
	move	$a2, $t3
	.p2align	4, , 16
