...
.LBB13_9:                               # %makect.exit.thread
	...
	bstrpick.d	$t5, $a1, 61, 0
	ori	$a1, $zero, 7
	pcalau12i	$s6, %pc_hi20(.LCPI13_1)
	bgeu	$a1, $ra, .LBB13_13
# %bb.10:                               # %.lr.ph.preheader
...
# %bb.36:                               # %.lr.ph243
	...
	move	$a6, $s3
	.p2align	4, , 16
.LBB13_37:                              #   Parent Loop BB13_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $a6, -8
	fld.d	$fa1, $a6, 0
	fneg.d	$fa0, $fa0
...
# %bb.39:                               # %.lr.ph247.preheader
	...
	ori	$a5, $zero, 12
	bgeu	$a4, $a5, .LBB13_42
.LBB13_40:                              # %.lr.ph247.preheader403
                                        #   in Loop: Header=BB13_29 Depth=1
	slli.d	$a5, $a3, 3
	alsl.d	$a4, $a3, $s0, 3
	sub.d	$a5, $s0, $a5
...
# %bb.47:                               # %vector.ph387
	...
	.p2align	4, , 16
.LBB13_48:                              # %vector.body390
                                        #   Parent Loop BB13_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s6, %pc_lo12(.LCPI13_1)
	vldx	$vr1, $t0, $a2
	vldx	$vr2, $a7, $a1
	vori.b	$vr3, $vr0, 0
	vshuf.d	$vr3, $vr0, $vr1
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB13_48
# %bb.49:                               # %middle.block400
                                        #   in Loop: Header=BB13_29 Depth=1
	beq	$a4, $a5, .LBB13_28
	b	.LBB13_40
	.p2align	4, , 16
.LBB13_50:                              #   in Loop: Header=BB13_29 Depth=1
	move	$s6, $t8
	move	$s4, $t5
	move	$a0, $s5
	move	$a1, $s0
	...
	ori	$a0, $zero, 5
	bne	$s5, $a0, .LBB13_52
# %bb.51:                               #   in Loop: Header=BB13_29 Depth=1
	ld.d	$ra, $sp, 96                    # 8-byte Folded Reload
	move	$t5, $s4
	ld.d	$t6, $sp, 72                    # 8-byte Folded Reload
...
.LBB13_53:                              # %.lr.ph.i229
	...
	addi.d	$a6, $a6, 16
	bltu	$a5, $s2, .LBB13_53
# %bb.54:                               #   in Loop: Header=BB13_29 Depth=1
	ld.d	$t7, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s4, $sp, 32                    # 8-byte Folded Reload
	ori	$t4, $zero, 4
	b	.LBB13_35
.LBB13_55:                              #   in Loop: Header=BB13_29 Depth=1
	ori	$t4, $zero, 4
	b	.LBB13_40
.LBB13_56:                              # %.preheader.._crit_edge252_crit_edge
	fld.d	$fa0, $s0, 0
	ori	$s8, $zero, 2
	b	.LBB13_59
.LBB13_57:                              # %._crit_edge244.thread
	slli.w	$s8, $s8, 1
.LBB13_58:                              # %._crit_edge252.loopexit
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $s0, $a0
	fst.d	$fa0, $s0, 0
.LBB13_59:                              # %._crit_edge252
	slli.d	$a0, $s8, 3
	fstx.d	$fa0, $fp, $a0
.LBB13_60:
	st.d	$zero, $fp, 0
...
# %bb.0:
	...
	fsub.d	$fa0, $fa0, $ft1
	fst.d	$fa0, $a0, 184
	fld.d	$fa5, $sp, 0                    # 8-byte Folded Reload
	fsub.d	$fa0, $fa5, $fa4
	fadd.d	$fa1, $ft11, $fs1
	fsub.d	$fa2, $fa0, $fa1
	fadd.d	$fa0, $fa1, $fa0
...
.LBB27_23:
	...
	fstx.d	$fa0, $a2, $a0
	blt	$a3, $a5, .LBB27_28
# %bb.24:                               # %.preheader239.preheader
	addi.d	$a0, $a2, 8
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB27_25:                              # %.preheader239
                                        # =>This Loop Header: Depth=1
	...
	move	$t4, $a1
	.p2align	4, , 16
.LBB27_26:                              #   Parent Loop BB27_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t5, $t4, 0
	add.w	$t6, $t5, $a7
	fld.d	$fa0, $t1, 0
...
# %bb.0:
	...
	fmul.d	$fa2, $fa1, $fa2
	fsub.d	$fa3, $fa7, $fa2
	fst.d	$fa3, $sp, 0                    # 8-byte Folded Spill
	fadd.d	$fa2, $fa7, $fa2
	...
	fsub.d	$fa0, $fa2, $fa5
	fst.d	$fa0, $a0, 120
	fld.d	$fa6, $sp, 0                    # 8-byte Folded Reload
	fadd.d	$fa0, $fa6, $ft7
	fadd.d	$fa2, $fs4, $ft2
	fsub.d	$fa3, $ft8, $ft5
	fsub.d	$fa4, $ft9, $ft6
