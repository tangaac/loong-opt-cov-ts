...
.Lfunc_end1:
	.size	mp_mul_radix_test, .Lfunc_end1-mp_mul_radix_test
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function mp_sscanf
.LCPI2_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
.LBB2_48:                               # %vector.body175
	...
	addi.d	$a0, $a0, 32
	bnez	$a4, .LBB2_48
# %bb.49:                               # %middle.block178
	beq	$a2, $a3, .LBB2_52
.LBB2_50:                               # %.lr.ph121.preheader181
	alsl.d	$a0, $a1, $fp, 2
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
...
# %bb.19:
	bltz	$s7, .LBB36_23
# %bb.20:                               # %.lr.ph46.preheader.i
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_21:                              # %.lr.ph46.i108
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s0, $a1
...
# %bb.33:
	bltz	$s7, .LBB36_37
# %bb.34:                               # %.lr.ph46.preheader.i125
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_35:                              # %.lr.ph46.i126
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s6, $a1
