...
# %bb.0:                                # %.preheader204
	...
	vld	$vr8, $a0, %pc_lo12(.LCPI1_7)
	pcalau12i	$a0, %pc_hi20(.LCPI1_8)
	vld	$vr9, $a0, %pc_lo12(.LCPI1_8)
	...
	vld	$vr10, $a0, %pc_lo12(.LCPI1_10)
	pcalau12i	$a0, %pc_hi20(.LCPI1_11)
	vld	$vr11, $a0, %pc_lo12(.LCPI1_11)
	pcalau12i	$a0, %pc_hi20(.LCPI1_12)
	vld	$vr12, $a0, %pc_lo12(.LCPI1_12)
	pcalau12i	$a0, %pc_hi20(.LCPI1_13)
	vld	$vr13, $a0, %pc_lo12(.LCPI1_13)
	vst	$vr10, $fp, 160
	vst	$vr11, $fp, 176
	vst	$vr12, $fp, 192
	vst	$vr13, $fp, 208
	...
	vld	$vr11, $a0, %pc_lo12(.LCPI1_15)
	pcalau12i	$a0, %pc_hi20(.LCPI1_16)
	vld	$vr12, $a0, %pc_lo12(.LCPI1_16)
	pcalau12i	$a0, %pc_hi20(.LCPI1_17)
	vld	$vr13, $a0, %pc_lo12(.LCPI1_17)
	vst	$vr10, $fp, 224
	vst	$vr11, $fp, 240
	vst	$vr12, $fp, 256
	vst	$vr13, $fp, 272
	...
	fld.d	$fs7, $a0, %pc_lo12(.LCPI1_43)
	pcalau12i	$a0, %pc_hi20(.LCPI1_44)
	fld.d	$fs1, $a0, %pc_lo12(.LCPI1_44)
	pcalau12i	$a0, %pc_hi20(.LCPI1_45)
	fld.d	$fs2, $a0, %pc_lo12(.LCPI1_45)
	pcalau12i	$a0, %pc_hi20(.LCPI1_46)
	fld.d	$fs3, $a0, %pc_lo12(.LCPI1_46)
	pcalau12i	$a0, %pc_hi20(.LCPI1_47)
	fld.d	$fs4, $a0, %pc_lo12(.LCPI1_47)
	pcalau12i	$a0, %pc_hi20(.LCPI1_48)
	fld.d	$fs5, $a0, %pc_lo12(.LCPI1_48)
	lu12i.w	$a0, 116508
	ori	$a0, $a0, 1820
	lu32i.d	$a0, -233017
	lu52i.d	$a0, $a0, 1019
...
# %bb.4:                                # %.preheader197.preheader
	...
	fld.d	$fs0, $a1, %pc_lo12(.LCPI1_63)
	pcalau12i	$a1, %pc_hi20(.LCPI1_64)
	fld.d	$fs1, $a1, %pc_lo12(.LCPI1_64)
...
# %bb.36:                               # %.preheader194
	...
	vld	$vr2, $a0, %pc_lo12(.LCPI1_66)
	pcalau12i	$a0, %pc_hi20(.LCPI1_67)
	vld	$vr3, $a0, %pc_lo12(.LCPI1_67)
	vst	$vr1, $fp, 1136
	...
	pcalau12i	$a1, %pc_hi20(.LCPI1_69)
	vld	$vr3, $a1, %pc_lo12(.LCPI1_69)
	pcalau12i	$a1, %pc_hi20(.LCPI1_70)
	vld	$vr4, $a1, %pc_lo12(.LCPI1_70)
	fst.d	$fa2, $a0, 144
	vfmul.d	$vr2, $vr1, $vr3
	vst	$vr2, $a0, 0
	vfmul.d	$vr2, $vr1, $vr4
	pcalau12i	$a1, %pc_hi20(.LCPI1_71)
	vld	$vr3, $a1, %pc_lo12(.LCPI1_71)
	pcalau12i	$a1, %pc_hi20(.LCPI1_72)
	vld	$vr4, $a1, %pc_lo12(.LCPI1_72)
	vst	$vr2, $a0, 24
	vfmul.d	$vr2, $vr1, $vr3
	vst	$vr2, $a0, 48
	vfmul.d	$vr2, $vr1, $vr4
	pcalau12i	$a1, %pc_hi20(.LCPI1_73)
	vld	$vr3, $a1, %pc_lo12(.LCPI1_73)
	pcalau12i	$a1, %pc_hi20(.LCPI1_74)
	vld	$vr4, $a1, %pc_lo12(.LCPI1_74)
	vst	$vr2, $a0, 72
	vfmul.d	$vr3, $vr1, $vr3
	vst	$vr3, $a0, 96
	vfmul.d	$vr3, $vr1, $vr4
	pcalau12i	$a1, %pc_hi20(.LCPI1_75)
	vld	$vr4, $a1, %pc_lo12(.LCPI1_75)
	vst	$vr3, $a0, 120
	vreplvei.d	$vr2, $vr2, 1
	fst.d	$fa2, $a0, 152
	vfmul.d	$vr2, $vr1, $vr4
	pcalau12i	$a1, %pc_hi20(.LCPI1_76)
	vld	$vr3, $a1, %pc_lo12(.LCPI1_76)
	pcalau12i	$a1, %pc_hi20(.LCPI1_77)
	vld	$vr4, $a1, %pc_lo12(.LCPI1_77)
	vst	$vr2, $a0, 168
	vfmul.d	$vr2, $vr1, $vr3
	vst	$vr2, $a0, 192
	vfmul.d	$vr2, $vr1, $vr4
	pcalau12i	$a1, %pc_hi20(.LCPI1_78)
	vld	$vr3, $a1, %pc_lo12(.LCPI1_78)
	pcalau12i	$a1, %pc_hi20(.LCPI1_79)
	vld	$vr4, $a1, %pc_lo12(.LCPI1_79)
	vst	$vr2, $a0, 216
	vfmul.d	$vr2, $vr1, $vr3
	vst	$vr2, $a0, 240
	vfmul.d	$vr1, $vr1, $vr4
	...
	fld.d	$fa3, $a1, %pc_lo12(.LCPI1_81)
	vst	$vr1, $a0, 264
	fmul.d	$fa1, $fa5, $fa2
	fmul.d	$fa0, $fa1, $fa0
	fmul.d	$fa0, $fa0, $fa3
	pcalau12i	$a1, %pc_hi20(.LCPI1_82)
	fld.d	$fa1, $a1, %pc_lo12(.LCPI1_82)
	pcalau12i	$a1, %pc_hi20(.LCPI1_83)
	fld.d	$fa2, $a1, %pc_lo12(.LCPI1_83)
	lu12i.w	$a1, 343402
	ori	$a1, $a1, 1652
	lu32i.d	$a1, -487951
	lu52i.d	$a1, $a1, 1022
	...
	fld.d	$fa2, $a1, %pc_lo12(.LCPI1_84)
	pcalau12i	$a1, %pc_hi20(.LCPI1_85)
	fld.d	$fa3, $a1, %pc_lo12(.LCPI1_85)
	fst.d	$fa1, $a0, 40
	fmul.d	$fa1, $fa0, $fa2
	fst.d	$fa1, $a0, 64
	fmul.d	$fa1, $fa0, $fa3
	pcalau12i	$a1, %pc_hi20(.LCPI1_86)
	fld.d	$fa2, $a1, %pc_lo12(.LCPI1_86)
	pcalau12i	$a1, %pc_hi20(.LCPI1_87)
	fld.d	$fa3, $a1, %pc_lo12(.LCPI1_87)
	fst.d	$fa1, $a0, 88
	fmul.d	$fa1, $fa0, $fa2
	fst.d	$fa1, $a0, 112
	fmul.d	$fa1, $fa0, $fa3
	pcalau12i	$a1, %pc_hi20(.LCPI1_88)
	fld.d	$fa2, $a1, %pc_lo12(.LCPI1_88)
	pcalau12i	$a1, %pc_hi20(.LCPI1_89)
	fld.d	$fa3, $a1, %pc_lo12(.LCPI1_89)
	fst.d	$fa1, $a0, 136
	fmul.d	$fa1, $fa0, $fa2
	fst.d	$fa1, $a0, 160
	fmul.d	$fa1, $fa0, $fa3
	pcalau12i	$a1, %pc_hi20(.LCPI1_90)
	fld.d	$fa2, $a1, %pc_lo12(.LCPI1_90)
