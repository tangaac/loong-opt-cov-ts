...
.LBB7_14:                               # %vector.ph74
	...
	.p2align	4, , 16
.LBB7_15:                               # %vector.body75
                                        #   Parent Loop BB7_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $s5, %pc_lo12(.LCPI7_0)
	vld	$vr2, $a3, 0
	vld	$vr3, $a3, -16
	vld	$vr4, $a5, -16
	vld	$vr5, $a5, 0
	...
	vshuf.d	$vr6, $vr0, $vr2
	vshuf.d	$vr1, $vr0, $vr3
	vfmadd.d	$vr2, $vr0, $vr6, $vr4
	vfmadd.d	$vr1, $vr0, $vr1, $vr5
	vst	$vr2, $a4, -16
	vst	$vr1, $a4, 0
	addi.d	$a1, $a1, -4
	addi.d	$a5, $a5, 32
	...
	addi.d	$a3, $a3, -32
	bnez	$a1, .LBB7_15
# %bb.16:                               # %middle.block82
                                        #   in Loop: Header=BB7_10 Depth=1
	beq	$fp, $a2, .LBB7_9
.LBB7_17:                               # %scalar.ph73.preheader
                                        #   in Loop: Header=BB7_10 Depth=1
	slli.d	$a3, $a2, 3
	addi.d	$a1, $sp, 80
	alsl.d	$a1, $a2, $a1, 3
