...
.LBB1_54:                               # %vector.ph
	...
	vld	$vr15, $a2, %pc_lo12(.LCPI1_0)
	pcalau12i	$a2, %pc_hi20(.LCPI1_1)
	vld	$vr16, $a2, %pc_lo12(.LCPI1_1)
	pcalau12i	$a2, %pc_hi20(.LCPI1_2)
	vld	$vr17, $a2, %pc_lo12(.LCPI1_2)
	vrepli.w	$vr18, -7
	vrepli.d	$vr19, 6
	vrepli.d	$vr20, 10
	vrepli.d	$vr21, 12
...
.LBB1_55:                               # %vector.body
                                        # =>This Inner Loop Header: Depth=1
	vadd.w	$vr30, $vr17, $vr18
	vori.b	$vr29, $vr3, 0
	vld	$vr1, $sp, 0                    # 16-byte Folded Reload
	vmadd.w	$vr29, $vr30, $vr1
	vadd.w	$vr30, $vr29, $vr4
	vsrai.w	$vr30, $vr30, 5
	vmaxi.w	$vr30, $vr30, 0
	vmin.w	$vr30, $vr30, $vr2
	add.d	$a3, $fp, $a0
	vpickve2gr.h	$a4, $vr30, 0
	st.h	$a4, $a3, 104
	vpickve2gr.h	$a4, $vr30, 2
	st.h	$a4, $a3, 136
	vpickve2gr.h	$a4, $vr30, 4
	st.h	$a4, $a3, 168
	vpickve2gr.h	$a4, $vr30, 6
	st.h	$a4, $a3, 200
	vslli.d	$vr30, $vr16, 5
	vslli.d	$vr31, $vr15, 5
	vbitseti.d	$vr1, $vr30, 1
	vpickve2gr.d	$a3, $vr1, 0
	vpickve2gr.d	$a4, $vr1, 1
	vbitseti.d	$vr1, $vr31, 1
	...
	stx.h	$a3, $a1, $a6
	vbitseti.d	$vr1, $vr30, 2
	vpickve2gr.d	$a3, $vr1, 0
	vpickve2gr.d	$a4, $vr1, 1
	vbitseti.d	$vr1, $vr31, 2
	vpickve2gr.d	$a5, $vr1, 0
	vpickve2gr.d	$a6, $vr1, 1
	vadd.w	$vr1, $vr29, $vr6
	vsrai.w	$vr1, $vr1, 5
	...
	vpickve2gr.h	$a3, $vr1, 6
	stx.h	$a3, $a1, $a6
	vbitseti.d	$vr1, $vr30, 3
	vpickve2gr.d	$a3, $vr1, 0
	vpickve2gr.d	$a4, $vr1, 1
	vbitseti.d	$vr1, $vr31, 3
	vpickve2gr.d	$a5, $vr1, 0
	vpickve2gr.d	$a6, $vr1, 1
	vadd.w	$vr1, $vr29, $vr8
	vsrai.w	$vr1, $vr1, 5
	...
	vpickve2gr.h	$a3, $vr1, 6
	stx.h	$a3, $a1, $a6
	vbitseti.d	$vr1, $vr30, 4
	vpickve2gr.d	$a3, $vr1, 0
	vpickve2gr.d	$a4, $vr1, 1
	vbitseti.d	$vr1, $vr31, 4
	vpickve2gr.d	$a5, $vr1, 0
	vpickve2gr.d	$a6, $vr1, 1
	vadd.w	$vr1, $vr29, $vr0
	vsrai.w	$vr1, $vr1, 5
	...
	vadd.w	$vr1, $vr29, $vr11
	vsrai.w	$vr1, $vr1, 5
	vmaxi.w	$vr1, $vr1, 0
	vmin.w	$vr1, $vr1, $vr2
	vpickve2gr.h	$t7, $vr1, 0
	vpickve2gr.h	$s1, $vr1, 2
	vpickve2gr.h	$a3, $vr1, 4
	...
	vadd.w	$vr1, $vr29, $vr13
	vsrai.w	$vr1, $vr1, 5
	vmaxi.w	$vr1, $vr1, 0
	vmin.w	$vr1, $vr1, $vr2
	vpickve2gr.h	$a6, $vr1, 0
	move	$t3, $fp
	vpickve2gr.h	$fp, $vr1, 2
	...
	stx.h	$a7, $a1, $a2
	vpickve2gr.d	$a7, $vr31, 0
	move	$a2, $a0
	vpickve2gr.d	$a0, $vr31, 1
	stx.h	$t7, $a1, $t1
	stx.h	$s1, $a1, $t2
	vadd.w	$vr1, $vr29, $vr14
	vsrai.w	$vr1, $vr1, 5
	vmaxi.w	$vr1, $vr1, 0
	vmin.w	$vr1, $vr1, $vr2
	vpickve2gr.h	$t1, $vr1, 0
	vpickve2gr.h	$t2, $vr1, 2
	vpickve2gr.h	$t7, $vr1, 4
	vpickve2gr.h	$s1, $vr1, 6
...
.LBB1_61:                               # %vector.body413
	...
	vslli.d	$vr17, $vr1, 5
	vslli.d	$vr18, $vr0, 5
	vbitseti.d	$vr19, $vr18, 1
	vbitseti.d	$vr20, $vr17, 1
	vbitseti.d	$vr21, $vr16, 1
	vbitseti.d	$vr22, $vr15, 1
	vpickve2gr.d	$a6, $vr22, 0
	vpickve2gr.d	$a7, $vr22, 1
	vpickve2gr.d	$t0, $vr21, 0
	vpickve2gr.d	$t1, $vr21, 1
	vpickve2gr.d	$t2, $vr20, 0
	vpickve2gr.d	$t3, $vr20, 1
	...
	stx.h	$a5, $a0, $t5
	ld.h	$a5, $a1, 4
	vbitseti.d	$vr19, $vr18, 2
	vbitseti.d	$vr20, $vr17, 2
	vbitseti.d	$vr21, $vr16, 2
	vbitseti.d	$vr22, $vr15, 2
	vpickve2gr.d	$a6, $vr22, 0
	vpickve2gr.d	$a7, $vr22, 1
	vpickve2gr.d	$t0, $vr21, 0
	vpickve2gr.d	$t1, $vr21, 1
	...
	stx.h	$a5, $a0, $t5
	ld.h	$a5, $a1, 8
	vbitseti.d	$vr19, $vr18, 3
	vbitseti.d	$vr20, $vr17, 3
	vbitseti.d	$vr21, $vr16, 3
	vbitseti.d	$vr22, $vr15, 3
	vpickve2gr.d	$a6, $vr22, 0
	vpickve2gr.d	$a7, $vr22, 1
	vpickve2gr.d	$t0, $vr21, 0
	vpickve2gr.d	$t1, $vr21, 1
	...
	stx.h	$a5, $a0, $t5
	ld.h	$a5, $a1, 16
	vbitseti.d	$vr19, $vr18, 4
	vbitseti.d	$vr20, $vr17, 4
	vbitseti.d	$vr21, $vr16, 4
	vbitseti.d	$vr22, $vr15, 4
	vpickve2gr.d	$a6, $vr22, 0
	vpickve2gr.d	$a7, $vr22, 1
	vpickve2gr.d	$t0, $vr21, 0
	vpickve2gr.d	$t1, $vr21, 1
	...
	stx.h	$a5, $a0, $t5
	ld.h	$a5, $a1, 22
	vor.v	$vr19, $vr18, $vr10
	vor.v	$vr20, $vr17, $vr10
	vor.v	$vr21, $vr16, $vr10
	vor.v	$vr22, $vr15, $vr10
	vpickve2gr.d	$a6, $vr22, 0
	vpickve2gr.d	$a7, $vr22, 1
	vpickve2gr.d	$t0, $vr21, 0
	vpickve2gr.d	$t1, $vr21, 1
	...
	stx.h	$a5, $a0, $t5
	ld.h	$a5, $a1, 24
	vor.v	$vr19, $vr18, $vr11
	vor.v	$vr20, $vr17, $vr11
	vor.v	$vr21, $vr16, $vr11
	vor.v	$vr22, $vr15, $vr11
	vpickve2gr.d	$a6, $vr22, 0
	vpickve2gr.d	$a7, $vr22, 1
	vpickve2gr.d	$t0, $vr21, 0
	vpickve2gr.d	$t1, $vr21, 1
	...
	stx.h	$a5, $a0, $t5
	ld.h	$a5, $a1, 26
	vor.v	$vr19, $vr18, $vr12
	vor.v	$vr20, $vr17, $vr12
	vor.v	$vr21, $vr16, $vr12
	vor.v	$vr22, $vr15, $vr12
	vpickve2gr.d	$a6, $vr22, 0
	vpickve2gr.d	$a7, $vr22, 1
	vpickve2gr.d	$t0, $vr21, 0
	vpickve2gr.d	$t1, $vr21, 1
	...
	stx.h	$a5, $a0, $t5
	ld.h	$a5, $a1, 28
	vor.v	$vr19, $vr18, $vr13
	vor.v	$vr20, $vr17, $vr13
	vor.v	$vr21, $vr16, $vr13
	vor.v	$vr22, $vr15, $vr13
	vpickve2gr.d	$a6, $vr22, 0
	vpickve2gr.d	$a7, $vr22, 1
	vpickve2gr.d	$t0, $vr21, 0
	vpickve2gr.d	$t1, $vr21, 1
	...
	stx.h	$a5, $a0, $t5
	ld.h	$a5, $a1, 30
	vor.v	$vr18, $vr18, $vr14
	vor.v	$vr17, $vr17, $vr14
	vor.v	$vr16, $vr16, $vr14
	vor.v	$vr15, $vr15, $vr14
	vpickve2gr.d	$a6, $vr15, 0
	vpickve2gr.d	$a7, $vr15, 1
	vpickve2gr.d	$t0, $vr16, 0
	vpickve2gr.d	$t1, $vr16, 1
	vpickve2gr.d	$t2, $vr17, 0
	vpickve2gr.d	$t3, $vr17, 1
	vpickve2gr.d	$t4, $vr18, 0
	vpickve2gr.d	$t5, $vr18, 1
	stx.h	$a5, $a0, $a6
	stx.h	$a5, $a0, $a7
	stx.h	$a5, $a0, $t0
	stx.h	$a5, $a0, $t1
...
# %bb.0:                                # %.preheader199
	...
	add.d	$a3, $a2, $a0
	pcalau12i	$t1, %got_pc_hi20(dequant_coef)
	ld.d	$t2, $t1, %got_pc_lo12(dequant_coef)
	addi.d	$a3, $a3, 2047
	addi.d	$a3, $a3, 373
	slli.d	$a4, $a4, 6
	add.d	$a4, $a4, $t2
	...
	addi.d	$t1, $t1, %pc_lo12(quant_coef)
	add.d	$t1, $t1, $t3
	add.d	$t2, $t2, $t3
	ori	$t3, $zero, 4
	addi.d	$t4, $sp, 24
...
# %bb.7:
	...
	ld.d	$t7, $a7, %got_pc_lo12(dequant_coef)
	slli.d	$s0, $a4, 1
	addi.d	$t6, $a2, 16
