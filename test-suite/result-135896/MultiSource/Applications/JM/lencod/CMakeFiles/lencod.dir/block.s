...
.LBB1_52:                               # %vector.body
	...
	add.d	$a7, $a1, $a2
	vpickve2gr.h	$t0, $vr30, 0
	ld.d	$a3, $sp, 24                    # 8-byte Folded Reload
	stx.h	$t0, $a7, $a3
	vpickve2gr.h	$t0, $vr30, 2
	ld.d	$a3, $sp, 16                    # 8-byte Folded Reload
	stx.h	$t0, $a7, $a3
	vpickve2gr.h	$t0, $vr30, 4
	ld.d	$a3, $sp, 8                     # 8-byte Folded Reload
	stx.h	$t0, $a7, $a3
	vpickve2gr.h	$t0, $vr30, 6
	...
	vpickve2gr.d	$s3, $vr1, 1
	vadd.w	$vr1, $vr29, $vr12
	vsrai.w	$vr1, $vr1, 5
	vmaxi.w	$vr1, $vr1, 0
	vmin.w	$vr1, $vr1, $vr2
	vpickve2gr.h	$s5, $vr1, 0
	vpickve2gr.h	$s6, $vr1, 2
	vpickve2gr.h	$s7, $vr1, 4
	vpickve2gr.h	$s8, $vr1, 6
	vor.v	$vr1, $vr30, $vr28
	...
	stx.h	$t3, $a0, $a3
	vpickve2gr.d	$t3, $vr31, 0
	move	$a3, $a2
	move	$a2, $a1
	vpickve2gr.d	$a1, $vr31, 1
	stx.h	$s1, $a0, $t5
	stx.h	$s4, $a0, $t6
...
.LBB2_2:
	...
	addi.d	$a6, $a0, 32
	slli.d	$a7, $a3, 1
	pcalau12i	$t4, %pc_hi20(dct_luma_16x16.M0)
	addi.d	$ra, $t4, %pc_lo12(dct_luma_16x16.M0)
	vrepli.b	$vr0, 0
	ori	$t4, $zero, 16
	.p2align	4, , 16
...
# %bb.4:
	...
	addi.d	$t6, $a0, %pc_lo12(dct_luma_16x16.M4)
	addi.d	$a0, $t0, 16
...
.LBB6_6:                                # %.preheader669
	...
	vshuf.w	$vr4, $vr9, $vr5
	vst	$vr4, $sp, 560
	vpickve2gr.w	$a0, $vr9, 1
	ori	$a1, $t0, 1040
	vldx	$vr4, $t4, $a1
	st.w	$a0, $sp, 604
	vpickve2gr.w	$a0, $vr9, 2
	st.w	$a0, $sp, 636
	vadd.w	$vr4, $vr4, $vr9
	ldptr.d	$a0, $t4, 12728
...
.LBB6_23:                               #   in Loop: Header=BB6_12 Depth=1
	...
	pcalau12i	$s5, %pc_hi20(sp2_frame_indicator)
	ld.w	$a3, $s5, %pc_lo12(sp2_frame_indicator)
	mul.d	$a1, $a0, $a1
	sll.w	$a1, $a1, $t4
	stx.w	$a1, $s8, $s3
	or	$a1, $a2, $a3
...
.LBB6_42:                               # %.thread610
	...
	ld.w	$a2, $t8, %pc_lo12(si_frame_indicator)
	ld.w	$a4, $s5, %pc_lo12(sp2_frame_indicator)
	add.w	$a3, $a1, $s8
	or	$a1, $a2, $a4
	slti	$a2, $a3, 0
	bnez	$a1, .LBB6_30
...
.LBB6_45:                               # %.preheader659
	...
	vld	$vr1, $a3, %pc_lo12(.LCPI6_4)
	pcalau12i	$a3, %pc_hi20(.LCPI6_5)
	vld	$vr2, $a3, %pc_lo12(.LCPI6_5)
	ori	$a4, $zero, 1
	lu12i.w	$a3, 3
	ori	$a3, $a3, 3236
	vrepli.w	$vr3, 32
