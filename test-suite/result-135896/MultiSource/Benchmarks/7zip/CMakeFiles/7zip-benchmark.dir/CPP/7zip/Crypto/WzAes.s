...
.LBB12_7:
	move	$a3, $a4
	move	$s2, $a1
.LBB12_8:                               # %.preheader48.preheader71
	ori	$a1, $zero, 1
	.p2align	4, , 16
.LBB12_9:                               # %.preheader48
                                        # =>This Inner Loop Header: Depth=1
...
.LBB13_6:
	...
	move	$s5, $s0
	move	$s3, $a1
.LBB13_7:                               # %.preheader48.i.preheader23
	ori	$a4, $zero, 1
	.p2align	4, , 16
...
.LBB14_7:
	move	$a2, $a3
	move	$s3, $s4
.LBB14_8:                               # %.preheader48.i.preheader23
	ori	$a3, $zero, 1
	.p2align	4, , 16
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit24
	...
	ld.bu	$a4, $a5, 15
	bne	$a1, $a4, .LBB15_33
.LBB15_32:                              # %_ZeqRK4GUIDS1_.exit24.thread.sink.split
	addi.d	$sp, $sp, -16
	...
	addi.d	$sp, $sp, 16
.LBB15_33:                              # %_ZeqRK4GUIDS1_.exit24.thread
	move	$a0, $a3
	ret
.Lfunc_end15:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit27
	...
	ori	$a5, $zero, 8
	beq	$a6, $a3, .LBB28_48
.LBB28_32:                              # %_ZeqRK4GUIDS1_.exit27.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit46
	...
	ori	$a5, $zero, 592
	bne	$a1, $a4, .LBB28_49
.LBB28_48:                              # %_ZeqRK4GUIDS1_.exit46.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB28_49:                              # %_ZeqRK4GUIDS1_.exit46.thread
	move	$a0, $a3
	ret
.Lfunc_end28:
