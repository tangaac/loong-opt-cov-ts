...
# %bb.142:                              # %.lr.ph63.preheader.i65
	...
	move	$a1, $zero
	b	.LBB1_135
.LBB1_143:                              # %.preheader96.preheader.preheader
	lu12i.w	$a0, -1
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2364
	add.d	$a1, $sp, $a1
	...
	add.d	$a2, $sp, $a2
	.p2align	4, , 16
.LBB1_144:                              # %.preheader96.preheader
	...
	addi.d	$a1, $a1, 96
	bnez	$a0, .LBB1_144
# %bb.145:                              # %.preheader96.1.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2372
	add.d	$a1, $sp, $a1
...
.LBB1_146:                              # %.preheader96.1
	...
	addi.d	$a3, $a3, 8
	bnez	$a0, .LBB1_146
# %bb.147:                              # %.preheader96.2.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2380
	add.d	$a1, $sp, $a1
...
.LBB1_148:                              # %.preheader96.2
	...
	addi.d	$t4, $t4, 8
	bnez	$a0, .LBB1_148
# %bb.149:                              # %.preheader96.3.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2388
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_150:                              # %.preheader96.3
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $t3, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
	...
	addi.d	$t3, $t3, 8
	bnez	$a0, .LBB1_150
# %bb.151:                              # %.preheader96.4.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2396
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_152:                              # %.preheader96.4
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $t2, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
	...
	addi.d	$t2, $t2, 8
	bnez	$a0, .LBB1_152
# %bb.153:                              # %.preheader96.5.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2404
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_154:                              # %.preheader96.5
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $t1, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
	...
	addi.d	$t1, $t1, 8
	bnez	$a0, .LBB1_154
# %bb.155:                              # %.preheader96.6.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2412
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_156:                              # %.preheader96.6
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $t0, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
	...
	addi.d	$t0, $t0, 8
	bnez	$a0, .LBB1_156
# %bb.157:                              # %.preheader96.7.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2420
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_158:                              # %.preheader96.7
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a7, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
	...
	addi.d	$a7, $a7, 8
	bnez	$a0, .LBB1_158
# %bb.159:                              # %.preheader96.8.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2428
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_160:                              # %.preheader96.8
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a6, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
	...
	addi.d	$a6, $a6, 8
	bnez	$a0, .LBB1_160
# %bb.161:                              # %.preheader96.9.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2436
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_162:                              # %.preheader96.9
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a5, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
	...
	addi.d	$a5, $a5, 8
	bnez	$a0, .LBB1_162
# %bb.163:                              # %.preheader96.10.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2444
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_164:                              # %.preheader96.10
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a4, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
	...
	addi.d	$a4, $a4, 8
	bnez	$a0, .LBB1_164
# %bb.165:                              # %.preheader96.11.preheader
	ori	$a0, $zero, 512
	lu12i.w	$a1, 2
	ori	$a1, $a1, 2452
	add.d	$a1, $sp, $a1
	.p2align	4, , 16
.LBB1_166:                              # %.preheader96.11
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a3, -4
	st.d	$a2, $a1, -4
	addi.d	$a0, $a0, -1
...
# %bb.167:                              # %.preheader94.preheader
	...
	add.d	$s3, $sp, $a0
	ori	$t6, $zero, 512
	vst	$vr27, $sp, 288                 # 16-byte Folded Spill
	.p2align	4, , 16
.LBB1_168:                              # %.preheader94
                                        # =>This Loop Header: Depth=1
...
.LBB1_169:                              # %vector.body263
	...
	vslli.d	$vr26, $vr25, 3
	vslli.d	$vr27, $vr24, 3
	vpickve2gr.d	$a2, $vr27, 0
	vpickve2gr.d	$a3, $vr27, 1
	vpickve2gr.d	$a4, $vr26, 0
	fldx.s	$fs3, $a1, $s7
	fldx.s	$fs4, $t1, $s7
	fldx.s	$fs5, $t2, $s7
	fldx.s	$fs6, $t3, $s7
	vpickve2gr.d	$a1, $vr26, 1
	movfr2gr.s	$t1, $fs3
	...
	vfmul.s	$vr28, $vr1, $vr27
	vfsub.s	$vr28, $vr31, $vr28
	vfadd.s	$vr28, $vr28, $vr2
	...
	vld	$vr30, $sp, 224                 # 16-byte Folded Reload
	vfmul.s	$vr0, $vr30, $vr29
	vfsub.s	$vr0, $vr1, $vr0
	vfadd.s	$vr0, $vr28, $vr0
	vfmul.s	$vr1, $vr3, $vr29
	vfmul.s	$vr27, $vr27, $vr30
	...
	fstx.s	$fs2, $a2, $s8
	vreplvei.w	$vr26, $vr0, 1
	fstx.s	$fs2, $a3, $s8
	vreplvei.w	$vr26, $vr0, 2
	fstx.s	$fs2, $a4, $s8
	add.d	$a2, $s8, $a2
	add.d	$a3, $s8, $a3
	add.d	$a4, $s8, $a4
...
# %bb.145:                              # %.lr.ph63.preheader.i77
	...
	b	.LBB2_138
	.p2align	4, , 16
.LBB2_146:                              # %.preheader111.preheader.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	lu12i.w	$a0, 4
	ori	$a0, $a0, 2364
	add.d	$a0, $sp, $a0
	...
	add.d	$a3, $sp, $a2
	.p2align	4, , 16
.LBB2_147:                              # %.preheader111.preheader
                                        #   Parent Loop BB2_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a3, $a1
	ldptr.d	$a2, $a2, 4096
	...
	addi.d	$a0, $a0, 96
	bnez	$a1, .LBB2_147
# %bb.148:                              # %.preheader111.1.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_149:                              # %.preheader111.1
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_149
# %bb.150:                              # %.preheader111.2.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_151:                              # %.preheader111.2
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_151
# %bb.152:                              # %.preheader111.3.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_153:                              # %.preheader111.3
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_153
# %bb.154:                              # %.preheader111.4.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_155:                              # %.preheader111.4
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_155
# %bb.156:                              # %.preheader111.5.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_157:                              # %.preheader111.5
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_157
# %bb.158:                              # %.preheader111.6.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_159:                              # %.preheader111.6
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_159
# %bb.160:                              # %.preheader111.7.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_161:                              # %.preheader111.7
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_161
# %bb.162:                              # %.preheader111.8.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_163:                              # %.preheader111.8
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_163
# %bb.164:                              # %.preheader111.9.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_165:                              # %.preheader111.9
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_165
# %bb.166:                              # %.preheader111.10.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_167:                              # %.preheader111.10
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_167
# %bb.168:                              # %.preheader111.11.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a0, $zero, 512
...
.LBB2_169:                              # %.preheader111.11
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_169
# %bb.170:                              # %.preheader110.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	move	$s0, $zero
	.p2align	4, , 16
.LBB2_171:                              # %.preheader110
                                        #   Parent Loop BB2_3 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB2_172 Depth 3
                                        #       Child Loop BB2_175 Depth 3
	...
	vld	$vr22, $a0, %pc_lo12(.LCPI2_0)
	pcalau12i	$a0, %pc_hi20(.LCPI2_1)
	st.d	$a0, $sp, 224                   # 8-byte Folded Spill
	vld	$vr23, $a0, %pc_lo12(.LCPI2_1)
...
.LBB2_172:                              # %vector.body293
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	vrepli.d	$vr26, 96
	vmul.d	$vr27, $vr22, $vr26
	vmul.d	$vr26, $vr23, $vr26
	vpickve2gr.d	$a1, $vr26, 0
	add.d	$t0, $t4, $a1
	...
	vfmul.s	$vr1, $vr25, $vr1
	vfmadd.s	$vr1, $vr24, $vr26, $vr1
	vfadd.s	$vr1, $vr28, $vr1
	vfmul.s	$vr26, $vr26, $vr25
	vfmadd.s	$vr2, $vr24, $vr2, $vr26
	vfadd.s	$vr0, $vr0, $vr2
	...
	vreplvei.w	$vr0, $vr0, 3
	fst.s	$fa0, $a1, 4
	vaddi.du	$vr23, $vr23, 4
	addi.d	$a0, $a0, -4
	vaddi.du	$vr22, $vr22, 4
	bnez	$a0, .LBB2_172
# %bb.173:                              # %.preheader109
