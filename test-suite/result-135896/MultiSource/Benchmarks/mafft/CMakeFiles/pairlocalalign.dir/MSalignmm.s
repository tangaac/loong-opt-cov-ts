...
.LBB1_255:                              # %vector.body219
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB1_255
# %bb.256:                              # %middle.block224
	beq	$a1, $s6, .LBB1_259
.LBB1_257:                              # %scalar.ph212.preheader
	alsl.d	$a2, $a1, $s3, 3
	sub.d	$a1, $s6, $a1
	.p2align	4, , 16
.LBB1_258:                              # %scalar.ph212
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
