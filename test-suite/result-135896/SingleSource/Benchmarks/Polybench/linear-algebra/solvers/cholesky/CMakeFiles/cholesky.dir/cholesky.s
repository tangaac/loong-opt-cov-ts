...
.LBB7_9:                                # %vector.body103
	...
	addi.d	$s3, $s3, 32
	bnez	$s2, .LBB7_9
# %bb.10:                               # %middle.block106
                                        #   in Loop: Header=BB7_6 Depth=1
	beq	$a4, $t8, .LBB7_13
.LBB7_11:                               # %scalar.ph98.preheader
                                        #   in Loop: Header=BB7_6 Depth=1
	alsl.d	$s2, $t8, $t7, 3
	alsl.d	$s3, $t8, $t6, 3
	sub.w	$s4, $zero, $t8
...
.LBB7_27:                               # %.preheader83.i
	...
	alsl.d	$t6, $a1, $t6, 3
	beqz	$t3, .LBB7_30
# %bb.28:                               # %scalar.ph115.preheader
                                        #   in Loop: Header=BB7_27 Depth=2
	move	$t7, $t1
	move	$t8, $a6
	.p2align	4, , 16
.LBB7_29:                               # %scalar.ph115
                                        #   Parent Loop BB7_25 Depth=1
	...
	b	.LBB7_26
	.p2align	4, , 16
.LBB7_30:                               # %vector.body117.preheader
                                        #   in Loop: Header=BB7_27 Depth=2
	fld.d	$fa0, $t6, 0
...
# %bb.53:                               # %.preheader.lr.ph.i25
	...
	b	.LBB7_56
	.p2align	4, , 16
.LBB7_54:                               # %.preheader.._crit_edge_crit_edge.i46
                                        #   in Loop: Header=BB7_56 Depth=2
	fld.d	$fa0, $a0, 0
.LBB7_55:                               # %._crit_edge.i35
                                        #   in Loop: Header=BB7_56 Depth=2
	mul.d	$a4, $a1, $s3
	add.d	$a4, $s0, $a4
	fldx.d	$fa1, $a4, $a3
...
.LBB7_60:                               #   Parent Loop BB7_52 Depth=1
	...
	fst.d	$fa0, $a0, 0
	bne	$s2, $a1, .LBB7_60
# %bb.61:                               # %._crit_edge49.i43
                                        #   in Loop: Header=BB7_52 Depth=1
	fsqrt.d	$fa1, $fa0
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bceqz	$fcc0, .LBB7_64
.LBB7_62:                               # %._crit_edge49.i43.split
                                        #   in Loop: Header=BB7_52 Depth=1
	add.d	$a0, $s0, $s1
	alsl.d	$a0, $s6, $a0, 3
	fst.d	$fa1, $a0, 0
	...
	b	.LBB7_65
	.p2align	4, , 16
.LBB7_63:                               # %.preheader43.._crit_edge49_crit_edge.i48
                                        #   in Loop: Header=BB7_52 Depth=1
	fld.d	$fa0, $s0, 0
	fsqrt.d	$fa1, $fa0
	fcmp.cor.d	$fcc0, $fa1, $fa1
...
.LBB7_64:                               # %call.sqrt334
	...
	fmov.d	$fa1, $fa0
	b	.LBB7_62
.LBB7_65:                               # %.preheader.i50.preheader
