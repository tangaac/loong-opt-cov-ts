...
# %bb.12:                               # %iter.check626
	...
	bgeu	$a4, $t0, .LBB2_32
# %bb.13:                               # %vector.memcheck617
	addi.d	$a4, $a1, 4
	alsl.d	$t3, $t2, $a0, 2
	bgeu	$a4, $t3, .LBB2_15
# %bb.14:                               # %vector.memcheck617
	alsl.d	$a4, $t2, $a1, 2
	bltu	$a0, $a4, .LBB2_32
.LBB2_15:                               # %vector.main.loop.iter.check628
	ori	$a4, $zero, 17
	addi.d	$t3, $t2, -1
	bgeu	$t0, $a4, .LBB2_17
# %bb.16:
...
.LBB2_18:                               # %vector.body634
	...
	addi.d	$t4, $t4, 64
	bnez	$t6, .LBB2_18
# %bb.19:                               # %middle.block641
	beq	$t3, $t5, .LBB2_34
# %bb.20:                               # %vec.epilog.iter.check646
	andi	$a4, $t3, 12
	beqz	$a4, .LBB2_31
.LBB2_21:                               # %vec.epilog.ph645
	move	$a4, $t3
	...
	sub.d	$t5, $t5, $a4
	.p2align	4, , 16
.LBB2_22:                               # %vec.epilog.vector.body653
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t6, 0
	vld	$vr2, $t6, -4
	vsub.w	$vr1, $vr1, $vr2
	...
	addi.d	$t7, $t7, 16
	bnez	$t5, .LBB2_22
# %bb.23:                               # %vec.epilog.middle.block659
	bne	$t3, $a4, .LBB2_32
	b	.LBB2_34
.LBB2_24:                               # %vector.ph
	move	$a4, $a3
...
.LBB2_80:                               #   in Loop: Header=BB2_77 Depth=1
	...
	b	.LBB2_92
	.p2align	4, , 16
.LBB2_81:                               # %vector.main.loop.iter.check667
                                        #   in Loop: Header=BB2_77 Depth=1
	ori	$a4, $zero, 16
	bgeu	$s4, $a4, .LBB2_83
...
# %bb.85:                               # %middle.block682
	...
	beq	$t2, $t1, .LBB2_92
# %bb.86:                               # %vec.epilog.iter.check687
                                        #   in Loop: Header=BB2_77 Depth=1
	move	$s8, $t2
	move	$ra, $t2
...
.LBB2_87:                               # %vec.epilog.ph686
	...
	alsl.d	$s7, $s8, $a3, 1
	.p2align	4, , 16
.LBB2_88:                               # %vec.epilog.vector.body694
                                        #   Parent Loop BB2_77 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s8, $s7, 0
