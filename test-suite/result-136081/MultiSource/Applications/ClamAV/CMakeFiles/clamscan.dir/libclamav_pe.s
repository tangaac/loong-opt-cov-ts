...
# %bb.594:
	...
	bgeu	$a1, $a0, .LBB0_557
	b	.LBB0_563
.LBB0_595:                              # %vector.main.loop.iter.check3784
	ori	$a0, $zero, 16
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB0_616
# %bb.596:
...
# %bb.618:                              # %middle.block3793
	...
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_625
# %bb.619:                              # %vec.epilog.iter.check3800
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	andi	$a1, $a1, 12
	beqz	$a1, .LBB0_623
.LBB0_620:                              # %vec.epilog.ph3799
	move	$a2, $a0
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	andi	$a0, $a0, 124
	vreplgr2vr.w	$vr0, $s5
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_621:                              # %vec.epilog.vector.body3805
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
...
# %bb.632:                              # %.lr.ph3490
	...
	ld.d	$s3, $sp, 144                   # 8-byte Folded Reload
	b	.LBB0_634
.LBB0_633:                              #   in Loop: Header=BB0_634 Depth=1
	addi.w	$s7, $s7, -1
	addi.d	$s4, $s4, -1
	addi.d	$s3, $s3, 36
	beqz	$s4, .LBB0_673
.LBB0_634:                              # =>This Inner Loop Header: Depth=1
	ld.w	$a0, $s3, 12
	beqz	$a0, .LBB0_633
# %bb.635:                              #   in Loop: Header=BB0_634 Depth=1
	move	$a0, $s1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_640
# %bb.636:                              #   in Loop: Header=BB0_634 Depth=1
	ld.wu	$a0, $s3, 12
	addi.w	$a1, $a0, -1
	bgeu	$a1, $s5, .LBB0_640
# %bb.637:                              #   in Loop: Header=BB0_634 Depth=1
	ld.wu	$a1, $s3, 0
	add.d	$a1, $s6, $a1
	add.d	$a2, $a1, $a0
	bltu	$s0, $a2, .LBB0_640
# %bb.638:                              #   in Loop: Header=BB0_634 Depth=1
	bgeu	$s6, $a2, .LBB0_640
# %bb.639:                              #   in Loop: Header=BB0_634 Depth=1
	addi.w	$a2, $a0, 0
	move	$a0, $s1
	pcaddu18i	$ra, %call36(cli_readn)
	jirl	$ra, $ra, 0
...
# %bb.641:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_642:                              # %.critedge200.sink.split
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_643:                              # %.critedge200
	ld.d	$a0, $fp, 56
	ld.bu	$a0, $a0, 1
	andi	$a0, $a0, 16
	beqz	$a0, .LBB0_650
...
.LBB0_671:
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
.LBB0_672:                              # %.critedge3021
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_673:                              # %._crit_edge3491.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_678
...
.LBB0_728:
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_729:                              # %vector.main.loop.iter.check
	ori	$a0, $zero, 17
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB0_773
# %bb.730:
...
# %bb.775:                              # %middle.block3767
	...
	beq	$a0, $s7, .LBB0_782
# %bb.776:                              # %vec.epilog.iter.check
	andi	$a1, $s7, 12
	beqz	$a1, .LBB0_780
.LBB0_777:                              # %vec.epilog.ph
	move	$a2, $a0
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 80
.LBB0_778:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
...
# %bb.786:
	...
	b	.LBB0_204
.LBB0_787:                              # %._crit_edge3478._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_788:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
# %bb.791:                              # %.lr.ph3481
	...
	sub.d	$s7, $a0, $a1
	b	.LBB0_793
.LBB0_792:                              #   in Loop: Header=BB0_793 Depth=1
	addi.d	$s8, $s8, 36
	beq	$s4, $s8, .LBB0_810
...
# %bb.794:                              #   in Loop: Header=BB0_793 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_798
# %bb.795:                              #   in Loop: Header=BB0_793 Depth=1
	ld.wu	$a0, $s3, 0
	ld.w	$a2, $s3, 12
	add.d	$a1, $s7, $a0
	move	$a0, $s1
...
.LBB0_806:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a4, $a5, -1
	bltu	$a4, $a2, .LBB0_890
# %bb.807:                              #   in Loop: Header=BB0_806 Depth=1
	ld.w	$a4, $s4, 0
	slli.d	$a5, $a5, 12
	sub.d	$a5, $a5, $a1
	add.w	$a5, $a5, $a3
	...
	bltu	$a5, $a4, .LBB0_889
# %bb.808:                              #   in Loop: Header=BB0_806 Depth=1
	ld.w	$a6, $s4, 4
	sub.w	$a4, $a5, $a4
	bgeu	$a4, $a6, .LBB0_889
# %bb.809:                              #   in Loop: Header=BB0_806 Depth=1
	addi.w	$s7, $s7, 2
	bltu	$s7, $a0, .LBB0_806
	b	.LBB0_890
.LBB0_810:                              # %._crit_edge3482
	ld.wu	$a0, $s5, 12
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
	jirl	$ra, $ra, 0
