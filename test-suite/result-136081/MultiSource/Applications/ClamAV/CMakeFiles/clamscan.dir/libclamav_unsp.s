...
# %bb.28:                               #   in Loop: Header=BB1_15 Depth=1
	ori	$t5, $zero, 1
.LBB1_29:                               # %.preheader.preheader699
                                        #   in Loop: Header=BB1_15 Depth=1
	sub.w	$a1, $zero, $a2
	addi.w	$a5, $a4, -1
	move	$a3, $s5
...
.LBB1_219:                              #   in Loop: Header=BB1_15 Depth=1
	...
	ori	$a6, $zero, 255
	b	.LBB1_249
.LBB1_220:                              # %vector.main.loop.iter.check664
                                        #   in Loop: Header=BB1_15 Depth=1
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB1_222
# %bb.221:                              #   in Loop: Header=BB1_15 Depth=1
	move	$s7, $t6
	move	$a4, $zero
	move	$a3, $zero
	b	.LBB1_226
.LBB1_222:                              # %vector.ph665
                                        #   in Loop: Header=BB1_15 Depth=1
...
# %bb.224:                              # %middle.block675
	...
	beq	$a2, $a6, .LBB1_230
# %bb.225:                              # %vec.epilog.iter.check680
                                        #   in Loop: Header=BB1_15 Depth=1
	andi	$a6, $a5, 12
	beqz	$a6, .LBB1_229
.LBB1_226:                              # %vec.epilog.ph679
                                        #   in Loop: Header=BB1_15 Depth=1
	bstrins.d	$a5, $zero, 1, 0
	pcalau12i	$a6, %pc_hi20(.LCPI1_2)
	vld	$vr1, $a6, %pc_lo12(.LCPI1_2)
	vreplgr2vr.w	$vr2, $a4
	pcalau12i	$a6, %pc_hi20(.LCPI1_3)
	vld	$vr0, $a6, %pc_lo12(.LCPI1_3)
	vor.v	$vr1, $vr2, $vr1
...
.LBB1_227:                              # %vec.epilog.vector.body685
                                        #   Parent Loop BB1_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vsll.w	$vr2, $vr3, $vr1
	vor.v	$vr0, $vr2, $vr0
	...
	vaddi.wu	$vr1, $vr1, 4
	bnez	$a3, .LBB1_227
# %bb.228:                              # %vec.epilog.middle.block694
                                        #   in Loop: Header=BB1_15 Depth=1
	...
	beq	$a2, $a6, .LBB1_230
	.p2align	4, , 16
.LBB1_229:                              # %getbit_from_table.exit.us.i435
                                        #   Parent Loop BB1_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ori	$a5, $zero, 255
	sll.w	$a5, $a5, $a4
...
.LBB1_232:                              # %get_byte.exit.i382
	...
	slli.d	$a0, $a2, 8
	st.w	$a0, $sp, 296
.LBB1_233:                              # %getbit_from_table.exit384
                                        #   in Loop: Header=BB1_15 Depth=1
	ori	$s6, $zero, 1
	beqz	$s5, .LBB1_1
...
# %bb.241:                              #   in Loop: Header=BB1_15 Depth=1
	bgeu	$a3, $a5, .LBB1_246
# %bb.242:                              #   in Loop: Header=BB1_15 Depth=1
	ld.bu	$t2, $a3, 0
	addi.d	$a3, $a3, 1
	st.d	$a3, $sp, 280
	b	.LBB1_247
...
.LBB1_246:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t8, $sp, 304
	ori	$t2, $zero, 255
.LBB1_247:                              # %get_byte.exit53.i.i455
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t2, $a4
	st.w	$a4, $sp, 300
	slli.d	$t1, $t1, 8
.LBB1_248:                              # %getbit_from_table.exit.i450
                                        #   in Loop: Header=BB1_15 Depth=1
	st.w	$t1, $sp, 296
.LBB1_249:                              # %getbit_from_table.exit.i450
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t3, $a6, 2
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	alsl.d	$t2, $t3, $t2, 1
	bltu	$t2, $t0, .LBB1_255
# %bb.250:                              # %getbit_from_table.exit.i450
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t4, $t2, 2
	bltu	$a7, $t4, .LBB1_255
...
# %bb.257:                              #   in Loop: Header=BB1_15 Depth=1
	bgeu	$a3, $a5, .LBB1_262
# %bb.258:                              #   in Loop: Header=BB1_15 Depth=1
	ld.bu	$t4, $a3, 0
	addi.d	$a3, $a3, 1
	st.d	$a3, $sp, 280
	b	.LBB1_263
...
.LBB1_260:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t8, $sp, 304
	ori	$t1, $zero, 255
.LBB1_261:                              # %get_byte.exit.i.i458.1
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$t6, $t7
	move	$t2, $zero
	slli.w	$a4, $a4, 8
...
.LBB1_262:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t8, $sp, 304
	ori	$t4, $zero, 255
.LBB1_263:                              # %get_byte.exit53.i.i455.1
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t4, $a4
	st.w	$a4, $sp, 300
	slli.d	$t1, $t1, 8
.LBB1_264:                              # %getbit_from_table.exit.i450.1
                                        #   in Loop: Header=BB1_15 Depth=1
	st.w	$t1, $sp, 296
.LBB1_265:                              # %getbit_from_table.exit.i450.1
                                        #   in Loop: Header=BB1_15 Depth=1
	alsl.d	$t4, $t3, $t2, 1
	ld.d	$t3, $sp, 80                    # 8-byte Folded Reload
	alsl.d	$t3, $t4, $t3, 1
	bltu	$t3, $t0, .LBB1_271
# %bb.266:                              # %getbit_from_table.exit.i450.1
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t5, $t3, 2
	bltu	$a7, $t5, .LBB1_271
...
# %bb.273:                              #   in Loop: Header=BB1_15 Depth=1
	bgeu	$a3, $a5, .LBB1_278
# %bb.274:                              #   in Loop: Header=BB1_15 Depth=1
	ld.bu	$t5, $a3, 0
	addi.d	$a3, $a3, 1
	st.d	$a3, $sp, 280
	b	.LBB1_279
...
.LBB1_276:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t8, $sp, 304
	ori	$t1, $zero, 255
.LBB1_277:                              # %get_byte.exit.i.i458.2
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$t6, $s7
	move	$t3, $zero
	slli.w	$a4, $a4, 8
...
.LBB1_278:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t8, $sp, 304
	ori	$t5, $zero, 255
.LBB1_279:                              # %get_byte.exit53.i.i455.2
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t5, $a4
	st.w	$a4, $sp, 300
	slli.d	$t1, $t1, 8
.LBB1_280:                              # %getbit_from_table.exit.i450.2
                                        #   in Loop: Header=BB1_15 Depth=1
	st.w	$t1, $sp, 296
.LBB1_281:                              # %getbit_from_table.exit.i450.2
                                        #   in Loop: Header=BB1_15 Depth=1
	alsl.d	$t4, $t4, $t3, 1
	ld.d	$t5, $sp, 80                    # 8-byte Folded Reload
	alsl.d	$t4, $t4, $t5, 1
	bltu	$t4, $t0, .LBB1_287
# %bb.282:                              # %getbit_from_table.exit.i450.2
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t0, $t4, 2
	bltu	$a7, $t0, .LBB1_287
...
# %bb.286:                              #   in Loop: Header=BB1_15 Depth=1
	...
	st.d	$a3, $sp, 280
	b	.LBB1_293
.LBB1_287:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t8, $sp, 304
	ori	$a7, $zero, 2040
	b	.LBB1_297
.LBB1_288:                              #   in Loop: Header=BB1_15 Depth=1
	...
	ori	$a7, $zero, 8
	bnez	$t0, .LBB1_297
# %bb.289:                              #   in Loop: Header=BB1_15 Depth=1
	bgeu	$a3, $a5, .LBB1_294
...
.LBB1_292:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t8, $sp, 304
	ori	$a5, $zero, 255
.LBB1_293:                              # %get_byte.exit.i.i458.3
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$a7, $zero
	slli.d	$a3, $a4, 8
	or	$a3, $a5, $a3
...
.LBB1_294:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t8, $sp, 304
	ori	$a5, $zero, 255
.LBB1_295:                              # %get_byte.exit53.i.i455.3
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.d	$a3, $a4, 8
	or	$a3, $a5, $a3
	st.w	$a3, $sp, 300
	slli.d	$a3, $t1, 8
.LBB1_296:                              # %getbit_from_table.exit.i450.3
                                        #   in Loop: Header=BB1_15 Depth=1
	st.w	$a3, $sp, 296
.LBB1_297:                              # %getbit_from_table.exit.i450.3
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.d	$a3, $t2, 1
	slli.d	$a4, $t3, 2
	or	$a3, $a3, $a4
	or	$a3, $a3, $a7
	or	$a3, $a3, $a6
.LBB1_298:                              # %get_bb.exit465
                                        #   in Loop: Header=BB1_15 Depth=1
	alsl.w	$a1, $a2, $a1, 4
	add.d	$a2, $a1, $a3
.LBB1_299:                              #   in Loop: Header=BB1_15 Depth=1
	slti	$a1, $s6, 7
	ori	$a3, $zero, 10
	masknez	$a3, $a3, $a1
	ori	$a4, $zero, 7
...
.LBB8_29:                               # %vec.epilog.ph
	...
	vld	$vr1, $a4, %pc_lo12(.LCPI8_2)
	vreplgr2vr.w	$vr2, $a3
	pcalau12i	$a4, %pc_hi20(.LCPI8_3)
	vld	$vr0, $a4, %pc_lo12(.LCPI8_3)
	vor.v	$vr1, $vr2, $vr1
