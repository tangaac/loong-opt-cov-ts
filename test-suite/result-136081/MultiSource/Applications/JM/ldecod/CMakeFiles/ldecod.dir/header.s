...
# %bb.40:                               # %iter.check268
	...
	add.d	$a6, $a0, $a6
	bltu	$a4, $t0, .LBB4_43
# %bb.41:                               # %vector.memcheck260
	alsl.d	$t0, $a4, $a1, 2
	addi.d	$t0, $t0, 1040
	bgeu	$a6, $t0, .LBB4_84
# %bb.42:                               # %vector.memcheck260
	ori	$a3, $a3, 1632
	add.d	$a3, $a0, $a3
	bgeu	$a5, $a3, .LBB4_84
.LBB4_43:
	move	$a5, $zero
.LBB4_44:                               # %vec.epilog.scalar.ph286.preheader
	addi.d	$a3, $a5, -1
	alsl.d	$a5, $a5, $a1, 2
	addi.d	$a5, $a5, 1036
	.p2align	4, , 16
.LBB4_45:                               # %vec.epilog.scalar.ph286
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a5, 0
	add.d	$a7, $a7, $t0
	st.w	$a7, $a6, 0
...
.LBB4_83:
	...
	bge	$a4, $a7, .LBB4_16
	b	.LBB4_37
.LBB4_84:                               # %vector.main.loop.iter.check270
	ori	$a5, $zero, 15
	addi.d	$a3, $a4, 1
	bgeu	$a4, $a5, .LBB4_93
# %bb.85:
...
.LBB4_97:                               # %vec.epilog.ph287
	...
	addi.d	$a7, $a7, 1036
	.p2align	4, , 16
.LBB4_98:                               # %vec.epilog.vector.body293
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vadd.w	$vr0, $vr0, $vr1
	addi.d	$t0, $t0, 4
