...
# %bb.1:
	...
	maskeqz	$a6, $a6, $a7
	or	$a6, $a6, $t0
	pcalau12i	$a7, %pc_hi20(NTAB1)
	addi.d	$a7, $a7, %pc_lo12(NTAB1)
	alsl.d	$a6, $a6, $a7, 4
...
# %bb.1:
	...
	maskeqz	$a6, $a6, $a7
	or	$a6, $a6, $t0
	pcalau12i	$a7, %pc_hi20(NTAB3)
	addi.d	$a7, $a7, %pc_lo12(NTAB3)
	alsl.d	$a6, $a6, $a7, 2
	bstrins.d	$a1, $zero, 0, 0
	add.d	$a1, $a6, $a1
	ld.bu	$a6, $a1, -4
