...
# %bb.41:                               # %.split
	fneg.d	$fs3, $fs3
	fmadd.d	$fa0, $fs3, $fs2, $fa0
	fcmp.cult.d	$fcc0, $fs6, $fa0
	bceqz	$fcc0, .LBB4_90
.LBB4_42:
	fadd.d	$fa1, $fs1, $fs1
	fsqrt.d	$fa0, $fs0
...
# %bb.49:                               # %.sink.split.i212
	...
	st.w	$a4, $a0, 1352
	st.w	$a3, $a0, 1356
.LBB4_50:                               # %updateQPInterlace.exit215
	ld.w	$a3, $a0, 1356
	ld.w	$a4, $a0, 1352
	sub.w	$a3, $a3, $a4
	slli.d	$a6, $a1, 1
...
# %bb.69:                               # %.sink.split.i222
	...
	st.w	$a4, $a0, 1352
	st.w	$a3, $a0, 1356
.LBB4_70:                               # %updateQPInterlace.exit225
	ld.w	$a3, $a0, 1356
	ld.w	$a4, $a0, 1352
	sub.w	$a3, $a3, $a4
	slli.d	$a6, $a1, 1
...
.LBB4_90:
	move	$s1, $a0
	fdiv.d	$fa0, $fs4, $fs5
.LBB4_91:                               # %updateModelQPFrame.exit
	fcvt.s.d	$fa0, $fa0
	fcvt.d.s	$fa0, $fa0
...
# %bb.93:
	...
	add.d	$a3, $a3, $a1
	st.w	$a3, $a2, 44
.LBB4_94:                               # %updateQPNonPicAFF.exit
	st.w	$a4, $a0, 1352
	st.w	$a1, $a0, 1356
	st.w	$a1, $a0, 1328
	b	.LBB4_96
.LBB4_95:
	st.w	$a1, $a0, 1460
.LBB4_96:                               # %updateQPNonPicAFF.exit
	addi.w	$a0, $a1, 0
	fld.d	$fs6, $sp, 8                    # 8-byte Folded Reload
	fld.d	$fs5, $sp, 16                   # 8-byte Folded Reload
	fld.d	$fs4, $sp, 24                   # 8-byte Folded Reload
...
# %bb.26:
	...
	st.w	$a2, $a0, 1356
	ori	$a3, $zero, 1328
.LBB5_27:                               # %updateBottomField.exit
	stx.w	$a2, $a0, $a3
	b	.LBB5_42
.LBB5_28:
	ld.w	$a3, $a2, 24
...
.LBB5_45:
	...
	ori	$a5, $zero, 1468
	blt	$a6, $a7, .LBB5_47
.LBB5_46:                               # %.sink.split.i.sink.split
	ld.w	$a6, $a2, 44
	add.d	$a6, $a6, $a4
	st.w	$a6, $a2, 44
.LBB5_47:                               # %.sink.split.i
	st.w	$a4, $a0, 1384
	ldx.w	$a4, $a0, $a5
	st.w	$a4, $a0, 1380
.LBB5_48:
...
# %bb.49:
	...
	ori	$a5, $zero, 1504
	beqz	$a7, .LBB5_56
.LBB5_50:                               # %.sink.split31.i
	stx.w	$a6, $a0, $a5
	ld.w	$a3, $a0, 1368
.LBB5_51:                               # %updateFirstBU.exit
	ld.w	$a2, $a0, 1364
	add.d	$a2, $a2, $a1
	st.w	$a2, $a0, 1364
	addi.d	$a2, $a3, -1
...
.LBB5_64:
	move	$s2, $a0
	fdiv.d	$fa0, $fs4, $fs5
.LBB5_65:                               # %updateModelQPFrame.exit
	fcvt.s.d	$fa0, $fa0
	fcvt.d.s	$fa0, $fa0
	pcaddu18i	$ra, %call36(Qstep2QP)
	jirl	$ra, $ra, 0
...
.LBB5_67:
	...
	st.w	$a1, $a0, 1356
	st.w	$a1, $a0, 1328
.LBB5_68:                               # %updateQPNonPicAFF.exit
	move	$a0, $a1
	fld.d	$fs6, $sp, 8                    # 8-byte Folded Reload
	fld.d	$fs5, $sp, 16                   # 8-byte Folded Reload
	fld.d	$fs4, $sp, 24                   # 8-byte Folded Reload
...
.LBB6_72:
	...
	ori	$a5, $zero, 1468
	blt	$a6, $a7, .LBB6_74
.LBB6_73:                               # %.sink.split.i169.sink.split
	ld.w	$a6, $a3, 44
	add.d	$a6, $a6, $a2
	st.w	$a6, $a3, 44
.LBB6_74:                               # %.sink.split.i169
	st.w	$a2, $a0, 1384
	ldx.w	$a2, $a0, $a5
	st.w	$a2, $a0, 1380
.LBB6_75:
...
# %bb.76:
	...
	ori	$a6, $zero, 1504
	beqz	$a1, .LBB6_80
.LBB6_77:                               # %.sink.split31.i
	stx.w	$a7, $a0, $a6
	ld.w	$a4, $a0, 1368
.LBB6_78:                               # %updateFirstBU.exit
	ld.w	$a1, $a0, 1364
	add.d	$a1, $a1, $a2
	st.w	$a1, $a0, 1364
	addi.d	$a1, $a4, -1
...
.LBB6_82:
	move	$s1, $a0
	fdiv.d	$fa0, $fs4, $fs5
.LBB6_83:                               # %updateModelQPFrame.exit
	fcvt.s.d	$fa0, $fa0
	fcvt.d.s	$fa0, $fa0
	pcaddu18i	$ra, %call36(Qstep2QP)
	jirl	$ra, $ra, 0
...
.LBB6_86:
	...
	st.w	$a2, $a0, 1356
	st.w	$a2, $a0, 1328
.LBB6_87:                               # %updateQPNonPicAFF.exit
	move	$a0, $a2
	fld.d	$fs6, $sp, 8                    # 8-byte Folded Reload
	fld.d	$fs5, $sp, 16                   # 8-byte Folded Reload
	fld.d	$fs4, $sp, 24                   # 8-byte Folded Reload
...
.LBB7_57:
	...
	ori	$a5, $zero, 1468
	blt	$a6, $a7, .LBB7_59
.LBB7_58:                               # %.sink.split.i.sink.split
	ld.w	$a6, $a3, 44
	add.d	$a6, $a6, $a2
	st.w	$a6, $a3, 44
.LBB7_59:                               # %.sink.split.i
	st.w	$a2, $a0, 1384
	ldx.w	$a2, $a0, $a5
	st.w	$a2, $a0, 1380
.LBB7_60:
...
# %bb.61:
	...
	ori	$a6, $zero, 1504
	beqz	$a1, .LBB7_65
.LBB7_62:                               # %.sink.split31.i
	stx.w	$a7, $a0, $a6
	ld.w	$a4, $a0, 1368
.LBB7_63:                               # %updateFirstBU.exit
	ld.w	$a1, $a0, 1364
	add.d	$a1, $a1, $a2
	st.w	$a1, $a0, 1364
	addi.d	$a1, $a4, -1
...
.LBB7_67:
	move	$s1, $a0
	fdiv.d	$fa0, $fs4, $fs5
.LBB7_68:                               # %updateModelQPFrame.exit
	fcvt.s.d	$fa0, $fa0
	fcvt.d.s	$fa0, $fa0
	pcaddu18i	$ra, %call36(Qstep2QP)
	jirl	$ra, $ra, 0
...
.LBB7_80:
	st.w	$a2, $a0, 1460
.LBB7_81:                               # %updateQPNonPicAFF.exit
	addi.w	$a0, $a2, 0
	fld.d	$fs6, $sp, 8                    # 8-byte Folded Reload
	fld.d	$fs5, $sp, 16                   # 8-byte Folded Reload
	fld.d	$fs4, $sp, 24                   # 8-byte Folded Reload
...
.LBB8_27:                               # %vector.body
	...
	movfr2gr.d	$t3, $fa3
	xvinsgr2vr.d	$xr5, $t3, 3
	xvpermi.d	$xr3, $xr5, 238
	xvfcvt.s.d	$xr3, $xr3, $xr5
	xvftintrz.w.s	$xr3, $xr3
	vst	$vr3, $t1, 0
	addi.d	$t2, $t2, -4
	addi.d	$t1, $t1, 16
	addi.d	$t0, $t0, 32
...
.LBB8_30:                               # %scalar.ph
	...
	addi.d	$a6, $a6, 8
	bnez	$a5, .LBB8_30
.LBB8_31:                               # %._crit_edge140.loopexit
	ld.w	$a6, $a4, 1560
	ld.w	$a5, $a4, 8
	bnez	$a6, .LBB8_21
.LBB8_32:
	move	$a6, $zero
.LBB8_33:                               # %._crit_edge140._crit_edge
	st.w	$a6, $a3, 140
	nor	$a6, $a6, $zero
	add.d	$a5, $a5, $a6
	st.w	$a5, $a3, 136
...
.Lfunc_end8:
	...
	.p2align	5, 0x0                          # -- Begin function rc_init_pict
.LCPI9_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
.LBB9_83:                               # %vector.ph
	...
	pcalau12i	$t3, %pc_hi20(.LCPI9_0)
	xvld	$xr1, $t3, %pc_lo12(.LCPI9_0)
	xvpermi.d	$xr2, $xr2, 68
	xvinsgr2vr.w	$xr3, $zero, 0
	xvpermi.d	$xr3, $xr3, 68
	xvshuf.w	$xr1, $xr3, $xr2
	addi.d	$t3, $a6, 148
	xvrepli.b	$xr2, 0
	move	$t4, $t2
.LBB9_84:                               # %vector.body
...
# %bb.13:
	ori	$a2, $zero, 1
	bne	$a3, $a2, .LBB14_10
# %bb.14:                               # %updateComplexity.exit.thread37.thread
	ld.w	$a2, $a0, 1344
	mul.d	$a1, $a2, $a1
	movgr2fr.w	$fa0, $a1
	ffint.d.w	$fa0, $fa0
...
.LBB14_17:
	bne	$a5, $a6, .LBB14_34
.LBB14_18:                              # %updateComplexity.exit28
	ori	$a5, $zero, 2
	bne	$a4, $a5, .LBB14_25
.LBB14_19:
...
.LBB14_21:
	bne	$a4, $a5, .LBB14_38
.LBB14_22:                              # %updateComplexity.exit
	ld.w	$a4, $a0, 1344
	mul.d	$a1, $a4, $a1
	movgr2fr.w	$fa0, $a1
	ffint.d.w	$fa0, $fa0
	...
	movfr2gr.s	$a1, $fa0
	beqz	$a3, .LBB14_42
# %bb.23:                               # %updateComplexity.exit.thread37
	ori	$a2, $zero, 1
	bne	$a3, $a2, .LBB14_10
.LBB14_24:
	ld.w	$a2, $a0, 1548
	...
	st.w	$a0, $a2, 32
	ret
.LBB14_25:                              # %updateComplexity.exit28.thread
	ld.w	$a5, $a0, 1344
	mul.d	$a1, $a5, $a1
	movgr2fr.w	$fa0, $a1
	ffint.d.w	$fa0, $fa0
...
.LBB14_34:
	...
	beq	$a2, $a3, .LBB14_10
# %bb.35:
	pcalau12i	$a4, %pc_hi20(generic_RC)
	ld.d	$a4, $a4, %pc_lo12(generic_RC)
	ld.w	$a5, $a4, 12
	ld.w	$a4, $a4, 4
	sltui	$a5, $a5, 1
	addi.d	$a6, $a4, -1
...
# %bb.41:
	...
	bne	$a2, $a3, .LBB14_43
	b	.LBB14_10
.LBB14_42:                              # %updateComplexity.exit.updateComplexity.exit.thread_crit_edge
	pcalau12i	$a3, %got_pc_hi20(start_frame_no_in_this_IGOP)
	ld.d	$a3, $a3, %got_pc_lo12(start_frame_no_in_this_IGOP)
	ld.w	$a2, $a2, 0
	ld.w	$a3, $a3, 0
...
.LBB14_46:
	...
	fmadd.d	$fa0, $fa1, $fa0, $fa2
	b	.LBB14_9
.LBB14_47:                              # %updateComplexity.exit28.thread.updateComplexity.exit28.thread.thread_crit_edge
	pcalau12i	$a3, %got_pc_hi20(start_frame_no_in_this_IGOP)
	ld.d	$a3, $a3, %got_pc_lo12(start_frame_no_in_this_IGOP)
	ld.w	$a2, $a2, 0
	ld.w	$a3, $a3, 0
...
.LBB15_32:                              # %vector.ph
	...
	b	.LBB15_34
	.p2align	4, , 16
.LBB15_33:                              # %pred.store.continue163
...
# %bb.35:                               # %pred.store.continue
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB15_39
.LBB15_36:                              # %pred.store.continue159
                                        #   in Loop: Header=BB15_34 Depth=1
	xvpickve2gr.d	$a6, $xr2, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB15_40
.LBB15_37:                              # %pred.store.continue161
                                        #   in Loop: Header=BB15_34 Depth=1
...
.LBB15_38:                              # %pred.store.if
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_36
.LBB15_39:                              # %pred.store.if158
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, -4
	xvpickve2gr.d	$a6, $xr2, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_37
.LBB15_40:                              # %pred.store.if160
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, 0
	xvpickve2gr.d	$a6, $xr2, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_33
.LBB15_41:                              # %pred.store.if162
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, 4
	b	.LBB15_33
...
.LBB15_48:
	...
	jr	$t8
.LBB15_49:                              # %.lr.ph137.preheader164
	alsl.d	$a2, $a0, $s0, 2
	pcalau12i	$a3, %pc_hi20(updateRCModel.error)
	addi.d	$a3, $a3, %pc_lo12(updateRCModel.error)
	alsl.d	$a3, $a0, $a3, 3
...
.Lfunc_end15:
	.size	updateRCModel, .Lfunc_end15-updateRCModel
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function RCModelEstimator
.LCPI16_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
.LBB17_26:                              # %vector.ph
	...
	b	.LBB17_28
	.p2align	4, , 16
.LBB17_27:                              # %pred.store.continue120
...
# %bb.29:                               # %pred.store.continue
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB17_33
.LBB17_30:                              # %pred.store.continue116
                                        #   in Loop: Header=BB17_28 Depth=1
	xvpickve2gr.d	$a5, $xr2, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB17_34
.LBB17_31:                              # %pred.store.continue118
                                        #   in Loop: Header=BB17_28 Depth=1
...
.LBB17_32:                              # %pred.store.if
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_30
.LBB17_33:                              # %pred.store.if115
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, -4
	xvpickve2gr.d	$a5, $xr2, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_31
.LBB17_34:                              # %pred.store.if117
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, 0
	xvpickve2gr.d	$a5, $xr2, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_27
.LBB17_35:                              # %pred.store.if119
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, 4
	b	.LBB17_27
...
.Lfunc_end17:
	.size	updateMADModel, .Lfunc_end17-updateMADModel
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function MADModelEstimator
.LCPI18_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
# %bb.0:
	...
	fst.d	$fs6, $sp, 0                    # 8-byte Folded Spill
	move	$fp, $a0
	ld.w	$a0, $a0, 1536
	move	$s0, $a2
	fld.d	$fs1, $fp, 1400
...
.LBB28_8:
	...
	or	$a0, $a1, $a0
	st.w	$a0, $fp, 1344
	fld.d	$fs6, $sp, 0                    # 8-byte Folded Reload
