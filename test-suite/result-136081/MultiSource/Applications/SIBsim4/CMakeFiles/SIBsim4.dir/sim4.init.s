...
# %bb.57:                               # %middle.block213
	...
	beq	$a3, $a0, .LBB0_60
.LBB0_58:                               # %scalar.ph201.preheader
                                        #   in Loop: Header=BB0_40 Depth=1
	alsl.d	$a2, $a3, $a2, 3
	sub.d	$a3, $a0, $a3
	.p2align	4, , 16
.LBB0_59:                               # %scalar.ph201
                                        #   Parent Loop BB0_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a2, 0
	ld.w	$a5, $a5, 36
...
# %bb.73:                               # %middle.block
	...
	bne	$a6, $a4, .LBB4_28
	b	.LBB4_31
.LBB4_74:                               # %vector.scevcheck40
	addi.w	$t3, $a4, -2
	addi.d	$a3, $a6, -1
	addi.w	$t4, $a3, 0
	move	$t2, $zero
	bltu	$t3, $t4, .LBB4_80
# %bb.75:                               # %vector.scevcheck40
	srli.d	$t4, $a3, 32
	move	$a3, $t2
	bnez	$t4, .LBB4_55
# %bb.76:                               # %vector.ph43
