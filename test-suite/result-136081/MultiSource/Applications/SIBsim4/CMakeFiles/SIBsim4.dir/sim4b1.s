...
.LBB0_53:                               # %vector.body1028
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB0_53
# %bb.54:                               # %middle.block1032
                                        #   in Loop: Header=BB0_6 Depth=1
	beq	$a1, $s6, .LBB0_57
.LBB0_55:                               # %scalar.ph1021.preheader
                                        #   in Loop: Header=BB0_6 Depth=1
	sub.d	$a1, $s6, $a0
	addi.d	$a1, $a1, 1
	alsl.d	$a0, $a0, $t5, 2
	.p2align	4, , 16
.LBB0_56:                               # %scalar.ph1021
                                        #   Parent Loop BB0_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$s3, $a0, 0
	addi.d	$a1, $a1, -1
...
.LBB0_231:                              # %add_col_elt.exit508.i
	...
	ld.w	$a3, $s6, 36
	bnez	$a1, .LBB0_286
.LBB0_232:                              # %greedy.exit..thread575_crit_edge
                                        #   in Loop: Header=BB0_216 Depth=2
	move	$s1, $s8
	move	$s8, $s4
	ld.d	$a0, $s6, 8
...
.LBB0_244:                              #   in Loop: Header=BB0_216 Depth=2
	ld.d	$s5, $sp, 424                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 208                   # 8-byte Folded Reload
.LBB0_245:                              # %scalar.ph976.preheader
                                        #   in Loop: Header=BB0_216 Depth=2
	sub.d	$a1, $t0, $a4
	addi.d	$a1, $a1, 1
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
...
.LBB0_261:                              #   in Loop: Header=BB0_216 Depth=2
	...
	ld.d	$a7, $sp, 416                   # 8-byte Folded Reload
	ld.d	$t1, $sp, 400                   # 8-byte Folded Reload
.LBB0_262:                              # %scalar.ph963.preheader
                                        #   in Loop: Header=BB0_216 Depth=2
	sub.d	$a1, $a7, $a5
	addi.d	$a1, $a1, 1
	alsl.d	$a2, $a5, $a0, 2
...
.LBB0_318:                              #   in Loop: Header=BB0_216 Depth=2
	...
	ld.d	$a7, $sp, 208                   # 8-byte Folded Reload
	ld.d	$t3, $sp, 280                   # 8-byte Folded Reload
.LBB0_319:                              # %scalar.ph950.preheader
                                        #   in Loop: Header=BB0_216 Depth=2
	sub.d	$a4, $t4, $a1
	ld.d	$a2, $sp, 328                   # 8-byte Folded Reload
	alsl.d	$a2, $a1, $a2, 2
...
.LBB0_415:                              # %.thread579.thread
	...
	sub.w	$a2, $a0, $fp
	st.w	$a2, $s0, 16
.LBB0_416:                              # %thread-pre-split583
                                        #   in Loop: Header=BB0_6 Depth=1
	addi.w	$a0, $a2, -1
	bltz	$a0, .LBB0_424
# %bb.417:                              # %.lr.ph693.preheader
                                        #   in Loop: Header=BB0_6 Depth=1
	ld.d	$a1, $ra, 0
	slli.d	$a0, $a0, 3
	ldx.d	$a0, $a1, $a0
...
# %bb.430:                              #   in Loop: Header=BB0_429 Depth=2
	...
	sltui	$t3, $t3, 1
	bltu	$a6, $s3, .LBB0_437
# %bb.431:                              # %.lr.ph.i.i548.preheader
                                        #   in Loop: Header=BB0_429 Depth=2
	move	$t7, $zero
	move	$t5, $zero
	sub.d	$t4, $s1, $t0
	.p2align	4, , 16
.LBB0_432:                              # %.lr.ph.i.i548
                                        #   Parent Loop BB0_6 Depth=1
...
.LBB0_591:                              # %.critedge8.i
	...
	ori	$t0, $zero, 1
	b	.LBB0_209
.LBB0_592:                              # %._crit_edge702.loopexit
	ld.d	$fp, $sp, 520
	b	.LBB0_594
.LBB0_593:
	move	$fp, $zero
.LBB0_594:                              # %._crit_edge702
	ld.d	$a0, $sp, 536
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $fp
