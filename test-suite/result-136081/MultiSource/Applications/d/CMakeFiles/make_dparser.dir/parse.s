...
.LBB30_106:                             #   in Loop: Header=BB30_4 Depth=1
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free_old_nodes)
	jirl	$ra, $ra, 0
	ld.d	$s1, $s8, 264
...
# %bb.110:                              #   in Loop: Header=BB30_4 Depth=1
	...
	st.d	$a0, $sp, 8                     # 8-byte Folded Spill
	b	.LBB30_117
.LBB30_111:                             #   in Loop: Header=BB30_4 Depth=1
	ld.d	$a0, $s1, 8
	beqz	$a0, .LBB30_105
# %bb.112:                              #   in Loop: Header=BB30_4 Depth=1
	ld.d	$a0, $s1, 0
	ld.d	$fp, $a0, 24
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	b	.LBB30_149
.LBB30_113:                             #   in Loop: Header=BB30_4 Depth=1
	ld.d	$a1, $s1, 0
	move	$a0, $s8
...
.LBB30_121:                             #   in Loop: Header=BB30_117 Depth=2
	...
	ld.d	$a0, $s2, 80
	beqz	$a0, .LBB30_123
.LBB30_122:                             #   in Loop: Header=BB30_117 Depth=2
	ld.d	$a0, $s8, 384
	slli.d	$a1, $s5, 3
	slli.d	$a2, $s5, 5
	or	$a1, $a2, $a1
	...
	jirl	$ra, $ra, 0
	add.w	$s5, $a0, $s5
.LBB30_123:                             #   in Loop: Header=BB30_117 Depth=2
	blt	$s5, $fp, .LBB30_115
# %bb.124:                              # %.lr.ph.i112
                                        #   in Loop: Header=BB30_117 Depth=2
	move	$s2, $zero
...
.LBB30_126:                             # %find_ws_before.exit.i
	...
	st.d	$a1, $s3, 120
	st.d	$a0, $s3, 128
.LBB30_127:                             #   in Loop: Header=BB30_129 Depth=3
	addi.d	$a1, $sp, 440
	move	$a0, $s8
	move	$a2, $s3
	pcaddu18i	$ra, %call36(goto_PNode)
	jirl	$ra, $ra, 0
.LBB30_128:                             #   in Loop: Header=BB30_129 Depth=3
	addi.d	$s2, $s2, 1
	beq	$s2, $s5, .LBB30_115
.LBB30_129:                             #   Parent Loop BB30_4 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB30_128
# %bb.130:                              #   in Loop: Header=BB30_129 Depth=3
	move	$s3, $a0
	ld.d	$a1, $sp, 440
	addi.d	$a0, $s7, 8
	beqz	$a1, .LBB30_133
# %bb.131:                              #   in Loop: Header=BB30_129 Depth=3
	ld.d	$a2, $a0, 0
	bne	$a1, $a2, .LBB30_133
# %bb.132:                              #   in Loop: Header=BB30_129 Depth=3
	ld.d	$a1, $s3, 216
	beq	$s6, $a1, .LBB30_140
	.p2align	4, , 16
.LBB30_133:                             #   in Loop: Header=BB30_129 Depth=3
	xvld	$xr0, $a0, 0
	ld.d	$s6, $s3, 216
	xvst	$xr0, $sp, 440
	addi.d	$a2, $s3, 224
	...
	addi.w	$a1, $zero, -1
	bge	$a1, $a0, .LBB30_135
# %bb.134:                              #   in Loop: Header=BB30_129 Depth=3
	ld.d	$a1, $a3, 80
	st.w	$a0, $sp, 456
	ld.d	$a0, $a1, 0
	bnez	$a0, .LBB30_136
	b	.LBB30_125
	.p2align	4, , 16
.LBB30_135:                             #   in Loop: Header=BB30_129 Depth=3
	ld.w	$a0, $a3, 40
	ld.d	$a1, $a3, 80
	st.w	$a0, $sp, 456
	ld.d	$a0, $a1, 0
...
.LBB30_136:                             # %.lr.ph.i.i115
	...
	ld.d	$a1, $a1, 192
	bne	$a2, $a1, .LBB30_126
# %bb.137:                              #   in Loop: Header=BB30_136 Depth=4
	ld.w	$a1, $a0, 8
	beqz	$a1, .LBB30_125
# %bb.138:                              #   in Loop: Header=BB30_136 Depth=4
	ld.d	$a0, $a0, 16
	ld.d	$a0, $a0, 0
	ld.w	$a1, $a0, 72
	beqz	$a1, .LBB30_125
# %bb.139:                              #   in Loop: Header=BB30_136 Depth=4
	ld.d	$a0, $a0, 80
	ld.d	$a0, $a0, 0
	bnez	$a0, .LBB30_136
	b	.LBB30_125
.LBB30_140:                             # %._crit_edge81.i
                                        #   in Loop: Header=BB30_129 Depth=3
	ld.d	$a3, $s1, 0
	b	.LBB30_127
	.p2align	4, , 16
.LBB30_141:                             #   in Loop: Header=BB30_117 Depth=2
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free_SNode)
	jirl	$ra, $ra, 0
	b	.LBB30_116
.LBB30_142:                             # %.critedge2
	...
	beqz	$a0, .LBB30_4
# %bb.143:                              #   in Loop: Header=BB30_4 Depth=1
	ld.d	$a0, $s8, 256
	beqz	$a0, .LBB30_4
# %bb.144:                              #   in Loop: Header=BB30_4 Depth=1
	ld.d	$a1, $a0, 40
	bnez	$a1, .LBB30_4
# %bb.145:                              #   in Loop: Header=BB30_4 Depth=1
	ld.d	$a1, $a0, 8
	move	$a0, $s8
	pcaddu18i	$ra, %call36(commit_stack)
	jirl	$ra, $ra, 0
	st.d	$zero, $sp, 8                   # 8-byte Folded Spill
	b	.LBB30_4
.LBB30_146:                             #   in Loop: Header=BB30_149 Depth=2
	ld.d	$a1, $a0, 8
	st.d	$a1, $a6, 0
	ld.w	$a1, $a2, 112
	addi.w	$a1, $a1, -1
	st.w	$a1, $a2, 112
	beqz	$a1, .LBB30_180
.LBB30_147:                             #   in Loop: Header=BB30_149 Depth=2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB30_148:                             # %.critedge2.i
...
.LBB30_149:                             #   Parent Loop BB30_4 Depth=1
	...
	ld.d	$a0, $a1, 24
	bne	$a0, $fp, .LBB30_181
# %bb.150:                              #   in Loop: Header=BB30_149 Depth=2
	ld.w	$a0, $a1, 72
	bne	$a0, $s4, .LBB30_148
# %bb.151:                              #   in Loop: Header=BB30_149 Depth=2
	ld.d	$a0, $a1, 80
	ld.d	$a3, $a0, 0
	ld.d	$a4, $a3, 0
	ld.w	$a0, $a4, 8
	bne	$a0, $s5, .LBB30_155
# %bb.152:                              #   in Loop: Header=BB30_149 Depth=2
	ld.w	$a0, $a3, 8
	bne	$a0, $s4, .LBB30_148
# %bb.153:                              #   in Loop: Header=BB30_149 Depth=2
	ld.d	$a0, $a3, 16
	ld.d	$a0, $a0, 0
	ld.w	$a2, $a0, 72
	bne	$a2, $s4, .LBB30_148
# %bb.154:                              #   in Loop: Header=BB30_149 Depth=2
	ld.d	$a0, $a0, 80
	ld.d	$a3, $a0, 0
	ld.d	$a4, $a3, 0
	ld.w	$a0, $a4, 8
	.p2align	4, , 16
.LBB30_155:                             #   in Loop: Header=BB30_149 Depth=2
	andi	$a0, $a0, 16
	beqz	$a0, .LBB30_148
# %bb.156:                              # %binary_op_ZNode.exit.i
                                        #   in Loop: Header=BB30_149 Depth=2
	ld.d	$a5, $s1, 8
	beqz	$a5, .LBB30_148
# %bb.157:                              # %.lr.ph.i105
	...
	b	.LBB30_159
	.p2align	4, , 16
.LBB30_158:                             # %binary_op_ZNode.exit71.thread.i
                                        #   in Loop: Header=BB30_159 Depth=3
	addi.d	$a6, $a0, 8
	ld.d	$a0, $a0, 8
	beqz	$a0, .LBB30_148
.LBB30_159:                             #   Parent Loop BB30_4 Depth=1
	...
	ld.d	$a7, $a2, 24
	bne	$a7, $fp, .LBB30_148
# %bb.160:                              #   in Loop: Header=BB30_159 Depth=3
	ld.w	$a7, $a2, 72
	bne	$a7, $s4, .LBB30_158
# %bb.161:                              #   in Loop: Header=BB30_159 Depth=3
	ld.d	$a7, $a2, 80
	ld.d	$t0, $a7, 0
	ld.d	$a7, $t0, 0
	ld.w	$t1, $a7, 8
	bne	$t1, $s5, .LBB30_165
# %bb.162:                              #   in Loop: Header=BB30_159 Depth=3
	ld.w	$a7, $t0, 8
	bne	$a7, $s4, .LBB30_158
# %bb.163:                              #   in Loop: Header=BB30_159 Depth=3
	ld.d	$a7, $t0, 16
	ld.d	$a7, $a7, 0
	ld.w	$t0, $a7, 72
	bne	$t0, $s4, .LBB30_158
# %bb.164:                              #   in Loop: Header=BB30_159 Depth=3
	ld.d	$a7, $a7, 80
	ld.d	$t0, $a7, 0
	ld.d	$a7, $t0, 0
	ld.w	$t1, $a7, 8
	.p2align	4, , 16
.LBB30_165:                             #   in Loop: Header=BB30_159 Depth=3
	andi	$t1, $t1, 16
	beqz	$t1, .LBB30_158
# %bb.166:                              # %binary_op_ZNode.exit71.i
                                        #   in Loop: Header=BB30_159 Depth=3
	ld.w	$t3, $a3, 8
	ld.w	$t1, $t0, 8
	bne	$t3, $t1, .LBB30_158
# %bb.167:                              # %.preheader17.i.i
                                        #   in Loop: Header=BB30_159 Depth=3
	beqz	$t3, .LBB30_173
# %bb.168:                              # %.preheader.lr.ph.split.i.i
                                        #   in Loop: Header=BB30_159 Depth=3
	ld.d	$t1, $a3, 16
	ld.d	$t0, $t0, 16
	move	$t2, $zero
	bstrpick.d	$t3, $t3, 31, 0
.LBB30_169:                             # %.preheader.i.i106
                                        #   Parent Loop BB30_4 Depth=1
                                        #     Parent Loop BB30_149 Depth=2
	...
	move	$t6, $t3
	.p2align	4, , 16
.LBB30_170:                             #   Parent Loop BB30_4 Depth=1
                                        #     Parent Loop BB30_149 Depth=2
                                        #       Parent Loop BB30_159 Depth=3
	...
	ld.d	$t7, $t5, 0
	beq	$t4, $t7, .LBB30_172
# %bb.171:                              #   in Loop: Header=BB30_170 Depth=5
	addi.d	$t6, $t6, -1
	addi.d	$t5, $t5, 8
	bnez	$t6, .LBB30_170
	b	.LBB30_158
.LBB30_172:                             #   in Loop: Header=BB30_169 Depth=4
	addi.d	$t2, $t2, 1
	bne	$t2, $t3, .LBB30_169
.LBB30_173:                             # %VecSNode_equal.exit.i
                                        #   in Loop: Header=BB30_159 Depth=3
	ld.d	$t2, $s8, 144
	ld.d	$t0, $a1, 0
	ld.d	$t1, $a2, 0
	...
	mul.d	$t4, $t4, $t5
	beq	$t4, $t3, .LBB30_175
# %bb.174:                              #   in Loop: Header=BB30_159 Depth=3
	ld.w	$t1, $t1, 112
	sub.d	$t0, $t0, $t2
	srai.d	$t0, $t0, 3
	...
	mul.d	$t0, $t0, $t2
	bne	$t0, $t1, .LBB30_158
.LBB30_175:                             #   in Loop: Header=BB30_159 Depth=3
	ld.w	$t0, $a4, 12
	ld.w	$a7, $a7, 12
	blt	$a7, $t0, .LBB30_146
# %bb.176:                              #   in Loop: Header=BB30_159 Depth=3
	bge	$t0, $a7, .LBB30_158
# %bb.177:                              #   in Loop: Header=BB30_149 Depth=2
	st.d	$a5, $s2, 0
	ld.w	$a0, $a1, 112
	addi.w	$a0, $a0, -1
	st.w	$a0, $a1, 112
	bnez	$a0, .LBB30_179
# %bb.178:                              #   in Loop: Header=BB30_149 Depth=2
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free_SNode)
	jirl	$ra, $ra, 0
.LBB30_179:                             #   in Loop: Header=BB30_149 Depth=2
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$s1, $s2, 0
	b	.LBB30_148
.LBB30_180:                             #   in Loop: Header=BB30_149 Depth=2
	move	$s2, $a0
	move	$a0, $s8
	move	$a1, $a2
	pcaddu18i	$ra, %call36(free_SNode)
	...
	move	$a0, $s2
	b	.LBB30_147
.LBB30_181:                             # %cmp_stacks.exit.loopexit
                                        #   in Loop: Header=BB30_4 Depth=1
	ori	$fp, $zero, 1
...
.LBB31_53:                              # %vector.body103
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB31_53
# %bb.54:                               # %middle.block109
                                        #   in Loop: Header=BB31_44 Depth=1
	beq	$a3, $a4, .LBB31_57
.LBB31_55:                              # %scalar.ph98.preheader
                                        #   in Loop: Header=BB31_44 Depth=1
	alsl.d	$a1, $a2, $a1, 3
	addi.d	$a1, $a1, 8
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB31_56:                              # %scalar.ph98
                                        #   Parent Loop BB31_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a1, 0
	st.d	$a2, $a1, -8
...
# %bb.22:                               # %middle.block96
	...
	beq	$t3, $t2, .LBB40_25
.LBB40_23:                              # %scalar.ph84.preheader
                                        #   in Loop: Header=BB40_14 Depth=1
	sub.d	$t2, $t2, $t3
	alsl.d	$t1, $t3, $t1, 3
	.p2align	4, , 16
.LBB40_24:                              # %scalar.ph84
                                        #   Parent Loop BB40_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t1, 0
	ld.w	$t3, $t3, 56
