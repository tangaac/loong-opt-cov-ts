...
# %bb.59:                               # %middle.block299
	...
	beq	$a4, $a5, .LBB13_62
.LBB13_60:                              # %scalar.ph287.preheader
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a3, $s3, $a3
	.p2align	4, , 16
.LBB13_61:                              # %scalar.ph287
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	slli.d	$a4, $a4, 1
...
.LBB13_75:                              # %vector.body281
	...
	addi.d	$a1, $a1, 32
	bnez	$a5, .LBB13_75
# %bb.76:                               # %middle.block284
	beq	$a3, $a4, .LBB13_79
.LBB13_77:                              # %scalar.ph276.preheader
	sub.d	$a1, $s3, $a2
	alsl.d	$a2, $a2, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_78:                              # %scalar.ph276
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
...
.LBB13_97:                              # %vector.body307
	...
	addi.d	$a1, $a1, 32
	bnez	$a5, .LBB13_97
# %bb.98:                               # %middle.block311
	beq	$a3, $a4, .LBB13_101
.LBB13_99:                              # %scalar.ph302.preheader
	sub.d	$a1, $s3, $a2
	alsl.d	$a2, $a2, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_100:                             # %scalar.ph302
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
