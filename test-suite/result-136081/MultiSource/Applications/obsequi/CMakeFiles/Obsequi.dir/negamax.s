...
.LBB0_21:                               #   Parent Loop BB0_19 Depth=1
	...
	ld.w	$a1, $s0, %pc_lo12(g_empty_squares)
	srli.d	$a2, $s1, 32
	ld.wu	$a3, $s2, 8
	...
	ld.d	$a0, $s2, 0
	addi.d	$a1, $a1, -2
	st.w	$a1, $s0, %pc_lo12(g_empty_squares)
	move	$a1, $a3
...
.LBB1_29:                               # %.lr.ph
	...
	ld.w	$a1, $s4, %pc_lo12(g_empty_squares)
	srli.d	$a2, $s7, 32
	ld.wu	$s7, $s1, 8
	...
	ld.d	$a0, $s1, 0
	addi.d	$a1, $a1, -2
	st.w	$a1, $s4, %pc_lo12(g_empty_squares)
