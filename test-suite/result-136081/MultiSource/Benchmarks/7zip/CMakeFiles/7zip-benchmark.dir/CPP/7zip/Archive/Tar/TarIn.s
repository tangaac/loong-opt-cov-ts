...
# %bb.49:                               # %iter.check362
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_174
# %bb.50:                               # %vector.main.loop.iter.check364
                                        #   in Loop: Header=BB0_2 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_167
...
# %bb.80:                               # %iter.check395
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_186
# %bb.81:                               # %vector.main.loop.iter.check397
                                        #   in Loop: Header=BB0_2 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_179
...
# %bb.87:                               # %iter.check428
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_199
# %bb.88:                               # %vector.main.loop.iter.check430
                                        #   in Loop: Header=BB0_2 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_192
...
# %bb.143:                              #   in Loop: Header=BB0_2 Depth=1
	st.d	$zero, $s7, 16
.LBB0_144:                              # %vector.body457.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a0, $zero
...
.LBB0_168:                              # %vector.body368
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_168
# %bb.169:                              # %middle.block373
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_176
# %bb.170:                              # %vec.epilog.iter.check378
                                        #   in Loop: Header=BB0_2 Depth=1
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_174
.LBB0_171:                              # %vec.epilog.ph377
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_172:                              # %vec.epilog.vector.body383
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_172
# %bb.173:                              # %vec.epilog.middle.block387
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_176
.LBB0_174:                              # %vec.epilog.scalar.ph376.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s5, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_175:                              # %vec.epilog.scalar.ph376
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB0_180:                              # %vector.body401
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_180
# %bb.181:                              # %middle.block406
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_188
# %bb.182:                              # %vec.epilog.iter.check411
                                        #   in Loop: Header=BB0_2 Depth=1
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_186
.LBB0_183:                              # %vec.epilog.ph410
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_184:                              # %vec.epilog.vector.body416
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_184
# %bb.185:                              # %vec.epilog.middle.block420
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_188
.LBB0_186:                              # %vec.epilog.scalar.ph409.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s5, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_187:                              # %vec.epilog.scalar.ph409
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
# %bb.194:                              # %middle.block439
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_201
# %bb.195:                              # %vec.epilog.iter.check444
                                        #   in Loop: Header=BB0_2 Depth=1
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_199
.LBB0_196:                              # %vec.epilog.ph443
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_197:                              # %vec.epilog.vector.body449
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_197
# %bb.198:                              # %vec.epilog.middle.block453
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_201
.LBB0_199:                              # %vec.epilog.scalar.ph442.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s5, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_200:                              # %vec.epilog.scalar.ph442
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
# %bb.212:                              # %.preheader.i.i115
	ld.d	$a0, $s6, 0
	blt	$a1, $a2, .LBB0_220
# %bb.213:                              # %iter.check471
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_228
# %bb.214:                              # %iter.check471
	sub.d	$a3, $s1, $a0
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_228
# %bb.215:                              # %vector.main.loop.iter.check473
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_221
# %bb.216:
	move	$a2, $zero
...
.LBB0_220:                              # %._crit_edge.i.i117
	bnez	$a0, .LBB0_230
	b	.LBB0_231
.LBB0_221:                              # %vector.ph474
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a3, $s1, 32
	addi.d	$a4, $a0, 32
	move	$a5, $a2
.LBB0_222:                              # %vector.body477
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_222
# %bb.223:                              # %middle.block482
	beq	$a2, $a1, .LBB0_230
# %bb.224:                              # %vec.epilog.iter.check487
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_228
.LBB0_225:                              # %vec.epilog.ph486
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_226:                              # %vec.epilog.vector.body492
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_226
# %bb.227:                              # %vec.epilog.middle.block496
	beq	$a2, $a1, .LBB0_230
.LBB0_228:                              # %vec.epilog.scalar.ph485.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_229:                              # %vec.epilog.scalar.ph485
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.246:                              # %.preheader.i.i131
	...
	ld.d	$a0, $a0, 0
	blt	$a1, $a2, .LBB0_251
# %bb.247:                              # %iter.check505
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_259
# %bb.248:                              # %iter.check505
	sub.d	$a3, $s1, $a0
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_259
# %bb.249:                              # %vector.main.loop.iter.check507
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_252
# %bb.250:
	move	$a2, $zero
...
.LBB0_251:                              # %._crit_edge.i.i133
	bnez	$a0, .LBB0_261
	b	.LBB0_262
.LBB0_252:                              # %vector.ph508
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a3, $s1, 32
	addi.d	$a4, $a0, 32
	move	$a5, $a2
.LBB0_253:                              # %vector.body511
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a4, -32
	xvld	$xr1, $a4, 0
	xvst	$xr0, $a3, -32
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_253
# %bb.254:                              # %middle.block516
	beq	$a2, $a1, .LBB0_261
# %bb.255:                              # %vec.epilog.iter.check521
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_259
.LBB0_256:                              # %vec.epilog.ph520
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_257:                              # %vec.epilog.vector.body526
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_257
# %bb.258:                              # %vec.epilog.middle.block530
	beq	$a2, $a1, .LBB0_261
.LBB0_259:                              # %vec.epilog.scalar.ph519.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_260:                              # %vec.epilog.scalar.ph519
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
