...
# %bb.44:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_45:                               # %_ZN8NArchive4NTarL17MakeOctalString12EPcy.exit101
...
# %bb.48:
	...
	st.d	$a0, $sp, 257
	blt	$a2, $a1, .LBB2_62
# %bb.49:                               # %.preheader.i109.preheader
	ld.d	$a0, $s1, 64
	move	$a1, $zero
	addi.d	$a2, $sp, 0
	.p2align	4, , 16
.LBB2_50:                               # %.preheader.i109
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a3, $a0, $a1
	add.d	$a4, $a2, $a1
	st.b	$a3, $a4, 265
...
# %bb.39:                               # %iter.check76
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB4_50
# %bb.40:                               # %vector.main.loop.iter.check78
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB4_43
# %bb.41:
	move	$a2, $zero
...
.LBB4_44:                               # %vector.body82
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_44
# %bb.45:                               # %middle.block87
	beq	$a2, $a1, .LBB4_52
# %bb.46:                               # %vec.epilog.iter.check92
	andi	$a3, $a1, 48
	beqz	$a3, .LBB4_50
.LBB4_47:                               # %vec.epilog.ph91
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_48:                               # %vec.epilog.vector.body97
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_48
# %bb.49:                               # %vec.epilog.middle.block101
	beq	$a2, $a1, .LBB4_52
.LBB4_50:                               # %vec.epilog.scalar.ph90.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
.LBB4_51:                               # %vec.epilog.scalar.ph90
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB7_34:                               # %vector.body84
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB7_34
# %bb.35:                               # %middle.block89
	beq	$a2, $a1, .LBB7_42
# %bb.36:                               # %vec.epilog.iter.check94
	andi	$a3, $a1, 48
	beqz	$a3, .LBB7_40
.LBB7_37:                               # %vec.epilog.ph93
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_38:                               # %vec.epilog.vector.body99
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_38
# %bb.39:                               # %vec.epilog.middle.block103
	beq	$a2, $a1, .LBB7_42
.LBB7_40:                               # %vec.epilog.scalar.ph92.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB7_41:                               # %vec.epilog.scalar.ph92
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB7_56:                               # %vector.body117
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB7_56
# %bb.57:                               # %middle.block122
	beq	$a2, $a1, .LBB7_64
# %bb.58:                               # %vec.epilog.iter.check127
	andi	$a3, $a1, 48
	beqz	$a3, .LBB7_62
.LBB7_59:                               # %vec.epilog.ph126
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_60:                               # %vec.epilog.vector.body132
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_60
# %bb.61:                               # %vec.epilog.middle.block136
	beq	$a2, $a1, .LBB7_64
.LBB7_62:                               # %vec.epilog.scalar.ph125.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB7_63:                               # %vec.epilog.scalar.ph125
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB7_78:                               # %vector.body150
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB7_78
# %bb.79:                               # %middle.block155
	beq	$a2, $a1, .LBB7_86
# %bb.80:                               # %vec.epilog.iter.check160
	andi	$a3, $a1, 48
	beqz	$a3, .LBB7_84
.LBB7_81:                               # %vec.epilog.ph159
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_82:                               # %vec.epilog.vector.body165
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_82
# %bb.83:                               # %vec.epilog.middle.block169
	beq	$a2, $a1, .LBB7_86
.LBB7_84:                               # %vec.epilog.scalar.ph158.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB7_85:                               # %vec.epilog.scalar.ph158
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
