...
# %bb.46:                               # %.lr.ph31.preheader.i
                                        #   in Loop: Header=BB29_41 Depth=2
	bstrpick.d	$s6, $s5, 30, 0
	bgeu	$s6, $t4, .LBB29_48
# %bb.47:                               #   in Loop: Header=BB29_41 Depth=2
	move	$s5, $s6
	b	.LBB29_51
	.p2align	4, , 16
.LBB29_48:                              # %vector.ph607
                                        #   in Loop: Header=BB29_41 Depth=2
	bstrpick.d	$s7, $s5, 30, 4
	slli.d	$s7, $s7, 4
	andi	$s5, $s5, 15
	add.d	$s8, $a7, $s6
	move	$ra, $s7
	.p2align	4, , 16
.LBB29_49:                              # %vector.body610
                                        #   Parent Loop BB29_40 Depth=1
                                        #     Parent Loop BB29_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $s8, 0
...
.LBB29_51:                              # %.lr.ph31.i
	...
	stx.b	$s7, $s6, $t0
	bltu	$a4, $s6, .LBB29_51
.LBB29_52:                              # %_ZN9NCompress12CMtf8Encoder11FindAndMoveEh.exit
                                        #   in Loop: Header=BB29_41 Depth=2
	st.b	$s1, $sp, 1576
	bne	$s0, $a4, .LBB29_54
...
# %bb.56:                               # %._crit_edge
	...
	move	$s0, $s1
	bltu	$t8, $t5, .LBB29_58
.LBB29_57:                              #   in Loop: Header=BB29_40 Depth=1
	addi.w	$s0, $s1, 1
...
.LBB29_59:                              #   in Loop: Header=BB29_40 Depth=1
	...
	bgeu	$t8, $t5, .LBB29_57
	b	.LBB29_58
.LBB29_60:                              # %.preheader405
	beqz	$t8, .LBB29_63
# %bb.61:                               # %.lr.ph431.preheader
	ori	$a1, $zero, 1
	move	$a2, $a0
	.p2align	4, , 16
.LBB29_62:                              # %.lr.ph431
...
.LBB29_89:                              #   in Loop: Header=BB29_79 Depth=2
	...
	blt	$t6, $s8, .LBB29_88
	.p2align	4, , 16
.LBB29_90:                              # %vector.main.loop.iter.check722
                                        #   in Loop: Header=BB29_79 Depth=2
	vreplgr2vr.d	$vr0, $a4
	vreplgr2vr.d	$vr1, $a6
...
.LBB29_93:                              # %vector.body728
	...
	addi.d	$t1, $t1, 16
	bnez	$t2, .LBB29_93
# %bb.94:                               # %middle.block733
                                        #   in Loop: Header=BB29_79 Depth=2
	beq	$ra, $t8, .LBB29_78
# %bb.95:                               # %vec.epilog.iter.check738
                                        #   in Loop: Header=BB29_79 Depth=2
	move	$t1, $ra
	move	$t2, $ra
	ld.d	$t5, $sp, 192                   # 8-byte Folded Reload
	beqz	$t5, .LBB29_99
.LBB29_96:                              # %vec.epilog.ph737
                                        #   in Loop: Header=BB29_79 Depth=2
	...
	vor.v	$vr3, $vr4, $vr3
	.p2align	4, , 16
.LBB29_97:                              # %vec.epilog.vector.body747
                                        #   Parent Loop BB29_67 Depth=1
                                        #     Parent Loop BB29_79 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vslt.d	$vr4, $vr3, $vr0
	...
	vaddi.du	$vr2, $vr2, 4
	bne	$t3, $t1, .LBB29_97
# %bb.98:                               # %vec.epilog.middle.block755
                                        #   in Loop: Header=BB29_79 Depth=2
	move	$t2, $t3
	beq	$t3, $t8, .LBB29_78
	.p2align	4, , 16
.LBB29_99:                              # %vec.epilog.scalar.ph736
                                        #   Parent Loop BB29_67 Depth=1
                                        #     Parent Loop BB29_79 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	slt	$a7, $t2, $a4
...
.LBB29_110:                             #   Parent Loop BB29_67 Depth=1
	...
	alsl.d	$t2, $a6, $t2, 1
	add.d	$t2, $s7, $t2
	bgeu	$a3, $s0, .LBB29_112
# %bb.111:                              #   in Loop: Header=BB29_110 Depth=4
	move	$t4, $zero
	move	$t3, $zero
	b	.LBB29_115
	.p2align	4, , 16
.LBB29_112:                             # %vector.body705.preheader
...
# %bb.114:                              # %middle.block712
	...
	addi.d	$t7, $sp, 344
	beq	$a4, $a7, .LBB29_117
.LBB29_115:                             # %scalar.ph700.preheader
                                        #   in Loop: Header=BB29_110 Depth=4
	alsl.d	$t5, $t4, $t7, 2
	.p2align	4, , 16
.LBB29_116:                             # %scalar.ph700
                                        #   Parent Loop BB29_67 Depth=1
                                        #     Parent Loop BB29_102 Depth=2
                                        #       Parent Loop BB29_103 Depth=3
                                        #         Parent Loop BB29_110 Depth=4
...
.LBB29_126:                             # %vector.ph675
	...
	b	.LBB29_128
	.p2align	4, , 16
.LBB29_127:                             # %pred.store.continue695
                                        #   in Loop: Header=BB29_128 Depth=4
	addi.d	$a0, $a0, -8
	addi.d	$a1, $a1, 32
	beqz	$a0, .LBB29_144
.LBB29_128:                             # %vector.body678
                                        #   Parent Loop BB29_67 Depth=1
                                        #     Parent Loop BB29_102 Depth=2
...
# %bb.129:                              # %pred.store.if
	...
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_133
.LBB29_130:                             # %pred.store.continue683
                                        #   in Loop: Header=BB29_128 Depth=4
	vpickve2gr.w	$a2, $vr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_134
.LBB29_131:                             # %pred.store.if684
                                        #   in Loop: Header=BB29_128 Depth=4
	st.w	$s4, $a1, 8
...
.LBB29_132:                             # %pred.store.continue
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_130
.LBB29_133:                             # %pred.store.if682
                                        #   in Loop: Header=BB29_128 Depth=4
	st.w	$s4, $a1, 4
	vpickve2gr.w	$a2, $vr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_131
.LBB29_134:                             # %pred.store.continue685
                                        #   in Loop: Header=BB29_128 Depth=4
	vpickve2gr.w	$a2, $vr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_136
.LBB29_135:                             # %pred.store.if686
                                        #   in Loop: Header=BB29_128 Depth=4
	st.w	$s4, $a1, 12
.LBB29_136:                             # %pred.store.continue687
                                        #   in Loop: Header=BB29_128 Depth=4
	vld	$vr0, $a1, 16
	vseqi.w	$vr0, $vr0, 0
	vpickve2gr.w	$a2, $vr0, 0
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_140
# %bb.137:                              # %pred.store.if688
                                        #   in Loop: Header=BB29_128 Depth=4
	st.w	$s4, $a1, 16
	vpickve2gr.w	$a2, $vr0, 1
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_141
.LBB29_138:                             # %pred.store.continue691
                                        #   in Loop: Header=BB29_128 Depth=4
	vpickve2gr.w	$a2, $vr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_142
.LBB29_139:                             # %pred.store.if692
                                        #   in Loop: Header=BB29_128 Depth=4
	st.w	$s4, $a1, 24
	vpickve2gr.w	$a2, $vr0, 3
	andi	$a2, $a2, 1
	...
	b	.LBB29_143
	.p2align	4, , 16
.LBB29_140:                             # %pred.store.continue689
                                        #   in Loop: Header=BB29_128 Depth=4
	vpickve2gr.w	$a2, $vr0, 1
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_138
.LBB29_141:                             # %pred.store.if690
                                        #   in Loop: Header=BB29_128 Depth=4
	st.w	$s4, $a1, 20
	vpickve2gr.w	$a2, $vr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_139
.LBB29_142:                             # %pred.store.continue693
                                        #   in Loop: Header=BB29_128 Depth=4
	vpickve2gr.w	$a2, $vr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_127
.LBB29_143:                             # %pred.store.if694
                                        #   in Loop: Header=BB29_128 Depth=4
	st.w	$s4, $a1, 28
	b	.LBB29_127
	.p2align	4, , 16
.LBB29_144:                             # %middle.block697
                                        #   in Loop: Header=BB29_124 Depth=3
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	move	$a1, $a0
	beq	$a0, $a3, .LBB29_123
.LBB29_145:                             # %scalar.ph673.preheader
                                        #   in Loop: Header=BB29_124 Depth=3
	slli.d	$a0, $a1, 2
	sub.d	$a1, $a3, $a1
	b	.LBB29_147
...
# %bb.150:                              #   in Loop: Header=BB29_67 Depth=1
	...
	b	.LBB29_160
	.p2align	4, , 16
.LBB29_151:                             # %vector.main.loop.iter.check648
                                        #   in Loop: Header=BB29_67 Depth=1
	addi.d	$t7, $sp, 544
	ld.d	$s3, $sp, 136                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 120                   # 8-byte Folded Reload
...
.LBB29_154:                             # %vector.body652
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB29_154
# %bb.155:                              # %middle.block655
                                        #   in Loop: Header=BB29_67 Depth=1
	ld.d	$t8, $sp, 256                   # 8-byte Folded Reload
	addi.d	$a3, $sp, 344
	beq	$a0, $s1, .LBB29_161
# %bb.156:                              # %vec.epilog.iter.check660
                                        #   in Loop: Header=BB29_67 Depth=1
	andi	$a1, $s1, 24
	beqz	$a1, .LBB29_160
.LBB29_157:                             # %vec.epilog.ph659
                                        #   in Loop: Header=BB29_67 Depth=1
	move	$a2, $a0
	...
	add.d	$a2, $a3, $a2
	.p2align	4, , 16
.LBB29_158:                             # %vec.epilog.vector.body665
                                        #   Parent Loop BB29_67 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB29_158
# %bb.159:                              # %vec.epilog.middle.block670
                                        #   in Loop: Header=BB29_67 Depth=1
	addi.d	$a3, $sp, 344
	beq	$a0, $s1, .LBB29_161
	.p2align	4, , 16
.LBB29_160:                             # %vec.epilog.scalar.ph658
                                        #   Parent Loop BB29_67 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.b	$a0, $a0, $a3
	addi.d	$a0, $a0, 1
...
# %bb.200:                              #   in Loop: Header=BB29_199 Depth=5
	...
	b	.LBB29_198
	.p2align	4, , 16
.LBB29_201:                             # %.preheader586.preheader
                                        #   in Loop: Header=BB29_192 Depth=4
	ori	$a7, $zero, 1
	ori	$t0, $zero, 1
	b	.LBB29_203
