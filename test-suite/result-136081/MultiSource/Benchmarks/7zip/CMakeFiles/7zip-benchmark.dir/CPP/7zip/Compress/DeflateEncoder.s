...
# %bb.2:                                # %middle.block
	...
	vilvl.b	$vr11, $vr2, $vr10
	vilvh.h	$vr12, $vr2, $vr11
	vmadd.w	$vr5, $vr9, $vr12
	vldx	$vr9, $a0, $a7
	ori	$a6, $zero, 3472
	vilvh.b	$vr10, $vr2, $vr10
	vilvl.h	$vr12, $vr2, $vr10
	...
	vmadd.w	$vr6, $vr9, $vr10
	vilvl.b	$vr9, $vr2, $vr12
	vilvh.h	$vr10, $vr2, $vr9
	vmul.w	$vr10, $vr11, $vr10
	vldx	$vr11, $a0, $a5
	vilvh.h	$vr4, $vr2, $vr4
	ori	$a5, $zero, 3348
	ori	$a6, $zero, 3284
	vmadd.w	$vr10, $vr11, $vr4
	vldx	$vr4, $a0, $a6
	ld.w	$a6, $a1, 24
	vldx	$vr11, $a0, $a5
	vilvl.h	$vr9, $vr2, $vr9
	...
	vmadd.w	$vr4, $vr3, $vr9
	vldx	$vr3, $a0, $a5
	vilvh.b	$vr9, $vr2, $vr12
	vilvh.h	$vr12, $vr2, $vr9
