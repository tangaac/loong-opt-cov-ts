...
.LBB12_361:                             #   in Loop: Header=BB12_149 Depth=1
	ld.d	$s2, $sp, 208                   # 8-byte Folded Reload
	b	.LBB12_365
.LBB12_362:                             #   in Loop: Header=BB12_149 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	beqz	$a0, .LBB12_374
# %bb.363:                              #   in Loop: Header=BB12_149 Depth=1
.Ltmp440:
...
.LBB12_364:                             #   in Loop: Header=BB12_149 Depth=1
	move	$s3, $a0
.LBB12_365:                             #   in Loop: Header=BB12_149 Depth=1
	ld.d	$a0, $s8, 0
	ld.d	$a1, $a0, 16
.Ltmp449:
	move	$a0, $s8
	jirl	$ra, $a1, 0
.Ltmp450:
.LBB12_366:                             # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit324.i.i
                                        #   in Loop: Header=BB12_149 Depth=1
...
.Ltmp452:
	jirl	$ra, $a1, 0
.Ltmp453:
.LBB12_367:                             # %_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit.i.i
                                        #   in Loop: Header=BB12_149 Depth=1
	addi.d	$a0, $sp, 760
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB12_368:                             #   in Loop: Header=BB12_149 Depth=1
	ld.d	$a0, $sp, 800
	beqz	$a0, .LBB12_370
# %bb.369:                              #   in Loop: Header=BB12_149 Depth=1
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp455:
	jirl	$ra, $a1, 0
.Ltmp456:
.LBB12_370:                             # %_ZL8CompressP7CCodecsRKN14NUpdateArchive10CActionSetEP10IInArchiveRK22CCompressionMethodModeR12CArchivePathRK13CObjectVectorI8CArcItemEbbbRK9CDirItemsbRK11CStringBaseIwERK13CRecordVectorIyER10CTempFilesR16CUpdateErrorInfoP17IUpdateCallbackUI.exit.i
                                        #   in Loop: Header=BB12_149 Depth=1
	bnez	$s3, .LBB12_409
# %bb.371:                              #   in Loop: Header=BB12_149 Depth=1
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 136
.Ltmp458:
...
# %bb.372:                              # %.noexc390
	...
	move	$s3, $a0
	bnez	$a0, .LBB12_409
# %bb.373:                              #   in Loop: Header=BB12_149 Depth=1
	ld.w	$a0, $s0, 52
	addi.d	$s1, $s1, 1
	blt	$s1, $a0, .LBB12_149
	b	.LBB12_375
.LBB12_374:                             #   in Loop: Header=BB12_149 Depth=1
	move	$s3, $zero
	b	.LBB12_365
.LBB12_375:                             # %.loopexit
...
.Ltmp174:
	...
	jirl	$ra, $ra, 0
.Ltmp175:
# %bb.392:                              # %_ZN13CRecordVectorIiE3AddEi.exit
	ld.w	$a0, $sp, 692
	ld.d	$a1, $sp, 696
	slli.d	$a0, $a0, 2
	stx.w	$s1, $a1, $a0
...
# %bb.406:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_407:                             # %_ZN11CStringBaseIwED2Ev.exit392
	beqz	$s0, .LBB12_409
.LBB12_408:
	move	$s3, $zero
.LBB12_409:                             # %_ZL19UpdateWithItemListsP7CCodecsR14CUpdateOptionsP10IInArchiveRK13CObjectVectorI8CArcItemER9CDirItemsR10CTempFilesR16CUpdateErrorInfoP18IUpdateCallbackUI2.exit.thread
...
.Ltmp491:
	...
	jirl	$ra, $ra, 0
.Ltmp492:
# %bb.410:                              # %_ZN13CObjectVectorI8CArcItemED2Ev.exit
	addi.d	$a0, $sp, 376
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB12_411:                             # %.thread410
...
.Ltmp497:
	...
	jirl	$ra, $ra, 0
.Ltmp498:
# %bb.413:                              # %_ZN11CStringBaseIwED2Ev.exit393
	addi.d	$a0, $sp, 408
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB12_414:
...
.Ltmp500:
	...
	jirl	$ra, $ra, 0
.Ltmp501:
# %bb.415:                              # %_ZN13CObjectVectorI8CDirItemED2Ev.exit.i
	addi.d	$fp, $sp, 472
	addi.d	$s0, $sp, 504
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
...
# %bb.418:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_419:                             # %_ZN11CStringBaseIwED2Ev.exit395
	addi.d	$a0, $sp, 584
