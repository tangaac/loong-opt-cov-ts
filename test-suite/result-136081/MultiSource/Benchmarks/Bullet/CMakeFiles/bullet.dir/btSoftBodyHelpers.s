...
.Lttbase7:
	...
	.p2align	5, 0x0                          # -- Begin function _ZN17btSoftBodyHelpers17CreateFromTriMeshER19btSoftBodyWorldInfoPKfPKii
.LCPI18_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
	.dword	0                               # 0x0
...
.Ltmp144:
	...
	jirl	$ra, $ra, 0
.Ltmp145:
# %bb.19:                               # %_ZN17btCollisionObjectnwEm.exit
.Ltmp146:
...
.Ltmp155:
	...
	jirl	$ra, $ra, 0
.Ltmp156:
.LBB18_28:                              #   in Loop: Header=BB18_22 Depth=1
.Ltmp158:
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	move	$a1, $s0
	move	$a2, $s2
	...
	jirl	$ra, $ra, 0
.Ltmp159:
# %bb.29:                               #   in Loop: Header=BB18_22 Depth=1
	addi.w	$s8, $s8, 3
	addi.d	$s6, $s6, 12
	ld.d	$s4, $sp, 8                     # 8-byte Folded Reload
	move	$s7, $s5
	blt	$s8, $s4, .LBB18_22
.LBB18_30:                              # %._crit_edge162
.Ltmp161:
...
.LBB18_38:
.Ltmp157:
.LBB18_39:                              # %_ZN17btCollisionObjectdlEPv.exit
	move	$s0, $a0
	ld.d	$a0, $sp, 0                     # 8-byte Folded Reload
	beqz	$a0, .LBB18_41
.LBB18_40:                              # %_ZN17btCollisionObjectdlEPv.exit.thread140
.Ltmp164:
	ld.d	$a0, $sp, 0                     # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp165:
.LBB18_41:                              # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit85
.Ltmp169:
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp170:
# %bb.42:                               # %_ZN20btAlignedObjectArrayIbED2Ev.exit89
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB18_43:
