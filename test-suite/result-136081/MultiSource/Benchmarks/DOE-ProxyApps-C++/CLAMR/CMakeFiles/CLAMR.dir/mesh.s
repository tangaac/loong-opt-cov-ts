...
.Lfunc_end15:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst32,"aM",@progbits,32
	.p2align	5, 0x0                          # -- Begin function _ZN4Mesh20calc_neighbors_localEv
.LCPI16_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
	.dword	0                               # 0x0
	.dword	0                               # 0x0
	.text
	.globl	_ZN4Mesh20calc_neighbors_localEv
	.p2align	5
...
# %bb.27:
	...
	move	$t0, $a3
	move	$t1, $a1
.LBB16_28:                              # %vec.epilog.scalar.ph635.preheader
	addi.w	$t4, $a7, 1
	ori	$t5, $zero, 2
	.p2align	4, , 16
.LBB16_29:                              # %vec.epilog.scalar.ph635
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a7, $a7, 2
	ldx.w	$t6, $a4, $a7
	ldx.w	$t7, $a5, $a7
...
# %bb.129:                              # %vector.scevcheck
	...
	move	$t3, $a7
	bnez	$t4, .LBB16_28
# %bb.130:                              # %vector.main.loop.iter.check603
	ori	$a7, $zero, 16
...
.LBB16_140:                             # %vector.ph604
	...
	xvori.b	$xr2, $xr0, 0
	.p2align	4, , 16
.LBB16_141:                             # %vector.body607
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr11, $t2, -32
	xvld	$xr12, $t2, 0
	xvld	$xr13, $t1, -32
	xvld	$xr14, $t1, 0
	xvsub.w	$xr11, $xr7, $xr11
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB16_141
# %bb.142:                              # %middle.block626
	pcalau12i	$t0, %pc_hi20(.LCPI16_0)
	xvld	$xr7, $t0, %pc_lo12(.LCPI16_0)
	...
	beq	$a0, $a7, .LBB16_30
# %bb.143:                              # %vec.epilog.iter.check637
	andi	$t4, $a0, 12
	beqz	$t4, .LBB16_28
.LBB16_144:                             # %vec.epilog.ph636
	move	$t4, $a7
	...
	vrepli.b	$vr6, -1
	.p2align	4, , 16
.LBB16_145:                             # %vec.epilog.vector.body644
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr7, $t3, 0
	vld	$vr8, $t2, 0
	vsub.w	$vr7, $vr4, $vr7
	...
	addi.d	$t3, $t3, 16
	bnez	$t0, .LBB16_145
# %bb.146:                              # %vec.epilog.middle.block662
...
# %bb.20:                               # %vector.main.loop.iter.check547
	ori	$a4, $zero, 16
...
.LBB19_67:                              #   in Loop: Header=BB19_38 Depth=1
	ldx.w	$t0, $a3, $s8
	slli.d	$t0, $t0, 1
.LBB19_68:                              # %.sink.split513
                                        #   in Loop: Header=BB19_38 Depth=1
	stx.w	$t0, $a2, $a7
	ldx.w	$t0, $a1, $s8
	slli.d	$t0, $t0, 1
	addi.d	$t0, $t0, 1
.LBB19_69:                              # %.sink.split513
                                        #   in Loop: Header=BB19_38 Depth=1
	ld.d	$t1, $sp, 96                    # 8-byte Folded Reload
	stx.w	$t0, $a0, $a7
	addi.w	$s3, $s3, 1
...
.LBB19_76:                              #   in Loop: Header=BB19_38 Depth=1
	ldx.w	$t0, $a3, $s8
	slli.d	$t0, $t0, 1
.LBB19_77:                              # %.sink.split516
                                        #   in Loop: Header=BB19_38 Depth=1
	stx.w	$t0, $a2, $a7
	ldx.w	$t0, $a1, $s8
	slli.d	$t0, $t0, 1
	addi.d	$t0, $t0, 1
.LBB19_78:                              # %.sink.split516
                                        #   in Loop: Header=BB19_38 Depth=1
	ld.d	$t1, $sp, 96                    # 8-byte Folded Reload
...
.LBB19_94:                              # %.noexc.i.i.i
	...
	ld.d	$a2, $a2, 16
	bnez	$a2, .LBB19_94
# %bb.95:                               # %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_P24malloc_plus_memory_entryESt10_Select1stISA_ESt4lessIS5_ESaISA_EE10_S_minimumEPSt18_Rb_tree_node_base.exit.i.i.i.i.i
	st.d	$a1, $sp, 184
	move	$a2, $a0
	.p2align	4, , 16
...
.LBB19_101:                             # %.noexc.i.i5.i
	...
	ld.d	$a2, $a2, 16
	bnez	$a2, .LBB19_101
# %bb.102:                              # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE10_S_minimumEPSt18_Rb_tree_node_base.exit.i.i.i.i.i
	st.d	$a1, $sp, 232
	move	$a2, $a0
	.p2align	4, , 16
...
# %bb.151:
	move	$a5, $zero
.LBB19_152:                             # %vec.epilog.scalar.ph597.preheader
	alsl.d	$a0, $a5, $a0, 2
	alsl.d	$a4, $a5, $a4, 2
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a2, $a5, $a2, 2
	...
	lu32i.d	$a5, 0
	.p2align	4, , 16
.LBB19_153:                             # %vec.epilog.scalar.ph597
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	st.w	$a5, $a3, 0
	st.w	$a5, $a4, 0
...
.LBB19_180:                             #   in Loop: Header=BB19_159 Depth=1
	ldx.w	$s7, $a3, $s7
	.p2align	4, , 16
.LBB19_181:                             # %.sink.split521
                                        #   in Loop: Header=BB19_159 Depth=1
	move	$s8, $s6
.LBB19_182:                             # %.sink.split521
                                        #   in Loop: Header=BB19_159 Depth=1
	slli.d	$s8, $s8, 2
	stx.w	$s7, $t0, $s8
...
# %bb.195:
	move	$a2, $zero
	b	.LBB19_227
.LBB19_196:                             # %vector.memcheck572
	sub.d	$a7, $a3, $a2
	ori	$a6, $zero, 64
	move	$a5, $zero
	bltu	$a7, $a6, .LBB19_152
# %bb.197:                              # %vector.memcheck572
	sub.d	$a7, $a4, $a2
	bltu	$a7, $a6, .LBB19_152
# %bb.198:                              # %vector.memcheck572
	sub.d	$a7, $a0, $a2
	ori	$a6, $zero, 64
	bltu	$a7, $a6, .LBB19_152
# %bb.199:                              # %vector.memcheck572
	sub.d	$a7, $a4, $a3
	bltu	$a7, $a6, .LBB19_152
# %bb.200:                              # %vector.memcheck572
	sub.d	$a7, $a0, $a3
	ori	$a6, $zero, 64
	bltu	$a7, $a6, .LBB19_152
# %bb.201:                              # %vector.memcheck572
	sub.d	$a7, $a0, $a4
	bltu	$a7, $a6, .LBB19_152
# %bb.202:                              # %vector.main.loop.iter.check587
	ori	$a5, $zero, 16
	bgeu	$a1, $a5, .LBB19_230
# %bb.203:
	move	$a5, $zero
	b	.LBB19_234
.LBB19_204:                             # %vector.ph548
...
.LBB19_205:                             # %vector.body551
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB19_205
# %bb.206:                              # %middle.block555
	beq	$a3, $a4, .LBB19_213
# %bb.207:                              # %vec.epilog.iter.check560
	andi	$a5, $a0, 12
	beqz	$a5, .LBB19_211
.LBB19_208:                             # %vec.epilog.ph559
	move	$a7, $a4
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB19_209:                             # %vec.epilog.vector.body565
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	addi.d	$a5, $a5, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB19_209
# %bb.210:                              # %vec.epilog.middle.block569
	beq	$a3, $a4, .LBB19_213
.LBB19_211:                             # %vec.epilog.scalar.ph558.preheader
	alsl.d	$a1, $a4, $a1, 2
	alsl.d	$a2, $a4, $a2, 2
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB19_212:                             # %vec.epilog.scalar.ph558
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, 4
	...
	addi.d	$a2, $a2, 4
	bnez	$a3, .LBB19_212
.LBB19_213:                             # %._crit_edge448.thread
	add.w	$a1, $s0, $a0
	st.w	$a1, $s2, %pc_lo12(_ZZN4Mesh10rezone_allEiiSt6vectorIiSaIiEEiR10MallocPlusE10new_ncells)
.LBB19_214:                             # %.lr.ph452
...
.LBB19_231:                             # %vector.body591
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB19_231
# %bb.232:                              # %middle.block594
	beq	$a5, $a1, .LBB19_154
# %bb.233:                              # %vec.epilog.iter.check599
	andi	$a6, $a1, 12
	beqz	$a6, .LBB19_152
.LBB19_234:                             # %vec.epilog.ph598
	move	$t2, $a5
	...
	vrepli.b	$vr0, -1
	.p2align	4, , 16
.LBB19_235:                             # %vec.epilog.vector.body604
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $t2, 0
	vst	$vr0, $t1, 0
	vst	$vr0, $t0, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB19_235
# %bb.236:                              # %vec.epilog.middle.block607
	bne	$a5, $a1, .LBB19_152
	b	.LBB19_154
.LBB19_237:
	pcalau12i	$a0, %pc_hi20(_ZGVZN4Mesh10rezone_allEiiSt6vectorIiSaIiEEiR10MallocPlusE13celltype_save)
...
# %bb.10:
	move	$a5, $zero
.LBB27_11:                              # %vec.epilog.scalar.ph.preheader
	alsl.d	$a4, $a5, $a4, 2
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a1, $a5, $a1, 2
	alsl.d	$a0, $a5, $a0, 2
...
.LBB27_114:                             # %vec.epilog.ph
	...
	vrepli.b	$vr0, -1
	.p2align	4, , 16
.LBB27_115:                             # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $t2, 0
	vst	$vr0, $t1, 0
	vst	$vr0, $t0, 0
...
.LBB27_122:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB27_123:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit376
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end27:
...
# %bb.9:
	...
	pcaddu18i	$ra, %call36(memmove)
	jirl	$ra, $ra, 0
.LBB60_10:                              # %iter.check145
	addi.d	$a0, $s2, -1
	bstrpick.d	$a2, $a0, 61, 0
	ori	$a0, $zero, 3
	move	$a1, $fp
	bltu	$a2, $a0, .LBB60_52
# %bb.11:                               # %vector.main.loop.iter.check147
	ori	$a1, $zero, 15
	addi.d	$a0, $a2, 1
	bgeu	$a2, $a1, .LBB60_28
# %bb.12:
...
.LBB60_17:
	move	$s4, $zero
.LBB60_18:                              # %iter.check180
	add.d	$a0, $s4, $s5
	ld.w	$a1, $a3, 0
	addi.d	$a2, $s2, -1
	bstrpick.d	$a3, $a2, 61, 0
	ori	$a2, $zero, 3
	alsl.d	$s2, $s2, $a0, 2
	bltu	$a3, $a2, .LBB60_43
# %bb.19:                               # %vector.main.loop.iter.check182
	ori	$a4, $zero, 15
	addi.d	$a2, $a3, 1
	bgeu	$a3, $a4, .LBB60_21
# %bb.20:
...
.LBB60_22:                              # %vector.body188
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB60_22
# %bb.23:                               # %middle.block192
	beq	$a2, $a3, .LBB60_44
# %bb.24:                               # %vec.epilog.iter.check197
	andi	$a4, $a2, 12
	beqz	$a4, .LBB60_42
.LBB60_25:                              # %vec.epilog.ph196
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB60_26:                              # %vec.epilog.vector.body204
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB60_26
# %bb.27:                               # %vec.epilog.middle.block209
	bne	$a2, $a4, .LBB60_43
	b	.LBB60_44
.LBB60_28:                              # %vector.ph148
...
# %bb.30:                               # %middle.block157
	beq	$a0, $a2, .LBB60_71
# %bb.31:                               # %vec.epilog.iter.check162
	andi	$a1, $a0, 12
	beqz	$a1, .LBB60_51
.LBB60_32:                              # %vec.epilog.ph161
	...
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB60_33:                              # %vec.epilog.vector.body169
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	addi.d	$a2, $a2, 4
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB60_33
# %bb.34:                               # %vec.epilog.middle.block174
	bne	$a0, $a3, .LBB60_52
	b	.LBB60_71
.LBB60_35:                              # %vector.ph
...
.LBB60_39:                              # %vec.epilog.ph
	...
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB60_40:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a2, $a2, 4
	addi.d	$a5, $a5, 16
...
.LBB60_42:
	alsl.d	$a0, $a3, $a0, 2
	.p2align	4, , 16
.LBB60_43:                              # %.lr.ph.i.i.i.i.i.i.i75
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a1, $a0, 0
	addi.d	$a0, $a0, 4
	bne	$a0, $s2, .LBB60_43
.LBB60_44:                              # %_ZSt24__uninitialized_fill_n_aIPimiiET_S1_T0_RKT1_RSaIT2_E.exit79
	ori	$a0, $zero, 5
	blt	$s5, $a0, .LBB60_72
# %bb.45:
	move	$a0, $s4
	...
	pcaddu18i	$ra, %call36(memmove)
	jirl	$ra, $ra, 0
.LBB60_46:                              # %_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_.exit
	sub.d	$s0, $s0, $fp
	ori	$a0, $zero, 5
	blt	$s0, $a0, .LBB60_74
# %bb.47:
...
# %bb.49:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB60_50:                              # %_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit
	st.d	$s4, $s1, 0
	st.d	$fp, $s1, 8
	alsl.d	$a0, $s7, $s4, 2
	st.d	$a0, $s1, 16
...
.LBB60_51:
	alsl.d	$a1, $a2, $fp, 2
.LBB60_52:                              # %.lr.ph.i.i.i.preheader
	alsl.d	$a0, $s2, $fp, 2
	.p2align	4, , 16
.LBB60_53:                              # %.lr.ph.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s4, $a1, 0
	addi.d	$a1, $a1, 4
	bne	$a1, $a0, .LBB60_53
...
.LBB60_54:
	alsl.d	$a3, $a2, $s0, 2
	.p2align	4, , 16
.LBB60_55:                              # %.lr.ph.i.i.i.i.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s4, $a3, 0
	addi.d	$a3, $a3, 4
	bne	$a3, $a0, .LBB60_55
.LBB60_56:                              # %_ZSt24__uninitialized_fill_n_aIPimiiET_S1_T0_RKT1_RSaIT2_E.exit
	ori	$a1, $zero, 5
	st.d	$a0, $s1, 8
	blt	$s3, $a1, .LBB60_80
# %bb.57:
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s1, 8
.LBB60_58:                              # %_ZSt22__uninitialized_move_aIPiS0_SaIiEET0_T_S3_S2_RT1_.exit69
	add.d	$a0, $a0, $s3
	st.d	$a0, $s1, 8
	beq	$s0, $fp, .LBB60_71
# %bb.59:                               # %iter.check110
	...
	move	$a1, $fp
	bltu	$a2, $a0, .LBB60_70
# %bb.60:                               # %vector.main.loop.iter.check112
	srli.d	$a0, $a2, 2
	ori	$a1, $zero, 60
	addi.d	$a0, $a0, 1
	bgeu	$a2, $a1, .LBB60_62
...
.LBB60_63:                              # %vector.body118
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB60_63
# %bb.64:                               # %middle.block122
	beq	$a0, $a2, .LBB60_71
# %bb.65:                               # %vec.epilog.iter.check127
	andi	$a1, $a0, 12
	beqz	$a1, .LBB60_69
.LBB60_66:                              # %vec.epilog.ph126
	bstrpick.d	$a1, $a0, 62, 2
	slli.d	$a3, $a1, 2
	alsl.d	$a1, $a1, $fp, 4
	vreplgr2vr.w	$vr0, $s4
	...
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB60_67:                              # %vec.epilog.vector.body134
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	addi.d	$a2, $a2, 4
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB60_67
# %bb.68:                               # %vec.epilog.middle.block139
	bne	$a0, $a3, .LBB60_70
	b	.LBB60_71
.LBB60_69:
	alsl.d	$a1, $a2, $fp, 2
	.p2align	4, , 16
.LBB60_70:                              # %.lr.ph.i.i.i71
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s4, $a1, 0
	addi.d	$a1, $a1, 4
	bne	$a1, $s0, .LBB60_70
.LBB60_71:                              # %_ZSt4fillIPiiEvT_S1_RKT0_.exit
	ld.d	$s7, $sp, 0                     # 8-byte Folded Reload
	ld.d	$s6, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s5, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s4, $sp, 24                    # 8-byte Folded Reload
