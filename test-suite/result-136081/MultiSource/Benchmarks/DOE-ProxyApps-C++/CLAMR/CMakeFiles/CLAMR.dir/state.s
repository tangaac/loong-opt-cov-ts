...
# %bb.24:                               # %middle.block
	bne	$a0, $a4, .LBB12_3
	b	.LBB12_5
.LBB12_25:                              # %vector.ph108
	bstrpick.d	$a2, $a1, 30, 1
	slli.d	$a2, $a2, 1
	addi.d	$a3, $s1, 4
	move	$a4, $a2
	.p2align	4, , 16
.LBB12_26:                              # %vector.body111
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a3, -4
	ld.w	$a6, $a3, 0
	slli.d	$a5, $a5, 3
...
# %bb.27:                               # %middle.block114
	beq	$a2, $a1, .LBB12_30
.LBB12_28:                              # %scalar.ph106.preheader
	alsl.d	$a3, $a2, $s1, 2
	sub.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB12_29:                              # %scalar.ph106
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a3, 0
	slli.d	$a2, $a2, 3
	fstx.d	$fs0, $a0, $a2
...
.LBB12_42:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB12_43:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit51
	sub.d	$a1, $s4, $s1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.LBB16_15:                              #   in Loop: Header=BB16_6 Depth=1
	...
	ldx.w	$a5, $s4, $a4
	ldx.w	$t0, $t2, $a4
	st.d	$t3, $sp, 640                   # 8-byte Folded Spill
...
.LBB16_18:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$fa7, $fs2, $fa7
	fsub.d	$fs5, $ft10, $fa7
	fst.d	$ft12, $sp, 600                 # 8-byte Folded Spill
	fmul.d	$fa7, $ft12, $fa3
	fdiv.d	$ft12, $fa7, $fs4
	fst.d	$ft13, $sp, 808                 # 8-byte Folded Spill
	fmul.d	$fa7, $ft13, $fa0
	fdiv.d	$fa7, $fa7, $fs7
	...
	fst.d	$ft15, $sp, 696                 # 8-byte Folded Spill
...
# %bb.19:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$ft13, $sp, 736                 # 8-byte Folded Reload
	...
	fdiv.d	$ft0, $ft0, $ft12
	fld.d	$fa0, $sp, 784                  # 8-byte Folded Reload
	fadd.d	$ft0, $fa0, $ft0
	fmul.d	$fa0, $ft0, $fs1
...
# %bb.22:                               #   in Loop: Header=BB16_6 Depth=1
	fld.d	$ft13, $sp, 744                 # 8-byte Folded Reload
	fmul.d	$ft9, $fs0, $ft13
	fadd.d	$ft4, $ft4, $ft9
	fdiv.d	$ft4, $ft4, $fs1
	...
	fmul.d	$fa5, $ft4, $fa5
	fst.d	$ft9, $sp, 712                  # 8-byte Folded Spill
	fdiv.d	$fa5, $fa5, $ft9
	fadd.d	$fa5, $fa3, $fa5
	fmul.d	$fa3, $fa5, $ft14
	b	.LBB16_24
...
.LBB16_23:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fst.d	$fa5, $sp, 712                  # 8-byte Folded Spill
	fst.d	$fa5, $sp, 296                  # 8-byte Folded Spill
.LBB16_24:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fmul.d	$ft7, $ft2, $ft13
	fdiv.d	$ft8, $ft7, $fs5
	fld.d	$ft7, $sp, 808                  # 8-byte Folded Reload
	fmul.d	$ft7, $ft7, $ft4
	fmul.d	$ft2, $ft2, $fa5
	fadd.d	$ft2, $ft2, $ft7
	fdiv.d	$ft12, $ft2, $ft3
	...
	fmul.d	$ft8, $fa0, $ft4
	vldi	$vr0, -912
	fst.d	$ft13, $sp, 584                 # 8-byte Folded Spill
	...
	fdiv.d	$fa7, $fa7, $fs6
	fst.d	$fs6, $sp, 544                  # 8-byte Folded Spill
	fmul.d	$ft9, $fs6, $fs6
	fmul.d	$ft9, $ft9, $fa1
	fadd.d	$fs6, $fa7, $ft9
	fadd.d	$fa7, $fs0, $ft4
...
# %bb.25:                               #   in Loop: Header=BB16_6 Depth=1
	...
	fst.d	$fa6, $sp, 336                  # 8-byte Folded Spill
	fmul.d	$fa4, $fa6, $fa6
	fdiv.d	$fa4, $fa4, $ft10
	fst.d	$ft10, $sp, 664                 # 8-byte Folded Spill
...
.LBB16_41:                              #   in Loop: Header=BB16_6 Depth=1
	fst.d	$fa7, $sp, 592                  # 8-byte Folded Spill
	ld.w	$s6, $s1, 0
	fmul.d	$fa0, $fa3, $ft3
...
# %bb.43:                               #   in Loop: Header=BB16_6 Depth=1
	...
	ldx.w	$a0, $s4, $a0
	ldx.w	$a1, $s4, $s6
	fld.d	$fa7, $sp, 600                  # 8-byte Folded Reload
...
.LBB16_76:                              # %.split1386
	...
	fdiv.d	$fa3, $fa0, $ft2
	fst.d	$fa3, $sp, 632                  # 8-byte Folded Spill
	bge	$fp, $a0, .LBB16_79
...
.LBB16_83:                              #   in Loop: Header=BB16_6 Depth=1
	...
	fsqrt.d	$fa0, $fa1
	fcmp.cor.d	$fcc0, $fa0, $fa0
	fld.d	$fa7, $sp, 584                  # 8-byte Folded Reload
...
.LBB16_98:                              # %call.sqrt
	...
	fst.d	$ft3, $sp, 80                   # 8-byte Folded Spill
...
# %bb.7:                                # %.noexc53
	...
	st.d	$zero, $s4, 0
	beq	$s5, $a0, .LBB25_9
# %bb.8:                                # %_ZSt6fill_nIPdmdET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i50
	addi.d	$a0, $s4, 8
	addi.d	$a2, $fp, -8
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
...
# %bb.4:                                # %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i29
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB43_5:                               # %_ZSt27__uninitialized_default_n_aIPimiET_S1_T0_RSaIT1_E.exit31
	blt	$s2, $s7, .LBB43_7
# %bb.6:
	move	$a0, $s3
	move	$a1, $s1
...
# %bb.4:                                # %_ZSt6fill_nIPdmdET_S1_T0_RKT1_.exit.loopexit.i.i.i29
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB44_5:                               # %_ZSt27__uninitialized_default_n_aIPdmdET_S1_T0_RSaIT1_E.exit31
	blt	$s2, $s7, .LBB44_7
# %bb.6:
	move	$a0, $s3
	move	$a1, $s1
