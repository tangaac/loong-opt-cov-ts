...
# %bb.29:                               # %.noexc156
	...
	st.d	$a2, $sp, 32                    # 8-byte Folded Spill
	beq	$a0, $a1, .LBB14_31
# %bb.30:                               # %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit157.thread466
	addi.d	$a0, $s4, 4
	addi.d	$a2, $s6, -4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
...
# %bb.37:                               # %.lr.ph315
	...
	move	$a1, $s6
	bgeu	$a3, $a7, .LBB14_59
.LBB14_38:                              # %scalar.ph518.preheader
	slli.d	$a7, $a1, 3
	alsl.d	$a3, $a1, $a6, 3
	slli.d	$a6, $a1, 2
	alsl.d	$a2, $a1, $a2, 2
...
.Ltmp885:
	...
	jirl	$ra, $ra, 0
.Ltmp886:
# %bb.42:                               # %._ZNSt6vectorIiSaIiEE6resizeEm.exit162_crit_edge
	ld.d	$a0, $s2, 0
	b	.LBB14_55
.LBB14_43:
	ld.d	$a4, $sp, 56                    # 8-byte Folded Reload
...
# %bb.44:
	alsl.d	$a0, $s5, $a1, 2
	beq	$a2, $a0, .LBB14_46
# %bb.45:                               # %_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i.i
	st.d	$a0, $t5, 40
...
# %bb.58:
	move	$a2, $zero
	b	.LBB14_68
.LBB14_59:                              # %vector.memcheck513
	alsl.d	$a1, $s6, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 32
	move	$a1, $s6
	bltu	$a7, $t0, .LBB14_38
# %bb.60:                               # %vector.memcheck513
	alsl.d	$a1, $s6, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 64
	move	$a1, $s6
...
.LBB14_62:                              # %vector.body523
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB14_62
# %bb.63:                               # %middle.block531
	bne	$a3, $a7, .LBB14_38
	b	.LBB14_40
.LBB14_64:                              # %vector.ph541
	move	$a2, $a1
...
.LBB14_72:                              # %vec.epilog.scalar.ph
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB14_72
.LBB14_73:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit164
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $s4
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
# %bb.76:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB14_77:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit167
	beqz	$s0, .LBB14_79
# %bb.78:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB14_79:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit169
	beqz	$fp, .LBB14_81
# %bb.80:
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $fp
	...
	jr	$t8
.LBB14_81:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit171
	ld.d	$s8, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 112                   # 8-byte Folded Reload
...
.LBB14_85:                              # =>This Loop Header: Depth=1
	...
	stx.w	$a0, $s4, $t4
	bge	$t5, $t6, .LBB14_84
# %bb.86:                               # %.lr.ph292.preheader
                                        #   in Loop: Header=BB14_85 Depth=1
	sub.d	$t7, $t6, $t5
	addi.w	$a0, $a0, 0
	bgeu	$t7, $t2, .LBB14_89
.LBB14_87:                              # %.lr.ph292.preheader561
                                        #   in Loop: Header=BB14_85 Depth=1
	alsl.d	$t7, $a0, $s1, 2
	alsl.d	$t8, $a0, $s3, 3
	alsl.d	$s6, $t5, $a3, 2
...
.Ltmp875:
# %bb.98:                               # %.noexc155
.LBB14_99:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit173.thread
.Ltmp873:
	move	$s2, $a0
	b	.LBB14_112
.LBB14_100:
...
# %bb.101:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit
	bnez	$s3, .LBB14_111
.LBB14_102:                             # %_ZNSt6vectorIdSaIdEED2Ev.exit173
	bnez	$s1, .LBB14_112
...
.LBB14_107:
	...
	beqz	$s3, .LBB14_102
	b	.LBB14_111
.LBB14_108:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit177.thread
.Ltmp868:
	move	$s2, $a0
	b	.LBB14_114
.LBB14_109:                             # %_ZNSt6vectorIiSaIiEED2Ev.exit175.thread
.Ltmp878:
	move	$s2, $a0
	b	.LBB14_113
.LBB14_110:
...
.LBB37_1:                               # =>This Inner Loop Header: Depth=1
	...
	fst.d	$ft1, $a0, 224
	fst.d	$ft11, $a0, 232
	fld.d	$fa6, $sp, 8                    # 8-byte Folded Reload
	fmul.d	$ft1, $ft13, $fa6
	fst.d	$ft1, $a0, 240
	fmul.d	$ft1, $ft2, $ft13
	fst.d	$ft1, $a0, 248
	...
	fst.d	$fa2, $sp, 56
	fst.d	$fa4, $sp, 48
	fld.d	$fa7, $sp, 0                    # 8-byte Folded Reload
	fst.d	$fa7, $sp, 32
	fst.d	$ft13, $sp, 40
	fld.d	$ft1, $sp, 72
	movfr2gr.d	$t1, $ft13
	xvinsgr2vr.d	$xr28, $t1, 0
	fmul.d	$fs1, $ft10, $ft14
	fsub.d	$ft12, $fa1, $ft1
	fld.d	$ft15, $sp, 64
	fadd.d	$ft11, $ft1, $fa1
	fmul.d	$ft13, $ft10, $ft12
	fmul.d	$ft9, $ft10, $ft11
	fsub.d	$fs0, $fa1, $ft15
	fadd.d	$ft15, $ft15, $fa1
	fmul.d	$fs3, $ft10, $fs0
	fmul.d	$fs5, $ft10, $ft15
	movfr2gr.d	$t1, $ft10
	fmul.d	$fs6, $ft8, $ft14
	fmul.d	$fs2, $ft8, $ft12
	...
	xvinsgr2vr.d	$xr28, $t2, 2
	xvinsgr2vr.d	$xr28, $t3, 3
	xvfmul.d	$xr22, $xr28, $xr22
	xvpickve2gr.d	$t1, $xr22, 2
	movgr2fr.d	$fs4, $t1
	fst.d	$fs4, $a0, 88
	fst.d	$fs4, $a0, 104
	xvst	$xr22, $a0, 264
...
.LBB39_6:                               # %.preheader.preheader
	...
	xvfmul.d	$xr15, $xr11, $xr13
	xvfmul.d	$xr16, $xr12, $xr13
	xvld	$xr17, $sp, 64                  # 32-byte Folded Reload
	xvori.b	$xr14, $xr17, 0
	xvshuf.d	$xr14, $xr5, $xr7
	xvld	$xr18, $sp, 32                  # 32-byte Folded Reload
	xvori.b	$xr13, $xr18, 0
	xvshuf.d	$xr13, $xr4, $xr14
	xvshuf.d	$xr17, $xr9, $xr10
	xvori.b	$xr14, $xr18, 0
	xvshuf.d	$xr14, $xr6, $xr17
	xvpermi.q	$xr8, $xr8, 2
	xvfmul.d	$xr17, $xr14, $xr8
	xvfmul.d	$xr8, $xr13, $xr8
	xvfadd.d	$xr16, $xr16, $xr8
	...
	xvpermi.d	$xr9, $xr9, 68
	xvpackev.d	$xr8, $xr9, $xr8
	xvpickve2gr.d	$a2, $xr8, 0
	movgr2fr.d	$ft1, $a2
	xvfadd.d	$xr10, $xr15, $xr17
	movfr2gr.d	$a2, $ft1
	...
	xvfmul.d	$xr3, $xr8, $xr3
	vld	$vr6, $sp, 248
	xvfadd.d	$xr3, $xr10, $xr3
	xvfadd.d	$xr4, $xr16, $xr4
	xvst	$xr4, $sp, 464
	xvst	$xr3, $sp, 432
	xvori.b	$xr3, $xr6, 0
	xvpermi.q	$xr3, $xr0, 2
	...
	fld.d	$ft13, $s3, 104
	xvori.b	$xr22, $xr17, 0
	vreplvei.d	$vr23, $vr17, 0
	vreplvei.d	$vr24, $vr17, 1
	xvpermi.q	$xr17, $xr0, 2
	xvpermi.d	$xr17, $xr17, 68
	xvshuf.d	$xr25, $xr0, $xr17
	fld.d	$ft9, $s3, 96
	xvfmul.d	$xr25, $xr11, $xr25
	xvpermi.q	$xr22, $xr22, 2
	xvfmul.d	$xr22, $xr14, $xr22
	xvfadd.d	$xr22, $xr25, $xr22
	xvreplve0.d	$xr25, $xr1
	xvfmul.d	$xr25, $xr8, $xr25
