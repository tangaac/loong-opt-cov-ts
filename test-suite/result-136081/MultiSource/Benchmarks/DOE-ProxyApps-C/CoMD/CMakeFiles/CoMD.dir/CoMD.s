...
# %bb.51:                               # %vector.memcheck81
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB0_65
# %bb.52:                               # %vector.memcheck81
	addi.d	$a3, $a0, 4
	bgeu	$a2, $a3, .LBB0_65
.LBB0_53:
	move	$a3, $zero
	move	$a4, $zero
.LBB0_54:                               # %vec.epilog.scalar.ph107.preheader
	sub.d	$a1, $a1, $a3
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB0_55:                               # %vec.epilog.scalar.ph107
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	add.d	$a4, $a3, $a4
	st.w	$a4, $a0, 0
...
# %bb.64:
	...
	move	$a4, $zero
	b	.LBB0_71
.LBB0_65:                               # %vector.main.loop.iter.check91
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_74
# %bb.66:
	move	$a3, $zero
...
# %bb.76:                               # %middle.block102
	...
	st.w	$a4, $a0, 0
	beq	$a3, $a1, .LBB0_56
# %bb.77:                               # %vec.epilog.iter.check109
	andi	$a5, $a1, 12
	beqz	$a5, .LBB0_54
.LBB0_78:                               # %vec.epilog.ph108
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	pcalau12i	$a6, %pc_hi20(.LCPI0_2)
	vld	$vr0, $a6, %pc_lo12(.LCPI0_2)
	...
	alsl.d	$a5, $a5, $a2, 2
	.p2align	4, , 16
.LBB0_79:                               # %vec.epilog.vector.body114
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vadd.w	$vr0, $vr1, $vr0
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_79
# %bb.80:                               # %vec.epilog.middle.block119
	vshuf4i.w	$vr1, $vr0, 14
	vadd.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vadd.w	$vr0, $vr0, $vr1
