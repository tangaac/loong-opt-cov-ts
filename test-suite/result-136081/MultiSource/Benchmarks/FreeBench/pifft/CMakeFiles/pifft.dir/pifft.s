...
.LBB1_12:                               # %vector.body51
	...
	movfr2gr.d	$a5, $fa3
	xvinsgr2vr.d	$xr1, $a5, 2
	movfr2gr.d	$a5, $fa4
	fld.d	$fa2, $a3, -8
	fld.d	$fa3, $a3, 8
	fld.d	$fa4, $a3, 24
	fld.d	$fa5, $a3, 40
	xvinsgr2vr.d	$xr1, $a5, 3
	movfr2gr.d	$a5, $fa2
...
.Lfunc_end1:
	.size	mp_mul_radix_test, .Lfunc_end1-mp_mul_radix_test
                                        # -- End function
	.section	.rodata.cst32,"aM",@progbits,32
	.p2align	5, 0x0                          # -- Begin function mp_sscanf
.LCPI2_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
# %bb.53:                               # %iter.check180
	...
	ori	$a2, $zero, 2
	bgeu	$a2, $a3, .LBB2_64
# %bb.54:                               # %vector.main.loop.iter.check182
...
# %bb.58:                               # %middle.block189
	beq	$a2, $a3, .LBB2_66
# %bb.59:                               # %vec.epilog.iter.check194
	andi	$a4, $a2, 12
	beqz	$a4, .LBB2_63
.LBB2_60:                               # %vec.epilog.ph193
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB2_61:                               # %vec.epilog.vector.body199
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a0, 0
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, 16
	bnez	$a3, .LBB2_61
# %bb.62:                               # %vec.epilog.middle.block202
	bne	$a2, $a4, .LBB2_64
	b	.LBB2_66
.LBB2_63:
	add.d	$a1, $a1, $a3
.LBB2_64:                               # %.lr.ph121.preheader206
	alsl.d	$a0, $a1, $fp, 2
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
...
# %bb.21:
	bne	$s0, $a0, .LBB8_23
# %bb.22:                               # %.._crit_edge57_crit_edge.i102
	move	$a0, $zero
	b	.LBB8_25
.LBB8_23:                               # %.lr.ph56.preheader.i92
	move	$a0, $zero
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a1, $a1, 1
...
# %bb.36:
	move	$a0, $zero
	b	.LBB8_39
.LBB8_37:                               # %.lr.ph56.preheader.i117
	move	$a0, $zero
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a1, $a1, 1
...
# %bb.47:                               # %.lr.ph.preheader.i160
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB8_48:                               # %._crit_edge.i143
	st.d	$s4, $sp, 80                    # 8-byte Folded Spill
	ori	$a0, $zero, 2
	blt	$s0, $a0, .LBB8_54
# %bb.49:
	bne	$s0, $a0, .LBB8_51
# %bb.50:                               # %.._crit_edge57_crit_edge.i158
	move	$a0, $zero
	b	.LBB8_53
.LBB8_51:                               # %.lr.ph56.preheader.i146
	move	$a0, $zero
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a1, $a1, 1
...
# %bb.21:
	bne	$s6, $a2, .LBB11_23
# %bb.22:                               # %.._crit_edge57_crit_edge.i81
	move	$a2, $zero
	b	.LBB11_25
.LBB11_23:                              # %.lr.ph56.preheader.i71
	move	$a2, $zero
...
# %bb.19:                               # %middle.block
	beq	$a0, $a3, .LBB19_22
.LBB19_20:                              # %.lr.ph101.preheader114
	addi.d	$a0, $a1, 1
	alsl.d	$a1, $a1, $a5, 2
	ori	$a2, $zero, 1
	.p2align	4, , 16
...
# %bb.16:                               # %middle.block
	beq	$a3, $a4, .LBB27_19
.LBB27_17:                              # %.lr.ph137.preheader157
	addi.d	$a3, $a2, 1
	alsl.d	$a2, $a2, $fp, 2
	.p2align	4, , 16
.LBB27_18:                              # %.lr.ph137
...
# %bb.18:
	move	$a0, $zero
	b	.LBB29_21
.LBB29_19:                              # %.lr.ph56.preheader.i34
	move	$a0, $zero
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	add.w	$a1, $s2, $a1
	srai.d	$a1, $a1, 1
...
.LBB29_20:                              # %.lr.ph56.i35
	...
	addi.d	$a4, $a4, -4
	blt	$a5, $a2, .LBB29_20
.LBB29_21:                              # %._crit_edge57.i42
	ld.w	$a1, $s7, 12
	sub.d	$a0, $a1, $a0
	movgr2fr.w	$fa0, $a0
	ffint.d.w	$fa0, $fa0
	fst.d	$fa0, $fp, 16
.LBB29_22:                              # %mp_mul_i2d.exit49
	movgr2fr.w	$fa0, $s5
	ld.w	$a0, $s7, 4
	ffint.d.w	$fa0, $fa0
	addi.d	$s7, $fp, 8
...
# %bb.23:
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	bltz	$a0, .LBB36_27
# %bb.24:                               # %.lr.ph46.preheader.i
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_25:                              # %.lr.ph46.i108
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s1, $a1
...
# %bb.31:                               # %vector.ph185
	...
	bstrpick.d	$a0, $a1, 62, 2
	slli.d	$a7, $a0, 2
	pcalau12i	$a4, %pc_hi20(.LCPI36_0)
	xvld	$xr0, $a4, %pc_lo12(.LCPI36_0)
	slli.d	$a0, $a0, 3
	addi.d	$a0, $a0, 3
	addi.d	$a6, $s5, 40
	move	$a4, $a7
...
# %bb.41:
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	bltz	$a0, .LBB36_45
# %bb.42:                               # %.lr.ph46.preheader.i125
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_43:                              # %.lr.ph46.i126
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s7, $a1
