...
.LBB1_78:
	move	$a2, $zero
.LBB1_79:                               # %vec.epilog.scalar.ph323.preheader
	slli.d	$a3, $a2, 2
	alsl.d	$a3, $s0, $a3, 2
	add.d	$a0, $a0, $a3
	add.w	$a1, $a1, $a2
	sub.d	$a2, $s7, $a2
	.p2align	4, , 16
.LBB1_80:                               # %vec.epilog.scalar.ph323
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a0, 0
	slli.d	$a4, $a1, 2
	stx.w	$a3, $s3, $a4
...
# %bb.93:                               # %.lr.ph238
	...
	move	$a3, $t2
	bgeu	$a2, $a4, .LBB1_114
.LBB1_94:                               # %scalar.ph342.preheader
	alsl.d	$a2, $a3, $s1, 3
	add.d	$a0, $a0, $a3
	sub.w	$a0, $a0, $t2
	sub.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB1_95:                               # %scalar.ph342
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	slli.d	$a5, $a0, 3
	stx.d	$a4, $a1, $a5
...
# %bb.97:
	...
	b	.LBB1_99
	.p2align	4, , 16
.LBB1_98:                               #   in Loop: Header=BB1_99 Depth=1
	addi.d	$s0, $s0, -1
	addi.d	$fp, $fp, 8
	beqz	$s0, .LBB1_107
.LBB1_99:                               # %.lr.ph240
...
# %bb.103:                              # %vector.memcheck
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB1_78
# %bb.104:                              # %vector.main.loop.iter.check311
	ori	$a2, $zero, 16
	bgeu	$s7, $a2, .LBB1_121
# %bb.105:
	move	$a2, $zero
	b	.LBB1_125
.LBB1_106:                              # %._crit_edge241
	beqz	$s1, .LBB1_108
.LBB1_107:                              # %._crit_edge241.thread
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_108:
...
.LBB1_113:
	...
	addi.d	$sp, $sp, 1152
	ret
.LBB1_114:                              # %vector.scevcheck337
	nor	$a3, $t2, $zero
	add.d	$a4, $a3, $s0
	add.w	$a5, $a0, $a4
	move	$a3, $t2
	blt	$a5, $a0, .LBB1_94
# %bb.115:                              # %vector.scevcheck337
	srli.d	$a4, $a4, 32
	move	$a3, $t2
	bnez	$a4, .LBB1_94
# %bb.116:                              # %vector.memcheck338
	alsl.d	$a3, $t2, $s1, 3
	add.d	$a4, $s0, $a0
	sub.d	$a4, $a4, $t2
	alsl.d	$a4, $a4, $a1, 3
	bgeu	$a3, $a4, .LBB1_118
# %bb.117:                              # %vector.memcheck338
	alsl.d	$a4, $s0, $s1, 3
	alsl.d	$a5, $a0, $a1, 3
	move	$a3, $t2
	bltu	$a5, $a4, .LBB1_94
.LBB1_118:                              # %vector.ph344
	slli.d	$a5, $t2, 3
	move	$a4, $a2
...
.LBB1_119:                              # %vector.body347
	...
	addi.w	$a7, $a7, 8
	bnez	$a6, .LBB1_119
# %bb.120:                              # %middle.block353
	bne	$a2, $a4, .LBB1_94
	b	.LBB1_96
.LBB1_121:                              # %vector.ph312
...
.LBB1_122:                              # %vector.body315
	...
	addi.w	$a4, $a4, 16
	bnez	$a5, .LBB1_122
# %bb.123:                              # %middle.block320
	beq	$a2, $s7, .LBB1_81
# %bb.124:                              # %vec.epilog.iter.check325
	andi	$a3, $s7, 12
	beqz	$a3, .LBB1_79
.LBB1_125:                              # %vec.epilog.ph324
	move	$a5, $a2
	...
	add.w	$a5, $a1, $a5
	.p2align	4, , 16
.LBB1_126:                              # %vec.epilog.vector.body330
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	slli.d	$a6, $a5, 2
	vstx	$vr0, $s3, $a6
	...
	addi.w	$a5, $a5, 4
	bnez	$a3, .LBB1_126
# %bb.127:                              # %vec.epilog.middle.block334
	bne	$a2, $s7, .LBB1_79
	b	.LBB1_81
.Lfunc_end1:
...
# %bb.33:
	move	$a3, $zero
.LBB11_34:                              # %vec.epilog.scalar.ph74.preheader
	sub.d	$a4, $s0, $a3
	alsl.d	$a0, $a3, $a0, 2
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a5, $a3, $s5, 2
	alsl.d	$a1, $a3, $a1, 2
	.p2align	4, , 16
.LBB11_35:                              # %vec.epilog.scalar.ph74
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a1, 0
	st.w	$a3, $a5, 0
	ld.w	$a3, $a2, 0
...
.LBB11_50:
	...
	addi.d	$sp, $sp, 128
	ret
.LBB11_51:                              # %vector.memcheck47
	sub.d	$a5, $a0, $s5
	ori	$a4, $zero, 64
	move	$a3, $zero
	bltu	$a5, $a4, .LBB11_34
# %bb.52:                               # %vector.memcheck47
	sub.d	$a5, $s5, $a1
	bltu	$a5, $a4, .LBB11_34
# %bb.53:                               # %vector.memcheck47
	sub.d	$a5, $a2, $s5
	ori	$a4, $zero, 64
	bltu	$a5, $a4, .LBB11_34
...
# %bb.55:                               # %vector.memcheck47
	...
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB11_34
# %bb.56:                               # %vector.main.loop.iter.check60
	ori	$a3, $zero, 16
	bgeu	$s0, $a3, .LBB11_58
# %bb.57:
	move	$a3, $zero
	b	.LBB11_62
.LBB11_58:                              # %vector.ph61
...
.LBB11_59:                              # %vector.body64
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB11_59
# %bb.60:                               # %middle.block71
	beq	$a3, $s0, .LBB11_36
# %bb.61:                               # %vec.epilog.iter.check76
	andi	$a4, $s0, 12
	beqz	$a4, .LBB11_34
.LBB11_62:                              # %vec.epilog.ph75
	move	$t0, $a3
	...
	alsl.d	$t0, $t0, $a1, 2
	.p2align	4, , 16
.LBB11_63:                              # %vec.epilog.vector.body81
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	vld	$vr0, $a6, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a4, .LBB11_63
# %bb.64:                               # %vec.epilog.middle.block86
	bne	$a3, $s0, .LBB11_34
	b	.LBB11_36
.Lfunc_end11:
