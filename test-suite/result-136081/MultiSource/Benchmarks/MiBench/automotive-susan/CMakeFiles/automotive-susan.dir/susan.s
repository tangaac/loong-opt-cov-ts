...
.LBB10_35:                              # %vector.body
	...
	vilvl.b	$vr9, $vr0, $vr9
	vpickve2gr.b	$t4, $vr7, 3
	st.b	$t4, $sp, 152
	vpickve2gr.b	$t4, $vr7, 2
	st.b	$t4, $sp, 144
	vpickve2gr.b	$t4, $vr7, 1
	st.b	$t4, $sp, 136
	vpickve2gr.b	$t4, $vr7, 0
	st.b	$t4, $sp, 128
	xvld	$xr7, $sp, 128
	vilvl.h	$vr9, $vr0, $vr9
...
.LBB18_69:                              # %vec.epilog.ph272
	...
	alsl.d	$a2, $a3, $s1, 2
	.p2align	4, , 16
.LBB18_70:                              # %vec.epilog.vector.body278
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a2, 0
	vmax.w	$vr0, $vr2, $vr0
	vmin.w	$vr1, $vr2, $vr1
