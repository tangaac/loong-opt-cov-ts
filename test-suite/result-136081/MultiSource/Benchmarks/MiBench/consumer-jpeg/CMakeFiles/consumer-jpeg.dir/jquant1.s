...
.LBB6_10:                               # %vector.body
	...
	vpickve2gr.b	$t5, $vr4, 3
	st.b	$t5, $sp, 120
	vpickve2gr.b	$t5, $vr4, 2
	st.b	$t5, $sp, 112
	vpickve2gr.b	$t5, $vr4, 1
	st.b	$t5, $sp, 104
	vpickve2gr.b	$t5, $vr4, 0
	st.b	$t5, $sp, 96
	xvld	$xr4, $sp, 96
	vst	$vr5, $sp, 160
	st.b	$zero, $sp, 95
	...
	st.w	$zero, $sp, 65
	xvld	$xr5, $sp, 160
	vpickve2gr.b	$t5, $vr5, 3
	st.b	$t5, $sp, 88
	vpickve2gr.b	$t5, $vr5, 2
	st.b	$t5, $sp, 80
	vpickve2gr.b	$t5, $vr5, 1
	st.b	$t5, $sp, 72
	vpickve2gr.b	$t5, $vr5, 0
	st.b	$t5, $sp, 64
	xvld	$xr5, $sp, 64
	ld.d	$t5, $t4, -16
