...
# %bb.0:
	...
	fst.d	$fs4, $sp, 1152                 # 8-byte Folded Spill
	fst.d	$fs5, $sp, 1144                 # 8-byte Folded Spill
	fst.d	$fs6, $sp, 1136                 # 8-byte Folded Spill
	fst.d	$fs7, $sp, 1128                 # 8-byte Folded Spill
	...
	addi.d	$s2, $a0, %pc_lo12(L3psycho_anal.cw)
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.w2_s)
	addi.d	$s1, $a0, %pc_lo12(L3psycho_anal.w2_s)
	...
	addi.d	$s7, $a0, %pc_lo12(L3psycho_anal.s3ind_s)
...
.LBB0_9:                                # %vector.ph
	...
	vld	$vr0, $a4, %pc_lo12(.LCPI0_13)
	pcalau12i	$a4, %pc_hi20(.LCPI0_14)
	vld	$vr1, $a4, %pc_lo12(.LCPI0_14)
	or	$a1, $a1, $a3
	ori	$a3, $zero, 6
	vst	$vr0, $a2, 64
	vst	$vr1, $a2, 80
	pcalau12i	$a4, %pc_hi20(.LCPI0_15)
	vld	$vr0, $a4, %pc_lo12(.LCPI0_15)
	pcalau12i	$a4, %pc_hi20(.LCPI0_16)
	vld	$vr1, $a4, %pc_lo12(.LCPI0_16)
	slt	$a4, $a3, $a1
	maskeqz	$a1, $a1, $a4
	masknez	$a3, $a3, $a4
	or	$a1, $a1, $a3
	vst	$vr0, $a2, 96
	vst	$vr1, $a2, 112
	pcalau12i	$a3, %pc_hi20(.LCPI0_17)
	vld	$vr0, $a3, %pc_lo12(.LCPI0_17)
	pcalau12i	$a3, %pc_hi20(.LCPI0_18)
	vld	$vr1, $a3, %pc_lo12(.LCPI0_18)
	ld.d	$a3, $sp, 280                   # 8-byte Folded Reload
	st.w	$a1, $a3, %pc_lo12(L3psycho_anal.cw_upper_index)
	stptr.w	$a0, $s2, 2048
	vst	$vr0, $a2, 128
	vst	$vr1, $a2, 144
	lu12i.w	$a0, 18980
	...
	pcalau12i	$a2, %pc_hi20(L3psycho_anal.numlines_s)
	addi.d	$fp, $a2, %pc_lo12(L3psycho_anal.numlines_s)
	...
	addi.d	$s8, $a2, %pc_lo12(L3psycho_anal.s3_l)
...
# %bb.11:                               # %.loopexit1591
	...
	st.w	$a7, $a0, %pc_lo12(L3psycho_anal.npart_l_orig)
	addi.d	$a2, $s5, -16
	addi.w	$a0, $zero, -1
	addi.d	$a3, $zero, -2
	move	$a4, $a0
...
# %bb.13:
	...
	addi.w	$a0, $t0, 1
	st.w	$a0, $t6, %pc_lo12(L3psycho_anal.npart_s)
...
.LBB0_15:
	...
	b	.LBB0_29
.LBB0_16:
	st.w	$a7, $t5, %pc_lo12(L3psycho_anal.npart_l)
	st.w	$a6, $t4, 80
	...
	blt	$t0, $a5, .LBB0_15
.LBB0_17:
	st.w	$a5, $t6, %pc_lo12(L3psycho_anal.npart_s)
	st.w	$a3, $t2, 44
...
.LBB0_18:                               # %.preheader969.lr.ph
	...
	slli.d	$t4, $t4, 3
	pcalau12i	$t5, %pc_hi20(L3psycho_anal.s3_l)
	addi.d	$t5, $t5, %pc_lo12(L3psycho_anal.s3_l)
	ori	$t6, $zero, 2
	movgr2fr.d	$fa0, $zero
	b	.LBB0_21
	.p2align	4, , 16
...
# %bb.28:                               #   in Loop: Header=BB0_27 Depth=2
	...
	bcnez	$fcc0, .LBB0_27
	b	.LBB0_20
.LBB0_29:                               # %.preheader968
	blt	$a0, $t0, .LBB0_40
# %bb.30:                               # %.preheader967.lr.ph
	move	$a6, $zero
...
.LBB0_31:                               #   in Loop: Header=BB0_32 Depth=1
	...
	addi.d	$a2, $a2, 512
	beq	$a6, $a0, .LBB0_40
.LBB0_32:                               # %.preheader967
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB0_34 Depth 2
                                        #     Child Loop BB0_38 Depth 2
	move	$t1, $zero
	beqz	$a4, .LBB0_37
# %bb.33:                               # %.lr.ph990.preheader
...
# %bb.39:                               #   in Loop: Header=BB0_38 Depth=2
	...
	bcnez	$fcc0, .LBB0_38
	b	.LBB0_31
.LBB0_40:                               # %.preheader966
	ori	$a2, $zero, 1
	blt	$a1, $a2, .LBB0_52
# %bb.41:                               # %.lr.ph1008.preheader
	pcalau12i	$a3, %pc_hi20(.LCPI0_19)
	fld.d	$fa0, $a3, %pc_lo12(.LCPI0_19)
	move	$a3, $zero
	movgr2fr.d	$fa1, $zero
	ori	$a4, $zero, 3
	b	.LBB0_43
	.p2align	4, , 16
.LBB0_42:                               # %._crit_edge1006
...
.LBB0_48:                               # %vector.body1478
	...
	addi.d	$a7, $a7, 32
	bnez	$t2, .LBB0_48
# %bb.49:                               # %middle.block1483
                                        #   in Loop: Header=BB0_43 Depth=1
	beq	$t0, $t1, .LBB0_42
.LBB0_50:                               # %scalar.ph1476.preheader
                                        #   in Loop: Header=BB0_43 Depth=1
	slli.d	$a7, $a5, 3
	sub.d	$a5, $a6, $a5
	addi.d	$a5, $a5, 1
	.p2align	4, , 16
.LBB0_51:                               # %scalar.ph1476
                                        #   Parent Loop BB0_43 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.d	$fa3, $s8, $a7
	fmul.d	$fa3, $fa2, $fa3
	...
	bnez	$a5, .LBB0_51
	b	.LBB0_42
.LBB0_52:                               # %._crit_edge1009
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	ld.w	$a1, $a1, 192
	bne	$a1, $a2, .LBB0_56
# %bb.53:                               # %._crit_edge1009
	ori	$a1, $zero, 1
	ld.d	$s8, $sp, 296                   # 8-byte Folded Reload
	blt	$a0, $a1, .LBB0_56
# %bb.54:                               # %.lr.ph1011.preheader
...
.LBB0_64:                               # %vector.body1492
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_64
# %bb.65:                               # %middle.block1498
                                        #   in Loop: Header=BB0_59 Depth=1
	beq	$a7, $t0, .LBB0_58
.LBB0_66:                               # %scalar.ph1485.preheader
                                        #   in Loop: Header=BB0_59 Depth=1
	slli.d	$a6, $a4, 3
	sub.d	$a4, $a5, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB0_67:                               # %scalar.ph1485
                                        #   Parent Loop BB0_59 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.d	$fa2, $s5, $a6
	fmul.d	$fa2, $fa2, $fa1
...
.LBB0_69:
	...
	ori	$s0, $zero, 1
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.thm)
	addi.d	$s8, $a0, %pc_lo12(L3psycho_anal.thm)
...
# %bb.70:                               # %.lr.ph1131
	...
	addi.d	$s5, $a0, %pc_lo12(L3psycho_anal.numlines_s)
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.s3_l)
	addi.d	$a0, $a0, %pc_lo12(L3psycho_anal.s3_l)
	st.d	$a0, $sp, 200                   # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.ax_sav)
	addi.d	$a2, $a0, %pc_lo12(L3psycho_anal.ax_sav)
	ori	$a0, $zero, 2056
	st.d	$a2, $sp, 160                   # 8-byte Folded Spill
	add.d	$a3, $a2, $a0
	pcalau12i	$a2, %pc_hi20(L3psycho_anal.rx_sav)
	addi.d	$a2, $a2, %pc_lo12(L3psycho_anal.rx_sav)
	st.d	$a2, $sp, 152                   # 8-byte Folded Spill
	add.d	$a2, $a2, $a0
	st.d	$a2, $sp, 408                   # 8-byte Folded Spill
	pcalau12i	$a2, %pc_hi20(L3psycho_anal.bx_sav)
	addi.d	$a2, $a2, %pc_lo12(L3psycho_anal.bx_sav)
	st.d	$a2, $sp, 144                   # 8-byte Folded Spill
	add.d	$a0, $a2, $a0
	st.d	$a0, $sp, 400                   # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.wsamp_L)
	addi.d	$a2, $a0, %pc_lo12(L3psycho_anal.wsamp_L)
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.wsamp_S)
	addi.d	$a4, $a0, %pc_lo12(L3psycho_anal.wsamp_S)
	ori	$a0, $zero, 1952
	mul.d	$a0, $a5, $a0
...
.LBB0_72:                               # =>This Loop Header: Depth=1
	...
	addi.d	$s4, $a0, %pc_lo12(L3psycho_anal.pe)
	slli.d	$a5, $a1, 3
	ori	$a0, $zero, 488
	mul.d	$a4, $a1, $a0
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.en)
	addi.d	$a3, $a0, %pc_lo12(L3psycho_anal.en)
...
.LBB0_74:                               #   in Loop: Header=BB0_72 Depth=1
	...
	ori	$a7, $zero, 4080
	bne	$a6, $a0, .LBB0_83
# %bb.75:                               # %vector.body1577.preheader
...
.LBB0_76:                               # %vector.body1577
	...
	vstx	$vr1, $a1, $a7
	bnez	$a0, .LBB0_76
# %bb.77:                               # %vector.body1563.preheader
                                        #   in Loop: Header=BB0_72 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_78:                               # %vector.body1563
                                        #   Parent Loop BB0_72 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $t0, $a1
	vldx	$vr1, $a2, $t2
	...
	vstx	$vr1, $a2, $a3
	bne	$a1, $a0, .LBB0_78
# %bb.79:                               # %vector.body1549.preheader
                                        #   in Loop: Header=BB0_72 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_80:                               # %vector.body1549
                                        #   Parent Loop BB0_72 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $t0, $a1
	vld	$vr1, $a2, 2032
	...
	vstx	$vr1, $a2, $a3
	bne	$a1, $a0, .LBB0_80
# %bb.81:                               # %vector.body1535.preheader
                                        #   in Loop: Header=BB0_72 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_82:                               # %vector.body1535
                                        #   Parent Loop BB0_72 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $t0, $a1
	vld	$vr1, $a2, 1008
...
.LBB0_83:                               # %.loopexit960
	...
	addi.d	$ra, $a5, %pc_lo12(L3psycho_anal.energy)
	fst.s	$fa0, $ra, 0
	addi.d	$a5, $sp, 608
	alsl.d	$a5, $a6, $a5, 2
	ori	$a6, $zero, 4092
...
# %bb.85:                               # %.preheader958
	...
	addi.d	$fp, $a5, %pc_lo12(L3psycho_anal.energy_s)
	fst.s	$fa0, $fp, 1032
...
# %bb.106:                              #   in Loop: Header=BB0_101 Depth=2
	...
	fcvt.s.d	$fa0, $fa0
	b	.LBB0_100
.LBB0_107:                              # %call.sqrt2000
                                        #   in Loop: Header=BB0_101 Depth=2
	fmov.s	$fa0, $fa1
	st.d	$ra, $sp, 440                   # 8-byte Folded Spill
	fst.s	$ft0, $sp, 416                  # 4-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrtf)
	jirl	$ra, $ra, 0
	fld.s	$ft0, $sp, 416                  # 4-byte Folded Reload
...
.LBB0_125:                              # %.preheader955
                                        #   in Loop: Header=BB0_72 Depth=1
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.numlines_l)
	addi.d	$s1, $a0, %pc_lo12(L3psycho_anal.numlines_l)
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.eb)
	addi.d	$s4, $a0, %pc_lo12(L3psycho_anal.eb)
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.cb)
	addi.d	$s2, $a0, %pc_lo12(L3psycho_anal.cb)
	blt	$a2, $s0, .LBB0_133
...
.LBB0_141:                              # %._crit_edge1069
                                        #   in Loop: Header=BB0_72 Depth=1
	ld.w	$a0, $t6, %pc_lo12(L3psycho_anal.npart_l)
	ld.d	$a2, $sp, 576                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 448                   # 8-byte Folded Reload
	stx.d	$zero, $a2, $a1
	pcalau12i	$a1, %pc_hi20(L3psycho_anal.thr)
	addi.d	$s8, $a1, %pc_lo12(L3psycho_anal.thr)
	blt	$a0, $s0, .LBB0_156
# %bb.142:                              # %.lr.ph1081.preheader
                                        #   in Loop: Header=BB0_72 Depth=1
...
.LBB0_154:                              # %._crit_edge1076.thread
	...
	fldx.d	$fa1, $a0, $s3
	fcmp.clt.d	$fcc0, $fa1, $fa0
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.nb_1)
	addi.d	$a0, $a0, %pc_lo12(L3psycho_anal.nb_1)
	ld.d	$a2, $sp, 576                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	fldx.d	$fa2, $a0, $s3
	...
	pcalau12i	$a2, %pc_hi20(L3psycho_anal.qthr_l)
	addi.d	$a2, $a2, %pc_lo12(L3psycho_anal.qthr_l)
	fldx.d	$fa3, $a2, $s3
...
.LBB0_173:                              # %.preheader952
	...
	ld.w	$a2, $a2, %pc_lo12(L3psycho_anal.npart_s_orig)
	ld.w	$a3, $t6, %pc_lo12(L3psycho_anal.npart_s)
	move	$a4, $zero
...
.LBB0_188:                              # %.lr.ph1113
	...
	b	.LBB0_185
	.p2align	4, , 16
.LBB0_189:                              # %.preheader948.preheader
                                        #   in Loop: Header=BB0_175 Depth=2
	move	$a5, $zero
	b	.LBB0_191
	.p2align	4, , 16
...
.LBB0_221:                              #   in Loop: Header=BB0_223 Depth=1
	fdiv.d	$fa0, $fa1, $fa0
	vst	$vr4, $sp, 464                  # 16-byte Folded Spill
	pcaddu18i	$ra, %call36(log10)
	jirl	$ra, $ra, 0
...
.LBB0_272:
	st.d	$zero, $s3, 0
.LBB0_273:
	fld.d	$fs7, $sp, 1128                 # 8-byte Folded Reload
	fld.d	$fs6, $sp, 1136                 # 8-byte Folded Reload
	fld.d	$fs5, $sp, 1144                 # 8-byte Folded Reload
	fld.d	$fs4, $sp, 1152                 # 8-byte Folded Reload
