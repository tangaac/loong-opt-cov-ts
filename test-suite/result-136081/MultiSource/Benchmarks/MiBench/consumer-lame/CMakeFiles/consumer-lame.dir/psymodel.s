...
# %bb.0:
	...
	addi.d	$s8, $a0, %pc_lo12(L3psycho_anal.bu_s)
	...
	pcalau12i	$s5, %pc_hi20(L3psycho_anal.npart_s)
...
.LBB0_9:                                # %vector.ph
	...
	addi.d	$s7, $a0, %pc_lo12(L3psycho_anal.partition_l)
	ori	$a1, $zero, 255
	ori	$a2, $zero, 2052
	move	$a0, $s7
	pcaddu18i	$ra, %call36(memset)
	...
	addi.d	$s6, $a2, %pc_lo12(L3psycho_anal.s3_s)
...
# %bb.11:
	...
	addi.w	$a0, $a7, 1
	st.w	$a0, $s5, %pc_lo12(L3psycho_anal.npart_s)
	blt	$t0, $t1, .LBB0_14
# %bb.12:
	bge	$a7, $a5, .LBB0_15
.LBB0_13:
...
.LBB0_14:
	...
	blt	$a7, $a5, .LBB0_13
.LBB0_15:
	st.w	$a5, $s5, %pc_lo12(L3psycho_anal.npart_s)
	st.w	$a3, $s1, 44
...
.LBB0_45:                               # %vector.body1478
	...
	addi.d	$a7, $a7, 64
	bnez	$t2, .LBB0_45
# %bb.46:                               # %middle.block1483
                                        #   in Loop: Header=BB0_40 Depth=1
	beq	$t0, $t1, .LBB0_39
.LBB0_47:                               # %scalar.ph1476.preheader
                                        #   in Loop: Header=BB0_40 Depth=1
	slli.d	$a7, $a5, 3
	sub.d	$a5, $a6, $a5
	addi.d	$a5, $a5, 1
	.p2align	4, , 16
.LBB0_48:                               # %scalar.ph1476
                                        #   Parent Loop BB0_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.d	$fa3, $fp, $a7
	fmul.d	$fa3, $fa2, $fa3
...
.LBB0_52:                               # %.lr.ph1011
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s5, %pc_lo12(L3psycho_anal.npart_s)
	fst.d	$fa0, $s2, 0
	addi.d	$fp, $fp, 1
	addi.d	$s2, $s2, 8
	blt	$fp, $a0, .LBB0_52
...
.LBB0_61:                               # %vector.body1492
	...
	addi.d	$a6, $a6, 64
	bnez	$t1, .LBB0_61
# %bb.62:                               # %middle.block1498
                                        #   in Loop: Header=BB0_56 Depth=1
	beq	$a7, $t0, .LBB0_55
.LBB0_63:                               # %scalar.ph1485.preheader
                                        #   in Loop: Header=BB0_56 Depth=1
	slli.d	$a6, $a4, 3
	sub.d	$a4, $a5, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB0_64:                               # %scalar.ph1485
                                        #   Parent Loop BB0_56 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fldx.d	$fa2, $s6, $a6
	fmul.d	$fa2, $fa2, $fa1
...
# %bb.67:                               # %.lr.ph1131
	...
	addi.d	$a1, $a0, %pc_lo12(L3psycho_anal.wsamp_S)
	ori	$a0, $zero, 1952
	mul.d	$a0, $a2, $a0
...
.LBB0_71:                               #   in Loop: Header=BB0_69 Depth=1
	...
	ld.d	$s3, $sp, 424                   # 8-byte Folded Reload
	bne	$fp, $a0, .LBB0_80
# %bb.72:                               # %vector.body1577.preheader
...
.LBB0_73:                               # %vector.body1577
	...
	xvstx	$xr1, $a1, $a5
	bnez	$a0, .LBB0_73
# %bb.74:                               # %vector.body1563.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_75:                               # %vector.body1563
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $t0, $a1
	xvldx	$xr1, $a2, $a6
	...
	xvstx	$xr1, $a2, $a3
	bne	$a1, $a0, .LBB0_75
# %bb.76:                               # %vector.body1549.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_77:                               # %vector.body1549
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $t0, $a1
	xvld	$xr1, $a2, 2016
...
# %bb.82:                               # %.preheader958
	...
	addi.d	$s7, $a5, %pc_lo12(L3psycho_anal.energy_s)
	fst.s	$fa0, $s7, 1032
...
# %bb.103:                              #   in Loop: Header=BB0_98 Depth=2
	...
	fcvt.s.d	$fa0, $fa0
	b	.LBB0_97
.LBB0_104:                              # %call.sqrt1993
                                        #   in Loop: Header=BB0_98 Depth=2
	fmov.s	$fa0, $fa1
	st.d	$t2, $sp, 512                   # 8-byte Folded Spill
	st.d	$t3, $sp, 496                   # 8-byte Folded Spill
	fst.s	$ft0, $sp, 368                  # 4-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrtf)
	jirl	$ra, $ra, 0
	fld.s	$ft0, $sp, 368                  # 4-byte Folded Reload
...
.LBB0_170:                              # %.preheader952
	...
	ld.w	$a3, $a3, %pc_lo12(L3psycho_anal.npart_s)
	move	$a4, $zero
	ori	$t8, $zero, 12
	b	.LBB0_172
	.p2align	4, , 16
...
.LBB0_185:                              # %.lr.ph1113
	...
	b	.LBB0_182
	.p2align	4, , 16
.LBB0_186:                              # %.preheader948.preheader
                                        #   in Loop: Header=BB0_172 Depth=2
	move	$a5, $zero
	b	.LBB0_188
	.p2align	4, , 16
