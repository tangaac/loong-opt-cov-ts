...
.LBB4_35:                               # %vector.body
	...
	xvfcvt.s.d	$xr6, $xr8, $xr6
	xvftintrz.w.s	$xr6, $xr6
	xvpermi.d	$xr8, $xr7, 238
	xvfcvt.s.d	$xr7, $xr8, $xr7
...
# %bb.52:                               #   in Loop: Header=BB4_51 Depth=1
	...
	b	.LBB4_62
	.p2align	4, , 16
.LBB4_53:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB4_51 Depth=1
	bgeu	$a0, $t3, .LBB4_55
# %bb.54:                               #   in Loop: Header=BB4_51 Depth=1
	...
	b	.LBB4_59
	.p2align	4, , 16
.LBB4_55:                               # %vector.body512.preheader
                                        #   in Loop: Header=BB4_51 Depth=1
	move	$t4, $a7
	move	$t5, $a4
	.p2align	4, , 16
.LBB4_56:                               # %vector.body512
...
# %bb.58:                               # %vec.epilog.iter.check
	...
	move	$t5, $a4
	beqz	$a5, .LBB4_62
.LBB4_59:                               # %vec.epilog.ph
                                        #   in Loop: Header=BB4_51 Depth=1
	add.d	$t4, $t0, $t6
	alsl.d	$t5, $t6, $t1, 2
	.p2align	4, , 16
.LBB4_60:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB4_51 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr4, $t5, 0
	vmul.w	$vr4, $vr2, $vr4
...
# %bb.61:                               # %vec.epilog.middle.block
	...
	move	$t5, $a6
	beq	$a6, $a0, .LBB4_50
.LBB4_62:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB4_51 Depth=1
	slli.d	$t4, $t5, 2
	sub.d	$t5, $a0, $t5
	.p2align	4, , 16
.LBB4_63:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB4_51 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$t6, $t1, $t4
	mul.w	$t6, $a2, $t6
...
.LBB4_64:                               # %.loopexit
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB4_110
.LBB4_65:                               # %.preheader342.lr.ph
	ld.w	$a0, $s3, 204
	addi.d	$s6, $s7, 48
	ori	$a3, $zero, 1
	lu12i.w	$a2, 1
	blt	$a0, $a3, .LBB4_89
# %bb.66:                               # %.preheader342.preheader
	move	$s1, $zero
	addi.d	$a4, $s7, 288
	move	$a3, $a2
	lu12i.w	$a2, 2
	...
	b	.LBB4_69
	.p2align	4, , 16
.LBB4_67:                               # %._crit_edge399.loopexit
...
# %bb.74:                               # %.peel.next.thread
	...
	bnez	$a0, .LBB4_77
	.p2align	4, , 16
# %bb.75:                               #   in Loop: Header=BB4_69 Depth=1
...
.LBB4_77:                               # %.peel.next
	...
	mul.d	$s1, $s7, $a1
	beqz	$a0, .LBB4_79
# %bb.78:                               #   in Loop: Header=BB4_69 Depth=1
	ld.w	$a0, $s3, 92
	addi.d	$a1, $sp, 352
	alsl.d	$a1, $s7, $a1, 3
	slli.d	$a0, $a0, 1
...
.LBB4_80:                               #   in Loop: Header=BB4_69 Depth=1
	...
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB4_67
.LBB4_81:                               # %.peel.next444.preheader
                                        #   in Loop: Header=BB4_69 Depth=1
	ori	$s1, $zero, 2
...
# %bb.87:                               #   in Loop: Header=BB4_85 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB4_83
.LBB4_88:                               # %.preheader341
	ori	$a0, $zero, 1
	lu12i.w	$a2, 1
	blt	$a1, $a0, .LBB4_110
.LBB4_89:                               # %.preheader340.lr.ph
	ld.w	$a0, $s3, 204
	ori	$a3, $zero, 1
	blt	$a0, $a3, .LBB4_99
# %bb.90:                               # %.preheader340.preheader
	move	$s2, $zero
	ori	$s0, $a2, 512
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
	b	.LBB4_93
	.p2align	4, , 16
.LBB4_91:                               # %._crit_edge403.loopexit
                                        #   in Loop: Header=BB4_93 Depth=1
	ld.w	$a1, $s8, 200
	move	$s3, $s8
	lu12i.w	$a2, 1
	move	$s6, $fp
.LBB4_92:                               # %._crit_edge403
                                        #   in Loop: Header=BB4_93 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s6, $s6, 240
	add.d	$s1, $s1, $s0
	bge	$s2, $a1, .LBB4_98
.LBB4_93:                               # %.preheader340
                                        # =>This Loop Header: Depth=1
...
# %bb.97:                               #   in Loop: Header=BB4_96 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB4_95
.LBB4_98:                               # %.preheader339
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB4_110
.LBB4_99:                               # %.preheader338.lr.ph
	ld.w	$a6, $s3, 204
	ori	$a0, $zero, 1
	blt	$a6, $a0, .LBB4_110
# %bb.100:                              # %.preheader338.preheader
	move	$a4, $a2
	move	$a2, $zero
	lu12i.w	$a3, -2
	ori	$a3, $a3, 3584
	...
	b	.LBB4_103
	.p2align	4, , 16
.LBB4_101:                              # %._crit_edge407.loopexit
                                        #   in Loop: Header=BB4_103 Depth=1
	ld.w	$a1, $s3, 200
.LBB4_102:                              # %._crit_edge407
                                        #   in Loop: Header=BB4_103 Depth=1
	addi.d	$a2, $a2, 1
...
.LBB4_107:                              #   in Loop: Header=BB4_108 Depth=3
	...
	addi.d	$a6, $a6, 4
	beqz	$t1, .LBB4_105
.LBB4_108:                              #   Parent Loop BB4_103 Depth=1
...
.LBB8_46:                               # %vector.body166
	...
	movfr2gr.d	$s3, $fa7
	xvinsgr2vr.d	$xr6, $s3, 1
	movfr2gr.d	$s3, $ft0
	xvinsgr2vr.d	$xr6, $s3, 2
	movfr2gr.d	$s3, $ft1
	xvinsgr2vr.d	$xr6, $s3, 3
	xvfmul.d	$xr6, $xr4, $xr6
