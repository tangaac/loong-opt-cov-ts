...
.LBB3_59:                               # %vector.body159
	...
	vld	$vr19, $sp, 384
	vpickve2gr.w	$s1, $vr17, 2
	vpickve2gr.w	$t6, $vr17, 1
	...
	st.h	$zero, $sp, 225
	xvld	$xr17, $sp, 576
	vpickve2gr.b	$a2, $vr17, 7
	st.b	$a2, $sp, 252
	vpickve2gr.b	$a2, $vr17, 6
	st.b	$a2, $sp, 248
	vpickve2gr.b	$a2, $vr17, 5
	st.b	$a2, $sp, 244
	vpickve2gr.b	$a2, $vr17, 4
	st.b	$a2, $sp, 240
	vpickve2gr.b	$a2, $vr17, 3
	st.b	$a2, $sp, 236
	vpickve2gr.b	$a2, $vr17, 2
	st.b	$a2, $sp, 232
	vpickve2gr.b	$a2, $vr17, 1
	st.b	$a2, $sp, 228
	...
	st.h	$zero, $sp, 289
	xvld	$xr18, $sp, 512
	vpickve2gr.b	$a2, $vr18, 7
	st.b	$a2, $sp, 316
	vpickve2gr.b	$a2, $vr18, 6
	st.b	$a2, $sp, 312
	vpickve2gr.b	$a2, $vr18, 5
	st.b	$a2, $sp, 308
	vpickve2gr.b	$a2, $vr18, 4
	st.b	$a2, $sp, 304
	vpickve2gr.b	$a2, $vr18, 3
	st.b	$a2, $sp, 300
	vpickve2gr.b	$a2, $vr18, 2
	st.b	$a2, $sp, 296
	vpickve2gr.b	$a2, $vr18, 1
	st.b	$a2, $sp, 292
	vpickve2gr.b	$a2, $vr18, 0
	st.b	$a2, $sp, 288
	xvld	$xr18, $sp, 288
	ldx.b	$a2, $t1, $a5
	ldx.b	$a3, $t1, $t2
	...
	st.h	$zero, $sp, 257
	xvld	$xr19, $sp, 544
	vpickve2gr.b	$a2, $vr19, 7
	st.b	$a2, $sp, 284
	vpickve2gr.b	$a2, $vr19, 6
	st.b	$a2, $sp, 280
	vpickve2gr.b	$a2, $vr19, 5
	st.b	$a2, $sp, 276
	vpickve2gr.b	$a2, $vr19, 4
	st.b	$a2, $sp, 272
	vpickve2gr.b	$a2, $vr19, 3
	st.b	$a2, $sp, 268
	vpickve2gr.b	$a2, $vr19, 2
	st.b	$a2, $sp, 264
	vpickve2gr.b	$a2, $vr19, 1
	st.b	$a2, $sp, 260
	vpickve2gr.b	$a2, $vr19, 0
	st.b	$a2, $sp, 256
	xvld	$xr19, $sp, 256
	vst	$vr20, $sp, 480
	st.b	$zero, $sp, 351
	...
	st.h	$zero, $sp, 321
	xvld	$xr20, $sp, 480
	vpickve2gr.b	$a2, $vr20, 7
	st.b	$a2, $sp, 348
	vpickve2gr.b	$a2, $vr20, 6
	st.b	$a2, $sp, 344
	vpickve2gr.b	$a2, $vr20, 5
	st.b	$a2, $sp, 340
	vpickve2gr.b	$a2, $vr20, 4
	st.b	$a2, $sp, 336
	vpickve2gr.b	$a2, $vr20, 3
	st.b	$a2, $sp, 332
	vpickve2gr.b	$a2, $vr20, 2
	st.b	$a2, $sp, 328
	vpickve2gr.b	$a2, $vr20, 1
	st.b	$a2, $sp, 324
