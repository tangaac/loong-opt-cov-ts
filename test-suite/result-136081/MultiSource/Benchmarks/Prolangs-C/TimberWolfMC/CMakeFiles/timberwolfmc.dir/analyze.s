...
.LBB0_24:                               # %vector.body
	...
	vsub.w	$vr0, $vr0, $vr8
	vsub.w	$vr1, $vr1, $vr9
	vbitsel.v	$vr6, $vr2, $vr6, $vr8
	vbitsel.v	$vr7, $vr2, $vr7, $vr9
	vadd.w	$vr4, $vr6, $vr4
	vadd.w	$vr5, $vr7, $vr5
	addi.d	$a4, $a4, -8
	addi.d	$a3, $a3, 64
...
# %bb.45:                               #   in Loop: Header=BB3_3 Depth=1
	...
	ld.d	$t3, $sp, 0                     # 8-byte Folded Reload
	b	.LBB3_2
.LBB3_46:                               # %vector.main.loop.iter.check148
                                        #   in Loop: Header=BB3_3 Depth=1
...
.LBB3_52:                               # %vec.epilog.ph165
	...
	add.d	$a1, $s0, $a1
	.p2align	4, , 16
.LBB3_53:                               # %vec.epilog.vector.body172
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$t0, .LBB3_53
# %bb.54:                               # %vec.epilog.middle.block179
                                        #   in Loop: Header=BB3_3 Depth=1
	bne	$a7, $a3, .LBB3_11
	b	.LBB3_12
