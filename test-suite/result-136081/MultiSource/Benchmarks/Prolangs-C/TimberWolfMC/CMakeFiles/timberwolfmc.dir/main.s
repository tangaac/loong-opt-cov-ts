...
.LBB0_53:                               # %call.sqrt233
	...
	fmov.d	$fs0, $fa0
	b	.LBB0_51
.LBB0_54:                               # %._crit_edge127.loopexit
	movgr2fr.w	$fa0, $a0
	ffint.d.w	$fa0, $fa0
.LBB0_55:                               # %._crit_edge127
	fdiv.d	$fa0, $fs5, $fa0
	fsqrt.d	$fs0, $fa0
	fcmp.cor.d	$fcc0, $fs0, $fs0
...
# %bb.71:                               # %middle.block174
	...
	beq	$a4, $a5, .LBB0_74
.LBB0_72:                               # %scalar.ph161.preheader
	alsl.d	$a3, $a2, $a3, 3
	addi.d	$a3, $a3, 8
	.p2align	4, , 16
.LBB0_73:                               # %scalar.ph161
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	ld.w	$a4, $a4, 8
	addi.d	$a2, $a2, 1
...
.Lfunc_end0:
	...
	.p2align	4, 0x0                          # -- Begin function prepSpots
.LCPI1_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
# %bb.42:                               # %.preheader.us.preheader
	...
	b	.LBB1_44
	.p2align	4, , 16
.LBB1_43:                               # %._crit_edge167.us
                                        #   in Loop: Header=BB1_44 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB1_39
.LBB1_44:                               # %.preheader.us
                                        # =>This Loop Header: Depth=1
...
.LBB1_51:                               # %vector.body
	...
	vfmul.d	$vr11, $vr2, $vr13
	vfmul.d	$vr13, $vr2, $vr14
	vfmul.d	$vr12, $vr2, $vr12
	vfmul.d	$vr14, $vr2, $vr15
	vfmul.d	$vr13, $vr13, $vr3
	vfmul.d	$vr11, $vr11, $vr3
	vfmul.d	$vr14, $vr14, $vr3
	vfmul.d	$vr12, $vr12, $vr3
	vreplvei.d	$vr15, $vr11, 0
	ftintrz.w.d	$ft7, $ft7
	movfr2gr.s	$t3, $ft7
