...
.LBB0_24:                               #   in Loop: Header=BB0_9 Depth=2
	...
	bnez	$a0, .LBB0_96
	b	.LBB0_88
.LBB0_25:                               # %vector.main.loop.iter.check401
                                        #   in Loop: Header=BB0_9 Depth=2
...
# %bb.26:                               #   in Loop: Header=BB0_9 Depth=2
	...
	move	$a0, $zero
	b	.LBB0_45
.LBB0_27:                               # %vector.main.loop.iter.check473
                                        #   in Loop: Header=BB0_9 Depth=2
	bstrpick.d	$a2, $a0, 31, 0
	addi.d	$ra, $a2, 1
	ori	$a2, $zero, 15
...
.LBB0_41:                               # %vector.body381
	...
	xvinsgr2vr.w	$xr3, $t6, 4
	xvinsgr2vr.w	$xr3, $t7, 5
	xvinsgr2vr.w	$xr3, $t8, 6
	xvinsgr2vr.w	$xr3, $fp, 7
	ld.w	$a2, $a0, 20
	ld.w	$a7, $a0, 40
	ld.w	$t2, $a0, 60
	ld.w	$t4, $a0, 80
...
# %bb.43:                               #   in Loop: Header=BB0_9 Depth=2
	...
	ld.d	$t6, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_92
.LBB0_44:                               # %vec.epilog.iter.check417
                                        #   in Loop: Header=BB0_9 Depth=2
	andi	$a2, $s8, 12
	ori	$s0, $zero, 3
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
...
.LBB0_45:                               # %vec.epilog.ph416
	...
	add.d	$t1, $t1, $a7
	.p2align	4, , 16
.LBB0_46:                               # %vec.epilog.vector.body422
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_9 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a7, $t1, -40
...
# %bb.47:                               # %vec.epilog.middle.block427
	...
	bne	$s8, $a2, .LBB0_57
	b	.LBB0_59
.LBB0_48:                               # %vec.epilog.iter.check489
                                        #   in Loop: Header=BB0_9 Depth=2
	andi	$a2, $ra, 12
	ori	$s0, $zero, 3
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
...
.LBB0_49:                               # %vec.epilog.ph488
	...
	add.d	$t0, $t0, $a7
	.p2align	4, , 16
.LBB0_50:                               # %vec.epilog.vector.body494
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_9 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a7, $t0, -40
...
# %bb.68:                               #   in Loop: Header=BB0_9 Depth=2
	...
	move	$t0, $t2
	b	.LBB0_80
.LBB0_69:                               # %vector.main.loop.iter.check437
                                        #   in Loop: Header=BB0_9 Depth=2
	bstrpick.d	$a2, $a0, 31, 0
	addi.d	$s8, $a2, 1
	ori	$a2, $zero, 15
...
.LBB0_72:                               # %vector.body441
	...
	xvinsgr2vr.w	$xr3, $t6, 3
	xvinsgr2vr.w	$xr3, $t7, 4
	xvinsgr2vr.w	$xr3, $t8, 5
	xvinsgr2vr.w	$xr3, $fp, 6
...
# %bb.74:                               #   in Loop: Header=BB0_9 Depth=2
	...
	ld.d	$t6, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_82
.LBB0_75:                               # %vec.epilog.iter.check453
                                        #   in Loop: Header=BB0_9 Depth=2
	andi	$a2, $s8, 12
	ori	$s0, $zero, 3
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
...
.LBB0_76:                               # %vec.epilog.ph452
	...
	add.d	$t1, $t1, $a7
	.p2align	4, , 16
.LBB0_77:                               # %vec.epilog.vector.body458
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_9 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a7, $t1, -40
...
.LBB0_111:                              # %vector.body367
	...
	addi.d	$t7, $t7, 88
	bnez	$t8, .LBB0_111
# %bb.112:                              # %middle.block371
                                        #   in Loop: Header=BB0_107 Depth=3
	beq	$t0, $a7, .LBB0_106
.LBB0_113:                              # %.lr.ph240.preheader504
                                        #   in Loop: Header=BB0_107 Depth=3
	mul.d	$a7, $a2, $a3
	add.d	$a7, $s2, $a7
	.p2align	4, , 16
...
# %bb.117:                              # %middle.block
                                        #   in Loop: Header=BB0_9 Depth=2
	beq	$t0, $a7, .LBB0_8
.LBB0_118:                              # %.lr.ph252.preheader505
                                        #   in Loop: Header=BB0_9 Depth=2
	mul.d	$a7, $a2, $a3
	add.d	$a7, $s2, $a7
	.p2align	4, , 16
