...
.LBB21_36:                              #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr4, -912
.LBB21_37:                              # %factorial.exit31.i14.i
                                        #   in Loop: Header=BB21_40 Depth=2
	fdiv.d	$fa3, $fa3, $fa4
.LBB21_38:                              # %combination.exit37.i
                                        #   in Loop: Header=BB21_40 Depth=2
	fmul.d	$fa2, $fa2, $fa3
.LBB21_39:                              # %probability.exit
	...
	addi.d	$a6, $a6, 1
	beq	$s0, $t2, .LBB21_34
.LBB21_40:                              #   Parent Loop BB21_35 Depth=1
...
# %bb.42:                               # %.preheader.i.i
                                        #   in Loop: Header=BB21_40 Depth=2
	blt	$t3, $a2, .LBB21_53
# %bb.43:                               # %.lr.ph40.i.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	move	$t4, $t0
	move	$t5, $t1
	.p2align	4, , 16
.LBB21_44:                              # %.lr.ph40.i.i
...
.LBB21_46:                              # %.lr.ph.i.i.i
	...
	b	.LBB21_52
	.p2align	4, , 16
.LBB21_47:                              # %.preheader32.i.i
                                        #   in Loop: Header=BB21_40 Depth=2
	bge	$t3, $t0, .LBB21_50
# %bb.48:                               # %.lr.ph.i.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	move	$t5, $t0
	.p2align	4, , 16
.LBB21_49:                              # %.lr.ph.i.i
	...
	fmul.d	$fa2, $fa2, $fa3
	blt	$t3, $t5, .LBB21_49
.LBB21_50:                              # %._crit_edge.i.i
                                        #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr3, -912
	blt	$t4, $a2, .LBB21_52
	.p2align	4, , 16
.LBB21_51:                              # %.lr.ph.i28.i.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$t3, $t4
...
.LBB21_53:                              # %combination.exit.i
	...
	sub.w	$t4, $t3, $t2
	bge	$t2, $t4, .LBB21_59
# %bb.54:                               # %.preheader.i24.i
                                        #   in Loop: Header=BB21_40 Depth=2
	beqz	$t2, .LBB21_64
# %bb.55:                               # %.lr.ph40.i29.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	move	$t4, $zero
	vldi	$vr3, -912
	.p2align	4, , 16
.LBB21_56:                              # %.lr.ph40.i29.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t5, $t3, $t4
	...
	fmul.d	$fa3, $fa3, $fa4
	bnez	$t5, .LBB21_56
# %bb.57:                               # %.lr.ph.i.i34.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr4, -912
	move	$t3, $a6
	.p2align	4, , 16
.LBB21_58:                              # %.lr.ph.i.i34.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	addi.w	$t3, $t3, -1
	...
	b	.LBB21_37
	.p2align	4, , 16
.LBB21_59:                              # %.preheader32.i10.i
                                        #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr3, -912
	bge	$t2, $t3, .LBB21_61
	.p2align	4, , 16
.LBB21_60:                              # %.lr.ph.i20.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movgr2fr.w	$fa4, $t3
	...
	fmul.d	$fa3, $fa3, $fa4
	blt	$t2, $t3, .LBB21_60
.LBB21_61:                              # %._crit_edge.i12.i
                                        #   in Loop: Header=BB21_40 Depth=2
	blt	$t4, $a2, .LBB21_36
# %bb.62:                               # %.lr.ph.i28.i17.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	sub.w	$t3, $zero, $t0
	vldi	$vr4, -912
	.p2align	4, , 16
.LBB21_63:                              # %.lr.ph.i28.i17.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t4, $a7, $t3
...
.LBB21_64:                              #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr3, -912
	b	.LBB21_38
.LBB21_65:                              # %.preheader77
	movgr2fr.d	$fs0, $zero
	fmov.d	$fs1, $fs0
	fmov.d	$fs2, $fs0
	bge	$s3, $s2, .LBB21_70
# %bb.66:                               # %.lr.ph109.preheader
	alsl.d	$a2, $s3, $a0, 4
	addi.d	$a3, $a2, 24
	sub.d	$a1, $s2, $s3
	movgr2fr.d	$fs1, $zero
