...
.LBB3_3:                                # %append_states.exit.thread14
                                        #   in Loop: Header=BB3_4 Depth=1
...
# %bb.14:                               #   in Loop: Header=BB3_4 Depth=1
	move	$a5, $a4
	b	.LBB3_25
.LBB3_15:                               # %vector.main.loop.iter.check36
                                        #   in Loop: Header=BB3_4 Depth=1
	srli.d	$a3, $a5, 1
	addi.d	$a3, $a3, 1
	ori	$a6, $zero, 62
...
.LBB3_18:                               # %vector.body40
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_18
# %bb.19:                               # %middle.block47
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a6, .LBB3_26
# %bb.20:                               # %vec.epilog.iter.check52
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a5, $a3, 24
	beqz	$a5, .LBB3_24
.LBB3_21:                               # %vec.epilog.ph51
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a7, $a3
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB3_22:                               # %vec.epilog.vector.body57
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $t0, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a6, .LBB3_22
# %bb.23:                               # %vec.epilog.middle.block65
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a3, $a7, .LBB3_25
	b	.LBB3_26
...
# %bb.51:                               #   in Loop: Header=BB3_4 Depth=1
	move	$a5, $a4
	b	.LBB3_62
.LBB3_52:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB3_4 Depth=1
	srli.d	$a3, $a5, 1
	addi.d	$a3, $a3, 1
	ori	$a6, $zero, 62
...
.LBB3_58:                               # %vec.epilog.ph
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB3_59:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $t0, 0
...
# %bb.1:                                # %.lr.ph
	...
	ld.d	$a2, $a2, 0
	pcalau12i	$fp, %pc_hi20(redset)
	ld.d	$a3, $fp, %pc_lo12(redset)
	move	$s0, $zero
	addi.w	$a4, $zero, -1
	b	.LBB5_3
	.p2align	4, , 16
...
.LBB9_17:
	move	$a2, $a1
.LBB9_18:                               # %vec.epilog.scalar.ph155.preheader
	addi.d	$a1, $a2, 1
	alsl.d	$a3, $a2, $a0, 1
	addi.d	$a3, $a3, 12
	alsl.d	$a2, $a2, $fp, 1
	...
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB9_19:                               # %vec.epilog.scalar.ph155
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a5, $a2, 0
	st.h	$a5, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB9_45:                               # %vec.epilog.ph156
	...
	add.d	$a6, $a6, $fp
	addi.d	$a6, $a6, -4
.LBB9_46:                               # %vec.epilog.vector.body162
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a3, 0
	addi.d	$a5, $a5, 8
	...
	addi.d	$a6, $a6, -16
	bnez	$a5, .LBB9_46
# %bb.47:                               # %vec.epilog.middle.block168
	bne	$a4, $a1, .LBB9_18
	b	.LBB9_20
.LBB9_48:                               # %vector.ph144
...
# %bb.50:                               # %middle.block152
	beq	$a3, $a1, .LBB9_20
# %bb.51:                               # %vec.epilog.iter.check157
	andi	$a2, $a1, 8
	bnez	$a2, .LBB9_45
# %bb.52:
	andi	$a2, $a1, 15
...
# %bb.41:
	move	$a5, $zero
	b	.LBB10_48
.LBB10_42:                              # %vector.main.loop.iter.check96
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 62
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_51
...
.LBB10_52:                              # %vector.body100
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB10_52
# %bb.53:                               # %middle.block107
	beq	$a3, $a5, .LBB10_63
# %bb.54:                               # %vec.epilog.iter.check112
	andi	$a4, $a3, 24
	beqz	$a4, .LBB10_61
.LBB10_55:                              # %vec.epilog.ph111
	move	$a6, $a3
	bstrins.d	$a6, $zero, 2, 0
	alsl.d	$a4, $a6, $s3, 1
	alsl.d	$a2, $a6, $a2, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_56:                              # %vec.epilog.vector.body117
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_56
# %bb.57:                               # %vec.epilog.middle.block125
	bne	$a3, $a6, .LBB10_62
	b	.LBB10_63
.LBB10_58:
	alsl.d	$a4, $a5, $s1, 1
