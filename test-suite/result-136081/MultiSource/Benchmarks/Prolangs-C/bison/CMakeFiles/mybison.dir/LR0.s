...
.LBB3_17:                               # %vec.epilog.ph51
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB3_18:                               # %vec.epilog.vector.body57
	...
	addi.d	$a4, $a4, 16
	bnez	$a6, .LBB3_18
# %bb.19:                               # %vec.epilog.middle.block65
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a3, $a7, .LBB3_25
	b	.LBB3_26
.LBB3_20:                               # %vector.ph37
...
.LBB3_21:                               # %vector.body40
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB3_21
# %bb.22:                               # %middle.block47
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a6, .LBB3_26
# %bb.23:                               # %vec.epilog.iter.check52
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a5, $a3, 8
	bnez	$a5, .LBB3_17
...
.LBB3_54:                               # %vec.epilog.ph
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB3_55:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $t0, 0
...
# %bb.32:
	move	$a4, $s3
	b	.LBB10_55
.LBB10_33:                              # %vector.main.loop.iter.check119
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 30
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_43
...
.LBB10_35:                              # %vec.epilog.ph134
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_36:                              # %vec.epilog.vector.body140
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_36
# %bb.37:                               # %vec.epilog.middle.block148
	bne	$a3, $a6, .LBB10_48
	b	.LBB10_49
...
# %bb.45:                               # %middle.block130
	beq	$a3, $a5, .LBB10_49
# %bb.46:                               # %vec.epilog.iter.check135
	andi	$a4, $a3, 8
	bnez	$a4, .LBB10_35
# %bb.47:
	alsl.d	$a4, $a5, $s1, 1
