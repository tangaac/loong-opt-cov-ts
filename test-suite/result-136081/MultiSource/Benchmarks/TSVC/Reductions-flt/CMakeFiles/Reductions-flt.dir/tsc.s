...
.LBB8_2:                                # %.lr.ph
	...
	xvrepl128vei.w	$xr6, $xr1, 1
	xvst	$xr6, $sp, 608
	xvrepl128vei.w	$xr6, $xr3, 1
	xvst	$xr6, $sp, 640
	vld	$vr6, $sp, 608
	vld	$vr7, $sp, 640
	fadd.s	$fa0, $fa2, $fa0
	...
	vld	$vr3, $sp, 768
	vfadd.s	$vr2, $vr2, $vr4
	vpackev.w	$vr4, $vr6, $vr5
	vfadd.s	$vr2, $vr2, $vr4
	vpackev.w	$vr1, $vr3, $vr1
	vfadd.s	$vr1, $vr2, $vr1
	xvld	$xr2, $s0, 64
