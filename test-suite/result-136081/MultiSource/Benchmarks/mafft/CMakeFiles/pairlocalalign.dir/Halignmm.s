...
.LBB2_40:                               # %imp_match_out_veadH.exit
	...
	ori	$a0, $zero, 1
	bne	$a1, $a0, .LBB2_44
.LBB2_41:                               # %.preheader650
	ori	$a0, $zero, 1
	ld.d	$t7, $sp, 96                    # 8-byte Folded Reload
	bge	$t7, $a0, .LBB2_151
.LBB2_42:                               # %.preheader648
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	bgtz	$a0, .LBB2_167
# %bb.43:                               # %.loopexit649.thread
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	ld.d	$t2, $a0, %pc_lo12(H__align.m)
	st.w	$zero, $t2, 0
	b	.LBB2_59
.LBB2_44:                               # %.preheader653
...
.LBB2_47:                               # %vector.body863
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_47
# %bb.48:                               # %middle.block868
	beq	$a2, $a4, .LBB2_51
.LBB2_49:                               # %scalar.ph858.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $s1, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_50:                               # %scalar.ph858
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB2_54:                               # %vector.body878
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_54
# %bb.55:                               # %middle.block885
	beq	$a3, $a4, .LBB2_58
.LBB2_56:                               # %scalar.ph871.preheader
	mul.d	$a3, $a0, $a1
	alsl.d	$a4, $a1, $s2, 2
	sub.d	$a1, $a2, $a1
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_57:                               # %scalar.ph871
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB2_64:                               # %vector.body896
	...
	addi.d	$a5, $a5, 32
	bnez	$a7, .LBB2_64
# %bb.65:                               # %middle.block902
	beq	$a3, $a4, .LBB2_68
.LBB2_66:                               # %scalar.ph889.preheader
	addi.d	$a3, $s1, -4
...
# %bb.74:                               # %.lr.ph.preheader.i534
	...
	ori	$a1, $zero, 7
	bltu	$a0, $a1, .LBB2_77
# %bb.75:                               # %vector.memcheck905
                                        #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	add.d	$a0, $a4, $a1
	bgeu	$s5, $a0, .LBB2_119
# %bb.76:                               # %vector.memcheck905
                                        #   in Loop: Header=BB2_73 Depth=1
	add.d	$a0, $s5, $a1
	bgeu	$a4, $a0, .LBB2_119
...
.LBB2_122:
	...
	beqz	$a1, .LBB2_124
	b	.LBB2_138
.LBB2_123:                              # %._crit_edge707.loopexit
	ld.d	$s4, $sp, 8                     # 8-byte Folded Reload
	ld.w	$a1, $s4, 0
	move	$s1, $a2
	ld.d	$s0, $sp, 120                   # 8-byte Folded Reload
...
.LBB2_127:                              # %vector.body942
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_127
# %bb.128:                              # %middle.block949
	beq	$a2, $a4, .LBB2_131
.LBB2_129:                              # %scalar.ph933.preheader
	sub.w	$a2, $s8, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s1, 2
	sub.d	$a1, $a1, $a3
...
.LBB2_134:                              # %vector.body957
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB2_134
# %bb.135:                              # %middle.block962
	beq	$a3, $a5, .LBB2_138
.LBB2_136:                              # %scalar.ph952.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB2_137:                              # %scalar.ph952
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_216:                              # %vector.body1060
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_216
# %bb.217:                              # %middle.block1066
	beq	$a4, $a5, .LBB2_220
.LBB2_218:                              # %scalar.ph1055.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_219:                              # %scalar.ph1055
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB2_225:                              #   in Loop: Header=BB2_222 Depth=1
	...
	bnez	$t4, .LBB2_238
	.p2align	4, , 16
.LBB2_226:                              # %._crit_edge20.i612
                                        #   in Loop: Header=BB2_222 Depth=1
	beq	$t3, $a1, .LBB2_247
.LBB2_227:                              # %.lr.ph29.preheader.i614
                                        #   in Loop: Header=BB2_222 Depth=1
	addi.w	$a0, $zero, -9
	nor	$t7, $t3, $zero
	bltu	$a0, $t3, .LBB2_232
# %bb.228:                              # %.lr.ph29.preheader.i614
                                        #   in Loop: Header=BB2_222 Depth=1
	sub.d	$a0, $s8, $s1
	bltu	$a0, $a5, .LBB2_232
# %bb.229:                              # %vector.ph1075
                                        #   in Loop: Header=BB2_222 Depth=1
...
.LBB2_232:                              #   in Loop: Header=BB2_222 Depth=1
	...
	move	$t4, $s1
	move	$t5, $s8
.LBB2_233:                              # %.lr.ph29.i615.preheader
                                        #   in Loop: Header=BB2_222 Depth=1
	add.d	$t2, $t2, $t6
	.p2align	4, , 16
.LBB2_234:                              # %.lr.ph29.i615
                                        #   Parent Loop BB2_222 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a4, $t5, -1
	addi.d	$t5, $t5, -1
...
.LBB2_237:                              #   in Loop: Header=BB2_222 Depth=1
	...
	add.w	$t4, $s5, $a0
	beqz	$t4, .LBB2_226
.LBB2_238:                              # %.lr.ph19.preheader.i609
                                        #   in Loop: Header=BB2_222 Depth=1
	bltu	$t4, $a6, .LBB2_243
# %bb.239:                              # %.lr.ph19.preheader.i609
                                        #   in Loop: Header=BB2_222 Depth=1
	sub.d	$a0, $s8, $s1
	bltu	$a0, $a6, .LBB2_243
# %bb.240:                              # %vector.ph1101
                                        #   in Loop: Header=BB2_222 Depth=1
...
.LBB2_243:                              #   in Loop: Header=BB2_222 Depth=1
	move	$t5, $s1
	move	$t6, $s8
.LBB2_244:                              # %.lr.ph19.i610.preheader
                                        #   in Loop: Header=BB2_222 Depth=1
	move	$t7, $t5
	move	$a0, $t6
	.p2align	4, , 16
.LBB2_245:                              # %.lr.ph19.i610
                                        #   Parent Loop BB2_222 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$t6, $a0, -1
	st.b	$a3, $a0, -1
	...
	move	$a0, $t6
	bnez	$t4, .LBB2_245
.LBB2_246:                              # %._crit_edge20.loopexit.i611
                                        #   in Loop: Header=BB2_222 Depth=1
	addi.d	$a0, $s5, -1
	add.d	$a0, $a0, $t2
	sub.d	$t2, $a0, $t0
...
.LBB2_251:
	...
	ld.d	$s5, $sp, 104                   # 8-byte Folded Reload
	blt	$s5, $fp, .LBB2_254
.LBB2_252:                              # %.lr.ph50.preheader.i628
	ld.d	$s0, $sp, 112                   # 8-byte Folded Reload
	move	$s3, $s5
	.p2align	4, , 16
.LBB2_253:                              # %.lr.ph50.i630
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 0
	ld.d	$a1, $s0, 0
	move	$a2, $s8
...
.LBB2_258:                              # %vector.body985
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB2_258
# %bb.259:                              # %middle.block991
	beq	$a5, $a6, .LBB2_262
.LBB2_260:                              # %scalar.ph980.preheader
	alsl.d	$a4, $a6, $a4, 2
	nor	$a7, $a6, $zero
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB2_261:                              # %scalar.ph980
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a7, $a4, 0
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, -1
...
.LBB2_279:                              #   in Loop: Header=BB2_264 Depth=1
	...
	add.w	$fp, $s5, $a0
	beqz	$fp, .LBB2_268
.LBB2_280:                              # %.lr.ph19.preheader.i
                                        #   in Loop: Header=BB2_264 Depth=1
	bltu	$fp, $t0, .LBB2_285
# %bb.281:                              # %.lr.ph19.preheader.i
                                        #   in Loop: Header=BB2_264 Depth=1
	sub.d	$a0, $s8, $s1
	bltu	$a0, $t0, .LBB2_285
# %bb.282:                              # %vector.ph1023
                                        #   in Loop: Header=BB2_264 Depth=1
