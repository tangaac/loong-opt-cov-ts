...
# %bb.0:
	...
	pcalau12i	$s2, %pc_hi20(R__align.orlgth1)
	ld.w	$s6, $s2, %pc_lo12(R__align.orlgth1)
	ld.w	$s3, $t0, 0
...
.LBB2_2:
	...
	ld.w	$s1, $a1, %pc_lo12(R__align.orlgth2)
...
# %bb.6:
	...
	ld.w	$s1, $a0, %pc_lo12(R__align.orlgth2)
	b	.LBB2_8
.LBB2_7:
	ld.d	$s4, $sp, 208                   # 8-byte Folded Reload
	move	$s3, $a1
.LBB2_8:
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, %pc_lo12(R__align.mseq)
	move	$a0, $s8
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s3, %pc_lo12(R__align.fgcp1)
	move	$a0, $s4
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	st.w	$s6, $s2, %pc_lo12(R__align.orlgth1)
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	st.w	$s1, $a0, %pc_lo12(R__align.orlgth2)
...
.LBB2_51:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$t0, $t0, 4
	bnez	$a7, .LBB2_51
.LBB2_52:                               # %.preheader576
	bgtz	$t1, .LBB2_71
# %bb.53:                               # %.loopexit577.thread
	move	$a4, $t1
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
	ld.d	$a7, $a0, %pc_lo12(R__align.m)
	st.w	$zero, $a7, 0
	b	.LBB2_69
.LBB2_54:                               # %.preheader580
	blt	$t1, $a0, .LBB2_61
# %bb.55:                               # %.lr.ph596
...
.LBB2_64:                               # %vector.body805
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_64
# %bb.65:                               # %middle.block812
	beq	$a3, $a4, .LBB2_68
.LBB2_66:                               # %scalar.ph798.preheader
	mul.d	$a3, $a0, $a1
	alsl.d	$a4, $a1, $t7, 2
	sub.d	$a1, $a2, $a1
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_67:                               # %scalar.ph798
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB2_72:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a6, $a6, 4
	bnez	$a5, .LBB2_72
# %bb.73:                               # %.loopexit577.thread734
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
	ld.d	$a7, $a0, %pc_lo12(R__align.m)
	st.w	$zero, $a7, 0
	move	$a4, $t1
.LBB2_74:                               # %iter.check819
	move	$t2, $a4
	ld.d	$a0, $sp, 344                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(R__align.mp)
	addi.d	$a1, $t5, 1
	...
	ori	$a4, $zero, 1
	bltu	$a2, $a3, .LBB2_87
# %bb.75:                               # %vector.memcheck815
	sub.d	$a3, $a7, $t3
	addi.d	$a3, $a3, 4
	ori	$a5, $zero, 64
	bltu	$a3, $a5, .LBB2_87
# %bb.76:                               # %vector.main.loop.iter.check821
	ori	$a4, $zero, 16
	lu12i.w	$a3, 287172
	move	$t6, $a7
	bgeu	$a2, $a4, .LBB2_81
...
.LBB2_78:                               # %vec.epilog.ph836
	...
	vreplgr2vr.w	$vr2, $a3
	.p2align	4, , 16
.LBB2_79:                               # %vec.epilog.vector.body844
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t3, $a7
	vstx	$vr1, $t0, $a7
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB2_79
# %bb.80:                               # %vec.epilog.middle.block849
	move	$a7, $t6
	bne	$a2, $a6, .LBB2_87
	b	.LBB2_89
.LBB2_81:                               # %vector.ph822
	move	$a4, $zero
	move	$a5, $a2
...
# %bb.84:
	...
	move	$a7, $t6
	b	.LBB2_91
.LBB2_85:                               # %vec.epilog.iter.check837
	andi	$a4, $a2, 12
	bnez	$a4, .LBB2_78
# %bb.86:
	move	$a7, $t6
	addi.d	$a4, $a5, 1
.LBB2_87:                               # %vec.epilog.scalar.ph835.preheader
	...
	sub.d	$a1, $a1, $a4
	.p2align	4, , 16
.LBB2_88:                               # %vec.epilog.scalar.ph835
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a2, $a3
	stx.w	$zero, $a0, $a3
...
# %bb.96:                               # %iter.check862
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB2_99
# %bb.97:                               # %vector.memcheck853
                                        #   in Loop: Header=BB2_95 Depth=1
	ld.d	$a1, $sp, 200                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$s5, $a0, .LBB2_123
# %bb.98:                               # %vector.memcheck853
                                        #   in Loop: Header=BB2_95 Depth=1
	add.d	$a0, $s5, $a1
	bgeu	$a2, $a0, .LBB2_123
...
# %bb.122:                              #   in Loop: Header=BB2_114 Depth=2
	...
	fstx.s	$fa1, $s3, $a4
	b	.LBB2_113
.LBB2_123:                              # %vector.main.loop.iter.check864
                                        #   in Loop: Header=BB2_95 Depth=1
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB2_125
# %bb.124:                              #   in Loop: Header=BB2_95 Depth=1
	move	$a4, $zero
	b	.LBB2_129
.LBB2_125:                              # %vector.body868.preheader
                                        #   in Loop: Header=BB2_95 Depth=1
	addi.d	$a0, $s5, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 184                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_126:                              # %vector.body868
                                        #   Parent Loop BB2_95 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB2_126
# %bb.127:                              # %middle.block877
                                        #   in Loop: Header=BB2_95 Depth=1
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB2_101
# %bb.128:                              # %vec.epilog.iter.check882
                                        #   in Loop: Header=BB2_95 Depth=1
	ld.d	$a4, $sp, 184                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	beqz	$a0, .LBB2_132
.LBB2_129:                              # %vec.epilog.ph881
                                        #   in Loop: Header=BB2_95 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB2_130:                              # %vec.epilog.vector.body888
                                        #   Parent Loop BB2_95 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB2_130
# %bb.131:                              # %vec.epilog.middle.block897
                                        #   in Loop: Header=BB2_95 Depth=1
...
.LBB2_133:
	...
	beqz	$a1, .LBB2_135
	b	.LBB2_149
.LBB2_134:                              # %._crit_edge635.loopexit
...
.LBB2_138:                              # %vector.body915
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_138
# %bb.139:                              # %middle.block922
	beq	$a2, $a4, .LBB2_142
.LBB2_140:                              # %scalar.ph906.preheader
	sub.w	$a2, $t5, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB2_145:                              # %vector.body934
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_145
# %bb.146:                              # %middle.block941
	beq	$a3, $a4, .LBB2_149
.LBB2_147:                              # %scalar.ph925.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB2_148:                              # %scalar.ph925
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.193:
	move	$a7, $zero
	b	.LBB2_251
.LBB2_194:                              # %vector.main.loop.iter.check1058
	ori	$a1, $zero, 16
	bgeu	$a5, $a1, .LBB2_204
# %bb.195:
	move	$a6, $zero
.LBB2_196:                              # %vec.epilog.ph1072
	move	$a1, $a6
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_197:                              # %vec.epilog.vector.body1078
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a1, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB2_197
# %bb.198:                              # %vec.epilog.middle.block1086
	bne	$a5, $a6, .LBB2_208
	b	.LBB2_210
.LBB2_199:                              # %vector.main.loop.iter.check964
	ori	$a1, $zero, 16
	bgeu	$a6, $a1, .LBB2_247
# %bb.200:
	move	$a7, $zero
.LBB2_201:                              # %vec.epilog.ph978
	move	$a1, $a7
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_202:                              # %vec.epilog.vector.body984
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a1, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB2_202
# %bb.203:                              # %vec.epilog.middle.block989
	bne	$a6, $a7, .LBB2_251
	b	.LBB2_253
.LBB2_204:                              # %vector.ph1059
...
.LBB2_205:                              # %vector.body1062
	...
	addi.d	$a1, $a1, 64
	bnez	$a7, .LBB2_205
# %bb.206:                              # %middle.block1068
	beq	$a5, $a6, .LBB2_210
# %bb.207:                              # %vec.epilog.iter.check1073
	andi	$a1, $a0, 12
	bnez	$a1, .LBB2_196
.LBB2_208:                              # %vec.epilog.scalar.ph1071.preheader
	alsl.d	$a0, $a6, $a4, 2
	nor	$a1, $a6, $zero
	sub.d	$a4, $a5, $a6
	.p2align	4, , 16
.LBB2_209:                              # %vec.epilog.scalar.ph1071
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a1, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a4, $a4, -1
...
.LBB2_215:                              #   in Loop: Header=BB2_212 Depth=1
	...
	bnez	$t5, .LBB2_228
	.p2align	4, , 16
.LBB2_216:                              # %._crit_edge20.i541
                                        #   in Loop: Header=BB2_212 Depth=1
	beq	$t3, $a2, .LBB2_237
.LBB2_217:                              # %.lr.ph29.preheader.i543
                                        #   in Loop: Header=BB2_212 Depth=1
	addi.w	$a0, $zero, -17
	nor	$t8, $t3, $zero
	bltu	$a0, $t3, .LBB2_222
# %bb.218:                              # %.lr.ph29.preheader.i543
                                        #   in Loop: Header=BB2_212 Depth=1
	sub.d	$a0, $s5, $s4
	bltu	$a0, $a6, .LBB2_222
# %bb.219:                              # %vector.ph1095
                                        #   in Loop: Header=BB2_212 Depth=1
...
.LBB2_222:                              #   in Loop: Header=BB2_212 Depth=1
	...
	move	$t5, $s4
	move	$t6, $s5
.LBB2_223:                              # %.lr.ph29.i544.preheader
                                        #   in Loop: Header=BB2_212 Depth=1
	add.d	$t4, $t4, $t7
	.p2align	4, , 16
.LBB2_224:                              # %.lr.ph29.i544
                                        #   Parent Loop BB2_212 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a5, $t6, -1
	addi.d	$t6, $t6, -1
...
.LBB2_227:                              #   in Loop: Header=BB2_212 Depth=1
	...
	add.w	$t5, $s8, $a0
	beqz	$t5, .LBB2_216
.LBB2_228:                              # %.lr.ph19.preheader.i538
                                        #   in Loop: Header=BB2_212 Depth=1
	bltu	$t5, $a7, .LBB2_233
# %bb.229:                              # %.lr.ph19.preheader.i538
                                        #   in Loop: Header=BB2_212 Depth=1
	sub.d	$a0, $s5, $s4
	bltu	$a0, $a7, .LBB2_233
# %bb.230:                              # %vector.ph1121
                                        #   in Loop: Header=BB2_212 Depth=1
...
.LBB2_233:                              #   in Loop: Header=BB2_212 Depth=1
	move	$a0, $s4
	move	$t6, $s5
.LBB2_234:                              # %.lr.ph19.i539.preheader
                                        #   in Loop: Header=BB2_212 Depth=1
	move	$a1, $a0
	move	$t7, $t6
	.p2align	4, , 16
.LBB2_235:                              # %.lr.ph19.i539
                                        #   Parent Loop BB2_212 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$t6, $t7, -1
	st.b	$a4, $t7, -1
	...
	move	$t7, $t6
	bnez	$t5, .LBB2_235
.LBB2_236:                              # %._crit_edge20.loopexit.i540
                                        #   in Loop: Header=BB2_212 Depth=1
	addi.d	$a1, $s8, -1
	add.d	$a1, $a1, $t4
	sub.d	$t4, $a1, $t1
	...
	move	$s4, $a0
	bne	$t3, $a2, .LBB2_217
.LBB2_237:                              #   in Loop: Header=BB2_212 Depth=1
	move	$t6, $s5
	move	$t5, $s4
	blt	$t0, $a3, .LBB2_241
.LBB2_238:                              # %._crit_edge30.i545
                                        #   in Loop: Header=BB2_212 Depth=1
	blt	$t2, $a3, .LBB2_241
# %bb.239:                              #   in Loop: Header=BB2_212 Depth=1
	add.d	$s7, $t3, $s7
	addi.d	$s5, $t6, -1
	st.b	$a4, $t6, -1
	addi.d	$s4, $t5, -1
...
.LBB2_241:
	...
	ld.d	$s7, $sp, 104                   # 8-byte Folded Reload
	blt	$s7, $s1, .LBB2_244
.LBB2_242:                              # %.lr.ph50.preheader.i557
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	move	$s3, $s7
	.p2align	4, , 16
.LBB2_243:                              # %.lr.ph50.i559
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s0, 0
	ld.d	$a1, $s2, 0
	move	$a2, $s5
	...
	addi.d	$s0, $s0, 8
	bnez	$s3, .LBB2_243
.LBB2_244:                              # %.preheader.i550
	ld.d	$s2, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 8                     # 8-byte Folded Reload
	blt	$s2, $s1, .LBB2_293
# %bb.245:                              # %.lr.ph52.preheader.i551
	move	$s0, $s3
	move	$s1, $s2
	.p2align	4, , 16
.LBB2_246:                              # %.lr.ph52.i553
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s6, 0
	ld.d	$a1, $s0, 0
	move	$a2, $s4
...
.LBB2_248:                              # %vector.body968
	...
	addi.d	$a1, $a1, 64
	bnez	$t0, .LBB2_248
# %bb.249:                              # %middle.block974
	beq	$a6, $a7, .LBB2_253
# %bb.250:                              # %vec.epilog.iter.check979
	andi	$a1, $a0, 12
	bnez	$a1, .LBB2_201
.LBB2_251:                              # %vec.epilog.scalar.ph977.preheader
	alsl.d	$a0, $a7, $a5, 2
	nor	$a1, $a7, $zero
	sub.d	$a5, $a6, $a7
	.p2align	4, , 16
.LBB2_252:                              # %vec.epilog.scalar.ph977
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a1, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a5, $a5, -1
...
.LBB2_270:                              #   in Loop: Header=BB2_255 Depth=1
	...
	add.w	$s2, $s8, $a0
	beqz	$s2, .LBB2_259
.LBB2_271:                              # %.lr.ph19.preheader.i
                                        #   in Loop: Header=BB2_255 Depth=1
	bltu	$s2, $t1, .LBB2_276
# %bb.272:                              # %.lr.ph19.preheader.i
                                        #   in Loop: Header=BB2_255 Depth=1
	sub.d	$a0, $s5, $s4
	bltu	$a0, $t1, .LBB2_276
# %bb.273:                              # %vector.ph1021
                                        #   in Loop: Header=BB2_255 Depth=1
...
.LBB2_278:                              # %.lr.ph19.i
	...
	move	$t0, $s3
	bnez	$s2, .LBB2_278
.LBB2_279:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB2_255 Depth=1
	addi.d	$a1, $s8, -1
	add.d	$a1, $a1, $s1
	sub.d	$s1, $a1, $t4
...
# %bb.282:                              #   in Loop: Header=BB2_255 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a3, 0
.LBB2_283:                              #   in Loop: Header=BB2_255 Depth=1
	ld.d	$t8, $sp, 496                   # 8-byte Folded Reload
	blt	$t3, $a5, .LBB2_287
# %bb.284:                              #   in Loop: Header=BB2_255 Depth=1
	blt	$t5, $a5, .LBB2_287
# %bb.285:                              #   in Loop: Header=BB2_255 Depth=1
	add.d	$t2, $t6, $t2
	addi.d	$s5, $s3, -1
	st.b	$a6, $s3, -1
	addi.d	$s4, $s2, -1
...
.LBB2_289:                              # %.lr.ph50.i
	...
	addi.d	$s0, $s0, 8
	bnez	$s3, .LBB2_289
.LBB2_290:                              # %.preheader.i
	ld.d	$s2, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 8                     # 8-byte Folded Reload
	blt	$s2, $s1, .LBB2_293
# %bb.291:                              # %.lr.ph52.preheader.i
	move	$s0, $s3
	move	$s1, $s2
	.p2align	4, , 16
.LBB2_292:                              # %.lr.ph52.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s1, .LBB2_292
.LBB2_293:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 472                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 416                   # 8-byte Folded Reload
	...
	blt	$s5, $a3, .LBB2_295
# %bb.294:                              # %Atracking_localhom.exit
	ori	$a0, $a2, 2881
	blt	$a3, $a0, .LBB2_296
.LBB2_295:
