...
.Lfunc_end9:
	...
	.p2align	4, 0x0                          # -- Begin function DoAssignIteration
.LCPI10_0:
	.half	0                               # 0x0
	.half	8                               # 0x8
	.half	8                               # 0x8
...
# %bb.37:                               # %vector.body81.preheader
	...
	b	.LBB10_39
	.p2align	4, , 16
.LBB10_38:                              # %pred.store.continue92
                                        #   in Loop: Header=BB10_39 Depth=4
	addi.d	$a2, $a2, 32
	addi.d	$a3, $a3, 8
	beq	$a2, $t8, .LBB10_47
.LBB10_39:                              # %vector.body81
                                        #   Parent Loop BB10_18 Depth=1
                                        #     Parent Loop BB10_119 Depth=2
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB10_41
# %bb.40:                               # %pred.store.if85
                                        #   in Loop: Header=BB10_39 Depth=4
	st.h	$s2, $a3, -4
.LBB10_41:                              # %pred.store.continue86
                                        #   in Loop: Header=BB10_39 Depth=4
	vpickve2gr.d	$a4, $vr0, 1
	andi	$a4, $a4, 1
	beqz	$a4, .LBB10_43
# %bb.42:                               # %pred.store.if87
                                        #   in Loop: Header=BB10_39 Depth=4
	st.h	$s2, $a3, -2
.LBB10_43:                              # %pred.store.continue88
                                        #   in Loop: Header=BB10_39 Depth=4
	vldx	$vr0, $a1, $a2
	vseqi.d	$vr0, $vr0, 0
	vpickve2gr.d	$a4, $vr0, 0
...
# %bb.44:                               # %pred.store.continue90
	...
	b	.LBB10_46
	.p2align	4, , 16
.LBB10_45:                              # %pred.store.if89
                                        #   in Loop: Header=BB10_39 Depth=4
	st.h	$s2, $a3, 0
	vpickve2gr.d	$a4, $vr0, 1
	andi	$a4, $a4, 1
	beqz	$a4, .LBB10_38
.LBB10_46:                              # %pred.store.if91
                                        #   in Loop: Header=BB10_39 Depth=4
	st.h	$s2, $a3, 2
	b	.LBB10_38
	.p2align	4, , 16
.LBB10_47:                              # %.preheader113.i.i
                                        #   in Loop: Header=BB10_36 Depth=3
	ld.d	$a1, $a1, 800
	beqz	$a1, .LBB10_97
...
# %bb.52:                               # %vector.ph22
	...
	b	.LBB10_54
	.p2align	4, , 16
.LBB10_53:                              # %pred.store.continue57
                                        #   in Loop: Header=BB10_54 Depth=5
	vand.v	$vr3, $vr3, $vr9
	vbitsel.v	$vr2, $vr7, $vr3, $vr2
	vadd.h	$vr0, $vr0, $vr2
	vand.v	$vr2, $vr5, $vr9
...
# %bb.55:                               # %pred.store.continue
	...
	add.d	$a4, $s7, $a2
	bnez	$a5, .LBB10_72
.LBB10_56:                              # %pred.store.continue29
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr4, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_73
.LBB10_57:                              # %pred.store.continue31
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr4, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_74
.LBB10_58:                              # %pred.store.continue33
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr4, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_75
.LBB10_59:                              # %pred.store.continue35
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr4, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_76
.LBB10_60:                              # %pred.store.continue37
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr4, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_77
.LBB10_61:                              # %pred.store.continue39
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr4, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_63
.LBB10_62:                              # %pred.store.if40
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 14
.LBB10_63:                              # %pred.store.continue41
                                        #   in Loop: Header=BB10_54 Depth=5
	ld.h	$a5, $a3, 0
	ld.h	$a6, $a3, 202
	ld.h	$a7, $a3, 404
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_78
# %bb.64:                               # %pred.store.continue43
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr6, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_79
.LBB10_65:                              # %pred.store.continue45
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr6, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_80
.LBB10_66:                              # %pred.store.continue47
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr6, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_81
.LBB10_67:                              # %pred.store.continue49
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr6, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_82
.LBB10_68:                              # %pred.store.continue51
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr6, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_83
.LBB10_69:                              # %pred.store.continue53
                                        #   in Loop: Header=BB10_54 Depth=5
	vpickve2gr.h	$a5, $vr6, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB10_84
.LBB10_70:                              # %pred.store.continue55
                                        #   in Loop: Header=BB10_54 Depth=5
...
.LBB10_71:                              # %pred.store.if
	...
	add.d	$a4, $s7, $a2
	beqz	$a5, .LBB10_56
.LBB10_72:                              # %pred.store.if28
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 2
	vpickve2gr.h	$a5, $vr4, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_57
.LBB10_73:                              # %pred.store.if30
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 4
	vpickve2gr.h	$a5, $vr4, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_58
.LBB10_74:                              # %pred.store.if32
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 6
	vpickve2gr.h	$a5, $vr4, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_59
.LBB10_75:                              # %pred.store.if34
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 8
	vpickve2gr.h	$a5, $vr4, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_60
.LBB10_76:                              # %pred.store.if36
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 10
	vpickve2gr.h	$a5, $vr4, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_61
.LBB10_77:                              # %pred.store.if38
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 12
	vpickve2gr.h	$a5, $vr4, 7
	andi	$a5, $a5, 1
	...
	b	.LBB10_63
	.p2align	4, , 16
.LBB10_78:                              # %pred.store.if42
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 16
	vpickve2gr.h	$a5, $vr6, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_65
.LBB10_79:                              # %pred.store.if44
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 18
	vpickve2gr.h	$a5, $vr6, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_66
.LBB10_80:                              # %pred.store.if46
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 20
	vpickve2gr.h	$a5, $vr6, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_67
.LBB10_81:                              # %pred.store.if48
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 22
	vpickve2gr.h	$a5, $vr6, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_68
.LBB10_82:                              # %pred.store.if50
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 24
	vpickve2gr.h	$a5, $vr6, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_69
.LBB10_83:                              # %pred.store.if52
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 26
	vpickve2gr.h	$a5, $vr6, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_70
.LBB10_84:                              # %pred.store.if54
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 28
	vpickve2gr.h	$a5, $vr6, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_53
.LBB10_85:                              # %pred.store.if56
                                        #   in Loop: Header=BB10_54 Depth=5
	st.h	$s2, $a4, 30
	b	.LBB10_53
	.p2align	4, , 16
.LBB10_86:                              # %vec.epilog.iter.check
	...
	andi	$a3, $a3, 1
	bnez	$a3, .LBB10_94
# %bb.87:                               # %pred.store.continue67
                                        #   in Loop: Header=BB10_51 Depth=4
	vpickve2gr.w	$a3, $vr3, 1
	andi	$a3, $a3, 1
	bnez	$a3, .LBB10_95
.LBB10_88:                              # %pred.store.continue69
                                        #   in Loop: Header=BB10_51 Depth=4
	vpickve2gr.w	$a3, $vr3, 2
	andi	$a3, $a3, 1
	bnez	$a3, .LBB10_96
.LBB10_89:                              # %pred.store.continue71
                                        #   in Loop: Header=BB10_51 Depth=4
	vpickve2gr.w	$a3, $vr3, 3
	andi	$a3, $a3, 1
	beqz	$a3, .LBB10_91
.LBB10_90:                              # %pred.store.if72
                                        #   in Loop: Header=BB10_51 Depth=4
	lu12i.w	$a3, 5
	ori	$a3, $a3, 534
	add.d	$a3, $sp, $a3
...
.LBB10_100:                             # %.preheader110.i.i
	...
	ldx.hu	$a3, $a3, $s7
	beqz	$a3, .LBB10_99
# %bb.101:                              # %.preheader108.i.i.preheader
                                        #   in Loop: Header=BB10_100 Depth=3
	move	$a3, $zero
	move	$a4, $a2
	b	.LBB10_103
...
.LBB10_107:                             # %.preheader107.i.i
	...
	ldx.hu	$a3, $a3, $s7
	beqz	$a3, .LBB10_106
# %bb.108:                              # %.preheader105.i.i.preheader
                                        #   in Loop: Header=BB10_107 Depth=3
	move	$a3, $zero
	move	$a4, $a2
	b	.LBB10_110
...
.LBB10_114:                             # %.preheader104.i.i
	...
	ldx.hu	$a3, $a3, $s7
	bnez	$a3, .LBB10_113
# %bb.115:                              # %.preheader.i15.i.preheader
                                        #   in Loop: Header=BB10_114 Depth=3
	move	$a3, $zero
	move	$a4, $a2
	b	.LBB10_117
...
# %bb.160:                              #   in Loop: Header=BB10_158 Depth=4
	...
	b	.LBB10_157
	.p2align	4, , 16
.LBB10_161:                             # %.preheader.i8.i.preheader
                                        #   in Loop: Header=BB10_152 Depth=3
	move	$a6, $zero
	b	.LBB10_163
	.p2align	4, , 16
...
.LBB13_7:                               # %vector.body.preheader
	...
	b	.LBB13_9
	.p2align	4, , 16
.LBB13_8:                               # %pred.store.continue233
...
.LBB14_14:                              # %vector.body
	...
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
	vld	$vr5, $sp, 32                   # 16-byte Folded Reload
...
.LBB14_20:                              # %pred.store.continue27
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_22
# %bb.21:                               # %pred.store.if28
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 24
.LBB14_22:                              # %pred.store.continue29
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr0, $a0, 32
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
...
.LBB14_24:                              # %pred.store.continue.1
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_26
# %bb.25:                               # %pred.store.if24.1
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 40
.LBB14_26:                              # %pred.store.continue25.1
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr0, $a0, 48
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
	...
	vbitsel.v	$vr0, $vr4, $vr5, $vr2
	beqz	$a1, .LBB14_28
# %bb.27:                               # %pred.store.if26.1
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr2, $vr0, 0
	fst.d	$fa2, $a0, 48
.LBB14_28:                              # %pred.store.continue27.1
                                        #   in Loop: Header=BB14_10 Depth=1
	vpickve2gr.d	$a1, $vr1, 1
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_30
# %bb.29:                               # %pred.store.if28.1
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 56
.LBB14_30:                              # %pred.store.continue29.1
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr0, $a0, 64
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
...
.LBB14_32:                              # %pred.store.continue.2
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_34
# %bb.33:                               # %pred.store.if24.2
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 72
.LBB14_34:                              # %pred.store.continue25.2
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr0, $a0, 80
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
	...
	vbitsel.v	$vr0, $vr4, $vr5, $vr2
	beqz	$a1, .LBB14_36
# %bb.35:                               # %pred.store.if26.2
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr2, $vr0, 0
	fst.d	$fa2, $a0, 80
.LBB14_36:                              # %pred.store.continue27.2
                                        #   in Loop: Header=BB14_10 Depth=1
	vpickve2gr.d	$a1, $vr1, 1
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_38
# %bb.37:                               # %pred.store.if28.2
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 88
.LBB14_38:                              # %pred.store.continue29.2
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr1, $a0, 96
	vld	$vr0, $a0, 112
	vfcmp.cle.d	$vr2, $vr4, $vr1
	vfcmp.cult.d	$vr3, $vr1, $vr4
	vfcmp.cle.d	$vr1, $vr1, $vr5
	vand.v	$vr3, $vr3, $vr1
	vor.v	$vr2, $vr1, $vr2
	vpickve2gr.d	$a1, $vr2, 0
	andi	$a1, $a1, 1
	vbitsel.v	$vr1, $vr4, $vr5, $vr3
	beqz	$a1, .LBB14_40
...
.LBB14_40:                              # %pred.store.continue.3
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_42
# %bb.41:                               # %pred.store.if24.3
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr1, $vr1, 1
	fst.d	$fa1, $a0, 104
.LBB14_42:                              # %pred.store.continue25.3
                                        #   in Loop: Header=BB14_10 Depth=1
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
	vfcmp.cle.d	$vr0, $vr0, $vr5
	...
	vbitsel.v	$vr0, $vr4, $vr5, $vr2
	beqz	$a1, .LBB14_44
# %bb.43:                               # %pred.store.if26.3
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr2, $vr0, 0
	fst.d	$fa2, $a0, 112
.LBB14_44:                              # %pred.store.continue27.3
                                        #   in Loop: Header=BB14_10 Depth=1
	vpickve2gr.d	$a1, $vr1, 1
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_46
# %bb.45:                               # %pred.store.if28.3
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 120
.LBB14_46:                              # %pred.store.continue29.3
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr1, $a0, 128
	vld	$vr0, $a0, 144
	vfcmp.cle.d	$vr2, $vr4, $vr1
...
.LBB14_48:                              # %pred.store.continue.4
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_50
# %bb.49:                               # %pred.store.if24.4
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr1, $vr1, 1
	fst.d	$fa1, $a0, 136
.LBB14_50:                              # %pred.store.continue25.4
                                        #   in Loop: Header=BB14_10 Depth=1
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
	vfcmp.cle.d	$vr0, $vr0, $vr5
	...
	vbitsel.v	$vr0, $vr4, $vr5, $vr2
	beqz	$a1, .LBB14_52
# %bb.51:                               # %pred.store.if26.4
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr2, $vr0, 0
	fst.d	$fa2, $a0, 144
.LBB14_52:                              # %pred.store.continue27.4
                                        #   in Loop: Header=BB14_10 Depth=1
	vpickve2gr.d	$a1, $vr1, 1
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_54
# %bb.53:                               # %pred.store.if28.4
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 152
.LBB14_54:                              # %pred.store.continue29.4
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr1, $a0, 160
	vld	$vr0, $a0, 176
	vfcmp.cle.d	$vr2, $vr4, $vr1
...
.LBB14_56:                              # %pred.store.continue.5
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_58
# %bb.57:                               # %pred.store.if24.5
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr1, $vr1, 1
	fst.d	$fa1, $a0, 168
.LBB14_58:                              # %pred.store.continue25.5
                                        #   in Loop: Header=BB14_10 Depth=1
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
	vfcmp.cle.d	$vr0, $vr0, $vr5
	...
	vbitsel.v	$vr0, $vr4, $vr5, $vr2
	beqz	$a1, .LBB14_60
# %bb.59:                               # %pred.store.if26.5
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr2, $vr0, 0
	fst.d	$fa2, $a0, 176
.LBB14_60:                              # %pred.store.continue27.5
                                        #   in Loop: Header=BB14_10 Depth=1
	vpickve2gr.d	$a1, $vr1, 1
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_62
# %bb.61:                               # %pred.store.if28.5
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 184
.LBB14_62:                              # %pred.store.continue29.5
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr1, $a0, 192
	vld	$vr0, $a0, 208
	vfcmp.cle.d	$vr2, $vr4, $vr1
...
.LBB14_64:                              # %pred.store.continue.6
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_66
# %bb.65:                               # %pred.store.if24.6
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr1, $vr1, 1
	fst.d	$fa1, $a0, 200
.LBB14_66:                              # %pred.store.continue25.6
                                        #   in Loop: Header=BB14_10 Depth=1
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
	vfcmp.cle.d	$vr0, $vr0, $vr5
	...
	vbitsel.v	$vr0, $vr4, $vr5, $vr2
	beqz	$a1, .LBB14_68
# %bb.67:                               # %pred.store.if26.6
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr2, $vr0, 0
	fst.d	$fa2, $a0, 208
.LBB14_68:                              # %pred.store.continue27.6
                                        #   in Loop: Header=BB14_10 Depth=1
	vpickve2gr.d	$a1, $vr1, 1
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_70
# %bb.69:                               # %pred.store.if28.6
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr0, $vr0, 1
	fst.d	$fa0, $a0, 216
.LBB14_70:                              # %pred.store.continue29.6
                                        #   in Loop: Header=BB14_10 Depth=1
	vld	$vr1, $a0, 224
	vld	$vr0, $a0, 240
	vfcmp.cle.d	$vr2, $vr4, $vr1
...
.LBB14_72:                              # %pred.store.continue.7
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB14_74
# %bb.73:                               # %pred.store.if24.7
                                        #   in Loop: Header=BB14_10 Depth=1
	vreplvei.d	$vr1, $vr1, 1
	fst.d	$fa1, $a0, 232
.LBB14_74:                              # %pred.store.continue25.7
                                        #   in Loop: Header=BB14_10 Depth=1
	vfcmp.cle.d	$vr1, $vr4, $vr0
	vfcmp.cult.d	$vr2, $vr0, $vr4
	vfcmp.cle.d	$vr0, $vr0, $vr5
...
# %bb.29:                               # %do_forward_pass.exit
	...
	vst	$vr2, $sp, 720                  # 16-byte Folded Spill
	...
	vst	$vr3, $sp, 800                  # 16-byte Folded Spill
	fld.d	$fa1, $s8, 48
	...
	fmadd.d	$fa0, $fa1, $fa3, $fa0
	vst	$vr4, $sp, 688                  # 16-byte Folded Spill
	...
	vld	$vr4, $sp, 880                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa0, $fa4, $fs5
	fst.d	$fa1, $sp, 520                  # 8-byte Folded Spill
	vld	$vr4, $sp, 864                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa1, $fa4, $fa0
	...
	fld.d	$fa3, $s8, 176
	fld.d	$fa4, $s8, 184
	fst.d	$fa1, $sp, 496                  # 8-byte Folded Spill
	vld	$vr5, $sp, 816                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa1, $fa5, $fa0
	fst.d	$fa2, $sp, 488                  # 8-byte Folded Spill
	vld	$vr1, $sp, 800                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa2, $fa1, $fa0
	fst.d	$fa3, $sp, 480                  # 8-byte Folded Spill
	vld	$vr1, $sp, 768                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa3, $fa1, $fa0
	fst.d	$fa4, $sp, 472                  # 8-byte Folded Spill
	vld	$vr1, $sp, 784                  # 16-byte Folded Reload
	fnmadd.d	$fa0, $fa4, $fa1, $fa0
	pcaddu18i	$ra, %call36(exp)
	jirl	$ra, $ra, 0
	...
	vld	$vr1, $sp, 768                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa3, $fa1, $fa0
	fst.d	$fa4, $sp, 408                  # 8-byte Folded Spill
	vld	$vr1, $sp, 784                  # 16-byte Folded Reload
	fnmadd.d	$fa0, $fa4, $fa1, $fa0
	pcaddu18i	$ra, %call36(exp)
	jirl	$ra, $ra, 0
	...
	vld	$vr1, $sp, 768                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa3, $fa1, $fa0
	fst.d	$fa4, $sp, 344                  # 8-byte Folded Spill
	vld	$vr1, $sp, 784                  # 16-byte Folded Reload
	fnmadd.d	$fa0, $fa4, $fa1, $fa0
	pcaddu18i	$ra, %call36(exp)
	jirl	$ra, $ra, 0
...
# %bb.66:                               #   in Loop: Header=BB15_25 Depth=2
	fneg.d	$ft1, $fa7
	fcmp.cule.d	$fcc0, $ft1, $ft3
	fsub.d	$ft2, $ft2, $fa7
	bcnez	$fcc0, .LBB15_69
	b	.LBB15_70
	.p2align	4, , 16
.LBB15_67:                              #   in Loop: Header=BB15_25 Depth=2
	fcmp.cule.d	$fcc0, $fa7, $ft3
	fadd.d	$ft2, $ft2, $fa7
	bcnez	$fcc0, .LBB15_69
...
.LBB15_70:                              # %do_out_error.exit.i
                                        #   in Loop: Header=BB15_25 Depth=2
	move	$a3, $zero
	fld.d	$ft3, $sp, 680                  # 8-byte Folded Reload
	...
	fld.d	$ft6, $sp, 656                  # 8-byte Folded Reload
	fmadd.d	$ft6, $ft6, $fa1, $fa0
	fld.d	$ft7, $sp, 592                  # 8-byte Folded Reload
	fmadd.d	$ft6, $ft7, $fa2, $ft6
	fld.d	$ft7, $sp, 648                  # 8-byte Folded Reload
	fmadd.d	$ft7, $ft7, $fa1, $fa0
	fld.d	$ft8, $sp, 584                  # 8-byte Folded Reload
	fmadd.d	$ft7, $ft8, $fa2, $ft7
	fld.d	$ft8, $sp, 640                  # 8-byte Folded Reload
	fmadd.d	$ft8, $ft8, $fa1, $fa0
	fld.d	$ft9, $sp, 576                  # 8-byte Folded Reload
	fmadd.d	$ft8, $ft9, $fa2, $ft8
	fld.d	$ft9, $sp, 632                  # 8-byte Folded Reload
	fmadd.d	$ft9, $ft9, $fa1, $fa0
	fld.d	$ft12, $sp, 568                 # 8-byte Folded Reload
	fmadd.d	$ft9, $ft12, $fa2, $ft9
	fld.d	$ft12, $sp, 624                 # 8-byte Folded Reload
	fmadd.d	$fa1, $ft12, $fa1, $fa0
	fld.d	$ft12, $sp, 536                 # 8-byte Folded Reload
	fmadd.d	$fa1, $ft12, $fa2, $fa1
	fld.d	$fa2, $sp, 528                  # 8-byte Folded Reload
	fmadd.d	$fa2, $fa2, $fa3, $ft3
	fld.d	$ft3, $sp, 520                  # 8-byte Folded Reload
	fmadd.d	$ft3, $ft3, $fa3, $ft4
	fld.d	$ft4, $sp, 512                  # 8-byte Folded Reload
	fmadd.d	$ft4, $ft4, $fa3, $ft5
	fld.d	$ft5, $sp, 504                  # 8-byte Folded Reload
	fmadd.d	$ft5, $ft5, $fa3, $ft6
	fld.d	$ft6, $sp, 496                  # 8-byte Folded Reload
	fmadd.d	$ft6, $ft6, $fa3, $ft7
	fld.d	$ft7, $sp, 488                  # 8-byte Folded Reload
	fmadd.d	$ft7, $ft7, $fa3, $ft8
	fld.d	$ft8, $sp, 480                  # 8-byte Folded Reload
	fmadd.d	$ft8, $ft8, $fa3, $ft9
	fld.d	$ft9, $sp, 472                  # 8-byte Folded Reload
	fmadd.d	$fa1, $ft9, $fa3, $fa1
	fld.d	$fa3, $sp, 464                  # 8-byte Folded Reload
	fmadd.d	$fa2, $fa3, $fa4, $fa2
	fld.d	$fa3, $sp, 456                  # 8-byte Folded Reload
	fmadd.d	$fa3, $fa3, $fa4, $ft3
	...
	fld.d	$fa4, $sp, 384                  # 8-byte Folded Reload
	fmadd.d	$fa4, $fa4, $fa5, $ft3
	...
	fmadd.d	$ft5, $ft5, $fa5, $ft6
	fld.d	$ft6, $sp, 352                  # 8-byte Folded Reload
	fmadd.d	$ft6, $ft6, $fa5, $ft7
	fld.d	$ft7, $sp, 344                  # 8-byte Folded Reload
	...
	fld.d	$fa5, $sp, 312                  # 8-byte Folded Reload
	fmadd.d	$fa5, $fa5, $fa6, $ft3
	fld.d	$ft3, $sp, 304                  # 8-byte Folded Reload
	fmadd.d	$ft3, $ft3, $fa6, $ft4
	fld.d	$ft4, $sp, 296                  # 8-byte Folded Reload
	fmadd.d	$ft4, $ft4, $fa6, $ft5
	fld.d	$ft5, $sp, 288                  # 8-byte Folded Reload
	fmadd.d	$ft5, $ft5, $fa6, $ft6
	fld.d	$ft6, $sp, 280                  # 8-byte Folded Reload
	fmadd.d	$fa1, $ft6, $fa6, $fa1
	fld.d	$fa6, $sp, 272                  # 8-byte Folded Reload
	fmadd.d	$fa2, $fa6, $ft0, $fa2
	fld.d	$fa6, $sp, 264                  # 8-byte Folded Reload
	fmadd.d	$fa3, $fa6, $ft0, $fa3
	fld.d	$fa6, $sp, 256                  # 8-byte Folded Reload
	fmadd.d	$fa4, $fa6, $ft0, $fa4
	fld.d	$fa6, $sp, 248                  # 8-byte Folded Reload
	fmadd.d	$fa5, $fa6, $ft0, $fa5
	fld.d	$fa6, $sp, 240                  # 8-byte Folded Reload
	fmadd.d	$fa6, $fa6, $ft0, $ft3
	fld.d	$ft3, $sp, 232                  # 8-byte Folded Reload
	fmadd.d	$ft3, $ft3, $ft0, $ft4
	fld.d	$ft4, $sp, 224                  # 8-byte Folded Reload
	fmadd.d	$ft4, $ft4, $ft0, $ft5
	fld.d	$ft5, $sp, 216                  # 8-byte Folded Reload
	fmadd.d	$fa1, $ft5, $ft0, $fa1
	fld.d	$ft0, $sp, 208                  # 8-byte Folded Reload
	fmadd.d	$fa2, $ft0, $fa7, $fa2
	fld.d	$ft0, $sp, 200                  # 8-byte Folded Reload
	fmadd.d	$fa3, $ft0, $fa7, $fa3
	fmadd.d	$fa4, $fs2, $fa7, $fa4
	fmadd.d	$fa5, $fs6, $fa7, $fa5
	fmadd.d	$fa6, $fs7, $fa7, $fa6
	fmadd.d	$ft3, $fs1, $fa7, $ft3
	fmadd.d	$ft4, $fs3, $fa7, $ft4
	fmadd.d	$fa1, $fs4, $fa7, $fa1
	vldi	$vr7, -960
	fmul.d	$fa7, $ft2, $fa7
	slli.d	$a4, $a4, 3
	...
	fmul.d	$fa2, $fa3, $fa2
	fmul.d	$fa3, $fa2, $fa1
	pcalau12i	$a4, %pc_hi20(mid_error)
	addi.d	$a4, $a4, %pc_lo12(mid_error)
	fst.d	$ft2, $a4, 0
	fst.d	$ft1, $a4, 8
	fst.d	$ft0, $a4, 16
	fst.d	$fa7, $a4, 24
...
# %bb.72:                               # %adjust_out_wts.exit.i
	...
	ld.w	$a3, $a5, %pc_lo12(iteration_count)
	fmul.d	$fa2, $fa3, $fa2
	...
	fstx.d	$fa1, $s3, $a4
	addi.d	$a3, $a3, 1
	st.w	$a3, $a5, %pc_lo12(iteration_count)
	ori	$s7, $zero, 280
...
# %bb.78:                               #   in Loop: Header=BB15_25 Depth=2
	...
	b	.LBB15_82
	.p2align	4, , 16
.LBB15_79:                              # %vector.ph76
                                        #   in Loop: Header=BB15_25 Depth=2
	pcalau12i	$a1, %pc_hi20(tot_out_error+16)
	bstrpick.d	$a0, $a2, 30, 2
	slli.d	$a0, $a0, 2
	addi.d	$a1, $a1, %pc_lo12(tot_out_error+16)
	move	$a3, $a0
	vori.b	$vr1, $vr5, 0
	vori.b	$vr2, $vr5, 0
	.p2align	4, , 16
.LBB15_80:                              # %vector.body79
                                        #   Parent Loop BB15_5 Depth=1
                                        #     Parent Loop BB15_25 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr3, $a1, -16
