...
.LBB0_10:                               # %._crit_edge267.critedge
	...
	jirl	$ra, $ra, 0
	st.w	$s1, $s7, %pc_lo12(J)
	st.w	$s2, $s6, %pc_lo12(K)
	ori	$a2, $zero, 2
	ori	$a3, $zero, 3
	move	$a0, $s4
	ori	$s4, $zero, 1
...
.LBB0_12:                               # =>This Loop Header: Depth=1
	...
	st.d	$a0, $s6, %pc_lo12(T)
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	st.d	$a1, $a0, %pc_lo12(T1)
	pcalau12i	$s1, %pc_hi20(T2)
	lu52i.d	$a0, $zero, 1024
	st.d	$a0, $s1, %pc_lo12(T2)
	pcalau12i	$a0, %pc_hi20(.L.str.3)
	addi.d	$a0, $a0, %pc_lo12(.L.str.3)
	move	$a1, $zero
	move	$a2, $zero
...
# %bb.15:                               # %.lr.ph211
	...
	fld.d	$fa4, $s2, 16
	fld.d	$fa5, $s2, 8
	fld.d	$fa0, $s6, %pc_lo12(T)
	fld.d	$fa1, $s1, %pc_lo12(T2)
	ori	$a0, $zero, 6
...
.LBB0_25:                               #   in Loop: Header=BB0_12 Depth=1
	...
	pcalau12i	$s6, %pc_hi20(K)
	st.w	$s8, $s6, %pc_lo12(K)
	ori	$a0, $zero, 2
	pcalau12i	$s8, %pc_hi20(L)
	ori	$a1, $zero, 3
	st.w	$a1, $s8, %pc_lo12(L)
	blt	$fp, $s4, .LBB0_29
# %bb.26:                               # %.lr.ph224.preheader
                                        #   in Loop: Header=BB0_12 Depth=1
...
# %bb.28:                               # %.lr.ph241.preheader
	...
	b	.LBB0_30
	.p2align	4, , 16
.LBB0_29:                               # %._crit_edge235.thread.critedge
                                        #   in Loop: Header=BB0_12 Depth=1
	ld.d	$a7, $s2, 32
	ld.d	$a6, $s2, 24
	ld.d	$a5, $s2, 16
