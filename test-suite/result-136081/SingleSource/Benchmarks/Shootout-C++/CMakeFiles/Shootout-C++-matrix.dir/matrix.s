...
# %bb.10:                               # %.preheader24.us.i.preheader.preheader
	...
	st.d	$t0, $sp, 864                   # 8-byte Folded Spill
	st.d	$a7, $sp, 832                   # 8-byte Folded Spill
	.p2align	4, , 16
...
.LBB4_12:                               # %.preheader24.us.i
	...
	vpickve2gr.h	$s4, $vr0, 5
	vpickve2gr.h	$t6, $vr0, 4
	vpickve2gr.h	$t7, $vr0, 3
	vpickve2gr.h	$t8, $vr0, 2
	vpickve2gr.h	$s3, $vr0, 0
	vpickve2gr.h	$a2, $vr0, 1
	andi	$a2, $a2, 1
	bstrins.d	$s3, $a2, 63, 1
	bstrins.d	$s3, $t8, 2, 2
	bstrins.d	$s3, $t7, 3, 3
	bstrins.d	$s3, $t6, 4, 4
	bstrins.d	$s3, $s4, 5, 5
...
# %bb.20:                               # %vector.body.preheader
	...
	ld.w	$t8, $a3, 32
	ld.w	$s3, $a3, 36
	vreplgr2vr.w	$vr18, $t6
	vreplgr2vr.w	$vr19, $t7
	vreplgr2vr.w	$vr20, $t8
	...
	vreplgr2vr.w	$vr23, $t7
	vreplgr2vr.w	$vr24, $t8
	vreplgr2vr.w	$vr25, $s3
	ld.w	$t6, $a3, 56
	ld.w	$t7, $a3, 60
	ld.w	$t8, $a3, 64
	ld.w	$s3, $a3, 68
	vreplgr2vr.w	$vr26, $t6
	vreplgr2vr.w	$vr27, $t7
	vreplgr2vr.w	$vr28, $t8
	vreplgr2vr.w	$vr29, $s3
	ld.w	$t6, $a3, 72
	ld.w	$t7, $a3, 76
	ld.w	$t8, $a3, 80
	ld.w	$s3, $a3, 84
	vreplgr2vr.w	$vr30, $t6
	vreplgr2vr.w	$vr31, $t7
	vreplgr2vr.w	$vr0, $t8
	vreplgr2vr.w	$vr1, $s3
	ld.w	$t6, $a3, 88
	ld.w	$t7, $a3, 92
...
.LBB4_21:                               # %vector.body
	...
	vld	$vr12, $sp, 704                 # 16-byte Folded Reload
	vmadd.w	$vr10, $vr11, $vr12
	vldx	$vr11, $t4, $a2
	vldx	$vr12, $t6, $a2
	vldx	$vr13, $t3, $a2
	vldx	$vr14, $t7, $a2
	vld	$vr15, $sp, 672                 # 16-byte Folded Reload
...
.LBB4_23:                               # %.preheader.us.us.i.preheader
                                        #   in Loop: Header=BB4_12 Depth=2
	slli.d	$a2, $a2, 2
	ld.d	$t2, $sp, 632                   # 8-byte Folded Reload
	ld.d	$t1, $sp, 624                   # 8-byte Folded Reload
...
.LBB4_24:                               # %.preheader.us.us.i
	...
	addi.d	$a2, $a2, 4
	bne	$a2, $t8, .LBB4_24
# %bb.25:                               # %._crit_edge28.split.us.us.i
                                        #   in Loop: Header=BB4_12 Depth=2
	...
	ori	$a0, $zero, 30
	bne	$a1, $a0, .LBB4_12
# %bb.26:                               # %_Z5mmultiiPPiS0_S0_.exit
                                        #   in Loop: Header=BB4_11 Depth=1
	ld.d	$a3, $sp, 24                    # 8-byte Folded Reload
	addi.w	$a3, $a3, 1
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	bne	$a3, $a2, .LBB4_11
.LBB4_27:                               # %_Z8mkmatrixii.exit36._crit_edge
	ld.d	$a0, $s5, 0
	ld.w	$a1, $a0, 0
...
.LBB4_30:
	...
	move	$a1, $a0
	move	$a0, $s0
.LBB4_31:                               # %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
	ext.w.b	$a1, $a1
