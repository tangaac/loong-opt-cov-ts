...
# %bb.17:                               # %"_ZZ4mainENK3$_0clEmmmPiPKiS2_.exit"
	...
	vld	$vr0, $s4, %pc_lo12(.LCPI0_1)
	pcalau12i	$s6, %pc_hi20(.LCPI0_2)
	vld	$vr1, $s6, %pc_lo12(.LCPI0_2)
	vreplgr2vr.d	$vr2, $s2
	vrepli.b	$vr3, 0
	vrepli.d	$vr4, 400
	ori	$a2, $zero, 100
...
.LBB0_40:                               # =>This Inner Loop Header: Depth=1
	...
	add.d	$a0, $a4, $a0
	bne	$a1, $a3, .LBB0_40
# %bb.41:                               # %scalar.ph333.2
	vst	$vr13, $sp, 480                 # 16-byte Folded Spill
	move	$a1, $zero
	addi.d	$a2, $a0, 1785
	ld.w	$a0, $s1, 488
	st.w	$a2, $s0, 484
...
# %bb.69:                               # %.preheader1.i174.preheader
	...
	vld	$vr3, $a1, %pc_lo12(.LCPI0_4)
	pcalau12i	$a1, %pc_hi20(.LCPI0_5)
	vld	$vr4, $a1, %pc_lo12(.LCPI0_5)
	lu12i.w	$a2, 2
	ori	$a7, $a2, 3892
	ori	$t0, $a2, 3876
	pcalau12i	$a1, %pc_hi20(.LCPI0_6)
	vld	$vr5, $a1, %pc_lo12(.LCPI0_6)
	pcalau12i	$a1, %pc_hi20(.LCPI0_7)
	vld	$vr6, $a1, %pc_lo12(.LCPI0_7)
	ori	$t1, $a2, 3924
	ori	$t2, $a2, 3908
	pcalau12i	$a1, %pc_hi20(.LCPI0_8)
	vld	$vr7, $a1, %pc_lo12(.LCPI0_8)
	pcalau12i	$a1, %pc_hi20(.LCPI0_9)
	vld	$vr8, $a1, %pc_lo12(.LCPI0_9)
	ori	$t3, $a2, 3956
	ori	$t4, $a2, 3940
	pcalau12i	$a1, %pc_hi20(.LCPI0_10)
	vld	$vr9, $a1, %pc_lo12(.LCPI0_10)
	pcalau12i	$a1, %pc_hi20(.LCPI0_11)
	vld	$vr10, $a1, %pc_lo12(.LCPI0_11)
	ori	$t5, $a2, 3988
	ori	$t6, $a2, 3972
	pcalau12i	$a1, %pc_hi20(.LCPI0_12)
	vld	$vr11, $a1, %pc_lo12(.LCPI0_12)
	pcalau12i	$a1, %pc_hi20(.LCPI0_13)
	vld	$vr16, $a1, %pc_lo12(.LCPI0_13)
	ori	$t7, $a2, 4020
	ori	$t8, $a2, 4004
	pcalau12i	$a1, %pc_hi20(.LCPI0_14)
	vld	$vr17, $a1, %pc_lo12(.LCPI0_14)
	pcalau12i	$a1, %pc_hi20(.LCPI0_15)
	vld	$vr18, $a1, %pc_lo12(.LCPI0_15)
	ori	$s2, $a2, 4052
	lu12i.w	$s3, 3
	ori	$s7, $zero, 123
...
.LBB0_71:                               # %.preheader.i176
	...
	vld	$vr12, $s1, %pc_lo12(.LCPI0_16)
	pcalau12i	$s1, %pc_hi20(.LCPI0_17)
	vld	$vr13, $s1, %pc_lo12(.LCPI0_17)
	ori	$s1, $fp, 4036
	vstx	$vr1, $a2, $s1
	vmul.w	$vr1, $vr0, $vr12
	vmul.w	$vr2, $vr0, $vr13
	...
	vld	$vr14, $s1, %pc_lo12(.LCPI0_18)
	pcalau12i	$s1, %pc_hi20(.LCPI0_19)
	vld	$vr15, $s1, %pc_lo12(.LCPI0_19)
	ori	$s1, $fp, 4068
	vstx	$vr1, $a2, $s1
	vmul.w	$vr1, $vr0, $vr14
	vmul.w	$vr0, $vr0, $vr15
...
# %bb.72:                               #   in Loop: Header=BB0_70 Depth=1
	...
	add.d	$s8, $s8, $a1
	bne	$a5, $s7, .LBB0_70
# %bb.73:                               # %vector.body368.preheader
	...
	move	$a2, $zero
	vld	$vr16, $s4, %pc_lo12(.LCPI0_1)
	vld	$vr17, $s6, %pc_lo12(.LCPI0_2)
...
.LBB0_74:                               # %vector.body368
	...
	vld	$vr27, $sp, 304                 # 16-byte Folded Reload
...
.LBB0_75:                               # %.preheader.i183372
	...
	vpickve2gr.w	$a0, $vr25, 2
	vpickve2gr.w	$a6, $vr25, 0
	vpickve2gr.w	$a7, $vr24, 2
	vpickve2gr.w	$t0, $vr24, 0
	vaddi.du	$vr24, $vr7, 4
	vaddi.du	$vr25, $vr8, 4
	vpickve2gr.d	$t1, $vr25, 0
	st.w	$t0, $t1, 0
	...
	vaddi.du	$vr25, $vr7, 8
	vpickve2gr.w	$a7, $vr24, 0
	st.w	$a7, $a0, 0
	vpickve2gr.w	$a0, $vr24, 1
	st.w	$a0, $a6, 0
	vpickve2gr.w	$a0, $vr24, 2
	vpickve2gr.d	$a6, $vr25, 0
	st.w	$a0, $a6, 0
	vpickve2gr.w	$a0, $vr24, 3
	vpickve2gr.d	$a6, $vr25, 1
	st.w	$a0, $a6, 0
	vld	$vr24, $sp, 464                 # 16-byte Folded Reload
	...
	vpickve2gr.w	$a7, $vr25, 0
	st.w	$a7, $a0, 0
	vpickve2gr.w	$a0, $vr25, 1
	st.w	$a0, $a6, 0
	vpickve2gr.w	$a0, $vr25, 2
	vpickve2gr.d	$a6, $vr24, 0
	st.w	$a0, $a6, 0
	vpickve2gr.w	$a0, $vr25, 3
	vpickve2gr.d	$a6, $vr24, 1
	st.w	$a0, $a6, 0
	vrepli.d	$vr24, 72
	vadd.d	$vr25, $vr8, $vr24
	...
	vpickve2gr.d	$a0, $vr25, 0
	vpickve2gr.d	$a6, $vr25, 1
	vld	$vr25, $sp, 480                 # 16-byte Folded Reload
	vmul.w	$vr25, $vr23, $vr25
	vadd.d	$vr24, $vr7, $vr24
	vpickve2gr.w	$a7, $vr25, 0
	st.w	$a7, $a0, 0
	...
	vadd.d	$vr25, $vr8, $vr24
	vpickve2gr.d	$a0, $vr25, 0
	vpickve2gr.d	$t3, $vr25, 1
	vrepli.w	$vr25, 62
	vmul.w	$vr25, $vr23, $vr25
	vadd.d	$vr24, $vr7, $vr24
	vpickve2gr.w	$a6, $vr25, 0
	st.w	$a6, $a0, 0
	vpickve2gr.w	$s3, $vr25, 1
	vpickve2gr.w	$t0, $vr25, 2
	vpickve2gr.d	$t2, $vr24, 0
	vpickve2gr.w	$a6, $vr25, 3
	vpickve2gr.d	$a7, $vr24, 1
	vrepli.d	$vr24, 252
	vadd.d	$vr25, $vr8, $vr24
	vpickve2gr.d	$t5, $vr25, 0
	vpickve2gr.d	$t1, $vr25, 1
	vrepli.w	$vr25, 63
	vmul.w	$vr25, $vr23, $vr25
	vadd.d	$vr24, $vr7, $vr24
	vpickve2gr.w	$s4, $vr25, 0
	vpickve2gr.w	$t6, $vr25, 1
	vpickve2gr.w	$t4, $vr25, 2
	vpickve2gr.d	$t7, $vr24, 0
	vpickve2gr.w	$t8, $vr25, 3
	vpickve2gr.d	$s2, $vr24, 1
	vrepli.d	$vr24, 256
	vadd.d	$vr25, $vr8, $vr24
	vpickve2gr.d	$s5, $vr25, 0
	vpickve2gr.d	$s6, $vr25, 1
	vslli.w	$vr25, $vr23, 6
	vadd.d	$vr24, $vr7, $vr24
	vpickve2gr.w	$s7, $vr25, 0
	vpickve2gr.w	$s8, $vr25, 1
	vpickve2gr.w	$ra, $vr25, 2
	vpickve2gr.d	$a0, $vr24, 0
	vpickve2gr.w	$s1, $vr25, 3
	vpickve2gr.d	$s0, $vr24, 1
	vrepli.d	$vr24, 260
	vadd.d	$vr25, $vr8, $vr24
	vpickve2gr.d	$a5, $vr25, 0
	vpickve2gr.d	$fp, $vr25, 1
	vrepli.w	$vr25, 65
	vmul.w	$vr25, $vr23, $vr25
	vpickve2gr.w	$a1, $vr25, 0
	vpickve2gr.w	$a3, $vr25, 1
	vpickve2gr.w	$a4, $vr25, 2
	vpickve2gr.w	$a2, $vr25, 3
	st.w	$s3, $t3, 0
	vadd.d	$vr24, $vr7, $vr24
	vpickve2gr.d	$t3, $vr24, 0
	vpickve2gr.d	$s3, $vr24, 1
	vrepli.w	$vr24, 66
	...
	st.w	$a6, $a7, 0
	st.w	$s4, $t5, 0
	vpickve2gr.w	$a6, $vr23, 0
	vpickve2gr.w	$a7, $vr23, 1
	vpickve2gr.w	$t5, $vr23, 2
	vpickve2gr.w	$s4, $vr23, 3
	st.w	$t6, $t1, 0
...
.LBB0_110:                              # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit209
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_111:                              # %_ZNSt10unique_ptrIA_iSt14default_deleteIS0_EED2Ev.exit212
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.LBB1_3:                                # %.lr.ph.i
	...
	addi.w	$a1, $a0, 0
	bltu	$a1, $s2, .LBB1_3
.LBB1_4:                                # %_ZNSt24uniform_int_distributionImE5_S_ndImSt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EEjEET1_RT0_S4_.exit
	srli.d	$a0, $a0, 32
	b	.LBB1_10
.LBB1_5:
	move	$s1, $a0
...
.LBB1_10:                               # %.loopexit
	...
	ret
.Lfunc_end1:
	.size	_ZNSt24uniform_int_distributionImEclISt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EEEEmRT_RKNS0_10param_typeE, .Lfunc_end1-_ZNSt24uniform_int_distributionImEclISt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EEEEmRT_RKNS0_10param_typeE
	.cfi_endproc
                                        # -- End function
