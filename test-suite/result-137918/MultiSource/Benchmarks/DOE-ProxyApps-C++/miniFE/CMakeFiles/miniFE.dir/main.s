...
# %bb.46:                               # %.lr.ph315
	...
	move	$a1, $s6
	bgeu	$a3, $a7, .LBB14_71
.LBB14_47:                              # %scalar.ph516.preheader
	slli.d	$a7, $a1, 3
	alsl.d	$a3, $a1, $a6, 3
	slli.d	$a6, $a1, 2
	alsl.d	$a2, $a1, $a2, 2
...
.LBB14_58:                              # %vector.body538
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB14_58
# %bb.59:                               # %middle.block543
	beq	$s5, $a1, .LBB14_62
.LBB14_60:                              # %scalar.ph533.preheader
	sub.d	$a2, $a2, $a1
	alsl.d	$a3, $a1, $s4, 2
	alsl.d	$a0, $a1, $a0, 2
	.p2align	4, , 16
.LBB14_61:                              # %scalar.ph533
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a3, 0
	add.d	$a1, $a1, $s6
	st.w	$a1, $a0, 0
...
.LBB14_70:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit171
	...
	addi.d	$sp, $sp, 160
	ret
.LBB14_71:                              # %vector.memcheck511
	alsl.d	$a1, $s6, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 8
	move	$a1, $s6
	bltu	$a7, $t0, .LBB14_47
# %bb.72:                               # %vector.memcheck511
	alsl.d	$a1, $s6, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 16
	move	$a1, $s6
...
# %bb.80:                               # %.lr.ph292.preheader
	...
	addi.w	$a0, $a0, 0
	bgeu	$t3, $a6, .LBB14_83
.LBB14_81:                              # %.lr.ph292.preheader547
                                        #   in Loop: Header=BB14_79 Depth=1
	alsl.d	$t3, $a0, $s1, 2
	alsl.d	$t4, $a0, $s3, 3
	alsl.d	$t5, $t1, $a3, 2
...
# %bb.0:
	...
	vpackev.d	$vr21, $vr18, $vr16
	vreplvei.d	$vr8, $vr8, 0
	vfmul.d	$vr8, $vr21, $vr8
	vfadd.d	$vr21, $vr8, $vr20
	pcalau12i	$a3, %pc_hi20(.LCPI42_0)
	vld	$vr8, $a3, %pc_lo12(.LCPI42_0)
	movfr2gr.d	$a3, $ft8
	vbsrl.v	$vr16, $vr19, 8
	vld	$vr22, $a1, 40
	vbsll.v	$vr23, $vr19, 8
	vor.v	$vr16, $vr23, $vr16
	vbsrl.v	$vr23, $vr18, 8
	vori.b	$vr24, $vr8, 0
	vshuf.d	$vr24, $vr18, $vr22
	vinsgr2vr.d	$vr18, $a3, 1
	vfmul.d	$vr19, $vr19, $vr18
	vfmul.d	$vr16, $vr16, $vr18
	vld	$vr18, $a0, 32
	vfadd.d	$vr19, $vr19, $vr20
	vfadd.d	$vr16, $vr16, $vr20
	vreplvei.d	$vr10, $vr10, 0
	vfmul.d	$vr10, $vr18, $vr10
	vfadd.d	$vr17, $vr17, $vr10
	vbsll.v	$vr10, $vr22, 8
	vor.v	$vr20, $vr10, $vr23
	fld.d	$ft2, $a1, 184
	vreplvei.d	$vr15, $vr15, 0
	vfmul.d	$vr15, $vr20, $vr15
	vfadd.d	$vr15, $vr21, $vr15
	vfmul.d	$vr20, $vr18, $vr24
	vfadd.d	$vr19, $vr19, $vr20
	vbsrl.v	$vr20, $vr18, 8
	vbsll.v	$vr18, $vr18, 8
	vor.v	$vr18, $vr18, $vr20
	vfmul.d	$vr18, $vr18, $vr24
	vld	$vr20, $a0, 56
	...
	vbsrl.v	$vr17, $vr22, 8
	vbsll.v	$vr21, $vr18, 8
	vor.v	$vr17, $vr21, $vr17
	vreplvei.d	$vr13, $vr13, 0
	vfmul.d	$vr13, $vr17, $vr13
	vfadd.d	$vr13, $vr15, $vr13
	vori.b	$vr15, $vr8, 0
	vshuf.d	$vr15, $vr22, $vr18
	vfmul.d	$vr17, $vr20, $vr15
	...
	vld	$vr15, $a1, 112
	vfmul.d	$vr9, $vr17, $vr9
	vfadd.d	$vr9, $vr12, $vr9
	vbsrl.v	$vr12, $vr16, 8
	vbsll.v	$vr18, $vr15, 8
	vor.v	$vr12, $vr18, $vr12
	vreplvei.d	$vr7, $vr7, 0
	vfmul.d	$vr7, $vr12, $vr7
	vfadd.d	$vr7, $vr11, $vr7
	vori.b	$vr11, $vr8, 0
	vshuf.d	$vr11, $vr16, $vr15
	vfmul.d	$vr12, $vr17, $vr11
	vfadd.d	$vr12, $vr14, $vr12
	vbsrl.v	$vr14, $vr17, 8
	vbsll.v	$vr16, $vr17, 8
	...
	vfadd.d	$vr5, $vr7, $vr5
	vori.b	$vr7, $vr8, 0
	vshuf.d	$vr7, $vr15, $vr13
	vfmul.d	$vr9, $vr14, $vr7
	vfadd.d	$vr9, $vr12, $vr9
	vbsrl.v	$vr12, $vr14, 8
	vbsll.v	$vr14, $vr14, 8
	...
	vfmul.d	$vr3, $vr6, $vr3
	vfadd.d	$vr3, $vr5, $vr3
	vshuf.d	$vr8, $vr13, $vr11
	vfmul.d	$vr5, $vr12, $vr8
	vfadd.d	$vr5, $vr9, $vr5
	vbsrl.v	$vr6, $vr12, 8
	vbsll.v	$vr9, $vr12, 8
	vor.v	$vr6, $vr9, $vr6
