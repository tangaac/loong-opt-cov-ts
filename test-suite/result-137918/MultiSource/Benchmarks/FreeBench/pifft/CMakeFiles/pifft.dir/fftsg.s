...
# %bb.46:                               #   in Loop: Header=BB12_28 Depth=1
	move	$a2, $zero
.LBB12_47:                              # %.lr.ph271.preheader432
                                        #   in Loop: Header=BB12_28 Depth=1
	slli.d	$a4, $a2, 3
	alsl.d	$a3, $a2, $s0, 3
	sub.d	$a4, $s0, $a4
...
# %bb.45:                               # %.lr.ph247.preheader
	...
	ori	$a5, $zero, 12
	bgeu	$a4, $a5, .LBB13_48
.LBB13_46:                              # %.lr.ph247.preheader401
                                        #   in Loop: Header=BB13_29 Depth=1
	slli.d	$a5, $a3, 3
	alsl.d	$a4, $a3, $s0, 3
	sub.d	$a5, $s0, $a5
...
# %bb.50:                               # %vector.memcheck354
	...
	and	$a7, $t4, $a7
	bnez	$a7, .LBB13_56
# %bb.51:                               # %vector.memcheck354
                                        #   in Loop: Header=BB13_29 Depth=1
	sltu	$a7, $a6, $t1
	sltu	$t0, $t0, $a5
	and	$a7, $a7, $t0
	bnez	$a7, .LBB13_56
# %bb.52:                               # %vector.memcheck354
                                        #   in Loop: Header=BB13_29 Depth=1
	sltu	$a6, $a6, $t3
	sltu	$a5, $t2, $a5
	and	$a5, $a6, $a5
