...
.LBB1_70:                               # %.lr.ph455
	...
	ld.w	$s1, $fp, 0
	bne	$s1, $s4, .LBB1_69
# %bb.71:                               # %.preheader736.preheader
                                        #   in Loop: Header=BB1_70 Depth=4
	move	$s2, $s5
	.p2align	4, , 16
.LBB1_72:                               # %.preheader736
                                        #   Parent Loop BB1_54 Depth=1
                                        #     Parent Loop BB1_60 Depth=2
                                        #       Parent Loop BB1_66 Depth=3
...
.LBB1_94:                               # %vector.body762
	...
	addi.d	$a6, $a6, 16
	bnez	$a7, .LBB1_94
# %bb.95:                               # %middle.block768
                                        #   in Loop: Header=BB1_91 Depth=1
	beq	$a1, $a4, .LBB1_98
.LBB1_96:                               # %scalar.ph757.preheader
                                        #   in Loop: Header=BB1_91 Depth=1
	alsl.d	$a2, $a3, $a2, 1
	alsl.d	$a4, $a3, $a0, 2
	sub.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB1_97:                               # %scalar.ph757
                                        #   Parent Loop BB1_91 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$a5, $a4, 0
	st.h	$a5, $a2, 0
...
.LBB1_125:                              # %vector.body750
	...
	addi.d	$t1, $t1, 16
	bnez	$t2, .LBB1_125
# %bb.126:                              # %middle.block754
                                        #   in Loop: Header=BB1_91 Depth=1
	beq	$a6, $a7, .LBB1_129
.LBB1_127:                              # %scalar.ph745.preheader
                                        #   in Loop: Header=BB1_91 Depth=1
	slli.d	$a6, $a5, 1
	alsl.d	$a6, $a4, $a6, 1
	add.d	$a6, $a2, $a6
...
.LBB1_164:                              # %.lr.ph589
	...
	addi.d	$s0, $s0, 8
	blt	$fp, $a0, .LBB1_164
.LBB1_165:                              # %._crit_edge590
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB1_174
.LBB1_166:                              # %vector.ph775
