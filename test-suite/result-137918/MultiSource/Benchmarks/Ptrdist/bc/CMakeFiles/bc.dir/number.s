...
# %bb.49:
	move	$a5, $zero
	b	.LBB15_54
.LBB15_50:                              # %vector.ph221
	bstrpick.d	$a0, $a1, 30, 5
	slli.d	$a5, $a0, 5
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	addi.d	$a3, $a0, 32
	addi.d	$a4, $a2, 16
...
# %bb.29:
	...
	ld.d	$s1, $sp, 0                     # 8-byte Folded Reload
	b	.LBB19_40
.LBB19_30:                              # %vector.main.loop.iter.check
	ori	$a3, $zero, 16
...
.LBB19_36:                              # %vec.epilog.ph
	...
	addi.d	$a4, $a4, 16
	.p2align	4, , 16
.LBB19_37:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a7, 0
...
.LBB19_48:                              # %free_num.exit48
	...
	ld.w	$a0, $s3, 4
	bne	$a4, $a0, .LBB19_45
# %bb.49:                               #   in Loop: Header=BB19_45 Depth=1
	ld.w	$a2, $s4, 8
	ld.w	$a3, $s3, 8
	slt	$a0, $a2, $a3
	masknez	$a1, $a3, $a0
...
# %bb.52:                               #   in Loop: Header=BB19_51 Depth=2
	...
	blt	$s5, $a4, .LBB19_51
	b	.LBB19_54
.LBB19_53:                              # %._crit_edge.i49
                                        #   in Loop: Header=BB19_45 Depth=1
	bnez	$a5, .LBB19_45
.LBB19_54:                              # %._crit_edge.thread.i
                                        #   in Loop: Header=BB19_45 Depth=1
	beq	$a3, $a2, .LBB19_65
# %bb.55:                               #   in Loop: Header=BB19_45 Depth=1
	bge	$a3, $a2, .LBB19_61
# %bb.56:                               # %.lr.ph101.i.preheader
                                        #   in Loop: Header=BB19_45 Depth=1
	sub.d	$a0, $a2, $a3
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
...
# %bb.60:                               # %.critedge.i
	...
	bne	$a4, $s6, .LBB19_45
	b	.LBB19_65
.LBB19_61:                              #   in Loop: Header=BB19_45 Depth=1
	sub.w	$a1, $a3, $a2
	blt	$a1, $s5, .LBB19_65
# %bb.62:                               # %.lr.ph97.i.preheader
                                        #   in Loop: Header=BB19_45 Depth=1
	addi.d	$a1, $a1, 1
	.p2align	4, , 16
.LBB19_63:                              # %.lr.ph97.i
...
# %bb.76:
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB19_77:                              # %free_num.exit54
	ori	$a0, $zero, 1
.LBB19_78:                              # %free_num.exit54
	ld.d	$s8, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 80                    # 8-byte Folded Reload
...
.LBB21_7:                               # %is_zero.exit
	beqz	$a4, .LBB21_19
.LBB21_8:                               # %is_zero.exit.thread156
	ori	$s1, $zero, 10
	bne	$s4, $s1, .LBB21_20
# %bb.9:
	ori	$s0, $zero, 1
...
.LBB21_40:                              # %iter.check295
	...
	bltu	$fp, $a1, .LBB21_43
# %bb.41:                               # %vector.memcheck285
	bgeu	$a0, $s0, .LBB21_122
# %bb.42:                               # %vector.memcheck285
	addi.d	$a1, $fp, -1
	bstrpick.d	$a1, $a1, 31, 0
	add.d	$a2, $t2, $a1
	addi.d	$a2, $a2, 17
...
.LBB21_43:
	move	$a2, $s0
.LBB21_44:                              # %vec.epilog.scalar.ph311.preheader
	addi.d	$a1, $fp, 1
	addi.d	$a2, $a2, -1
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB21_45:                              # %vec.epilog.scalar.ph311
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a0, 0
	addi.d	$a0, $a0, 1
...
.LBB21_52:                              # %is_zero.exit95
                                        #   in Loop: Header=BB21_48 Depth=1
	beqz	$a0, .LBB21_60
.LBB21_53:                              # %is_zero.exit95.thread168
                                        #   in Loop: Header=BB21_48 Depth=1
	addi.d	$a2, $sp, 120
	move	$a1, $s7
	move	$s7, $t1
...
.LBB21_66:
	...
	st.d	$s2, $sp, 112
	bge	$a3, $a0, .LBB21_78
.LBB21_67:                              # %.loopexit178
	beqz	$t1, .LBB21_70
.LBB21_68:                              # %.loopexit178.thread
...
# %bb.72:
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB21_73:                              # %free_num.exit143
	ld.w	$a0, $s7, 12
	addi.w	$a0, $a0, -1
	st.w	$a0, $s7, 12
	beqz	$a0, .LBB21_75
# %bb.74:                               # %free_num.exit144
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	bnez	$a0, .LBB21_76
	b	.LBB21_77
.LBB21_75:
...
.LBB21_95:                              #   in Loop: Header=BB21_81 Depth=1
	...
	ori	$a1, $zero, 4
	bltu	$s2, $a1, .LBB21_98
.LBB21_96:                              # %vector.memcheck336
                                        #   in Loop: Header=BB21_81 Depth=1
	bgeu	$a0, $s5, .LBB21_110
# %bb.97:                               # %vector.memcheck336
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a1, $s2, -1
	bstrpick.d	$a1, $a1, 31, 0
	add.d	$a2, $t0, $a1
...
.LBB21_98:                              #   in Loop: Header=BB21_81 Depth=1
	move	$a2, $s5
.LBB21_99:                              # %vec.epilog.scalar.ph364.preheader
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a1, $s2, 1
	addi.d	$a2, $a2, -1
	.p2align	4, , 16
.LBB21_100:                             # %vec.epilog.scalar.ph364
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a2, 0
	st.b	$a3, $a0, 0
...
.LBB21_105:                             # %.lr.ph.i140
	...
	addi.w	$s2, $s2, -1
	blt	$s5, $s2, .LBB21_105
.LBB21_106:                             # %.preheader.i132
                                        #   in Loop: Header=BB21_81 Depth=1
	ld.d	$s7, $sp, 72                    # 8-byte Folded Reload
	blt	$s5, $s0, .LBB21_109
# %bb.107:                              # %.lr.ph15.preheader.i134
                                        #   in Loop: Header=BB21_81 Depth=1
	bstrpick.d	$s2, $s6, 30, 0
	addi.d	$s5, $sp, 144
	.p2align	4, , 16
.LBB21_108:                             # %.lr.ph15.i136
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a0, $s5, 0
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	...
	addi.d	$s5, $s5, 1
	bnez	$s2, .LBB21_108
.LBB21_109:                             # %out_long.exit142
                                        #   in Loop: Header=BB21_81 Depth=1
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	b	.LBB21_80
	.p2align	4, , 16
.LBB21_110:                             # %vector.main.loop.iter.check350
                                        #   in Loop: Header=BB21_81 Depth=1
...
.LBB21_113:                             # %vector.body354
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB21_113
# %bb.114:                              # %middle.block361
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a3, $a1, .LBB21_101
# %bb.115:                              # %vec.epilog.iter.check366
                                        #   in Loop: Header=BB21_81 Depth=1
	andi	$a2, $a1, 12
	beqz	$a2, .LBB21_119
.LBB21_116:                             # %vec.epilog.ph365
                                        #   in Loop: Header=BB21_81 Depth=1
	...
	addi.d	$a3, $a3, 16
	.p2align	4, , 16
.LBB21_117:                             # %vec.epilog.vector.body372
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a7, $a6, 0
	...
	addi.d	$a3, $a3, 4
	bnez	$a5, .LBB21_117
# %bb.118:                              # %vec.epilog.middle.block380
                                        #   in Loop: Header=BB21_81 Depth=1
	bne	$a4, $a1, .LBB21_99
	b	.LBB21_101
...
# %bb.121:
	move	$a3, $zero
	b	.LBB21_138
.LBB21_122:                             # %vector.main.loop.iter.check297
	ori	$a2, $zero, 16
	bstrpick.d	$a1, $fp, 31, 0
...
.LBB21_142:                             # %vector.body301
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB21_142
# %bb.143:                              # %middle.block308
	beq	$a3, $a1, .LBB21_46
# %bb.144:                              # %vec.epilog.iter.check313
	andi	$a2, $a1, 12
	beqz	$a2, .LBB21_149
.LBB21_145:                             # %vec.epilog.ph312
	bstrpick.d	$a2, $a1, 31, 2
	slli.d	$a4, $a2, 2
	sub.d	$fp, $fp, $a4
	alsl.d	$a0, $a2, $a0, 2
	...
	addi.d	$a3, $a3, 16
	.p2align	4, , 16
.LBB21_146:                             # %vec.epilog.vector.body319
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a7, $a6, 0
	vinsgr2vr.w	$vr0, $a7, 0
	vshuf4i.b	$vr0, $vr0, 27
	...
	addi.d	$a3, $a3, 4
	bnez	$a5, .LBB21_146
# %bb.147:                              # %vec.epilog.middle.block327
	bne	$a4, $a1, .LBB21_44
	b	.LBB21_46
.LBB21_148:
	sub.d	$fp, $fp, $a3
