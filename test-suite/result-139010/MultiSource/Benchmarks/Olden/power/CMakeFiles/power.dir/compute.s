...
# %bb.0:
	...
	vinsgr2vr.d	$vr3, $a0, 1
	vfadd.d	$vr2, $vr2, $vr3
	fld.d	$fa3, $sp, 0                    # 8-byte Folded Reload
	movfr2gr.d	$a0, $fa3
	vinsgr2vr.d	$vr3, $a0, 0
...
.LBB4_16:                               # %call.sqrt81
	...
	fst.d	$ft2, $sp, 0                    # 8-byte Folded Spill
	fst.d	$ft4, $sp, 64                   # 8-byte Folded Spill
	fst.d	$ft5, $sp, 56                   # 8-byte Folded Spill
	fst.d	$ft6, $sp, 48                   # 8-byte Folded Spill
	fst.d	$ft7, $sp, 40                   # 8-byte Folded Spill
	fst.d	$ft8, $sp, 32                   # 8-byte Folded Spill
	fst.d	$ft9, $sp, 24                   # 8-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	vldi	$vr18, -912
	fld.d	$ft9, $sp, 24                   # 8-byte Folded Reload
	fld.d	$ft8, $sp, 32                   # 8-byte Folded Reload
	fld.d	$ft7, $sp, 40                   # 8-byte Folded Reload
	fld.d	$ft6, $sp, 48                   # 8-byte Folded Reload
	fld.d	$ft5, $sp, 56                   # 8-byte Folded Reload
	fld.d	$ft4, $sp, 64                   # 8-byte Folded Reload
	vldi	$vr11, -876
	fld.d	$ft2, $sp, 0                    # 8-byte Folded Reload
