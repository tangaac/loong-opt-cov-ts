...
# %bb.13:                               # %middle.block
	...
	move	$t8, $a6
	beq	$a2, $a4, .LBB12_16
.LBB12_14:                              # %"_Z6forallIZL16BM_PIC_1D_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.preheader159"
                                        #   in Loop: Header=BB12_4 Depth=1
	alsl.d	$a7, $t6, $s7, 3
	alsl.d	$t0, $t6, $fp, 2
	alsl.d	$t1, $t6, $s5, 3
...
.LBB18_5:                               #   Parent Loop BB18_4 Depth=1
	...
	fld.d	$fa5, $t1, -8
	move	$s1, $t2
	pcalau12i	$t2, %pc_hi20(.LCPI18_0)
	fld.d	$fa0, $t2, %pc_lo12(.LCPI18_0)
	move	$t2, $s1
