...
.LBB1_54:                               # %vector.ph
	...
	xvld	$xr15, $t7, %pc_lo12(.LCPI1_1)
	addi.d	$t7, $fp, 134
	vreplgr2vr.w	$vr16, $t8
	vrepli.w	$vr17, -7
	ori	$t8, $zero, 512
	.p2align	4, , 16
.LBB1_55:                               # %vector.body
	...
	add.d	$s0, $fp, $a0
	vstelm.h	$vr19, $s0, 104, 0
	vstelm.h	$vr19, $s0, 136, 2
	vstelm.h	$vr19, $s0, 168, 4
	vstelm.h	$vr19, $s0, 200, 6
	...
	add.d	$s7, $a1, $s3
	vstelm.h	$vr19, $s4, 0, 0
	vstelm.h	$vr19, $s5, 0, 2
	vstelm.h	$vr19, $s6, 0, 4
	vstelm.h	$vr19, $s7, 0, 6
	...
	add.d	$s2, $t7, $s2
	add.d	$s3, $t7, $s3
	vstelm.h	$vr18, $s0, 0, 0
	vstelm.h	$vr18, $s1, 0, 2
	vstelm.h	$vr18, $s2, 0, 4
	vstelm.h	$vr18, $s3, 0, 6
...
.LBB1_61:                               # %vector.body442
	...
	vst	$vr1, $fp, 600
	b	.LBB1_97
.LBB1_62:                               # %.preheader155.split.us
	beqz	$a0, .LBB1_98
# %bb.63:                               # %.preheader155.split.us.split
	ld.d	$a4, $a4, 0
	alsl.d	$a2, $a3, $a4, 1
	slli.d	$a3, $a3, 1
	ldx.hu	$a4, $a4, $a3
...
.LBB1_64:
	...
	ldx.w	$a1, $fp, $a0
	b	.LBB1_96
.LBB1_65:                               # %.preheader155.split.1.thread
	ld.w	$a2, $sp, 44
	slli.d	$a2, $a2, 3
	ldx.d	$a5, $s3, $a2
	ld.w	$a6, $sp, 40
...
# %bb.89:                               #   in Loop: Header=BB2_86 Depth=1
	...
	b	.LBB2_94
	.p2align	4, , 16
.LBB2_90:                               # %vector.ph764
                                        #   in Loop: Header=BB2_86 Depth=1
	xvreplgr2vr.h	$xr0, $s0
	move	$s1, $a7
	move	$s2, $a4
	.p2align	4, , 16
.LBB2_91:                               # %vector.body767
...
# %bb.152:                              #   in Loop: Header=BB2_150 Depth=1
	...
	b	.LBB2_157
	.p2align	4, , 16
.LBB2_153:                              # %vector.ph787
                                        #   in Loop: Header=BB2_150 Depth=1
	xvreplgr2vr.h	$xr0, $s7
	move	$s8, $s2
	move	$ra, $t8
	.p2align	4, , 16
.LBB2_154:                              # %vector.body792
	...
	addi.d	$s8, $s8, 64
	bnez	$ra, .LBB2_154
# %bb.155:                              # %middle.block795
                                        #   in Loop: Header=BB2_150 Depth=1
	beq	$a5, $t8, .LBB2_149
# %bb.156:                              # %vec.epilog.iter.check800
                                        #   in Loop: Header=BB2_150 Depth=1
	move	$ra, $t8
	move	$s8, $s0
	beqz	$a6, .LBB2_160
.LBB2_157:                              # %vec.epilog.ph799
                                        #   in Loop: Header=BB2_150 Depth=1
	vreplgr2vr.h	$vr0, $s7
	add.d	$s8, $s3, $ra
	add.d	$ra, $a1, $ra
	alsl.d	$ra, $ra, $t2, 1
	.p2align	4, , 16
.LBB2_158:                              # %vec.epilog.vector.body807
                                        #   Parent Loop BB2_150 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $ra, 0
	addi.d	$s8, $s8, 8
	addi.d	$ra, $ra, 16
	bnez	$s8, .LBB2_158
# %bb.159:                              # %vec.epilog.middle.block811
                                        #   in Loop: Header=BB2_150 Depth=1
	move	$s8, $s1
	beq	$a5, $a7, .LBB2_149
...
# %bb.167:                              #   in Loop: Header=BB2_164 Depth=1
	...
	b	.LBB2_172
	.p2align	4, , 16
.LBB2_168:                              # %vector.ph820
                                        #   in Loop: Header=BB2_164 Depth=1
	xvreplgr2vr.h	$xr0, $s5
	move	$s6, $t8
	move	$s7, $t3
	.p2align	4, , 16
.LBB2_169:                              # %vector.body825
	...
	addi.d	$s6, $s6, 64
	bnez	$s7, .LBB2_169
# %bb.170:                              # %middle.block828
                                        #   in Loop: Header=BB2_164 Depth=1
	beq	$t3, $a1, .LBB2_163
# %bb.171:                              # %vec.epilog.iter.check833
                                        #   in Loop: Header=BB2_164 Depth=1
	move	$s8, $t3
	move	$s7, $t3
	beqz	$t6, .LBB2_175
.LBB2_172:                              # %vec.epilog.ph832
                                        #   in Loop: Header=BB2_164 Depth=1
	vreplgr2vr.h	$vr0, $s5
	add.d	$s6, $fp, $s8
	alsl.d	$s7, $s8, $s0, 1
	.p2align	4, , 16
.LBB2_173:                              # %vec.epilog.vector.body840
                                        #   Parent Loop BB2_164 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s7, 0
	addi.d	$s6, $s6, 8
	addi.d	$s7, $s7, 16
	bnez	$s6, .LBB2_173
# %bb.174:                              # %vec.epilog.middle.block843
                                        #   in Loop: Header=BB2_164 Depth=1
	move	$s7, $t7
	beq	$t7, $a1, .LBB2_163
...
# %bb.181:                              #   in Loop: Header=BB2_179 Depth=1
	...
	b	.LBB2_186
	.p2align	4, , 16
.LBB2_182:                              # %vector.ph852
                                        #   in Loop: Header=BB2_179 Depth=1
	xvreplgr2vr.h	$xr0, $s0
	move	$s1, $t5
	move	$s2, $a2
	.p2align	4, , 16
.LBB2_183:                              # %vector.body857
...
.LBB2_187:                              # %vec.epilog.vector.body872
	...
	addi.d	$s2, $s2, 16
	bnez	$s1, .LBB2_187
# %bb.188:                              # %vec.epilog.middle.block876
                                        #   in Loop: Header=BB2_179 Depth=1
	move	$s1, $t4
	beq	$a5, $a7, .LBB2_178
...
# %bb.0:                                # %.preheader148
	...
	addi.d	$t4, $t1, %pc_lo12(quant_coef)
	ldx.w	$s7, $t4, $s6
	bstrpick.d	$t1, $t2, 31, 31
	add.w	$t1, $t2, $t1
	srai.d	$t1, $t1, 1
	mul.d	$a7, $a7, $s7
	add.d	$a7, $a7, $t1
