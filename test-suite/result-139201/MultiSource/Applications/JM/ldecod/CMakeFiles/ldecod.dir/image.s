...
# %bb.0:
	...
	ld.d	$s1, $a0, %pc_lo12(dec_picture)
	lu12i.w	$a0, 77
	ori	$a0, $a0, 1520
...
.LBB0_14:                               # %.preheader61.us
	...
	ldx.d	$t4, $t2, $t4
	bltu	$a1, $t6, .LBB0_17
# %bb.15:                               # %vector.memcheck223
                                        #   in Loop: Header=BB0_14 Depth=2
	add.d	$fp, $t4, $a5
	alsl.d	$t8, $a3, $t4, 1
	bgeu	$s6, $fp, .LBB0_20
# %bb.16:                               # %vector.memcheck223
                                        #   in Loop: Header=BB0_14 Depth=2
	bgeu	$t8, $s4, .LBB0_20
.LBB0_17:                               #   in Loop: Header=BB0_14 Depth=2
	move	$fp, $zero
.LBB0_18:                               # %scalar.ph230.preheader
                                        #   in Loop: Header=BB0_14 Depth=2
	add.d	$t4, $t4, $a6
	alsl.d	$t4, $fp, $t4, 1
	slli.d	$t8, $fp, 6
...
.LBB0_19:                               # %scalar.ph230
	...
	b	.LBB0_13
	.p2align	4, , 16
.LBB0_20:                               # %vector.body235.preheader
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$fp, $t3
	move	$s0, $t7
	.p2align	4, , 16
.LBB0_21:                               # %vector.body235
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t8, 0
	vstelm.h	$vr0, $fp, -256, 0
	vstelm.h	$vr0, $fp, -192, 1
	vstelm.h	$vr0, $fp, -128, 2
	vstelm.h	$vr0, $fp, -64, 3
	vstelm.h	$vr0, $fp, 0, 4
	vstelm.h	$vr0, $fp, 64, 5
	vstelm.h	$vr0, $fp, 128, 6
	vstelm.h	$vr0, $fp, 192, 7
	addi.d	$s0, $s0, -8
	addi.d	$t8, $t8, 16
	addi.d	$fp, $fp, 512
	bnez	$s0, .LBB0_21
# %bb.22:                               # %middle.block239
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$fp, $t7
	beq	$t7, $a1, .LBB0_13
	b	.LBB0_18
...
# %bb.24:                               # %.preheader.lr.ph.split.us
	...
	slli.d	$a0, $a4, 3
	st.d	$a0, $sp, 112                   # 8-byte Folded Spill
	bstrpick.d	$a0, $a7, 36, 9
	slli.d	$t2, $a0, 9
	move	$a7, $s8
	st.d	$s7, $sp, 128                   # 8-byte Folded Spill
	b	.LBB0_26
	.p2align	4, , 16
.LBB0_25:                               # %._crit_edge.us76
...
# %bb.27:                               #   in Loop: Header=BB0_26 Depth=2
	move	$fp, $zero
.LBB0_28:                               # %scalar.ph212.preheader
                                        #   in Loop: Header=BB0_26 Depth=2
	add.d	$a4, $a3, $fp
	alsl.d	$a0, $a4, $s2, 1
	alsl.d	$t3, $a4, $t4, 1
...
.LBB0_30:                               # %vector.memcheck183
	...
	move	$fp, $zero
	bnez	$s5, .LBB0_28
# %bb.31:                               # %vector.memcheck183
                                        #   in Loop: Header=BB0_26 Depth=2
	sltu	$s5, $t3, $t1
	sltu	$s7, $s8, $s4
	and	$s5, $s5, $s7
	bnez	$s5, .LBB0_38
# %bb.32:                               # %vector.memcheck183
                                        #   in Loop: Header=BB0_26 Depth=2
...
# %bb.34:                               # %vector.memcheck183
	...
	and	$s1, $s4, $s1
	bnez	$s1, .LBB0_28
# %bb.35:                               # %vector.body217.preheader
                                        #   in Loop: Header=BB0_26 Depth=2
	move	$fp, $zero
	.p2align	4, , 16
.LBB0_36:                               # %vector.body217
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_26 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$s1, $s3, $fp
...
.LBB0_38:                               #   in Loop: Header=BB0_26 Depth=2
	ld.d	$s7, $sp, 128                   # 8-byte Folded Reload
	b	.LBB0_28
.LBB0_39:                               # %.preheader61.lr.ph.split.us.1
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a4, $a0, 8
	move	$a0, $zero
	...
	b	.LBB0_41
	.p2align	4, , 16
.LBB0_40:                               # %._crit_edge.us.1
                                        #   in Loop: Header=BB0_41 Depth=2
	addi.d	$a0, $a0, 1
	addi.d	$t8, $t8, 2
	addi.d	$t4, $t4, 2
	beq	$a0, $t5, .LBB0_50
.LBB0_41:                               # %.preheader61.us.1
                                        #   Parent Loop BB0_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB0_48 Depth 3
                                        #       Child Loop BB0_46 Depth 3
	...
	ldx.d	$fp, $a7, $a4
	bltu	$a1, $t6, .LBB0_44
# %bb.42:                               # %vector.memcheck165
                                        #   in Loop: Header=BB0_41 Depth=2
	add.d	$a4, $fp, $a5
	alsl.d	$s0, $a3, $fp, 1
	bgeu	$ra, $a4, .LBB0_47
# %bb.43:                               # %vector.memcheck165
                                        #   in Loop: Header=BB0_41 Depth=2
	ld.d	$a4, $sp, 120                   # 8-byte Folded Reload
	bgeu	$s0, $a4, .LBB0_47
.LBB0_44:                               #   in Loop: Header=BB0_41 Depth=2
	move	$s1, $zero
.LBB0_45:                               # %scalar.ph172.preheader
                                        #   in Loop: Header=BB0_41 Depth=2
	add.d	$a4, $fp, $a6
	alsl.d	$fp, $s1, $a4, 1
	sub.d	$s0, $a1, $s1
...
.LBB0_46:                               # %scalar.ph172
	...
	b	.LBB0_40
	.p2align	4, , 16
.LBB0_47:                               # %vector.body177.preheader
                                        #   in Loop: Header=BB0_41 Depth=2
	move	$s1, $t8
	move	$s2, $t7
	.p2align	4, , 16
.LBB0_48:                               # %vector.body177
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $s0, 0
...
# %bb.49:                               # %middle.block180
	...
	beq	$t3, $a1, .LBB0_40
	b	.LBB0_45
.LBB0_50:                               # %.preheader.lr.ph.split.us.1
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$t5, $a0, 8
	move	$a7, $zero
...
.LBB2_8:
	...
	ret
.LBB2_9:                                # %vector.ph
	pcalau12i	$a3, %pc_hi20(ref_flag+16)
	bstrpick.d	$a2, $a1, 30, 3
	slli.d	$a2, $a2, 3
	addi.d	$a3, $a3, %pc_lo12(ref_flag+16)
	move	$a4, $a2
	b	.LBB2_12
	.p2align	4, , 16
