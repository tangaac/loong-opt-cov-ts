...
# %bb.14:                               # %middle.block
	...
	move	$a2, $s7
	beq	$s7, $s5, .LBB8_6
.LBB8_15:                               # %.lr.ph.split.us.split.us.us.us.preheader1286
                                        #   in Loop: Header=BB8_7 Depth=2
	slli.d	$a1, $a2, 7
	sub.d	$a2, $s5, $a2
	.p2align	4, , 16
...
.LBB8_18:                               # %vector.body1251
	...
	vmax.w	$vr11, $vr11, $vr3
	vmin.w	$vr11, $vr11, $vr4
	vori.b	$vr12, $vr5, 0
	vmadd.w	$vr12, $vr11, $vr10
	vsrai.w	$vr11, $vr12, 6
	addi.d	$a0, $zero, -2048
...
.LBB8_27:                               # %vector.body1268
	...
	vld	$vr13, $a0, %pc_lo12(.LCPI8_0)
	vsub.w	$vr14, $vr11, $vr9
	vmax.w	$vr14, $vr14, $vr3
	vmin.w	$vr14, $vr14, $vr4
	vshuf.b	$vr13, $vr0, $vr14, $vr13
	vsrli.b	$vr15, $vr13, 7
	vadd.b	$vr13, $vr13, $vr15
	vsrai.b	$vr13, $vr13, 1
	vneg.b	$vr15, $vr13
	vmax.b	$vr13, $vr13, $vr15
	vpickev.h	$vr15, $vr12, $vr12
	vilvl.b	$vr13, $vr7, $vr13
	vbitseti.h	$vr13, $vr13, 14
	vpickev.h	$vr14, $vr14, $vr14
	vbitsel.v	$vr14, $vr14, $vr8, $vr15
	vpickve2gr.h	$a0, $vr13, 0
	ori	$a1, $a7, 127
	and	$a0, $a0, $a1
	vpickve2gr.h	$a2, $vr14, 0
	ext.w.h	$a2, $a2
	div.d	$a0, $a0, $a2
	vpickve2gr.h	$a2, $vr13, 1
	and	$a2, $a2, $a1
	vpickve2gr.h	$t4, $vr14, 1
	ext.w.h	$t4, $t4
	div.d	$a2, $a2, $t4
	vpickve2gr.h	$t4, $vr13, 2
	and	$t4, $t4, $a1
	vpickve2gr.h	$t5, $vr14, 2
	ext.w.h	$t5, $t5
	div.d	$t4, $t4, $t5
	vpickve2gr.h	$t5, $vr13, 3
	and	$a1, $t5, $a1
	vpickve2gr.h	$t5, $vr14, 3
	ext.w.h	$t5, $t5
	div.d	$a1, $a1, $t5
	st.h	$a1, $sp, 108
	st.h	$t4, $sp, 104
	...
	vmax.w	$vr10, $vr10, $vr3
	vmin.w	$vr10, $vr10, $vr4
	vslli.w	$vr11, $vr13, 16
	vsrai.w	$vr11, $vr11, 16
	vori.b	$vr13, $vr5, 0
	...
	addi.d	$t0, $t0, 32
	bnez	$t7, .LBB8_27
# %bb.28:                               # %middle.block1272
                                        #   in Loop: Header=BB8_24 Depth=2
	move	$a2, $s8
	beq	$s8, $s5, .LBB8_23
.LBB8_29:                               # %scalar.ph1257.preheader
                                        #   in Loop: Header=BB8_24 Depth=2
	ld.d	$a0, $s6, 0
	ldx.d	$a1, $a0, $a4
	ld.w	$a4, $a1, 4
...
.LBB8_51:                               #   in Loop: Header=BB8_43 Depth=2
	...
	addi.d	$a2, $a2, -256
	b	.LBB8_42
.LBB8_52:                               # %._crit_edge970
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	beqz	$a0, .LBB8_56
.LBB8_53:                               # %._crit_edge970.thread
	ori	$a0, $zero, 16
	masknez	$a0, $a0, $a5
	ori	$a1, $zero, 24
	maskeqz	$a1, $a1, $a5
...
# %bb.64:                               # %.preheader926
	...
	ori	$a0, $zero, 8
	blt	$a1, $a0, .LBB8_101
# %bb.65:                               # %.preheader925.lr.ph
	ldptr.w	$a2, $a4, 6392
	ori	$a0, $zero, 4
	blt	$a2, $a0, .LBB8_101
# %bb.66:                               # %.preheader925.us.preheader
	move	$t2, $zero
...
# %bb.72:                               # %.preheader919.us.us
	...
	ori	$t2, $zero, 256
	blt	$t4, $s8, .LBB8_76
# %bb.73:                               # %.lr.ph988.us.us.preheader
                                        #   in Loop: Header=BB8_71 Depth=2
	move	$s2, $zero
	slli.d	$s3, $t4, 2
	move	$t4, $t8
	.p2align	4, , 16
.LBB8_74:                               # %.lr.ph988.us.us
...
# %bb.102:                              # %.critedge.preheader
	ori	$a1, $zero, 1
	blt	$t3, $a1, .LBB8_187
# %bb.103:                              # %.preheader918.lr.ph
	ldptr.w	$a0, $a4, 6392
	srai.d	$a5, $a0, 2
	blt	$a5, $a1, .LBB8_187
# %bb.104:                              # %.preheader918.lr.ph.split.us
	ldptr.d	$a0, $a4, 6504
	move	$a7, $zero
	ld.d	$t1, $a0, 0
	addi.d	$t2, $sp, 1036
	...
	b	.LBB8_106
	.p2align	4, , 16
.LBB8_105:                              # %._crit_edge1000.us
                                        #   in Loop: Header=BB8_106 Depth=1
	addi.d	$a7, $a7, 1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	beq	$a7, $a0, .LBB8_187
.LBB8_106:                              # %.preheader918.us
                                        # =>This Loop Header: Depth=1
...
# %bb.109:                              # %.preheader916.us
	...
	ori	$s4, $zero, 256
	blt	$s7, $t4, .LBB8_113
# %bb.110:                              # %.lr.ph997.us.preheader
                                        #   in Loop: Header=BB8_108 Depth=2
	move	$s6, $zero
	slli.d	$s7, $s7, 2
	move	$s8, $s2
	.p2align	4, , 16
.LBB8_111:                              # %.lr.ph997.us
...
# %bb.118:                              # %.lr.ph979.us.preheader
	...
	b	.LBB8_120
	.p2align	4, , 16
.LBB8_119:                              # %._crit_edge980.us
                                        #   in Loop: Header=BB8_120 Depth=1
	addi.d	$t6, $t6, 1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	beq	$t6, $a0, .LBB8_63
.LBB8_120:                              # %.lr.ph979.us
                                        # =>This Loop Header: Depth=1
...
# %bb.126:                              # %.preheader930.us
	...
	move	$a5, $zero
	blt	$t3, $s0, .LBB8_146
# %bb.127:                              # %.lr.ph974.us.preheader
                                        #   in Loop: Header=BB8_122 Depth=2
	slli.d	$t3, $t3, 2
	move	$fp, $t7
	.p2align	4, , 16
.LBB8_128:                              # %.lr.ph974.us
...
# %bb.129:                              #   in Loop: Header=BB8_128 Depth=3
	...
	addi.d	$fp, $fp, 8
	bne	$t3, $a5, .LBB8_128
# %bb.130:                              #   in Loop: Header=BB8_122 Depth=2
	move	$a5, $zero
	b	.LBB8_146
	.p2align	4, , 16
...
# %bb.132:                              # %.preheader928.us
	...
	ori	$a5, $zero, 256
	blt	$t3, $s0, .LBB8_136
# %bb.133:                              # %.lr.ph976.us.preheader
                                        #   in Loop: Header=BB8_122 Depth=2
	move	$fp, $zero
	slli.d	$t3, $t3, 2
	move	$ra, $t7
	.p2align	4, , 16
.LBB8_134:                              # %.lr.ph976.us
                                        #   Parent Loop BB8_120 Depth=1
                                        #     Parent Loop BB8_122 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $ra, 0
...
# %bb.138:                              # %.preheader932.us
	...
	move	$a5, $zero
	blt	$t3, $s0, .LBB8_148
# %bb.139:                              # %.lr.ph972.us.preheader
                                        #   in Loop: Header=BB8_122 Depth=2
	slli.d	$t3, $t3, 2
	move	$fp, $t7
	.p2align	4, , 16
.LBB8_140:                              # %.lr.ph972.us
                                        #   Parent Loop BB8_120 Depth=1
                                        #     Parent Loop BB8_122 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $fp, 0
...
# %bb.141:                              #   in Loop: Header=BB8_140 Depth=3
	...
	addi.d	$fp, $fp, 8
	bne	$t3, $a5, .LBB8_140
# %bb.142:                              #   in Loop: Header=BB8_122 Depth=2
	move	$a5, $zero
	b	.LBB8_148
...
.LBB8_151:
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beqz	$a0, .LBB8_167
.LBB8_152:                              # %.critedge912.preheader
	ori	$a0, $zero, 1
...
.LBB8_158:                              #   in Loop: Header=BB8_161 Depth=2
	...
	ld.h	$t0, $a0, 2
	slli.d	$t0, $t0, 1
.LBB8_159:                              # %.thread898.thread.us
                                        #   in Loop: Header=BB8_161 Depth=2
	st.h	$t0, $a0, 2
.LBB8_160:                              # %.thread898.thread.us
                                        #   in Loop: Header=BB8_161 Depth=2
	addi.d	$a6, $a6, 8
	addi.d	$a5, $a5, 1
	beq	$a3, $a6, .LBB8_155
...
# %bb.162:                              #   in Loop: Header=BB8_161 Depth=2
	beqz	$t2, .LBB8_166
# %bb.163:                              # %.thread898.thread899.us
                                        #   in Loop: Header=BB8_161 Depth=2
	bnez	$t1, .LBB8_160
	b	.LBB8_165
.LBB8_164:                              # %.thread898.us
                                        #   in Loop: Header=BB8_161 Depth=2
	beqz	$t2, .LBB8_160
.LBB8_165:                              # %.thread898.thread899.us.thread
                                        #   in Loop: Header=BB8_161 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	ld.d	$t0, $a0, 0
...
# %bb.177:                              # %.preheader913.us
	...
	ori	$t5, $zero, 256
	blt	$t3, $t7, .LBB8_181
# %bb.178:                              # %.lr.ph1003.us.preheader
                                        #   in Loop: Header=BB8_175 Depth=2
	move	$t6, $zero
	slli.d	$t3, $t3, 2
	move	$t4, $s7
	.p2align	4, , 16
.LBB8_179:                              # %.lr.ph1003.us
