...
# %bb.4:                                # %vector.body66
	...
	alsl.d	$t1, $s1, $t0, 3
	vpickve2gr.h	$t8, $vr1, 3
	st.h	$t8, $sp, 184
	vpickve2gr.h	$t8, $vr1, 2
	st.h	$t8, $sp, 176
	vpickve2gr.h	$t8, $vr1, 1
	st.h	$t8, $sp, 168
	vpickve2gr.h	$t8, $vr1, 0
	st.h	$t8, $sp, 160
	xvld	$xr1, $sp, 160
	ld.d	$t8, $t1, 8
	ld.d	$s4, $t1, 16
	...
	vpickve2gr.h	$t5, $vr5, 3
	st.h	$t5, $sp, 248
	vpickve2gr.h	$t5, $vr5, 2
	st.h	$t5, $sp, 240
	vpickve2gr.h	$t5, $vr5, 1
	st.h	$t5, $sp, 232
	vpickve2gr.h	$t5, $vr5, 0
	st.h	$t5, $sp, 224
	ldx.d	$t5, $a5, $a3
	ldx.d	$t6, $a4, $t4
	vilvl.h	$vr5, $vr2, $vr6
	...
	vadd.w	$vr5, $vr3, $vr4
	alsl.d	$t5, $s1, $a2, 3
	vpickve2gr.h	$t6, $vr6, 3
	st.h	$t6, $sp, 24
	vpickve2gr.h	$t6, $vr6, 2
	st.h	$t6, $sp, 16
	vpickve2gr.h	$t6, $vr6, 1
	st.h	$t6, $sp, 8
	vpickve2gr.h	$t6, $vr6, 0
	st.h	$t6, $sp, 0
	xvld	$xr3, $sp, 0
	ld.d	$t6, $t5, 24
	ld.d	$t8, $t5, 16
	...
	vpickve2gr.h	$t4, $vr7, 3
	st.h	$t4, $sp, 216
	vpickve2gr.h	$t4, $vr7, 2
	st.h	$t4, $sp, 208
	vpickve2gr.h	$t4, $vr7, 1
	st.h	$t4, $sp, 200
	vpickve2gr.h	$t4, $vr7, 0
	st.h	$t4, $sp, 192
	xvld	$xr5, $sp, 192
	addi.d	$a7, $a7, 32
	add.d	$t4, $t0, $a7
