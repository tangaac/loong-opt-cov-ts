...
# %bb.4:                                # %vector.body66
	...
	vilvl.h	$vr6, $vr2, $vr6
	vadd.w	$vr4, $vr4, $vr6
	vabsd.hu	$vr6, $vr8, $vr9
	xvstelm.h	$xr5, $sp, 248, 3
	xvstelm.h	$xr5, $sp, 240, 2
	xvstelm.h	$xr5, $sp, 232, 1
	xvstelm.h	$xr5, $sp, 224, 0
	ldx.d	$t4, $a5, $a2
	ldx.d	$t5, $a4, $t6
	vilvl.h	$vr5, $vr2, $vr6
	xvld	$xr2, $sp, 224
	...
	vadd.w	$vr5, $vr3, $vr4
	alsl.d	$t4, $s1, $a3, 3
	xvstelm.h	$xr6, $sp, 24, 3
	xvstelm.h	$xr6, $sp, 16, 2
	xvstelm.h	$xr6, $sp, 8, 1
	xvstelm.h	$xr6, $sp, 0, 0
	xvld	$xr3, $sp, 0
	ld.d	$t5, $t4, 24
	ld.d	$t7, $t4, 16
	ld.d	$t4, $t4, 8
	...
	st.w	$zero, $sp, 130
	xvld	$xr7, $sp, 608
	xvshuf4i.d	$xr9, $xr0, 4
	xvadd.d	$xr8, $xr6, $xr9
	xvpermi.d	$xr6, $xr8, 68
	xvstelm.h	$xr7, $sp, 152, 3
	xvstelm.h	$xr7, $sp, 144, 2
	xvstelm.h	$xr7, $sp, 136, 1
	xvstelm.h	$xr7, $sp, 128, 0
	ldx.d	$a5, $a5, $t4
	ldx.d	$a4, $a4, $t3
	xvrepl128vei.d	$xr7, $xr6, 1
	xvld	$xr6, $sp, 128
	vinsgr2vr.d	$vr9, $a5, 0
	vinsgr2vr.d	$vr10, $a4, 0
	vabsd.hu	$vr9, $vr9, $vr10
	vst	$vr9, $sp, 704
	st.h	$zero, $sp, 62
	st.w	$zero, $sp, 58
	st.h	$zero, $sp, 54
	...
	xvld	$xr10, $a4, %pc_lo12(.LCPI1_1)
	xvstelm.h	$xr9, $sp, 56, 3
	xvstelm.h	$xr9, $sp, 48, 2
	xvstelm.h	$xr9, $sp, 40, 1
	xvstelm.h	$xr9, $sp, 32, 0
	xvld	$xr7, $sp, 32
	add.d	$a4, $a3, $a7
	ldx.d	$a3, $a3, $a7
	ld.d	$a5, $a4, 24
	...
	vld	$vr11, $sp, 480
	xvrepli.b	$xr12, 0
	xvshuf.d	$xr10, $xr12, $xr8
	xvadd.d	$xr1, $xr10, $xr1
	vabsd.hu	$vr8, $vr9, $vr11
	vst	$vr8, $sp, 640
	st.h	$zero, $sp, 126
	st.w	$zero, $sp, 122
	st.h	$zero, $sp, 118
	...
	xvadd.d	$xr1, $xr1, $xr3
	xvadd.d	$xr1, $xr1, $xr4
	xvstelm.h	$xr8, $sp, 120, 3
	xvstelm.h	$xr8, $sp, 112, 2
	xvstelm.h	$xr8, $sp, 104, 1
	xvstelm.h	$xr8, $sp, 96, 0
	xvld	$xr2, $sp, 96
	xvadd.d	$xr1, $xr1, $xr5
	xvadd.d	$xr1, $xr1, $xr6
	xvadd.d	$xr1, $xr1, $xr7
...
.LBB8_46:                               #   in Loop: Header=BB8_6 Depth=1
	...
	ldptr.w	$a0, $a0, 4168
	beqz	$a0, .LBB8_76
# %bb.47:                               #   in Loop: Header=BB8_6 Depth=1
