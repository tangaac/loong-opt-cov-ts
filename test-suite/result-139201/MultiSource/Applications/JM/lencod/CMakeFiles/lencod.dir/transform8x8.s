...
.LBB4_14:                               # %.preheader505
	...
	xvinsgr2vr.w	$xr9, $t2, 5
	xvinsgr2vr.w	$xr9, $t3, 6
	...
	xvinsgr2vr.w	$xr10, $t2, 5
	xvinsgr2vr.w	$xr10, $t3, 6
	xvinsgr2vr.w	$xr10, $a0, 7
...
# %bb.21:                               #   in Loop: Header=BB4_19 Depth=1
	pcalau12i	$fp, %got_pc_hi20(AdaptRndWeight)
	ld.d	$fp, $fp, %got_pc_lo12(AdaptRndWeight)
	ld.w	$fp, $fp, 0
	sll.w	$s8, $t4, $t8
	sub.d	$s6, $s6, $s8
	mul.d	$fp, $fp, $s6
