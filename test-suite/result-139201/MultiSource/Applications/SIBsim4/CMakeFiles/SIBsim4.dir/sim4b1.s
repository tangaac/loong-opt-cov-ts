...
# %bb.107:                              #   in Loop: Header=BB0_106 Depth=3
	...
	st.w	$a5, $a3, 0
	b	.LBB0_105
.LBB0_108:                              # %iter.check1073
                                        #   in Loop: Header=BB0_71 Depth=2
	beqz	$a2, .LBB0_113
# %bb.109:                              # %iter.check1073
                                        #   in Loop: Header=BB0_71 Depth=2
	ori	$a0, $zero, 64
	ld.d	$a3, $sp, 264                   # 8-byte Folded Reload
	ld.d	$t8, $sp, 344                   # 8-byte Folded Reload
	bltu	$a3, $a0, .LBB0_112
# %bb.110:                              # %vector.main.loop.iter.check1075
                                        #   in Loop: Header=BB0_71 Depth=2
	ori	$a0, $zero, 7
	bgeu	$a2, $a0, .LBB0_114
...
.LBB0_113:                              #   in Loop: Header=BB0_71 Depth=2
	...
	move	$a0, $t8
	b	.LBB0_121
.LBB0_114:                              # %vector.ph1076
                                        #   in Loop: Header=BB0_71 Depth=2
	ld.d	$a4, $sp, 336                   # 8-byte Folded Reload
	move	$a3, $a4
	bstrins.d	$a3, $zero, 3, 0
	.p2align	4, , 16
.LBB0_115:                              # %vector.body1079
                                        #   Parent Loop BB0_6 Depth=1
                                        #     Parent Loop BB0_71 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvld	$xr0, $t3, -32
	...
	addi.d	$t3, $t3, 64
	bnez	$t5, .LBB0_115
# %bb.116:                              # %vec.epilog.iter.check1089
                                        #   in Loop: Header=BB0_71 Depth=2
	andi	$a0, $a4, 12
	beqz	$a0, .LBB0_120
...
.LBB0_118:                              # %vec.epilog.ph1088
	...
	alsl.d	$a6, $a5, $a6, 2
	.p2align	4, , 16
.LBB0_119:                              # %vec.epilog.vector.body1094
                                        #   Parent Loop BB0_6 Depth=1
                                        #     Parent Loop BB0_71 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a6, 0
...
.LBB0_223:                              # %vector.body1044
	...
	addi.d	$a1, $a1, 64
	bnez	$t6, .LBB0_223
# %bb.224:                              # %vec.epilog.iter.check1054
                                        #   in Loop: Header=BB0_178 Depth=2
	andi	$a1, $t0, 12
	beqz	$a1, .LBB0_229
.LBB0_225:                              # %vec.epilog.ph1053
                                        #   in Loop: Header=BB0_178 Depth=2
	...
	slli.d	$a2, $a2, 2
	.p2align	4, , 16
.LBB0_226:                              # %vec.epilog.vector.body1059
                                        #   Parent Loop BB0_6 Depth=1
                                        #     Parent Loop BB0_178 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $t1, $a2
...
.LBB0_257:                              # %add_col_elt.exit508.i
	...
	ld.w	$a3, $s6, 36
	bnez	$a1, .LBB0_323
.LBB0_258:                              # %greedy.exit..thread574_crit_edge
                                        #   in Loop: Header=BB0_242 Depth=2
	ld.d	$a0, $s6, 8
	b	.LBB0_324
...
# %bb.263:                              # %iter.check1004
	...
	bltu	$a1, $a2, .LBB0_277
# %bb.264:                              # %vector.main.loop.iter.check1006
                                        #   in Loop: Header=BB0_242 Depth=2
	ori	$a0, $zero, 15
	bgeu	$s0, $a0, .LBB0_270
...
.LBB0_271:                              # %vector.body1012
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB0_271
# %bb.272:                              # %middle.block1015
                                        #   in Loop: Header=BB0_242 Depth=2
	ld.d	$a5, $sp, 224                   # 8-byte Folded Reload
	beq	$t2, $a0, .LBB0_279
# %bb.273:                              # %vec.epilog.iter.check1020
                                        #   in Loop: Header=BB0_242 Depth=2
	andi	$a1, $t2, 12
	beqz	$a1, .LBB0_277
.LBB0_274:                              # %vec.epilog.ph1019
                                        #   in Loop: Header=BB0_242 Depth=2
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s8, 2
	.p2align	4, , 16
.LBB0_275:                              # %vec.epilog.vector.body1027
                                        #   Parent Loop BB0_6 Depth=1
                                        #     Parent Loop BB0_242 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB0_275
# %bb.276:                              # %vec.epilog.middle.block1030
                                        #   in Loop: Header=BB0_242 Depth=2
	ld.d	$a5, $sp, 224                   # 8-byte Folded Reload
	beq	$t2, $a0, .LBB0_279
.LBB0_277:                              # %vec.epilog.scalar.ph1018.preheader
                                        #   in Loop: Header=BB0_242 Depth=2
	sub.d	$a1, $t1, $a0
	addi.d	$a1, $a1, 1
	alsl.d	$a2, $a0, $a4, 2
	alsl.d	$a0, $a0, $s8, 2
	.p2align	4, , 16
.LBB0_278:                              # %vec.epilog.scalar.ph1018
                                        #   Parent Loop BB0_6 Depth=1
                                        #     Parent Loop BB0_242 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a5, $a0, 0
...
# %bb.289:                              # %iter.check974
	...
	bltu	$a1, $a2, .LBB0_300
# %bb.290:                              # %vector.main.loop.iter.check976
                                        #   in Loop: Header=BB0_242 Depth=2
	ori	$a0, $zero, 15
	bgeu	$s0, $a0, .LBB0_293
...
.LBB0_294:                              # %vector.body980
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB0_294
# %bb.295:                              # %middle.block983
                                        #   in Loop: Header=BB0_242 Depth=2
	beq	$t1, $a0, .LBB0_302
# %bb.296:                              # %vec.epilog.iter.check988
                                        #   in Loop: Header=BB0_242 Depth=2
	andi	$a1, $t1, 12
	beqz	$a1, .LBB0_300
.LBB0_297:                              # %vec.epilog.ph987
                                        #   in Loop: Header=BB0_242 Depth=2
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s8, 2
	.p2align	4, , 16
.LBB0_298:                              # %vec.epilog.vector.body993
                                        #   Parent Loop BB0_6 Depth=1
                                        #     Parent Loop BB0_242 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB0_298
# %bb.299:                              # %vec.epilog.middle.block996
                                        #   in Loop: Header=BB0_242 Depth=2
	beq	$t1, $a0, .LBB0_302
.LBB0_300:                              # %vec.epilog.scalar.ph986.preheader
                                        #   in Loop: Header=BB0_242 Depth=2
	sub.d	$a1, $t0, $a0
	addi.d	$a1, $a1, 1
	alsl.d	$a2, $a0, $a5, 2
	alsl.d	$a0, $a0, $s8, 2
	.p2align	4, , 16
.LBB0_301:                              # %vec.epilog.scalar.ph986
                                        #   Parent Loop BB0_6 Depth=1
                                        #     Parent Loop BB0_242 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	addi.w	$a3, $zero, -1
...
.LBB0_458:                              # %.thread578.thread
	...
	sub.w	$a2, $a0, $fp
	st.w	$a2, $s4, 16
.LBB0_459:                              # %thread-pre-split582
                                        #   in Loop: Header=BB0_6 Depth=1
	addi.w	$a0, $a2, -1
	bltz	$a0, .LBB0_464
# %bb.460:                              # %.lr.ph692.preheader
                                        #   in Loop: Header=BB0_6 Depth=1
	ld.d	$a1, $s5, 0
	slli.d	$a0, $a0, 3
	ldx.d	$a0, $a1, $a0
...
# %bb.472:                              #   in Loop: Header=BB0_471 Depth=2
	...
	sltui	$t3, $t3, 1
	bltu	$a6, $s3, .LBB0_479
# %bb.473:                              # %.lr.ph.i.i547.preheader
                                        #   in Loop: Header=BB0_471 Depth=2
	move	$t7, $zero
	move	$t5, $zero
	sub.d	$t4, $s0, $t0
	.p2align	4, , 16
.LBB0_474:                              # %.lr.ph.i.i547
                                        #   Parent Loop BB0_6 Depth=1
...
# %bb.612:                              # %middle.block
	...
	beq	$t2, $a7, .LBB0_615
.LBB0_613:                              # %.lr.ph.i530.preheader1179
                                        #   in Loop: Header=BB0_603 Depth=3
	sub.d	$t2, $a7, $t2
	.p2align	4, , 16
.LBB0_614:                              # %.lr.ph.i530
...
.LBB0_633:                              # %.critedge8.i
	...
	move	$s3, $s0
	b	.LBB0_235
.LBB0_634:                              # %._crit_edge701.loopexit
	ld.d	$fp, $sp, 536
	b	.LBB0_636
.LBB0_635:
	move	$fp, $zero
.LBB0_636:                              # %._crit_edge701
	ld.d	$a0, $sp, 552
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $fp
