...
.LBB9_12:                               # %.loopexit
	ret
.LBB9_13:                               # %vector.memcheck66
	sub.d	$a5, $a1, $a2
	ori	$a4, $zero, 64
	move	$a7, $zero
	bltu	$a5, $a4, .LBB9_4
# %bb.14:                               # %vector.memcheck66
	sub.d	$a5, $a1, $a3
	bltu	$a5, $a4, .LBB9_4
# %bb.15:                               # %vector.main.loop.iter.check74
	ori	$a4, $zero, 16
	bgeu	$a0, $a4, .LBB9_21
# %bb.16:
	move	$t0, $zero
...
.LBB9_22:                               # %vector.body78
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB9_22
# %bb.23:                               # %middle.block88
	beq	$t0, $a0, .LBB9_12
# %bb.24:                               # %vec.epilog.iter.check93
	andi	$a4, $a0, 12
	beqz	$a4, .LBB9_35
.LBB9_25:                               # %vec.epilog.ph92
...
.LBB9_26:                               # %vec.epilog.vector.body98
	...
	addi.d	$a1, $a1, 16
	bnez	$t0, .LBB9_26
# %bb.27:                               # %vec.epilog.middle.block109
	bne	$a7, $a0, .LBB9_5
	b	.LBB9_12
.LBB9_28:                               # %vector.ph
	bstrpick.d	$a4, $a0, 30, 4
