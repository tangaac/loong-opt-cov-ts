...
.LBB0_5:                                # %.lr.ph109
	...
	st.w	$a3, $a1, 0
	bcnez	$fcc0, .LBB0_7
# %bb.6:                                # %.lr.ph109..loopexit_crit_edge
                                        #   in Loop: Header=BB0_5 Depth=1
	addi.d	$a2, $s5, 1
...
.LBB0_10:                               # %iter.check150
	...
	ori	$a3, $zero, 2
	bgeu	$a3, $a4, .LBB0_21
# %bb.11:                               # %vector.main.loop.iter.check152
                                        #   in Loop: Header=BB0_5 Depth=1
	ori	$a3, $zero, 15
	bgeu	$a4, $a3, .LBB0_13
...
.LBB0_14:                               # %vector.body158
	...
	addi.d	$a3, $a3, 64
	bnez	$t0, .LBB0_14
# %bb.15:                               # %middle.block164
                                        #   in Loop: Header=BB0_5 Depth=1
	beq	$a5, $t2, .LBB0_23
# %bb.16:                               # %vec.epilog.iter.check169
                                        #   in Loop: Header=BB0_5 Depth=1
	andi	$a3, $a5, 12
	beqz	$a3, .LBB0_20
.LBB0_17:                               # %vec.epilog.ph168
                                        #   in Loop: Header=BB0_5 Depth=1
	...
	sub.d	$t2, $t2, $a7
	.p2align	4, , 16
.LBB0_18:                               # %vec.epilog.vector.body177
                                        #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $a3, 0
	vfmul.s	$vr2, $vr1, $vr2
	...
	addi.d	$a3, $a3, 16
	bnez	$t2, .LBB0_18
# %bb.19:                               # %vec.epilog.middle.block183
                                        #   in Loop: Header=BB0_5 Depth=1
	bne	$a5, $t4, .LBB0_21
	b	.LBB0_23
