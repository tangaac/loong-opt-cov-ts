...
# %bb.0:
	...
	addi.w	$a0, $a1, 0
	st.d	$a0, $fp, -296                  # 8-byte Folded Spill
	st.d	$a1, $fp, -256                  # 8-byte Folded Spill
	addi.d	$a4, $a1, 2
	bstrpick.d	$a1, $a4, 31, 0
	addi.w	$a0, $a3, 0
	st.d	$a0, $fp, -304                  # 8-byte Folded Spill
	addi.d	$a5, $a3, 2
	...
	ld.w	$a5, $a4, 4
	ori	$a4, $zero, 7
	st.d	$a5, $fp, -280                  # 8-byte Folded Spill
	bne	$a6, $a4, .LBB0_24
# %bb.1:                                # %.preheader255
	ori	$a4, $zero, 1
	blt	$a5, $a4, .LBB0_57
# %bb.2:                                # %.lr.ph313
	...
	ld.d	$t0, $fp, -232                  # 8-byte Folded Reload
	slti	$a4, $t0, 1
	ld.d	$a7, $fp, -296                  # 8-byte Folded Reload
	slti	$a5, $a7, 1
	ld.d	$t1, $fp, -304                  # 8-byte Folded Reload
	slti	$a6, $t1, 1
	addi.w	$s6, $t1, 1
	addi.d	$a7, $a7, 1
	addi.d	$t0, $t0, 1
	...
	st.d	$a3, $fp, -104                  # 8-byte Folded Spill
	ori	$a3, $a3, 1
	...
	lu52i.d	$a0, $a0, 1025
	vreplgr2vr.d	$vr0, $a0
	vst	$vr0, $fp, -224                 # 16-byte Folded Spill
	b	.LBB0_4
	.p2align	4, , 16
.LBB0_3:                                # %.loopexit
...
# %bb.8:                                # %.preheader252.lr.ph.split.split
	...
	vld	$vr5, $fp, -224                 # 16-byte Folded Reload
	vldi	$vr6, -996
	b	.LBB0_10
	.p2align	4, , 16
.LBB0_9:                                # %._crit_edge294.split
	...
	add.d	$a4, $a4, $a0
	ld.d	$t1, $fp, -120                  # 8-byte Folded Reload
	add.d	$t1, $t1, $a0
...
.LBB0_10:                               # %.preheader252
	...
	ldx.d	$a7, $a2, $a1
	ld.d	$t0, $a0, 8
	st.d	$t1, $fp, -120                  # 8-byte Folded Spill
	move	$a5, $a4
	ori	$t3, $zero, 1
	b	.LBB0_12
	.p2align	4, , 16
...
# %bb.16:                               #   in Loop: Header=BB0_12 Depth=3
	...
	ld.d	$s1, $fp, -112                  # 8-byte Folded Reload
...
.LBB0_21:                               # %.preheader251
                                        ...
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB0_22 Depth 3
	st.d	$a1, $fp, -120                  # 8-byte Folded Spill
	st.d	$a2, $fp, -136                  # 8-byte Folded Spill
	slli.d	$a0, $a2, 3
	ld.d	$a1, $fp, -160                  # 8-byte Folded Reload
	ldx.d	$a0, $a1, $a0
	addi.d	$s1, $a0, 8
	ld.d	$s4, $fp, -256                  # 8-byte Folded Reload
	st.d	$s2, $fp, -152                  # 8-byte Folded Spill
	move	$a2, $t1
	.p2align	4, , 16
.LBB0_22:                               # %.preheader
                                        #   Parent Loop BB0_4 Depth=1
...
# %bb.23:                               # %._crit_edge306.split
	...
	addi.d	$a1, $a1, 1
	ld.d	$a0, $fp, -128                  # 8-byte Folded Reload
	ld.d	$s2, $fp, -152                  # 8-byte Folded Reload
	add.d	$s2, $s2, $a0
...
# %bb.25:                               # %.lr.ph
	...
	pcalau12i	$a4, %pc_hi20(blocks)
	ld.d	$a4, $a4, %pc_lo12(blocks)
	st.d	$a4, $fp, -312                  # 8-byte Folded Spill
	ld.d	$t0, $fp, -232                  # 8-byte Folded Reload
	slti	$a4, $t0, 1
	ld.d	$a7, $fp, -296                  # 8-byte Folded Reload
	slti	$a5, $a7, 1
	...
	st.d	$t1, $fp, -128                  # 8-byte Folded Spill
	...
	mul.d	$a7, $a0, $a1
	slli.d	$t4, $a7, 3
	st.d	$t0, $fp, -136                  # 8-byte Folded Spill
	add.d	$a1, $a1, $t0
	slli.d	$a1, $a1, 3
	addi.d	$a1, $a1, -8
	mul.d	$a1, $a1, $a0
	...
	addi.d	$a7, $t1, -1
	add.d	$a3, $a2, $a3
	st.d	$a3, $fp, -352                  # 8-byte Folded Spill
	addi.d	$a3, $a3, 8
	...
	lu32i.d	$a0, -327680
	lu52i.d	$s1, $a0, 1027
	st.d	$t3, $fp, -152                  # 8-byte Folded Spill
	st.d	$t4, $fp, -224                  # 8-byte Folded Spill
	b	.LBB0_27
	.p2align	4, , 16
.LBB0_26:                               # %.loopexit262
                                        #   in Loop: Header=BB0_27 Depth=1
	ld.d	$t2, $fp, -288                  # 8-byte Folded Reload
	addi.d	$t2, $t2, 1
	ld.d	$a0, $fp, -280                  # 8-byte Folded Reload
	beq	$t2, $a0, .LBB0_57
.LBB0_27:                               # =>This Loop Header: Depth=1
	...
	st.d	$t2, $fp, -288                  # 8-byte Folded Spill
...
# %bb.31:                               # %.preheader260.lr.ph.split.split
	...
	move	$a1, $zero
	ori	$a2, $zero, 1
	ld.d	$t0, $fp, -352                  # 8-byte Folded Reload
	ld.d	$t7, $fp, -240                  # 8-byte Folded Reload
	vldi	$vr24, -965
	b	.LBB0_33
	.p2align	4, , 16
.LBB0_32:                               # %._crit_edge270.split
	...
	addi.d	$a1, $a1, 1
	ld.d	$t4, $fp, -224                  # 8-byte Folded Reload
	ld.d	$t7, $fp, -208                  # 8-byte Folded Reload
	add.d	$t7, $t7, $t4
...
.LBB0_33:                               # %.preheader260
	...
	ld.d	$a1, $a1, 8
	ld.d	$s2, $a4, 0
	st.d	$a4, $fp, -104                  # 8-byte Folded Spill
	ld.d	$t8, $a4, 8
	ld.d	$ra, $a2, 0
	st.d	$a2, $fp, -112                  # 8-byte Folded Spill
	ld.d	$t2, $a2, 8
	ld.d	$a3, $a1, 0
	st.d	$a1, $fp, -120                  # 8-byte Folded Spill
	ld.d	$t3, $a1, 8
	...
	st.d	$t7, $fp, -208                  # 8-byte Folded Spill
	ori	$a0, $zero, 1
	b	.LBB0_35
	.p2align	4, , 16
.LBB0_34:                               # %._crit_edge
...
.LBB0_35:                               # %.preheader258
	...
	move	$a2, $t2
	move	$a5, $t3
	ld.d	$a6, $fp, -112                  # 8-byte Folded Reload
	ldx.d	$t2, $a6, $a4
	ld.d	$a6, $fp, -120                  # 8-byte Folded Reload
	ldx.d	$t3, $a6, $a4
	fld.d	$fa0, $t8, 0
	fld.d	$fa1, $t8, 8
	fld.d	$fa2, $t2, 0
	...
	fld.d	$fa5, $t3, 8
	ori	$s3, $zero, 1
	ld.d	$a4, $fp, -128                  # 8-byte Folded Reload
	ori	$a6, $zero, 3
	bgeu	$a4, $a6, .LBB0_39
...
.LBB0_37:                               # %scalar.ph.preheader
	...
	addi.d	$s6, $a2, 8
	addi.d	$s7, $t2, 8
	ld.d	$a7, $fp, -144                  # 8-byte Folded Reload
	sub.d	$s3, $a7, $s3
	addi.d	$s8, $t3, 8
	addi.d	$a7, $a5, 8
	addi.d	$a3, $a3, 8
...
# %bb.48:                               # %vector.ph
	...
	ld.d	$t6, $fp, -160                  # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_49:                               # %vector.body
                                        #   Parent Loop BB0_27 Depth=1
                                        #     Parent Loop BB0_33 Depth=2
	...
	vbsrl.v	$vr22, $vr18, 8
	vldx	$vr18, $a6, $a7
	vpackod.d	$vr8, $vr8, $vr7
	vfadd.d	$vr7, $vr11, $vr20
	vfadd.d	$vr11, $vr7, $vr21
	vbsll.v	$vr7, $vr18, 8
	vor.v	$vr7, $vr7, $vr22
	vbsrl.v	$vr20, $vr17, 8
	vpackod.d	$vr19, $vr17, $vr19
	vldx	$vr17, $a4, $a7
	vfadd.d	$vr8, $vr11, $vr8
	vfadd.d	$vr8, $vr8, $vr7
	vfadd.d	$vr11, $vr8, $vr18
	vbsll.v	$vr8, $vr17, 8
	vor.v	$vr8, $vr8, $vr20
	vfadd.d	$vr11, $vr11, $vr19
	...
	vld	$vr21, $s3, 16
	vbsrl.v	$vr22, $vr16, 8
	vpackod.d	$vr23, $vr16, $vr10
	vldx	$vr16, $s5, $a7
	vfadd.d	$vr11, $vr11, $vr17
	vfadd.d	$vr10, $vr19, $vr20
	vfadd.d	$vr19, $vr10, $vr21
	vbsll.v	$vr10, $vr16, 8
	vor.v	$vr10, $vr10, $vr22
	vbsrl.v	$vr20, $vr15, 8
	vpackod.d	$vr9, $vr15, $vr9
	vldx	$vr15, $s6, $a7
	vfadd.d	$vr19, $vr19, $vr23
	vfadd.d	$vr19, $vr19, $vr10
	vfadd.d	$vr19, $vr19, $vr16
	vbsll.v	$vr21, $vr15, 8
	vor.v	$vr20, $vr21, $vr20
	vfadd.d	$vr9, $vr19, $vr9
	vfadd.d	$vr9, $vr9, $vr20
	add.d	$s3, $a3, $a7
	vldx	$vr19, $a3, $a7
	vld	$vr21, $s3, 8
	vld	$vr22, $s3, 16
	vbsrl.v	$vr23, $vr14, 8
	vpackod.d	$vr6, $vr14, $vr6
	vldx	$vr14, $s8, $a7
	vfadd.d	$vr9, $vr9, $vr15
	vfadd.d	$vr19, $vr19, $vr21
	vfadd.d	$vr19, $vr19, $vr22
	vbsll.v	$vr21, $vr14, 8
	...
	vfadd.d	$vr6, $vr6, $vr21
	vfadd.d	$vr6, $vr6, $vr14
	vbsll.v	$vr19, $vr13, 8
	vor.v	$vr19, $vr19, $vr22
...
# %bb.51:                               #   in Loop: Header=BB0_35 Depth=3
	...
	ld.d	$s3, $fp, -176                  # 8-byte Folded Reload
	b	.LBB0_37
	.p2align	4, , 16
.LBB0_52:                               # %.preheader261
                                        #   in Loop: Header=BB0_27 Depth=1
	ld.d	$t3, $fp, -152                  # 8-byte Folded Reload
...
# %bb.53:                               # %.preheader259.lr.ph.split.split
	...
	move	$s5, $zero
	ori	$s6, $zero, 1
	ld.d	$s7, $fp, -240                  # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_54:                               # %.preheader259
                                        ...
                                        #       Child Loop BB0_55 Depth 3
	slli.d	$a0, $s6, 3
	ld.d	$a1, $fp, -104                  # 8-byte Folded Reload
	ldx.d	$a0, $a1, $a0
	addi.d	$s8, $a0, 8
	ld.d	$s3, $fp, -256                  # 8-byte Folded Reload
	move	$s2, $s7
	move	$a2, $t3
	.p2align	4, , 16
