...
# %bb.3:
	...
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB3_4:                                # %_ZNSt6vectorIdSaIdEEC2IPdvEET_S4_RKS0_.exit
	srli.d	$a0, $fp, 3
	clz.d	$a0, $a0
	slli.d	$a0, $a0, 1
	xori	$a2, $a0, 126
...
# %bb.8:                                #   in Loop: Header=BB3_7 Depth=1
	...
	addi.d	$a3, $a3, -8
	bcnez	$fcc0, .LBB3_7
# %bb.9:                                # %_ZSt15__adjacent_findIPdN9__gnu_cxx5__ops19_Iter_equal_to_iterEET_S4_S4_T0_.exit.i.i
	addi.d	$a3, $a1, 16
	beq	$a3, $s1, .LBB3_14
...
# %bb.13:                               #   in Loop: Header=BB3_12 Depth=1
	...
	fmov.d	$fa0, $fa1
	b	.LBB3_11
.LBB3_14:                               # %_ZSt6uniqueIPdET_S1_S1_.exit
	move	$a0, $s0
	move	$a1, $fp
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	...
	pcaddu18i	$t8, %call36(_ZdlPvm)
	jr	$t8
.LBB3_15:                               # %_ZNSt6vectorIdSaIdEED2Ev.exit
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
...
# %bb.3:
	...
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB4_4:                                # %_ZNSt6vectorIdSaIdEEC2IPdvEET_S4_RKS0_.exit
	srli.d	$a0, $fp, 3
	clz.d	$a0, $a0
	slli.d	$a0, $a0, 1
	xori	$a2, $a0, 126
...
# %bb.8:                                #   in Loop: Header=BB4_7 Depth=1
	...
	addi.d	$a3, $a3, -8
	bcnez	$fcc0, .LBB4_7
# %bb.9:                                # %_ZSt15__adjacent_findIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops19_Iter_equal_to_iterEET_S9_S9_T0_.exit.i.i
	addi.d	$a3, $a1, 16
	beq	$a3, $s1, .LBB4_14
# %bb.10:                               # %.lr.ph.i.i.preheader
	ori	$a3, $zero, 8
...
.LBB4_14:                               # %.loopexit
	...
	pcaddu18i	$t8, %call36(_ZdlPvm)
	jr	$t8
.LBB4_15:                               # %_ZNSt6vectorIdSaIdEED2Ev.exit
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
...
# %bb.11:                               #   in Loop: Header=BB14_10 Depth=1
	...
	fst.d	$fa1, $a0, 0
	b	.LBB14_9
.LBB14_12:                              # %_ZSt14random_shuffleIPdEvT_S1_.exit
	bgtz	$s3, .LBB14_15
	b	.LBB14_36
.LBB14_13:                              # %_ZSt14random_shuffleIPdEvT_S1_.exit.thread
	ori	$a0, $zero, 1
	blt	$s3, $a0, .LBB14_37
# %bb.14:
	move	$s0, $zero
	move	$fp, $zero
.LBB14_15:                              # %.lr.ph.i46.preheader
	addi.d	$s1, $s3, 1
	ori	$s2, $zero, 1
	move	$s3, $s1
	.p2align	4, , 16
...
# %bb.35:                               # %.noexc70
	...
	addi.w	$s1, $s1, -1
	bltu	$s2, $s1, .LBB14_34
.LBB14_36:                              # %_Z3runPFvPdS_iES_S_i.exit71.thread90
	sub.d	$a1, $s0, $fp
	move	$a0, $fp
	...
	pcaddu18i	$t8, %call36(_ZdlPvm)
	jr	$t8
.LBB14_37:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit
	fld.d	$fs0, $sp, 8                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
...
.LBB14_38:                              # %.noexc
	...
	pcaddu18i	$ra, %call36(_ZSt20__throw_length_errorPKc)
	jirl	$ra, $ra, 0
.LBB14_39:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit73.loopexit
.Ltmp63:
	b	.LBB14_46
.LBB14_40:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit73.loopexit.split-lp.loopexit
.Ltmp60:
	b	.LBB14_46
.LBB14_41:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit73.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp57:
	b	.LBB14_46
.LBB14_42:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit73.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp54:
	b	.LBB14_46
.LBB14_43:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit73.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp51:
	b	.LBB14_46
.LBB14_44:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit73.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp48:
	b	.LBB14_46
.LBB14_45:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit73.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp
.Ltmp45:
.LBB14_46:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit73
	move	$s1, $a0
	sub.d	$a1, $s0, $fp
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
