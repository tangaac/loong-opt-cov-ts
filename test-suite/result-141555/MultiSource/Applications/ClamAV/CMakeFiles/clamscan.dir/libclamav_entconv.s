...
.LBB4_126:
	beqz	$s5, .LBB4_198
# %bb.127:                              # %iter.check377
	ori	$a0, $zero, 15
	bltu	$s5, $a0, .LBB4_130
# %bb.128:                              # %vector.memcheck368
	addi.d	$a0, $s5, -1
...
.LBB4_146:
	...
	jirl	$ra, $ra, 0
	b	.LBB4_198
.LBB4_147:                              # %.preheader2.i
	ori	$a0, $zero, 2
	bltu	$s5, $a0, .LBB4_198
# %bb.148:                              # %.lr.ph30.i.preheader
	move	$a0, $zero
	srli.d	$a1, $s5, 1
	addi.d	$a2, $s2, 2
	lu12i.w	$a3, 15
...
# %bb.151:                              #   in Loop: Header=BB4_150 Depth=1
	ld.hu	$a4, $a2, -2
	b	.LBB4_149
.LBB4_152:                              # %.preheader4.i
	beqz	$s5, .LBB4_198
# %bb.153:                              # %.lr.ph28.i.preheader
	move	$a0, $zero
	move	$a1, $s4
	b	.LBB4_155
...
.LBB4_183:
	...
	ori	$a3, $zero, 2
	b	.LBB4_68
.LBB4_184:                              # %vector.main.loop.iter.check379
	srli.d	$a0, $a0, 1
	ori	$a2, $zero, 31
	addi.d	$a0, $a0, 1
	bgeu	$s5, $a2, .LBB4_195
...
.LBB4_186:                              # %vec.epilog.ph390
	...
	add.d	$a1, $s6, $a1
	sub.d	$a3, $a3, $a4
.LBB4_187:                              # %vec.epilog.vector.body396
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a3, .LBB4_187
# %bb.188:                              # %vec.epilog.middle.block403
	bne	$a0, $a4, .LBB4_131
	b	.LBB4_198
.LBB4_189:                              # %vector.main.loop.iter.check
	ori	$a2, $zero, 16
...
# %bb.194:
	...
	b	.LBB4_60
.LBB4_195:                              # %vector.ph380
	move	$a3, $a0
	bstrins.d	$a3, $zero, 3, 0
	move	$a2, $a3
	move	$a4, $s4
	move	$a5, $s2
.LBB4_196:                              # %vector.body383
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vld	$vr1, $a5, 16
	vshuf4i.b	$vr0, $vr0, 177
...
.LBB4_203:                              # %vector.ph
	...
	vld	$vr6, $a6, %pc_lo12(.LCPI4_6)
	st.d	$a5, $sp, 32                    # 8-byte Folded Spill
	vld	$vr7, $a5, %pc_lo12(.LCPI4_7)
	bstrpick.d	$a2, $a0, 62, 4
	slli.d	$a2, $a2, 4
	move	$a5, $s2
	move	$a6, $a2
.LBB4_204:                              # %vector.body
                                        # =>This Inner Loop Header: Depth=1
	vslli.d	$vr8, $vr0, 1
	vslli.d	$vr9, $vr1, 1
	vslli.d	$vr10, $vr2, 1
	...
	vslli.d	$vr14, $vr6, 1
	vslli.d	$vr15, $vr7, 1
	vpickve2gr.d	$a7, $vr15, 0
	add.d	$t0, $s4, $a7
	vpickve2gr.d	$t1, $vr15, 1
	vpickve2gr.d	$t2, $vr14, 0
	vpickve2gr.d	$t3, $vr14, 1
	...
	vstelm.b	$vr8, $t0, 1, 9
	add.d	$t0, $s4, $s1
	vstelm.b	$vr8, $t0, 1, 10
	add.d	$t0, $s4, $s5
	vstelm.b	$vr8, $t0, 1, 11
	add.d	$t0, $s4, $ra
	vstelm.b	$vr8, $t0, 1, 12
	add.d	$a3, $s4, $a3
	vstelm.b	$vr8, $a3, 1, 13
	add.d	$a3, $s4, $a4
	vstelm.b	$vr8, $a3, 1, 14
	add.d	$a3, $s4, $a7
	vstelm.b	$vr8, $a3, 1, 15
	vaddi.du	$vr7, $vr7, 16
	vaddi.du	$vr6, $vr6, 16
	vaddi.du	$vr5, $vr5, 16
	vaddi.du	$vr4, $vr4, 16
...
# %bb.206:                              # %vec.epilog.iter.check
	andi	$a3, $a0, 12
	beqz	$a3, .LBB4_138
.LBB4_207:                              # %vec.epilog.ph
	move	$a4, $a2
	bstrpick.d	$a2, $a0, 62, 2
	vld	$vr0, $a6, %pc_lo12(.LCPI4_6)
	vld	$vr1, $a5, %pc_lo12(.LCPI4_7)
	slli.d	$a2, $a2, 2
	vreplgr2vr.d	$vr2, $a4
	vor.v	$vr0, $vr2, $vr0
	vor.v	$vr1, $vr2, $vr1
	sub.d	$a3, $a4, $a2
	add.d	$a4, $s2, $a4
.LBB4_208:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vslli.d	$vr2, $vr0, 1
	vslli.d	$vr3, $vr1, 1
...
# %bb.209:                              # %vec.epilog.middle.block
	beq	$a0, $a2, .LBB4_140
	b	.LBB4_138
.LBB4_210:                              # %vec.epilog.iter.check391
	andi	$a2, $a0, 8
	bnez	$a2, .LBB4_212
# %bb.211:
	slli.d	$a2, $a3, 1
