...
.LBB1_53:
	...
	move	$a2, $zero
	move	$s7, $s0
.LBB1_54:                               # %.preheader.i230.preheader
	add.d	$a0, $a4, $a0
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a3
	addi.d	$a0, $a0, 1
...
.LBB1_55:                               # %.preheader.i230
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB1_55
.LBB1_56:                               # %sis_utf16_decode.exit237
...
.LBB1_119:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vpickev.b	$vr2, $vr1, $vr1
	vpickod.b	$vr1, $vr1, $vr1
	vslli.b	$vr1, $vr1, 4
	vadd.b	$vr1, $vr2, $vr1
	vseq.b	$vr2, $vr1, $vr0
...
.LBB1_137:
	...
	addi.w	$a0, $zero, -123
	b	.LBB1_110
.LBB1_138:                              # %vector.main.loop.iter.check38
	ori	$a2, $zero, 31
	bgeu	$s7, $a2, .LBB1_143
# %bb.139:
	move	$a2, $zero
	move	$s7, $s0
.LBB1_140:                              # %vec.epilog.ph52
	move	$a7, $a2
	bstrpick.d	$a4, $a3, 30, 3
	slli.d	$a2, $a4, 3
	slli.d	$a4, $a4, 4
	...
	add.d	$a7, $s6, $a7
	vrepli.b	$vr0, 37
.LBB1_141:                              # %vec.epilog.vector.body58
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vpickev.b	$vr2, $vr1, $vr1
	vpickod.b	$vr1, $vr1, $vr1
	...
	addi.d	$a7, $a7, 8
	bnez	$a6, .LBB1_141
# %bb.142:                              # %vec.epilog.middle.block65
	bne	$a2, $a3, .LBB1_54
	b	.LBB1_56
.LBB1_143:                              # %vector.ph39
	bstrpick.d	$a2, $a3, 30, 4
	slli.d	$a2, $a2, 4
	vrepli.b	$vr0, 37
	move	$a5, $s6
...
.LBB1_144:                              # %vector.body42
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB1_144
# %bb.145:                              # %middle.block48
	beq	$a2, $a3, .LBB1_56
# %bb.146:                              # %vec.epilog.iter.check53
	andi	$a4, $a3, 8
	bnez	$a4, .LBB1_140
# %bb.147:
	slli.d	$a4, $a2, 1
