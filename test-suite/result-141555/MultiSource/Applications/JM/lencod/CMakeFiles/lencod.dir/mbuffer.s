...
# %bb.186:                              # %middle.block1069
	beq	$a0, $s3, .LBB11_189
.LBB11_187:                             # %.lr.ph745.preheader1174
	slli.d	$a1, $a0, 3
	alsl.d	$a1, $s7, $a1, 3
	slli.d	$a2, $s3, 3
	sub.d	$a1, $a1, $a2
...
.LBB11_263:                             # %vector.body1079
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_263
# %bb.264:                              # %middle.block1084
	beq	$a2, $a0, .LBB11_267
.LBB11_265:                             # %scalar.ph1074.preheader
	alsl.d	$a1, $a2, $a1, 3
	alsl.d	$a3, $a2, $s2, 3
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB11_266:                             # %scalar.ph1074
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	st.d	$a2, $a3, 0
	addi.d	$a1, $a1, 8
...
.LBB11_324:
	move	$a3, $zero
.LBB11_325:                             # %scalar.ph1090.preheader
	slli.d	$a4, $a3, 3
	alsl.d	$a4, $s2, $a4, 3
	sub.d	$a4, $a4, $a1
	add.d	$a2, $a2, $a4
...
# %bb.329:                              # %vector.memcheck1103
	alsl.d	$a3, $fp, $a0, 3
	sub.d	$a3, $a2, $a3
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB11_333
# %bb.330:                              # %vector.ph1107
	move	$a3, $s0
...
.LBB11_331:                             # %vector.body1110
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB11_331
# %bb.332:                              # %middle.block1115
	beq	$a3, $s0, .LBB11_335
.LBB11_333:                             # %scalar.ph1105.preheader
	slli.d	$a3, $fp, 3
	sub.d	$a1, $a3, $a1
	add.d	$a1, $a2, $a1
	alsl.d	$a2, $fp, $a0, 3
...
# %bb.393:                              # %middle.block1131
	...
	sltu	$a6, $zero, $a6
	beq	$a5, $a4, .LBB11_396
.LBB11_394:                             # %scalar.ph1118.preheader
	alsl.d	$a7, $a5, $a2, 3
	alsl.d	$a3, $a5, $a3, 3
	sub.d	$a4, $a4, $a5
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB11_395:                             # %scalar.ph1118
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t0, $a3, 0
	ld.d	$t1, $a7, 0
	xor	$t0, $t0, $t1
...
# %bb.28:                               # %middle.block125
                                        #   in Loop: Header=BB21_5 Depth=1
	beq	$a3, $t0, .LBB21_31
.LBB21_29:                              # %.lr.ph.i73.preheader132
                                        #   in Loop: Header=BB21_5 Depth=1
	alsl.d	$a3, $a7, $s4, 3
	.p2align	4, , 16
.LBB21_30:                              # %.lr.ph.i73
...
.LBB29_34:                              #   in Loop: Header=BB29_23 Depth=2
	...
	stx.d	$a1, $a2, $s6
	bgez	$s8, .LBB29_33
.LBB29_35:                              #   in Loop: Header=BB29_23 Depth=2
	move	$a1, $zero
	ld.d	$a2, $s7, 0
	ldx.d	$a2, $a2, $t5
	stx.d	$a1, $a2, $s6
...
.LBB29_38:                              #   in Loop: Header=BB29_39 Depth=2
	...
	addi.d	$t5, $t5, 8
	beqz	$s0, .LBB29_18
.LBB29_39:                              #   Parent Loop BB29_19 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $t6, 0
	move	$a1, $t3
	bltz	$a3, .LBB29_41
...
.LBB29_45:                              # %.loopexit469.thread535
	ldptr.d	$a1, $a0, 6528
	ldptr.w	$a2, $a0, 6392
	ld.d	$a0, $a1, 0
	srli.d	$a1, $a2, 4
...
.LBB29_49:                              # %._crit_edge494
	...
	srai.d	$a1, $a1, 3
	bge	$a2, $a1, .LBB29_55
.LBB29_50:                              # =>This Loop Header: Depth=1
...
.LBB29_52:                              #   in Loop: Header=BB29_53 Depth=2
	...
	addi.d	$a1, $a1, 8
	bge	$t0, $t7, .LBB29_49
.LBB29_53:                              #   Parent Loop BB29_50 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldptr.d	$t7, $a0, 6480
	srli.d	$t8, $a7, 1
	and	$t8, $t8, $a5
...
.LBB29_58:                              # %._crit_edge500
	...
	srai.d	$a5, $a5, 3
	bge	$a1, $a5, .LBB29_77
.LBB29_59:                              # =>This Loop Header: Depth=1
...
.LBB29_62:                              #   in Loop: Header=BB29_63 Depth=2
	...
	addi.w	$a5, $a5, 1
	bge	$a7, $t5, .LBB29_58
.LBB29_63:                              #   Parent Loop BB29_59 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldptr.w	$t5, $a0, 6432
	beqz	$t5, .LBB29_65
# %bb.64:                               #   in Loop: Header=BB29_63 Depth=2
	...
	ldx.bu	$t5, $t5, $t6
	bnez	$t5, .LBB29_61
.LBB29_65:                              #   in Loop: Header=BB29_63 Depth=2
	ldptr.d	$a0, $a0, 6528
	ldx.d	$a0, $a0, $t2
	stx.b	$zero, $a0, $a7
	ld.d	$a0, $fp, 40
...
# %bb.66:                               #   in Loop: Header=BB29_63 Depth=2
	...
	stx.b	$t5, $t6, $a7
	bltz	$t5, .LBB29_69
# %bb.67:                               #   in Loop: Header=BB29_63 Depth=2
	ld.d	$t6, $fp, 48
	ldptr.d	$t6, $t6, 6504
	ld.d	$t7, $fp, 40
	ld.d	$t6, $t6, 0
	...
	b	.LBB29_70
	.p2align	4, , 16
.LBB29_68:                              #   in Loop: Header=BB29_63 Depth=2
	stx.b	$a4, $t6, $a7
	ld.d	$t5, $fp, 48
	ldptr.d	$t5, $t5, 6488
	ld.d	$t5, $t5, 0
...
.LBB29_70:                              #   in Loop: Header=BB29_63 Depth=2
	...
	ldx.d	$t6, $t6, $t3
	stx.d	$t5, $t6, $a6
.LBB29_71:                              #   in Loop: Header=BB29_63 Depth=2
	ld.d	$t5, $fp, 40
	ldptr.d	$t5, $t5, 6488
	ld.d	$t6, $fp, 56
	ld.d	$t5, $t5, 8
	...
	ldx.d	$t5, $t6, $t3
	beq	$a0, $a3, .LBB29_74
# %bb.72:                               #   in Loop: Header=BB29_63 Depth=2
	stx.b	$a0, $t5, $a7
	ld.d	$t5, $fp, 48
	ldptr.d	$t5, $t5, 6488
	ld.d	$t5, $t5, 8
	...
	stx.b	$a0, $t5, $a7
	bltz	$a0, .LBB29_75
# %bb.73:                               #   in Loop: Header=BB29_63 Depth=2
	ld.d	$t5, $fp, 48
	ldptr.d	$t5, $t5, 6504
	ld.d	$t6, $fp, 40
	ld.d	$t5, $t5, 8
	...
	b	.LBB29_76
	.p2align	4, , 16
.LBB29_74:                              #   in Loop: Header=BB29_63 Depth=2
	stx.b	$a4, $t5, $a7
	ld.d	$a0, $fp, 48
	ldptr.d	$a0, $a0, 6488
	ld.d	$a0, $a0, 8
...
.LBB29_75:                              # %.critedge466
	...
	move	$a0, $zero
	stx.d	$zero, $t5, $a6
.LBB29_76:                              #   in Loop: Header=BB29_63 Depth=2
	ld.d	$t5, $fp, 56
	ldptr.d	$t5, $t5, 6504
	ld.d	$t5, $t5, 8
	ldx.d	$t5, $t5, $t3
...
# %bb.5:                                # %vector.ph
	addi.w	$a7, $zero, -2
	pcalau12i	$t1, %pc_hi20(.LCPI34_0)
	vld	$vr0, $t1, %pc_lo12(.LCPI34_0)
	or	$a7, $a4, $a7
	add.d	$a7, $a7, $a4
	move	$t1, $a7
	.p2align	4, , 16
...
# %bb.11:
	move	$a5, $zero
	b	.LBB34_17
.LBB34_12:                              # %.preheader167..preheader_crit_edge
	ld.d	$t1, $fp, 48
	b	.LBB34_19
.LBB34_13:                              # %vector.memcheck192
	addi.d	$a3, $t1, 24
	addi.d	$a4, $a1, 24
	alsl.d	$a5, $a2, $a1, 3
	addi.d	$a7, $a5, 24
...
# %bb.15:                               # %vector.ph205
	addi.w	$a5, $zero, -2
	pcalau12i	$a7, %pc_hi20(.LCPI34_0)
	vld	$vr0, $a7, %pc_lo12(.LCPI34_0)
	or	$a5, $a2, $a5
	add.d	$a5, $a5, $a2
	move	$a7, $a5
	.p2align	4, , 16
.LBB34_16:                              # %vector.body208
                                        # =>This Inner Loop Header: Depth=1
	vslli.d	$vr1, $vr0, 1
	...
	addi.d	$a4, $a4, 16
	bnez	$a7, .LBB34_16
.LBB34_17:                              # %scalar.ph203.preheader
	slli.d	$a3, $a5, 4
	addi.d	$a3, $a3, 24
	alsl.d	$a1, $a5, $a1, 3
	addi.d	$a1, $a1, 24
...
# %bb.26:                               #   in Loop: Header=BB34_25 Depth=2
	...
	b	.LBB34_28
	.p2align	4, , 16
.LBB34_27:                              #   in Loop: Header=BB34_25 Depth=2
	move	$t6, $zero
.LBB34_28:                              #   in Loop: Header=BB34_25 Depth=2
	ldptr.d	$t5, $t4, 6504
	ld.d	$t7, $t5, 0
	ldx.d	$t7, $t7, $t0
	stx.d	$t6, $t7, $a4
...
# %bb.29:                               #   in Loop: Header=BB34_25 Depth=2
	...
	stx.d	$t6, $t5, $a4
	bltz	$t1, .LBB34_32
.LBB34_30:                              #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t5, $t3, 1608
	b	.LBB34_33
	.p2align	4, , 16
.LBB34_31:                              #   in Loop: Header=BB34_25 Depth=2
	move	$t6, $zero
	ld.d	$t5, $t5, 8
	ldx.d	$t5, $t5, $t0
	stx.d	$t6, $t5, $a4
	bgez	$t1, .LBB34_30
.LBB34_32:                              #   in Loop: Header=BB34_25 Depth=2
	move	$t5, $zero
.LBB34_33:                              #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t1, $fp, 40
	ldptr.d	$t3, $t1, 6504
	ld.d	$t6, $t3, 0
	ldx.d	$t6, $t6, $a7
	stx.d	$t5, $t6, $a4
	bltz	$t2, .LBB34_35
# %bb.34:                               #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t2, $t4, 1872
	b	.LBB34_36
	.p2align	4, , 16
.LBB34_35:                              #   in Loop: Header=BB34_25 Depth=2
	move	$t2, $zero
.LBB34_36:                              #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t4, $fp, 56
	ldptr.d	$t5, $t4, 6512
	ld.d	$t6, $t5, 0
	ldptr.d	$t7, $t1, 6512
	...
	alsl.d	$t3, $t2, $t4, 3
	bltz	$t2, .LBB34_38
# %bb.37:                               #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t6, $t3, 24
	b	.LBB34_39
	.p2align	4, , 16
.LBB34_38:                              #   in Loop: Header=BB34_25 Depth=2
	move	$t6, $zero
.LBB34_39:                              #   in Loop: Header=BB34_25 Depth=2
	ldptr.d	$t5, $t4, 6504
	ld.d	$t7, $t5, 0
	ldx.d	$t7, $t7, $t0
	stx.d	$t6, $t7, $a4
	alsl.d	$t4, $t1, $t4, 3
	bltz	$t1, .LBB34_41
# %bb.40:                               #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t6, $t4, 288
	b	.LBB34_42
	.p2align	4, , 16
.LBB34_41:                              #   in Loop: Header=BB34_25 Depth=2
	move	$t6, $zero
.LBB34_42:                              #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t5, $t5, 8
	ldx.d	$t7, $t5, $t0
	addi.w	$t5, $zero, -1
	stx.d	$t6, $t7, $a4
	move	$t6, $t5
	bltz	$t2, .LBB34_44
# %bb.43:                               #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t6, $t3, 1608
.LBB34_44:                              #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t2, $fp, 40
	ldptr.d	$t2, $t2, 6504
	ld.d	$t3, $t2, 0
	ldx.d	$t3, $t3, $a6
	stx.d	$t6, $t3, $a4
	bltz	$t1, .LBB34_24
# %bb.45:                               #   in Loop: Header=BB34_25 Depth=2
	ld.d	$t5, $t4, 1872
	b	.LBB34_24
.LBB34_46:                              # %._crit_edge175
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
	addi.d	$sp, $sp, 32
...
.LBB40_22:                              #   in Loop: Header=BB40_18 Depth=2
	...
	move	$s5, $t3
	b	.LBB40_17
.LBB40_23:                              # %.loopexit827.loopexit
	ld.d	$s5, $a3, 0
.LBB40_24:                              # %.loopexit827
	ld.w	$a5, $s5, 24
	bnez	$a5, .LBB40_26
# %bb.25:
	ldptr.w	$a5, $s5, 15268
...
# %bb.27:                               # %.lr.ph838
	...
	b	.LBB40_30
	.p2align	4, , 16
.LBB40_28:                              # %._crit_edge835.loopexit
                                        #   in Loop: Header=BB40_30 Depth=1
	ori	$a5, $a4, 2300
	ldx.w	$fp, $a2, $a5
.LBB40_29:                              # %._crit_edge835
                                        #   in Loop: Header=BB40_30 Depth=1
	addi.d	$t0, $t0, 1
...
# %bb.83:                               # %.lr.ph844
	...
	b	.LBB40_86
	.p2align	4, , 16
.LBB40_84:                              # %._crit_edge842.loopexit
                                        #   in Loop: Header=BB40_86 Depth=1
	ldx.w	$t5, $a2, $t4
.LBB40_85:                              # %._crit_edge842
                                        #   in Loop: Header=BB40_86 Depth=1
	addi.d	$a7, $a7, 1
	srai.d	$a5, $t5, 2
	bge	$a7, $a5, .LBB40_95
...
# %bb.93:                               #   in Loop: Header=BB40_91 Depth=2
	...
	move	$s2, $t7
	b	.LBB40_89
.LBB40_94:                              # %.loopexit825.thread
	ori	$a5, $a4, 2280
	ldx.b	$a5, $a2, $a5
	ori	$a6, $a4, 768
	stx.b	$a5, $a0, $a6
	b	.LBB40_97
.LBB40_95:                              # %.loopexit825.loopexit
	ld.d	$a5, $sp, 0                     # 8-byte Folded Reload
	ld.d	$a7, $a5, %pc_lo12(active_sps)
	ld.w	$t0, $a7, 1148
.LBB40_96:                              # %.loopexit825
	ori	$a5, $a4, 2280
	ldx.b	$a5, $a2, $a5
	ori	$a6, $a4, 768
	stx.b	$a5, $a0, $a6
...
# %bb.99:                               # %.lr.ph855
	...
	b	.LBB40_102
	.p2align	4, , 16
.LBB40_100:                             # %._crit_edge852.loopexit
                                        #   in Loop: Header=BB40_102 Depth=1
	ori	$t3, $a4, 2300
	ldx.w	$t3, $a2, $t3
.LBB40_101:                             # %._crit_edge852
                                        #   in Loop: Header=BB40_102 Depth=1
	addi.d	$a6, $a6, 1
	srai.d	$t4, $t3, 2
	bge	$a6, $t4, .LBB40_136
...
# %bb.116:                              #   in Loop: Header=BB40_107 Depth=2
	...
	sltu	$t7, $a7, $t7
	b	.LBB40_105
.LBB40_117:                             # %.preheader822
	ldptr.w	$t3, $a2, 6396
	ori	$a5, $zero, 4
	blt	$t3, $a5, .LBB40_136
# %bb.118:                              # %.preheader821.lr.ph
	move	$a6, $zero
	ori	$a7, $a4, 2296
	ldx.w	$t6, $a2, $a7
	ori	$a7, $zero, 1
	...
	b	.LBB40_121
	.p2align	4, , 16
.LBB40_119:                             # %._crit_edge847.loopexit
                                        #   in Loop: Header=BB40_121 Depth=1
	ori	$t3, $a4, 2300
	ldx.w	$t3, $a2, $t3
.LBB40_120:                             # %._crit_edge847
                                        #   in Loop: Header=BB40_121 Depth=1
	addi.d	$a6, $a6, 1
	...
	srai.d	$t4, $t4, 2
	bge	$a6, $t4, .LBB40_136
.LBB40_121:                             # %.preheader821
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB40_126 Depth 2
	blt	$t6, $a5, .LBB40_120
# %bb.122:                              # %.lr.ph846.preheader
                                        #   in Loop: Header=BB40_121 Depth=1
	move	$t3, $zero
	move	$t4, $zero
	slli.d	$t5, $a6, 3
...
.LBB40_137:                             # %.loopexit
	...
	addi.d	$sp, $sp, 96
	ret
.LBB40_138:                             # %.preheader819
	ori	$a4, $zero, 4
	blt	$t3, $a4, .LBB40_153
# %bb.139:                              # %.preheader818.lr.ph
	ldptr.w	$a7, $a2, 6392
	blt	$a7, $a4, .LBB40_153
# %bb.140:                              # %.preheader818.lr.ph.split.us
	move	$a4, $zero
	...
	b	.LBB40_142
	.p2align	4, , 16
.LBB40_141:                             # %._crit_edge858.us
                                        #   in Loop: Header=BB40_142 Depth=1
	addi.d	$a4, $a4, 1
	beq	$a4, $a6, .LBB40_153
.LBB40_142:                             # %.preheader818.us
                                        # =>This Loop Header: Depth=1
...
# %bb.154:                              # %.preheader.lr.ph
	...
	b	.LBB40_157
	.p2align	4, , 16
.LBB40_155:                             # %._crit_edge862.loopexit
                                        #   in Loop: Header=BB40_157 Depth=1
	ldx.w	$t7, $a3, $a7
.LBB40_156:                             # %._crit_edge862
                                        #   in Loop: Header=BB40_157 Depth=1
	addi.d	$t8, $t6, 2
	slli.w	$fp, $t7, 2
	addi.d	$a0, $a0, 256
...
.LBB41_25:                              # %.lr.ph.split.us112
	...
	b	.LBB41_29
	.p2align	4, , 16
.LBB41_26:                              # %.sink.split123.sink.split
                                        #   in Loop: Header=BB41_29 Depth=1
	ld.d	$t2, $t1, 40
	stptr.d	$zero, $t2, 6376
.LBB41_27:                              # %.sink.split123
                                        #   in Loop: Header=BB41_29 Depth=1
	st.d	$zero, $t1, 4
...
# %bb.40:                               #   in Loop: Header=BB41_29 Depth=1
	ld.d	$t3, $t1, 56
	beqz	$t3, .LBB41_26
# %bb.41:                               # %.sink.split123.sink.split.sink.split
                                        #   in Loop: Header=BB41_29 Depth=1
	stptr.d	$zero, $t2, 6376
	stptr.d	$zero, $t3, 6376
	b	.LBB41_26
