...
# %bb.62:                               # %vector.memcheck
	...
	add.d	$a2, $a1, $a2
	addi.d	$a2, $a2, -24
	bgeu	$a0, $a2, .LBB29_114
# %bb.63:                               # %vector.memcheck
	alsl.d	$a2, $fp, $a0, 3
	bgeu	$a1, $a2, .LBB29_114
.LBB29_64:
	move	$a2, $zero
	b	.LBB29_116
.LBB29_65:                              # %vector.ph80
	move	$a4, $zero
...
.LBB29_66:                              # %vector.body83
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB29_66
# %bb.67:                               # %middle.block87
	beq	$a2, $a3, .LBB29_70
.LBB29_68:                              # %.lr.ph.preheader119
	alsl.d	$a4, $a2, $a0, 3
	sub.d	$a3, $a3, $a2
	.p2align	4, , 16
.LBB29_69:                              # %.lr.ph
...
.LBB29_74:                              # %vector.body94
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB29_74
# %bb.75:                               # %middle.block99
	beq	$a0, $a1, .LBB29_78
.LBB29_76:                              # %scalar.ph89.preheader
	alsl.d	$a2, $a0, $fp, 3
	sub.d	$a1, $a1, $a0
	.p2align	4, , 16
.LBB29_77:                              # %scalar.ph89
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	st.w	$a0, $a3, 8
	addi.d	$a0, $a0, 1
...
# %bb.81:
	...
	bnez	$a0, .LBB29_95
.LBB29_82:                              # %FindRulePrecedences.exit
	addi.d	$a0, $sp, 24
...
.LBB29_100:                             #   in Loop: Header=BB29_101 Depth=2
	...
	addi.d	$a5, $a5, 1
	beq	$a5, $a4, .LBB29_96
.LBB29_101:                             #   Parent Loop BB29_97 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB29_105 Depth 3
	bnez	$a6, .LBB29_96
# %bb.102:                              #   in Loop: Header=BB29_101 Depth=2
	...
	ld.w	$a7, $a6, 12
	bne	$a7, $a2, .LBB29_107
# %bb.103:                              # %.preheader.i38
                                        #   in Loop: Header=BB29_101 Depth=2
	ld.w	$a7, $a6, 84
	blt	$a7, $a1, .LBB29_100
# %bb.104:                              # %.lr.ph.i39
                                        #   in Loop: Header=BB29_101 Depth=2
	ld.d	$t0, $a6, 88
	.p2align	4, , 16
.LBB29_105:                             #   Parent Loop BB29_97 Depth=1
                                        #     Parent Loop BB29_101 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a6, $t0, 0
	ld.w	$t1, $a6, 32
	blt	$a3, $t1, .LBB29_108
# %bb.106:                              #   in Loop: Header=BB29_105 Depth=3
	addi.d	$a7, $a7, -1
	addi.d	$t0, $t0, 8
	bnez	$a7, .LBB29_105
	b	.LBB29_100
...
.LBB29_107:                             #   in Loop: Header=BB29_101 Depth=2
	ld.w	$a7, $a6, 32
	bltz	$a7, .LBB29_100
.LBB29_108:                             # %.loopexit.sink.split.i
                                        #   in Loop: Header=BB29_101 Depth=2
	st.d	$a6, $a0, 64
	addi.d	$a5, $a5, 1
	bne	$a5, $a4, .LBB29_101
	b	.LBB29_96
.LBB29_109:                             # %.preheader.i45
	ori	$a1, $zero, 1
	blt	$fp, $a1, .LBB29_85
# %bb.110:                              # %.lr.ph.i48
	ld.d	$a1, $s0, 8
	ori	$a2, $zero, 13
	bltu	$fp, $a2, .LBB29_113
# %bb.111:                              # %vector.memcheck102
	slli.d	$a2, $fp, 5
	add.d	$a2, $a1, $a2
	addi.d	$a2, $a2, -24
	bgeu	$a0, $a2, .LBB29_118
# %bb.112:                              # %vector.memcheck102
	alsl.d	$a2, $fp, $a0, 3
...
.LBB29_119:                             # %vector.body113
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB29_119
.LBB29_120:                             # %scalar.ph108.preheader
	sub.d	$a3, $fp, $a2
	slli.d	$a4, $a2, 3
	slli.d	$a2, $a2, 5
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB29_121:                             # %scalar.ph108
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	stx.d	$a2, $a0, $a4
	addi.d	$a3, $a3, -1
...
.LBB37_17:                              #   in Loop: Header=BB37_6 Depth=1
	ori	$a2, $zero, 10
.LBB37_18:                              # %.critedge.i.loopexit621
                                        #   in Loop: Header=BB37_6 Depth=1
	ori	$a1, $zero, 37
	b	.LBB37_5
...
.LBB37_49:                              # %vector.ph
	...
	b	.LBB37_51
	.p2align	4, , 16
.LBB37_50:                              # %pred.store.continue467
...
.LBB37_67:                              # %pred.store.continue
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB37_53
.LBB37_68:                              # %pred.store.if438
                                        #   in Loop: Header=BB37_51 Depth=2
	st.b	$a6, $a4, -6
	vpickve2gr.b	$a5, $vr0, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB37_54
.LBB37_69:                              # %pred.store.continue441
                                        #   in Loop: Header=BB37_51 Depth=2
	vpickve2gr.b	$a5, $vr0, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB37_55
.LBB37_70:                              # %pred.store.if442
                                        #   in Loop: Header=BB37_51 Depth=2
	st.b	$a6, $a4, -4
	vpickve2gr.b	$a5, $vr0, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB37_56
.LBB37_71:                              # %pred.store.continue445
                                        #   in Loop: Header=BB37_51 Depth=2
	vpickve2gr.b	$a5, $vr0, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB37_57
.LBB37_72:                              # %pred.store.if446
                                        #   in Loop: Header=BB37_51 Depth=2
	st.b	$a6, $a4, -2
	vpickve2gr.b	$a5, $vr0, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB37_58
.LBB37_73:                              # %pred.store.continue449
                                        #   in Loop: Header=BB37_51 Depth=2
	vpickve2gr.b	$a5, $vr0, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB37_59
.LBB37_74:                              # %pred.store.if450
                                        #   in Loop: Header=BB37_51 Depth=2
	st.b	$a6, $a4, 0
	vpickve2gr.b	$a5, $vr0, 8
	andi	$a5, $a5, 1
	bnez	$a5, .LBB37_60
.LBB37_75:                              # %pred.store.continue453
                                        #   in Loop: Header=BB37_51 Depth=2
	vpickve2gr.b	$a5, $vr0, 9
	andi	$a5, $a5, 1
	beqz	$a5, .LBB37_61
.LBB37_76:                              # %pred.store.if454
                                        #   in Loop: Header=BB37_51 Depth=2
	st.b	$a6, $a4, 2
	vpickve2gr.b	$a5, $vr0, 10
	andi	$a5, $a5, 1
	bnez	$a5, .LBB37_62
.LBB37_77:                              # %pred.store.continue457
                                        #   in Loop: Header=BB37_51 Depth=2
	vpickve2gr.b	$a5, $vr0, 11
	andi	$a5, $a5, 1
	beqz	$a5, .LBB37_63
.LBB37_78:                              # %pred.store.if458
                                        #   in Loop: Header=BB37_51 Depth=2
	st.b	$a6, $a4, 4
	vpickve2gr.b	$a5, $vr0, 12
	andi	$a5, $a5, 1
	bnez	$a5, .LBB37_64
.LBB37_79:                              # %pred.store.continue461
                                        #   in Loop: Header=BB37_51 Depth=2
	vpickve2gr.b	$a5, $vr0, 13
	andi	$a5, $a5, 1
	beqz	$a5, .LBB37_65
.LBB37_80:                              # %pred.store.if462
                                        #   in Loop: Header=BB37_51 Depth=2
	st.b	$a6, $a4, 6
	vpickve2gr.b	$a5, $vr0, 14
	andi	$a5, $a5, 1
	bnez	$a5, .LBB37_66
.LBB37_81:                              # %pred.store.continue465
                                        #   in Loop: Header=BB37_51 Depth=2
	vpickve2gr.b	$a5, $vr0, 15
	andi	$a5, $a5, 1
	beqz	$a5, .LBB37_50
.LBB37_82:                              # %pred.store.if466
                                        #   in Loop: Header=BB37_51 Depth=2
	st.b	$a6, $a4, 8
	b	.LBB37_50
...
.LBB37_86:                              # %vec.epilog.ph
	...
	b	.LBB37_88
	.p2align	4, , 16
.LBB37_87:                              # %pred.store.continue479
...
.LBB37_88:                              # %vec.epilog.vector.body
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB37_90
# %bb.89:                               # %pred.store.if472
                                        #   in Loop: Header=BB37_88 Depth=2
	st.b	$a6, $a1, -1
.LBB37_90:                              # %pred.store.continue473
                                        #   in Loop: Header=BB37_88 Depth=2
	vilvl.b	$vr0, $vr0, $vr0
	vilvl.h	$vr0, $vr0, $vr0
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB37_93
# %bb.91:                               # %pred.store.if474
                                        #   in Loop: Header=BB37_88 Depth=2
	st.b	$a6, $a1, 0
	vpickve2gr.w	$a2, $vr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB37_94
.LBB37_92:                              # %pred.store.continue477
                                        #   in Loop: Header=BB37_88 Depth=2
	...
	b	.LBB37_95
	.p2align	4, , 16
.LBB37_93:                              # %pred.store.continue475
                                        #   in Loop: Header=BB37_88 Depth=2
	vpickve2gr.w	$a2, $vr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB37_92
.LBB37_94:                              # %pred.store.if476
                                        #   in Loop: Header=BB37_88 Depth=2
	st.b	$a6, $a1, 1
	vpickve2gr.w	$a2, $vr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB37_87
.LBB37_95:                              # %pred.store.if478
                                        #   in Loop: Header=BB37_88 Depth=2
	st.b	$a6, $a1, 2
	b	.LBB37_87
...
.LBB37_328:                             #   in Loop: Header=BB37_113 Depth=1
	...
	addi.d	$a0, $a0, 120
	b	.LBB37_367
.LBB37_329:                             # %vector.ph483
                                        #   in Loop: Header=BB37_113 Depth=1
	bstrpick.d	$a3, $fp, 30, 2
	slli.d	$a3, $a3, 2
	ld.d	$a4, $sp, 64                    # 8-byte Folded Reload
	move	$a5, $a3
.LBB37_330:                             # %vector.body486
                                        #   Parent Loop BB37_113 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ori	$a6, $a7, 176
	vldx	$vr0, $a4, $a6
