...
.Lttbase1:
	...
	.p2align	4, 0x0                          # -- Begin function _ZN8NArchive4NCab10CCheckSum26UpdateEPKvj
.LCPI4_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
.LBB4_10:                               # %vector.body
	...
	vld	$vr6, $t0, -16
	vld	$vr7, $t0, 0
	vshuf.b	$vr8, $vr4, $vr6, $vr1
	vshuf.b	$vr9, $vr4, $vr7, $vr1
	vshuf.b	$vr10, $vr4, $vr6, $vr2
	vshuf.b	$vr11, $vr4, $vr7, $vr2
	vslli.w	$vr10, $vr10, 8
	vslli.w	$vr11, $vr11, 8
	vor.v	$vr8, $vr10, $vr8
	vor.v	$vr9, $vr11, $vr9
	vshuf.b	$vr10, $vr4, $vr6, $vr3
	vshuf.b	$vr11, $vr4, $vr7, $vr3
	vslli.w	$vr10, $vr10, 16
	vslli.w	$vr11, $vr11, 16
	vor.v	$vr8, $vr8, $vr10
	vor.v	$vr9, $vr9, $vr11
	vshuf4i.b	$vr6, $vr6, 3
	vshuf4i.b	$vr7, $vr7, 3
