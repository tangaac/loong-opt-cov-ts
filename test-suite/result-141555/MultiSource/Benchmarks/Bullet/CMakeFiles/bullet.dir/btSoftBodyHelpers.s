...
# %bb.104:                              # %.lr.ph2146
	...
	addi.d	$s7, $a0, %pc_lo12(_ZZNK10btSoftBody4Body5xformEvE8identity)
...
# %bb.1:
	...
	fst.s	$ft1, $sp, 36                   # 4-byte Folded Spill
	...
	fst.s	$ft5, $sp, 44                   # 4-byte Folded Spill
	fadd.s	$fa2, $ft5, $fa2
	fst.s	$ft6, $sp, 40                   # 4-byte Folded Spill
	fst.s	$ft3, $sp, 28                   # 4-byte Folded Spill
...
# %bb.2:                                # %.lr.ph
	...
	fst.s	$fs6, $sp, 8                    # 4-byte Folded Spill
	.p2align	4, , 16
.LBB11_3:                               # =>This Inner Loop Header: Depth=1
	...
	st.d	$a0, $sp, 104
	st.d	$s7, $sp, 112
	fld.s	$fs1, $sp, 12                   # 4-byte Folded Reload
	fadd.s	$fa0, $fs7, $fs1
	fld.s	$fs4, $sp, 28                   # 4-byte Folded Reload
	fadd.s	$fa1, $fs5, $fs4
	fadd.s	$fa2, $fs3, $fs4
	movfr2gr.s	$a0, $fa0
	ld.d	$a1, $s0, 0
	...
	fadd.s	$fa1, $fs5, $fs1
	fmov.s	$fs5, $fs6
	fld.s	$fs6, $sp, 8                    # 4-byte Folded Reload
...
.LBB13_4:                               # %.lr.ph.us
	...
	fdiv.s	$ft13, $ft10, $fa0
	fld.s	$fa0, $sp, 36                   # 4-byte Folded Reload
	fmadd.s	$ft10, $fa0, $ft13, $fa3
	fmadd.s	$ft11, $fa4, $ft13, $fa1
	fmadd.s	$ft12, $ft1, $ft13, $fa5
	fmadd.s	$ft14, $ft2, $ft13, $fa6
	fmadd.s	$ft15, $ft3, $ft13, $fa7
	fmadd.s	$fs0, $ft4, $ft13, $ft0
	fsub.s	$ft13, $ft14, $ft10
	fsub.s	$ft14, $ft15, $ft11
	fsub.s	$ft15, $fs0, $ft12
	vreplvei.w	$vr24, $vr18, 0
	vreplvei.w	$vr25, $vr19, 0
	vreplvei.w	$vr26, $vr20, 0
	vreplvei.w	$vr27, $vr21, 0
	vreplvei.w	$vr28, $vr22, 0
	vreplvei.w	$vr29, $vr23, 0
	move	$t2, $t0
	move	$t3, $t1
	move	$t4, $a1
	vori.b	$vr30, $vr15, 0
...
.LBB13_5:                               # %vector.body
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	vffint.s.wu	$vr31, $vr30
	vfdiv.s	$vr31, $vr31, $vr14
	vfmadd.s	$vr2, $vr27, $vr31, $vr24
	vfmadd.s	$vr0, $vr28, $vr31, $vr25
	vfmadd.s	$vr31, $vr29, $vr31, $vr26
	vshuf4i.w	$vr0, $vr0, 16
	vslli.d	$vr0, $vr0, 32
	vilvl.w	$vr2, $vr16, $vr2
	vor.v	$vr0, $vr0, $vr2
	vilvl.w	$vr2, $vr16, $vr31
	vpackev.d	$vr31, $vr2, $vr0
	vpackod.d	$vr0, $vr2, $vr0
	vst	$vr0, $t2, 16
	vst	$vr31, $t2, 0
	vstelm.d	$vr17, $t3, 0, 0
	vaddi.wu	$vr30, $vr30, 2
	addi.d	$t4, $t4, -2
	addi.d	$t3, $t3, 8
	addi.d	$t2, $t2, 32
	bnez	$t4, .LBB13_5
...
.LBB13_8:                               # %scalar.ph
	...
	ffint.s.l	$fa0, $fa0
	fdiv.s	$fa0, $fa0, $ft5
	fmadd.s	$fa2, $ft13, $fa0, $ft10
	fmadd.s	$fs0, $ft14, $fa0, $ft11
	fmadd.s	$fa0, $ft15, $fa0, $ft12
	movfr2gr.s	$t6, $fa2
	movfr2gr.s	$t7, $fs0
	bstrins.d	$t6, $t7, 63, 32
	movfr2gr.s	$t7, $fa0
...
# %bb.20:                               # %.lr.ph.split.us.us.preheader
	...
	b	.LBB13_24
	.p2align	4, , 16
.LBB13_21:                              # %.thread.us.us.critedge
                                        #   in Loop: Header=BB13_24 Depth=2
	add.w	$a2, $s7, $s5
	move	$a0, $s4
	move	$a1, $s1
.LBB13_22:                              # %.thread.us.us
                                        #   in Loop: Header=BB13_24 Depth=2
	move	$a3, $zero
	move	$a4, $zero
	pcaddu18i	$ra, %call36(_ZN10btSoftBody10appendLinkEiiPNS_8MaterialEb)
	jirl	$ra, $ra, 0
.LBB13_23:                              # %.thread.us.us
                                        #   in Loop: Header=BB13_24 Depth=2
	beq	$s0, $fp, .LBB13_18
.LBB13_24:                              # %.lr.ph.split.us.us
...
# %bb.29:                               #   in Loop: Header=BB13_24 Depth=2
	...
	b	.LBB13_22
	.p2align	4, , 16
.LBB13_30:                              # %.lr.ph.split.us196.preheader
                                        #   in Loop: Header=BB13_19 Depth=1
	move	$a0, $zero
	b	.LBB13_32
	.p2align	4, , 16
.LBB13_31:                              # %.thread.us193
                                        #   in Loop: Header=BB13_32 Depth=2
	move	$a0, $fp
	beq	$s0, $fp, .LBB13_18
.LBB13_32:                              # %.lr.ph.split.us196
                                        #   Parent Loop BB13_19 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$fp, $a0, 1
	bge	$fp, $s0, .LBB13_31
...
# %bb.22:                               # %.preheader.us.preheader
	...
	b	.LBB14_24
	.p2align	4, , 16
.LBB14_23:                              # %._crit_edge.us260
                                        #   in Loop: Header=BB14_24 Depth=1
	add.d	$s8, $s8, $s4
	ld.d	$s0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	beq	$a1, $s0, .LBB14_37
.LBB14_24:                              # %.preheader.us
                                        # =>This Loop Header: Depth=1
...
# %bb.29:                               #   in Loop: Header=BB14_27 Depth=2
	...
	b	.LBB14_32
	.p2align	4, , 16
.LBB14_30:                              # %.thread.us.us.critedge
...
.LBB14_32:                              #   in Loop: Header=BB14_27 Depth=2
	...
	b	.LBB14_26
	.p2align	4, , 16
.LBB14_33:                              # %.lr.ph.split.us259.preheader
                                        #   in Loop: Header=BB14_24 Depth=1
	move	$a0, $zero
	b	.LBB14_35
	.p2align	4, , 16
.LBB14_34:                              # %.thread.us256
                                        #   in Loop: Header=BB14_35 Depth=2
	move	$a0, $s0
	beq	$s4, $s0, .LBB14_23
.LBB14_35:                              # %.lr.ph.split.us259
                                        #   Parent Loop BB14_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$s0, $a0, 1
	bge	$s0, $s4, .LBB14_34
...
.Ltmp94:
	...
	jirl	$ra, $ra, 0
.Ltmp95:
# %bb.15:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit31
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB16_16:
...
.Ltmp144:
	...
	jirl	$ra, $ra, 0
.Ltmp145:
# %bb.13:                               # %_ZN17btCollisionObjectnwEm.exit
.Ltmp146:
	move	$s7, $a0
	move	$a1, $s4
	move	$a2, $s1
...
.Ltmp166:
	...
	jirl	$ra, $ra, 0
.Ltmp167:
# %bb.26:                               # %_ZN20btAlignedObjectArrayIbED2Ev.exit
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
	move	$a0, $s7
...
.LBB18_32:
.Ltmp157:
.LBB18_33:                              # %_ZN17btCollisionObjectdlEPv.exit
	move	$s1, $a0
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	beqz	$a0, .LBB18_35
.LBB18_34:                              # %_ZN17btCollisionObjectdlEPv.exit.thread140
.Ltmp164:
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp165:
.LBB18_35:                              # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit85
.Ltmp169:
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp170:
# %bb.36:                               # %_ZN20btAlignedObjectArrayIbED2Ev.exit89
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB18_37:
