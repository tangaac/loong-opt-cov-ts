...
.LBB0_22:                               # %vector.scevcheck101
	...
	move	$a1, $zero
	bltu	$a4, $a3, .LBB0_27
# %bb.23:                               # %vector.scevcheck101
	alsl.d	$a2, $a2, $a2, 1
	srli.d	$a2, $a2, 32
	sltu	$a2, $zero, $a2
	bnez	$a2, .LBB0_27
# %bb.24:                               # %vector.scevcheck101
	ori	$a2, $zero, 1
	bne	$fp, $a2, .LBB0_27
# %bb.25:                               # %vector.ph107
	move	$a2, $zero
