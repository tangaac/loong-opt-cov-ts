...
# %bb.31:                               #   in Loop: Header=BB0_30 Depth=2
	move	$ra, $zero
.LBB0_32:                               # %scalar.ph216.preheader
                                        #   in Loop: Header=BB0_30 Depth=2
	sub.d	$t7, $t1, $ra
	.p2align	4, , 16
.LBB0_33:                               # %scalar.ph216
                                        #   Parent Loop BB0_28 Depth=1
...
.LBB0_34:                               # %vector.scevcheck213
	...
	move	$ra, $zero
	blt	$s8, $t7, .LBB0_32
# %bb.35:                               # %vector.scevcheck213
                                        #   in Loop: Header=BB0_30 Depth=2
	mul.d	$t5, $a1, $s2
	add.w	$s8, $s4, $t5
	add.w	$t5, $t5, $s6
	blt	$t5, $s8, .LBB0_32
# %bb.36:                               # %vector.scevcheck213
                                        #   in Loop: Header=BB0_30 Depth=2
	srli.d	$t5, $t4, 32
	bnez	$t5, .LBB0_32
# %bb.37:                               # %vector.scevcheck213
                                        #   in Loop: Header=BB0_30 Depth=2
	alsl.d	$t5, $t7, $a0, 3
	alsl.d	$t7, $s8, $a7, 3
	sub.d	$t5, $t5, $t7
	bltu	$t5, $fp, .LBB0_32
# %bb.38:                               # %vector.body221.preheader
                                        #   in Loop: Header=BB0_30 Depth=2
	move	$ra, $s7
	move	$s8, $s1
	move	$t7, $t6
	.p2align	4, , 16
.LBB0_39:                               # %vector.body221
                                        #   Parent Loop BB0_28 Depth=1
                                        #     Parent Loop BB0_30 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	alsl.d	$t5, $ra, $a7, 3
...
.LBB3_14:                               # %._crit_edge213.split.us.us.us
	...
	add.d	$a6, $a6, $t1
	ld.d	$s0, $sp, 656                   # 8-byte Folded Reload
	add.d	$s0, $s0, $t1
...
.LBB3_16:                               # %.preheader.us.us.us
                                        ...
                                        #             Child Loop BB3_41 Depth 6
                                        #             Child Loop BB3_18 Depth 6
	ld.d	$s7, $sp, 968                   # 8-byte Folded Reload
...
# %bb.25:                               # %middle.block
	...
	bne	$a0, $t7, .LBB6_12
	b	.LBB6_14
.LBB6_26:                               # %.preheader198.lr.ph.split.us.split
                                        #   in Loop: Header=BB6_3 Depth=1
	blt	$s1, $a1, .LBB6_2
# %bb.27:                               # %.preheader198.us.us232.preheader
                                        #   in Loop: Header=BB6_3 Depth=1
	move	$a0, $zero
	move	$a1, $zero
	move	$a2, $zero
	...
	b	.LBB6_29
	.p2align	4, , 16
.LBB6_28:                               # %._crit_edge.split.split.us.us.us
...
.LBB6_29:                               # %.preheader198.us.us232
	...
	b	.LBB6_31
	.p2align	4, , 16
.LBB6_30:                               # %..preheader196_crit_edge.us212.us.us
	...
	ld.d	$t2, $sp, 240                   # 8-byte Folded Reload
	bge	$a6, $t2, .LBB6_28
.LBB6_31:                               # %.preheader197.us207.us.us
                                        #   Parent Loop BB6_3 Depth=1
...
# %bb.32:                               #   in Loop: Header=BB6_31 Depth=3
	move	$t2, $zero
.LBB6_33:                               # %scalar.ph265.preheader
                                        #   in Loop: Header=BB6_31 Depth=3
	add.w	$t3, $t1, $t2
	sub.d	$t2, $s1, $t2
	.p2align	4, , 16
.LBB6_34:                               # %scalar.ph265
                                        #   Parent Loop BB6_3 Depth=1
                                        #     Parent Loop BB6_29 Depth=2
...
.LBB6_35:                               # %vector.scevcheck260
	...
	move	$t2, $zero
	blt	$t4, $t3, .LBB6_33
# %bb.36:                               # %vector.scevcheck260
                                        #   in Loop: Header=BB6_31 Depth=3
	srli.d	$t3, $a3, 32
	bnez	$t3, .LBB6_33
# %bb.37:                               # %vector.body270.preheader
                                        #   in Loop: Header=BB6_31 Depth=3
	move	$t2, $t1
	move	$t3, $a4
	.p2align	4, , 16
.LBB6_38:                               # %vector.body270
                                        #   Parent Loop BB6_3 Depth=1
                                        #     Parent Loop BB6_29 Depth=2
                                        #       Parent Loop BB6_31 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.10:                               # %._crit_edge.us.us.us
	...
	add.w	$t2, $t2, $t7
	bne	$s7, $t0, .LBB7_8
# %bb.11:                               # %._crit_edge107.split.us.us.us
...
.LBB8_10:                               # %vector.scevcheck374
	...
	move	$a3, $zero
	blt	$a6, $t1, .LBB8_23
# %bb.11:                               # %vector.scevcheck374
                                        #   in Loop: Header=BB8_8 Depth=3
	add.w	$a7, $s4, $a4
	add.w	$a6, $a4, $s8
	blt	$a6, $a7, .LBB8_23
# %bb.12:                               # %vector.scevcheck374
                                        #   in Loop: Header=BB8_8 Depth=3
	ld.d	$a6, $sp, 288                   # 8-byte Folded Reload
	add.w	$s7, $a6, $a4
	add.w	$a6, $a4, $t7
	blt	$a6, $s7, .LBB8_23
# %bb.13:                               # %vector.scevcheck374
                                        #   in Loop: Header=BB8_8 Depth=3
	mul.d	$s1, $t0, $a0
	ld.d	$a6, $sp, 280                   # 8-byte Folded Reload
	add.w	$a6, $a6, $s1
	...
	add.w	$s1, $s1, $s5
	blt	$s1, $a6, .LBB8_23
# %bb.14:                               # %vector.scevcheck374
                                        #   in Loop: Header=BB8_8 Depth=3
	add.w	$s1, $t4, $a4
	ld.d	$s5, $sp, 264                   # 8-byte Folded Reload
	add.w	$a4, $a4, $s5
	blt	$a4, $s1, .LBB8_23
# %bb.15:                               # %vector.scevcheck374
                                        #   in Loop: Header=BB8_8 Depth=3
	ld.d	$a4, $sp, 256                   # 8-byte Folded Reload
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB8_23
# %bb.16:                               # %vector.memcheck387
                                        #   in Loop: Header=BB8_8 Depth=3
...
.LBB8_21:                               # %vector.body440
	...
	addi.w	$s7, $s7, 2
	bnez	$a3, .LBB8_21
# %bb.22:                               #   in Loop: Header=BB8_8 Depth=3
	ld.d	$a3, $sp, 224                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB8_23:                               # %scalar.ph427.preheader
                                        #   in Loop: Header=BB8_8 Depth=3
	add.d	$a4, $s6, $a3
	slli.w	$s7, $a4, 1
	add.w	$s1, $s3, $a3
...
.LBB8_24:                               # %scalar.ph427
	...
	addi.w	$s1, $s1, 1
	bnez	$a3, .LBB8_24
# %bb.25:                               # %._crit_edge.us.us.us
                                        #   in Loop: Header=BB8_8 Depth=3
	addi.w	$a0, $a0, 1
	add.w	$s3, $s3, $t0
	add.d	$s6, $s6, $t6
	bne	$a0, $t3, .LBB8_8
# %bb.26:                               # %._crit_edge203.split.us.us.us
...
.LBB8_34:                               # %vector.scevcheck305
	...
	move	$s5, $zero
	blt	$a0, $s2, .LBB8_47
# %bb.35:                               # %vector.scevcheck305
                                        #   in Loop: Header=BB8_32 Depth=3
	add.w	$fp, $s6, $a6
	add.w	$a0, $a6, $s3
	blt	$a0, $fp, .LBB8_47
# %bb.36:                               # %vector.scevcheck305
                                        #   in Loop: Header=BB8_32 Depth=3
	add.w	$s7, $s4, $a6
	add.w	$a0, $a6, $a7
	blt	$a0, $s7, .LBB8_47
# %bb.37:                               # %vector.scevcheck305
                                        #   in Loop: Header=BB8_32 Depth=3
	mul.d	$a2, $t0, $ra
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	add.w	$a0, $a0, $a2
	...
	add.w	$a2, $a2, $t1
	blt	$a2, $a0, .LBB8_47
# %bb.38:                               # %vector.scevcheck305
                                        #   in Loop: Header=BB8_32 Depth=3
	add.w	$a2, $t4, $a6
	ld.d	$t1, $sp, 272                   # 8-byte Folded Reload
	add.w	$a6, $a6, $t1
	blt	$a6, $a2, .LBB8_47
# %bb.39:                               # %vector.scevcheck305
                                        #   in Loop: Header=BB8_32 Depth=3
	ld.d	$a6, $sp, 264                   # 8-byte Folded Reload
	srli.d	$a6, $a6, 32
	bnez	$a6, .LBB8_47
# %bb.40:                               # %vector.memcheck318
                                        #   in Loop: Header=BB8_32 Depth=3
...
.LBB8_45:                               # %vector.body367
	...
	addi.w	$s7, $s7, 2
	bnez	$s5, .LBB8_45
# %bb.46:                               #   in Loop: Header=BB8_32 Depth=3
	ld.d	$s5, $sp, 240                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB8_47:                               # %scalar.ph358.preheader
                                        #   in Loop: Header=BB8_32 Depth=3
	add.d	$a0, $s8, $s5
	slli.w	$s7, $a0, 1
	add.w	$a2, $a5, $s5
...
.LBB8_48:                               # %scalar.ph358
	...
	addi.w	$a2, $a2, 1
	bnez	$s5, .LBB8_48
# %bb.49:                               # %._crit_edge210.us.us.us
                                        #   in Loop: Header=BB8_32 Depth=3
	addi.w	$ra, $ra, 1
	add.w	$a5, $a5, $t0
	add.d	$s8, $s8, $t6
	bne	$ra, $t3, .LBB8_32
# %bb.50:                               # %._crit_edge212.split.us.us.us
...
.LBB8_69:                               # %vector.body
	...
	addi.w	$s3, $s3, 2
	bnez	$s8, .LBB8_69
# %bb.70:                               #   in Loop: Header=BB8_56 Depth=3
...
.LBB8_72:                               # %scalar.ph
	...
	addi.w	$a2, $a2, 1
	bnez	$s3, .LBB8_72
# %bb.73:                               # %._crit_edge220.us.us.us
                                        #   in Loop: Header=BB8_56 Depth=3
	addi.w	$ra, $ra, 1
	add.w	$a5, $a5, $t0
	add.d	$s7, $s7, $t6
	bne	$ra, $t3, .LBB8_56
# %bb.74:                               # %._crit_edge222.split.us.us.us
...
# %bb.0:
	...
	pcaddu18i	$ra, %call36(CycleTime)
	jirl	$ra, $ra, 0
	vld	$vr16, $sp, 0                   # 16-byte Folded Reload
...
.LBB12_15:                              # %vector.body
	...
	vbitsel.v	$vr13, $vr5, $vr0, $vr14
	vbitsel.v	$vr12, $vr5, $vr0, $vr12
	alsl.d	$t0, $ra, $t8, 3
	slli.d	$s5, $ra, 3
	vstx	$vr13, $t8, $s5
	vst	$vr12, $t0, 16
...
# %bb.49:                               #   in Loop: Header=BB22_48 Depth=3
	move	$s4, $zero
.LBB22_50:                              # %scalar.ph334.preheader
                                        #   in Loop: Header=BB22_48 Depth=3
	sub.d	$s5, $t0, $s4
	add.w	$s4, $s3, $s4
	.p2align	4, , 16
.LBB22_51:                              # %scalar.ph334
                                        #   Parent Loop BB22_41 Depth=1
                                        #     Parent Loop BB22_46 Depth=2
...
.LBB22_52:                              # %vector.scevcheck333
	...
	move	$s4, $zero
	blt	$s6, $s5, .LBB22_50
# %bb.53:                               # %vector.scevcheck333
                                        #   in Loop: Header=BB22_48 Depth=3
	srli.d	$s5, $t6, 32
	bnez	$s5, .LBB22_50
# %bb.54:                               # %vector.body341.preheader
                                        #   in Loop: Header=BB22_48 Depth=3
	move	$s4, $s3
	move	$s5, $t7
	.p2align	4, , 16
.LBB22_55:                              # %vector.body341
                                        #   Parent Loop BB22_41 Depth=1
                                        #     Parent Loop BB22_46 Depth=2
                                        #       Parent Loop BB22_48 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
