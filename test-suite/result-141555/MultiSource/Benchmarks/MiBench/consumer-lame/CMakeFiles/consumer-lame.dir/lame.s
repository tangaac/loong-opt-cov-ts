...
.LBB0_92:                               # %.preheader380.preheader
	...
	ld.d	$a6, $a0, %got_pc_lo12(scalefac_band)
	vld	$vr0, $a5, 16
	vld	$vr1, $a5, 32
	vld	$vr2, $a5, 48
	vld	$vr3, $a5, 64
...
.LBB2_19:                               # %vector.body191
	...
	addi.d	$a3, $a3, 32
	bnez	$a5, .LBB2_19
# %bb.20:                               # %middle.block196
                                        #   in Loop: Header=BB2_15 Depth=1
	beq	$a2, $a1, .LBB2_23
.LBB2_21:                               # %scalar.ph186.preheader
                                        #   in Loop: Header=BB2_15 Depth=1
	lu12i.w	$a3, 4
	ori	$a3, $a3, 1808
	add.d	$a3, $sp, $a3
...
# %bb.37:                               #   in Loop: Header=BB2_36 Depth=1
	...
	b	.LBB2_41
	.p2align	4, , 16
.LBB2_38:                               # %vector.body215.preheader
                                        #   in Loop: Header=BB2_36 Depth=1
	move	$t0, $a5
	move	$t1, $a6
	.p2align	4, , 16
.LBB2_39:                               # %vector.body215
	...
	addi.d	$t0, $t0, 240
	bnez	$t1, .LBB2_39
# %bb.40:                               # %middle.block218
                                        #   in Loop: Header=BB2_36 Depth=1
	move	$t1, $a6
	beq	$a6, $t4, .LBB2_35
.LBB2_41:                               # %scalar.ph210.preheader
                                        #   in Loop: Header=BB2_36 Depth=1
	mul.d	$t0, $t1, $a7
	sub.d	$t1, $t4, $t1
	.p2align	4, , 16
.LBB2_42:                               # %scalar.ph210
                                        #   Parent Loop BB2_36 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$t2, $a4, $t0
	ld.w	$t3, $t2, 72
...
# %bb.49:                               #   in Loop: Header=BB2_48 Depth=1
	...
	b	.LBB2_53
	.p2align	4, , 16
.LBB2_50:                               # %vector.body204.preheader
                                        #   in Loop: Header=BB2_48 Depth=1
	move	$t3, $a7
	move	$t4, $a4
	move	$t5, $a3
	.p2align	4, , 16
.LBB2_51:                               # %vector.body204
	...
	addi.d	$t3, $t3, 32
	bnez	$t5, .LBB2_51
# %bb.52:                               # %middle.block207
                                        #   in Loop: Header=BB2_48 Depth=1
	move	$t5, $a3
	beq	$a3, $t6, .LBB2_47
.LBB2_53:                               # %scalar.ph199.preheader
                                        #   in Loop: Header=BB2_48 Depth=1
	mul.d	$t3, $t5, $t1
	add.d	$t3, $a5, $t3
	alsl.d	$t4, $t5, $a6, 3
...
# %bb.37:                               # %vec.epilog.middle.block
	...
	b	.LBB5_42
	.p2align	4, , 16
.LBB5_38:                               # %vector.body123.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t2, $s4
	move	$t3, $a6
	.p2align	4, , 16
.LBB5_39:                               # %vector.body123
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t4, $t2, $a4
...
.Lfunc_end5:
	.size	lame_encode_buffer, .Lfunc_end5-lame_encode_buffer
                                        # -- End function
	.globl	lame_encode_buffer_interleaved  # -- Begin function lame_encode_buffer_interleaved
	.p2align	5
...
.LBB6_54:                               # %vector.body190
	...
	addi.d	$a2, $a2, 32
	bnez	$a6, .LBB6_54
# %bb.55:                               # %middle.block196
	beq	$a1, $s2, .LBB6_58
.LBB6_56:                               # %.lr.ph136.preheader200
	alsl.d	$a2, $a1, $s3, 2
	addi.d	$a2, $a2, 2
	alsl.d	$a3, $a1, $a0, 1
	alsl.d	$t0, $a1, $s4, 1
