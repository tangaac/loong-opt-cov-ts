...
.LBB5_19:                               # =>This Inner Loop Header: Depth=1
	...
	bnez	$a3, .LBB5_19
	b	.LBB5_42
.LBB5_20:                               # %vector.main.loop.iter.check167
	ori	$a2, $zero, 16
	bgeu	$a4, $a2, .LBB5_24
# %bb.21:
	move	$a4, $zero
...
.LBB5_28:                               # %vec.epilog.ph187
	...
	add.d	$a6, $a0, $a6
	vrepli.b	$vr1, -1
.LBB5_29:                               # %vec.epilog.vector.body193
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a6, 0
	vld	$vr3, $a5, 0
	vseq.w	$vr2, $vr2, $vr3
...
# %bb.30:                               # %vec.epilog.middle.block201
	...
	sltui	$a2, $a2, 1
	beq	$a4, $a3, .LBB5_42
.LBB5_31:                               # %vec.epilog.scalar.ph186.preheader
	slli.d	$a5, $a4, 2
	addi.d	$a6, $a5, 996
	add.d	$a5, $a0, $a6
	add.d	$a6, $a1, $a6
	sub.d	$a3, $a3, $a4
.LBB5_32:                               # %vec.epilog.scalar.ph186
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a5, 0
	ld.w	$a7, $a6, 0
	xor	$a4, $a4, $a7
