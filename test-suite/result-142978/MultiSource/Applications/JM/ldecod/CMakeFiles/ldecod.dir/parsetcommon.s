...
.LBB5_21:                               # =>This Inner Loop Header: Depth=1
	...
	bnez	$a3, .LBB5_21
	b	.LBB5_44
.LBB5_22:                               # %vector.main.loop.iter.check167
	ori	$a2, $zero, 16
	bgeu	$a4, $a2, .LBB5_26
# %bb.23:
	move	$a4, $zero
	ori	$a2, $zero, 1
	b	.LBB5_30
.LBB5_24:                               # %vector.main.loop.iter.check
	ori	$a2, $zero, 16
	bgeu	$a6, $a2, .LBB5_35
# %bb.25:
	move	$a6, $zero
...
# %bb.28:                               # %middle.block180
	...
	sltui	$a2, $a2, 1
	beq	$a4, $a3, .LBB5_44
# %bb.29:                               # %vec.epilog.iter.check188
	andi	$a5, $a3, 12
	beqz	$a5, .LBB5_33
.LBB5_30:                               # %vec.epilog.ph187
	move	$a5, $a4
	sltui	$a2, $a2, 1
	...
	add.d	$a6, $a0, $a6
	vrepli.b	$vr1, -1
.LBB5_31:                               # %vec.epilog.vector.body193
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a6, 0
	vld	$vr3, $a5, 0
	vseq.w	$vr2, $vr2, $vr3
	...
	addi.d	$a6, $a6, 16
	bnez	$a2, .LBB5_31
# %bb.32:                               # %vec.epilog.middle.block201
	vpickve2gr.w	$a2, $vr0, 0
	...
	sltui	$a2, $a2, 1
	beq	$a4, $a3, .LBB5_44
.LBB5_33:                               # %vec.epilog.scalar.ph186.preheader
	slli.d	$a5, $a4, 2
	addi.d	$a6, $a5, 996
	add.d	$a5, $a0, $a6
	add.d	$a6, $a1, $a6
	sub.d	$a3, $a3, $a4
.LBB5_34:                               # %vec.epilog.scalar.ph186
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a5, 0
	ld.w	$a7, $a6, 0
	xor	$a4, $a4, $a7
