...
# %bb.62:                               # %iter.check559
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB0_73
# %bb.63:                               # %vector.main.loop.iter.check561
                                        #   in Loop: Header=BB0_55 Depth=2
	ori	$a0, $zero, 16
	bgeu	$s4, $a0, .LBB0_66
...
.LBB0_67:                               # %vector.body565
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB0_67
# %bb.68:                               # %middle.block570
                                        #   in Loop: Header=BB0_55 Depth=2
	beq	$a0, $s4, .LBB0_75
# %bb.69:                               # %vec.epilog.iter.check575
                                        #   in Loop: Header=BB0_55 Depth=2
	andi	$a1, $s4, 12
	beqz	$a1, .LBB0_73
.LBB0_70:                               # %vec.epilog.ph574
                                        #   in Loop: Header=BB0_55 Depth=2
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s2, 2
	.p2align	4, , 16
.LBB0_71:                               # %vec.epilog.vector.body580
                                        #   Parent Loop BB0_39 Depth=1
                                        #     Parent Loop BB0_55 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB0_71
# %bb.72:                               # %vec.epilog.middle.block584
                                        #   in Loop: Header=BB0_55 Depth=2
	beq	$a0, $s4, .LBB0_75
.LBB0_73:                               # %vec.epilog.scalar.ph573.preheader
                                        #   in Loop: Header=BB0_55 Depth=2
	sub.d	$a1, $s4, $a0
	alsl.d	$a2, $a0, $s3, 2
	alsl.d	$a0, $a0, $s2, 2
	.p2align	4, , 16
.LBB0_74:                               # %vec.epilog.scalar.ph573
                                        #   Parent Loop BB0_39 Depth=1
                                        #     Parent Loop BB0_55 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a3, $a0, 0
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB0_74
.LBB0_75:                               # %._crit_edge.thread.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=2
	ori	$s0, $zero, 1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$s4, $sp, 160
.LBB0_76:                               #   in Loop: Header=BB0_55 Depth=2
	st.d	$s3, $sp, 152
	slli.d	$a0, $s4, 2
	stx.w	$zero, $s3, $a0
	st.w	$fp, $sp, 164
...
.LBB0_77:                               # %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
	...
	alsl.d	$a1, $s4, $s2, 2
	.p2align	4, , 16
.LBB0_78:                               #   Parent Loop BB0_39 Depth=1
                                        #     Parent Loop BB0_55 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a2, $a0, 0
	addi.d	$a0, $a0, 4
...
.Ltmp84:
	...
	jirl	$ra, $ra, 0
.Ltmp85:
# %bb.83:                               # %thread-pre-split
                                        #   in Loop: Header=BB0_55 Depth=2
	ld.w	$s3, $sp, 160
	ld.w	$fp, $sp, 164
.LBB0_84:                               #   in Loop: Header=BB0_55 Depth=2
	nor	$a0, $s3, $zero
	add.w	$a0, $fp, $a0
	bgtz	$a0, .LBB0_53
# %bb.85:                               #   in Loop: Header=BB0_55 Depth=2
	...
	addi.w	$s5, $a0, 1
	beq	$s5, $fp, .LBB0_53
# %bb.86:                               #   in Loop: Header=BB0_55 Depth=2
	slti	$a0, $a0, -1
	slli.d	$a1, $s5, 2
	masknez	$a1, $a1, $a0
	addi.w	$a2, $zero, -1
...
.LBB0_103:                              # %vec.epilog.scalar.ph
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB0_103
.LBB0_104:                              # %._crit_edge.thread.i.i.i347
                                        #   in Loop: Header=BB0_55 Depth=2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$s3, $sp, 160
.LBB0_105:                              #   in Loop: Header=BB0_55 Depth=2
	st.d	$s2, $sp, 152
	slli.d	$a0, $s3, 2
	stx.w	$zero, $s2, $a0
	st.w	$s5, $sp, 164
...
# %bb.110:                              # %.noexc336
	...
	and	$a0, $fp, $s8
	beqz	$a0, .LBB0_109
.LBB0_111:                              # %_ZL11PrintStringR13CStdOutStreamRK11CStringBaseIwEi.exit337
                                        #   in Loop: Header=BB0_39 Depth=1
.Ltmp94:
	pcalau12i	$a0, %pc_hi20(.L.str.1)
...
# %bb.113:                              # %.lr.ph477
	...
	move	$fp, $zero
	.p2align	4, , 16
.LBB0_114:                              #   Parent Loop BB0_39 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s1, 88
	ldx.b	$a0, $a0, $fp
	andi	$s2, $a0, 255
...
.Ltmp104:
	...
	jirl	$ra, $ra, 0
.Ltmp105:
# %bb.121:                              #   in Loop: Header=BB0_39 Depth=1
	ld.d	$a0, $sp, 152
	ld.d	$fp, $sp, 80                    # 8-byte Folded Reload
	beqz	$a0, .LBB0_38
# %bb.122:                              #   in Loop: Header=BB0_39 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_38
.LBB0_123:
...
.Ltmp291:
	...
	jirl	$ra, $a1, 0
.Ltmp292:
# %bb.134:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackEC2EPS0_.exit
	ld.b	$a0, $sp, 608
	ld.d	$s4, $s1, 24
	st.d	$s0, $s1, 72
	st.b	$a0, $s1, 20
...
# %bb.157:                              # %.noexc540
	...
	ori	$a0, $zero, 1
	blt	$s3, $a0, .LBB0_164
# %bb.158:                              # %._crit_edge.thread.i.i538
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 976
...
.LBB0_165:
	...
	ori	$a0, $zero, 10
	st.w	$a0, $sp, 980
.LBB0_166:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i534
...
# %bb.170:
	...
	st.w	$s4, $sp, 452
	move	$s2, $s1
.LBB0_171:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i396
	ld.d	$s4, $sp, 616
	move	$a0, $zero
	addi.d	$s1, $sp, 760
	.p2align	4, , 16
...
# %bb.176:
	...
	st.w	$fp, $sp, 244
	move	$a0, $s2
.LBB0_177:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i405.preheader
	addi.d	$a1, $sp, 256
	addi.d	$s2, $sp, 288
	.p2align	4, , 16
.LBB0_178:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i405
...
# %bb.196:                              # %.lr.ph486
	...
	b	.LBB0_198
	.p2align	4, , 16
.LBB0_197:                              # %_ZN11CStringBaseIwED2Ev.exit422
...
.Ltmp178:
	...
	jirl	$ra, $ra, 0
.Ltmp179:
# %bb.202:                              # %_ZN8NWindows6NError16MyFormatMessageWEj.exit
                                        #   in Loop: Header=BB0_198 Depth=1
	ld.d	$a1, $sp, 400
.Ltmp181:
	move	$a0, $s0
...
.Ltmp183:
	...
	jirl	$ra, $ra, 0
.Ltmp184:
# %bb.204:                              #   in Loop: Header=BB0_198 Depth=1
	ld.d	$a0, $sp, 400
	beqz	$a0, .LBB0_197
...
# %bb.222:                              # %.lr.ph489
	...
	b	.LBB0_224
	.p2align	4, , 16
.LBB0_223:                              # %_ZN11CStringBaseIwED2Ev.exit435
...
.Ltmp247:
	...
	jirl	$ra, $ra, 0
.Ltmp248:
# %bb.228:                              # %_ZN8NWindows6NError16MyFormatMessageWEj.exit434
                                        #   in Loop: Header=BB0_224 Depth=1
	ld.d	$a1, $sp, 400
.Ltmp250:
	move	$a0, $s0
...
# %bb.230:                              #   in Loop: Header=BB0_224 Depth=1
	ld.d	$a0, $sp, 400
	beqz	$a0, .LBB0_223
# %bb.231:                              #   in Loop: Header=BB0_224 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_223
.LBB0_232:                              # %._crit_edge490
.Ltmp255:
	pcalau12i	$a0, %pc_hi20(.L.str.19)
	addi.d	$a1, $a0, %pc_lo12(.L.str.19)
	move	$a0, $s0
...
# %bb.244:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_245:                              # %_ZN11CStringBaseIwED2Ev.exit.i437
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB0_247
# %bb.246:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_247:                              # %_ZN11CStringBaseIwED2Ev.exit1.i
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB0_249
# %bb.248:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
# %bb.250:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_345
.LBB0_251:                              # %.lr.ph483.split.preheader
	move	$s2, $zero
	move	$s3, $zero
	b	.LBB0_254
.LBB0_252:                              # %_ZN11CStringBaseIwED2Ev.exit417
...
.Ltmp155:
	...
	jirl	$ra, $ra, 0
.Ltmp156:
# %bb.256:                              #   in Loop: Header=BB0_254 Depth=1
.Ltmp158:
	addi.d	$a0, $sp, 400
	pcaddu18i	$ra, %call36(_Z12myAddExeFlagRK11CStringBaseIwE)
	jirl	$ra, $ra, 0
.Ltmp159:
# %bb.257:                              #   in Loop: Header=BB0_254 Depth=1
	ld.d	$a0, $sp, 400
	beqz	$a0, .LBB0_252
# %bb.258:                              #   in Loop: Header=BB0_254 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_252
.LBB0_259:
...
# %bb.266:
	...
	st.w	$s7, $sp, 452
	move	$s3, $s4
.LBB0_267:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i364
	move	$a0, $zero
	addi.d	$fp, $s1, 40
	.p2align	4, , 16
...
# %bb.274:                              # %.noexc379
	...
	ori	$a0, $zero, 1
	blt	$s6, $a0, .LBB0_276
# %bb.275:                              # %._crit_edge.thread.i.i377
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 176
...
.LBB0_277:
	...
	stx.w	$zero, $s3, $a0
	st.w	$s4, $sp, 180
.LBB0_278:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i373
	ld.d	$a0, $sp, 640
	addi.d	$s2, $sp, 184
	.p2align	4, , 16
...
# %bb.285:                              # %.noexc383
	...
	addi.d	$s4, $s4, 8
	bne	$s3, $s4, .LBB0_284
.LBB0_286:                              # %_ZN13CObjectVectorI9CPropertyEaSERKS1_.exit
	ori	$a0, $zero, 0
	lu32i.d	$a0, 4
	st.d	$a0, $sp, 408
.Ltmp318:
...
# %bb.312:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_313:                              # %_ZN11CStringBaseIwED2Ev.exit442
	addi.d	$a0, $sp, 152
...
# %bb.340:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_341:                              # %_ZN11CStringBaseIwED2Ev.exit387
	addi.d	$a0, $sp, 152
	pcaddu18i	$ra, %call36(_ZN15CExtractOptionsD2Ev)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 440
...
.Ltmp396:
	...
	jirl	$ra, $a1, 0
.Ltmp397:
.LBB0_346:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit
	addi.d	$a0, $sp, 488
...
# %bb.378:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_379:                              # %_ZN11CStringBaseIwED2Ev.exit427
.Ltmp222:
	pcalau12i	$a0, %pc_hi20(.L.str.23)
	addi.d	$a1, $a0, %pc_lo12(.L.str.23)
	addi.d	$a0, $sp, 400
...
.LBB0_442:
.Ltmp407:
.LBB0_443:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit449
	move	$s0, $a0
	b	.LBB0_473
.LBB0_444:
.Ltmp118:
...
.LBB0_455:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_456:                              # %_ZN20COpenCallbackConsoleD2Ev.exit441
	ld.d	$s6, $sp, 72                    # 8-byte Folded Reload
	b	.LBB0_471
.LBB0_457:
.Ltmp106:
...
.LBB0_460:
	...
	jirl	$ra, $ra, 0
.LBB0_461:                              # %.loopexit.split-lp465
.Ltmp96:
	b	.LBB0_468
.LBB0_462:                              # %.loopexit.split-lp470
.Ltmp74:
	b	.LBB0_465
.LBB0_463:                              # %.loopexit464
.Ltmp93:
	b	.LBB0_468
.LBB0_464:                              # %.loopexit469
.Ltmp71:
.LBB0_465:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackED2Ev.exit393
	move	$s0, $a0
	b	.LBB0_471
.LBB0_466:
.Ltmp88:
...
# %bb.470:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_471:                              # %_ZN9CMyComPtrI29IFolderArchiveExtractCallbackED2Ev.exit393
	addi.d	$a0, $sp, 456
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB0_472:
...
.Ltmp402:
	...
	jirl	$ra, $a1, 0
.Ltmp403:
.LBB0_473:                              # %_ZN9CMyComPtrI8IUnknownED2Ev.exit449
	addi.d	$a0, $sp, 488
	pcaddu18i	$ra, %call36(_ZN18NCommandLineParser7CParserD1Ev)
	jirl	$ra, $ra, 0
.LBB0_474:
