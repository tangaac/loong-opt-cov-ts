...
.LBB1_113:                              # %vector.body
	...
	xvldx	$xr3, $s8, $a1
	xvfmul.d	$xr4, $xr6, $xr7
	xvld	$xr5, $ra, 8
	xvldx	$xr7, $fp, $a3
	xvldx	$xr8, $s7, $a1
	xvldx	$xr9, $t5, $a3
	xvfmadd.d	$xr3, $xr4, $xr5, $xr3
	ld.d	$a0, $sp, 824                   # 8-byte Folded Reload
	xvldx	$xr4, $a0, $a1
	xvfmul.d	$xr8, $xr7, $xr8
	xvfmadd.d	$xr3, $xr8, $xr9, $xr3
	xvldx	$xr8, $s2, $a1
	xvfmadd.d	$xr3, $xr6, $xr4, $xr3
	xvldx	$xr4, $t7, $a3
	xvldx	$xr6, $s0, $a1
	xvstx	$xr2, $t6, $a3
	xvfmul.d	$xr0, $xr0, $xr8
	xvfmul.d	$xr0, $xr0, $xr4
	xvfmadd.d	$xr2, $xr7, $xr6, $xr3
	xvldx	$xr3, $s1, $a1
	xvldx	$xr4, $t4, $a1
	xvstx	$xr0, $t0, $a3
	xvstx	$xr1, $t1, $a3
	xvfmadd.d	$xr0, $xr3, $xr5, $xr2
...
.LBB4_14:                               # %vector.memcheck
	...
	xvinsgr2vr.d	$xr7, $t8, 0
	xvinsgr2vr.d	$xr2, $t2, 3
	xvori.b	$xr5, $xr7, 0
	xvinsgr2vr.d	$xr5, $t6, 1
	xvinsgr2vr.d	$xr5, $s3, 2
	...
	xvinsgr2vr.d	$xr16, $s4, 0
	xvinsgr2vr.d	$xr9, $s2, 3
	xvori.b	$xr12, $xr16, 0
	xvinsgr2vr.d	$xr12, $t6, 1
	xvinsgr2vr.d	$xr12, $s4, 2
	xvinsgr2vr.d	$xr15, $t7, 0
	xvinsgr2vr.d	$xr12, $t8, 3
	xvori.b	$xr14, $xr15, 0
	xvinsgr2vr.d	$xr14, $t8, 1
	xvinsgr2vr.d	$xr14, $s4, 2
	xvinsgr2vr.d	$xr14, $a1, 3
	xvinsgr2vr.d	$xr15, $a1, 1
	xvinsgr2vr.d	$xr15, $t7, 2
	xvinsgr2vr.d	$xr15, $t6, 3
	xvinsgr2vr.d	$xr17, $t6, 0
	xvinsgr2vr.d	$xr17, $t5, 1
	xvinsgr2vr.d	$xr17, $t8, 2
	...
	xvpickve2gr.d	$a4, $xr13, 2
	vinsgr2vr.b	$vr2, $a4, 6
	xvpickve2gr.d	$a4, $xr13, 3
	...
	xvori.b	$xr10, $xr2, 0
	xvpermi.q	$xr10, $xr2, 1
	vinsgr2vr.b	$vr10, $a4, 1
	xvpermi.q	$xr2, $xr10, 2
	xvpickve2gr.d	$a4, $xr8, 2
	xvori.b	$xr10, $xr2, 0
	xvpermi.q	$xr10, $xr2, 1
	vinsgr2vr.b	$vr10, $a4, 2
	xvpermi.q	$xr2, $xr10, 2
	...
	xvori.b	$xr4, $xr2, 0
	xvpermi.q	$xr4, $xr2, 1
	vinsgr2vr.b	$vr4, $a4, 12
	xvpermi.q	$xr2, $xr4, 2
	xvpickve2gr.d	$a4, $xr3, 1
	xvori.b	$xr4, $xr2, 0
	xvpermi.q	$xr4, $xr2, 1
	vinsgr2vr.b	$vr4, $a4, 13
	xvpermi.q	$xr2, $xr4, 2
	xvpickve2gr.d	$a4, $xr3, 2
	xvori.b	$xr4, $xr2, 0
	xvpermi.q	$xr4, $xr2, 1
	vinsgr2vr.b	$vr4, $a4, 14
	xvpermi.q	$xr2, $xr4, 2
	xvpickve2gr.d	$a4, $xr3, 3
	xvori.b	$xr3, $xr2, 0
	xvpermi.q	$xr3, $xr2, 1
	xvinsgr2vr.d	$xr9, $s2, 0
	vinsgr2vr.b	$vr3, $a4, 15
	xvori.b	$xr7, $xr9, 0
	xvinsgr2vr.d	$xr7, $s3, 1
	...
	xvinsgr2vr.d	$xr15, $s2, 1
	xvinsgr2vr.d	$xr15, $t5, 2
	xvinsgr2vr.d	$xr15, $s3, 3
	xvslt.du	$xr15, $xr6, $xr15
	...
	xvori.b	$xr9, $xr6, 0
	xvpermi.q	$xr9, $xr6, 1
	vinsgr2vr.b	$vr9, $s2, 0
	xvpermi.q	$xr6, $xr9, 2
	xvpickve2gr.d	$s2, $xr8, 1
	xvori.b	$xr9, $xr6, 0
	xvpermi.q	$xr9, $xr6, 1
	vinsgr2vr.b	$vr9, $s2, 1
	xvpermi.q	$xr6, $xr9, 2
	...
	xvori.b	$xr8, $xr6, 0
	xvpermi.q	$xr8, $xr6, 1
	vinsgr2vr.b	$vr8, $s2, 3
	xvpermi.q	$xr6, $xr8, 2
	xvslt.du	$xr1, $xr1, $xr7
	...
	xvori.b	$xr1, $xr6, 0
	xvpermi.q	$xr1, $xr6, 1
	vinsgr2vr.b	$vr1, $s2, 7
	xvpermi.q	$xr6, $xr1, 2
	xvslt.du	$xr1, $xr5, $xr4
	xvpickve2gr.d	$s2, $xr1, 0
	xvori.b	$xr4, $xr6, 0
	xvpermi.q	$xr4, $xr6, 1
	...
	andi	$s3, $s3, 1
	bstrins.d	$s2, $s3, 63, 1
	vpickve2gr.b	$s3, $vr0, 2
	bstrins.d	$s2, $s3, 2, 2
	vpickve2gr.b	$s3, $vr0, 3
	bstrins.d	$s2, $s3, 3, 3
	vpickve2gr.b	$s3, $vr0, 4
	bstrins.d	$s2, $s3, 4, 4
	vpickve2gr.b	$s3, $vr0, 5
	bstrins.d	$s2, $s3, 5, 5
	vpickve2gr.b	$s3, $vr0, 6
	andi	$s3, $s3, 1
	slli.d	$s3, $s3, 6
	or	$s2, $s2, $s3
	...
	slli.d	$s3, $s3, 10
	or	$s2, $s2, $s3
	vpickve2gr.b	$s3, $vr0, 11
	andi	$s3, $s3, 1
	slli.d	$s3, $s3, 11
	or	$s2, $s2, $s3
	vpickve2gr.b	$s3, $vr0, 12
	andi	$s3, $s3, 1
	slli.d	$s3, $s3, 12
	or	$s2, $s2, $s3
