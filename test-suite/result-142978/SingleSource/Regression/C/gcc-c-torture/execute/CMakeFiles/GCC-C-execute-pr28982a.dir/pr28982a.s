...
.LBB0_2:                                # =>This Inner Loop Header: Depth=1
	...
	movfr2gr.s	$ra, $fa5
	xvinsgr2vr.w	$xr3, $ra, 2
	movfr2gr.s	$ra, $fa6
	xvinsgr2vr.w	$xr3, $ra, 3
	movfr2gr.s	$ra, $fa7
	xvinsgr2vr.w	$xr3, $ra, 4
	movfr2gr.s	$ra, $ft0
	xvinsgr2vr.w	$xr3, $ra, 5
	movfr2gr.s	$ra, $ft1
	xvinsgr2vr.w	$xr3, $ra, 6
	movfr2gr.s	$ra, $ft2
	xvinsgr2vr.w	$xr3, $ra, 7
	fld.s	$fa4, $t4, 0
	fld.s	$fa5, $t3, 0
	fld.s	$fa6, $t2, 0
	fld.s	$fa7, $t1, 0
	...
	movfr2gr.s	$ra, $fa7
	xvinsgr2vr.w	$xr4, $ra, 3
	movfr2gr.s	$ra, $ft0
	xvinsgr2vr.w	$xr4, $ra, 4
	movfr2gr.s	$ra, $ft1
...
# %bb.0:                                # %.preheader.preheader
	...
	vld	$vr1, $a5, 64
	pcalau12i	$a5, %pc_hi20(.LCPI1_15)
	vld	$vr2, $a5, %pc_lo12(.LCPI1_15)
	vld	$vr3, $sp, 0
