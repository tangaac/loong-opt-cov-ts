...
# %bb.4:                                # %_ZN9benchmark8internal18GetNullLogInstanceEv.exit22
	...
	add.d	$a0, $a1, $a0
	addi.d	$fp, $a2, %pc_lo12(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_08__invokeEl)
	jr	$a0
.LBB3_5:
...
.LBB3_9:                                # %_ZN9benchmark12FittingCurveENS_4BigOE.exit53
	ld.d	$a2, $s1, 8
	ld.d	$a0, $s1, 0
	movgr2fr.d	$fs0, $zero
	beq	$a2, $a0, .LBB3_20
.LBB3_10:                               # %.lr.ph.i55.preheader
	movgr2fr.d	$fs2, $zero
	move	$s3, $zero
	move	$s4, $zero
	fmov.d	$fs1, $fs2
...
.LBB3_22:                               # %.lr.ph47.i65
	...
	addi.d	$s3, $s3, 8
	bltu	$s4, $a1, .LBB3_22
.LBB3_23:                               # %_ZN9benchmark14MinimalLeastSqERKSt6vectorIlSaIlEERKS0_IdSaIdEEPFdlE.exit76
	srli.d	$a0, $a1, 32
	...
	fdiv.d	$fs0, $fs1, $fa2
	bceqz	$fcc0, .LBB3_52
.LBB3_24:                               # %_ZN9benchmark14MinimalLeastSqERKSt6vectorIlSaIlEERKS0_IdSaIdEEPFdlE.exit76.split
	fdiv.d	$fa0, $fa0, $fs0
	fst.d	$fs2, $s5, 0
	fst.d	$fa0, $s5, 8
	st.w	$s2, $s5, 16
.LBB3_25:                               # %_ZN9benchmark14MinimalLeastSqERKSt6vectorIlSaIlEERKS0_IdSaIdEEPFdlE.exit76.split
...
.LBB3_28:                               # %.loopexit94.split
	...
	addi.d	$s8, $a0, %pc_lo12(.Lswitch.table._ZN9benchmark14MinimalLeastSqERKSt6vectorIlSaIlEERKS0_IdSaIdEENS_4BigOE)
	fld.d	$fa0, $fp, %pc_lo12(.LCPI3_0)
	fst.d	$fa0, $sp, 8                    # 8-byte Folded Spill
	fld.d	$fs3, $s3, %pc_lo12(.LCPI3_1)
	movgr2fr.d	$fs4, $zero
	ori	$fp, $zero, 20
	b	.LBB3_30
	.p2align	4, , 16
...
.LBB3_53:                               # %call.sqrt
	...
	jirl	$ra, $ra, 0
	b	.LBB3_28
.LBB3_54:                               # %_ZNSt6vectorIN9benchmark4BigOESaIS1_EED2Ev.exit51.loopexit
.Ltmp5:
	b	.LBB3_56
.LBB3_55:                               # %_ZNSt6vectorIN9benchmark4BigOESaIS1_EED2Ev.exit51.loopexit.split-lp
.Ltmp2:
.LBB3_56:                               # %_ZNSt6vectorIN9benchmark4BigOESaIS1_EED2Ev.exit51
	move	$s0, $a0
	ld.d	$a0, $sp, 0                     # 8-byte Folded Reload
	fst.d	$fs1, $a0, 8
	fst.d	$fs0, $a0, 0
...
.Ltmp93:
	...
	jirl	$ra, $ra, 0
.Ltmp94:
# %bb.88:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEPKc.exit118
	st.w	$s0, $sp, 368
	addi.d	$a0, $sp, 376
.Ltmp95:
	move	$a1, $s2
...
.Ltmp103:
	...
	jirl	$ra, $ra, 0
.Ltmp104:
.LBB4_97:                               # %_ZNSt6vectorIN9benchmark17BenchmarkReporter3RunESaIS2_EE9push_backERKS2_.exit127
	ld.d	$a1, $sp, 568
	addi.d	$a0, $sp, 552
.Ltmp106:
...
.Ltmp109:
	...
	jirl	$ra, $ra, 0
.Ltmp110:
# %bb.105:                              # %_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN9benchmark7CounterESt4lessIS5_ESaISt4pairIKS5_S7_EEED2Ev.exit.i128
	ld.d	$a0, $sp, 976
	addi.d	$a1, $sp, 992
	beq	$a0, $a1, .LBB4_107
# %bb.106:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i129
	ld.d	$a1, $sp, 992
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_107:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i130
	ld.d	$a0, $sp, 936
	addi.d	$a1, $sp, 952
	beq	$a0, $a1, .LBB4_109
# %bb.108:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i1.i131
	ld.d	$a1, $sp, 952
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_109:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit3.i132
	ld.d	$a0, $sp, 896
	addi.d	$a1, $sp, 912
	beq	$a0, $a1, .LBB4_111
# %bb.110:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4.i133
	ld.d	$a1, $sp, 912
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_111:                              # %_ZN9benchmark17BenchmarkReporter3RunD2Ev.exit137
	addi.d	$a0, $sp, 616
	pcaddu18i	$ra, %call36(_ZN9benchmark13BenchmarkNameD2Ev)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 1176
...
# %bb.114:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_115:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit139
	ld.d	$a0, $sp, 1480
...
.Ltmp49:
	b	.LBB4_147
.LBB4_133:                              # %.loopexit186
.Ltmp16:
	b	.LBB4_147
.LBB4_134:                              # %.loopexit.split-lp182
.Ltmp22:
	b	.LBB4_147
.LBB4_135:                              # %.loopexit.split-lp177
.Ltmp25:
	b	.LBB4_147
.LBB4_136:                              # %.loopexit.split-lp187
.Ltmp19:
	b	.LBB4_147
.LBB4_137:                              # %.loopexit181
.Ltmp13:
	b	.LBB4_147
.LBB4_138:                              # %.loopexit
.Ltmp46:
...
.LBB4_148:
	ld.d	$a0, $sp, 1432
	bnez	$a0, .LBB4_152
# %bb.149:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit142
	ld.d	$a0, $sp, 1456
	bnez	$a0, .LBB4_153
.LBB4_150:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit144
	ld.d	$a0, $sp, 1480
	bnez	$a0, .LBB4_154
.LBB4_151:                              # %_ZNSt6vectorIlSaIlEED2Ev.exit146
