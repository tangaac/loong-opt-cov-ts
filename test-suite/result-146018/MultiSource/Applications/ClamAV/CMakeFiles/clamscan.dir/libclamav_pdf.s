...
.LBB4_45:                               # %vec.epilog.ph
	...
	slli.d	$a5, $a4, 2
	alsl.d	$a4, $a4, $s5, 2
	vld	$vr3, $a2, %pc_lo12(.LCPI4_4)
	vreplgr2vr.w	$vr4, $a3
	pcalau12i	$a2, %pc_hi20(.LCPI4_5)
	vld	$vr2, $a2, %pc_lo12(.LCPI4_5)
	vadd.w	$vr3, $vr4, $vr3
	sub.d	$a2, $a3, $a5
	add.d	$a3, $s5, $a3
