...
.LBB0_44:                               # %.lr.ph1130
	...
	addi.d	$a5, $a5, 4
	bnez	$a1, .LBB0_44
.LBB0_45:                               # %._crit_edge1131
	addi.d	$a2, $a4, 8
	bltu	$s6, $a2, .LBB0_55
# %bb.46:                               # %._crit_edge1131
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
...
# %bb.147:
	...
	move	$a0, $s2
	bltu	$s7, $a3, .LBB0_71
# %bb.148:                              # %.preheader1093.preheader
	ld.w	$a0, $a2, 0
	st.w	$a0, $a1, 0
	ld.w	$a0, $a2, 4
	st.w	$a0, $a1, 4
...
# %bb.156:
	...
	move	$a0, $s2
	bltu	$s7, $a2, .LBB0_71
# %bb.157:                              # %.preheader1094.preheader
	ld.w	$a0, $a1, 0
	st.w	$a0, $s4, 0
	ld.w	$a0, $a1, 4
	st.w	$a0, $s4, 4
