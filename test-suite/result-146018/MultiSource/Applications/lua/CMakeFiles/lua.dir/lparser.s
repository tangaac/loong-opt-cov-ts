...
.LBB2_118:                              # %vector.body222
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_118
# %bb.119:                              # %middle.block226
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_122
.LBB2_120:                              # %scalar.ph217.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_121:                              # %scalar.ph217
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_129:                              # %vector.body210
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_129
# %bb.130:                              # %middle.block214
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_133
.LBB2_131:                              # %scalar.ph205.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_132:                              # %scalar.ph205
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_145:                              # %vector.body270
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_145
# %bb.146:                              # %middle.block274
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_149
.LBB2_147:                              # %scalar.ph265.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_148:                              # %scalar.ph265
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_160:                              # %vector.body282
	...
	addi.d	$a7, $a7, 8
	bnez	$t0, .LBB2_160
# %bb.161:                              # %middle.block286
                                        #   in Loop: Header=BB2_5 Depth=1
	ori	$s7, $zero, 27
	beq	$a6, $a5, .LBB2_164
.LBB2_162:                              # %scalar.ph277.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_171:                              # %vector.body234
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_171
# %bb.172:                              # %middle.block238
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_173:                              # %scalar.ph229.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_174:                              # %scalar.ph229
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_186:                              # %vector.body258
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_186
# %bb.187:                              # %middle.block262
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_190
.LBB2_188:                              # %scalar.ph253.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_189:                              # %scalar.ph253
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_198:                              # %vector.body246
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_198
# %bb.199:                              # %middle.block250
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_200:                              # %scalar.ph241.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_201:                              # %scalar.ph241
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
# %bb.18:                               # %middle.block57
	beq	$a5, $a6, .LBB18_21
.LBB18_19:                              # %scalar.ph48.preheader
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB18_20:                              # %scalar.ph48
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	alsl.d	$a6, $a6, $a3, 4
...
.LBB18_28:                              # %vector.body65
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB18_28
# %bb.29:                               # %middle.block69
	beq	$a5, $a6, .LBB18_32
.LBB18_30:                              # %scalar.ph60.preheader
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB18_31:                              # %scalar.ph60
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	alsl.d	$a6, $a6, $a3, 4
