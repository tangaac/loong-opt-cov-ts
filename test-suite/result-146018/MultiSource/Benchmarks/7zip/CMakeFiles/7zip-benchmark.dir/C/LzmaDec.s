...
.LBB4_113:                              # %vec.epilog.ph
	...
	add.d	$t6, $fp, $a2
	.p2align	4, , 16
.LBB4_114:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $t6, $a6
...
.LBB4_119:                              #   in Loop: Header=BB4_4 Depth=2
	...
	addi.w	$a2, $t7, 0
	bgeu	$s3, $a2, .LBB4_138
# %bb.120:                              #   in Loop: Header=BB4_4 Depth=2
	sub.d	$a2, $a5, $a1
	bstrpick.d	$a2, $a2, 31, 5
	add.d	$a3, $a1, $a2
...
.LBB4_121:                              #   in Loop: Header=BB4_4 Depth=2
	...
	b	.LBB4_124
	.p2align	4, , 16
.LBB4_122:                              #   in Loop: Header=BB4_124 Depth=3
	ld.bu	$a1, $t1, 0
	slli.d	$t5, $t7, 8
	slli.d	$a2, $s3, 8
	addi.d	$t1, $t1, 1
...
.LBB4_123:                              #   in Loop: Header=BB4_124 Depth=3
	...
	add.w	$s3, $a2, $a1
	beqz	$a6, .LBB4_126
.LBB4_124:                              #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bstrpick.d	$a1, $t7, 31, 24
	beqz	$a1, .LBB4_122
# %bb.125:                              #   in Loop: Header=BB4_124 Depth=3
	move	$t5, $t7
	b	.LBB4_123
...
# %bb.127:                              #   in Loop: Header=BB4_4 Depth=2
	...
	addi.d	$t1, $t1, 1
	or	$s3, $a2, $a1
.LBB4_128:                              #   in Loop: Header=BB4_4 Depth=2
	ld.hu	$a1, $t0, 1606
	bstrpick.d	$a2, $t7, 31, 11
	mul.d	$t8, $a2, $a1
	addi.w	$a2, $t8, 0
	slli.w	$t5, $t2, 4
	bgeu	$s3, $a2, .LBB4_141
# %bb.129:                              #   in Loop: Header=BB4_4 Depth=2
	sub.d	$a2, $a5, $a1
	bstrpick.d	$a2, $a2, 31, 5
	add.d	$a1, $a1, $a2
	ori	$t2, $zero, 2
...
.LBB4_130:                              # %vector.ph
                                        #   in Loop: Header=BB4_4 Depth=2
	bstrpick.d	$a1, $t5, 31, 5
	slli.d	$s1, $a1, 5
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	add.d	$a1, $a1, $t4
	move	$t8, $s1
	.p2align	4, , 16
.LBB4_131:                              # %vector.body
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a2, $a1, $a6
...
# %bb.133:                              # %vec.epilog.iter.check
	...
	andi	$a1, $t5, 16
	bnez	$a1, .LBB4_113
# %bb.134:                              #   in Loop: Header=BB4_4 Depth=2
	add.d	$t8, $t7, $s1
.LBB4_135:                              # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB4_4 Depth=2
	add.d	$a1, $t7, $t5
	.p2align	4, , 16
.LBB4_136:                              # %vec.epilog.scalar.ph
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.b	$a2, $t8, $a6
	...
	addi.d	$t8, $t8, 1
	bne	$t8, $a1, .LBB4_136
.LBB4_137:                              # %.loopexit1142.loopexit1156.i
                                        #   in Loop: Header=BB4_4 Depth=2
	add.d	$t4, $t5, $t4
	add.w	$s4, $t5, $s4
	bltu	$t4, $ra, .LBB4_108
