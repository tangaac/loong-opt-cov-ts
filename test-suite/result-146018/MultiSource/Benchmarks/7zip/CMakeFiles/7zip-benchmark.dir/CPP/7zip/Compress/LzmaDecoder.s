...
# %bb.10:
	...
	move	$a0, $zero
	st.w	$a1, $fp, 248
.LBB19_11:                              # %_ZN9NCompress5NLzma8CDecoder17CreateInputBufferEv.exit
...
# %bb.14:
	...
	add.d	$a0, $a1, $a0
	jr	$a0
.LBB30_15:                              # %.thread.loopexit50
	ori	$a0, $zero, 1
	b	.LBB30_20
.LBB30_16:                              # %.thread.loopexit
	lu12i.w	$a0, -524176
	ori	$a0, $a0, 14
	b	.LBB30_20
.LBB30_17:                              # %.thread.loopexit49
	lu12i.w	$a0, -524284
	ori	$a0, $a0, 1
	b	.LBB30_20
.LBB30_18:                              # %.thread.loopexit47
	lu12i.w	$a0, -524176
	ori	$a0, $a0, 87
	b	.LBB30_20
.LBB30_19:                              # %.thread.loopexit51
	lu12i.w	$a0, -524284
	ori	$a0, $a0, 5
.LBB30_20:                              # %.loopexit
...
.LBB33_20:
	lu12i.w	$a0, -524176
	ori	$a0, $a0, 14
.LBB33_21:                              # %_ZN9NCompress5NLzma8CDecoder17CreateInputBufferEv.exit
...
# %bb.30:
	...
	ld.bu	$a3, $a0, 14
	bne	$a2, $a3, .LBB34_32
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit39
	ld.bu	$a2, $s1, 15
	ld.bu	$a3, $a0, 15
	move	$a0, $fp
	beq	$a2, $a3, .LBB34_72
.LBB34_32:                              # %_ZeqRK4GUIDS1_.exit39.thread
...
# %bb.48:
	addi.d	$a0, $fp, 8
	b	.LBB34_72
.LBB34_49:                              # %_ZeqRK4GUIDS1_.exit58.thread
...
# %bb.65:
	addi.d	$a0, $fp, 16
	b	.LBB34_72
.LBB34_66:                              # %_ZeqRK4GUIDS1_.exit77.thread
...
.set _ZN9NCompress5NLzma8CDecoderC1Ev, _ZN9NCompress5NLzma8CDecoderC2Ev
	.globl	_ZN9NCompress5NLzma8CDecoderD1Ev
	.type	_ZN9NCompress5NLzma8CDecoderD1Ev,@function
.set _ZN9NCompress5NLzma8CDecoderD1Ev, _ZN9NCompress5NLzma8CDecoderD2Ev
