...
.LBB6_31:                               #   in Loop: Header=BB6_18 Depth=3
	move	$fp, $zero
.LBB6_32:                               # %._crit_edge.i
                                        #   in Loop: Header=BB6_18 Depth=3
	add.d	$a0, $s3, $fp
	st.d	$a0, $sp, 184
	move	$fp, $s5
.LBB6_33:                               # %_ZN9CInBuffer9ReadBytesEPhj.exit
                                        #   in Loop: Header=BB6_18 Depth=3
.Ltmp57:
	addi.d	$a0, $sp, 128
...
.LBB6_39:                               # %.thread
                                        #   in Loop: Header=BB6_18 Depth=3
	move	$a0, $zero
.LBB6_40:                               #   in Loop: Header=BB6_18 Depth=3
	add.w	$s4, $a0, $s5
	bltu	$s1, $s4, .LBB6_76
# %bb.41:                               #   in Loop: Header=BB6_18 Depth=3
	...
	and	$fp, $a0, $a1
	bgeu	$fp, $s8, .LBB6_78
# %bb.42:                               #   in Loop: Header=BB6_18 Depth=3
	addi.d	$a0, $fp, -256
	sltu	$a0, $zero, $a0
...
.LBB6_47:                               #   in Loop: Header=BB6_18 Depth=3
	...
	stx.b	$a1, $a2, $a0
	beqz	$a3, .LBB6_50
.LBB6_48:                               #   in Loop: Header=BB6_18 Depth=3
	ld.d	$a2, $s0, 32
	ld.d	$a3, $sp, 32                    # 8-byte Folded Reload
	stx.b	$a1, $a2, $a3
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	bne	$fp, $a2, .LBB6_50
# %bb.49:                               #   in Loop: Header=BB6_18 Depth=3
	ld.d	$a2, $s0, 40
	st.b	$a1, $a2, 0
.LBB6_50:                               #   in Loop: Header=BB6_18 Depth=3
	addi.w	$a0, $a0, 1
	addi.d	$s6, $a0, -1
	b	.LBB6_52
	.p2align	4, , 16
.LBB6_51:                               # %_ZN10COutBuffer9WriteByteEh.exit
                                        #   in Loop: Header=BB6_52 Depth=4
	addi.d	$a0, $s6, 1
	addi.d	$s6, $s6, -1
	bge	$s7, $a0, .LBB6_17
.LBB6_52:                               #   Parent Loop BB6_15 Depth=1
                                        #     Parent Loop BB6_16 Depth=2
                                        #       Parent Loop BB6_18 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	ld.d	$a0, $s0, 40
	...
	ld.w	$a1, $sp, 140
	bne	$a0, $a1, .LBB6_51
# %bb.53:                               #   in Loop: Header=BB6_52 Depth=4
.Ltmp63:
	addi.d	$a0, $sp, 128
...
.Ltmp64:
	b	.LBB6_51
.LBB6_54:                               #   in Loop: Header=BB6_16 Depth=2
	ld.d	$a0, $s0, 24
	addi.w	$a1, $s8, 1
	slli.d	$a2, $s8, 1
	stx.h	$fp, $a0, $a2
	...
	bge	$s5, $a0, .LBB6_16
# %bb.55:                               #   in Loop: Header=BB6_16 Depth=2
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	bltu	$s8, $a0, .LBB6_16
# %bb.56:                               #   in Loop: Header=BB6_15 Depth=1
	addi.w	$s5, $s5, 1
	b	.LBB6_15
