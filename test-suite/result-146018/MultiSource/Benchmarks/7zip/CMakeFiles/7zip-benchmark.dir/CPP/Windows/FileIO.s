...
# %bb.58:                               # %iter.check101
	...
	ori	$a4, $zero, 31
	bgeu	$a4, $a3, .LBB3_71
# %bb.59:                               # %vector.main.loop.iter.check103
	ori	$a2, $zero, 32
	bgeu	$a1, $a2, .LBB3_67
# %bb.60:
	move	$a2, $zero
.LBB3_61:                               # %vec.epilog.ph116
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB3_62:                               # %vec.epilog.vector.body122
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB3_62
# %bb.63:                               # %vec.epilog.middle.block126
	bne	$a2, $a1, .LBB3_71
	b	.LBB3_73
.LBB3_64:
	move	$a0, $zero
...
.LBB3_68:                               # %vector.body107
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_68
# %bb.69:                               # %middle.block112
	beq	$a2, $a1, .LBB3_73
# %bb.70:                               # %vec.epilog.iter.check117
	andi	$a3, $a1, 16
	bnez	$a3, .LBB3_61
.LBB3_71:                               # %vec.epilog.scalar.ph115.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s2, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB3_72:                               # %vec.epilog.scalar.ph115
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
