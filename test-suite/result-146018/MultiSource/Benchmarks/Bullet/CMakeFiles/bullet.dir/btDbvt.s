...
.LBB11_27:                              # %vector.body293
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_27
# %bb.28:                               # %middle.block298
	beq	$a2, $a1, .LBB11_31
.LBB11_29:                              # %scalar.ph288.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_30:                              # %scalar.ph288
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	st.d	$a4, $a2, 0
	addi.d	$a1, $a1, -1
...
# %bb.54:                               # %middle.block314
	beq	$a2, $a1, .LBB11_57
.LBB11_55:                              # %scalar.ph304.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_56:                              # %scalar.ph304
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	st.d	$a4, $a2, 0
	addi.d	$a1, $a1, -1
...
.LBB11_92:                              # %vector.body325
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_92
# %bb.93:                               # %middle.block330
                                        #   in Loop: Header=BB11_83 Depth=1
	beq	$a2, $a1, .LBB11_96
.LBB11_94:                              # %scalar.ph320.preheader
                                        #   in Loop: Header=BB11_83 Depth=1
	sub.d	$a3, $a1, $a2
	alsl.d	$a4, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_95:                              # %scalar.ph320
                                        #   Parent Loop BB11_83 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	st.d	$a5, $a2, 0
...
.LBB11_105:                             # %vector.body341
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_105
# %bb.106:                              # %middle.block346
                                        #   in Loop: Header=BB11_83 Depth=1
	beq	$a2, $a1, .LBB11_109
.LBB11_107:                             # %scalar.ph336.preheader
                                        #   in Loop: Header=BB11_83 Depth=1
	sub.d	$a3, $a1, $a2
	alsl.d	$a4, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_108:                             # %scalar.ph336
                                        #   Parent Loop BB11_83 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	st.d	$a5, $a2, 0
...
.LBB11_132:                             # %vector.body261
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_132
# %bb.133:                              # %middle.block266
	beq	$a2, $a1, .LBB11_136
.LBB11_134:                             # %scalar.ph256.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_135:                             # %scalar.ph256
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	st.d	$a4, $a2, 0
	addi.d	$a1, $a1, -1
...
.LBB11_155:                             # %vector.body277
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_155
# %bb.156:                              # %middle.block282
                                        #   in Loop: Header=BB11_147 Depth=1
	beq	$a2, $a1, .LBB11_159
.LBB11_157:                             # %scalar.ph272.preheader
                                        #   in Loop: Header=BB11_147 Depth=1
	sub.d	$a3, $a1, $a2
	alsl.d	$a4, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_158:                             # %scalar.ph272
                                        #   Parent Loop BB11_147 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	st.d	$a5, $a2, 0
