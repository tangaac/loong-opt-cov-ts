...
.LBB10_24:
	...
	fadd.s	$fa2, $fs1, $fa2
	fadd.s	$fa6, $fs2, $fa6
	fst.s	$fs0, $sp, 0                    # 4-byte Folded Spill
	fadd.s	$ft3, $fs0, $ft3
	movfr2gr.s	$a1, $fa2
	movfr2gr.s	$a2, $fa6
	bstrins.d	$a1, $a2, 63, 32
	...
	ld.d	$a4, $a1, 40
	fneg.s	$fs6, $fs3
	fst.s	$fs6, $sp, 48                   # 4-byte Folded Spill
	fneg.s	$fs7, $fs4
	fst.s	$fs7, $sp, 32                   # 4-byte Folded Spill
	fneg.s	$fs0, $fs5
	...
	fadd.s	$fa2, $fs1, $fa2
	fadd.s	$fa6, $fs2, $fa6
	fld.s	$ft4, $sp, 0                    # 4-byte Folded Reload
	fadd.s	$ft3, $ft4, $ft3
	movfr2gr.s	$a1, $fa2
	movfr2gr.s	$a2, $fa6
	bstrins.d	$a1, $a2, 63, 32
...
# %bb.0:
	...
	move	$s0, $a0
	fld.s	$fa1, $a1, 48
	fst.s	$fa1, $sp, 4                    # 4-byte Folded Spill
	fld.s	$fs1, $a1, 52
	fld.s	$fa1, $a1, 4
	fld.s	$fs2, $a1, 56
	fld.s	$fa2, $a1, 0
	...
	fst.s	$fs7, $sp, 8                    # 4-byte Folded Spill
	fmul.s	$fa1, $fa0, $fa6
	fmadd.s	$fa1, $fa7, $fa3, $fa1
	...
	move	$a0, $s0
	jirl	$ra, $a1, 0
	fld.s	$fa3, $sp, 4                    # 4-byte Folded Reload
	fsub.s	$fa0, $fa3, $fs4
	fmov.s	$fa4, $fs1
	fsub.s	$fa1, $fs1, $fs5
	fsub.s	$fa2, $fs2, $fs6
...
# %bb.14:                               #   in Loop: Header=BB47_6 Depth=1
	...
	b	.LBB47_23
	.p2align	4, , 16
.LBB47_15:                              # %.peel.next.preheader297
                                        #   in Loop: Header=BB47_6 Depth=1
...
.set _ZN23btDiscreteDynamicsWorldC1EP12btDispatcherP21btBroadphaseInterfaceP18btConstraintSolverP24btCollisionConfiguration, _ZN23btDiscreteDynamicsWorldC2EP12btDispatcherP21btBroadphaseInterfaceP18btConstraintSolverP24btCollisionConfiguration
	.globl	_ZN23btDiscreteDynamicsWorldD1Ev
	.type	_ZN23btDiscreteDynamicsWorldD1Ev,@function
.set _ZN23btDiscreteDynamicsWorldD1Ev, _ZN23btDiscreteDynamicsWorldD2Ev
