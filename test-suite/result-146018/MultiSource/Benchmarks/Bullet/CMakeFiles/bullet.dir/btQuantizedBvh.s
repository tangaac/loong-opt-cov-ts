...
# %bb.1:                                # %.lr.ph
	...
	fsel	$ft4, $fa1, $fa0, $fcc0
	frecip.s	$fa1, $fa3
	fcmp.ceq.s	$fcc0, $fa3, $fs7
	fsel	$fs5, $fa1, $fa0, $fcc0
	fcmp.cule.s	$fcc0, $fs7, $fs5
	fcmp.clt.s	$fcc1, $fs5, $fs7
	fcmp.cule.s	$fcc2, $fs7, $ft4
	fcmp.clt.s	$fcc3, $ft4, $fs7
	fcmp.cule.s	$fcc4, $fs7, $fs3
	fcmp.clt.s	$fcc5, $fs3, $fs7
	addi.d	$a0, $sp, 56
	movcf2gr	$a1, $fcc5
	alsl.d	$a7, $a1, $a0, 4
	movcf2gr	$a1, $fcc4
...
# %bb.11:                               #   in Loop: Header=BB20_4 Depth=1
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB20_16
.LBB20_12:                              # %_Z10btRayAabb2RK9btVector3S1_PKjPS0_Rfff.exit.thread
                                        #   in Loop: Header=BB20_4 Depth=1
	ld.w	$a1, $s7, 32
	move	$a0, $zero
	addi.d	$a1, $a1, 1
...
# %bb.1:                                # %.lr.ph
	...
	fcmp.clt.s	$fcc1, $fs4, $fs1
	fcmp.cule.s	$fcc2, $fs1, $fs3
	fcmp.clt.s	$fcc3, $fs3, $fs1
	fcmp.cule.s	$fcc4, $fs1, $fs2
	fcmp.clt.s	$fcc5, $fs2, $fs1
	ld.d	$a0, $s5, 184
	addi.d	$a1, $sp, 96
	movcf2gr	$a2, $fcc5
	alsl.d	$t8, $a2, $a1, 4
...
# %bb.35:                               # %.lr.ph236
	...
	ld.d	$a2, $s0, 224
	add.d	$a1, $s3, $fp
	pcalau12i	$a3, %pc_hi20(.LCPI26_2)
	vld	$vr0, $a3, %pc_lo12(.LCPI26_2)
	addi.d	$a1, $a1, 264
	addi.d	$a2, $a2, 8
