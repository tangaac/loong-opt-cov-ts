...
.LBB7_42:                               # %vector.body138
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB7_42
# %bb.43:                               # %middle.block143
	beq	$a0, $s2, .LBB7_46
.LBB7_44:                               # %scalar.ph133.preheader
	sub.d	$a2, $s2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB7_45:                               # %scalar.ph133
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
...
.LBB7_52:
	...
	jirl	$ra, $ra, 0
	ld.w	$s2, $fp, 140
.LBB7_53:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i59
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s1, $fp, 152
	st.w	$s3, $fp, 144
.LBB7_54:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit71
	move	$a0, $s2
.LBB7_55:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit71
	slli.d	$a1, $a0, 2
	fstx.s	$fs0, $s1, $a1
	fld.s	$fs0, $s0, 8
	addi.w	$a0, $a0, 1
...
.LBB7_62:                               # %vector.body154
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB7_62
# %bb.63:                               # %middle.block159
	beq	$a0, $s3, .LBB7_66
.LBB7_64:                               # %scalar.ph149.preheader
	sub.d	$a1, $s3, $a0
	alsl.d	$a2, $a0, $s1, 2
	alsl.d	$a0, $a0, $s0, 2
	.p2align	4, , 16
.LBB7_65:                               # %scalar.ph149
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a1, $a1, -1
...
.LBB7_72:
	...
	jirl	$ra, $ra, 0
	ld.w	$s3, $fp, 140
.LBB7_73:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i80
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s0, $fp, 152
	st.w	$s2, $fp, 144
.LBB7_74:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit92
	move	$a0, $s3
.LBB7_75:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit92
	ld.d	$a1, $fp, 40
	slli.d	$a2, $a0, 2
	ld.w	$a3, $a1, 20
	fstx.s	$fs0, $s0, $a2
...
.set _ZN14btTriangleMeshC1Ebb, _ZN14btTriangleMeshC2Ebb
