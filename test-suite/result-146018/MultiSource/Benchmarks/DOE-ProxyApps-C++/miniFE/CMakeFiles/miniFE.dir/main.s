...
# %bb.19:                               # %_ZNK6miniFE23simple_mesh_descriptionIiE13map_id_to_rowERKi.exit.us.us.us
	...
	vslli.w	$vr7, $vr7, 31
	vsrai.w	$vr7, $vr7, 31
	vld	$vr15, $sp, 480                 # 16-byte Folded Reload
	vadd.w	$vr8, $vr4, $vr15
...
.LBB12_22:                              # %vector.body
	...
	xvbitsel.v	$xr1, $xr6, $xr5, $xr3
	xvbitsel.v	$xr2, $xr6, $xr5, $xr2
	xvst	$xr1, $a5, -32
	xvst	$xr2, $a5, 0
	addi.d	$a7, $a7, -8
	addi.d	$a5, $a5, 64
...
.LBB14_26:                              # %_ZNSt6vectorIdSaIdEEC2EmRKS0_.exit
	...
	srli.d	$a0, $s5, 61
	bnez	$a0, .LBB14_97
# %bb.27:                               # %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i153
	beqz	$s5, .LBB14_82
.LBB14_28:                              # %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i153.thread
	slli.d	$s6, $s5, 2
.Ltmp879:
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_Znwm)
...
# %bb.29:                               # %.noexc160
	...
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB14_31
# %bb.30:                               # %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit161.thread470
	addi.d	$a0, $s4, 4
	addi.d	$a2, $s6, -4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
...
# %bb.46:                               # %.lr.ph319
	...
	move	$a1, $s6
	bgeu	$a3, $a7, .LBB14_59
.LBB14_47:                              # %scalar.ph522.preheader
	slli.d	$a7, $a1, 3
	alsl.d	$a3, $a1, $a6, 3
	slli.d	$a6, $a1, 2
	alsl.d	$a2, $a1, $a2, 2
...
.Ltmp885:
	...
	jirl	$ra, $ra, 0
.Ltmp886:
# %bb.51:                               # %._ZNSt6vectorIiSaIiEE6resizeEm.exit166_crit_edge
	ld.d	$a0, $s2, 0
	b	.LBB14_55
.LBB14_52:
	bgeu	$s5, $a2, .LBB14_55
# %bb.53:
	alsl.d	$a2, $s5, $a0, 2
	beq	$a1, $a2, .LBB14_55
# %bb.54:                               # %_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i.i164
	st.d	$a2, $s2, 64
.LBB14_55:                              # %iter.check
	move	$a1, $zero
	ori	$a2, $zero, 1
...
# %bb.58:
	move	$a1, $zero
	b	.LBB14_68
.LBB14_59:                              # %vector.memcheck517
	alsl.d	$a1, $s6, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 32
	move	$a1, $s6
	bltu	$a7, $t0, .LBB14_47
# %bb.60:                               # %vector.memcheck517
	alsl.d	$a1, $s6, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 64
	move	$a1, $s6
...
.LBB14_62:                              # %vector.body527
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB14_62
# %bb.63:                               # %middle.block535
	bne	$a3, $a7, .LBB14_47
	b	.LBB14_49
.LBB14_64:                              # %vector.ph545
	move	$a1, $a2
...
.LBB14_65:                              # %vector.body548
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB14_65
# %bb.66:                               # %middle.block553
	beq	$s5, $a1, .LBB14_73
# %bb.67:                               # %vec.epilog.iter.check
	andi	$a3, $a2, 12
	beqz	$a3, .LBB14_71
.LBB14_68:                              # %vec.epilog.ph
	move	$a5, $a1
	move	$a1, $a2
	...
	alsl.d	$a5, $a5, $s4, 2
	.p2align	4, , 16
.LBB14_69:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vadd.w	$vr1, $vr1, $vr0
	vst	$vr1, $a4, 0
...
# %bb.70:                               # %vec.epilog.middle.block
	beq	$s5, $a1, .LBB14_73
.LBB14_71:                              # %vec.epilog.scalar.ph.preheader
	sub.d	$a2, $a2, $a1
	alsl.d	$a3, $a1, $s4, 2
	alsl.d	$a0, $a1, $a0, 2
	.p2align	4, , 16
.LBB14_72:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a3, 0
	add.d	$a1, $a1, $s6
	st.w	$a1, $a0, 0
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB14_72
.LBB14_73:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit168
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $s4
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
# %bb.74:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB14_75:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit
	beqz	$s1, .LBB14_77
# %bb.76:
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	sub.d	$a1, $a0, $s1
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB14_77:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit171
	beqz	$s0, .LBB14_79
# %bb.78:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB14_79:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit173
	beqz	$fp, .LBB14_81
# %bb.80:
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $fp
	...
	jr	$t8
.LBB14_81:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit175
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 80                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 96                    # 8-byte Folded Reload
...
.LBB14_83:                              # %.lr.ph301
	...
	b	.LBB14_85
	.p2align	4, , 16
.LBB14_84:                              # %._crit_edge297
                                        #   in Loop: Header=BB14_85 Depth=1
	addi.d	$a1, $a1, 1
	beq	$a1, $s8, .LBB14_32
.LBB14_85:                              # =>This Loop Header: Depth=1
	...
	stx.w	$a0, $s4, $t3
	bge	$t4, $t5, .LBB14_84
# %bb.86:                               # %.lr.ph296.preheader
                                        #   in Loop: Header=BB14_85 Depth=1
	sub.d	$t6, $t5, $t4
	addi.w	$a0, $a0, 0
	bgeu	$t6, $t1, .LBB14_89
.LBB14_87:                              # %.lr.ph296.preheader565
                                        #   in Loop: Header=BB14_85 Depth=1
	alsl.d	$t6, $a0, $s1, 2
	alsl.d	$t7, $a0, $s3, 3
	alsl.d	$t8, $t4, $a4, 2
...
# %bb.81:                               #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $zero
	b	.LBB15_92
.LBB15_82:                              # %vector.body506.preheader
                                        #   in Loop: Header=BB15_67 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	move	$a2, $s2
...
.LBB15_83:                              # %vector.body506
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_83
# %bb.84:                               # %middle.block511
                                        #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $s2
	beq	$s6, $s2, .LBB15_87
.LBB15_85:                              # %.lr.ph.i185.preheader533
                                        #   in Loop: Header=BB15_67 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s0, 3
...
.LBB15_90:                              # %vector.body521
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_90
# %bb.91:                               # %middle.block528
                                        #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $s2
	beq	$s6, $s2, .LBB15_94
.LBB15_92:                              # %.lr.ph.i203.preheader534
                                        #   in Loop: Header=BB15_67 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s0, 3
...
# %bb.138:                              # %vector.memcheck482
                                        #   in Loop: Header=BB15_67 Depth=1
	alsl.d	$a3, $a1, $s0, 3
	bgeu	$a0, $a3, .LBB15_153
# %bb.139:                              # %vector.memcheck482
                                        #   in Loop: Header=BB15_67 Depth=1
	alsl.d	$a3, $a1, $a0, 3
...
# %bb.144:                              # %.lr.ph.i258.preheader
                                        #   in Loop: Header=BB15_67 Depth=1
	ori	$a0, $zero, 8
	bgeu	$s6, $a0, .LBB15_146
# %bb.145:                              #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $zero
	b	.LBB15_149
	.p2align	4, , 16
.LBB15_146:                             # %vector.ph469
                                        #   in Loop: Header=BB15_67 Depth=1
	xvreplve0.d	$xr1, $xr0
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
...
.LBB15_147:                             # %vector.body472
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_147
# %bb.148:                              # %middle.block479
                                        #   in Loop: Header=BB15_67 Depth=1
	move	$a2, $s2
	beq	$s6, $s2, .LBB15_151
.LBB15_149:                             # %.lr.ph.i258.preheader532
                                        #   in Loop: Header=BB15_67 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s1, 3
...
.LBB15_154:                             # %vector.body491
	...
	addi.d	$a3, $a3, 64
	bnez	$a5, .LBB15_154
# %bb.155:                              # %middle.block498
                                        #   in Loop: Header=BB15_67 Depth=1
	beq	$a1, $a2, .LBB15_143
	b	.LBB15_141
.LBB15_156:                             # %call.sqrt703
                                        #   in Loop: Header=BB15_67 Depth=1
	fmov.d	$fa0, $fs1
...
# %bb.160:
	ld.d	$fp, $sp, 192                   # 8-byte Folded Reload
	b	.LBB15_175
.LBB15_161:                             # %vector.memcheck447
	sub.d	$a5, $s5, $a0
	ori	$a4, $zero, 64
	move	$a2, $zero
	bltu	$a5, $a4, .LBB15_47
# %bb.162:                              # %vector.memcheck447
	sub.d	$a5, $s5, $s1
	bltu	$a5, $a4, .LBB15_47
# %bb.163:                              # %vector.ph454
	bstrpick.d	$a2, $a3, 30, 3
...
.Ltmp984:
	b	.LBB15_200
.LBB15_193:                             # %.loopexit.split-lp372
.Ltmp978:
	b	.LBB15_200
.LBB15_194:
.Ltmp990:
...
.Ltmp987:
	b	.LBB15_200
.LBB15_198:                             # %.loopexit370
.Ltmp950:
	b	.LBB15_200
.LBB15_199:                             # %.loopexit371
.Ltmp963:
.LBB15_200:
	move	$s2, $a0
	bnez	$s1, .LBB15_204
...
# %bb.81:                               #   in Loop: Header=BB16_67 Depth=1
	move	$a2, $zero
	b	.LBB16_92
.LBB16_82:                              # %vector.body506.preheader
                                        #   in Loop: Header=BB16_67 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	move	$a2, $s2
...
# %bb.84:                               # %middle.block511
	...
	move	$a2, $s2
	beq	$s6, $s2, .LBB16_87
.LBB16_85:                              # %.lr.ph.i185.preheader533
                                        #   in Loop: Header=BB16_67 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s0, 3
...
# %bb.91:                               # %middle.block528
	...
	move	$a2, $s2
	beq	$s6, $s2, .LBB16_94
.LBB16_92:                              # %.lr.ph.i203.preheader534
                                        #   in Loop: Header=BB16_67 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s0, 3
...
# %bb.144:                              # %.lr.ph.i258.preheader
                                        #   in Loop: Header=BB16_67 Depth=1
	ori	$a0, $zero, 8
	bgeu	$s6, $a0, .LBB16_146
# %bb.145:                              #   in Loop: Header=BB16_67 Depth=1
	move	$a2, $zero
	b	.LBB16_149
	.p2align	4, , 16
.LBB16_146:                             # %vector.ph469
                                        #   in Loop: Header=BB16_67 Depth=1
	xvreplve0.d	$xr1, $xr0
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
...
# %bb.148:                              # %middle.block479
	...
	move	$a2, $s2
	beq	$s6, $s2, .LBB16_151
.LBB16_149:                             # %.lr.ph.i258.preheader532
                                        #   in Loop: Header=BB16_67 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $s1, 3
...
.Ltmp1087:
	b	.LBB16_200
.LBB16_193:                             # %.loopexit.split-lp372
.Ltmp1081:
	b	.LBB16_200
.LBB16_194:
.Ltmp1093:
...
.Ltmp1090:
	b	.LBB16_200
.LBB16_198:                             # %.loopexit370
.Ltmp1053:
	b	.LBB16_200
.LBB16_199:                             # %.loopexit371
.Ltmp1066:
.LBB16_200:
	move	$s2, $a0
	bnez	$s1, .LBB16_204
...
.LBB39_6:                               # %.preheader.preheader
	...
	vst	$vr12, $sp, 128
	xvld	$xr11, $sp, 160
	xvbsrl.v	$xr12, $xr10, 8
	xvbsll.v	$xr10, $xr10, 8
	xvor.v	$xr13, $xr10, $xr12
	...
	xvfmul.d	$xr15, $xr12, $xr13
	xvfmul.d	$xr16, $xr10, $xr13
	xvld	$xr17, $sp, 64                  # 32-byte Folded Reload
	xvori.b	$xr13, $xr17, 0
	xvshuf.d	$xr13, $xr4, $xr6
	xvld	$xr18, $sp, 32                  # 32-byte Folded Reload
	xvori.b	$xr11, $xr18, 0
	xvshuf.d	$xr11, $xr14, $xr13
	xvshuf.d	$xr17, $xr8, $xr9
	xvori.b	$xr13, $xr18, 0
	xvshuf.d	$xr13, $xr5, $xr17
	xvpermi.q	$xr7, $xr7, 2
	xvfmul.d	$xr17, $xr13, $xr7
	...
	xvfmul.d	$xr4, $xr5, $xr3
	xvfmul.d	$xr3, $xr9, $xr3
	vld	$vr6, $sp, 232
	xvfadd.d	$xr3, $xr15, $xr3
	...
	xvbsll.v	$xr7, $xr7, 8
	xvor.v	$xr7, $xr7, $xr8
	xvfmul.d	$xr8, $xr12, $xr7
	xvpermi.q	$xr4, $xr4, 2
	xvfmul.d	$xr14, $xr13, $xr4
	xvfadd.d	$xr8, $xr8, $xr14
	xvreplve0.d	$xr2, $xr2
	xvfmul.d	$xr14, $xr9, $xr2
	xvfadd.d	$xr8, $xr8, $xr14
	xvst	$xr8, $sp, 288
	xvfmul.d	$xr8, $xr12, $xr3
	xvfmul.d	$xr3, $xr10, $xr3
	xvpermi.q	$xr6, $xr6, 2
	xvfmul.d	$xr12, $xr13, $xr6
	xvfmul.d	$xr6, $xr11, $xr6
	xvfadd.d	$xr3, $xr3, $xr6
	xvfadd.d	$xr6, $xr8, $xr12
	xvpermi.q	$xr1, $xr0, 2
	xvpermi.d	$xr1, $xr1, 68
	xvrepl128vei.d	$xr1, $xr1, 0
	xvfmul.d	$xr8, $xr5, $xr1
	xvfmul.d	$xr1, $xr9, $xr1
	xvfadd.d	$xr1, $xr6, $xr1
	xvfadd.d	$xr3, $xr3, $xr8
	xvst	$xr3, $sp, 384
	xvst	$xr1, $sp, 352
	xvfmul.d	$xr1, $xr10, $xr7
	xvfmul.d	$xr3, $xr11, $xr4
	xvfadd.d	$xr1, $xr1, $xr3
