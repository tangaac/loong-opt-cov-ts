...
.LBB0_24:                               # %.preheader186
	...
	ld.d	$s4, $a0, 0
	beqz	$a1, .LBB0_36
# %bb.25:                               # %.lr.ph208.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(strcmp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_29
# %bb.26:                               # %.lr.ph330.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	pcalau12i	$a0, %pc_hi20(esp_opt_table)
...
.LBB0_31:                               #   in Loop: Header=BB0_2 Depth=1
	...
	ori	$fp, $zero, 52
	b	.LBB0_2
.LBB0_32:                               # %.preheader184._crit_edge.loopexit
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	st.w	$a0, $sp, 152
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	st.w	$a0, $sp, 148
	move	$s0, $s1
.LBB0_33:                               # %.preheader184._crit_edge
	...
	jirl	$ra, $ra, 0
.LBB0_34:                               # %._crit_edge.loopexit336
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	st.w	$a0, $sp, 152
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	st.w	$a0, $sp, 148
	...
	pcaddu18i	$ra, %call36(exit)
	jirl	$ra, $ra, 0
.LBB0_35:                               # %.preheader185._crit_edge.loopexit338
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	st.w	$a0, $sp, 152
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	st.w	$a0, $sp, 148
	...
	pcaddu18i	$ra, %call36(exit)
	jirl	$ra, $ra, 0
.LBB0_36:                               # %.preheader186._crit_edge.loopexit337
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	st.w	$a0, $sp, 152
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	st.w	$a0, $sp, 148
...
.LBB0_49:
	...
	pcaddu18i	$ra, %call36(exit)
	jirl	$ra, $ra, 0
.LBB0_50:                               # %.preheader184._crit_edge.loopexit339
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	st.w	$a0, $sp, 152
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	st.w	$a0, $sp, 148
...
.LBB6_25:                               # %.lr.ph.i77
	...
	addi.d	$a1, $a1, 8
	bnez	$a2, .LBB6_25
.LBB6_26:                               # %delete_arg.exit81
	ld.d	$a1, $s7, 0
	beqz	$a1, .LBB6_108
# %bb.27:                               # %delete_arg.exit81..loopexit149_crit_edge
	addi.w	$s7, $a0, -3
	ori	$a0, $zero, 3
	blt	$s3, $a0, .LBB6_52
.LBB6_28:                               # %.lr.ph170.preheader
...
.LBB6_43:                               # %.lr.ph.i84
	...
	addi.d	$a3, $a3, 8
	bnez	$a2, .LBB6_43
.LBB6_44:                               # %delete_arg.exit88
	addi.w	$s3, $a1, -2
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	st.w	$s3, $a1, 0
	bge	$a0, $s3, .LBB6_51
# %bb.45:                               # %.lr.ph.preheader.i89
...
.LBB6_47:                               # %vector.body312
	...
	addi.d	$a4, $a4, 32
	bnez	$a0, .LBB6_47
# %bb.48:                               # %middle.block318
	beq	$a2, $a3, .LBB6_51
.LBB6_49:                               # %.lr.ph.i91.preheader
	alsl.d	$a0, $a1, $fp, 3
	addi.d	$a0, $a0, 8
	sub.d	$a1, $s3, $a1
	.p2align	4, , 16
.LBB6_50:                               # %.lr.ph.i91
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB6_50
.LBB6_51:                               # %delete_arg.exit95
	ld.d	$a0, $s5, 0
	beqz	$a0, .LBB6_109
.LBB6_52:                               # %.loopexit147
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB6_107
# %bb.53:                               # %.lr.ph179.preheader
	move	$s4, $zero
	addi.d	$s5, $fp, 16
	addi.d	$a0, $fp, 8
	st.d	$a0, $sp, 8                     # 8-byte Folded Spill
...
# %bb.61:                               #   in Loop: Header=BB6_60 Depth=2
	...
	addi.d	$s0, $s0, 24
	bnez	$a0, .LBB6_60
.LBB6_62:                               # %._crit_edge273
                                        #   in Loop: Header=BB6_56 Depth=1
	addi.w	$a0, $s3, -1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	st.w	$a0, $a1, 0
	bge	$s7, $a0, .LBB6_54
# %bb.63:                               # %.lr.ph.i98.preheader
                                        #   in Loop: Header=BB6_56 Depth=1
	nor	$a1, $s4, $zero
	add.d	$a2, $a1, $a0
	move	$a1, $s7
...
.LBB6_65:                               # %vector.body328
	...
	addi.d	$a5, $a5, 32
	bnez	$a4, .LBB6_65
# %bb.66:                               # %middle.block334
                                        #   in Loop: Header=BB6_56 Depth=1
	beq	$a2, $a3, .LBB6_54
.LBB6_67:                               # %.lr.ph.i98.preheader394
                                        #   in Loop: Header=BB6_56 Depth=1
...
.LBB6_77:                               # %vector.body345
	...
	addi.d	$s2, $s2, 32
	bnez	$a2, .LBB6_77
# %bb.78:                               # %middle.block351
	beq	$a0, $a1, .LBB6_81
.LBB6_79:                               # %.lr.ph.i.i.preheader
	alsl.d	$a0, $s0, $fp, 3
	addi.d	$a0, $a0, 8
	sub.d	$a1, $s4, $s0
	.p2align	4, , 16
.LBB6_80:                               # %.lr.ph.i.i
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB6_80
.LBB6_81:                               # %check_arg.exit
	pcalau12i	$a0, %pc_hi20(input_type)
	ori	$a1, $zero, 7
	st.w	$a1, $a0, %pc_lo12(input_type)
	ori	$a0, $zero, 2
	blt	$s4, $a0, .LBB6_107
.LBB6_82:                               # %.lr.ph.preheader.i110
	addi.w	$s3, $s4, -1
	addi.d	$s5, $s3, -1
	addi.d	$s2, $fp, 32
	ori	$s6, $zero, 1
...
.LBB6_89:                               # %vector.body362
	...
	addi.d	$s2, $s2, 32
	bnez	$a2, .LBB6_89
# %bb.90:                               # %middle.block368
	beq	$a0, $a1, .LBB6_93
.LBB6_91:                               # %.lr.ph.i.i118.preheader
	alsl.d	$a0, $s0, $fp, 3
	addi.d	$a0, $a0, 8
	sub.d	$a1, $s3, $s0
	.p2align	4, , 16
.LBB6_92:                               # %.lr.ph.i.i118
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 0
	st.d	$a2, $a0, -8
	addi.d	$a1, $a1, -1
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB6_92
.LBB6_93:                               # %check_arg.exit122
	pcalau12i	$a0, %pc_hi20(input_type)
	ori	$a1, $zero, 5
	st.w	$a1, $a0, %pc_lo12(input_type)
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB6_107
.LBB6_94:                               # %.lr.ph.preheader.i124
	addi.w	$a0, $s3, -1
	addi.d	$a3, $a0, -1
	addi.d	$a2, $fp, 32
	ori	$a4, $zero, 1
	...
	b	.LBB6_96
	.p2align	4, , 16
.LBB6_95:                               # %.lr.ph.i126.tail.thread
...
.LBB6_102:                              # %vector.body379
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB6_102
# %bb.103:                              # %middle.block385
	beq	$a4, $a5, .LBB6_106
.LBB6_104:                              # %.lr.ph.i.i132.preheader
	alsl.d	$a2, $a1, $fp, 3
	addi.d	$a2, $a2, 8
	sub.d	$a0, $a0, $a1
.LBB6_105:                              # %.lr.ph.i.i132
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $a2, 0
	st.d	$a1, $a2, -8
	addi.d	$a0, $a0, -1
	addi.d	$a2, $a2, 8
	bnez	$a0, .LBB6_105
.LBB6_106:                              # %check_arg.exit136
	pcalau12i	$a0, %pc_hi20(input_type)
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(input_type)
.LBB6_107:                              # %check_arg.exit136.thread
	move	$a0, $zero
	ld.d	$s8, $sp, 24                    # 8-byte Folded Reload
	...
	addi.d	$sp, $sp, 112
	ret
.LBB6_108:                              # %delete_arg.exit81.thread
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	ld.d	$a2, $s5, -16
	...
	pcaddu18i	$ra, %call36(exit)
	jirl	$ra, $ra, 0
.LBB6_109:                              # %delete_arg.exit95.thread
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	ld.d	$a2, $s2, 0
