...
# %bb.7:                                # %.lr.ph75
	...
	alsl.d	$s6, $a0, $s4, 2
	blez	$s7, .LBB1_20
# %bb.8:                                # %.lr.ph75.split.us.preheader
	ori	$s8, $zero, 1
	addi.d	$t4, $zero, -1
	pcalau12i	$a0, %got_pc_hi20(cdata)
...
.LBB3_58:                               #   in Loop: Header=BB3_52 Depth=1
	move	$t0, $t3
.LBB3_59:                               # %scalar.ph149.preheader
                                        #   in Loop: Header=BB3_52 Depth=1
	addi.d	$t1, $t0, 1
	alsl.d	$t2, $t0, $a3, 2
	alsl.d	$t0, $t0, $a1, 2
	.p2align	4, , 16
.LBB3_60:                               # %scalar.ph149
                                        #   Parent Loop BB3_52 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t3, $t0, 0
	st.w	$t3, $t2, 0
...
.LBB4_37:                               #   in Loop: Header=BB4_7 Depth=1
	...
	b	.LBB4_6
.LBB4_38:                               # %._crit_edge120.loopexit
	ld.d	$s1, $sp, 104
.LBB4_39:                               # %._crit_edge120
	ld.w	$s0, $s3, 4
	ori	$a1, $zero, 33
	ori	$a0, $zero, 8
	blt	$s0, $a1, .LBB4_41
...
.LBB4_52:
	...
	jr	$t8
.LBB4_53:                               # %._crit_edge124
	beqz	$a0, .LBB4_55
.LBB4_54:                               # %._crit_edge124.thread
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB4_55:
	pcalau12i	$a0, %got_pc_hi20(debug)
