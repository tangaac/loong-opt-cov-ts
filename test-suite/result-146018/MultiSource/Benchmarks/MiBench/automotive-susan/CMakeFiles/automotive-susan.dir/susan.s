...
.LBB10_34:                              # %vector.ph
                                        #   in Loop: Header=BB10_32 Depth=3
	pcalau12i	$t5, %pc_hi20(.LCPI10_1)
	vld	$vr1, $t5, %pc_lo12(.LCPI10_1)
	add.d	$ra, $a1, $s2
	add.d	$t5, $a5, $s2
...
.LBB11_12:                              # %vector.ph
	...
	b	.LBB11_14
	.p2align	4, , 16
.LBB11_13:                              # %pred.store.continue74
...
.LBB11_16:                              # %pred.store.continue
	...
	andi	$t1, $t1, 1
	beqz	$t1, .LBB11_18
# %bb.17:                               # %pred.store.if45
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.d	$t1, $vr11, 1
	stx.b	$zero, $a0, $t1
.LBB11_18:                              # %pred.store.continue46
                                        #   in Loop: Header=BB11_14 Depth=1
	...
	bnez	$t1, .LBB11_32
# %bb.19:                               # %pred.store.continue48
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 3
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_33
.LBB11_20:                              # %pred.store.continue50
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 4
	andi	$t1, $t1, 1
	vadd.d	$vr11, $vr10, $vr7
	bnez	$t1, .LBB11_34
.LBB11_21:                              # %pred.store.continue52
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 5
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_35
.LBB11_22:                              # %pred.store.continue54
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 6
	andi	$t1, $t1, 1
	vadd.d	$vr11, $vr10, $vr6
	bnez	$t1, .LBB11_36
.LBB11_23:                              # %pred.store.continue56
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 7
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_37
.LBB11_24:                              # %pred.store.continue58
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 8
	andi	$t1, $t1, 1
	vadd.d	$vr11, $vr10, $vr5
	bnez	$t1, .LBB11_38
.LBB11_25:                              # %pred.store.continue60
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 9
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_39
.LBB11_26:                              # %pred.store.continue62
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 10
	andi	$t1, $t1, 1
	vadd.d	$vr11, $vr10, $vr4
	bnez	$t1, .LBB11_40
.LBB11_27:                              # %pred.store.continue64
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 11
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_41
.LBB11_28:                              # %pred.store.continue66
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 12
	andi	$t1, $t1, 1
	vadd.d	$vr11, $vr10, $vr3
	bnez	$t1, .LBB11_42
.LBB11_29:                              # %pred.store.continue68
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 13
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_43
.LBB11_30:                              # %pred.store.continue70
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr9, 14
	andi	$t1, $t1, 1
	vadd.d	$vr10, $vr10, $vr2
	bnez	$t1, .LBB11_44
.LBB11_31:                              # %pred.store.continue72
                                        #   in Loop: Header=BB11_14 Depth=1
...
.LBB11_48:                              # %vec.epilog.ph
	...
	b	.LBB11_50
	.p2align	4, , 16
.LBB11_49:                              # %pred.store.continue91
...
.LBB11_50:                              # %vec.epilog.vector.body
	...
	vsub.d	$vr5, $vr5, $vr0
	beqz	$a7, .LBB11_52
# %bb.51:                               # %pred.store.if84
                                        #   in Loop: Header=BB11_50 Depth=1
	vpickve2gr.d	$a7, $vr5, 0
	stx.b	$zero, $a0, $a7
.LBB11_52:                              # %pred.store.continue85
                                        #   in Loop: Header=BB11_50 Depth=1
	vilvl.b	$vr4, $vr4, $vr4
	vilvl.h	$vr4, $vr4, $vr4
	...
	andi	$a7, $a7, 1
	beqz	$a7, .LBB11_54
# %bb.53:                               # %pred.store.if86
                                        #   in Loop: Header=BB11_50 Depth=1
	vpickve2gr.d	$a7, $vr5, 1
	stx.b	$zero, $a0, $a7
.LBB11_54:                              # %pred.store.continue87
                                        #   in Loop: Header=BB11_50 Depth=1
	vsub.d	$vr3, $vr3, $vr0
...
.LBB18_91:                              # %vector.ph254
	...
	b	.LBB18_93
	.p2align	4, , 16
.LBB18_92:                              # %pred.store.continue291
                                        #   in Loop: Header=BB18_93 Depth=1
	addi.d	$a4, $a4, -16
	addi.d	$a5, $a5, 16
	beqz	$a4, .LBB18_125
.LBB18_93:                              # %vector.body259
                                        # =>This Inner Loop Header: Depth=1
...
.LBB18_95:                              # %pred.store.continue
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_97
# %bb.96:                               # %pred.store.if262
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 1
	stx.b	$zero, $s2, $a6
.LBB18_97:                              # %pred.store.continue263
                                        #   in Loop: Header=BB18_93 Depth=1
	vsub.d	$vr10, $vr10, $vr0
...
# %bb.98:                               # %pred.store.if264
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_112
.LBB18_99:                              # %pred.store.continue267
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 4
	andi	$a6, $a6, 1
	vadd.d	$vr11, $vr10, $vr7
	beqz	$a6, .LBB18_113
.LBB18_100:                             # %pred.store.if268
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 0
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_114
.LBB18_101:                             # %pred.store.continue271
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 6
	andi	$a6, $a6, 1
	vadd.d	$vr11, $vr10, $vr6
	beqz	$a6, .LBB18_115
.LBB18_102:                             # %pred.store.if272
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 0
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_116
.LBB18_103:                             # %pred.store.continue275
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 8
	andi	$a6, $a6, 1
	vadd.d	$vr11, $vr10, $vr5
	beqz	$a6, .LBB18_117
.LBB18_104:                             # %pred.store.if276
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 0
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_118
.LBB18_105:                             # %pred.store.continue279
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 10
	andi	$a6, $a6, 1
	vadd.d	$vr11, $vr10, $vr4
	beqz	$a6, .LBB18_119
.LBB18_106:                             # %pred.store.if280
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 0
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_120
.LBB18_107:                             # %pred.store.continue283
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 12
	andi	$a6, $a6, 1
	vadd.d	$vr11, $vr10, $vr3
	beqz	$a6, .LBB18_121
.LBB18_108:                             # %pred.store.if284
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 0
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_122
.LBB18_109:                             # %pred.store.continue287
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 14
	andi	$a6, $a6, 1
	vadd.d	$vr10, $vr10, $vr2
	beqz	$a6, .LBB18_123
.LBB18_110:                             # %pred.store.if288
                                        #   in Loop: Header=BB18_93 Depth=1
	...
	b	.LBB18_124
	.p2align	4, , 16
.LBB18_111:                             # %pred.store.continue265
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_99
.LBB18_112:                             # %pred.store.if266
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr9, 4
	...
	vadd.d	$vr11, $vr10, $vr7
	bnez	$a6, .LBB18_100
.LBB18_113:                             # %pred.store.continue269
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_101
.LBB18_114:                             # %pred.store.if270
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr9, 6
	...
	vadd.d	$vr11, $vr10, $vr6
	bnez	$a6, .LBB18_102
.LBB18_115:                             # %pred.store.continue273
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 7
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_103
.LBB18_116:                             # %pred.store.if274
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr9, 8
	...
	vadd.d	$vr11, $vr10, $vr5
	bnez	$a6, .LBB18_104
.LBB18_117:                             # %pred.store.continue277
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 9
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_105
.LBB18_118:                             # %pred.store.if278
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr9, 10
	...
	vadd.d	$vr11, $vr10, $vr4
	bnez	$a6, .LBB18_106
.LBB18_119:                             # %pred.store.continue281
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 11
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_107
.LBB18_120:                             # %pred.store.if282
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr9, 12
	...
	vadd.d	$vr11, $vr10, $vr3
	bnez	$a6, .LBB18_108
.LBB18_121:                             # %pred.store.continue285
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 13
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_109
.LBB18_122:                             # %pred.store.if286
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr9, 14
	...
	vadd.d	$vr10, $vr10, $vr2
	bnez	$a6, .LBB18_110
.LBB18_123:                             # %pred.store.continue289
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.b	$a6, $vr9, 15
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_92
.LBB18_124:                             # %pred.store.if290
                                        #   in Loop: Header=BB18_93 Depth=1
	vpickve2gr.d	$a6, $vr10, 1
	stx.b	$zero, $s2, $a6
	b	.LBB18_92
.LBB18_125:                             # %middle.block293
	beq	$a3, $s3, .LBB18_138
...
.LBB18_127:                             # %vec.epilog.ph
	...
	b	.LBB18_129
	.p2align	4, , 16
.LBB18_128:                             # %pred.store.continue312
...
.LBB18_129:                             # %vec.epilog.vector.body
	...
	vsub.d	$vr5, $vr5, $vr0
	beqz	$a4, .LBB18_131
# %bb.130:                              # %pred.store.if305
                                        #   in Loop: Header=BB18_129 Depth=1
	vpickve2gr.d	$a4, $vr5, 0
	stx.b	$zero, $s2, $a4
.LBB18_131:                             # %pred.store.continue306
                                        #   in Loop: Header=BB18_129 Depth=1
	vilvl.b	$vr4, $vr4, $vr4
	vilvl.h	$vr4, $vr4, $vr4
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_133
# %bb.132:                              # %pred.store.if307
                                        #   in Loop: Header=BB18_129 Depth=1
	vpickve2gr.d	$a4, $vr5, 1
	stx.b	$zero, $s2, $a4
.LBB18_133:                             # %pred.store.continue308
                                        #   in Loop: Header=BB18_129 Depth=1
	vsub.d	$vr3, $vr3, $vr0
...
# %bb.134:                              # %pred.store.if309
	...
	b	.LBB18_136
	.p2align	4, , 16
.LBB18_135:                             # %pred.store.continue310
                                        #   in Loop: Header=BB18_129 Depth=1
	vpickve2gr.w	$a4, $vr4, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_128
.LBB18_136:                             # %pred.store.if311
                                        #   in Loop: Header=BB18_129 Depth=1
