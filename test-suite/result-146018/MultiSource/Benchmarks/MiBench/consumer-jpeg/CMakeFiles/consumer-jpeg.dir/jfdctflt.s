...
# %bb.0:                                # %vector.ph
	...
	xvfmadd.s	$xr8, $xr11, $xr4, $xr12
	xvfmul.s	$xr11, $xr9, $xr1
	xvfadd.s	$xr9, $xr0, $xr11
	...
	xvshuf.w	$xr10, $xr0, $xr7
	xvpermi.d	$xr0, $xr10, 68
	xvpermi.d	$xr6, $xr6, 68
	xvshuf.d	$xr12, $xr6, $xr0
	...
	xvinsgr2vr.w	$xr0, $a1, 7
	xvst	$xr0, $a0, 0
	xvstelm.w	$xr6, $a0, 60, 1
	xvstelm.w	$xr6, $a0, 92, 2
	xvstelm.w	$xr6, $a0, 124, 3
	xvstelm.w	$xr6, $a0, 156, 4
	xvstelm.w	$xr6, $a0, 220, 6
	xvstelm.w	$xr6, $a0, 252, 7
	xvld	$xr5, $a0, 224
	xvld	$xr7, $a0, 32
	xvld	$xr8, $a0, 192
	xvstelm.w	$xr6, $a0, 188, 5
	xvfadd.s	$xr6, $xr0, $xr5
