...
.LBB1_39:                               #   in Loop: Header=BB1_18 Depth=2
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_60
# %bb.40:                               #   in Loop: Header=BB1_18 Depth=2
...
.LBB1_42:                               #   in Loop: Header=BB1_43 Depth=3
	addi.d	$a1, $a1, 1
	move	$a2, $a3
.LBB1_43:                               #   Parent Loop BB1_15 Depth=1
                                        #     Parent Loop BB1_18 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a4, $a1, 0
	ori	$a3, $zero, 57
...
.LBB1_46:                               #   in Loop: Header=BB1_18 Depth=2
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_60
# %bb.47:                               #   in Loop: Header=BB1_18 Depth=2
...
# %bb.52:                               #   in Loop: Header=BB1_18 Depth=2
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB1_53:                               #   in Loop: Header=BB1_18 Depth=2
	ld.bu	$a0, $sp, 1668
...
.LBB1_58:                               # %AddClassToTrie.exit
	...
	ori	$s1, $zero, 1
	b	.LBB1_69
.LBB1_59:                               #   in Loop: Header=BB1_18 Depth=2
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
...
.LBB1_66:                               #   in Loop: Header=BB1_18 Depth=2
	...
	bnez	$a0, .LBB1_69
	b	.LBB1_75
.LBB1_67:                               #   in Loop: Header=BB1_18 Depth=2
	ori	$s1, $zero, 1
	b	.LBB1_69
.LBB1_68:                               #   in Loop: Header=BB1_18 Depth=2
	ori	$s1, $zero, 2
	.p2align	4, , 16
.LBB1_69:                               #   in Loop: Header=BB1_18 Depth=2
	...
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB1_14
# %bb.70:                               #   in Loop: Header=BB1_18 Depth=2
	ld.bu	$a0, $sp, 1668
	ori	$a1, $zero, 37
	bne	$a0, $a1, .LBB1_18
	b	.LBB1_14
...
.LBB2_53:                               #   in Loop: Header=BB2_37 Depth=2
	...
	addi.d	$s0, $a1, 2
	.p2align	4, , 16
.LBB2_54:                               #   Parent Loop BB2_8 Depth=1
                                        #     Parent Loop BB2_37 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.bu	$a2, $a1, $a0
	beqz	$a2, .LBB2_56
# %bb.55:                               #   in Loop: Header=BB2_54 Depth=3
	...
	beq	$a3, $a2, .LBB2_54
	b	.LBB2_36
.LBB2_56:                               # %.preheader339
                                        #   in Loop: Header=BB2_37 Depth=2
	add.d	$a0, $a1, $a0
	ld.bu	$fp, $a0, 1
	beqz	$fp, .LBB2_61
# %bb.57:                               # %.lr.ph383.preheader
                                        #   in Loop: Header=BB2_37 Depth=2
	addi.d	$s5, $sp, 128
	b	.LBB2_59
	.p2align	4, , 16
.LBB2_58:                               # %._crit_edge377
...
.LBB2_61:                               #   in Loop: Header=BB2_37 Depth=2
	addi.d	$a0, $sp, 128
.LBB2_62:                               # %._crit_edge384
                                        #   in Loop: Header=BB2_37 Depth=2
	st.b	$zero, $a0, 0
	ld.bu	$a0, $sp, 128
	beqz	$a0, .LBB2_36
# %bb.63:                               # %.lr.ph390.preheader
                                        #   in Loop: Header=BB2_37 Depth=2
	addi.d	$a1, $sp, 129
	b	.LBB2_65
	.p2align	4, , 16
...
.LBB2_74:                               # %.lr.ph393
	...
	move	$a0, $s5
	.p2align	4, , 16
.LBB2_75:                               #   Parent Loop BB2_8 Depth=1
                                        #     Parent Loop BB2_71 Depth=2
...
.LBB2_84:                               #   in Loop: Header=BB2_81 Depth=2
	...
	st.w	$a2, $fp, 0
	beqz	$a0, .LBB2_86
# %bb.85:                               #   in Loop: Header=BB2_81 Depth=2
	pcalau12i	$a1, %got_pc_hi20(zz_hold)
	ld.d	$a1, $a1, %got_pc_lo12(zz_hold)
	st.d	$a0, $a1, 0
	ld.d	$a1, $a0, 0
...
.LBB2_86:                               #   in Loop: Header=BB2_81 Depth=2
	...
	jirl	$ra, $ra, 0
.LBB2_87:                               #   in Loop: Header=BB2_81 Depth=2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a1, $s5, 0
	beqz	$a1, .LBB2_89
# %bb.88:                               #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a2, $a1, 0
...
.LBB2_90:                               #   in Loop: Header=BB2_81 Depth=2
	...
	st.d	$a1, $a0, 16
	st.d	$a0, $a1, 24
.LBB2_91:                               #   in Loop: Header=BB2_81 Depth=2
	ld.bu	$a0, $s3, 1
	slli.d	$a1, $a0, 3
	ldx.d	$s4, $s1, $a1
	st.w	$a0, $fp, 0
	beqz	$s4, .LBB2_93
# %bb.92:                               #   in Loop: Header=BB2_81 Depth=2
	st.d	$s4, $s5, 0
	ld.d	$a1, $s4, 0
	alsl.d	$a0, $a0, $s1, 3
	st.d	$a1, $a0, 0
...
.LBB2_93:                               #   in Loop: Header=BB2_81 Depth=2
	...
	move	$s4, $a0
	st.d	$a0, $s5, 0
.LBB2_94:                               #   in Loop: Header=BB2_81 Depth=2
	ori	$a0, $zero, 1
	st.b	$a0, $s4, 32
	st.d	$s4, $s4, 24
	st.d	$s4, $s4, 16
	...
	st.w	$a2, $fp, 0
	beqz	$a0, .LBB2_96
# %bb.95:                               #   in Loop: Header=BB2_81 Depth=2
	st.d	$a0, $s5, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $s1, 3
	st.d	$a1, $a2, 0
...
.LBB2_97:                               #   in Loop: Header=BB2_81 Depth=2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a1, $s5, 0
	beqz	$a1, .LBB2_100
# %bb.98:                               #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a2, $a1, 0
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a2, $a3, 0
...
.LBB2_101:                              #   in Loop: Header=BB2_81 Depth=2
	...
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
.LBB2_102:                              #   in Loop: Header=BB2_81 Depth=2
	ld.bu	$a2, $s3, 0
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $s1, $a0
	st.w	$a2, $fp, 0
	beqz	$a0, .LBB2_104
# %bb.103:                              #   in Loop: Header=BB2_81 Depth=2
	st.d	$a0, $s5, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $s1, 3
	st.d	$a1, $a2, 0
...
.LBB2_104:                              #   in Loop: Header=BB2_81 Depth=2
	...
	jirl	$ra, $ra, 0
	move	$a4, $fp
.LBB2_105:                              #   in Loop: Header=BB2_81 Depth=2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
...
# %bb.106:                              #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a1, $s7, 0
	beqz	$a1, .LBB2_108
# %bb.107:                              #   in Loop: Header=BB2_81 Depth=2
	ld.d	$a2, $a0, 16
	ld.d	$a3, $a1, 16
	st.d	$a2, $fp, 0
	st.d	$a3, $a0, 16
...
.LBB2_108:                              # %.thread463
	...
	blt	$a3, $s6, .LBB2_81
	b	.LBB2_110
.LBB2_109:                              # %._crit_edge409
                                        #   in Loop: Header=BB2_8 Depth=1
	andi	$a0, $a0, 1
	bnez	$a0, .LBB2_7
.LBB2_110:                              # %._crit_edge409.thread
                                        #   in Loop: Header=BB2_8 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(FontWordSize)
	jirl	$ra, $ra, 0
