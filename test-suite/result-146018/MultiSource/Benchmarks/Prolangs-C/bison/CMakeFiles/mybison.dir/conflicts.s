...
# %bb.2:                                # %.lr.ph
	...
	ld.d	$t1, $a3, %pc_lo12(lookaheadset)
	move	$t2, $zero
	.p2align	4, , 16
...
# %bb.13:                               # %.lr.ph63.us.preheader
	pcalau12i	$t0, %got_pc_hi20(LA)
	ld.d	$t1, $t0, %got_pc_lo12(LA)
	addi.d	$t0, $a0, 4
	sltu	$t2, $t0, $a3
	maskeqz	$t3, $a3, $t2
	masknez	$t0, $t0, $t2
...
# %bb.5:                                # %.lr.ph216
	...
	ld.d	$a1, $a1, %got_pc_lo12(accessing_symbol)
	ld.d	$a5, $a1, 0
	ld.d	$a6, $t7, %pc_lo12(shiftset)
	pcalau12i	$a1, %got_pc_hi20(ntokens)
	ld.d	$a7, $a1, %got_pc_lo12(ntokens)
	pcalau12i	$a1, %got_pc_hi20(error_token_number)
	ld.d	$t0, $a1, %got_pc_lo12(error_token_number)
	move	$t2, $zero
	addi.d	$t1, $a2, 12
	b	.LBB10_7
	.p2align	4, , 16
...
.LBB10_33:                              # %.lr.ph253
	...
	ld.d	$a4, $a1, %pc_lo12(lookaheadset)
	pcalau12i	$a1, %got_pc_hi20(LA)
	ld.d	$a1, $a1, %got_pc_lo12(LA)
	move	$a5, $zero
	move	$t1, $zero
...
.LBB10_43:                              #   in Loop: Header=BB10_35 Depth=1
	...
	move	$t5, $a3
	move	$t1, $fp
.LBB10_44:                              #   in Loop: Header=BB10_35 Depth=1
	blt	$a0, $s8, .LBB10_34
# %bb.45:                               # %.lr.ph247.preheader
	...
	move	$s0, $t0
	bnez	$s1, .LBB10_49
# %bb.46:                               # %vector.body345.preheader
                                        #   in Loop: Header=BB10_35 Depth=1
	move	$fp, $t6
	move	$s0, $s7
	move	$s1, $a1
	.p2align	4, , 16
.LBB10_47:                              # %vector.body345
                                        #   Parent Loop BB10_35 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $s0, -16
	vld	$vr2, $s0, 0
...
.LBB10_49:                              # %.lr.ph247
	...
	b	.LBB10_34
	.p2align	4, , 16
.LBB10_50:                              #   in Loop: Header=BB10_35 Depth=1
	move	$fp, $zero
	blt	$t1, $fp, .LBB10_43
	b	.LBB10_44
	.p2align	4, , 16
.LBB10_51:                              # %vector.memcheck360
                                        #   in Loop: Header=BB10_35 Depth=1
...
.LBB10_54:                              # %vector.body369
	...
	addi.d	$s0, $s0, 32
	bnez	$s1, .LBB10_54
# %bb.55:                               # %middle.block382
                                        #   in Loop: Header=BB10_35 Depth=1
	move	$s0, $t8
	move	$s1, $s4
	bne	$t4, $t6, .LBB10_38
	b	.LBB10_39
.LBB10_56:                              # %vector.memcheck
	alsl.d	$a5, $a3, $t0, 2
	sub.d	$a7, $s2, $a5
	ori	$a5, $zero, 32
	bltu	$a7, $a5, .LBB10_24
...
# %bb.66:                               # %.lr.ph262
	...
	b	.LBB10_69
	.p2align	4, , 16
.LBB10_67:                              #   in Loop: Header=BB10_69 Depth=1
	srai.d	$a0, $a6, 5
	slli.d	$a0, $a0, 2
...
# %bb.70:                               #   in Loop: Header=BB10_69 Depth=1
	...
	blt	$a6, $a0, .LBB10_67
	b	.LBB10_73
.LBB10_71:                              # %._crit_edge259..loopexit_crit_edge
	ld.d	$a0, $t7, %pc_lo12(shiftset)
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
.LBB10_72:                              # %.loopexitthread-pre-split
	pcalau12i	$a0, %got_pc_hi20(ntokens)
...
# %bb.74:                               # %.lr.ph275
	...
	b	.LBB10_77
	.p2align	4, , 16
.LBB10_75:                              # %._crit_edge270.loopexit
...
.LBB10_81:                              #   in Loop: Header=BB10_82 Depth=2
	...
	addi.d	$fp, $fp, -1
	beqz	$s1, .LBB10_75
.LBB10_82:                              #   Parent Loop BB10_77 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a1, $s7, 0
	and	$a1, $a1, $s8
	beqz	$a1, .LBB10_81
...
# %bb.85:                               #   in Loop: Header=BB10_82 Depth=2
	...
	b	.LBB10_79
	.p2align	4, , 16
.LBB10_86:                              #   in Loop: Header=BB10_82 Depth=2
	beqz	$fp, .LBB10_88
# %bb.87:                               #   in Loop: Header=BB10_82 Depth=2
	ld.d	$a0, $s2, 0
	pcalau12i	$a1, %pc_hi20(.L.str.13)
	addi.d	$a1, $a1, %pc_lo12(.L.str.13)
	b	.LBB10_80
.LBB10_88:                              #   in Loop: Header=BB10_82 Depth=2
	ori	$a0, $zero, 1
	ori	$s3, $zero, 1
	b	.LBB10_81
.LBB10_89:                              # %._crit_edge276
