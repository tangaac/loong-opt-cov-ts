...
# %bb.1:                                # %.lr.ph
	move	$a1, $zero
	ld.d	$a2, $fp, %pc_lo12(F)
	pcalau12i	$a3, %pc_hi20(LA)
	ld.d	$a4, $a3, %pc_lo12(LA)
	ld.d	$a3, $s1, %pc_lo12(lookback)
	addi.d	$a5, $a2, 4
	addi.d	$a6, $a2, 16
...
.LBB11_3:                               # =>This Loop Header: Depth=1
	...
	ld.w	$t4, $a7, %pc_lo12(tokensetsize)
	slli.d	$t2, $a1, 3
	ldx.d	$t2, $a3, $t2
	move	$t3, $a4
	alsl.d	$a4, $t4, $a4, 2
...
.LBB11_7:                               # %.lr.ph.us
                                        ...
                                        #       Child Loop BB11_13 Depth 3
                                        #       Child Loop BB11_15 Depth 3
	ld.w	$s5, $a7, %pc_lo12(tokensetsize)
	ld.h	$s6, $t2, 8
	mul.w	$s6, $s5, $s6
	alsl.d	$s5, $s6, $a2, 2
	bgeu	$t4, $t1, .LBB11_9
...
# %bb.0:
	...
	ld.d	$s4, $a2, %pc_lo12(F)
	pcalau12i	$a2, %pc_hi20(R)
	ld.d	$a3, $a2, %pc_lo12(R)
	pcalau12i	$s5, %pc_hi20(tokensetsize)
	ld.w	$a5, $s5, %pc_lo12(tokensetsize)
	slli.d	$a2, $a0, 3
	ldx.d	$a2, $a3, $a2
	stx.h	$a6, $s2, $a1
	mul.w	$a4, $a5, $a0
...
.LBB16_7:                               #   in Loop: Header=BB16_5 Depth=1
	st.h	$a1, $s6, 0
	move	$a0, $a1
	ld.w	$a1, $s5, %pc_lo12(tokensetsize)
	mul.w	$a2, $a1, $s0
	alsl.d	$a1, $a2, $s4, 2
	bltu	$s1, $a6, .LBB16_13
...
.LBB16_24:                              # %.lr.ph.us45
	...
	ld.w	$t3, $s5, %pc_lo12(tokensetsize)
	mul.w	$t3, $t3, $t2
	alsl.d	$t2, $t3, $s4, 2
	bgeu	$a2, $t1, .LBB16_26
