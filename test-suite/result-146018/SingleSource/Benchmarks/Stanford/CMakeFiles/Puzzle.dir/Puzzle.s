...
.Lfunc_end2:
	...
	.p2align	4, 0x0                          # -- Begin function Place
.LCPI3_0:
	.dword	2                               # 0x2
	.dword	3                               # 0x3
.LCPI3_1:
...
.LBB3_3:                                # %vector.ph
	...
	vld	$vr2, $t0, %pc_lo12(.LCPI3_0)
	pcalau12i	$t0, %pc_hi20(.LCPI3_1)
	vld	$vr3, $t0, %pc_lo12(.LCPI3_1)
	addi.d	$a7, $a7, 16
	vrepli.b	$vr4, -1
	ori	$t0, $zero, 1
	move	$t1, $a6
...
.Lfunc_end3:
	.size	Place, .Lfunc_end3-Place
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function Remove
.LCPI4_0:
	.dword	2                               # 0x2
	.dword	3                               # 0x3
.LCPI4_1:
...
.Lfunc_end4:
	.size	Remove, .Lfunc_end4-Remove
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function Trial
.LCPI5_0:
	.dword	2                               # 0x2
	.dword	3                               # 0x3
.LCPI5_1:
...
# %bb.47:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_56
.LBB5_48:                               # %pred.store.continue39
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 2
	andi	$a4, $a4, 1
	vadd.d	$vr3, $vr0, $vr4
	bnez	$a4, .LBB5_57
.LBB5_49:                               # %pred.store.continue41
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_51
.LBB5_50:                               # %pred.store.if42
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.d	$a4, $vr3, 1
	slli.d	$a4, $a4, 2
	stx.w	$zero, $s2, $a4
.LBB5_51:                               # %pred.store.continue43
                                        #   in Loop: Header=BB5_46 Depth=2
	add.d	$a4, $s5, $a2
	vld	$vr2, $a4, 16
	vseqi.w	$vr2, $vr2, 0
	...
	vadd.d	$vr3, $vr1, $vr5
	bnez	$a4, .LBB5_58
# %bb.52:                               # %pred.store.continue45
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 1
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_59
.LBB5_53:                               # %pred.store.continue47
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 2
	andi	$a4, $a4, 1
	vadd.d	$vr3, $vr0, $vr5
	bnez	$a4, .LBB5_60
.LBB5_54:                               # %pred.store.continue49
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_45
...
# %bb.26:
	...
	b	.LBB6_57
.LBB6_27:                               # %.lr.ph.i200.preheader
	beqz	$a1, .LBB6_29
# %bb.28:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 292
.LBB6_29:                               # %.lr.ph.i200.1
	beqz	$a2, .LBB6_31
# %bb.30:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 296
.LBB6_31:                               # %.lr.ph.i200.2
	beqz	$a3, .LBB6_33
# %bb.32:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 300
.LBB6_33:                               # %.lr.ph.i200.3
	beqz	$a4, .LBB6_35
# %bb.34:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 304
.LBB6_35:                               # %.lr.ph.i200.4
	beqz	$a5, .LBB6_37
# %bb.36:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 308
.LBB6_37:                               # %.lr.ph.i200.5
	beqz	$a6, .LBB6_39
# %bb.38:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 312
.LBB6_39:                               # %.lr.ph.i200.6
	beqz	$a7, .LBB6_41
# %bb.40:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 316
.LBB6_41:                               # %.lr.ph.i200.7
	beqz	$t0, .LBB6_43
# %bb.42:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 320
.LBB6_43:                               # %.lr.ph.i200.8
	beqz	$t1, .LBB6_45
# %bb.44:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 324
.LBB6_45:                               # %.lr.ph.i200.9
	beqz	$t2, .LBB6_47
# %bb.46:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 328
.LBB6_47:                               # %.lr.ph.i200.10
	beqz	$t3, .LBB6_49
# %bb.48:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 332
.LBB6_49:                               # %.lr.ph.i200.11
	beqz	$t4, .LBB6_51
# %bb.50:
	ori	$a1, $zero, 1
	st.w	$a1, $fp, 336
.LBB6_51:                               # %._crit_edge.i
	ori	$a1, $zero, 12
