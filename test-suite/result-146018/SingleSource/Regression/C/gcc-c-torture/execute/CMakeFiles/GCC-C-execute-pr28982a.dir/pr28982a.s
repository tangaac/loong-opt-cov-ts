...
# %bb.0:                                # %.preheader.preheader
	...
	vld	$vr0, $a1, %pc_lo12(.LCPI1_6)
	vst	$vr1, $a0, 0
	pcalau12i	$a1, %pc_hi20(.LCPI1_7)
	vld	$vr1, $a1, %pc_lo12(.LCPI1_7)
	vst	$vr0, $a0, 16
	pcalau12i	$a1, %pc_hi20(.LCPI1_8)
	vld	$vr0, $a1, %pc_lo12(.LCPI1_8)
	vst	$vr1, $a0, 32
	pcalau12i	$a1, %pc_hi20(.LCPI1_9)
	vld	$vr1, $a1, %pc_lo12(.LCPI1_9)
	vst	$vr0, $a0, 48
	pcalau12i	$a1, %pc_hi20(.LCPI1_10)
	vld	$vr0, $a1, %pc_lo12(.LCPI1_10)
	vst	$vr1, $a0, 64
	...
	addi.d	$a2, $a0, 12
	vst	$vr0, $a0, 128
	pcalau12i	$a3, %pc_hi20(.LCPI1_14)
	vld	$vr0, $a3, %pc_lo12(.LCPI1_14)
	st.d	$a2, $a1, 24
	addi.d	$a2, $a0, 16
	st.d	$a2, $a1, 32
	vst	$vr0, $a0, 144
