...
# %bb.22:
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
	bne	$s3, $a0, .LBB2_66
# %bb.23:                               # %vector.body250.preheader
	ori	$a0, $s5, 96
	ori	$a1, $zero, 4000
	ori	$a2, $zero, 4016
	.p2align	4, , 16
.LBB2_24:                               # %vector.body250
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	vstx	$vr0, $a3, $a1
	vstx	$vr0, $a3, $a2
...
# %bb.29:
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
	bne	$s3, $a0, .LBB2_71
# %bb.30:                               # %vector.body257.preheader
	ori	$a0, $s5, 96
	ori	$a1, $zero, 4000
	ori	$a2, $zero, 4016
	.p2align	4, , 16
.LBB2_31:                               # %vector.body257
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	vstx	$vr0, $a3, $a1
	vstx	$vr0, $a3, $a2
...
# %bb.36:
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
	bne	$s3, $a0, .LBB2_76
# %bb.37:                               # %vector.body264.preheader
	ori	$a0, $s5, 96
	ori	$a1, $zero, 4000
	ori	$a2, $zero, 4016
	.p2align	4, , 16
.LBB2_38:                               # %vector.body264
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	vstx	$vr0, $a3, $a1
	vstx	$vr0, $a3, $a2
...
# %bb.43:
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
	bne	$s3, $a0, .LBB2_81
# %bb.44:                               # %vector.body271.preheader
	ori	$a0, $s5, 96
	ori	$a1, $zero, 4000
	ori	$a2, $zero, 4016
	.p2align	4, , 16
.LBB2_45:                               # %vector.body271
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s0, $a0
	vstx	$vr0, $a3, $a1
	vstx	$vr0, $a3, $a2
...
.LBB48_8:                               # %.lr.ph.i.i.i
	...
	addi.d	$a1, $a1, 2
	bnez	$a3, .LBB48_8
.LBB48_9:                               # %._crit_edge.loopexit.i.i.i
	addi.d	$sp, $sp, 16
	bstrpick.d	$a0, $a0, 15, 0
	ret
.Lfunc_end48:
