...
# %bb.288:                              # %.lr.ph3444
	...
	ori	$s2, $zero, 1280
	b	.LBB0_290
.LBB0_289:                              # %._crit_edge3611
                                        #   in Loop: Header=BB0_290 Depth=1
	addi.d	$s8, $s8, 1
	addi.d	$a0, $s7, -5
	bstrpick.d	$a0, $a0, 31, 0
	bgeu	$s8, $a0, .LBB0_323
.LBB0_290:                              # =>This Loop Header: Depth=1
...
# %bb.294:                              #   in Loop: Header=BB0_290 Depth=1
	addi.w	$a2, $s8, 9
	bgeu	$a1, $a2, .LBB0_308
# %bb.295:                              #   in Loop: Header=BB0_290 Depth=1
	add.w	$a0, $a1, $a0
	bltu	$a0, $a2, .LBB0_308
# %bb.296:                              #   in Loop: Header=BB0_290 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	andi	$a0, $a0, 127
	bnez	$a0, .LBB0_300
# %bb.297:                              #   in Loop: Header=BB0_290 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	beq	$a0, $s2, .LBB0_814
# %bb.298:                              #   in Loop: Header=BB0_290 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	addi.d	$a0, $a0, 128
	bstrpick.d	$a0, $a0, 31, 0
	slli.d	$a1, $a0, 2
	...
	st.d	$a0, $sp, 200                   # 8-byte Folded Spill
	beqz	$a0, .LBB0_815
# %bb.299:                              #   in Loop: Header=BB0_290 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_309
.LBB0_300:                              # %.lr.ph3438.preheader
                                        #   in Loop: Header=BB0_290 Depth=1
	move	$a0, $zero
	...
	b	.LBB0_303
.LBB0_301:                              #   in Loop: Header=BB0_303 Depth=2
	st.w	$s8, $a2, 0
	move	$s8, $a3
.LBB0_302:                              #   in Loop: Header=BB0_303 Depth=2
	addi.w	$a0, $a0, 1
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
	beqz	$a1, .LBB0_305
.LBB0_303:                              # %.lr.ph3438
                                        #   Parent Loop BB0_290 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a2, 0
	bltu	$a3, $s8, .LBB0_302
# %bb.304:                              #   in Loop: Header=BB0_303 Depth=2
	bne	$a3, $s8, .LBB0_301
	b	.LBB0_307
.LBB0_305:                              # %.loopexit3356.loopexit
                                        #   in Loop: Header=BB0_290 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	addi.w	$a1, $a0, 1
.LBB0_306:                              # %.loopexit3356
                                        #   in Loop: Header=BB0_290 Depth=1
	st.d	$a1, $sp, 216                   # 8-byte Folded Spill
.LBB0_307:                              # %.loopexit3356
                                        #   in Loop: Header=BB0_290 Depth=1
	bstrpick.d	$a0, $a0, 31, 0
	slli.d	$a0, $a0, 2
	ld.d	$a1, $sp, 200                   # 8-byte Folded Reload
	...
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.w	$s7, $a0, 12
.LBB0_308:                              #   in Loop: Header=BB0_290 Depth=1
	move	$s8, $s6
	addi.d	$a0, $s7, -5
	bstrpick.d	$a0, $a0, 31, 0
	bltu	$s8, $a0, .LBB0_290
	b	.LBB0_323
.LBB0_309:                              #   in Loop: Header=BB0_290 Depth=1
	move	$a0, $zero
	ori	$a1, $zero, 1
	b	.LBB0_306
.LBB0_310:
...
.LBB0_337:                              # %.critedge81
	...
	and	$a0, $a0, $a1
	beqz	$a0, .LBB0_361
# %bb.338:                              # %.preheader3355
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	move	$s8, $zero
	addi.d	$a0, $a0, -1
	beqz	$a0, .LBB0_361
# %bb.339:                              # %.lr.ph3451.preheader
	move	$s5, $zero
	bstrpick.d	$a1, $a0, 31, 0
	ori	$a2, $zero, 36
	mul.d	$a1, $a1, $a2
...
# %bb.477:
	...
	bne	$a0, $a2, .LBB0_755
# %bb.478:                              # %.preheader3353
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 168                   # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_665
# %bb.479:                              # %.lr.ph3455.preheader
...
# %bb.481:                              #   in Loop: Header=BB0_480 Depth=1
	...
	beqz	$a1, .LBB0_483
# %bb.482:                              #   in Loop: Header=BB0_480 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 192                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s4, 0
.LBB0_483:                              #   in Loop: Header=BB0_480 Depth=1
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	nor	$a1, $a1, $zero
	add.w	$a1, $s3, $a1
	bltu	$a1, $a0, .LBB0_843
# %bb.484:                              #   in Loop: Header=BB0_480 Depth=1
	ld.w	$a2, $s4, 4
	sub.w	$a1, $a1, $a0
	bgeu	$a1, $a2, .LBB0_843
# %bb.485:                              #   in Loop: Header=BB0_480 Depth=1
	addi.w	$s0, $s0, 4
...
# %bb.577:                              # %.lr.ph3471
	...
	sub.d	$s5, $s2, $a0
	b	.LBB0_579
.LBB0_578:                              #   in Loop: Header=BB0_579 Depth=1
	addi.d	$s6, $s6, 36
	beq	$s4, $s6, .LBB0_605
.LBB0_579:                              # =>This Inner Loop Header: Depth=1
	...
	ld.w	$a0, $s3, 8
	beqz	$a0, .LBB0_578
# %bb.580:                              #   in Loop: Header=BB0_579 Depth=1
	move	$a0, $s1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
...
# %bb.593:
	...
	bgeu	$a1, $a0, .LBB0_556
	b	.LBB0_562
.LBB0_594:                              # %vector.main.loop.iter.check3784
	ori	$a0, $zero, 16
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB0_615
# %bb.595:
...
# %bb.617:                              # %middle.block3793
	...
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_624
# %bb.618:                              # %vec.epilog.iter.check3800
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	andi	$a1, $a1, 12
	beqz	$a1, .LBB0_622
.LBB0_619:                              # %vec.epilog.ph3799
	move	$a2, $a0
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	andi	$a0, $a0, 124
	vreplgr2vr.w	$vr0, $s5
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_620:                              # %vec.epilog.vector.body3807
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_620
# %bb.621:                              # %vec.epilog.middle.block3811
...
# %bb.636:                              #   in Loop: Header=BB0_633 Depth=1
	...
	add.d	$a2, $a1, $a0
	bltu	$s4, $a2, .LBB0_639
# %bb.637:                              #   in Loop: Header=BB0_633 Depth=1
	bgeu	$s6, $a2, .LBB0_639
# %bb.638:                              #   in Loop: Header=BB0_633 Depth=1
	addi.w	$a2, $a0, 0
	move	$a0, $s1
	pcaddu18i	$ra, %call36(cli_readn)
	jirl	$ra, $ra, 0
...
# %bb.640:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_641:                              # %.critedge200.sink.split
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_642:                              # %.critedge200
	ld.d	$a0, $fp, 56
	ld.bu	$a0, $a0, 1
	andi	$a0, $a0, 16
	beqz	$a0, .LBB0_649
...
.LBB0_670:
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
.LBB0_671:                              # %.critedge3021
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_672:                              # %._crit_edge3491.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_677
...
# %bb.774:                              # %middle.block3767
	...
	beq	$a0, $s7, .LBB0_781
# %bb.775:                              # %vec.epilog.iter.check
	andi	$a1, $s7, 12
	beqz	$a1, .LBB0_779
.LBB0_776:                              # %vec.epilog.ph
	move	$a2, $a0
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 80
.LBB0_777:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_777
# %bb.778:                              # %vec.epilog.middle.block
	vshuf4i.w	$vr1, $vr0, 14
	vmin.wu	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmin.wu	$vr0, $vr0, $vr1
...
# %bb.785:
	...
	b	.LBB0_204
.LBB0_786:                              # %._crit_edge3478._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_787:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
# %bb.790:                              # %.lr.ph3481
	...
	sub.d	$s7, $a0, $a1
	b	.LBB0_792
.LBB0_791:                              #   in Loop: Header=BB0_792 Depth=1
	addi.d	$s8, $s8, 36
	beq	$s4, $s8, .LBB0_809
...
# %bb.806:                              #   in Loop: Header=BB0_805 Depth=1
	...
	bltu	$a5, $a4, .LBB0_889
# %bb.807:                              #   in Loop: Header=BB0_805 Depth=1
	ld.w	$a6, $s4, 4
	sub.w	$a4, $a5, $a4
	bgeu	$a4, $a6, .LBB0_889
# %bb.808:                              #   in Loop: Header=BB0_805 Depth=1
	addi.w	$s7, $s7, 2
	bltu	$s7, $a0, .LBB0_805
	b	.LBB0_890
.LBB0_809:                              # %._crit_edge3482
	ld.wu	$a0, $s5, 12
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
	jirl	$ra, $ra, 0
...
# %bb.853:                              # %middle.block
	beq	$a2, $a3, .LBB0_856
.LBB0_854:                              # %.lr.ph3459.preheader3825
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s3, $a3
...
.LBB0_869:
	move	$s5, $s6
.LBB0_870:                              # %.thread3319.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_649
