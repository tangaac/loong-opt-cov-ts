...
.LBB5_86:                               # %.tail12.thread
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.87:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.88:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.89:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.90:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.91:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.92:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.93:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.94:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.95:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.96:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.97:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.98:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.99:                               #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.100:                              #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.101:                              #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	move	$a1, $s0
	pcaddu18i	$ra, %call36(cli_strbcasestr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB5_103
# %bb.102:                              #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	...
	beqz	$a0, .LBB5_80
	.p2align	4, , 16
.LBB5_103:                              #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s7
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	move	$s2, $a0
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB5_108
# %bb.104:                              #   in Loop: Header=BB5_81 Depth=1
	move	$s2, $a0
	move	$a1, $s1
	move	$a2, $fp
	move	$a3, $s7
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB5_106
# %bb.105:                              #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s2
	...
	beqz	$a0, .LBB5_107
	b	.LBB5_112
.LBB5_106:                              #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s2
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 160                   # 8-byte Folded Reload
	...
	move	$s3, $a0
	bnez	$a0, .LBB5_112
.LBB5_107:                              #   in Loop: Header=BB5_81 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$s3, $zero
...
.LBB15_43:
	...
	jirl	$ra, $ra, 0
	ld.d	$s5, $s1, 8
.LBB15_44:                              # %.loopexit154.sink.split.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s1
