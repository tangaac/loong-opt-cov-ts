...
.LBB1_52:                               # %vector.body
	...
	ori	$s4, $a1, 2864
	add.d	$s0, $s0, $s4
	vstelm.h	$vr19, $s1, 0, 0
	vstelm.h	$vr19, $s2, 0, 2
	vstelm.h	$vr19, $s3, 0, 4
	vstelm.h	$vr19, $s0, 0, 6
...
.LBB4_86:
	...
	ldx.d	$t0, $t1, $t0
	pcalau12i	$t1, %got_pc_hi20(input)
	ld.d	$t1, $t1, %got_pc_lo12(input)
	sub.w	$s8, $a3, $a6
	ld.d	$a7, $a7, 0
	ld.d	$a6, $t0, 0
	ld.d	$s4, $t1, 0
...
# %bb.0:                                # %.preheader149
	...
	slli.d	$t6, $t6, 6
	addi.d	$t7, $t6, 32
	pcalau12i	$t6, %pc_hi20(dequant_coef)
	addi.d	$t6, $t6, %pc_lo12(dequant_coef)
	add.d	$t6, $t6, $t7
...
.LBB11_26:
	...
	addi.d	$t1, $a2, %pc_lo12(FIELD_SCAN)
...
# %bb.49:                               #   in Loop: Header=BB11_44 Depth=1
	...
	ori	$s6, $zero, 2
	b	.LBB11_43
.LBB11_50:                              # %.preheader330.preheader
	move	$a0, $zero
	slli.d	$a2, $a5, 2
	stx.w	$zero, $a1, $a2
...
.LBB11_51:                              # %.preheader330
	...
	ori	$t1, $zero, 1
	.p2align	4, , 16
.LBB11_52:                              # %.preheader329
                                        #   Parent Loop BB11_51 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.d	$a2, $a7, 6
	add.d	$a7, $fp, $a2
	alsl.d	$a2, $a0, $a7, 2
