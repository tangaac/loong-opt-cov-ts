...
.LBB0_360:                              # %list_Delete.exit.thread.i.i
	...
	ld.w	$a0, $s7, 136
	beqz	$a0, .LBB0_371
.LBB0_361:                              #   in Loop: Header=BB0_219 Depth=3
...
# %bb.391:                              #   in Loop: Header=BB0_219 Depth=3
	beqz	$a0, .LBB0_400
# %bb.392:                              # %.preheader.i349.i.preheader
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$a2, $fp
	.p2align	4, , 16
.LBB0_393:                              # %.preheader.i349.i
                                        #   Parent Loop BB0_208 Depth=1
                                        #     Parent Loop BB0_210 Depth=2
                                        #       Parent Loop BB0_219 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB0_394:                              #   in Loop: Header=BB0_219 Depth=3
	...
	jirl	$ra, $ra, 0
	beqz	$fp, .LBB0_399
# %bb.395:                              #   in Loop: Header=BB0_219 Depth=3
	beqz	$a0, .LBB0_400
# %bb.396:                              # %.preheader.i357.i.preheader
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$a2, $fp
	.p2align	4, , 16
.LBB0_397:                              # %.preheader.i357.i
                                        #   Parent Loop BB0_208 Depth=1
                                        #     Parent Loop BB0_210 Depth=2
                                        #       Parent Loop BB0_219 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.402:                              #   in Loop: Header=BB0_219 Depth=3
	...
	jirl	$ra, $ra, 0
	b	.LBB0_218
.LBB0_403:                              # %top_GetOptimalSplitLiteralIndex.exit.thread.i278.i
                                        #   in Loop: Header=BB0_219 Depth=3
	ld.d	$s7, $sp, 280                   # 8-byte Folded Reload
	move	$a0, $s7
	move	$a1, $s6
	...
	ld.d	$s5, $sp, 264                   # 8-byte Folded Reload
	bnez	$s0, .LBB0_384
.LBB0_404:                              #   in Loop: Header=BB0_219 Depth=3
	ld.w	$a1, $s4, 348
	beqz	$a1, .LBB0_407
# %bb.405:                              #   in Loop: Header=BB0_219 Depth=3
	ld.d	$a2, $s7, 32
	ld.d	$a3, $s7, 48
	move	$a0, $s6
	move	$a4, $s4
...
.LBB0_407:                              #   in Loop: Header=BB0_219 Depth=3
	...
	move	$s4, $a0
	beqz	$s3, .LBB0_413
# %bb.408:                              #   in Loop: Header=BB0_219 Depth=3
	ld.d	$s6, $sp, 216                   # 8-byte Folded Reload
	beqz	$s4, .LBB0_412
# %bb.409:                              # %.preheader.i.i.i.preheader
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$a1, $s3
	.p2align	4, , 16
.LBB0_410:                              # %.preheader.i.i.i
                                        #   Parent Loop BB0_208 Depth=1
                                        #     Parent Loop BB0_210 Depth=2
                                        #       Parent Loop BB0_219 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.411:                              #   in Loop: Header=BB0_219 Depth=3
	st.d	$s4, $a0, 0
.LBB0_412:                              # %list_Nconc.exit.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$s4, $s3
	b	.LBB0_379
.LBB0_413:                              #   in Loop: Header=BB0_219 Depth=3
	ld.d	$s6, $sp, 216                   # 8-byte Folded Reload
	b	.LBB0_379
...
.LBB0_491:                              # %list_Delete.exit481
	...
	bgeu	$a1, $a0, .LBB0_494
# %bb.492:                              # %scalar.ph718.preheader
	lu12i.w	$a0, -4
	ori	$a0, $a0, 384
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_493:                              # %scalar.ph718
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a3, $a0
	ldx.w	$a1, $a1, $s1
	add.d	$a2, $s2, $a0
	...
	bnez	$a0, .LBB0_493
	b	.LBB0_496
.LBB0_494:                              # %vector.body720.preheader
	lu12i.w	$a0, -4
	ori	$a0, $a0, 384
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_495:                              # %vector.body720
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a2, $a0
	xvldx	$xr0, $a1, $s1
	xvldx	$xr1, $a1, $s5
