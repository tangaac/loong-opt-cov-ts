...
# %bb.61:                               # %middle.block309
	...
	beq	$a3, $a4, .LBB13_83
# %bb.62:                               # %vec.epilog.iter.check314
	andi	$a5, $a3, 12
	beqz	$a5, .LBB13_80
.LBB13_63:                              # %vec.epilog.ph313
	move	$a6, $a3
	...
	sub.d	$a4, $a4, $a6
	.p2align	4, , 16
.LBB13_64:                              # %vec.epilog.vector.body319
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vsrai.w	$vr1, $vr1, 1
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB13_64
# %bb.65:                               # %vec.epilog.middle.block325
	vshuf4i.w	$vr1, $vr0, 14
	vor.v	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vor.v	$vr0, $vr0, $vr1
...
.LBB13_67:                              # %.loopexit.i.i.i159
	...
	st.d	$a0, $fp, 504
	ld.d	$ra, $sp, 32                    # 8-byte Folded Reload
.LBB13_68:                              # %_ZN3vecI3LitE4growEi.exit.i.i150
	bge	$a1, $s3, .LBB13_107
# %bb.69:                               # %iter.check
	sub.d	$a2, $s3, $a1
	ori	$a3, $zero, 3
...
.LBB13_80:
	addi.d	$a5, $a4, 1
.LBB13_81:                              # %vec.epilog.scalar.ph312.preheader
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $s3, $a5
	.p2align	4, , 16
.LBB13_82:                              # %vec.epilog.scalar.ph312
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	slli.d	$a4, $a4, 1
...
.LBB13_87:                              # %.preheader.i.i.i
	...
	blt	$a2, $s3, .LBB13_87
	b	.LBB13_91
.LBB13_88:                              # %._ZN3vecI3LitE5clearEb.exit_crit_edge.i
	ld.w	$a1, $fp, 512
	blt	$a1, $s3, .LBB13_85
...
# %bb.94:
	move	$a4, $a1
	b	.LBB13_120
.LBB13_95:                              # %vector.main.loop.iter.check335
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB13_97
# %bb.96:
	move	$a3, $zero
	b	.LBB13_101
.LBB13_97:                              # %vector.ph336
	move	$a3, $a2
	bstrins.d	$a3, $zero, 3, 0
	alsl.d	$a4, $a1, $a0, 2
	addi.d	$a4, $a4, 32
...
.LBB13_98:                              # %vector.body339
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB13_98
# %bb.99:                               # %middle.block342
	beq	$a2, $a3, .LBB13_122
# %bb.100:                              # %vec.epilog.iter.check347
	andi	$a4, $a2, 12
	beqz	$a4, .LBB13_119
.LBB13_101:                             # %vec.epilog.ph346
	move	$a5, $a2
	bstrins.d	$a5, $zero, 1, 0
	add.d	$a4, $a5, $a1
	slli.d	$a6, $a3, 2
	...
	vrepli.w	$vr0, -2
	.p2align	4, , 16
.LBB13_102:                             # %vec.epilog.vector.body352
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a1, 0
	addi.d	$a3, $a3, 4
	addi.d	$a1, $a1, 16
	bnez	$a3, .LBB13_102
# %bb.103:                              # %vec.epilog.middle.block356
	bne	$a2, $a5, .LBB13_120
	b	.LBB13_122
.LBB13_104:
	add.d	$a4, $a3, $a1
...
.LBB13_106:                             # %vec.epilog.scalar.ph
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB13_106
.LBB13_107:                             # %._crit_edge.i.i151
	st.w	$s3, $fp, 512
	ld.w	$s3, $s1, 8
	ori	$s4, $zero, 1
	blt	$s3, $s4, .LBB13_133
.LBB13_108:                             # %.lr.ph.i146
	ld.d	$a1, $s1, 0
	move	$a2, $zero
	.p2align	4, , 16
.LBB13_109:                             # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 4
	blt	$a2, $s3, .LBB13_109
# %bb.110:                              # %_ZNK3vecI3LitE6copyToERS1_.exit164
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB13_133
# %bb.111:                              # %.lr.ph196
	ld.d	$a0, $s1, 0
	...
	b	.LBB13_113
	.p2align	4, , 16
.LBB13_112:                             # %.loopexit177
                                        #   in Loop: Header=BB13_113 Depth=1
	addi.d	$s0, $s0, 1
	bge	$s0, $s3, .LBB13_134
.LBB13_113:                             # =>This Loop Header: Depth=1
...
.LBB13_115:                             #   in Loop: Header=BB13_116 Depth=2
	...
	addi.d	$a7, $a7, 4
	beqz	$t0, .LBB13_112
.LBB13_116:                             #   Parent Loop BB13_113 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t1, $a7, 0
	srai.d	$t1, $t1, 1
	ldx.bu	$t2, $a2, $t1
...
# %bb.117:                              #   in Loop: Header=BB13_116 Depth=2
	...
	ldx.w	$t1, $a6, $t1
	blt	$t1, $a3, .LBB13_115
# %bb.118:                              #   in Loop: Header=BB13_113 Depth=1
	slli.d	$a6, $s4, 2
	stx.w	$a5, $a0, $a6
	ld.w	$s3, $s1, 8
	addi.w	$s4, $s4, 1
...
.LBB13_119:
	add.d	$a4, $a3, $a1
.LBB13_120:                             # %vec.epilog.scalar.ph345.preheader
	sub.d	$a1, $s3, $a4
	alsl.d	$a2, $a4, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_121:                             # %vec.epilog.scalar.ph345
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB13_121
.LBB13_122:                             # %._crit_edge.i.i
	st.w	$s3, $fp, 512
	ld.w	$s3, $s1, 8
	ori	$s4, $zero, 1
	blt	$s3, $s4, .LBB13_133
.LBB13_123:                             # %.lr.ph.i134
	ld.d	$a1, $s1, 0
	move	$a2, $zero
	.p2align	4, , 16
...
# %bb.126:                              # %.lr.ph205.preheader
	...
	b	.LBB13_130
	.p2align	4, , 16
.LBB13_127:                             # %._crit_edge247
                                        #   in Loop: Header=BB13_130 Depth=1
	ld.d	$a0, $s1, 0
	ldx.w	$a1, $a0, $s6
	ld.d	$ra, $sp, 32                    # 8-byte Folded Reload
.LBB13_128:                             #   in Loop: Header=BB13_130 Depth=1
	slli.d	$a2, $s4, 2
	addi.w	$s4, $s4, 1
	stx.w	$a1, $a0, $a2
