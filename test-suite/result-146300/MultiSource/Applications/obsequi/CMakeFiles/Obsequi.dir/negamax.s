...
.LBB0_26:                               # =>This Loop Header: Depth=1
	...
	st.w	$s5, $a0, %pc_lo12(starting_depth)
	blt	$s4, $s2, .LBB0_31
# %bb.27:                               # %.lr.ph294
                                        #   in Loop: Header=BB0_26 Depth=1
	move	$s7, $zero
...
.LBB0_28:                               #   Parent Loop BB0_26 Depth=1
	...
	st.w	$s7, $a0, %pc_lo12(g_move_number)
	ld.d	$a0, $s2, 0
	addi.d	$a1, $a1, -2
