...
.LBB6_51:                               #   in Loop: Header=BB6_6 Depth=1
	move	$s5, $s8
.LBB6_52:                               # %_ZN8NArchive4NTar8CHandler9ReadItem2EP19ISequentialInStreamRbRNS0_7CItemExE.exit
                                        #   in Loop: Header=BB6_6 Depth=1
	ld.d	$a0, $sp, 208
	beqz	$a0, .LBB6_54
...
.LBB6_54:                               # %_ZN11CStringBaseIcED2Ev.exit.i
	...
	ld.d	$a0, $sp, 192
	beqz	$a0, .LBB6_56
# %bb.55:                               #   in Loop: Header=BB6_6 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_56:                               # %_ZN11CStringBaseIcED2Ev.exit1.i
                                        #   in Loop: Header=BB6_6 Depth=1
	ld.d	$a0, $sp, 176
	beqz	$a0, .LBB6_58
# %bb.57:                               #   in Loop: Header=BB6_6 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_58:                               # %_ZN11CStringBaseIcED2Ev.exit2.i
                                        #   in Loop: Header=BB6_6 Depth=1
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB6_5
...
.Ltmp59:
	...
	move	$a1, $a0
.Ltmp60:
# %bb.76:                               # %_ZNK11CStringBaseIwE13CompareNoCaseEPKw.exit
	ld.d	$a0, $sp, 104
	sltui	$fp, $a1, 1
	ori	$a1, $zero, 1
	masknez	$s0, $a1, $fp
...
# %bb.77:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_78:                               # %_ZN11CStringBaseIwED2Ev.exit94
	or	$s2, $s1, $s0
.LBB6_79:
.Ltmp68:
	addi.d	$a0, $sp, 128
...
.Ltmp15:
	move	$fp, $a0
.LBB6_113:                              # %_ZN11CStringBaseIcED2Ev.exit8.i
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB6_115
# %bb.114:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
# %bb.12:                               # %middle.block
	add.d	$a1, $a4, $a1
	beq	$a3, $a2, .LBB19_19
.LBB19_13:                              # %.lr.ph.split.preheader315
...
.LBB19_98:                              # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
	...
	addi.d	$sp, $sp, 320
	ret
.LBB19_99:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit._crit_edge.loopexit311
