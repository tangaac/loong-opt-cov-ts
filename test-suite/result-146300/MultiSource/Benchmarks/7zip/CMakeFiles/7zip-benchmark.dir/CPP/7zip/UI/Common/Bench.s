...
# %bb.64:                               # %middle.block
	...
	beq	$a0, $a3, .LBB13_67
.LBB13_65:                              # %.lr.ph353.preheader565
	ori	$a3, $zero, 224
	mul.d	$a3, $a0, $a3
	add.d	$a3, $a3, $fp
	addi.d	$a3, $a3, 176
...
.LBB13_99:                              # %vector.body536
	...
	addi.d	$a5, $a5, 448
	bnez	$a6, .LBB13_99
# %bb.100:                              # %middle.block543
	add.d	$a1, $a2, $a1
	add.d	$a2, $a4, $a3
	ld.d	$a3, $sp, 40                    # 8-byte Folded Reload
	beq	$a0, $a3, .LBB13_103
.LBB13_101:                             # %.lr.ph371.preheader552
	ori	$a3, $zero, 224
	mul.d	$a3, $a0, $a3
	add.d	$a3, $a3, $fp
	addi.d	$a3, $a3, 176
...
.Ltmp116:
	b	.LBB13_121
.LBB13_111:                             # %.loopexit.split-lp410
.Ltmp92:
	b	.LBB13_121
.LBB13_112:                             # %.loopexit.split-lp415
.Ltmp95:
	b	.LBB13_121
.LBB13_113:
.Ltmp80:
...
.Ltmp122:
	b	.LBB13_121
.LBB13_116:                             # %.loopexit414
.Ltmp110:
	b	.LBB13_121
.LBB13_117:                             # %.loopexit409
.Ltmp107:
	b	.LBB13_121
