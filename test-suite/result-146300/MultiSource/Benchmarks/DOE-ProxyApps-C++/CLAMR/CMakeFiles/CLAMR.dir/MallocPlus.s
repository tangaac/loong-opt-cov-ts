...
.LBB1_10:
	move	$a1, $zero
	b	.LBB1_14
.LBB1_11:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i
	sub.d	$a0, $s6, $fp
	slt	$a1, $s5, $a0
	maskeqz	$a0, $a0, $a1
	masknez	$a1, $s5, $a1
...
.LBB15_57:                              # %.thread.i
	...
	st.d	$a0, $s0, 88
	b	.LBB15_8
.LBB15_58:                              # %._crit_edge202
	ld.d	$a0, $sp, 16
	ld.d	$a1, $sp, 24
	beq	$a1, $a0, .LBB15_60
# %bb.59:                               # %_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i.i124
	st.d	$a0, $sp, 24
...
# %bb.61:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB15_62:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit126
	ld.d	$a1, $sp, 56
.Ltmp90:
	addi.d	$a0, $sp, 40
	pcaddu18i	$ra, %call36(_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE8_M_eraseEPSt13_Rb_tree_nodeIS5_E)
...
.Ltmp92:
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB15_65:                              # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE10_Auto_nodeD2Ev.exit.i129
.Ltmp89:
	b	.LBB15_72
.LBB15_66:
.Ltmp86:
	b	.LBB15_75
.LBB15_67:                              # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE10_Auto_nodeD2Ev.exit.i141
.Ltmp83:
	b	.LBB15_72
.LBB15_68:
.Ltmp80:
