...
# %bb.7:                                # %middle.block158
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a5, .LBB1_10
.LBB1_8:                                # %.lr.ph.i.i.i.preheader164
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a5, $s7, $s2, 3
	.p2align	4, , 16
.LBB1_9:                                # %.lr.ph.i.i.i
...
# %bb.13:                               # %middle.block143
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a4, .LBB1_16
.LBB1_14:                               # %.lr.ph.i.i.i77.preheader163
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a0, $s7, $s3, 3
	.p2align	4, , 16
...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $t1
.LBB5_19:                               # %.lr.ph.i166.preheader355
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t2, $a1
	alsl.d	$a3, $a1, $a0, 3
...
# %bb.36:                               # %.lr.ph228
	...
	vst	$vr6, $sp, 320                  # 16-byte Folded Spill
...
.LBB5_74:                               # %.lr.ph.i209
	...
	b	.LBB5_64
	.p2align	4, , 16
.LBB5_75:                               # %vector.memcheck326
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $s4
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_67
# %bb.76:                               # %vector.memcheck326
                                        #   in Loop: Header=BB5_65 Depth=1
	ld.d	$a6, $sp, 376                   # 8-byte Folded Reload
	sub.d	$a7, $a3, $a6
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_67
# %bb.77:                               # %vector.memcheck326
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_67
# %bb.78:                               # %vector.memcheck326
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_67
...
.LBB5_80:                               # %vector.body339
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB5_80
# %bb.81:                               # %middle.block351
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_67
	b	.LBB5_69
	.p2align	4, , 16
.LBB5_82:                               # %vector.memcheck306
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_70
# %bb.83:                               # %vector.memcheck306
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_70
...
.LBB5_85:                               # %vector.body315
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB5_85
# %bb.86:                               # %middle.block323
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_70
	b	.LBB5_72
	.p2align	4, , 16
.LBB5_87:                               # %vector.memcheck286
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s7, .LBB5_73
# %bb.88:                               # %vector.memcheck286
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $s4
	move	$a3, $a4
	bltu	$a6, $s7, .LBB5_73
...
.LBB10_9:                               # %vector.body
	...
	xvfrecip.d	$xr2, $xr2
	movfr2gr.d	$t3, $fa3
	xvinsgr2vr.d	$xr3, $t3, 0
	movfr2gr.d	$t3, $fa4
	xvinsgr2vr.d	$xr3, $t3, 1
	movfr2gr.d	$t3, $fa5
	xvinsgr2vr.d	$xr3, $t3, 2
	movfr2gr.d	$t3, $fa6
	xvinsgr2vr.d	$xr3, $t3, 3
	fld.d	$fa4, $t1, -24
	fld.d	$fa5, $t1, -8
	fld.d	$fa6, $t1, 8
	fld.d	$fa7, $t1, 24
