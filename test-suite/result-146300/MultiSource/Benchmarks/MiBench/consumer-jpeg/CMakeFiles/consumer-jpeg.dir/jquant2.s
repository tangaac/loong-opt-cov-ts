...
# %bb.18:
	...
	jirl	$ra, $ra, 0
.LBB1_19:                               # %.sink.split52
	move	$a0, $zero
.LBB1_20:                               # %.sink.split52
	stx.w	$a0, $s1, $s0
	ld.w	$a0, $s1, 56
	bnez	$a0, .LBB1_10
	b	.LBB1_11
...
.LBB5_28:                               # %vector.ph
	...
	xvld	$xr5, $a0, %pc_lo12(.LCPI5_2)
	add.d	$s7, $s7, $t5
	xvinsgr2vr.d	$xr6, $ra, 0
	xvpermi.d	$xr6, $xr6, 68
	xvinsgr2vr.d	$xr7, $zero, 0
	xvpermi.d	$xr8, $xr7, 68
	xvori.b	$xr9, $xr5, 0
	xvshuf.d	$xr9, $xr8, $xr6
	xvinsgr2vr.d	$xr6, $s3, 0
	xvpermi.d	$xr6, $xr6, 68
	xvori.b	$xr7, $xr5, 0
	xvshuf.d	$xr7, $xr8, $xr6
	xvinsgr2vr.d	$xr6, $s1, 0
	xvpermi.d	$xr10, $xr6, 68
	xvori.b	$xr6, $xr5, 0
	xvshuf.d	$xr6, $xr8, $xr10
	xvinsgr2vr.d	$xr10, $a1, 0
	xvpermi.d	$xr10, $xr10, 68
	xvshuf.d	$xr5, $xr8, $xr10
	xvreplgr2vr.d	$xr13, $s8
	move	$a1, $t3
	move	$s1, $s5
	xvori.b	$xr12, $xr1, 0
	xvori.b	$xr11, $xr1, 0
...
.LBB5_29:                               # %vector.body
	...
	vinsgr2vr.d	$vr16, $s0, 0
	vseqi.h	$vr17, $vr15, 0
	vst	$vr17, $sp, 224
	pcalau12i	$a0, %pc_hi20(.LCPI5_3)
	xvld	$xr17, $a0, %pc_lo12(.LCPI5_3)
	xvld	$xr18, $sp, 224
	vseqi.h	$vr19, $vr16, 0
	vst	$vr19, $sp, 160
	xvld	$xr19, $sp, 160
	...
	xvori.b	$xr20, $xr17, 0
	xvshuf.h	$xr20, $xr0, $xr18
	xvslli.d	$xr18, $xr20, 48
	xvstelm.h	$xr15, $sp, 88, 3
	xvstelm.h	$xr15, $sp, 80, 2
	xvstelm.h	$xr15, $sp, 72, 1
	xvstelm.h	$xr15, $sp, 64, 0
	xvld	$xr15, $sp, 64
	vst	$vr16, $sp, 128
	st.h	$zero, $sp, 126
	st.w	$zero, $sp, 122
	...
	st.w	$zero, $sp, 98
	xvld	$xr16, $sp, 128
	xvsrai.d	$xr18, $xr18, 48
	xvpermi.d	$xr19, $xr19, 68
	xvshuf.h	$xr17, $xr0, $xr19
	xvstelm.h	$xr16, $sp, 120, 3
	xvstelm.h	$xr16, $sp, 112, 2
	xvstelm.h	$xr16, $sp, 104, 1
	xvstelm.h	$xr16, $sp, 96, 0
	xvld	$xr16, $sp, 96
	xvslli.d	$xr17, $xr17, 48
	xvsrai.d	$xr17, $xr17, 48
	xvadd.d	$xr5, $xr5, $xr15
	xvadd.d	$xr8, $xr8, $xr16
	xvmul.d	$xr19, $xr4, $xr15
	xvmul.d	$xr20, $xr4, $xr16
	xvmul.d	$xr21, $xr13, $xr15
	xvmul.d	$xr22, $xr13, $xr16
	vslli.w	$vr23, $vr14, 3
	vbitseti.w	$vr24, $vr23, 2
	vadd.w	$vr23, $vr23, $vr2
	vpickve2gr.w	$a0, $vr24, 0
	...
	vpickve2gr.w	$a0, $vr23, 0
	xvinsgr2vr.d	$xr24, $a0, 0
	vpickve2gr.w	$a0, $vr23, 1
	xvinsgr2vr.d	$xr24, $a0, 1
	vpickve2gr.w	$a0, $vr23, 2
	xvinsgr2vr.d	$xr24, $a0, 2
	vpickve2gr.w	$a0, $vr23, 3
	xvinsgr2vr.d	$xr24, $a0, 3
	xvmul.d	$xr15, $xr15, $xr25
	xvmul.d	$xr16, $xr16, $xr24
	xvbitsel.v	$xr19, $xr19, $xr1, $xr18
	xvadd.d	$xr6, $xr6, $xr19
	xvbitsel.v	$xr19, $xr20, $xr1, $xr17
	xvadd.d	$xr10, $xr10, $xr19
	xvbitsel.v	$xr19, $xr21, $xr1, $xr18
	xvadd.d	$xr7, $xr7, $xr19
	xvbitsel.v	$xr19, $xr22, $xr1, $xr17
	xvadd.d	$xr11, $xr11, $xr19
	xvbitsel.v	$xr15, $xr15, $xr1, $xr18
	xvadd.d	$xr9, $xr9, $xr15
	xvbitsel.v	$xr15, $xr16, $xr1, $xr17
...
# %bb.30:                               # %middle.block
	...
	xvld	$xr13, $a0, %pc_lo12(.LCPI5_4)
	xvadd.d	$xr9, $xr12, $xr9
	xvpermi.d	$xr12, $xr9, 78
	xvori.b	$xr14, $xr13, 0
	xvshuf.d	$xr14, $xr0, $xr12
	xvadd.d	$xr9, $xr9, $xr14
	xvpermi.d	$xr12, $xr9, 68
...
.LBB9_67:                               # %.loopexit
	...
	move	$s0, $zero
	blt	$t1, $a2, .LBB9_69
# %bb.68:                               # %.preheader.lr.ph
	addi.w	$a4, $t2, 0
	bge	$a4, $a5, .LBB9_70
.LBB9_69:                               # %._crit_edge127
	st.d	$s0, $a1, 32
	...
	addi.d	$sp, $sp, 64
	ret
.LBB9_70:                               # %.preheader.preheader
	addi.w	$a4, $t2, 1
	addi.w	$a6, $a6, 1
	bstrpick.d	$t1, $a3, 31, 0
	addi.d	$t1, $t1, 1
	bstrpick.d	$t4, $t1, 32, 2
	slli.d	$t2, $t4, 2
	slli.d	$t3, $t4, 3
	alsl.w	$t4, $t4, $t0, 2
	slli.d	$t5, $a5, 6
