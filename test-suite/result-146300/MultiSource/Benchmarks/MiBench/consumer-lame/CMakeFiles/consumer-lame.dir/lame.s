...
.LBB5_25:                               # %._crit_edge
	...
	ld.w	$a2, $a4, %pc_lo12(mf_size)
	ld.d	$a5, $sp, 40                    # 8-byte Folded Reload
	ld.w	$a3, $a5, %pc_lo12(mf_samples_to_encode)
	add.w	$a2, $a2, $a0
	st.w	$a2, $a4, %pc_lo12(mf_size)
	add.d	$a0, $a3, $a0
	st.w	$a0, $a5, %pc_lo12(mf_samples_to_encode)
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	blt	$a2, $a0, .LBB5_16
# %bb.26:                               #   in Loop: Header=BB5_18 Depth=1
	pcalau12i	$a0, %pc_hi20(mfbuf)
	addi.d	$s5, $a0, %pc_lo12(mfbuf)
	add.d	$a2, $s5, $s1
	move	$a0, $s3
	move	$a1, $s5
	ld.d	$s7, $sp, 48                    # 8-byte Folded Reload
...
# %bb.27:                               #   in Loop: Header=BB5_18 Depth=1
	...
	ld.w	$a3, $a5, %pc_lo12(mf_size)
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	add.w	$a1, $a0, $a1
	st.d	$a1, $sp, 32                    # 8-byte Folded Spill
	ld.d	$a6, $sp, 40                    # 8-byte Folded Reload
	ld.w	$a4, $a6, %pc_lo12(mf_samples_to_encode)
	ld.w	$a1, $s3, 204
	sub.w	$a0, $a3, $a2
	st.w	$a0, $a5, %pc_lo12(mf_size)
	sub.d	$a3, $a4, $a2
	st.w	$a3, $a6, %pc_lo12(mf_samples_to_encode)
	blt	$a1, $t6, .LBB5_17
...
# %bb.32:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_42
	.p2align	4, , 16
.LBB5_33:                               # %vector.main.loop.iter.check128
                                        #   in Loop: Header=BB5_31 Depth=2
	bgeu	$a0, $t7, .LBB5_35
# %bb.34:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_39
	.p2align	4, , 16
.LBB5_35:                               # %vector.body132.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t2, $s5
	move	$t3, $a6
	.p2align	4, , 16
.LBB5_36:                               # %vector.body132
                                        #   Parent Loop BB5_18 Depth=1
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB5_36
# %bb.37:                               # %middle.block137
                                        #   in Loop: Header=BB5_31 Depth=2
	beq	$a6, $a0, .LBB5_30
# %bb.38:                               # %vec.epilog.iter.check142
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t5, $a6
	move	$t4, $a6
	beqz	$a7, .LBB5_42
.LBB5_39:                               # %vec.epilog.ph141
                                        #   in Loop: Header=BB5_31 Depth=2
	add.d	$t2, $t1, $t5
	alsl.d	$t3, $t5, $s5, 1
	add.d	$t4, $a2, $t5
	slli.d	$t4, $t4, 1
	.p2align	4, , 16
.LBB5_40:                               # %vec.epilog.vector.body147
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $s5, $t4
	...
	addi.d	$t4, $t4, 16
	bnez	$t2, .LBB5_40
# %bb.41:                               # %vec.epilog.middle.block151
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t4, $t0
	beq	$t0, $a0, .LBB5_30
.LBB5_42:                               # %vec.epilog.scalar.ph140.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	alsl.d	$t2, $t4, $s5, 1
	add.d	$t3, $a2, $t4
	slli.d	$t3, $t3, 1
	sub.d	$t4, $a0, $t4
	.p2align	4, , 16
.LBB5_43:                               # %vec.epilog.scalar.ph140
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.h	$t5, $s5, $t3
...
# %bb.23:                               # %iter.check176
	...
	ori	$a3, $zero, 8
	blt	$s1, $a3, .LBB6_26
# %bb.24:                               # %vector.memcheck171
                                        #   in Loop: Header=BB6_22 Depth=1
	alsl.d	$a3, $a0, $s4, 1
	alsl.d	$a5, $a1, $s3, 2
	bgeu	$a3, $a5, .LBB6_48
# %bb.25:                               # %vector.memcheck171
                                        #   in Loop: Header=BB6_22 Depth=1
	add.d	$a3, $a0, $a1
	alsl.d	$a3, $a3, $s4, 1
	add.d	$a3, $a3, $s8
...
.LBB6_26:                               #   in Loop: Header=BB6_22 Depth=1
	move	$a3, $zero
.LBB6_27:                               # %vec.epilog.scalar.ph188.preheader
                                        #   in Loop: Header=BB6_22 Depth=1
	alsl.d	$a5, $a3, $s3, 2
	addi.d	$a6, $a5, 2
	add.d	$a5, $a3, $a0
	...
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB6_28:                               # %vec.epilog.scalar.ph188
...
# %bb.31:                               #   in Loop: Header=BB6_22 Depth=1
	...
	add.d	$a4, $a4, $a0
	ld.w	$a2, $s5, 188
	ld.w	$a3, $s0, %pc_lo12(mf_size)
	add.w	$t7, $a0, $t7
	ld.w	$a5, $s6, %pc_lo12(mf_samples_to_encode)
	ld.w	$a1, $s5, 204
	sub.w	$a0, $a3, $a2
	st.w	$a0, $s0, %pc_lo12(mf_size)
	sub.d	$a3, $a5, $a2
...
.LBB6_47:                               # %vec.epilog.scalar.ph
	...
	bnez	$t5, .LBB6_47
	b	.LBB6_34
.LBB6_48:                               # %vector.main.loop.iter.check178
                                        #   in Loop: Header=BB6_22 Depth=1
	ori	$a3, $zero, 16
...
.LBB6_50:                               # %vec.epilog.ph189
	...
	alsl.d	$a5, $a5, $s4, 1
	.p2align	4, , 16
.LBB6_51:                               # %vec.epilog.vector.body195
                                        #   Parent Loop BB6_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB6_51
# %bb.52:                               # %vec.epilog.middle.block200
                                        #   in Loop: Header=BB6_22 Depth=1
...
# %bb.55:                               # %middle.block185
	...
	ld.d	$a4, $sp, 96                    # 8-byte Folded Reload
	beq	$a3, $a1, .LBB6_29
# %bb.56:                               # %vec.epilog.iter.check190
                                        #   in Loop: Header=BB6_22 Depth=1
	andi	$a5, $a1, 8
	bnez	$a5, .LBB6_50
	b	.LBB6_27
...
.LBB6_58:                               # %.thread
	move	$a0, $a1
	b	.LBB6_71
.LBB6_59:                               # %vector.main.loop.iter.check207
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB6_64
# %bb.60:
	move	$a1, $zero
.LBB6_61:                               # %vec.epilog.ph220
	move	$s6, $fp
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s4, 1
	.p2align	4, , 16
.LBB6_62:                               # %vec.epilog.vector.body229
                                        # =>This Inner Loop Header: Depth=1
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB6_62
# %bb.63:                               # %vec.epilog.middle.block234
	move	$fp, $s6
	move	$s0, $s8
	bne	$a1, $s2, .LBB6_68
	b	.LBB6_70
.LBB6_64:                               # %vector.ph208
...
.LBB6_65:                               # %vector.body211
	...
	addi.d	$a2, $a2, 32
	bnez	$a4, .LBB6_65
# %bb.66:                               # %middle.block216
	beq	$a1, $s2, .LBB6_70
# %bb.67:                               # %vec.epilog.iter.check221
	andi	$a2, $s2, 8
	bnez	$a2, .LBB6_61
