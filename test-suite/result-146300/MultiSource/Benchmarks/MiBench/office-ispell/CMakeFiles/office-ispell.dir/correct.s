...
# %bb.133:                              # %.lr.ph.preheader.i139
	...
	add.d	$fp, $fp, $s2
	move	$s2, $s0
.LBB2_134:                              # %._crit_edge.i142
	ld.d	$s0, $s5, 0
	move	$a0, $s6
	pcaddu18i	$ra, %call36(skipoverword)
	jirl	$ra, $ra, 0
	bgeu	$s6, $a0, .LBB2_140
# %bb.135:                              # %.lr.ph8.i165.preheader
	sub.d	$a3, $a0, $s6
	ori	$a1, $zero, 64
	bltu	$a3, $a1, .LBB2_141
...
.LBB2_142:                              # %.lr.ph8.i165
	...
	move	$a2, $s2
	bne	$a4, $a0, .LBB2_142
.LBB2_143:                              # %._crit_edge9.i145.loopexit
	move	$a3, $a0
.LBB2_144:                              # %._crit_edge9.i145
	st.d	$s2, $s5, 0
	ld.bu	$a2, $a3, 0
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	sub.d	$a1, $s0, $a1
...
.LBB2_147:                              # %.lr.ph18.i152
	...
	addi.d	$a0, $a0, 1
	bnez	$a2, .LBB2_147
.LBB2_148:                              # %.loopexit.i158.preheader
	add.d	$a0, $fp, $a1
	.p2align	4, , 16
.LBB2_149:                              # %.loopexit.i158
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $s2, 1
...
# %bb.3:                                # %.lr.ph.preheader
	...
	ld.d	$s4, $a3, %got_pc_lo12(hashheader)
	ld.d	$s5, $fp, 0
	add.d	$a3, $s4, $a1
	ld.bu	$a3, $a3, 1210
