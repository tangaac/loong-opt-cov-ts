...
.LBB0_2:
	...
	ld.d	$s1, $a0, %got_pc_lo12(hashname)
	move	$a0, $s1
	move	$a1, $zero
...
# %bb.3:
	...
	ld.d	$s0, $a1, %got_pc_lo12(hashsize)
...
# %bb.9:
	...
	ld.d	$s8, $a0, %got_pc_lo12(nodictflag)
	ld.w	$s6, $s8, 0
...
.LBB0_13:
	...
	ld.d	$s4, $a0, %got_pc_lo12(hashstrings)
	ld.w	$s7, $s1, 24
