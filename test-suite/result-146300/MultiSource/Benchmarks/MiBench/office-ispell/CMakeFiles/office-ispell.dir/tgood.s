...
# %bb.39:                               # %iter.check84
	...
	ori	$a1, $zero, 16
	bltu	$a2, $a1, .LBB3_57
# %bb.40:                               # %vector.main.loop.iter.check86
                                        #   in Loop: Header=BB3_5 Depth=1
	addi.d	$a1, $s8, 526
	ori	$a3, $zero, 32
	bgeu	$a2, $a3, .LBB3_52
...
.LBB3_42:                               # %vec.epilog.ph99
	...
	add.d	$a2, $a6, $a2
	.p2align	4, , 16
.LBB3_43:                               # %vec.epilog.vector.body105
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vpickve2gr.b	$a6, $vr0, 15
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB3_43
# %bb.44:                               # %vec.epilog.middle.block110
                                        #   in Loop: Header=BB3_5 Depth=1
	ori	$s5, $zero, 1
	bne	$a4, $a0, .LBB3_57
	b	.LBB3_66
...
.LBB3_53:                               # %vector.body90
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB3_53
# %bb.54:                               # %middle.block95
                                        #   in Loop: Header=BB3_5 Depth=1
	beq	$a2, $a0, .LBB3_66
# %bb.55:                               # %vec.epilog.iter.check100
                                        #   in Loop: Header=BB3_5 Depth=1
	andi	$a3, $a0, 16
	bnez	$a3, .LBB3_42
...
.LBB3_60:                               # %vector.body58
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB3_60
# %bb.61:                               # %middle.block63
                                        #   in Loop: Header=BB3_5 Depth=1
	beq	$t1, $a2, .LBB3_66
# %bb.62:                               # %vec.epilog.iter.check68
                                        #   in Loop: Header=BB3_5 Depth=1
	andi	$a3, $t1, 16
	bnez	$a3, .LBB3_72
