...
.LBB2_7:                                # %vector.body
	...
	addi.d	$a3, $sp, 176
	xvstelm.b	$xr2, $a3, 0, 2
	addi.d	$a3, $sp, 168
	xvstelm.b	$xr2, $a3, 0, 1
	addi.d	$a3, $sp, 160
	xvstelm.b	$xr2, $a3, 0, 0
	xvld	$xr2, $sp, 160
	xvxor.v	$xr3, $xr1, $xr4
	xvadd.d	$xr3, $xr0, $xr3
	...
	alsl.d	$a6, $a6, $s2, 3
	xvstelm.d	$xr3, $a3, 0, 0
	xvstelm.d	$xr3, $a4, 0, 1
	xvstelm.d	$xr3, $a5, 0, 2
	xvstelm.d	$xr3, $a6, 0, 3
	xvaddi.du	$xr1, $xr1, 4
	addi.d	$a2, $a2, -4
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB2_7
...
# %bb.15:                               #   in Loop: Header=BB2_14 Depth=2
	...
	b	.LBB2_13
	.p2align	4, , 16
.LBB2_16:                               # %.critedge.thread.loopexit.i
                                        #   in Loop: Header=BB2_14 Depth=2
	sub.d	$a0, $s1, $s4
	add.d	$s7, $s8, $a0
	move	$a0, $s3
