...
.LBB0_77:                               # %.preheader298
	...
	blt	$a4, $a3, .LBB0_114
# %bb.78:                               # %.lr.ph380
	pcalau12i	$a4, %got_pc_hi20(xNodeArray)
	ld.d	$a4, $a4, %got_pc_lo12(xNodeArray)
	xvrepli.b	$xr0, 0
	ld.d	$a0, $a4, 0
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	bstrpick.d	$a0, $a5, 31, 0
	st.d	$a0, $sp, 40                    # 8-byte Folded Spill
	pcalau12i	$a6, %got_pc_hi20(eArray)
	ld.d	$a0, $a6, %got_pc_lo12(eArray)
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	pcalau12i	$a7, %got_pc_hi20(edgeList)
	ld.d	$a0, $a7, %got_pc_lo12(edgeList)
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	pcalau12i	$t0, %got_pc_hi20(cellList)
	ld.d	$a0, $t0, %got_pc_lo12(cellList)
...
.LBB0_92:                               # %vector.body500
	...
	xvinsgr2vr.w	$xr3, $ra, 3
	xvinsgr2vr.w	$xr3, $s8, 4
	xvinsgr2vr.w	$xr3, $s7, 5
	xvinsgr2vr.w	$xr3, $s6, 6
	xvinsgr2vr.w	$xr3, $s5, 7
	ld.w	$a1, $t5, 8
	ld.w	$a2, $t3, 8
	ld.w	$a0, $a0, 8
	ld.w	$a6, $t4, 8
...
.LBB0_129:                              # %vector.body526
	...
	xvinsgr2vr.w	$xr3, $s8, 1
	xvinsgr2vr.w	$xr3, $s7, 2
	xvinsgr2vr.w	$xr3, $s6, 3
	xvinsgr2vr.w	$xr3, $s5, 4
	xvinsgr2vr.w	$xr3, $s4, 5
