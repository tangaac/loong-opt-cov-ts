...
.LBB6_6:                                # %.preheader.loopexit
	...
	xvstelm.b	$xr0, $sp, 80, 4
	xvstelm.b	$xr0, $sp, 76, 3
	xvstelm.b	$xr0, $sp, 72, 2
...
# %bb.9:
	addi.w	$s4, $a2, 0
	pcalau12i	$a0, %pc_hi20(apwCand)
	addi.d	$s5, $a0, %pc_lo12(apwCand)
	slli.d	$a0, $s4, 3
	ldx.d	$a0, $s5, $a0
	addi.w	$s1, $a2, 1
	st.w	$s1, $a1, %pc_lo12(cpwCand)
	bnez	$a0, .LBB6_12
# %bb.10:
	ori	$a0, $zero, 32
	pcaddu18i	$ra, %call36(malloc)
...
# %bb.16:                               # %.lr.ph.preheader.i
                                        #   in Loop: Header=BB14_6 Depth=1
	ld.w	$a3, $s6, %pc_lo12(cchMinLength)
	move	$a2, $a1
	move	$a1, $a3
	move	$s5, $a0
	b	.LBB14_19
