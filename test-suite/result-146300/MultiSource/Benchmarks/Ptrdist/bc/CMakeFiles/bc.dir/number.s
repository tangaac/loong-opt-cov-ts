...
# %bb.6:                                # %vector.ph
	...
	xvld	$xr1, $a6, %pc_lo12(.LCPI15_0)
	xvpermi.d	$xr2, $xr2, 68
	xvinsgr2vr.d	$xr3, $zero, 0
...
.LBB15_20:                              # %vector.body197
	...
	addi.d	$a3, $a3, 8
	bnez	$a5, .LBB15_20
# %bb.21:                               # %middle.block210
                                        #   in Loop: Header=BB15_16 Depth=1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	xvld	$xr3, $a0, %pc_lo12(.LCPI15_2)
	xvadd.d	$xr1, $xr2, $xr1
	xvpermi.d	$xr2, $xr1, 78
	xvshuf.d	$xr3, $xr0, $xr2
	xvadd.d	$xr1, $xr1, $xr3
...
.LBB15_40:                              # %.lr.ph25.i
	...
	move	$a4, $a5
	bltu	$a2, $a1, .LBB15_40
.LBB15_41:                              # %_rm_leading_zeros.exit
	pcalau12i	$a0, %pc_hi20(_zero_)
...
# %bb.45:                               #   in Loop: Header=BB15_44 Depth=1
	...
	blt	$a1, $a2, .LBB15_44
	b	.LBB15_47
.LBB15_46:                              # %is_zero.exit
	bnez	$a4, .LBB15_48
.LBB15_47:                              # %is_zero.exit.thread
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	st.w	$zero, $a0, 0
.LBB15_48:                              # %is_zero.exit.thread135
	...
	addi.d	$sp, $sp, 160
	ret
.LBB15_49:                              # %vector.main.loop.iter.check
	bgeu	$a1, $a3, .LBB15_51
# %bb.50:
	move	$a5, $zero
	b	.LBB15_55
.LBB15_51:                              # %vector.ph221
...
.LBB15_55:                              # %vec.epilog.ph
	...
	add.d	$a2, $a2, $a5
	.p2align	4, , 16
.LBB15_56:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	vst	$vr0, $t1, 0
	addi.d	$t0, $t0, 16
...
.LBB21_112:                             # %vec.epilog.ph365
	...
	.p2align	4, , 16
.LBB21_113:                             # %vec.epilog.vector.body372
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a6, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_113
# %bb.114:                              # %vec.epilog.middle.block380
                                        #   in Loop: Header=BB21_81 Depth=1
	bne	$a4, $a1, .LBB21_99
	b	.LBB21_101
.LBB21_115:                             # %vector.ph351
                                        #   in Loop: Header=BB21_81 Depth=1
...
.LBB21_116:                             # %vector.body354
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_116
# %bb.117:                              # %middle.block361
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a2, $a1, .LBB21_101
# %bb.118:                              # %vec.epilog.iter.check366
                                        #   in Loop: Header=BB21_81 Depth=1
	andi	$a3, $a1, 16
	bnez	$a3, .LBB21_112
...
# %bb.124:                              # %vec.epilog.middle.block
	bne	$a4, $a1, .LBB21_31
	b	.LBB21_33
.LBB21_125:                             # %vector.main.loop.iter.check297
	ori	$a2, $zero, 32
	bstrpick.d	$a1, $fp, 31, 0
	bgeu	$fp, $a2, .LBB21_145
# %bb.126:
	move	$a2, $zero
.LBB21_127:                             # %vec.epilog.ph312
	bstrpick.d	$a3, $a1, 31, 4
	slli.d	$a4, $a3, 4
	sub.d	$fp, $fp, $a4
	alsl.d	$a0, $a3, $a0, 4
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_128:                             # %vec.epilog.vector.body319
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vshuf.b	$vr1, $vr0, $vr1, $vr0
	vst	$vr1, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_128
# %bb.129:                              # %vec.epilog.middle.block327
	bne	$a4, $a1, .LBB21_44
	b	.LBB21_46
.LBB21_130:
	ld.d	$s8, $sp, 184                   # 8-byte Folded Reload
...
.LBB21_146:                             # %vector.body301
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_146
# %bb.147:                              # %middle.block308
	beq	$a2, $a1, .LBB21_46
# %bb.148:                              # %vec.epilog.iter.check313
	andi	$a3, $a1, 16
	bnez	$a3, .LBB21_127
# %bb.149:
	sub.d	$fp, $fp, $a2
