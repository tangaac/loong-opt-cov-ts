...
# %bb.20:                               # %vector.body809.preheader
	...
	ori	$t4, $zero, 4068
	ori	$s3, $zero, 4060
	lu52i.d	$s5, $zero, 1022
	lu52i.d	$a6, $zero, 1021
	b	.LBB0_22
	.p2align	4, , 16
...
.LBB0_22:                               # %vector.body809
	...
	xvstx	$xr13, $a5, $t3
	xvldx	$xr15, $a2, $t4
	xvfsub.s	$xr16, $xr11, $xr12
	add.d	$a2, $fp, $t2
	xvstx	$xr16, $a2, $t3
	xvfsub.s	$xr11, $xr15, $xr12
	xvfmul.s	$xr15, $xr14, $xr14
	xvfmul.s	$xr17, $xr13, $xr13
	xvfadd.s	$xr15, $xr15, $xr17
	xvfmul.s	$xr17, $xr16, $xr16
	xvfadd.s	$xr15, $xr15, $xr17
	xvfmul.s	$xr17, $xr11, $xr11
	xvfadd.s	$xr15, $xr17, $xr15
	xvfmul.s	$xr17, $xr12, $xr12
	xvfdiv.s	$xr15, $xr15, $xr17
	xvfadd.s	$xr13, $xr14, $xr13
	xvfadd.s	$xr13, $xr13, $xr16
	xvfadd.s	$xr13, $xr11, $xr13
	xvpermi.q	$xr14, $xr15, 1
	vreplvei.w	$vr16, $vr14, 0
	fcvt.d.s	$ft8, $ft8
	xvfdiv.s	$xr12, $xr13, $xr12
	movfr2gr.d	$a2, $ft8
	vreplvei.w	$vr13, $vr14, 1
	fcvt.d.s	$ft5, $ft5
	...
	movfr2gr.d	$a2, $ft5
	vreplvei.w	$vr13, $vr14, 3
	fcvt.d.s	$ft5, $ft5
	xvinsgr2vr.d	$xr16, $a2, 2
	movfr2gr.d	$a2, $ft5
	vreplvei.w	$vr13, $vr15, 0
	fcvt.d.s	$ft5, $ft5
	xvinsgr2vr.d	$xr16, $a2, 3
	movfr2gr.d	$a2, $ft5
	vreplvei.w	$vr13, $vr15, 1
	fcvt.d.s	$ft5, $ft5
	xvinsgr2vr.d	$xr14, $a2, 0
	movfr2gr.d	$a2, $ft5
	vreplvei.w	$vr13, $vr15, 2
	fcvt.d.s	$ft5, $ft5
	xvinsgr2vr.d	$xr14, $a2, 1
	movfr2gr.d	$a2, $ft5
	vreplvei.w	$vr13, $vr15, 3
	fcvt.d.s	$ft5, $ft5
	xvinsgr2vr.d	$xr14, $a2, 2
	movfr2gr.d	$a2, $ft5
	xvinsgr2vr.d	$xr14, $a2, 3
	xvreplgr2vr.d	$xr15, $s5
	xvfmul.d	$xr13, $xr14, $xr15
	xvfmul.s	$xr14, $xr12, $xr12
	xvpermi.q	$xr17, $xr14, 1
	vreplvei.w	$vr18, $vr17, 0
	fcvt.d.s	$ft10, $ft10
	vreplvei.w	$vr19, $vr17, 1
	fcvt.d.s	$ft11, $ft11
	xvfmul.d	$xr15, $xr16, $xr15
	movfr2gr.d	$a5, $ft10
	movfr2gr.d	$a7, $ft11
	vreplvei.w	$vr16, $vr17, 2
	fcvt.d.s	$ft8, $ft8
	add.d	$a2, $s4, $t2
	movfr2gr.d	$t7, $ft8
	vreplvei.w	$vr16, $vr17, 3
	fcvt.d.s	$ft8, $ft8
	...
	xvreplgr2vr.d	$xr14, $s7
	xvfmul.d	$xr16, $xr16, $xr14
	xvfmul.d	$xr14, $xr17, $xr14
	...
	movgr2fr.d	$ft7, $a7
	fcvt.s.d	$ft7, $ft7
	xvinsgr2vr.w	$xr13, $a5, 2
	movfr2gr.s	$a5, $ft7
	xvpickve2gr.d	$a7, $xr14, 0
	movgr2fr.d	$ft7, $a7
	fcvt.s.d	$ft7, $ft7
	xvinsgr2vr.w	$xr13, $a5, 3
	movfr2gr.s	$a5, $ft7
	xvpickve2gr.d	$a7, $xr14, 1
	movgr2fr.d	$ft7, $a7
	fcvt.s.d	$ft7, $ft7
	xvinsgr2vr.w	$xr13, $a5, 4
	movfr2gr.s	$a5, $ft7
	xvpickve2gr.d	$a7, $xr14, 2
	movgr2fr.d	$ft7, $a7
	fcvt.s.d	$ft7, $ft7
	xvinsgr2vr.w	$xr13, $a5, 5
	movfr2gr.s	$a5, $ft7
	xvpickve2gr.d	$a7, $xr14, 3
	movgr2fr.d	$ft6, $a7
	fcvt.s.d	$ft6, $ft6
	xvinsgr2vr.w	$xr13, $a5, 6
	movfr2gr.s	$a5, $ft6
	xvpermi.q	$xr14, $xr12, 1
	vreplvei.w	$vr15, $vr14, 0
	fcvt.d.s	$ft7, $ft7
	xvinsgr2vr.w	$xr13, $a5, 7
	movfr2gr.d	$a5, $ft7
	...
	movgr2fr.d	$ft8, $a7
	fcvt.s.d	$ft8, $ft8
	xvinsgr2vr.w	$xr17, $a5, 0
	movfr2gr.s	$a5, $ft8
	xvpickve2gr.d	$a7, $xr14, 2
	movgr2fr.d	$ft8, $a7
	fcvt.s.d	$ft8, $ft8
	xvinsgr2vr.w	$xr17, $a5, 1
	movfr2gr.s	$a5, $ft8
	xvpickve2gr.d	$a7, $xr14, 3
	movgr2fr.d	$ft6, $a7
	fcvt.s.d	$ft6, $ft6
	xvinsgr2vr.w	$xr17, $a5, 2
	movfr2gr.s	$a5, $ft6
	xvpickve2gr.d	$a7, $xr15, 0
	movgr2fr.d	$ft6, $a7
	fcvt.s.d	$ft6, $ft6
	xvinsgr2vr.w	$xr17, $a5, 3
	movfr2gr.s	$a5, $ft6
	xvpickve2gr.d	$a7, $xr15, 1
	movgr2fr.d	$ft6, $a7
	fcvt.s.d	$ft6, $ft6
	xvinsgr2vr.w	$xr17, $a5, 4
	movfr2gr.s	$a5, $ft6
	xvpickve2gr.d	$a7, $xr15, 2
	movgr2fr.d	$ft6, $a7
	fcvt.s.d	$ft6, $ft6
	xvinsgr2vr.w	$xr17, $a5, 5
	movfr2gr.s	$a5, $ft6
	xvpickve2gr.d	$a7, $xr15, 3
	movgr2fr.d	$ft6, $a7
	fcvt.s.d	$ft6, $ft6
	xvinsgr2vr.w	$xr17, $a5, 6
	movfr2gr.s	$a5, $ft6
	xvinsgr2vr.w	$xr17, $a5, 7
	xvfmul.s	$xr14, $xr17, $xr17
	xvfdiv.s	$xr13, $xr13, $xr14
	xvfsub.s	$xr13, $xr13, $xr9
	...
	movgr2fr.d	$ft3, $a5
	fcvt.s.d	$ft3, $ft3
	xvinsgr2vr.w	$xr14, $a2, 6
	movfr2gr.s	$a2, $ft3
	xvinsgr2vr.w	$xr14, $a2, 7
	add.d	$a2, $ra, $t2
	ori	$a5, $t0, 4068
	xvstx	$xr14, $a2, $a5
	xvrepli.b	$xr11, 0
...
.LBB0_47:                               # %vector.body721
	...
	add.d	$a2, $t1, $a4
	xvldx	$xr12, $a2, $t3
	xvfmul.s	$xr7, $xr7, $xr9
	xvfadd.s	$xr7, $xr8, $xr7
	xvfmul.s	$xr8, $xr10, $xr11
	vreplvei.w	$vr9, $vr12, 0
	fcvt.d.s	$ft1, $ft1
	xvfadd.s	$xr8, $xr7, $xr8
	movfr2gr.d	$a3, $ft1
	vreplvei.w	$vr7, $vr12, 1
	fcvt.d.s	$ft1, $fa7
	...
	fcvt.d.s	$ft3, $ft1
	xvinsgr2vr.d	$xr9, $a3, 0
	movfr2gr.d	$a3, $ft3
	vreplvei.w	$vr11, $vr10, 2
	fcvt.d.s	$ft3, $ft3
	xvinsgr2vr.d	$xr9, $a3, 1
	movfr2gr.d	$a3, $ft3
	...
	fcvt.d.s	$ft3, $ft3
	xvinsgr2vr.d	$xr9, $a3, 3
	movfr2gr.d	$a3, $ft3
	vreplvei.w	$vr11, $vr10, 1
	fcvt.d.s	$ft3, $ft3
	xvinsgr2vr.d	$xr12, $a3, 0
	movfr2gr.d	$a3, $ft3
	vreplvei.w	$vr11, $vr10, 2
	fcvt.d.s	$ft3, $ft3
	...
	vreplvei.w	$vr10, $vr10, 3
	fcvt.d.s	$ft2, $ft2
	xvinsgr2vr.d	$xr12, $a3, 2
	movfr2gr.d	$a3, $ft2
	vreplvei.w	$vr10, $vr8, 0
	fcvt.d.s	$ft2, $ft2
	xvinsgr2vr.d	$xr12, $a3, 3
	movfr2gr.d	$a3, $ft2
	vreplvei.w	$vr10, $vr8, 1
	fcvt.d.s	$ft2, $ft2
	xvinsgr2vr.d	$xr11, $a3, 0
	movfr2gr.d	$a3, $ft2
	...
	movfr2gr.s	$a3, $ft0
	fcvt.s.d	$ft0, $ft2
	xvinsgr2vr.w	$xr10, $a3, 0
	movfr2gr.s	$a3, $ft0
	xvinsgr2vr.w	$xr10, $a3, 1
