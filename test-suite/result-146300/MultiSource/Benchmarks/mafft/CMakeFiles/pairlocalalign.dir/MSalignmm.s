...
.LBB1_58:                               # %iter.check438
	...
	addi.d	$s0, $t6, 4
	blt	$a4, $t5, .LBB1_125
.LBB1_59:                               # %vec.epilog.scalar.ph454.preheader
	sub.d	$a1, $a0, $a3
	...
	addi.d	$a3, $a3, -4
	.p2align	4, , 16
.LBB1_60:                               # %vec.epilog.scalar.ph454
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fld.s	$fa1, $a2, 0
	fadd.s	$fa0, $fa0, $fa1
...
# %bb.180:                              # %vec.epilog.middle.block517
	beq	$a3, $a2, .LBB1_183
.LBB1_181:                              # %vec.epilog.scalar.ph503.preheader
	alsl.d	$a0, $a3, $a0, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_182:                              # %vec.epilog.scalar.ph503
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $a2, -1
...
.LBB1_202:                              # %._crit_edge126.loopexit.i.i
	...
	add.d	$t0, $t1, $t0
	bne	$a7, $a1, .LBB1_195
.LBB1_203:                              #   in Loop: Header=BB1_185 Depth=1
	move	$t2, $s8
	move	$t1, $s7
	bge	$s0, $a0, .LBB1_208
	b	.LBB1_212
...
.LBB1_208:                              # %._crit_edge135.i.i
                                        #   in Loop: Header=BB1_185 Depth=1
	blt	$ra, $a0, .LBB1_212
# %bb.209:                              #   in Loop: Header=BB1_185 Depth=1
	add.w	$ra, $a7, $ra
	addi.d	$s8, $t2, -1
	st.b	$a2, $t2, -1
	addi.d	$s7, $t1, -1
	...
	b	.LBB1_211
	.p2align	4, , 16
.LBB1_210:                              #   in Loop: Header=BB1_185 Depth=1
	addi.w	$a6, $s0, -1
	move	$a7, $a1
	nor	$t1, $a6, $zero
	add.w	$t2, $s0, $t1
...
.LBB1_242:                              # %vector.body298
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB1_242
# %bb.243:                              # %middle.block303
	ld.d	$a3, $sp, 344                   # 8-byte Folded Reload
	beq	$a2, $a3, .LBB1_246
.LBB1_244:                              # %scalar.ph293.preheader
	alsl.d	$a3, $a2, $fp, 3
	ld.d	$a4, $sp, 344                   # 8-byte Folded Reload
	sub.d	$a2, $a4, $a2
	.p2align	4, , 16
.LBB1_245:                              # %scalar.ph293
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	add.d	$a4, $a4, $a0
	st.d	$a4, $a3, 0
...
.LBB1_250:                              # %vector.body311
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB1_250
# %bb.251:                              # %middle.block316
	beq	$a1, $s6, .LBB1_254
.LBB1_252:                              # %scalar.ph306.preheader
	alsl.d	$a2, $a1, $s7, 3
	sub.d	$a1, $s6, $a1
	.p2align	4, , 16
.LBB1_253:                              # %scalar.ph306
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
...
.LBB1_258:                              # %vector.body392
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_258
# %bb.259:                              # %middle.block401
	beq	$a1, $a2, .LBB1_58
# %bb.260:                              # %vec.epilog.iter.check406
	andi	$a3, $a1, 12
	beqz	$a3, .LBB1_314
.LBB1_261:                              # %vec.epilog.ph405
	move	$a3, $a1
	...
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_262:                              # %vec.epilog.vector.body411
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vld	$vr2, $a4, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a5, $a5, 16
	bnez	$a2, .LBB1_262
# %bb.263:                              # %vec.epilog.middle.block419
	bne	$a1, $a3, .LBB1_56
	b	.LBB1_58
.LBB1_264:                              # %vector.ph441
	move	$a4, $a1
...
.LBB1_265:                              # %vector.body444
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_265
# %bb.266:                              # %middle.block451
	beq	$a1, $a4, .LBB1_61
# %bb.267:                              # %vec.epilog.iter.check456
	andi	$a3, $a1, 12
	beqz	$a3, .LBB1_315
.LBB1_268:                              # %vec.epilog.ph455
	move	$a5, $a1
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB1_269:                              # %vec.epilog.vector.body461
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a6, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a7, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a4, .LBB1_269
# %bb.270:                              # %vec.epilog.middle.block468
	ld.d	$t0, $sp, 448                   # 8-byte Folded Reload
	bne	$a1, $a5, .LBB1_59
	b	.LBB1_61
.LBB1_271:
...
.LBB1_273:                              # %vector.body41
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_273
# %bb.274:                              # %middle.block48
	beq	$a1, $a2, .LBB1_23
# %bb.275:                              # %vec.epilog.iter.check
	andi	$a3, $a1, 12
	beqz	$a3, .LBB1_316
.LBB1_276:                              # %vec.epilog.ph
	move	$a3, $a1
	bstrins.d	$a3, $zero, 1, 0
	ori	$a4, $zero, 1
	move	$s0, $a1
	...
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_277:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vld	$vr2, $a4, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a5, $a5, 16
	bnez	$a2, .LBB1_277
# %bb.278:                              # %vec.epilog.middle.block
	bne	$a1, $a3, .LBB1_21
	b	.LBB1_23
.LBB1_279:                              # %vector.ph78
	move	$a4, $a1
	bstrins.d	$a4, $zero, 3, 0
	xvldrepl.w	$xr0, $t4, 0
	addi.d	$a3, $s1, 36
...
.LBB1_280:                              # %vector.body81
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_280
# %bb.281:                              # %middle.block90
	beq	$a1, $a4, .LBB1_26
# %bb.282:                              # %vec.epilog.iter.check95
	andi	$a3, $a1, 12
	beqz	$a3, .LBB1_317
.LBB1_283:                              # %vec.epilog.ph94
	move	$a5, $a1
	bstrins.d	$a5, $zero, 1, 0
	ori	$a6, $zero, 1
	move	$a3, $a1
	...
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB1_284:                              # %vec.epilog.vector.body100
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $a6, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB1_284
# %bb.285:                              # %vec.epilog.middle.block108
	bne	$a1, $a5, .LBB1_24
	b	.LBB1_26
.LBB1_286:                              # %vector.ph130
	move	$a2, $a1
	bstrins.d	$a2, $zero, 3, 0
	xvldrepl.w	$xr0, $t5, 0
	addi.d	$a3, $s1, 32
...
.LBB1_287:                              # %vector.body133
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_287
# %bb.288:                              # %middle.block140
	beq	$a1, $a2, .LBB1_29
# %bb.289:                              # %vec.epilog.iter.check145
	andi	$a3, $a1, 12
	beqz	$a3, .LBB1_318
.LBB1_290:                              # %vec.epilog.ph144
	move	$a4, $a1
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB1_291:                              # %vec.epilog.vector.body150
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a5, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $a6, 0
	...
	addi.d	$a7, $a7, 16
	bnez	$a2, .LBB1_291
# %bb.292:                              # %vec.epilog.middle.block157
	ld.d	$t4, $sp, 400                   # 8-byte Folded Reload
	bne	$a1, $a4, .LBB1_27
	b	.LBB1_29
.LBB1_293:                              # %vector.ph337
	move	$a3, $a1
	xvldrepl.w	$xr0, $s3, 0
...
.LBB1_294:                              # %vector.body340
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_294
# %bb.295:                              # %middle.block349
	beq	$a1, $a3, .LBB1_54
# %bb.296:                              # %vec.epilog.iter.check354
	andi	$a2, $a1, 12
	beqz	$a2, .LBB1_319
.LBB1_297:                              # %vec.epilog.ph353
	move	$a4, $a1
	bstrins.d	$a4, $zero, 1, 0
	ori	$a5, $zero, 1
	move	$a2, $a1
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB1_298:                              # %vec.epilog.vector.body359
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vld	$vr2, $a5, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a6, $a6, 16
	bnez	$a3, .LBB1_298
# %bb.299:                              # %vec.epilog.middle.block367
	bne	$a1, $a4, .LBB1_52
	b	.LBB1_54
.LBB1_300:                              # %vector.ph178
...
.LBB1_301:                              # %vector.body181
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB1_301
# %bb.302:                              # %middle.block190
	beq	$a1, $s3, .LBB1_77
# %bb.303:                              # %vec.epilog.iter.check195
	andi	$a2, $s3, 12
	beqz	$a2, .LBB1_75
.LBB1_304:                              # %vec.epilog.ph194
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s5, 2
	.p2align	4, , 16
.LBB1_305:                              # %vec.epilog.vector.body200
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a2, 0
	vld	$vr2, $a4, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB1_305
# %bb.306:                              # %vec.epilog.middle.block207
	bne	$a1, $s3, .LBB1_75
	b	.LBB1_77
.LBB1_307:                              # %vector.ph228
...
.LBB1_308:                              # %vector.body231
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_308
# %bb.309:                              # %middle.block240
	beq	$a2, $a1, .LBB1_82
# %bb.310:                              # %vec.epilog.iter.check245
	andi	$a3, $a1, 12
	beqz	$a3, .LBB1_80
.LBB1_311:                              # %vec.epilog.ph244
	move	$a5, $a2
	...
	alsl.d	$a5, $a5, $t6, 2
	.p2align	4, , 16
.LBB1_312:                              # %vec.epilog.vector.body250
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vld	$vr2, $a5, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB1_312
# %bb.313:                              # %vec.epilog.middle.block257
	bne	$a2, $a1, .LBB1_80
	b	.LBB1_82
.LBB1_314:
	addi.d	$fp, $a2, 1
