...
.LBB3_2:
	...
	pcalau12i	$s8, %pc_hi20(Q__align.mseq)
...
# %bb.6:
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s8, %pc_lo12(Q__align.mseq)
...
.LBB3_7:
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s8, %pc_lo12(Q__align.mseq)
	move	$a0, $s5
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
...
.LBB3_8:
	...
	blt	$s3, $a0, .LBB3_11
# %bb.9:                                # %.lr.ph
	ld.d	$a1, $s8, %pc_lo12(Q__align.mseq)
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
...
.LBB3_11:                               # %.preheader561
	blt	$s7, $a0, .LBB3_14
# %bb.12:                               # %.lr.ph568
	ld.d	$a2, $s8, %pc_lo12(Q__align.mseq)
...
.LBB3_29:                               # %._crit_edge572
	...
	blt	$s2, $a0, .LBB3_34
# %bb.30:                               # %.lr.ph575
	ld.d	$a0, $s8, %pc_lo12(Q__align.ogcp1g)
	ld.d	$a1, $sp, 440                   # 8-byte Folded Reload
...
# %bb.36:                               # %.lr.ph.preheader.i
	ld.d	$s3, $fp, %pc_lo12(Q__align.initverticalw)
	slli.d	$a0, $s4, 2
...
.LBB3_123:
	...
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Q__align.fg_h_dg_n1_p)
	ld.d	$a2, $fp, %pc_lo12(Q__align.initverticalw)
	movgr2fr.w	$fa7, $zero
...
# %bb.124:                              # %.lr.ph586
	...
	ori	$a7, $zero, 8
	bgeu	$a6, $a7, .LBB3_155
.LBB3_125:                              # %scalar.ph1119.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_126:                              # %scalar.ph1119
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a2, 0
...
# %bb.128:                              # %.lr.ph589
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB3_161
.LBB3_129:                              # %scalar.ph1157.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a5, $a4, $t3, 2
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB3_130:                              # %scalar.ph1157
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a5, 0
...
.LBB3_135:                              # %vector.body1076
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_135
# %bb.136:                              # %middle.block1081
	beq	$a2, $a4, .LBB3_140
.LBB3_137:                              # %scalar.ph1069.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_138:                              # %scalar.ph1069
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB3_143:                              # %vector.body1091
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_143
# %bb.144:                              # %middle.block1098
	beq	$a4, $a5, .LBB3_147
.LBB3_145:                              # %scalar.ph1084.preheader
	mul.d	$a4, $a0, $a1
	alsl.d	$a2, $a1, $a2, 2
	sub.d	$a1, $a3, $a1
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_146:                              # %scalar.ph1084
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a2, 0
	movgr2fr.w	$fa2, $a4
	ffint.d.w	$fa2, $fa2
...
# %bb.149:                              # %vector.memcheck1177
	...
	ori	$a6, $zero, 64
	bltu	$a4, $a6, .LBB3_187
# %bb.150:                              # %vector.main.loop.iter.check1183
	ori	$a5, $zero, 16
	lu12i.w	$a4, 287172
	bgeu	$a3, $a5, .LBB3_170
# %bb.151:
...
.LBB3_159:                              # %vector.body1124
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB3_159
# %bb.160:                              # %middle.block1136
	bne	$a6, $t1, .LBB3_125
	b	.LBB3_127
.LBB3_161:                              # %vector.memcheck1139
	addi.d	$a6, $t3, 4
	alsl.d	$t0, $a3, $t3, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
...
# %bb.192:                              # %.lr.ph630
	...
	ld.d	$t6, $fp, %pc_lo12(Q__align.initverticalw)
	ld.d	$a1, $sp, 400                   # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Q__align.cpmx1)
	...
	ld.d	$t0, $s8, %pc_lo12(Q__align.ogcp1g)
...
.LBB3_238:                              # %.loopexit
	...
	ld.d	$s5, $a0, %pc_lo12(Q__align.mseq1)
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
...
.LBB3_268:                              # %vec.epilog.ph1340
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_269:                              # %vec.epilog.vector.body1348
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_269
# %bb.270:                              # %vec.epilog.middle.block1353
	beq	$a4, $a5, .LBB3_273
...
# %bb.277:                              #   in Loop: Header=BB3_275 Depth=1
	...
	add.w	$t8, $s7, $t7
	beqz	$t8, .LBB3_284
.LBB3_278:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_275 Depth=1
	bltu	$t8, $a7, .LBB3_290
# %bb.279:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_275 Depth=1
	sub.d	$fp, $s3, $s6
	bltu	$fp, $a7, .LBB3_290
# %bb.280:                              # %vector.ph1385
                                        #   in Loop: Header=BB3_275 Depth=1
...
.LBB3_291:                              # %.lr.ph19.i
	...
	move	$s0, $s3
	bnez	$t8, .LBB3_291
.LBB3_292:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_275 Depth=1
	add.d	$t6, $s7, $t6
	add.d	$t6, $t7, $t6
	move	$s2, $a0
	bne	$t3, $s8, .LBB3_285
.LBB3_293:                              #   in Loop: Header=BB3_275 Depth=1
	move	$t8, $s3
	move	$t7, $s6
	bne	$t0, $ra, .LBB3_298
	b	.LBB3_300
...
.LBB3_298:                              # %._crit_edge30.i
	...
	addi.w	$fp, $fp, 0
	beq	$t2, $fp, .LBB3_300
# %bb.299:                              #   in Loop: Header=BB3_275 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a1, 0
.LBB3_300:                              #   in Loop: Header=BB3_275 Depth=1
	blt	$t0, $a3, .LBB3_305
# %bb.301:                              #   in Loop: Header=BB3_275 Depth=1
	blt	$t2, $a3, .LBB3_305
# %bb.302:                              #   in Loop: Header=BB3_275 Depth=1
	...
	b	.LBB3_304
	.p2align	4, , 16
.LBB3_303:                              #   in Loop: Header=BB3_275 Depth=1
	addi.d	$t1, $s7, -1
	move	$t3, $s8
	nor	$t7, $t1, $zero
	add.w	$t8, $s7, $t7
...
.LBB6_12:                               # %.preheader561
	...
	blt	$a1, $a0, .LBB6_15
# %bb.13:                               # %.lr.ph564
	ld.d	$a2, $fp, %pc_lo12(Q__align_gapmap.mseq)
...
.LBB6_25:
	...
	addi.w	$a0, $zero, -1
	xvld	$xr19, $sp, 272                 # 32-byte Folded Reload
	fcvt.d.s	$fa0, $ft11
...
# %bb.32:
	move	$t2, $zero
.LBB6_33:                               # %scalar.ph988.preheader
	slli.d	$t3, $t2, 2
	sub.d	$t1, $t1, $t2
	vldi	$vr1, -912
	vldi	$vr2, -928
...
# %bb.54:                               # %.lr.ph582
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB6_151
.LBB6_55:                               # %scalar.ph1061.preheader
	alsl.d	$a4, $a6, $a4, 2
	alsl.d	$a3, $a6, $a3, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_56:                               # %scalar.ph1061
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
# %bb.58:                               # %.lr.ph585
	...
	ori	$a5, $zero, 1
	bgeu	$a6, $a7, .LBB6_157
.LBB6_59:                               # %scalar.ph1099.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a6, $a5, $t5, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_60:                               # %scalar.ph1099
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a6, 0
...
.LBB6_65:                               # %vector.body1019
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB6_65
# %bb.66:                               # %middle.block1023
	beq	$a3, $a5, .LBB6_69
.LBB6_67:                               # %scalar.ph1012.preheader
	mul.d	$a3, $a1, $a4
	alsl.d	$a5, $a4, $t5, 2
	sub.d	$a2, $a2, $a4
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_68:                               # %scalar.ph1012
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a5, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB6_72:                               # %vector.body1033
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB6_72
# %bb.73:                               # %middle.block1040
	beq	$a5, $a6, .LBB6_76
.LBB6_74:                               # %scalar.ph1026.preheader
	mul.d	$a5, $a1, $a2
	alsl.d	$a3, $a2, $a3, 2
	sub.d	$a2, $a4, $a2
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_75:                               # %scalar.ph1026
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a3, 0
	movgr2fr.w	$fa2, $a5
	ffint.d.w	$fa2, $fa2
...
.LBB6_171:
	addi.d	$a6, $a7, 1
.LBB6_172:                              # %vec.epilog.scalar.ph.preheader
	ld.d	$a4, $sp, 248                   # 8-byte Folded Reload
...
# %bb.180:                              #   in Loop: Header=BB6_179 Depth=1
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	bnez	$a0, .LBB6_185
# %bb.181:                              # %clearvec.exit537.thread
                                        #   in Loop: Header=BB6_179 Depth=1
	move	$a0, $t1
	move	$a1, $zero
...
.LBB6_184:                              # %.lr.ph.i539
	...
	move	$a2, $a4
	bnez	$a1, .LBB6_184
.LBB6_185:                              # %imp_match_out_veadQ_gapmap.exit544
                                        #   in Loop: Header=BB6_179 Depth=1
	fldx.s	$fa0, $t3, $t5
	fst.s	$fa0, $t1, 0
	addi.d	$a0, $s8, 1
...
# %bb.186:                              # %.lr.ph617.preheader
	...
	b	.LBB6_188
	.p2align	4, , 16
.LBB6_187:                              #   in Loop: Header=BB6_188 Depth=2
	fmul.s	$ft2, $fa4, $ft2
	fadd.s	$ft1, $ft1, $ft2
	fcmp.cult.s	$fcc0, $ft1, $ft0
	fsel	$ft0, $ft1, $ft0, $fcc0
...
.LBB6_188:                              # %.lr.ph617
	...
	stx.w	$zero, $a5, $a2
	bcnez	$fcc0, .LBB6_190
# %bb.189:                              #   in Loop: Header=BB6_188 Depth=2
	add.d	$a7, $a3, $a6
	stx.w	$a7, $a5, $a2
	fmov.s	$fs0, $ft2
.LBB6_190:                              #   in Loop: Header=BB6_188 Depth=2
	add.d	$a7, $s5, $a2
	fld.s	$ft4, $a7, 0
	fldx.s	$ft3, $s4, $a2
	fldx.s	$ft2, $s1, $a2
	...
	fcmp.cule.s	$fcc0, $ft4, $fs0
	bcnez	$fcc0, .LBB6_192
# %bb.191:                              #   in Loop: Header=BB6_188 Depth=2
	ldx.w	$t0, $s0, $a2
	sub.d	$t0, $s8, $t0
	stx.w	$t0, $a5, $a2
	fmov.s	$fs0, $ft4
.LBB6_192:                              #   in Loop: Header=BB6_188 Depth=2
	fld.s	$ft4, $a7, -4
	fmul.s	$ft4, $fa1, $ft4
	fadd.s	$ft4, $ft1, $ft4
	fcmp.cult.s	$fcc0, $ft4, $ft3
	bcnez	$fcc0, .LBB6_187
# %bb.193:                              #   in Loop: Header=BB6_188 Depth=2
	fstx.s	$ft4, $s4, $a2
	stx.w	$t2, $s0, $a2
	b	.LBB6_187
.LBB6_194:
	...
	bnez	$s1, .LBB6_210
	b	.LBB6_196
.LBB6_195:                              # %._crit_edge627.loopexit
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	ld.w	$s1, $a0, 0
	move	$t5, $t1
...
.LBB6_199:                              # %vector.body1155
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_199
# %bb.200:                              # %middle.block1162
	beq	$a2, $a4, .LBB6_203
.LBB6_201:                              # %scalar.ph1146.preheader
	ld.d	$a2, $sp, 304                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t5, 2
...
.LBB6_206:                              # %vector.body1174
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_206
# %bb.207:                              # %middle.block1181
	beq	$a3, $a4, .LBB6_210
.LBB6_208:                              # %scalar.ph1165.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_209:                              # %scalar.ph1165
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
.LBB6_227:                              # %vector.body1189
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_227
# %bb.228:                              # %middle.block1196
	beq	$a3, $a4, .LBB6_231
.LBB6_229:                              # %.lr.ph17.i.preheader
	alsl.d	$a5, $a4, $s3, 3
	sub.d	$a3, $a3, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB6_230:                              # %.lr.ph17.i
	...
	addi.d	$a4, $a4, 1
	bnez	$a3, .LBB6_230
.LBB6_231:                              # %.preheader8.i
	bltz	$a2, .LBB6_245
# %bb.232:                              # %iter.check1202
	ld.d	$a2, $s3, 0
	addi.d	$a5, $a0, 1
	bstrpick.d	$a3, $a5, 31, 0
	ori	$a4, $zero, 3
...
# %bb.233:
	move	$a4, $zero
	b	.LBB6_243
.LBB6_234:                              # %vector.main.loop.iter.check1204
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_236
# %bb.235:
	move	$a4, $zero
	b	.LBB6_240
.LBB6_236:                              # %vector.ph1205
	bstrpick.d	$a4, $a5, 31, 4
	slli.d	$a4, $a4, 4
...
.LBB6_237:                              # %vector.body1208
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB6_237
# %bb.238:                              # %middle.block1214
	beq	$a3, $a4, .LBB6_245
# %bb.239:                              # %vec.epilog.iter.check1219
	andi	$a6, $a5, 12
	beqz	$a6, .LBB6_243
.LBB6_240:                              # %vec.epilog.ph1218
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_241:                              # %vec.epilog.vector.body1226
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_241
# %bb.242:                              # %vec.epilog.middle.block1231
	beq	$a3, $a4, .LBB6_245
.LBB6_243:                              # %vec.epilog.scalar.ph1217.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_244:                              # %vec.epilog.scalar.ph1217
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.252:                              # %.lr.ph53.i
	...
	b	.LBB6_254
	.p2align	4, , 16
.LBB6_253:                              # %._crit_edge47.i
                                        #   in Loop: Header=BB6_254 Depth=1
	addi.w	$a5, $a5, 2
	move	$s7, $t3
	blt	$a2, $a5, .LBB6_284
.LBB6_254:                              # =>This Loop Header: Depth=1
...
.LBB6_257:                              #   in Loop: Header=BB6_254 Depth=1
	...
	b	.LBB6_266
	.p2align	4, , 16
.LBB6_258:                              #   in Loop: Header=BB6_254 Depth=1
	addi.w	$t3, $s7, -1
.LBB6_259:                              #   in Loop: Header=BB6_254 Depth=1
	...
	b	.LBB6_266
	.p2align	4, , 16
.LBB6_260:                              # %._crit_edge29.i
                                        #   in Loop: Header=BB6_261 Depth=2
	addi.d	$fp, $fp, -1
	ld.d	$ra, $sp, 424                   # 8-byte Folded Reload
	beqz	$fp, .LBB6_265
.LBB6_261:                              # %.preheader3.i
                                        #   Parent Loop BB6_254 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB6_262 Depth 3
                                        #       Child Loop BB6_264 Depth 3
...
.LBB6_264:                              # %.lr.ph28.i
	...
	b	.LBB6_260
	.p2align	4, , 16
.LBB6_265:                              # %._crit_edge32.loopexit.i
                                        #   in Loop: Header=BB6_254 Depth=1
	add.d	$a5, $s7, $a5
	add.d	$a5, $t8, $a5
.LBB6_266:                              # %._crit_edge32.i
                                        #   in Loop: Header=BB6_254 Depth=1
	add.w	$a4, $t7, $a4
	ld.d	$s7, $sp, 120                   # 8-byte Folded Reload
	ld.d	$t8, $sp, 320                   # 8-byte Folded Reload
	beq	$t7, $t8, .LBB6_273
# %bb.267:                              # %.preheader1.preheader.i
                                        #   in Loop: Header=BB6_254 Depth=1
	nor	$t7, $t7, $zero
	b	.LBB6_269
	.p2align	4, , 16
.LBB6_268:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB6_269 Depth=2
	addi.d	$t7, $t7, -1
	addi.d	$a5, $a5, 1
	beqz	$t7, .LBB6_273
.LBB6_269:                              # %.preheader1.i
                                        #   Parent Loop BB6_254 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB6_270 Depth 3
                                        #       Child Loop BB6_272 Depth 3
...
.LBB6_272:                              # %.lr.ph37.i
	...
	b	.LBB6_268
	.p2align	4, , 16
.LBB6_273:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB6_254 Depth=1
	beq	$t4, $a1, .LBB6_276
# %bb.274:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB6_254 Depth=1
	addi.w	$t7, $a0, 0
	beq	$t5, $t7, .LBB6_276
# %bb.275:                              #   in Loop: Header=BB6_254 Depth=1
	slli.d	$t7, $t4, 2
	...
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a3, 0
.LBB6_276:                              #   in Loop: Header=BB6_254 Depth=1
	blt	$t4, $t1, .LBB6_285
# %bb.277:                              #   in Loop: Header=BB6_254 Depth=1
	blt	$t5, $t1, .LBB6_285
# %bb.278:                              # %.preheader5.i
                                        #   in Loop: Header=BB6_254 Depth=1
	blt	$ra, $t1, .LBB6_281
# %bb.279:                              # %.lr.ph44.i
	...
	move	$t6, $a7
	.p2align	4, , 16
.LBB6_280:                              #   Parent Loop BB6_254 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t4, 0
	ld.d	$t8, $t5, 0
	ldx.b	$t7, $t7, $t3
...
# %bb.282:                              # %.lr.ph46.i
	...
	move	$t6, $t0
	.p2align	4, , 16
.LBB6_283:                              #   Parent Loop BB6_254 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $s7, 0
	ld.d	$t8, $t5, 0
	ldx.b	$t7, $t7, $a4
...
.LBB6_285:                              # %Atracking_localhom_gapmap.exit
	ld.d	$s0, $sp, 80                    # 8-byte Folded Reload
.LBB6_286:                              # %Atracking_localhom_gapmap.exit
	ld.d	$a0, $s4, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
	...
	blt	$a2, $a3, .LBB6_295
# %bb.287:                              # %Atracking_localhom_gapmap.exit
	ori	$a0, $a4, 2881
	bge	$a3, $a0, .LBB6_295
.LBB6_288:
	ori	$fp, $zero, 1
