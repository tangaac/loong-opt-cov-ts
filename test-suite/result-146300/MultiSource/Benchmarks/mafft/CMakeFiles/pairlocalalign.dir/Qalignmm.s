...
# %bb.0:
	...
	ld.w	$s7, $t1, %pc_lo12(Q__align.orlgth1)
	ld.w	$t0, $t0, 0
...
# %bb.1:
	...
	ld.w	$s7, $a1, %pc_lo12(Q__align.orlgth1)
...
.LBB3_2:
	...
	ld.w	$s4, $a0, %pc_lo12(Q__align.orlgth2)
	addi.w	$a6, $s5, 0
	...
	pcalau12i	$s3, %pc_hi20(Q__align.mseq)
...
# %bb.6:
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s3, %pc_lo12(Q__align.mseq)
	...
	ld.w	$s7, $a0, %pc_lo12(Q__align.orlgth1)
...
.LBB3_7:
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s3, %pc_lo12(Q__align.mseq)
	move	$a0, $s6
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	ld.d	$a0, $sp, 384                   # 8-byte Folded Reload
	st.w	$s7, $a0, %pc_lo12(Q__align.orlgth1)
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	st.w	$s4, $a0, %pc_lo12(Q__align.orlgth2)
...
.LBB3_8:
	...
	blt	$s6, $a0, .LBB3_11
# %bb.9:                                # %.lr.ph
	ld.d	$a1, $s3, %pc_lo12(Q__align.mseq)
	ld.d	$a2, $sp, 192                   # 8-byte Folded Reload
...
.LBB3_11:                               # %.preheader561
	blt	$s8, $a0, .LBB3_14
# %bb.12:                               # %.lr.ph568
	ld.d	$a2, $s3, %pc_lo12(Q__align.mseq)
...
.LBB3_21:
	...
	pcalau12i	$s0, %pc_hi20(Q__align.ijp)
	st.d	$a0, $s0, %pc_lo12(Q__align.ijp)
...
.LBB3_34:                               # %._crit_edge576
	...
	ld.bu	$a0, $a1, 0
	ld.d	$a1, $sp, 376                   # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Q__align.w2)
...
# %bb.123:                              # %.lr.ph586
	...
	ori	$a7, $zero, 8
	bgeu	$a6, $a7, .LBB3_154
.LBB3_124:                              # %scalar.ph1119.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_125:                              # %scalar.ph1119
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a2, 0
...
# %bb.127:                              # %.lr.ph589
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB3_160
.LBB3_128:                              # %scalar.ph1157.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a5, $a4, $t3, 2
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB3_129:                              # %scalar.ph1157
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a5, 0
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB3_129
.LBB3_130:                              # %.loopexit557.thread724
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Q__align.m)
	st.w	$zero, $a0, 0
	b	.LBB3_147
.LBB3_131:                              # %.preheader560
	blt	$ra, $a0, .LBB3_139
# %bb.132:                              # %.lr.ph579
...
.LBB3_134:                              # %vector.body1076
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_134
# %bb.135:                              # %middle.block1081
	beq	$a2, $a4, .LBB3_139
.LBB3_136:                              # %scalar.ph1069.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_137:                              # %scalar.ph1069
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB3_142:                              # %vector.body1091
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_142
# %bb.143:                              # %middle.block1098
	beq	$a4, $a5, .LBB3_146
.LBB3_144:                              # %scalar.ph1084.preheader
	mul.d	$a4, $a0, $a1
	alsl.d	$a2, $a1, $a2, 2
	sub.d	$a1, $a3, $a1
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_145:                              # %scalar.ph1084
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a2, 0
	movgr2fr.w	$fa2, $a4
	ffint.d.w	$fa2, $fa2
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB3_145
.LBB3_146:                              # %.loopexit557
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Q__align.m)
	ori	$a1, $zero, 1
	st.w	$zero, $a0, 0
	blt	$ra, $a1, .LBB3_152
.LBB3_147:                              # %iter.check1181
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	...
	ori	$a5, $zero, 1
	bltu	$a3, $a4, .LBB3_186
# %bb.148:                              # %vector.memcheck1177
	sub.d	$a4, $a0, $t3
	addi.d	$a4, $a4, 4
	ori	$a6, $zero, 64
	bltu	$a4, $a6, .LBB3_186
# %bb.149:                              # %vector.main.loop.iter.check1183
	ori	$a5, $zero, 16
	lu12i.w	$a4, 287172
	bgeu	$a3, $a5, .LBB3_169
# %bb.150:
	move	$a6, $zero
	b	.LBB3_173
.LBB3_151:                              # %.loopexit557.thread
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Q__align.m)
	st.w	$zero, $a0, 0
.LBB3_152:                              # %._crit_edge594
	ori	$t2, $zero, 1
	beqz	$ra, .LBB3_166
# %bb.153:
	ori	$a1, $zero, 1
...
.LBB3_154:                              # %vector.memcheck1101
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_124
# %bb.155:                              # %vector.memcheck1101
	addi.d	$t0, $a1, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a1, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_124
# %bb.156:                              # %vector.memcheck1101
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB3_158:                              # %vector.body1124
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB3_158
# %bb.159:                              # %middle.block1136
	bne	$a6, $t1, .LBB3_124
	b	.LBB3_126
.LBB3_160:                              # %vector.memcheck1139
	addi.d	$a6, $t3, 4
	alsl.d	$t0, $a3, $t3, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
	...
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_128
# %bb.161:                              # %vector.memcheck1139
	addi.d	$a7, $a1, 4
	sltu	$a7, $a6, $a7
	sltu	$t1, $a1, $t0
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_128
# %bb.162:                              # %vector.memcheck1139
	addi.d	$a7, $a2, 4
	alsl.d	$t1, $a3, $a2, 2
	sltu	$t1, $a6, $t1
	sltu	$t0, $a7, $t0
...
.LBB3_170:                              # %vector.body1189
	...
	addi.d	$a5, $a5, 64
	bnez	$t0, .LBB3_170
# %bb.171:                              # %middle.block1194
	beq	$a3, $a6, .LBB3_188
# %bb.172:                              # %vec.epilog.iter.check1199
	andi	$a5, $a3, 12
	beqz	$a5, .LBB3_185
.LBB3_173:                              # %vec.epilog.ph1198
	move	$a7, $a3
	...
	vreplgr2vr.w	$vr2, $a4
	.p2align	4, , 16
.LBB3_174:                              # %vec.epilog.vector.body1206
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t3, $t0
	vstx	$vr1, $t1, $t0
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB3_174
# %bb.175:                              # %vec.epilog.middle.block1211
	bne	$a3, $a7, .LBB3_186
	b	.LBB3_188
.LBB3_176:                              # %vector.ph1040
...
.LBB3_185:
	addi.d	$a5, $a6, 1
.LBB3_186:                              # %vec.epilog.scalar.ph1197.preheader
	...
	sub.d	$a2, $a2, $a5
	.p2align	4, , 16
.LBB3_187:                              # %vec.epilog.scalar.ph1197
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a3, $a4
	stx.w	$zero, $a1, $a4
...
# %bb.191:                              # %.lr.ph630
	...
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	ld.d	$t4, $a1, %pc_lo12(Q__align.initverticalw)
	ld.d	$a1, $sp, 424                   # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Q__align.cpmx1)
	...
	ld.d	$a1, $t5, %pc_lo12(Q__align.ijp)
...
# %bb.194:                              #   in Loop: Header=BB3_193 Depth=1
	ld.d	$a0, $sp, 368                   # 8-byte Folded Reload
	bnez	$a0, .LBB3_202
# %bb.195:                              # %clearvec.exit529.thread
                                        #   in Loop: Header=BB3_193 Depth=1
	move	$a0, $t5
	move	$a1, $zero
...
.LBB3_201:                              # %.lr.ph.i532
	...
	move	$a1, $a2
	bnez	$a3, .LBB3_201
.LBB3_202:                              # %imp_match_out_veadQ.exit537
                                        #   in Loop: Header=BB3_193 Depth=1
	slli.d	$a1, $s7, 2
	fldx.s	$fa0, $t4, $a1
	fst.s	$fa0, $t5, 0
...
# %bb.206:                              #   in Loop: Header=BB3_205 Depth=2
	...
	stx.w	$t0, $a6, $a3
	fmov.s	$fs0, $ft2
.LBB3_207:                              #   in Loop: Header=BB3_205 Depth=2
	add.d	$t0, $t6, $a3
	fld.s	$ft4, $t0, 0
	fldx.s	$ft3, $s0, $a3
	fldx.s	$ft2, $s8, $a3
...
# %bb.210:                              #   in Loop: Header=BB3_205 Depth=2
	...
	stx.w	$t7, $s5, $a3
	b	.LBB3_204
.LBB3_211:                              # %vector.main.loop.iter.check1226
                                        #   in Loop: Header=BB3_193 Depth=1
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_213
# %bb.212:                              #   in Loop: Header=BB3_193 Depth=1
	move	$a4, $zero
	b	.LBB3_217
.LBB3_213:                              # %vector.body1230.preheader
                                        #   in Loop: Header=BB3_193 Depth=1
	addi.d	$a0, $t5, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_214:                              # %vector.body1230
                                        #   Parent Loop BB3_193 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB3_214
# %bb.215:                              # %middle.block1239
                                        #   in Loop: Header=BB3_193 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_202
# %bb.216:                              # %vec.epilog.iter.check1244
                                        #   in Loop: Header=BB3_193 Depth=1
	ld.d	$a4, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	beqz	$a0, .LBB3_220
.LBB3_217:                              # %vec.epilog.ph1243
                                        #   in Loop: Header=BB3_193 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB3_218:                              # %vec.epilog.vector.body1250
                                        #   Parent Loop BB3_193 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB3_218
# %bb.219:                              # %vec.epilog.middle.block1259
                                        #   in Loop: Header=BB3_193 Depth=1
	...
	bne	$a2, $a4, .LBB3_201
	b	.LBB3_202
.LBB3_220:                              #   in Loop: Header=BB3_193 Depth=1
...
.LBB3_221:
	...
	bnez	$a1, .LBB3_237
	b	.LBB3_223
.LBB3_222:                              # %._crit_edge631.loopexit
...
.LBB3_226:                              # %vector.body1277
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_226
# %bb.227:                              # %middle.block1284
	beq	$a2, $a4, .LBB3_230
.LBB3_228:                              # %scalar.ph1268.preheader
	sub.w	$a2, $t7, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_233:                              # %vector.body1296
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_233
# %bb.234:                              # %middle.block1303
	beq	$a3, $a4, .LBB3_237
.LBB3_235:                              # %scalar.ph1287.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_236:                              # %scalar.ph1287
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_237:                              # %.loopexit
	...
	ld.d	$a6, $t5, %pc_lo12(Q__align.ijp)
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_239
# %bb.238:
	st.d	$s8, $sp, 0
...
.LBB3_254:                              # %vector.body1311
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_254
# %bb.255:                              # %middle.block1318
	beq	$a1, $a3, .LBB3_258
.LBB3_256:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $ra, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
.LBB3_257:                              # %.lr.ph10.i
	...
	addi.d	$a3, $a3, 1
	bnez	$a1, .LBB3_257
.LBB3_258:                              # %.preheader1.i
	ld.d	$a1, $fp, 0
	bltz	$a2, .LBB3_272
# %bb.259:                              # %iter.check1324
	ld.d	$a3, $ra, 0
	addi.d	$a6, $t1, 1
...
# %bb.260:
	move	$a5, $zero
	b	.LBB3_270
.LBB3_261:                              # %vector.main.loop.iter.check1326
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_263
# %bb.262:
	move	$a5, $zero
	b	.LBB3_267
.LBB3_263:                              # %vector.ph1327
...
.LBB3_264:                              # %vector.body1330
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_264
# %bb.265:                              # %middle.block1336
	beq	$a4, $a5, .LBB3_272
# %bb.266:                              # %vec.epilog.iter.check1341
	andi	$a7, $a6, 12
	beqz	$a7, .LBB3_270
.LBB3_267:                              # %vec.epilog.ph1340
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_268:                              # %vec.epilog.vector.body1348
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_268
# %bb.269:                              # %vec.epilog.middle.block1353
	beq	$a4, $a5, .LBB3_272
.LBB3_270:                              # %vec.epilog.scalar.ph1339.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_271:                              # %vec.epilog.scalar.ph1339
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.276:                              #   in Loop: Header=BB3_274 Depth=1
	...
	add.w	$t8, $s8, $t7
	beqz	$t8, .LBB3_283
.LBB3_277:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_274 Depth=1
	bltu	$t8, $a7, .LBB3_289
# %bb.278:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_274 Depth=1
	sub.d	$s0, $s4, $s1
	bltu	$s0, $a7, .LBB3_289
# %bb.279:                              # %vector.ph1385
                                        #   in Loop: Header=BB3_274 Depth=1
	bstrpick.d	$s3, $t8, 31, 0
	bstrpick.d	$s0, $s3, 31, 5
	slli.d	$s7, $s0, 5
	sub.d	$t8, $t8, $s7
	sub.d	$s0, $s1, $s7
	sub.d	$s2, $s4, $s7
	...
	move	$ra, $s7
	.p2align	4, , 16
.LBB3_280:                              # %vector.body1389
                                        #   Parent Loop BB3_274 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvst	$xr3, $s4, 0
	xvst	$xr4, $s1, 0
	addi.d	$ra, $ra, -32
...
# %bb.281:                              # %middle.block1396
	...
	b	.LBB3_291
	.p2align	4, , 16
.LBB3_282:                              #   in Loop: Header=BB3_274 Depth=1
	addi.d	$t1, $s8, -1
	nor	$t7, $t1, $zero
	add.w	$t8, $s8, $t7
	bnez	$t8, .LBB3_277
	.p2align	4, , 16
.LBB3_283:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_274 Depth=1
	beq	$t3, $s7, .LBB3_292
.LBB3_284:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_274 Depth=1
	addi.w	$t7, $zero, -17
	nor	$s2, $t3, $zero
	bltu	$t7, $t3, .LBB3_293
# %bb.285:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_274 Depth=1
	sub.d	$t7, $s4, $s1
	bltu	$t7, $a6, .LBB3_293
# %bb.286:                              # %vector.ph1362
                                        #   in Loop: Header=BB3_274 Depth=1
	bstrpick.d	$t7, $s2, 30, 4
	slli.d	$s3, $t7, 4
	sub.d	$s0, $s2, $s3
	sub.d	$t7, $s1, $s3
	sub.d	$t8, $s4, $s3
...
# %bb.288:                              # %middle.block1374
	...
	b	.LBB3_296
	.p2align	4, , 16
.LBB3_289:                              #   in Loop: Header=BB3_274 Depth=1
	move	$s0, $s1
	move	$s2, $s4
	.p2align	4, , 16
.LBB3_290:                              # %.lr.ph19.i
	...
	move	$s2, $s4
	bnez	$t8, .LBB3_290
.LBB3_291:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_274 Depth=1
	add.d	$t6, $s8, $t6
	add.d	$t6, $t7, $t6
	ld.d	$s7, $sp, 200                   # 8-byte Folded Reload
	bne	$t3, $s7, .LBB3_284
.LBB3_292:                              #   in Loop: Header=BB3_274 Depth=1
	move	$t8, $s4
	move	$t7, $s1
	...
	b	.LBB3_299
	.p2align	4, , 16
.LBB3_293:                              #   in Loop: Header=BB3_274 Depth=1
	move	$s0, $s2
	move	$t7, $s1
	move	$t8, $s4
.LBB3_294:                              # %.lr.ph29.i.preheader
                                        #   in Loop: Header=BB3_274 Depth=1
	add.d	$t6, $t6, $s0
	.p2align	4, , 16
.LBB3_295:                              # %.lr.ph29.i
...
.LBB3_296:                              # %._crit_edge30.i
	...
	ld.d	$s0, $sp, 504                   # 8-byte Folded Reload
	beq	$t0, $s0, .LBB3_299
.LBB3_297:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_274 Depth=1
	addi.w	$s0, $a0, 0
	beq	$t2, $s0, .LBB3_299
# %bb.298:                              #   in Loop: Header=BB3_274 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a1, 0
.LBB3_299:                              #   in Loop: Header=BB3_274 Depth=1
	blt	$t0, $a3, .LBB3_304
# %bb.300:                              #   in Loop: Header=BB3_274 Depth=1
	blt	$t2, $a3, .LBB3_304
# %bb.301:                              #   in Loop: Header=BB3_274 Depth=1
	add.d	$a2, $t3, $a2
	addi.d	$s4, $t8, -1
	st.b	$a4, $t8, -1
	addi.d	$s1, $t7, -1
	...
	b	.LBB3_303
	.p2align	4, , 16
.LBB3_302:                              #   in Loop: Header=BB3_274 Depth=1
	addi.d	$t1, $s8, -1
	move	$t3, $s7
	nor	$t7, $t1, $zero
	add.w	$t8, $s8, $t7
...
.LBB3_306:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s2, .LBB3_306
.LBB3_307:                              # %.preheader.i
	ld.d	$s8, $sp, 128                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	blt	$s8, $s0, .LBB3_310
# %bb.308:                              # %.lr.ph52.preheader.i
	move	$s0, $s8
	move	$s2, $s3
	.p2align	4, , 16
.LBB3_309:                              # %.lr.ph52.i
	...
	addi.d	$s5, $s5, 8
	bnez	$s0, .LBB3_309
.LBB3_310:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 480                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 472                   # 8-byte Folded Reload
...
.LBB3_314:                              # %.lr.ph642
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	ld.d	$s1, $a0, %pc_lo12(Q__align.mseq1)
	.p2align	4, , 16
.LBB3_315:                              # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s4, 0
	ld.d	$a1, $s1, 0
...
# %bb.0:
	...
	move	$s1, $a1
	move	$s6, $a0
	pcalau12i	$s2, %pc_hi20(Q__align_gapmap.mseq1)
...
# %bb.1:
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s0, 0
	st.d	$a0, $s2, %pc_lo12(Q__align_gapmap.mseq1)
	move	$a0, $a1
	move	$a1, $zero
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
...
.LBB6_2:
	...
	st.d	$a0, $sp, 368                   # 8-byte Folded Spill
	pcalau12i	$s5, %pc_hi20(Q__align_gapmap.ogcp1g)
...
# %bb.6:
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s5, %pc_lo12(Q__align_gapmap.ogcp1g)
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
...
.LBB6_7:
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, %pc_lo12(Q__align_gapmap.ogcp1g)
	move	$a0, $s1
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
...
.LBB6_11:                               # %.preheader561
	blt	$s8, $a0, .LBB6_14
# %bb.12:                               # %.lr.ph564
	ld.d	$a2, $s3, %pc_lo12(Q__align_gapmap.mseq)
...
.LBB6_21:
	...
	pcalau12i	$s7, %pc_hi20(Q__align_gapmap.ijp)
	st.d	$a0, $s7, %pc_lo12(Q__align_gapmap.ijp)
...
# %bb.35:
	beqz	$s7, .LBB6_146
# %bb.36:                               # %.lr.ph.preheader.i
	ld.d	$s4, $s6, %pc_lo12(Q__align_gapmap.initverticalw)
	slli.d	$a0, $s2, 2
	bstrpick.d	$a0, $a0, 33, 2
	slli.d	$a2, $a0, 2
	move	$a0, $s4
...
.LBB6_51:                               # %imp_match_out_veadQ_gapmap.exit
	...
	bne	$a2, $a1, .LBB6_61
# %bb.52:
	ld.d	$a2, $s5, %pc_lo12(Q__align_gapmap.ogcp1g)
	...
	ld.d	$a3, $s6, %pc_lo12(Q__align_gapmap.initverticalw)
	movgr2fr.w	$fa7, $zero
	fmadd.s	$fa0, $fa0, $fa1, $fa7
	fld.s	$fa1, $a2, 0
	fld.s	$fa7, $a3, 0
...
.LBB6_113:                              # %vector.memcheck859
	...
	move	$t2, $zero
	bnez	$t4, .LBB6_295
# %bb.114:                              # %vector.memcheck859
	alsl.d	$s1, $t1, $a5, 2
	sltu	$t4, $a2, $s1
	sltu	$t5, $a5, $s3
	and	$t4, $t4, $t5
	bnez	$t4, .LBB6_295
# %bb.115:                              # %vector.memcheck859
	alsl.d	$t5, $t1, $a6, 2
	sltu	$t4, $a2, $t5
	sltu	$t6, $a6, $s3
	and	$t4, $t4, $t6
	bnez	$t4, .LBB6_295
# %bb.116:                              # %vector.memcheck859
	alsl.d	$t4, $t1, $t0, 2
	sltu	$t6, $a2, $t4
	sltu	$t7, $t0, $s3
	and	$t6, $t6, $t7
	bnez	$t6, .LBB6_295
# %bb.117:                              # %vector.memcheck859
	alsl.d	$t6, $t1, $a0, 2
	sltu	$t7, $a2, $t6
	sltu	$t8, $a0, $s3
	and	$t7, $t7, $t8
...
.LBB6_144:                              # %vector.body995
	...
	addi.d	$t3, $t3, 32
	bnez	$s5, .LBB6_144
# %bb.145:                              # %middle.block1009
	ld.d	$s7, $sp, 136                   # 8-byte Folded Reload
	move	$s5, $s6
	ld.d	$s6, $sp, 272                   # 8-byte Folded Reload
	bne	$t1, $t2, .LBB6_32
	b	.LBB6_34
.LBB6_146:                              # %clearvec.exit.thread
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	sltui	$a0, $a0, 1
	st.d	$a0, $sp, 128                   # 8-byte Folded Spill
	ld.d	$t4, $sp, 376                   # 8-byte Folded Reload
	...
	beq	$a0, $a1, .LBB6_43
	b	.LBB6_46
.LBB6_147:                              # %.loopexit557.thread
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Q__align_gapmap.m)
	st.w	$zero, $a1, 0
.LBB6_148:                              # %._crit_edge590
	ori	$t2, $zero, 1
	beqz	$t4, .LBB6_162
# %bb.149:
	ori	$a2, $zero, 1
...
.LBB6_154:                              # %vector.body1066
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB6_154
# %bb.155:                              # %middle.block1078
	bne	$a7, $t2, .LBB6_54
	b	.LBB6_56
.LBB6_156:                              # %vector.memcheck1081
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
...
# %bb.176:                              # %.lr.ph626
	...
	ld.d	$t3, $s6, %pc_lo12(Q__align_gapmap.initverticalw)
	...
	ld.d	$t1, $s5, %pc_lo12(Q__align_gapmap.ogcp1g)
...
.LBB6_209:                              # %.loopexit
	...
	ld.d	$s5, $s0, %pc_lo12(Q__align_gapmap.mseq1)
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s6, $a0, %pc_lo12(Q__align_gapmap.mseq2)
	ld.d	$s7, $t0, %pc_lo12(Q__align_gapmap.ijp)
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	beqz	$a0, .LBB6_211
# %bb.210:
	st.d	$s8, $sp, 0
...
.LBB6_239:                              # %vec.epilog.ph1218
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_240:                              # %vec.epilog.vector.body1226
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_240
# %bb.241:                              # %vec.epilog.middle.block1231
	beq	$a3, $a4, .LBB6_244
...
.LBB6_287:                              # %.lr.ph638
	...
	ld.d	$s1, $a0, %pc_lo12(Q__align_gapmap.mseq1)
	.p2align	4, , 16
