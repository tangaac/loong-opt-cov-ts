...
# %bb.0:
	...
	pcalau12i	$s4, %pc_hi20(Aalign.orlgth1)
	ld.w	$s8, $s4, %pc_lo12(Aalign.orlgth1)
...
.LBB0_2:
	...
	pcalau12i	$s5, %pc_hi20(Aalign.mseq)
...
# %bb.4:
	...
	blt	$s2, $a0, .LBB0_12
.LBB0_5:                                # %.lr.ph
	ld.d	$a1, $s5, %pc_lo12(Aalign.mseq)
...
.LBB0_12:                               # %.preheader177
	blt	$s0, $a0, .LBB0_18
# %bb.13:                               # %.lr.ph181
	ld.d	$a0, $s5, %pc_lo12(Aalign.mseq)
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Aalign.mseq2)
	ori	$a2, $zero, 8
	bltu	$s0, $a2, .LBB0_15
# %bb.14:                               # %vector.memcheck280
	alsl.d	$a2, $s2, $a0, 3
	sub.d	$a2, $a1, $a2
	ori	$a3, $zero, 64
	bgeu	$a2, $a3, .LBB0_85
.LBB0_15:
	move	$a2, $zero
.LBB0_16:                               # %scalar.ph282.preheader
	slli.d	$a3, $a2, 3
	alsl.d	$a3, $s2, $a3, 3
	add.d	$a0, $a0, $a3
	alsl.d	$a1, $a2, $a1, 3
...
.LBB0_18:                               # %._crit_edge
	...
	ld.d	$s6, $a0, %got_pc_lo12(commonAlloc2)
	ld.w	$a1, $s5, 0
	ld.w	$a0, $s6, 0
	blt	$a1, $s8, .LBB0_146
# %bb.19:                               # %._crit_edge
...
.LBB0_20:
	...
	ld.d	$s6, $s5, %pc_lo12(Aalign.cpmx2)
	...
	ld.d	$s7, $s5, %pc_lo12(Aalign.cpmx2)
	ld.d	$s4, $s4, %pc_lo12(Aalign.cpmx1)
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s6, $a0, %pc_lo12(Aalign.floatwork)
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	ld.d	$s5, $a0, %pc_lo12(Aalign.intwork)
	ori	$a7, $zero, 1
...
.LBB0_24:                               # %vector.body300
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_24
# %bb.25:                               # %middle.block304
	beq	$a2, $a4, .LBB0_28
.LBB0_26:                               # %scalar.ph295.preheader
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr1, -928
	.p2align	4, , 16
.LBB0_27:                               # %scalar.ph295
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa2, $a2, 0
	fcvt.d.s	$fa2, $fa2
...
.LBB0_31:                               # %vector.body314
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_31
# %bb.32:                               # %middle.block319
	beq	$a3, $a4, .LBB0_36
.LBB0_33:                               # %scalar.ph307.preheader
	alsl.d	$a3, $a1, $s8, 2
	sub.d	$a1, $a2, $a1
	vldi	$vr1, -928
	.p2align	4, , 16
.LBB0_34:                               # %scalar.ph307
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa2, $a3, 0
	fcvt.d.s	$fa2, $fa2
	fmadd.d	$fa2, $fa0, $fa1, $fa2
...
# %bb.37:
	move	$a3, $zero
.LBB0_38:                               # %scalar.ph328.preheader
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a5, $a3, $s8, 2
...
.LBB0_47:                               # %._crit_edge192
	...
	ld.d	$s1, $a1, %pc_lo12(Aalign.lastverticalw)
	sltu	$a1, $zero, $t0
	add.w	$a2, $a1, $t1
	ori	$a1, $zero, 2
	fst.s	$fa0, $s1, 0
...
# %bb.48:                               # %.lr.ph201
	...
	movgr2fr.w	$fs0, $zero
	pcalau12i	$a1, %got_pc_hi20(penalty)
	ld.d	$s4, $a1, %got_pc_lo12(penalty)
	slli.d	$a0, $a0, 2
...
.LBB0_50:                               # =>This Loop Header: Depth=1
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.d	$s1, $a0, %pc_lo12(Aalign.initverticalw)
	addi.d	$s5, $s7, -1
	slli.d	$a0, $s5, 2
	fldx.s	$fa0, $s1, $a0
...
.LBB0_61:                               # %._crit_edge202
	...
	ld.d	$s5, $a0, %pc_lo12(Aalign.mseq1)
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s6, $a0, %pc_lo12(Aalign.mseq2)
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s7, $a0, %pc_lo12(Aalign.ijp)
	ld.d	$a0, $s3, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
...
.LBB0_86:                               # %vector.body287
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_86
# %bb.87:                               # %middle.block292
	beq	$a2, $s0, .LBB0_18
	b	.LBB0_16
.LBB0_88:                               # %vector.ph359
...
.LBB0_142:
	ori	$a0, $zero, 1
	pcalau12i	$s1, %pc_hi20(Aalign.match)
...
# %bb.144:
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s1, %pc_lo12(Aalign.match)
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
...
.LBB0_145:
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, %pc_lo12(Aalign.mseq)
	ori	$a0, $zero, 26
	move	$a1, $s1
	...
	jirl	$ra, $ra, 0
	st.w	$s8, $s4, %pc_lo12(Aalign.orlgth1)
...
# %bb.148:
	...
	ld.w	$s8, $s4, %pc_lo12(Aalign.orlgth1)
	ld.w	$a1, $s5, 0
	ld.w	$s7, $s1, %pc_lo12(Aalign.orlgth2)
	ld.w	$a0, $s6, 0
.LBB0_149:
	slt	$a2, $a1, $s8
	masknez	$a1, $a1, $a2
