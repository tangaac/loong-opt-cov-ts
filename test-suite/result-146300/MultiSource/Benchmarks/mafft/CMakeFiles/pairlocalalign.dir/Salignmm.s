...
.LBB3_2:
	...
	ld.w	$fp, $a1, %pc_lo12(A__align.orlgth2)
...
.LBB3_4:
	ori	$a0, $zero, 1
	pcalau12i	$s1, %pc_hi20(A__align.match)
	blt	$s4, $a0, .LBB3_7
# %bb.5:
	blt	$fp, $a0, .LBB3_7
# %bb.6:
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s1, %pc_lo12(A__align.match)
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	...
	ld.w	$fp, $a0, %pc_lo12(A__align.orlgth2)
.LBB3_7:
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s1, %pc_lo12(A__align.match)
	addi.w	$s6, $s4, 102
	move	$a0, $s6
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	st.w	$fp, $a0, %pc_lo12(A__align.orlgth2)
...
.LBB3_11:                               # %.preheader347
	blt	$s1, $a0, .LBB3_14
# %bb.12:                               # %.lr.ph354
	ld.d	$a2, $s0, %pc_lo12(A__align.mseq)
...
.LBB3_35:
	move	$a3, $zero
.LBB3_36:                               # %scalar.ph525.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr1, -912
...
.LBB3_38:                               # %._crit_edge360
	...
	ld.d	$fp, $s4, %pc_lo12(A__align.cpmx1)
	ld.d	$a1, $sp, 304                   # 8-byte Folded Reload
...
.LBB3_53:                               # %vector.body586
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_53
# %bb.54:                               # %middle.block591
	beq	$a2, $a4, .LBB3_66
.LBB3_55:                               # %scalar.ph579.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_56:                               # %scalar.ph579
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
# %bb.59:                               # %iter.check625
	...
	ori	$a5, $zero, 3
	bltu	$a5, $a3, .LBB3_161
.LBB3_60:                               # %vec.epilog.scalar.ph643.preheader
	...
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB3_61:                               # %vec.epilog.scalar.ph643
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a3, 0
...
# %bb.63:                               # %iter.check677
	...
	ori	$a5, $zero, 3
	bltu	$a5, $a3, .LBB3_165
.LBB3_64:                               # %vec.epilog.scalar.ph695.preheader
	alsl.d	$a3, $a4, $s6, 2
	alsl.d	$a1, $a4, $a1, 2
	addi.d	$a1, $a1, -4
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB3_65:                               # %vec.epilog.scalar.ph695
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a3, 0
...
.LBB3_69:                               # %vector.body601
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_69
# %bb.70:                               # %middle.block608
	beq	$a3, $a4, .LBB3_73
.LBB3_71:                               # %scalar.ph594.preheader
	mul.d	$a3, $a0, $a1
...
.LBB3_74:                               # %iter.check729
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB3_133
.LBB3_75:                               # %vec.epilog.scalar.ph745.preheader
	alsl.d	$a2, $a5, $a2, 2
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a4, $a5, $s6, 2
	addi.d	$a4, $a4, -4
	sub.d	$a1, $a1, $a5
	.p2align	4, , 16
.LBB3_76:                               # %vec.epilog.scalar.ph745
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB3_77:
	...
	b	.LBB3_80
.LBB3_78:                               # %._crit_edge381
	ori	$a0, $zero, 1
	beqz	$s8, .LBB3_169
# %bb.79:
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 304                   # 8-byte Folded Spill
.LBB3_80:                               # %._crit_edge381.thread
...
# %bb.82:                               # %.lr.ph405
	...
	ld.d	$a0, $t4, %pc_lo12(A__align.ijp)
	st.d	$a0, $sp, 256                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(A__align.m)
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
...
# %bb.87:                               # %vector.memcheck763
	...
	add.d	$a1, $s3, $a2
	bgeu	$a3, $a1, .LBB3_99
.LBB3_88:                               #   in Loop: Header=BB3_84 Depth=1
	ld.d	$a4, $sp, 288                   # 8-byte Folded Reload
	move	$a1, $a3
	move	$a2, $s3
	.p2align	4, , 16
.LBB3_89:                               # %.lr.ph.i327
	...
	move	$a2, $a3
	bnez	$a4, .LBB3_89
.LBB3_90:                               # %imp_match_out_vead.exit332
                                        #   in Loop: Header=BB3_84 Depth=1
	slli.d	$a1, $s7, 2
	ld.d	$a2, $sp, 344                   # 8-byte Folded Reload
	fldx.s	$fa0, $a2, $a1
...
# %bb.94:                               #   in Loop: Header=BB3_93 Depth=2
	...
	st.w	$t3, $a4, 0
	fmov.s	$fs0, $fa4
.LBB3_95:                               #   in Loop: Header=BB3_93 Depth=2
	fld.s	$fa5, $t0, 0
	fld.s	$fa4, $a6, 0
	fadd.s	$fa6, $fa0, $fa5
	fcmp.cule.s	$fcc0, $fa6, $fs0
	bcnez	$fcc0, .LBB3_97
# %bb.96:                               #   in Loop: Header=BB3_93 Depth=2
	ld.w	$t3, $a7, 0
	sub.d	$t3, $s7, $t3
	st.w	$t3, $a4, 0
	fmov.s	$fs0, $fa6
.LBB3_97:                               #   in Loop: Header=BB3_93 Depth=2
	fadd.s	$fa6, $fa1, $fa3
	fcmp.cult.s	$fcc0, $fa6, $fa5
	bcnez	$fcc0, .LBB3_92
# %bb.98:                               #   in Loop: Header=BB3_93 Depth=2
	fst.s	$fa6, $t0, 0
	st.w	$s5, $a7, 0
	b	.LBB3_92
.LBB3_99:                               # %vector.main.loop.iter.check774
                                        #   in Loop: Header=BB3_84 Depth=1
	ld.d	$a1, $sp, 280                   # 8-byte Folded Reload
	ori	$a2, $zero, 15
	bgeu	$a1, $a2, .LBB3_101
# %bb.100:                              #   in Loop: Header=BB3_84 Depth=1
	move	$a5, $zero
	b	.LBB3_105
.LBB3_101:                              # %vector.body778.preheader
                                        #   in Loop: Header=BB3_84 Depth=1
	addi.d	$a1, $s3, 32
	addi.d	$a2, $a3, 32
	ld.d	$a4, $sp, 104                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_102:                              # %vector.body778
                                        #   Parent Loop BB3_84 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a2, -32
	xvld	$xr1, $a2, 0
	...
	addi.d	$a2, $a2, 64
	bnez	$a4, .LBB3_102
# %bb.103:                              # %middle.block787
                                        #   in Loop: Header=BB3_84 Depth=1
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	beq	$a1, $a2, .LBB3_90
# %bb.104:                              # %vec.epilog.iter.check792
                                        #   in Loop: Header=BB3_84 Depth=1
	ld.d	$a5, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB3_108
.LBB3_105:                              # %vec.epilog.ph791
                                        #   in Loop: Header=BB3_84 Depth=1
	...
	add.d	$a5, $a6, $a5
	.p2align	4, , 16
.LBB3_106:                              # %vec.epilog.vector.body798
                                        #   Parent Loop BB3_84 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vld	$vr1, $a4, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a5, .LBB3_106
# %bb.107:                              # %vec.epilog.middle.block807
                                        #   in Loop: Header=BB3_84 Depth=1
	...
	bne	$a3, $a5, .LBB3_89
	b	.LBB3_90
.LBB3_108:                              #   in Loop: Header=BB3_84 Depth=1
...
.LBB3_109:
	...
	bnez	$a1, .LBB3_125
	b	.LBB3_111
.LBB3_110:                              # %._crit_edge406.loopexit
	ld.d	$fp, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a1, $fp, 0
	move	$s6, $s3
	ld.d	$s1, $sp, 152                   # 8-byte Folded Reload
...
.LBB3_114:                              # %vector.body825
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_114
# %bb.115:                              # %middle.block832
	beq	$a2, $a4, .LBB3_118
.LBB3_116:                              # %scalar.ph816.preheader
	sub.w	$a2, $t0, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_121:                              # %vector.body844
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_121
# %bb.122:                              # %middle.block851
	beq	$a3, $a4, .LBB3_125
.LBB3_123:                              # %scalar.ph835.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_124:                              # %scalar.ph835
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_125:                              # %.loopexit
	...
	ld.d	$s5, $a0, %pc_lo12(A__align.mseq1)
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s4, $a0, %pc_lo12(A__align.mseq2)
	ld.d	$a6, $t4, %pc_lo12(A__align.ijp)
	beqz	$t3, .LBB3_132
# %bb.126:
	ld.d	$a0, $s7, 0
...
.LBB3_133:                              # %vector.memcheck714
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB3_75
# %bb.134:                              # %vector.memcheck714
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB3_75
# %bb.135:                              # %vector.main.loop.iter.check731
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_229
# %bb.136:
	move	$a6, $zero
...
.LBB3_146:                              # %vector.body859
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_146
# %bb.147:                              # %middle.block866
	beq	$a1, $a3, .LBB3_150
.LBB3_148:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $ra, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
.LBB3_149:                              # %.lr.ph10.i
	...
	addi.d	$a3, $a3, 1
	bnez	$a1, .LBB3_149
.LBB3_150:                              # %.preheader1.i
	ld.d	$a1, $sp, 448
	bltz	$a2, .LBB3_181
# %bb.151:                              # %iter.check872
	ld.d	$a3, $ra, 0
	addi.d	$a6, $t1, 1
...
# %bb.152:
	move	$a5, $zero
	b	.LBB3_179
.LBB3_153:                              # %vector.main.loop.iter.check874
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_172
# %bb.154:
	move	$a5, $zero
...
# %bb.157:                              # %middle.block
	beq	$a2, $t2, .LBB3_31
	b	.LBB3_29
.LBB3_158:                              # %vector.ph527
	bstrpick.d	$a3, $t3, 30, 3
	slli.d	$a3, $a3, 3
	xvreplve0.d	$xr1, $xr0
	lu52i.d	$a5, $zero, 1023
	xvreplgr2vr.d	$xr2, $a5
...
.LBB3_159:                              # %vector.body532
	...
	addi.d	$t0, $t0, 32
	bnez	$a6, .LBB3_159
# %bb.160:                              # %middle.block537
	beq	$a1, $a3, .LBB3_38
	b	.LBB3_36
.LBB3_161:                              # %vector.memcheck611
...
# %bb.162:                              # %vector.memcheck611
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB3_60
# %bb.163:                              # %vector.main.loop.iter.check627
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_244
# %bb.164:
	move	$a5, $zero
	b	.LBB3_248
.LBB3_165:                              # %vector.memcheck662
	addi.d	$a5, $s6, 4
	alsl.d	$a6, $a2, $s6, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
...
# %bb.166:                              # %vector.memcheck662
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB3_64
# %bb.167:                              # %vector.main.loop.iter.check679
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_251
# %bb.168:
	move	$a5, $zero
...
.LBB3_169:
	...
	ld.d	$a3, $sp, 296                   # 8-byte Folded Reload
	b	.LBB3_81
.LBB3_170:                              # %vector.main.loop.iter.check
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB3_237
# %bb.171:
	move	$a5, $zero
	b	.LBB3_241
.LBB3_172:                              # %vector.ph875
...
.LBB3_173:                              # %vector.body878
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_173
# %bb.174:                              # %middle.block884
	beq	$a4, $a5, .LBB3_181
# %bb.175:                              # %vec.epilog.iter.check889
	andi	$a7, $a6, 12
	beqz	$a7, .LBB3_179
.LBB3_176:                              # %vec.epilog.ph888
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_177:                              # %vec.epilog.vector.body896
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_177
# %bb.178:                              # %vec.epilog.middle.block901
	beq	$a4, $a5, .LBB3_181
.LBB3_179:                              # %vec.epilog.scalar.ph887.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_180:                              # %vec.epilog.scalar.ph887
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.184:                              #   in Loop: Header=BB3_183 Depth=1
	beqz	$t4, .LBB3_211
# %bb.185:                              #   in Loop: Header=BB3_183 Depth=1
	sub.d	$t2, $s7, $t4
	move	$t4, $a3
	nor	$t8, $t2, $zero
	add.w	$fp, $s7, $t8
	beqz	$fp, .LBB3_192
.LBB3_186:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_183 Depth=1
	move	$a7, $s8
	bltu	$fp, $t0, .LBB3_198
# %bb.187:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB3_183 Depth=1
	sub.d	$s0, $s3, $s6
	bltu	$s0, $t0, .LBB3_198
# %bb.188:                              # %vector.ph932
...
# %bb.190:                              # %middle.block943
	...
	b	.LBB3_200
	.p2align	4, , 16
.LBB3_191:                              #   in Loop: Header=BB3_183 Depth=1
	addi.d	$t2, $s7, -1
	nor	$t8, $t2, $zero
	add.w	$fp, $s7, $t8
	bnez	$fp, .LBB3_186
	.p2align	4, , 16
.LBB3_192:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_183 Depth=1
	beq	$t4, $a3, .LBB3_201
.LBB3_193:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_183 Depth=1
	addi.w	$t8, $zero, -17
	nor	$s1, $t4, $zero
	bltu	$t8, $t4, .LBB3_202
# %bb.194:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_183 Depth=1
	sub.d	$t8, $s3, $s6
	ori	$a7, $zero, 16
	bltu	$t8, $a7, .LBB3_202
...
# %bb.197:                              # %middle.block921
	...
	b	.LBB3_205
	.p2align	4, , 16
.LBB3_198:                              #   in Loop: Header=BB3_183 Depth=1
	move	$s0, $s6
	move	$s1, $s3
	.p2align	4, , 16
.LBB3_199:                              # %.lr.ph19.i
...
.LBB3_200:                              # %._crit_edge20.loopexit.i
	...
	move	$s8, $a7
	bne	$t4, $a3, .LBB3_193
.LBB3_201:                              #   in Loop: Header=BB3_183 Depth=1
	move	$fp, $s3
	move	$t8, $s6
	bne	$t1, $s8, .LBB3_206
	b	.LBB3_208
	.p2align	4, , 16
.LBB3_202:                              #   in Loop: Header=BB3_183 Depth=1
	move	$s0, $s1
	move	$t8, $s6
	move	$fp, $s3
...
.LBB3_206:                              # %._crit_edge30.i
	...
	addi.w	$s0, $a0, 0
	beq	$t3, $s0, .LBB3_208
# %bb.207:                              #   in Loop: Header=BB3_183 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a1, 0
.LBB3_208:                              #   in Loop: Header=BB3_183 Depth=1
	blt	$t1, $a4, .LBB3_213
# %bb.209:                              #   in Loop: Header=BB3_183 Depth=1
	blt	$t3, $a4, .LBB3_213
# %bb.210:                              #   in Loop: Header=BB3_183 Depth=1
	add.d	$a2, $t4, $a2
	addi.d	$s3, $fp, -1
	st.b	$a5, $fp, -1
	addi.d	$s6, $t8, -1
	...
	b	.LBB3_212
	.p2align	4, , 16
.LBB3_211:                              #   in Loop: Header=BB3_183 Depth=1
	addi.d	$t2, $s7, -1
	move	$t4, $a3
	nor	$t8, $t2, $zero
	add.w	$fp, $s7, $t8
...
.LBB3_230:                              # %vector.body735
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_230
# %bb.231:                              # %middle.block742
	beq	$a4, $a6, .LBB3_77
# %bb.232:                              # %vec.epilog.iter.check747
	andi	$a5, $a4, 12
	beqz	$a5, .LBB3_258
.LBB3_233:                              # %vec.epilog.ph746
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB3_234:                              # %vec.epilog.vector.body752
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB3_234
# %bb.235:                              # %vec.epilog.middle.block759
	bne	$a4, $a7, .LBB3_75
	b	.LBB3_77
.LBB3_236:
	...
	bge	$s3, $fp, .LBB3_223
	b	.LBB3_225
.LBB3_237:                              # %vector.ph550
	bstrpick.d	$a2, $t1, 31, 4
	slli.d	$a5, $a2, 4
	addi.d	$a2, $s6, 32
	addi.d	$a3, $a1, 32
	move	$a4, $a5
	.p2align	4, , 16
.LBB3_238:                              # %vector.body553
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a3, -32
	xvld	$xr1, $a3, 0
	xvld	$xr2, $a2, -32
...
.LBB3_245:                              # %vector.body631
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB3_245
# %bb.246:                              # %middle.block640
	beq	$a3, $a5, .LBB3_62
# %bb.247:                              # %vec.epilog.iter.check645
	andi	$a4, $a3, 12
	beqz	$a4, .LBB3_260
.LBB3_248:                              # %vec.epilog.ph644
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_249:                              # %vec.epilog.vector.body650
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_249
# %bb.250:                              # %vec.epilog.middle.block658
	bne	$a3, $a6, .LBB3_60
	b	.LBB3_62
.LBB3_251:                              # %vector.ph680
	move	$a5, $a3
	xvldrepl.w	$xr0, $a0, 0
	bstrins.d	$a5, $zero, 3, 0
	addi.d	$a4, $s6, 36
...
.LBB3_252:                              # %vector.body683
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB3_252
# %bb.253:                              # %middle.block692
	beq	$a3, $a5, .LBB3_74
# %bb.254:                              # %vec.epilog.iter.check697
	andi	$a4, $a3, 12
	beqz	$a4, .LBB3_261
.LBB3_255:                              # %vec.epilog.ph696
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_256:                              # %vec.epilog.vector.body702
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_256
# %bb.257:                              # %vec.epilog.middle.block710
	bne	$a3, $a6, .LBB3_64
	b	.LBB3_74
.LBB3_258:
	addi.d	$a5, $a6, 1
...
# %bb.0:
	...
	ld.w	$s4, $t0, %pc_lo12(A__align_gapmap.orlgth1)
...
# %bb.1:
	...
	ld.w	$s4, $a1, %pc_lo12(A__align_gapmap.orlgth1)
...
.LBB6_2:
	...
	pcalau12i	$s5, %pc_hi20(A__align_gapmap.ogcp1)
...
# %bb.6:
	...
	pcaddu18i	$ra, %call36(FreeCharMtx)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s5, %pc_lo12(A__align_gapmap.ogcp1)
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
...
.LBB6_8:
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s2, %pc_lo12(A__align_gapmap.ogcp1)
	move	$a0, $s5
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
...
.LBB6_12:                               # %.preheader328
	blt	$s6, $a0, .LBB6_15
# %bb.13:                               # %.lr.ph335
	ld.d	$a2, $s7, %pc_lo12(A__align_gapmap.mseq)
...
.LBB6_23:
	...
	ld.d	$a0, $s1, %pc_lo12(A__align_gapmap.ogcp1)
	move	$a1, $fp
	move	$a2, $s0
	move	$a3, $s4
	move	$a4, $s2
	...
	blt	$s2, $a0, .LBB6_30
# %bb.24:                               # %.lr.ph338
	ld.d	$a1, $s5, %pc_lo12(A__align_gapmap.ogcp1)
	ld.d	$a2, $sp, 176                   # 8-byte Folded Reload
...
.LBB6_37:                               # %._crit_edge341
	...
	st.d	$a0, $sp, 184                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	ld.d	$s6, $a0, %pc_lo12(A__align_gapmap.w1)
	ld.d	$a0, $sp, 232                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(A__align_gapmap.w2)
	st.d	$a0, $sp, 256                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
...
# %bb.59:                               # %iter.check604
	...
	ori	$a5, $zero, 3
	bltu	$a5, $a3, .LBB6_149
.LBB6_60:                               # %vec.epilog.scalar.ph622.preheader
	alsl.d	$a3, $a4, $s6, 2
	alsl.d	$a1, $a4, $a1, 2
	addi.d	$a1, $a1, -4
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB6_61:                               # %vec.epilog.scalar.ph622
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a3, 0
...
.LBB6_69:                               # %.loopexit322
	ori	$a0, $zero, 1
	blt	$s8, $a0, .LBB6_74
.LBB6_70:                               # %iter.check656
	ld.d	$a6, $s5, %pc_lo12(A__align_gapmap.ogcp1)
	addi.d	$a0, $a6, 4
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB6_117
.LBB6_71:                               # %vec.epilog.scalar.ph672.preheader
	alsl.d	$a2, $a5, $a2, 2
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a4, $a5, $s6, 2
	addi.d	$a4, $a4, -4
	sub.d	$a1, $a1, $a5
	.p2align	4, , 16
.LBB6_72:                               # %vec.epilog.scalar.ph672
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB6_77:
	pcalau12i	$a0, %got_pc_hi20(outgap)
	ld.d	$fp, $a0, %got_pc_lo12(outgap)
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s0, $a1, %pc_lo12(A__align_gapmap.lastverticalw)
	sltu	$a1, $zero, $a0
	add.w	$s2, $a1, $s1
	ori	$a1, $zero, 2
	fst.s	$fa0, $s0, 0
...
.LBB6_83:                               # %.lr.ph.i312
	...
	move	$a3, $a5
	bnez	$a2, .LBB6_83
.LBB6_84:                               # %imp_match_out_vead_gapmap.exit317
                                        #   in Loop: Header=BB6_80 Depth=1
	ld.d	$a1, $sp, 264                   # 8-byte Folded Reload
	fldx.s	$fa0, $a1, $a0
	fst.s	$fa0, $s3, 0
...
.LBB6_93:
	...
	bnez	$a0, .LBB6_109
	b	.LBB6_95
.LBB6_94:                               # %._crit_edge387.loopexit
...
.LBB6_98:                               # %vector.body699
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_98
# %bb.99:                               # %middle.block706
	beq	$a2, $a4, .LBB6_102
.LBB6_100:                              # %scalar.ph690.preheader
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s6, 2
...
.LBB6_105:                              # %vector.body718
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_105
# %bb.106:                              # %middle.block725
	beq	$a3, $a4, .LBB6_109
.LBB6_107:                              # %scalar.ph709.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_108:                              # %scalar.ph709
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
.LBB6_109:                              # %.loopexit
	...
	ld.d	$s5, $a0, %pc_lo12(A__align_gapmap.mseq1)
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
...
.LBB6_117:                              # %vector.memcheck641
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB6_71
# %bb.118:                              # %vector.memcheck641
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB6_71
# %bb.119:                              # %vector.main.loop.iter.check658
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB6_211
# %bb.120:
	move	$a6, $zero
...
# %bb.136:
	move	$a5, $zero
	b	.LBB6_161
.LBB6_137:                              # %vector.main.loop.iter.check748
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB6_154
# %bb.138:
	move	$a5, $zero
...
.LBB6_143:                              # %vector.body512
	...
	addi.d	$a4, $a4, 32
	bnez	$a6, .LBB6_143
# %bb.144:                              # %middle.block517
	beq	$a1, $a3, .LBB6_37
	b	.LBB6_35
.LBB6_145:                              # %vector.memcheck549
...
# %bb.146:                              # %vector.memcheck549
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB6_56
# %bb.147:                              # %vector.main.loop.iter.check
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_219
# %bb.148:
	move	$a5, $zero
	b	.LBB6_223
.LBB6_149:                              # %vector.memcheck589
	addi.d	$a5, $s6, 4
	alsl.d	$a6, $a2, $s6, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
...
# %bb.150:                              # %vector.memcheck589
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB6_60
# %bb.151:                              # %vector.main.loop.iter.check606
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_226
# %bb.152:
	move	$a5, $zero
...
.LBB6_155:                              # %vector.body752
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_155
# %bb.156:                              # %middle.block758
	beq	$a4, $a5, .LBB6_163
# %bb.157:                              # %vec.epilog.iter.check763
	andi	$a7, $a6, 12
	beqz	$a7, .LBB6_161
.LBB6_158:                              # %vec.epilog.ph762
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_159:                              # %vec.epilog.vector.body770
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB6_159
# %bb.160:                              # %vec.epilog.middle.block775
	beq	$a4, $a5, .LBB6_163
.LBB6_161:                              # %vec.epilog.scalar.ph761.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_162:                              # %vec.epilog.scalar.ph761
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.167:                              #   in Loop: Header=BB6_165 Depth=1
	...
	add.w	$t8, $s7, $t7
	beqz	$t8, .LBB6_174
.LBB6_168:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB6_165 Depth=1
	bltu	$t8, $t0, .LBB6_180
# %bb.169:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB6_165 Depth=1
	sub.d	$fp, $s6, $s3
	bltu	$fp, $t0, .LBB6_180
# %bb.170:                              # %vector.ph804
...
# %bb.172:                              # %middle.block815
	...
	b	.LBB6_182
	.p2align	4, , 16
.LBB6_173:                              #   in Loop: Header=BB6_165 Depth=1
	addi.d	$t2, $s7, -1
	nor	$t7, $t2, $zero
	add.w	$t8, $s7, $t7
	bnez	$t8, .LBB6_168
	.p2align	4, , 16
.LBB6_174:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB6_165 Depth=1
	beq	$t4, $a3, .LBB6_183
.LBB6_175:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB6_165 Depth=1
	addi.w	$t7, $zero, -17
	nor	$s0, $t4, $zero
	bltu	$t7, $t4, .LBB6_184
# %bb.176:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB6_165 Depth=1
	sub.d	$t7, $s6, $s3
	bltu	$t7, $a7, .LBB6_184
# %bb.177:                              # %vector.ph783
...
.LBB6_182:                              # %._crit_edge20.loopexit.i
	...
	move	$s2, $a0
	bne	$t4, $a3, .LBB6_175
.LBB6_183:                              #   in Loop: Header=BB6_165 Depth=1
	move	$t8, $s6
	move	$t7, $s3
	bne	$t1, $ra, .LBB6_188
	b	.LBB6_190
...
# %bb.189:                              #   in Loop: Header=BB6_165 Depth=1
	...
	fadd.s	$fa5, $fa5, $fa6
	fst.s	$fa5, $a1, 0
.LBB6_190:                              #   in Loop: Header=BB6_165 Depth=1
	blt	$t1, $a4, .LBB6_195
# %bb.191:                              #   in Loop: Header=BB6_165 Depth=1
	blt	$t3, $a4, .LBB6_195
# %bb.192:                              #   in Loop: Header=BB6_165 Depth=1
	add.d	$a2, $t4, $a2
	addi.d	$s6, $t8, -1
	st.b	$a5, $t8, -1
	addi.d	$s3, $t7, -1
...
.LBB6_212:                              # %vector.body662
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB6_212
# %bb.213:                              # %middle.block669
	beq	$a4, $a6, .LBB6_73
# %bb.214:                              # %vec.epilog.iter.check674
	andi	$a5, $a4, 12
	beqz	$a5, .LBB6_233
.LBB6_215:                              # %vec.epilog.ph673
	move	$a7, $a4
	bstrins.d	$a7, $zero, 1, 0
	ori	$t0, $zero, 1
	move	$a5, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB6_216:                              # %vec.epilog.vector.body679
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB6_216
# %bb.217:                              # %vec.epilog.middle.block686
	bne	$a4, $a7, .LBB6_71
	b	.LBB6_73
.LBB6_218:
	pcalau12i	$a0, %got_pc_hi20(stderr)
...
.LBB6_227:                              # %vector.body610
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB6_227
# %bb.228:                              # %middle.block619
	beq	$a3, $a5, .LBB6_70
# %bb.229:                              # %vec.epilog.iter.check624
	andi	$a4, $a3, 12
	beqz	$a4, .LBB6_235
.LBB6_230:                              # %vec.epilog.ph623
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_231:                              # %vec.epilog.vector.body629
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB6_231
# %bb.232:                              # %vec.epilog.middle.block637
	bne	$a3, $a6, .LBB6_60
	b	.LBB6_70
.LBB6_233:
	addi.d	$a5, $a6, 1
