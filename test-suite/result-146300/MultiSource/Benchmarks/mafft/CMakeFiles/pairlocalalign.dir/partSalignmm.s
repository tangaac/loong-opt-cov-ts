...
# %bb.0:
	...
	ld.w	$s6, $t1, %pc_lo12(partA__align.orlgth1)
	ld.w	$t0, $t0, 0
...
# %bb.1:
	...
	ld.w	$s6, $a1, %pc_lo12(partA__align.orlgth1)
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
...
.LBB4_2:
	...
	st.d	$a0, $sp, 160                   # 8-byte Folded Spill
	ld.w	$s5, $a0, %pc_lo12(partA__align.orlgth2)
	addi.w	$a1, $s7, 0
	pcalau12i	$s4, %pc_hi20(partA__align.w1)
	...
	pcalau12i	$a2, %pc_hi20(partA__align.mseq)
...
.LBB4_5:
	ori	$a0, $zero, 1
	pcalau12i	$s8, %pc_hi20(partA__align.match)
	move	$s3, $a2
	blt	$s6, $a0, .LBB4_8
# %bb.6:
	blt	$s5, $a0, .LBB4_8
# %bb.7:
	ld.d	$a0, $s4, %pc_lo12(partA__align.w1)
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s8, %pc_lo12(partA__align.match)
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s3, %pc_lo12(partA__align.mseq)
	...
	ld.w	$s6, $a0, %pc_lo12(partA__align.orlgth1)
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	ld.w	$s5, $a0, %pc_lo12(partA__align.orlgth2)
.LBB4_8:
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s8, %pc_lo12(partA__align.match)
	addi.w	$s8, $s6, 102
	move	$a0, $s8
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s3, %pc_lo12(partA__align.mseq)
	move	$a0, $s8
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	st.w	$s6, $a0, %pc_lo12(partA__align.orlgth1)
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	st.w	$s5, $a0, %pc_lo12(partA__align.orlgth2)
	ld.d	$s8, $sp, 80                    # 8-byte Folded Reload
	ori	$a0, $zero, 1
	ld.d	$a7, $sp, 280                   # 8-byte Folded Reload
	blt	$s2, $a0, .LBB4_16
.LBB4_9:                                # %.lr.ph
	ld.d	$a1, $s3, %pc_lo12(partA__align.mseq)
	ld.d	$a2, $sp, 56                    # 8-byte Folded Reload
...
.LBB4_46:                               # %._crit_edge469
	...
	ld.d	$s3, $t4, %pc_lo12(partA__align.w1)
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(partA__align.w2)
	st.d	$a0, $sp, 8                     # 8-byte Folded Spill
	ld.d	$a0, $sp, 232                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(partA__align.initverticalw)
	ld.d	$a1, $sp, 256                   # 8-byte Folded Reload
	ld.d	$s1, $a1, %pc_lo12(partA__align.cpmx2)
	ld.d	$a1, $sp, 272                   # 8-byte Folded Reload
	ld.d	$s7, $a1, %pc_lo12(partA__align.cpmx1)
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	ld.d	$s4, $a1, %pc_lo12(partA__align.floatwork)
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	ld.d	$s8, $a1, %pc_lo12(partA__align.intwork)
	ori	$a7, $zero, 1
	st.d	$a0, $sp, 272                   # 8-byte Folded Spill
	move	$a1, $s1
	move	$a2, $s7
...
# %bb.60:                               # %iter.check750
	...
	ori	$a4, $zero, 1
	bltu	$a5, $a3, .LBB4_170
.LBB4_61:                               # %vec.epilog.scalar.ph768.preheader
	alsl.d	$a3, $a4, $t3, 2
	alsl.d	$a1, $a4, $a1, 2
	addi.d	$a1, $a1, -4
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB4_62:                               # %vec.epilog.scalar.ph768
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a3, 0
...
.LBB4_78:                               # %iter.check802
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB4_82
.LBB4_79:                               # %vec.epilog.scalar.ph818.preheader
	alsl.d	$a2, $a5, $a2, 2
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a4, $a5, $t3, 2
	addi.d	$a4, $a4, -4
	sub.d	$a1, $a1, $a5
	.p2align	4, , 16
.LBB4_80:                               # %vec.epilog.scalar.ph818
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB4_82:                               # %vector.memcheck787
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB4_79
# %bb.83:                               # %vector.memcheck787
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB4_79
# %bb.84:                               # %vector.main.loop.iter.check804
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_232
# %bb.85:
	move	$a6, $zero
...
.LBB4_87:                               # %._crit_edge490
	...
	fldx.s	$fa0, $t3, $a1
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	ld.d	$s7, $a1, %pc_lo12(partA__align.lastverticalw)
	sltu	$a1, $zero, $t0
	add.w	$a3, $a1, $s3
	ori	$a1, $zero, 2
	fst.s	$fa0, $s7, 0
...
.LBB4_102:
	...
	bnez	$t0, .LBB4_118
	b	.LBB4_104
.LBB4_103:                              # %._crit_edge515.loopexit
...
.LBB4_107:                              # %vector.body845
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_107
# %bb.108:                              # %middle.block852
	beq	$a2, $a4, .LBB4_111
.LBB4_109:                              # %scalar.ph836.preheader
...
.LBB4_114:                              # %vector.body864
	...
	vreplvei.w	$vr6, $vr6, 3
	fcvt.d.s	$fa6, $fa6
	xvinsgr2vr.d	$xr9, $a6, 2
	movfr2gr.d	$a6, $fa6
	xvinsgr2vr.d	$xr9, $a6, 3
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB4_114
# %bb.115:                              # %middle.block871
	beq	$a2, $a3, .LBB4_118
.LBB4_116:                              # %scalar.ph855.preheader
	alsl.d	$a2, $a0, $s7, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_117:                              # %scalar.ph855
                                        # =>This Inner Loop Header: Depth=1
...
.LBB4_118:                              # %.loopexit
	...
	ld.d	$s5, $a0, %pc_lo12(partA__align.mseq1)
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s8, $a0, %pc_lo12(partA__align.mseq2)
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s3, $a0, %pc_lo12(partA__align.ijp)
	ld.d	$a0, $t5, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
...
# %bb.146:
	move	$a5, $zero
	b	.LBB4_191
.LBB4_147:                              # %vector.main.loop.iter.check945
	ori	$a2, $zero, 16
	bgeu	$a4, $a2, .LBB4_184
# %bb.148:
	move	$a5, $zero
...
.LBB4_158:                              # %vector.body635
	...
	addi.d	$a5, $a5, 32
	bnez	$a7, .LBB4_158
# %bb.159:                              # %middle.block640
	beq	$a2, $a4, .LBB4_39
	b	.LBB4_37
.LBB4_160:                              # %vector.ph651
...
.LBB4_161:                              # %vector.body656
	...
	addi.d	$a4, $a4, 32
	bnez	$a6, .LBB4_161
# %bb.162:                              # %middle.block661
	beq	$a1, $a3, .LBB4_46
	b	.LBB4_44
.LBB4_163:                              # %vector.ph617
	slli.d	$a4, $s2, 3
...
.LBB4_164:                              # %vector.body620
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_164
# %bb.165:                              # %middle.block625
	beq	$a2, $s0, .LBB4_22
	b	.LBB4_20
.LBB4_166:                              # %vector.memcheck695
...
# %bb.171:                              # %vector.memcheck735
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB4_61
# %bb.172:                              # %vector.main.loop.iter.check752
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_301
# %bb.173:
	move	$a5, $zero
	b	.LBB4_305
.LBB4_174:                              # %vector.ph876
	pcalau12i	$a5, %pc_hi20(.LCPI4_5)
	vld	$vr0, $a5, %pc_lo12(.LCPI4_5)
...
# %bb.181:
	move	$a4, $zero
	b	.LBB4_246
.LBB4_182:                              # %vector.main.loop.iter.check894
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_239
# %bb.183:
	move	$a4, $zero
	b	.LBB4_243
.LBB4_184:                              # %vector.ph946
...
.LBB4_185:                              # %vector.body949
	...
	addi.d	$a2, $a2, 64
	bnez	$a7, .LBB4_185
# %bb.186:                              # %middle.block955
	beq	$a4, $a5, .LBB4_193
# %bb.187:                              # %vec.epilog.iter.check960
	andi	$a2, $a6, 12
	beqz	$a2, .LBB4_191
.LBB4_188:                              # %vec.epilog.ph959
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_189:                              # %vec.epilog.vector.body968
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a2, .LBB4_189
# %bb.190:                              # %vec.epilog.middle.block973
	beq	$a4, $a5, .LBB4_193
.LBB4_191:                              # %vec.epilog.scalar.ph958.preheader
	alsl.d	$a2, $a5, $a3, 2
	nor	$a3, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_192:                              # %vec.epilog.scalar.ph958
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a4, $a4, -1
...
.LBB4_233:                              # %vector.body808
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_233
# %bb.234:                              # %middle.block815
	beq	$a4, $a6, .LBB4_81
# %bb.235:                              # %vec.epilog.iter.check820
	andi	$a5, $a4, 12
	beqz	$a5, .LBB4_308
.LBB4_236:                              # %vec.epilog.ph819
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB4_237:                              # %vec.epilog.vector.body825
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB4_237
# %bb.238:                              # %vec.epilog.middle.block832
	bne	$a4, $a7, .LBB4_79
	b	.LBB4_81
.LBB4_239:                              # %vector.ph895
...
.LBB4_240:                              # %vector.body898
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_240
# %bb.241:                              # %middle.block904
	beq	$a3, $a4, .LBB4_248
# %bb.242:                              # %vec.epilog.iter.check909
	andi	$a6, $a5, 12
	beqz	$a6, .LBB4_246
.LBB4_243:                              # %vec.epilog.ph908
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_244:                              # %vec.epilog.vector.body916
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_244
# %bb.245:                              # %vec.epilog.middle.block921
	beq	$a3, $a4, .LBB4_248
.LBB4_246:                              # %vec.epilog.scalar.ph907.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_247:                              # %vec.epilog.scalar.ph907
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.290:                              # %.lr.ph528
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s1, $a0, %pc_lo12(partA__align.mseq2)
	.p2align	4, , 16
...
.LBB4_302:                              # %vector.body756
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_302
# %bb.303:                              # %middle.block765
	beq	$a3, $a5, .LBB4_78
# %bb.304:                              # %vec.epilog.iter.check770
	andi	$a4, $a3, 12
	beqz	$a4, .LBB4_310
.LBB4_305:                              # %vec.epilog.ph769
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_306:                              # %vec.epilog.vector.body775
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB4_306
# %bb.307:                              # %vec.epilog.middle.block783
	bne	$a3, $a6, .LBB4_61
	b	.LBB4_78
.LBB4_308:
	addi.d	$a5, $a6, 1
