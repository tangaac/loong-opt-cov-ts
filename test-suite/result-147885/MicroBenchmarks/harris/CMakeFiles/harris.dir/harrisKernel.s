...
# %bb.14:                               #   in Loop: Header=BB0_13 Depth=1
	...
	b	.LBB0_18
	.p2align	4, , 16
.LBB0_15:                               # %vector.body497.preheader
                                        #   in Loop: Header=BB0_13 Depth=1
	move	$a2, $t8
	move	$a3, $fp
	move	$a5, $s5
	.p2align	4, , 16
.LBB0_16:                               # %vector.body497
	...
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB0_16
# %bb.17:                               # %middle.block506
                                        #   in Loop: Header=BB0_13 Depth=1
	move	$a3, $t8
	beq	$t8, $t1, .LBB0_12
.LBB0_18:                               # %scalar.ph492.preheader
                                        #   in Loop: Header=BB0_13 Depth=1
	sub.d	$a2, $t1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB0_19:                               # %scalar.ph492
                                        #   Parent Loop BB0_13 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a5, $t4, $a3
	fldx.s	$fa4, $t4, $a3
...
# %bb.23:                               #   in Loop: Header=BB0_22 Depth=1
	...
	b	.LBB0_27
	.p2align	4, , 16
.LBB0_24:                               # %vector.body515.preheader
                                        #   in Loop: Header=BB0_22 Depth=1
	move	$a3, $fp
	move	$t3, $t8
	move	$s2, $t7
	.p2align	4, , 16
.LBB0_25:                               # %vector.body515
	...
	addi.d	$a3, $a3, 32
	bnez	$s2, .LBB0_25
# %bb.26:                               # %middle.block520
                                        #   in Loop: Header=BB0_22 Depth=1
	move	$s2, $t7
	beq	$t7, $t1, .LBB0_21
.LBB0_27:                               # %scalar.ph510.preheader
                                        #   in Loop: Header=BB0_22 Depth=1
	alsl.d	$a3, $s2, $s1, 2
	alsl.d	$t3, $s2, $s0, 2
	sub.d	$s2, $t1, $s2
	.p2align	4, , 16
.LBB0_28:                               # %scalar.ph510
                                        #   Parent Loop BB0_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa0, $a3, 0
	fmul.s	$fa0, $fa0, $fa0
...
# %bb.32:                               #   in Loop: Header=BB0_31 Depth=1
	...
	b	.LBB0_36
	.p2align	4, , 16
.LBB0_33:                               # %vector.body531.preheader
                                        #   in Loop: Header=BB0_31 Depth=1
	move	$a3, $s0
	move	$a5, $fp
	move	$t3, $t8
...
.LBB0_34:                               # %vector.body531
	...
	addi.d	$a3, $a3, 32
	bnez	$s5, .LBB0_34
# %bb.35:                               # %middle.block538
                                        #   in Loop: Header=BB0_31 Depth=1
	move	$s5, $t7
	beq	$t7, $t1, .LBB0_30
.LBB0_36:                               # %scalar.ph526.preheader
                                        #   in Loop: Header=BB0_31 Depth=1
	alsl.d	$a3, $s5, $s3, 2
	alsl.d	$a5, $s5, $s4, 2
	alsl.d	$t3, $s5, $s2, 2
...
# %bb.41:                               #   in Loop: Header=BB0_40 Depth=1
	...
	b	.LBB0_45
	.p2align	4, , 16
.LBB0_42:                               # %vector.body548.preheader
                                        #   in Loop: Header=BB0_40 Depth=1
	move	$s0, $t6
	move	$t8, $t5
	move	$fp, $t4
	.p2align	4, , 16
.LBB0_43:                               # %vector.body548
	...
	addi.d	$s0, $s0, 32
	bnez	$fp, .LBB0_43
# %bb.44:                               # %middle.block553
                                        #   in Loop: Header=BB0_40 Depth=1
	move	$fp, $t4
	beq	$t4, $t1, .LBB0_39
.LBB0_45:                               # %scalar.ph543.preheader
                                        #   in Loop: Header=BB0_40 Depth=1
	alsl.d	$s0, $fp, $a4, 2
	alsl.d	$t8, $fp, $t7, 2
	sub.d	$fp, $t1, $fp
	.p2align	4, , 16
.LBB0_46:                               # %scalar.ph543
                                        #   Parent Loop BB0_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa0, $s0, 0
	fmul.s	$fa0, $fa0, $fa0
...
# %bb.52:                               #   in Loop: Header=BB0_51 Depth=1
	...
	b	.LBB0_56
	.p2align	4, , 16
.LBB0_53:                               # %vector.body568.preheader
                                        #   in Loop: Header=BB0_51 Depth=1
	move	$s6, $s4
	move	$s8, $s3
	move	$ra, $s7
	.p2align	4, , 16
.LBB0_54:                               # %vector.body568
	...
	addi.d	$s6, $s6, 16
	bnez	$s8, .LBB0_54
# %bb.55:                               # %middle.block579
                                        #   in Loop: Header=BB0_51 Depth=1
	move	$s8, $s3
	beq	$s3, $a1, .LBB0_50
.LBB0_56:                               # %scalar.ph563.preheader
                                        #   in Loop: Header=BB0_51 Depth=1
	slli.d	$s6, $s8, 2
	sub.d	$s8, $a1, $s8
	.p2align	4, , 16
.LBB0_57:                               # %scalar.ph563
                                        #   Parent Loop BB0_51 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$ra, $t0, $s6
	fldx.s	$fa2, $ra, $t6
...
# %bb.62:                               #   in Loop: Header=BB0_61 Depth=1
	...
	b	.LBB0_66
	.p2align	4, , 16
.LBB0_63:                               # %vector.body593.preheader
                                        #   in Loop: Header=BB0_61 Depth=1
	move	$s4, $s8
	move	$s3, $s5
	move	$t2, $s6
	.p2align	4, , 16
.LBB0_64:                               # %vector.body593
	...
	addi.d	$s4, $s4, 16
	bnez	$s3, .LBB0_64
# %bb.65:                               # %middle.block605
                                        #   in Loop: Header=BB0_61 Depth=1
	move	$t2, $s5
	beq	$s5, $a1, .LBB0_60
.LBB0_66:                               # %scalar.ph588.preheader
                                        #   in Loop: Header=BB0_61 Depth=1
	sub.d	$s3, $a1, $t2
	slli.d	$t2, $t2, 2
	.p2align	4, , 16
.LBB0_67:                               # %scalar.ph588
                                        #   Parent Loop BB0_61 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$s4, $a7, $t2
	fldx.s	$fa0, $a7, $t2
...
# %bb.71:                               #   in Loop: Header=BB0_70 Depth=1
	...
	b	.LBB0_75
	.p2align	4, , 16
.LBB0_72:                               # %vector.body619.preheader
                                        #   in Loop: Header=BB0_70 Depth=1
	move	$s7, $s4
	move	$s8, $s3
	move	$s6, $t2
	.p2align	4, , 16
.LBB0_73:                               # %vector.body619
	...
	addi.d	$s7, $s7, 16
	bnez	$s8, .LBB0_73
# %bb.74:                               # %middle.block631
                                        #   in Loop: Header=BB0_70 Depth=1
	move	$s6, $s3
	beq	$s3, $a1, .LBB0_69
.LBB0_75:                               # %scalar.ph614.preheader
                                        #   in Loop: Header=BB0_70 Depth=1
	sub.d	$s7, $a1, $s6
	slli.d	$s6, $s6, 2
	.p2align	4, , 16
.LBB0_76:                               # %scalar.ph614
                                        #   Parent Loop BB0_70 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$s8, $a6, $s6
	fldx.s	$fa0, $a6, $s6
...
# %bb.98:                               #   in Loop: Header=BB0_97 Depth=1
	...
	b	.LBB0_102
	.p2align	4, , 16
.LBB0_99:                               # %vector.body685.preheader
                                        #   in Loop: Header=BB0_97 Depth=1
	move	$a2, $t3
	move	$t4, $t2
	move	$t5, $t1
...
.LBB0_100:                              # %vector.body685
	...
	addi.d	$a2, $a2, 32
	bnez	$t6, .LBB0_100
# %bb.101:                              # %middle.block692
                                        #   in Loop: Header=BB0_97 Depth=1
	move	$t6, $a6
	beq	$a6, $a1, .LBB0_96
.LBB0_102:                              # %scalar.ph680.preheader
                                        #   in Loop: Header=BB0_97 Depth=1
	alsl.d	$a2, $t6, $a4, 2
	alsl.d	$t4, $t6, $a3, 2
	alsl.d	$t5, $t6, $t8, 2
