...
# %bb.39:
	...
	ld.d	$fp, $sp, 104
	beq	$a0, $fp, .LBB22_203
.LBB22_40:                              # %.lr.ph.i.i76.preheader
	addi.d	$s2, $a0, 312
	.p2align	4, , 16
.LBB22_41:                              # %.lr.ph.i.i76
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s2, 16
.Ltmp232:
	move	$a0, $s2
...
.LBB22_57:                              # %.lr.ph.i
	...
	bne	$a2, $a1, .LBB22_57
	b	.LBB22_47
.LBB22_58:                              # %._crit_edge250.loopexit.i
	addi.d	$s1, $s3, 1
	ld.d	$s4, $sp, 16                    # 8-byte Folded Reload
	b	.LBB22_60
.LBB22_59:
	ori	$s0, $zero, 10
.LBB22_60:                              # %._crit_edge250.i
.Ltmp89:
	lu12i.w	$a0, 2
	ori	$a0, $a0, 3160
	add.d	$a0, $sp, $a0
...
.LBB22_75:                              # %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i
	...
	addi.d	$s0, $s0, 32
	beq	$a0, $fp, .LBB22_78
.LBB22_76:                              # %.lr.ph.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s0, -16
	beq	$s0, $a0, .LBB22_75
# %bb.77:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i
                                        #   in Loop: Header=BB22_76 Depth=1
	ld.d	$a1, $s0, 0
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
# %bb.144:                              # %.lr.ph283.i
	...
	b	.LBB22_147
	.p2align	4, , 16
.LBB22_145:                             # %_ZN9benchmark8internal12_GLOBAL__N_16ReportEPNS_17BenchmarkReporterES3_RKNS0_10RunResultsE.exit.i
...
.LBB22_147:                             # =>This Loop Header: Depth=1
                                        #     Child Loop BB22_161 Depth 2
                                        #     Child Loop BB22_165 Depth 2
...
.Ltmp159:
	...
	jirl	$ra, $a3, 0
.Ltmp160:
# %bb.150:                              #   in Loop: Header=BB22_147 Depth=1
	beqz	$s2, .LBB22_152
# %bb.151:                              #   in Loop: Header=BB22_147 Depth=1
	ld.d	$a0, $s2, 0
	fld.d	$fa0, $s8, 88
	ld.bu	$a1, $s8, 112
	ld.d	$a2, $s8, 168
...
# %bb.153:                              #   in Loop: Header=BB22_147 Depth=1
	...
	ld.d	$a0, $s8, 64
	beqz	$a0, .LBB22_171
# %bb.154:                              #   in Loop: Header=BB22_147 Depth=1
	ld.w	$a2, $a0, 4
	ld.w	$a3, $a0, 0
	bne	$a2, $a3, .LBB22_171
...
.Ltmp170:
	...
	jirl	$ra, $ra, 0
.Ltmp171:
# %bb.157:                              #   in Loop: Header=BB22_147 Depth=1
	lu12i.w	$a0, 2
	ori	$a0, $a0, 3128
	add.d	$a0, $sp, $a0
	ld.d	$a3, $a0, 0
	...
	add.d	$a1, $sp, $a0
	beqz	$a3, .LBB22_168
# %bb.158:                              # %.lr.ph.i.i.i.i.preheader
                                        #   in Loop: Header=BB22_147 Depth=1
	ld.d	$a0, $s8, 0
	ld.w	$a0, $a0, 256
	lu12i.w	$a1, 2
...
# %bb.163:                              #   in Loop: Header=BB22_147 Depth=1
	...
	ori	$t1, $zero, 24
	beqz	$a4, .LBB22_166
# %bb.164:                              # %.lr.ph.i.i.i.i146.i.preheader
                                        #   in Loop: Header=BB22_147 Depth=1
	move	$a1, $a3
	.p2align	4, , 16
.LBB22_165:                             # %.lr.ph.i.i.i.i146.i
                                        #   Parent Loop BB22_147 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a5, $a4, 32
	slt	$a5, $a5, $a0
	...
	or	$a1, $a1, $a6
	bnez	$a4, .LBB22_165
.LBB22_166:                             # %_ZNKSt8_Rb_treeIiSt4pairIKiN9benchmark17BenchmarkReporter19PerFamilyRunReportsEESt10_Select1stIS5_ESt4lessIiESaIS5_EE14_M_lower_boundEPSt18_Rb_tree_node_baseSD_RS1_.exit.i.i.i.i
                                        #   in Loop: Header=BB22_147 Depth=1
	ld.d	$a3, $a3, 24
	beqz	$a3, .LBB22_169
	.p2align	4, , 16
.LBB22_167:                             # %.lr.ph.i25.i.i.i.i
                                        #   Parent Loop BB22_147 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a4, $a3, 32
	slt	$a4, $a0, $a4
...
# %bb.170:                              #   in Loop: Header=BB22_147 Depth=1
	...
	add.d	$a0, $sp, $a0
	ld.b	$a1, $a0, 0
.LBB22_171:                             #   in Loop: Header=BB22_147 Depth=1
	andi	$a0, $a1, 1
	beqz	$a0, .LBB22_174
# %bb.172:                              #   in Loop: Header=BB22_147 Depth=1
	lu12i.w	$a0, 1
	ori	$a0, $a0, 1560
	add.d	$a0, $sp, $a0
	ld.d	$a0, $a0, 0
	...
	ld.d	$a1, $a1, 0
	beq	$a0, $a1, .LBB22_174
# %bb.173:                              #   in Loop: Header=BB22_147 Depth=1
	bne	$a0, $a1, .LBB22_176
	b	.LBB22_177
	.p2align	4, , 16
...
# %bb.175:                              # %.noexc158.i
	...
	ld.d	$a1, $a1, 0
	beq	$a0, $a1, .LBB22_177
.LBB22_176:                             #   in Loop: Header=BB22_147 Depth=1
	ld.d	$a0, $s3, 0
	ld.d	$a2, $a0, 16
.Ltmp178:
	move	$a0, $s3
	...
	jirl	$ra, $a2, 0
.Ltmp179:
.LBB22_177:                             # %"_ZZN9benchmark8internal12_GLOBAL__N_16ReportEPNS_17BenchmarkReporterES3_RKNS0_10RunResultsEENK3$_0clES3_bS6_.exit.i.i"
                                        #   in Loop: Header=BB22_147 Depth=1
	move	$s1, $s3
	beqz	$s2, .LBB22_186
# %bb.178:                              # %.split10.i.i
...
# %bb.179:                              # %.split10.i.i
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB22_181
# %bb.180:                              #   in Loop: Header=BB22_147 Depth=1
	bne	$a0, $a1, .LBB22_183
	b	.LBB22_184
...
# %bb.182:                              # %.noexc160.i
	...
	ld.d	$a1, $a1, 0
	beq	$a0, $a1, .LBB22_184
.LBB22_183:                             #   in Loop: Header=BB22_147 Depth=1
	ld.d	$a0, $s2, 0
	ld.d	$a2, $a0, 16
.Ltmp182:
	move	$a0, $s2
	...
	jirl	$ra, $a2, 0
.Ltmp183:
.LBB22_184:                             # %"_ZZN9benchmark8internal12_GLOBAL__N_16ReportEPNS_17BenchmarkReporterES3_RKNS0_10RunResultsEENK3$_0clES3_bS6_.exit13.i.i"
                                        #   in Loop: Header=BB22_147 Depth=1
	ld.d	$a0, $s3, 8
.Ltmp184:
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
...
.Ltmp187:
	move	$s1, $s2
.LBB22_186:                             # %_ZN9benchmark8internal12_GLOBAL__N_112FlushStreamsEPNS_17BenchmarkReporterE.exit.sink.split.i.i
                                        #   in Loop: Header=BB22_147 Depth=1
	ld.d	$a0, $s1, 8
.Ltmp188:
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
...
# %bb.189:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB22_190:                             # %_ZNSt6vectorImSaImEED2Ev.exit.i
	lu12i.w	$a0, 2
	ori	$a0, $a0, 2448
	add.d	$a0, $sp, $a0
...
.Ltmp199:
	...
	jirl	$ra, $ra, 0
.Ltmp200:
# %bb.196:                              # %_ZN9benchmark8internal12_GLOBAL__N_112FlushStreamsEPNS_17BenchmarkReporterE.exit171.i
	beqz	$s2, .LBB22_199
# %bb.197:
	ld.d	$a0, $s2, 8
.Ltmp201:
...
.Ltmp203:
	...
	jirl	$ra, $ra, 0
.Ltmp204:
.LBB22_199:                             # %_ZN9benchmark8internal12_GLOBAL__N_112FlushStreamsEPNS_17BenchmarkReporterE.exit175.i
	lu12i.w	$a0, 2
	ori	$a0, $a0, 3128
	add.d	$a0, $sp, $a0
	ld.d	$a1, $a0, 0
...
# %bb.202:
	...
	ld.d	$fp, $sp, 104
	bne	$a0, $fp, .LBB22_40
.LBB22_203:                             # %_ZSt8_DestroyIPN9benchmark8internal17BenchmarkInstanceES2_EvT_S4_RSaIT0_E.exit.i
	beqz	$a0, .LBB22_205
.LBB22_204:
	ld.d	$a1, $sp, 112
	sub.d	$a1, $a1, $a0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB22_205:                             # %_ZNSt6vectorIN9benchmark8internal17BenchmarkInstanceESaIS2_EED2Ev.exit
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	beqz	$a0, .LBB22_207
# %bb.206:                              # %_ZNKSt14default_deleteIN9benchmark17BenchmarkReporterEEclEPS1_.exit.i81
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 40
	jirl	$ra, $a1, 0
.LBB22_207:                             # %_ZNSt10unique_ptrIN9benchmark17BenchmarkReporterESt14default_deleteIS1_EED2Ev.exit82
	beqz	$s4, .LBB22_209
# %bb.208:                              # %_ZNKSt14default_deleteIN9benchmark17BenchmarkReporterEEclEPS1_.exit.i84
	ld.d	$a0, $s4, 0
	ld.d	$a1, $a0, 40
	move	$a0, $s4
	jirl	$ra, $a1, 0
.LBB22_209:                             # %_ZNSt10unique_ptrIN9benchmark17BenchmarkReporterESt14default_deleteIS1_EED2Ev.exit85
	addi.d	$a0, $sp, 120
...
.Ltmp235:
	...
	jirl	$ra, $ra, 0
.Ltmp236:
# %bb.213:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
.Ltmp237:
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
	jirl	$ra, $ra, 0
.Ltmp238:
# %bb.214:                              # %_ZNSolsEPFRSoS_E.exit
.Ltmp239:
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
...
.Ltmp69:
	...
	jirl	$ra, $ra, 0
.Ltmp70:
# %bb.218:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit49
	ld.d	$a1, $fp, 0
	ld.d	$a2, $fp, 8
.Ltmp71:
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
...
.Ltmp73:
	...
	jirl	$ra, $ra, 0
.Ltmp74:
# %bb.220:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit52
.Ltmp75:
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
	jirl	$ra, $ra, 0
.Ltmp76:
# %bb.221:                              # %_ZNSolsEPFRSoS_E.exit54
.Ltmp77:
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
...
.Ltmp62:
	...
	jirl	$ra, $ra, 0
.Ltmp63:
# %bb.226:                              # %_ZNSt10unique_ptrIN9benchmark17BenchmarkReporterESt14default_deleteIS1_EED2Ev.exit.i
	lu12i.w	$a0, 1
	ori	$a0, $a0, 1536
	add.d	$a0, $sp, $a0
	ld.d	$a0, $a0, 0
...
.Ltmp145:
	...
	move	$s1, $a0
	beq	$a2, $s0, .LBB22_270
# %bb.238:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4.i.i
	ld.d	$a0, $sp, 648
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB22_260:
.Ltmp243:
.LBB22_261:                             # %_ZNSt10unique_ptrIN9benchmark17BenchmarkReporterESt14default_deleteIS1_EED2Ev.exit88
	st.d	$s4, $sp, 16                    # 8-byte Folded Spill
	move	$s1, $a0
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beqz	$a0, .LBB22_276
	b	.LBB22_278
.LBB22_262:                             # %.loopexit114
.Ltmp88:
	b	.LBB22_266
.LBB22_263:                             # %.loopexit.split-lp
.Ltmp231:
	b	.LBB22_265
.LBB22_264:
.Ltmp211:
...
.LBB22_266:                             # %.body
	move	$s1, $a0
	b	.LBB22_274
.LBB22_267:                             # %.loopexit.i
.Ltmp139:
	b	.LBB22_269
.LBB22_268:                             # %.loopexit.split-lp.i
.Ltmp142:
.LBB22_269:
	move	$s1, $a0
	move	$s5, $s7
...
# %bb.271:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB22_272:                             # %_ZNSt6vectorImSaImEED2Ev.exit167.i
	lu12i.w	$a0, 2
	ori	$a0, $a0, 2448
	add.d	$a0, $sp, $a0
	pcaddu18i	$ra, %call36(_ZNSt6vectorIN9benchmark8internal15BenchmarkRunnerESaIS2_EED2Ev)
...
.LBB22_274:                             # %.body
	...
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	bnez	$a0, .LBB22_277
# %bb.275:                              # %_ZNSt10unique_ptrIN9benchmark17BenchmarkReporterESt14default_deleteIS1_EED2Ev.exit88
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	bnez	$a0, .LBB22_278
.LBB22_276:                             # %_ZNSt10unique_ptrIN9benchmark17BenchmarkReporterESt14default_deleteIS1_EED2Ev.exit91
	addi.d	$a0, $sp, 120
	pcaddu18i	$ra, %call36(_ZNSt14basic_ofstreamIcSt11char_traitsIcEED1Ev)
	jirl	$ra, $ra, 0
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB22_277:                             # %_ZNKSt14default_deleteIN9benchmark17BenchmarkReporterEEclEPS1_.exit.i87
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 40
	jirl	$ra, $a1, 0
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beqz	$a0, .LBB22_276
.LBB22_278:                             # %_ZNKSt14default_deleteIN9benchmark17BenchmarkReporterEEclEPS1_.exit.i90
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 40
	jirl	$ra, $a1, 0
...
.Ltmp216:
	...
	move	$s1, $a0
	beq	$a2, $s0, .LBB22_274
# %bb.280:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i66
	lu12i.w	$a0, 1
	ori	$a0, $a0, 1552
	add.d	$a0, $sp, $a0
	ld.d	$a0, $a0, 0
