...
# %bb.5:                                # %.noexc30
	...
	addi.d	$a0, $a1, 4
	beq	$s5, $a2, .LBB9_7
# %bb.6:                                # %.lr.ph.i.preheader.i.i.i.i.i
	add.d	$s5, $a1, $s1
	addi.d	$a2, $s1, -4
	move	$a1, $zero
...
# %bb.24:                               # %._crit_edge.i29
	move	$a0, $fp
	bge	$s0, $a2, .LBB18_33
.LBB18_25:                              # %._crit_edge.thread.i37
	bne	$fp, $a1, .LBB18_32
	b	.LBB18_7
.LBB18_26:
	move	$a1, $a0
...
# %bb.30:                               # %._crit_edge.i48
	move	$a0, $fp
	bge	$s0, $a2, .LBB18_33
.LBB18_31:                              # %._crit_edge.thread.i56
	ld.d	$a0, $a1, 24
	beq	$fp, $a0, .LBB18_35
.LBB18_32:
	move	$a0, $fp
...
# %bb.9:
	move	$fp, $zero
	b	.LBB22_29
.LBB22_10:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit29
	bltu	$s5, $s6, .LBB22_12
	b	.LBB22_19
.LBB22_11:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit29.thread81
	bgeu	$s5, $s6, .LBB22_18
.LBB22_12:
	ld.d	$a0, $s1, 24
	beq	$a0, $fp, .LBB22_22
...
# %bb.14:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i31
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB22_16
.LBB22_15:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i34
	sub.d	$a0, $s3, $s5
	lu12i.w	$a1, -524288
	slt	$a2, $a1, $a0
	maskeqz	$a0, $a0, $a2
	...
	masknez	$a1, $a1, $a2
	or	$a0, $a0, $a1
.LBB22_16:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit38
	addi.w	$a0, $a0, 0
	addi.w	$a1, $zero, -1
	blt	$a1, $a0, .LBB22_28
# %bb.17:
	...
	or	$a1, $a0, $fp
	b	.LBB22_29
.LBB22_18:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i40
	move	$a0, $s3
	move	$a1, $s4
	move	$a2, $s2
	pcaddu18i	$ra, %call36(memcmp)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB22_20
.LBB22_19:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i43
	sub.d	$a0, $s6, $s5
	lu12i.w	$a1, -524288
	slt	$a2, $a1, $a0
	maskeqz	$a0, $a0, $a2
	...
	masknez	$a1, $a1, $a2
	or	$a0, $a0, $a1
.LBB22_20:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit47
	addi.w	$a0, $a0, 0
	addi.w	$s3, $zero, -1
	bge	$s3, $a0, .LBB22_23
# %bb.21:
...
# %bb.25:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i49
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB22_27
.LBB22_26:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i52
	sub.d	$a0, $s5, $s4
	lu12i.w	$a1, -524288
	slt	$a2, $a1, $a0
	maskeqz	$a0, $a0, $a2
	...
	masknez	$a1, $a1, $a2
	or	$a0, $a0, $a1
.LBB22_27:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit56
	addi.w	$a0, $a0, 0
	bge	$s3, $a0, .LBB22_31
.LBB22_28:
	move	$a0, $s1
