...
.LBB0_24:                               # %._crit_edge.i
	...
	ld.w	$s4, $sp, 192
	b	.LBB0_27
.LBB0_25:                               # %.readstream.exit_crit_edge.i.i
                                        #   in Loop: Header=BB0_12 Depth=2
	ld.w	$a3, $sp, 196
.LBB0_26:                               # %readstream.exit.i.i
                                        #   in Loop: Header=BB0_12 Depth=2
	ld.bu	$a2, $a2, 0
	ori	$a4, $zero, 8
	sub.d	$a4, $a4, $a0
...
# %bb.36:                               #   in Loop: Header=BB0_35 Depth=3
	...
	bltu	$a3, $s4, .LBB0_35
	b	.LBB0_38
.LBB0_37:                               # %..loopexit121_crit_edge.i.i
                                        #   in Loop: Header=BB0_12 Depth=2
	ld.w	$a0, $sp, 196
.LBB0_38:                               # %.loopexit121.i.i
                                        #   in Loop: Header=BB0_12 Depth=2
	ori	$a1, $zero, 8
	sub.d	$a1, $a1, $s4
	srl.w	$a0, $a0, $a1
...
# %bb.40:                               #   in Loop: Header=BB0_12 Depth=2
	...
	st.w	$a2, $a0, 0
	b	.LBB0_45
.LBB0_41:                               # %..loopexit123_crit_edge.i.i
                                        #   in Loop: Header=BB0_12 Depth=2
	ld.w	$s3, $sp, 196
.LBB0_42:                               # %.loopexit123.i.i
                                        #   in Loop: Header=BB0_12 Depth=2
	add.d	$a0, $a5, $s4
	addi.d	$a0, $a0, -3
	st.w	$a0, $sp, 192
...
.LBB0_49:                               #   in Loop: Header=BB0_12 Depth=2
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
.LBB0_50:                               # %.preheader.i.i.preheader293
                                        #   in Loop: Header=BB0_12 Depth=2
	move	$a1, $s2
	.p2align	4, , 16
...
.LBB0_81:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_91
.LBB0_82:                               # %vector.ph283
	bstrpick.d	$a0, $s2, 15, 1
	slli.d	$a0, $a0, 1
	addi.d	$a1, $fp, 36
	move	$a2, $a0
.LBB0_83:                               # %vector.body286
	...
	addi.d	$a1, $a1, 72
	bnez	$a2, .LBB0_83
# %bb.84:                               # %middle.block289
	beq	$a0, $s2, .LBB0_87
.LBB0_85:                               # %.lr.ph215.preheader292
	slli.d	$a1, $a0, 5
	alsl.d	$a1, $a0, $a1, 2
	add.d	$a1, $a1, $fp
	addi.d	$a1, $a1, 8
