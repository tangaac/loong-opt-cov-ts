...
# %bb.75:                               #   in Loop: Header=BB0_65 Depth=1
	...
	beq	$a0, $a1, .LBB0_86
	b	.LBB0_62
.LBB0_76:                               #   in Loop: Header=BB0_65 Depth=1
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(cli_malloc)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_78
...
.LBB0_100:                              # %chm_read_data.exit.thread.i110.i
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_101:                              # %chm_read_data.exit.thread.i110.i
                                        #   in Loop: Header=BB0_65 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_102:                              # %read_sys_control.exit.i
                                        #   in Loop: Header=BB0_65 Depth=1
	st.d	$zero, $sp, 136                 # 8-byte Folded Spill
.LBB0_103:                              # %read_sys_control.exit.i
                                        #   in Loop: Header=BB0_65 Depth=1
...
.LBB0_132:                              # %.sink.split.i70
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
.LBB0_133:                              # %.sink.split.i70
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
.LBB0_134:                              # %.sink.split.i70
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
...
# %bb.142:                              #   in Loop: Header=BB0_141 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB0_140
.LBB0_143:                              # %free_file_list.exit77
	beqz	$s2, .LBB0_145
# %bb.144:
	move	$a0, $s2
	move	$a1, $s1
...
.LBB0_160:                              #   in Loop: Header=BB0_152 Depth=1
	...
	b	.LBB0_163
.LBB0_161:                              #   in Loop: Header=BB0_152 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	sub.d	$a0, $a0, $s4
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
	b	.LBB0_163
.LBB0_162:                              #   in Loop: Header=BB0_152 Depth=1
	add.d	$a0, $s4, $s5
...
.LBB0_163:                              # %chm_copy_file_data.exit.i
	...
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_165
# %bb.164:                              #   in Loop: Header=BB0_152 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_165:                              # %.outer.i
...
.LBB0_167:
	...
	jirl	$ra, $ra, 0
	b	.LBB0_132
.LBB0_168:                              # %.thread.thread.i
	pcalau12i	$a0, %pc_hi20(.L.str.45)
	addi.d	$a0, $a0, %pc_lo12(.L.str.45)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	b	.LBB0_134
.LBB0_169:                              # %.thread.thread168.i
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	b	.LBB0_133
.Lfunc_end0:
