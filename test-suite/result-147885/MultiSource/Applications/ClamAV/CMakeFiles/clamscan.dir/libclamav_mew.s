...
.LBB1_17:
	...
	addi.d	$sp, $sp, 16
.LBB1_18:                               # %lzma_486248.exit.thread
	ret
.LBB1_19:
	ld.d	$t1, $a1, 0
	bltu	$t1, $a5, .LBB1_17
...
# %bb.46:
	...
	st.w	$t2, $a1, 8
	st.d	$t1, $a1, 0
.LBB1_47:                               # %lzma_486248.exit.i90
	add.d	$t1, $a7, $t0
	st.d	$t1, $a2, 0
	bltu	$t1, $a5, .LBB1_17
# %bb.48:                               # %lzma_486248.exit.i90
	addi.d	$t3, $t1, 4
	bltu	$a6, $t3, .LBB1_17
# %bb.49:
	ld.d	$t3, $a1, 0
...
# %bb.56:
	...
	st.w	$t1, $a1, 8
	st.d	$t3, $a1, 0
.LBB1_57:                               # %lzma_486248.exit.i90.1
	or	$t0, $t2, $t0
	alsl.d	$a7, $t0, $a7, 1
	st.d	$a7, $a2, 0
	bltu	$a7, $a5, .LBB1_17
# %bb.58:                               # %lzma_486248.exit.i90.1
	addi.d	$t2, $a7, 4
	bltu	$a6, $t2, .LBB1_17
# %bb.59:
	ld.d	$t2, $a1, 0
...
# %bb.65:
	...
	st.w	$t2, $a1, 8
	st.d	$t1, $a1, 0
.LBB1_66:                               # %lzma_486248.exit.i70
	add.d	$t1, $t0, $a7
	st.d	$t1, $a2, 0
	bltu	$t1, $a5, .LBB1_17
# %bb.67:                               # %lzma_486248.exit.i70
	addi.d	$t3, $t1, 4
	bltu	$a6, $t3, .LBB1_17
# %bb.68:
	ld.d	$t3, $a1, 0
...
# %bb.74:
	...
	st.w	$a2, $a1, 8
	st.d	$a7, $a1, 0
.LBB1_75:                               # %lzma_486248.exit.i90.2
	or	$a0, $a5, $a0
	ori	$a1, $zero, 8
	st.w	$a1, $a3, 0
	addi.d	$a1, $a0, -8
...
# %bb.79:
	...
	st.w	$t1, $a1, 8
	st.d	$t3, $a1, 0
.LBB1_80:                               # %lzma_486248.exit.i70.1
	or	$a7, $t2, $a7
	alsl.d	$t0, $a7, $t0, 1
	st.d	$t0, $a2, 0
	bltu	$t0, $a5, .LBB1_17
# %bb.81:                               # %lzma_486248.exit.i70.1
	addi.d	$t2, $t0, 4
	bltu	$a6, $t2, .LBB1_17
# %bb.82:
	ld.d	$t2, $a1, 0
...
# %bb.88:
	...
	st.w	$a2, $a1, 8
	st.d	$a7, $a1, 0
.LBB1_89:                               # %lzma_486248.exit.i70.2
	or	$a1, $a5, $a0
	ori	$a0, $zero, 8
	st.w	$a0, $a3, 0
	b	.LBB1_76
