...
.LBB1_4:                                # %.preheader.outer486.outer
                                        #   Parent Loop BB1_2 Depth=1
...
.LBB1_40:                               # %.loopexit2311
	...
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_4
.LBB1_41:                               # %.loopexit523.loopexit
                                        #   in Loop: Header=BB1_4 Depth=3
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_80
.LBB1_42:                               # %.loopexit529.loopexit
                                        #   in Loop: Header=BB1_4 Depth=3
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 160                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_87
.LBB1_43:                               # %.loopexit522.loopexit
                                        #   in Loop: Header=BB1_4 Depth=3
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_93
.LBB1_44:                               # %.loopexit1931
                                        #   in Loop: Header=BB1_4 Depth=3
	ld.d	$a3, $sp, 200                   # 8-byte Folded Reload
	addi.w	$a3, $a3, 0
	sltui	$a3, $a3, 1
	...
	b	.LBB1_82
.LBB1_45:                               # %.loopexit521.loopexit
                                        #   in Loop: Header=BB1_4 Depth=3
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$a5, $sp, 208                   # 8-byte Folded Reload
	b	.LBB1_90
.LBB1_46:                               # %.loopexit1810
                                        #   in Loop: Header=BB1_4 Depth=3
...
# %bb.57:                               #   in Loop: Header=BB1_4 Depth=3
	...
	ori	$a3, $zero, 19
	b	.LBB1_75
.LBB1_58:                               # %.loopexit4571
                                        #   in Loop: Header=BB1_4 Depth=3
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	bnez	$s7, .LBB1_79
	b	.LBB1_158
.LBB1_59:                               # %.loopexit2180
                                        #   in Loop: Header=BB1_4 Depth=3
	ori	$a3, $zero, 18
...
.LBB1_74:                               #   in Loop: Header=BB1_4 Depth=3
	...
	addi.d	$s1, $a3, 480
	ori	$a3, $zero, 9
.LBB1_75:                               # %.loopexit528.loopexit
                                        #   in Loop: Header=BB1_4 Depth=3
	st.d	$a3, $sp, 176                   # 8-byte Folded Spill
.LBB1_76:                               # %.loopexit528.loopexit
                                        #   in Loop: Header=BB1_4 Depth=3
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 160                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
...
.LBB1_98:                               # %.loopexit1947
	...
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_112
.LBB1_99:                               # %.preheader479.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a7, $sp, 136                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_115
.LBB1_100:                              # %.loopexit482.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a7, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_106
.LBB1_101:                              # %.loopexit483.loopexit
                                        #   in Loop: Header=BB1_3 Depth=2
	ld.d	$a4, $sp, 200                   # 8-byte Folded Reload
...
.LBB1_129:                              #   in Loop: Header=BB1_2 Depth=1
	...
	st.d	$a2, $sp, 200                   # 8-byte Folded Spill
	ori	$a7, $zero, 8
.LBB1_130:                              # %.loopexit484
                                        #   in Loop: Header=BB1_2 Depth=1
	ori	$a2, $zero, 3
.LBB1_131:                              # %.loopexit484
                                        #   in Loop: Header=BB1_2 Depth=1
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 184                   # 8-byte Folded Reload
	addi.w	$a3, $a2, 0
...
.LBB1_143:
	...
	move	$s7, $zero
	ori	$a3, $zero, 28
.LBB1_144:                              # %.loopexit480
	st.d	$a4, $sp, 136                   # 8-byte Folded Spill
.LBB1_145:                              # %.loopexit480
	ld.d	$t1, $sp, 208                   # 8-byte Folded Reload
.LBB1_146:                              # %.loopexit480
	ld.w	$a4, $sp, 224
	ld.h	$a5, $sp, 228
	move	$s2, $zero
