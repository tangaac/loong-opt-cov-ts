...
# %bb.318:                              #   in Loop: Header=BB0_317 Depth=2
	bne	$a3, $s7, .LBB0_315
	b	.LBB0_320
.LBB0_319:                              # %.loopexit3359.loopexit
                                        #   in Loop: Header=BB0_304 Depth=1
	addi.w	$a1, $s8, 1
	move	$a0, $s8
	move	$s8, $a1
.LBB0_320:                              # %.loopexit3359
                                        #   in Loop: Header=BB0_304 Depth=1
	bstrpick.d	$a0, $a0, 31, 0
	slli.d	$a0, $a0, 2
...
.LBB0_338:                              # %.critedge81
	...
	and	$a0, $a0, $a1
	beqz	$a0, .LBB0_362
# %bb.339:                              # %.preheader3358
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	move	$s8, $zero
	addi.d	$a0, $a0, -1
	beqz	$a0, .LBB0_362
# %bb.340:                              # %.lr.ph3454.preheader
	move	$s5, $zero
	bstrpick.d	$a1, $a0, 31, 0
	ori	$a2, $zero, 36
	mul.d	$a1, $a1, $a2
...
# %bb.564:                              # %middle.block3809
	...
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_567
.LBB0_565:                              # %.lr.ph3489.preheader3816
	slli.d	$a1, $a0, 5
	alsl.d	$a1, $a0, $a1, 2
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a2
...
# %bb.592:
	...
	bne	$a0, $a2, .LBB0_768
# %bb.593:                              # %.preheader3356
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 168                   # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_640
# %bb.594:                              # %.lr.ph3458.preheader
...
.LBB0_601:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_602:                              # %.critedge3021
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
.LBB0_603:                              # %.critedge3021
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s4
	b	.LBB0_646
...
# %bb.610:                              #   in Loop: Header=BB0_609 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_614
# %bb.611:                              #   in Loop: Header=BB0_609 Depth=1
	ld.wu	$a0, $s3, 12
	addi.w	$a1, $a0, -1
	bgeu	$a1, $s6, .LBB0_614
# %bb.612:                              #   in Loop: Header=BB0_609 Depth=1
	...
	add.d	$a2, $a1, $a0
	bltu	$s0, $a2, .LBB0_614
# %bb.613:                              #   in Loop: Header=BB0_609 Depth=1
	addi.w	$a2, $a0, 0
	move	$a0, $s1
	pcaddu18i	$ra, %call36(cli_readn)
	jirl	$ra, $ra, 0
...
# %bb.615:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_616:                              # %.critedge200.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_617:                              # %.critedge200
	ld.d	$a0, $fp, 56
	ld.bu	$a0, $a0, 1
	andi	$a0, $a0, 16
	beqz	$a0, .LBB0_624
...
.LBB0_646:                              # %.critedge3021
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_647:                              # %._crit_edge3494.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_671
...
.LBB0_667:                              # %.critedge3021
	...
	move	$a0, $s5
	b	.LBB0_646
.LBB0_668:                              # %.preheader3353
	beqz	$s0, .LBB0_728
# %bb.669:                              # %.lr.ph3480.preheader
	ori	$a0, $zero, 9
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB0_723
# %bb.670:
...
# %bb.725:                              # %middle.block3796
	...
	vpickve2gr.w	$s6, $vr0, 0
	beq	$a0, $s7, .LBB0_728
.LBB0_726:                              # %.lr.ph3480.preheader3820
	slli.d	$a1, $a0, 5
	alsl.d	$a1, $a0, $a1, 2
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a2
...
# %bb.732:
	...
	b	.LBB0_204
.LBB0_733:                              # %._crit_edge3481._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_734:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
# %bb.737:                              # %.lr.ph3484
	...
	sub.d	$s7, $a0, $a1
	b	.LBB0_739
.LBB0_738:                              #   in Loop: Header=BB0_739 Depth=1
	addi.d	$s8, $s8, 36
	beq	$s4, $s8, .LBB0_798
.LBB0_739:                              # =>This Inner Loop Header: Depth=1
	...
	ld.w	$a0, $s3, 12
	beqz	$a0, .LBB0_738
# %bb.740:                              #   in Loop: Header=BB0_739 Depth=1
	move	$a0, $s1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(cli_seeksect)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_770
# %bb.741:                              #   in Loop: Header=BB0_739 Depth=1
	ld.wu	$a0, $s3, 0
	ld.w	$a2, $s3, 12
	add.d	$a1, $s7, $a0
	move	$a0, $s1
...
.LBB0_760:
	...
	jirl	$ra, $ra, 0
	move	$a0, $s3
.LBB0_761:                              # %.critedge3021
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s5
.LBB0_762:                              # %.critedge3021
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	move	$a2, $zero
	pcaddu18i	$ra, %call36(cli_multifree)
	jirl	$ra, $ra, 0
...
# %bb.833:                              # %.lr.ph3462.preheader
	...
	ori	$a1, $zero, 1
	bgeu	$s0, $a2, .LBB0_895
.LBB0_834:                              # %.lr.ph3462.preheader3825
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s3, $a3
...
.LBB0_849:
	move	$s5, $s6
.LBB0_850:                              # %.thread3320.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_624
...
.LBB0_917:                              # %vector.body3775
	...
	vaddi.wu	$vr2, $vr2, 4
	bnez	$a3, .LBB0_917
# %bb.918:                              # %middle.block3782
	beq	$a1, $a0, .LBB0_921
.LBB0_919:                              # %scalar.ph3770.preheader
	slli.d	$a2, $a1, 1
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $a1, 3
	slli.d	$a1, $a1, 2
