...
.LBB23_66:
	...
	addi.w	$fp, $zero, -115
	move	$s8, $s0
.LBB23_67:                              # %.loopexit200thread-pre-split.sink.split
	move	$a0, $s7
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$s1, $fp
.LBB23_68:                              # %.loopexit200thread-pre-split
	ld.w	$a0, $s2, 0
	ori	$a1, $zero, 1
	bge	$a0, $a1, .LBB23_70
	b	.LBB23_72
