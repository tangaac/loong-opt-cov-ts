...
# %bb.100:
	andi	$a0, $s8, 1
	beqz	$a0, .LBB0_109
# %bb.101:                              # %.lr.ph705.split.preheader
	ld.d	$s0, $sp, 32                    # 8-byte Folded Reload
.LBB0_102:                              # %.lr.ph705.split
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s0, 0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
# %bb.108:                              #   in Loop: Header=BB0_107 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB0_106
.LBB0_109:                              # %._crit_edge706
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_26
.LBB0_110:                              # %.lr.ph701.peel.next.preheader
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	add.d	$s4, $a0, $s0
	addi.d	$s0, $fp, -1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
