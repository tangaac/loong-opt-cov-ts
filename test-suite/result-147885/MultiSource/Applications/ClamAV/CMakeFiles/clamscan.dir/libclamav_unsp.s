...
# %bb.26:                               #   in Loop: Header=BB1_15 Depth=1
	ori	$t5, $zero, 1
.LBB1_27:                               # %.preheader.preheader668
                                        #   in Loop: Header=BB1_15 Depth=1
	sub.w	$a1, $zero, $a2
	addi.w	$a5, $a4, -1
	move	$a3, $s8
...
.LBB1_194:                              # %get_byte.exit.i.i428
	...
	slli.d	$t4, $t6, 8
	b	.LBB1_197
.LBB1_195:                              #   in Loop: Header=BB1_183 Depth=2
	st.w	$s1, $sp, 192
	ori	$t6, $zero, 255
...
# %bb.220:                              # %middle.block663
	...
	beq	$a2, $a3, .LBB1_222
	.p2align	4, , 16
.LBB1_221:                              # %getbit_from_table.exit.us.i430
                                        #   Parent Loop BB1_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ori	$a3, $zero, 255
	sll.w	$a3, $a3, $a5
	...
	or	$a4, $a3, $a4
	bne	$a2, $a5, .LBB1_221
.LBB1_222:                              # %get_bb.exit
                                        #   in Loop: Header=BB1_15 Depth=1
	add.d	$a2, $a4, $a1
	ld.d	$t1, $sp, 120                   # 8-byte Folded Reload
	b	.LBB1_283
.LBB1_223:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t5, $sp, 192
	ori	$a1, $zero, 255
.LBB1_224:                              # %get_byte.exit.i377
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.d	$a0, $a0, 8
	or	$a0, $a1, $a0
	st.w	$a0, $sp, 188
	slli.d	$a0, $a2, 8
	st.w	$a0, $sp, 184
.LBB1_225:                              # %getbit_from_table.exit379
                                        #   in Loop: Header=BB1_15 Depth=1
	ori	$s5, $zero, 1
	beqz	$s8, .LBB1_1
# %bb.226:                              #   in Loop: Header=BB1_15 Depth=1
	beqz	$s2, .LBB1_1
...
# %bb.234:                              #   in Loop: Header=BB1_15 Depth=1
	...
	st.d	$a3, $sp, 168
	b	.LBB1_239
.LBB1_235:                              #   in Loop: Header=BB1_15 Depth=1
	move	$a6, $zero
	move	$t1, $t2
	b	.LBB1_241
...
.LBB1_238:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$t2, $zero, 255
.LBB1_239:                              # %get_byte.exit53.i.i450
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t2, $a4
	st.w	$a4, $sp, 188
	slli.d	$t1, $t1, 8
.LBB1_240:                              # %getbit_from_table.exit.i445
                                        #   in Loop: Header=BB1_15 Depth=1
	st.w	$t1, $sp, 184
.LBB1_241:                              # %getbit_from_table.exit.i445
	...
	alsl.d	$t2, $t3, $t2, 1
	bltu	$t2, $t0, .LBB1_247
# %bb.242:                              # %getbit_from_table.exit.i445
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t4, $t2, 2
	bltu	$a7, $t4, .LBB1_247
...
# %bb.246:                              #   in Loop: Header=BB1_15 Depth=1
	...
	st.d	$a3, $sp, 168
	b	.LBB1_253
.LBB1_247:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$t2, $zero, 255
	b	.LBB1_257
...
.LBB1_252:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$t1, $zero, 255
.LBB1_253:                              # %get_byte.exit.i.i453.1
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$t2, $zero
	slli.w	$a4, $a4, 8
	or	$a4, $t1, $a4
...
.LBB1_254:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$t4, $zero, 255
.LBB1_255:                              # %get_byte.exit53.i.i450.1
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t4, $a4
	st.w	$a4, $sp, 188
	slli.d	$t1, $t1, 8
.LBB1_256:                              # %getbit_from_table.exit.i445.1
                                        #   in Loop: Header=BB1_15 Depth=1
	st.w	$t1, $sp, 184
.LBB1_257:                              # %getbit_from_table.exit.i445.1
	...
	alsl.d	$t3, $t4, $t3, 1
	bltu	$t3, $t0, .LBB1_263
# %bb.258:                              # %getbit_from_table.exit.i445.1
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t5, $t3, 2
	bltu	$a7, $t5, .LBB1_263
...
# %bb.262:                              #   in Loop: Header=BB1_15 Depth=1
	...
	st.d	$a3, $sp, 168
	b	.LBB1_269
.LBB1_263:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$t3, $zero, 255
	b	.LBB1_273
...
.LBB1_268:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$t1, $zero, 255
.LBB1_269:                              # %get_byte.exit.i.i453.2
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$t3, $zero
	slli.w	$a4, $a4, 8
	or	$a4, $t1, $a4
...
.LBB1_270:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$t5, $zero, 255
.LBB1_271:                              # %get_byte.exit53.i.i450.2
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t5, $a4
	st.w	$a4, $sp, 188
	slli.d	$t1, $t1, 8
.LBB1_272:                              # %getbit_from_table.exit.i445.2
                                        #   in Loop: Header=BB1_15 Depth=1
	st.w	$t1, $sp, 184
.LBB1_273:                              # %getbit_from_table.exit.i445.2
	...
	alsl.d	$t4, $t4, $t5, 1
	bltu	$t4, $t0, .LBB1_279
# %bb.274:                              # %getbit_from_table.exit.i445.2
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t0, $t4, 2
	bltu	$a7, $t0, .LBB1_279
...
# %bb.278:                              #   in Loop: Header=BB1_15 Depth=1
	...
	st.d	$a3, $sp, 168
	b	.LBB1_289
.LBB1_279:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$a7, $zero, 2040
.LBB1_280:                              # %getbit_from_table.exit.i445.3
                                        #   in Loop: Header=BB1_15 Depth=1
	ld.d	$t1, $sp, 120                   # 8-byte Folded Reload
...
.LBB1_288:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$a5, $zero, 255
.LBB1_289:                              # %get_byte.exit.i.i453.3
                                        #   in Loop: Header=BB1_15 Depth=1
	ld.d	$t1, $sp, 120                   # 8-byte Folded Reload
	move	$a7, $zero
	slli.d	$a3, $a4, 8
...
.LBB1_290:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 192
	ori	$a5, $zero, 255
.LBB1_291:                              # %get_byte.exit53.i.i450.3
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.d	$a3, $a4, 8
	or	$a3, $a5, $a3
	st.w	$a3, $sp, 188
