...
# %bb.26:                               #   in Loop: Header=BB2_14 Depth=2
	...
	ori	$a1, $zero, 46
	blt	$a0, $a1, .LBB2_33
# %bb.27:                               #   in Loop: Header=BB2_14 Depth=2
	ld.w	$a0, $sp, 264
...
.LBB2_35:
	...
	addi.d	$a0, $a0, %pc_lo12(.L.str.16)
	move	$a1, $s1
.LBB2_36:                               # %__zip_find_disk_trailer.exit.thread
	pcaddu18i	$ra, %call36(cli_errmsg)
	jirl	$ra, $ra, 0
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free)
...
.LBB2_40:                               # %__zip_parse_root_directory.exit
	move	$a1, $s2
	b	.LBB2_5
.LBB2_41:                               # %._crit_edge.i
...
# %bb.50:                               #   in Loop: Header=BB2_45 Depth=1
	bne	$a1, $a2, .LBB2_53
# %bb.51:                               #   in Loop: Header=BB2_45 Depth=1
	move	$fp, $zero
...
# %bb.56:                               #   in Loop: Header=BB2_45 Depth=1
	...
	ld.d	$fp, $sp, 0                     # 8-byte Folded Reload
	bne	$a0, $s4, .LBB2_67
# %bb.57:                               #   in Loop: Header=BB2_45 Depth=1
	stx.b	$zero, $s5, $s4
	...
	bltu	$a0, $s3, .LBB2_68
# %bb.58:                               #   in Loop: Header=BB2_45 Depth=1
	add.d	$a0, $s1, $s4
	addi.d	$a0, $a0, 33
	andi	$a1, $a0, 1
	add.d	$a0, $a0, $a1
