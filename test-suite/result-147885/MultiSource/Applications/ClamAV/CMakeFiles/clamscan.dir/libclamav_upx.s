...
# %bb.22:
	bltz	$s6, .LBB1_80
# %bb.23:                               # %.lr.ph407.split.preheader
...
# %bb.26:                               # %.lr.ph420
	...
	bgeu	$a2, $a4, .LBB1_28
# %bb.27:                               # %select.unfold.us.preheader
	move	$a0, $zero
	add.d	$a1, $s0, $a3
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 1
	...
	sub.d	$s2, $s0, $a1
	b	.LBB1_39
.LBB1_28:                               # %.lr.ph420.split.preheader
	add.d	$a2, $s0, $a1
	add.d	$s2, $s0, $a3
	lu12i.w	$a0, 4
	ori	$a3, $a0, 1360
...
.LBB1_29:                               #   in Loop: Header=BB1_31 Depth=1
	move	$s3, $zero
	.p2align	4, , 16
.LBB1_30:                               # %select.unfold
                                        #   in Loop: Header=BB1_31 Depth=1
	addi.d	$s2, $s2, -1
	bgeu	$s0, $s2, .LBB1_38
.LBB1_31:                               # %.lr.ph420.split
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $s2, 248
	bltu	$a2, $a0, .LBB1_30
...
# %bb.44:                               # %.lr.ph438
	move	$a1, $zero
	beqz	$s6, .LBB1_62
# %bb.45:                               # %.lr.ph438.split.preheader
	add.w	$a2, $s6, $s1
	addi.d	$a0, $a0, 12
	.p2align	4, , 16
.LBB1_46:                               # %.lr.ph438.split
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a0, -4
	beqz	$s3, .LBB1_48
...
.LBB1_67:
	...
	bgeu	$s4, $a1, .LBB1_25
	b	.LBB1_40
.LBB1_68:                               # %.critedge9..critedge7.loopexit_crit_edge
...
# %bb.78:                               # %.preheader
	...
	bltu	$a0, $a3, .LBB1_73
# %bb.79:                               #   in Loop: Header=BB1_77 Depth=3
	ld.bu	$a5, $a3, -2
	addi.d	$a2, $a3, 1
	bnez	$a5, .LBB1_77
	b	.LBB1_73
...
# %bb.15:                               #   in Loop: Header=BB2_11 Depth=1
	...
	addi.d	$s1, $s0, 4
	bltu	$a7, $s1, .LBB2_75
# %bb.16:                               # %doubleebx.exit160.thread
                                        #   in Loop: Header=BB2_11 Depth=1
	ld.w	$s0, $s0, 0
	slli.d	$s1, $s0, 1
	addi.d	$s2, $s1, 1
...
.LBB2_37:
	slli.d	$fp, $s0, 1
.LBB2_38:                               # %doubleebx.exit184
	bstrpick.d	$s0, $s0, 31, 31
	slli.d	$s1, $s1, 1
	or	$s0, $s1, $s0
	addi.w	$s1, $s0, 0
	bnez	$s1, .LBB2_51
# %bb.39:                               # %.preheader275.preheader
	ori	$s0, $zero, 1
	b	.LBB2_42
...
# %bb.48:                               #   in Loop: Header=BB2_42 Depth=1
	...
	addi.d	$s1, $fp, 4
	bltu	$a7, $s1, .LBB2_75
# %bb.49:                               # %doubleebx.exit190.thread
                                        #   in Loop: Header=BB2_42 Depth=1
	ld.w	$fp, $fp, 0
	slli.d	$s1, $fp, 1
	addi.d	$s1, $s1, 1
...
# %bb.15:                               #   in Loop: Header=BB3_11 Depth=1
	...
	addi.d	$s1, $s0, 4
	bltu	$a7, $s1, .LBB3_87
# %bb.16:                               # %doubleebx.exit165.thread
                                        #   in Loop: Header=BB3_11 Depth=1
	ld.w	$s0, $s0, 0
	slli.d	$s1, $s0, 1
	addi.d	$s2, $s1, 1
...
# %bb.31:
	...
	addi.d	$fp, $fp, 1
	addi.w	$t3, $t3, 4
.LBB3_32:                               # %doubleebx.exit195
	addi.w	$s0, $s0, 0
	bltz	$s0, .LBB3_73
# %bb.33:                               # %.preheader309.preheader
	ori	$s0, $zero, 1
	b	.LBB3_36
...
# %bb.42:                               #   in Loop: Header=BB3_36 Depth=1
	...
	addi.d	$s1, $fp, 4
	bltu	$a7, $s1, .LBB3_87
# %bb.43:                               # %doubleebx.exit207.thread
                                        #   in Loop: Header=BB3_36 Depth=1
	ld.w	$fp, $fp, 0
	slli.d	$s1, $fp, 1
	addi.d	$s1, $s1, 1
