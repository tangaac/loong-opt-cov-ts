...
.LBB5_5:                                # %vector.body116
	...
	addi.d	$a6, $a6, -16
	bnez	$a7, .LBB5_5
# %bb.6:                                # %middle.block124
                                        #   in Loop: Header=BB5_1 Depth=1
	beq	$a4, $a5, .LBB5_9
.LBB5_7:                                # %scalar.ph108.preheader
                                        #   in Loop: Header=BB5_1 Depth=1
	addi.d	$a3, $a3, -2
	.p2align	4, , 16
.LBB5_8:                                # %scalar.ph108
...
# %bb.30:                               #   in Loop: Header=BB19_2 Depth=1
	...
	st.d	$a0, $s1, 32
	b	.LBB19_1
.LBB19_31:                              # %thread-pre-split133.split.loop.exit180
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 3
	b	.LBB19_38
.LBB19_32:                              # %thread-pre-split133.split.loop.exit178
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 4
	b	.LBB19_38
.LBB19_33:                              # %thread-pre-split133.split.loop.exit176
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 5
	b	.LBB19_38
.LBB19_34:                              # %thread-pre-split133.split.loop.exit174
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 6
	b	.LBB19_38
.LBB19_35:                              # %thread-pre-split133.split.loop.exit172
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 7
	b	.LBB19_38
.LBB19_36:                              # %thread-pre-split133.split.loop.exit170
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 8
	b	.LBB19_38
.LBB19_37:                              # %thread-pre-split133.split.loop.exit168
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 9
...
# %bb.33:
	ld.d	$a0, $s0, 16
	st.d	$a0, $s0, 32
.LBB21_34:                              # %flush_pending.exit146
	ld.d	$a0, $fp, 0
	ld.w	$a0, $a0, 32
	sltui	$a0, $a0, 1
	xori	$a0, $a0, 3
...
# %bb.38:
	ld.d	$a0, $s0, 16
	st.d	$a0, $s0, 32
.LBB21_39:                              # %flush_pending.exit148
	ld.d	$a0, $fp, 0
	ld.w	$a0, $a0, 32
	beqz	$a0, .LBB21_41
.LBB21_40:
...
# %bb.52:
	ld.d	$a0, $s0, 16
	st.d	$a0, $s0, 32
.LBB22_53:                              # %flush_pending.exit186
	ld.d	$a0, $fp, 0
	ld.w	$a0, $a0, 32
	sltui	$a0, $a0, 1
	xori	$a0, $a0, 3
...
# %bb.57:
	ld.d	$a0, $s0, 16
	st.d	$a0, $s0, 32
.LBB22_58:                              # %flush_pending.exit188
	ld.d	$a0, $fp, 0
	ld.w	$a0, $a0, 32
	beqz	$a0, .LBB22_60
.LBB22_59:
...
# %bb.14:                               #   in Loop: Header=BB23_6 Depth=2
	...
	move	$s0, $s1
	bltu	$s2, $t6, .LBB23_6
.LBB23_15:                              # %.critedge.split.loop.exit152
...
.LBB23_16:                              # %.critedge.split.loop.exit
	...
	blt	$a4, $fp, .LBB23_23
	b	.LBB23_25
.LBB23_17:                              # %.critedge.split.loop.exit140
                                        #   in Loop: Header=BB23_1 Depth=1
	addi.d	$fp, $s1, 4
	sub.d	$s0, $fp, $a7
	addi.w	$fp, $s0, 258
	blt	$a4, $fp, .LBB23_23
	b	.LBB23_25
.LBB23_18:                              # %.critedge.split.loop.exit142
                                        #   in Loop: Header=BB23_1 Depth=1
	addi.d	$fp, $s1, 5
	sub.d	$s0, $fp, $a7
	addi.w	$fp, $s0, 258
	blt	$a4, $fp, .LBB23_23
	b	.LBB23_25
.LBB23_19:                              # %.critedge.split.loop.exit144
                                        #   in Loop: Header=BB23_1 Depth=1
	addi.d	$fp, $s1, 6
	sub.d	$s0, $fp, $a7
	addi.w	$fp, $s0, 258
	blt	$a4, $fp, .LBB23_23
	b	.LBB23_25
.LBB23_20:                              # %.critedge.split.loop.exit146
                                        #   in Loop: Header=BB23_1 Depth=1
	addi.d	$fp, $s1, 7
	sub.d	$s0, $fp, $a7
	addi.w	$fp, $s0, 258
	blt	$a4, $fp, .LBB23_23
	b	.LBB23_25
.LBB23_21:                              # %.critedge.split.loop.exit148
                                        #   in Loop: Header=BB23_1 Depth=1
	addi.d	$fp, $s1, 8
	sub.d	$s0, $fp, $a7
	addi.w	$fp, $s0, 258
	blt	$a4, $fp, .LBB23_23
	b	.LBB23_25
.LBB23_22:                              # %.critedge.split.loop.exit150
                                        #   in Loop: Header=BB23_1 Depth=1
	addi.d	$fp, $s1, 9
	sub.d	$s0, $fp, $a7
	addi.w	$fp, $s0, 258
