...
.LBB8_22:
	...
	move	$a2, $a0
	b	.LBB8_43
.LBB8_23:                               # %.preheader.split.us.preheader
	ld.w	$a0, $fp, 152
	lu12i.w	$s2, 262144
	lu12i.w	$s3, -524288
	lu32i.d	$s3, 0
...
.LBB8_30:                               #   in Loop: Header=BB8_24 Depth=1
	...
	jirl	$ra, $ra, 0
	beq	$a0, $s4, .LBB8_45
# %bb.31:                               #   in Loop: Header=BB8_24 Depth=1
	ld.w	$a0, $fp, 152
	bne	$s5, $a0, .LBB8_24
	b	.LBB8_40
.LBB8_32:
	...
	lu32i.d	$s3, 0
	addi.w	$s4, $zero, -2
.LBB8_33:                               # %.preheader.split.split.us
                                        # =>This Loop Header: Depth=1
