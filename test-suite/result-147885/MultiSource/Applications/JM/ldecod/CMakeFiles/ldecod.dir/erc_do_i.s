...
# %bb.83:                               #   in Loop: Header=BB2_77 Depth=1
	move	$fp, $zero
.LBB2_84:                               # %vec.epilog.vector.body198.preheader
                                        #   in Loop: Header=BB2_77 Depth=1
	sub.d	$t7, $a2, $fp
	alsl.d	$t8, $fp, $a1, 1
	alsl.d	$fp, $fp, $t0, 1
	.p2align	4, , 16
.LBB2_85:                               # %vec.epilog.vector.body198
                                        #   Parent Loop BB2_77 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $fp, 0
	vand.v	$vr1, $vr1, $vr0
	...
	bnez	$t7, .LBB2_85
	b	.LBB2_76
.LBB2_86:                               # %vector.body183.preheader
                                        #   in Loop: Header=BB2_77 Depth=1
	move	$t7, $a0
	move	$t8, $t5
	move	$fp, $t2
	.p2align	4, , 16
.LBB2_87:                               # %vector.body183
                                        #   Parent Loop BB2_77 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $t8, -16
	vld	$vr2, $t8, 0
	...
	addi.d	$t7, $t7, 32
	bnez	$fp, .LBB2_87
# %bb.88:                               # %middle.block188
                                        #   in Loop: Header=BB2_77 Depth=1
	beq	$t2, $a2, .LBB2_76
# %bb.89:                               # %vec.epilog.iter.check193
                                        #   in Loop: Header=BB2_77 Depth=1
	move	$t8, $t2
	move	$fp, $t2
	beqz	$t3, .LBB2_80
...
.LBB2_111:                              # %vec.epilog.vector.body
	...
	bnez	$t5, .LBB2_111
	b	.LBB2_102
.LBB2_112:                              # %vector.body158.preheader
                                        #   in Loop: Header=BB2_103 Depth=1
	move	$t5, $t2
	move	$t6, $a0
	move	$t7, $a7
	.p2align	4, , 16
.LBB2_113:                              # %vector.body158
                                        #   Parent Loop BB2_103 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $t5, -16
	vld	$vr2, $t5, 0
