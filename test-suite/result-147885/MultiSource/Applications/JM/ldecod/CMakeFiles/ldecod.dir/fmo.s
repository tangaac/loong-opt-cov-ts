...
# %bb.31:                               # %middle.block134
	beq	$a2, $s4, .LBB0_34
.LBB0_32:                               # %scalar.ph124.preheader
	sub.d	$a3, $s4, $a2
	alsl.d	$a0, $a2, $a0, 2
	alsl.d	$a1, $a2, $a1, 2
	.p2align	4, , 16
.LBB0_33:                               # %scalar.ph124
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a1, 0
	st.w	$a2, $a0, 0
	addi.d	$a3, $a3, -1
...
# %bb.49:                               # %.lr.ph.i.i
	...
	addi.w	$a2, $a2, 1
	bltu	$a3, $a5, .LBB0_52
# %bb.50:                               # %vector.memcheck102
	ori	$a3, $s3, 1728
	add.d	$a3, $a4, $a3
	bgeu	$a0, $a3, .LBB0_115
# %bb.51:                               # %vector.memcheck102
	alsl.d	$a3, $s4, $a0, 2
	bgeu	$a1, $a3, .LBB0_115
.LBB0_52:
	move	$a3, $zero
.LBB0_53:                               # %scalar.ph104.preheader
	sub.d	$a4, $s4, $a3
	alsl.d	$a0, $a3, $a0, 2
	.p2align	4, , 16
.LBB0_54:                               # %scalar.ph104
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a1, 0
	addi.w	$a6, $a3, 0
	div.wu	$a6, $a6, $a5
...
.LBB0_75:                               # %vector.body72
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_75
# %bb.76:                               # %middle.block75
	beq	$a4, $s4, .LBB0_21
.LBB0_77:                               # %scalar.ph63.preheader
	alsl.d	$a0, $a4, $a0, 2
	.p2align	4, , 16
.LBB0_78:                               # %scalar.ph63
                                        # =>This Inner Loop Header: Depth=1
...
.LBB0_80:                               # %vector.body96
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_80
# %bb.81:                               # %middle.block99
	beq	$a1, $s4, .LBB0_84
.LBB0_82:                               # %.lr.ph.i39.i.preheader147
	sub.d	$a3, $s4, $a1
	alsl.d	$a0, $a1, $a0, 2
	.p2align	4, , 16
.LBB0_83:                               # %.lr.ph.i39.i
...
.LBB0_94:                               # %vector.body83
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB0_94
# %bb.95:                               # %middle.block86
	beq	$a3, $s4, .LBB0_98
.LBB0_96:                               # %.lr.ph.i48.i.preheader149
	sub.d	$a6, $s4, $a3
	alsl.d	$a3, $a3, $a0, 2
	ori	$a7, $zero, 2
	.p2align	4, , 16
