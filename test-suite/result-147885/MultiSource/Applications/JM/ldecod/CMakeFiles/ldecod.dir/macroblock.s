...
# %bb.74:                               # %.preheader1216
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB15_153
# %bb.75:                               # %.preheader1216.split
                                        #   in Loop: Header=BB15_72 Depth=2
	addi.w	$s5, $zero, -5
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	beqz	$a0, .LBB15_154
# %bb.76:                               # %.preheader1213.us1246.preheader
                                        #   in Loop: Header=BB15_72 Depth=2
	ld.w	$a0, $s8, 40
	lu32i.d	$s5, 0
	and	$a1, $a0, $s5
...
# %bb.96:                               #   in Loop: Header=BB15_91 Depth=3
	...
	ori	$a0, $zero, 16
	bltu	$s4, $a0, .LBB15_91
.LBB15_97:                              # %.loopexit1209.us.us.11405
                                        #   in Loop: Header=BB15_72 Depth=2
	ld.w	$a0, $s8, 40
	and	$a1, $a0, $s1
	addi.w	$a1, $a1, 0
...
.LBB15_104:                             # %.preheader1214
	...
	b	.LBB15_107
	.p2align	4, , 16
.LBB15_105:                             # %.preheader1212.split.us
...
# %bb.108:                              # %.preheader1212.split
	...
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	beqz	$a0, .LBB15_115
# %bb.109:                              # %.preheader1212.split.split.us.preheader
                                        #   in Loop: Header=BB15_107 Depth=3
	addi.d	$a5, $sp, 488
	addi.d	$a6, $sp, 424
	addi.d	$a7, $sp, 420
...
# %bb.114:                              #   in Loop: Header=BB15_113 Depth=4
	...
	b	.LBB15_112
	.p2align	4, , 16
.LBB15_115:                             # %.preheader1212.split.split.preheader
                                        #   in Loop: Header=BB15_107 Depth=3
	addi.d	$a5, $sp, 488
	addi.d	$a6, $sp, 424
	addi.d	$a7, $sp, 420
...
.LBB15_126:                             # %.loopexit1201.us
	...
	sub.d	$a1, $zero, $a1
	beqz	$a2, .LBB15_143
# %bb.127:                              # %.preheader1202.us.1
                                        #   in Loop: Header=BB15_107 Depth=3
	ld.d	$ra, $sp, 304                   # 8-byte Folded Reload
	blez	$a0, .LBB15_106
# %bb.128:                              # %.lr.ph1258.us.1
                                        #   in Loop: Header=BB15_107 Depth=3
...
# %bb.142:                              #   in Loop: Header=BB15_141 Depth=4
	...
	stx.w	$a5, $a7, $a6
	b	.LBB15_140
.LBB15_143:                             # %.preheader1200.us.1
                                        #   in Loop: Header=BB15_107 Depth=3
	ld.d	$ra, $sp, 304                   # 8-byte Folded Reload
	blez	$a0, .LBB15_106
# %bb.144:                              # %.lr.ph1261.us.1
                                        #   in Loop: Header=BB15_107 Depth=3
...
# %bb.152:                              #   in Loop: Header=BB15_151 Depth=4
	...
	stx.w	$a5, $a6, $a7
	b	.LBB15_150
.LBB15_153:                             # %.preheader1213.us.preheader
                                        #   in Loop: Header=BB15_72 Depth=2
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	stptr.w	$a0, $ra, 5612
	stptr.w	$a3, $ra, 5608
	b	.LBB15_71
.LBB15_154:                             # %.preheader1213.preheader
                                        #   in Loop: Header=BB15_72 Depth=2
	st.d	$s5, $sp, 240                   # 8-byte Folded Spill
	addi.d	$fp, $a5, 1
	move	$s1, $s6
	b	.LBB15_156
	.p2align	4, , 16
.LBB15_155:                             # %.loopexit1211.1
                                        #   in Loop: Header=BB15_156 Depth=3
	addi.d	$s1, $s1, 1
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	beq	$s1, $a0, .LBB15_71
.LBB15_156:                             # %.preheader1213
                                        #   Parent Loop BB15_69 Depth=1
                                        #     Parent Loop BB15_72 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB15_157 Depth 4
...
.LBB15_170:
	...
	ldx.w	$a0, $a0, $a1
	beqz	$a0, .LBB15_273
# %bb.171:                              # %.preheader1199
	ldptr.w	$a1, $ra, 5924
	vrepli.b	$vr4, 0
	lu12i.w	$a0, -1
	blez	$a1, .LBB15_174
# %bb.172:                              # %.preheader1198.lr.ph
	lu12i.w	$a7, 1
	ori	$a1, $a7, 872
	add.d	$a1, $ra, $a1
	ori	$a2, $zero, 3
...
.LBB15_189:                             #   in Loop: Header=BB15_178 Depth=1
	...
	addi.d	$s3, $a1, %pc_lo12(SCAN_YUV422)
	beqz	$a0, .LBB15_216
# %bb.190:                              # %.preheader1194
                                        #   in Loop: Header=BB15_178 Depth=1
	slli.d	$a0, $s7, 2
	lu12i.w	$a1, 4080
	sll.d	$s0, $a1, $a0
...
# %bb.213:                              # %.lr.ph1310
	...
	ori	$a3, $zero, 5
	bge	$a2, $a3, .LBB15_245
# %bb.214:                              # %.lr.ph1310.split.us.preheader
                                        #   in Loop: Header=BB15_178 Depth=1
	sub.d	$a2, $a3, $a2
	bgeu	$a1, $s4, .LBB15_261
...
# %bb.220:                              #   in Loop: Header=BB15_219 Depth=2
	...
	b	.LBB15_218
	.p2align	4, , 16
.LBB15_221:                             # %.loopexit1193
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$a6, $sp, 352
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	beqz	$a0, .LBB15_223
# %bb.222:                              # %.loopexit1192.thread
                                        #   in Loop: Header=BB15_178 Depth=1
	ori	$a4, $zero, 768
	mul.d	$a0, $s7, $a4
	ld.w	$a1, $sp, 356
...
# %bb.224:                              # %.split1293.us
	...
	beqz	$s3, .LBB15_247
# %bb.225:                              # %.split1293.us.split.us.preheader
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$s3, $a3, 0
	mul.d	$s2, $s2, $s3
	add.d	$s2, $s2, $a2
...
.LBB15_233:                             # %.split1325.split
	...
	stptr.w	$t1, $t0, 2944
	ld.w	$t1, $a4, 0
.LBB15_234:                             # %.split1327.us
                                        #   in Loop: Header=BB15_236 Depth=2
	mul.d	$t1, $t1, $t2
	sll.w	$t1, $t1, $a1
.LBB15_235:                             # %.split1327.us
                                        #   in Loop: Header=BB15_236 Depth=2
	addi.w	$t1, $t1, 2
	srli.d	$t1, $t1, 2
	addi.d	$a7, $a7, 768
...
.LBB15_243:                             # %.split1293
	...
	beqz	$fp, .LBB15_249
# %bb.244:                              # %.split1293.split.us.preheader
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$fp, $a3, 0
	mul.d	$fp, $s2, $fp
	sll.w	$fp, $fp, $a4
	...
	ld.w	$t7, $a3, 0
	b	.LBB15_250
.LBB15_245:                             # %.lr.ph1310.split.preheader
                                        #   in Loop: Header=BB15_178 Depth=1
	addi.d	$a2, $a2, -5
	bgeu	$a1, $s4, .LBB15_266
# %bb.246:                              #   in Loop: Header=BB15_178 Depth=1
	move	$a3, $zero
	b	.LBB15_269
.LBB15_247:                             # %.split1293.us.split.preheader
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$s3, $a0, 0
	mul.d	$s2, $s2, $s3
	add.d	$s2, $s2, $a2
...
.LBB15_248:                             # %.split1295.us
	...
	sra.w	$t7, $t7, $a1
	b	.LBB15_251
.LBB15_249:                             # %.split1293.split.preheader
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$fp, $a0, 0
	mul.d	$fp, $s2, $fp
	sll.w	$fp, $fp, $a4
	...
	st.w	$t7, $t6, 320
	ld.w	$t7, $a0, 0
.LBB15_250:                             # %.split1295.us
                                        #   in Loop: Header=BB15_178 Depth=1
	mul.d	$t7, $t7, $t8
	sll.w	$t7, $t7, $a4
.LBB15_251:                             # %.split1295.us
                                        #   in Loop: Header=BB15_178 Depth=1
	sub.d	$a7, $a6, $a7
	sub.d	$t8, $t0, $t1
	sub.d	$t0, $t2, $t3
	...
	ori	$t5, $zero, 24
	bge	$a5, $t5, .LBB15_254
# %bb.252:                              # %.split1293.us.1
                                        #   in Loop: Header=BB15_178 Depth=1
	beqz	$t4, .LBB15_256
# %bb.253:                              # %.split1293.us.split.us.preheader.1
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$a0, $a3, 0
	mul.d	$a0, $t3, $a0
	add.d	$a0, $a0, $a2
	...
	ld.w	$a0, $a3, 0
	b	.LBB15_257
.LBB15_254:                             # %.split1293.1
                                        #   in Loop: Header=BB15_178 Depth=1
	sub.d	$a1, $t0, $t1
	beqz	$t4, .LBB15_258
# %bb.255:                              # %.split1293.split.us.preheader.1
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$a0, $a3, 0
	mul.d	$a0, $t3, $a0
	sll.w	$a0, $a0, $a4
	...
	ld.w	$a0, $a3, 0
	b	.LBB15_259
.LBB15_256:                             # %.split1293.us.split.preheader.1
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$a3, $a0, 0
	mul.d	$a3, $t3, $a3
	add.d	$a3, $a3, $a2
...
.LBB15_257:                             # %.split1295.us.1
	...
	sra.w	$a0, $a0, $a1
	b	.LBB15_260
.LBB15_258:                             # %.split1293.split.preheader.1
                                        #   in Loop: Header=BB15_178 Depth=1
	ld.w	$a2, $a0, 0
	mul.d	$a2, $t3, $a2
	sll.w	$a2, $a2, $a4
	...
	st.w	$a2, $a6, 320
	ld.w	$a0, $a0, 0
.LBB15_259:                             # %.split1295.us.1
                                        #   in Loop: Header=BB15_178 Depth=1
	mul.d	$a0, $a0, $a1
	sll.w	$a0, $a0, $a4
.LBB15_260:                             # %.split1295.us.1
                                        #   in Loop: Header=BB15_178 Depth=1
	addi.w	$a0, $a0, 2
	srli.d	$a0, $a0, 2
	st.w	$a0, $a6, 384
...
# %bb.263:                              # %middle.block
                                        #   in Loop: Header=BB15_178 Depth=1
	beq	$a3, $a1, .LBB15_176
.LBB15_264:                             # %.lr.ph1310.split.us.preheader1880
                                        #   in Loop: Header=BB15_178 Depth=1
	addi.d	$a4, $sp, 388
	alsl.d	$a4, $a3, $a4, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB15_265:                             # %.lr.ph1310.split.us
                                        #   Parent Loop BB15_178 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a4, 0
	mul.d	$a3, $a0, $a3
...
.LBB15_267:                             # %vector.body1766
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB15_267
# %bb.268:                              # %middle.block1771
                                        #   in Loop: Header=BB15_178 Depth=1
	beq	$a3, $a1, .LBB15_176
.LBB15_269:                             # %.lr.ph1310.split.preheader1881
                                        #   in Loop: Header=BB15_178 Depth=1
	addi.d	$a4, $sp, 388
	alsl.d	$a4, $a3, $a4, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB15_270:                             # %.lr.ph1310.split
                                        #   Parent Loop BB15_178 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a4, 0
	mul.d	$a3, $a0, $a3
	...
	bnez	$a1, .LBB15_270
	b	.LBB15_176
.LBB15_271:                             # %.loopexit1197
	ori	$a0, $zero, 31
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	blt	$a0, $a1, .LBB15_274
.LBB15_272:                             # %.loopexit1179
	ld.wu	$a0, $ra, 4
	ldptr.d	$a1, $ra, 5560
	slli.d	$a0, $a0, 3
	ldx.d	$a0, $a1, $a0
...
# %bb.280:                              # %switch.lookup1835
	...
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	beqz	$a0, .LBB15_294
# %bb.281:                              # %.preheader1172.preheader
                                        #   in Loop: Header=BB15_279 Depth=2
	move	$s7, $zero
	addi.d	$s0, $zero, -1
	.p2align	4, , 16
.LBB15_282:                             # %.preheader1172
...
# %bb.293:                              #   in Loop: Header=BB15_292 Depth=3
	...
	b	.LBB15_291
	.p2align	4, , 16
.LBB15_294:                             # %.preheader1174.preheader
                                        #   in Loop: Header=BB15_279 Depth=2
	move	$s7, $zero
	addi.d	$s0, $zero, -1
	.p2align	4, , 16
.LBB15_295:                             # %.preheader1174
                                        #   Parent Loop BB15_277 Depth=1
                                        #     Parent Loop BB15_279 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a0, $sp, 552
...
# %bb.300:                              #   in Loop: Header=BB15_295 Depth=3
	...
	stx.w	$a0, $a1, $a2
	ori	$a0, $zero, 15
	bltu	$s0, $a0, .LBB15_295
	b	.LBB15_278
.LBB15_301:                             # %.preheader1170
                                        #   in Loop: Header=BB15_279 Depth=2
	blez	$a0, .LBB15_278
# %bb.302:                              # %.lr.ph1339
                                        #   in Loop: Header=BB15_279 Depth=2
...
# %bb.39:                               # %middle.block200
	beq	$a2, $a4, .LBB21_42
.LBB21_40:                              # %.lr.ph167.preheader205
	alsl.d	$a2, $a1, $s0, 2
	addi.d	$a3, $a3, -1
	.p2align	4, , 16
.LBB21_41:                              # %.lr.ph167
