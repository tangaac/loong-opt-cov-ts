...
.LBB11_48:
	pcalau12i	$a1, %pc_hi20(listXsize)
	ld.wu	$a0, $s7, 32
	addi.d	$s6, $a1, %pc_lo12(listXsize)
	ori	$a1, $zero, 0
	lu32i.d	$a1, 1
	st.d	$a1, $s6, 0
	beqz	$a0, .LBB11_174
...
.LBB21_30:                              # %vector.body118
	...
	addi.d	$t2, $t2, -16
	bnez	$a4, .LBB21_30
# %bb.31:                               # %middle.block122
                                        #   in Loop: Header=BB21_8 Depth=1
	beq	$a3, $t1, .LBB21_34
.LBB21_32:                              # %.lr.ph.i69.preheader129
                                        #   in Loop: Header=BB21_8 Depth=1
	alsl.d	$a3, $t0, $s4, 3
	.p2align	4, , 16
.LBB21_33:                              # %.lr.ph.i69
