...
# %bb.9:                                #   in Loop: Header=BB8_7 Depth=2
	...
	b	.LBB8_15
	.p2align	4, , 16
.LBB8_10:                               # %.lr.ph.split.us.split.us964.us
                                        #   in Loop: Header=BB8_7 Depth=2
	sub.w	$a1, $s5, $a1
	addi.w	$t0, $zero, -128
	slt	$a5, $t0, $a1
...
# %bb.14:                               # %middle.block
	...
	move	$a1, $s7
	beq	$s7, $s2, .LBB8_6
.LBB8_15:                               # %.lr.ph.split.us.split.us.us.us.preheader1269
                                        #   in Loop: Header=BB8_7 Depth=2
	slli.d	$a5, $a1, 7
	sub.d	$t0, $s2, $a1
	.p2align	4, , 16
...
# %bb.19:                               # %middle.block1256
	...
	move	$a5, $s7
	beq	$s7, $s2, .LBB8_6
.LBB8_20:                               # %scalar.ph1246.preheader
                                        #   in Loop: Header=BB8_7 Depth=2
	slli.d	$a1, $a5, 7
	add.d	$s1, $ra, $a1
	alsl.d	$t4, $a5, $s6, 3
...
.LBB8_22:                               # %.preheader940.us.preheader
	...
	b	.LBB8_24
	.p2align	4, , 16
.LBB8_23:                               # %._crit_edge.split.us960
...
# %bb.113:                              # %.lr.ph981.us.preheader
	...
	b	.LBB8_115
	.p2align	4, , 16
.LBB8_114:                              # %._crit_edge982.us
                                        #   in Loop: Header=BB8_115 Depth=1
	addi.d	$t6, $t6, 1
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	beq	$t6, $a1, .LBB8_58
.LBB8_115:                              # %.lr.ph981.us
                                        # =>This Loop Header: Depth=1
