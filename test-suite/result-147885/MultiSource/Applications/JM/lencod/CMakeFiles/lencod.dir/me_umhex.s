...
.LBB4_11:                               # %.thread
	...
	ld.d	$t7, $a2, %got_pc_lo12(ref_pic_sub)
	lu12i.w	$t8, 1
	ori	$a2, $t8, 2296
	ldx.w	$a2, $a5, $a2
...
.LBB4_77:                               # %.loopexit1027
	ld.d	$a3, $sp, 216                   # 8-byte Folded Reload
.LBB4_78:                               # %.loopexit1027
	srai.d	$s6, $t7, 18
	srai.d	$s7, $t8, 18
	ori	$a0, $zero, 1
	ext.w.h	$s0, $s0
...
.LBB4_84:
	...
	jirl	$ra, $ra, 0
	pcalau12i	$t5, %pc_hi20(pred_SAD)
	ld.w	$a2, $t5, %pc_lo12(pred_SAD)
	slli.d	$a0, $fp, 2
...
# %bb.151:                              #   in Loop: Header=BB4_146 Depth=1
	...
	move	$ra, $a0
	.p2align	4, , 16
.LBB4_152:                              #   in Loop: Header=BB4_146 Depth=1
	add.w	$a0, $t3, $s1
	srai.d	$a1, $a0, 31
	xor	$a0, $a0, $a1
	sub.w	$a0, $a0, $a1
...
# %bb.157:                              #   in Loop: Header=BB4_146 Depth=1
	...
	move	$ra, $a0
	b	.LBB4_145
.LBB4_158:                              #   in Loop: Header=BB4_160 Depth=1
	move	$ra, $a0
	move	$s1, $t3
	move	$s2, $s4
	ld.d	$s6, $sp, 216                   # 8-byte Folded Reload
...
# %bb.161:                              #   in Loop: Header=BB4_160 Depth=1
	...
	sub.w	$a1, $a2, $a1
	bltu	$t0, $a1, .LBB4_165
# %bb.162:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a1, $t2, %pc_lo12(McostState)
	add.w	$a2, $s4, $t0
	slli.d	$s2, $a2, 3
	ldx.d	$a1, $a1, $s2
	...
	ldx.bu	$a0, $a1, $fp
	bnez	$a0, .LBB4_165
# %bb.163:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $s1, 2
	ld.d	$a1, $sp, 328                   # 8-byte Folded Reload
	...
	addi.w	$s3, $ra, 0
	bge	$s5, $s3, .LBB4_165
# %bb.164:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	ld.w	$a2, $a2, %pc_lo12(dist_method)
	slli.d	$a2, $a2, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
	...
	b	.LBB4_166
	.p2align	4, , 16
.LBB4_165:                              #   in Loop: Header=BB4_160 Depth=1
	move	$s1, $t3
.LBB4_166:                              #   in Loop: Header=BB4_160 Depth=1
	sub.w	$s3, $t3, $a7
	srai.d	$a0, $s3, 31
	xor	$a1, $s3, $a0
	sub.w	$s5, $a1, $a0
	blt	$t0, $s5, .LBB4_172
# %bb.167:                              #   in Loop: Header=BB4_160 Depth=1
	addi.w	$fp, $t4, 1
	sub.w	$a0, $fp, $t1
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
	sub.w	$a1, $a2, $a1
	bltu	$t0, $a1, .LBB4_172
# %bb.168:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a1, $t2, %pc_lo12(McostState)
	add.w	$a0, $a0, $t0
	slli.d	$s7, $a0, 3
	ldx.d	$a0, $a1, $s7
	...
	ldx.bu	$a0, $a0, $s2
	bnez	$a0, .LBB4_172
# %bb.169:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $t3, 2
	ld.d	$a1, $sp, 328                   # 8-byte Folded Reload
	...
	addi.w	$s8, $ra, 0
	bge	$s6, $s8, .LBB4_172
# %bb.170:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	ld.w	$a2, $a2, %pc_lo12(dist_method)
	slli.d	$a2, $a2, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
...
# %bb.171:                              #   in Loop: Header=BB4_160 Depth=1
	...
	b	.LBB4_173
	.p2align	4, , 16
.LBB4_172:                              #   in Loop: Header=BB4_160 Depth=1
	move	$s2, $t4
.LBB4_173:                              #   in Loop: Header=BB4_160 Depth=1
	addi.w	$s7, $t3, 1
	sub.w	$a0, $s7, $a7
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
	sub.w	$a1, $a2, $a1
	blt	$t0, $a1, .LBB4_179
# %bb.174:                              #   in Loop: Header=BB4_160 Depth=1
	srai.d	$a1, $s4, 31
	xor	$a2, $s4, $a1
	sub.w	$a1, $a2, $a1
	bltu	$t0, $a1, .LBB4_179
# %bb.175:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a1, $t2, %pc_lo12(McostState)
	add.w	$a2, $s4, $t0
	slli.d	$s4, $a2, 3
	ldx.d	$a1, $a1, $s4
	...
	ldx.bu	$a0, $a1, $fp
	bnez	$a0, .LBB4_179
# %bb.176:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $s7, 2
	ld.d	$a1, $sp, 328                   # 8-byte Folded Reload
	...
	addi.w	$s8, $ra, 0
	bge	$s6, $s8, .LBB4_179
# %bb.177:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	ld.w	$a2, $a2, %pc_lo12(dist_method)
	slli.d	$a2, $a2, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
	...
	stx.b	$a2, $a1, $fp
	bge	$a0, $s8, .LBB4_179
# %bb.178:                              #   in Loop: Header=BB4_160 Depth=1
	move	$s2, $t4
	move	$s1, $s7
	move	$ra, $a0
	.p2align	4, , 16
...
# %bb.180:                              #   in Loop: Header=BB4_160 Depth=1
	...
	sub.w	$a1, $a2, $a1
	bltu	$t0, $a1, .LBB4_184
# %bb.181:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a1, $t2, %pc_lo12(McostState)
	add.w	$a0, $a0, $t0
	slli.d	$s5, $a0, 3
	ldx.d	$a0, $a1, $s5
	...
	ldx.bu	$a0, $a0, $fp
	bnez	$a0, .LBB4_184
# %bb.182:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $t3, 2
	ld.d	$a1, $sp, 328                   # 8-byte Folded Reload
	...
	addi.w	$s3, $ra, 0
	bge	$s7, $s3, .LBB4_184
# %bb.183:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	ld.w	$a2, $a2, %pc_lo12(dist_method)
	slli.d	$a2, $a2, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
	...
	blt	$a0, $s3, .LBB4_158
	.p2align	4, , 16
.LBB4_184:                              #   in Loop: Header=BB4_160 Depth=1
	ld.d	$s6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$s7, $sp, 208                   # 8-byte Folded Reload
	bne	$s1, $t3, .LBB4_159
# %bb.185:                              #   in Loop: Header=BB4_160 Depth=1
	bne	$s2, $t4, .LBB4_159
	b	.LBB4_236
.LBB4_186:
	move	$t5, $t4
...
.LBB4_194:
	ld.d	$s6, $sp, 216                   # 8-byte Folded Reload
	ld.d	$s7, $sp, 208                   # 8-byte Folded Reload
.LBB4_195:                              # %.loopexit1022
	ori	$a0, $zero, 1
	blt	$t0, $a0, .LBB4_236
# %bb.196:                              # %.preheader1019.preheader
	move	$a1, $zero
...
.LBB4_198:                              # %.preheader1019
	...
	b	.LBB4_200
	.p2align	4, , 16
.LBB4_199:                              #   in Loop: Header=BB4_200 Depth=2
	addi.d	$s8, $s8, 4
	beq	$s8, $a6, .LBB4_206
.LBB4_200:                              #   Parent Loop BB4_198 Depth=1
	...
	sub.w	$a1, $a2, $a1
	blt	$t0, $a1, .LBB4_199
# %bb.201:                              #   in Loop: Header=BB4_200 Depth=2
	ldx.w	$a1, $a5, $s8
	add.w	$fp, $a1, $s7
	sub.w	$a1, $fp, $t1
	srai.d	$a2, $a1, 31
	...
	sub.w	$a2, $a3, $a2
	bltu	$t0, $a2, .LBB4_199
# %bb.202:                              #   in Loop: Header=BB4_200 Depth=2
	ld.d	$a2, $t2, %pc_lo12(McostState)
	add.w	$a1, $a1, $t0
	slli.d	$s3, $a1, 3
	ldx.d	$a1, $a2, $s3
	...
	ldx.bu	$a0, $a1, $s1
	bnez	$a0, .LBB4_199
# %bb.203:                              #   in Loop: Header=BB4_200 Depth=2
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $s0, 2
	ld.d	$a1, $sp, 328                   # 8-byte Folded Reload
	...
	addi.w	$s4, $ra, 0
	bge	$s6, $s4, .LBB4_199
# %bb.204:                              #   in Loop: Header=BB4_200 Depth=2
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	ld.w	$a2, $a2, %pc_lo12(dist_method)
	slli.d	$a2, $a2, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
	...
	stx.b	$a2, $a1, $s1
	bge	$a0, $s4, .LBB4_199
# %bb.205:                              #   in Loop: Header=BB4_200 Depth=2
	move	$t4, $fp
	move	$t3, $s0
	move	$ra, $a0
	b	.LBB4_199
	.p2align	4, , 16
.LBB4_206:                              #   in Loop: Header=BB4_198 Depth=1
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	bne	$t3, $s5, .LBB4_197
# %bb.207:                              #   in Loop: Header=BB4_198 Depth=1
	bne	$t4, $s7, .LBB4_197
# %bb.208:
	move	$t4, $s7
	move	$t3, $s5
	b	.LBB4_139
.LBB4_209:                              # %.preheader1024.preheader
...
# %bb.214:                              #   in Loop: Header=BB4_212 Depth=1
	...
	ldx.bu	$a0, $a3, $s8
	bnez	$a0, .LBB4_211
# %bb.215:                              #   in Loop: Header=BB4_212 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a3, $a0, 0
	slli.d	$a0, $s5, 2
	...
	addi.w	$s0, $ra, 0
	bge	$s4, $s0, .LBB4_210
# %bb.216:                              #   in Loop: Header=BB4_212 Depth=1
	st.d	$t4, $sp, 312                   # 8-byte Folded Spill
	move	$s1, $t3
	...
	add.w	$a0, $a0, $s4
	bge	$a0, $s0, .LBB4_218
# %bb.217:                              #   in Loop: Header=BB4_212 Depth=1
	move	$t4, $s7
	move	$t3, $s5
	move	$ra, $a0
	ld.d	$a7, $sp, 272                   # 8-byte Folded Reload
	...
	ld.d	$t1, $sp, 288                   # 8-byte Folded Reload
	b	.LBB4_219
.LBB4_218:                              #   in Loop: Header=BB4_212 Depth=1
	ld.d	$a7, $sp, 272                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 296                   # 8-byte Folded Reload
	ld.d	$t1, $sp, 288                   # 8-byte Folded Reload
	move	$ra, $s6
...
# %bb.222:
	...
	ld.d	$s7, $sp, 208                   # 8-byte Folded Reload
	blt	$t0, $a0, .LBB4_195
# %bb.223:                              # %.preheader1021.preheader
...
.LBB4_224:                              # %.preheader1021
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB4_227 Depth 2
	move	$s2, $zero
	st.d	$a0, $sp, 152                   # 8-byte Folded Spill
	b	.LBB4_227
.LBB4_225:                              #   in Loop: Header=BB4_227 Depth=2
	ld.d	$a6, $sp, 104                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_226:                              #   in Loop: Header=BB4_227 Depth=2
	addi.d	$s2, $s2, 4
	beq	$s2, $t6, .LBB4_233
.LBB4_227:                              #   Parent Loop BB4_224 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a0, $s2, $s3
	ldx.w	$a2, $a5, $s2
	ldx.w	$a1, $s2, $s4
...
# %bb.229:                              #   in Loop: Header=BB4_227 Depth=2
	...
	ldx.bu	$a0, $a1, $fp
	bnez	$a0, .LBB4_226
# %bb.230:                              #   in Loop: Header=BB4_227 Depth=2
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $s7, 2
	ld.d	$a1, $sp, 328                   # 8-byte Folded Reload
...
# %bb.232:                              #   in Loop: Header=BB4_227 Depth=2
	...
	move	$ra, $a0
	b	.LBB4_226
.LBB4_233:                              #   in Loop: Header=BB4_224 Depth=1
	addi.w	$a0, $ra, 0
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	blt	$a0, $a1, .LBB4_235
# %bb.234:                              #   in Loop: Header=BB4_224 Depth=1
...
.LBB4_236:                              # %.loopexit
	...
	blt	$a0, $a2, .LBB4_253
# %bb.237:                              # %.preheader.lr.ph
	ld.d	$a1, $sp, 304                   # 8-byte Folded Reload
	srai.d	$a1, $a1, 2
	blt	$a1, $a2, .LBB4_253
# %bb.238:                              # %.preheader.us.preheader
	move	$a2, $zero
	...
	b	.LBB4_240
	.p2align	4, , 16
.LBB4_239:                              # %._crit_edge1107.us
                                        #   in Loop: Header=BB4_240 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB4_253
.LBB4_240:                              # %.preheader.us
                                        # =>This Loop Header: Depth=1
...
# %bb.241:                              # %.lr.ph1106.split.us1112
	...
	move	$t7, $a1
	.p2align	4, , 16
.LBB4_242:                              #   Parent Loop BB4_240 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t8, $t4, 180
	srli.d	$t8, $t8, 2
	ld.w	$fp, $t4, 176
	...
	b	.LBB4_239
	.p2align	4, , 16
.LBB4_243:                              # %.lr.ph1106.split.us.us
                                        #   in Loop: Header=BB4_240 Depth=1
	...
	slli.d	$t3, $t5, 2
	beqz	$s3, .LBB4_246
# %bb.244:                              # %.lr.ph1106.split.us.split.us1115.preheader
                                        #   in Loop: Header=BB4_240 Depth=1
	bgeu	$a1, $t2, .LBB4_248
# %bb.245:                              #   in Loop: Header=BB4_240 Depth=1
	move	$t5, $zero
	b	.LBB4_251
.LBB4_246:                              # %.lr.ph1106.split.us.split.us.us
                                        #   in Loop: Header=BB4_240 Depth=1
	...
	move	$fp, $s7
	.p2align	4, , 16
.LBB4_247:                              #   Parent Loop BB4_240 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s0, $t6, 0
	stx.w	$ra, $s0, $t3
	ld.w	$s0, $t4, 180
	...
	bnez	$t8, .LBB4_247
	b	.LBB4_239
.LBB4_248:                              # %vector.body.preheader
                                        #   in Loop: Header=BB4_240 Depth=1
	add.d	$t4, $t6, $a5
	move	$t5, $a3
	.p2align	4, , 16
.LBB4_249:                              # %vector.body
...
# %bb.250:                              # %middle.block
	...
	move	$t5, $a3
	beq	$a3, $a1, .LBB4_239
.LBB4_251:                              # %.lr.ph1106.split.us.split.us1115.preheader1194
                                        #   in Loop: Header=BB4_240 Depth=1
	add.d	$t4, $t6, $a4
	alsl.d	$t4, $t5, $t4, 3
	sub.d	$t5, $a1, $t5
	.p2align	4, , 16
.LBB4_252:                              # %.lr.ph1106.split.us.split.us1115
                                        #   Parent Loop BB4_240 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $t4, 0
	stx.w	$ra, $t6, $t3
...
# %bb.254:
	ldx.w	$a2, $a4, $a1
	bge	$a0, $a2, .LBB4_256
.LBB4_255:                              # %._crit_edge1109._crit_edge
	stx.w	$ra, $a4, $a1
.LBB4_256:
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	sub.d	$a1, $s5, $a1
	...
	addi.d	$sp, $sp, 592
	ret
.LBB4_257:                              # %.lr.ph1053.split.preheader
	...
	b	.LBB4_260
.LBB4_258:                              #   in Loop: Header=BB4_260 Depth=1
	ld.d	$a2, $sp, 176                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_259:                              #   in Loop: Header=BB4_260 Depth=1
	addi.d	$s2, $s2, 2
	addi.d	$s0, $s0, 2
	addi.d	$t7, $t7, 8
	addi.d	$t6, $t6, 8
...
.LBB4_260:                              # %.lr.ph1053.split
	...
	sub.w	$a0, $a0, $a1
	bltu	$t0, $a0, .LBB4_266
# %bb.261:                              #   in Loop: Header=BB4_260 Depth=1
	ld.d	$a0, $t2, %pc_lo12(McostState)
	add.d	$a0, $a0, $a2
	ldx.d	$a0, $a0, $s7
	ldx.bu	$a0, $a0, $a5
	bnez	$a0, .LBB4_266
# %bb.262:                              #   in Loop: Header=BB4_260 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	slli.d	$a1, $a6, 2
	ldx.w	$a1, $a0, $a1
	...
	addi.w	$a0, $ra, 0
	bge	$fp, $a0, .LBB4_265
# %bb.263:                              #   in Loop: Header=BB4_260 Depth=1
	...
	bge	$a0, $a1, .LBB4_266
# %bb.264:                              #   in Loop: Header=BB4_260 Depth=1
	add.w	$t5, $t4, $s0
	st.d	$a3, $sp, 104                   # 8-byte Folded Spill
	move	$ra, $a0
	b	.LBB4_266
.LBB4_265:                              #   in Loop: Header=BB4_260 Depth=1
	ld.d	$a2, $sp, 176                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_266:                              #   in Loop: Header=BB4_260 Depth=1
	add.w	$a0, $t4, $s8
	srai.d	$a1, $a0, 31
	xor	$a0, $a0, $a1
	sub.w	$a0, $a0, $a1
	bltu	$t0, $a0, .LBB4_259
# %bb.267:                              #   in Loop: Header=BB4_260 Depth=1
	ld.d	$a0, $t2, %pc_lo12(McostState)
	add.d	$a0, $a0, $a2
	ldx.d	$a0, $a0, $s4
	ldx.bu	$a0, $a0, $a5
	bnez	$a0, .LBB4_259
# %bb.268:                              #   in Loop: Header=BB4_260 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	slli.d	$a1, $a6, 2
	ldx.w	$a1, $a0, $a1
	...
	addi.w	$a0, $ra, 0
	bge	$fp, $a0, .LBB4_258
# %bb.269:                              #   in Loop: Header=BB4_260 Depth=1
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.w	$a0, $a0, %pc_lo12(dist_method)
	slli.d	$a0, $a0, 3
	...
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	bge	$a0, $a1, .LBB4_259
# %bb.270:                              #   in Loop: Header=BB4_260 Depth=1
	add.w	$t5, $t4, $t8
	st.d	$a3, $sp, 104                   # 8-byte Folded Spill
	move	$ra, $a0
	b	.LBB4_259
