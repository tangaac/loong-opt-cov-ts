...
# %bb.2:                                # %.preheader60
	...
	ld.d	$a0, $s8, %pc_lo12(direct_ref_idx)
	ld.d	$a4, $a0, 0
	ld.d	$a0, $a0, 8
	ldx.d	$a4, $a4, $s0
	ldx.d	$a0, $a0, $s0
...
# %bb.3:                                # %.preheader60.1
                                        #   in Loop: Header=BB8_1 Depth=1
	ld.d	$a3, $s8, %pc_lo12(direct_ref_idx)
	ld.d	$a4, $a3, 0
	ld.d	$a3, $a3, 8
	ldx.d	$a4, $a4, $s0
	ldx.d	$a3, $a3, $s0
