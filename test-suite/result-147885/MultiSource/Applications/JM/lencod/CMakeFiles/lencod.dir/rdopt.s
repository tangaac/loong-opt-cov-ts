...
.LBB10_5:                               #   in Loop: Header=BB10_7 Depth=1
	ld.d	$t7, $t3, %pc_lo12(direct_ref_idx)
	ld.d	$t8, $t1, 0
	ld.d	$t7, $t7, 0
	ldptr.d	$t8, $t8, 6488
	ldx.d	$t7, $t7, $t5
...
# %bb.22:                               #   in Loop: Header=BB10_7 Depth=1
	pcalau12i	$t8, %pc_hi20(best8x8bwref)
	addi.d	$t8, $t8, %pc_lo12(best8x8bwref)
	alsl.d	$t8, $a0, $t8, 2
	ldx.bu	$t8, $t8, $t6
.LBB10_23:                              # %.split.1
                                        #   in Loop: Header=BB10_7 Depth=1
...
# %bb.40:                               #   in Loop: Header=BB10_7 Depth=1
	pcalau12i	$t6, %pc_hi20(best8x8bwref)
	addi.d	$t6, $t6, %pc_lo12(best8x8bwref)
	alsl.d	$t6, $a0, $t6, 2
	ldx.bu	$t6, $t6, $t7
.LBB10_41:                              # %.split.3
                                        #   in Loop: Header=BB10_7 Depth=1
...
# %bb.2:                                # %.preheader154.preheader
	...
	addi.d	$a5, $fp, 392
	pcalau12i	$a0, %got_pc_hi20(enc_picture)
	ld.d	$a6, $a0, %got_pc_lo12(enc_picture)
	ori	$a7, $s4, 2064
	ori	$t0, $s4, 2068
	ori	$t1, $zero, 4
	b	.LBB12_4
