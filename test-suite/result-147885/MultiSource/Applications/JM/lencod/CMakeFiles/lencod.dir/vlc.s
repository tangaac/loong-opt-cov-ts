...
.LBB24_4:
	...
	slli.d	$a4, $a5, 8
	alsl.d	$a6, $a5, $a4, 4
	pcalau12i	$a4, %pc_hi20(writeSyntaxElement_NumCoeffTrailingOnes.lentab)
	addi.d	$a4, $a4, %pc_lo12(writeSyntaxElement_NumCoeffTrailingOnes.lentab)
	add.d	$a4, $a4, $a6
	add.d	$a4, $a4, $a3
	slli.d	$a7, $a2, 2
	ldx.w	$a4, $a4, $a7
