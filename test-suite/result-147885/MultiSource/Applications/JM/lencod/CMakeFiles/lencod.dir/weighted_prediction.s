...
.LBB0_19:                               # %.preheader117.preheader
	...
	ori	$t8, $zero, 32
	lu32i.d	$t8, 32
	pcalau12i	$fp, %pc_hi20(ref_pic_sub)
	b	.LBB0_22
	.p2align	4, , 16
.LBB0_20:                               # %._crit_edge141.split
                                        #   in Loop: Header=BB0_22 Depth=1
	st.d	$s5, $fp, %pc_lo12(ref_pic_sub)
...
.LBB2_20:                               # %._crit_edge160.split
	...
	ld.d	$a3, $sp, 16                    # 8-byte Folded Reload
	st.d	$s3, $a3, %pc_lo12(ref_pic_sub)
...
.LBB3_3:
	...
	pcalau12i	$a5, %got_pc_hi20(listXsize)
	ld.d	$s6, $a5, %got_pc_lo12(listXsize)
	sll.w	$s1, $a1, $a4
	lu12i.w	$a4, 18
	ori	$a4, $a4, 88
	add.d	$a4, $sp, $a4
