...
.LBB0_14:                               # %.loopexit82.preheader
	...
	addi.d	$s8, $a1, %pc_lo12(yy_ec)
	ori	$s2, $zero, 82
	pcalau12i	$a1, %pc_hi20(yy_nxt)
	addi.d	$s6, $a1, %pc_lo12(yy_nxt)
...
.LBB0_44:                               # %.lr.ph.i56
	...
	move	$a3, $a4
	beqz	$a6, .LBB0_44
.LBB0_45:                               # %._crit_edge.i.loopexit
                                        #   in Loop: Header=BB0_22 Depth=4
	ld.w	$a3, $s0, 48
.LBB0_46:                               # %._crit_edge.i
                                        #   in Loop: Header=BB0_22 Depth=4
	bne	$a3, $a1, .LBB0_48
# %bb.47:                               # %.thread64.i
                                        #   in Loop: Header=BB0_22 Depth=4
...
.LBB0_55:                               #   Parent Loop BB0_15 Depth=1
	...
	addi.w	$a1, $zero, -1
	beq	$a0, $a1, .LBB0_59
# %bb.56:                               #   in Loop: Header=BB0_55 Depth=5
	ori	$a2, $zero, 10
	beq	$a0, $a2, .LBB0_59
# %bb.57:                               #   in Loop: Header=BB0_55 Depth=5
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
...
# %bb.60:                               # %.critedge.i
	...
	bne	$a0, $a1, .LBB0_66
	b	.LBB0_89
.LBB0_61:                               #   in Loop: Header=BB0_22 Depth=4
	ld.d	$a0, $s0, 8
...
# %bb.62:                               #   in Loop: Header=BB0_22 Depth=4
	...
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
	bnez	$a0, .LBB0_177
# %bb.63:                               # %thread-pre-split.thread.i
                                        #   in Loop: Header=BB0_22 Depth=4
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s0, $a0, %pc_lo12(yy_current_buffer)
	ld.d	$fp, $sp, 24                    # 8-byte Folded Reload
.LBB0_64:                               # %.sink.split.i
                                        #   in Loop: Header=BB0_22 Depth=4
	...
	beq	$a2, $a0, .LBB0_68
	b	.LBB0_76
.LBB0_65:                               #   in Loop: Header=BB0_22 Depth=4
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(dfg_in)
	pcaddu18i	$ra, %call36(ferror)
	jirl	$ra, $ra, 0
...
# %bb.67:                               #   in Loop: Header=BB0_22 Depth=4
	...
	ld.w	$a0, $s5, %pc_lo12(yy_more_len)
	bne	$a2, $a0, .LBB0_76
.LBB0_68:                               # %yy_get_next_buffer.exit.thread77
                                        #   in Loop: Header=BB0_22 Depth=4
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(dfg_in)
	move	$s0, $a2
	...
	ld.w	$a1, $s5, %pc_lo12(yy_more_len)
	st.d	$a0, $s1, %pc_lo12(dfg_text)
.LBB0_69:                               # %yy_get_previous_state.exit63
                                        #   in Loop: Header=BB0_22 Depth=4
	ld.w	$a2, $s3, %pc_lo12(yy_start)
	add.d	$a0, $a0, $a1
	st.d	$a0, $s4, %pc_lo12(yy_c_buf_p)
...
.LBB0_88:                               #   in Loop: Header=BB0_18 Depth=2
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	b	.LBB0_90
.LBB0_89:                               # %thread-pre-split.thread85.i
                                        #   in Loop: Header=BB0_18 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s0, $a0, %pc_lo12(yy_current_buffer)
	ld.d	$a2, $s0, 8
...
.LBB0_133:                              # %.loopexit
	ori	$a0, $zero, 258
	b	.LBB0_169
.LBB0_134:                              # %.loopexit85.loopexit365
	ori	$a0, $zero, 261
	b	.LBB0_169
.LBB0_135:
	ori	$a0, $zero, 282
...
.LBB0_139:
	ori	$a0, $zero, 270
	b	.LBB0_169
.LBB0_140:                              # %.loopexit85.loopexit1109
	ori	$a0, $zero, 263
	b	.LBB0_169
.LBB0_141:
	ori	$a0, $zero, 297
	b	.LBB0_169
.LBB0_142:                              # %.loopexit85.loopexit177
	ori	$a0, $zero, 260
	b	.LBB0_169
.LBB0_143:
	ori	$a0, $zero, 274
...
.LBB0_146:
	ori	$a0, $zero, 267
	b	.LBB0_169
.LBB0_147:                              # %.loopexit85.loopexit624
	ori	$a0, $zero, 262
	b	.LBB0_169
.LBB0_148:
	ori	$a0, $zero, 295
