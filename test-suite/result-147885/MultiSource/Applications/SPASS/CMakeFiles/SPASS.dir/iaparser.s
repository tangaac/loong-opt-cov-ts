...
.LBB0_83:                               #   in Loop: Header=BB0_3 Depth=1
	...
	st.d	$zero, $a0, 0
	beqz	$s1, .LBB0_87
# %bb.84:                               # %.preheader.i306.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a0, $s1
	move	$a3, $s1
	.p2align	4, , 16
.LBB0_85:                               # %.preheader.i306
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a2, $a3
	ld.d	$a3, $a3, 0
...
# %bb.96:                               #   in Loop: Header=BB0_3 Depth=1
	...
	ld.w	$a2, $s2, 0
	bne	$a0, $a2, .LBB0_111
# %bb.97:                               # %.preheader.i303.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$s1, $a1
	.p2align	4, , 16
.LBB0_98:                               # %.preheader.i303
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %got_pc_hi20(fol_NOT)
	ld.d	$a0, $a0, %got_pc_lo12(fol_NOT)
...
# %bb.99:                               #   in Loop: Header=BB0_3 Depth=1
	...
	beqz	$a0, .LBB0_103
# %bb.100:                              # %.preheader.i91.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a2, $a3
	.p2align	4, , 16
.LBB0_101:                              # %.preheader.i91.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a1, $a2
	ld.d	$a2, $a2, 0
...
# %bb.106:                              #   in Loop: Header=BB0_3 Depth=1
	ld.d	$a0, $s2, 16
	beqz	$a0, .LBB0_110
# %bb.107:                              # %.preheader.i99.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a2, $a1
	.p2align	4, , 16
.LBB0_108:                              # %.preheader.i99.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a3, $a2
	ld.d	$a2, $a2, 0
...
.LBB0_113:                              #   in Loop: Header=BB0_3 Depth=1
	...
	move	$a2, $a1
	.p2align	4, , 16
.LBB0_114:                              # %.preheader.i107.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a3, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB0_114
# %bb.115:                              # %list_Nconc.exit112.i
                                        #   in Loop: Header=BB0_3 Depth=1
	st.d	$a0, $a3, 0
	ld.w	$a0, $s1, 0
	b	.LBB0_117
...
# %bb.146:                              #   in Loop: Header=BB0_144 Depth=1
	...
	addi.d	$t1, $a7, -1
	.p2align	4, , 16
.LBB0_147:                              #   Parent Loop BB0_144 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$t3, $t2, 0
	move	$a7, $t1
	addi.d	$t1, $t1, 1
...
.LBB0_153:
	...
	pcaddu18i	$ra, %call36(misc_Error)
	jirl	$ra, $ra, 0
.LBB0_154:                              # %symbol_IsPredicate.exit.thread
	pcalau12i	$a0, %got_pc_hi20(stdout)
	ld.d	$a0, $a0, %got_pc_lo12(stdout)
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(fflush)
