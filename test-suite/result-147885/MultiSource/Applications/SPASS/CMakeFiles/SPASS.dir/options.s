...
# %bb.43:                               # %.lr.ph.preheader.i.i.i
	...
	ori	$t0, $zero, 4
	bltu	$a7, $t0, .LBB14_46
# %bb.44:                               # %vector.memcheck320
                                        #   in Loop: Header=BB14_34 Depth=2
	alsl.d	$t0, $a5, $s8, 3
	alsl.d	$t1, $a7, $a3, 3
	bgeu	$t0, $t1, .LBB14_55
# %bb.45:                               # %vector.memcheck320
                                        #   in Loop: Header=BB14_34 Depth=2
	add.d	$t0, $a5, $a7
	alsl.d	$t0, $t0, $s8, 3
	bgeu	$a3, $t0, .LBB14_55
...
# %bb.114:                              #   in Loop: Header=BB14_22 Depth=1
	...
	bnez	$s7, .LBB14_131
.LBB14_115:                             # %.thread368.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ori	$a0, $zero, 45
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	beq	$a1, $a0, .LBB14_250
# %bb.116:                              #   in Loop: Header=BB14_22 Depth=1
	ld.b	$a1, $s6, 0
	move	$a0, $s3
	...
	beqz	$a0, .LBB14_249
.LBB14_117:                             #   in Loop: Header=BB14_22 Depth=1
	addi.d	$s4, $s6, 1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	...
	ld.bu	$a1, $s6, 1
	bnez	$a1, .LBB14_119
# %bb.118:                              #   in Loop: Header=BB14_22 Depth=1
	addi.w	$s0, $s0, 1
	st.w	$s0, $s1, %pc_lo12(opts_Ind)
.LBB14_119:                             #   in Loop: Header=BB14_22 Depth=1
	ori	$fp, $zero, 58
	andi	$a2, $s5, 255
	beq	$a2, $fp, .LBB14_247
# %bb.120:                              #   in Loop: Header=BB14_22 Depth=1
	beqz	$a0, .LBB14_247
# %bb.121:                              #   in Loop: Header=BB14_22 Depth=1
	...
	ori	$a4, $zero, 87
	bne	$a3, $a4, .LBB14_125
# %bb.122:                              #   in Loop: Header=BB14_22 Depth=1
	ori	$a3, $zero, 59
	bne	$a2, $a3, .LBB14_125
...
# %bb.128:                              #   in Loop: Header=BB14_22 Depth=1
	move	$s4, $zero
	b	.LBB14_173
.LBB14_129:                             #   in Loop: Header=BB14_22 Depth=1
	move	$a0, $s3
	pcaddu18i	$ra, %call36(strchr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB14_117
...
.LBB14_131:                             # %.thread286.i.i
	...
	beqz	$s1, .LBB14_134
# %bb.132:                              #   in Loop: Header=BB14_22 Depth=1
	ori	$fp, $zero, 58
	beqz	$a1, .LBB14_254
# %bb.133:                              #   in Loop: Header=BB14_22 Depth=1
	add.d	$a0, $s6, $s4
	addi.d	$s4, $a0, 1
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	b	.LBB14_137
...
.LBB14_189:                             #   in Loop: Header=BB14_22 Depth=1
	...
	ori	$fp, $zero, 45
	bnez	$a1, .LBB14_187
.LBB14_190:                             #   in Loop: Header=BB14_22 Depth=1
	ld.w	$a0, $a0, 8
	ori	$a1, $zero, 1
	beq	$a0, $a1, .LBB14_256
# %bb.191:                              #   in Loop: Header=BB14_22 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.6)
	addi.d	$a1, $a0, %pc_lo12(.L.str.6)
	move	$a0, $s4
	pcaddu18i	$ra, %call36(opts_AddParamCheck)
...
# %bb.220:                              # %.lr.ph62.i271.i.i
                                        #   in Loop: Header=BB14_218 Depth=1
	bltu	$t3, $a6, .LBB14_223
# %bb.221:                              # %vector.memcheck342
                                        #   in Loop: Header=BB14_218 Depth=1
	alsl.d	$t2, $t0, $s8, 3
	add.d	$t4, $t1, $t3
	alsl.d	$t4, $t4, $s8, 3
	bgeu	$t2, $t4, .LBB14_236
# %bb.222:                              # %vector.memcheck342
                                        #   in Loop: Header=BB14_218 Depth=1
	alsl.d	$t2, $t1, $s8, 3
	add.d	$t4, $t0, $t3
	alsl.d	$t4, $t4, $s8, 3
...
.LBB14_223:                             #   in Loop: Header=BB14_218 Depth=1
	move	$t2, $zero
.LBB14_224:                             # %scalar.ph348.preheader
                                        #   in Loop: Header=BB14_218 Depth=1
	sub.d	$t3, $t3, $t2
	slli.d	$t4, $t2, 3
	alsl.d	$t2, $t1, $t4, 3
...
# %bb.227:                              # %.lr.ph.preheader.i261.i.i
                                        #   in Loop: Header=BB14_218 Depth=1
	bltu	$t2, $a7, .LBB14_230
# %bb.228:                              # %vector.memcheck363
                                        #   in Loop: Header=BB14_218 Depth=1
	alsl.d	$t3, $t0, $s8, 3
	alsl.d	$t4, $t2, $a3, 3
	bgeu	$t3, $t4, .LBB14_239
# %bb.229:                              # %vector.memcheck363
                                        #   in Loop: Header=BB14_218 Depth=1
	add.d	$t3, $t0, $t2
	alsl.d	$t3, $t3, $s8, 3
	bgeu	$a3, $t3, .LBB14_239
...
# %bb.235:                              # %._crit_edge63.i258.i.i
	...
	blt	$t0, $a1, .LBB14_218
	b	.LBB14_243
.LBB14_236:                             # %vector.ph350
                                        #   in Loop: Header=BB14_218 Depth=1
	bstrpick.d	$t2, $t3, 30, 2
	slli.d	$t2, $t2, 2
...
.LBB14_237:                             # %vector.body353
	...
	addi.d	$t5, $t5, 32
	bnez	$t6, .LBB14_237
# %bb.238:                              # %middle.block360
                                        #   in Loop: Header=BB14_218 Depth=1
	beq	$t2, $t3, .LBB14_234
	b	.LBB14_224
.LBB14_239:                             # %vector.ph372
                                        #   in Loop: Header=BB14_218 Depth=1
...
.L.str.1:
	.asciz	"/home/tangyan/code/auto-tests/loong-opt-cov-ts/test-suite/llvm-test-suite/MultiSource/Applications/SPASS/options.c"
	.size	.L.str.1, 115
