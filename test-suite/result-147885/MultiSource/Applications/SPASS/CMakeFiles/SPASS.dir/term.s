...
# %bb.0:
	...
	ld.d	$s1, $a2, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$s2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	move	$fp, $a1
	move	$s4, $zero
	move	$s3, $zero
	ld.w	$a2, $a0, 0
...
.LBB63_4:                               # %term_ActMark.exit
	...
	ld.d	$s3, $a3, %got_pc_lo12(stack_STACK)
	addi.d	$a3, $s2, 1
...
# %bb.0:
	...
	ld.w	$a2, $a1, 0
	addi.w	$a3, $a3, -1
	pcalau12i	$a4, %got_pc_hi20(symbol_STANDARDVARCOUNTER)
	ld.d	$a4, $a4, %got_pc_lo12(symbol_STANDARDVARCOUNTER)
	pcalau12i	$a5, %got_pc_hi20(stack_STACK)
	ld.d	$a5, $a5, %got_pc_lo12(stack_STACK)
	bstrpick.d	$a6, $a3, 31, 0
	pcalau12i	$a7, %pc_hi20(term_BIND)
	addi.d	$a7, $a7, %pc_lo12(term_BIND)
	move	$t0, $a2
	move	$t1, $a0
	ld.d	$t2, $t1, 16
	beqz	$t2, .LBB71_2
...
# %bb.2:                                # %term_ActMark.exit
	...
	jr	$t8
.LBB73_3:                               # %vector.body10.preheader
	pcalau12i	$a1, %pc_hi20(term_BIND)
	addi.d	$a1, $a1, %pc_lo12(term_BIND)
	addi.d	$a2, $a1, 16
	ori	$a4, $zero, 3000
	.p2align	4, , 16
.LBB73_4:                               # %vector.body10
                                        # =>This Inner Loop Header: Depth=1
	st.d	$zero, $a2, -16
	st.d	$zero, $a2, 0
	addi.d	$a4, $a4, -2
...
.L.str.3:
	.asciz	"/home/tangyan/code/auto-tests/loong-opt-cov-ts/test-suite/llvm-test-suite/MultiSource/Applications/SPASS/term.c"
	.size	.L.str.3, 112
