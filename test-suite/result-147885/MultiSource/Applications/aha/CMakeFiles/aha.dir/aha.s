...
# %bb.6:                                # %.preheader.split.preheader
	move	$s5, $zero
	pcalau12i	$s6, %pc_hi20(check.itrialx)
...
.LBB25_7:                               # %.preheader.split
	...
	ld.w	$a0, $s6, %pc_lo12(check.itrialx)
	addi.w	$a2, $a0, 1
	ori	$a3, $zero, 15
	slt	$a0, $a3, $a0
	masknez	$a0, $a2, $a0
	...
	ldx.w	$a2, $a5, $a2
	st.w	$a0, $s6, %pc_lo12(check.itrialx)
	st.w	$a3, $s0, 44
