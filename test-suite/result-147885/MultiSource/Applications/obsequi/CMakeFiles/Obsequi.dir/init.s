...
# %bb.10:                               # %.preheader141
	blt	$s1, $a0, .LBB3_17
# %bb.11:                               # %.preheader140.us.preheader
	move	$a3, $zero
	ori	$a1, $zero, 2
	addi.d	$a2, $s2, 132
	move	$a4, $s0
...
.LBB3_47:                               # %init_hashkey_code.exit.thread
	...
	st.w	$zero, $a2, 16
	st.w	$zero, $a1, 16
.LBB3_48:                               # %init_hashkey_code.exit138
	move	$a0, $zero
...
.LBB3_49:                               # %init_hashkey_code.exit
	...
	b	.LBB3_51
	.p2align	4, , 16
.LBB3_50:                               # %._crit_edge.us.i108
                                        #   in Loop: Header=BB3_51 Depth=1
	addi.d	$t3, $t3, 128
	add.d	$t0, $t0, $a3
	add.d	$a6, $a6, $a3
	beq	$t2, $a0, .LBB3_55
.LBB3_51:                               # %.preheader.us.i100
                                        # =>This Loop Header: Depth=1
...
# %bb.60:                               #   in Loop: Header=BB3_59 Depth=2
	...
	st.w	$t0, $a2, 16
	b	.LBB3_58
.LBB3_61:                               # %init_hashkey_code.exit124
	move	$a2, $zero
	move	$a4, $zero
	move	$a6, $zero
	move	$t0, $zero
	...
	b	.LBB3_63
	.p2align	4, , 16
.LBB3_62:                               # %._crit_edge.us.i136
                                        #   in Loop: Header=BB3_63 Depth=1
	addi.d	$a7, $a7, 128
	add.d	$a4, $a4, $a3
	add.d	$a2, $a2, $a3
	beq	$t0, $a0, .LBB3_48
.LBB3_63:                               # %.preheader.us.i128
                                        # =>This Loop Header: Depth=1
...
.L.str:
	.asciz	"/home/tangyan/code/auto-tests/loong-opt-cov-ts/test-suite/llvm-test-suite/MultiSource/Applications/obsequi/init.c"
	.size	.L.str, 114
