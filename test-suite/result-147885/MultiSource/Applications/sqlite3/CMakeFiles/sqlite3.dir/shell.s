...
# %bb.116:                              # %.lr.ph.preheader.i204
	bstrpick.d	$a0, $s2, 30, 0
	ori	$a2, $zero, 8
	bgeu	$a0, $a2, .LBB14_118
# %bb.117:
	move	$a2, $zero
	b	.LBB14_121
.LBB14_118:                             # %vector.ph299
	bstrpick.d	$a2, $s2, 30, 3
	pcalau12i	$a3, %pc_hi20(.LCPI14_0)
	vld	$vr0, $a3, %pc_lo12(.LCPI14_0)
	slli.d	$a2, $a2, 3
