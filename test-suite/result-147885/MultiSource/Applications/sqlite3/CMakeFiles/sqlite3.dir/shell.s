...
# %bb.232:                              # %middle.block
	beq	$a3, $a2, .LBB4_235
.LBB4_233:                              # %.lr.ph662.preheader773
	sub.d	$a1, $s5, $a1
	lu12i.w	$a2, 3
	ori	$a2, $a2, 3884
.LBB4_234:                              # %.lr.ph662
...
.LJTI13_0:
	...
	.word	.LBB13_5-.LJTI13_0
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function dump_callback
.LCPI14_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
# %bb.115:
	...
	move	$s3, $a0
	b	.LBB14_117
.LBB14_116:                             # %appendText.exit188.thread
	move	$a0, $s0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	move	$s2, $a0
...
.LBB14_117:
	...
	addi.w	$a1, $a0, 3
	blt	$s4, $a2, .LBB14_125
# %bb.118:                              # %.lr.ph.preheader.i204
	bstrpick.d	$a0, $s2, 30, 0
	ori	$a2, $zero, 8
	bgeu	$a0, $a2, .LBB14_120
# %bb.119:
	move	$a2, $zero
	b	.LBB14_123
.LBB14_120:                             # %vector.ph299
	bstrpick.d	$a2, $s2, 30, 3
	pcalau12i	$a3, %pc_hi20(.LCPI14_0)
	vld	$vr0, $a3, %pc_lo12(.LCPI14_0)
	slli.d	$a2, $a2, 3
...
# %bb.122:                              # %middle.block309
	...
	vpickve2gr.w	$a1, $vr0, 0
	beq	$a0, $a2, .LBB14_125
.LBB14_123:                             # %.lr.ph.i206.preheader
	sub.d	$a0, $a0, $a2
	add.d	$a2, $s0, $a2
	.p2align	4, , 16
.LBB14_124:                             # %.lr.ph.i206
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a3, $a2, 0
	addi.d	$a3, $a3, -34
	sltui	$a3, $a3, 1
...
# %bb.130:                              #   in Loop: Header=BB14_129 Depth=1
	...
	addi.d	$s0, $s0, 1
	bnez	$a2, .LBB14_129
.LBB14_131:                             # %._crit_edge63.i193
	st.h	$a0, $a1, 0
.LBB14_132:                             # %appendText.exit212
	ld.d	$a0, $s6, 16
	ld.d	$a1, $s6, 0
	move	$a2, $s1
	pcaddu18i	$ra, %call36(run_table_dump_query)
