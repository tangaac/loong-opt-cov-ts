...
# %bb.24:                               # %.lr.ph35.preheader
	ori	$a2, $zero, 16
	bltu	$s2, $a2, .LBB13_27
# %bb.25:                               # %vector.memcheck41
	add.d	$a2, $s5, $s4
	add.d	$a2, $a2, $s2
	bgeu	$a1, $a2, .LBB13_31
# %bb.26:                               # %vector.memcheck41
	alsl.d	$a2, $s2, $a1, 1
	bgeu	$s1, $a2, .LBB13_31
.LBB13_27:
	move	$a2, $zero
.LBB13_28:                              # %.lr.ph35.preheader59
	alsl.d	$a3, $a2, $a1, 2
	sub.d	$a2, $s3, $a2
	.p2align	4, , 16
.LBB13_29:                              # %.lr.ph35
...
# %bb.52:                               # %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEED2Ev.exit
	...
	addi.d	$sp, $sp, 688
	ret
.LBB31_53:                              # %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit._crit_edge.i
	ori	$a0, $zero, 4
	pcaddu18i	$ra, %call36(__cxa_allocate_exception)
	jirl	$ra, $ra, 0
	ori	$a1, $zero, 1
...
.Ltmp124:
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB31_70:                              # %_ZN7CBufferIhED2Ev.exit83
.Ltmp101:
.LBB31_71:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit
	move	$fp, $a0
.LBB31_72:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit
	addi.d	$a0, $sp, 112
	pcaddu18i	$ra, %call36(_ZN8NArchive3N7z8CDecoderD2Ev)
	jirl	$ra, $ra, 0
.LBB31_73:
...
.LBB34_169:
	...
	jirl	$ra, $ra, 0
	move	$s1, $zero
.LBB34_170:                             # %_ZN8NArchive3N7z10CInArchive6ReadIDEv.exit
...
.Ltmp242:
	move	$fp, $a0
	b	.LBB34_201
.LBB34_192:                             # %.loopexit.split-lp333
.Ltmp190:
	move	$fp, $a0
	b	.LBB34_224
.LBB34_193:
...
.Ltmp147:
	b	.LBB34_226
.LBB34_207:                             # %.loopexit.split-lp340
.Ltmp150:
	b	.LBB34_226
.LBB34_208:                             # %.loopexit
.Ltmp239:
