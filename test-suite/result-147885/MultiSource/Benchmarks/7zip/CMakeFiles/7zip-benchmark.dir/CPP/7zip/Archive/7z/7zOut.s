...
# %bb.119:                              # %middle.block386
	...
	beq	$a2, $a0, .LBB23_122
.LBB23_120:                             # %scalar.ph372.preheader
	alsl.d	$a1, $a2, $a1, 3
	sub.d	$a0, $a0, $a2
	ori	$a2, $zero, 2
	.p2align	4, , 16
.LBB23_121:                             # %scalar.ph372
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a1, 0
	ld.w	$a4, $a4, 24
	sltu	$a5, $zero, $a4
...
.LBB23_139:                             # %.lr.ph328
	pcalau12i	$a1, %got_pc_hi20(g_CrcTable)
	ld.d	$s4, $a1, %got_pc_lo12(g_CrcTable)
	move	$s5, $zero
	addi.d	$s2, $fp, 32
	addi.w	$s3, $zero, -1
	b	.LBB23_142
...
# %bb.166:                              # %middle.block405
	...
	vpickve2gr.w	$a2, $vr0, 0
	beq	$a3, $a0, .LBB23_169
.LBB23_167:                             # %scalar.ph393.preheader
	sub.d	$a0, $a0, $a3
	add.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB23_168:                             # %scalar.ph393
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a3, $a1, 0
	add.w	$a2, $a2, $a3
	addi.d	$a0, $a0, -1
...
# %bb.181:                              # %middle.block422
	...
	vpickve2gr.w	$a2, $vr0, 0
	beq	$a3, $a0, .LBB23_184
.LBB23_182:                             # %scalar.ph410.preheader
	sub.d	$a0, $a0, $a3
	add.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB23_183:                             # %scalar.ph410
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a3, $a1, 0
	add.w	$a2, $a2, $a3
	addi.d	$a0, $a0, -1
...
# %bb.196:                              # %middle.block439
	...
	vpickve2gr.w	$a2, $vr0, 0
	beq	$a3, $a0, .LBB23_199
.LBB23_197:                             # %scalar.ph427.preheader
	sub.d	$a0, $a0, $a3
	add.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB23_198:                             # %scalar.ph427
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a3, $a1, 0
	add.w	$a2, $a2, $a3
	addi.d	$a0, $a0, -1
...
# %bb.210:                              # %middle.block456
	...
	vpickve2gr.w	$a2, $vr0, 0
	beq	$a3, $a0, .LBB23_213
.LBB23_211:                             # %scalar.ph444.preheader
	sub.d	$a0, $a0, $a3
	add.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB23_212:                             # %scalar.ph444
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a3, $a1, 0
	add.w	$a2, $a2, $a3
	addi.d	$a0, $a0, -1
