...
.LBB4_42:                               # %vec.epilog.ph91
	...
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_43:                               # %vec.epilog.vector.body97
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB4_47:                               # %vector.body82
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB4_47
# %bb.48:                               # %middle.block87
	beq	$a2, $a1, .LBB4_52
# %bb.49:                               # %vec.epilog.iter.check92
	andi	$a3, $a1, 16
	bnez	$a3, .LBB4_42
...
.LBB7_32:                               # %vec.epilog.ph93
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_33:                               # %vec.epilog.vector.body99
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB7_54:                               # %vec.epilog.ph126
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_55:                               # %vec.epilog.vector.body132
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB7_76:                               # %vec.epilog.ph159
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_77:                               # %vec.epilog.vector.body165
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
