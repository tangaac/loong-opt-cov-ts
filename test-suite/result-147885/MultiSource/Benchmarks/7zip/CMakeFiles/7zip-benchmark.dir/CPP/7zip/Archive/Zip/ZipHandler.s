...
.Ltmp161:
	...
	jirl	$ra, $ra, 0
.Ltmp162:
# %bb.180:                              # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit173
	addi.w	$s1, $fp, 0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(__cxa_begin_catch)
	jirl	$ra, $ra, 0
...
.Ltmp256:
	jirl	$ra, $a1, 0
.Ltmp257:
.LBB23_56:                              # %_ZN9CMyComPtrI15ICompressFilterEaSEPS0_.exit323
	st.d	$s1, $s3, 32
.LBB23_57:
	ld.d	$a0, $s1, 0
	ld.d	$a1, $a0, 8
...
.Ltmp247:
	jirl	$ra, $a1, 0
.Ltmp248:
.LBB23_64:                              # %_ZN9CMyComPtrI15ICompressFilterEaSEPS0_.exit332
	st.d	$s1, $s3, 24
.LBB23_65:
	ld.d	$a0, $s1, 0
	ld.d	$a1, $a0, 8
.Ltmp249:
	...
	jirl	$ra, $a1, 0
.Ltmp250:
.LBB23_66:                              # %_ZN9CMyComPtrI15ICompressFilterEaSERKS1_.exit328
	st.d	$s0, $sp, 0                     # 8-byte Folded Spill
	st.d	$zero, $sp, 128
	ld.d	$a0, $s1, 0
	ld.d	$a3, $a0, 0
...
# %bb.88:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB23_89:                              # %_ZN11CStringBaseIcED2Ev.exit346
	sltui	$s2, $s2, 1
.LBB23_90:
	ld.d	$a0, $sp, 120
.Ltmp312:
...
.Ltmp477:
	jirl	$ra, $a1, 0
.Ltmp478:
.LBB23_165:                             # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit422
	ld.d	$a0, $fp, 0
	ld.d	$a1, $a0, 16
.Ltmp480:
	move	$a0, $fp
...
.LBB23_192:
	bnez	$s4, .LBB23_141
.LBB23_193:                             # %_ZN8NArchive4NZip11CMethodItemD2Ev.exit.thread707
	move	$s6, $zero
	move	$s8, $zero
	ori	$a0, $zero, 1
...
.Ltmp446:
	...
	jirl	$ra, $a6, 0
.Ltmp447:
# %bb.196:                              # %_ZN9CMyComPtrI19ISequentialInStreamEaSERKS1_.exit411
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB23_200
	b	.LBB23_210
.LBB23_197:
...
.LBB23_199:
	...
	ori	$a1, $zero, 1
	beq	$a0, $a1, .LBB23_210
.LBB23_200:                             # %_ZN9CMyComPtrI19ISequentialInStreamEaSERKS1_.exit411
	lu12i.w	$a1, -524284
	ori	$a1, $a1, 1
	bne	$a0, $a1, .LBB23_202
# %bb.201:
...
.LBB23_210:
	move	$s4, $zero
	move	$s8, $zero
.LBB23_211:                             # %_ZN9CMyComPtrI19ISequentialInStreamEaSERKS1_.exit411.thread535
...
.Ltmp457:
	...
	jirl	$ra, $a1, 0
.Ltmp458:
.LBB23_220:                             # %_ZN9CMyComPtrI19ISequentialInStreamE6AttachEPS0_.exit417
	ld.d	$a0, $s3, 16
.Ltmp459:
	addi.d	$a2, $sp, 104
	move	$s4, $s0
...
.LBB23_236:
.Ltmp302:
.LBB23_237:                             # %_ZN11CStringBaseIcED2Ev.exit340
	move	$s0, $a0
.LBB23_238:                             # %_ZN11CStringBaseIcED2Ev.exit340
	ld.d	$a0, $sp, 72
	beqz	$a0, .LBB23_247
# %bb.239:
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp255:
	move	$s0, $a0
	ori	$a1, $zero, 432
.LBB23_253:                             # %_ZN9CMyComPtrI15ICompressFilterED2Ev.exit420
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	move	$s6, $zero
...
.Ltmp318:
	jirl	$ra, $a1, 0
.Ltmp319:
.LBB23_288:                             # %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit350
	move	$s6, $zero
	b	.LBB23_309
.LBB23_289:
.Ltmp320:
...
.LBB23_296:
.Ltmp260:
.LBB23_297:                             # %_ZN9CMyComPtrI15ICompressFilterED2Ev.exit420
	move	$s0, $a0
	move	$s6, $zero
	b	.LBB23_310
.LBB23_298:
...
.Ltmp485:
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB23_301:                             # %_ZN9CMyComPtrI15ICompressFilterED2Ev.exit420.thread
.Ltmp242:
	b	.LBB23_316
.LBB23_302:
.Ltmp482:
...
.Ltmp384:
	jirl	$ra, $a1, 0
.Ltmp385:
.LBB23_307:                             # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit414
	move	$s6, $zero
.LBB23_308:                             # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit414
	beqz	$s1, .LBB23_310
.LBB23_309:                             # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit414.thread613
	ld.d	$a0, $s1, 0
	ld.d	$a1, $a0, 16
.Ltmp462:
	move	$a0, $s1
	jirl	$ra, $a1, 0
.Ltmp463:
.LBB23_310:                             # %_ZN9CMyComPtrI15ICompressFilterED2Ev.exit420
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	beqz	$a0, .LBB23_317
# %bb.311:
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
...
.LBB23_315:
.Ltmp239:
.LBB23_316:                             # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit425
	move	$s0, $a0
	move	$s6, $zero
.LBB23_317:                             # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit425
	ld.d	$a0, $fp, 0
	ld.d	$a1, $a0, 16
.Ltmp468:
	move	$a0, $fp
	jirl	$ra, $a1, 0
.Ltmp469:
# %bb.318:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit427
	beqz	$s6, .LBB23_320
# %bb.319:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit427.thread641
	ld.d	$a0, $s6, 0
	ld.d	$a1, $a0, 48
.Ltmp471:
	move	$a0, $s6
	jirl	$ra, $a1, 0
.Ltmp472:
.LBB23_320:                             # %_ZN17CInStreamReleaserD2Ev.exit430
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB23_321:
...
# %bb.9:                                # %middle.block
	add.d	$a1, $a4, $a1
	beq	$a3, $a2, .LBB26_16
.LBB26_10:                              # %.preheader212.split.preheader252
	alsl.d	$a4, $a3, $s2, 2
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit30
	...
	move	$a3, $a0
	beq	$a5, $a6, .LBB29_66
.LBB29_32:                              # %_ZeqRK4GUIDS1_.exit30.thread
...
# %bb.48:
	addi.d	$a3, $a0, 8
	b	.LBB29_66
.LBB29_49:                              # %_ZeqRK4GUIDS1_.exit49.thread
...
# %bb.65:
	addi.d	$a3, $a0, 16
.LBB29_66:                              # %_ZeqRK4GUIDS1_.exit68.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB29_67:                              # %_ZeqRK4GUIDS1_.exit68.thread
	move	$a0, $a3
	ret
.Lfunc_end29:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit24
	...
	ld.bu	$a4, $a5, 15
	bne	$a1, $a4, .LBB51_33
.LBB51_32:                              # %_ZeqRK4GUIDS1_.exit24.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB51_33:                              # %_ZeqRK4GUIDS1_.exit24.thread
	move	$a0, $a3
	ret
.Lfunc_end51:
