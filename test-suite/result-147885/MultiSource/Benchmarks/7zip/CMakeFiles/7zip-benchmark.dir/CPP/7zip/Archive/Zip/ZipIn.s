...
# %bb.34:                               # %._crit_edge32.i.i.peel
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$a0, $s6, 0
.LBB16_35:                              # %.noexc64.peel.thread148.thread
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$a1, $fp, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 40
...
.LBB16_49:                              # %._crit_edge32.i.i
	...
	ld.d	$a0, $s6, 0
.LBB16_50:                              # %.noexc64.thread152.thread
                                        #   in Loop: Header=BB16_52 Depth=2
	ld.d	$a1, $fp, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 40
...
.LBB16_74:                              # %_ZN8NArchive4NZip10CInArchive4SkipEy.exit
	...
	addi.d	$sp, $sp, 208
	ret
.LBB16_75:                              # %.loopexit120.invoke.loopexit222.split.loop.exit234
	sltu	$a0, $zero, $a0
	ori	$a1, $zero, 6
	maskeqz	$fp, $a1, $a0
	b	.LBB16_79
...
# %bb.99:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_100:                             # %_ZN8NArchive4NZip14CExtraSubBlockD2Ev.exit69
	ld.d	$a0, $sp, 0                     # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end16:
