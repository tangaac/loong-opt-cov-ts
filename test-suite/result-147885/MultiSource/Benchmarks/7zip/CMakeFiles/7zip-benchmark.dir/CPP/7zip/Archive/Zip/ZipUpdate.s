...
# %bb.71:
	...
	addi.d	$fp, $a1, %pc_lo12(_ZTV13CObjectVectorIN8NArchive4NZip11CMemBlocks2EE+16)
	st.d	$fp, $sp, 824
	vst	$vr0, $sp, 792
	st.d	$a0, $sp, 808
...
# %bb.141:                              # %.critedge463.i
	...
	bnez	$a1, .LBB17_140
	b	.LBB17_130
.LBB17_142:                             #   in Loop: Header=BB17_102 Depth=1
	move	$s5, $s0
	ldx.d	$s0, $a0, $a1
...
.Ltmp306:
	...
	jirl	$ra, $ra, 0
.Ltmp307:
# %bb.143:                              #   in Loop: Header=BB17_102 Depth=1
	st.d	$a0, $sp, 344
	st.b	$zero, $a0, 0
	vld	$vr0, $sp, 176                  # 16-byte Folded Reload
	addi.d	$a0, $sp, 368
...
# %bb.144:                              #   in Loop: Header=BB17_102 Depth=1
	ld.bu	$a0, $s0, 0
	bnez	$a0, .LBB17_164
.LBB17_145:                             #   in Loop: Header=BB17_102 Depth=1
	ld.w	$a0, $s0, 8
	ld.d	$a1, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 16
	slli.d	$a0, $a0, 3
...
.Ltmp309:
	...
	jirl	$ra, $ra, 0
.Ltmp310:
# %bb.146:                              #   in Loop: Header=BB17_102 Depth=1
	ld.h	$a0, $s1, 184
	addi.d	$a1, $sp, 492
	st.h	$a0, $a1, 4
	ld.w	$a0, $s1, 180
...
# %bb.148:                              #   in Loop: Header=BB17_102 Depth=1
	...
	ori	$s7, $a0, 1
	b	.LBB17_189
.LBB17_149:                             #   in Loop: Header=BB17_102 Depth=1
	ld.d	$s0, $sp, 304
	st.b	$zero, $s4, 400
	beqz	$s0, .LBB17_151
# %bb.150:                              #   in Loop: Header=BB17_102 Depth=1
	ld.d	$a0, $s0, 0
	ld.d	$a1, $a0, 8
.Ltmp274:
	move	$a0, $s0
	jirl	$ra, $a1, 0
.Ltmp275:
.LBB17_151:                             # %.noexc502.i
                                        #   in Loop: Header=BB17_102 Depth=1
	ld.d	$a0, $s4, 184
	beqz	$a0, .LBB17_153
# %bb.152:                              #   in Loop: Header=BB17_102 Depth=1
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp276:
	jirl	$ra, $a1, 0
.Ltmp277:
.LBB17_153:                             #   in Loop: Header=BB17_102 Depth=1
	ld.d	$a0, $sp, 304
	st.d	$s0, $s4, 184
	beqz	$a0, .LBB17_156
# %bb.154:                              #   in Loop: Header=BB17_102 Depth=1
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp278:
	jirl	$ra, $a1, 0
...
.Ltmp280:
	...
	jirl	$ra, $ra, 0
.Ltmp281:
# %bb.157:                              #   in Loop: Header=BB17_102 Depth=1
	ld.d	$a1, $s4, 152
	ld.d	$a0, $a1, 16
	ld.w	$a1, $a1, 24
.Ltmp282:
...
.Ltmp286:
	...
	jirl	$ra, $ra, 0
.Ltmp287:
# %bb.160:                              #   in Loop: Header=BB17_102 Depth=1
	ld.w	$a0, $sp, 764
	ld.d	$a1, $sp, 768
	addi.d	$a2, $s4, 120
	slli.d	$a3, $a0, 3
...
# %bb.161:                              #   in Loop: Header=BB17_102 Depth=1
	...
	st.w	$a0, $sp, 732
	b	.LBB17_129
.LBB17_162:                             #   in Loop: Header=BB17_102 Depth=1
	ld.bu	$a0, $s0, 0
	beqz	$a0, .LBB17_168
# %bb.163:                              # %.thread.i
                                        #   in Loop: Header=BB17_102 Depth=1
	ld.bu	$a0, $s0, 1
	beqz	$a0, .LBB17_170
.LBB17_164:                             # %.thread.thread.i
                                        #   in Loop: Header=BB17_102 Depth=1
	ld.bu	$a0, $s0, 2
	beqz	$a0, .LBB17_172
.LBB17_165:                             #   in Loop: Header=BB17_102 Depth=1
.Ltmp378:
	addi.d	$a0, $sp, 216
	addi.d	$a3, $sp, 312
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
...
.Ltmp383:
	b	.LBB17_184
.LBB17_168:                             #   in Loop: Header=BB17_102 Depth=1
.Ltmp313:
	addi.d	$a0, $sp, 216
	addi.d	$a3, $sp, 312
	addi.d	$a5, $sp, 1456
	...
	jirl	$ra, $ra, 0
.Ltmp314:
# %bb.169:                              #   in Loop: Header=BB17_102 Depth=1
	move	$s7, $a0
	bnez	$a0, .LBB17_189
	b	.LBB17_184
.LBB17_170:                             #   in Loop: Header=BB17_102 Depth=1
.Ltmp316:
	addi.d	$a0, $sp, 312
	pcaddu18i	$ra, %call36(_ZNK8NArchive4NZip5CItem5IsDirEv)
	jirl	$ra, $ra, 0
.Ltmp317:
# %bb.171:                              #   in Loop: Header=BB17_102 Depth=1
	bnez	$a0, .LBB17_165
.LBB17_172:                             #   in Loop: Header=BB17_102 Depth=1
	addi.w	$a0, $s5, 0
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	addi.w	$a1, $a1, 0
	bge	$a1, $a0, .LBB17_175
# %bb.173:                              #   in Loop: Header=BB17_102 Depth=1
.Ltmp318:
	addi.d	$a0, $sp, 216
	addi.d	$a3, $sp, 312
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
...
.LBB17_175:                             #   in Loop: Header=BB17_102 Depth=1
	ld.d	$a0, $sp, 840
	slli.d	$a1, $s5, 3
	ldx.d	$s7, $a0, $a1
	ld.bu	$a0, $s7, 72
	beqz	$a0, .LBB17_198
# %bb.176:                              #   in Loop: Header=BB17_102 Depth=1
	st.d	$zero, $sp, 304
.Ltmp359:
	addi.d	$a0, $sp, 216
	addi.d	$a1, $sp, 304
...
.Ltmp387:
	...
	jirl	$ra, $ra, 0
.Ltmp388:
# %bb.186:                              #   in Loop: Header=BB17_102 Depth=1
.Ltmp390:
	addi.d	$a0, $sp, 944
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector18ReserveOnePositionEv)
	jirl	$ra, $ra, 0
...
.Ltmp350:
	...
	jirl	$ra, $ra, 0
.Ltmp351:
# %bb.217:                              #   in Loop: Header=BB17_102 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.bu	$a1, $a0, 104
	ld.bu	$a2, $a0, 105
	addi.d	$a0, $fp, 376
...
# %bb.226:
	...
	addi.d	$a1, $a1, %pc_lo12(_ZTV13CObjectVectorIN8NArchive4NZip5CItemEE+16)
...
.LBB17_238:                             #   in Loop: Header=BB17_228 Depth=1
	ld.bu	$a0, $s6, 0
	beqz	$a0, .LBB17_244
# %bb.239:                              # %.thread198.i.i
                                        #   in Loop: Header=BB17_228 Depth=1
	ld.bu	$a0, $s6, 1
	beqz	$a0, .LBB17_247
.LBB17_240:                             # %.thread198.i.thread.i
                                        #   in Loop: Header=BB17_228 Depth=1
	ld.bu	$a0, $s6, 2
	beqz	$a0, .LBB17_249
...
.Ltmp180:
	...
	jirl	$ra, $ra, 0
.Ltmp181:
# %bb.276:                              # %_ZN8NArchive4NZip11CExtraBlockD2Ev.exit.i.i472.i
                                        #   in Loop: Header=BB17_228 Depth=1
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
# %bb.316:
	...
	jirl	$ra, $ra, 0
	b	.LBB17_286
.LBB17_317:                             # %.thread583.i.loopexit1005
	move	$s6, $s7
	b	.LBB17_302
.LBB17_318:
.Ltmp349:
...
.Ltmp393:
	jirl	$ra, $a1, 0
.Ltmp394:
.LBB17_418:                             # %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit552.i
	addi.d	$a0, $sp, 944
