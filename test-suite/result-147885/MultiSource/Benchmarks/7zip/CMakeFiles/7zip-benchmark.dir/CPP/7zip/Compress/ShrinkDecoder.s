...
.LBB0_57:                               # %vector.body310.preheader
	...
	b	.LBB0_59
	.p2align	4, , 16
.LBB0_58:                               # %pred.store.continue342
...
.LBB0_75:                               # %pred.store.if
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_61
.LBB0_76:                               # %pred.store.if313
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 1
	vpickve2gr.b	$a2, $vr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_62
.LBB0_77:                               # %pred.store.if315
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 2
	vpickve2gr.b	$a2, $vr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_63
.LBB0_78:                               # %pred.store.if317
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 3
	vpickve2gr.b	$a2, $vr0, 4
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_64
.LBB0_79:                               # %pred.store.if319
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 4
	vpickve2gr.b	$a2, $vr0, 5
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_65
.LBB0_80:                               # %pred.store.if321
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 5
	vpickve2gr.b	$a2, $vr0, 6
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_66
.LBB0_81:                               # %pred.store.if323
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 6
	vpickve2gr.b	$a2, $vr0, 7
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_67
.LBB0_82:                               # %pred.store.if325
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 7
	vpickve2gr.b	$a2, $vr0, 8
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_68
.LBB0_83:                               # %pred.store.if327
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 8
	vpickve2gr.b	$a2, $vr0, 9
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_69
.LBB0_84:                               # %pred.store.if329
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 9
	vpickve2gr.b	$a2, $vr0, 10
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_70
.LBB0_85:                               # %pred.store.if331
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 10
	vpickve2gr.b	$a2, $vr0, 11
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_71
.LBB0_86:                               # %pred.store.if333
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 11
	vpickve2gr.b	$a2, $vr0, 12
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_72
.LBB0_87:                               # %pred.store.if335
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 12
	vpickve2gr.b	$a2, $vr0, 13
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_73
.LBB0_88:                               # %pred.store.if337
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 13
	vpickve2gr.b	$a2, $vr0, 14
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_74
.LBB0_89:                               # %pred.store.if339
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 14
	vpickve2gr.b	$a2, $vr0, 15
	andi	$a2, $a2, 1
	beqz	$a2, .LBB0_58
.LBB0_90:                               # %pred.store.if341
                                        #   in Loop: Header=BB0_59 Depth=2
	st.b	$s0, $a1, 15
	b	.LBB0_58
	.p2align	4, , 16
.LBB0_91:                               # %vec.epilog.vector.body
	...
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_120
# %bb.92:                               # %pred.store.continue349
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 1
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_121
.LBB0_93:                               # %pred.store.continue351
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 2
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_122
.LBB0_94:                               # %pred.store.continue353
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_96
.LBB0_95:                               # %pred.store.if354
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 2
.LBB0_96:                               # %pred.store.continue355
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.w	$a0, $a3, 4
	vinsgr2vr.w	$vr0, $a0, 0
	vpickve2gr.b	$a0, $vr0, 0
	...
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_123
# %bb.97:                               # %pred.store.continue349.1
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 1
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_124
.LBB0_98:                               # %pred.store.continue351.1
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 2
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_125
.LBB0_99:                               # %pred.store.continue353.1
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_101
.LBB0_100:                              # %pred.store.if354.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 6
.LBB0_101:                              # %pred.store.continue355.1
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.w	$a0, $a3, 8
	vinsgr2vr.w	$vr0, $a0, 0
	vpickve2gr.b	$a0, $vr0, 0
	...
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_126
# %bb.102:                              # %pred.store.continue349.2
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 1
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_127
.LBB0_103:                              # %pred.store.continue351.2
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 2
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_128
.LBB0_104:                              # %pred.store.continue353.2
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.w	$a0, $vr0, 3
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_129
...
.LBB0_120:                              # %pred.store.if348
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_93
.LBB0_121:                              # %pred.store.if350
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 0
	vpickve2gr.w	$a0, $vr0, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_94
.LBB0_122:                              # %pred.store.if352
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 1
	vpickve2gr.w	$a0, $vr0, 3
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_95
	b	.LBB0_96
.LBB0_123:                              # %pred.store.if348.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 3
	vpickve2gr.w	$a0, $vr0, 1
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_98
.LBB0_124:                              # %pred.store.if350.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 4
	vpickve2gr.w	$a0, $vr0, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_99
.LBB0_125:                              # %pred.store.if352.1
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 5
	vpickve2gr.w	$a0, $vr0, 3
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_100
	b	.LBB0_101
.LBB0_126:                              # %pred.store.if348.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 7
	vpickve2gr.w	$a0, $vr0, 1
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_103
.LBB0_127:                              # %pred.store.if350.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 8
	vpickve2gr.w	$a0, $vr0, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_104
.LBB0_128:                              # %pred.store.if352.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 9
	vpickve2gr.w	$a0, $vr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_105
.LBB0_129:                              # %pred.store.if354.2
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s0, $a4, 10
	ld.bu	$a0, $a3, 12
	bnez	$a0, .LBB0_106
