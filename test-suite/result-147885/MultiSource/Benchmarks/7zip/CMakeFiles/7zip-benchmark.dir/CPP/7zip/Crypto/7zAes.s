...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit30
	...
	ori	$a5, $zero, 8
	beq	$a6, $a3, .LBB21_64
.LBB21_32:                              # %_ZeqRK4GUIDS1_.exit30.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit49
	...
	ori	$a5, $zero, 176
	beq	$a6, $a3, .LBB21_64
.LBB21_48:                              # %_ZeqRK4GUIDS1_.exit49.thread
...
# %bb.63:                               # %_ZeqRK4GUIDS1_.exit68
	...
	ori	$a5, $zero, 184
	bne	$a1, $a4, .LBB21_65
.LBB21_64:                              # %_ZeqRK4GUIDS1_.exit68.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB21_65:                              # %_ZeqRK4GUIDS1_.exit68.thread
	move	$a0, $a3
	ret
.Lfunc_end21:
...
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit27
	...
	ori	$a5, $zero, 8
	beq	$a6, $a3, .LBB45_48
.LBB45_32:                              # %_ZeqRK4GUIDS1_.exit27.thread
...
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit46
	...
	ori	$a5, $zero, 176
	bne	$a1, $a4, .LBB45_49
.LBB45_48:                              # %_ZeqRK4GUIDS1_.exit46.thread.sink.split
	addi.d	$sp, $sp, -16
	.cfi_def_cfa_offset 16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	.cfi_offset 1, -8
	...
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
.LBB45_49:                              # %_ZeqRK4GUIDS1_.exit46.thread
	move	$a0, $a3
	ret
.Lfunc_end45:
