...
.LBB7_2:                                # %vector.ph
	...
	vld	$vr3, $a5, %pc_lo12(.LCPI7_1)
	pcalau12i	$a6, %pc_hi20(.LCPI7_2)
	vld	$vr4, $a6, %pc_lo12(.LCPI7_2)
...
.LBB7_101:                              # %vector.body472
	...
	vpickev.b	$vr1, $vr6, $vr1
	vmskltz.b	$vr6, $vr1
	vpickve2gr.hu	$a6, $vr6, 0
	addi.w	$a0, $a0, 16
	bnez	$a6, .LBB7_103
# %bb.102:                              # %vector.body472
...
# %bb.51:                               #   in Loop: Header=BB13_39 Depth=1
	...
	addi.d	$s4, $s4, 224
	bnez	$s5, .LBB13_39
.LBB13_52:                              # %._crit_edge348
	ori	$a0, $zero, 4
	bltu	$s1, $a0, .LBB13_56
# %bb.53:                               # %.lr.ph350.preheader
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
	move	$s3, $s7
.LBB13_54:                              # %.lr.ph350
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.64:                               # %middle.block
	...
	beq	$a0, $a3, .LBB13_67
.LBB13_65:                              # %.lr.ph354.preheader563
	ori	$a3, $zero, 224
	mul.d	$a3, $a0, $a3
	add.d	$a3, $a3, $fp
	addi.d	$a3, $a3, 176
...
.LBB13_99:                              # %vector.body534
	...
	addi.d	$a5, $a5, 448
	bnez	$a6, .LBB13_99
# %bb.100:                              # %middle.block541
	add.d	$a1, $a2, $a1
	add.d	$a2, $a4, $a3
	ld.d	$a3, $sp, 40                    # 8-byte Folded Reload
	beq	$a0, $a3, .LBB13_103
.LBB13_101:                             # %.lr.ph372.preheader550
	ori	$a3, $zero, 224
	mul.d	$a3, $a0, $a3
	add.d	$a3, $a3, $fp
	addi.d	$a3, $a3, 176
...
.Ltmp116:
	b	.LBB13_121
.LBB13_111:                             # %.loopexit.split-lp411
.Ltmp92:
	b	.LBB13_121
.LBB13_112:                             # %.loopexit.split-lp416
.Ltmp95:
	b	.LBB13_121
.LBB13_113:
.Ltmp80:
...
.Ltmp122:
	b	.LBB13_121
.LBB13_116:                             # %.loopexit415
.Ltmp110:
	b	.LBB13_121
.LBB13_117:                             # %.loopexit410
.Ltmp107:
	b	.LBB13_121
...
# %bb.3:                                # %vector.body
	...
	vld	$vr0, $a1, %pc_lo12(.LCPI16_2)
	vst	$vr1, $fp, 16
	pcalau12i	$a1, %pc_hi20(.LCPI16_3)
	vld	$vr1, $a1, %pc_lo12(.LCPI16_3)
	vst	$vr0, $fp, 32
	pcalau12i	$a1, %pc_hi20(.LCPI16_4)
	vld	$vr0, $a1, %pc_lo12(.LCPI16_4)
	vst	$vr1, $fp, 48
	pcalau12i	$a1, %pc_hi20(.LCPI16_5)
	vld	$vr1, $a1, %pc_lo12(.LCPI16_5)
	vst	$vr0, $fp, 64
	pcalau12i	$a1, %pc_hi20(.LCPI16_6)
	vld	$vr0, $a1, %pc_lo12(.LCPI16_6)
	vst	$vr1, $fp, 80
	pcalau12i	$a1, %pc_hi20(.LCPI16_7)
	vld	$vr1, $a1, %pc_lo12(.LCPI16_7)
	vst	$vr0, $fp, 96
	pcalau12i	$a1, %pc_hi20(.LCPI16_8)
	vld	$vr0, $a1, %pc_lo12(.LCPI16_8)
	vst	$vr1, $fp, 112
	pcalau12i	$a1, %pc_hi20(.LCPI16_9)
	vld	$vr1, $a1, %pc_lo12(.LCPI16_9)
	vst	$vr0, $fp, 128
	pcalau12i	$a1, %pc_hi20(.LCPI16_10)
	vld	$vr0, $a1, %pc_lo12(.LCPI16_10)
	vst	$vr1, $fp, 144
	pcalau12i	$a1, %pc_hi20(.LCPI16_11)
	vld	$vr1, $a1, %pc_lo12(.LCPI16_11)
	vst	$vr0, $fp, 160
	pcalau12i	$a1, %pc_hi20(.LCPI16_12)
	vld	$vr0, $a1, %pc_lo12(.LCPI16_12)
	vst	$vr1, $fp, 176
	pcalau12i	$a1, %pc_hi20(.LCPI16_13)
	vld	$vr1, $a1, %pc_lo12(.LCPI16_13)
	vst	$vr0, $fp, 192
	pcalau12i	$a1, %pc_hi20(.LCPI16_14)
	vld	$vr0, $a1, %pc_lo12(.LCPI16_14)
	vst	$vr1, $fp, 208
	pcalau12i	$a1, %pc_hi20(.LCPI16_15)
	vld	$vr1, $a1, %pc_lo12(.LCPI16_15)
	vst	$vr0, $fp, 224
...
.LBB18_22:                              # %.lr.ph.i6.i103
	...
	addi.d	$a2, $a2, 1
	bnez	$a3, .LBB18_22
# %bb.23:                               # %._crit_edge.loopexit.i.i110
	nor	$s3, $a1, $zero
	addi.d	$a0, $sp, 24
	move	$a1, $zero
	pcaddu18i	$ra, %call36(gettimeofday)
...
.LBB18_53:
	...
	mul.d	$a0, $a0, $a2
	add.d	$a0, $a0, $a1
.LBB18_54:                              # %_ZL12GetTimeCountv.exit119
	move	$s2, $zero
	sub.d	$a0, $a0, $s4
	ori	$a1, $zero, 1
	sltu	$a2, $a1, $a0
...
.Ltmp168:
	...
	jirl	$ra, $ra, 0
.Ltmp169:
# %bb.66:                               # %_ZN12CBenchBufferD2Ev.exit120
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB18_67:
