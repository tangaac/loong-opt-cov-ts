...
# %bb.65:                               # %.noexc419
	...
	move	$s1, $a0
	blez	$s0, .LBB6_86
# %bb.66:                               # %._crit_edge.thread.i.i417
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
# %bb.73:                               # %.noexc443
	...
	move	$s1, $a0
	blez	$s0, .LBB6_77
# %bb.74:                               # %._crit_edge.thread.i.i441
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	...
	ld.w	$a0, $a1, 32
	b	.LBB6_78
.LBB6_75:                               # %._ZN11CStringBaseIwEaSERKS0_.exit444_crit_edge
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 88
	bnez	$a0, .LBB6_82
	b	.LBB6_83
...
.LBB6_78:                               #   in Loop: Header=BB6_22 Depth=1
	...
	st.w	$s3, $a1, 36
	move	$s2, $s1
.LBB6_79:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i436
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 88
	move	$a1, $zero
	ld.d	$s3, $sp, 80                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB6_80:                               #   Parent Loop BB6_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s2, $a1
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB6_80
# %bb.81:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i440
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.w	$a1, $sp, 96
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	st.w	$a1, $s2, 32
...
.LBB6_82:                               #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_83:                               # %_ZN11CStringBaseIwED2Ev.exit423
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$s7, $zero
	move	$s1, $zero
.LBB6_84:                               # %.thread524
...
.Ltmp193:
	...
	jirl	$ra, $a1, 0
.Ltmp194:
# %bb.85:                               # %_ZN9CMyComPtrI10IInArchiveED2Ev.exit
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$s8, $s7
	bnez	$s1, .LBB6_21
	b	.LBB6_96
...
.LBB6_87:                               #   in Loop: Header=BB6_22 Depth=1
	...
	st.w	$s3, $a1, 36
	move	$s2, $s1
.LBB6_88:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i413
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 88
	move	$a1, $zero
	ld.d	$s3, $sp, 80                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB6_89:                               #   Parent Loop BB6_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s2, $a1
	addi.d	$a1, $a1, 4
...
.LBB6_91:                               #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_92:                               # %_ZN11CStringBaseIwED2Ev.exit421
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 344
	beqz	$a0, .LBB6_94
# %bb.93:                               #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_94:                               # %_ZN11CStringBaseIwED2Ev.exit422
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 376
	bnez	$a0, .LBB6_82
	b	.LBB6_83
.LBB6_95:
	ori	$s8, $zero, 1
.LBB6_96:                               # %_ZN11CStringBaseIwED2Ev.exit450
	addi.d	$a0, $sp, 408
...
# %bb.97:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_98:                               # %_ZN11CStringBaseIwED2Ev.exit451
	addi.w	$a0, $s8, 0
...
# %bb.100:                              # %.lr.ph
	...
	b	.LBB6_103
	.p2align	4, , 16
.LBB6_101:                              # %_ZNK10CArcInfoEx13FindExtensionERK11CStringBaseIwE.exit.thread
...
.Ltmp65:
	...
	jirl	$ra, $ra, 0
.Ltmp66:
# %bb.102:                              # %_ZN13CRecordVectorIiE3AddEi.exit330
                                        #   in Loop: Header=BB6_103 Depth=1
	ld.w	$a0, $sp, 420
	ld.d	$a1, $sp, 424
	slli.d	$a0, $a0, 2
...
.Ltmp88:
	...
	jirl	$ra, $ra, 0
.Ltmp89:
# %bb.148:                              # %_ZNK11CStringBaseIwE13CompareNoCaseEPKw.exit357
...
# %bb.152:
	move	$s1, $zero
	b	.LBB6_190
.LBB6_153:                              # %_ZN7CBufferIhED2Ev.exit360.thread687
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$s7, $zero
...
# %bb.158:                              # %.lr.ph614
	...
	move	$a0, $s6
	b	.LBB6_160
.LBB6_159:                              #   in Loop: Header=BB6_160 Depth=1
	addi.d	$a2, $a2, 1
	addi.d	$a1, $a1, 4
	bge	$a2, $a0, .LBB6_164
...
.LBB6_163:                              # %.thread487
	...
	ori	$s0, $zero, 1
	b	.LBB6_188
.LBB6_164:                              # %._crit_edge615
	st.d	$s1, $sp, 8                     # 8-byte Folded Spill
	ld.d	$a1, $sp, 368
	addi.d	$a1, $a1, -1
	st.d	$a1, $sp, 368
	beqz	$a1, .LBB6_180
# %bb.165:                              # %.preheader.lr.ph
...
.LBB6_166:                              #   in Loop: Header=BB6_167 Depth=1
	...
	bgeu	$a0, $a1, .LBB6_179
	.p2align	4, , 16
.LBB6_167:                              # =>This Loop Header: Depth=1
...
# %bb.168:                              #   in Loop: Header=BB6_167 Depth=1
	...
	beq	$a0, $a2, .LBB6_167
.LBB6_169:                              # %.critedge
                                        #   in Loop: Header=BB6_167 Depth=1
	beq	$a1, $s2, .LBB6_179
# %bb.170:                              #   in Loop: Header=BB6_167 Depth=1
	...
	b	.LBB6_172
	.p2align	4, , 16
.LBB6_171:                              # %_ZL13TestSignaturePKhS0_m.exit
	...
	ori	$a0, $zero, 255
	beq	$s6, $a0, .LBB6_166
.LBB6_172:                              #   Parent Loop BB6_167 Depth=1
...
# %bb.176:                              #   in Loop: Header=BB6_175 Depth=3
	...
	addi.d	$a2, $a2, 1
	bnez	$a0, .LBB6_175
# %bb.177:                              #   in Loop: Header=BB6_172 Depth=2
.Ltmp108:
	addi.d	$a0, $sp, 376
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector18ReserveOnePositionEv)
	jirl	$ra, $ra, 0
.Ltmp109:
# %bb.178:                              #   in Loop: Header=BB6_172 Depth=2
	ld.w	$a0, $sp, 388
	ld.d	$a1, $sp, 392
	slli.d	$a0, $a0, 2
	stx.w	$s1, $a1, $a0
	...
	bne	$s6, $a0, .LBB6_172
	b	.LBB6_166
.LBB6_179:                              # %.critedge._crit_edge.loopexit
	ld.w	$a0, $sp, 420
	ld.d	$s6, $sp, 0                     # 8-byte Folded Reload
.LBB6_180:                              # %.critedge._crit_edge
	blez	$a0, .LBB6_186
# %bb.181:                              # %.lr.ph620
	move	$s1, $zero
	move	$s2, $zero
	ori	$s5, $zero, 255
	b	.LBB6_183
.LBB6_182:                              #   in Loop: Header=BB6_183 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s1, $s1, 4
	bge	$s2, $a0, .LBB6_186
...
.Ltmp111:
	...
	jirl	$ra, $ra, 0
.Ltmp112:
# %bb.185:                              # %_ZN13CRecordVectorIiE3AddEi.exit339
                                        #   in Loop: Header=BB6_183 Depth=1
	ld.w	$a0, $sp, 388
	ld.d	$a1, $sp, 392
	slli.d	$a0, $a0, 2
	stx.w	$s0, $a1, $a0
...
.LBB6_188:
	...
	jirl	$ra, $ra, 0
	move	$s7, $s0
.LBB6_189:                              # %_ZN7CBufferIhED2Ev.exit
	slti	$s1, $s6, 256
.LBB6_190:                              # %_ZN7CBufferIhED2Ev.exit340
	move	$a0, $s8
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 376
...
# %bb.195:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_196:                              # %_ZN11CStringBaseIwED2Ev.exit367
.Ltmp123:
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
...
# %bb.199:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_200:                              # %_ZN11CStringBaseIwED2Ev.exit375
	ld.w	$a1, $sp, 420
	blez	$a1, .LBB6_19
# %bb.201:                              # %.lr.ph625
	ld.d	$a2, $sp, 424
...
.LBB6_207:                              # %scalar.ph
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB6_207
.LBB6_208:                              # %._crit_edge626
	addi.w	$a0, $a4, 0
	bltz	$a0, .LBB6_19
# %bb.209:                              # %._crit_edge626
	addi.w	$a1, $a3, 0
	bge	$a0, $a1, .LBB6_19
# %bb.210:
	ld.d	$a2, $sp, 424
...
# %bb.213:                              # %.thread498
	ld.d	$a0, $sp, 424
	st.w	$s1, $a0, 0
.LBB6_214:                              # %_ZN7CBufferIhED2Ev.exit360
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
...
.Ltmp189:
	...
	move	$s1, $a0
	bnez	$a1, .LBB6_240
# %bb.238:                              # %_ZN11CStringBaseIwED2Ev.exit424
	ld.d	$a0, $sp, 344
	bnez	$a0, .LBB6_251
.LBB6_239:                              # %_ZN11CStringBaseIwED2Ev.exit425
	ld.d	$a0, $sp, 376
	bnez	$a0, .LBB6_253
	b	.LBB6_271
.LBB6_240:
...
.LBB6_245:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_246:                              # %_ZN7CBufferIhED2Ev.exit342
	addi.d	$a0, $sp, 376
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB6_276
...
# %bb.248:
	...
	jirl	$ra, $ra, 0
	b	.LBB6_271
.LBB6_249:                              # %.loopexit.split-lp577.loopexit.split-lp
.Ltmp78:
	b	.LBB6_275
.LBB6_250:
.Ltmp186:
...
.Ltmp168:
	b	.LBB6_270
.LBB6_268:                              # %.loopexit.split-lp577.loopexit
.Ltmp69:
	b	.LBB6_275
.LBB6_269:
.Ltmp171:
...
.Ltmp139:
	b	.LBB6_275
.LBB6_274:                              # %.loopexit576
.Ltmp64:
.LBB6_275:                              # %_ZN7CBufferIhED2Ev.exit361
	move	$s1, $a0
.LBB6_276:                              # %_ZN7CBufferIhED2Ev.exit361
	addi.d	$a0, $sp, 408
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB6_277:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_278:                              # %_ZN11CStringBaseIwED2Ev.exit452
	ld.d	$a0, $sp, 440
	beqz	$a0, .LBB6_280
# %bb.279:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_280:                              # %_ZN11CStringBaseIwED2Ev.exit453
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end6:
