...
.LBB6_172:                              # %scalar.ph
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB6_172
.LBB6_173:                              # %._crit_edge626
	addi.w	$a0, $a3, 0
	bltz	$a0, .LBB6_19
# %bb.174:                              # %._crit_edge626
	addi.w	$a1, $a7, 0
	bge	$a0, $a1, .LBB6_19
# %bb.175:
	ld.d	$a2, $sp, 440
	...
	stx.w	$s6, $a2, $a0
	b	.LBB6_19
.LBB6_176:                              # %_ZN7CBufferIhED2Ev.exit360.thread687
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$s7, $zero
...
.LBB6_186:                              # %.thread487
	...
	ori	$s0, $zero, 1
	b	.LBB6_211
.LBB6_187:                              # %._crit_edge615
	ld.d	$a1, $sp, 384
	addi.d	$a1, $a1, -1
	st.d	$a1, $sp, 384
	beqz	$a1, .LBB6_203
# %bb.188:                              # %.preheader.lr.ph
	...
	st.d	$s2, $sp, 24                    # 8-byte Folded Spill
	b	.LBB6_190
.LBB6_189:                              #   in Loop: Header=BB6_190 Depth=1
	ld.d	$a1, $sp, 384
	...
	bgeu	$a0, $a1, .LBB6_202
	.p2align	4, , 16
.LBB6_190:                              # =>This Loop Header: Depth=1
                                        #     Child Loop BB6_195 Depth 2
                                        #       Child Loop BB6_198 Depth 3
	bstrpick.d	$s6, $s7, 31, 0
	addi.w	$s7, $s7, 1
	bgeu	$s6, $a1, .LBB6_192
# %bb.191:                              #   in Loop: Header=BB6_190 Depth=1
...
# %bb.193:                              #   in Loop: Header=BB6_190 Depth=1
	...
	b	.LBB6_195
	.p2align	4, , 16
.LBB6_194:                              # %_ZL13TestSignaturePKhS0_m.exit
	...
	ori	$a0, $zero, 255
	beq	$s5, $a0, .LBB6_189
.LBB6_195:                              #   Parent Loop BB6_190 Depth=1
...
.LBB6_198:                              # %.lr.ph.i334
                                        ...
                                        #     Parent Loop BB6_195 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a3, $a2, 0
	ld.bu	$a4, $a1, 0
	bne	$a3, $a4, .LBB6_194
# %bb.199:                              #   in Loop: Header=BB6_198 Depth=3
	addi.d	$a0, $a0, -1
	addi.d	$a1, $a1, 1
	addi.d	$a2, $a2, 1
	bnez	$a0, .LBB6_198
...
# %bb.201:                              #   in Loop: Header=BB6_195 Depth=2
	...
	bne	$s5, $a0, .LBB6_195
	b	.LBB6_189
.LBB6_202:                              # %.critedge._crit_edge.loopexit
	ld.w	$a0, $sp, 436
	ld.d	$s6, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 8                     # 8-byte Folded Reload
.LBB6_203:                              # %.critedge._crit_edge
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB6_209
# %bb.204:                              # %.lr.ph620
	move	$s1, $zero
	...
	ori	$s5, $zero, 255
	b	.LBB6_206
.LBB6_205:                              #   in Loop: Header=BB6_206 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s1, $s1, 4
	bge	$s2, $a0, .LBB6_209
.LBB6_206:                              # =>This Inner Loop Header: Depth=1
	...
	ldx.w	$s0, $a1, $s1
	beq	$s0, $s5, .LBB6_205
# %bb.207:                              #   in Loop: Header=BB6_206 Depth=1
.Ltmp111:
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector18ReserveOnePositionEv)
	jirl	$ra, $ra, 0
.Ltmp112:
# %bb.208:                              # %_ZN13CRecordVectorIiE3AddEi.exit339
...
.LBB6_211:
	...
	jirl	$ra, $ra, 0
	move	$s7, $s0
.LBB6_212:                              # %_ZN7CBufferIhED2Ev.exit
	slti	$s1, $s1, 256
	b	.LBB6_134
.LBB6_213:
.Ltmp91:
...
# %bb.215:                              # %.thread498
	ld.d	$a0, $sp, 440
	st.w	$s1, $a0, 0
.LBB6_216:                              # %_ZN7CBufferIhED2Ev.exit360
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
...
.Ltmp189:
	...
	move	$s1, $a0
	bnez	$a1, .LBB6_243
# %bb.241:                              # %_ZN11CStringBaseIwED2Ev.exit424
	ld.d	$a0, $sp, 360
	bnez	$a0, .LBB6_254
.LBB6_242:                              # %_ZN11CStringBaseIwED2Ev.exit425
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_256
	b	.LBB6_274
.LBB6_243:
...
.LBB6_248:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_249:                              # %_ZN7CBufferIhED2Ev.exit342
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB6_279
...
# %bb.251:
	...
	jirl	$ra, $ra, 0
	b	.LBB6_274
.LBB6_252:                              # %.loopexit.split-lp577.loopexit.split-lp
.Ltmp78:
	b	.LBB6_278
.LBB6_253:
.Ltmp186:
...
.Ltmp168:
	b	.LBB6_273
.LBB6_271:                              # %.loopexit.split-lp577.loopexit
.Ltmp69:
	b	.LBB6_278
.LBB6_272:
.Ltmp171:
...
.Ltmp139:
	b	.LBB6_278
.LBB6_277:                              # %.loopexit576
.Ltmp64:
.LBB6_278:                              # %_ZN7CBufferIhED2Ev.exit361
	move	$s1, $a0
...
.LBB6_280:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_281:                              # %_ZN11CStringBaseIwED2Ev.exit452
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB6_283
# %bb.282:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_283:                              # %_ZN11CStringBaseIwED2Ev.exit453
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end6:
