...
# %bb.42:
	...
	st.w	$s2, $sp, 276
	move	$s0, $s3
.LBB0_43:                               # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i14.preheader
	move	$a0, $zero
	.p2align	4, , 16
.LBB0_44:                               # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i14
                                        # =>This Inner Loop Header: Depth=1
	ldx.bu	$a1, $a0, $s4
	stx.b	$a1, $s0, $a0
	addi.d	$a0, $a0, 1
...
# %bb.48:
	ld.d	$a0, $sp, 264
	bnez	$a0, .LBB0_53
.LBB0_49:                               # %_ZN11CStringBaseIcED2Ev.exit39
	move	$a0, $fp
