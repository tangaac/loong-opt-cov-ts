...
# %bb.5:                                #   in Loop: Header=BB2_3 Depth=1
	...
	ori	$a3, $zero, 1
	blt	$a2, $a3, .LBB2_2
# %bb.6:                                # %.preheader545.lr.ph
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a2, $zero, 1
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
	blt	$a3, $a2, .LBB2_2
# %bb.7:                                # %.preheader545.lr.ph
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a2, $zero, 1
	blt	$a1, $a2, .LBB2_2
# %bb.8:                                # %.preheader545.lr.ph
                                        #   in Loop: Header=BB2_3 Depth=1
	ori	$a2, $zero, 1
	blt	$a0, $a2, .LBB2_2
# %bb.9:                                # %.preheader544.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	move	$a3, $zero
	...
	b	.LBB2_11
	.p2align	4, , 16
.LBB2_10:                               # %._crit_edge556.split.us.us.us.us.us.us
	...
	beq	$a3, $t0, .LBB2_2
.LBB2_11:                               # %.preheader544.us.us.us.us.us
	...
	b	.LBB2_13
	.p2align	4, , 16
.LBB2_12:                               # %._crit_edge.us.us.us.us.us.us
                                        #   in Loop: Header=BB2_13 Depth=3
	add.w	$a2, $a5, $ra
	addi.w	$s6, $s6, 1
	add.w	$a7, $a6, $s0
	beq	$s6, $a1, .LBB2_10
.LBB2_13:                               # %.preheader543.us.us.us.us.us.us
                                        #   Parent Loop BB2_3 Depth=1
...
.LBB2_34:                               # %._crit_edge700
	...
	addi.d	$t4, $t4, 1
	bge	$t4, $a0, .LBB2_27
.LBB2_35:                               #   Parent Loop BB2_23 Depth=1
...
# %bb.36:                               # %.preheader541.lr.ph
	...
	blt	$a3, $a2, .LBB2_34
# %bb.37:                               # %.preheader541.lr.ph
                                        #   in Loop: Header=BB2_35 Depth=3
	ori	$a2, $zero, 1
	blt	$a1, $a2, .LBB2_34
# %bb.38:                               # %.preheader541.lr.ph
                                        #   in Loop: Header=BB2_35 Depth=3
	ori	$a2, $zero, 1
	blt	$a0, $a2, .LBB2_34
# %bb.39:                               # %.preheader540.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB2_35 Depth=3
	move	$a3, $zero
	ld.w	$a2, $sp, 204
	...
	b	.LBB2_41
	.p2align	4, , 16
.LBB2_40:                               # %._crit_edge680.split.us.us.us.us.us.us
	...
	beq	$a3, $a2, .LBB2_34
.LBB2_41:                               # %.preheader540.us.us.us.us.us
                                        #   Parent Loop BB2_23 Depth=1
                                        #     Parent Loop BB2_29 Depth=2
	...
	b	.LBB2_43
	.p2align	4, , 16
.LBB2_42:                               # %._crit_edge675.us.us.us.us.us.us
                                        #   in Loop: Header=BB2_43 Depth=5
	add.w	$a4, $a7, $a4
	addi.w	$t8, $t8, 1
	add.w	$a5, $t0, $a5
	beq	$t8, $a1, .LBB2_40
.LBB2_43:                               # %.preheader.us.us.us.us.us.us
                                        #   Parent Loop BB2_23 Depth=1
                                        #     Parent Loop BB2_29 Depth=2
                                        #       Parent Loop BB2_35 Depth=3
...
# %bb.44:                               # %vector.memcheck872
	...
	move	$ra, $zero
	bltu	$t1, $s1, .LBB2_52
# %bb.45:                               # %vector.memcheck872
                                        #   in Loop: Header=BB2_43 Depth=5
	bltu	$s3, $s1, .LBB2_52
# %bb.46:                               # %vector.memcheck872
                                        #   in Loop: Header=BB2_43 Depth=5
	alsl.d	$t1, $a4, $s7, 3
	sub.d	$a2, $a2, $t1
	bltu	$a2, $s1, .LBB2_52
# %bb.47:                               # %vector.memcheck872
                                        #   in Loop: Header=BB2_43 Depth=5
	bltu	$s0, $s1, .LBB2_52
# %bb.48:                               # %vector.ph882
                                        #   in Loop: Header=BB2_43 Depth=5
...
.LBB2_49:                               # %vector.body885
	...
	vfmul.d	$vr2, $vr3, $vr2
	vfmul.d	$vr3, $vr4, $vr5
	vfmadd.d	$vr0, $vr0, $vr6, $vr2
	vfmadd.d	$vr1, $vr1, $vr7, $vr3
	vst	$vr0, $ra, -16
	vst	$vr1, $ra, 0
	addi.d	$t2, $t2, -4
	add.d	$ra, $ra, $t6
...
.LBB2_51:                               #   in Loop: Header=BB2_43 Depth=5
	move	$ra, $zero
.LBB2_52:                               # %scalar.ph880.preheader
                                        #   in Loop: Header=BB2_43 Depth=5
	alsl.d	$a2, $a5, $s5, 3
	alsl.d	$t1, $a4, $s4, 3
	alsl.d	$t2, $a4, $s7, 3
