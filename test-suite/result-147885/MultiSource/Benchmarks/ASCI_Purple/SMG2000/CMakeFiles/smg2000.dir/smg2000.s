...
# %bb.77:                               # %.preheader513.preheader
	...
	b	.LBB0_80
	.p2align	4, , 16
.LBB0_78:                               # %._crit_edge637.split.split.us
                                        #   in Loop: Header=BB0_80 Depth=1
	fst.d	$fa0, $t1, 0
	fst.d	$fa1, $t1, 8
	fst.d	$fa4, $t1, 16
.LBB0_79:                               # %._crit_edge637
                                        #   in Loop: Header=BB0_80 Depth=1
	add.d	$a0, $a0, $a1
	addi.w	$t1, $a0, 0
	bge	$t1, $s2, .LBB0_113
...
# %bb.82:                               # %.preheader513
                                        #   in Loop: Header=BB0_80 Depth=1
	bne	$s6, $t0, .LBB0_89
# %bb.83:                               # %.lr.ph636.split.us641.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s5, $a6, .LBB0_102
# %bb.84:                               #   in Loop: Header=BB0_80 Depth=1
	...
	b	.LBB0_105
	.p2align	4, , 16
.LBB0_85:                               # %.lr.ph636.split.us638.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s5, $a6, .LBB0_91
# %bb.86:                               #   in Loop: Header=BB0_80 Depth=1
	...
	b	.LBB0_94
	.p2align	4, , 16
.LBB0_87:                               # %.lr.ph636.split.us.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s5, $a6, .LBB0_96
# %bb.88:                               #   in Loop: Header=BB0_80 Depth=1
	...
	b	.LBB0_99
	.p2align	4, , 16
.LBB0_89:                               # %.lr.ph636.split.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s5, $a6, .LBB0_108
# %bb.90:                               #   in Loop: Header=BB0_80 Depth=1
	move	$t1, $zero
	b	.LBB0_111
.LBB0_91:                               # %vector.body872.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	vld	$vr7, $a5, %pc_lo12(.LCPI0_2)
	move	$t2, $a3
	move	$t3, $a2
	.p2align	4, , 16
.LBB0_92:                               # %vector.body872
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_92
# %bb.93:                               # %middle.block878
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_78
.LBB0_94:                               # %.lr.ph636.split.us638.preheader909
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
.LBB0_95:                               # %.lr.ph636.split.us638
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t2, $t3, 0
	addi.d	$t2, $t2, 1
	...
	bnez	$t4, .LBB0_95
	b	.LBB0_78
.LBB0_96:                               # %vector.body858.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a3
	move	$t3, $a2
	vori.b	$vr7, $vr6, 0
	.p2align	4, , 16
.LBB0_97:                               # %vector.body858
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.wu	$vr8, $vr7, 4
	vst	$vr7, $t2, -16
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_97
# %bb.98:                               # %middle.block864
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_101
.LBB0_99:                               # %.lr.ph636.split.us.preheader908
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
.LBB0_100:                              # %.lr.ph636.split.us
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t2, $t3, 0
	addi.d	$t2, $t2, 1
	...
	addi.d	$t3, $t3, 4
	bnez	$t4, .LBB0_100
.LBB0_101:                              # %._crit_edge637.split.us
                                        #   in Loop: Header=BB0_80 Depth=1
	fst.d	$fa0, $t1, 0
	fst.d	$fa5, $t1, 8
	b	.LBB0_79
.LBB0_102:                              # %vector.body886.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	vld	$vr7, $a5, %pc_lo12(.LCPI0_2)
	move	$t2, $a3
	move	$t3, $a2
	.p2align	4, , 16
.LBB0_103:                              # %vector.body886
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.wu	$vr8, $vr7, 4
	vst	$vr7, $t2, -16
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_103
# %bb.104:                              # %middle.block892
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_107
.LBB0_105:                              # %.lr.ph636.split.us641.preheader910
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
.LBB0_106:                              # %.lr.ph636.split.us641
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t2, $t3, 0
	addi.d	$t2, $t2, 1
	...
	addi.d	$t3, $t3, 4
	bnez	$t4, .LBB0_106
.LBB0_107:                              # %._crit_edge637.split.split.split.us
                                        #   in Loop: Header=BB0_80 Depth=1
	fst.d	$fa0, $t1, 0
	fst.d	$fa1, $t1, 8
	fst.d	$fa2, $t1, 16
	fst.d	$fa3, $t1, 24
	b	.LBB0_79
.LBB0_108:                              # %vector.body845.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	vld	$vr7, $a5, %pc_lo12(.LCPI0_2)
	move	$t1, $a3
	move	$t2, $a2
	.p2align	4, , 16
.LBB0_109:                              # %vector.body845
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.wu	$vr8, $vr7, 4
	vst	$vr7, $t1, -16
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB0_109
# %bb.110:                              # %middle.block850
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t1, $a2
	beq	$a2, $a1, .LBB0_79
.LBB0_111:                              # %.lr.ph636.split.preheader907
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t2, $t1, $s3, 2
	sub.d	$t3, $a1, $t1
	.p2align	4, , 16
.LBB0_112:                              # %.lr.ph636.split
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t1, $t2, 0
	addi.d	$t1, $t1, 1
...
.LBB0_126:                              # %._crit_edge653
	...
	ld.d	$s4, $sp, 144                   # 8-byte Folded Reload
	blez	$s5, .LBB0_134
# %bb.127:                              # %.lr.ph656.preheader
	ori	$a0, $zero, 4
	bgeu	$s5, $a0, .LBB0_129
# %bb.128:
	move	$a0, $zero
	b	.LBB0_132
.LBB0_129:                              # %vector.ph897
...
.LBB0_130:                              # %vector.body900
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB0_130
# %bb.131:                              # %middle.block903
	beq	$a0, $s5, .LBB0_134
.LBB0_132:                              # %.lr.ph656.preheader906
	alsl.d	$a1, $a0, $s0, 3
	sub.d	$a0, $s5, $a0
	lu52i.d	$a2, $zero, 1023
	.p2align	4, , 16
