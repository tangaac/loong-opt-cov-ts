...
# %bb.8:                                #   in Loop: Header=BB2_3 Depth=1
	...
	st.d	$s0, $sp, 1180
	ld.d	$s0, $sp, 1072                  # 8-byte Folded Reload
	st.w	$s0, $sp, 1188
	addi.d	$a2, $sp, 1180
	move	$a0, $s6
	move	$a1, $s1
...
.LBB2_13:                               #   in Loop: Header=BB2_3 Depth=1
	...
	maskeqz	$a1, $a1, $a2
	masknez	$a2, $s4, $a2
	ld.d	$s1, $sp, 1096                  # 8-byte Folded Reload
	ld.w	$a3, $s1, 4
	ld.w	$a4, $s1, -8
	or	$a1, $a1, $a2
	addi.d	$a1, $a1, 1
	...
	st.w	$zero, $sp, 1188
	addi.d	$a1, $sp, 1156
	ld.d	$s5, $sp, 1112                  # 8-byte Folded Reload
	move	$a0, $s5
	pcaddu18i	$ra, %call36(hypre_BoxGetSize)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s5, 0
	...
	mul.d	$a6, $a7, $s2
	add.w	$a6, $a3, $a6
	ld.d	$t6, $sp, 1088                  # 8-byte Folded Reload
	ld.w	$a3, $t6, 0
	ld.w	$a7, $t6, 4
	ld.w	$t3, $t6, 8
	ld.w	$t4, $t6, 16
	...
	slt	$a2, $a3, $t4
	masknez	$a3, $a3, $a2
	st.d	$t4, $sp, 656                   # 8-byte Folded Spill
	maskeqz	$a2, $t4, $a2
	or	$a2, $a2, $a3
	slt	$a3, $a2, $t5
	masknez	$a2, $a2, $a3
...
# %bb.20:                               # %.preheader2316.us.us.us.us.us.preheader
	...
	mul.d	$t5, $fp, $t6
	st.d	$t5, $sp, 1008                  # 8-byte Folded Spill
	...
	st.d	$t8, $sp, 992                   # 8-byte Folded Spill
	alsl.d	$a1, $t8, $a1, 3
	st.d	$a1, $sp, 952                   # 8-byte Folded Spill
	add.d	$a1, $t1, $s5
	nor	$a1, $a1, $zero
	...
	slli.d	$s5, $t6, 3
	add.d	$a0, $a0, $a1
	st.d	$t7, $sp, 1000                  # 8-byte Folded Spill
	slli.d	$a1, $t7, 3
	mul.d	$a0, $a0, $s2
	st.d	$a0, $sp, 888                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 696                   # 8-byte Folded Reload
...
.LBB2_21:                               # %.preheader2316.us.us.us.us.us
                                        ...
                                        #       Child Loop BB2_22 Depth 3
                                        #         Child Loop BB2_23 Depth 4
	st.d	$s0, $sp, 896                   # 8-byte Folded Spill
	move	$a1, $zero
	.p2align	4, , 16
...
.LBB2_23:                               #   Parent Loop BB2_3 Depth=1
	...
	sub.d	$t3, $t3, $t5
	bne	$s4, $ra, .LBB2_23
# %bb.24:                               # %._crit_edge.us.us.us.us.us.us2653
	...
	ld.d	$a0, $sp, 656                   # 8-byte Folded Reload
	bne	$a1, $a0, .LBB2_22
# %bb.25:                               # %._crit_edge2588.split.us.us.us.us.us.us
	...
	add.d	$a0, $a0, $a2
	sub.w	$a6, $a0, $t3
	ld.d	$s0, $sp, 896                   # 8-byte Folded Reload
	addi.w	$s0, $s0, 1
	sub.w	$a7, $s4, $a3
...
.LBB2_33:                               #   Parent Loop BB2_3 Depth=1
	...
	fldx.d	$fa1, $a3, $s5
	add.d	$a1, $s3, $t6
	ld.d	$s1, $sp, 1032                  # 8-byte Folded Reload
	fldx.d	$fa2, $s1, $s5
	fld.d	$fa3, $a1, 8
	fldx.d	$fa4, $t8, $s5
	fmul.d	$fa1, $fa0, $fa1
	...
	fldx.d	$fa3, $s1, $s5
	ld.d	$s1, $sp, 1016                  # 8-byte Folded Reload
	fldx.d	$fa4, $s1, $s5
	fmul.d	$fa1, $fa0, $fa1
	fmul.d	$fa1, $fa2, $fa1
	fmadd.d	$fa1, $fa3, $fa2, $fa1
	...
	sub.d	$s2, $s2, $a2
	bne	$t7, $s6, .LBB2_33
# %bb.34:                               # %._crit_edge.us.us.us.us.us.us2530
	...
	move	$t8, $t7
	bne	$a2, $a0, .LBB2_32
# %bb.35:                               # %._crit_edge2465.split.us.us.us.us.us.us
...
# %bb.44:                               # %._crit_edge.us.us.us.us.us.us
	...
	ld.d	$a0, $sp, 656                   # 8-byte Folded Reload
	bne	$a1, $a0, .LBB2_42
# %bb.45:                               # %._crit_edge2346.split.us.us.us.us.us.us
...
.LBB2_53:                               #   Parent Loop BB2_3 Depth=1
	...
	add.d	$t1, $t1, $s8
	bne	$a3, $a0, .LBB2_53
# %bb.54:                               # %._crit_edge.us.us.us.us.us.us2779
	...
	bne	$a2, $a1, .LBB2_52
# %bb.55:                               # %._crit_edge2713.split.us.us.us.us.us.us
