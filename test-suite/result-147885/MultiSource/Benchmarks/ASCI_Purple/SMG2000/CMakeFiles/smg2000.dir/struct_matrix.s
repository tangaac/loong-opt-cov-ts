...
# %bb.17:                               # %.preheader485.us.us.us.us.us.preheader
	...
	b	.LBB8_19
	.p2align	4, , 16
.LBB8_18:                               # %._crit_edge502.split.us.us.us.us.us.us
                                        #   in Loop: Header=BB8_19 Depth=3
	add.w	$ra, $ra, $a6
	addi.w	$a3, $a3, 1
	add.w	$s6, $s6, $a7
	beq	$a3, $a2, .LBB8_12
.LBB8_19:                               # %.preheader485.us.us.us.us.us
                                        #   Parent Loop BB8_8 Depth=1
	...
	b	.LBB8_21
	.p2align	4, , 16
.LBB8_20:                               # %._crit_edge497.us.us.us.us.us.us
                                        #   in Loop: Header=BB8_21 Depth=4
	add.w	$ra, $a4, $fp
	addi.w	$t7, $t7, 1
	add.w	$s6, $a5, $t8
	beq	$t7, $a1, .LBB8_18
.LBB8_21:                               # %.preheader483.us.us.us.us.us.us
                                        #   Parent Loop BB8_8 Depth=1
                                        #     Parent Loop BB8_13 Depth=2
                                        #       Parent Loop BB8_19 Depth=3
                                        # =>      This Loop Header: Depth=4
                                        #           Child Loop BB8_28 Depth 5
                                        #           Child Loop BB8_26 Depth 5
	beqz	$t3, .LBB8_24
# %bb.22:                               # %vector.memcheck829
                                        #   in Loop: Header=BB8_21 Depth=4
	alsl.d	$t8, $ra, $t0, 3
	alsl.d	$fp, $s6, $t2, 3
	bgeu	$t8, $fp, .LBB8_27
# %bb.23:                               # %vector.memcheck829
                                        #   in Loop: Header=BB8_21 Depth=4
	alsl.d	$t8, $ra, $t1, 3
	alsl.d	$fp, $s6, $s1, 3
	bgeu	$fp, $t8, .LBB8_27
.LBB8_24:                               #   in Loop: Header=BB8_21 Depth=4
	move	$s5, $zero
	move	$t8, $s6
	move	$fp, $ra
.LBB8_25:                               # %scalar.ph838.preheader
                                        #   in Loop: Header=BB8_21 Depth=4
	alsl.d	$s6, $t8, $s1, 3
	alsl.d	$ra, $fp, $t0, 3
	sub.d	$s5, $a0, $s5
	.p2align	4, , 16
.LBB8_26:                               # %scalar.ph838
                                        #   Parent Loop BB8_8 Depth=1
                                        #     Parent Loop BB8_13 Depth=2
                                        #       Parent Loop BB8_19 Depth=3
                                        #         Parent Loop BB8_21 Depth=4
...
# %bb.36:                               # %.preheader484.us.us.us.us.us.us744.preheader
	...
	b	.LBB8_38
	.p2align	4, , 16
.LBB8_37:                               # %._crit_edge613.split.us.us.us.us.us.us.us758
                                        #   in Loop: Header=BB8_38 Depth=3
	add.w	$t8, $t8, $a6
	addi.w	$a3, $a3, 1
	add.w	$t0, $t0, $a7
	beq	$a3, $a2, .LBB8_31
.LBB8_38:                               # %.preheader484.us.us.us.us.us.us744
                                        #   Parent Loop BB8_8 Depth=1
	...
	b	.LBB8_40
	.p2align	4, , 16
.LBB8_39:                               # %._crit_edge607.us.us.us.us.us.us.us755
                                        #   in Loop: Header=BB8_40 Depth=4
	add.w	$t8, $a4, $t7
	addi.w	$t6, $t6, 1
	add.w	$t0, $a5, $t0
	beq	$t6, $a1, .LBB8_37
.LBB8_40:                               # %.preheader.us.us.us.us.us.us.us748
                                        #   Parent Loop BB8_8 Depth=1
                                        #     Parent Loop BB8_32 Depth=2
                                        #       Parent Loop BB8_38 Depth=3
                                        # =>      This Loop Header: Depth=4
                                        #           Child Loop BB8_46 Depth 5
                                        #           Child Loop BB8_44 Depth 5
	beqz	$t1, .LBB8_42
