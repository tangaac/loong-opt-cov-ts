...
.LBB0_9:                                # %vector.body339
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB0_9
# %bb.10:                               # %middle.block344
	beq	$a0, $t7, .LBB0_61
.LBB0_11:                               # %.lr.ph237.preheader347
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB0_12:                               # %.lr.ph237
...
.LBB0_57:                               # %vector.body324
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB0_57
# %bb.58:                               # %middle.block329
	beq	$a0, $t7, .LBB0_61
.LBB0_59:                               # %.lr.ph235.preheader348
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB0_60:                               # %.lr.ph235
...
.LBB1_9:                                # %vector.body283
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB1_9
# %bb.10:                               # %middle.block288
	beq	$a0, $t7, .LBB1_45
.LBB1_11:                               # %.lr.ph220.preheader291
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB1_12:                               # %.lr.ph220
...
.LBB1_41:                               # %vector.body268
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB1_41
# %bb.42:                               # %middle.block273
	beq	$a0, $t7, .LBB1_45
.LBB1_43:                               # %.lr.ph218.preheader292
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB1_44:                               # %.lr.ph218
...
.LBB2_23:                               # %vector.ph
	...
	b	.LBB2_25
	.p2align	4, , 16
.LBB2_24:                               # %pred.store.continue152
...
.LBB2_27:                               # %pred.store.continue
	...
	andi	$s0, $s0, 1
	beqz	$s0, .LBB2_29
# %bb.28:                               # %pred.store.if147
                                        #   in Loop: Header=BB2_25 Depth=1
	st.d	$zero, $t6, -8
.LBB2_29:                               # %pred.store.continue148
                                        #   in Loop: Header=BB2_25 Depth=1
	vinsgr2vr.d	$vr2, $fp, 0
	vseq.w	$vr2, $vr2, $vr1
...
# %bb.30:                               # %pred.store.if149
	...
	b	.LBB2_32
	.p2align	4, , 16
.LBB2_31:                               # %pred.store.continue150
                                        #   in Loop: Header=BB2_25 Depth=1
	vshuf4i.w	$vr2, $vr2, 16
	vpickve2gr.d	$fp, $vr2, 1
	andi	$fp, $fp, 1
	beqz	$fp, .LBB2_24
.LBB2_32:                               # %pred.store.if151
                                        #   in Loop: Header=BB2_25 Depth=1
	st.d	$zero, $t6, 8
	b	.LBB2_24
