...
.LBB5_4:
	...
	fst.s	$ft5, $sp, 160                  # 4-byte Folded Spill
	fnmadd.s	$fa5, $ft5, $fa5, $fa2
	fneg.s	$fa2, $fa1
	fmadd.s	$fa4, $fs7, $fa2, $fa4
	fmadd.s	$fa6, $fs2, $fa1, $fs7
	fst.s	$ft8, $sp, 144                  # 4-byte Folded Spill
...
.LBB5_8:                                # %_Z15shortestArcQuatRK9btVector3S1_.exit
	...
	fmul.s	$ft12, $fa4, $fa5
	fst.s	$fs5, $sp, 176                  # 4-byte Folded Spill
	bcnez	$fcc0, .LBB5_13
# %bb.9:                                # %_Z15shortestArcQuatRK9btVector3S1_.exit
	fcmp.cult.s	$fcc1, $ft15, $fa0
	bcnez	$fcc1, .LBB5_13
# %bb.10:
	fst.s	$fs1, $sp, 56                   # 4-byte Folded Spill
	fst.s	$fs2, $sp, 60                   # 4-byte Folded Spill
	fmov.s	$fs2, $ft15
	fmov.s	$fs1, $fs7
	fmov.s	$fs7, $ft11
	fmov.s	$fs6, $ft8
...
# %bb.12:
	...
	fmul.s	$fa6, $ft2, $ft2
	frecip.s	$fa6, $fa6
	fld.s	$fa7, $sp, 56                   # 4-byte Folded Reload
	fmul.s	$fa7, $fa7, $fa7
	fdiv.s	$fa7, $fa5, $fa7
	fadd.s	$fa6, $fa6, $fa7
	vldi	$vr7, -1168
...
# %bb.15:
	...
	fabs.s	$fa1, $fs5
	fcmp.cule.s	$fcc0, $fa0, $fa1
	fld.s	$fs5, $sp, 176                  # 4-byte Folded Reload
	bcnez	$fcc0, .LBB5_17
# %bb.16:
	fabs.s	$fa1, $fs4
...
# %bb.20:
	...
	bcnez	$fcc0, .LBB5_47
# %bb.21:
	fst.s	$ft1, $sp, 4                    # 4-byte Folded Spill
	...
	fmov.s	$fs1, $fs2
	fst.s	$ft14, $sp, 28                  # 4-byte Folded Spill
	fst.s	$ft13, $sp, 32                  # 4-byte Folded Spill
	fst.s	$ft12, $sp, 36                  # 4-byte Folded Spill
	fst.s	$ft11, $sp, 40                  # 4-byte Folded Spill
	...
	fmov.s	$fa0, $fs4
	fst.s	$fa1, $sp, 0                    # 4-byte Folded Spill
	fmov.s	$fs2, $ft15
...
# %bb.22:
	...
	fld.s	$ft11, $sp, 40                  # 4-byte Folded Reload
	fld.s	$ft12, $sp, 36                  # 4-byte Folded Reload
	fld.s	$ft13, $sp, 32                  # 4-byte Folded Reload
	fld.s	$ft14, $sp, 28                  # 4-byte Folded Reload
	fmov.s	$fs2, $fs1
	b	.LBB5_45
.LBB5_23:
	movgr2fr.w	$fa5, $zero
...
.LBB5_37:                               # %_ZNK21btConeTwistConstraint33adjustSwingAxisToUseEllipseNormalER9btVector3.exit
	...
	fneg.s	$fa4, $fa1
	fneg.s	$fa5, $fa2
	fld.s	$fa7, $sp, 160                  # 4-byte Folded Reload
	fmul.s	$fa6, $fa7, $fa5
	fld.s	$ft2, $sp, 112                  # 4-byte Folded Reload
	fmadd.s	$fa6, $ft2, $fa3, $fa6
	fld.s	$ft0, $sp, 144                  # 4-byte Folded Reload
...
.LBB5_46:
	...
	fld.s	$ft2, $sp, 8                    # 4-byte Folded Reload
	fld.s	$ft1, $sp, 4                    # 4-byte Folded Reload
	fld.s	$fa1, $sp, 0                    # 4-byte Folded Reload
.LBB5_47:
	fmul.s	$fa0, $fa4, $fs5
...
.LBB5_56:                               # %._crit_edge712
	fst.s	$fa3, $fp, 580
	fst.s	$fa5, $fp, 556
	fld.s	$fa4, $sp, 160                  # 4-byte Folded Reload
	fmul.s	$fa3, $fa4, $fa1
	fld.s	$ft3, $sp, 112                  # 4-byte Folded Reload
	fmadd.s	$fa3, $ft3, $fa2, $fa3
	fld.s	$ft1, $sp, 144                  # 4-byte Folded Reload
...
.LBB10_21:                              # %_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit336
	...
	addi.d	$a3, $sp, 224
	fmov.s	$fa0, $fs0
	vst	$vr6, $sp, 0                    # 16-byte Folded Spill
...
# %bb.0:
	...
	fst.s	$ft3, $sp, 60                   # 4-byte Folded Spill
	fmul.s	$fa1, $ft3, $fs4
	fst.s	$ft4, $sp, 56                   # 4-byte Folded Spill
	fmadd.s	$fa1, $fs5, $ft4, $fa1
	fst.s	$fa4, $sp, 64                   # 4-byte Folded Spill
	...
	fst.s	$ft6, $sp, 0                    # 4-byte Folded Spill
	...
	fst.s	$fa7, $sp, 12                   # 4-byte Folded Spill
	...
	fmul.s	$fa0, $ft5, $fs0
	fst.s	$ft0, $sp, 4                    # 4-byte Folded Spill
	...
	fmul.s	$fa1, $fs7, $fa1
	fld.s	$ft1, $sp, 0                    # 4-byte Folded Reload
	...
	fld.s	$ft2, $sp, 48                   # 4-byte Folded Reload
	fadd.s	$ft2, $ft2, $ft1
	fmul.s	$ft1, $fs0, $ft3
	fmadd.s	$ft1, $fs4, $ft4, $ft1
	fmadd.s	$ft1, $fs6, $ft5, $ft1
	fld.s	$ft6, $sp, 52                   # 4-byte Folded Reload
	fadd.s	$ft6, $ft6, $ft1
	fmul.s	$ft1, $fs7, $ft3
	...
	fld.s	$fa0, $sp, 4                    # 4-byte Folded Reload
	fmadd.s	$ft6, $ft9, $fa0, $ft5
	fld.s	$ft10, $fp, 368
	fld.s	$fa3, $sp, 16                   # 4-byte Folded Reload
	fmul.s	$ft5, $fa3, $ft7
	fld.s	$fs7, $sp, 20                   # 4-byte Folded Reload
	...
	fld.s	$ft8, $fp, 352
	fld.s	$fs3, $sp, 32                   # 4-byte Folded Reload
	fmadd.s	$ft11, $ft9, $fs3, $ft5
	fld.s	$fs6, $sp, 28                   # 4-byte Folded Reload
	...
	fld.s	$ft13, $sp, 56                  # 4-byte Folded Reload
	fadd.s	$ft9, $ft13, $ft9
	fmul.s	$ft13, $fa3, $fs0
	fmadd.s	$ft13, $fs7, $fs1, $ft13
	fmadd.s	$ft13, $fs3, $fs2, $ft13
	fld.s	$fs3, $sp, 60                   # 4-byte Folded Reload
	...
	fmadd.s	$fa7, $ft0, $fa1, $fa7
	fmov.s	$ft1, $ft0
	fld.s	$ft0, $sp, 68                   # 4-byte Folded Reload
