...
.LBB28_26:                              # %vector.body567
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB28_26
# %bb.27:                               # %middle.block572
                                        #   in Loop: Header=BB28_18 Depth=1
	beq	$a2, $a1, .LBB28_32
.LBB28_28:                              # %scalar.ph562.preheader
                                        #   in Loop: Header=BB28_18 Depth=1
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s2, 2
	.p2align	4, , 16
.LBB28_29:                              # %scalar.ph562
                                        #   Parent Loop BB28_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
...
.LBB28_43:                              # %vector.body551
	...
	addi.d	$a3, $a3, 32
	bnez	$a1, .LBB28_43
# %bb.44:                               # %middle.block556
                                        #   in Loop: Header=BB28_18 Depth=1
	beq	$s7, $a0, .LBB28_48
.LBB28_45:                              # %.lr.ph.i.i.i243.preheader581
                                        #   in Loop: Header=BB28_18 Depth=1
	alsl.d	$a1, $a0, $s4, 2
	alsl.d	$a2, $a0, $s2, 2
	.p2align	4, , 16
...
.Ltmp47:
# %bb.55:
	fst.s	$fs6, $sp, 4                    # 4-byte Folded Spill
	ori	$a1, $zero, 0
	lu32i.d	$a1, 1
	st.d	$a1, $a0, 12
	ori	$a1, $zero, 3
...
.LBB29_13:                              # %vector.body147
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB29_13
# %bb.14:                               # %middle.block152
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$a0, $s5, .LBB29_20
.LBB29_15:                              # %.lr.ph.i.i.i.preheader194
                                        #   in Loop: Header=BB29_4 Depth=1
	sub.d	$a1, $s5, $a0
	alsl.d	$a2, $a0, $s4, 2
	alsl.d	$a0, $a0, $s2, 2
...
# %bb.32:                               # %middle.block135
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$fp, $a0, .LBB29_35
.LBB29_33:                              # %.lr.ph.i.i.i.1.preheader193
                                        #   in Loop: Header=BB29_4 Depth=1
	sub.d	$a1, $s5, $a0
	addi.d	$a1, $a1, 1
	alsl.d	$a2, $a0, $s2, 2
...
# %bb.47:                               # %middle.block
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$s7, $a0, .LBB29_50
.LBB29_48:                              # %.lr.ph.i.i.i.2.preheader192
                                        #   in Loop: Header=BB29_4 Depth=1
	sub.d	$a1, $s5, $a0
	addi.d	$a1, $a1, 2
	alsl.d	$a2, $a0, $s3, 2
...
# %bb.64:                               # %middle.block168
	beq	$a2, $a1, .LBB29_67
.LBB29_65:                              # %scalar.ph158.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB29_66:                              # %scalar.ph158
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
...
.LBB29_79:                              # %vector.body179
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB29_79
# %bb.80:                               # %middle.block184
	beq	$a1, $s5, .LBB29_83
.LBB29_81:                              # %scalar.ph174.preheader
	alsl.d	$a0, $a1, $a0, 2
	alsl.d	$a2, $a1, $s2, 2
	sub.d	$a1, $s5, $a1
	.p2align	4, , 16
.LBB29_82:                              # %scalar.ph174
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	st.w	$a3, $a0, 0
	addi.d	$a0, $a0, 4
...
.LBB32_43:                              # %vector.body311
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB32_43
# %bb.44:                               # %middle.block316
	beq	$a2, $a1, .LBB32_47
.LBB32_45:                              # %scalar.ph306.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s4, 2
	.p2align	4, , 16
.LBB32_46:                              # %scalar.ph306
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
