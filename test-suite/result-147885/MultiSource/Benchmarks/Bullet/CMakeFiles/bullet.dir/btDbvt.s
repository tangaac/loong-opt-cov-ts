...
# %bb.1:                                # %.preheader.lr.ph
	...
	addi.w	$s2, $zero, -1
	vrepli.b	$vr13, 0
	vst	$vr13, $sp, 0                   # 16-byte Folded Spill
	b	.LBB8_4
	.p2align	4, , 16
.LBB8_2:                                #   in Loop: Header=BB8_4 Depth=1
	...
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
	jirl	$ra, $ra, 0
	vld	$vr13, $sp, 0                   # 16-byte Folded Reload
	st.d	$zero, $a0, 0
	vst	$vr13, $a0, 8
	vst	$vr13, $a0, 24
	vst	$vr13, $a0, 40
...
.LBB11_27:                              # %vector.body300
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_27
# %bb.28:                               # %middle.block305
	beq	$a2, $a1, .LBB11_31
.LBB11_29:                              # %scalar.ph295.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_30:                              # %scalar.ph295
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	st.d	$a4, $a2, 0
	addi.d	$a1, $a1, -1
...
.Ltmp30:
	...
	jirl	$ra, $ra, 0
.Ltmp31:
# %bb.33:                               # %_ZN20btAlignedObjectArrayIP10btDbvtNodeE8allocateEi.exit.i133
	move	$s3, $a0
	ld.w	$a1, $sp, 76
	ld.d	$a0, $sp, 88
	ori	$a2, $zero, 1
...
.LBB11_40:                              # %scalar.ph
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB11_40
.LBB11_41:                              # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.thread.i143
	ld.bu	$a1, $sp, 96
	ori	$a2, $zero, 1
	beq	$a1, $a2, .LBB11_122
	b	.LBB11_123
...
.LBB11_53:                              # %vector.body316
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_53
# %bb.54:                               # %middle.block321
	beq	$a2, $a1, .LBB11_57
.LBB11_55:                              # %scalar.ph311.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_56:                              # %scalar.ph311
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	st.d	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB11_56
.LBB11_57:                              # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.thread.i116
	ld.bu	$a1, $sp, 128
	ori	$a2, $zero, 1
	beq	$a1, $a2, .LBB11_61
	b	.LBB11_62
.LBB11_58:
	...
	ori	$a2, $zero, 1
	bge	$a1, $a2, .LBB11_50
.LBB11_59:                              # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i108
	beqz	$a0, .LBB11_62
...
.Ltmp49:
	...
	jirl	$ra, $ra, 0
.Ltmp50:
.LBB11_62:                              # %_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i110
	ori	$a0, $zero, 1
	st.b	$a0, $sp, 128
	st.d	$s3, $sp, 120
	st.w	$fp, $sp, 112
.LBB11_63:                              # %_ZN20btAlignedObjectArrayIP10btDbvtNodeE7reserveEi.exit119
	ld.w	$s2, $sp, 76
	addi.w	$fp, $zero, -1
	bge	$fp, $s2, .LBB11_66
...
.LBB11_92:                              # %vector.body332
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_92
# %bb.93:                               # %middle.block337
                                        #   in Loop: Header=BB11_83 Depth=1
	beq	$a2, $a1, .LBB11_96
.LBB11_94:                              # %scalar.ph327.preheader
                                        #   in Loop: Header=BB11_83 Depth=1
	sub.d	$a3, $a1, $a2
	alsl.d	$a4, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_95:                              # %scalar.ph327
                                        #   Parent Loop BB11_83 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	st.d	$a5, $a2, 0
...
.LBB11_105:                             # %vector.body348
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_105
# %bb.106:                              # %middle.block353
                                        #   in Loop: Header=BB11_83 Depth=1
	beq	$a2, $a1, .LBB11_109
.LBB11_107:                             # %scalar.ph343.preheader
                                        #   in Loop: Header=BB11_83 Depth=1
	sub.d	$a3, $a1, $a2
	alsl.d	$a4, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_108:                             # %scalar.ph343
                                        #   Parent Loop BB11_83 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	st.d	$a5, $a2, 0
...
# %bb.119:                              # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i.i53.i
	...
	bnez	$a2, .LBB11_79
	b	.LBB11_81
.LBB11_120:                             # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i135
	beqz	$a0, .LBB11_123
# %bb.121:                              # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i135
	ld.b	$a1, $sp, 96
	andi	$a1, $a1, 1
	beqz	$a1, .LBB11_123
.LBB11_122:
.Ltmp32:
	...
	jirl	$ra, $ra, 0
.Ltmp33:
.LBB11_123:                             # %_ZN20btAlignedObjectArrayIP10btDbvtNodeE7reserveEi.exit146
	ori	$s4, $zero, 1
	ld.wu	$a0, $s1, 4
	st.b	$s4, $sp, 96
	st.d	$s3, $sp, 88
...
# %bb.127:
	move	$s3, $a0
.LBB11_128:                             # %_ZN20btAlignedObjectArrayIP10btDbvtNodeE8allocateEi.exit.i148
	ld.w	$a1, $sp, 108
	ld.d	$a0, $sp, 120
	ori	$a2, $zero, 1
	blt	$a1, $a2, .LBB11_137
...
.LBB11_132:                             # %vector.body268
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_132
# %bb.133:                              # %middle.block273
	beq	$a2, $a1, .LBB11_136
.LBB11_134:                             # %scalar.ph263.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_135:                             # %scalar.ph263
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	st.d	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB11_135
.LBB11_136:                             # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.thread.i158
	ld.bu	$a1, $sp, 128
	ori	$a2, $zero, 1
	beq	$a1, $a2, .LBB11_139
	b	.LBB11_140
.LBB11_137:                             # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i150
	beqz	$a0, .LBB11_140
# %bb.138:                              # %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i150
	ld.b	$a1, $sp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB11_140
.LBB11_139:
.Ltmp36:
	...
	jirl	$ra, $ra, 0
.Ltmp37:
.LBB11_140:                             # %_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i152
	ori	$a1, $zero, 1
	ld.w	$a0, $s1, 4
	st.b	$a1, $sp, 128
	st.d	$s3, $sp, 120
	st.w	$s2, $sp, 112
.LBB11_141:                             # %_ZN20btAlignedObjectArrayIP10btDbvtNodeE7reserveEi.exit161
	addi.w	$s2, $a0, 0
	blt	$s2, $s4, .LBB11_163
...
.LBB11_155:                             # %vector.body284
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB11_155
# %bb.156:                              # %middle.block289
                                        #   in Loop: Header=BB11_147 Depth=1
	beq	$a2, $a1, .LBB11_159
.LBB11_157:                             # %scalar.ph279.preheader
                                        #   in Loop: Header=BB11_147 Depth=1
	sub.d	$a3, $a1, $a2
	alsl.d	$a4, $a2, $a0, 3
	alsl.d	$a2, $a2, $s3, 3
	.p2align	4, , 16
.LBB11_158:                             # %scalar.ph279
                                        #   Parent Loop BB11_147 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	st.d	$a5, $a2, 0
...
.LBB25_28:                              #   Parent Loop BB25_13 Depth=1
	...
	addi.d	$a0, $a0, 16
	bnez	$s7, .LBB25_28
.LBB25_29:                              # %_ZNK20btAlignedObjectArrayIN6btDbvt7sStkCLNEE4copyEiiPS1_.exit.i.i38
                                        #   in Loop: Header=BB25_13 Depth=1
.Ltmp105:
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
...
.LBB25_30:                              #   in Loop: Header=BB25_13 Depth=1
	...
	ld.d	$fp, $s5, 48
	bne	$s6, $s0, .LBB25_35
# %bb.31:                               #   in Loop: Header=BB25_13 Depth=1
	slli.w	$s0, $s6, 1
	slli.d	$a0, $s0, 4
.Ltmp108:
	ori	$a1, $zero, 16
...
# %bb.32:                               # %.lr.ph.i.i.i61
	...
	move	$a1, $s6
	.p2align	4, , 16
.LBB25_33:                              #   Parent Loop BB25_13 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $s3, $a0
	vstx	$vr0, $s1, $a0
	addi.d	$a1, $a1, -1
	addi.d	$a0, $a0, 16
	bnez	$a1, .LBB25_33
# %bb.34:                               # %_ZNK20btAlignedObjectArrayIN6btDbvt7sStkCLNEE4copyEiiPS1_.exit.i.i56
                                        #   in Loop: Header=BB25_13 Depth=1
.Ltmp110:
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
...
.LBB25_35:                              # %._crit_edge
                                        #   in Loop: Header=BB25_13 Depth=1
	move	$s1, $s3
.LBB25_36:                              #   in Loop: Header=BB25_13 Depth=1
	alsl.d	$a0, $s6, $s1, 4
	slli.d	$a1, $s6, 4
	stx.d	$fp, $s1, $a1
	st.d	$s2, $a0, 8
...
.Ltmp116:
	...
	jirl	$ra, $ra, 0
.Ltmp117:
# %bb.43:                               # %_ZN20btAlignedObjectArrayIN6btDbvt7sStkCLNEED2Ev.exit74
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB25_44:
