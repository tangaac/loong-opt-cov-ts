...
# %bb.0:
	...
	fneg.s	$ft8, $ft6
	fmul.s	$ft8, $ft4, $ft8
	fmadd.s	$ft12, $ft3, $ft7, $ft8
	fst.s	$ft12, $a0, 116
	fneg.s	$ft7, $ft7
	fmul.s	$ft7, $ft2, $ft7
	fmadd.s	$ft11, $ft4, $ft5, $ft7
	fst.s	$ft11, $a0, 120
	fneg.s	$ft4, $ft5
	fmul.s	$ft3, $ft3, $ft4
	fmadd.s	$ft10, $ft2, $ft6, $ft3
	pcalau12i	$a0, %pc_hi20(.LCPI1_0)
	fld.s	$ft9, $a0, %pc_lo12(.LCPI1_0)
	fmul.s	$ft2, $ft11, $ft11
	fmadd.s	$ft2, $ft12, $ft12, $ft2
...
.LBB1_3:                                # %.thread
	fmul.s	$ft2, $ft0, $ft11
	fmadd.s	$ft2, $fa7, $ft12, $ft2
	fmadd.s	$fs1, $ft1, $ft10, $ft2
	fld.s	$ft3, $s0, 8
	fld.s	$ft6, $s0, 4
	fld.s	$ft2, $s0, 12
	fst.s	$fs1, $s0, 128
	fmul.s	$ft4, $ft11, $ft3
	fmadd.s	$ft4, $ft12, $ft6, $ft4
	fmadd.s	$ft4, $ft10, $ft2, $ft4
	fsub.s	$ft8, $ft4, $fs1
	fld.s	$ft5, $s0, 24
	fld.s	$ft7, $s0, 20
	fld.s	$ft4, $s0, 28
	fst.s	$ft8, $s0, 196
	fmul.s	$ft13, $ft11, $ft5
	fmadd.s	$ft13, $ft12, $ft7, $ft13
	fmadd.s	$ft13, $ft10, $ft4, $ft13
	fsub.s	$fs2, $ft13, $fs1
	fld.s	$ft13, $s0, 40
	fld.s	$ft14, $s0, 36
	fld.s	$ft15, $s0, 44
	fst.s	$fs2, $s0, 200
	fmul.s	$fs0, $ft11, $ft13
	fmadd.s	$fs0, $ft12, $ft14, $fs0
	fmadd.s	$fs0, $ft10, $ft15, $fs0
	fsub.s	$fs3, $fs0, $fs1
	fst.s	$fs3, $s0, 204
	fmul.s	$fs5, $ft8, $fs2
	fst.s	$fs5, $s0, 212
...
.LBB1_12:
	...
	fmadd.s	$ft12, $fs1, $ft15, $ft12
	fst.s	$ft12, $s0, 100
	fneg.s	$ft15, $ft15
	fmul.s	$ft15, $ft10, $ft15
	fmadd.s	$ft11, $ft11, $ft14, $ft15
	fst.s	$ft11, $s0, 104
	fneg.s	$ft14, $ft14
	fmul.s	$ft14, $fs1, $ft14
	fmadd.s	$ft10, $ft10, $ft13, $ft14
	fmul.s	$ft13, $ft11, $ft11
	fmadd.s	$ft13, $ft12, $ft12, $ft13
...
.LBB1_15:                               # %.thread150
	fmul.s	$ft9, $ft3, $ft11
	fmadd.s	$ft9, $ft6, $ft12, $ft9
	fmadd.s	$ft9, $ft2, $ft10, $ft9
	fst.s	$ft9, $s0, 112
	fmul.s	$ft0, $ft11, $ft0
	fmadd.s	$fa7, $ft12, $fa7, $ft0
	fmadd.s	$fa7, $ft10, $ft1, $fa7
	fsub.s	$fa7, $fa7, $ft9
	fst.s	$fa7, $s0, 220
	fmul.s	$fa2, $ft11, $fa2
	fmadd.s	$fa1, $ft12, $fa1, $fa2
	fmadd.s	$fa1, $ft10, $fa4, $fa1
	fsub.s	$fa1, $fa1, $ft9
	fst.s	$fa1, $s0, 224
	fmul.s	$fa2, $fa5, $ft11
	fmadd.s	$fa2, $ft12, $fa3, $fa2
	fmadd.s	$fa2, $ft10, $fa6, $fa2
	fsub.s	$fa2, $fa2, $ft9
	fst.s	$fa2, $s0, 228
	fmul.s	$fa4, $fa7, $fa1
	fst.s	$fa4, $s0, 236
