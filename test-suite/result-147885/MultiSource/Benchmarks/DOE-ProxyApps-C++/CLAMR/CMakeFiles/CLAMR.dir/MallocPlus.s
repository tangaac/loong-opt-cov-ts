...
# %bb.13:                               #   in Loop: Header=BB6_9 Depth=1
	...
	maskeqz	$a0, $s8, $a0
	or	$a0, $a0, $a1
.LBB6_14:                               # %_ZNKSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE14_M_lower_boundEPSt18_Rb_tree_node_baseSD_RS2_.exit.thread.i.i
                                        #   in Loop: Header=BB6_9 Depth=1
	move	$a1, $s8
	pcaddu18i	$ra, %call36(_ZSt28_Rb_tree_rebalance_for_erasePSt18_Rb_tree_node_baseRS_)
	jirl	$ra, $ra, 0
...
# %bb.14:                               #   in Loop: Header=BB8_10 Depth=1
	...
	maskeqz	$a0, $s4, $a0
	or	$a0, $a0, $a1
.LBB8_15:                               # %_ZNKSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE14_M_lower_boundEPSt18_Rb_tree_node_baseSD_RS2_.exit.thread.i.i
                                        #   in Loop: Header=BB8_10 Depth=1
	move	$a1, $s4
	pcaddu18i	$ra, %call36(_ZSt28_Rb_tree_rebalance_for_erasePSt18_Rb_tree_node_baseRS_)
	jirl	$ra, $ra, 0
...
.Ltmp63:
	...
	jirl	$ra, $ra, 0
.Ltmp64:
# %bb.28:                               # %_ZNSt6vectorIiSaIiEE6resizeEm.exit.preheader
                                        #   in Loop: Header=BB15_9 Depth=1
	ld.d	$a0, $s2, 16
	ld.d	$s7, $a0, 0
	addi.w	$a0, $s7, 0
...
# %bb.29:                               # %.lr.ph
	...
	ld.d	$a3, $sp, 8                     # 8-byte Folded Reload
	.p2align	4, , 16
.LBB15_30:                              # %_ZNSt6vectorIiSaIiEE6resizeEm.exit
                                        #   Parent Loop BB15_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a4, $a3, 0
	slli.d	$a4, $a4, 2
...
# %bb.35:                               #   in Loop: Header=BB15_9 Depth=1
	...
	move	$s8, $s4
	beqz	$a0, .LBB15_40
# %bb.36:                               # %.lr.ph.i.i.i.i.preheader
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$a1, $s4
	.p2align	4, , 16
.LBB15_37:                              # %.lr.ph.i.i.i.i
                                        #   Parent Loop BB15_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 32
	sltu	$a2, $a2, $s5
...
# %bb.46:                               #   in Loop: Header=BB15_9 Depth=1
	...
	move	$s8, $s4
	beqz	$a0, .LBB15_51
# %bb.47:                               # %.lr.ph.i.i.i.i105.preheader
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$a1, $s4
	.p2align	4, , 16
.LBB15_48:                              # %.lr.ph.i.i.i.i105
                                        #   Parent Loop BB15_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 32
	sltu	$a2, $a2, $s5
	...
	or	$a1, $a1, $a3
	bnez	$a0, .LBB15_48
# %bb.49:                               # %_ZNSt3mapIPvP24malloc_plus_memory_entrySt4lessIS0_ESaISt4pairIKS0_S2_EEE11lower_boundERS6_.exit.i113
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$s8, $s4
	beq	$a1, $s4, .LBB15_51
...
# %bb.61:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB15_62:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit125
	ld.d	$a1, $sp, 56
.Ltmp90:
	addi.d	$a0, $sp, 40
	pcaddu18i	$ra, %call36(_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE8_M_eraseEPSt13_Rb_tree_nodeIS5_E)
...
.Ltmp92:
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB15_65:                              # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE10_Auto_nodeD2Ev.exit.i128
.Ltmp89:
	b	.LBB15_72
.LBB15_66:
.Ltmp86:
	b	.LBB15_75
.LBB15_67:                              # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE10_Auto_nodeD2Ev.exit.i140
.Ltmp83:
	b	.LBB15_72
.LBB15_68:
.Ltmp80:
...
# %bb.5:                                # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i
	...
	move	$a3, $s3
	bnez	$a0, .LBB60_7
.LBB60_6:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i.i.i
	sub.d	$a0, $s4, $s5
	lu12i.w	$a1, -524288
	slt	$a2, $a1, $a0
	maskeqz	$a0, $a0, $a2
