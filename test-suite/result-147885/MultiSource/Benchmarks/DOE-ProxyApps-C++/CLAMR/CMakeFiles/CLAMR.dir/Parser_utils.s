...
.LBB2_9:                                # %._crit_edge
	...
	sub.w	$t1, $t1, $a5
	bne	$a3, $t2, .LBB2_12
# %bb.10:                               # %_ZN2PP12Parser_utils9start_dexERSt6vectorIiSaIiEERKS3_.exit.thread100
	beq	$t1, $a1, .LBB2_41
# %bb.11:                               # %_ZN2PP12Parser_utils9start_dexERSt6vectorIiSaIiEERKS3_.exit.thread100
	ori	$a6, $zero, 1
	bgtz	$a2, .LBB2_23
	b	.LBB2_41
.LBB2_12:                               # %.lr.ph.i
...
# %bb.18:                               # %middle.block130
	...
	beq	$t2, $t6, .LBB2_13
.LBB2_19:                               # %scalar.ph120.preheader
                                        #   in Loop: Header=BB2_14 Depth=1
	alsl.d	$t8, $t6, $t3, 2
	.p2align	4, , 16
.LBB2_20:                               # %scalar.ph120
                                        #   Parent Loop BB2_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$fp, $t8, 0
	mul.d	$t7, $fp, $t7
...
# %bb.38:                               # %middle.block145
	...
	beq	$fp, $s0, .LBB2_33
.LBB2_39:                               # %scalar.ph133.preheader
                                        #   in Loop: Header=BB2_34 Depth=2
	alsl.d	$s2, $s0, $t0, 2
	.p2align	4, , 16
.LBB2_40:                               # %scalar.ph133
                                        #   Parent Loop BB2_24 Depth=1
                                        #     Parent Loop BB2_34 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$s3, $s2, 0
...
.LBB3_27:                               # %vector.ph
	...
	b	.LBB3_29
	.p2align	4, , 16
.LBB3_28:                               # %pred.store.continue493
...
# %bb.30:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_39
.LBB3_31:                               # %pred.store.continue481
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.w	$a4, $vr1, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_40
.LBB3_32:                               # %pred.store.continue483
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.w	$a4, $vr1, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_34
.LBB3_33:                               # %pred.store.if484
                                        #   in Loop: Header=BB3_29 Depth=1
	vstelm.w	$vr0, $a1, -4, 3
.LBB3_34:                               # %pred.store.continue485
                                        #   in Loop: Header=BB3_29 Depth=1
	vld	$vr0, $a2, 0
	vld	$vr1, $a1, 0
	vslt.w	$vr1, $vr1, $vr0
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_41
# %bb.35:                               # %pred.store.continue487
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.w	$a4, $vr1, 1
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_42
.LBB3_36:                               # %pred.store.continue489
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.w	$a4, $vr1, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_43
.LBB3_37:                               # %pred.store.continue491
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.w	$a4, $vr1, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_28
...
.LBB3_38:                               # %pred.store.if
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_31
.LBB3_39:                               # %pred.store.if480
                                        #   in Loop: Header=BB3_29 Depth=1
	vstelm.w	$vr0, $a1, -12, 1
	vpickve2gr.w	$a4, $vr1, 2
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_32
.LBB3_40:                               # %pred.store.if482
                                        #   in Loop: Header=BB3_29 Depth=1
	vstelm.w	$vr0, $a1, -8, 2
	vpickve2gr.w	$a4, $vr1, 3
	andi	$a4, $a4, 1
	...
	b	.LBB3_34
	.p2align	4, , 16
.LBB3_41:                               # %pred.store.if486
                                        #   in Loop: Header=BB3_29 Depth=1
	vstelm.w	$vr0, $a1, 0, 0
	vpickve2gr.w	$a4, $vr1, 1
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_36
.LBB3_42:                               # %pred.store.if488
                                        #   in Loop: Header=BB3_29 Depth=1
	vstelm.w	$vr0, $a1, 4, 1
	vpickve2gr.w	$a4, $vr1, 2
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_37
.LBB3_43:                               # %pred.store.if490
                                        #   in Loop: Header=BB3_29 Depth=1
	vstelm.w	$vr0, $a1, 8, 2
	vpickve2gr.w	$a4, $vr1, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_28
.LBB3_44:                               # %pred.store.if492
                                        #   in Loop: Header=BB3_29 Depth=1
...
.Ltmp6:
	...
	move	$a1, $a0
.Ltmp7:
# %bb.48:                               # %.lr.ph.i.i.i.i.i198.preheader
	ori	$a2, $zero, 8
	move	$a0, $s0
	move	$a5, $a1
	bltu	$s0, $a2, .LBB3_52
...
.LBB3_50:                               # %vector.body499
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB3_50
# %bb.51:                               # %middle.block502
	beq	$s0, $a2, .LBB3_53
	.p2align	4, , 16
.LBB3_52:                               # %.lr.ph.i.i.i.i.i198
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $a0, -1
	st.w	$s2, $a1, 0
	addi.d	$a1, $a1, 4
	bnez	$a0, .LBB3_52
.LBB3_53:                               # %_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit206.loopexit
	alsl.d	$a0, $s0, $a5, 2
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	b	.LBB3_59
.LBB3_54:                               # %.lr.ph.preheader535
...
.LBB3_59:                               # %_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit206
...
.LBB3_73:                               #   in Loop: Header=BB3_74 Depth=1
	...
	mul.w	$a0, $a0, $a1
	bge	$s0, $a0, .LBB3_129
.LBB3_74:                               # %.preheader321
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB3_77 Depth 2
	slli.d	$a0, $s0, 4
	blez	$s3, .LBB3_91
# %bb.75:                               # %.lr.ph368.preheader
	...
	b	.LBB3_77
	.p2align	4, , 16
.LBB3_76:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit213
...
# %bb.79:                               # %.noexc209
	...
	st.d	$a0, $sp, 184
	st.d	$a1, $sp, 200
.LBB3_80:                               # %._crit_edge.i.i207
                                        #   in Loop: Header=BB3_77 Depth=2
	addi.w	$a2, $zero, -1
	beq	$a1, $a2, .LBB3_83
# %bb.81:                               # %._crit_edge.i.i207
                                        #   in Loop: Header=BB3_77 Depth=2
	bnez	$a1, .LBB3_86
# %bb.82:                               #   in Loop: Header=BB3_77 Depth=2
	ld.b	$a1, $s6, 0
	st.b	$a1, $a0, 0
.LBB3_83:                               #   in Loop: Header=BB3_77 Depth=2
	ld.d	$a0, $sp, 152
	st.d	$a0, $sp, 192
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	blt	$s3, $a1, .LBB3_87
.LBB3_84:                               #   in Loop: Header=BB3_77 Depth=2
	beq	$s5, $s3, .LBB3_88
.LBB3_85:                               #   in Loop: Header=BB3_77 Depth=2
	ld.d	$a0, $sp, 184
	bne	$a0, $s4, .LBB3_89
	b	.LBB3_76
	.p2align	4, , 16
.LBB3_86:                               #   in Loop: Header=BB3_77 Depth=2
	addi.d	$a2, $a1, 1
	move	$a1, $s6
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
	...
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	bge	$s3, $a1, .LBB3_84
.LBB3_87:                               #   in Loop: Header=BB3_77 Depth=2
	ld.w	$a1, $s1, 0
	ld.w	$a2, $s8, 0
	add.d	$a1, $a1, $fp
	add.w	$fp, $a1, $a2
	bne	$s5, $s3, .LBB3_85
.LBB3_88:                               #   in Loop: Header=BB3_77 Depth=2
	...
	ld.d	$a0, $sp, 184
	beq	$a0, $s4, .LBB3_76
.LBB3_89:                               # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i211
                                        #   in Loop: Header=BB3_77 Depth=2
	ld.d	$a1, $sp, 200
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	...
	b	.LBB3_76
	.p2align	4, , 16
.LBB3_90:                               # %._crit_edge369.loopexit
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s6, $a0, 0
	ld.d	$s3, $sp, 56                    # 8-byte Folded Reload
...
.LBB3_91:                               #   in Loop: Header=BB3_74 Depth=1
	move	$fp, $zero
	bge	$s1, $fp, .LBB3_72
.LBB3_92:                               #   in Loop: Header=BB3_74 Depth=1
	alsl.d	$s2, $s0, $a0, 3
	ldx.d	$a0, $s6, $s2
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	slli.d	$s1, $a1, 5
...
# %bb.94:                               # %.noexc216
	...
	st.d	$a0, $sp, 184
	st.d	$a1, $sp, 200
.LBB3_95:                               # %._crit_edge.i.i214
                                        #   in Loop: Header=BB3_74 Depth=1
	move	$s8, $s0
	addi.w	$s0, $zero, -1
	beq	$a1, $s0, .LBB3_99
# %bb.96:                               # %._crit_edge.i.i214
                                        #   in Loop: Header=BB3_74 Depth=1
	bnez	$a1, .LBB3_98
# %bb.97:                               #   in Loop: Header=BB3_74 Depth=1
	ld.b	$a1, $s6, 0
	st.b	$a1, $a0, 0
	b	.LBB3_99
.LBB3_98:                               #   in Loop: Header=BB3_74 Depth=1
	...
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB3_99:                               #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a3, $sp, 152
...
.Ltmp15:
	...
	jirl	$ra, $ra, 0
.Ltmp16:
.LBB3_104:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$s6, $sp, 184
	ld.d	$s7, $sp, 192
	addi.d	$a0, $sp, 168
...
.Ltmp18:
	...
	jirl	$ra, $ra, 0
.Ltmp19:
# %bb.105:                              #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a0, $sp, 160
	addi.w	$a1, $zero, -2
	lu52i.d	$a1, $a1, 2047
	sub.d	$a0, $a1, $a0
...
.Ltmp20:
	...
	jirl	$ra, $ra, 0
.Ltmp21:
# %bb.107:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKcm.exit.i.i
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a0, $sp, 160
	addi.w	$a1, $zero, -5
	lu52i.d	$a1, $a1, 2047
	bgeu	$a0, $a1, .LBB3_187
# %bb.108:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i10.i.i
                                        #   in Loop: Header=BB3_74 Depth=1
.Ltmp22:
	...
	jirl	$ra, $ra, 0
.Ltmp23:
# %bb.109:                              # %_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EERKS8_PKS5_.exit
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ldx.d	$a1, $a0, $s2
	...
	addi.d	$a2, $fp, 16
	beq	$a0, $a2, .LBB3_112
# %bb.110:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a1, $sp, 152
	addi.d	$a3, $sp, 168
	ld.d	$s1, $sp, 80                    # 8-byte Folded Reload
	beq	$a1, $a3, .LBB3_116
# %bb.111:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit23.thread25.i
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a2, $a2, 0
	b	.LBB3_114
...
# %bb.113:                              #   in Loop: Header=BB3_74 Depth=1
	move	$a0, $zero
                                        # implicit-def: $r6
.LBB3_114:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit24.i
                                        #   in Loop: Header=BB3_74 Depth=1
	st.d	$a1, $fp, 0
	ld.d	$a1, $sp, 160
	st.d	$a1, $fp, 8
	...
	st.d	$a1, $fp, 16
	beqz	$a0, .LBB3_120
# %bb.115:                              #   in Loop: Header=BB3_74 Depth=1
	st.d	$a0, $sp, 152
	st.d	$a2, $sp, 168
	b	.LBB3_123
.LBB3_116:                              #   in Loop: Header=BB3_74 Depth=1
	addi.d	$a2, $sp, 152
	beq	$a2, $fp, .LBB3_128
# %bb.117:                              #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a2, $sp, 160
	beqz	$a2, .LBB3_122
# %bb.118:                              #   in Loop: Header=BB3_74 Depth=1
	ori	$a3, $zero, 1
	bne	$a2, $a3, .LBB3_121
# %bb.119:                              #   in Loop: Header=BB3_74 Depth=1
	ld.b	$a1, $a1, 0
	st.b	$a1, $a0, 0
	b	.LBB3_122
.LBB3_120:                              #   in Loop: Header=BB3_74 Depth=1
	addi.d	$a0, $sp, 168
	st.d	$a0, $sp, 152
	b	.LBB3_123
.LBB3_121:                              #   in Loop: Header=BB3_74 Depth=1
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
...
.LBB3_123:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
	...
	addi.d	$a1, $sp, 168
	beq	$a0, $a1, .LBB3_125
# %bb.124:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i220
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a1, $sp, 168
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_125:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit222
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a0, $sp, 184
	addi.d	$a1, $sp, 200
	beq	$a0, $a1, .LBB3_127
# %bb.126:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i223
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a1, $sp, 200
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_127:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit225
                                        #   in Loop: Header=BB3_74 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s6, $a0, 0
	b	.LBB3_73
...
# %bb.132:                              # %.preheader320
	...
	blez	$s3, .LBB3_143
# %bb.133:                              # %.preheader319.preheader
                                        #   in Loop: Header=BB3_131 Depth=1
	move	$s0, $zero
	b	.LBB3_135
	.p2align	4, , 16
.LBB3_134:                              # %._crit_edge377
                                        #   in Loop: Header=BB3_135 Depth=2
	addi.d	$s0, $s0, 1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	beq	$s0, $a0, .LBB3_143
.LBB3_135:                              # %.preheader319
...
.Ltmp25:
	...
	jirl	$ra, $ra, 0
.Ltmp26:
# %bb.138:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
                                        #   in Loop: Header=BB3_137 Depth=3
	ld.w	$a0, $fp, 0
	addi.w	$s2, $s2, 1
	blt	$s2, $a0, .LBB3_137
.LBB3_139:                              # %.preheader318
                                        #   in Loop: Header=BB3_135 Depth=2
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ldx.w	$a0, $a0, $s1
	blez	$a0, .LBB3_134
# %bb.140:                              # %.lr.ph376.preheader
                                        #   in Loop: Header=BB3_135 Depth=2
	move	$s1, $zero
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	alsl.d	$fp, $s0, $a0, 2
...
.Ltmp28:
	...
	jirl	$ra, $ra, 0
.Ltmp29:
# %bb.142:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit236
...
# %bb.144:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
	...
	ld.bu	$a0, $s7, 56
	beqz	$a0, .LBB3_146
# %bb.145:                              #   in Loop: Header=BB3_131 Depth=1
	ld.bu	$a0, $s7, 67
	b	.LBB3_148
.LBB3_146:                              #   in Loop: Header=BB3_131 Depth=1
.Ltmp31:
	move	$a0, $s7
...
.Ltmp37:
	...
	jirl	$ra, $ra, 0
.Ltmp38:
.LBB3_150:                              # %_ZNSolsEPFRSoS_E.exit
                                        #   in Loop: Header=BB3_131 Depth=1
	blez	$s3, .LBB3_172
# %bb.151:                              # %.lr.ph395
                                        #   in Loop: Header=BB3_131 Depth=1
	...
	b	.LBB3_153
	.p2align	4, , 16
.LBB3_152:                              # %._crit_edge389
                                        #   in Loop: Header=BB3_153 Depth=2
	addi.d	$s7, $s7, 1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	move	$s8, $s1
	beq	$s7, $a0, .LBB3_172
.LBB3_153:                              #   Parent Loop BB3_131 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_158 Depth 3
                                        #       Child Loop BB3_161 Depth 3
                                        #       Child Loop BB3_170 Depth 3
...
.Ltmp39:
	...
	jirl	$ra, $ra, 0
.Ltmp40:
# %bb.159:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit240
...
.LBB3_160:                              # %.preheader
                                        #   in Loop: Header=BB3_153 Depth=2
	sub.w	$s2, $s3, $s8
	bstrpick.d	$fp, $s2, 31, 1
	move	$s0, $fp
	ori	$a0, $zero, 2
	blt	$s2, $a0, .LBB3_163
	.p2align	4, , 16
.LBB3_161:                              # %.lr.ph384.split
                                        #   Parent Loop BB3_131 Depth=1
                                        #     Parent Loop BB3_153 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
.Ltmp42:
	...
	jirl	$ra, $ra, 0
.Ltmp43:
# %bb.162:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit242
                                        #   in Loop: Header=BB3_161 Depth=3
	addi.w	$s0, $s0, -1
	bnez	$s0, .LBB3_161
.LBB3_163:                              # %._crit_edge385
                                        #   in Loop: Header=BB3_153 Depth=2
	move	$a0, $s7
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	blt	$s1, $a1, .LBB3_167
# %bb.164:                              #   in Loop: Header=BB3_153 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	bge	$s7, $a0, .LBB3_166
# %bb.165:                              #   in Loop: Header=BB3_153 Depth=2
	ld.d	$a0, $s5, 0
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
	alsl.d	$a1, $s7, $a1, 2
	ld.w	$a1, $a1, 0
...
.Ltmp45:
	...
	jirl	$ra, $ra, 0
.Ltmp46:
.LBB3_166:                              # %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit
                                        #   in Loop: Header=BB3_153 Depth=2
...
.Ltmp47:
	...
	jirl	$ra, $ra, 0
.Ltmp48:
.LBB3_168:                              # %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit245
                                        #   in Loop: Header=BB3_153 Depth=2
	blez	$s2, .LBB3_152
# %bb.169:                              # %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit245
                                        #   in Loop: Header=BB3_153 Depth=2
	add.d	$a0, $s8, $fp
	sub.w	$s0, $s3, $a0
	blez	$s0, .LBB3_152
	.p2align	4, , 16
.LBB3_170:                              # %.lr.ph388.split
                                        #   Parent Loop BB3_131 Depth=1
                                        #     Parent Loop BB3_153 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
.Ltmp50:
	...
	jirl	$ra, $ra, 0
.Ltmp51:
# %bb.171:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit249
                                        #   in Loop: Header=BB3_170 Depth=3
	addi.w	$s0, $s0, -1
	bnez	$s0, .LBB3_170
	b	.LBB3_152
	.p2align	4, , 16
.LBB3_172:                              # %._crit_edge396
                                        #   in Loop: Header=BB3_131 Depth=1
	ld.d	$a0, $s5, 0
	ld.d	$a0, $a0, -24
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	...
	ld.d	$s3, $sp, 56                    # 8-byte Folded Reload
	beqz	$s7, .LBB3_185
# %bb.173:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i263
                                        #   in Loop: Header=BB3_131 Depth=1
	ld.bu	$a0, $s7, 56
	beqz	$a0, .LBB3_175
# %bb.174:                              #   in Loop: Header=BB3_131 Depth=1
	ld.bu	$a0, $s7, 67
	b	.LBB3_177
	.p2align	4, , 16
.LBB3_175:                              #   in Loop: Header=BB3_131 Depth=1
.Ltmp53:
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp55:
	...
	jirl	$ra, $a2, 0
.Ltmp56:
.LBB3_177:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i265
                                        #   in Loop: Header=BB3_131 Depth=1
.Ltmp57:
	ext.w.b	$a1, $a0
	move	$a0, $s5
...
.Ltmp59:
	...
	jirl	$ra, $ra, 0
.Ltmp60:
# %bb.179:                              # %_ZNSolsEPFRSoS_E.exit238
                                        #   in Loop: Header=BB3_131 Depth=1
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a0, $a1, 8
	ld.d	$a1, $a1, 0
	...
	mul.w	$a0, $a0, $a1
	blt	$s8, $a0, .LBB3_131
.LBB3_180:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
...
# %bb.181:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_182:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit230
...
# %bb.183:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_184:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit232
...
.Ltmp5:
	...
	beqz	$a0, .LBB3_218
	b	.LBB3_220
.LBB3_194:                              # %.loopexit323
.Ltmp17:
	b	.LBB3_197
.LBB3_195:
.Ltmp14:
	b	.LBB3_214
.LBB3_196:                              # %.loopexit.split-lp324
.Ltmp70:
.LBB3_197:
	move	$s0, $a0
	b	.LBB3_202
.LBB3_198:                              # %.loopexit.split-lp329
.Ltmp67:
	b	.LBB3_200
.LBB3_199:                              # %.loopexit328
.Ltmp24:
.LBB3_200:
	move	$s0, $a0
	ld.d	$a0, $sp, 152
	addi.d	$a1, $sp, 168
	beq	$a0, $a1, .LBB3_202
# %bb.201:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i
	ld.d	$a1, $sp, 168
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_202:
	...
	addi.d	$a1, $sp, 200
	beq	$a0, $a1, .LBB3_215
# %bb.203:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i226
	ld.d	$a1, $sp, 200
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	b	.LBB3_215
.LBB3_204:                              # %.loopexit.split-lp
.Ltmp64:
	b	.LBB3_214
.LBB3_205:
.Ltmp11:
...
.LBB3_213:
.Ltmp41:
.LBB3_214:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit251
	move	$s0, $a0
.LBB3_215:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit251
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB3_216:
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	bnez	$a0, .LBB3_219
# %bb.217:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit253
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	bnez	$a0, .LBB3_220
.LBB3_218:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit255
	move	$a0, $s0
