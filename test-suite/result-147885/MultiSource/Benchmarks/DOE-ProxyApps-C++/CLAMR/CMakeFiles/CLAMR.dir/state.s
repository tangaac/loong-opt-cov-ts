...
# %bb.20:
	st.d	$a1, $fp, 1448
.LBB6_21:                               # %_ZNSt6vectorIdSaIdEE6resizeEm.exit480
	ld.d	$a3, $fp, 1472
	ld.d	$a1, $fp, 1464
	sub.d	$a2, $a3, $a1
	srai.d	$a2, $a2, 3
...
# %bb.25:
	st.d	$a1, $fp, 1472
.LBB6_26:                               # %_ZNSt6vectorIdSaIdEE6resizeEm.exit482
	ld.d	$a3, $fp, 1496
	ld.d	$a1, $fp, 1488
	sub.d	$a2, $a3, $a1
	srai.d	$a2, $a2, 3
...
# %bb.30:
	...
	st.d	$a1, $a0, 1496
.LBB6_31:                               # %_ZNSt6vectorIdSaIdEE6resizeEm.exit484
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s3, $a0, 1160
	addi.w	$t0, $s3, 0
	bge	$t0, $s0, .LBB6_35
# %bb.32:                               # %.lr.ph490.preheader
	sub.d	$a1, $s0, $t0
	ori	$a2, $zero, 24
	move	$a0, $t0
	bgeu	$a1, $a2, .LBB6_85
.LBB6_33:                               # %.lr.ph490.preheader540
...
# %bb.24:                               # %middle.block
	bne	$a0, $a4, .LBB12_3
	b	.LBB12_5
.LBB12_25:                              # %vector.ph109
	bstrpick.d	$a2, $a1, 30, 1
	slli.d	$a2, $a2, 1
	addi.d	$a3, $s1, 4
	move	$a4, $a2
	.p2align	4, , 16
.LBB12_26:                              # %vector.body112
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a3, -4
	ld.w	$a6, $a3, 0
	slli.d	$a5, $a5, 3
	...
	addi.d	$a3, $a3, 8
	bnez	$a4, .LBB12_26
# %bb.27:                               # %middle.block115
	beq	$a2, $a1, .LBB12_30
.LBB12_28:                              # %scalar.ph107.preheader
	alsl.d	$a3, $a2, $s1, 2
	sub.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB12_29:                              # %scalar.ph107
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a3, 0
	slli.d	$a2, $a2, 3
	fstx.d	$fs0, $a0, $a2
...
.LBB17_178:                             # %call.sqrt1318
	...
	move	$a1, $s0
	b	.LBB17_154
.LBB17_179:                             # %._crit_edge1181.._crit_edge1185_crit_edge
