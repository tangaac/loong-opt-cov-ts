...
# %bb.14:                               # %.lr.ph.i.preheader.i.i.i.i.i64
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB0_15:                               # %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit69
                                        #   in Loop: Header=BB0_5 Depth=1
	vldi	$vr5, -928
	vldi	$vr6, -1168
	b	.LBB0_17
...
# %bb.23:                               # %.noexc84
	...
	ori	$a0, $zero, 1
	beq	$s5, $a0, .LBB0_25
# %bb.24:                               # %.lr.ph.i.preheader.i.i.i.i.i80
                                        #   in Loop: Header=BB0_5 Depth=1
	addi.d	$a0, $s4, 4
	addi.d	$a2, $s8, -4
	move	$a1, $zero
...
# %bb.26:                               # %.noexc92
	...
	ori	$a0, $zero, 1
	beq	$s5, $a0, .LBB0_28
# %bb.27:                               # %.lr.ph.i.preheader.i.i.i.i.i88
                                        #   in Loop: Header=BB0_5 Depth=1
	addi.d	$a0, $s6, 4
	addi.d	$a2, $s8, -4
	move	$a1, $zero
...
# %bb.29:                               # %.noexc100
	...
	ori	$a0, $zero, 1
	beq	$s5, $a0, .LBB0_31
# %bb.30:                               # %.lr.ph.i.preheader.i.i.i.i.i96
                                        #   in Loop: Header=BB0_5 Depth=1
	addi.d	$a0, $s7, 4
	addi.d	$a2, $s8, -4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB0_31:                               # %_ZNSt6vectorIfSaIfEEC2EmRKS0_.exit101
                                        #   in Loop: Header=BB0_5 Depth=1
	vldi	$vr5, -928
	vldi	$vr6, -1168
...
# %bb.51:                               #   in Loop: Header=BB0_5 Depth=1
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_52:                               # %_ZNSt6vectorIfSaIfEED2Ev.exit109
                                        #   in Loop: Header=BB0_5 Depth=1
	beqz	$s0, .LBB0_54
# %bb.53:                               #   in Loop: Header=BB0_5 Depth=1
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_54:                               # %_ZNSt6vectorIfSaIfEED2Ev.exit111
                                        #   in Loop: Header=BB0_5 Depth=1
	beqz	$fp, .LBB0_4
...
.LBB0_73:                               # %_ZNSt6vectorIfSaIfEED2Ev.exit125
	bnez	$fp, .LBB0_77
.LBB0_74:                               # %_ZNSt6vectorIfSaIfEED2Ev.exit127
	move	$a0, $s0
