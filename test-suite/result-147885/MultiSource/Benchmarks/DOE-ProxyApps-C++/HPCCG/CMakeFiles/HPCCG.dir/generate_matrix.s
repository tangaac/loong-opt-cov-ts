...
.LBB0_20:                               #   in Loop: Header=BB0_13 Depth=4
	...
	addi.d	$a0, $a0, 4
	addi.w	$s4, $s4, 1
.LBB0_21:                               # %.preheader.split.us.split.us212.us.us.1
                                        #   in Loop: Header=BB0_13 Depth=4
	add.w	$s6, $t8, $s5
	bgeu	$s6, $s0, .LBB0_26
...
.LBB0_25:                               #   in Loop: Header=BB0_13 Depth=4
	...
	addi.d	$a0, $a0, 4
	addi.w	$s4, $s4, 1
.LBB0_26:                               # %.preheader.split.us.split.us212.us.us.2
                                        #   in Loop: Header=BB0_13 Depth=4
	bgeu	$a7, $s2, .LBB0_32
# %bb.27:                               # %.preheader.split.us.split.us212.us.us.2
                                        #   in Loop: Header=BB0_13 Depth=4
	addi.w	$s6, $s6, 1
	bgeu	$s6, $s0, .LBB0_32
...
.LBB0_30:                               #   in Loop: Header=BB0_13 Depth=4
	st.d	$s8, $s7, 0
	vldi	$vr1, -965
.LBB0_31:                               #   in Loop: Header=BB0_13 Depth=4
	fst.d	$fa1, $s8, 0
	addi.d	$s8, $s8, 8
	st.w	$s6, $a0, 0
	addi.d	$a0, $a0, 4
	addi.w	$s4, $s4, 1
.LBB0_32:                               # %.preheader.split.us.us.us.us.1
                                        #   in Loop: Header=BB0_13 Depth=4
	bge	$t3, $s1, .LBB0_50
# %bb.33:                               # %.preheader.split.us.split.us212.us.us.preheader.1
                                        #   in Loop: Header=BB0_13 Depth=4
	add.w	$a1, $a4, $s5
	bgeu	$a2, $s2, .LBB0_39
# %bb.34:                               # %.preheader.split.us.split.us212.us.us.preheader.1
                                        #   in Loop: Header=BB0_13 Depth=4
	add.w	$s6, $t1, $s5
	bgeu	$s6, $s0, .LBB0_39
# %bb.35:                               #   in Loop: Header=BB0_13 Depth=4
	addi.w	$t2, $a1, -1
	beqz	$t2, .LBB0_37
# %bb.36:                               #   in Loop: Header=BB0_13 Depth=4
	vldi	$vr1, -784
	b	.LBB0_38
.LBB0_37:                               #   in Loop: Header=BB0_13 Depth=4
	st.d	$s8, $s7, 0
	vldi	$vr1, -965
.LBB0_38:                               #   in Loop: Header=BB0_13 Depth=4
	...
	addi.d	$a0, $a0, 4
	addi.w	$s4, $s4, 1
.LBB0_39:                               # %.preheader.split.us.split.us212.us.us.1.1
                                        #   in Loop: Header=BB0_13 Depth=4
	add.w	$s6, $t5, $s5
	bgeu	$s6, $s0, .LBB0_44
...
# %bb.41:                               #   in Loop: Header=BB0_13 Depth=4
	vldi	$vr1, -784
	b	.LBB0_43
.LBB0_42:                               #   in Loop: Header=BB0_13 Depth=4
	st.d	$s8, $s7, 0
	vldi	$vr1, -965
.LBB0_43:                               #   in Loop: Header=BB0_13 Depth=4
	...
	addi.d	$a0, $a0, 4
	addi.w	$s4, $s4, 1
.LBB0_44:                               # %.preheader.split.us.split.us212.us.us.2.1
                                        #   in Loop: Header=BB0_13 Depth=4
	bgeu	$a7, $s2, .LBB0_50
# %bb.45:                               # %.preheader.split.us.split.us212.us.us.2.1
                                        #   in Loop: Header=BB0_13 Depth=4
	addi.w	$s6, $s6, 1
	bgeu	$s6, $s0, .LBB0_50
# %bb.46:                               #   in Loop: Header=BB0_13 Depth=4
	beq	$a1, $s3, .LBB0_48
# %bb.47:                               #   in Loop: Header=BB0_13 Depth=4
	vldi	$vr1, -784
	b	.LBB0_49
.LBB0_48:                               #   in Loop: Header=BB0_13 Depth=4
	st.d	$s8, $s7, 0
	vldi	$vr1, -965
.LBB0_49:                               #   in Loop: Header=BB0_13 Depth=4
	...
	addi.d	$a0, $a0, 4
	addi.w	$s4, $s4, 1
.LBB0_50:                               # %.split.us205.us.us.1
                                        #   in Loop: Header=BB0_13 Depth=4
	bgeu	$a5, $s1, .LBB0_12
# %bb.51:                               # %.preheader.split.us.split.us212.us.us.preheader.2
                                        #   in Loop: Header=BB0_13 Depth=4
	add.w	$a1, $a6, $s5
	bgeu	$a2, $s2, .LBB0_57
# %bb.52:                               # %.preheader.split.us.split.us212.us.us.preheader.2
                                        #   in Loop: Header=BB0_13 Depth=4
	add.w	$s6, $ra, $s5
	bgeu	$s6, $s0, .LBB0_57
# %bb.53:                               #   in Loop: Header=BB0_13 Depth=4
	addi.w	$t2, $a1, -1
	beqz	$t2, .LBB0_55
...
.LBB0_55:                               #   in Loop: Header=BB0_13 Depth=4
	st.d	$s8, $s7, 0
	vldi	$vr1, -965
.LBB0_56:                               #   in Loop: Header=BB0_13 Depth=4
	fst.d	$fa1, $s8, 0
	addi.d	$s8, $s8, 8
	st.w	$s6, $a0, 0
	addi.d	$a0, $a0, 4
	addi.w	$s4, $s4, 1
.LBB0_57:                               # %.preheader.split.us.split.us212.us.us.1.2
                                        #   in Loop: Header=BB0_13 Depth=4
	add.w	$s6, $t4, $s5
	bgeu	$s6, $s0, .LBB0_62
# %bb.58:                               #   in Loop: Header=BB0_13 Depth=4
	beqz	$a1, .LBB0_60
# %bb.59:                               #   in Loop: Header=BB0_13 Depth=4
	vldi	$vr1, -784
	b	.LBB0_61
.LBB0_60:                               #   in Loop: Header=BB0_13 Depth=4
	st.d	$s8, $s7, 0
	vldi	$vr1, -965
.LBB0_61:                               #   in Loop: Header=BB0_13 Depth=4
	fst.d	$fa1, $s8, 0
	addi.d	$s8, $s8, 8
	st.w	$s6, $a0, 0
	addi.d	$a0, $a0, 4
	addi.w	$s4, $s4, 1
.LBB0_62:                               # %.preheader.split.us.split.us212.us.us.2.2
                                        #   in Loop: Header=BB0_13 Depth=4
	bgeu	$a7, $s2, .LBB0_12
# %bb.63:                               # %.preheader.split.us.split.us212.us.us.2.2
                                        #   in Loop: Header=BB0_13 Depth=4
	addi.w	$s6, $s6, 1
	bgeu	$s6, $s0, .LBB0_12
# %bb.64:                               #   in Loop: Header=BB0_13 Depth=4
	beq	$a1, $s3, .LBB0_10
