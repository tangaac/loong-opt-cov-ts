...
.LBB0_11:                               # %.lr.ph42
	...
	bnez	$a0, .LBB0_11
	b	.LBB0_22
.LBB0_12:                               # %vector.memcheck86
	sub.d	$a6, $a3, $a1
	ori	$a5, $zero, 32
	move	$a4, $zero
	bltu	$a6, $a5, .LBB0_4
# %bb.13:                               # %vector.memcheck86
	sub.d	$a6, $a3, $a2
	bltu	$a6, $a5, .LBB0_4
# %bb.14:                               # %vector.ph92
...
.LBB0_22:                               # %.loopexit
	move	$a0, $zero
	ret
.LBB0_23:                               # %vector.memcheck65
	sub.d	$a6, $a3, $a1
	ori	$a5, $zero, 32
	move	$a4, $zero
	bltu	$a6, $a5, .LBB0_10
# %bb.24:                               # %vector.memcheck65
	sub.d	$a6, $a3, $a2
	bltu	$a6, $a5, .LBB0_10
# %bb.25:                               # %vector.ph71
	bstrpick.d	$a4, $a0, 30, 2
