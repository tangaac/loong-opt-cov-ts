...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s6
.LBB5_19:                               # %.lr.ph.i167.preheader330
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
# %bb.56:                               # %.lr.ph234
	...
	b	.LBB5_58
	.p2align	4, , 16
.LBB5_57:                               # %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit215
...
.LBB5_64:                               # %.lr.ph.i205
	...
	addi.d	$a2, $a2, 8
	bnez	$a7, .LBB5_64
.LBB5_65:                               # %.lr.ph.preheader.i209
                                        #   in Loop: Header=BB5_58 Depth=1
	ld.d	$a2, $fp, 304
	move	$a3, $a4
	bgeu	$a0, $s4, .LBB5_80
.LBB5_66:                               # %.lr.ph.i211.preheader
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a0, $a5, $a3
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a6, $a3, $s6, 3
...
# %bb.69:                               # %vector.memcheck301
	...
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
# %bb.70:                               # %vector.memcheck301
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
# %bb.71:                               # %vector.memcheck301
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
...
.LBB5_73:                               # %vector.body314
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB5_73
# %bb.74:                               # %middle.block326
                                        #   in Loop: Header=BB5_58 Depth=1
	bne	$a0, $a7, .LBB5_60
	b	.LBB5_62
	.p2align	4, , 16
.LBB5_75:                               # %vector.memcheck281
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_63
# %bb.76:                               # %vector.memcheck281
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_63
...
.LBB5_78:                               # %vector.body290
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB5_78
# %bb.79:                               # %middle.block298
                                        #   in Loop: Header=BB5_58 Depth=1
	bne	$a0, $a7, .LBB5_63
	b	.LBB5_65
	.p2align	4, , 16
.LBB5_80:                               # %vector.memcheck261
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s5, .LBB5_66
# %bb.81:                               # %vector.memcheck261
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a6, $a2, $s6
	move	$a3, $a4
	bltu	$a6, $s5, .LBB5_66
...
.LBB5_83:                               # %vector.body270
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB5_83
# %bb.84:                               # %middle.block278
                                        #   in Loop: Header=BB5_58 Depth=1
	beq	$a0, $a6, .LBB5_57
	b	.LBB5_66
.LBB5_85:                               # %._crit_edge235
