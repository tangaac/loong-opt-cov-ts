...
.LBB0_18:
	movgr2fr.d	$fa0, $zero
.LBB0_19:                               # %initInterpolationObject.exit.i21
	fst.d	$fa0, $s2, 0
	alsl.d	$a0, $s3, $s1, 3
	fld.d	$fa0, $a0, -8
	ld.w	$s3, $sp, 120
...
.LBB0_28:                               # %scalar.ph
	...
	bnez	$a1, .LBB0_28
	b	.LBB0_30
.LBB0_29:                               # %.preheader.thread.i
	fld.d	$fa0, $sp, 104
	vst	$vr0, $sp, 16                   # 16-byte Folded Spill
.LBB0_30:                               # %._crit_edge71.i
	fld.d	$fa0, $s6, 8
	fld.d	$fa1, $s6, 16
	fsub.d	$fa1, $fa0, $fa1
	fadd.d	$fa0, $fa0, $fa1
...
.LBB0_32:                               # %.lr.ph73.i
	...
	addi.d	$s1, $s1, 8
	blt	$s8, $s3, .LBB0_32
# %bb.33:                               # %._crit_edge74.loopexit.i
	fld.d	$fa0, $sp, 104
	slli.d	$a0, $s3, 3
	addi.d	$s8, $a0, 24
	frecip.d	$fs0, $fa0
	b	.LBB0_35
.LBB0_34:                               # %._crit_edge74.critedge.i
	alsl.d	$a0, $s3, $s1, 3
	fld.d	$fa0, $a0, -8
	fstx.d	$fa0, $s1, $s0
	fst.d	$fa0, $a0, 8
...
.LBB0_49:                               # %vector.body63
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_49
# %bb.50:                               # %middle.block72
	beq	$a1, $a2, .LBB0_54
.LBB0_51:                               # %scalar.ph56.preheader
	sub.d	$a1, $s3, $a0
	alsl.d	$a2, $a0, $s5, 3
	movgr2fr.d	$fa0, $zero
	.p2align	4, , 16
.LBB0_52:                               # %scalar.ph56
	...
	bnez	$a1, .LBB0_52
	b	.LBB0_54
.LBB0_53:                               # %._crit_edge73.critedge.i
	alsl.d	$a0, $s3, $s8, 3
	fld.d	$fa0, $a0, -8
	fstx.d	$fa0, $s8, $s0
	fst.d	$fa0, $a0, 8
