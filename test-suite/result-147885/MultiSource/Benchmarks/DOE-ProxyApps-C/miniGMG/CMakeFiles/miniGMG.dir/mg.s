...
# %bb.7:                                #   in Loop: Header=BB8_6 Depth=1
	...
	b	.LBB8_11
	.p2align	4, , 16
.LBB8_8:                                # %vector.body145.preheader
                                        #   in Loop: Header=BB8_6 Depth=1
	move	$t1, $a3
	move	$t2, $a4
	.p2align	4, , 16
.LBB8_9:                                # %vector.body145
	...
	addi.d	$t2, $t2, 512
	bnez	$t1, .LBB8_9
# %bb.10:                               # %middle.block148
                                        #   in Loop: Header=BB8_6 Depth=1
	move	$t2, $a3
	beq	$a3, $a0, .LBB8_5
.LBB8_11:                               # %scalar.ph140.preheader
                                        #   in Loop: Header=BB8_6 Depth=1
	slli.d	$t1, $t2, 8
	add.d	$t1, $a5, $t1
	sub.d	$t2, $a0, $t2
	.p2align	4, , 16
.LBB8_12:                               # %scalar.ph140
                                        #   Parent Loop BB8_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t1, 0
	fstx.d	$fa0, $t3, $t0
...
# %bb.18:                               # %middle.block
	beq	$a0, $s1, .LBB8_21
.LBB8_19:                               # %.lr.ph95.split.preheader151
	alsl.d	$a1, $a0, $fp, 3
	addi.d	$a1, $a1, 1616
	sub.d	$a2, $s1, $a0
	ori	$a3, $zero, 1
