...
.LBB0_18:                               # %vector.body1108
	...
	addi.d	$a4, $a4, 288
	bnez	$a3, .LBB0_18
.LBB0_19:                               # %.lr.ph594.preheader1136
                                        #   in Loop: Header=BB0_6 Depth=1
	slli.d	$a3, $a1, 7
	alsl.d	$a3, $a1, $a3, 4
	lu12i.w	$a4, 2
...
.LBB0_24:                               # %vector.body1094
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_24
.LBB0_25:                               # %.lr.ph596.preheader1135
                                        #   in Loop: Header=BB0_6 Depth=1
	slli.d	$a3, $a2, 7
	alsl.d	$a3, $a2, $a3, 4
	lu12i.w	$a4, 1
...
.LBB0_30:                               # %vector.body1080
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_30
# %bb.31:                               # %middle.block1086
                                        #   in Loop: Header=BB0_6 Depth=1
	beq	$a2, $a3, .LBB0_34
.LBB0_32:                               # %.lr.ph598.preheader1134
                                        #   in Loop: Header=BB0_6 Depth=1
	slli.d	$a2, $a1, 7
	alsl.d	$a2, $a1, $a2, 4
	lu12i.w	$a3, 1
...
.LBB0_78:                               #   in Loop: Header=BB0_47 Depth=2
	move	$a3, $zero
.LBB0_79:                               # %.lr.ph.i422.preheader1131
                                        #   in Loop: Header=BB0_47 Depth=2
	add.d	$a0, $s5, $a3
	alsl.d	$a1, $a3, $t7, 3
	alsl.d	$a2, $a3, $t2, 3
...
.LBB0_96:                               #   in Loop: Header=BB0_47 Depth=2
	move	$a3, $zero
.LBB0_97:                               # %.lr.ph.i454.preheader1130
                                        #   in Loop: Header=BB0_47 Depth=2
	add.d	$a0, $s5, $a3
	alsl.d	$a1, $a3, $t5, 3
	alsl.d	$a2, $a3, $t2, 3
...
.LBB0_128:                              #   in Loop: Header=BB0_47 Depth=2
	move	$a2, $zero
.LBB0_129:                              # %.lr.ph.i484.preheader1128
                                        #   in Loop: Header=BB0_47 Depth=2
	add.d	$a0, $a3, $a2
	alsl.d	$a1, $a2, $t3, 3
	alsl.d	$a2, $a2, $s6, 3
...
.LBB0_135:                              #   in Loop: Header=BB0_47 Depth=2
	move	$a2, $zero
.LBB0_136:                              # %.lr.ph.i491.preheader1127
                                        #   in Loop: Header=BB0_47 Depth=2
	add.d	$a0, $a3, $a2
	alsl.d	$a1, $a2, $t2, 3
	alsl.d	$a2, $a2, $s6, 3
