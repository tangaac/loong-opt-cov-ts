...
# %bb.0:
	...
	pcalau12i	$s3, %pc_hi20(nplies)
	ld.w	$a2, $s3, %pc_lo12(nplies)
	addi.d	$a4, $a4, 1
...
# %bb.1:
	...
	addi.d	$s8, $a5, %pc_lo12(color)
	ldx.d	$a4, $s8, $a4
	pcalau12i	$a5, %pc_hi20(height)
	addi.d	$s1, $a5, %pc_lo12(height)
	ori	$a7, $zero, 1
	lu12i.w	$a5, 33026
	ori	$a5, $a5, 64
	lu32i.d	$a5, 66052
...
.LBB19_30:                              # %.thread145
	...
	stx.d	$a4, $s8, $a6
	addi.d	$a4, $a2, 1
	st.w	$a4, $s3, %pc_lo12(nplies)
	slli.d	$a2, $a2, 2
	pcalau12i	$a4, %pc_hi20(moves)
	addi.d	$s0, $a4, %pc_lo12(moves)
	stx.w	$a3, $s0, $a2
	ori	$s2, $zero, 6
	sub.w	$a2, $s2, $a1
	sub.w	$a1, $s2, $a0
...
.LBB19_39:                              # %hash.exit.i
	...
	lu12i.w	$a5, 2027
	ori	$a5, $a5, 3477
	pcalau12i	$t3, %pc_hi20(ht)
	ld.d	$a6, $t3, %pc_lo12(ht)
	mul.d	$a4, $a4, $a5
	sub.d	$t1, $a3, $a4
	slli.d	$t2, $t1, 3
	ldx.d	$a3, $a6, $t2
	pcalau12i	$a4, %pc_hi20(lock)
	st.w	$a7, $a4, %pc_lo12(lock)
	pcalau12i	$a4, %pc_hi20(htindex)
	bstrpick.d	$a5, $a3, 25, 0
	st.w	$t1, $a4, %pc_lo12(htindex)
	bne	$a5, $t0, .LBB19_41
# %bb.40:
	srli.d	$s6, $a3, 61
	b	.LBB19_43
.LBB19_41:
	bstrpick.d	$a4, $a3, 57, 32
	ori	$a5, $zero, 6
	bne	$a4, $t0, .LBB19_51
# %bb.42:
	bstrpick.d	$s6, $a3, 60, 58
...
# %bb.64:                               # %middle.block
                                        #   in Loop: Header=BB19_56 Depth=1
	beq	$a5, $a6, .LBB19_67
.LBB19_65:                              # %.lr.ph166.preheader248
                                        #   in Loop: Header=BB19_56 Depth=1
	alsl.d	$a5, $a4, $t5, 2
	.p2align	4, , 16
.LBB19_66:                              # %.lr.ph166
