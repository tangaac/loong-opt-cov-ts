...
.LBB3_31:                               #   Parent Loop BB3_25 Depth=1
...
.LBB3_38:                               # %.lr.ph302.preheader
	...
	b	.LBB3_41
	.p2align	4, , 16
.LBB3_39:                               # %._crit_edge299.loopexit
                                        #   in Loop: Header=BB3_41 Depth=3
	ld.w	$a1, $s0, %pc_lo12(epoch_length)
.LBB3_40:                               # %._crit_edge299
                                        #   in Loop: Header=BB3_41 Depth=3
	addi.d	$s7, $s7, 1
	div.w	$a0, $s3, $a1
	bge	$s7, $a0, .LBB3_30
.LBB3_41:                               # %.lr.ph302
	...
	ldx.d	$s5, $s1, $a0
	beqz	$s5, .LBB3_40
# %bb.42:                               # %.lr.ph298.preheader
                                        #   in Loop: Header=BB3_41 Depth=3
	move	$s8, $zero
	b	.LBB3_44
	.p2align	4, , 16
.LBB3_43:                               #   in Loop: Header=BB3_44 Depth=4
	ld.d	$s5, $s5, 24
	addi.w	$s8, $s8, 1
	beqz	$s5, .LBB3_39
.LBB3_44:                               # %.lr.ph298
...
# %bb.45:                               #   in Loop: Header=BB3_44 Depth=4
	...
	ld.d	$a1, $sp, 104
	bne	$a0, $a1, .LBB3_43
# %bb.46:                               #   in Loop: Header=BB3_44 Depth=4
	pcaddu18i	$ra, %call36(def_list_lookup)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_43
# %bb.47:                               #   in Loop: Header=BB3_44 Depth=4
	ld.wu	$a1, $a0, 16
	bne	$s7, $a1, .LBB3_43
# %bb.48:                               #   in Loop: Header=BB3_44 Depth=4
	ld.w	$a0, $a0, 20
	bne	$s8, $a0, .LBB3_43
# %bb.49:                               #   in Loop: Header=BB3_44 Depth=4
	ld.d	$a0, $sp, 104
