...
# %bb.1:
	...
	addi.d	$s8, $a1, %pc_lo12(Cameradir)
	pcalau12i	$a1, %pc_hi20(Cameraup)
	addi.d	$s3, $a1, %pc_lo12(Cameraup)
	vrepli.b	$vr0, 0
...
.LBB2_33:                               # %call.sqrt
	...
	fst.d	$ft1, $sp, 16                   # 8-byte Folded Spill
	...
	fmov.d	$fa1, $fa0
	b	.LBB2_7
.LBB2_34:                               # %call.sqrt144
	move	$s0, $a4
	move	$s3, $a2
	move	$s1, $a0
	move	$s4, $a3
	move	$s2, $a1
	fst.d	$fa5, $sp, 0                    # 8-byte Folded Spill
	fst.d	$fa4, $sp, 40                   # 8-byte Folded Spill
	fst.d	$fa6, $sp, 48                   # 8-byte Folded Spill
	fst.d	$fa7, $sp, 32                   # 8-byte Folded Spill
	fst.d	$ft0, $sp, 24                   # 8-byte Folded Spill
