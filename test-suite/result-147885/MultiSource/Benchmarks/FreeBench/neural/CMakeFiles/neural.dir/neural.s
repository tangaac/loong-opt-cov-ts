...
# %bb.36:                               #   in Loop: Header=BB0_35 Depth=2
	...
	b	.LBB0_40
	.p2align	4, , 16
.LBB0_37:                               # %vector.body107.preheader
                                        #   in Loop: Header=BB0_35 Depth=2
	addi.d	$t5, $t4, 16
	move	$t6, $t2
	move	$t7, $a5
...
# %bb.43:                               #   in Loop: Header=BB0_35 Depth=2
	...
	b	.LBB0_47
	.p2align	4, , 16
.LBB0_44:                               # %vector.body89.preheader
                                        #   in Loop: Header=BB0_35 Depth=2
	addi.d	$t6, $t4, 16
	move	$t7, $t2
	move	$t8, $a5
...
# %bb.46:                               # %middle.block97
	...
	move	$t8, $a5
	beq	$a5, $a4, .LBB0_34
.LBB0_47:                               # %.lr.ph.i18.us.us.i.preheader167
                                        #   in Loop: Header=BB0_35 Depth=2
	sub.d	$t7, $a4, $t8
	alsl.d	$t4, $t8, $t4, 2
	alsl.d	$t8, $t8, $t1, 2
...
# %bb.84:                               # %middle.block135
	...
	maskeqz	$s4, $s4, $a4
	beq	$a3, $a0, .LBB0_87
.LBB0_85:                               # %scalar.ph121.preheader
                                        #   in Loop: Header=BB0_76 Depth=2
	sub.d	$a4, $a0, $a3
	alsl.d	$a5, $a3, $fp, 2
	alsl.d	$a2, $a3, $a2, 2
...
.LBB2_15:                               #   in Loop: Header=BB2_7 Depth=1
	...
	b	.LBB2_31
	.p2align	4, , 16
.LBB2_16:                               # %.preheader92.lr.ph
                                        #   in Loop: Header=BB2_7 Depth=1
	vld	$vr6, $sp, 48                   # 16-byte Folded Reload
	blez	$s8, .LBB2_59
# %bb.17:                               # %.preheader92.preheader
                                        #   in Loop: Header=BB2_7 Depth=1
	move	$a0, $zero
	.p2align	4, , 16
.LBB2_18:                               # %.preheader92
...
.LBB2_24:                               #   Parent Loop BB2_7 Depth=1
	...
	addi.d	$a0, $a0, 4
	bnez	$s8, .LBB2_24
# %bb.25:                               # %._crit_edge108.loopexit
                                        #   in Loop: Header=BB2_21 Depth=3
	fcvt.d.s	$fa0, $fa0
.LBB2_26:                               # %._crit_edge108
                                        #   in Loop: Header=BB2_21 Depth=3
	alsl.d	$s8, $s4, $s1, 2
	fneg.d	$fa1, $fa0
	fcmp.clt.d	$fcc0, $fa0, $fs2
	...
	fst.s	$fa0, $s8, 0
	bcnez	$fcc0, .LBB2_20
# %bb.27:                               #   in Loop: Header=BB2_21 Depth=3
	move	$s6, $zero
	b	.LBB2_20
	.p2align	4, , 16
.LBB2_28:                               # %._crit_edge113
                                        #   in Loop: Header=BB2_18 Depth=2
	bnez	$s6, .LBB2_15
# %bb.29:                               # %._crit_edge113
                                        #   in Loop: Header=BB2_18 Depth=2
...
.LBB2_35:                               # %vector.body30
	...
	addi.d	$a2, $a2, 32
	bnez	$a4, .LBB2_35
# %bb.36:                               # %middle.block35
                                        #   in Loop: Header=BB2_7 Depth=1
	ld.d	$a5, $sp, 24                    # 8-byte Folded Reload
	beq	$a1, $s8, .LBB2_39
.LBB2_37:                               # %.lr.ph119.preheader39
                                        #   in Loop: Header=BB2_7 Depth=1
	alsl.d	$a2, $a1, $a5, 2
	alsl.d	$a3, $a1, $s1, 2
	sub.d	$a1, $s8, $a1
...
.LBB2_45:                               # %.lr.ph.i
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB2_45
.LBB2_46:                               # %hamming.exit
                                        #   in Loop: Header=BB2_7 Depth=1
	beqz	$a1, .LBB2_59
# %bb.47:                               # %.lr.ph123.preheader
                                        #   in Loop: Header=BB2_7 Depth=1
	move	$a6, $zero
	move	$a1, $s8
	move	$a2, $fp
