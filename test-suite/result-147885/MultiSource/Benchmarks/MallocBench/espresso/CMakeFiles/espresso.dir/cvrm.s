...
# %bb.36:                               # %.lr.ph106.i
                                        #   in Loop: Header=BB0_34 Depth=2
	blt	$a0, $s2, .LBB0_47
# %bb.37:                               # %.lr.ph106.split.us.i.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	move	$a1, $zero
	alsl.d	$a2, $s5, $a2, 2
	b	.LBB0_40
	.p2align	4, , 16
.LBB0_38:                               # %._crit_edge100.split.us.us.i
                                        #   in Loop: Header=BB0_40 Depth=3
	add.w	$a1, $a1, $a0
.LBB0_39:                               #   in Loop: Header=BB0_40 Depth=3
	addi.w	$a5, $a3, 1
	bge	$a3, $a4, .LBB0_32
.LBB0_40:                               # %.lr.ph106.split.us.i
                                        #   Parent Loop BB0_14 Depth=1
	...
	and	$a7, $a5, $a7
	beqz	$a7, .LBB0_39
# %bb.41:                               # %.preheader88.us.i
                                        #   in Loop: Header=BB0_40 Depth=3
	bge	$a1, $s8, .LBB0_38
# %bb.42:                               # %.preheader.lr.ph.us.i
                                        #   in Loop: Header=BB0_40 Depth=3
	ld.d	$a4, $s3, 24
	alsl.d	$a4, $a6, $a4, 2
	add.d	$a6, $s0, $a1
...
.LBB0_44:                               #   Parent Loop BB0_14 Depth=1
	...
	addi.d	$t0, $t0, 1
	bnez	$t1, .LBB0_44
# %bb.45:                               # %._crit_edge98.us.us.i
                                        #   in Loop: Header=BB0_43 Depth=4
	add.w	$a7, $a7, $fp
	add.d	$a6, $a6, $fp
	blt	$a7, $s8, .LBB0_43
# %bb.46:                               # %._crit_edge100.split.us.us.loopexit.i
                                        #   in Loop: Header=BB0_40 Depth=3
	ld.w	$a4, $a2, 0
	b	.LBB0_38
.LBB0_47:                               # %.lr.ph106.split.i
                                        #   in Loop: Header=BB0_34 Depth=2
	srai.d	$a1, $a5, 5
	slli.d	$a1, $a1, 2
...
.LBB10_7:                               #   Parent Loop BB10_2 Depth=1
	...
	addi.d	$t1, $t1, 1
	bltu	$t1, $s6, .LBB10_13
# %bb.8:                                # %vector.memcheck98
                                        #   in Loop: Header=BB10_7 Depth=2
	alsl.d	$t4, $t3, $a2, 2
	alsl.d	$t6, $t2, $a7, 2
	alsl.d	$t5, $t2, $a2, 2
	bgeu	$t4, $t6, .LBB10_10
# %bb.9:                                # %vector.memcheck98
                                        #   in Loop: Header=BB10_7 Depth=2
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $a3, 2
	bltu	$t3, $t4, .LBB10_13
.LBB10_10:                              # %vector.ph112
                                        #   in Loop: Header=BB10_7 Depth=2
	move	$t3, $t1
...
# %bb.12:                               # %middle.block124
	...
	beq	$t1, $t3, .LBB10_6
	.p2align	4, , 16
.LBB10_13:                              # %scalar.ph110.preheader
                                        #   in Loop: Header=BB10_7 Depth=2
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a3, 2
	alsl.d	$t2, $t2, $a2, 2
	.p2align	4, , 16
.LBB10_14:                              # %scalar.ph110
                                        #   Parent Loop BB10_2 Depth=1
                                        #     Parent Loop BB10_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t4, $t2, 0
...
.LBB10_21:                              #   Parent Loop BB10_2 Depth=1
	...
	addi.d	$t1, $t1, 1
	bltu	$t1, $s6, .LBB10_27
# %bb.22:                               # %vector.memcheck69
                                        #   in Loop: Header=BB10_21 Depth=2
	alsl.d	$t4, $t3, $a2, 2
	alsl.d	$t6, $t2, $a7, 2
	alsl.d	$t5, $t2, $a2, 2
	bgeu	$t4, $t6, .LBB10_24
# %bb.23:                               # %vector.memcheck69
                                        #   in Loop: Header=BB10_21 Depth=2
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $a3, 2
	bltu	$t3, $t4, .LBB10_27
.LBB10_24:                              # %vector.ph83
                                        #   in Loop: Header=BB10_21 Depth=2
	move	$t3, $t1
	bstrins.d	$t3, $zero, 1, 0
	sub.d	$t4, $t2, $t3
...
.LBB10_25:                              # %vector.body86
	...
	addi.d	$t5, $t5, -16
	bnez	$t6, .LBB10_25
# %bb.26:                               # %middle.block95
                                        #   in Loop: Header=BB10_21 Depth=2
	move	$t2, $t4
	beq	$t1, $t3, .LBB10_20
	.p2align	4, , 16
.LBB10_27:                              # %scalar.ph81.preheader
                                        #   in Loop: Header=BB10_21 Depth=2
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a3, 2
	alsl.d	$t2, $t2, $a2, 2
	.p2align	4, , 16
.LBB10_28:                              # %scalar.ph81
                                        #   Parent Loop BB10_2 Depth=1
                                        #     Parent Loop BB10_21 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t4, $t2, 0
