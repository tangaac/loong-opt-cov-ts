...
.LBB0_49:                               # %._crit_edge109
	andi	$a0, $a3, 1
	bnez	$a0, .LBB0_33
.LBB0_50:                               # %._crit_edge109.thread135
	move	$a0, $fp
...
.LBB7_25:                               # %.lr.ph139.us
	...
	move	$fp, $zero
	.p2align	4, , 16
.LBB7_26:                               #   Parent Loop BB7_16 Depth=1
...
# %bb.6:                                # %.lr.ph103
	...
	alsl.d	$s6, $a3, $s4, 2
	bge	$a1, $a0, .LBB9_16
# %bb.7:                                # %.lr.ph103.split.preheader
	move	$s7, $zero
	ori	$s8, $zero, 2
	ori	$s2, $zero, 500
.LBB9_8:                                # %.lr.ph103.split
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB9_11 Depth 2
	ld.w	$fp, $s5, 8
	ori	$s0, $zero, 1
	bge	$fp, $a0, .LBB9_13
# %bb.9:                                # %.lr.ph98.preheader
...
# %bb.14:                               #   in Loop: Header=BB9_8 Depth=1
	...
	alsl.d	$s4, $a1, $s4, 2
	bltu	$s4, $s6, .LBB9_8
# %bb.15:                               # %._crit_edge104.loopexit
	ld.w	$a1, $s5, 8
	b	.LBB9_19
.LBB9_16:                               # %.lr.ph103.split.us.preheader
	slli.d	$a0, $a2, 2
	ori	$a2, $zero, 501
	.p2align	4, , 16
.LBB9_17:                               # %.lr.ph103.split.us
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, -1
	beqz	$a2, .LBB9_24
# %bb.18:                               #   in Loop: Header=BB9_17 Depth=1
	add.d	$s4, $s4, $a0
	bltu	$s4, $s6, .LBB9_17
.LBB9_19:                               # %._crit_edge104
	ld.d	$fp, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
.LBB9_20:                               # %._crit_edge104
	move	$a0, $s3
