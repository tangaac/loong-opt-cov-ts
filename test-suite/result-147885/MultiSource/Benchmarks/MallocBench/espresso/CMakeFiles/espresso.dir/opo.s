...
# %bb.23:                               # %.lr.ph132
	...
	b	.LBB3_26
	.p2align	4, , 16
.LBB3_24:                               # %._crit_edge129.loopexit
                                        #   in Loop: Header=BB3_26 Depth=1
	ld.w	$a1, $s1, 0
.LBB3_25:                               # %._crit_edge129
                                        #   in Loop: Header=BB3_26 Depth=1
	alsl.d	$s7, $a1, $s7, 2
	bgeu	$s7, $s2, .LBB3_31
...
# %bb.39:                               #   in Loop: Header=BB3_37 Depth=1
	...
	stx.w	$a2, $s3, $a1
	b	.LBB3_36
.LBB3_40:                               # %._crit_edge140
	beqz	$s4, .LBB3_42
.LBB3_41:                               # %._crit_edge140.thread
	move	$a0, $s4
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB3_42:
...
# %bb.13:                               # %.lr.ph247
	...
	b	.LBB6_16
	.p2align	4, , 16
.LBB6_14:                               # %._crit_edge244.thread
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.w	$t1, $a3, 12
	addi.d	$t1, $t1, -1
	st.w	$t1, $a3, 12
.LBB6_15:                               # %._crit_edge244.thread299
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.w	$t1, $s1, 0
	alsl.d	$a4, $t1, $a4, 2
	bgeu	$a4, $a7, .LBB6_30
...
# %bb.23:                               #   in Loop: Header=BB6_22 Depth=2
	...
	b	.LBB6_21
	.p2align	4, , 16
.LBB6_24:                               # %.preheader224
                                        #   in Loop: Header=BB6_16 Depth=1
	addi.d	$t1, $a4, 4
	addi.d	$t2, $t2, 4
	ori	$t4, $zero, 1
	move	$t5, $s6
.LBB6_25:                               # %.lr.ph243.outer
                                        #   Parent Loop BB6_16 Depth=1
...
.LBB6_28:                               # %.thread
	...
	b	.LBB6_15
	.p2align	4, , 16
.LBB6_29:                               # %._crit_edge244
                                        #   in Loop: Header=BB6_16 Depth=1
	andi	$t1, $t4, 1
	bnez	$t1, .LBB6_14
	b	.LBB6_15
.LBB6_30:                               # %._crit_edge248
	ld.w	$a2, $fp, 12
	ld.w	$a3, $fp, 0
	mul.w	$a7, $a3, $a2
	blez	$a7, .LBB6_50
...
# %bb.37:                               # %.preheader223
                                        #   in Loop: Header=BB6_33 Depth=1
	blt	$s5, $s6, .LBB6_44
# %bb.38:                               # %.lr.ph256.outer.preheader
                                        #   in Loop: Header=BB6_33 Depth=1
	addi.d	$t3, $a4, 4
	addi.d	$t2, $t2, 4
	ori	$t5, $zero, 1
	move	$t6, $s6
.LBB6_39:                               # %.lr.ph256.outer
...
.LBB6_42:                               # %.thread302
	...
	b	.LBB6_45
	.p2align	4, , 16
.LBB6_43:                               # %._crit_edge257
                                        #   in Loop: Header=BB6_33 Depth=1
	andi	$t2, $t5, 1
	beqz	$t2, .LBB6_45
.LBB6_44:                               # %._crit_edge257.thread
                                        #   in Loop: Header=BB6_33 Depth=1
	ld.w	$t2, $a2, 12
	addi.d	$t2, $t2, -1
	st.w	$t2, $a2, 12
.LBB6_45:                               # %._crit_edge257.thread306
                                        #   in Loop: Header=BB6_33 Depth=1
	blt	$s5, $s6, .LBB6_32
# %bb.46:                               # %.lr.ph262.preheader
                                        #   in Loop: Header=BB6_33 Depth=1
	move	$t2, $s6
	b	.LBB6_48
	.p2align	4, , 16
