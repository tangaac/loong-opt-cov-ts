...
.LBB1_68:                               # %vector.body293
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB1_68
# %bb.69:                               # %middle.block296
	beq	$a0, $fp, .LBB1_72
.LBB1_70:                               # %.lr.ph224.preheader333
	slli.d	$a2, $a0, 2
	alsl.d	$a1, $a1, $a2, 2
	add.d	$a1, $s3, $a1
	ori	$a2, $zero, 4
...
.LBB1_74:
	move	$a2, $zero
.LBB1_75:                               # %scalar.ph299.preheader
	slli.d	$a3, $a2, 2
	alsl.d	$a3, $s0, $a3, 2
	add.d	$a0, $a0, $a3
	add.w	$a1, $a1, $a2
...
.LBB1_82:                               # =>This Inner Loop Header: Depth=1
	...
	blt	$s8, $a2, .LBB1_82
	b	.LBB1_90
.LBB1_83:                               # %vector.scevcheck
	addi.d	$a3, $s7, -1
	add.w	$a4, $a1, $a3
	move	$a2, $zero
	blt	$a4, $a1, .LBB1_75
# %bb.84:                               # %vector.scevcheck
	srli.d	$a3, $a3, 32
	bnez	$a3, .LBB1_75
...
.LBB1_87:                               # %vector.body304
	...
	addi.w	$a4, $a4, 8
	bnez	$a5, .LBB1_87
# %bb.88:                               # %middle.block309
	bne	$a2, $s7, .LBB1_75
	b	.LBB1_77
.LBB1_89:
	move	$a1, $a0
.LBB1_90:                               # %.preheader210
...
# %bb.96:                               # %.lr.ph238
	...
	move	$a3, $t2
	bgeu	$a2, $a4, .LBB1_112
.LBB1_97:                               # %scalar.ph317.preheader
	alsl.d	$a2, $a3, $s1, 3
	add.d	$a0, $a0, $a3
	sub.w	$a0, $a0, $t2
	sub.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB1_98:                               # %scalar.ph317
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	slli.d	$a5, $a0, 3
	stx.d	$a4, $a1, $a5
