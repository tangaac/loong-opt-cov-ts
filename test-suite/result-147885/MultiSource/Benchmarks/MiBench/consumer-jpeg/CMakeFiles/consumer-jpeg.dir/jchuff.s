...
# %bb.9:                                #   in Loop: Header=BB1_1 Depth=1
	...
	move	$a5, $a1
	b	.LBB1_1
.LBB1_10:                               # %.preheader106.preheader
	move	$s1, $zero
	addi.d	$s2, $sp, 1040
	ori	$s3, $zero, 1028
	ori	$s4, $zero, 33
...
# %bb.15:                               #   in Loop: Header=BB1_13 Depth=1
	...
	jirl	$ra, $a1, 0
	b	.LBB1_11
.LBB1_16:                               # %.preheader104.preheader
	ori	$a3, $zero, 32
	ori	$a0, $zero, 2103
	add.d	$a0, $sp, $a0
	ori	$a1, $zero, 0
	...
	b	.LBB1_18
	.p2align	4, , 16
.LBB1_17:                               # %._crit_edge124
                                        #   in Loop: Header=BB1_18 Depth=1
	addi.d	$a0, $a0, -1
	add.d	$a2, $a2, $a1
	bgeu	$a5, $a6, .LBB1_22
.LBB1_18:                               # %.preheader104
                                        # =>This Loop Header: Depth=1
...
# %bb.21:                               #   in Loop: Header=BB1_19 Depth=2
	...
	bnez	$a7, .LBB1_19
	b	.LBB1_17
.LBB1_22:                               # %.preheader103.preheader
	ori	$a0, $zero, 2089
	add.d	$a0, $sp, $a0
	.p2align	4, , 16
.LBB1_23:                               # %.preheader103
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, -1
	addi.d	$a0, $a0, -1
	beqz	$a1, .LBB1_23
...
.LBB6_70:                               #   in Loop: Header=BB6_4 Depth=1
	...
	ori	$a1, $zero, 8
	bge	$a0, $a1, .LBB6_75
.LBB6_71:                               # %emit_bits.exit133.i
                                        #   in Loop: Header=BB6_4 Depth=1
	st.d	$fp, $sp, 128
	st.w	$a0, $sp, 136
.LBB6_72:                               # %encode_one_block.exit
                                        #   in Loop: Header=BB6_4 Depth=1
	...
	blt	$a2, $a1, .LBB6_4
	b	.LBB6_81
.LBB6_73:                               # %dump_buffer.exit39.i130.i
...
# %bb.76:                               #   in Loop: Header=BB6_75 Depth=2
	...
	b	.LBB6_79
	.p2align	4, , 16
.LBB6_77:                               #   in Loop: Header=BB6_75 Depth=2
	ld.d	$a0, $sp, 160
	ld.d	$s1, $a0, 32
	ld.d	$a1, $s1, 24
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB6_106
# %bb.78:                               # %dump_buffer.exit.i132.i
                                        #   in Loop: Header=BB6_75 Depth=2
	ld.d	$a0, $s1, 0
	ld.d	$s6, $s1, 8
	st.d	$a0, $sp, 112
	...
	and	$a0, $fp, $s7
	bne	$a0, $s7, .LBB6_74
.LBB6_79:                               #   in Loop: Header=BB6_75 Depth=2
	ld.d	$a0, $sp, 112
	addi.d	$a1, $a0, 1
	st.d	$a1, $sp, 112
	st.b	$zero, $a0, 0
	...
	st.d	$s6, $sp, 120
	bnez	$s6, .LBB6_74
# %bb.80:                               #   in Loop: Header=BB6_75 Depth=2
	ld.d	$a0, $sp, 160
	ld.d	$s1, $a0, 32
	ld.d	$a1, $s1, 24
	jirl	$ra, $a1, 0
...
.LBB6_92:                               #   in Loop: Header=BB6_88 Depth=1
	...
	st.d	$a0, $sp, 120
	bnez	$a0, .LBB6_87
# %bb.93:                               #   in Loop: Header=BB6_88 Depth=1
	ld.d	$a0, $sp, 160
	ld.d	$s4, $a0, 32
	ld.d	$a1, $s4, 24
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB6_106
# %bb.94:                               # %dump_buffer.exit39.i.i.i
                                        #   in Loop: Header=BB6_88 Depth=1
	vld	$vr0, $s4, 0
	vst	$vr0, $sp, 112
	b	.LBB6_87
.LBB6_95:                               # %.loopexit.i.loopexit
	ld.d	$a0, $sp, 112
	move	$s2, $s6
.LBB6_96:                               # %.loopexit.i
	st.d	$zero, $sp, 128
...
.LBB6_106:
	move	$a0, $zero
.LBB6_107:                              # %emit_restart.exit.thread
