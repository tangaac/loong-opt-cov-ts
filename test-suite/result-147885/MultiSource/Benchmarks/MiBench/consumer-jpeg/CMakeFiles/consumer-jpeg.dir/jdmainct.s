...
# %bb.3:
	...
	addi.d	$a3, $a3, %pc_lo12(process_data_context_main)
	st.d	$a3, $a2, 8
	blez	$a1, .LBB1_39
# %bb.4:                                # %.lr.ph63.i
	move	$a3, $zero
