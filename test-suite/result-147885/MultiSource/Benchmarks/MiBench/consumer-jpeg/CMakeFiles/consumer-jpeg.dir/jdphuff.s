...
.LBB2_26:                               # %._crit_edge
	...
	addi.d	$a1, $a1, -1
	st.w	$a1, $s1, 52
.LBB2_27:                               # %process_restart.exit.thread
...
.LBB3_12:
	...
	st.w	$a0, $s2, 52
	ori	$a0, $zero, 1
.LBB3_13:                               # %process_restart.exit.thread
...
# %bb.55:                               #   in Loop: Header=BB5_51 Depth=1
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB5_50
.LBB5_56:                               #   in Loop: Header=BB5_51 Depth=1
	alsl.d	$a0, $fp, $s2, 1
	ld.h	$a3, $a0, 0
	and	$a4, $s4, $a3
	bnez	$a4, .LBB5_50
...
.LBB5_63:
	move	$a0, $zero
.LBB5_64:                               # %process_restart.exit.thread
