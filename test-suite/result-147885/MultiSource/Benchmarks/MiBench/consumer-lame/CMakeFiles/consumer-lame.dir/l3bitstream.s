...
.LBB1_2:
	...
	pcalau12i	$s5, %pc_hi20(headerPH)
	pcalau12i	$s8, %pc_hi20(frameSIPH)
	pcalau12i	$a1, %pc_hi20(userFrameDataPH)
...
# %bb.3:                                # %.preheader74.preheader
	...
	st.d	$a0, $a1, %pc_lo12(userFrameDataPH)
	ori	$a0, $zero, 1
	st.w	$a0, $fp, %pc_lo12(PartHoldersInitialized)
.LBB1_4:
	ld.d	$a0, $s5, %pc_lo12(headerPH)
