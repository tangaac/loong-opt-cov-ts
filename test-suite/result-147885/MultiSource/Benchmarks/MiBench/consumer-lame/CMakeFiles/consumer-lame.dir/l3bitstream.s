...
# %bb.18:                               #   in Loop: Header=BB1_17 Depth=1
	...
	b	.LBB1_22
	.p2align	4, , 16
.LBB1_19:                               # %vector.body122.preheader
                                        #   in Loop: Header=BB1_17 Depth=1
	move	$t0, $a6
	move	$t1, $a2
	.p2align	4, , 16
.LBB1_20:                               # %vector.body122
...
# %bb.21:                               # %middle.block127
	...
	move	$t1, $a2
	beq	$a2, $a1, .LBB1_16
.LBB1_22:                               # %scalar.ph117.preheader
                                        #   in Loop: Header=BB1_17 Depth=1
	sub.d	$t0, $a1, $t1
	alsl.d	$t1, $t1, $a5, 3
	.p2align	4, , 16
.LBB1_23:                               # %scalar.ph117
                                        #   Parent Loop BB1_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t2, $t1, 0
	ld.d	$t2, $t2, 8
...
.LBB1_49:                               # %.split.us.i
	...
	beqz	$a0, .LBB1_51
# %bb.50:
	ld.d	$a0, $s0, %pc_lo12(headerPH)
	ld.w	$a1, $s4, %pc_lo12(crc)
	ori	$a2, $zero, 16
	pcaddu18i	$ra, %call36(BF_addEntry)
	jirl	$ra, $ra, 0
	st.d	$a0, $s0, %pc_lo12(headerPH)
.LBB1_51:                               # %encodeSideInfo.exit
	ld.w	$a0, $fp, 200
	ld.d	$s2, $sp, 104                   # 8-byte Folded Reload
	blez	$a0, .LBB1_71
# %bb.52:                               # %.preheader195.lr.ph.i
	ld.w	$a1, $fp, 204
	blez	$a1, .LBB1_71
# %bb.53:                               # %.preheader195.us.preheader.i
	move	$a3, $zero
	pcalau12i	$a2, %pc_hi20(scaleFactorsPH)
	addi.d	$a4, $a2, %pc_lo12(scaleFactorsPH)
	addi.d	$a5, $a4, 16
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a6, $a2, 2
	ori	$a7, $zero, 4
	b	.LBB1_55
	.p2align	4, , 16
.LBB1_54:                               # %._crit_edge.us.i65
                                        #   in Loop: Header=BB1_55 Depth=1
	addi.d	$a3, $a3, 1
	addi.d	$a5, $a5, 16
	addi.d	$a4, $a4, 16
	beq	$a3, $a0, .LBB1_62
.LBB1_55:                               # %.preheader195.us.i
                                        # =>This Loop Header: Depth=1
...
# %bb.56:                               #   in Loop: Header=BB1_55 Depth=1
	...
	b	.LBB1_60
	.p2align	4, , 16
.LBB1_57:                               # %vector.body135.preheader
                                        #   in Loop: Header=BB1_55 Depth=1
	move	$t0, $a5
	move	$t1, $a6
	.p2align	4, , 16
.LBB1_58:                               # %vector.body135
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB1_58
# %bb.59:                               # %middle.block140
                                        #   in Loop: Header=BB1_55 Depth=1
	move	$t1, $a6
	beq	$a6, $a1, .LBB1_54
.LBB1_60:                               # %scalar.ph130.preheader
                                        #   in Loop: Header=BB1_55 Depth=1
	sub.d	$t0, $a1, $t1
	alsl.d	$t1, $t1, $a4, 3
	.p2align	4, , 16
.LBB1_61:                               # %scalar.ph130
                                        #   Parent Loop BB1_55 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t2, $t1, 0
	ld.d	$t2, $t2, 8
	...
	bnez	$t0, .LBB1_61
	b	.LBB1_54
.LBB1_62:                               # %.preheader193.us.i.preheader
	move	$a3, $zero
	pcalau12i	$a4, %pc_hi20(codedDataPH)
	addi.d	$a4, $a4, %pc_lo12(codedDataPH)
	addi.d	$a5, $a4, 16
	slli.d	$a2, $a2, 2
	ori	$a6, $zero, 4
	b	.LBB1_64
	.p2align	4, , 16
.LBB1_63:                               # %._crit_edge.us201.i
                                        #   in Loop: Header=BB1_64 Depth=1
	addi.d	$a3, $a3, 1
	addi.d	$a5, $a5, 16
	addi.d	$a4, $a4, 16
	beq	$a3, $a0, .LBB1_71
.LBB1_64:                               # %.preheader193.us.i
                                        # =>This Loop Header: Depth=1
...
# %bb.65:                               #   in Loop: Header=BB1_64 Depth=1
	...
	b	.LBB1_69
	.p2align	4, , 16
.LBB1_66:                               # %vector.body148.preheader
                                        #   in Loop: Header=BB1_64 Depth=1
	move	$a7, $a5
	move	$t0, $a2
	.p2align	4, , 16
.LBB1_67:                               # %vector.body148
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB1_67
# %bb.68:                               # %middle.block153
                                        #   in Loop: Header=BB1_64 Depth=1
	move	$t0, $a2
	beq	$a2, $a1, .LBB1_63
.LBB1_69:                               # %scalar.ph143.preheader
                                        #   in Loop: Header=BB1_64 Depth=1
	sub.d	$a7, $a1, $t0
	alsl.d	$t0, $t0, $a4, 3
	.p2align	4, , 16
.LBB1_70:                               # %scalar.ph143
                                        #   Parent Loop BB1_64 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t1, $t0, 0
	ld.d	$t1, $t1, 8
...
.LBB1_71:                               # %._crit_edge200.i
	...
	bne	$a0, $a2, .LBB1_94
# %bb.72:                               # %.preheader184.i
	ld.w	$a0, $fp, 204
	blez	$a0, .LBB1_128
# %bb.73:                               # %.preheader183.i.preheader
	move	$a1, $zero
	addi.d	$a2, $s2, 24
	...
	pcalau12i	$a3, %pc_hi20(slen1_tab)
	addi.d	$a3, $a3, %pc_lo12(slen1_tab)
	st.d	$a3, $sp, 120                   # 8-byte Folded Spill
	pcalau12i	$a3, %pc_hi20(slen2_tab)
	addi.d	$a3, $a3, %pc_lo12(slen2_tab)
	st.d	$a3, $sp, 112                   # 8-byte Folded Spill
	b	.LBB1_75
	.p2align	4, , 16
.LBB1_74:                               # %._crit_edge226.i
                                        #   in Loop: Header=BB1_75 Depth=1
	move	$a2, $zero
	ori	$a1, $zero, 1
	ld.d	$a3, $sp, 136                   # 8-byte Folded Reload
	beqz	$a3, .LBB1_128
.LBB1_75:                               # %.preheader183.i
                                        # =>This Loop Header: Depth=1
...
# %bb.76:                               # %.lr.ph225.i
	...
	b	.LBB1_80
	.p2align	4, , 16
.LBB1_77:                               # %.preheader179.preheader.i
...
# %bb.88:                               # %.thread178.i
	...
	bnez	$a0, .LBB1_79
	b	.LBB1_92
.LBB1_89:                               # %.thread177._crit_edge.i
                                        #   in Loop: Header=BB1_80 Depth=2
	ld.d	$a0, $fp, 0
.LBB1_90:                               #   in Loop: Header=BB1_80 Depth=2
	...
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	bnez	$a1, .LBB1_93
# %bb.91:                               # %..thread178_crit_edge.i
                                        #   in Loop: Header=BB1_80 Depth=2
	slli.d	$a0, $s8, 4
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	ldx.w	$a0, $a1, $a0
	bnez	$a0, .LBB1_79
.LBB1_92:                               # %.thread178..loopexit.loopexit228_crit_edge.i
                                        #   in Loop: Header=BB1_80 Depth=2
	ld.d	$a0, $fp, 0
.LBB1_93:                               # %.loopexit.loopexit228.i
                                        #   in Loop: Header=BB1_80 Depth=2
	ld.w	$a1, $s1, -52
	move	$a2, $s5
	pcaddu18i	$ra, %call36(BF_addEntry)
...
# %bb.99:                               #   in Loop: Header=BB1_97 Depth=1
	...
	b	.LBB1_110
	.p2align	4, , 16
.LBB1_100:                              # %.preheader189.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s4, 96
	ld.w	$s2, $a0, 0
	blez	$s2, .LBB1_117
# %bb.101:                              # %.lr.ph.preheader.i55
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s7, 0
	move	$s0, $zero
	move	$s1, $s3
...
.LBB1_102:                              # %.lr.ph.i56
	...
	addi.d	$s1, $s1, 4
	bne	$s2, $s0, .LBB1_102
# %bb.103:                              # %._crit_edge.loopexit.i57
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s4, 96
	ld.w	$s2, $a0, 4
	move	$s6, $s0
	...
	b	.LBB1_121
	.p2align	4, , 16
.LBB1_104:                              # %.preheader186.preheader.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s7, 0
	move	$s0, $zero
...
.LBB1_105:                              # %.preheader186.i
	...
	addi.d	$s6, $s6, 12
	bne	$s2, $s0, .LBB1_105
# %bb.106:                              # %._crit_edge210.loopexit.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s4, 96
	ld.wu	$a1, $a0, 4
	ori	$a2, $zero, 3
	bltu	$a1, $a2, .LBB1_110
.LBB1_107:                              # %.preheader186.preheader.1.i
                                        #   in Loop: Header=BB1_97 Depth=1
...
.LBB1_108:                              # %.preheader186.1.i
	...
	addi.d	$s2, $s2, 12
	bnez	$s6, .LBB1_108
# %bb.109:                              # %._crit_edge210.loopexit.1.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s4, 96
.LBB1_110:                              # %._crit_edge210.1.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.wu	$a1, $a0, 8
	ori	$a2, $zero, 3
	bgeu	$a1, $a2, .LBB1_112
# %bb.111:                              # %._crit_edge210.2.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.wu	$a0, $a0, 12
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB1_96
	b	.LBB1_115
	.p2align	4, , 16
.LBB1_112:                              # %.preheader186.preheader.2.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	mul.d	$a0, $a1, $a0
	srli.d	$s6, $a0, 33
...
.LBB1_113:                              # %.preheader186.2.i
	...
	addi.d	$s2, $s2, 12
	bnez	$s6, .LBB1_113
# %bb.114:                              # %._crit_edge210.loopexit.2.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s4, 96
	ld.wu	$a0, $a0, 12
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB1_96
.LBB1_115:                              # %.preheader186.preheader.3.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	mul.d	$a1, $a0, $a1
	ld.w	$s5, $s4, 116
...
.LBB1_119:                              # %.lr.ph.1.i
	...
	addi.d	$s1, $s1, 4
	bnez	$s8, .LBB1_119
# %bb.120:                              # %._crit_edge.loopexit.1.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s4, 96
.LBB1_121:                              # %._crit_edge.1.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.w	$s8, $a0, 8
	blez	$s8, .LBB1_125
# %bb.122:                              # %.lr.ph.preheader.2.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.w	$s5, $s4, 112
	ld.d	$a0, $s7, 0
	slli.d	$s1, $s6, 2
...
.LBB1_123:                              # %.lr.ph.2.i
	...
	addi.d	$s1, $s1, 4
	bnez	$s8, .LBB1_123
# %bb.124:                              # %._crit_edge.loopexit.2.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.d	$a0, $s4, 96
.LBB1_125:                              # %._crit_edge.2.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.w	$s0, $a0, 12
	ld.d	$s8, $sp, 112                   # 8-byte Folded Reload
	blez	$s0, .LBB1_96
# %bb.126:                              # %.lr.ph.preheader.3.i
                                        #   in Loop: Header=BB1_97 Depth=1
	ld.w	$s5, $s4, 116
	ld.d	$a0, $s7, 0
	slli.d	$s1, $s6, 2
...
.LBB1_128:                              # %encodeMainData.exit
	...
	ld.d	$a0, $s1, %pc_lo12(userFrameDataPH)
...
.LBB1_130:                              # %.lr.ph.i68
	...
	jirl	$ra, $ra, 0
	addi.w	$fp, $fp, -1
	st.d	$a0, $s1, %pc_lo12(userFrameDataPH)
	bnez	$fp, .LBB1_130
# %bb.131:                              # %._crit_edge.i66
	beqz	$s2, .LBB1_133
.LBB1_132:
	move	$a1, $zero
	move	$a2, $s2
...
.LBB1_133:                              # %drain_into_ancillary_data.exit
	ld.d	$a2, $s0, %pc_lo12(frameData)
	ld.d	$a0, $sp, 0                     # 8-byte Folded Reload
	st.w	$a0, $a2, 0
	ld.d	$a3, $s3, %pc_lo12(headerPH)
...
# %bb.137:                              # %.preheader.us.preheader
	...
	.p2align	4, , 16
.LBB1_138:                              # %.preheader.us
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB1_139 Depth 2
	move	$a7, $zero
	.p2align	4, , 16
.LBB1_139:                              #   Parent Loop BB1_138 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.d	$t0, $a4, $a7
	ld.d	$t1, $s0, %pc_lo12(frameData)
	ld.d	$t0, $t0, 8
	add.d	$t1, $t1, $a2
	add.d	$t1, $t1, $a7
	st.d	$t0, $t1, 48
...
# %bb.140:                              # %._crit_edge.us
	...
	addi.d	$a6, $a6, 16
	bne	$a3, $a0, .LBB1_138
.LBB1_141:                              # %._crit_edge86
	ld.d	$a0, $s1, %pc_lo12(userFrameDataPH)
	ld.d	$a2, $a0, 8
	ld.d	$a0, $s0, %pc_lo12(frameData)
	ld.d	$s0, $sp, 16                    # 8-byte Folded Reload
	ld.d	$a1, $s0, %pc_lo12(frameResults)
	st.d	$a2, $a0, 176
