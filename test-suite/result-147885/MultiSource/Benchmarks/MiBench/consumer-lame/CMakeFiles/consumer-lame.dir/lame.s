...
.LBB6_19:                               # %.lr.ph132
	...
	addi.w	$s4, $fp, 752
	pcalau12i	$a0, %pc_hi20(mfbuf)
	addi.d	$t8, $a0, %pc_lo12(mfbuf)
	ld.w	$a2, $a7, 188
	ld.w	$a0, $a6, %pc_lo12(mf_size)
	ori	$s0, $zero, 1
