...
# %bb.171:                              #   in Loop: Header=BB0_10 Depth=1
	beqz	$a1, .LBB0_173
# %bb.172:                              #   in Loop: Header=BB0_10 Depth=1
	ld.d	$a2, $s7, 16
	ld.d	$a3, $a1, 16
	st.d	$a2, $a0, 0
	st.d	$a3, $s7, 16
	...
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
.LBB0_173:                              #   in Loop: Header=BB0_10 Depth=1
	ld.d	$a0, $s6, 8
	bne	$a0, $s6, .LBB0_175
