...
# %bb.28:                               # %._crit_edge.loopexit
	...
	ld.bu	$a0, $s3, 0
	beqz	$a0, .LBB1_19
.LBB1_29:                               #   in Loop: Header=BB1_20 Depth=3
	slli.d	$a0, $s1, 3
	ldx.d	$fp, $s2, $a0
	move	$a0, $s7
	move	$a1, $fp
...
# %bb.49:                               #   in Loop: Header=BB1_18 Depth=2
	...
	beq	$a0, $a1, .LBB1_66
	b	.LBB1_71
.LBB1_50:                               #   in Loop: Header=BB1_18 Depth=2
...
# %bb.53:                               #   in Loop: Header=BB1_18 Depth=2
	...
	ld.w	$a1, $a1, 288
	beq	$a0, $a1, .LBB1_55
# %bb.54:                               #   in Loop: Header=BB1_18 Depth=2
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB1_55:                               #   in Loop: Header=BB1_18 Depth=2
	ld.bu	$a0, $sp, 1668
...
# %bb.56:                               # %.lr.ph.i.preheader
	...
	b	.LBB1_58
	.p2align	4, , 16
.LBB1_57:                               #   in Loop: Header=BB1_58 Depth=3
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ld.b	$a1, $a1, 4
	stx.b	$a1, $a2, $a0
	ld.bu	$a0, $fp, 0
...
.LBB1_65:                               #   in Loop: Header=BB1_18 Depth=2
	ori	$s1, $zero, 2
	.p2align	4, , 16
.LBB1_66:                               #   in Loop: Header=BB1_18 Depth=2
	...
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB1_14
# %bb.67:                               #   in Loop: Header=BB1_18 Depth=2
	ld.bu	$a0, $sp, 1668
	ori	$a1, $zero, 37
	bne	$a0, $a1, .LBB1_18
	b	.LBB1_14
...
.LBB2_44:                               #   in Loop: Header=BB2_38 Depth=2
	addi.d	$a0, $sp, 112
.LBB2_45:                               # %._crit_edge366
                                        #   in Loop: Header=BB2_38 Depth=2
	st.b	$zero, $a0, 0
	ld.bu	$a0, $sp, 112
	ori	$s8, $zero, 1
	beqz	$a0, .LBB2_50
# %bb.46:                               # %.lr.ph372.preheader
                                        #   in Loop: Header=BB2_38 Depth=2
	addi.d	$a1, $sp, 113
	move	$a2, $s3
	b	.LBB2_48
...
# %bb.56:                               #   in Loop: Header=BB2_55 Depth=3
	...
	beq	$a3, $a2, .LBB2_55
	b	.LBB2_37
.LBB2_57:                               # %.preheader339
                                        #   in Loop: Header=BB2_38 Depth=2
	add.d	$a0, $a1, $a0
	ld.bu	$fp, $a0, 1
	beqz	$fp, .LBB2_62
# %bb.58:                               # %.lr.ph383.preheader
                                        #   in Loop: Header=BB2_38 Depth=2
	addi.d	$s5, $sp, 112
	b	.LBB2_60
	.p2align	4, , 16
.LBB2_59:                               # %._crit_edge377
...
# %bb.61:                               # %.lr.ph376.preheader
	...
	add.d	$s5, $s7, $s5
	b	.LBB2_59
.LBB2_62:                               #   in Loop: Header=BB2_38 Depth=2
	addi.d	$a0, $sp, 112
.LBB2_63:                               # %._crit_edge384
                                        #   in Loop: Header=BB2_38 Depth=2
	st.b	$zero, $a0, 0
	ld.bu	$a0, $sp, 112
	beqz	$a0, .LBB2_37
# %bb.64:                               # %.lr.ph390.preheader
                                        #   in Loop: Header=BB2_38 Depth=2
	addi.d	$a1, $sp, 113
	b	.LBB2_66
	.p2align	4, , 16
.LBB2_65:                               #   in Loop: Header=BB2_66 Depth=3
	ld.bu	$a0, $a1, 0
	addi.d	$s3, $s3, 1
	addi.d	$a1, $a1, 1
	beqz	$a0, .LBB2_37
...
# %bb.67:                               #   in Loop: Header=BB2_66 Depth=3
	st.b	$a0, $s3, 0
	b	.LBB2_65
.LBB2_68:                               #   in Loop: Header=BB2_9 Depth=1
	ld.bu	$fp, $s2, 64
	beqz	$fp, .LBB2_81
# %bb.69:                               # %.lr.ph400.preheader
                                        #   in Loop: Header=BB2_9 Depth=1
	...
	ori	$s5, $zero, 2
	b	.LBB2_72
.LBB2_70:                               #   in Loop: Header=BB2_72 Depth=2
	ori	$a0, $zero, 48
	ori	$a1, $zero, 2163
	add.d	$a1, $sp, $a1
	stx.b	$a0, $s5, $a1
...
.LBB2_75:                               # %.lr.ph393
	...
	move	$a0, $s4
	.p2align	4, , 16
.LBB2_76:                               #   Parent Loop BB2_9 Depth=1
                                        #     Parent Loop BB2_72 Depth=2
...
# %bb.86:                               #   in Loop: Header=BB2_82 Depth=2
	...
	st.d	$a1, $a2, 0
	b	.LBB2_88
.LBB2_87:                               #   in Loop: Header=BB2_82 Depth=2
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	...
	jirl	$ra, $ra, 0
	move	$a5, $s5
.LBB2_88:                               #   in Loop: Header=BB2_82 Depth=2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a1, $s5, 0
	beqz	$a1, .LBB2_90
# %bb.89:                               #   in Loop: Header=BB2_82 Depth=2
	ld.d	$a2, $a1, 0
...
.LBB2_90:                               # %.thread462
	...
	st.d	$s4, $s5, 0
.LBB2_91:                               #   in Loop: Header=BB2_82 Depth=2
	ld.d	$a1, $s4, 16
...
.LBB2_94:                               #   in Loop: Header=BB2_82 Depth=2
	...
	move	$s4, $a0
	st.d	$a0, $s5, 0
.LBB2_95:                               #   in Loop: Header=BB2_82 Depth=2
	st.b	$s8, $s4, 32
	st.d	$s4, $s4, 24
	st.d	$s4, $s4, 16
	ld.hu	$a0, $s4, 44
...
# %bb.96:                               #   in Loop: Header=BB2_82 Depth=2
	...
	st.d	$a1, $a2, 0
	b	.LBB2_98
.LBB2_97:                               #   in Loop: Header=BB2_82 Depth=2
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	...
	move	$a4, $fp
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
.LBB2_98:                               #   in Loop: Header=BB2_82 Depth=2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a1, $s5, 0
	beqz	$a1, .LBB2_101
# %bb.99:                               #   in Loop: Header=BB2_82 Depth=2
	ld.d	$a2, $a1, 0
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a2, $a3, 0
...
.LBB2_101:                              # %.thread336
	...
	st.d	$s4, $s5, 0
	move	$a1, $a0
.LBB2_102:                              #   in Loop: Header=BB2_82 Depth=2
	ld.d	$a2, $s4, 16
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a0, $s4, 16
	...
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
.LBB2_103:                              #   in Loop: Header=BB2_82 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.bu	$a2, $a0, 0
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $s1, $a0
	st.w	$a2, $a5, 0
	beqz	$a0, .LBB2_105
# %bb.104:                              #   in Loop: Header=BB2_82 Depth=2
	st.d	$a0, $s5, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $s1, 3
	st.d	$a1, $a2, 0
	b	.LBB2_106
.LBB2_105:                              #   in Loop: Header=BB2_82 Depth=2
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	...
	jirl	$ra, $ra, 0
	move	$a4, $fp
.LBB2_106:                              #   in Loop: Header=BB2_82 Depth=2
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
...
# %bb.107:                              #   in Loop: Header=BB2_82 Depth=2
	ld.d	$a1, $s7, 0
	beqz	$a1, .LBB2_109
# %bb.108:                              #   in Loop: Header=BB2_82 Depth=2
	ld.d	$a2, $a0, 16
	ld.d	$a3, $a1, 16
	st.d	$a2, $fp, 0
	st.d	$a3, $a0, 16
...
.LBB2_109:                              # %.thread463
	...
	blt	$a3, $s6, .LBB2_82
	b	.LBB2_111
.LBB2_110:                              # %._crit_edge409
                                        #   in Loop: Header=BB2_9 Depth=1
	andi	$a0, $a0, 1
	bnez	$a0, .LBB2_8
.LBB2_111:                              # %._crit_edge409.thread
                                        #   in Loop: Header=BB2_9 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(FontWordSize)
	jirl	$ra, $ra, 0
	...
	ld.d	$s0, $a0, 0
	b	.LBB2_8
.LBB2_112:                              #   in Loop: Header=BB2_9 Depth=1
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	...
	jirl	$ra, $ra, 0
	move	$a5, $s1
.LBB2_113:                              #   in Loop: Header=BB2_9 Depth=1
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a1, $s6, 0
	beqz	$a1, .LBB2_115
# %bb.114:                              #   in Loop: Header=BB2_9 Depth=1
	ld.d	$a2, $a1, 0
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a2, $a3, 0
...
.LBB2_115:                              # %.thread461
                                        #   in Loop: Header=BB2_9 Depth=1
	st.d	$s4, $s6, 0
.LBB2_116:                              #   in Loop: Header=BB2_9 Depth=1
	ld.d	$a1, $s4, 16
	pcalau12i	$a2, %got_pc_hi20(zz_tmp)
	ld.d	$a2, $a2, %got_pc_lo12(zz_tmp)
	ld.d	$a3, $a0, 16
	...
	st.d	$a1, $a0, 16
	st.d	$a0, $a1, 24
.LBB2_117:                              #   in Loop: Header=BB2_9 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.bu	$a0, $a0, 1
	slli.d	$a1, $a0, 3
	ldx.d	$s4, $s7, $a1
	st.w	$a0, $a5, 0
	beqz	$s4, .LBB2_119
# %bb.118:                              #   in Loop: Header=BB2_9 Depth=1
	st.d	$s4, $s6, 0
	ld.d	$a1, $s4, 0
	alsl.d	$a0, $a0, $s7, 3
	st.d	$a1, $a0, 0
	b	.LBB2_120
.LBB2_119:                              #   in Loop: Header=BB2_9 Depth=1
	pcalau12i	$a1, %got_pc_hi20(no_fpos)
	ld.d	$a1, $a1, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a1, 0
	move	$s4, $a4
	...
	move	$s4, $a0
	st.d	$a0, $s6, 0
.LBB2_120:                              #   in Loop: Header=BB2_9 Depth=1
	st.b	$s8, $s4, 32
	st.d	$s4, $s4, 24
	st.d	$s4, $s4, 16
	ld.hu	$a0, $s4, 44
	...
	st.w	$a2, $a5, 0
	beqz	$a0, .LBB2_122
# %bb.121:                              #   in Loop: Header=BB2_9 Depth=1
	st.d	$a0, $s6, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $s7, 3
	st.d	$a1, $a2, 0
	b	.LBB2_123
.LBB2_122:                              #   in Loop: Header=BB2_9 Depth=1
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
...
.LBB2_123:                              #   in Loop: Header=BB2_9 Depth=1
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a1, $s6, 0
	beqz	$a1, .LBB2_126
# %bb.124:                              #   in Loop: Header=BB2_9 Depth=1
	ld.d	$a2, $a1, 0
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a2, $a3, 0
...
.LBB2_126:                              # %.thread334
	...
	st.d	$s4, $s6, 0
	move	$a1, $a0
.LBB2_127:                              #   in Loop: Header=BB2_9 Depth=1
	ld.d	$a2, $s4, 16
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	st.d	$a0, $s4, 16
	...
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
.LBB2_128:                              #   in Loop: Header=BB2_9 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.bu	$a2, $a0, 0
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $s7, $a0
	st.w	$a2, $a5, 0
	beqz	$a0, .LBB2_130
# %bb.129:                              #   in Loop: Header=BB2_9 Depth=1
	st.d	$a0, $s6, 0
	ld.d	$a1, $a0, 0
	alsl.d	$a2, $a2, $s7, 3
	st.d	$a1, $a2, 0
	b	.LBB2_131
.LBB2_130:                              #   in Loop: Header=BB2_9 Depth=1
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a0, 0
	move	$a0, $a2
	...
	jirl	$ra, $ra, 0
	move	$a4, $fp
.LBB2_131:                              #   in Loop: Header=BB2_9 Depth=1
	st.b	$zero, $a0, 32
	st.d	$a0, $a0, 24
	st.d	$a0, $a0, 16
	st.d	$a0, $a0, 8
	...
	st.d	$a0, $s6, 0
	beqz	$a0, .LBB2_134
# %bb.132:                              #   in Loop: Header=BB2_9 Depth=1
	ld.d	$a1, $s1, 0
	beqz	$a1, .LBB2_134
# %bb.133:                              #   in Loop: Header=BB2_9 Depth=1
	ld.d	$a2, $a0, 16
	ld.d	$a3, $a1, 16
	st.d	$a2, $fp, 0
	st.d	$a3, $a0, 16
	...
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
.LBB2_134:                              #   in Loop: Header=BB2_9 Depth=1
	st.b	$zero, $s5, 0
	move	$a0, $s2
	pcaddu18i	$ra, %call36(FontWordSize)
	jirl	$ra, $ra, 0
...
.LBB3_29:                               # %NewTrieNode.exit100
	...
	addi.d	$s2, $s2, 1
	bnez	$a1, .LBB3_21
.LBB3_30:                               # %._crit_edge111.loopexit
...
.LBB3_33:
	...
	ld.bu	$a1, $sp, 536
	bnez	$a1, .LBB3_19
.LBB3_34:                               # %._crit_edge.._crit_edge111_crit_edge
	ld.d	$s5, $fp, 264
	move	$a0, $zero
	slli.d	$s0, $a0, 1
	ldx.hu	$a0, $s5, $s0
...
.LBB3_35:
	...
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB3_36:                               # %NewTrieString.exit.thread
	ori	$a0, $zero, 1
	b	.LBB3_41
.LBB3_37:
	ld.wu	$s0, $fp, 292
