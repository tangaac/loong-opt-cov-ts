...
.LBB1_384:                              # %.thread426
	...
	ext.w.h	$fp, $a1
	.p2align	4, , 16
.LBB1_385:                              # =>This Loop Header: Depth=1
...
.LBB1_387:                              # %.preheader
	...
	ld.bu	$a2, $a1, 32
	beqz	$a2, .LBB1_387
# %bb.388:                              #   in Loop: Header=BB1_385 Depth=1
	ld.w	$a2, $a1, 48
	bne	$a2, $fp, .LBB1_385
# %bb.389:
	ld.wu	$a0, $s8, 12
...
.LBB1_416:                              # =>This Inner Loop Header: Depth=1
	ld.bu	$t5, $a0, 0
	beq	$t5, $a4, .LBB1_415
# %bb.417:                              #   in Loop: Header=BB1_416 Depth=1
	add.d	$t5, $a2, $a3
	ldx.h	$t6, $t5, $a5
	ld.w	$t7, $s1, 48
	ld.w	$t8, $s0, 48
...
.LBB1_420:
	ori	$a0, $zero, 2
	blt	$s4, $a0, .LBB1_425
# %bb.421:                              # %.lr.ph511.preheader
	addi.d	$a0, $s2, 10
	addi.d	$a1, $s4, -1
	addi.d	$a2, $s3, 10
	b	.LBB1_423
	.p2align	4, , 16
.LBB1_422:                              #   in Loop: Header=BB1_423 Depth=1
	addi.d	$a0, $a0, 6
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 6
	beqz	$a1, .LBB1_425
.LBB1_423:                              # %.lr.ph511
	...
	st.b	$a3, $a0, -4
	beqz	$a3, .LBB1_422
# %bb.424:                              #   in Loop: Header=BB1_423 Depth=1
	ld.h	$a3, $a2, -2
	ld.w	$a4, $s1, 48
	ld.w	$a5, $s0, 48
	mul.w	$a3, $a4, $a3
...
# %bb.430:                              # %iter.check
	...
	ori	$a5, $zero, 32
	bltu	$a2, $a5, .LBB1_446
# %bb.431:                              # %vector.main.loop.iter.check
	addi.d	$a2, $s3, -1
	ori	$a4, $zero, 17
	vreplgr2vr.w	$vr0, $a0
	vreplgr2vr.w	$vr1, $a1
...
.LBB1_433:                              # %vec.epilog.ph
	...
	add.d	$a7, $s2, $a7
	sub.d	$a3, $a3, $a5
.LBB1_434:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a6, 0
	vilvl.h	$vr3, $vr2, $vr2
	vslli.w	$vr3, $vr3, 16
	...
	addi.d	$a7, $a7, 16
	bnez	$a3, .LBB1_434
# %bb.435:                              # %vec.epilog.middle.block
	bne	$a2, $a5, .LBB1_446
	b	.LBB1_448
.LBB1_436:
	alsl.d	$a0, $s5, $s5, 1
...
.LBB1_440:                              # %.thread426
	...
	jirl	$ra, $ra, 0
                                        # implicit-def: $r4
	b	.LBB1_384
.LBB1_441:                              # %vector.ph686
	move	$a3, $a2
	bstrins.d	$a3, $zero, 3, 0
	addi.d	$a4, $fp, 18
	addi.d	$a5, $s2, 18
	move	$a6, $a3
.LBB1_442:                              # %vector.body691
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a4, -16
	vld	$vr3, $a4, 0
	vilvl.h	$vr4, $vr2, $vr2
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_442
# %bb.443:                              # %middle.block696
	beq	$a2, $a3, .LBB1_448
# %bb.444:                              # %vec.epilog.iter.check
	andi	$a4, $a2, 8
	bnez	$a4, .LBB1_433
# %bb.445:
	addi.d	$a4, $a3, 1
.LBB1_446:                              # %.lr.ph515.preheader
	alsl.d	$a2, $a4, $s2, 1
	alsl.d	$a3, $a4, $fp, 1
	sub.d	$a4, $s3, $a4
.LBB1_447:                              # %.lr.ph515
