...
# %bb.0:
	...
	ld.w	$a3, $s3, %pc_lo12(gs_stack_top)
	move	$s0, $a2
	move	$s1, $a1
	move	$fp, $a0
	ori	$a0, $zero, 48
...
# %bb.1:
	ld.wu	$a1, $fp, 76
	ld.w	$a2, $s5, %pc_lo12(currentfont)
	andi	$a0, $a1, 4095
	bne	$a0, $a2, .LBB3_5
# %bb.2:
...
# %bb.3:
	...
	addi.w	$a2, $a3, 2
	st.w	$a2, $s3, %pc_lo12(gs_stack_top)
	st.w	$zero, $sp, 56
	st.w	$a1, $sp, 52
	st.w	$a0, $sp, 48
	st.w	$t0, $sp, 60
...
.LBB17_23:                              #   in Loop: Header=BB17_16 Depth=2
	...
	ld.bu	$a2, $fp, 1
	beqz	$a2, .LBB17_25
.LBB17_24:                              # %.preheader226.preheader
                                        #   in Loop: Header=BB17_16 Depth=2
	addi.d	$a0, $fp, 1
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
...
.LBB17_31:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 1
	bltu	$a3, $a4, .LBB17_31
# %bb.32:                               # %.preheader223.preheader
	addi.d	$fp, $sp, 100
	.p2align	4, , 16
.LBB17_33:                              # %.preheader223
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $fp, $a2
	ld.b	$a0, $a0, -1
	ld.d	$a1, $s5, %pc_lo12(out_fp)
...
.LBB17_38:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 1
	bltu	$a1, $a3, .LBB17_38
# %bb.39:                               # %.preheader225.preheader
	addi.d	$fp, $sp, 100
	.p2align	4, , 16
.LBB17_40:                              # %.preheader225
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $fp, $a2
	ld.b	$a0, $a0, -1
	ld.d	$a1, $s5, %pc_lo12(out_fp)
...
.LBB17_44:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 1
	bltu	$a1, $a3, .LBB17_44
# %bb.45:                               # %.preheader224.preheader
	addi.d	$fp, $sp, 100
	.p2align	4, , 16
.LBB17_46:                              # %.preheader224
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $fp, $a2
	ld.b	$a0, $a0, -1
	ld.d	$a1, $s5, %pc_lo12(out_fp)
...
.LBB17_56:                              # =>This Inner Loop Header: Depth=1
	...
	move	$fp, $a5
	bltu	$a3, $a4, .LBB17_56
# %bb.57:                               # %.preheader222.preheader
	addi.d	$fp, $sp, 100
	.p2align	4, , 16
.LBB17_58:                              # %.preheader222
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $fp, $a2
	ld.b	$a0, $a0, -1
	ld.d	$a1, $s5, %pc_lo12(out_fp)
...
# %bb.64:                               #   in Loop: Header=BB17_63 Depth=1
	...
	ld.d	$a4, $a1, 72
	.p2align	4, , 16
.LBB17_65:                              #   Parent Loop BB17_63 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.bu	$a5, $a4, $a2
	addi.d	$a2, $a2, 1
	bltu	$a3, $a5, .LBB17_65
# %bb.66:                               #   in Loop: Header=BB17_63 Depth=1
	bne	$a5, $a3, .LBB17_69
# %bb.67:                               #   in Loop: Header=BB17_63 Depth=1
	ld.d	$a3, $a1, 80
	add.d	$a2, $a3, $a2
	ld.bu	$a2, $a2, -1
	ld.d	$a1, $a1, 88
	...
	ldx.hu	$a1, $a1, $a2
	beqz	$a1, .LBB17_69
# %bb.68:                               #   in Loop: Header=BB17_63 Depth=1
	ld.d	$a0, $s5, %pc_lo12(out_fp)
	ext.w.h	$a1, $a1
	sub.d	$a3, $zero, $a1
...
.LBB17_69:                              # %.thread
	...
	ldx.hu	$a1, $s7, $a1
	beqz	$a1, .LBB17_62
# %bb.70:                               #   in Loop: Header=BB17_63 Depth=1
	ld.d	$a0, $s5, %pc_lo12(out_fp)
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	move	$a2, $s1
	pcaddu18i	$ra, %call36(fprintf)
...
# %bb.75:                               #   in Loop: Header=BB17_63 Depth=1
	...
	pcaddu18i	$ra, %call36(putc)
	jirl	$ra, $ra, 0
.LBB17_76:                              # %.preheader305
                                        #   in Loop: Header=BB17_63 Depth=1
	move	$a2, $zero
	addi.d	$a0, $sp, 100
	.p2align	4, , 16
.LBB17_77:                              #   Parent Loop BB17_63 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a1, $fp, 0
...
.LBB17_78:                              # %.preheader
	...
	move	$a2, $fp
	bnez	$fp, .LBB17_78
# %bb.79:                               #   in Loop: Header=BB17_63 Depth=1
	ld.d	$a1, $s5, %pc_lo12(out_fp)
	ori	$a0, $zero, 40
	pcaddu18i	$ra, %call36(putc)
	jirl	$ra, $ra, 0
