...
# %bb.0:
	...
	add.w	$s8, $a5, $a2
	ld.w	$a3, $s5, 68
	pcalau12i	$a4, %got_pc_hi20(binOffsetX)
	ld.d	$a4, $a4, %got_pc_lo12(binOffsetX)
	...
	sltui	$a6, $a6, 1
	and	$a4, $a4, $a6
	pcalau12i	$a6, %got_pc_hi20(binX)
	ld.d	$a6, $a6, %got_pc_lo12(binX)
...
# %bb.2:                                # %.lr.ph288.split.preheader
	...
	pcalau12i	$a6, %got_pc_hi20(numcells)
	ld.d	$a6, $a6, %got_pc_lo12(numcells)
	move	$t1, $zero
	ld.d	$a4, $a4, 0
