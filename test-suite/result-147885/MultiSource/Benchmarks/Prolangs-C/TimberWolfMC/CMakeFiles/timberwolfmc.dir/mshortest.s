...
# %bb.47:                               # %vector.memcheck782
	...
	addi.d	$a5, $a0, 2
	bgeu	$a6, $t0, .LBB0_49
# %bb.48:                               # %vector.memcheck782
                                        #   in Loop: Header=BB0_30 Depth=1
	addi.d	$a6, $a7, 2
	bltu	$a5, $a6, .LBB0_52
.LBB0_49:                               # %vector.ph794
                                        #   in Loop: Header=BB0_30 Depth=1
...
.LBB0_50:                               # %vector.body797
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB0_50
# %bb.51:                               # %middle.block803
                                        #   in Loop: Header=BB0_30 Depth=1
	beq	$a6, $a4, .LBB0_54
.LBB0_52:                               # %scalar.ph792.preheader
                                        #   in Loop: Header=BB0_30 Depth=1
	slli.d	$a4, $a4, 1
	slli.d	$a5, $fp, 1
	sub.d	$a4, $a4, $a5
...
.LBB0_121:                              #   in Loop: Header=BB0_79 Depth=3
	move	$a4, $s7
.LBB0_122:                              # %.lr.ph516.preheader825
                                        #   in Loop: Header=BB0_79 Depth=3
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a2, $s3, 1
...
.LBB0_133:                              # %vector.body744
	...
	addi.d	$t0, $t0, -16
	bnez	$t1, .LBB0_133
# %bb.134:                              # %middle.block750
                                        #   in Loop: Header=BB0_79 Depth=3
	beq	$a7, $a4, .LBB0_137
	.p2align	4, , 16
.LBB0_135:                              # %scalar.ph739.preheader
                                        #   in Loop: Header=BB0_79 Depth=3
	slli.d	$a4, $a4, 1
	slli.d	$a6, $a5, 1
	sub.d	$a4, $a4, $a6
...
# %bb.162:                              # %.preheader431
	...
	blt	$a7, $a1, .LBB0_171
.LBB0_163:                              # %.lr.ph547.preheader
                                        #   in Loop: Header=BB0_58 Depth=2
	bstrpick.d	$a1, $s7, 31, 0
	ori	$a2, $zero, 9
	bltu	$a7, $a2, .LBB0_166
# %bb.164:                              # %vector.memcheck701
                                        #   in Loop: Header=BB0_58 Depth=2
	alsl.d	$a3, $a1, $a0, 1
	addi.d	$a2, $a3, 2
	bgeu	$a2, $s6, .LBB0_186
...
.LBB0_167:                              # %.lr.ph547.preheader826
                                        #   in Loop: Header=BB0_58 Depth=2
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a3, $s3, 1
...
.LBB0_168:                              # %.lr.ph547
	...
	addi.d	$a2, $a2, -2
	bnez	$a3, .LBB0_168
.LBB0_169:                              # %._crit_edge548.loopexit
                                        #   in Loop: Header=BB0_58 Depth=2
	move	$s7, $a1
	b	.LBB0_172
...
.LBB0_187:                              # %vector.body717
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB0_187
# %bb.188:                              # %middle.block724
                                        #   in Loop: Header=BB0_58 Depth=2
	bne	$a6, $a5, .LBB0_167
	b	.LBB0_169
.LBB0_189:                              # %._crit_edge563
                                        #   in Loop: Header=BB0_30 Depth=1
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.w	$fp, $a0, 0
	bge	$fp, $s3, .LBB0_193
...
.LBB0_207:                              # %vector.body811
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB0_207
# %bb.208:                              # %middle.block817
                                        #   in Loop: Header=BB0_203 Depth=1
	beq	$a4, $a5, .LBB0_202
.LBB0_209:                              # %.lr.ph578.preheader823
                                        #   in Loop: Header=BB0_203 Depth=1
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a0, $a3, $a0, 1
	sub.d	$a2, $a2, $a3
