...
.LBB0_40:                               # %.preheader
	...
	ori	$a2, $zero, 2
	blt	$a0, $a2, .LBB0_47
# %bb.41:                               # %.lr.ph1098.peel.next.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	addi.d	$a0, $a1, 20
	ori	$a2, $zero, 1
	move	$s8, $s0
...
# %bb.51:                               #   in Loop: Header=BB0_4 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_2
# %bb.52:                               # %.peel.next1240.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ori	$s7, $zero, 1
	.p2align	4, , 16
.LBB0_53:                               # %.peel.next1240
                                        #   Parent Loop BB0_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
...
.LBB0_97:                               # %.preheader941
	...
	ori	$a2, $zero, 2
	blt	$a0, $a2, .LBB0_114
# %bb.98:                               # %.lr.ph1035.peel.next.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	addi.d	$a0, $a1, 20
	ori	$a2, $zero, 1
	move	$s3, $s0
...
# %bb.106:                              #   in Loop: Header=BB0_4 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_2
# %bb.107:                              # %.peel.next1219.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ori	$s7, $zero, 1
	.p2align	4, , 16
.LBB0_108:                              # %.peel.next1219
                                        #   Parent Loop BB0_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
...
# %bb.142:                              #   in Loop: Header=BB0_4 Depth=1
	...
	ori	$a0, $zero, 2
	blt	$a1, $a0, .LBB0_2
# %bb.143:                              # %.peel.next1179.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ori	$s7, $zero, 1
	.p2align	4, , 16
.LBB0_144:                              # %.peel.next1179
                                        #   Parent Loop BB0_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
...
# %bb.154:                              #   in Loop: Header=BB0_152 Depth=2
	...
	bltu	$a6, $a5, .LBB0_152
	b	.LBB0_180
.LBB0_155:                              # %._crit_edge.loopexit.loopexit
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a1, $a0
	addi.d	$a6, $a0, 1
	ori	$s3, $zero, 1
.LBB0_156:                              # %._crit_edge.loopexit
                                        #   in Loop: Header=BB0_4 Depth=1
	st.d	$a3, $sp, 104                   # 8-byte Folded Spill
...
.LBB0_165:                              #   Parent Loop BB0_4 Depth=1
	...
	addi.d	$a0, $a0, 44
	bnez	$a1, .LBB0_165
# %bb.166:                              # %._crit_edge985.loopexit
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a0, $sp, 1356
.LBB0_167:                              # %._crit_edge985
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a1, $sp, 1368
	movgr2fr.w	$fa0, $a1
	ffint.d.w	$fa0, $fa0
...
# %bb.169:                              # %.lr.ph992
	...
	ld.d	$a1, $s6, 144
	bne	$a3, $a2, .LBB0_182
# %bb.170:                              #   in Loop: Header=BB0_4 Depth=1
	move	$a3, $a2
	b	.LBB0_185
...
.LBB0_186:                              # %scalar.ph
	...
	addi.d	$a1, $a1, 44
	bnez	$a2, .LBB0_186
.LBB0_187:                              # %.preheader946
                                        #   in Loop: Header=BB0_4 Depth=1
	blez	$a0, .LBB0_113
# %bb.188:                              # %.lr.ph995.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	move	$s7, $zero
	.p2align	4, , 16
.LBB0_189:                              # %.lr.ph995
