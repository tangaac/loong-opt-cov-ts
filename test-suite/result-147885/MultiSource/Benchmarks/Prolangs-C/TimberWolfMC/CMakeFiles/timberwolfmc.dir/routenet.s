...
.LBB1_9:
	...
	ld.d	$s3, $a1, %got_pc_lo12(MAXPATHS)
	ld.w	$a1, $s3, 0
...
.LBB1_69:                               # %.lr.ph455
	...
	ld.w	$fp, $s4, 0
	bne	$fp, $s5, .LBB1_68
# %bb.70:                               # %.preheader736.preheader
                                        #   in Loop: Header=BB1_69 Depth=4
	move	$s1, $s6
	.p2align	4, , 16
.LBB1_71:                               # %.preheader736
                                        #   Parent Loop BB1_53 Depth=1
                                        #     Parent Loop BB1_59 Depth=2
                                        #       Parent Loop BB1_65 Depth=3
...
.LBB1_93:                               # %vector.body762
	...
	addi.d	$a6, $a6, 16
	bnez	$a7, .LBB1_93
# %bb.94:                               # %middle.block768
                                        #   in Loop: Header=BB1_90 Depth=1
	beq	$a1, $a4, .LBB1_97
.LBB1_95:                               # %scalar.ph757.preheader
                                        #   in Loop: Header=BB1_90 Depth=1
	alsl.d	$a2, $a3, $a2, 1
	alsl.d	$a4, $a3, $a0, 2
	sub.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB1_96:                               # %scalar.ph757
                                        #   Parent Loop BB1_90 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$a5, $a4, 0
	st.h	$a5, $a2, 0
...
.LBB1_98:                               #   in Loop: Header=BB1_99 Depth=2
	...
	addi.d	$a5, $a5, 2
	beqz	$a1, .LBB1_102
.LBB1_99:                               #   Parent Loop BB1_90 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$a6, $a5, 0
	bge	$a2, $a6, .LBB1_98
...
# %bb.103:                              # %.lr.ph533
	...
	b	.LBB1_105
	.p2align	4, , 16
.LBB1_104:                              # %._crit_edge526
                                        #   in Loop: Header=BB1_105 Depth=2
	addi.d	$t1, $t1, 1
	beq	$t1, $a7, .LBB1_121
.LBB1_105:                              #   Parent Loop BB1_90 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB1_108 Depth 3
                                        #       Child Loop BB1_116 Depth 3
                                        #         Child Loop BB1_118 Depth 4
...
.LBB1_111:                              # %.loopexit390
	...
	b	.LBB1_104
	.p2align	4, , 16
.LBB1_112:                              #   in Loop: Header=BB1_105 Depth=2
	add.d	$t2, $a4, $t3
	addi.d	$t2, $t2, 16
	ld.d	$t2, $t2, 0
	beqz	$t2, .LBB1_104
...
.LBB1_114:                              # %._crit_edge519
	...
	slli.d	$t5, $t6, 1
	stx.h	$t4, $t3, $t5
.LBB1_115:                              # %.loopexit389
                                        #   in Loop: Header=BB1_116 Depth=3
	ld.d	$t2, $t2, 8
	beqz	$t2, .LBB1_104
.LBB1_116:                              #   Parent Loop BB1_90 Depth=1
                                        #     Parent Loop BB1_105 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB1_118 Depth 4
	ld.w	$t4, $t2, 0
...
.LBB1_124:                              # %vector.body750
	...
	addi.d	$t1, $t1, 16
	bnez	$t2, .LBB1_124
# %bb.125:                              # %middle.block754
                                        #   in Loop: Header=BB1_90 Depth=1
	beq	$a6, $a7, .LBB1_128
.LBB1_126:                              # %scalar.ph745.preheader
                                        #   in Loop: Header=BB1_90 Depth=1
	slli.d	$a6, $a5, 1
	alsl.d	$a6, $a4, $a6, 1
	add.d	$a6, $a2, $a6
...
.LBB1_127:                              # %scalar.ph745
	...
	addi.d	$a7, $a7, 4
	bnez	$a1, .LBB1_127
.LBB1_128:                              #   in Loop: Header=BB1_90 Depth=1
	move	$a5, $s8
	b	.LBB1_130
	.p2align	4, , 16
.LBB1_129:                              #   in Loop: Header=BB1_90 Depth=1
	ori	$a5, $zero, 1
.LBB1_130:                              # %._crit_edge540
                                        #   in Loop: Header=BB1_90 Depth=1
	addi.w	$a1, $s0, -1
	add.w	$s2, $s7, $a1
	add.w	$a5, $a4, $a5
...
# %bb.132:                              # %.lr.ph562
	...
	b	.LBB1_134
	.p2align	4, , 16
.LBB1_133:                              # %._crit_edge558
                                        #   in Loop: Header=BB1_134 Depth=2
	addi.d	$s0, $s0, 1
	addi.w	$a3, $s0, 0
	beq	$a2, $a3, .LBB1_89
.LBB1_134:                              #   Parent Loop BB1_90 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB1_135 Depth 3
                                        #         Child Loop BB1_136 Depth 4
	slli.d	$a3, $s0, 1
...
.LBB1_135:                              # %.lr.ph557
	...
	alsl.d	$a6, $a5, $a1, 3
	.p2align	4, , 16
.LBB1_136:                              #   Parent Loop BB1_90 Depth=1
                                        #     Parent Loop BB1_134 Depth=2
...
.LBB1_138:                              # %.lr.ph551
	...
	b	.LBB1_140
	.p2align	4, , 16
.LBB1_139:                              # %._crit_edge547
                                        #   in Loop: Header=BB1_140 Depth=2
	addi.d	$a6, $a6, 1
	addi.w	$a7, $a6, 0
	beq	$a5, $a7, .LBB1_131
.LBB1_140:                              #   Parent Loop BB1_90 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB1_141 Depth 3
                                        #         Child Loop BB1_142 Depth 4
	slli.d	$a7, $a6, 1
...
.LBB1_141:                              # %.lr.ph546
	...
	alsl.d	$t2, $t1, $a4, 3
	.p2align	4, , 16
.LBB1_142:                              #   Parent Loop BB1_90 Depth=1
                                        #     Parent Loop BB1_140 Depth=2
...
.LBB1_159:                              #   in Loop: Header=BB1_157 Depth=1
	...
	alsl.d	$a7, $a3, $a1, 3
	.p2align	4, , 16
.LBB1_160:                              #   Parent Loop BB1_157 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a6, $a7, 0
	ld.w	$t0, $a6, 0
	addi.d	$a7, $a6, 32
	bne	$t0, $a5, .LBB1_160
# %bb.161:                              #   in Loop: Header=BB1_157 Depth=1
	ld.w	$a5, $a6, 8
	ld.w	$a7, $a4, 0
	st.w	$a5, $a6, 12
	beq	$a7, $a3, .LBB1_156
...
.LBB1_165:                              # %.lr.ph589
	...
	addi.d	$s0, $s0, 8
	blt	$fp, $a0, .LBB1_165
.LBB1_166:                              # %._crit_edge590
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB1_175
.LBB1_167:                              # %vector.ph775
...
.LBB1_168:                              # %vector.body778
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB1_168
# %bb.169:                              # %middle.block783
	beq	$a5, $a0, .LBB1_174
# %bb.170:                              # %vec.epilog.iter.check
	andi	$a4, $a0, 8
	bnez	$a4, .LBB1_6
# %bb.171:
	addi.d	$a4, $a5, 1
