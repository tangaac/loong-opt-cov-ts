...
# %bb.0:
	...
	pcalau12i	$a1, %pc_hi20(PSIZE)
	st.w	$zero, $a1, %pc_lo12(PSIZE)
	pcalau12i	$a1, %pc_hi20(Num_Pat)
	vst	$vr0, $a0, 52
	pcalau12i	$a2, %pc_hi20(.LCPI0_5)
	vld	$vr0, $a2, %pc_lo12(.LCPI0_5)
	st.w	$zero, $a1, %pc_lo12(Num_Pat)
	pcalau12i	$a1, %pc_hi20(SILENT)
	st.d	$a1, $sp, 56                    # 8-byte Folded Spill
	st.w	$zero, $a1, %pc_lo12(SILENT)
	vst	$vr0, $a0, 36
	pcalau12i	$a1, %pc_hi20(.LCPI0_6)
	vld	$vr0, $a1, %pc_lo12(.LCPI0_6)
	pcalau12i	$a1, %pc_hi20(RE_ERR)
	st.w	$zero, $a1, %pc_lo12(RE_ERR)
	...
	st.w	$zero, $a1, %pc_lo12(WORDBOUND)
	vst	$vr0, $a0, 4
...
# %bb.155:                              # %.lr.ph266.preheader
	move	$s5, $zero
	move	$s7, $zero
	pcalau12i	$s8, %pc_hi20(Textfiles)
	pcalau12i	$a0, %pc_hi20(CurrentFileName)
...
.LBB7_10:                               # %.lr.ph
	...
	bnez	$a2, .LBB7_10
.LBB7_11:                               # %._crit_edge
	pcalau12i	$s4, %pc_hi20(FIRST_IN_RE)
	ld.w	$a1, $s4, %pc_lo12(FIRST_IN_RE)
...
.LBB7_13:
	...
	st.w	$zero, $s4, %pc_lo12(FIRST_IN_RE)
...
.LBB7_55:                               # %vector.body681
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB7_55
# %bb.56:                               # %middle.block684
                                        #   in Loop: Header=BB7_31 Depth=2
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	move	$a2, $a3
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	beq	$a3, $a1, .LBB7_59
.LBB7_57:                               # %scalar.ph674.preheader
                                        #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a1, 141
	ori	$a1, $a1, 872
	add.d	$a1, $sp, $a1
...
# %bb.85:                               #   in Loop: Header=BB7_31 Depth=2
	...
	b	.LBB7_29
	.p2align	4, , 16
.LBB7_86:                               # %vector.body668.preheader
                                        #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 912
	add.d	$a0, $sp, $a0
...
.LBB7_87:                               # %vector.body668
	...
	addi.d	$a0, $a0, 32
	bnez	$a1, .LBB7_87
# %bb.88:                               # %middle.block671
                                        #   in Loop: Header=BB7_31 Depth=2
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	move	$a1, $a3
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	beq	$a3, $a0, .LBB7_91
.LBB7_89:                               # %scalar.ph663.preheader
                                        #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 896
	add.d	$a0, $sp, $a0
...
.LBB7_92:                               # %.lr.ph594
	...
	bnez	$a1, .LBB7_92
	b	.LBB7_30
.LBB7_93:                               #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a3, 141
	ori	$a3, $a3, 876
	add.d	$a3, $sp, $a3
	ld.w	$a3, $a3, 0
	...
	ori	$a2, $zero, 1
	beq	$s1, $a2, .LBB7_62
# %bb.94:                               #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a2, 141
	ori	$a2, $a2, 880
	add.d	$a2, $sp, $a2
	ld.w	$a2, $a2, 0
...
# %bb.96:                               #   in Loop: Header=BB7_31 Depth=2
	...
	and	$a2, $a2, $fp
	or	$a2, $a2, $a4
.LBB7_97:                               # %.loopexit559.sink.split
                                        #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a3, 141
	ori	$a3, $a3, 912
	add.d	$a3, $sp, $a3
	st.w	$a2, $a3, 0
	b	.LBB7_62
.LBB7_98:                               #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a2, 141
	ori	$a2, $a2, 900
	add.d	$a2, $sp, $a2
	ld.w	$a2, $a2, 0
	...
	ori	$a1, $zero, 1
	beq	$s1, $a1, .LBB7_30
# %bb.99:                               #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a1, 141
	ori	$a1, $a1, 904
	add.d	$a1, $sp, $a1
	ld.w	$a1, $a1, 0
...
# %bb.103:                              # %.lr.ph607
	...
	b	.LBB7_105
	.p2align	4, , 16
.LBB7_104:                              #   in Loop: Header=BB7_105 Depth=1
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	bstrpick.d	$a0, $a0, 30, 0
	add.d	$a1, $a5, $a0
	addi.d	$a0, $sp, 231
	...
	ori	$a3, $zero, 2
	blez	$a1, .LBB7_153
.LBB7_105:                              # =>This Loop Header: Depth=1
                                        #     Child Loop BB7_113 Depth 2
                                        #       Child Loop BB7_122 Depth 3
                                        #       Child Loop BB7_128 Depth 3
	...
	bltu	$a3, $a2, .LBB7_108
# %bb.106:                              #   in Loop: Header=BB7_105 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	addi.d	$a1, $a1, 1023
	bstrpick.d	$a1, $a1, 16, 0
	ldx.bu	$a1, $a1, $a5
	beq	$a1, $a6, .LBB7_108
# %bb.107:                              #   in Loop: Header=BB7_105 Depth=1
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$a6, $a1, $a5
.LBB7_108:                              #   in Loop: Header=BB7_105 Depth=1
	andi	$a0, $a0, 1
	ori	$s2, $zero, 1024
	bnez	$a0, .LBB7_110
# %bb.109:                              #   in Loop: Header=BB7_105 Depth=1
	st.b	$a6, $sp, 1254
	ori	$s2, $zero, 1023
.LBB7_110:                              # %.preheader687
                                        #   in Loop: Header=BB7_105 Depth=1
	addi.w	$fp, $s2, 1
	addi.w	$s1, $s2, 2
	b	.LBB7_113
	.p2align	4, , 16
.LBB7_111:                              # %r_output.exit525
	...
	ori	$a0, $a0, 1256
	add.d	$s3, $sp, $a0
.LBB7_112:                              #   in Loop: Header=BB7_113 Depth=2
	addi.w	$s2, $s2, 2
	addi.w	$fp, $fp, 2
	addi.w	$s1, $s1, 2
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bgeu	$s2, $a0, .LBB7_104
.LBB7_113:                              #   Parent Loop BB7_105 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB7_122 Depth 3
                                        #       Child Loop BB7_128 Depth 3
                                        #       Child Loop BB7_142 Depth 3
...
# %bb.114:                              #   in Loop: Header=BB7_113 Depth=2
	...
	or	$a0, $a1, $a0
	beqz	$a3, .LBB7_116
# %bb.115:                              #   in Loop: Header=BB7_113 Depth=2
	srl.w	$a1, $a0, $s6
	bstrpick.d	$a1, $a1, 31, 0
	slli.d	$a1, $a1, 2
	ldx.w	$a1, $a1, $s4
	...
	or	$a1, $a1, $a2
	or	$a0, $a1, $a0
.LBB7_116:                              #   in Loop: Header=BB7_113 Depth=2
	...
	addi.w	$s5, $s5, 1
	beq	$a0, $a1, .LBB7_129
# %bb.117:                              #   in Loop: Header=BB7_113 Depth=2
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	ld.w	$a0, $a2, %pc_lo12(num_of_matched)
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(FILENAMEONLY)
	...
	st.w	$a0, $a2, %pc_lo12(num_of_matched)
	bnez	$a1, .LBB7_152
# %bb.118:                              #   in Loop: Header=BB7_113 Depth=2
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a0, $a0, %pc_lo12(COUNT)
	bnez	$a0, .LBB7_129
# %bb.119:                              #   in Loop: Header=BB7_113 Depth=2
	move	$s3, $s5
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.w	$a0, $a0, %pc_lo12(FNAME)
	beqz	$a0, .LBB7_121
# %bb.120:                              #   in Loop: Header=BB7_113 Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.25)
	addi.d	$a0, $a0, %pc_lo12(.L.str.25)
	pcalau12i	$a1, %pc_hi20(CurrentFileName)
	addi.d	$a1, $a1, %pc_lo12(CurrentFileName)
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
.LBB7_121:                              #   in Loop: Header=BB7_113 Depth=2
	move	$s4, $fp
	move	$s8, $s2
	ori	$a2, $zero, 2
	addi.d	$a3, $sp, 231
	ori	$a4, $zero, 10
	.p2align	4, , 16
.LBB7_122:                              #   Parent Loop BB7_105 Depth=1
	...
	addi.w	$s4, $s4, -1
	blt	$a1, $a2, .LBB7_124
# %bb.123:                              #   in Loop: Header=BB7_122 Depth=3
	bne	$a0, $a4, .LBB7_122
.LBB7_124:                              #   in Loop: Header=BB7_113 Depth=2
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(LINENUM)
	beqz	$a1, .LBB7_126
# %bb.125:                              #   in Loop: Header=BB7_113 Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.26)
	addi.d	$a0, $a0, %pc_lo12(.L.str.26)
	move	$a1, $s3
	pcaddu18i	$ra, %call36(printf)
	...
	addi.d	$a0, $sp, 231
	ldx.bu	$a0, $s8, $a0
.LBB7_126:                              #   in Loop: Header=BB7_113 Depth=2
	addi.d	$a0, $a0, -10
	sltui	$a0, $a0, 1
	ori	$a1, $zero, 1024
	masknez	$a1, $a1, $a0
...
.LBB7_129:                              # %r_output.exit
	...
	b	.LBB7_132
	.p2align	4, , 16
.LBB7_130:                              #   in Loop: Header=BB7_113 Depth=2
	beqz	$s0, .LBB7_132
# %bb.131:                              #   in Loop: Header=BB7_113 Depth=2
	srl.w	$a1, $s8, $s6
	bstrpick.d	$a1, $a1, 31, 0
	slli.d	$a1, $a1, 2
	ldx.w	$a1, $a1, $s4
	...
	and	$a1, $a1, $s0
	or	$a0, $a1, $a0
.LBB7_132:                              #   in Loop: Header=BB7_113 Depth=2
	addi.w	$s5, $s2, 1
	ldx.bu	$a1, $s5, $a5
	slli.d	$a2, $a1, 2
	...
	and	$s8, $a3, $a0
	bne	$a1, $a6, .LBB7_149
# %bb.133:                              #   in Loop: Header=BB7_113 Depth=2
	srl.w	$a1, $a0, $s6
	bstrpick.d	$a1, $a1, 31, 0
	slli.d	$a1, $a1, 2
	ldx.w	$a1, $a1, $s4
	...
	or	$a0, $a0, $s8
	beqz	$a2, .LBB7_135
# %bb.134:                              #   in Loop: Header=BB7_113 Depth=2
	srl.w	$a1, $a0, $s6
	bstrpick.d	$a1, $a1, 31, 0
	slli.d	$a1, $a1, 2
	ldx.w	$a1, $a1, $s4
	...
	or	$a1, $a1, $a2
	or	$a0, $a1, $a0
.LBB7_135:                              #   in Loop: Header=BB7_113 Depth=2
	...
	beq	$a0, $a1, .LBB7_111
# %bb.136:                              #   in Loop: Header=BB7_113 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.w	$a0, $a0, %pc_lo12(FILENAMEONLY)
	bnez	$a0, .LBB7_151
# %bb.137:                              #   in Loop: Header=BB7_113 Depth=2
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bge	$s5, $a0, .LBB7_111
# %bb.138:                              #   in Loop: Header=BB7_113 Depth=2
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	ld.w	$a0, $a2, %pc_lo12(num_of_matched)
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(COUNT)
	...
	st.w	$a0, $a2, %pc_lo12(num_of_matched)
	bnez	$a1, .LBB7_111
# %bb.139:                              #   in Loop: Header=BB7_113 Depth=2
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.w	$a0, $a0, %pc_lo12(FNAME)
	beqz	$a0, .LBB7_141
# %bb.140:                              #   in Loop: Header=BB7_113 Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.25)
	addi.d	$a0, $a0, %pc_lo12(.L.str.25)
	pcalau12i	$a1, %pc_hi20(CurrentFileName)
	addi.d	$a1, $a1, %pc_lo12(CurrentFileName)
	...
	ori	$a6, $zero, 10
	addi.d	$a5, $sp, 231
.LBB7_141:                              #   in Loop: Header=BB7_113 Depth=2
	move	$s8, $s1
	move	$s4, $s5
	ori	$a2, $zero, 2
	.p2align	4, , 16
.LBB7_142:                              #   Parent Loop BB7_105 Depth=1
                                        #     Parent Loop BB7_113 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a1, $s4
	add.d	$a0, $a5, $s4
...
# %bb.143:                              #   in Loop: Header=BB7_142 Depth=3
	bne	$a0, $a6, .LBB7_142
.LBB7_144:                              #   in Loop: Header=BB7_113 Depth=2
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(LINENUM)
	beqz	$a1, .LBB7_146
# %bb.145:                              #   in Loop: Header=BB7_113 Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.26)
	addi.d	$a0, $a0, %pc_lo12(.L.str.26)
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(printf)
	...
	addi.d	$a5, $sp, 231
	ldx.bu	$a0, $s4, $a5
.LBB7_146:                              #   in Loop: Header=BB7_113 Depth=2
	addi.d	$a0, $a0, -10
	sltui	$a0, $a0, 1
	ori	$a1, $zero, 1024
	masknez	$a1, $a1, $a0
...
.LBB7_148:                              # %.lr.ph.i520
	...
	b	.LBB7_111
	.p2align	4, , 16
.LBB7_149:                              #   in Loop: Header=BB7_113 Depth=2
	beqz	$s0, .LBB7_112
# %bb.150:                              #   in Loop: Header=BB7_113 Depth=2
	srl.w	$a1, $a0, $s6
	bstrpick.d	$a1, $a1, 31, 0
	slli.d	$a1, $a1, 2
	ldx.w	$a1, $a1, $s4
