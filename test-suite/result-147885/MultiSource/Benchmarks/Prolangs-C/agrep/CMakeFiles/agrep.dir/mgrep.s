...
.LBB3_20:                               # %.preheader93.preheader
	...
	vld	$vr2, $a1, %pc_lo12(.LCPI3_4)
	pcalau12i	$a1, %pc_hi20(.LCPI3_5)
	vld	$vr3, $a1, %pc_lo12(.LCPI3_5)
	vst	$vr0, $s1, 32
	vst	$vr1, $s1, 48
	vst	$vr2, $s1, 64
	vst	$vr3, $s1, 80
	...
	vld	$vr2, $a1, %pc_lo12(.LCPI3_8)
	pcalau12i	$a1, %pc_hi20(.LCPI3_9)
	vld	$vr3, $a1, %pc_lo12(.LCPI3_9)
	vst	$vr0, $s1, 96
	vst	$vr1, $s1, 112
	vst	$vr2, $s1, 128
	vst	$vr3, $s1, 144
	...
	vld	$vr2, $a1, %pc_lo12(.LCPI3_12)
	pcalau12i	$a1, %pc_hi20(.LCPI3_13)
	vld	$vr3, $a1, %pc_lo12(.LCPI3_13)
	vst	$vr0, $s1, 160
	vst	$vr1, $s1, 176
	vst	$vr2, $s1, 192
	vst	$vr3, $s1, 208
...
.LBB3_39:                               # %.preheader88.preheader.sink.split
	ori	$a1, $zero, 1
	st.w	$a1, $a0, 0
.LBB3_40:                               # %.preheader88.preheader
	addi.d	$a1, $s1, -2
	pcalau12i	$a0, %pc_hi20(SHIFT1)
	addi.d	$a0, $a0, %pc_lo12(SHIFT1)
	lu12i.w	$a2, 1
