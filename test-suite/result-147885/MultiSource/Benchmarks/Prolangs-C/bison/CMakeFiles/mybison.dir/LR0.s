...
.LBB3_43:                               # %save_shifts.exit
	...
	b	.LBB3_3
.LBB3_44:                               # %vector.main.loop.iter.check37
                                        #   in Loop: Header=BB3_4 Depth=1
	srli.d	$a3, $a4, 1
	addi.d	$a3, $a3, 1
	ori	$a5, $zero, 30
...
.LBB3_46:                               # %vec.epilog.ph52
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_47:                               # %vec.epilog.vector.body58
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_47
# %bb.48:                               # %vec.epilog.middle.block66
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a3, $a6, .LBB3_14
	b	.LBB3_16
...
.LBB3_55:                               # %vector.body41
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_55
# %bb.56:                               # %middle.block48
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a5, .LBB3_16
# %bb.57:                               # %vec.epilog.iter.check53
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a4, $a3, 8
	bnez	$a4, .LBB3_46
