...
.LBB1_22:
	move	$a1, $s1
	move	$a0, $s0
.LBB1_23:                               # %.lr.ph27.i.preheader318
	sub.d	$a2, $fp, $a2
	move	$a3, $a0
	.p2align	4, , 16
.LBB1_24:                               # %.lr.ph27.i
...
.LBB1_32:                               # %vector.body216
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_32
# %bb.33:                               # %middle.block223
	bne	$a3, $s2, .LBB1_35
	b	.LBB1_37
.LBB1_34:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_35:                               # %.lr.ph27.i69.preheader316
	sub.d	$a3, $fp, $a3
	move	$a4, $a1
	.p2align	4, , 16
.LBB1_36:                               # %.lr.ph27.i69
...
.LBB1_43:                               # %vector.body235
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_43
# %bb.44:                               # %middle.block242
	bne	$a3, $s5, .LBB1_46
	b	.LBB1_48
.LBB1_45:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_46:                               # %.lr.ph27.i81.preheader314
	sub.d	$a3, $s1, $a3
	move	$a4, $a1
	.p2align	4, , 16
.LBB1_47:                               # %.lr.ph27.i81
...
.LBB1_54:                               # %vector.body254
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_54
# %bb.55:                               # %middle.block261
	bne	$a3, $s3, .LBB1_57
	b	.LBB1_59
.LBB1_56:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_57:                               # %.lr.ph27.i129.preheader312
	sub.d	$a3, $s1, $a3
	move	$a4, $a1
	.p2align	4, , 16
...
.LBB1_64:                               # %vector.body273
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_64
# %bb.65:                               # %middle.block280
	bne	$a3, $s2, .LBB1_67
	b	.LBB1_69
.LBB1_66:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_67:                               # %.lr.ph27.i141.preheader310
	sub.d	$a3, $fp, $a3
	move	$a4, $a1
	.p2align	4, , 16
...
.LBB1_73:                               # %vector.body292
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_73
# %bb.74:                               # %middle.block299
	bne	$a3, $s2, .LBB1_76
	b	.LBB1_78
.LBB1_75:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_76:                               # %.lr.ph27.i153.preheader309
	sub.d	$a3, $fp, $a3
	move	$a4, $a1
	.p2align	4, , 16
