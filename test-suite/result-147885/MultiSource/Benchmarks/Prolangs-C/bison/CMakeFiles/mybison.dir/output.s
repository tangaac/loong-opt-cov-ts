...
# %bb.6:                                # %.lr.ph131.us.preheader
	...
	ld.d	$a7, $a6, %got_pc_lo12(tokensetsize)
	ld.d	$a5, $a5, 0
...
# %bb.16:                               # %.lr.ph140
	...
	pcalau12i	$a7, %got_pc_hi20(error_token_number)
	ld.d	$t0, $a7, %got_pc_lo12(error_token_number)
	ld.d	$a6, $a6, 0
...
.LBB21_35:                              # %vector.ph233
	...
	b	.LBB21_37
	.p2align	4, , 16
.LBB21_36:                              # %pred.store.continue254
                                        #   in Loop: Header=BB21_37 Depth=1
	addi.d	$a4, $a4, -8
	addi.d	$a3, $a3, 16
	beqz	$a4, .LBB21_53
.LBB21_37:                              # %vector.body236
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, -8
	vseq.h	$vr1, $vr1, $vr0
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_45
# %bb.38:                               # %pred.store.if239
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -8
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_46
.LBB21_39:                              # %pred.store.continue242
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_47
.LBB21_40:                              # %pred.store.if243
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_48
.LBB21_41:                              # %pred.store.continue246
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_49
.LBB21_42:                              # %pred.store.if247
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_50
.LBB21_43:                              # %pred.store.continue250
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_51
.LBB21_44:                              # %pred.store.if251
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 4
	...
	b	.LBB21_52
	.p2align	4, , 16
.LBB21_45:                              # %pred.store.continue240
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_39
.LBB21_46:                              # %pred.store.if241
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -6
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_40
.LBB21_47:                              # %pred.store.continue244
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_41
.LBB21_48:                              # %pred.store.if245
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_42
.LBB21_49:                              # %pred.store.continue248
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_43
.LBB21_50:                              # %pred.store.if249
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_44
.LBB21_51:                              # %pred.store.continue252
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_36
.LBB21_52:                              # %pred.store.if253
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_36
.LBB21_53:                              # %middle.block256
	beq	$a2, $s0, .LBB21_73
.LBB21_54:                              # %scalar.ph231.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s0, $a2
	lu12i.w	$a3, 8
	b	.LBB21_56
...
# %bb.77:                               # %pred.store.if
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_81
.LBB21_78:                              # %pred.store.continue214
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr2, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_82
.LBB21_79:                              # %pred.store.if215
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, -4
...
.LBB21_80:                              # %pred.store.continue
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_78
.LBB21_81:                              # %pred.store.if213
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, -6
	vpickve2gr.h	$a5, $vr2, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_79
.LBB21_82:                              # %pred.store.continue216
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr2, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_84
.LBB21_83:                              # %pred.store.if217
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, -2
.LBB21_84:                              # %pred.store.continue218
                                        #   in Loop: Header=BB21_76 Depth=1
	vilvh.h	$vr1, $vr1, $vr1
	vslli.w	$vr1, $vr1, 16
	vsrai.w	$vr1, $vr1, 16
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_88
# %bb.85:                               # %pred.store.if219
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_89
.LBB21_86:                              # %pred.store.continue222
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_90
.LBB21_87:                              # %pred.store.if223
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, 4
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	...
	b	.LBB21_91
	.p2align	4, , 16
.LBB21_88:                              # %pred.store.continue220
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_86
.LBB21_89:                              # %pred.store.if221
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_87
.LBB21_90:                              # %pred.store.continue224
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_75
.LBB21_91:                              # %pred.store.if225
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_75
.LBB21_92:                              # %middle.block228
	bne	$a2, $s0, .LBB21_94
.LBB21_93:                              # %._crit_edge163
	sub.d	$a0, $zero, $a0
	b	.LBB21_31
.LBB21_94:                              # %scalar.ph203.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s0, $a2
	addi.w	$a3, $a0, 0
	b	.LBB21_96
