...
.LBB17_27:                              #   in Loop: Header=BB17_4 Depth=1
	...
	bne	$a0, $a7, .LBB17_29
# %bb.28:                               # %.loopexit.sink.split.sink.split
                                        #   in Loop: Header=BB17_4 Depth=1
	ld.w	$a1, $s4, %pc_lo12(yylineno)
	addi.d	$a1, $a1, -1
	st.w	$a1, $s4, %pc_lo12(yylineno)
.LBB17_29:                              # %.loopexit.sink.split
                                        #   in Loop: Header=BB17_4 Depth=1
...
.LBB17_51:                              # %yyback.exit
                                        #   in Loop: Header=BB17_47 Depth=1
	bgeu	$s3, $a1, .LBB17_55
# %bb.52:                               #   in Loop: Header=BB17_47 Depth=1
	ld.b	$a4, $s8, 0
	andi	$a3, $a4, 255
	st.w	$a4, $s1, %pc_lo12(yytchar)
	bne	$a3, $a0, .LBB17_46
# %bb.53:                               #   in Loop: Header=BB17_47 Depth=1
