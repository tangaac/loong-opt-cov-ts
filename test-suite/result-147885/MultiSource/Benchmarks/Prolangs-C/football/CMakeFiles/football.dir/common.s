...
.Lfunc_end0:
	...
	.p2align	4, 0x0                          # -- Begin function common
.LCPI1_0:
	.word	0                               # 0x0
	.word	4                               # 0x4
	.word	4                               # 0x4
...
# %bb.1:                                # %.preheader94.preheader
	...
	pcalau12i	$a6, %got_pc_hi20(team_plays)
	ld.d	$a6, $a6, %got_pc_lo12(team_plays)
	addi.d	$a7, $a0, 4
	addi.d	$t0, $t0, -1
	ori	$t1, $zero, 116
	.p2align	4, , 16
...
# %bb.3:                                # %.preheader93.loopexit
	...
	st.w	$a3, $sp, 48
	vst	$vr3, $sp, 52
	vstelm.w	$vr4, $sp, 72, 1
	vstelm.w	$vr4, $sp, 76, 2
	vstelm.w	$vr4, $sp, 80, 3
	vst	$vr5, $sp, 84
	vst	$vr6, $sp, 100
	st.w	$a5, $sp, 116
