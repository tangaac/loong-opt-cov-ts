...
.LBB2_93:                               #   in Loop: Header=BB2_5 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB2_122
.LBB2_94:                               # %.preheader147.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	srai.d	$a4, $a2, 10
	addi.d	$a3, $a3, 2
	st.w	$a3, $s4, 4
...
# %bb.125:                              #   in Loop: Header=BB2_5 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB2_122
.LBB2_126:                              #   in Loop: Header=BB2_5 Depth=1
	pcalau12i	$a0, %got_pc_hi20(ex_stack)
	ld.d	$a0, $a0, %got_pc_lo12(ex_stack)
	ld.d	$a0, $a0, 0
	ld.d	$a3, $a0, 0
...
.LBB2_131:                              #   in Loop: Header=BB2_5 Depth=1
	move	$a1, $zero
.LBB2_132:                              # %._crit_edge169
                                        #   in Loop: Header=BB2_5 Depth=1
	add.w	$a1, $a1, $a2
	pcaddu18i	$ra, %call36(int2num)
	jirl	$ra, $ra, 0
	b	.LBB2_122
.LBB2_133:                              # %thread-pre-split
	beqz	$a0, .LBB2_136
# %bb.134:
	ori	$fp, $zero, 168
	.p2align	4, , 16
