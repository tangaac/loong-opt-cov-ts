...
.LBB0_72:                               # %.loopexit166.loopexit
	...
	move	$s0, $t1
	b	.LBB0_74
.LBB0_73:                               # %.loopexit166.sink.split
...
.LBB0_99:                               # %.loopexit830
	ori	$a0, $zero, 260
	b	.LBB0_142
.LBB0_100:                              # %.loopexit819
	ori	$a0, $zero, 277
	b	.LBB0_142
.LBB0_101:                              # %.loopexit824
	ori	$a0, $zero, 286
	b	.LBB0_142
.LBB0_102:                              # %.loopexit813
	ori	$a0, $zero, 275
	b	.LBB0_142
.LBB0_103:                              # %.loopexit825
	ori	$a0, $zero, 287
	b	.LBB0_142
.LBB0_104:                              # %.loopexit654
	ori	$a0, $zero, 272
	b	.LBB0_142
.LBB0_105:                              # %.loopexit816
	ori	$a0, $zero, 279
	b	.LBB0_142
.LBB0_106:                              # %.loopexit285
	ori	$a0, $zero, 269
	b	.LBB0_142
.LBB0_107:                              # %.loopexit842
	ld.d	$a0, $t1, %pc_lo12(yytext)
...
.LBB0_115:                              # %.loopexit165
	ori	$a0, $zero, 268
	b	.LBB0_142
.LBB0_116:                              # %.loopexit814
	ori	$a0, $zero, 276
	b	.LBB0_142
.LBB0_117:                              # %.loopexit817
	ori	$a0, $zero, 280
	b	.LBB0_142
.LBB0_118:                              # %.loopexit811.loopexit
	ori	$a0, $zero, 273
	b	.LBB0_142
.LBB0_119:                              # %.loopexit818
	ori	$a0, $zero, 281
	b	.LBB0_142
.LBB0_120:                              # %.loopexit826
	ori	$a0, $zero, 288
	b	.LBB0_142
.LBB0_121:                              # %.loopexit837
	ld.d	$a0, $t1, %pc_lo12(yytext)
	ld.b	$a0, $a0, 0
	pcalau12i	$a1, %got_pc_hi20(yylval)
	ld.d	$a1, $a1, %got_pc_lo12(yylval)
...
.LBB0_122:                              # %.loopexit831
	...
	ori	$a0, $zero, 264
	b	.LBB0_142
.LBB0_123:                              # %.loopexit828
	ori	$a0, $zero, 258
	b	.LBB0_142
.LBB0_124:                              # %.loopexit832
	ld.d	$a0, $t1, %pc_lo12(yytext)
	ld.b	$a0, $a0, 0
	pcalau12i	$a1, %got_pc_hi20(yylval)
	ld.d	$a1, $a1, %got_pc_lo12(yylval)
...
.LBB0_136:
	...
	ori	$a0, $zero, 263
	b	.LBB0_142
.LBB0_137:                              # %.loopexit822
	ori	$a0, $zero, 285
	b	.LBB0_142
.LBB0_138:                              # %.loopexit836
	ld.d	$a0, $t1, %pc_lo12(yytext)
	pcaddu18i	$ra, %call36(strcopyof)
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %got_pc_hi20(yylval)
...
.LBB0_140:                              # %.loopexit838
	...
	ori	$a0, $zero, 257
	b	.LBB0_142
.LBB0_141:                              # %.loopexit820
	ori	$a0, $zero, 282
.LBB0_142:                              # %.loopexit811
