...
.LBB10_7:                               # %pred.store.continue
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_9
# %bb.8:                                # %pred.store.if21
                                        #   in Loop: Header=BB10_5 Depth=2
	vstelm.d	$vr0, $a1, 8, 1
.LBB10_9:                               # %pred.store.continue22
                                        #   in Loop: Header=BB10_5 Depth=2
	vldx	$vr0, $a1, $s7
	vfcmp.clt.d	$vr1, $vr2, $vr0
	vpickve2gr.d	$a2, $vr1, 0
...
# %bb.10:                               # %pred.store.continue24
	...
	b	.LBB10_12
	.p2align	4, , 16
.LBB10_11:                              # %pred.store.if23
                                        #   in Loop: Header=BB10_5 Depth=2
	vstelm.d	$vr0, $a1, 16, 0
	vpickve2gr.d	$a2, $vr1, 1
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_4
.LBB10_12:                              # %pred.store.if25
                                        #   in Loop: Header=BB10_5 Depth=2
