...
# %bb.0:
	...
	pcalau12i	$t3, %pc_hi20(.LCPI0_33)
	pcalau12i	$t4, %pc_hi20(.LCPI0_34)
	ori	$a7, $zero, 16
	ori	$t0, $zero, 1
	vld	$vr0, $t1, %pc_lo12(.LCPI0_32)
	vld	$vr1, $t3, %pc_lo12(.LCPI0_33)
...
# %bb.9:                                #   in Loop: Header=BB10_7 Depth=3
	ori	$a0, $zero, 2
	bne	$s2, $a0, .LBB10_14
# %bb.10:                               #   in Loop: Header=BB10_7 Depth=3
	addi.d	$a3, $s4, 16
	addi.d	$a0, $sp, 152
	move	$a1, $s4
...
.LBB10_12:                              #   Parent Loop BB10_5 Depth=1
	...
	addi.d	$a0, $a0, 16
	bltu	$a2, $s0, .LBB10_12
# %bb.13:                               # %des3_set_2keys.exit.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	beqz	$s2, .LBB10_18
.LBB10_14:                              # %des3_set_2keys.exit.split.us47.us
                                        #   in Loop: Header=BB10_7 Depth=3
	move	$s5, $s8
	beqz	$s7, .LBB10_16
	.p2align	4, , 16
.LBB10_15:                              # %des3_set_2keys.exit.split.split.us.us.us
                                        #   Parent Loop BB10_5 Depth=1
                                        #     Parent Loop BB10_6 Depth=2
                                        #       Parent Loop BB10_7 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
