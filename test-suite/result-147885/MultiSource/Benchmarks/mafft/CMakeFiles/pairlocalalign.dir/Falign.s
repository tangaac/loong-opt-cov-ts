...
.LBB0_10:
	...
	pcalau12i	$s1, %pc_hi20(Fgetlag.naisekiNoWa)
...
.LBB0_13:
	...
	st.d	$a0, $s1, %pc_lo12(Fgetlag.naisekiNoWa)
	move	$a0, $a1
	move	$a1, $s8
...
# %bb.166:                              # %.preheader371.lr.ph
	...
	pcalau12i	$s6, %pc_hi20(Fgetlag.tmpres1)
	pcalau12i	$s7, %pc_hi20(Fgetlag.tmpres2)
...
# %bb.169:                              # %.lr.ph464
	...
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Fgetlag.cut1)
	ld.d	$s4, $s6, %pc_lo12(Fgetlag.tmpres1)
	alsl.d	$s0, $s1, $a0, 2
...
# %bb.172:                              # %.lr.ph466
	...
	ld.d	$s4, $s7, %pc_lo12(Fgetlag.tmpres2)
	alsl.d	$s0, $s1, $a0, 2
...
.LBB0_176:                              #   in Loop: Header=BB0_168 Depth=1
	ld.d	$a0, $s6, %pc_lo12(Fgetlag.tmpres1)
	ld.d	$a1, $s7, %pc_lo12(Fgetlag.tmpres2)
...
# %bb.188:                              # %.lr.ph470
	...
	ld.d	$s0, $s6, %pc_lo12(Fgetlag.tmpres1)
...
# %bb.191:                              # %.lr.ph472
	...
	ld.d	$s0, $s7, %pc_lo12(Fgetlag.tmpres2)
...
# %bb.236:                              # %vector.scevcheck
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB2_105
# %bb.237:                              # %vector.memcheck737
	alsl.d	$a4, $s3, $a2, 3
	addi.d	$a4, $a4, 8
	alsl.d	$a6, $a3, $a0, 4
	addi.d	$a6, $a6, 8
	bgeu	$a4, $a6, .LBB2_239
# %bb.238:                              # %vector.memcheck737
	alsl.d	$a4, $s8, $a2, 3
	add.d	$a3, $s3, $a3
	sub.d	$a3, $a3, $s8
	alsl.d	$a3, $a3, $a0, 4
...
# %bb.148:                              # %.lr.ph559
	...
	addi.d	$a5, $s3, 1
	bgeu	$a1, $a3, .LBB3_256
.LBB3_149:                              # %scalar.ph847.preheader
	sub.d	$a1, $s3, $a5
	add.w	$a1, $a1, $s1
	alsl.d	$a3, $a5, $a2, 3
	sub.d	$a4, $s8, $a5
	.p2align	4, , 16
.LBB3_150:                              # %scalar.ph847
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a5, $a1, 4
	fldx.d	$fa0, $a0, $a5
	fst.d	$fa0, $a3, 0
...
.LBB3_159:                              # %vector.body872
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_159
# %bb.160:                              # %middle.block878
	beq	$a4, $s2, .LBB3_163
.LBB3_161:                              # %scalar.ph867.preheader
	alsl.d	$a3, $a4, $a3, 3
	slli.d	$a5, $a4, 5
	alsl.d	$a6, $a4, $a5, 4
	add.d	$a1, $a1, $a6
...
.LBB3_165:                              # %vector.body886
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_165
# %bb.166:                              # %middle.block890
	beq	$a1, $a3, .LBB3_169
.LBB3_167:                              # %scalar.ph881.preheader
	alsl.d	$a2, $a1, $a2, 3
	sub.d	$a4, $a3, $a1
	.p2align	4, , 16
.LBB3_168:                              # %scalar.ph881
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a2, 0
	st.w	$a1, $a5, 40
	addi.d	$a1, $a1, 1
...
# %bb.254:                              # %.lr.ph502
	...
	addi.d	$a5, $s4, 1
	bgeu	$a1, $a3, .LBB4_260
.LBB4_255:                              # %scalar.ph768.preheader
	sub.d	$a1, $s4, $a5
	ld.d	$a3, $sp, 96                    # 8-byte Folded Reload
	add.w	$a1, $a1, $a3
	alsl.d	$a3, $a5, $a2, 3
