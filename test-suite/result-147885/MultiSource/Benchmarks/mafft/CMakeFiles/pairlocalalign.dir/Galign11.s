...
.LBB0_34:                               # %vector.body275
	...
	addi.d	$t3, $t3, 32
	bnez	$t4, .LBB0_34
# %bb.35:                               # %middle.block281
	beq	$t1, $t2, .LBB0_39
.LBB0_36:                               # %.lr.ph197.preheader325
	alsl.d	$t1, $t0, $a4, 2
	sub.d	$a2, $a2, $t0
	.p2align	4, , 16
.LBB0_37:                               # %.lr.ph197
...
.LBB0_42:                               # %vector.body289
	...
	addi.d	$t7, $t7, 32
	bnez	$t8, .LBB0_42
# %bb.43:                               # %middle.block295
	beq	$t3, $t4, .LBB0_47
.LBB0_44:                               # %scalar.ph284.preheader
	alsl.d	$t0, $t2, $t0, 2
	alsl.d	$t1, $t2, $t1, 2
	alsl.d	$t3, $t2, $a4, 2
	addi.d	$t3, $t3, -4
...
.LBB0_75:                               # %vector.body316
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_75
# %bb.76:                               # %middle.block322
	beq	$a2, $a3, .LBB0_79
.LBB0_77:                               # %scalar.ph311.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_78:                               # %scalar.ph311
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
