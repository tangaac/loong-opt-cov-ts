...
# %bb.9:                                # %scalar.ph
	...
	ld.w	$a3, $a2, 200
	ffint.s.w	$fa0, $fa0
	movgr2fr.w	$ft15, $zero
	fmadd.s	$fa0, $fa0, $fs2, $ft15
	sub.d	$a3, $a3, $a1
	ld.w	$a7, $a2, 304
	movgr2fr.w	$fa1, $a3
	ffint.s.w	$fa1, $fa1
	...
	movgr2fr.w	$fa1, $a3
	ffint.s.w	$fa1, $fa1
	vld	$vr22, $sp, 240                 # 16-byte Folded Reload
