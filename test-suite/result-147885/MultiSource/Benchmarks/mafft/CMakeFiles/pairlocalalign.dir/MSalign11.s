...
.LBB2_82:                               # %vector.body453
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB2_82
# %bb.83:                               # %middle.block459
	beq	$a2, $a3, .LBB2_86
.LBB2_84:                               # %scalar.ph448.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB2_85:                               # %scalar.ph448
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
