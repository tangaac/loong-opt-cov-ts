...
.LBB1_59:                               # %.lr.ph19.i
	...
	bge	$a6, $a4, .LBB1_127
.LBB1_60:                               # %scalar.ph295.preheader
	sub.d	$a1, $a0, $a3
...
.LBB1_125:                              # %vector.body270
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_125
# %bb.126:                              # %middle.block280
	bne	$a1, $a2, .LBB1_57
	b	.LBB1_59
.LBB1_127:                              # %vector.memcheck283
	alsl.d	$a4, $a0, $t7, 2
	alsl.d	$a5, $a0, $t3, 2
	addi.d	$a5, $a5, -4
	sltu	$a5, $s2, $a5
...
.LBB1_182:                              # %vector.body329
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_182
# %bb.183:                              # %middle.block335
	beq	$a3, $a2, .LBB1_186
.LBB1_184:                              # %scalar.ph324.preheader
	alsl.d	$a0, $a3, $a0, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_185:                              # %scalar.ph324
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $a2, -1
...
.LBB1_203:                              #   in Loop: Header=BB1_188 Depth=1
	move	$t3, $s1
	move	$t4, $s5
.LBB1_204:                              # %.lr.ph125.i.i.preheader385
                                        #   in Loop: Header=BB1_188 Depth=1
	move	$t5, $t3
	move	$t6, $t4
	.p2align	4, , 16
...
.LBB1_247:                              # %vector.body202
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_247
# %bb.248:                              # %middle.block207
	ld.d	$a3, $sp, 248                   # 8-byte Folded Reload
	beq	$a2, $a3, .LBB1_251
.LBB1_249:                              # %scalar.ph197.preheader
	alsl.d	$a3, $a2, $s5, 3
	ld.d	$a4, $sp, 248                   # 8-byte Folded Reload
	sub.d	$a2, $a4, $a2
	.p2align	4, , 16
.LBB1_250:                              # %scalar.ph197
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a3, 0
	add.d	$a4, $a4, $a0
	st.d	$a4, $a3, 0
...
.LBB1_255:                              # %vector.body215
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB1_255
# %bb.256:                              # %middle.block220
	beq	$a1, $s6, .LBB1_259
.LBB1_257:                              # %scalar.ph210.preheader
	alsl.d	$a2, $a1, $s3, 3
	sub.d	$a1, $s6, $a1
	.p2align	4, , 16
.LBB1_258:                              # %scalar.ph210
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
...
.LBB1_259:                              # %._crit_edge120
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_260:                              # %common.ret.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s3
