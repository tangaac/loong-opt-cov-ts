...
.LBB1_21:                               # %.lr.ph28.preheader401
	ld.d	$s2, $sp, 352                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 112                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 272                   # 8-byte Folded Reload
.LBB1_22:                               # %.lr.ph28.preheader401
	slli.d	$a2, $s0, 2
	alsl.d	$a1, $s0, $t4, 2
...
.LBB1_61:                               # %scalar.ph295.preheader
	sub.d	$a1, $a0, $a3
	ld.d	$a4, $sp, 416                   # 8-byte Folded Reload
	alsl.d	$a4, $a3, $a4, 2
	alsl.d	$a5, $a3, $t4, 2
...
# %bb.76:
	move	$a1, $zero
.LBB1_77:                               # %scalar.ph118.preheader
	slli.d	$a3, $a1, 2
	alsl.d	$a2, $a1, $t4, 2
	sub.d	$a1, $s4, $a1
	alsl.d	$a3, $a5, $a3, 2
...
# %bb.81:
	move	$a2, $zero
	move	$a6, $t8
.LBB1_82:                               # %scalar.ph147.preheader
	slli.d	$a4, $a2, 2
	alsl.d	$a3, $a2, $a6, 2
	sub.d	$a1, $a1, $a2
	alsl.d	$a2, $t1, $a4, 2
...
# %bb.85:
	move	$a0, $t0
.LBB1_86:                               # %scalar.ph178.preheader
	addi.d	$a3, $a0, 1
...
.LBB1_101:                              #   in Loop: Header=BB1_95 Depth=2
	...
	b	.LBB1_105
	.p2align	4, , 16
.LBB1_102:                              #   in Loop: Header=BB1_95 Depth=2
	fstx.s	$fa5, $s3, $a2
	stx.w	$s4, $fp, $a2
	beqz	$a6, .LBB1_100
.LBB1_103:                              #   in Loop: Header=BB1_95 Depth=2
	stx.w	$t1, $s8, $a2
	stx.w	$t2, $t7, $a2
	bne	$s0, $t5, .LBB1_101
.LBB1_104:                              #   in Loop: Header=BB1_95 Depth=2
	fldx.s	$fa3, $t6, $a2
	fadd.s	$fa3, $fa1, $fa3
	fstx.s	$fa3, $t6, $a2
	fldx.s	$fa3, $s3, $a2
	...
	fsel	$fa0, $fa2, $fa0, $fcc0
	bne	$s4, $s6, .LBB1_94
.LBB1_105:                              #   in Loop: Header=BB1_95 Depth=2
	fldx.s	$fa2, $ra, $a2
	fadd.s	$fa2, $fa0, $fa2
	fstx.s	$fa2, $ra, $a2
	b	.LBB1_94
	.p2align	4, , 16
.LBB1_106:                              # %._crit_edge79.loopexit
                                        #   in Loop: Header=BB1_91 Depth=1
	add.d	$a1, $a1, $a2
	...
	b	.LBB1_108
	.p2align	4, , 16
.LBB1_107:                              #   in Loop: Header=BB1_91 Depth=1
	addi.w	$a2, $zero, -1
	ld.d	$a7, $sp, 528                   # 8-byte Folded Reload
	ld.d	$t5, $sp, 504                   # 8-byte Folded Reload
.LBB1_108:                              # %._crit_edge79
                                        #   in Loop: Header=BB1_91 Depth=1
	fld.s	$fa0, $a1, 0
	...
	bne	$s0, $t5, .LBB1_110
# %bb.109:                              #   in Loop: Header=BB1_91 Depth=1
	slli.d	$a0, $a2, 2
	ld.d	$a1, $sp, 368                   # 8-byte Folded Reload
	fldx.s	$fa0, $a1, $a0
	fadd.s	$fa0, $fs0, $fa0
	fstx.s	$fa0, $a1, $a0
.LBB1_110:                              #   in Loop: Header=BB1_91 Depth=1
	bne	$s4, $s6, .LBB1_90
# %bb.111:                              #   in Loop: Header=BB1_91 Depth=1
	ld.d	$a0, $sp, 360                   # 8-byte Folded Reload
	fld.s	$fa0, $a0, 4
	move	$s7, $zero
	ori	$a0, $zero, 3
	blt	$t0, $a0, .LBB1_114
# %bb.112:                              # %.lr.ph86.preheader
                                        #   in Loop: Header=BB1_91 Depth=1
	ori	$a0, $zero, 2
...
# %bb.116:                              # %._crit_edge93
	...
	blez	$s7, .LBB1_120
# %bb.117:                              #   in Loop: Header=BB1_91 Depth=1
	slli.d	$a1, $a3, 2
	...
	move	$a1, $a3
	bcnez	$fcc1, .LBB1_119
# %bb.118:                              #   in Loop: Header=BB1_91 Depth=1
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	ldx.w	$a1, $a1, $a0
	fmov.s	$fa0, $fa1
.LBB1_119:                              #   in Loop: Header=BB1_91 Depth=1
	ld.d	$a2, $sp, 408                   # 8-byte Folded Reload
	fldx.s	$fa1, $a2, $a0
	fcmp.cule.s	$fcc1, $fa1, $fa0
	bceqz	$fcc1, .LBB1_89
	b	.LBB1_121
.LBB1_120:                              #   in Loop: Header=BB1_91 Depth=1
	move	$a1, $a3
	ld.d	$a2, $sp, 408                   # 8-byte Folded Reload
	fldx.s	$fa1, $a2, $a0
	fcmp.cule.s	$fcc1, $fa1, $fa0
...
.LBB1_126:                              # %vector.body270
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_126
# %bb.127:                              # %middle.block280
	bne	$a1, $a2, .LBB1_57
	b	.LBB1_59
.LBB1_128:                              # %vector.memcheck283
	alsl.d	$a4, $a0, $t4, 2
	alsl.d	$a5, $a0, $t3, 2
	addi.d	$a5, $a5, -4
	sltu	$a5, $s3, $a5
...
.LBB1_131:                              # %vector.body300
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB1_131
# %bb.132:                              # %middle.block308
	ld.d	$a7, $sp, 440                   # 8-byte Folded Reload
	bne	$a1, $a4, .LBB1_61
	b	.LBB1_63
.LBB1_133:                              # %vector.memcheck27
	addi.d	$a2, $s2, 4
	alsl.d	$a3, $a0, $s2, 2
	ld.d	$t1, $sp, 424                   # 8-byte Folded Reload
	addi.d	$a4, $t1, 4
...
.LBB1_136:                              # %vector.body39
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_136
# %bb.137:                              # %middle.block46
	bne	$a1, $a2, .LBB1_22
	b	.LBB1_24
.LBB1_138:                              # %vector.memcheck49
	addi.d	$a4, $s3, 4
	addi.d	$a5, $t5, 4
	sltu	$a5, $a4, $a5
	sltu	$a6, $t5, $a2
...
.LBB1_141:                              # %vector.body66
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB1_141
# %bb.142:                              # %middle.block76
	bne	$a1, $a4, .LBB1_25
	b	.LBB1_27
.LBB1_143:                              # %vector.memcheck79
	alsl.d	$a4, $a0, $t3, 2
	addi.d	$a2, $a2, -4
	sltu	$a2, $fp, $a2
	sltu	$a5, $s3, $a4
...
.LBB1_158:                              # %vector.body240
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_158
# %bb.159:                              # %middle.block250
	bne	$a2, $a3, .LBB1_53
	b	.LBB1_55
.LBB1_160:                              # %vector.memcheck107
	alsl.d	$a2, $s4, $t4, 2
	add.d	$a1, $a5, $s4
	slli.d	$a1, $a1, 2
	addi.d	$a3, $a1, 4
...
.LBB1_163:                              # %vector.body123
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_163
# %bb.164:                              # %middle.block132
	bne	$a1, $s4, .LBB1_77
	b	.LBB1_79
.LBB1_165:                              # %vector.memcheck135
	move	$a6, $t8
	alsl.d	$a3, $a1, $t8, 2
	add.d	$a2, $t1, $t0
	alsl.d	$a2, $a2, $t7, 2
...
.LBB1_168:                              # %vector.body152
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_168
# %bb.169:                              # %middle.block161
	bne	$a2, $a1, .LBB1_82
	b	.LBB1_84
.LBB1_170:                              # %vector.memcheck164
	move	$t3, $a7
...
.LBB1_173:                              # %vector.body185
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB1_173
# %bb.174:                              # %middle.block194
	ld.d	$t0, $sp, 440                   # 8-byte Folded Reload
	move	$a7, $t3
	bne	$a3, $a4, .LBB1_86
	b	.LBB1_88
.LBB1_175:                              # %vector.ph313
...
.LBB1_176:                              # %vector.body316
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_176
# %bb.177:                              # %middle.block321
	beq	$a2, $a0, .LBB1_180
.LBB1_178:                              # %.lr.ph.i.i.preheader
	ld.d	$a3, $sp, 512                   # 8-byte Folded Reload
	alsl.d	$a3, $a2, $a3, 3
	sub.d	$a0, $a0, $a2
	addi.d	$a2, $a2, 1
...
.LBB1_183:                              # %vector.body329
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_183
# %bb.184:                              # %middle.block335
	beq	$a3, $a2, .LBB1_187
.LBB1_185:                              # %scalar.ph324.preheader
	alsl.d	$a0, $a3, $a0, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_186:                              # %scalar.ph324
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $a2, -1
...
# %bb.190:                              #   in Loop: Header=BB1_189 Depth=1
	beqz	$a7, .LBB1_203
# %bb.191:                              #   in Loop: Header=BB1_189 Depth=1
	sub.w	$a5, $s7, $a7
	b	.LBB1_204
	.p2align	4, , 16
.LBB1_192:                              #   in Loop: Header=BB1_189 Depth=1
	addi.w	$a5, $s7, -1
	nor	$t0, $a5, $zero
	add.w	$t1, $s7, $t0
	bnez	$t1, .LBB1_205
...
.LBB1_193:                              # %._crit_edge126.i.i
                                        #   in Loop: Header=BB1_189 Depth=1
	beq	$a7, $a1, .LBB1_214
...
# %bb.196:                              # %vector.ph344
	...
	vori.b	$vr4, $vr0, 0
	.p2align	4, , 16
.LBB1_197:                              # %vector.body347
                                        #   Parent Loop BB1_189 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vstelm.w	$vr1, $a6, 0, 0
	vstelm.w	$vr1, $a6, -4, 0
	vstelm.w	$vr2, $t5, 0, 0
...
# %bb.198:                              # %middle.block354
	...
	b	.LBB1_202
	.p2align	4, , 16
.LBB1_199:                              #   in Loop: Header=BB1_189 Depth=1
	move	$t2, $t3
	move	$t0, $s1
	move	$t1, $s5
.LBB1_200:                              # %.lr.ph134.i.i.preheader
                                        #   in Loop: Header=BB1_189 Depth=1
	add.d	$a6, $a6, $t2
	.p2align	4, , 16
.LBB1_201:                              # %.lr.ph134.i.i
                                        #   Parent Loop BB1_189 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a2, $t1, -1
	addi.d	$t1, $t1, -1
	...
	addi.d	$t0, $t0, -1
	bnez	$t2, .LBB1_201
.LBB1_202:                              # %._crit_edge135.i.i
                                        #   in Loop: Header=BB1_189 Depth=1
	bgtz	$s7, .LBB1_215
	b	.LBB1_218
	.p2align	4, , 16
.LBB1_203:                              #   in Loop: Header=BB1_189 Depth=1
	addi.w	$a5, $s7, -1
.LBB1_204:                              #   in Loop: Header=BB1_189 Depth=1
	move	$a7, $a1
	nor	$t0, $a5, $zero
	add.w	$t1, $s7, $t0
	beqz	$t1, .LBB1_193
.LBB1_205:                              # %.lr.ph125.i.i.preheader
                                        #   in Loop: Header=BB1_189 Depth=1
	bltu	$t1, $a4, .LBB1_210
# %bb.206:                              # %.lr.ph125.i.i.preheader
                                        #   in Loop: Header=BB1_189 Depth=1
	sub.d	$t2, $s5, $s1
	bltu	$t2, $a4, .LBB1_210
# %bb.207:                              # %vector.ph365
...
.LBB1_208:                              # %vector.body369
	...
	addi.d	$t7, $t7, -16
	bnez	$t8, .LBB1_208
# %bb.209:                              # %middle.block376
                                        #   in Loop: Header=BB1_189 Depth=1
	bne	$t5, $t4, .LBB1_211
	b	.LBB1_213
	.p2align	4, , 16
.LBB1_210:                              #   in Loop: Header=BB1_189 Depth=1
	move	$t2, $s1
	move	$t3, $s5
.LBB1_211:                              # %.lr.ph125.i.i.preheader385
                                        #   in Loop: Header=BB1_189 Depth=1
	move	$t4, $t2
	move	$t5, $t3
	.p2align	4, , 16
.LBB1_212:                              # %.lr.ph125.i.i
                                        #   Parent Loop BB1_189 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$t3, $t5, -1
	st.b	$a0, $t5, -1
	...
	move	$t5, $t3
	bnez	$t1, .LBB1_212
.LBB1_213:                              # %._crit_edge126.loopexit.i.i
                                        #   in Loop: Header=BB1_189 Depth=1
	add.d	$a6, $s7, $a6
	add.d	$a6, $t0, $a6
	move	$s5, $t3
	move	$s1, $t2
	bne	$a7, $a1, .LBB1_194
.LBB1_214:                              #   in Loop: Header=BB1_189 Depth=1
	move	$t1, $s5
	move	$t0, $s1
	blez	$s7, .LBB1_218
.LBB1_215:                              # %._crit_edge135.i.i
                                        #   in Loop: Header=BB1_189 Depth=1
	blez	$ra, .LBB1_218
# %bb.216:                              #   in Loop: Header=BB1_189 Depth=1
	add.w	$ra, $a7, $ra
	addi.d	$s5, $t1, -1
	st.b	$a0, $t1, -1
	addi.d	$s1, $t0, -1
...
.LBB1_249:                              # %vector.body202
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB1_249
# %bb.250:                              # %middle.block207
	ld.d	$a2, $sp, 336                   # 8-byte Folded Reload
	beq	$a1, $a2, .LBB1_253
.LBB1_251:                              # %scalar.ph197.preheader
	alsl.d	$a2, $a1, $s7, 3
	ld.d	$a3, $sp, 336                   # 8-byte Folded Reload
	sub.d	$a1, $a3, $a1
	.p2align	4, , 16
.LBB1_252:                              # %scalar.ph197
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
...
.LBB1_257:                              # %vector.body215
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB1_257
# %bb.258:                              # %middle.block220
	beq	$a1, $s4, .LBB1_261
.LBB1_259:                              # %scalar.ph210.preheader
	alsl.d	$a2, $a1, $fp, 3
	sub.d	$a1, $s4, $a1
	.p2align	4, , 16
.LBB1_260:                              # %scalar.ph210
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
...
.LBB1_261:                              # %._crit_edge120
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_262:                              # %common.ret.sink.split
	move	$a0, $s7
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $fp
