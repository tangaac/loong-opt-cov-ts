...
# %bb.254:                              # %vector.ph1275
	...
	sub.d	$t8, $fp, $s0
	sub.d	$t6, $s5, $s0
	pcalau12i	$t7, %pc_hi20(.LCPI3_7)
	vld	$vr3, $t7, %pc_lo12(.LCPI3_7)
	sub.d	$t7, $s3, $s0
...
.LBB3_257:                              #   in Loop: Header=BB3_242 Depth=1
	move	$t8, $s5
	move	$fp, $s3
.LBB3_258:                              # %.lr.ph19.i.preheader1317
                                        #   in Loop: Header=BB3_242 Depth=1
	move	$s0, $t8
	move	$s1, $fp
	.p2align	4, , 16
...
# %bb.0:
	...
	ld.w	$s6, $t1, %pc_lo12(Q__align_gapmap.orlgth1)
	ld.w	$t0, $t0, 0
	st.d	$t0, $sp, 56                    # 8-byte Folded Spill
...
.LBB6_77:                               # %vector.memcheck859
	...
	move	$t2, $zero
	bnez	$t4, .LBB6_283
# %bb.78:                               # %vector.memcheck859
	alsl.d	$s0, $t1, $a5, 2
	sltu	$t4, $a2, $s0
	sltu	$t5, $a5, $s2
	and	$t4, $t4, $t5
	bnez	$t4, .LBB6_283
# %bb.79:                               # %vector.memcheck859
	alsl.d	$t5, $t1, $a6, 2
	sltu	$t4, $a2, $t5
	sltu	$t6, $a6, $s2
	and	$t4, $t4, $t6
...
.LBB6_147:                              # %vector.body1127
	...
	addi.d	$a7, $a7, 32
	bnez	$t1, .LBB6_147
# %bb.148:                              # %middle.block1133
	beq	$a4, $a6, .LBB6_151
.LBB6_149:                              # %scalar.ph1120.preheader
	ld.d	$a4, $sp, 256                   # 8-byte Folded Reload
...
.LBB6_178:                              # %vector.body1145
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_178
# %bb.179:                              # %middle.block1152
	beq	$a2, $a4, .LBB6_182
.LBB6_180:                              # %scalar.ph1136.preheader
	ld.d	$a2, $sp, 312                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t5, 2
...
.LBB6_185:                              # %vector.body1160
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB6_185
# %bb.186:                              # %middle.block1165
	beq	$a3, $a5, .LBB6_189
.LBB6_187:                              # %scalar.ph1155.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_188:                              # %scalar.ph1155
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
.LBB6_209:                              # %vector.body1066
	...
	addi.d	$t1, $t1, 16
	bnez	$t3, .LBB6_209
# %bb.210:                              # %middle.block1078
	bne	$a7, $t2, .LBB6_122
	b	.LBB6_124
.LBB6_211:                              # %vector.memcheck1081
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
...
.LBB6_215:                              # %vector.body1104
	...
	addi.d	$t0, $t0, 16
	bnez	$t2, .LBB6_215
# %bb.216:                              # %middle.block1116
	bne	$a6, $t1, .LBB6_126
	b	.LBB6_128
.LBB6_217:                              # %vector.ph1170
...
.LBB6_226:                              # %vector.body1188
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_226
# %bb.227:                              # %middle.block1194
	beq	$a3, $a4, .LBB6_230
.LBB6_228:                              # %scalar.ph1183.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_229:                              # %scalar.ph1183
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
