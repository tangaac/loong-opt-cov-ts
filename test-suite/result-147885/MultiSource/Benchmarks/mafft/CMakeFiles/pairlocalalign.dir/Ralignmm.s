...
.LBB2_25:
	...
	ld.d	$a1, $sp, 392                   # 8-byte Folded Reload
	ld.d	$s1, $a1, %pc_lo12(R__align.cpmx1)
	ld.d	$a1, $sp, 344                   # 8-byte Folded Reload
...
.LBB2_50:                               # %vector.body777
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_50
# %bb.51:                               # %middle.block782
	beq	$a2, $a4, .LBB2_54
.LBB2_52:                               # %scalar.ph772.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_53:                               # %scalar.ph772
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
# %bb.58:                               # %middle.block799
	beq	$a2, $a4, .LBB2_61
.LBB2_59:                               # %scalar.ph785.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t7, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_60:                               # %scalar.ph785
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB2_70:                               # %vector.body810
	...
	addi.d	$a5, $a5, 32
	bnez	$a7, .LBB2_70
# %bb.71:                               # %middle.block816
	move	$a6, $fp
	beq	$a2, $a4, .LBB2_74
.LBB2_72:                               # %scalar.ph803.preheader
...
# %bb.80:                               # %.lr.ph.preheader.i508
	...
	ori	$a1, $zero, 7
	bltu	$a0, $a1, .LBB2_83
# %bb.81:                               # %vector.memcheck819
                                        #   in Loop: Header=BB2_79 Depth=1
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	add.d	$a0, $a3, $a1
	bgeu	$a5, $a0, .LBB2_107
# %bb.82:                               # %vector.memcheck819
                                        #   in Loop: Header=BB2_79 Depth=1
	add.d	$a0, $a5, $a1
	bgeu	$a3, $a0, .LBB2_107
...
.LBB2_115:                              # %vector.body856
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_115
# %bb.116:                              # %middle.block863
	beq	$a2, $a4, .LBB2_119
.LBB2_117:                              # %scalar.ph847.preheader
	sub.w	$a2, $s6, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB2_122:                              # %vector.body871
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB2_122
# %bb.123:                              # %middle.block876
	beq	$a3, $a5, .LBB2_126
.LBB2_124:                              # %scalar.ph866.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB2_125:                              # %scalar.ph866
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_172:                              # %vector.body974
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_172
# %bb.173:                              # %middle.block980
	beq	$a4, $a5, .LBB2_176
.LBB2_174:                              # %scalar.ph969.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_175:                              # %scalar.ph969
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB2_199:                              #   in Loop: Header=BB2_178 Depth=1
	move	$t5, $s5
	move	$t6, $s8
.LBB2_200:                              # %.lr.ph19.i538.preheader1036
                                        #   in Loop: Header=BB2_178 Depth=1
	move	$t7, $t5
	move	$a0, $t6
	.p2align	4, , 16
...
.LBB2_214:                              # %vector.body899
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB2_214
# %bb.215:                              # %middle.block905
	beq	$a5, $a6, .LBB2_218
.LBB2_216:                              # %scalar.ph894.preheader
	alsl.d	$a4, $a6, $a4, 2
	nor	$a7, $a6, $zero
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB2_217:                              # %scalar.ph894
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a7, $a4, 0
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, -1
...
.LBB2_241:                              #   in Loop: Header=BB2_220 Depth=1
	move	$s0, $s5
	move	$s1, $s8
.LBB2_242:                              # %.lr.ph19.i.preheader1047
                                        #   in Loop: Header=BB2_220 Depth=1
	move	$s2, $s0
	move	$a0, $s1
	.p2align	4, , 16
