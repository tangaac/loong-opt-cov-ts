...
.LBB0_2:
	...
	ld.w	$s3, $a7, %pc_lo12(Aalign.orlgth2)
...
# %bb.4:
	...
	blt	$s1, $a0, .LBB0_12
.LBB0_5:                                # %.lr.ph
	ld.d	$a1, $s7, %pc_lo12(Aalign.mseq)
...
.LBB0_20:
	...
	ld.d	$s8, $a0, %pc_lo12(Aalign.intwork)
	ori	$a7, $zero, 1
	...
	ld.d	$s3, $a0, %pc_lo12(Aalign.currentw)
	ori	$a7, $zero, 1
	move	$a0, $s3
	move	$a1, $s6
	move	$a2, $s5
...
.LBB0_31:                               # %vector.body311
	...
	addi.d	$a5, $a5, 8
	bnez	$a6, .LBB0_31
# %bb.32:                               # %middle.block315
	beq	$a3, $a4, .LBB0_36
.LBB0_33:                               # %scalar.ph306.preheader
	alsl.d	$a3, $a1, $s3, 2
	sub.d	$a1, $a2, $a1
	vldi	$vr1, -928
	.p2align	4, , 16
.LBB0_34:                               # %scalar.ph306
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa2, $a3, 0
	fcvt.d.s	$fa2, $fa2
	fmadd.d	$fa2, $fa0, $fa1, $fa2
...
.LBB0_36:                               # %.lr.ph191
	...
	ld.d	$a2, $a2, %pc_lo12(Aalign.m)
	ld.d	$a3, $sp, 56                    # 8-byte Folded Reload
	ld.d	$a3, $a3, %pc_lo12(Aalign.mp)
...
.LBB0_77:                               # %vector.body336
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_77
# %bb.78:                               # %middle.block342
	beq	$a2, $a3, .LBB0_81
.LBB0_79:                               # %scalar.ph331.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_80:                               # %scalar.ph331
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB0_132:
	...
	st.w	$s3, $a7, %pc_lo12(Aalign.orlgth2)
	ori	$a0, $zero, 1
	bge	$s1, $a0, .LBB0_5
	b	.LBB0_12
.LBB0_133:
