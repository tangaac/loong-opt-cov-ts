...
# %bb.6:
	...
	ld.w	$s3, $a0, %pc_lo12(A__align.orlgth2)
.LBB3_7:
	...
	st.w	$s4, $s2, %pc_lo12(A__align.orlgth1)
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	st.w	$s3, $a0, %pc_lo12(A__align.orlgth2)
...
.LBB3_38:                               # %._crit_edge360
	...
	ld.d	$a0, $a0, %pc_lo12(A__align.initverticalw)
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ld.d	$s6, $a1, %pc_lo12(A__align.cpmx2)
	ld.d	$a1, $sp, 296                   # 8-byte Folded Reload
	ld.d	$fp, $a1, %pc_lo12(A__align.cpmx1)
	ld.d	$a1, $sp, 256                   # 8-byte Folded Reload
...
.LBB3_45:                               # %.critedge
	...
	move	$s1, $s4
	b	.LBB3_60
.LBB3_46:                               # %imp_match_out_vead.exit.thread
...
.LBB3_54:                               # %vector.body532
	...
	addi.d	$t1, $t1, 16
	bnez	$a6, .LBB3_54
# %bb.55:                               # %middle.block537
	beq	$a1, $a3, .LBB3_38
	b	.LBB3_36
.LBB3_56:                               # %vector.ph548
...
.LBB3_59:                               # %.lr.ph.i324
	...
	move	$a2, $a3
	bnez	$a0, .LBB3_59
.LBB3_60:                               # %imp_match_out_vead.exit
	pcalau12i	$a0, %got_pc_hi20(outgap)
	ld.d	$a0, $a0, %got_pc_lo12(outgap)
	ld.w	$a0, $a0, 0
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB3_69
.LBB3_61:                               # %.preheader342
	blez	$s1, .LBB3_65
# %bb.62:                               # %.lr.ph369
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(A__align.ogcp1)
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB3_210
.LBB3_63:                               # %scalar.ph608.preheader
...
# %bb.66:                               # %.lr.ph372
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB3_215
.LBB3_67:                               # %scalar.ph638.preheader
	alsl.d	$a4, $a3, $s5, 2
	alsl.d	$a1, $a3, $a1, 2
	addi.d	$a1, $a1, -4
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB3_68:                               # %scalar.ph638
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a4, 0
...
.LBB3_72:                               # %vector.body572
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_72
# %bb.73:                               # %middle.block577
	beq	$a2, $a4, .LBB3_76
.LBB3_74:                               # %scalar.ph565.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_75:                               # %scalar.ph565
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB3_79:                               # %vector.body587
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_79
# %bb.80:                               # %middle.block594
	beq	$a2, $a4, .LBB3_83
.LBB3_81:                               # %scalar.ph580.preheader
	mul.d	$a2, $a0, $a3
	ld.d	$a4, $sp, 296                   # 8-byte Folded Reload
	alsl.d	$a4, $a3, $a4, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_84:                               # %.lr.ph380
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a7, .LBB3_135
.LBB3_85:                               # %scalar.ph668.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a3, $a4, $a3, 2
	alsl.d	$a5, $a4, $s5, 2
	addi.d	$a5, $a5, -4
...
# %bb.94:                               # %.lr.ph.preheader.i326
	...
	ori	$a2, $zero, 7
	bltu	$a0, $a2, .LBB3_97
# %bb.95:                               # %vector.memcheck684
                                        #   in Loop: Header=BB3_93 Depth=1
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
	add.d	$a0, $a4, $a2
	bgeu	$s3, $a0, .LBB3_108
# %bb.96:                               # %vector.memcheck684
                                        #   in Loop: Header=BB3_93 Depth=1
	add.d	$a0, $s3, $a2
	bgeu	$a4, $a0, .LBB3_108
...
.LBB3_98:                               # %.lr.ph.i327
	...
	move	$a2, $a4
	bnez	$a3, .LBB3_98
.LBB3_99:                               # %imp_match_out_vead.exit332
                                        #   in Loop: Header=BB3_93 Depth=1
	slli.d	$a0, $s7, 2
	ld.d	$a2, $sp, 296                   # 8-byte Folded Reload
	fldx.s	$fa0, $a2, $a0
...
.LBB3_111:
	...
	bnez	$a1, .LBB3_127
	b	.LBB3_113
.LBB3_112:                              # %._crit_edge406.loopexit
...
.LBB3_116:                              # %vector.body721
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_116
# %bb.117:                              # %middle.block728
	beq	$a2, $a4, .LBB3_120
.LBB3_118:                              # %scalar.ph712.preheader
	sub.w	$a2, $t3, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_123:                              # %vector.body736
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB3_123
# %bb.124:                              # %middle.block741
	beq	$a3, $a5, .LBB3_127
.LBB3_125:                              # %scalar.ph731.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_126:                              # %scalar.ph731
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_138:                              # %vector.body673
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB3_138
# %bb.139:                              # %middle.block681
	bne	$a5, $a6, .LBB3_85
	b	.LBB3_87
.LBB3_140:                              # %.preheader2.i
	blez	$a2, .LBB3_145
# %bb.141:                              # %.lr.ph7.i
	slli.d	$a1, $s7, 32
	srai.d	$a1, $a1, 29
...
.LBB3_149:                              # %vector.body749
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_149
# %bb.150:                              # %middle.block756
	beq	$a1, $a3, .LBB3_153
.LBB3_151:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $s8, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
...
.LBB3_157:                              # %vector.body764
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_157
# %bb.158:                              # %middle.block770
	beq	$a4, $a5, .LBB3_161
.LBB3_159:                              # %scalar.ph759.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_160:                              # %scalar.ph759
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_169:                              # %vector.body805
	...
	addi.d	$s5, $s5, -16
	bnez	$s8, .LBB3_169
# %bb.170:                              # %middle.block812
                                        #   in Loop: Header=BB3_163 Depth=1
	ld.d	$s8, $sp, 288                   # 8-byte Folded Reload
	bne	$s2, $s1, .LBB3_179
	b	.LBB3_181
	.p2align	4, , 16
.LBB3_171:                              #   in Loop: Header=BB3_163 Depth=1
	addi.d	$t0, $s7, -1
	nor	$t7, $t0, $zero
	add.w	$t8, $s7, $t7
	bnez	$t8, .LBB3_166
	.p2align	4, , 16
.LBB3_172:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_163 Depth=1
	beq	$t4, $a2, .LBB3_182
.LBB3_173:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_163 Depth=1
	addi.w	$t7, $zero, -9
	nor	$s0, $t4, $zero
	bltu	$t7, $t4, .LBB3_183
...
# %bb.175:                              # %vector.ph778
	...
	sub.d	$fp, $s0, $s1
	sub.d	$t7, $s5, $s1
	pcalau12i	$t8, %pc_hi20(.LCPI3_6)
	vld	$vr3, $t8, %pc_lo12(.LCPI3_6)
	sub.d	$t8, $s3, $s1
...
.LBB3_178:                              #   in Loop: Header=BB3_163 Depth=1
	move	$fp, $s5
	move	$s0, $s3
.LBB3_179:                              # %.lr.ph19.i.preheader819
                                        #   in Loop: Header=BB3_163 Depth=1
	move	$s1, $fp
	move	$s2, $s0
	.p2align	4, , 16
...
.LBB3_182:                              #   in Loop: Header=BB3_163 Depth=1
	...
	b	.LBB3_189
	.p2align	4, , 16
.LBB3_183:                              #   in Loop: Header=BB3_163 Depth=1
	move	$fp, $s0
	move	$t7, $s5
	move	$t8, $s3
...
.LBB3_187:                              # %._crit_edge30.i
	...
	addi.w	$fp, $a0, 0
	beq	$t2, $fp, .LBB3_189
# %bb.188:                              #   in Loop: Header=BB3_163 Depth=1
...
.LBB3_213:                              # %vector.body613
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB3_213
# %bb.214:                              # %middle.block623
	bne	$a4, $a5, .LBB3_63
	b	.LBB3_65
.LBB3_215:                              # %vector.memcheck626
	addi.d	$a5, $s5, 4
	alsl.d	$a6, $a2, $s5, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
...
# %bb.36:                               # %vector.ph24
	...
	sub.d	$t4, $t5, $t6
	sub.d	$t2, $s1, $t6
	pcalau12i	$t3, %pc_hi20(.LCPI5_2)
	vld	$vr3, $t3, %pc_lo12(.LCPI5_2)
	sub.d	$t3, $s3, $t6
...
# %bb.156:                              # %vector.ph702
	...
	sub.d	$t8, $fp, $s0
	sub.d	$t6, $s3, $s0
	pcalau12i	$t7, %pc_hi20(.LCPI6_6)
	vld	$vr3, $t7, %pc_lo12(.LCPI6_6)
	sub.d	$t7, $s5, $s0
	vinsgr2vr.w	$vr4, $t3, 0
	vinsgr2vr.w	$vr5, $zero, 0
	vshuf.w	$vr3, $vr5, $vr4
