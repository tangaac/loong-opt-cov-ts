...
# %bb.0:
	...
	ld.w	$a4, $s6, %pc_lo12(genG__align11.orlgth1)
	ld.w	$a3, $a3, 0
...
.LBB0_34:                               # %vector.body362
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_34
# %bb.35:                               # %middle.block368
	beq	$a3, $t1, .LBB0_39
.LBB0_36:                               # %.lr.ph260.preheader406
	alsl.d	$a3, $t0, $a4, 2
	sub.d	$a2, $a2, $t0
	.p2align	4, , 16
.LBB0_37:                               # %.lr.ph260
...
.LBB0_39:                               # %.lr.ph263
	...
	ori	$t3, $zero, 1
	bgeu	$t4, $t5, .LBB0_44
.LBB0_40:                               # %scalar.ph376.preheader
	alsl.d	$a3, $t3, $a3, 2
	alsl.d	$t0, $t3, $t0, 2
	alsl.d	$t1, $t3, $t1, 2
	alsl.d	$t2, $t3, $t2, 2
...
.LBB0_80:                               # %vector.body397
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB0_80
# %bb.81:                               # %middle.block400
	beq	$a3, $a4, .LBB0_84
.LBB0_82:                               # %scalar.ph392.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	addi.w	$a4, $zero, -1
