...
# %bb.22:                               # %.lr.ph
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a3, $a0, %pc_lo12(genL__align11.m)
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a4, $a0, %pc_lo12(genL__align11.mp)
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
...
.LBB0_31:                               #   Parent Loop BB0_29 Depth=1
	...
	pcalau12i	$t8, %got_pc_hi20(amino_dis)
	ld.d	$t8, $t8, %got_pc_lo12(amino_dis)
	ld.b	$s3, $t7, 0
	add.d	$t8, $t8, $a0
	slli.d	$s3, $s3, 2
	ldx.w	$t8, $t8, $s3
...
# %bb.58:                               # %middle.block377
	beq	$a3, $a4, .LBB0_61
.LBB0_59:                               # %scalar.ph369.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	.p2align	4, , 16
.LBB0_60:                               # %scalar.ph369
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s6, $a1, 0
	st.w	$s6, $a2, 0
	addi.d	$a3, $a3, -1
