...
.LBB4_35:
	move	$a3, $zero
.LBB4_36:                               # %scalar.ph630.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr1, -912
...
.LBB4_42:
	move	$a3, $zero
.LBB4_43:                               # %scalar.ph649.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr1, -912
...
# %bb.55:                               # %.lr.ph478
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB4_209
.LBB4_56:                               # %scalar.ph706.preheader
	ld.d	$a4, $sp, 256                   # 8-byte Folded Reload
	alsl.d	$a4, $a3, $a4, 2
	alsl.d	$a1, $a3, $a1, 2
	addi.d	$a1, $a1, -4
...
# %bb.59:                               # %.lr.ph481
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB4_214
.LBB4_60:                               # %scalar.ph736.preheader
	alsl.d	$a4, $a3, $s6, 2
	alsl.d	$a1, $a3, $a1, 2
	addi.d	$a1, $a1, -4
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB4_61:                               # %scalar.ph736
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a4, 0
...
.LBB4_65:                               # %vector.body671
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_65
# %bb.66:                               # %middle.block675
	beq	$a2, $a4, .LBB4_69
.LBB4_67:                               # %scalar.ph664.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB4_68:                               # %scalar.ph664
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB4_72:                               # %vector.body685
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_72
# %bb.73:                               # %middle.block692
	beq	$a2, $a4, .LBB4_76
.LBB4_74:                               # %scalar.ph678.preheader
	mul.d	$a2, $a0, $a3
	ld.d	$a4, $sp, 256                   # 8-byte Folded Reload
	alsl.d	$a4, $a3, $a4, 2
	sub.d	$a1, $a1, $a3
...
.LBB4_77:                               # %.lr.ph489
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a7, .LBB4_81
.LBB4_78:                               # %scalar.ph766.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a3, $a4, $a3, 2
	alsl.d	$a5, $a4, $s6, 2
	addi.d	$a5, $a5, -4
...
.LBB4_79:                               # %scalar.ph766
	...
	addi.d	$a5, $a5, 4
	bnez	$a1, .LBB4_79
.LBB4_80:                               # %._crit_edge490.loopexit
	ld.w	$t1, $t4, 0
	st.d	$zero, $sp, 224                 # 8-byte Folded Spill
	b	.LBB4_88
.LBB4_81:                               # %vector.memcheck754
	addi.d	$a7, $a2, 4
	alsl.d	$t0, $a1, $a2, 2
	alsl.d	$t1, $a1, $s6, 2
	addi.d	$t1, $t1, -4
