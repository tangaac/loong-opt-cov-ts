...
# %bb.14:                               #   in Loop: Header=BB2_13 Depth=4
	...
	add.w	$a1, $s0, $a1
	bge	$a1, $a0, .LBB2_19
.LBB2_15:                               #   in Loop: Header=BB2_13 Depth=4
	ld.d	$a0, $fp, 480
	ld.d	$a7, $a0, 8
	ld.d	$a2, $s6, 0
	slli.d	$a0, $s7, 3
	...
	ld.w	$a1, $s2, 52
	bge	$s3, $a1, .LBB2_12
# %bb.16:                               #   in Loop: Header=BB2_13 Depth=4
	add.w	$a0, $s7, $s3
	slli.d	$a0, $a0, 3
	ldx.d	$a0, $s1, $a0
	sub.w	$a1, $a1, $s3
...
.LBB2_18:                               # %.lr.ph99
	...
	b	.LBB2_12
	.p2align	4, , 16
.LBB2_19:                               #   in Loop: Header=BB2_13 Depth=4
	slli.d	$a0, $s7, 3
	ld.w	$a1, $s2, 52
	ldx.d	$a0, $s1, $a0
	slli.d	$a1, $a1, 7
...
.LBB2_29:
	...
	st.w	$s4, $s8, 20
	b	.LBB2_37
.LBB2_30:                               # %._crit_edge115.loopexit
	ld.d	$a1, $fp, 448
.LBB2_31:                               # %._crit_edge115
	ld.w	$a0, $s8, 16
	ld.w	$a2, $fp, 316
	addi.d	$a0, $a0, 1
	ori	$a3, $zero, 2
