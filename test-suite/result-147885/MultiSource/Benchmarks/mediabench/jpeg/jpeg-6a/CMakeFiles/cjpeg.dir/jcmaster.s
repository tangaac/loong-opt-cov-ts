...
# %bb.81:                               # %.sink.split284.i
	...
	b	.LBB0_79
	.p2align	4, , 16
.LBB0_82:                               #   in Loop: Header=BB0_74 Depth=2
	ld.d	$a0, $fp, 0
	st.w	$s7, $a0, 44
	ld.d	$a1, $fp, 0
	ld.d	$a1, $a1, 0
...
.LBB1_29:                               # %vector.body141
	...
	addi.d	$a7, $a7, 16
	bnez	$t0, .LBB1_29
# %bb.30:                               # %middle.block146
	beq	$a5, $a4, .LBB1_33
.LBB1_31:                               # %scalar.ph136.preheader
	sub.d	$a4, $a4, $a5
	alsl.d	$a6, $a5, $fp, 3
	addi.d	$a6, $a6, 320
	alsl.d	$a3, $a5, $a3, 2
...
.LBB1_35:                               # %vector.body103
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_35
# %bb.36:                               # %middle.block106
	beq	$a2, $a0, .LBB1_39
.LBB1_37:                               # %scalar.ph98.preheader
	sub.d	$a0, $a0, $a2
	alsl.d	$a3, $a2, $fp, 3
	addi.d	$a3, $a3, 320
	alsl.d	$a2, $a2, $a2, 1
...
.LBB1_56:                               # %vector.body154
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_56
# %bb.57:                               # %middle.block160
	beq	$a2, $a0, .LBB1_60
.LBB1_58:                               # %scalar.ph149.preheader
	sub.d	$a0, $a0, $a2
	alsl.d	$a3, $a2, $fp, 3
	addi.d	$a3, $a3, 320
	alsl.d	$a2, $a2, $a2, 1
...
.LBB1_66:                               # %vector.body114
	...
	addi.d	$a7, $a7, 16
	bnez	$t0, .LBB1_66
# %bb.67:                               # %middle.block119
	beq	$a5, $a4, .LBB1_70
.LBB1_68:                               # %scalar.ph109.preheader
	sub.d	$a4, $a4, $a5
	alsl.d	$a6, $a5, $fp, 3
	addi.d	$a6, $a6, 320
	alsl.d	$a3, $a5, $a3, 2
...
.LBB1_72:                               # %vector.body127
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_72
# %bb.73:                               # %middle.block133
	beq	$a2, $a0, .LBB1_76
.LBB1_74:                               # %scalar.ph122.preheader
	sub.d	$a0, $a0, $a2
	alsl.d	$a3, $a2, $fp, 3
	addi.d	$a3, $a3, 320
	alsl.d	$a2, $a2, $a2, 1
