...
.LBB1_4:
	...
	vrepli.h	$vr11, 255
	move	$a1, $zero
	pcalau12i	$a2, %pc_hi20(jpeg_set_linear_quality.std_luminance_quant_tbl)
	addi.d	$a2, $a2, %pc_lo12(jpeg_set_linear_quality.std_luminance_quant_tbl)
	ori	$a3, $s3, 1803
	lu32i.d	$a3, 461373
	lu52i.d	$a3, $a3, -1475
	vreplgr2vr.d	$vr1, $a3
...
.LBB1_6:                                # %vector.body
	...
	bne	$a1, $a3, .LBB1_6
	b	.LBB1_9
.LBB1_7:                                # %vector.body33.preheader
	ori	$a3, $zero, 128
	.p2align	4, , 16
.LBB1_8:                                # %vector.body33
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr3, $a2, 0
	vilvl.w	$vr4, $vr9, $vr3
	vilvh.w	$vr3, $vr9, $vr3
...
# %bb.10:
	...
	vst	$vr11, $sp, 0                   # 16-byte Folded Spill
	jirl	$ra, $a1, 0
...
.LBB1_13:
	vreplgr2vr.d	$vr0, $s1
	move	$a1, $zero
	pcalau12i	$a2, %pc_hi20(jpeg_set_linear_quality.std_chrominance_quant_tbl)
	addi.d	$a2, $a2, %pc_lo12(jpeg_set_linear_quality.std_chrominance_quant_tbl)
	ori	$a3, $s3, 1803
	lu32i.d	$a3, 461373
	lu52i.d	$a3, $a3, -1475
	vreplgr2vr.d	$vr1, $a3
...
.LBB1_15:                               # %vector.body43
	...
	bne	$a1, $a3, .LBB1_15
	b	.LBB1_18
.LBB1_16:                               # %vector.body53.preheader
	ori	$a3, $zero, 128
	.p2align	4, , 16
.LBB1_17:                               # %vector.body53
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr3, $a2, 0
	vilvl.w	$vr4, $vr9, $vr3
	vilvh.w	$vr3, $vr9, $vr3
...
.LBB7_33:
	move	$a5, $zero
	move	$a4, $a3
.LBB7_34:                               # %.lr.ph.i49.preheader344
	vld	$vr0, $a6, %pc_lo12(.LCPI7_3)
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB7_35:                               # %.lr.ph.i49
...
.LBB7_40:
	move	$a3, $zero
	move	$a5, $a4
.LBB7_41:                               # %.lr.ph.i53.preheader342
	vld	$vr0, $a6, %pc_lo12(.LCPI7_4)
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB7_42:                               # %.lr.ph.i53
...
.LBB7_45:                               # %vector.body231
	...
	addi.d	$a7, $a7, 2
	bnez	$t1, .LBB7_45
# %bb.46:                               # %middle.block238
	bne	$a0, $a4, .LBB7_48
	b	.LBB7_50
.LBB7_47:
	move	$a4, $zero
	move	$a3, $a5
.LBB7_48:                               # %.lr.ph.i60.preheader339
	vld	$vr0, $a6, %pc_lo12(.LCPI7_5)
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB7_49:                               # %.lr.ph.i60
...
.LBB7_54:                               # %vector.body246
	...
	addi.d	$a6, $a6, 2
	bnez	$t0, .LBB7_54
# %bb.55:                               # %middle.block253
	beq	$a5, $s0, .LBB7_58
# %bb.56:                               # %.lr.ph.i.i65.preheader353
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB7_57:                               # %.lr.ph.i.i65
                                        # =>This Inner Loop Header: Depth=1
...
.LBB7_60:                               # %vector.body275
	...
	addi.d	$a5, $a5, 2
	bnez	$a7, .LBB7_60
# %bb.61:                               # %middle.block282
	bne	$a0, $a2, .LBB7_69
	b	.LBB7_71
.LBB7_62:                               # %vector.ph259
...
.LBB7_63:                               # %vector.body262
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB7_63
# %bb.64:                               # %middle.block267
	beq	$a3, $s1, .LBB7_67
.LBB7_65:                               # %scalar.ph257.preheader
	sub.d	$a5, $s1, $a3
	alsl.d	$a6, $a3, $a4, 2
	addi.d	$a6, $a6, 40
	.p2align	4, , 16
.LBB7_66:                               # %scalar.ph257
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a6, 0
	addi.d	$a5, $a5, -1
	addi.d	$a3, $a3, 1
...
.LBB7_68:
	move	$a2, $zero
	move	$a1, $a4
.LBB7_69:                               # %.lr.ph.i79.preheader337
	vld	$vr0, $a3, %pc_lo12(.LCPI7_7)
	ori	$a0, $zero, 1
	.p2align	4, , 16
.LBB7_70:                               # %.lr.ph.i79
