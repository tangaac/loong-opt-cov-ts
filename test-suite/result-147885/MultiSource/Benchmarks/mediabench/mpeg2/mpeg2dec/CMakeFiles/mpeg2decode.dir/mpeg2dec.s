...
.LBB0_53:
	...
	jirl	$ra, $ra, 0
.LBB0_54:                               # %Initialize_Decoder.exit.preheader
	move	$fp, $zero
	...
	.p2align	4, , 16
.LBB0_55:                               # %Initialize_Decoder.exit
...
.LBB0_68:                               #   in Loop: Header=BB0_55 Depth=1
	...
	ori	$a1, $zero, 2
	bne	$s5, $a1, .LBB0_91
# %bb.69:                               # %.split.us.preheader.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
...
# %bb.83:                               # %.split.us.2.i.i.i
	...
	st.d	$a0, $s5, 16
	beqz	$a0, .LBB0_134
# %bb.84:                               #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
...
# %bb.85:                               #   in Loop: Header=BB0_55 Depth=1
	...
	st.d	$a0, $s6, 16
	beqz	$a0, .LBB0_136
# %bb.86:                               #   in Loop: Header=BB0_55 Depth=1
	beqz	$s8, .LBB0_88
# %bb.87:                               #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
.LBB0_91:                               # %.split.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	beqz	$s8, .LBB0_104
# %bb.92:                               # %.split.split.preheader.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	ld.d	$s5, $sp, 184                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_134
# %bb.93:                               #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	st.d	$a0, $a1, 0
	beqz	$a0, .LBB0_135
# %bb.94:                               #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s6, 0
...
# %bb.98:                               #   in Loop: Header=BB0_55 Depth=1
	...
	st.d	$a0, $s6, 8
	beqz	$a0, .LBB0_136
# %bb.99:                               #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s1, 8
	beqz	$a0, .LBB0_137
# %bb.100:                              # %.split.split.2.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, 16
	beqz	$a0, .LBB0_134
# %bb.101:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	st.d	$a0, $a1, 16
	beqz	$a0, .LBB0_135
# %bb.102:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s6, 16
	beqz	$a0, .LBB0_136
# %bb.103:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s1, 16
	bnez	$a0, .LBB0_113
	b	.LBB0_137
.LBB0_104:                              # %.split.split.us.preheader.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	ld.d	$s5, $sp, 184                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_134
# %bb.105:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	st.d	$a0, $a1, 0
	beqz	$a0, .LBB0_135
# %bb.106:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s6, 0
	beqz	$a0, .LBB0_136
# %bb.107:                              # %.split.split.us.1.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, 8
	beqz	$a0, .LBB0_134
# %bb.108:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	st.d	$a0, $a1, 8
	beqz	$a0, .LBB0_135
# %bb.109:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s6, 8
	beqz	$a0, .LBB0_136
# %bb.110:                              # %.split.split.us.2.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s5, 16
	beqz	$a0, .LBB0_134
# %bb.111:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	st.d	$a0, $a1, 16
	beqz	$a0, .LBB0_135
# %bb.112:                              #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s6, 16
...
.LBB0_113:                              # %Initialize_Sequence.exit.i.i
	...
	ld.d	$s8, $sp, 152                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_114:                              #   Parent Loop BB0_55 Depth=1
...
# %bb.122:                              #   in Loop: Header=BB0_55 Depth=1
	...
	jirl	$ra, $ra, 0
.LBB0_123:                              #   in Loop: Header=BB0_55 Depth=1
...
.LBB0_125:                              #   in Loop: Header=BB0_55 Depth=1
	...
	ldptr.w	$a0, $s3, 3148
	bne	$a0, $s0, .LBB0_127
# %bb.126:                              #   in Loop: Header=BB0_55 Depth=1
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 8
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_127:                              #   in Loop: Header=BB0_55 Depth=1
	ld.d	$a0, $s1, 16
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	...
	ldptr.w	$a0, $s3, 3148
	bne	$a0, $s0, .LBB0_55
# %bb.128:                              #   in Loop: Header=BB0_55 Depth=1
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	...
	ldptr.w	$a0, $s3, 3148
	bne	$a0, $s0, .LBB0_55
# %bb.129:                              #   in Loop: Header=BB0_55 Depth=1
	pcalau12i	$a0, %pc_hi20(lltmp)
	ld.d	$a0, $a0, %pc_lo12(lltmp)
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_55
.LBB0_130:                              #   in Loop: Header=BB0_55 Depth=1
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a3, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str.20)
...
.LBB0_133:
	...
	addi.d	$sp, $sp, 304
	ret
.LBB0_134:                              # %.split33.us.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.22)
	addi.d	$a0, $a0, %pc_lo12(.L.str.22)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_135:                              # %.split35.us.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.23)
	addi.d	$a0, $a0, %pc_lo12(.L.str.23)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_136:                              # %.split37.us.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.24)
	addi.d	$a0, $a0, %pc_lo12(.L.str.24)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_137:                              # %.split39.us.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.25)
	addi.d	$a0, $a0, %pc_lo12(.L.str.25)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_138:                              # %.split41.us.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.26)
	addi.d	$a0, $a0, %pc_lo12(.L.str.26)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_139:                              # %.split43.us.i.i.i
