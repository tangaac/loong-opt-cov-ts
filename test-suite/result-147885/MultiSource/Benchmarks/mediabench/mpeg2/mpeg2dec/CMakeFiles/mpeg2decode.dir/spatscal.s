...
# %bb.21:                               #   in Loop: Header=BB3_20 Depth=1
	move	$s5, $zero
.LBB3_22:                               # %scalar.ph215.preheader
                                        #   in Loop: Header=BB3_20 Depth=1
	sub.d	$s2, $fp, $s5
	slli.d	$s3, $s5, 1
	add.d	$s1, $s5, $s1
...
# %bb.34:                               #   in Loop: Header=BB3_33 Depth=1
	move	$ra, $zero
.LBB3_35:                               # %scalar.ph275.preheader
                                        #   in Loop: Header=BB3_33 Depth=1
	sub.d	$s2, $fp, $ra
	slli.d	$s5, $ra, 1
	add.d	$t3, $ra, $s1
...
# %bb.47:                               #   in Loop: Header=BB3_46 Depth=1
	move	$s5, $zero
.LBB3_48:                               # %scalar.ph245.preheader
                                        #   in Loop: Header=BB3_46 Depth=1
	sub.d	$s2, $fp, $s5
	slli.d	$s3, $s5, 1
	add.d	$s1, $s5, $s1
...
# %bb.60:                               #   in Loop: Header=BB3_59 Depth=1
	move	$ra, $zero
.LBB3_61:                               # %scalar.ph306.preheader
                                        #   in Loop: Header=BB3_59 Depth=1
	sub.d	$s2, $fp, $ra
	slli.d	$s5, $ra, 1
	add.d	$s1, $ra, $s1
