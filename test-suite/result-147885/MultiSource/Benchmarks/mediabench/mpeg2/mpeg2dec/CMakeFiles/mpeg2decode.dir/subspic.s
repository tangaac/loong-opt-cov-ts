...
.LBB1_49:                               # %Copy_Frame.exit
	...
	ld.d	$a7, $a4, %got_pc_lo12(Chroma_Width)
	pcalau12i	$a4, %got_pc_hi20(Chroma_Height)
	ld.d	$t0, $a4, %got_pc_lo12(Chroma_Height)
	ld.w	$a4, $a7, 0
	ld.w	$a5, $t0, 0
	ori	$a6, $zero, 1
	blt	$a4, $a6, .LBB1_66
# %bb.50:                               # %Copy_Frame.exit
	blt	$a5, $a6, .LBB1_66
# %bb.51:                               # %.preheader.us.preheader.i24
	move	$t1, $zero
	ld.d	$t2, $a3, 8
	ld.d	$t3, $fp, 8
	sltui	$t5, $a1, 1
...
# %bb.54:                               #   in Loop: Header=BB1_53 Depth=1
	...
	b	.LBB1_64
	.p2align	4, , 16
.LBB1_55:                               # %vector.main.loop.iter.check84
                                        #   in Loop: Header=BB1_53 Depth=1
	bgeu	$a4, $s5, .LBB1_60
# %bb.56:                               #   in Loop: Header=BB1_53 Depth=1
	move	$s8, $zero
.LBB1_57:                               # %vec.epilog.ph97
                                        #   in Loop: Header=BB1_53 Depth=1
	add.d	$s6, $s4, $s8
	add.d	$s7, $t3, $s8
	add.d	$s8, $t2, $s8
	.p2align	4, , 16
.LBB1_58:                               # %vec.epilog.vector.body103
	...
	addi.d	$s8, $s8, 16
	bnez	$s6, .LBB1_58
# %bb.59:                               # %vec.epilog.middle.block107
                                        #   in Loop: Header=BB1_53 Depth=1
	move	$s6, $s1
	bne	$s1, $a4, .LBB1_64
	b	.LBB1_52
	.p2align	4, , 16
.LBB1_60:                               # %vector.body88.preheader
                                        #   in Loop: Header=BB1_53 Depth=1
	move	$s6, $s3
	move	$s7, $s2
	move	$s8, $t8
	.p2align	4, , 16
.LBB1_61:                               # %vector.body88
                                        #   Parent Loop BB1_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s7, -16
	vld	$vr1, $s7, 0
	...
	addi.d	$s6, $s6, 32
	bnez	$s8, .LBB1_61
# %bb.62:                               # %middle.block93
                                        #   in Loop: Header=BB1_53 Depth=1
	beq	$t8, $a4, .LBB1_52
# %bb.63:                               # %vec.epilog.iter.check98
                                        #   in Loop: Header=BB1_53 Depth=1
	move	$s8, $t8
	move	$s6, $t8
	bnez	$s0, .LBB1_57
	.p2align	4, , 16
.LBB1_64:                               # %vec.epilog.scalar.ph96
                                        #   Parent Loop BB1_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.b	$s7, $t6, $s6
	stx.b	$s7, $t3, $s6
...
# %bb.71:                               #   in Loop: Header=BB1_70 Depth=1
	...
	b	.LBB1_81
	.p2align	4, , 16
.LBB1_72:                               # %vector.main.loop.iter.check116
                                        #   in Loop: Header=BB1_70 Depth=1
	bgeu	$a4, $t8, .LBB1_77
# %bb.73:                               #   in Loop: Header=BB1_70 Depth=1
	move	$s1, $zero
.LBB1_74:                               # %vec.epilog.ph129
                                        #   in Loop: Header=BB1_70 Depth=1
	add.d	$fp, $t7, $s1
	add.d	$s0, $a7, $s1
	add.d	$s1, $a3, $s1
	.p2align	4, , 16
.LBB1_75:                               # %vec.epilog.vector.body135
	...
	addi.d	$s1, $s1, 16
	bnez	$fp, .LBB1_75
# %bb.76:                               # %vec.epilog.middle.block139
                                        #   in Loop: Header=BB1_70 Depth=1
	move	$fp, $t4
	bne	$t4, $a4, .LBB1_81
	b	.LBB1_69
	.p2align	4, , 16
.LBB1_77:                               # %vector.body120.preheader
                                        #   in Loop: Header=BB1_70 Depth=1
	move	$fp, $t6
	move	$s0, $t5
	move	$s1, $t2
	.p2align	4, , 16
.LBB1_78:                               # %vector.body120
                                        #   Parent Loop BB1_70 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s0, -16
	vld	$vr1, $s0, 0
	...
	addi.d	$fp, $fp, 32
	bnez	$s1, .LBB1_78
# %bb.79:                               # %middle.block125
                                        #   in Loop: Header=BB1_70 Depth=1
	beq	$t2, $a4, .LBB1_69
# %bb.80:                               # %vec.epilog.iter.check130
                                        #   in Loop: Header=BB1_70 Depth=1
	move	$s1, $t2
	move	$fp, $t2
	bnez	$t3, .LBB1_74
	.p2align	4, , 16
.LBB1_81:                               # %vec.epilog.scalar.ph128
                                        #   Parent Loop BB1_70 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.b	$s0, $t0, $fp
	stx.b	$s0, $a7, $fp
