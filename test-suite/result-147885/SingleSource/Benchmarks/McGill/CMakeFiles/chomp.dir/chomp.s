...
.LBB2_15:                               # %pred.store.continue
	...
	andi	$t0, $t0, 1
	beqz	$t0, .LBB2_13
.LBB2_16:                               # %pred.store.if13
                                        #   in Loop: Header=BB2_11 Depth=1
	vstelm.w	$vr0, $a5, 8, 2
	vpickve2gr.w	$t0, $vr1, 1
	andi	$t0, $t0, 1
	bnez	$t0, .LBB2_14
.LBB2_17:                               # %pred.store.continue16
                                        #   in Loop: Header=BB2_11 Depth=1
	vpickve2gr.w	$t0, $vr1, 0
	andi	$t0, $t0, 1
	beqz	$t0, .LBB2_10
.LBB2_18:                               # %pred.store.if17
                                        #   in Loop: Header=BB2_11 Depth=1
	vstelm.w	$vr0, $a5, 0, 0
	b	.LBB2_10
...
.LBB14_13:                              # %vector.body124
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB14_13
# %bb.14:                               # %middle.block127
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a2, $a0, .LBB14_17
.LBB14_15:                              # %scalar.ph117.preheader
                                        #   in Loop: Header=BB14_8 Depth=2
	sub.d	$a3, $a0, $a2
	alsl.d	$a2, $a2, $s3, 2
	.p2align	4, , 16
.LBB14_16:                              # %scalar.ph117
                                        #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$a1, $a2, 0
...
# %bb.27:                               # %middle.block
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a1, $fp, .LBB14_30
.LBB14_28:                              # %.lr.ph.i42.preheader132
                                        #   in Loop: Header=BB14_8 Depth=2
...
.LBB16_10:                              # %vector.body100
	...
	addi.d	$a3, $a3, 32
	bnez	$a2, .LBB16_10
# %bb.11:                               # %middle.block103
                                        #   in Loop: Header=BB16_5 Depth=2
	move	$a5, $s6
	beq	$s0, $a1, .LBB16_15
.LBB16_12:                              # %scalar.ph93.preheader
                                        #   in Loop: Header=BB16_5 Depth=2
	alsl.d	$a2, $a1, $a0, 2
	.p2align	4, , 16
.LBB16_13:                              # %scalar.ph93
                                        #   Parent Loop BB16_4 Depth=1
                                        #     Parent Loop BB16_5 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$s5, $a2, 0
...
# %bb.25:                               # %middle.block
	...
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	beq	$a2, $s3, .LBB16_28
.LBB16_26:                              # %.lr.ph.i28.preheader106
                                        #   in Loop: Header=BB16_5 Depth=2
