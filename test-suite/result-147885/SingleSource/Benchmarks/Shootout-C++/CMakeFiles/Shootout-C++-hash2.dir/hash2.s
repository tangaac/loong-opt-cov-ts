...
# %bb.23:                               #   in Loop: Header=BB0_22 Depth=2
	...
	b	.LBB0_19
	.p2align	4, , 16
.LBB0_24:                               # %.lr.ph.preheader.i.i.i.i.i.i
...
# %bb.54:                               #   in Loop: Header=BB0_88 Depth=2
	srli.d	$a0, $s5, 60
	bnez	$a0, .LBB0_93
# %bb.55:                               # %.lr.ph.preheader.i.i.i.i.i.i173
                                        #   in Loop: Header=BB0_88 Depth=2
	slli.d	$s2, $s5, 3
.Ltmp15:
	move	$a0, $s2
...
# %bb.56:                               # %.noexc198
	...
	add.d	$a0, $s0, $s2
	beq	$s3, $s1, .LBB0_68
# %bb.57:                               # %.lr.ph66.i176.preheader
                                        #   in Loop: Header=BB0_88 Depth=2
	move	$a2, $zero
	b	.LBB0_59
	.p2align	4, , 16
.LBB0_58:                               # %_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEC2EmRKS8_RKS9_.exit.i191
                                        #   in Loop: Header=BB0_59 Depth=3
	addi.d	$a2, $a2, 1
	beq	$a2, $s7, .LBB0_67
.LBB0_59:                               # %.lr.ph66.i176
                                        #   Parent Loop BB0_20 Depth=1
                                        #     Parent Loop BB0_88 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB0_63 Depth 4
...
.LBB0_63:                               # %.lr.ph.i180
	...
	ld.bu	$a5, $a7, 0
	beqz	$a5, .LBB0_61
# %bb.64:                               # %.lr.ph.i.i.i.i.i183.preheader
                                        #   in Loop: Header=BB0_63 Depth=4
	move	$a6, $zero
	addi.d	$a7, $a7, 1
	.p2align	4, , 16
.LBB0_65:                               # %.lr.ph.i.i.i.i.i183
                                        #   Parent Loop BB0_20 Depth=1
                                        #     Parent Loop BB0_88 Depth=2
                                        #       Parent Loop BB0_59 Depth=3
...
.LBB0_66:                               #   in Loop: Header=BB0_88 Depth=2
	...
	move	$a0, $s3
	b	.LBB0_70
.LBB0_67:                               # %_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEC2EmRKS8_RKS9_.exit._crit_edge.thread.i193
                                        #   in Loop: Header=BB0_88 Depth=2
	ld.d	$a2, $sp, 80
	st.d	$s0, $sp, 64
	st.d	$a0, $sp, 72
	st.d	$a1, $sp, 80
	b	.LBB0_69
.LBB0_68:                               # %_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEC2EmRKS8_RKS9_.exit._crit_edge.i194
                                        #   in Loop: Header=BB0_88 Depth=2
	ld.d	$a2, $sp, 80
	st.d	$s0, $sp, 64
	st.d	$a0, $sp, 72
...
# %bb.101:                              # %.noexc49
	...
	st.d	$a0, $sp, 128
	b	.LBB0_103
.LBB0_102:                              # %.loopexit216.loopexit
	ld.w	$a1, $s5, 16
.LBB0_103:                              # %.loopexit216
.Ltmp27:
...
# %bb.111:                              # %.noexc101
	...
	st.d	$a0, $sp, 128
	b	.LBB0_113
.LBB0_112:                              # %.loopexit215.loopexit
	ld.w	$a1, $s8, 16
.LBB0_113:                              # %.loopexit215
.Ltmp36:
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSolsEi)
	jirl	$ra, $ra, 0
...
# %bb.121:                              # %.noexc119
	...
	st.d	$a0, $sp, 88
	b	.LBB0_123
.LBB0_122:                              # %.loopexit214.loopexit
	ld.w	$a1, $s7, 16
.LBB0_123:                              # %.loopexit214
.Ltmp45:
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSolsEi)
	jirl	$ra, $ra, 0
