...
# %bb.101:                              # %gcd.exit892
                                        #   in Loop: Header=BB1_3 Depth=1
	bne	$a4, $fp, .LBB1_106
# %bb.102:                              # %.preheader986.preheader
                                        #   in Loop: Header=BB1_3 Depth=1
	move	$a5, $fp
	move	$a4, $a3
	.p2align	4, , 16
.LBB1_103:                              # %.preheader986
...
# %bb.112:                              # %gcd.exit901
                                        #   in Loop: Header=BB1_3 Depth=1
	bne	$a4, $a2, .LBB1_117
# %bb.113:                              # %.preheader985.preheader
                                        #   in Loop: Header=BB1_3 Depth=1
	move	$a5, $a2
	move	$a4, $a3
	.p2align	4, , 16
.LBB1_114:                              # %.preheader985
                                        #   Parent Loop BB1_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a6, $a4
	move	$a4, $a5
...
# %bb.123:                              # %gcd.exit910
                                        #   in Loop: Header=BB1_3 Depth=1
	bne	$a4, $fp, .LBB1_128
# %bb.124:                              # %.preheader984.preheader
                                        #   in Loop: Header=BB1_3 Depth=1
	move	$a5, $fp
	move	$a4, $a3
	.p2align	4, , 16
.LBB1_125:                              # %.preheader984
                                        #   Parent Loop BB1_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a6, $a4
	move	$a4, $a5
...
# %bb.134:                              # %gcd.exit919
                                        #   in Loop: Header=BB1_3 Depth=1
	bne	$a4, $a2, .LBB1_139
# %bb.135:                              # %.preheader983.preheader
                                        #   in Loop: Header=BB1_3 Depth=1
	move	$a5, $a2
	move	$a4, $a3
	.p2align	4, , 16
.LBB1_136:                              # %.preheader983
                                        #   Parent Loop BB1_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a6, $a4
	move	$a4, $a5
...
# %bb.145:                              # %gcd.exit928
                                        #   in Loop: Header=BB1_3 Depth=1
	bne	$a4, $fp, .LBB1_150
# %bb.146:                              # %.preheader982.preheader
                                        #   in Loop: Header=BB1_3 Depth=1
	move	$a5, $fp
	move	$a4, $a3
	.p2align	4, , 16
.LBB1_147:                              # %.preheader982
                                        #   Parent Loop BB1_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a6, $a4
	move	$a4, $a5
...
# %bb.156:                              # %gcd.exit937
                                        #   in Loop: Header=BB1_3 Depth=1
	bne	$a4, $a2, .LBB1_161
# %bb.157:                              # %.preheader981.preheader
                                        #   in Loop: Header=BB1_3 Depth=1
	move	$a5, $a2
	move	$a4, $a3
	.p2align	4, , 16
.LBB1_158:                              # %.preheader981
                                        #   Parent Loop BB1_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a6, $a4
	move	$a4, $a5
...
# %bb.167:                              # %gcd.exit946
                                        #   in Loop: Header=BB1_3 Depth=1
	bne	$a4, $fp, .LBB1_172
# %bb.168:                              # %.preheader980.preheader
                                        #   in Loop: Header=BB1_3 Depth=1
	move	$a5, $fp
	move	$a4, $a3
	.p2align	4, , 16
.LBB1_169:                              # %.preheader980
                                        #   Parent Loop BB1_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a6, $a4
	move	$a4, $a5
