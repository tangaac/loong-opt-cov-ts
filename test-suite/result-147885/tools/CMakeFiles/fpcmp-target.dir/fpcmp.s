...
.LBB1_126:
	ld.d	$fp, $sp, 88                    # 8-byte Folded Reload
.LBB1_127:                              # %skip_whitespace.exit84
	bgeu	$s6, $s0, .LBB1_129
# %bb.128:                              # %skip_whitespace.exit84
	bltu	$s1, $s8, .LBB1_143
.LBB1_129:
	bltu	$s6, $s0, .LBB1_144
# %bb.130:
...
.LBB1_133:
	addi.d	$s1, $s5, 1
	beq	$s1, $s8, .LBB1_138
# %bb.134:                              # %.peel.next.i81.preheader
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	add.d	$a2, $a2, $fp
	sub.d	$a2, $a2, $s5
	add.d	$a2, $s5, $a2
	.p2align	4, , 16
.LBB1_135:                              # %.peel.next.i81
