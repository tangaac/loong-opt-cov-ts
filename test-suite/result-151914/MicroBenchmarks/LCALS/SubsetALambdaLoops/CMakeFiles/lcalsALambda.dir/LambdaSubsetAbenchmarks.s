...
# %bb.3:                                # %.lr.ph55.split.us.preheader
	...
	b	.LBB0_5
	.p2align	4, , 16
.LBB0_4:                                # %"_Z6forallIZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit._Z6forallIZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEE3$_1Ev9simd_execiiT_.exit_crit_edge.us"
...
# %bb.6:                                #   in Loop: Header=BB0_5 Depth=1
	...
	b	.LBB0_10
	.p2align	4, , 16
.LBB0_7:                                # %vector.body98.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a7, $a5
	move	$t0, $a4
	move	$t1, $a2
	.p2align	4, , 16
.LBB0_8:                                # %vector.body98
...
.LBB0_11:                               # %.lr.ph.us
	...
	addi.d	$t0, $t0, 8
	bnez	$t1, .LBB0_11
.LBB0_12:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.preheader"
                                        #   in Loop: Header=BB0_5 Depth=1
	beqz	$a6, .LBB0_14
...
.LBB0_18:                               # %pred.store.continue
	...
	andi	$t4, $t4, 1
	bnez	$t4, .LBB0_21
# %bb.19:                               # %pred.store.continue85
                                        #   in Loop: Header=BB0_16 Depth=2
	vpickve2gr.w	$t4, $vr10, 2
	andi	$t4, $t4, 1
	bnez	$t4, .LBB0_22
.LBB0_20:                               # %pred.store.continue87
                                        #   in Loop: Header=BB0_16 Depth=2
...
.LBB0_24:                               # %middle.block
	...
	move	$t3, $a3
	beq	$a0, $a3, .LBB0_4
.LBB0_25:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us.preheader106"
                                        #   in Loop: Header=BB0_5 Depth=1
	alsl.d	$a7, $t3, $s2, 3
	alsl.d	$t0, $t3, $s4, 3
	alsl.d	$t1, $t3, $s3, 3
...
.LBB0_26:                               #   in Loop: Header=BB0_28 Depth=2
	...
	fsel	$ft0, $ft0, $ft6, $fcc0
	fst.d	$ft0, $t1, 0
.LBB0_27:                               # %"_Z6forallIZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEE3$_0Ev9simd_execiiT_.exit.us"
	...
	addi.d	$t2, $t2, 8
	beqz	$t3, .LBB0_4
.LBB0_28:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us"
                                        #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$ft0, $a7, 0
	fld.d	$ft1, $t0, 0
	...
	fsel	$ft0, $ft0, $fa5, $fcc0
	bcnez	$fcc0, .LBB0_26
# %bb.29:                               # %"_ZZL23BM_PRESSURE_CALC_LAMBDARN9benchmark5StateEENK3$_1clEi.exit.us"
                                        #   in Loop: Header=BB0_28 Depth=2
...
# %bb.6:                                #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_10
	.p2align	4, , 16
.LBB1_7:                                # %vector.body283.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
...
# %bb.21:                               #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_25
	.p2align	4, , 16
.LBB1_22:                               # %vector.body257.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
	move	$a1, $t6
	move	$a2, $t8
	move	$a3, $t1
...
.LBB1_23:                               # %vector.body257
	...
	addi.d	$a1, $a1, 32
	bnez	$a7, .LBB1_23
# %bb.24:                               # %middle.block266
                                        #   in Loop: Header=BB1_4 Depth=1
	ld.d	$a1, $sp, 464                   # 8-byte Folded Reload
	move	$a7, $a1
	beq	$s7, $a1, .LBB1_27
.LBB1_25:                               # %"_Z6forallIZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateEE3$_1Ev9simd_execiiT_.exit.preheader300"
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a1, $a7, $t2, 3
...
# %bb.31:                               # %middle.block
	...
	move	$a2, $a0
	beq	$s7, $a0, .LBB1_34
.LBB1_32:                               # %"_ZZL21BM_ENERGY_CALC_LAMBDARN9benchmark5StateEENK3$_3clEi.exit.preheader299"
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a0, $a2, $t6, 3
	alsl.d	$a1, $a2, $t4, 3
	sub.d	$a2, $s7, $a2
...
# %bb.4:                                # %.preheader.us.preheader
	...
	b	.LBB4_6
	.p2align	4, , 16
.LBB4_5:                                # %"._Z6forallI9simd_execZL16BM_COUPLE_LAMBDARN9benchmark5StateEE3$_0EviiT0_.exit_crit_edge.us"
...
.LBB4_7:                                # %.noexc26.loopexit.us.us
	...
	beq	$a3, $a0, .LBB4_5
.LBB4_8:                                # %.lr.ph249.split.i.preheader.us.us
	...
	b	.LBB4_10
	.p2align	4, , 16
.LBB4_9:                                # %._crit_edge.i.loopexit.us.us
	...
	beq	$a0, $s8, .LBB4_7
.LBB4_10:                               # %.lr.ph249.split.i.us.us
                                        #   Parent Loop BB4_6 Depth=1
...
.LBB4_12:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit.i.us.us
	...
	fmov.d	$fa1, $fs3
	bceqz	$fcc2, .LBB4_25
.LBB4_13:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit68.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fadd.d	$fa2, $fs4, $fa2
	fadd.d	$fa1, $fs2, $fa1
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_27
.LBB4_14:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit81.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fmul.d	$fa2, $fa0, $ft2
	fmul.d	$fa3, $fa0, $ft3
	fsub.d	$fa2, $fa2, $fa4
	...
	fst.d	$fa1, $s2, 0
	bceqz	$fcc2, .LBB4_29
.LBB4_15:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit88.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fneg.d	$fa4, $fs7
	fmul.d	$fa1, $fs1, $fs6
	fmul.d	$fa2, $fs1, $fs3
	...
	fsub.d	$fa6, $fa2, $fa1
	bceqz	$fcc0, .LBB4_31
.LBB4_16:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit92.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fmul.d	$fa1, $ft2, $fs1
	fmul.d	$fa3, $ft3, $fs1
	fmul.d	$fa2, $ft3, $fs7
	...
	fsub.d	$fa1, $fa3, $fa1
	bceqz	$fcc0, .LBB4_33
.LBB4_17:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit99.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	fmul.d	$fa1, $fa2, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_35
.LBB4_18:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit112.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fmul.d	$fa2, $fs7, $fs7
	...
	fst.d	$fa1, $s3, 0
	bceqz	$fcc1, .LBB4_37
.LBB4_19:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit119.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fneg.d	$fs4, $fs0
	fmul.d	$fa1, $fs5, $ft4
	fmul.d	$fa2, $fs5, $ft5
	...
	fsub.d	$fs7, $fa2, $fa1
	bceqz	$fcc0, .LBB4_39
.LBB4_20:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit123.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fmul.d	$fa1, $ft2, $fs5
	fmul.d	$fa3, $ft3, $fs5
	fmul.d	$fa2, $ft3, $fs0
	...
	fsub.d	$fa1, $fa3, $fa1
	bceqz	$fcc0, .LBB4_41
.LBB4_21:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit130.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	fmul.d	$fa1, $fa2, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_43
.LBB4_22:                               # %_ZStmlIdESt7complexIT_ERKS2_S4_.exit143.i.us.us
                                        #   in Loop: Header=BB4_11 Depth=4
...
.LBB6_32:                               # %vector.body102
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB6_32
# %bb.33:                               # %middle.block109
                                        #   in Loop: Header=BB6_29 Depth=1
	move	$t3, $a4
	beq	$a3, $a2, .LBB6_28
.LBB6_34:                               # %scalar.ph94.preheader
                                        #   in Loop: Header=BB6_29 Depth=1
	alsl.d	$t1, $a0, $s0, 2
	sub.d	$t2, $s3, $t3
	add.d	$t3, $t3, $a6
...
# %bb.38:
	...
	ori	$a4, $zero, 2
	blt	$a3, $a4, .LBB6_51
# %bb.39:                               # %.lr.ph49.us.us.preheader.preheader
	move	$a0, $zero
	addi.d	$a7, $s6, -1
	...
	b	.LBB6_41
	.p2align	4, , 16
.LBB6_40:                               # %._crit_edge58.us
                                        #   in Loop: Header=BB6_41 Depth=1
	addi.w	$a1, $a1, 1
	add.d	$t0, $t0, $s5
	beq	$a1, $a2, .LBB6_50
.LBB6_41:                               # %.lr.ph49.us.us.preheader
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB6_43
	.p2align	4, , 16
.LBB6_42:                               # %._crit_edge50.us.us
                                        #   in Loop: Header=BB6_43 Depth=2
	addi.w	$t5, $t4, 1
	add.d	$t3, $t3, $s4
	beq	$t4, $a3, .LBB6_40
.LBB6_43:                               # %.lr.ph49.us.us
