...
.LBB0_61:                               #   in Loop: Header=BB0_63 Depth=1
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_62:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit182
...
.LBB0_68:                               #   in Loop: Header=BB0_63 Depth=1
	...
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beq	$s0, $a0, .LBB0_78
# %bb.69:                               # %_ZNKSt6vectorIP7HydroBCSaIS1_EE12_M_check_lenEmPKc.exit.i.i.i172
                                        #   in Loop: Header=BB0_63 Depth=1
	srai.d	$a0, $s0, 3
	ori	$a2, $zero, 1
	sltu	$a1, $a2, $a0
...
.LBB0_72:                               # %_ZNSt6vectorIP7HydroBCSaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit.i.i.i174
                                        #   in Loop: Header=BB0_63 Depth=1
	beqz	$s2, .LBB0_74
# %bb.73:                               # %_ZNSt12_Vector_baseIP7HydroBCSaIS1_EE13_M_deallocateEPS1_m.exit.i.i.i.i176
                                        #   in Loop: Header=BB0_63 Depth=1
	move	$a0, $s2
	move	$a1, $s0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_74:                               # %_ZNSt6vectorIP7HydroBCSaIS1_EE17_M_realloc_appendIJS1_EEEvDpOT_.exit.i.i177
                                        #   in Loop: Header=BB0_63 Depth=1
	add.d	$a0, $s3, $s0
	addi.d	$a0, $a0, 8
	st.d	$s3, $fp, 32
...
.Ltmp59:                                # EH_LABEL
	move	$s0, $a0
	b	.LBB0_115
.LBB0_105:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit184.thread
.Ltmp62:                                # EH_LABEL
	move	$s0, $a0
	b	.LBB0_112
.LBB0_106:
...
.LBB0_115:
	...
	addi.d	$s1, $fp, 112
	bnez	$a0, .LBB0_119
# %bb.116:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit186
	ld.d	$a0, $s1, 0
	bnez	$a0, .LBB0_120
.LBB0_117:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit188
...
.LBB1_6:                                # %vector.body156
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_6
# %bb.7:                                # %middle.block161
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a5, .LBB1_10
.LBB1_8:                                # %.lr.ph.i.preheader167
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a5, $s7, $s2, 3
	.p2align	4, , 16
.LBB1_9:                                # %.lr.ph.i
...
.LBB1_12:                               # %vector.body142
	...
	addi.d	$a1, $a1, 64
	bnez	$a5, .LBB1_12
# %bb.13:                               # %middle.block146
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a4, .LBB1_16
.LBB1_14:                               # %.lr.ph.i77.preheader166
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a0, $s7, $s3, 3
	.p2align	4, , 16
.LBB1_15:                               # %.lr.ph.i77
...
.LBB1_16:                               # %.lr.ph.i82.preheader
	...
	ori	$t3, $zero, 56
.LBB1_17:                               # %_ZSt9__fill_a1IPddEvT_S1_RKT0_.exit85
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$s4, $s0, .LBB1_26
# %bb.18:                               # %_ZSt9__fill_a1IPddEvT_S1_RKT0_.exit85
                                        #   in Loop: Header=BB1_3 Depth=1
	bge	$s1, $s7, .LBB1_26
...
# %bb.35:                               # %.lr.ph102
	...
	bcnez	$fcc0, .LBB1_47
# %bb.36:                               # %.lr.ph102.split.preheader
...
.LBB5_7:                                # %.lr.ph.i.i159
	...
	addi.d	$t3, $t3, 16
	bnez	$t1, .LBB5_7
.LBB5_8:                                # %_ZSt4copyIP7double2S1_ET0_T_S3_S2_.exit164
                                        #   in Loop: Header=BB5_3 Depth=1
	bge	$a7, $t0, .LBB5_2
...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s6
.LBB5_19:                               # %.lr.ph.i167.preheader353
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB5_52:                               # %vector.body276
	...
	addi.d	$a7, $a7, 32
	bnez	$t4, .LBB5_52
# %bb.53:                               # %middle.block281
                                        #   in Loop: Header=BB5_38 Depth=1
	bne	$a2, $t1, .LBB5_45
	b	.LBB5_47
.LBB5_54:                               # %._crit_edge227
...
# %bb.63:                               # %.lr.ph234
	...
	b	.LBB5_65
	.p2align	4, , 16
.LBB5_64:                               # %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit215
...
.LBB5_71:                               # %.lr.ph.i205
	...
	addi.d	$a2, $a2, 8
	bnez	$a7, .LBB5_71
.LBB5_72:                               # %.lr.ph.preheader.i209
                                        #   in Loop: Header=BB5_65 Depth=1
	ld.d	$a2, $fp, 304
	move	$a3, $a4
	bgeu	$a0, $s5, .LBB5_87
.LBB5_73:                               # %.lr.ph.i211.preheader
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a0, $a5, $a3
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a6, $a3, $s8, 3
...
.LBB5_74:                               # %.lr.ph.i211
	...
	b	.LBB5_64
	.p2align	4, , 16
.LBB5_75:                               # %vector.memcheck324
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $s8
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.76:                               # %vector.memcheck324
                                        #   in Loop: Header=BB5_65 Depth=1
	ld.d	$a6, $sp, 344                   # 8-byte Folded Reload
	sub.d	$a7, $a3, $a6
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.77:                               # %vector.memcheck324
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.78:                               # %vector.memcheck324
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
...
.LBB5_80:                               # %vector.body337
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB5_80
# %bb.81:                               # %middle.block349
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_67
	b	.LBB5_69
	.p2align	4, , 16
.LBB5_82:                               # %vector.memcheck304
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_70
# %bb.83:                               # %vector.memcheck304
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_70
...
.LBB5_85:                               # %vector.body313
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB5_85
# %bb.86:                               # %middle.block321
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_70
	b	.LBB5_72
	.p2align	4, , 16
.LBB5_87:                               # %vector.memcheck284
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_73
# %bb.88:                               # %vector.memcheck284
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $s8
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_73
...
.LBB5_90:                               # %vector.body293
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB5_90
# %bb.91:                               # %middle.block301
                                        #   in Loop: Header=BB5_65 Depth=1
	beq	$a0, $a6, .LBB5_64
	b	.LBB5_73
.LBB5_92:                               # %._crit_edge235
