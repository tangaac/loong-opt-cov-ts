...
.LBB8_27:
	move	$t3, $zero
	b	.LBB8_103
.LBB8_28:                               # %vector.main.loop.iter.check181
	ori	$a6, $zero, 16
	bgeu	$t0, $a6, .LBB8_30
# %bb.29:
	move	$t2, $zero
...
# %bb.32:                               # %middle.block192
	...
	beq	$t2, $t0, .LBB8_73
# %bb.33:                               # %vec.epilog.iter.check199
	andi	$t3, $t0, 12
	beqz	$t3, .LBB8_70
.LBB8_34:                               # %vec.epilog.ph198
	...
	alsl.d	$t1, $t1, $a0, 2
	.p2align	4, , 16
.LBB8_35:                               # %vec.epilog.vector.body206
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t1, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$a6, $a6, 4
	addi.d	$t1, $t1, 16
	bnez	$a6, .LBB8_35
# %bb.36:                               # %vec.epilog.middle.block211
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.39:                               # %middle.block315
	...
	xvpickve2gr.w	$a4, $xr0, 0
	beq	$t2, $t1, .LBB8_46
# %bb.40:                               # %vec.epilog.iter.check322
	andi	$t3, $t2, 12
	beqz	$t3, .LBB8_44
.LBB8_41:                               # %vec.epilog.ph321
	move	$t3, $t1
	...
	addi.d	$t3, $t3, 132
	.p2align	4, , 16
.LBB8_42:                               # %vec.epilog.vector.body329
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $t3, -44
	ld.w	$t5, $t3, -32
	ld.w	$t6, $t3, -20
	...
	addi.d	$t3, $t3, 48
	bnez	$a4, .LBB8_42
# %bb.43:                               # %vec.epilog.middle.block333
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.51:
	...
	move	$t5, $a5
	b	.LBB8_120
.LBB8_52:                               # %vector.main.loop.iter.check382
...
# %bb.53:
	...
	move	$t1, $zero
	b	.LBB8_60
.LBB8_54:                               # %vector.main.loop.iter.check343
...
# %bb.58:                               # %middle.block391
	...
	beq	$t4, $t5, .LBB8_107
# %bb.59:                               # %vec.epilog.iter.check398
	andi	$t6, $t4, 12
	beqz	$t6, .LBB8_104
.LBB8_60:                               # %vec.epilog.ph397
	...
	addi.d	$t5, $t5, 132
	.p2align	4, , 16
.LBB8_61:                               # %vec.epilog.vector.body405
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t8, $t5, -44
	ld.w	$fp, $t5, -32
	ld.w	$s0, $t5, -20
	...
	addi.d	$t5, $t5, 48
	bnez	$t1, .LBB8_61
# %bb.62:                               # %vec.epilog.middle.block410
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.65:                               # %middle.block352
	...
	xvpickve2gr.w	$a6, $xr0, 0
	beq	$t2, $t3, .LBB8_122
# %bb.66:                               # %vec.epilog.iter.check359
	andi	$t4, $t2, 12
	beqz	$t4, .LBB8_119
.LBB8_67:                               # %vec.epilog.ph358
	...
	addi.d	$t3, $t3, 132
	.p2align	4, , 16
.LBB8_68:                               # %vec.epilog.vector.body366
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t6, $t3, -44
	ld.w	$t7, $t3, -32
	ld.w	$t8, $t3, -20
	...
	addi.d	$t3, $t3, 48
	bnez	$a6, .LBB8_68
# %bb.69:                               # %vec.epilog.middle.block371
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
.LBB8_70:
	add.d	$t3, $t2, $t1
	move	$t4, $t2
.LBB8_71:                               # %vec.epilog.scalar.ph197.preheader
	alsl.d	$t1, $t3, $a0, 2
	sub.d	$t2, $t0, $t4
	.p2align	4, , 16
.LBB8_72:                               # %vec.epilog.scalar.ph197
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t3, $t1, 0
	slt	$t4, $a6, $t3
	masknez	$a6, $a6, $t4
	...
	addi.d	$t1, $t1, 4
	bnez	$t2, .LBB8_72
.LBB8_73:                               # %._crit_edge.1
	add.w	$a5, $a5, $t0
	ld.w	$t2, $a7, 8
	ori	$t0, $zero, 1
	blt	$t2, $t0, .LBB8_26
.LBB8_74:                               # %iter.check220
	ori	$t1, $zero, 4
	bgeu	$t2, $t1, .LBB8_76
# %bb.75:
	move	$t1, $zero
	...
	move	$t4, $a5
	b	.LBB8_86
.LBB8_76:                               # %vector.main.loop.iter.check222
	ori	$t1, $zero, 16
	bgeu	$t2, $t1, .LBB8_78
# %bb.77:
	move	$t3, $zero
...
# %bb.80:                               # %middle.block233
	...
	xvpickve2gr.w	$t1, $xr0, 0
	beq	$t3, $t2, .LBB8_88
# %bb.81:                               # %vec.epilog.iter.check240
	andi	$t4, $t2, 12
	beqz	$t4, .LBB8_85
.LBB8_82:                               # %vec.epilog.ph239
	...
	alsl.d	$t3, $t3, $a0, 2
	.p2align	4, , 16
.LBB8_83:                               # %vec.epilog.vector.body247
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t3, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t1, $t1, 4
	addi.d	$t3, $t3, 16
	bnez	$t1, .LBB8_83
# %bb.84:                               # %vec.epilog.middle.block253
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
.LBB8_85:
	add.d	$t4, $t3, $a5
	move	$t5, $t3
.LBB8_86:                               # %vec.epilog.scalar.ph238.preheader
	alsl.d	$t3, $t4, $a0, 2
	sub.d	$t4, $t2, $t5
	.p2align	4, , 16
.LBB8_87:                               # %vec.epilog.scalar.ph238
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $t3, 0
	slt	$t6, $t1, $t5
	masknez	$t1, $t1, $t6
	...
	addi.d	$t3, $t3, 4
	bnez	$t4, .LBB8_87
.LBB8_88:                               # %._crit_edge.2
	add.w	$a5, $a5, $t2
	ld.w	$a7, $a7, 12
	blt	$a7, $t0, .LBB8_27
.LBB8_89:                               # %iter.check262
	ori	$t0, $zero, 4
	bgeu	$a7, $t0, .LBB8_91
# %bb.90:
	move	$t3, $zero
	...
	move	$t2, $a5
	b	.LBB8_101
.LBB8_91:                               # %vector.main.loop.iter.check264
	ori	$t0, $zero, 16
	bgeu	$a7, $t0, .LBB8_93
# %bb.92:
	move	$t0, $zero
...
# %bb.95:                               # %middle.block275
	...
	beq	$t0, $a7, .LBB8_103
# %bb.96:                               # %vec.epilog.iter.check282
	andi	$t2, $a7, 12
	beqz	$t2, .LBB8_100
.LBB8_97:                               # %vec.epilog.ph281
	...
	alsl.d	$a5, $a5, $a0, 2
	.p2align	4, , 16
.LBB8_98:                               # %vec.epilog.vector.body289
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t3, $t3, 4
	addi.d	$a5, $a5, 16
	bnez	$t3, .LBB8_98
# %bb.99:                               # %vec.epilog.middle.block295
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
.LBB8_100:
	add.d	$t2, $t0, $a5
	move	$t4, $t0
.LBB8_101:                              # %vec.epilog.scalar.ph280.preheader
	alsl.d	$a0, $t2, $a0, 2
	sub.d	$a5, $a7, $t4
	.p2align	4, , 16
.LBB8_102:                              # %vec.epilog.scalar.ph280
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a7, $a0, 0
	slt	$t0, $t3, $a7
	masknez	$t2, $t3, $t0
...
.LBB8_104:
	add.d	$t7, $t5, $a5
	move	$t6, $t5
.LBB8_105:                              # %.preheader.2.preheader
	slli.d	$t4, $t7, 3
	alsl.d	$t4, $t7, $t4, 2
	add.d	$t4, $t4, $a0
	addi.d	$t4, $t4, 96
...
.LBB8_106:                              # %.preheader.2
	...
	addi.d	$t4, $t4, 12
	bnez	$t5, .LBB8_106
.LBB8_107:                              # %._crit_edge111.2
	add.w	$a5, $a5, $t3
	ld.wu	$t3, $t0, 12
	ori	$t0, $zero, 1
	bltu	$t3, $t2, .LBB8_124
.LBB8_108:                              # %iter.check419
	mul.d	$a7, $t3, $a7
	srli.d	$a7, $a7, 33
	addi.d	$t3, $a7, -1
	ori	$t2, $zero, 3
...
# %bb.109:
	...
	move	$t6, $a5
	b	.LBB8_126
.LBB8_110:                              # %vector.main.loop.iter.check421
...
# %bb.114:                              # %middle.block430
	...
	xvpickve2gr.w	$t3, $xr0, 0
	beq	$t2, $t4, .LBB8_128
# %bb.115:                              # %vec.epilog.iter.check437
	andi	$t5, $t2, 12
	beqz	$t5, .LBB8_125
.LBB8_116:                              # %vec.epilog.ph436
	...
	addi.d	$a5, $a5, 132
	.p2align	4, , 16
.LBB8_117:                              # %vec.epilog.vector.body444
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $a5, -44
	ld.w	$t7, $a5, -32
	ld.w	$t8, $a5, -20
	...
	addi.d	$a5, $a5, 48
	bnez	$t3, .LBB8_117
# %bb.118:                              # %vec.epilog.middle.block449
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
.LBB8_119:
	add.d	$t5, $t3, $a5
	move	$t4, $t3
.LBB8_120:                              # %.preheader.1.preheader
	slli.d	$t2, $t5, 3
	alsl.d	$t2, $t5, $t2, 2
	add.d	$t2, $t2, $a0
	addi.d	$t2, $t2, 96
...
.LBB8_125:
	add.d	$t6, $t4, $a5
	move	$t5, $t4
.LBB8_126:                              # %.preheader.3.preheader
	slli.d	$a5, $t6, 3
	alsl.d	$a5, $t6, $a5, 2
	add.d	$a0, $a5, $a0
	addi.d	$a0, $a0, 96
