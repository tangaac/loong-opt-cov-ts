...
# %bb.31:
	move	$t2, $zero
.LBB3_32:                               # %scalar.ph1001.preheader
	slli.d	$t3, $t2, 2
	sub.d	$t1, $t1, $t2
	vldi	$vr1, -912
	vldi	$vr2, -928
...
.LBB3_77:                               # %vector.memcheck872
	...
	move	$t2, $zero
	bnez	$t4, .LBB3_322
# %bb.78:                               # %vector.memcheck872
	alsl.d	$s0, $t1, $a5, 2
	sltu	$t4, $a2, $s0
	sltu	$t5, $a5, $s2
	and	$t4, $t4, $t5
	bnez	$t4, .LBB3_322
# %bb.79:                               # %vector.memcheck872
	alsl.d	$t5, $t1, $a6, 2
	sltu	$t4, $a2, $t5
	sltu	$t6, $a6, $s2
	and	$t4, $t4, $t6
	bnez	$t4, .LBB3_322
# %bb.80:                               # %vector.memcheck872
	alsl.d	$t4, $t1, $t0, 2
	sltu	$t6, $a2, $t4
	sltu	$t7, $t0, $s2
	and	$t6, $t6, $t7
	bnez	$t6, .LBB3_322
# %bb.81:                               # %vector.memcheck872
	alsl.d	$t6, $t1, $a0, 2
	sltu	$t7, $a2, $t6
	sltu	$t8, $a0, $s2
	and	$t7, $t7, $t8
	bnez	$t7, .LBB3_322
# %bb.82:                               # %vector.memcheck872
	alsl.d	$t7, $t1, $a1, 2
	sltu	$t8, $a2, $t7
	sltu	$fp, $a1, $s2
	and	$t8, $t8, $fp
	bnez	$t8, .LBB3_322
# %bb.83:                               # %vector.memcheck872
	alsl.d	$t8, $t1, $a3, 2
	sltu	$fp, $a2, $t8
	sltu	$s3, $a3, $s2
	and	$fp, $fp, $s3
	bnez	$fp, .LBB3_322
# %bb.84:                               # %vector.memcheck872
	alsl.d	$fp, $t1, $a7, 2
	sltu	$s3, $a2, $fp
	sltu	$s2, $a7, $s2
	and	$s2, $s3, $s2
	bnez	$s2, .LBB3_322
# %bb.85:                               # %vector.memcheck872
	sltu	$s2, $a4, $s0
	sltu	$s3, $a5, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB3_322
# %bb.86:                               # %vector.memcheck872
	sltu	$s2, $a4, $t5
	sltu	$s3, $a6, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB3_322
# %bb.87:                               # %vector.memcheck872
	sltu	$s2, $a4, $t4
	sltu	$s3, $t0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB3_322
# %bb.88:                               # %vector.memcheck872
	sltu	$s2, $a4, $t6
	sltu	$s3, $a0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB3_322
# %bb.89:                               # %vector.memcheck872
	sltu	$s2, $a4, $t7
	sltu	$s3, $a1, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB3_322
# %bb.90:                               # %vector.memcheck872
	sltu	$s2, $a4, $t8
	sltu	$s3, $a3, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB3_322
# %bb.91:                               # %vector.memcheck872
	sltu	$s2, $a4, $fp
	sltu	$s1, $a7, $s1
	and	$s1, $s2, $s1
	bnez	$s1, .LBB3_322
# %bb.92:                               # %vector.memcheck872
	sltu	$s1, $a5, $t5
	sltu	$s2, $a6, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB3_322
# %bb.93:                               # %vector.memcheck872
	sltu	$s1, $a5, $t4
	sltu	$s2, $t0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB3_322
# %bb.94:                               # %vector.memcheck872
	sltu	$s1, $a5, $t6
	sltu	$s2, $a0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB3_322
# %bb.95:                               # %vector.memcheck872
	sltu	$s1, $a5, $t7
	sltu	$s2, $a1, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB3_322
# %bb.96:                               # %vector.memcheck872
	sltu	$s1, $a5, $t8
	sltu	$s2, $a3, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB3_322
# %bb.97:                               # %vector.memcheck872
	sltu	$s1, $a5, $fp
	sltu	$s0, $a7, $s0
	and	$s0, $s1, $s0
	ld.d	$s2, $sp, 144                   # 8-byte Folded Reload
	bnez	$s0, .LBB3_32
# %bb.98:                               # %vector.memcheck872
	sltu	$s0, $a6, $t4
	sltu	$s1, $t0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB3_32
# %bb.99:                               # %vector.memcheck872
	sltu	$s0, $a6, $t6
	sltu	$s1, $a0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB3_32
# %bb.100:                              # %vector.memcheck872
	sltu	$s0, $a6, $t7
	sltu	$s1, $a1, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB3_32
# %bb.101:                              # %vector.memcheck872
	sltu	$s0, $a6, $t8
	sltu	$s1, $a3, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB3_32
# %bb.102:                              # %vector.memcheck872
	sltu	$s0, $a6, $fp
	sltu	$t5, $a7, $t5
	and	$t5, $s0, $t5
	bnez	$t5, .LBB3_32
# %bb.103:                              # %vector.memcheck872
	sltu	$t5, $t0, $t6
	sltu	$t6, $a0, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB3_32
# %bb.104:                              # %vector.memcheck872
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB3_32
# %bb.105:                              # %vector.memcheck872
	sltu	$t5, $t0, $t8
	sltu	$t6, $a3, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB3_32
# %bb.106:                              # %vector.memcheck872
	sltu	$t5, $t0, $fp
	sltu	$t4, $a7, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB3_32
# %bb.107:                              # %vector.ph1003
	bstrpick.d	$t2, $t3, 31, 3
	slli.d	$t2, $t2, 3
	xvreplve0.d	$xr1, $xr0
	lu52i.d	$t3, $zero, 1023
...
# %bb.124:                              # %.lr.ph586
	...
	ori	$a7, $zero, 8
	bgeu	$a6, $a7, .LBB3_155
.LBB3_125:                              # %scalar.ph1114.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_126:                              # %scalar.ph1114
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a2, 0
...
# %bb.128:                              # %.lr.ph589
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB3_161
.LBB3_129:                              # %scalar.ph1152.preheader
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a5, $a4, $t3, 2
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB3_130:                              # %scalar.ph1152
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a1, 0
	fld.s	$fa2, $a5, 0
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB3_130
.LBB3_131:                              # %.loopexit557.thread723
	ld.d	$a0, $sp, 344                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Q__align.m)
	st.w	$zero, $a0, 0
	b	.LBB3_148
...
.LBB3_135:                              # %vector.body1071
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_135
# %bb.136:                              # %middle.block1076
	beq	$a2, $a4, .LBB3_140
.LBB3_137:                              # %scalar.ph1064.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_138:                              # %scalar.ph1064
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB3_143:                              # %vector.body1086
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_143
# %bb.144:                              # %middle.block1093
	beq	$a4, $a5, .LBB3_147
.LBB3_145:                              # %scalar.ph1079.preheader
	mul.d	$a4, $a0, $a1
	alsl.d	$a2, $a1, $a2, 2
	sub.d	$a1, $a3, $a1
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB3_146:                              # %scalar.ph1079
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a2, 0
	movgr2fr.w	$fa2, $a4
	ffint.d.w	$fa2, $fa2
...
.LBB3_148:                              # %iter.check1176
	...
	ori	$a5, $zero, 1
	bltu	$a3, $a4, .LBB3_184
# %bb.149:                              # %vector.memcheck1172
	sub.d	$a4, $a0, $t3
	addi.d	$a4, $a4, 4
	ori	$a6, $zero, 64
	bltu	$a4, $a6, .LBB3_184
# %bb.150:                              # %vector.main.loop.iter.check1178
	ori	$a5, $zero, 16
	lu12i.w	$a4, 287172
	bgeu	$a3, $a5, .LBB3_169
# %bb.151:
...
.LBB3_155:                              # %vector.memcheck1096
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_125
# %bb.156:                              # %vector.memcheck1096
	addi.d	$t0, $a1, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a1, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_125
# %bb.157:                              # %vector.memcheck1096
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB3_159:                              # %vector.body1119
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB3_159
# %bb.160:                              # %middle.block1131
	bne	$a6, $t1, .LBB3_125
	b	.LBB3_127
.LBB3_161:                              # %vector.memcheck1134
	addi.d	$a6, $t3, 4
	alsl.d	$t0, $a3, $t3, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
	...
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.162:                              # %vector.memcheck1134
	addi.d	$a7, $a1, 4
	sltu	$a7, $a6, $a7
	sltu	$t1, $a1, $t0
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.163:                              # %vector.memcheck1134
	addi.d	$a7, $a2, 4
	alsl.d	$t1, $a3, $a2, 2
	sltu	$t1, $a6, $t1
	sltu	$t0, $a7, $t0
...
.LBB3_170:                              # %vector.body1184
	...
	addi.d	$a5, $a5, 64
	bnez	$t0, .LBB3_170
# %bb.171:                              # %middle.block1189
	beq	$a3, $a6, .LBB3_186
# %bb.172:                              # %vec.epilog.iter.check1194
	andi	$a5, $a3, 12
	beqz	$a5, .LBB3_183
.LBB3_173:                              # %vec.epilog.ph1193
	move	$a7, $a3
	...
	vreplgr2vr.w	$vr2, $a4
	.p2align	4, , 16
.LBB3_174:                              # %vec.epilog.vector.body1201
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t3, $t1
	vstx	$vr1, $t0, $t1
	...
	addi.d	$t1, $t1, 16
	bnez	$a6, .LBB3_174
# %bb.175:                              # %vec.epilog.middle.block1206
	bne	$a3, $a7, .LBB3_184
	b	.LBB3_186
.LBB3_176:                              # %vector.ph1035
...
.LBB3_183:
	addi.d	$a5, $a6, 1
.LBB3_184:                              # %vec.epilog.scalar.ph1192.preheader
	...
	sub.d	$a2, $a2, $a5
	.p2align	4, , 16
.LBB3_185:                              # %vec.epilog.scalar.ph1192
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a4, $a3
	stx.w	$zero, $a1, $a3
...
.LBB3_190:                              # %._crit_edge622
	...
	ld.d	$a1, $sp, 424                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_220
.LBB3_191:                              # =>This Loop Header: Depth=1
...
# %bb.192:                              #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	bnez	$a0, .LBB3_200
# %bb.193:                              # %clearvec.exit529.thread
                                        #   in Loop: Header=BB3_191 Depth=1
	move	$a0, $t2
	move	$a1, $zero
...
.LBB3_195:                              # %iter.check1219
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB3_198
# %bb.196:                              # %vector.memcheck1210
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$t2, $a0, .LBB3_209
# %bb.197:                              # %vector.memcheck1210
                                        #   in Loop: Header=BB3_191 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a2, $a0, .LBB3_209
...
.LBB3_199:                              # %.lr.ph.i532
	...
	move	$a1, $a3
	bnez	$a2, .LBB3_199
.LBB3_200:                              # %imp_match_out_veadQ.exit537
                                        #   in Loop: Header=BB3_191 Depth=1
	slli.d	$a1, $s8, 2
	fldx.s	$fa0, $t5, $a1
	fst.s	$fa0, $t2, 0
...
# %bb.204:                              #   in Loop: Header=BB3_203 Depth=2
	...
	stx.w	$t0, $a6, $a3
	fmov.s	$fs0, $ft2
.LBB3_205:                              #   in Loop: Header=BB3_203 Depth=2
	add.d	$t0, $s1, $a3
	fld.s	$ft4, $t0, 0
	fldx.s	$ft3, $s4, $a3
	fldx.s	$ft2, $s0, $a3
	...
	bcnez	$fcc0, .LBB3_207
# %bb.206:                              #   in Loop: Header=BB3_203 Depth=2
	ldx.w	$t1, $s2, $a3
	sub.d	$t1, $s8, $t1
	stx.w	$t1, $a6, $a3
	fmov.s	$fs0, $ft4
.LBB3_207:                              #   in Loop: Header=BB3_203 Depth=2
	fld.s	$ft4, $t0, -4
	fmul.s	$ft4, $fa1, $ft4
	fadd.s	$ft4, $ft1, $ft4
	fcmp.cult.s	$fcc0, $ft4, $ft3
	bcnez	$fcc0, .LBB3_202
# %bb.208:                              #   in Loop: Header=BB3_203 Depth=2
	fstx.s	$ft4, $s4, $a3
	stx.w	$t6, $s2, $a3
	b	.LBB3_202
.LBB3_209:                              # %vector.main.loop.iter.check1221
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_211
# %bb.210:                              #   in Loop: Header=BB3_191 Depth=1
	move	$a4, $zero
	b	.LBB3_215
.LBB3_211:                              # %vector.body1225.preheader
                                        #   in Loop: Header=BB3_191 Depth=1
	addi.d	$a0, $t2, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_212:                              # %vector.body1225
                                        #   Parent Loop BB3_191 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB3_212
# %bb.213:                              # %middle.block1234
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_200
# %bb.214:                              # %vec.epilog.iter.check1239
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a4, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB3_218
.LBB3_215:                              # %vec.epilog.ph1238
                                        #   in Loop: Header=BB3_191 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB3_216:                              # %vec.epilog.vector.body1245
                                        #   Parent Loop BB3_191 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB3_216
# %bb.217:                              # %vec.epilog.middle.block1254
                                        #   in Loop: Header=BB3_191 Depth=1
...
.LBB3_219:
	...
	bnez	$a1, .LBB3_235
	b	.LBB3_221
.LBB3_220:                              # %._crit_edge631.loopexit
...
.LBB3_224:                              # %vector.body1272
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_224
# %bb.225:                              # %middle.block1279
	beq	$a2, $a4, .LBB3_228
.LBB3_226:                              # %scalar.ph1263.preheader
	sub.w	$a2, $s8, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_231:                              # %vector.body1291
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_231
# %bb.232:                              # %middle.block1298
	beq	$a3, $a4, .LBB3_235
.LBB3_233:                              # %scalar.ph1282.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_234:                              # %scalar.ph1282
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_252:                              # %vector.body1306
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_252
# %bb.253:                              # %middle.block1313
	beq	$a1, $a3, .LBB3_256
.LBB3_254:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $s2, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
.LBB3_255:                              # %.lr.ph10.i
	...
	addi.d	$a3, $a3, 1
	bnez	$a1, .LBB3_255
.LBB3_256:                              # %.preheader1.i
	ld.d	$a1, $sp, 576
	bltz	$a2, .LBB3_270
# %bb.257:                              # %iter.check1319
	ld.d	$a3, $s2, 0
...
# %bb.258:
	move	$a5, $zero
	b	.LBB3_268
.LBB3_259:                              # %vector.main.loop.iter.check1321
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_261
# %bb.260:
	move	$a5, $zero
	b	.LBB3_265
.LBB3_261:                              # %vector.ph1322
...
.LBB3_262:                              # %vector.body1325
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_262
# %bb.263:                              # %middle.block1331
	beq	$a4, $a5, .LBB3_270
# %bb.264:                              # %vec.epilog.iter.check1336
	andi	$a7, $a6, 12
	beqz	$a7, .LBB3_268
.LBB3_265:                              # %vec.epilog.ph1335
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_266:                              # %vec.epilog.vector.body1343
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_266
# %bb.267:                              # %vec.epilog.middle.block1348
	beq	$a4, $a5, .LBB3_270
.LBB3_268:                              # %vec.epilog.scalar.ph1334.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_269:                              # %vec.epilog.scalar.ph1334
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_278:                              # %vector.body1384
	...
	addi.d	$s5, $s5, -32
	bnez	$s8, .LBB3_278
# %bb.279:                              # %middle.block1391
                                        #   in Loop: Header=BB3_272 Depth=1
	ld.d	$s8, $sp, 160                   # 8-byte Folded Reload
	bne	$s2, $s1, .LBB3_288
	b	.LBB3_290
	.p2align	4, , 16
.LBB3_280:                              #   in Loop: Header=BB3_272 Depth=1
	addi.d	$t1, $s7, -1
	nor	$t7, $t1, $zero
	add.w	$t8, $s7, $t7
	bnez	$t8, .LBB3_275
	.p2align	4, , 16
.LBB3_281:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_272 Depth=1
	beq	$t4, $s8, .LBB3_291
.LBB3_282:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_272 Depth=1
	addi.w	$t7, $zero, -17
	nor	$s0, $t4, $zero
	bltu	$t7, $t4, .LBB3_292
# %bb.283:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_272 Depth=1
	sub.d	$t7, $s3, $s5
	bltu	$t7, $a5, .LBB3_292
# %bb.284:                              # %vector.ph1357
                                        #   in Loop: Header=BB3_272 Depth=1
...
.LBB3_287:                              #   in Loop: Header=BB3_272 Depth=1
	move	$fp, $s5
	move	$s0, $s3
.LBB3_288:                              # %.lr.ph19.i.preheader1399
                                        #   in Loop: Header=BB3_272 Depth=1
	move	$s1, $fp
	move	$s2, $s0
	.p2align	4, , 16
.LBB3_289:                              # %.lr.ph19.i
	...
	move	$s2, $s0
	bnez	$t8, .LBB3_289
.LBB3_290:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB3_272 Depth=1
	add.d	$t3, $s7, $t3
	add.d	$t3, $t7, $t3
	move	$s3, $s0
...
.LBB3_294:                              # %.lr.ph29.i
	...
	addi.d	$t7, $t7, -1
	bnez	$fp, .LBB3_294
.LBB3_295:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_272 Depth=1
	beq	$t0, $ra, .LBB3_298
.LBB3_296:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_272 Depth=1
	ld.d	$fp, $sp, 464                   # 8-byte Folded Reload
	addi.w	$fp, $fp, 0
	beq	$t2, $fp, .LBB3_298
# %bb.297:                              #   in Loop: Header=BB3_272 Depth=1
...
.LBB3_298:                              #   in Loop: Header=BB3_272 Depth=1
	blt	$t0, $a2, .LBB3_303
# %bb.299:                              #   in Loop: Header=BB3_272 Depth=1
	blt	$t2, $a2, .LBB3_303
# %bb.300:                              #   in Loop: Header=BB3_272 Depth=1
	add.d	$a7, $t4, $a7
	addi.d	$s3, $t8, -1
	st.b	$a3, $t8, -1
	addi.d	$s5, $t7, -1
	...
	b	.LBB3_302
	.p2align	4, , 16
.LBB3_301:                              #   in Loop: Header=BB3_272 Depth=1
	addi.d	$t1, $s7, -1
	move	$t4, $s8
	nor	$t7, $t1, $zero
	add.w	$t8, $s7, $t7
...
# %bb.32:
	move	$t2, $zero
.LBB6_33:                               # %scalar.ph983.preheader
	slli.d	$t3, $t2, 2
	sub.d	$t1, $t1, $t2
	vldi	$vr1, -912
	vldi	$vr2, -928
...
.LBB6_51:                               # %.lr.ph.i533
	...
	move	$a2, $a4
	bnez	$a1, .LBB6_51
.LBB6_52:                               # %imp_match_out_veadQ_gapmap.exit
	pcalau12i	$a0, %got_pc_hi20(outgap)
...
# %bb.54:                               # %.lr.ph582
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB6_151
.LBB6_55:                               # %scalar.ph1056.preheader
	alsl.d	$a4, $a6, $a4, 2
	alsl.d	$a3, $a6, $a3, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_56:                               # %scalar.ph1056
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
# %bb.58:                               # %.lr.ph585
	...
	ori	$a5, $zero, 1
	bgeu	$a6, $a7, .LBB6_157
.LBB6_59:                               # %scalar.ph1094.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a6, $a5, $t5, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_60:                               # %scalar.ph1094
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a6, 0
	...
	addi.d	$a6, $a6, 4
	bnez	$a4, .LBB6_60
.LBB6_61:                               # %.loopexit557.thread711
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Q__align_gapmap.m)
	st.w	$zero, $a1, 0
	b	.LBB6_77
.LBB6_62:                               # %.preheader560
	blt	$t4, $a1, .LBB6_69
# %bb.63:                               # %.lr.ph575
	pcalau12i	$a1, %got_pc_hi20(offset)
	ld.d	$a1, $a1, %got_pc_lo12(offset)
...
.LBB6_65:                               # %vector.body1014
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB6_65
# %bb.66:                               # %middle.block1018
	beq	$a3, $a5, .LBB6_69
.LBB6_67:                               # %scalar.ph1007.preheader
	mul.d	$a3, $a1, $a4
	alsl.d	$a5, $a4, $t5, 2
	sub.d	$a2, $a2, $a4
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_68:                               # %scalar.ph1007
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a5, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB6_72:                               # %vector.body1028
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB6_72
# %bb.73:                               # %middle.block1035
	beq	$a5, $a6, .LBB6_76
.LBB6_74:                               # %scalar.ph1021.preheader
	mul.d	$a5, $a1, $a2
	alsl.d	$a3, $a2, $a3, 2
	sub.d	$a2, $a4, $a2
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_75:                               # %scalar.ph1021
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a3, 0
	movgr2fr.w	$fa2, $a5
	ffint.d.w	$fa2, $fa2
...
# %bb.118:                              # %vector.memcheck854
	...
	and	$t7, $t7, $t8
	bnez	$t7, .LBB6_296
# %bb.119:                              # %vector.memcheck854
	alsl.d	$t7, $t1, $a1, 2
	sltu	$t8, $a2, $t7
	sltu	$fp, $a1, $s2
	and	$t8, $t8, $fp
	bnez	$t8, .LBB6_296
# %bb.120:                              # %vector.memcheck854
	alsl.d	$t8, $t1, $a3, 2
	sltu	$fp, $a2, $t8
	sltu	$s3, $a3, $s2
	and	$fp, $fp, $s3
	bnez	$fp, .LBB6_296
# %bb.121:                              # %vector.memcheck854
	alsl.d	$fp, $t1, $a7, 2
	sltu	$s3, $a2, $fp
	sltu	$s2, $a7, $s2
	and	$s2, $s3, $s2
	bnez	$s2, .LBB6_296
# %bb.122:                              # %vector.memcheck854
	sltu	$s2, $a4, $s0
	sltu	$s3, $a5, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.123:                              # %vector.memcheck854
	sltu	$s2, $a4, $t5
	sltu	$s3, $a6, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.124:                              # %vector.memcheck854
	sltu	$s2, $a4, $t4
	sltu	$s3, $t0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.125:                              # %vector.memcheck854
	sltu	$s2, $a4, $t6
	sltu	$s3, $a0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.126:                              # %vector.memcheck854
	sltu	$s2, $a4, $t7
	sltu	$s3, $a1, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.127:                              # %vector.memcheck854
	sltu	$s2, $a4, $t8
	sltu	$s3, $a3, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.128:                              # %vector.memcheck854
	sltu	$s2, $a4, $fp
	sltu	$s1, $a7, $s1
	and	$s1, $s2, $s1
	bnez	$s1, .LBB6_296
# %bb.129:                              # %vector.memcheck854
	sltu	$s1, $a5, $t5
	sltu	$s2, $a6, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.130:                              # %vector.memcheck854
	sltu	$s1, $a5, $t4
	sltu	$s2, $t0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.131:                              # %vector.memcheck854
	sltu	$s1, $a5, $t6
	sltu	$s2, $a0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.132:                              # %vector.memcheck854
	sltu	$s1, $a5, $t7
	sltu	$s2, $a1, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.133:                              # %vector.memcheck854
	sltu	$s1, $a5, $t8
	sltu	$s2, $a3, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.134:                              # %vector.memcheck854
	sltu	$s1, $a5, $fp
	sltu	$s0, $a7, $s0
	and	$s0, $s1, $s0
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	bnez	$s0, .LBB6_33
# %bb.135:                              # %vector.memcheck854
	sltu	$s0, $a6, $t4
	sltu	$s1, $t0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.136:                              # %vector.memcheck854
	sltu	$s0, $a6, $t6
	sltu	$s1, $a0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.137:                              # %vector.memcheck854
	sltu	$s0, $a6, $t7
	sltu	$s1, $a1, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.138:                              # %vector.memcheck854
	sltu	$s0, $a6, $t8
	sltu	$s1, $a3, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.139:                              # %vector.memcheck854
	sltu	$s0, $a6, $fp
	sltu	$t5, $a7, $t5
	and	$t5, $s0, $t5
	bnez	$t5, .LBB6_33
# %bb.140:                              # %vector.memcheck854
	sltu	$t5, $t0, $t6
	sltu	$t6, $a0, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_33
# %bb.141:                              # %vector.memcheck854
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_33
# %bb.142:                              # %vector.memcheck854
	sltu	$t5, $t0, $t8
	sltu	$t6, $a3, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_33
# %bb.143:                              # %vector.memcheck854
	sltu	$t5, $t0, $fp
	sltu	$t4, $a7, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB6_33
...
.LBB6_145:                              # %vector.body990
	...
	addi.d	$t3, $t3, 32
	bnez	$s5, .LBB6_145
# %bb.146:                              # %middle.block1004
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
	bne	$t1, $t2, .LBB6_33
	b	.LBB6_35
.LBB6_147:                              # %clearvec.exit.thread
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	sltui	$a0, $a0, 1
	st.d	$a0, $sp, 144                   # 8-byte Folded Spill
	ld.d	$t4, $sp, 352                   # 8-byte Folded Reload
...
.LBB6_151:                              # %vector.memcheck1038
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_55
# %bb.152:                              # %vector.memcheck1038
	addi.d	$t1, $a2, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a2, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_55
# %bb.153:                              # %vector.memcheck1038
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB6_155:                              # %vector.body1061
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB6_155
# %bb.156:                              # %middle.block1073
	bne	$a7, $t2, .LBB6_55
	b	.LBB6_57
.LBB6_157:                              # %vector.memcheck1076
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB6_59
# %bb.158:                              # %vector.memcheck1076
	addi.d	$t0, $a2, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a2, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB6_59
# %bb.159:                              # %vector.memcheck1076
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB6_161:                              # %vector.body1099
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB6_161
# %bb.162:                              # %middle.block1111
	bne	$a6, $t1, .LBB6_59
	b	.LBB6_61
.LBB6_163:                              # %vector.ph1119
	move	$a6, $zero
	move	$a7, $a4
...
.LBB6_198:                              # %vector.body1150
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_198
# %bb.199:                              # %middle.block1157
	beq	$a2, $a4, .LBB6_202
.LBB6_200:                              # %scalar.ph1141.preheader
	ld.d	$a2, $sp, 320                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t5, 2
...
.LBB6_205:                              # %vector.body1169
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_205
# %bb.206:                              # %middle.block1176
	beq	$a3, $a4, .LBB6_209
.LBB6_207:                              # %scalar.ph1160.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_208:                              # %scalar.ph1160
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
# %bb.232:
	move	$a4, $zero
	b	.LBB6_242
.LBB6_233:                              # %vector.main.loop.iter.check1199
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_235
# %bb.234:
	move	$a4, $zero
	b	.LBB6_239
.LBB6_235:                              # %vector.ph1200
	bstrpick.d	$a4, $a5, 31, 4
	slli.d	$a4, $a4, 4
...
.LBB6_236:                              # %vector.body1203
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB6_236
# %bb.237:                              # %middle.block1209
	beq	$a3, $a4, .LBB6_244
# %bb.238:                              # %vec.epilog.iter.check1214
	andi	$a6, $a5, 12
	beqz	$a6, .LBB6_242
.LBB6_239:                              # %vec.epilog.ph1213
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_240:                              # %vec.epilog.vector.body1221
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_240
# %bb.241:                              # %vec.epilog.middle.block1226
	beq	$a3, $a4, .LBB6_244
.LBB6_242:                              # %vec.epilog.scalar.ph1212.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_243:                              # %vec.epilog.scalar.ph1212
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
