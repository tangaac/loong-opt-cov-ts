...
.LBB0_15:
	move	$a2, $zero
.LBB0_16:                               # %scalar.ph278.preheader
	slli.d	$a3, $a2, 3
	alsl.d	$a3, $s1, $a3, 3
	add.d	$a0, $a0, $a3
	alsl.d	$a1, $a2, $a1, 3
...
.LBB0_24:                               # %vector.body296
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_24
# %bb.25:                               # %middle.block300
	beq	$a2, $a4, .LBB0_28
.LBB0_26:                               # %scalar.ph291.preheader
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	alsl.d	$a2, $a3, $a2, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr1, -928
	.p2align	4, , 16
.LBB0_27:                               # %scalar.ph291
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa2, $a2, 0
	fcvt.d.s	$fa2, $fa2
...
# %bb.32:                               # %middle.block315
	beq	$a3, $a4, .LBB0_36
.LBB0_33:                               # %scalar.ph303.preheader
	alsl.d	$a3, $a1, $s7, 2
	sub.d	$a1, $a2, $a1
	vldi	$vr1, -928
	.p2align	4, , 16
.LBB0_34:                               # %scalar.ph303
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa2, $a3, 0
	fcvt.d.s	$fa2, $fa2
	fmadd.d	$fa2, $fa0, $fa1, $fa2
...
# %bb.37:
	move	$a3, $zero
.LBB0_38:                               # %scalar.ph325.preheader
	alsl.d	$a4, $a3, $s7, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a2, $a3, $a2, 2
...
.LBB0_86:                               # %vector.body283
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_86
# %bb.87:                               # %middle.block288
	beq	$a2, $fp, .LBB0_18
	b	.LBB0_16
.LBB0_88:                               # %vector.ph356
