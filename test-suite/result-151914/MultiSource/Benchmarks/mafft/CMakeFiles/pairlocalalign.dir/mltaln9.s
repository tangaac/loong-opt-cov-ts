...
# %bb.5:                                # %.lr.ph87.us.us.preheader
	...
	b	.LBB8_7
	.p2align	4, , 16
.LBB8_6:                                # %._crit_edge88.us.us
                                        #   in Loop: Header=BB8_7 Depth=2
	fmadd.d	$fa1, $fa4, $fa2, $fa1
	addi.d	$t8, $t8, 1
	fst.d	$fa1, $a7, 0
	beq	$t8, $a5, .LBB8_3
.LBB8_7:                                # %.lr.ph87.us.us
...
# %bb.5:                                # %.lr.ph75.us.us.preheader
	...
	b	.LBB9_7
	.p2align	4, , 16
.LBB9_6:                                # %._crit_edge76.us.us
                                        #   in Loop: Header=BB9_7 Depth=2
	fmadd.d	$fa1, $fa4, $fa2, $fa1
	addi.d	$t7, $t7, 1
	fst.d	$fa1, $a7, 0
	beq	$t7, $a5, .LBB9_3
.LBB9_7:                                # %.lr.ph75.us.us
...
# %bb.40:                               # %vec.epilog.middle.block
	beq	$a2, $s1, .LBB19_43
.LBB19_41:                              # %vec.epilog.scalar.ph.preheader
	alsl.d	$a1, $a2, $a1, 2
	alsl.d	$a0, $a2, $a0, 2
	sub.d	$a2, $s1, $a2
	addi.w	$a3, $zero, -1
...
.LBB19_54:                              # %._crit_edge347
	...
	beq	$s5, $a2, .LBB19_61
# %bb.55:                               #   in Loop: Header=BB19_47 Depth=1
	slli.d	$a2, $s5, 3
	ldx.d	$a2, $s6, $a2
	ld.d	$a5, $a2, 0
	ld.d	$a6, $a2, 8
...
.LBB19_57:                              # %.lr.ph353
	...
	addi.d	$a5, $a5, 4
	bne	$a4, $a2, .LBB19_57
# %bb.58:                               # %.preheader320.loopexit
                                        #   in Loop: Header=BB19_47 Depth=1
	ld.w	$a4, $a3, 0
	beq	$a4, $a2, .LBB19_63
.LBB19_59:                              # %.lr.ph358.preheader
                                        #   in Loop: Header=BB19_47 Depth=1
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB19_60:                              # %.lr.ph358
...
.LBB19_65:                              #   in Loop: Header=BB19_47 Depth=1
	...
	st.d	$a0, $a1, 8
	beqz	$a0, .LBB19_108
# %bb.66:                               #   in Loop: Header=BB19_47 Depth=1
	addi.w	$s1, $zero, -1
	beq	$s5, $s1, .LBB19_73
# %bb.67:                               #   in Loop: Header=BB19_47 Depth=1
	slli.d	$a1, $s5, 3
	ld.d	$a2, $sp, 160                   # 8-byte Folded Reload
	ldx.d	$a1, $a2, $a1
	ld.d	$a3, $a1, 0
...
.LBB19_72:                              # %.lr.ph370
	...
	b	.LBB19_76
	.p2align	4, , 16
.LBB19_73:                              #   in Loop: Header=BB19_47 Depth=1
	st.w	$fp, $a0, 0
	move	$a1, $s1
	lu32i.d	$a1, 0
	st.w	$a1, $a0, 4
...
.LBB19_75:                              #   in Loop: Header=BB19_47 Depth=1
	move	$a3, $a0
.LBB19_76:                              # %._crit_edge371
                                        #   in Loop: Header=BB19_47 Depth=1
	move	$a0, $s1
	lu32i.d	$a0, 0
	st.w	$a0, $a3, 0
.LBB19_77:                              #   in Loop: Header=BB19_47 Depth=1
...
# %bb.78:                               # %.lr.ph377
	...
	b	.LBB19_80
	.p2align	4, , 16
.LBB19_79:                              #   in Loop: Header=BB19_80 Depth=2
	ld.d	$s8, $s8, 0
	beqz	$s8, .LBB19_90
.LBB19_80:                              #   Parent Loop BB19_47 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$s5, $s8, 16
	beq	$s5, $s7, .LBB19_79
...
# %bb.82:                               #   in Loop: Header=BB19_80 Depth=2
	...
	move	$a4, $s5
	blt	$s5, $s7, .LBB19_84
# %bb.83:                               #   in Loop: Header=BB19_80 Depth=2
	slt	$a0, $fp, $s5
	masknez	$a1, $fp, $a0
	maskeqz	$a0, $s5, $a0
	or	$a0, $a0, $a1
	...
	move	$a3, $s5
	move	$a4, $s7
.LBB19_84:                              #   in Loop: Header=BB19_80 Depth=2
	slli.d	$s0, $a2, 3
	ldx.d	$a2, $s2, $s0
	sub.w	$a3, $a3, $a4
	slli.d	$s4, $a3, 2
	...
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	bceqz	$fcc0, .LBB19_87
# %bb.85:                               #   in Loop: Header=BB19_80 Depth=2
	fld.s	$fa1, $s6, 0
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bceqz	$fcc0, .LBB19_88
.LBB19_86:                              #   in Loop: Header=BB19_80 Depth=2
	ldx.w	$a0, $a2, $a0
	bne	$a0, $fp, .LBB19_79
	b	.LBB19_89
	.p2align	4, , 16
.LBB19_87:                              #   in Loop: Header=BB19_80 Depth=2
	...
	fcmp.cule.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB19_86
.LBB19_88:                              #   in Loop: Header=BB19_80 Depth=2
	fst.s	$fa0, $s6, 0
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	st.w	$s5, $a1, 0
	ldx.w	$a0, $a2, $a0
...
.LBB19_89:                              #   in Loop: Header=BB19_80 Depth=2
	...
	b	.LBB19_79
	.p2align	4, , 16
.LBB19_90:                              # %._crit_edge378.loopexit
                                        #   in Loop: Header=BB19_47 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$s5, $sp, 128                   # 8-byte Folded Reload
.LBB19_91:                              # %._crit_edge378
                                        #   in Loop: Header=BB19_47 Depth=1
	...
	st.d	$a1, $a0, 0
	beqz	$a1, .LBB19_93
# %bb.92:                               #   in Loop: Header=BB19_47 Depth=1
	st.d	$a0, $a1, 8
.LBB19_93:                              #   in Loop: Header=BB19_47 Depth=1
	ldx.d	$a0, $s2, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s5, %pc_lo12(fixed_musclesupg_float_realloc_nobk_halfmtx_treeout.ac)
...
# %bb.98:                               # %.lr.ph.i308
	...
	b	.LBB19_100
	.p2align	4, , 16
.LBB19_99:                              #   in Loop: Header=BB19_100 Depth=3
	ld.d	$a5, $a5, 0
	beqz	$a5, .LBB19_103
.LBB19_100:                             #   Parent Loop BB19_47 Depth=1
	...
	bcnez	$fcc0, .LBB19_99
# %bb.101:                              #   in Loop: Header=BB19_100 Depth=3
	fst.s	$fa1, $a4, 0
	st.w	$a7, $a3, 0
	fmov.s	$fa0, $fa1
	b	.LBB19_99
.LBB19_102:                             #   in Loop: Header=BB19_96 Depth=2
	fld.s	$fa0, $fp, %pc_lo12(.LCPI19_0)
.LBB19_103:                             # %.lr.ph42.i315.preheader
                                        #   in Loop: Header=BB19_96 Depth=2
	move	$a5, $a0
	b	.LBB19_105
	.p2align	4, , 16
.LBB19_104:                             #   in Loop: Header=BB19_105 Depth=3
	ld.d	$a5, $a5, 0
	beqz	$a5, .LBB19_95
.LBB19_105:                             # %.lr.ph42.i315
                                        #   Parent Loop BB19_47 Depth=1
                                        #     Parent Loop BB19_96 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a6, $a5, 16
...
# %bb.107:                              #   in Loop: Header=BB19_105 Depth=3
	fst.s	$fa1, $a4, 0
	st.w	$a6, $a3, 0
	fmov.s	$fa0, $fa1
	b	.LBB19_104
...
.LBB29_16:                              # %vector.body288
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB29_16
# %bb.17:                               # %middle.block291
	beq	$a0, $fp, .LBB29_20
.LBB29_18:                              # %scalar.ph283.preheader
	addi.d	$a2, $a0, -1
	alsl.d	$a3, $a0, $a1, 3
	addi.d	$a3, $a3, 4
	sub.d	$a0, $fp, $a0
	.p2align	4, , 16
.LBB29_19:                              # %scalar.ph283
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a4, $a2, 2
	st.w	$a4, $a3, -4
	st.w	$a2, $a3, 0
...
# %bb.2:                                # %.preheader30.us.preheader
	...
	b	.LBB50_5
	.p2align	4, , 16
.LBB50_3:                               # %._crit_edge36.us
                                        #   in Loop: Header=BB50_5 Depth=1
	slli.d	$a4, $a2, 2
	stx.w	$a1, $fp, $a4
	addi.w	$a2, $a2, 1
.LBB50_4:                               # %._crit_edge.us.thread
                                        #   in Loop: Header=BB50_5 Depth=1
	addi.d	$a1, $a1, 1
	beq	$a1, $a0, .LBB50_25
.LBB50_5:                               # %.preheader30.us
                                        # =>This Loop Header: Depth=1
...
# %bb.2:                                # %.preheader27.us.preheader
	...
	b	.LBB51_5
	.p2align	4, , 16
.LBB51_3:                               # %._crit_edge33.us
                                        #   in Loop: Header=BB51_5 Depth=1
	addi.w	$a2, $a2, 1
.LBB51_4:                               # %._crit_edge.us.thread
                                        #   in Loop: Header=BB51_5 Depth=1
	addi.d	$a1, $a1, 1
	beq	$a1, $a0, .LBB51_11
.LBB51_5:                               # %.preheader27.us
                                        # =>This Loop Header: Depth=1
...
.LBB55_14:                              #   in Loop: Header=BB55_9 Depth=3
	bne	$t6, $a6, .LBB55_8
# %bb.15:                               # %.preheader94.preheader
                                        #   in Loop: Header=BB55_9 Depth=3
	addi.d	$t7, $t5, -1
	add.d	$t6, $t4, $t5
	move	$t5, $t7
	.p2align	4, , 16
.LBB55_16:                              # %.preheader94
                                        #   Parent Loop BB55_4 Depth=1
                                        #     Parent Loop BB55_6 Depth=2
                                        #       Parent Loop BB55_9 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.22:                               # %iter.check315
	...
	ori	$a3, $zero, 4
	bltu	$a6, $a3, .LBB66_34
# %bb.23:                               # %vector.main.loop.iter.check317
                                        #   in Loop: Header=BB66_19 Depth=4
...
.LBB66_26:                              # %vector.body325
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB66_26
# %bb.27:                               # %middle.block332
                                        #   in Loop: Header=BB66_19 Depth=4
	beq	$a6, $a3, .LBB66_18
# %bb.28:                               # %vec.epilog.iter.check338
                                        #   in Loop: Header=BB66_19 Depth=4
	andi	$t0, $a3, 12
	beqz	$t0, .LBB66_33
.LBB66_29:                              # %vec.epilog.ph337
                                        #   in Loop: Header=BB66_19 Depth=4
	...
	sub.d	$a5, $a6, $t0
	.p2align	4, , 16
.LBB66_30:                              # %vec.epilog.vector.body348
                                        #   Parent Loop BB66_5 Depth=1
                                        #     Parent Loop BB66_7 Depth=2
                                        #       Parent Loop BB66_9 Depth=3
                                        #         Parent Loop BB66_19 Depth=4
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB66_30
# %bb.31:                               # %vec.epilog.middle.block355
                                        #   in Loop: Header=BB66_19 Depth=4
	bne	$t0, $a3, .LBB66_34
	b	.LBB66_18
.LBB66_32:                              #   in Loop: Header=BB66_19 Depth=4
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
...
# %bb.50:                               # %vec.epilog.middle.block
	...
	bne	$t0, $a3, .LBB66_53
	b	.LBB66_37
.LBB66_51:                              #   in Loop: Header=BB66_38 Depth=4
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	pcalau12i	$a1, %pc_hi20(.L.str.32)
