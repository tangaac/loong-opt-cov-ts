...
.LBB4_19:
	move	$a2, $zero
.LBB4_20:                               # %scalar.ph606.preheader
	slli.d	$a3, $a2, 3
	alsl.d	$a3, $s1, $a3, 3
	add.d	$a0, $a0, $a3
	alsl.d	$a1, $a2, $a1, 3
...
# %bb.34:                               # %vector.memcheck619
	alsl.d	$a4, $a2, $a3, 2
	bgeu	$a1, $a4, .LBB4_157
# %bb.35:                               # %vector.memcheck619
	alsl.d	$a4, $a2, $a1, 2
	bgeu	$a3, $a4, .LBB4_157
.LBB4_36:
	move	$a4, $zero
.LBB4_37:                               # %scalar.ph621.preheader
	alsl.d	$a3, $a4, $a3, 2
	alsl.d	$a1, $a4, $a1, 2
	sub.d	$a2, $a2, $a4
	vldi	$vr1, -912
...
# %bb.41:                               # %vector.memcheck634
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB4_160
# %bb.42:                               # %vector.memcheck634
	alsl.d	$a3, $a1, $a0, 2
	bgeu	$a2, $a3, .LBB4_160
.LBB4_43:
	move	$a3, $zero
.LBB4_44:                               # %scalar.ph640.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr1, -912
...
# %bb.60:                               # %iter.check741
	...
	ori	$a4, $zero, 1
	bltu	$a5, $a3, .LBB4_170
.LBB4_61:                               # %vec.epilog.scalar.ph759.preheader
	alsl.d	$a2, $a4, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a3, $a4, $t3, 2
	sub.d	$a1, $a1, $a4
	.p2align	4, , 16
.LBB4_62:                               # %vec.epilog.scalar.ph759
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
.LBB4_66:                               # %vector.body662
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_66
# %bb.67:                               # %middle.block666
	beq	$a2, $a4, .LBB4_70
.LBB4_68:                               # %scalar.ph655.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB4_69:                               # %scalar.ph655
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB4_73:                               # %vector.body676
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_73
# %bb.74:                               # %middle.block683
	beq	$a3, $a4, .LBB4_77
.LBB4_75:                               # %scalar.ph669.preheader
	mul.d	$a3, $a0, $a1
...
.LBB4_78:                               # %iter.check793
	...
	ori	$a5, $zero, 1
	bgeu	$a4, $a7, .LBB4_82
.LBB4_79:                               # %vec.epilog.scalar.ph809.preheader
	alsl.d	$a4, $a5, $t3, 2
	addi.d	$a4, $a4, -4
	alsl.d	$a1, $a5, $a1, 2
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $a3, $a5
	.p2align	4, , 16
.LBB4_80:                               # %vec.epilog.scalar.ph809
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fld.s	$fa1, $a0, 0
	fadd.s	$fa0, $fa0, $fa1
...
.LBB4_82:                               # %vector.memcheck778
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB4_79
# %bb.83:                               # %vector.memcheck778
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB4_79
# %bb.84:                               # %vector.main.loop.iter.check795
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_232
# %bb.85:
	move	$a6, $zero
...
.LBB4_107:                              # %vector.body836
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_107
# %bb.108:                              # %middle.block843
	beq	$a2, $a4, .LBB4_111
.LBB4_109:                              # %scalar.ph827.preheader
	sub.w	$a2, $t4, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB4_114:                              # %vector.body855
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB4_114
# %bb.115:                              # %middle.block862
	beq	$a2, $a3, .LBB4_118
.LBB4_116:                              # %scalar.ph846.preheader
	alsl.d	$a2, $a0, $s5, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_117:                              # %scalar.ph846
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.146:
	move	$a5, $zero
	b	.LBB4_191
.LBB4_147:                              # %vector.main.loop.iter.check936
	ori	$a2, $zero, 16
	bgeu	$a4, $a2, .LBB4_184
# %bb.148:
	move	$a5, $zero
...
.LBB4_161:                              # %vector.body647
	...
	addi.d	$a4, $a4, 32
	bnez	$a6, .LBB4_161
# %bb.162:                              # %middle.block652
	beq	$a1, $a3, .LBB4_46
	b	.LBB4_44
.LBB4_163:                              # %vector.ph608
	slli.d	$a4, $s1, 3
...
.LBB4_164:                              # %vector.body611
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_164
# %bb.165:                              # %middle.block616
	beq	$a2, $fp, .LBB4_22
	b	.LBB4_20
.LBB4_166:                              # %vector.memcheck686
...
# %bb.171:                              # %vector.memcheck726
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB4_61
# %bb.172:                              # %vector.main.loop.iter.check743
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_301
# %bb.173:
	move	$a5, $zero
	b	.LBB4_305
.LBB4_174:                              # %vector.ph867
	pcalau12i	$a5, %pc_hi20(.LCPI4_5)
	vld	$vr0, $a5, %pc_lo12(.LCPI4_5)
...
# %bb.181:
	move	$a4, $zero
	b	.LBB4_246
.LBB4_182:                              # %vector.main.loop.iter.check885
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_239
# %bb.183:
	move	$a4, $zero
	b	.LBB4_243
.LBB4_184:                              # %vector.ph937
...
.LBB4_185:                              # %vector.body940
	...
	addi.d	$a2, $a2, 64
	bnez	$a7, .LBB4_185
# %bb.186:                              # %middle.block946
	beq	$a4, $a5, .LBB4_193
# %bb.187:                              # %vec.epilog.iter.check951
	andi	$a2, $a6, 12
	beqz	$a2, .LBB4_191
.LBB4_188:                              # %vec.epilog.ph950
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_189:                              # %vec.epilog.vector.body959
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a2, .LBB4_189
# %bb.190:                              # %vec.epilog.middle.block964
	beq	$a4, $a5, .LBB4_193
.LBB4_191:                              # %vec.epilog.scalar.ph949.preheader
	alsl.d	$a2, $a5, $a3, 2
	nor	$a3, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_192:                              # %vec.epilog.scalar.ph949
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a4, $a4, -1
...
.LBB4_233:                              # %vector.body799
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_233
# %bb.234:                              # %middle.block806
	beq	$a4, $a6, .LBB4_81
# %bb.235:                              # %vec.epilog.iter.check811
	andi	$a5, $a4, 12
	beqz	$a5, .LBB4_308
.LBB4_236:                              # %vec.epilog.ph810
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB4_237:                              # %vec.epilog.vector.body816
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB4_237
# %bb.238:                              # %vec.epilog.middle.block823
	bne	$a4, $a7, .LBB4_79
	b	.LBB4_81
.LBB4_239:                              # %vector.ph886
...
.LBB4_240:                              # %vector.body889
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_240
# %bb.241:                              # %middle.block895
	beq	$a3, $a4, .LBB4_248
# %bb.242:                              # %vec.epilog.iter.check900
	andi	$a6, $a5, 12
	beqz	$a6, .LBB4_246
.LBB4_243:                              # %vec.epilog.ph899
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_244:                              # %vec.epilog.vector.body907
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_244
# %bb.245:                              # %vec.epilog.middle.block912
	beq	$a3, $a4, .LBB4_248
.LBB4_246:                              # %vec.epilog.scalar.ph898.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_247:                              # %vec.epilog.scalar.ph898
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB4_302:                              # %vector.body747
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_302
# %bb.303:                              # %middle.block756
	beq	$a3, $a5, .LBB4_78
# %bb.304:                              # %vec.epilog.iter.check761
	andi	$a4, $a3, 12
	beqz	$a4, .LBB4_310
.LBB4_305:                              # %vec.epilog.ph760
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_306:                              # %vec.epilog.vector.body766
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB4_306
# %bb.307:                              # %vec.epilog.middle.block774
	bne	$a3, $a6, .LBB4_61
	b	.LBB4_78
.LBB4_308:
	addi.d	$a5, $a6, 1
