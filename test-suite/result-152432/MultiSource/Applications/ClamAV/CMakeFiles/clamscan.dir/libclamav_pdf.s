...
.LBB0_78:                               #   in Loop: Header=BB0_64 Depth=2
	...
	st.d	$a0, $sp, 80                    # 8-byte Folded Spill
	addi.d	$s7, $s8, 9
.LBB0_79:                               #   Parent Loop BB0_50 Depth=1
                                        #     Parent Loop BB0_64 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.b	$a0, $s7, 2
	slli.d	$a0, $a0, 1
...
.LBB0_84:                               #   in Loop: Header=BB0_64 Depth=2
	...
	ori	$s6, $zero, 47
	ld.d	$s0, $sp, 96                    # 8-byte Folded Reload
.LBB0_85:                               #   in Loop: Header=BB0_64 Depth=2
	addi.d	$s7, $s7, 4
...
.LBB0_87:                               #   in Loop: Header=BB0_50 Depth=1
	...
	move	$s5, $zero
	b	.LBB0_94
.LBB0_88:                               #   in Loop: Header=BB0_50 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_96
# %bb.89:                               #   in Loop: Header=BB0_50 Depth=1
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	bnez	$a0, .LBB0_91
# %bb.90:                               #   in Loop: Header=BB0_50 Depth=1
...
# %bb.97:                               #   in Loop: Header=BB0_50 Depth=1
	...
	bnez	$a0, .LBB0_99
# %bb.98:                               #   in Loop: Header=BB0_50 Depth=1
...
# %bb.101:                              #   in Loop: Header=BB0_50 Depth=1
	...
	move	$s5, $a0
	bnez	$a0, .LBB0_103
# %bb.102:                              #   in Loop: Header=BB0_50 Depth=1
...
# %bb.107:                              #   in Loop: Header=BB0_50 Depth=1
	move	$s5, $a0
	b	.LBB0_109
.LBB0_108:                              #   in Loop: Header=BB0_50 Depth=1
	ld.bu	$a1, $s5, -2
	addi.d	$a2, $s5, -2
	addi.d	$a1, $a1, -13
	sltui	$a1, $a1, 1
...
.LBB0_109:                              #   in Loop: Header=BB0_50 Depth=1
	bgeu	$s7, $s5, .LBB0_119
# %bb.110:                              #   in Loop: Header=BB0_50 Depth=1
	sub.w	$s8, $s5, $s7
	beq	$s8, $s1, .LBB0_112
...
# %bb.113:                              #   in Loop: Header=BB0_50 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_148
# %bb.114:                              #   in Loop: Header=BB0_50 Depth=1
	move	$s1, $a0
	move	$a0, $s7
	move	$a1, $s8
	move	$a2, $s1
	...
	move	$s5, $a0
	beqz	$a0, .LBB0_122
# %bb.115:                              #   in Loop: Header=BB0_50 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	beq	$s5, $a0, .LBB0_146
# %bb.116:                              #   in Loop: Header=BB0_50 Depth=1
	move	$a0, $s1
	move	$a1, $s8
...
# %bb.118:                              #   in Loop: Header=BB0_50 Depth=1
	...
	move	$s5, $a0
	b	.LBB0_125
.LBB0_119:                              #   in Loop: Header=BB0_50 Depth=1
	move	$a0, $s6
	...
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
	b	.LBB0_94
.LBB0_120:                              #   in Loop: Header=BB0_50 Depth=1
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	beqz	$a0, .LBB0_123
# %bb.121:                              #   in Loop: Header=BB0_50 Depth=1
	move	$a0, $s7
	move	$a1, $s1
	move	$a2, $s8
	move	$a3, $s6
...
.LBB0_122:                              #   in Loop: Header=BB0_50 Depth=1
	move	$s0, $s1
	b	.LBB0_125
.LBB0_123:                              #   in Loop: Header=BB0_50 Depth=1
	...
	move	$s5, $zero
	b	.LBB0_126
.LBB0_124:                              #   in Loop: Header=BB0_50 Depth=1
	move	$a0, $s6
	move	$a1, $s7
	move	$a2, $s5
	pcaddu18i	$ra, %call36(cli_writen)
...
.LBB0_125:                              # %.thread391
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_126:                              #   in Loop: Header=BB0_50 Depth=1
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
	move	$a0, $s6
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
	...
	jirl	$ra, $ra, 0
	bltz	$a0, .LBB0_128
# %bb.127:                              #   in Loop: Header=BB0_50 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB0_129
.LBB0_128:                              #   in Loop: Header=BB0_50 Depth=1
	ori	$a2, $zero, 1
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	move	$a1, $s0
...
.LBB0_129:                              #   in Loop: Header=BB0_50 Depth=1
	...
	beqz	$a0, .LBB0_93
# %bb.130:                              #   in Loop: Header=BB0_50 Depth=1
	ld.w	$a1, $a0, 4
	addi.w	$a0, $a1, -1
	ld.d	$s0, $sp, 64                    # 8-byte Folded Reload
	bgeu	$a0, $s1, .LBB0_94
...
# %bb.45:
	...
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	b	.LBB4_56
.LBB4_46:                               # %vector.main.loop.iter.check226
	addi.d	$a1, $s1, -1
	bstrpick.d	$a1, $a1, 31, 0
	ori	$a3, $zero, 33
...
.LBB4_49:                               # %vector.body230
	...
	xvreplgr2vr.b	$xr10, $a6
	xvpermi.q	$xr10, $xr8, 48
	xvextrins.b	$xr8, $xr10, 17
	xvpickve2gr.w	$a6, $xr9, 2
	xvreplgr2vr.b	$xr10, $a6
	xvpermi.q	$xr10, $xr8, 48
	xvextrins.b	$xr8, $xr10, 34
	xvpickve2gr.w	$a6, $xr9, 3
	xvreplgr2vr.b	$xr10, $a6
	xvpermi.q	$xr10, $xr8, 48
	xvextrins.b	$xr8, $xr10, 51
	...
	xvreplgr2vr.b	$xr10, $a6
	xvpermi.q	$xr10, $xr8, 48
	xvextrins.b	$xr8, $xr10, 85
	xvpickve2gr.w	$a6, $xr9, 6
	xvreplgr2vr.b	$xr10, $a6
	xvpermi.q	$xr10, $xr8, 48
	xvextrins.b	$xr8, $xr10, 102
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB4_49
# %bb.50:                               # %middle.block233
	beq	$a3, $a1, .LBB4_27
# %bb.51:                               # %vec.epilog.iter.check239
	andi	$a4, $a1, 24
	beqz	$a4, .LBB4_55
.LBB4_52:                               # %vec.epilog.ph238
	...
	sub.d	$a5, $a3, $a4
	add.d	$a3, $a6, $a3
.LBB4_53:                               # %vec.epilog.vector.body248
                                        # =>This Inner Loop Header: Depth=1
	xvslli.w	$xr3, $xr2, 3
	xvsub.w	$xr3, $xr1, $xr3
	xvsrl.w	$xr3, $xr0, $xr3
	...
	addi.d	$a3, $a3, 8
	bnez	$a5, .LBB4_53
# %bb.54:                               # %vec.epilog.middle.block254
	beq	$a4, $a1, .LBB4_27
	b	.LBB4_56
.LBB4_55:
