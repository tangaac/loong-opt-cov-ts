...
.LBB1_58:
	move	$a0, $zero
	b	.LBB1_94
.LBB1_59:                               # %.preheader155.split.us.preheader
	beqz	$a0, .LBB1_95
# %bb.60:
	ld.d	$a4, $a4, 0
	alsl.d	$a2, $a3, $a4, 1
...
# %bb.89:                               #   in Loop: Header=BB2_86 Depth=1
	...
	b	.LBB2_94
	.p2align	4, , 16
.LBB2_90:                               # %vector.ph766
                                        #   in Loop: Header=BB2_86 Depth=1
	xvreplgr2vr.h	$xr0, $s0
	move	$s1, $a7
	move	$s2, $a4
	.p2align	4, , 16
.LBB2_91:                               # %vector.body769
...
# %bb.103:                              #   in Loop: Header=BB2_102 Depth=1
	...
	b	.LBB2_107
	.p2align	4, , 16
.LBB2_104:                              # %vector.body732.preheader
                                        #   in Loop: Header=BB2_102 Depth=1
	move	$s0, $t3
	move	$s1, $t4
	.p2align	4, , 16
.LBB2_105:                              # %vector.body732
	...
	addi.d	$s1, $s1, 64
	bnez	$s0, .LBB2_105
# %bb.106:                              # %middle.block735
                                        #   in Loop: Header=BB2_102 Depth=1
	move	$s1, $t3
	beq	$t3, $t1, .LBB2_101
.LBB2_107:                              # %scalar.ph727.preheader
                                        #   in Loop: Header=BB2_102 Depth=1
	sub.d	$s0, $t1, $s1
	slli.d	$s1, $s1, 5
	add.d	$s1, $t5, $s1
	.p2align	4, , 16
.LBB2_108:                              # %scalar.ph727
                                        #   Parent Loop BB2_102 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$t8, $s1, 0
	addi.d	$s0, $s0, -1
...
.LBB2_109:                              # %.split500.us
	...
	b	.LBB2_111
	.p2align	4, , 16
.LBB2_110:                              # %._crit_edge493.us.us.1618
                                        #   in Loop: Header=BB2_111 Depth=1
	addi.d	$t3, $t3, 1
	addi.d	$fp, $fp, 2
	addi.d	$a5, $a5, 2
	beq	$t3, $a0, .LBB2_117
.LBB2_111:                              # %.lr.ph492.us.us.1613
                                        # =>This Loop Header: Depth=1
	...
	move	$s1, $a1
	beqz	$a7, .LBB2_115
# %bb.112:                              # %vector.body744.preheader
                                        #   in Loop: Header=BB2_111 Depth=1
	move	$s1, $t7
	move	$s2, $fp
	.p2align	4, , 16
.LBB2_113:                              # %vector.body744
	...
	addi.d	$s2, $s2, 64
	bnez	$s1, .LBB2_113
# %bb.114:                              # %middle.block747
                                        #   in Loop: Header=BB2_111 Depth=1
	move	$s1, $t8
	beq	$t2, $t7, .LBB2_110
.LBB2_115:                              # %scalar.ph739.preheader
                                        #   in Loop: Header=BB2_111 Depth=1
	slli.d	$s2, $s1, 5
	add.d	$s2, $a5, $s2
	.p2align	4, , 16
.LBB2_116:                              # %scalar.ph739
                                        #   Parent Loop BB2_111 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$s0, $s2, 0
	addi.w	$s1, $s1, 1
...
.LBB2_119:                              # %.lr.ph492.us.us.1.1
	...
	move	$t4, $a1
	beqz	$a7, .LBB2_123
# %bb.120:                              # %vector.body755.preheader
                                        #   in Loop: Header=BB2_119 Depth=1
	move	$t4, $a3
	move	$t5, $a5
	.p2align	4, , 16
.LBB2_121:                              # %vector.body755
	...
	addi.d	$t5, $t5, 64
	bnez	$t4, .LBB2_121
# %bb.122:                              # %middle.block759
                                        #   in Loop: Header=BB2_119 Depth=1
	move	$t4, $a4
	beq	$t2, $a3, .LBB2_118
.LBB2_123:                              # %scalar.ph750.preheader
                                        #   in Loop: Header=BB2_119 Depth=1
	slli.d	$t5, $t4, 5
	add.d	$t5, $t0, $t5
	.p2align	4, , 16
.LBB2_124:                              # %scalar.ph750
                                        #   Parent Loop BB2_119 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$t3, $t5, 0
	addi.w	$t4, $t4, 1
...
.LBB2_133:                              # %vector.body903
	...
	addi.d	$t4, $t4, -48
	bnez	$t6, .LBB2_133
# %bb.134:                              # %middle.block908
	add.d	$a6, $t2, $a6
	beq	$t1, $t0, .LBB2_137
.LBB2_135:                              # %scalar.ph898.preheader
	addi.d	$t2, $t1, 1
	ori	$t4, $zero, 24
	mul.d	$t3, $a3, $t4
	mul.d	$t5, $t1, $t4
...
.LBB2_144:                              # %vector.body926
	...
	addi.d	$t3, $t3, 16
	bnez	$t4, .LBB2_144
# %bb.145:                              # %middle.block931
                                        #   in Loop: Header=BB2_141 Depth=1
	move	$t5, $t0
	beq	$t0, $s6, .LBB2_140
.LBB2_146:                              # %scalar.ph913.preheader
                                        #   in Loop: Header=BB2_141 Depth=1
	add.d	$t3, $a0, $t5
	mul.d	$t3, $a4, $t3
	add.w	$t3, $t1, $t3
...
# %bb.152:                              #   in Loop: Header=BB2_150 Depth=1
	...
	b	.LBB2_157
	.p2align	4, , 16
.LBB2_153:                              # %vector.ph789
                                        #   in Loop: Header=BB2_150 Depth=1
	xvreplgr2vr.h	$xr0, $s7
	move	$s8, $s2
	move	$ra, $t8
	.p2align	4, , 16
.LBB2_154:                              # %vector.body794
	...
	addi.d	$s8, $s8, 64
	bnez	$ra, .LBB2_154
# %bb.155:                              # %middle.block797
                                        #   in Loop: Header=BB2_150 Depth=1
	beq	$a5, $t8, .LBB2_149
# %bb.156:                              # %vec.epilog.iter.check802
                                        #   in Loop: Header=BB2_150 Depth=1
	move	$ra, $t8
	move	$s8, $s0
	beqz	$a6, .LBB2_160
.LBB2_157:                              # %vec.epilog.ph801
                                        #   in Loop: Header=BB2_150 Depth=1
	vreplgr2vr.h	$vr0, $s7
	add.d	$s8, $s3, $ra
	add.d	$ra, $a1, $ra
	alsl.d	$ra, $ra, $t2, 1
	.p2align	4, , 16
.LBB2_158:                              # %vec.epilog.vector.body809
                                        #   Parent Loop BB2_150 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $ra, 0
	addi.d	$s8, $s8, 8
	addi.d	$ra, $ra, 16
	bnez	$s8, .LBB2_158
# %bb.159:                              # %vec.epilog.middle.block813
                                        #   in Loop: Header=BB2_150 Depth=1
	move	$s8, $s1
	beq	$a5, $a7, .LBB2_149
.LBB2_160:                              # %vec.epilog.scalar.ph800.preheader
                                        #   in Loop: Header=BB2_150 Depth=1
	slli.d	$ra, $s8, 1
	.p2align	4, , 16
.LBB2_161:                              # %vec.epilog.scalar.ph800
                                        #   Parent Loop BB2_150 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.h	$s7, $t2, $ra
	addi.w	$s8, $s8, 1
...
# %bb.165:                              #   in Loop: Header=BB2_164 Depth=1
	...
	b	.LBB2_175
	.p2align	4, , 16
.LBB2_166:                              # %vector.main.loop.iter.check821
                                        #   in Loop: Header=BB2_164 Depth=1
	bgeu	$a2, $s3, .LBB2_168
# %bb.167:                              #   in Loop: Header=BB2_164 Depth=1
	...
	b	.LBB2_172
	.p2align	4, , 16
.LBB2_168:                              # %vector.ph822
                                        #   in Loop: Header=BB2_164 Depth=1
	xvreplgr2vr.h	$xr0, $s5
	move	$s6, $t8
	move	$s7, $t3
	.p2align	4, , 16
.LBB2_169:                              # %vector.body827
	...
	addi.d	$s6, $s6, 64
	bnez	$s7, .LBB2_169
# %bb.170:                              # %middle.block830
                                        #   in Loop: Header=BB2_164 Depth=1
	beq	$t3, $a1, .LBB2_163
# %bb.171:                              # %vec.epilog.iter.check835
                                        #   in Loop: Header=BB2_164 Depth=1
	move	$s8, $t3
	move	$s7, $t3
	beqz	$t6, .LBB2_175
.LBB2_172:                              # %vec.epilog.ph834
                                        #   in Loop: Header=BB2_164 Depth=1
	vreplgr2vr.h	$vr0, $s5
	add.d	$s6, $fp, $s8
	alsl.d	$s7, $s8, $s0, 1
	.p2align	4, , 16
.LBB2_173:                              # %vec.epilog.vector.body842
                                        #   Parent Loop BB2_164 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s7, 0
	addi.d	$s6, $s6, 8
	addi.d	$s7, $s7, 16
	bnez	$s6, .LBB2_173
# %bb.174:                              # %vec.epilog.middle.block845
                                        #   in Loop: Header=BB2_164 Depth=1
	move	$s7, $t7
	beq	$t7, $a1, .LBB2_163
...
.LBB2_179:                              # %iter.check851
	...
	move	$s1, $a1
	bltu	$a4, $t8, .LBB2_189
# %bb.180:                              # %vector.main.loop.iter.check853
                                        #   in Loop: Header=BB2_179 Depth=1
	bgeu	$a4, $fp, .LBB2_182
# %bb.181:                              #   in Loop: Header=BB2_179 Depth=1
	...
	b	.LBB2_186
	.p2align	4, , 16
.LBB2_182:                              # %vector.ph854
                                        #   in Loop: Header=BB2_179 Depth=1
	xvreplgr2vr.h	$xr0, $s0
	move	$s1, $t5
	move	$s2, $a2
	.p2align	4, , 16
.LBB2_183:                              # %vector.body859
	...
	addi.d	$s1, $s1, 64
	bnez	$s2, .LBB2_183
# %bb.184:                              # %middle.block862
                                        #   in Loop: Header=BB2_179 Depth=1
	beq	$a5, $a2, .LBB2_178
# %bb.185:                              # %vec.epilog.iter.check867
                                        #   in Loop: Header=BB2_179 Depth=1
	move	$s2, $a2
	move	$s1, $t3
	beqz	$a6, .LBB2_189
.LBB2_186:                              # %vec.epilog.ph866
                                        #   in Loop: Header=BB2_179 Depth=1
	vreplgr2vr.h	$vr0, $s0
	add.d	$s1, $t6, $s2
	add.d	$s2, $a1, $s2
	alsl.d	$s2, $s2, $t0, 1
	.p2align	4, , 16
.LBB2_187:                              # %vec.epilog.vector.body874
                                        #   Parent Loop BB2_179 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s2, 0
	addi.d	$s1, $s1, 8
	addi.d	$s2, $s2, 16
	bnez	$s1, .LBB2_187
# %bb.188:                              # %vec.epilog.middle.block878
                                        #   in Loop: Header=BB2_179 Depth=1
	move	$s1, $t4
	beq	$a5, $a7, .LBB2_178
.LBB2_189:                              # %vec.epilog.scalar.ph865.preheader
                                        #   in Loop: Header=BB2_179 Depth=1
	slli.d	$s2, $s1, 1
	.p2align	4, , 16
.LBB2_190:                              # %vec.epilog.scalar.ph865
                                        #   Parent Loop BB2_179 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.h	$s0, $t0, $s2
	addi.w	$s1, $s1, 1
