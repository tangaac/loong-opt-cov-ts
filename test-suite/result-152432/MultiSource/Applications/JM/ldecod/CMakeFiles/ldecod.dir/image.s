...
.LBB0_17:                               #   in Loop: Header=BB0_14 Depth=2
	move	$t7, $zero
.LBB0_18:                               # %vec.epilog.scalar.ph287.preheader
                                        #   in Loop: Header=BB0_14 Depth=2
	alsl.d	$a5, $t7, $t6, 1
	slli.d	$t6, $t7, 6
	add.d	$t6, $t3, $t6
	sub.d	$t7, $s5, $t7
	.p2align	4, , 16
.LBB0_19:                               # %vec.epilog.scalar.ph287
                                        #   Parent Loop BB0_4 Depth=1
	...
	b	.LBB0_13
	.p2align	4, , 16
.LBB0_20:                               # %vector.main.loop.iter.check276
                                        #   in Loop: Header=BB0_14 Depth=2
	bgeu	$s5, $ra, .LBB0_25
# %bb.21:                               #   in Loop: Header=BB0_14 Depth=2
	move	$t8, $zero
.LBB0_22:                               # %vec.epilog.ph288
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$a0, $s0
	add.d	$a5, $s2, $t8
	alsl.d	$t7, $t8, $t6, 1
	...
	move	$fp, $t4
	.p2align	4, , 16
.LBB0_23:                               # %vec.epilog.vector.body294
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t7, 0
	...
	addi.d	$fp, $fp, 512
	bnez	$a5, .LBB0_23
# %bb.24:                               # %vec.epilog.middle.block298
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$t7, $t1
	move	$s0, $a0
	beq	$t1, $s5, .LBB0_13
	b	.LBB0_18
.LBB0_25:                               # %vector.body280.preheader
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$t7, $t5
	move	$t8, $a2
	.p2align	4, , 16
.LBB0_26:                               # %vector.body280
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvld	$xr0, $a5, 0
	...
	addi.d	$t7, $t7, 1024
	bnez	$t8, .LBB0_26
# %bb.27:                               # %middle.block284
                                        #   in Loop: Header=BB0_14 Depth=2
	beq	$a2, $s5, .LBB0_13
# %bb.28:                               # %vec.epilog.iter.check289
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$t8, $a2
	move	$t7, $a2
...
# %bb.33:                               #   in Loop: Header=BB0_32 Depth=2
	move	$a5, $zero
.LBB0_34:                               # %vec.epilog.scalar.ph252.preheader
                                        #   in Loop: Header=BB0_32 Depth=2
	add.d	$a1, $a6, $a5
	alsl.d	$a0, $a1, $s4, 1
	alsl.d	$a7, $a1, $fp, 1
	...
	sub.d	$a5, $s5, $a5
	.p2align	4, , 16
.LBB0_35:                               # %vec.epilog.scalar.ph252
                                        #   Parent Loop BB0_4 Depth=1
...
# %bb.37:                               # %vector.memcheck209
	...
	and	$fp, $fp, $s4
	bnez	$fp, .LBB0_50
# %bb.38:                               # %vector.memcheck209
                                        #   in Loop: Header=BB0_32 Depth=2
	sltu	$fp, $t0, $a2
	sltu	$t7, $s7, $t7
	and	$t7, $fp, $t7
	bnez	$t7, .LBB0_50
# %bb.39:                               # %vector.memcheck209
                                        #   in Loop: Header=BB0_32 Depth=2
	sltu	$t7, $a7, $t2
	sltu	$fp, $s1, $t4
	and	$t7, $t7, $fp
...
# %bb.40:                               # %vector.memcheck209
	...
	bnez	$t4, .LBB0_34
# %bb.41:                               # %vector.main.loop.iter.check242
                                        #   in Loop: Header=BB0_32 Depth=2
	bgeu	$s5, $ra, .LBB0_46
# %bb.42:                               #   in Loop: Header=BB0_32 Depth=2
	move	$t4, $zero
.LBB0_43:                               # %vec.epilog.ph253
                                        #   in Loop: Header=BB0_32 Depth=2
...
# %bb.45:                               # %vec.epilog.middle.block262
	...
	beq	$a0, $s5, .LBB0_31
	b	.LBB0_34
.LBB0_46:                               # %vector.body246.preheader
                                        #   in Loop: Header=BB0_32 Depth=2
	move	$t7, $s3
...
.LBB0_51:                               #   in Loop: Header=BB0_32 Depth=2
	ld.d	$fp, $sp, 248                   # 8-byte Folded Reload
	b	.LBB0_34
.LBB0_52:                               # %.preheader61.lr.ph.split.us.1
                                        #   in Loop: Header=BB0_4 Depth=1
...
.LBB0_54:                               # %iter.check183
	...
	add.d	$fp, $a5, $s4
	bltu	$s5, $a3, .LBB0_57
# %bb.55:                               # %vector.memcheck174
                                        #   in Loop: Header=BB0_54 Depth=2
	add.d	$a1, $a5, $s8
	alsl.d	$a5, $a6, $a5, 1
	bgeu	$s7, $a1, .LBB0_60
# %bb.56:                               # %vector.memcheck174
                                        #   in Loop: Header=BB0_54 Depth=2
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	bgeu	$a5, $a1, .LBB0_60
.LBB0_57:                               #   in Loop: Header=BB0_54 Depth=2
	move	$s0, $zero
.LBB0_58:                               # %vec.epilog.scalar.ph195.preheader
                                        #   in Loop: Header=BB0_54 Depth=2
	alsl.d	$a5, $s0, $fp, 1
	sub.d	$t4, $s5, $s0
	slli.d	$a1, $s0, 6
	add.d	$fp, $t6, $a1
	.p2align	4, , 16
.LBB0_59:                               # %vec.epilog.scalar.ph195
                                        #   Parent Loop BB0_4 Depth=1
	...
	b	.LBB0_53
	.p2align	4, , 16
.LBB0_60:                               # %vector.main.loop.iter.check185
                                        #   in Loop: Header=BB0_54 Depth=2
	bgeu	$s5, $ra, .LBB0_65
# %bb.61:                               #   in Loop: Header=BB0_54 Depth=2
	move	$s2, $zero
.LBB0_62:                               # %vec.epilog.ph196
                                        #   in Loop: Header=BB0_54 Depth=2
	add.d	$a5, $s3, $s2
	alsl.d	$t4, $s2, $fp, 1
	slli.d	$s0, $s2, 6
	move	$s2, $t7
	.p2align	4, , 16
.LBB0_63:                               # %vec.epilog.vector.body202
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_54 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t4, 0
	...
	addi.d	$s2, $s2, 512
	bnez	$a5, .LBB0_63
# %bb.64:                               # %vec.epilog.middle.block206
                                        #   in Loop: Header=BB0_54 Depth=2
	move	$s0, $t3
	beq	$t3, $s5, .LBB0_53
	b	.LBB0_58
.LBB0_65:                               # %vector.body189.preheader
                                        #   in Loop: Header=BB0_54 Depth=2
	move	$t4, $t8
	move	$s0, $t2
	.p2align	4, , 16
.LBB0_66:                               # %vector.body189
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_54 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvld	$xr0, $a5, 0
	...
	addi.d	$t4, $t4, 1024
	bnez	$s0, .LBB0_66
# %bb.67:                               # %middle.block192
                                        #   in Loop: Header=BB0_54 Depth=2
	beq	$t0, $s5, .LBB0_53
# %bb.68:                               # %vec.epilog.iter.check197
                                        #   in Loop: Header=BB0_54 Depth=2
	move	$s2, $t0
	move	$s0, $t0
	...
	bnez	$a1, .LBB0_62
	b	.LBB0_58
.LBB0_69:                               # %.preheader.lr.ph.split.us.1
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$t7, $a0, 8
	move	$t8, $zero
...
# %bb.72:                               #   in Loop: Header=BB0_71 Depth=2
	move	$a5, $zero
.LBB0_73:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB0_71 Depth=2
	sub.d	$a7, $s5, $a5
	add.d	$a1, $a6, $a5
	alsl.d	$a0, $a1, $a0, 1
