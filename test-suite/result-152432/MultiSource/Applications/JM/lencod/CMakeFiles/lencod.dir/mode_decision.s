...
# %bb.38:                               # %.lr.ph
	...
	move	$t3, $zero
	bnez	$t5, .LBB2_41
# %bb.39:                               # %.lr.ph.split.us.preheader
                                        #   in Loop: Header=BB2_37 Depth=1
	addi.d	$t4, $t4, -1
	sltui	$t4, $t4, 1
	.p2align	4, , 16
.LBB2_40:                               # %.lr.ph.split.us
...
# %bb.46:                               # %.lr.ph195
	ori	$a6, $zero, 2
	bne	$a5, $a6, .LBB2_57
# %bb.47:                               # %.lr.ph195.split.us197.preheader
	move	$a5, $zero
	.p2align	4, , 16
.LBB2_48:                               # %.lr.ph195.split.us197
...
# %bb.50:                               # %.preheader180.preheader
	...
	b	.LBB2_52
	.p2align	4, , 16
.LBB2_51:                               # %._crit_edge191
                                        #   in Loop: Header=BB2_52 Depth=1
	addi.d	$t1, $a4, 1
	beq	$a4, $a0, .LBB2_78
.LBB2_52:                               # %.preheader180
                                        # =>This Loop Header: Depth=1
...
.LBB2_54:                               #   Parent Loop BB2_52 Depth=1
	...
	blt	$a6, $t0, .LBB2_54
	b	.LBB2_51
.LBB2_55:                               # %.lr.ph195.split.us.preheader
	move	$a5, $zero
	addi.d	$a6, $zero, -2
	.p2align	4, , 16
.LBB2_56:                               # %.lr.ph195.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a3, 0
	ld.w	$t0, $a7, 0
	addi.d	$t0, $t0, -1
...
# %bb.61:                               # %middle.block
	beq	$a5, $a2, .LBB2_64
.LBB2_62:                               # %.thread176.preheader286
	alsl.d	$a3, $a5, $a3, 3
	.p2align	4, , 16
.LBB2_63:                               # %.thread176
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.66:                               # %.lr.ph195.1
	ori	$a3, $zero, 2
	bne	$a2, $a3, .LBB2_71
# %bb.67:                               # %.lr.ph195.split.us197.1.preheader
	move	$a2, $zero
	.p2align	4, , 16
.LBB2_68:                               # %.lr.ph195.split.us197.1
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 0
	ld.w	$a4, $a3, 0
	addi.d	$a4, $a4, -2
	...
	bltu	$a2, $a0, .LBB2_68
	b	.LBB2_78
.LBB2_69:                               # %.lr.ph195.split.us.1.preheader
	move	$a2, $zero
	addi.d	$a3, $zero, -2
	.p2align	4, , 16
.LBB2_70:                               # %.lr.ph195.split.us.1
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a1, 0
	ld.w	$a5, $a4, 0
	addi.d	$a5, $a5, -1
	...
	bltu	$a2, $a0, .LBB2_70
	b	.LBB2_78
.LBB2_71:                               # %.thread176.1.preheader
	ori	$a2, $zero, 8
	bgeu	$a0, $a2, .LBB2_73
# %bb.72:
	move	$a2, $zero
	b	.LBB2_76
.LBB2_73:                               # %vector.ph272
	bstrpick.d	$a2, $a0, 30, 3
	slli.d	$a2, $a2, 3
	addi.d	$a3, $a1, 32
	move	$a4, $a2
	.p2align	4, , 16
.LBB2_74:                               # %vector.body275
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a3, -32
	ld.d	$a6, $a3, -24
	ld.d	$a7, $a3, -16
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB2_74
# %bb.75:                               # %middle.block280
	beq	$a2, $a0, .LBB2_78
.LBB2_76:                               # %.thread176.1.preheader283
	alsl.d	$a1, $a2, $a1, 3
	.p2align	4, , 16
.LBB2_77:                               # %.thread176.1
                                        # =>This Inner Loop Header: Depth=1
