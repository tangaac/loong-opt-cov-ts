...
# %bb.9:                                # %iter.check
	...
	bltu	$a3, $a6, .LBB0_12
# %bb.10:                               # %vector.memcheck81
	addi.d	$a7, $a0, 1416
	add.d	$a6, $a0, $a4
	addi.d	$a6, $a6, 1546
	addi.d	$t0, $a0, 1546
	bgeu	$a7, $a6, .LBB0_28
# %bb.11:                               # %vector.memcheck81
	alsl.d	$a6, $a4, $a0, 1
	addi.d	$a6, $a6, 1416
	bgeu	$t0, $a6, .LBB0_28
.LBB0_12:
...
# %bb.17:                               # %iter.check132
	bstrpick.d	$a4, $a5, 31, 0
	bltu	$a3, $a6, .LBB0_20
# %bb.18:                               # %vector.memcheck123
	addi.d	$a6, $a0, 1620
	add.d	$a7, $a0, $a4
	addi.d	$t0, $a7, 1750
	addi.d	$a7, $a0, 1750
	bgeu	$a6, $t0, .LBB0_30
# %bb.19:                               # %vector.memcheck123
	alsl.d	$t0, $a4, $a0, 1
	addi.d	$t0, $t0, 1620
	bgeu	$a7, $t0, .LBB0_30
.LBB0_20:
	move	$a3, $zero
.LBB0_21:                               # %vec.epilog.scalar.ph150.preheader
	slli.d	$a2, $a3, 1
	addi.d	$a2, $a2, 1620
	sub.d	$a5, $a5, $a3
	.p2align	4, , 16
.LBB0_22:                               # %vec.epilog.scalar.ph150
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$a5, $a0, $a2
	add.d	$a6, $a0, $a3
	st.b	$a3, $a6, 1750
...
# %bb.29:
	move	$a6, $zero
	b	.LBB0_36
.LBB0_30:                               # %vector.main.loop.iter.check134
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB0_39
# %bb.31:
	move	$a3, $zero
...
.LBB0_40:                               # %vector.body140
	...
	addi.d	$a6, $a6, 32
	bnez	$t0, .LBB0_40
# %bb.41:                               # %middle.block147
	beq	$a3, $a4, .LBB0_24
# %bb.42:                               # %vec.epilog.iter.check152
	andi	$a6, $a4, 12
	beqz	$a6, .LBB0_21
.LBB0_43:                               # %vec.epilog.ph151
	move	$a7, $a3
	...
	addi.d	$a7, $a7, 1620
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body165
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr3, $vr0, $vr1
	vpickev.h	$vr3, $vr3, $vr3
	vstelm.d	$vr3, $a7, 0, 0
	...
	addi.d	$a7, $a7, 8
	bnez	$a2, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block172
	beq	$a3, $a4, .LBB0_24
	b	.LBB0_21
.Lfunc_end0:
...
.LBB2_25:                               # %vector.body96
	...
	addi.d	$a5, $a5, 8
	bnez	$a3, .LBB2_25
# %bb.26:                               # %middle.block100
	beq	$a4, $a2, .LBB2_30
# %bb.27:
	vpickve2gr.h	$a3, $vr0, 3
.LBB2_28:                               # %.lr.ph.preheader146
	alsl.d	$a5, $a4, $fp, 1
	addi.d	$a5, $a5, 10
	sub.d	$a4, $a2, $a4
	.p2align	4, , 16
...
.LBB2_40:
	move	$a5, $a3
.LBB2_41:                               # %vec.epilog.scalar.ph125.preheader
	addi.d	$a1, $a5, 1
	alsl.d	$a2, $a5, $fp, 1
	addi.d	$a2, $a2, 8
	.p2align	4, , 16
.LBB2_42:                               # %vec.epilog.scalar.ph125
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a3, $a2, 0
...
# %bb.45:                               # %vector.memcheck
	...
	addi.d	$a1, $a1, 8
	bltu	$a1, $a4, .LBB2_40
.LBB2_46:                               # %vector.main.loop.iter.check110
	ori	$a4, $zero, 15
	addi.d	$a1, $a3, 1
	bgeu	$a3, $a4, .LBB2_51
# %bb.47:
	move	$a4, $zero
.LBB2_48:                               # %vec.epilog.ph126
	...
	addi.d	$a2, $a2, -6
	.p2align	4, , 16
.LBB2_49:                               # %vec.epilog.vector.body132
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, -16
	bnez	$a7, .LBB2_49
# %bb.50:                               # %vec.epilog.middle.block141
	bne	$a1, $a6, .LBB2_41
	b	.LBB2_43
.LBB2_51:                               # %vector.ph111
	bstrpick.d	$a4, $a1, 32, 4
	slli.d	$a4, $a4, 4
	addi.d	$a5, $a5, -22
	move	$a6, $a1
	move	$a7, $a4
.LBB2_52:                               # %vector.body114
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a5, 0
	...
	addi.d	$a5, $a5, -32
	bnez	$a7, .LBB2_52
# %bb.53:                               # %middle.block122
	beq	$a1, $a4, .LBB2_43
# %bb.54:                               # %vec.epilog.iter.check127
	andi	$a5, $a1, 8
	bnez	$a5, .LBB2_48
# %bb.55:
	sub.d	$a5, $a3, $a4
