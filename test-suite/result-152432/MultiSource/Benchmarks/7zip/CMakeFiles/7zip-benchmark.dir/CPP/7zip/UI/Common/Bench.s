...
# %bb.64:                               # %middle.block
	...
	beq	$a0, $a3, .LBB13_67
.LBB13_65:                              # %.lr.ph355.preheader564
	ori	$a3, $zero, 224
	mul.d	$a3, $a0, $a3
	add.d	$a3, $a3, $fp
	addi.d	$a3, $a3, 176
...
.LBB13_99:                              # %vector.body535
	...
	addi.d	$a5, $a5, 448
	bnez	$a6, .LBB13_99
# %bb.100:                              # %middle.block542
	add.d	$a1, $a2, $a1
	add.d	$a2, $a4, $a3
	ld.d	$a3, $sp, 56                    # 8-byte Folded Reload
	beq	$a0, $a3, .LBB13_103
.LBB13_101:                             # %.lr.ph373.preheader551
	ori	$a3, $zero, 224
	mul.d	$a3, $a0, $a3
	add.d	$a3, $a3, $fp
	addi.d	$a3, $a3, 176
