...
.LBB4_20:                               # %._crit_edge40
	move	$a0, $zero
	ret
.LBB4_21:                               # %vector.main.loop.iter.check74
	ori	$a5, $zero, 16
	bgeu	$a2, $a5, .LBB4_23
# %bb.22:
	move	$a5, $zero
...
.LBB4_24:                               # %vector.body82
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_24
# %bb.25:                               # %middle.block87
	beq	$a5, $a2, .LBB4_20
# %bb.26:                               # %vec.epilog.iter.check92
	andi	$a6, $a2, 12
	beqz	$a6, .LBB4_18
.LBB4_27:                               # %vec.epilog.ph91
	move	$t0, $a5
...
.LBB11_35:                              # %pred.store.continue80
	...
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_65
.LBB11_36:                              # %pred.store.continue82
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 4
	andi	$t1, $t1, 1
	xvadd.d	$xr11, $xr9, $xr4
	bnez	$t1, .LBB11_66
.LBB11_37:                              # %pred.store.continue84
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 5
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_67
.LBB11_38:                              # %pred.store.continue86
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 6
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_68
.LBB11_39:                              # %pred.store.continue88
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 7
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_69
.LBB11_40:                              # %pred.store.continue90
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 8
	andi	$t1, $t1, 1
	xvadd.d	$xr11, $xr9, $xr3
	bnez	$t1, .LBB11_70
.LBB11_41:                              # %pred.store.continue92
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 9
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_71
.LBB11_42:                              # %pred.store.continue94
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 10
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_72
.LBB11_43:                              # %pred.store.continue96
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 11
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_73
.LBB11_44:                              # %pred.store.continue98
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 12
	andi	$t1, $t1, 1
	xvadd.d	$xr9, $xr9, $xr2
	bnez	$t1, .LBB11_74
.LBB11_45:                              # %pred.store.continue100
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 13
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_75
.LBB11_46:                              # %pred.store.continue102
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 14
	andi	$t1, $t1, 1
	bnez	$t1, .LBB11_76
.LBB11_47:                              # %pred.store.continue104
                                        #   in Loop: Header=BB11_14 Depth=1
	vpickve2gr.b	$t1, $vr10, 15
	andi	$t1, $t1, 1
	beqz	$t1, .LBB11_13
...
.LBB11_80:                              # %vec.epilog.ph
	...
	b	.LBB11_82
	.p2align	4, , 16
.LBB11_81:                              # %pred.store.continue130
...
.LBB11_82:                              # %vec.epilog.vector.body
	...
	xvsub.d	$xr5, $xr5, $xr0
	bnez	$a7, .LBB11_91
# %bb.83:                               # %pred.store.continue116
                                        #   in Loop: Header=BB11_82 Depth=1
	vilvl.b	$vr3, $vr3, $vr3
	vpickve2gr.h	$a7, $vr3, 1
	andi	$a7, $a7, 1
	bnez	$a7, .LBB11_92
.LBB11_84:                              # %pred.store.continue118
                                        #   in Loop: Header=BB11_82 Depth=1
	vpickve2gr.h	$a7, $vr3, 2
	andi	$a7, $a7, 1
	bnez	$a7, .LBB11_93
.LBB11_85:                              # %pred.store.continue120
                                        #   in Loop: Header=BB11_82 Depth=1
	vpickve2gr.h	$a7, $vr3, 3
	andi	$a7, $a7, 1
	beqz	$a7, .LBB11_87
.LBB11_86:                              # %pred.store.if121
                                        #   in Loop: Header=BB11_82 Depth=1
	xvpickve2gr.d	$a7, $xr5, 3
	stx.b	$zero, $a0, $a7
.LBB11_87:                              # %pred.store.continue122
                                        #   in Loop: Header=BB11_82 Depth=1
	xvsub.d	$xr4, $xr4, $xr0
...
.LBB11_89:                              # %pred.store.continue126
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB11_96
.LBB11_90:                              # %pred.store.continue128
                                        #   in Loop: Header=BB11_82 Depth=1
...
.LBB18_182:                             # %vec.epilog.ph413
	...
	b	.LBB18_184
	.p2align	4, , 16
.LBB18_183:                             # %pred.store.continue441
...
# %bb.185:                              # %pred.store.if426
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_189
.LBB18_186:                             # %pred.store.continue429
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 2
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_190
.LBB18_187:                             # %pred.store.if430
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	b	.LBB18_192
	.p2align	4, , 16
.LBB18_188:                             # %pred.store.continue427
                                        #   in Loop: Header=BB18_184 Depth=1
	vilvl.b	$vr3, $vr3, $vr3
	vpickve2gr.h	$a4, $vr3, 1
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_186
.LBB18_189:                             # %pred.store.if428
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_187
.LBB18_190:                             # %pred.store.continue431
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_192
.LBB18_191:                             # %pred.store.if432
                                        #   in Loop: Header=BB18_184 Depth=1
	xvpickve2gr.d	$a4, $xr5, 3
	stx.b	$zero, $s2, $a4
.LBB18_192:                             # %pred.store.continue433
                                        #   in Loop: Header=BB18_184 Depth=1
	xvsub.d	$xr4, $xr4, $xr0
...
# %bb.193:                              # %pred.store.if434
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_197
.LBB18_194:                             # %pred.store.continue437
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 6
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_198
.LBB18_195:                             # %pred.store.if438
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	b	.LBB18_199
	.p2align	4, , 16
.LBB18_196:                             # %pred.store.continue435
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 5
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_194
.LBB18_197:                             # %pred.store.if436
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_195
.LBB18_198:                             # %pred.store.continue439
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 7
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_183
.LBB18_199:                             # %pred.store.if440
                                        #   in Loop: Header=BB18_184 Depth=1
