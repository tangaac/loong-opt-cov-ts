...
# %bb.1:                                # %.lr.ph54
	...
	ld.d	$s3, $a0, 608
	blez	$s4, .LBB8_9
# %bb.2:                                # %.lr.ph50.us.preheader
	move	$s2, $a1
	move	$s5, $zero
	addi.d	$s6, $s3, 80
	b	.LBB8_4
	.p2align	4, , 16
.LBB8_3:                                # %._crit_edge51.us
...
.LBB9_4:                                # %.lr.ph101.us
	...
	jirl	$ra, $ra, 0
	beqz	$s1, .LBB9_13
# %bb.5:                                # %.lr.ph101.split.us111.preheader
                                        #   in Loop: Header=BB9_4 Depth=1
	move	$a0, $zero
	alsl.d	$a1, $s7, $s5, 3
...
# %bb.11:                               # %._crit_edge.us
	...
	st.h	$t2, $a7, 0
	bne	$a0, $s4, .LBB9_6
# %bb.12:                               # %._crit_edge102.us.loopexit113
                                        #   in Loop: Header=BB9_4 Depth=1
	ld.w	$a0, $s3, 144
	ld.d	$a3, $sp, 40                    # 8-byte Folded Reload
