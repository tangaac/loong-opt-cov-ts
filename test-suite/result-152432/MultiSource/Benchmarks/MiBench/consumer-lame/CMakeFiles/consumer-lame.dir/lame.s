...
.LBB2_19:                               # %vector.body190
	...
	addi.d	$a3, $a3, 64
	bnez	$a5, .LBB2_19
# %bb.20:                               # %middle.block195
                                        #   in Loop: Header=BB2_15 Depth=1
	beq	$a2, $a1, .LBB2_23
.LBB2_21:                               # %scalar.ph185.preheader
                                        #   in Loop: Header=BB2_15 Depth=1
	lu12i.w	$a3, 4
	ori	$a3, $a3, 1824
	add.d	$a3, $sp, $a3
...
# %bb.37:                               #   in Loop: Header=BB2_36 Depth=1
	...
	b	.LBB2_41
	.p2align	4, , 16
.LBB2_38:                               # %vector.body214.preheader
                                        #   in Loop: Header=BB2_36 Depth=1
	move	$t0, $a5
	move	$t1, $a6
	.p2align	4, , 16
.LBB2_39:                               # %vector.body214
	...
	addi.d	$t0, $t0, 240
	bnez	$t1, .LBB2_39
# %bb.40:                               # %middle.block217
                                        #   in Loop: Header=BB2_36 Depth=1
	move	$t1, $a6
	beq	$a6, $t4, .LBB2_35
.LBB2_41:                               # %scalar.ph209.preheader
                                        #   in Loop: Header=BB2_36 Depth=1
	mul.d	$t0, $t1, $a7
	sub.d	$t1, $t4, $t1
	.p2align	4, , 16
.LBB2_42:                               # %scalar.ph209
                                        #   Parent Loop BB2_36 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$t2, $a4, $t0
	ld.w	$t3, $t2, 72
...
# %bb.49:                               #   in Loop: Header=BB2_48 Depth=1
	...
	b	.LBB2_53
	.p2align	4, , 16
.LBB2_50:                               # %vector.body203.preheader
                                        #   in Loop: Header=BB2_48 Depth=1
	move	$t3, $a4
	move	$t4, $a7
	move	$t5, $a3
	.p2align	4, , 16
.LBB2_51:                               # %vector.body203
	...
	addi.d	$t3, $t3, 960
	bnez	$t5, .LBB2_51
# %bb.52:                               # %middle.block206
                                        #   in Loop: Header=BB2_48 Depth=1
	move	$t5, $a3
	beq	$a3, $t6, .LBB2_47
.LBB2_53:                               # %scalar.ph198.preheader
                                        #   in Loop: Header=BB2_48 Depth=1
	mul.d	$t3, $t5, $t1
	add.d	$t3, $a5, $t3
	alsl.d	$t4, $t5, $a6, 3
...
.LBB3_12:                               #   in Loop: Header=BB3_9 Depth=1
	...
	addi.d	$t7, $t7, 2
	b	.LBB3_8
.LBB3_13:                               # %.._crit_edge_crit_edge
	fldx.d	$fa1, $a7, $t1
	move	$a0, $zero
	move	$t3, $zero
	b	.LBB3_28
.LBB3_14:                               # %.lr.ph.split.preheader
	vldi	$vr3, -912
	vldi	$vr4, -896
	addi.w	$t5, $zero, -2
	vldi	$vr5, -1000
...
# %bb.32:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_42
	.p2align	4, , 16
.LBB5_33:                               # %vector.main.loop.iter.check125
                                        #   in Loop: Header=BB5_31 Depth=2
	bgeu	$a0, $t7, .LBB5_35
# %bb.34:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_39
	.p2align	4, , 16
.LBB5_35:                               # %vector.body129.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t2, $s4
	move	$t3, $a6
	.p2align	4, , 16
.LBB5_36:                               # %vector.body129
                                        #   Parent Loop BB5_18 Depth=1
...
# %bb.37:                               # %middle.block134
                                        #   in Loop: Header=BB5_31 Depth=2
	beq	$a6, $a0, .LBB5_30
# %bb.38:                               # %vec.epilog.iter.check139
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t5, $a6
	move	$t4, $a6
	beqz	$a7, .LBB5_42
.LBB5_39:                               # %vec.epilog.ph138
                                        #   in Loop: Header=BB5_31 Depth=2
	add.d	$t2, $t1, $t5
	alsl.d	$t3, $t5, $s4, 1
	add.d	$t4, $a2, $t5
	slli.d	$t4, $t4, 1
	.p2align	4, , 16
.LBB5_40:                               # %vec.epilog.vector.body144
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $s4, $t4
	...
	addi.d	$t4, $t4, 16
	bnez	$t2, .LBB5_40
# %bb.41:                               # %vec.epilog.middle.block148
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t4, $t0
	beq	$t0, $a0, .LBB5_30
.LBB5_42:                               # %vec.epilog.scalar.ph137.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	alsl.d	$t2, $t4, $s4, 1
	add.d	$t3, $a2, $t4
	slli.d	$t3, $t3, 1
	sub.d	$t4, $a0, $t4
	.p2align	4, , 16
.LBB5_43:                               # %vec.epilog.scalar.ph137
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.h	$t5, $s4, $t3
...
# %bb.22:                               # %iter.check173
	...
	ori	$a1, $zero, 8
	blt	$s1, $a1, .LBB6_25
# %bb.23:                               # %vector.memcheck168
                                        #   in Loop: Header=BB6_21 Depth=1
	alsl.d	$a3, $a0, $t7, 1
	alsl.d	$a4, $a6, $s3, 2
	bgeu	$a3, $a4, .LBB6_47
# %bb.24:                               # %vector.memcheck168
                                        #   in Loop: Header=BB6_21 Depth=1
	add.d	$a3, $a0, $a6
	alsl.d	$a3, $a3, $t7, 1
	add.d	$a3, $a3, $s8
...
.LBB6_25:                               #   in Loop: Header=BB6_21 Depth=1
	move	$ra, $zero
.LBB6_26:                               # %vec.epilog.scalar.ph185.preheader
                                        #   in Loop: Header=BB6_21 Depth=1
	alsl.d	$a1, $ra, $s3, 2
	addi.d	$a4, $a1, 2
	add.d	$a1, $ra, $a0
	...
	sub.d	$a1, $a6, $ra
	.p2align	4, , 16
.LBB6_27:                               # %vec.epilog.scalar.ph185
...
.LBB6_46:                               # %vec.epilog.scalar.ph
	...
	bnez	$t5, .LBB6_46
	b	.LBB6_33
.LBB6_47:                               # %vector.main.loop.iter.check175
                                        #   in Loop: Header=BB6_21 Depth=1
	ori	$a1, $zero, 16
...
.LBB6_49:                               # %vec.epilog.ph186
	...
	alsl.d	$a5, $a1, $t7, 1
	.p2align	4, , 16
.LBB6_50:                               # %vec.epilog.vector.body192
                                        #   Parent Loop BB6_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB6_50
# %bb.51:                               # %vec.epilog.middle.block197
                                        #   in Loop: Header=BB6_21 Depth=1
...
.LBB6_53:                               # %vector.body179
	...
	ldx.h	$a1, $s3, $s0
	ldx.h	$a3, $s3, $s7
	xvreplgr2vr.h	$xr7, $s4
	ldx.h	$s4, $s3, $t6
	xvreplgr2vr.h	$xr8, $s6
	ldx.h	$s6, $s3, $t7
	...
	xvreplgr2vr.h	$xr17, $s6
	xvreplgr2vr.h	$xr18, $a1
	xvreplgr2vr.h	$xr19, $a3
	add.d	$a1, $s3, $fp
	add.d	$a3, $s3, $s5
	add.d	$fp, $s3, $s0
	add.d	$s0, $s3, $s7
	...
	xvextrins.h	$xr7, $xr7, 0
	xvpermi.q	$xr8, $xr7, 18
	xvextrins.h	$xr7, $xr8, 17
	xvld	$xr8, $sp, 240                  # 32-byte Folded Reload
	xvpermi.q	$xr8, $xr7, 18
	xvextrins.h	$xr7, $xr8, 34
	xvld	$xr8, $sp, 208                  # 32-byte Folded Reload
	xvpermi.q	$xr8, $xr7, 18
	xvextrins.h	$xr7, $xr8, 51
	xvld	$xr8, $sp, 176                  # 32-byte Folded Reload
	xvpermi.q	$xr8, $xr7, 18
	xvextrins.h	$xr7, $xr8, 68
	xvpermi.q	$xr9, $xr7, 18
	xvextrins.h	$xr7, $xr9, 85
	xvpermi.q	$xr10, $xr7, 18
	xvextrins.h	$xr7, $xr10, 102
	xvpermi.q	$xr11, $xr7, 18
	xvextrins.h	$xr7, $xr11, 119
	xvpermi.q	$xr12, $xr7, 48
	xvextrins.h	$xr7, $xr12, 0
	xvpermi.q	$xr13, $xr7, 48
	xvextrins.h	$xr7, $xr13, 17
	xvpermi.q	$xr14, $xr7, 48
	xvextrins.h	$xr7, $xr14, 34
	xvpermi.q	$xr15, $xr7, 48
	xvextrins.h	$xr7, $xr15, 51
	xvpermi.q	$xr16, $xr7, 48
	xvextrins.h	$xr7, $xr16, 68
	xvpermi.q	$xr17, $xr7, 48
	xvextrins.h	$xr7, $xr17, 85
	xvpermi.q	$xr18, $xr7, 48
	xvextrins.h	$xr7, $xr18, 102
	xvpermi.q	$xr19, $xr7, 48
	xvextrins.h	$xr7, $xr19, 119
	xvst	$xr7, $a4, 0
	xvpermi.q	$xr20, $xr0, 18
	xvextrins.h	$xr7, $xr20, 0
	xvpermi.q	$xr21, $xr7, 18
	xvextrins.h	$xr7, $xr21, 17
	xvpermi.q	$xr22, $xr7, 18
	xvextrins.h	$xr7, $xr22, 34
	xvpermi.q	$xr23, $xr7, 18
	xvextrins.h	$xr7, $xr23, 51
	xvpermi.q	$xr24, $xr7, 18
	xvextrins.h	$xr7, $xr24, 68
	xvpermi.q	$xr25, $xr7, 18
	xvextrins.h	$xr7, $xr25, 85
	xvpermi.q	$xr26, $xr7, 18
	xvextrins.h	$xr7, $xr26, 102
	xvpermi.q	$xr27, $xr7, 18
	xvextrins.h	$xr7, $xr27, 119
	xvpermi.q	$xr28, $xr7, 48
	xvextrins.h	$xr7, $xr28, 0
	xvpermi.q	$xr29, $xr7, 48
	xvextrins.h	$xr7, $xr29, 17
	xvpermi.q	$xr30, $xr7, 48
	xvextrins.h	$xr7, $xr30, 34
	xvpermi.q	$xr31, $xr7, 48
	xvextrins.h	$xr7, $xr31, 51
	xvpermi.q	$xr0, $xr7, 48
	xvextrins.h	$xr7, $xr0, 68
	xvld	$xr0, $sp, 272                  # 32-byte Folded Reload
	xvpermi.q	$xr4, $xr7, 48
	xvextrins.h	$xr7, $xr4, 85
	xvpermi.q	$xr5, $xr7, 48
	xvextrins.h	$xr7, $xr5, 102
	xvpermi.q	$xr6, $xr7, 48
	xvextrins.h	$xr7, $xr6, 119
	xvstx	$xr7, $a4, $s8
...
# %bb.54:                               # %middle.block182
	...
	beq	$ra, $a6, .LBB6_28
# %bb.55:                               # %vec.epilog.iter.check187
                                        #   in Loop: Header=BB6_21 Depth=1
	andi	$a1, $a6, 8
	bnez	$a1, .LBB6_49
	b	.LBB6_26
...
.LBB6_57:                               # %.critedge
	move	$a0, $a1
	b	.LBB6_70
.LBB6_58:                               # %vector.main.loop.iter.check204
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB6_63
# %bb.59:
	move	$a1, $zero
.LBB6_60:                               # %vec.epilog.ph217
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s4, 1
	.p2align	4, , 16
.LBB6_61:                               # %vec.epilog.vector.body226
                                        # =>This Inner Loop Header: Depth=1
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB6_61
# %bb.62:                               # %vec.epilog.middle.block231
	ld.d	$a7, $sp, 112                   # 8-byte Folded Reload
	bne	$a1, $s2, .LBB6_67
	b	.LBB6_69
.LBB6_63:                               # %vector.ph205
	st.d	$s7, $sp, 24                    # 8-byte Folded Spill
	st.d	$s6, $sp, 8                     # 8-byte Folded Spill
...
.LBB6_64:                               # %vector.body208
	...
	xvreplgr2vr.h	$xr17, $s7
	xvreplgr2vr.h	$xr18, $s8
	xvreplgr2vr.h	$xr19, $ra
	add.d	$fp, $s3, $fp
	add.d	$s0, $s3, $s0
	add.d	$s1, $s3, $s1
	add.d	$s5, $s3, $s5
	...
	xvreplgr2vr.h	$xr6, $t0
	xvpermi.q	$xr7, $xr0, 18
	xvextrins.h	$xr7, $xr7, 0
	xvori.b	$xr3, $xr2, 0
	xvori.b	$xr2, $xr1, 0
	xvld	$xr1, $sp, 240                  # 32-byte Folded Reload
	xvpermi.q	$xr1, $xr7, 18
	xvextrins.h	$xr7, $xr1, 17
	xvori.b	$xr1, $xr2, 0
	xvori.b	$xr2, $xr3, 0
	xvld	$xr3, $sp, 208                  # 32-byte Folded Reload
	xvpermi.q	$xr3, $xr7, 18
	xvextrins.h	$xr7, $xr3, 34
	xvld	$xr3, $sp, 176                  # 32-byte Folded Reload
	xvpermi.q	$xr3, $xr7, 18
	xvextrins.h	$xr7, $xr3, 51
	xvld	$xr3, $sp, 144                  # 32-byte Folded Reload
	xvpermi.q	$xr3, $xr7, 18
	xvextrins.h	$xr7, $xr3, 68
	xvpermi.q	$xr9, $xr7, 18
	xvextrins.h	$xr7, $xr9, 85
	xvpermi.q	$xr10, $xr7, 18
	xvextrins.h	$xr7, $xr10, 102
	...
	addi.d	$a2, $a2, 32
	bnez	$a4, .LBB6_64
# %bb.65:                               # %middle.block213
	ld.d	$s6, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s7, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a7, $sp, 112                   # 8-byte Folded Reload
	beq	$a1, $s2, .LBB6_69
# %bb.66:                               # %vec.epilog.iter.check218
	andi	$a2, $s2, 8
	bnez	$a2, .LBB6_60
