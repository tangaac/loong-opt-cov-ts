...
# %bb.29:
	move	$a1, $zero
	b	.LBB10_50
.LBB10_30:                              # %vector.main.loop.iter.check295
	ori	$a0, $zero, 32
	bgeu	$s7, $a0, .LBB10_40
# %bb.31:
	move	$a2, $zero
.LBB10_32:                              # %vec.epilog.ph307
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	addi.d	$a1, $sp, 336
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_33:                              # %vec.epilog.vector.body313
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_33
# %bb.34:                               # %vec.epilog.middle.block317
	...
	bne	$a2, $a0, .LBB10_44
	b	.LBB10_52
.LBB10_35:                              # %vector.main.loop.iter.check266
	ori	$a0, $zero, 32
	bgeu	$s7, $a0, .LBB10_46
# %bb.36:
	move	$a2, $zero
.LBB10_37:                              # %vec.epilog.ph278
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	addi.d	$a1, $sp, 336
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_38:                              # %vec.epilog.vector.body284
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a1, 0
	vpickve2gr.b	$a2, $vr0, 15
	andi	$a2, $a2, 255
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_38
# %bb.39:                               # %vec.epilog.middle.block288
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$fp, $sp, 192                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 184                   # 8-byte Folded Reload
...
# %bb.42:                               # %middle.block303
	...
	beq	$a1, $a0, .LBB10_52
# %bb.43:                               # %vec.epilog.iter.check308
	ld.d	$a2, $sp, 168                   # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	bnez	$a0, .LBB10_32
.LBB10_44:                              # %.lr.ph168.preheader
	addi.d	$a0, $sp, 336
	add.d	$a0, $a0, $a1
...
.LBB10_45:                              # %.lr.ph168
	...
	bnez	$a1, .LBB10_45
	b	.LBB10_52
.LBB10_46:                              # %vector.body270.preheader
	st.d	$ra, $sp, 48                    # 8-byte Folded Spill
	st.d	$s6, $sp, 176                   # 8-byte Folded Spill
	addi.d	$a0, $sp, 336
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_47:                              # %vector.body270
                                        # =>This Inner Loop Header: Depth=1
	st.d	$a1, $sp, 320                   # 8-byte Folded Spill
	xvld	$xr0, $a0, 0
	xvpermi.q	$xr1, $xr0, 1
	...
	xvreplgr2vr.b	$xr6, $a6
	xvreplgr2vr.b	$xr7, $s8
	xvreplgr2vr.b	$xr8, $s0
	xvreplgr2vr.b	$xr9, $s6
	xvreplgr2vr.b	$xr10, $fp
	xvreplgr2vr.b	$xr11, $s1
	xvreplgr2vr.b	$xr12, $s2
	xvreplgr2vr.b	$xr13, $s3
...
# %bb.48:                               # %middle.block274
	...
	ld.d	$ra, $sp, 48                    # 8-byte Folded Reload
	beq	$a1, $a0, .LBB10_52
# %bb.49:                               # %vec.epilog.iter.check279
	ld.d	$a2, $sp, 168                   # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	bnez	$a0, .LBB10_37
.LBB10_50:                              # %.lr.ph170.preheader
	addi.d	$a0, $sp, 336
	add.d	$a0, $a0, $a1
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	sub.d	$a1, $a2, $a1
...
# %bb.54:                               # %iter.check228
	...
	ori	$a3, $zero, 15
	bltu	$a2, $a3, .LBB10_71
# %bb.55:                               # %vector.main.loop.iter.check230
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ori	$a1, $zero, 31
	bgeu	$a0, $a1, .LBB10_67
# %bb.56:
	move	$a2, $zero
.LBB10_57:                              # %vec.epilog.ph243
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_58:                              # %vec.epilog.vector.body250
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a1, 0
	vpickve2gr.b	$a2, $vr0, 15
	andi	$a2, $a2, 255
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_58
# %bb.59:                               # %vec.epilog.middle.block255
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 192                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 184                   # 8-byte Folded Reload
...
# %bb.66:                               # %vec.epilog.middle.block
	...
	bne	$a2, $a3, .LBB10_77
	b	.LBB10_79
.LBB10_67:                              # %vector.body234.preheader
	st.d	$s6, $sp, 176                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_68:                              # %vector.body234
                                        # =>This Inner Loop Header: Depth=1
	st.d	$a1, $sp, 320                   # 8-byte Folded Spill
	xvld	$xr0, $a0, 0
	xvpermi.q	$xr1, $xr0, 1
...
# %bb.69:                               # %middle.block239
	...
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB10_79
# %bb.70:                               # %vec.epilog.iter.check244
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a3, $sp, 16                    # 8-byte Folded Reload
	bnez	$a3, .LBB10_57
.LBB10_71:                              # %.lr.ph174.preheader
...
# %bb.94:                               #   in Loop: Header=BB10_92 Depth=1
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB10_91
.LBB10_95:                              #   in Loop: Header=BB10_92 Depth=1
	beqz	$s0, .LBB10_90
# %bb.96:                               #   in Loop: Header=BB10_92 Depth=1
	bne	$a5, $a2, .LBB10_91
	b	.LBB10_85
.LBB10_97:                              #   in Loop: Header=BB10_99 Depth=1
	beqz	$a5, .LBB10_110
.LBB10_98:                              # %.backedge
                                        #   in Loop: Header=BB10_99 Depth=1
	and	$a4, $a4, $a1
	beqz	$a4, .LBB10_12
.LBB10_99:                              # %.lr.ph161.split.split
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a3, 0
	ld.d	$a4, $a3, 16
	and	$a5, $a4, $a0
...
# %bb.100:                              #   in Loop: Header=BB10_99 Depth=1
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB10_98
# %bb.101:                              #   in Loop: Header=BB10_99 Depth=1
	ld.h	$a6, $fp, 16
	srl.d	$a6, $a4, $a6
	andi	$a6, $a6, 1
	beqz	$a6, .LBB10_98
# %bb.102:                              #   in Loop: Header=BB10_99 Depth=1
	beqz	$s0, .LBB10_97
...
.LBB10_104:                             #   in Loop: Header=BB10_106 Depth=1
	beqz	$a5, .LBB10_110
.LBB10_105:                             # %.backedge.us165
                                        #   in Loop: Header=BB10_106 Depth=1
	and	$a4, $a4, $a1
	beqz	$a4, .LBB10_12
.LBB10_106:                             # %.lr.ph161.split.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a3, 0
	ld.d	$a4, $a3, 16
	and	$a5, $a4, $a0
...
# %bb.108:                              #   in Loop: Header=BB10_106 Depth=1
	beqz	$s0, .LBB10_104
# %bb.109:                              #   in Loop: Header=BB10_106 Depth=1
	bne	$a5, $a2, .LBB10_105
	b	.LBB10_85
.LBB10_110:
	addi.d	$a0, $sp, 336
