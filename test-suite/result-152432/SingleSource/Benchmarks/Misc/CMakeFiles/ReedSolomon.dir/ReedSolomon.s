...
.LBB0_40:                               #   in Loop: Header=BB0_17 Depth=1
	...
	b	.LBB0_48
	.p2align	4, , 16
.LBB0_41:                               # %scalar.ph114.preheader
                                        #   in Loop: Header=BB0_17 Depth=1
	sub.d	$t3, $t0, $t1
	slli.d	$t1, $t1, 2
	ld.d	$t5, $sp, 72                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_42:                               # %scalar.ph114
                                        #   Parent Loop BB0_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a7, $a2, $t1
	ldx.w	$t0, $a3, $t1
...
.LBB0_44:                               # %vector.body108
	...
	addi.d	$s8, $s8, 32
	bne	$ra, $s8, .LBB0_44
# %bb.45:                               # %middle.block112
                                        #   in Loop: Header=BB0_17 Depth=1
	ld.d	$t5, $sp, 72                    # 8-byte Folded Reload
	ld.d	$t0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a7, $sp, 56                    # 8-byte Folded Reload
	beq	$a7, $t0, .LBB0_48
.LBB0_46:                               # %scalar.ph106.preheader
                                        #   in Loop: Header=BB0_17 Depth=1
	sub.d	$t3, $t0, $a7
	slli.d	$t1, $a7, 2
	.p2align	4, , 16
.LBB0_47:                               # %scalar.ph106
                                        #   Parent Loop BB0_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a7, $a2, $t1
	slli.d	$t0, $a7, 2
...
.LBB0_64:                               # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB0_64
# %bb.65:                               # %.preheader318.i
	beqz	$s5, .LBB0_99
# %bb.66:                               # %.preheader316.i.preheader
	addi.d	$s0, $sp, 88
	addi.d	$a1, $sp, 1596
	slli.d	$a2, $s5, 2
	move	$a0, $s0
	...
	b	.LBB0_69
	.p2align	4, , 16
.LBB0_67:                               # %._crit_edge358.i
                                        #   in Loop: Header=BB0_69 Depth=1
	beqz	$t1, .LBB0_73
# %bb.68:                               # %._crit_edge358.thread.i
                                        #   in Loop: Header=BB0_69 Depth=1
	addi.w	$a2, $a2, 1
	beq	$a2, $a6, .LBB0_74
.LBB0_69:                               # %.preheader316.i
...
.LBB0_88:                               #   in Loop: Header=BB0_77 Depth=1
	...
	bltu	$a2, $a5, .LBB0_76
	b	.LBB0_83
.LBB0_89:                               # %.preheader320.i.preheader
	move	$a0, $zero
	addi.w	$a1, $zero, -1
	ori	$a2, $zero, 1020
	b	.LBB0_91
...
.LBB0_93:                               # %iter.check
	...
	addi.d	$sp, $sp, 1744
	ret
.LBB0_94:                               # %.preheader319.i..preheader317.i_crit_edge
	addi.d	$a0, $s5, 1
	bstrpick.d	$s7, $a0, 31, 0
	beqz	$s5, .LBB0_100
.LBB0_95:                               # %.preheader314.i.preheader
	move	$a0, $zero
	ori	$a1, $zero, 1020
	b	.LBB0_97
	.p2align	4, , 16
...
.LBB0_114:                              #   in Loop: Header=BB0_115 Depth=2
	...
	addi.d	$t2, $t2, 4
	beq	$s5, $t1, .LBB0_106
.LBB0_115:                              #   Parent Loop BB0_108 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beq	$a0, $t1, .LBB0_114
