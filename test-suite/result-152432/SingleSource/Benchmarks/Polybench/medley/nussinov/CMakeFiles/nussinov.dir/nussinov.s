...
.LBB7_10:                               # =>This Loop Header: Depth=1
	...
	move	$a4, $a5
	bltu	$a2, $a5, .LBB7_9
# %bb.11:                               # %.lr.ph133.split.us.preheader.i
                                        #   in Loop: Header=BB7_10 Depth=1
	move	$a5, $zero
	addi.d	$a6, $a4, 1
	mul.d	$a7, $a4, $s4
...
.LBB7_16:                               # %.lr.ph.us.i
	...
	bnez	$t7, .LBB7_16
	b	.LBB7_12
.LBB7_17:                               # %vector.body92.preheader
...
.LBB7_18:                               # %vector.body92
	...
	xvadd.d	$xr0, $xr0, $xr10
	bnez	$a0, .LBB7_18
# %bb.19:                               # %vec.epilog.vector.body106
	stptr.w	$s8, $fp, 2496
	move	$a0, $s1
	move	$a1, $zero
	move	$a2, $s2
...
.LBB7_21:                               # =>This Loop Header: Depth=1
	...
	move	$a4, $a5
	bltu	$a2, $a5, .LBB7_20
# %bb.22:                               # %.lr.ph133.split.us.preheader.i37
                                        #   in Loop: Header=BB7_21 Depth=1
	move	$a5, $zero
	addi.d	$a6, $a4, 1
	mul.d	$a7, $a4, $s4
