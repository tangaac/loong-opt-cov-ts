...
.LBB0_23:                               # %scalar.ph68
	...
	move	$a7, $a6
	bnez	$a0, .LBB0_23
.LBB0_24:                               # %tr_total_non_safe_moves.exit29
	ld.d	$a0, $s2, %pc_lo12(trait_file)
	alsl.d	$s5, $fp, $s4, 2
...
# %bb.46:
	xvpickve2gr.w	$a4, $xr0, 7
.LBB0_47:                               # %scalar.ph120.preheader
	sub.d	$a1, $a1, $a3
	alsl.d	$a3, $a3, $s6, 2
	add.d	$a3, $a3, $a0
...
.LBB0_52:
	move	$a2, $zero
	b	.LBB0_64
.LBB0_53:                               # %vector.main.loop.iter.check146
	ori	$a2, $zero, 15
	bgeu	$a1, $a2, .LBB0_55
# %bb.54:
	move	$a1, $zero
...
# %bb.57:                               # %middle.block157
	...
	xvpickve2gr.w	$a2, $xr0, 0
	beq	$a1, $a0, .LBB0_64
# %bb.58:                               # %vec.epilog.iter.check164
	andi	$a3, $a0, 12
	beqz	$a3, .LBB0_62
.LBB0_59:                               # %vec.epilog.ph163
	move	$a4, $a1
	...
	sub.d	$a4, $a4, $a1
	.p2align	4, , 16
.LBB0_60:                               # %vec.epilog.vector.body169
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vsrli.w	$vr2, $vr1, 1
	...
	addi.d	$a3, $a3, 16
	bnez	$a4, .LBB0_60
# %bb.61:                               # %vec.epilog.middle.block174
	vshuf4i.w	$vr1, $vr0, 14
	vadd.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vadd.w	$vr0, $vr0, $vr1
	vpickve2gr.w	$a2, $vr0, 0
	beq	$a1, $a0, .LBB0_64
.LBB0_62:                               # %vec.epilog.scalar.ph162.preheader
	pcalau12i	$a3, %got_pc_hi20(g_board)
	ld.d	$a3, $a3, %got_pc_lo12(g_board)
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $s6, 2
	...
	ori	$a4, $a4, 4092
	.p2align	4, , 16
.LBB0_63:                               # %vec.epilog.scalar.ph162
                                        # =>This Inner Loop Header: Depth=1
	ld.wu	$a5, $a3, 0
	srli.d	$a6, $a5, 1
