...
# %bb.14:                               # %vector.memcheck642
	alsl.d	$a4, $t2, $a1, 2
	bltu	$a0, $a4, .LBB2_32
.LBB2_15:                               # %vector.main.loop.iter.check653
	ori	$a4, $zero, 17
	addi.d	$t3, $t2, -1
	bgeu	$t0, $a4, .LBB2_17
# %bb.16:
...
.LBB2_18:                               # %vector.body659
	...
	addi.d	$t4, $t4, 64
	bnez	$t6, .LBB2_18
# %bb.19:                               # %middle.block666
	beq	$t3, $t5, .LBB2_34
# %bb.20:                               # %vec.epilog.iter.check671
	andi	$a4, $t3, 12
	beqz	$a4, .LBB2_31
.LBB2_21:                               # %vec.epilog.ph670
	move	$a4, $t3
	...
	sub.d	$t5, $t5, $a4
	.p2align	4, , 16
.LBB2_22:                               # %vec.epilog.vector.body678
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t6, 0
	vld	$vr2, $t6, -4
	vsub.w	$vr1, $vr1, $vr2
	...
	addi.d	$t7, $t7, 16
	bnez	$t5, .LBB2_22
# %bb.23:                               # %vec.epilog.middle.block684
	bne	$t3, $a4, .LBB2_32
	b	.LBB2_34
.LBB2_24:                               # %vector.ph
	move	$a4, $a3
...
# %bb.52:                               #   in Loop: Header=BB2_40 Depth=1
	...
	add.d	$t6, $t6, $t0
	blt	$s5, $s4, .LBB2_38
# %bb.53:                               #   in Loop: Header=BB2_40 Depth=1
	slt	$t0, $zero, $s3
	srai.d	$s6, $s3, 31
	or	$t0, $s6, $t0
	mul.d	$s3, $s3, $t0
...
# %bb.54:                               #   in Loop: Header=BB2_40 Depth=1
	...
	add.d	$t3, $t3, $t0
	blt	$s5, $s2, .LBB2_38
# %bb.55:                               #   in Loop: Header=BB2_40 Depth=1
	slt	$t0, $zero, $s1
	srai.d	$s3, $s1, 31
	or	$t0, $s3, $t0
	mul.d	$s1, $s1, $t0
...
# %bb.71:                               #   in Loop: Header=BB2_63 Depth=1
	...
	add.d	$a4, $a4, $t5
	b	.LBB2_62
.LBB2_72:                               # %._crit_edge558
	st.h	$a4, $a3, 0
	st.h	$t1, $a3, 2
	st.h	$t2, $a3, 4
	st.h	$t3, $a3, 6
	b	.LBB2_102
.LBB2_73:                               # %.preheader523
	bge	$t0, $a2, .LBB2_102
# %bb.74:                               # %.lr.ph570
...
.LBB2_80:                               #   in Loop: Header=BB2_77 Depth=1
	...
	b	.LBB2_92
	.p2align	4, , 16
.LBB2_81:                               # %vector.main.loop.iter.check692
                                        #   in Loop: Header=BB2_77 Depth=1
	ori	$a4, $zero, 16
	bgeu	$s4, $a4, .LBB2_83
...
# %bb.85:                               # %middle.block707
	...
	beq	$t2, $t1, .LBB2_92
# %bb.86:                               # %vec.epilog.iter.check712
                                        #   in Loop: Header=BB2_77 Depth=1
	move	$s8, $t2
	move	$ra, $t2
	ld.d	$a4, $sp, 8                     # 8-byte Folded Reload
	beqz	$a4, .LBB2_90
.LBB2_87:                               # %vec.epilog.ph711
                                        #   in Loop: Header=BB2_77 Depth=1
	vori.b	$vr2, $vr0, 0
	...
	alsl.d	$s7, $s8, $a3, 1
	.p2align	4, , 16
.LBB2_88:                               # %vec.epilog.vector.body719
                                        #   Parent Loop BB2_77 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s8, $s7, 0
	...
	addi.d	$s7, $s7, 8
	bnez	$a4, .LBB2_88
# %bb.89:                               # %vec.epilog.middle.block726
                                        #   in Loop: Header=BB2_77 Depth=1
...
# %bb.95:                               #   in Loop: Header=BB2_94 Depth=2
	...
	bge	$s7, $s2, .LBB2_94
	b	.LBB2_76
.LBB2_96:                               # %.preheader521.preheader
                                        #   in Loop: Header=BB2_77 Depth=1
	move	$ra, $s1
	move	$s0, $t3
	move	$a4, $s4
	.p2align	4, , 16
.LBB2_97:                               # %.preheader521
                                        #   Parent Loop BB2_77 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	blt	$a4, $s2, .LBB2_76
