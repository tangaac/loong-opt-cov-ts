...
# %bb.92:                               # %vec.epilog.middle.block
	...
	b	.LBB2_97
	.p2align	4, , 16
.LBB2_93:                               # %vector.ph766
                                        #   in Loop: Header=BB2_86 Depth=1
	move	$s1, $a7
	move	$s2, $a4
	.p2align	4, , 16
.LBB2_94:                               # %vector.body769
                                        #   Parent Loop BB2_86 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s1, -16
	vst	$vr0, $s1, 0
...
# %bb.152:                              #   in Loop: Header=BB2_150 Depth=1
	move	$ra, $zero
.LBB2_153:                              # %vec.epilog.ph801
                                        #   in Loop: Header=BB2_150 Depth=1
	add.d	$s8, $s3, $ra
	add.d	$ra, $a1, $ra
	alsl.d	$ra, $ra, $t2, 1
	.p2align	4, , 16
.LBB2_154:                              # %vec.epilog.vector.body809
	...
	addi.d	$ra, $ra, 16
	bnez	$s8, .LBB2_154
# %bb.155:                              # %vec.epilog.middle.block813
                                        #   in Loop: Header=BB2_150 Depth=1
	move	$s8, $s1
	beq	$a5, $a7, .LBB2_149
	b	.LBB2_160
	.p2align	4, , 16
.LBB2_156:                              # %vector.ph789
                                        #   in Loop: Header=BB2_150 Depth=1
	move	$s8, $s2
	move	$ra, $t8
	.p2align	4, , 16
.LBB2_157:                              # %vector.body794
                                        #   Parent Loop BB2_150 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s8, -16
	vst	$vr0, $s8, 0
	...
	addi.d	$s8, $s8, 32
	bnez	$ra, .LBB2_157
# %bb.158:                              # %middle.block797
                                        #   in Loop: Header=BB2_150 Depth=1
	beq	$a5, $t8, .LBB2_149
# %bb.159:                              # %vec.epilog.iter.check802
                                        #   in Loop: Header=BB2_150 Depth=1
	move	$ra, $t8
	move	$s8, $s0
	bnez	$a6, .LBB2_153
...
# %bb.167:                              #   in Loop: Header=BB2_164 Depth=1
	move	$s8, $zero
.LBB2_168:                              # %vec.epilog.ph834
                                        #   in Loop: Header=BB2_164 Depth=1
	add.d	$s6, $fp, $s8
	alsl.d	$s7, $s8, $s0, 1
	.p2align	4, , 16
.LBB2_169:                              # %vec.epilog.vector.body842
	...
	addi.d	$s7, $s7, 16
	bnez	$s6, .LBB2_169
# %bb.170:                              # %vec.epilog.middle.block845
                                        #   in Loop: Header=BB2_164 Depth=1
	move	$s7, $t7
	beq	$t7, $a1, .LBB2_163
	b	.LBB2_175
	.p2align	4, , 16
.LBB2_171:                              # %vector.ph822
                                        #   in Loop: Header=BB2_164 Depth=1
	move	$s6, $t8
	move	$s7, $t3
	.p2align	4, , 16
.LBB2_172:                              # %vector.body827
                                        #   Parent Loop BB2_164 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s6, -16
	vst	$vr0, $s6, 0
	...
	addi.d	$s6, $s6, 32
	bnez	$s7, .LBB2_172
# %bb.173:                              # %middle.block830
                                        #   in Loop: Header=BB2_164 Depth=1
	beq	$t3, $a1, .LBB2_163
# %bb.174:                              # %vec.epilog.iter.check835
                                        #   in Loop: Header=BB2_164 Depth=1
	move	$s8, $t3
	move	$s7, $t3
	bnez	$t6, .LBB2_168
...
# %bb.181:                              #   in Loop: Header=BB2_179 Depth=1
	move	$s2, $zero
.LBB2_182:                              # %vec.epilog.ph866
                                        #   in Loop: Header=BB2_179 Depth=1
	add.d	$s1, $t6, $s2
	add.d	$s2, $a1, $s2
	alsl.d	$s2, $s2, $t0, 1
	.p2align	4, , 16
.LBB2_183:                              # %vec.epilog.vector.body874
	...
	addi.d	$s2, $s2, 16
	bnez	$s1, .LBB2_183
# %bb.184:                              # %vec.epilog.middle.block878
                                        #   in Loop: Header=BB2_179 Depth=1
	move	$s1, $t4
	beq	$a5, $a7, .LBB2_178
	b	.LBB2_189
	.p2align	4, , 16
.LBB2_185:                              # %vector.ph854
                                        #   in Loop: Header=BB2_179 Depth=1
	move	$s1, $t5
	move	$s2, $a2
	.p2align	4, , 16
.LBB2_186:                              # %vector.body859
                                        #   Parent Loop BB2_179 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s1, -16
	vst	$vr0, $s1, 0
	...
	addi.d	$s1, $s1, 32
	bnez	$s2, .LBB2_186
# %bb.187:                              # %middle.block862
                                        #   in Loop: Header=BB2_179 Depth=1
	beq	$a5, $a2, .LBB2_178
# %bb.188:                              # %vec.epilog.iter.check867
                                        #   in Loop: Header=BB2_179 Depth=1
	move	$s2, $a2
	move	$s1, $t3
	bnez	$a6, .LBB2_182
