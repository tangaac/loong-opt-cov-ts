...
# %bb.125:                              #   in Loop: Header=BB17_26 Depth=1
	move	$a7, $s8
	b	.LBB17_132
.LBB17_126:                             # %vector.body831.preheader
                                        #   in Loop: Header=BB17_26 Depth=1
	addi.d	$a0, $sp, 508
	addi.d	$a1, $sp, 874
...
.LBB17_127:                             # %vector.body831
	...
	addi.d	$a0, $a0, 48
	bnez	$a2, .LBB17_127
# %bb.128:                              # %middle.block834
                                        #   in Loop: Header=BB17_26 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a0
	ori	$t3, $zero, 8
	beq	$a0, $t0, .LBB17_131
.LBB17_129:                             # %.lr.ph494.preheader839
                                        #   in Loop: Header=BB17_26 Depth=1
	alsl.d	$a0, $a2, $t1, 1
	sub.d	$a1, $t0, $a2
	slli.d	$a3, $a2, 4
...
# %bb.135:                              #   in Loop: Header=BB17_134 Depth=2
	...
	b	.LBB17_139
	.p2align	4, , 16
.LBB17_136:                             # %vector.body819.preheader
                                        #   in Loop: Header=BB17_134 Depth=2
	addi.d	$a3, $sp, 872
	move	$a4, $a2
	move	$a5, $t2
	.p2align	4, , 16
.LBB17_137:                             # %vector.body819
                                        #   Parent Loop BB17_26 Depth=1
	...
	addi.d	$a4, $a4, 256
	bnez	$a5, .LBB17_137
# %bb.138:                              # %middle.block823
                                        #   in Loop: Header=BB17_134 Depth=2
	move	$a5, $t2
	beq	$t2, $t0, .LBB17_133
.LBB17_139:                             # %scalar.ph814.preheader
                                        #   in Loop: Header=BB17_134 Depth=2
	alsl.d	$a3, $a5, $t1, 1
	slli.d	$a4, $a5, 5
	add.d	$a4, $a0, $a4
...
# %bb.148:                              # %middle.block809
	...
	beq	$a5, $a3, .LBB17_151
.LBB17_149:                             # %.lr.ph503.preheader838
                                        #   in Loop: Header=BB17_26 Depth=1
	slli.d	$a3, $a7, 1
...
# %bb.158:                              # %middle.block787
	...
	beq	$a5, $a2, .LBB17_161
.LBB17_159:                             # %.lr.ph509.preheader837
                                        #   in Loop: Header=BB17_26 Depth=1
	slli.d	$a2, $a7, 1
...
.LBB31_17:                              # %vector.body133.preheader
                                        #   in Loop: Header=BB31_15 Depth=3
	vld	$vr1, $s6, %pc_lo12(.LCPI31_0)
	vld	$vr2, $fp, %pc_lo12(.LCPI31_1)
	add.d	$a3, $a1, $s2
	slli.d	$a3, $a3, 5
	add.d	$a3, $ra, $a3
	move	$a4, $s4
