...
# %bb.54:                               # %middle.block1069
	...
	beq	$t5, $a2, .LBB4_57
.LBB4_55:                               # %scalar.ph1040.preheader
                                        #   in Loop: Header=BB4_49 Depth=4
	move	$a2, $s1
	move	$s5, $a0
	.p2align	4, , 16
...
# %bb.61:                               # %middle.block1033
	...
	beq	$t5, $a0, .LBB4_64
.LBB4_62:                               # %scalar.ph1004.preheader
                                        #   in Loop: Header=BB4_49 Depth=4
	move	$a0, $s5
	move	$s1, $s8
	.p2align	4, , 16
...
# %bb.68:                               # %middle.block997
	...
	beq	$t5, $a4, .LBB4_71
.LBB4_69:                               # %scalar.ph968.preheader
                                        #   in Loop: Header=BB4_49 Depth=4
	move	$s4, $s7
	move	$s5, $a3
	.p2align	4, , 16
.LBB4_70:                               # %scalar.ph968
                                        #   Parent Loop BB4_27 Depth=1
                                        #     Parent Loop BB4_43 Depth=2
                                        #       Parent Loop BB4_46 Depth=3
                                        #         Parent Loop BB4_49 Depth=4
...
.LBB4_76:                               # %scalar.ph
	...
	b	.LBB4_48
	.p2align	4, , 16
.LBB4_77:                               # %.preheader549.preheader
                                        #   in Loop: Header=BB4_27 Depth=1
	move	$a1, $zero
	move	$a2, $zero
...
# %bb.86:                               # %.preheader545.lr.ph
	...
	move	$a6, $zero
	blez	$a5, .LBB4_117
# %bb.87:                               # %.preheader545.us.preheader
                                        #   in Loop: Header=BB4_85 Depth=2
	move	$t7, $zero
	move	$t6, $zero
	move	$t4, $zero
	...
	b	.LBB4_89
	.p2align	4, , 16
.LBB4_88:                               # %._crit_edge610.us
                                        #   in Loop: Header=BB4_89 Depth=3
	addi.w	$a6, $a6, 4
	alsl.d	$a0, $a7, $t8, 1
	bge	$a6, $a4, .LBB4_84
.LBB4_89:                               # %.preheader545.us
                                        #   Parent Loop BB4_27 Depth=1
...
.LBB4_95:                               # %scalar.ph1258
	...
	move	$s1, $s2
	blt	$t8, $a5, .LBB4_95
.LBB4_96:                               # %.lr.ph593.us.preheader
                                        #   in Loop: Header=BB4_89 Depth=3
	ori	$a0, $zero, 29
	bgeu	$a5, $a0, .LBB4_98
# %bb.97:                               #   in Loop: Header=BB4_89 Depth=3
	move	$a0, $zero
	move	$t8, $s0
	move	$s1, $s2
	b	.LBB4_101
	.p2align	4, , 16
.LBB4_98:                               # %vector.ph1234
                                        #   in Loop: Header=BB4_89 Depth=3
	add.d	$t8, $s0, $t2
	vrepli.b	$vr0, 0
	add.d	$s1, $s2, $t2
...
.LBB4_102:                              # %.lr.ph593.us
	...
	move	$s2, $s1
	blt	$a0, $a5, .LBB4_102
.LBB4_103:                              # %.lr.ph601.us.preheader
                                        #   in Loop: Header=BB4_89 Depth=3
	ori	$a0, $zero, 29
	bgeu	$a5, $a0, .LBB4_105
# %bb.104:                              #   in Loop: Header=BB4_89 Depth=3
	move	$s2, $zero
	move	$a0, $t8
	move	$s0, $s1
	b	.LBB4_108
	.p2align	4, , 16
.LBB4_105:                              # %vector.ph1208
                                        #   in Loop: Header=BB4_89 Depth=3
	add.d	$a0, $t8, $t2
	vrepli.b	$vr0, 0
	add.d	$s0, $s1, $t2
...
.LBB4_109:                              # %.lr.ph601.us
	...
	move	$s1, $s0
	blt	$s2, $a5, .LBB4_109
.LBB4_110:                              # %.lr.ph609.us.preheader
                                        #   in Loop: Header=BB4_89 Depth=3
	ori	$t8, $zero, 29
	bgeu	$a5, $t8, .LBB4_112
...
.LBB4_119:                              # %.preheader551.1
	...
	b	.LBB4_122
	.p2align	4, , 16
.LBB4_120:                              #   in Loop: Header=BB4_122 Depth=2
	move	$t5, $zero
	move	$t4, $zero
	move	$t6, $zero
	move	$t7, $zero
...
# %bb.123:                              # %.preheader545.lr.ph.1
	...
	move	$a6, $zero
	blez	$a5, .LBB4_154
# %bb.124:                              # %.preheader545.us.1.preheader
                                        #   in Loop: Header=BB4_122 Depth=2
	move	$t7, $zero
	move	$t6, $zero
	move	$t4, $zero
	...
	b	.LBB4_126
	.p2align	4, , 16
.LBB4_125:                              # %._crit_edge610.us.1
                                        #   in Loop: Header=BB4_126 Depth=3
	addi.w	$a6, $a6, 4
	alsl.d	$a0, $a7, $a0, 1
	bge	$a6, $a4, .LBB4_121
.LBB4_126:                              # %.preheader545.us.1
                                        #   Parent Loop BB4_27 Depth=1
...
.LBB4_133:                              # %.lr.ph593.us.preheader.1
	...
	ori	$a0, $zero, 29
	bgeu	$a5, $a0, .LBB4_135
# %bb.134:                              #   in Loop: Header=BB4_126 Depth=3
	move	$s2, $zero
	move	$a0, $t8
	move	$s1, $s0
	b	.LBB4_138
	.p2align	4, , 16
.LBB4_135:                              # %vector.ph1130
                                        #   in Loop: Header=BB4_126 Depth=3
	add.d	$a0, $t8, $t2
	vrepli.b	$vr0, 0
	add.d	$s1, $s0, $t2
...
.LBB4_139:                              # %.lr.ph593.us.1
	...
	move	$s0, $s1
	blt	$s2, $a5, .LBB4_139
.LBB4_140:                              # %.lr.ph601.us.preheader.1
                                        #   in Loop: Header=BB4_126 Depth=3
	ori	$t8, $zero, 29
	bgeu	$a5, $t8, .LBB4_142
# %bb.141:                              #   in Loop: Header=BB4_126 Depth=3
	move	$s2, $zero
	move	$t8, $a0
	move	$s0, $s1
	b	.LBB4_145
	.p2align	4, , 16
.LBB4_142:                              # %vector.ph1104
                                        #   in Loop: Header=BB4_126 Depth=3
	add.d	$t8, $a0, $t2
	vrepli.b	$vr0, 0
	add.d	$s0, $s1, $t2
...
.LBB4_146:                              # %.lr.ph601.us.1
	...
	move	$s1, $s0
	blt	$s2, $a5, .LBB4_146
.LBB4_147:                              # %.lr.ph609.us.preheader.1
                                        #   in Loop: Header=BB4_126 Depth=3
	ori	$a0, $zero, 29
	bgeu	$a5, $a0, .LBB4_149
...
.LBB4_157:
	...
	b	.LBB4_159
	.p2align	4, , 16
.LBB4_158:                              #   in Loop: Header=BB4_159 Depth=1
	addi.d	$a5, $a5, 1
	addi.d	$a4, $a4, 1
	addi.d	$a3, $a3, 2
	addi.d	$a0, $a0, 2
