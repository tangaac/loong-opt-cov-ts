...
.LBB11_23:                              #   in Loop: Header=BB11_13 Depth=2
	...
	beqz	$a0, .LBB11_42
# %bb.24:                               # %vector.body86.preheader
                                        #   in Loop: Header=BB11_13 Depth=2
	move	$a1, $a0
	move	$a0, $zero
	.p2align	4, , 16
.LBB11_25:                              # %vector.body86
...
# %bb.126:                              #   in Loop: Header=BB61_122 Depth=1
	...
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	bne	$s6, $s0, .LBB61_122
.LBB61_127:                             # %._crit_edge757.loopexit
	st.w	$s8, $sp, 108
.LBB61_128:                             # %._crit_edge757
	pcalau12i	$a0, %pc_hi20(.L.str.139)
	addi.d	$a0, $a0, %pc_lo12(.L.str.139)
	ori	$a1, $zero, 3
	ori	$a2, $zero, 1
...
# %bb.150:
	...
	addi.d	$a0, $a0, 1
	st.w	$a0, $sp, 108
.LBB61_151:                             # %._crit_edge772.thread
	ld.d	$a0, $a1, 64
	addi.d	$a3, $sp, 108
	move	$a1, $s8
	move	$a2, $s1
...
.LBB61_160:                             #   Parent Loop BB61_154 Depth=1
	...
	blt	$s7, $a0, .LBB61_160
	b	.LBB61_156
.LBB61_161:                             # %._crit_edge780.loopexit
	st.w	$a1, $sp, 108
	ld.d	$s8, $sp, 48                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
.LBB61_162:                             # %._crit_edge780
	ld.d	$a0, $a0, 64
	addi.d	$a3, $sp, 108
	move	$a1, $s8
	move	$a2, $s1
...
# %bb.187:                              # %.lr.ph798
	...
	st.d	$s0, $sp, 72                    # 8-byte Folded Spill
	b	.LBB61_191
.LBB61_188:                             # %._crit_edge795.loopexit
                                        #   in Loop: Header=BB61_191 Depth=1
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	st.w	$a0, $sp, 108
	ld.d	$s8, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 72                    # 8-byte Folded Reload
.LBB61_189:                             # %._crit_edge795
                                        #   in Loop: Header=BB61_191 Depth=1
	ld.d	$a0, $a3, 32
	ldx.d	$a1, $a0, $s6
	addi.d	$a3, $sp, 108
...
.LBB61_206:                             # %.lr.ph804
	...
	addi.d	$s0, $s0, 1
	bnez	$fp, .LBB61_206
# %bb.207:                              # %._crit_edge805.loopexit
	st.w	$s0, $sp, 108
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
.LBB61_208:                             # %._crit_edge805
	ld.d	$a0, $a0, 64
	addi.d	$a3, $sp, 108
	move	$a1, $s8
	move	$a2, $s1
...
# %bb.211:
	...
	b	.LBB61_215
	.p2align	4, , 16
.LBB61_212:                             # %._crit_edge816.loopexit
                                        #   in Loop: Header=BB61_215 Depth=1
	st.w	$a2, $sp, 108
.LBB61_213:                             # %._crit_edge816
                                        #   in Loop: Header=BB61_215 Depth=1
	addi.d	$a3, $sp, 108
	move	$a0, $s1
	move	$a1, $s2
