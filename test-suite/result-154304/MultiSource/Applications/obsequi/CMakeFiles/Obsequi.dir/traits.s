...
# %bb.44:
	xvpickve2gr.w	$a4, $xr0, 7
.LBB0_45:                               # %scalar.ph126.preheader
	sub.d	$a1, $a1, $a3
	alsl.d	$a3, $a3, $s3, 2
	add.d	$a3, $a3, $a0
...
.LBB0_50:
	move	$a2, $zero
	b	.LBB0_62
.LBB0_51:                               # %vector.main.loop.iter.check152
	ori	$a2, $zero, 15
	bgeu	$a1, $a2, .LBB0_53
# %bb.52:
	move	$a1, $zero
...
# %bb.55:                               # %middle.block163
	...
	xvpickve2gr.w	$a2, $xr0, 0
	beq	$a1, $a0, .LBB0_62
# %bb.56:                               # %vec.epilog.iter.check170
	andi	$a3, $a0, 12
	beqz	$a3, .LBB0_60
.LBB0_57:                               # %vec.epilog.ph169
	move	$a4, $a1
	...
	sub.d	$a4, $a4, $a1
	.p2align	4, , 16
.LBB0_58:                               # %vec.epilog.vector.body175
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vsrli.w	$vr2, $vr1, 1
	...
	addi.d	$a3, $a3, 16
	bnez	$a4, .LBB0_58
# %bb.59:                               # %vec.epilog.middle.block180
	vshuf4i.w	$vr1, $vr0, 14
	vadd.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vadd.w	$vr0, $vr0, $vr1
	vpickve2gr.w	$a2, $vr0, 0
	beq	$a1, $a0, .LBB0_62
.LBB0_60:                               # %vec.epilog.scalar.ph168.preheader
	pcalau12i	$a3, %got_pc_hi20(g_board)
	ld.d	$a3, $a3, %got_pc_lo12(g_board)
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $s3, 2
	...
	ori	$a4, $a4, 4092
	.p2align	4, , 16
.LBB0_61:                               # %vec.epilog.scalar.ph168
                                        # =>This Inner Loop Header: Depth=1
	ld.wu	$a5, $a3, 0
	srli.d	$a6, $a5, 1
