...
.LBB3_28:                               #   in Loop: Header=BB3_25 Depth=1
	...
	b	.LBB3_40
	.p2align	4, , 16
.LBB3_29:                               # %vector.main.loop.iter.check260
                                        #   in Loop: Header=BB3_25 Depth=1
	ori	$a0, $zero, 16
	bgeu	$a2, $a0, .LBB3_31
...
# %bb.34:                               #   in Loop: Header=BB3_25 Depth=1
	...
	b	.LBB3_40
.LBB3_35:                               # %vec.epilog.iter.check279
                                        #   in Loop: Header=BB3_25 Depth=1
	andi	$a5, $a2, 12
	ld.d	$s1, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 64                    # 8-byte Folded Reload
	beqz	$a5, .LBB3_39
.LBB3_36:                               # %vec.epilog.ph278
                                        #   in Loop: Header=BB3_25 Depth=1
	move	$a5, $a4
	move	$a4, $a2
	...
	sub.d	$a0, $a5, $a4
	.p2align	4, , 16
.LBB3_37:                               # %vec.epilog.vector.body287
                                        #   Parent Loop BB3_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
...
.LBB3_79:                               #   in Loop: Header=BB3_73 Depth=1
	move	$s4, $zero
	b	.LBB3_91
.LBB3_80:                               # %vector.main.loop.iter.check302
                                        #   in Loop: Header=BB3_73 Depth=1
	bgeu	$t1, $t7, .LBB3_82
...
# %bb.85:                               #   in Loop: Header=BB3_73 Depth=1
	...
	ori	$t7, $zero, 16
	b	.LBB3_91
.LBB3_86:                               # %vec.epilog.iter.check321
                                        #   in Loop: Header=BB3_73 Depth=1
	andi	$a5, $t1, 12
	ld.d	$s7, $sp, 128                   # 8-byte Folded Reload
	ori	$t4, $zero, 1
...
.LBB3_87:                               # %vec.epilog.ph320
	...
	sub.d	$t3, $a5, $t2
	.p2align	4, , 16
.LBB3_88:                               # %vec.epilog.vector.body329
                                        #   Parent Loop BB3_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vpickve2gr.w	$a5, $vr4, 3
	vpickve2gr.w	$a6, $vr4, 2
