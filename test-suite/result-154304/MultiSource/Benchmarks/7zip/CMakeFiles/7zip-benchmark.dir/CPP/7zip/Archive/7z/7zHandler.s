...
.LBB12_61:                              # %_ZN11CStringBaseIwED2Ev.exit52
	...
	b	.LBB12_100
.LBB12_62:                              # %.fold.split99
	ori	$a0, $zero, 2
	b	.LBB12_80
.LBB12_63:                              # %.fold.split98
	ori	$a0, $zero, 3
	b	.LBB12_80
.LBB12_64:                              # %.fold.split96
	ori	$a0, $zero, 5
	b	.LBB12_80
.LBB12_65:                              # %.fold.split97
	ori	$a0, $zero, 4
	b	.LBB12_80
.LBB12_66:                              # %.fold.split100
	ori	$a0, $zero, 1
	b	.LBB12_80
.LBB12_67:                              # %.fold.split95
	ori	$a0, $zero, 6
	b	.LBB12_80
.LBB12_68:                              # %.fold.split86
	ori	$a0, $zero, 15
	b	.LBB12_80
.LBB12_69:                              # %.fold.split94
	ori	$a0, $zero, 7
	b	.LBB12_80
.LBB12_70:                              # %.fold.split78
	ori	$a0, $zero, 23
	b	.LBB12_80
.LBB12_71:                              # %.fold.split82
	ori	$a0, $zero, 19
	b	.LBB12_80
.LBB12_72:                              # %.fold.split90
	ori	$a0, $zero, 11
	b	.LBB12_80
.LBB12_73:                              # %.fold.split74
	ori	$a0, $zero, 27
	b	.LBB12_80
.LBB12_74:                              # %.fold.split84
	ori	$a0, $zero, 17
	b	.LBB12_80
.LBB12_75:                              # %.fold.split92
	ori	$a0, $zero, 9
	b	.LBB12_80
.LBB12_76:                              # %.fold.split76
	ori	$a0, $zero, 25
	b	.LBB12_80
.LBB12_77:                              # %.fold.split80
	ori	$a0, $zero, 21
	b	.LBB12_80
.LBB12_78:                              # %.fold.split88
	ori	$a0, $zero, 13
	b	.LBB12_80
.LBB12_79:                              # %.fold.split72
	ori	$a0, $zero, 29
.LBB12_80:
	addi.d	$a1, $sp, 24
	addi.d	$s1, $sp, 24
