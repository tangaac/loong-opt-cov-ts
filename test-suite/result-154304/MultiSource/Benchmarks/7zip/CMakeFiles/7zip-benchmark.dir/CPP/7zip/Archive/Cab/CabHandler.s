...
# %bb.70:                               # %middle.block192
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s6, .LBB4_77
# %bb.71:                               # %vec.epilog.iter.check197
                                        #   in Loop: Header=BB4_23 Depth=1
	andi	$a1, $s6, 48
	beqz	$a1, .LBB4_75
.LBB4_72:                               # %vec.epilog.ph196
	...
	add.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB4_73:                               # %vec.epilog.vector.body202
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vst	$vr0, $a2, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB4_73
# %bb.74:                               # %vec.epilog.middle.block206
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s6, .LBB4_77
