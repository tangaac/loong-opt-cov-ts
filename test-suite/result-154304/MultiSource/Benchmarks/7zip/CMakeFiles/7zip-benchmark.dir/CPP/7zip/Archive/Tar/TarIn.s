...
.LBB0_55:                               # %vec.epilog.ph399
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_56:                               # %vec.epilog.vector.body405
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_56
# %bb.57:                               # %vec.epilog.middle.block409
                                        #   in Loop: Header=BB0_2 Depth=1
	bne	$a2, $a1, .LBB0_180
	b	.LBB0_182
...
# %bb.86:                               # %iter.check417
	...
	ori	$a4, $zero, 31
	bgeu	$a4, $a3, .LBB0_189
# %bb.87:                               # %vector.main.loop.iter.check419
                                        #   in Loop: Header=BB0_2 Depth=1
	ori	$a2, $zero, 32
	bgeu	$a1, $a2, .LBB0_185
# %bb.88:                               #   in Loop: Header=BB0_2 Depth=1
	move	$a2, $zero
.LBB0_89:                               # %vec.epilog.ph432
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_90:                               # %vec.epilog.vector.body438
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_90
# %bb.91:                               # %vec.epilog.middle.block442
                                        #   in Loop: Header=BB0_2 Depth=1
	bne	$a2, $a1, .LBB0_189
	b	.LBB0_191
...
# %bb.96:                               # %iter.check450
	...
	ori	$a4, $zero, 31
	bgeu	$a4, $a3, .LBB0_199
# %bb.97:                               # %vector.main.loop.iter.check452
                                        #   in Loop: Header=BB0_2 Depth=1
	ori	$a2, $zero, 32
	bgeu	$a1, $a2, .LBB0_195
...
.LBB0_99:                               # %vec.epilog.ph465
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_100:                              # %vec.epilog.vector.body471
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_100
# %bb.101:                              # %vec.epilog.middle.block475
                                        #   in Loop: Header=BB0_2 Depth=1
	bne	$a2, $a1, .LBB0_199
	b	.LBB0_201
...
# %bb.155:                              #   in Loop: Header=BB0_2 Depth=1
	st.d	$zero, $s7, 16
.LBB0_156:                              # %vector.body479.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a0, $zero
...
# %bb.178:                              # %middle.block395
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_182
# %bb.179:                              # %vec.epilog.iter.check400
                                        #   in Loop: Header=BB0_2 Depth=1
	andi	$a3, $a1, 16
	bnez	$a3, .LBB0_55
...
.LBB0_186:                              # %vector.body423
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_186
# %bb.187:                              # %middle.block428
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_191
# %bb.188:                              # %vec.epilog.iter.check433
                                        #   in Loop: Header=BB0_2 Depth=1
	andi	$a3, $a1, 16
	bnez	$a3, .LBB0_89
.LBB0_189:                              # %vec.epilog.scalar.ph431.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s5, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_190:                              # %vec.epilog.scalar.ph431
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB0_196:                              # %vector.body456
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_196
# %bb.197:                              # %middle.block461
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_201
# %bb.198:                              # %vec.epilog.iter.check466
                                        #   in Loop: Header=BB0_2 Depth=1
	andi	$a3, $a1, 16
	bnez	$a3, .LBB0_99
...
.LBB0_217:                              # %vec.epilog.ph507
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_218:                              # %vec.epilog.vector.body513
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_218
# %bb.219:                              # %vec.epilog.middle.block517
	bne	$a2, $a1, .LBB0_228
	b	.LBB0_230
.LBB0_220:
	ext.w.b	$a2, $a1
...
.LBB0_223:                              # %._crit_edge.i.i117
	bnez	$a0, .LBB0_230
	b	.LBB0_231
.LBB0_224:                              # %vector.ph495
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a3, $s1, 16
	addi.d	$a4, $a0, 16
	move	$a5, $a2
.LBB0_225:                              # %vector.body498
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, -16
	vld	$vr1, $a4, 0
	vst	$vr0, $a3, -16
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_225
# %bb.226:                              # %middle.block503
	beq	$a2, $a1, .LBB0_230
# %bb.227:                              # %vec.epilog.iter.check508
	andi	$a3, $a1, 16
	bnez	$a3, .LBB0_217
...
.LBB0_251:                              # %vec.epilog.ph541
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_252:                              # %vec.epilog.vector.body547
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_252
# %bb.253:                              # %vec.epilog.middle.block551
	bne	$a2, $a1, .LBB0_259
	b	.LBB0_261
.LBB0_254:                              # %._crit_edge.i.i133
	bnez	$a0, .LBB0_261
	b	.LBB0_262
.LBB0_255:                              # %vector.ph529
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a3, $s1, 16
	addi.d	$a4, $a0, 16
	move	$a5, $a2
.LBB0_256:                              # %vector.body532
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, -16
	vld	$vr1, $a4, 0
	vst	$vr0, $a3, -16
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_256
# %bb.257:                              # %middle.block537
	beq	$a2, $a1, .LBB0_261
# %bb.258:                              # %vec.epilog.iter.check542
	andi	$a3, $a1, 16
	bnez	$a3, .LBB0_251
