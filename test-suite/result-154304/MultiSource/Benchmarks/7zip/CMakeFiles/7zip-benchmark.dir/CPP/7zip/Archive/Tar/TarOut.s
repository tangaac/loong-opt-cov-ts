...
# %bb.45:                               # %middle.block101
	beq	$a2, $a1, .LBB4_52
# %bb.46:                               # %vec.epilog.iter.check106
	andi	$a3, $a1, 48
	beqz	$a3, .LBB4_50
.LBB4_47:                               # %vec.epilog.ph105
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_48:                               # %vec.epilog.vector.body111
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_48
# %bb.49:                               # %vec.epilog.middle.block115
	beq	$a2, $a1, .LBB4_52
...
# %bb.35:                               # %middle.block101
	beq	$a2, $a1, .LBB7_42
# %bb.36:                               # %vec.epilog.iter.check106
	andi	$a3, $a1, 48
	beqz	$a3, .LBB7_40
.LBB7_37:                               # %vec.epilog.ph105
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_38:                               # %vec.epilog.vector.body111
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_38
# %bb.39:                               # %vec.epilog.middle.block115
	beq	$a2, $a1, .LBB7_42
...
# %bb.51:                               # %iter.check123
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB7_62
# %bb.52:                               # %vector.main.loop.iter.check125
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB7_55
# %bb.53:
	move	$a2, $zero
...
.LBB7_56:                               # %vector.body129
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB7_56
# %bb.57:                               # %middle.block134
	beq	$a2, $a1, .LBB7_64
# %bb.58:                               # %vec.epilog.iter.check139
	andi	$a3, $a1, 48
	beqz	$a3, .LBB7_62
.LBB7_59:                               # %vec.epilog.ph138
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_60:                               # %vec.epilog.vector.body144
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_60
# %bb.61:                               # %vec.epilog.middle.block148
	beq	$a2, $a1, .LBB7_64
.LBB7_62:                               # %vec.epilog.scalar.ph137.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB7_63:                               # %vec.epilog.scalar.ph137
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.73:                               # %iter.check156
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB7_84
# %bb.74:                               # %vector.main.loop.iter.check158
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB7_77
# %bb.75:
	move	$a2, $zero
...
.LBB7_78:                               # %vector.body162
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB7_78
# %bb.79:                               # %middle.block167
	beq	$a2, $a1, .LBB7_86
# %bb.80:                               # %vec.epilog.iter.check172
	andi	$a3, $a1, 48
	beqz	$a3, .LBB7_84
.LBB7_81:                               # %vec.epilog.ph171
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_82:                               # %vec.epilog.vector.body177
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_82
# %bb.83:                               # %vec.epilog.middle.block181
	beq	$a2, $a1, .LBB7_86
.LBB7_84:                               # %vec.epilog.scalar.ph170.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s1, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB7_85:                               # %vec.epilog.scalar.ph170
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
