...
.LBB4_42:                               # %vec.epilog.ph105
	...
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_43:                               # %vec.epilog.vector.body111
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_43
# %bb.44:                               # %vec.epilog.middle.block115
	bne	$a2, $a1, .LBB4_50
	b	.LBB4_52
...
# %bb.48:                               # %middle.block101
	beq	$a2, $a1, .LBB4_52
# %bb.49:                               # %vec.epilog.iter.check106
	andi	$a3, $a1, 16
	bnez	$a3, .LBB4_42
...
.LBB7_32:                               # %vec.epilog.ph105
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_33:                               # %vec.epilog.vector.body111
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.38:                               # %middle.block101
	beq	$a2, $a1, .LBB7_42
# %bb.39:                               # %vec.epilog.iter.check106
	andi	$a3, $a1, 16
	bnez	$a3, .LBB7_32
...
.LBB7_54:                               # %vec.epilog.ph138
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_55:                               # %vec.epilog.vector.body144
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_55
# %bb.56:                               # %vec.epilog.middle.block148
	bne	$a2, $a1, .LBB7_62
	b	.LBB7_64
.LBB7_57:                               # %._crit_edge.i.i34
	bnez	$a0, .LBB7_64
	b	.LBB7_65
.LBB7_58:                               # %vector.ph126
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a3, $s1, 16
	addi.d	$a4, $a0, 16
...
.LBB7_59:                               # %vector.body129
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB7_59
# %bb.60:                               # %middle.block134
	beq	$a2, $a1, .LBB7_64
# %bb.61:                               # %vec.epilog.iter.check139
	andi	$a3, $a1, 16
	bnez	$a3, .LBB7_54
...
.LBB7_76:                               # %vec.epilog.ph171
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_77:                               # %vec.epilog.vector.body177
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB7_77
# %bb.78:                               # %vec.epilog.middle.block181
	bne	$a2, $a1, .LBB7_84
	b	.LBB7_86
.LBB7_79:                               # %._crit_edge.i.i53
	bnez	$a0, .LBB7_86
	b	.LBB7_87
.LBB7_80:                               # %vector.ph159
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a3, $s1, 16
	addi.d	$a4, $a0, 16
...
.LBB7_81:                               # %vector.body162
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB7_81
# %bb.82:                               # %middle.block167
	beq	$a2, $a1, .LBB7_86
# %bb.83:                               # %vec.epilog.iter.check172
	andi	$a3, $a1, 16
	bnez	$a3, .LBB7_76
