...
# %bb.10:                               # %middle.block
	beq	$a3, $a4, .LBB19_13
.LBB19_11:                              # %.preheader.preheader84
	sub.d	$a3, $a2, $s1
	addi.d	$a3, $a3, -8
	add.d	$a2, $a0, $a2
	ori	$a4, $s0, 3336
...
# %bb.48:                               #   in Loop: Header=BB29_41 Depth=2
	...
	b	.LBB29_59
	.p2align	4, , 16
.LBB29_49:                              # %vector.main.loop.iter.check635
                                        #   in Loop: Header=BB29_41 Depth=2
...
.LBB29_51:                              # %vec.epilog.ph648
	...
	add.d	$s7, $a7, $s7
	.p2align	4, , 16
.LBB29_52:                              # %vec.epilog.vector.body654
                                        #   Parent Loop BB29_40 Depth=1
                                        #     Parent Loop BB29_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $s7, 0
	...
	addi.d	$s7, $s7, -16
	bnez	$s4, .LBB29_52
# %bb.53:                               # %vec.epilog.middle.block660
                                        #   in Loop: Header=BB29_41 Depth=2
	bne	$s8, $t5, .LBB29_59
	b	.LBB29_61
.LBB29_54:                              # %vector.ph636
                                        #   in Loop: Header=BB29_41 Depth=2
...
.LBB29_55:                              # %vector.body639
	...
	addi.d	$t5, $t5, -32
	bnez	$t6, .LBB29_55
# %bb.56:                               # %middle.block644
                                        #   in Loop: Header=BB29_41 Depth=2
	beq	$s8, $ra, .LBB29_61
# %bb.57:                               # %vec.epilog.iter.check649
                                        #   in Loop: Header=BB29_41 Depth=2
	andi	$t5, $s8, 16
	bnez	$t5, .LBB29_51
...
.LBB29_98:                              #   in Loop: Header=BB29_88 Depth=2
	...
	blt	$t6, $s8, .LBB29_97
	.p2align	4, , 16
.LBB29_99:                              # %vector.main.loop.iter.check797
                                        #   in Loop: Header=BB29_88 Depth=2
...
.LBB29_102:                             # %vector.body805
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB29_102
# %bb.103:                              # %middle.block810
                                        #   in Loop: Header=BB29_88 Depth=2
	beq	$ra, $t8, .LBB29_87
# %bb.104:                              # %vec.epilog.iter.check815
                                        #   in Loop: Header=BB29_88 Depth=2
	move	$t0, $ra
	move	$t1, $ra
	beqz	$s1, .LBB29_108
.LBB29_105:                             # %vec.epilog.ph814
                                        #   in Loop: Header=BB29_88 Depth=2
	xvld	$xr2, $a7, %pc_lo12(.LCPI29_7)
	xvreplgr2vr.d	$xr3, $t0
	xvor.v	$xr2, $xr3, $xr2
	.p2align	4, , 16
.LBB29_106:                             # %vec.epilog.vector.body827
                                        #   Parent Loop BB29_76 Depth=1
                                        #     Parent Loop BB29_88 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvslt.d	$xr3, $xr2, $xr0
	...
	xvaddi.du	$xr2, $xr2, 4
	bne	$t3, $t0, .LBB29_106
# %bb.107:                              # %vec.epilog.middle.block832
                                        #   in Loop: Header=BB29_88 Depth=2
	move	$t1, $t3
	beq	$t3, $t8, .LBB29_87
	.p2align	4, , 16
.LBB29_108:                             # %vec.epilog.scalar.ph813
                                        #   Parent Loop BB29_76 Depth=1
                                        #     Parent Loop BB29_88 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	slt	$a7, $t1, $a4
...
# %bb.120:                              #   in Loop: Header=BB29_119 Depth=4
	...
	b	.LBB29_124
	.p2align	4, , 16
.LBB29_121:                             # %vector.body780.preheader
...
# %bb.123:                              # %middle.block787
	...
	addi.d	$t7, $sp, 312
	beq	$a4, $a7, .LBB29_126
.LBB29_124:                             # %scalar.ph775.preheader
                                        #   in Loop: Header=BB29_119 Depth=4
	alsl.d	$t5, $t4, $t7, 2
	.p2align	4, , 16
.LBB29_125:                             # %scalar.ph775
                                        #   Parent Loop BB29_76 Depth=1
                                        #     Parent Loop BB29_111 Depth=2
                                        #       Parent Loop BB29_112 Depth=3
                                        #         Parent Loop BB29_119 Depth=4
...
# %bb.134:                              #   in Loop: Header=BB29_133 Depth=3
	...
	b	.LBB29_154
	.p2align	4, , 16
.LBB29_135:                             # %vector.body754.preheader
                                        #   in Loop: Header=BB29_133 Depth=3
	...
	b	.LBB29_137
	.p2align	4, , 16
.LBB29_136:                             # %pred.store.continue770
                                        #   in Loop: Header=BB29_137 Depth=4
	addi.d	$a0, $a0, -8
	addi.d	$a1, $a1, 32
	beqz	$a0, .LBB29_153
.LBB29_137:                             # %vector.body754
                                        #   Parent Loop BB29_76 Depth=1
                                        #     Parent Loop BB29_111 Depth=2
...
# %bb.138:                              # %pred.store.if
	...
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_146
.LBB29_139:                             # %pred.store.continue758
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_147
.LBB29_140:                             # %pred.store.if759
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 8
	xvpickve2gr.w	$a2, $xr0, 3
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_148
.LBB29_141:                             # %pred.store.continue762
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 4
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_149
.LBB29_142:                             # %pred.store.if763
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 16
	xvpickve2gr.w	$a2, $xr0, 5
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_150
.LBB29_143:                             # %pred.store.continue766
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 6
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_151
.LBB29_144:                             # %pred.store.if767
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 24
...
.LBB29_145:                             # %pred.store.continue
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_139
.LBB29_146:                             # %pred.store.if757
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 4
	xvpickve2gr.w	$a2, $xr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_140
.LBB29_147:                             # %pred.store.continue760
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_141
.LBB29_148:                             # %pred.store.if761
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 12
	xvpickve2gr.w	$a2, $xr0, 4
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_142
.LBB29_149:                             # %pred.store.continue764
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 5
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_143
.LBB29_150:                             # %pred.store.if765
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 20
	xvpickve2gr.w	$a2, $xr0, 6
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_144
.LBB29_151:                             # %pred.store.continue768
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 7
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_136
.LBB29_152:                             # %pred.store.if769
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 28
	b	.LBB29_136
	.p2align	4, , 16
.LBB29_153:                             # %middle.block772
                                        #   in Loop: Header=BB29_133 Depth=3
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	move	$a1, $a0
	beq	$a0, $a3, .LBB29_132
...
# %bb.164:                              # %middle.block732
	...
	addi.d	$a3, $sp, 312
	beq	$a0, $s1, .LBB29_170
# %bb.165:                              # %vec.epilog.iter.check737
                                        #   in Loop: Header=BB29_76 Depth=1
	andi	$a1, $s1, 48
	beqz	$a1, .LBB29_169
.LBB29_166:                             # %vec.epilog.ph736
                                        #   in Loop: Header=BB29_76 Depth=1
	move	$a2, $a0
	...
	add.d	$a2, $a3, $a2
	.p2align	4, , 16
.LBB29_167:                             # %vec.epilog.vector.body742
                                        #   Parent Loop BB29_76 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a2, 0
	vaddi.bu	$vr0, $vr0, 16
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB29_167
# %bb.168:                              # %vec.epilog.middle.block747
                                        #   in Loop: Header=BB29_76 Depth=1
	addi.d	$a3, $sp, 312
	beq	$a0, $s1, .LBB29_170
	.p2align	4, , 16
...
# %bb.187:                              #   in Loop: Header=BB29_186 Depth=4
	...
	b	.LBB29_185
	.p2align	4, , 16
.LBB29_188:                             # %vector.main.loop.iter.check690
                                        #   in Loop: Header=BB29_172 Depth=2
	ori	$a3, $zero, 32
	bgeu	$a2, $a3, .LBB29_194
# %bb.189:                              #   in Loop: Header=BB29_172 Depth=2
	move	$a4, $zero
.LBB29_190:                             # %vec.epilog.ph704
                                        #   in Loop: Header=BB29_172 Depth=2
...
# %bb.217:                              #   in Loop: Header=BB29_216 Depth=5
	...
	b	.LBB29_215
	.p2align	4, , 16
.LBB29_218:                             # %.preheader611.preheader
                                        #   in Loop: Header=BB29_209 Depth=4
	ori	$a7, $zero, 1
	ori	$t0, $zero, 1
	b	.LBB29_220
