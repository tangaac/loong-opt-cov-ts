...
.LBB29_50:                              # %vector.body635
	...
	addi.d	$s5, $s5, -16
	bnez	$ra, .LBB29_50
# %bb.51:                               # %middle.block640
                                        #   in Loop: Header=BB29_41 Depth=2
	beq	$s7, $s8, .LBB29_54
.LBB29_52:                              # %.lr.ph31.i.preheader797
                                        #   in Loop: Header=BB29_41 Depth=2
	addi.d	$s5, $s6, 1
	add.d	$s6, $t0, $s6
	.p2align	4, , 16
...
.LBB29_91:                              #   in Loop: Header=BB29_81 Depth=2
	...
	blt	$t6, $s8, .LBB29_90
	.p2align	4, , 16
.LBB29_92:                              # %vector.main.loop.iter.check747
                                        #   in Loop: Header=BB29_81 Depth=2
	vreplgr2vr.d	$vr0, $a4
	vreplgr2vr.d	$vr1, $a6
...
.LBB29_95:                              # %vector.body755
	...
	addi.d	$t1, $t1, 16
	bnez	$t2, .LBB29_95
# %bb.96:                               # %middle.block760
                                        #   in Loop: Header=BB29_81 Depth=2
	beq	$ra, $t8, .LBB29_80
# %bb.97:                               # %vec.epilog.iter.check765
                                        #   in Loop: Header=BB29_81 Depth=2
	move	$t1, $ra
	move	$t2, $ra
	ld.d	$t5, $sp, 192                   # 8-byte Folded Reload
	beqz	$t5, .LBB29_101
.LBB29_98:                              # %vec.epilog.ph764
                                        #   in Loop: Header=BB29_81 Depth=2
	...
	vor.v	$vr3, $vr4, $vr3
	.p2align	4, , 16
.LBB29_99:                              # %vec.epilog.vector.body777
                                        #   Parent Loop BB29_69 Depth=1
                                        #     Parent Loop BB29_81 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vslt.d	$vr4, $vr3, $vr0
	...
	vaddi.du	$vr2, $vr2, 4
	bne	$t3, $t1, .LBB29_99
# %bb.100:                              # %vec.epilog.middle.block782
                                        #   in Loop: Header=BB29_81 Depth=2
	move	$t2, $t3
	beq	$t3, $t8, .LBB29_80
	.p2align	4, , 16
.LBB29_101:                             # %vec.epilog.scalar.ph763
                                        #   Parent Loop BB29_69 Depth=1
                                        #     Parent Loop BB29_81 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	slt	$a7, $t2, $a4
...
# %bb.152:                              #   in Loop: Header=BB29_69 Depth=1
	...
	b	.LBB29_162
	.p2align	4, , 16
.LBB29_153:                             # %vector.main.loop.iter.check673
                                        #   in Loop: Header=BB29_69 Depth=1
	addi.d	$t7, $sp, 480
	ld.d	$s3, $sp, 136                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 120                   # 8-byte Folded Reload
...
# %bb.161:                              # %vec.epilog.middle.block695
	...
	beq	$a0, $s1, .LBB29_163
	.p2align	4, , 16
.LBB29_162:                             # %vec.epilog.scalar.ph683
                                        #   Parent Loop BB29_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.b	$a0, $a0, $a3
	addi.d	$a0, $a0, 1
...
# %bb.202:                              #   in Loop: Header=BB29_201 Depth=5
	...
	b	.LBB29_200
	.p2align	4, , 16
.LBB29_203:                             # %.preheader611.preheader
                                        #   in Loop: Header=BB29_194 Depth=4
	ori	$a7, $zero, 1
	ori	$t0, $zero, 1
	b	.LBB29_205
