...
.LBB12_366:                             #   in Loop: Header=BB12_152 Depth=1
	beqz	$s4, .LBB12_378
# %bb.367:                              #   in Loop: Header=BB12_152 Depth=1
.Ltmp438:                               # EH_LABEL
	move	$a0, $s4
...
.Ltmp447:                               # EH_LABEL
	...
	jirl	$ra, $a1, 0
.Ltmp448:                               # EH_LABEL
.LBB12_370:                             # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit324.i.i
                                        #   in Loop: Header=BB12_152 Depth=1
...
.Ltmp450:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp451:                               # EH_LABEL
.LBB12_371:                             # %_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit.i.i
                                        #   in Loop: Header=BB12_152 Depth=1
	addi.d	$a0, $sp, 760
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB12_372:                             #   in Loop: Header=BB12_152 Depth=1
	ld.d	$a0, $sp, 800
	beqz	$a0, .LBB12_374
# %bb.373:                              #   in Loop: Header=BB12_152 Depth=1
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp453:                               # EH_LABEL
	jirl	$ra, $a1, 0
...
.LBB12_374:                             # %_ZL8CompressP7CCodecsRKN14NUpdateArchive10CActionSetEP10IInArchiveRK22CCompressionMethodModeR12CArchivePathRK13CObjectVectorI8CArcItemEbbbRK9CDirItemsbRK11CStringBaseIwERK13CRecordVectorIyER10CTempFilesR16CUpdateErrorInfoP17IUpdateCallbackUI.exit.i
                                        #   in Loop: Header=BB12_152 Depth=1
	bnez	$s3, .LBB12_413
# %bb.375:                              #   in Loop: Header=BB12_152 Depth=1
	ld.d	$a0, $sp, 360                   # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 136
.Ltmp456:                               # EH_LABEL
...
# %bb.376:                              # %.noexc390
	...
	move	$s3, $a0
	bnez	$a0, .LBB12_413
# %bb.377:                              #   in Loop: Header=BB12_152 Depth=1
	ld.w	$a0, $s0, 52
	addi.d	$s1, $s1, 1
	blt	$s1, $a0, .LBB12_152
	b	.LBB12_379
...
# %bb.410:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_411:                             # %_ZN11CStringBaseIwED2Ev.exit392
	beqz	$s0, .LBB12_413
.LBB12_412:
	move	$s3, $zero
.LBB12_413:                             # %_ZL19UpdateWithItemListsP7CCodecsR14CUpdateOptionsP10IInArchiveRK13CObjectVectorI8CArcItemER9CDirItemsR10CTempFilesR16CUpdateErrorInfoP18IUpdateCallbackUI2.exit.thread
...
.Ltmp495:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp496:                               # EH_LABEL
# %bb.417:                              # %_ZN11CStringBaseIwED2Ev.exit393
	addi.d	$a0, $sp, 408
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB12_418:
...
# %bb.422:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_423:                             # %_ZN11CStringBaseIwED2Ev.exit395
	addi.d	$a0, $sp, 584
...
.LBB12_457:
.Ltmp393:                               # EH_LABEL
.LBB12_458:                             # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit320.i.i
	move	$fp, $a0
...
.Ltmp331:                               # EH_LABEL
	...
	move	$a0, $s2
	b	.LBB12_474
.LBB12_463:                             # %.loopexit.split-lp.i.i
.Ltmp369:                               # EH_LABEL
	b	.LBB12_524
.LBB12_464:
.Ltmp323:                               # EH_LABEL
.LBB12_465:
	...
	move	$fp, $a0
	bnez	$a1, .LBB12_468
# %bb.466:                              # %_ZN11CStringBaseIwED2Ev.exit299.i.i
	ld.d	$a0, $sp, 664
	bnez	$a0, .LBB12_469
.LBB12_467:                             # %_ZN11CStringBaseIwED2Ev.exit300.i.i
	ld.d	$a0, $sp, 744
	bnez	$a0, .LBB12_471
	b	.LBB12_542
.LBB12_468:
...
.Ltmp303:                               # EH_LABEL
	...
	ori	$a1, $zero, 128
	move	$a0, $s8
.LBB12_474:                             # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit327.i.i
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	b	.LBB12_543
.LBB12_475:
...
.Ltmp377:                               # EH_LABEL
	b	.LBB12_540
.LBB12_491:                             # %_ZN9CMyComPtrI9IInStreamED2Ev.exit322.i.loopexit.split-lp.i
.Ltmp308:                               # EH_LABEL
	b	.LBB12_540
.LBB12_492:
.Ltmp174:                               # EH_LABEL
...
.LBB12_505:
	...
	jirl	$ra, $ra, 0
	b	.LBB12_549
.LBB12_506:                             # %_ZN9CMyComPtrI9IInStreamED2Ev.exit322.thread388.i.i
.Ltmp374:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB12_543
.LBB12_507:
...
.LBB12_522:
	move	$fp, $a0
	b	.LBB12_583
.LBB12_523:                             # %.loopexit.i.i
.Ltmp356:                               # EH_LABEL
.LBB12_524:                             # %.loopexit.split-lp.i.body.i
	move	$fp, $a0
...
.Ltmp500:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB12_539:                             # %_ZN9CMyComPtrI9IInStreamED2Ev.exit322.i.loopexit.i
.Ltmp311:                               # EH_LABEL
...
.Ltmp441:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp442:                               # EH_LABEL
.LBB12_543:                             # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit327.i.i
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp444:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp445:                               # EH_LABEL
.LBB12_544:                             # %_ZN9CMyComPtrI22IArchiveUpdateCallbackED2Ev.exit329.i.i
	addi.d	$a0, $sp, 760
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB12_569
...
# %bb.550:
	ld.d	$a0, $sp, 568
	bnez	$a0, .LBB12_584
.LBB12_551:                             # %_ZN11CStringBaseIwED2Ev.exit396
	addi.d	$a0, $sp, 584
	pcaddu18i	$ra, %call36(_ZN12CArchiveLinkD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
.Ltmp253:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB12_556:                             # %.loopexit.split-lp.i
.Ltmp247:                               # EH_LABEL
	b	.LBB12_558
.LBB12_557:                             # %.loopexit.i
.Ltmp244:                               # EH_LABEL
.LBB12_558:
	move	$fp, $a0
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
...
.LBB12_567:
.Ltmp263:                               # EH_LABEL
.LBB12_568:                             # %_ZN9CMyComPtrI10IInArchiveED2Ev.exit.i.i
	move	$fp, $a0
...
.LBB12_571:
.Ltmp160:                               # EH_LABEL
.LBB12_572:                             # %_ZN11CStringBaseIwED2Ev.exit
	move	$fp, $a0
...
# %bb.581:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_582:                             # %_ZN11CStringBaseIwED2Ev.exit394
	addi.d	$a0, $sp, 408
