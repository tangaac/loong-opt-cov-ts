...
.LBB2_14:                               # %vector.body734
	...
	addi.d	$fp, $fp, -32
	bnez	$s0, .LBB2_14
# %bb.15:                               # %middle.block741
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t7, $t8, .LBB2_18
.LBB2_16:                               # %scalar.ph729.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t7, $t6, $s3, 2
	.p2align	4, , 16
.LBB2_17:                               # %scalar.ph729
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t8, $t7, -4
	addi.d	$fp, $t7, -4
...
# %bb.43:                               # %middle.block711
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t7, $t8, .LBB2_46
.LBB2_44:                               # %scalar.ph699.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t7, $t6, $a6, 2
	.p2align	4, , 16
.LBB2_45:                               # %scalar.ph699
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t8, $t7, -4
	addi.d	$fp, $t7, -4
...
.LBB2_56:                               # %vector.body689
	...
	addi.d	$t8, $t8, -32
	bnez	$fp, .LBB2_56
# %bb.57:                               # %middle.block696
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t6, $t7, .LBB2_60
.LBB2_58:                               # %scalar.ph684.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t6, $t3, $a6, 2
	.p2align	4, , 16
.LBB2_59:                               # %scalar.ph684
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, -4
	addi.d	$t8, $t6, -4
...
.LBB2_70:                               # %vector.body674
	...
	addi.d	$t8, $t8, -32
	bnez	$fp, .LBB2_70
# %bb.71:                               # %middle.block681
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t6, $t7, .LBB2_74
.LBB2_72:                               # %scalar.ph669.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t6, $t5, $t0, 2
	.p2align	4, , 16
.LBB2_73:                               # %scalar.ph669
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, -4
	addi.d	$t8, $t6, -4
...
# %bb.115:                              #   in Loop: Header=BB2_113 Depth=3
	...
	b	.LBB2_120
	.p2align	4, , 16
.LBB2_116:                              # %vector.ph748
                                        #   in Loop: Header=BB2_113 Depth=3
	move	$t2, $ra
	move	$t1, $t7
	.p2align	4, , 16
.LBB2_117:                              # %vector.body751
                                        #   Parent Loop BB2_94 Depth=1
                                        #     Parent Loop BB2_111 Depth=2
...
.LBB2_137:
	...
	ld.d	$t8, $sp, 8                     # 8-byte Folded Reload
	b	.LBB2_164
.LBB2_138:                              # %.lr.ph260.us.preheader
	ori	$a0, $zero, 1
	bne	$t6, $a0, .LBB2_140
# %bb.139:
	move	$a0, $zero
	b	.LBB2_143
.LBB2_140:                              # %vector.ph767
	slt	$a2, $a0, $t6
	masknez	$a0, $a0, $a2
	maskeqz	$a2, $t6, $a2
	or	$a2, $a2, $a0
	...
	move	$a3, $a0
	.p2align	4, , 16
.LBB2_141:                              # %vector.body770
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a3, $a3, -2
	bnez	$a3, .LBB2_141
# %bb.142:                              # %middle.block773
	beq	$a2, $a0, .LBB2_144
	.p2align	4, , 16
.LBB2_143:                              # %._crit_edge261.split.us272
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a0, $a0, 1
	blt	$a0, $t6, .LBB2_143
.LBB2_144:
...
.LBB2_145:                              # %.lr.ph268.1
	blt	$s5, $a1, .LBB2_164
# %bb.146:                              # %.lr.ph268.split.us.1
	ori	$a1, $zero, 2
	blt	$s0, $a1, .LBB2_156
# %bb.147:                              # %.lr.ph260.us.us.1.preheader
	move	$a1, $zero
	move	$a2, $zero
	mul.d	$a3, $s2, $t7
	b	.LBB2_149
	.p2align	4, , 16
.LBB2_148:                              # %._crit_edge261.split.us.us.us.1
                                        #   in Loop: Header=BB2_149 Depth=1
	addi.w	$a2, $a2, 1
	add.w	$a1, $a1, $a3
	bge	$a2, $t6, .LBB2_164
.LBB2_149:                              # %.lr.ph260.us.us.1
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB2_151
	.p2align	4, , 16
.LBB2_150:                              # %._crit_edge254.us.us.us.1
                                        #   in Loop: Header=BB2_151 Depth=2
	addi.w	$a4, $a4, 1
	addi.w	$a5, $a5, 1
	bge	$a4, $t7, .LBB2_148
.LBB2_151:                              # %.lr.ph253.us.us.us.1
...
# %bb.155:                              #   in Loop: Header=BB2_153 Depth=3
	...
	bnez	$a6, .LBB2_153
	b	.LBB2_150
.LBB2_156:                              # %.lr.ph260.us.1.preheader
	move	$a1, $zero
	...
	b	.LBB2_158
	.p2align	4, , 16
.LBB2_157:                              # %._crit_edge261.split.us272.1
                                        #   in Loop: Header=BB2_158 Depth=1
	addi.w	$a1, $a1, 1
	bge	$a1, $t6, .LBB2_164
.LBB2_158:                              # %.lr.ph260.us.1
                                        # =>This Loop Header: Depth=1
...
# %bb.159:                              #   in Loop: Header=BB2_158 Depth=1
	...
	b	.LBB2_163
	.p2align	4, , 16
.LBB2_160:                              # %vector.body781.preheader
                                        #   in Loop: Header=BB2_158 Depth=1
	move	$a4, $a2
	.p2align	4, , 16
.LBB2_161:                              # %vector.body781
                                        #   Parent Loop BB2_158 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $a4, -2
	bnez	$a4, .LBB2_161
# %bb.162:                              # %middle.block784
                                        #   in Loop: Header=BB2_158 Depth=1
	move	$a4, $a2
	beq	$t7, $a2, .LBB2_157
	.p2align	4, , 16
.LBB2_163:                              # %scalar.ph776
                                        #   Parent Loop BB2_158 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $a4, 1
	blt	$a4, $t7, .LBB2_163
	b	.LBB2_157
.LBB2_164:                              # %._crit_edge269.thread587
	ori	$a1, $zero, 2
	blt	$s5, $a1, .LBB2_182
# %bb.165:                              # %._crit_edge269.thread587
	blt	$s0, $a1, .LBB2_182
# %bb.166:                              # %.lr.ph268.split.us.2
	ori	$a1, $zero, 1
	blt	$t6, $a1, .LBB2_176
# %bb.167:                              # %.lr.ph260.us.us.2.preheader
	move	$a1, $zero
	mul.d	$a2, $s2, $t7
	b	.LBB2_169
	.p2align	4, , 16
.LBB2_168:                              # %._crit_edge261.split.us.us.us.2
                                        #   in Loop: Header=BB2_169 Depth=1
	addi.w	$a1, $a1, 1
	bge	$a1, $t7, .LBB2_182
.LBB2_169:                              # %.lr.ph260.us.us.2
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB2_171
	.p2align	4, , 16
.LBB2_170:                              # %._crit_edge254.us.us.us.2
                                        #   in Loop: Header=BB2_171 Depth=2
	addi.w	$a3, $a3, 1
	add.w	$a4, $a4, $t7
	bge	$a3, $s2, .LBB2_168
.LBB2_171:                              # %.lr.ph253.us.us.us.2
...
.LBB2_173:                              #   Parent Loop BB2_169 Depth=1
	...
	ldx.w	$t0, $s1, $t0
	beqz	$a7, .LBB2_172
# %bb.174:                              #   in Loop: Header=BB2_173 Depth=3
	addi.w	$a7, $a0, 0
	bne	$t0, $a7, .LBB2_172
# %bb.175:                              #   in Loop: Header=BB2_173 Depth=3
	alsl.d	$a7, $a6, $s1, 2
	st.w	$zero, $a7, 0
	addi.w	$a7, $s7, 0
	slli.d	$a7, $a7, 2
	...
	bnez	$a5, .LBB2_173
	b	.LBB2_170
.LBB2_176:                              # %.lr.ph260.us.2.preheader
	ori	$a0, $zero, 2
	bne	$s5, $a0, .LBB2_178
# %bb.177:
	move	$a0, $zero
	b	.LBB2_181
.LBB2_178:                              # %vector.ph790
	slt	$a0, $a1, $t7
	masknez	$a1, $a1, $a0
	maskeqz	$a0, $t7, $a0
	or	$a1, $a0, $a1
	...
	move	$a2, $a0
	.p2align	4, , 16
.LBB2_179:                              # %vector.body793
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, -2
	bnez	$a2, .LBB2_179
# %bb.180:                              # %middle.block796
	beq	$a1, $a0, .LBB2_182
	.p2align	4, , 16
.LBB2_181:                              # %._crit_edge261.split.us272.2
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a0, $a0, 1
	blt	$a0, $t7, .LBB2_181
.LBB2_182:                              # %._crit_edge269.2
	blez	$t8, .LBB2_185
# %bb.183:                              # %.lr.ph283.preheader
	ori	$a0, $zero, 8
	bgeu	$t8, $a0, .LBB2_186
# %bb.184:
	move	$a0, $zero
...
.LBB2_187:                              # %vector.body804
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_187
# %bb.188:                              # %middle.block810
	vadd.w	$vr0, $vr1, $vr0
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a1, $vr0, 0
	beq	$a0, $t8, .LBB2_191
.LBB2_189:                              # %.lr.ph283.preheader813
	alsl.d	$a2, $a0, $s1, 2
	sub.d	$a0, $t8, $a0
	.p2align	4, , 16
.LBB2_190:                              # %.lr.ph283
...
.LBB2_191:                              # %._crit_edge284
	...
	blt	$t7, $a0, .LBB2_202
# %bb.192:                              # %._crit_edge284
	ori	$a0, $zero, 2
	blt	$s0, $a0, .LBB2_202
# %bb.193:                              # %._crit_edge284
	blt	$s5, $a0, .LBB2_202
# %bb.194:                              # %.preheader201.us.us.preheader
	move	$a0, $zero
	move	$a1, $zero
	move	$a7, $zero
	...
	b	.LBB2_196
	.p2align	4, , 16
.LBB2_195:                              # %._crit_edge296.split.us.us.us
                                        #   in Loop: Header=BB2_196 Depth=1
	addi.d	$a0, $a0, 1
	add.w	$a7, $a6, $a5
	beq	$a0, $t7, .LBB2_202
.LBB2_196:                              # %.preheader201.us.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB2_198
	.p2align	4, , 16
.LBB2_197:                              # %._crit_edge290.us.us.us
                                        #   in Loop: Header=BB2_198 Depth=2
	addi.d	$a3, $a3, 1
	add.w	$a7, $a6, $a5
	beq	$a3, $s2, .LBB2_195
.LBB2_198:                              # %.preheader.us.us.us
...
.LBB2_199:                              #   in Loop: Header=BB2_200 Depth=3
	...
	addi.d	$t1, $t1, 4
	beq	$a2, $a5, .LBB2_197
.LBB2_200:                              #   Parent Loop BB2_196 Depth=1
