...
.LBB8_33:                               # %vec.epilog.ph228
	...
	addi.d	$a4, $a4, 96
	.p2align	4, , 16
.LBB8_34:                               # %vec.epilog.vector.body234
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a4, -84
	ld.w	$a6, $a4, -60
	ld.w	$a7, $a4, -36
	...
	addi.d	$a4, $a4, 192
	bnez	$a3, .LBB8_34
# %bb.35:                               # %vec.epilog.middle.block238
	xvpermi.d	$xr1, $xr0, 78
	xvshuf4i.w	$xr1, $xr1, 228
	xvadd.w	$xr0, $xr0, $xr1
	xvpermi.d	$xr1, $xr0, 68
...
# %bb.38:                               # %middle.block223
	...
	xvpickve2gr.w	$a3, $xr0, 0
	beq	$a2, $a1, .LBB8_42
# %bb.39:                               # %vec.epilog.iter.check229
	andi	$a4, $a1, 8
	bnez	$a4, .LBB8_33
...
.LBB8_52:
	move	$a3, $zero
	b	.LBB8_64
.LBB8_53:                               # %vector.main.loop.iter.check247
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB8_58
# %bb.54:
	move	$a2, $zero
	move	$a3, $zero
.LBB8_55:                               # %vec.epilog.ph262
	move	$a4, $a2
...
# %bb.61:                               # %vec.epilog.iter.check263
	andi	$a4, $a0, 8
	bnez	$a4, .LBB8_55
.LBB8_62:                               # %vec.epilog.scalar.ph261.preheader
	slli.d	$a4, $a2, 4
	alsl.d	$a4, $a2, $a4, 3
	add.d	$a1, $a4, $a1
	addi.d	$a1, $a1, 16
	...
	addi.w	$a2, $zero, -1
	.p2align	4, , 16
.LBB8_63:                               # %vec.epilog.scalar.ph261
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, -4
	ld.w	$a5, $a1, -16
	sub.w	$a4, $a4, $a5
