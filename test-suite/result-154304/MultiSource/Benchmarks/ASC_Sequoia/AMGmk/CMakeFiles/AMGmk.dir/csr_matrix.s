...
.LBB8_30:                               # %vec.epilog.ph70
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB8_31:                               # %vec.epilog.vector.body76
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB8_31
# %bb.32:                               # %vec.epilog.middle.block80
	beq	$a2, $s1, .LBB8_35
...
# %bb.30:                               # %middle.block447
	beq	$a1, $s2, .LBB9_37
# %bb.31:                               # %vec.epilog.iter.check452
	andi	$a2, $s2, 12
	beqz	$a2, .LBB9_35
.LBB9_32:                               # %vec.epilog.ph451
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s0, 2
	.p2align	4, , 16
.LBB9_33:                               # %vec.epilog.vector.body457
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB9_33
# %bb.34:                               # %vec.epilog.middle.block461
	beq	$a1, $s2, .LBB9_37
...
# %bb.42:                               #   in Loop: Header=BB9_41 Depth=1
	...
	b	.LBB9_52
	.p2align	4, , 16
.LBB9_43:                               # %vector.main.loop.iter.check469
...
# %bb.47:                               # %middle.block482
	...
	sltu	$t4, $zero, $t4
	beq	$a2, $s2, .LBB9_54
# %bb.48:                               # %vec.epilog.iter.check490
                                        #   in Loop: Header=BB9_41 Depth=1
	move	$t6, $a2
	move	$t5, $a2
	beqz	$a3, .LBB9_52
.LBB9_49:                               # %vec.epilog.ph489
                                        #   in Loop: Header=BB9_41 Depth=1
	vreplgr2vr.w	$vr2, $t2
	vreplgr2vr.w	$vr1, $t4
	add.d	$t4, $a6, $t5
	alsl.d	$t5, $t5, $s0, 2
	.p2align	4, , 16
.LBB9_50:                               # %vec.epilog.vector.body499
                                        #   Parent Loop BB9_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t5, 0
	vseq.w	$vr3, $vr3, $vr2
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB9_50
# %bb.51:                               # %vec.epilog.middle.block504
                                        #   in Loop: Header=BB9_41 Depth=1
	vslli.w	$vr1, $vr1, 31
	vmskltz.w	$vr1, $vr1
	vpickve2gr.hu	$t4, $vr1, 0
	...
	move	$t6, $a4
	beq	$a4, $s2, .LBB9_54
.LBB9_52:                               # %vec.epilog.scalar.ph488.preheader
                                        #   in Loop: Header=BB9_41 Depth=1
	alsl.d	$t5, $t6, $s0, 2
	sub.d	$t6, $s2, $t6
	.p2align	4, , 16
.LBB9_53:                               # %vec.epilog.scalar.ph488
                                        #   Parent Loop BB9_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t5, 0
	xor	$t7, $t7, $t2
...
# %bb.58:                               # %middle.block
	beq	$a0, $s4, .LBB9_61
.LBB9_59:                               # %.lr.ph220.split.preheader545
	alsl.d	$a1, $a0, $s1, 2
	sub.d	$a0, $s4, $a0
	.p2align	4, , 16
...
.LBB9_104:                              #   in Loop: Header=BB9_101 Depth=1
	move	$t4, $t1
.LBB9_105:                              # %.lr.ph262.preheader533
                                        #   in Loop: Header=BB9_101 Depth=1
	alsl.d	$t5, $t4, $s8, 2
	sub.d	$t6, $t2, $t4
	alsl.d	$t7, $a4, $a0, 2
