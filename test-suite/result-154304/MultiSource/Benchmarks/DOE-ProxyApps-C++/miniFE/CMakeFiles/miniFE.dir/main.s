...
# %bb.32:                               # %.lr.ph295.preheader
	...
	addi.w	$a1, $a1, 0
	bgeu	$t5, $t0, .LBB14_35
.LBB14_33:                              # %.lr.ph295.preheader505
                                        #   in Loop: Header=BB14_31 Depth=1
	alsl.d	$t5, $a1, $s1, 2
	alsl.d	$t6, $a1, $s3, 3
	alsl.d	$t7, $t3, $a3, 2
...
# %bb.55:                               # %.lr.ph316
	...
	move	$a1, $s6
	bgeu	$a3, $a7, .LBB14_68
.LBB14_56:                              # %scalar.ph463.preheader
	slli.d	$a7, $a1, 3
	alsl.d	$a3, $a1, $a6, 3
	slli.d	$a6, $a1, 2
	alsl.d	$a2, $a1, $a2, 2
...
.LBB14_71:                              # %vector.body468
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB14_71
# %bb.72:                               # %middle.block476
	bne	$a3, $a7, .LBB14_56
	b	.LBB14_58
.LBB14_73:                              # %vector.ph485
