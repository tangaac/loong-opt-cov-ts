...
# %bb.35:                               #   in Loop: Header=BB0_34 Depth=2
	...
	b	.LBB0_39
	.p2align	4, , 16
.LBB0_36:                               # %vector.body124.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	addi.d	$t5, $t4, 16
	move	$t6, $t2
	move	$t7, $a5
...
# %bb.42:                               #   in Loop: Header=BB0_34 Depth=2
	...
	b	.LBB0_46
	.p2align	4, , 16
.LBB0_43:                               # %vector.body106.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	addi.d	$t6, $t4, 16
	move	$t7, $t2
	move	$t8, $a5
...
# %bb.83:                               # %middle.block152
	...
	maskeqz	$s5, $s5, $a4
	beq	$a3, $a0, .LBB0_86
.LBB0_84:                               # %scalar.ph138.preheader
                                        #   in Loop: Header=BB0_75 Depth=2
	sub.d	$a4, $a0, $a3
	alsl.d	$a5, $a3, $fp, 2
	alsl.d	$a2, $a3, $a2, 2
...
.LBB2_21:                               # %vector.body30
	...
	addi.d	$a2, $a2, 32
	bnez	$a4, .LBB2_21
# %bb.22:                               # %middle.block35
                                        #   in Loop: Header=BB2_7 Depth=1
	beq	$a1, $s6, .LBB2_25
.LBB2_23:                               # %.lr.ph119.preheader39
                                        #   in Loop: Header=BB2_7 Depth=1
	alsl.d	$a2, $a1, $a7, 2
	alsl.d	$a3, $a1, $s1, 2
	sub.d	$a1, $s6, $a1
...
# %bb.39:                               #   in Loop: Header=BB2_7 Depth=1
	...
	b	.LBB2_57
	.p2align	4, , 16
.LBB2_40:                               # %.preheader92.lr.ph
                                        #   in Loop: Header=BB2_7 Depth=1
	vld	$vr6, $sp, 64                   # 16-byte Folded Reload
	blt	$s6, $s4, .LBB2_59
# %bb.41:                               # %.preheader92.preheader
                                        #   in Loop: Header=BB2_7 Depth=1
	move	$a0, $zero
	.p2align	4, , 16
.LBB2_42:                               # %.preheader92
...
.LBB2_44:                               #   in Loop: Header=BB2_45 Depth=3
	...
	addi.d	$s2, $s2, 1
	bge	$s2, $s6, .LBB2_52
.LBB2_45:                               #   Parent Loop BB2_7 Depth=1
...
.LBB2_48:                               #   Parent Loop BB2_7 Depth=1
	...
	addi.d	$a0, $a0, 4
	bnez	$s6, .LBB2_48
# %bb.49:                               # %._crit_edge108.loopexit
                                        #   in Loop: Header=BB2_45 Depth=3
	fcvt.d.s	$fa0, $fa0
.LBB2_50:                               # %._crit_edge108
                                        #   in Loop: Header=BB2_45 Depth=3
	alsl.d	$s6, $s2, $s1, 2
	fneg.d	$fa1, $fa0
	fcmp.clt.d	$fcc0, $fa0, $fs2
