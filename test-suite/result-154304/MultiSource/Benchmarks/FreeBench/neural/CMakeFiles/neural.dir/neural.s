...
# %bb.35:                               #   in Loop: Header=BB0_34 Depth=2
	...
	b	.LBB0_39
	.p2align	4, , 16
.LBB0_36:                               # %vector.body145.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	addi.d	$t5, $t4, 16
	move	$t6, $t2
	move	$t7, $a5
...
# %bb.42:                               #   in Loop: Header=BB0_34 Depth=2
	...
	b	.LBB0_46
	.p2align	4, , 16
.LBB0_43:                               # %vector.body127.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	addi.d	$t6, $t4, 16
	move	$t7, $t2
	move	$t8, $a5
...
# %bb.45:                               # %middle.block135
	...
	move	$t8, $a5
	beq	$a5, $a4, .LBB0_33
.LBB0_46:                               # %.lr.ph.i18.us.us.i.preheader230
                                        #   in Loop: Header=BB0_34 Depth=2
	sub.d	$t7, $a4, $t8
	alsl.d	$t4, $t8, $t4, 2
	alsl.d	$t8, $t8, $t1, 2
...
# %bb.88:                               #   in Loop: Header=BB0_83 Depth=2
	...
	b	.LBB0_98
	.p2align	4, , 16
.LBB0_89:                               # %vector.main.loop.iter.check164
                                        #   in Loop: Header=BB0_83 Depth=2
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB0_91
...
# %bb.93:                               # %middle.block177
	...
	maskeqz	$a4, $s5, $a4
	beq	$a3, $a0, .LBB0_100
# %bb.94:                               # %vec.epilog.iter.check183
                                        #   in Loop: Header=BB0_83 Depth=2
	andi	$a5, $a0, 12
	beqz	$a5, .LBB0_98
.LBB0_95:                               # %vec.epilog.ph182
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB0_96:                               # %vec.epilog.vector.body190
                                        #   Parent Loop BB0_79 Depth=1
                                        #     Parent Loop BB0_83 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr1, $a7, 0
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB0_96
# %bb.97:                               # %vec.epilog.middle.block196
                                        #   in Loop: Header=BB0_83 Depth=2
	vslli.w	$vr0, $vr0, 31
	vmskltz.w	$vr0, $vr0
	vpickve2gr.hu	$a4, $vr0, 0
	...
	maskeqz	$a4, $s5, $a4
	beq	$a3, $a0, .LBB0_100
.LBB0_98:                               # %vec.epilog.scalar.ph181.preheader
                                        #   in Loop: Header=BB0_83 Depth=2
	sub.d	$a5, $a0, $a3
	alsl.d	$a6, $a3, $fp, 2
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a1, $a3, $a1, 2
	.p2align	4, , 16
.LBB0_99:                               # %vec.epilog.scalar.ph181
                                        #   Parent Loop BB0_79 Depth=1
                                        #     Parent Loop BB0_83 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a3, $a1, 0
...
# %bb.21:                               #   in Loop: Header=BB2_7 Depth=1
	...
	b	.LBB2_40
	.p2align	4, , 16
.LBB2_22:                               # %.preheader92.lr.ph
                                        #   in Loop: Header=BB2_7 Depth=1
	vld	$vr6, $sp, 112                  # 16-byte Folded Reload
	xvld	$xr7, $sp, 80                   # 32-byte Folded Reload
	blt	$s5, $s4, .LBB2_65
# %bb.23:                               # %.preheader92.preheader
                                        #   in Loop: Header=BB2_7 Depth=1
	move	$a0, $zero
	.p2align	4, , 16
.LBB2_24:                               # %.preheader92
...
.LBB2_30:                               #   Parent Loop BB2_7 Depth=1
	...
	addi.d	$a0, $a0, 4
	bnez	$s5, .LBB2_30
# %bb.31:                               # %._crit_edge108.loopexit
                                        #   in Loop: Header=BB2_27 Depth=3
	fcvt.d.s	$fa0, $fa0
.LBB2_32:                               # %._crit_edge108
                                        #   in Loop: Header=BB2_27 Depth=3
	alsl.d	$s5, $s2, $s1, 2
	fneg.d	$fa1, $fa0
	fcmp.clt.d	$fcc0, $fa0, $fs2
