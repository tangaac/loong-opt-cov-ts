...
# %bb.94:                               # %.lr.ph236
	...
	move	$a3, $t2
	bgeu	$a2, $a4, .LBB1_115
.LBB1_95:                               # %scalar.ph357.preheader
	alsl.d	$a2, $a3, $s1, 3
	add.d	$a0, $a0, $a3
	sub.w	$a0, $a0, $t2
	sub.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB1_96:                               # %scalar.ph357
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	slli.d	$a5, $a0, 3
	stx.d	$a4, $a1, $a5
...
# %bb.98:
	...
	b	.LBB1_100
	.p2align	4, , 16
.LBB1_99:                               #   in Loop: Header=BB1_100 Depth=1
	addi.d	$s0, $s0, -1
	addi.d	$fp, $fp, 8
	beqz	$s0, .LBB1_108
.LBB1_100:                              # %.lr.ph238
...
# %bb.106:
	move	$a2, $zero
	b	.LBB1_126
.LBB1_107:                              # %._crit_edge239
	beqz	$s1, .LBB1_109
.LBB1_108:                              # %._crit_edge239.thread
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_109:
...
.LBB1_114:
	...
	addi.d	$sp, $sp, 1152
	ret
.LBB1_115:                              # %vector.scevcheck352
	nor	$a3, $t2, $zero
	add.d	$a4, $a3, $s0
	add.w	$a5, $a0, $a4
	move	$a3, $t2
	blt	$a5, $a0, .LBB1_95
# %bb.116:                              # %vector.scevcheck352
	srli.d	$a4, $a4, 32
	move	$a3, $t2
	bnez	$a4, .LBB1_95
# %bb.117:                              # %vector.memcheck353
	alsl.d	$a3, $t2, $s1, 3
	add.d	$a4, $s0, $a0
	sub.d	$a4, $a4, $t2
	alsl.d	$a4, $a4, $a1, 3
	bgeu	$a3, $a4, .LBB1_119
# %bb.118:                              # %vector.memcheck353
	alsl.d	$a4, $s0, $s1, 3
	alsl.d	$a5, $a0, $a1, 3
	move	$a3, $t2
	bltu	$a5, $a4, .LBB1_95
.LBB1_119:                              # %vector.ph359
	slli.d	$a5, $t2, 3
	move	$a4, $a2
...
.LBB1_126:                              # %vec.epilog.ph339
	...
	add.w	$a5, $a1, $a5
	.p2align	4, , 16
.LBB1_127:                              # %vec.epilog.vector.body345
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	slli.d	$a6, $a5, 2
	vstx	$vr0, $s3, $a6
...
# %bb.60:                               # %middle.block79
	beq	$a3, $s0, .LBB11_36
# %bb.61:                               # %vec.epilog.iter.check84
	andi	$a4, $s0, 12
	beqz	$a4, .LBB11_34
.LBB11_62:                              # %vec.epilog.ph83
	move	$t0, $a3
	...
	alsl.d	$t0, $t0, $a1, 2
	.p2align	4, , 16
.LBB11_63:                              # %vec.epilog.vector.body89
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	vld	$vr0, $a6, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a4, .LBB11_63
# %bb.64:                               # %vec.epilog.middle.block94
	bne	$a3, $s0, .LBB11_34
	b	.LBB11_36
.Lfunc_end11:
