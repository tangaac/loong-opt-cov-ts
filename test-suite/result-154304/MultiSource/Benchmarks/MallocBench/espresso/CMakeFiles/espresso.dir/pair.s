...
.LBB1_69:                               # %vector.body308
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_69
# %bb.70:                               # %middle.block311
	beq	$a0, $fp, .LBB1_73
.LBB1_71:                               # %.lr.ph222.preheader348
	slli.d	$a3, $a0, 2
	alsl.d	$a2, $a2, $a3, 2
	add.d	$a2, $s3, $a2
	ori	$a3, $zero, 4
...
.LBB1_75:
	move	$a2, $zero
.LBB1_76:                               # %scalar.ph314.preheader
	slli.d	$a3, $a2, 2
	alsl.d	$a3, $s0, $a3, 2
	add.d	$a0, $a0, $a3
	add.w	$a1, $a1, $a2
...
# %bb.90:                               # %.lr.ph236
	...
	move	$a3, $t2
	bgeu	$a2, $a4, .LBB1_112
.LBB1_91:                               # %scalar.ph332.preheader
	alsl.d	$a2, $a3, $s1, 3
	add.d	$a0, $a0, $a3
	sub.w	$a0, $a0, $t2
	sub.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB1_92:                               # %scalar.ph332
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	slli.d	$a5, $a0, 3
	stx.d	$a4, $a1, $a5
...
.LBB1_102:                              # %vector.body319
	...
	addi.w	$a4, $a4, 8
	bnez	$a5, .LBB1_102
# %bb.103:                              # %middle.block324
	bne	$a2, $s7, .LBB1_76
	b	.LBB1_78
.LBB1_104:                              # %._crit_edge239
	beqz	$s1, .LBB1_106
.LBB1_105:                              # %._crit_edge239.thread
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB1_106:
...
.LBB1_111:
	...
	addi.d	$sp, $sp, 1152
	ret
.LBB1_112:                              # %vector.scevcheck327
	nor	$a3, $t2, $zero
	add.d	$a4, $a3, $s0
	add.w	$a5, $a0, $a4
	move	$a3, $t2
	blt	$a5, $a0, .LBB1_91
# %bb.113:                              # %vector.scevcheck327
	srli.d	$a4, $a4, 32
	move	$a3, $t2
	bnez	$a4, .LBB1_91
# %bb.114:                              # %vector.memcheck328
	...
	alsl.d	$a4, $a4, $a1, 3
	bgeu	$a3, $a4, .LBB1_116
# %bb.115:                              # %vector.memcheck328
	alsl.d	$a4, $s0, $s1, 3
	alsl.d	$a5, $a0, $a1, 3
	move	$a3, $t2
	bltu	$a5, $a4, .LBB1_91
.LBB1_116:                              # %vector.ph334
	slli.d	$a5, $t2, 3
	move	$a4, $a2
