...
# %bb.54:                               #   in Loop: Header=BB4_53 Depth=1
	...
	b	.LBB4_64
	.p2align	4, , 16
.LBB4_55:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB4_53 Depth=1
	bgeu	$a0, $t3, .LBB4_57
# %bb.56:                               #   in Loop: Header=BB4_53 Depth=1
	...
	b	.LBB4_61
	.p2align	4, , 16
.LBB4_57:                               # %vector.body527.preheader
                                        #   in Loop: Header=BB4_53 Depth=1
	move	$t4, $a7
	move	$t5, $a4
	.p2align	4, , 16
.LBB4_58:                               # %vector.body527
...
# %bb.60:                               # %vec.epilog.iter.check
	...
	move	$t5, $a4
	beqz	$a5, .LBB4_64
.LBB4_61:                               # %vec.epilog.ph
                                        #   in Loop: Header=BB4_53 Depth=1
	add.d	$t4, $t0, $t6
	alsl.d	$t5, $t6, $t1, 2
	.p2align	4, , 16
.LBB4_62:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB4_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr4, $t5, 0
	vmul.w	$vr4, $vr2, $vr4
...
# %bb.63:                               # %vec.epilog.middle.block
	...
	move	$t5, $a6
	beq	$a6, $a0, .LBB4_52
.LBB4_64:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB4_53 Depth=1
	slli.d	$t4, $t5, 2
	sub.d	$t5, $a0, $t5
	.p2align	4, , 16
.LBB4_65:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB4_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$t6, $t1, $t4
	mul.w	$t6, $a2, $t6
...
.LBB4_66:                               # %.loopexit
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB4_112
.LBB4_67:                               # %.preheader342.lr.ph
	ld.w	$a0, $s3, 204
	addi.d	$a3, $s7, 48
	ori	$a4, $zero, 1
	lu12i.w	$a2, 1
	blt	$a0, $a4, .LBB4_91
# %bb.68:                               # %.preheader342.preheader
	move	$fp, $zero
	ori	$a4, $a2, 512
	...
	b	.LBB4_71
	.p2align	4, , 16
.LBB4_69:                               # %._crit_edge399.loopexit
...
# %bb.73:                               #   in Loop: Header=BB4_71 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB4_78
# %bb.74:                               #   in Loop: Header=BB4_71 Depth=1
	ld.w	$a0, $s3, 92
	slli.d	$a0, $a0, 1
	addi.d	$a0, $a0, -6
	ld.w	$s4, $s1, 0
...
# %bb.76:                               # %.peel.next.thread
	...
	bnez	$a0, .LBB4_79
	.p2align	4, , 16
# %bb.77:                               #   in Loop: Header=BB4_71 Depth=1
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 204
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB4_69
	b	.LBB4_83
.LBB4_78:                               #   in Loop: Header=BB4_71 Depth=1
	ori	$a2, $zero, 244
	move	$a0, $s7
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
...
.LBB4_79:                               # %.peel.next
	...
	addi.d	$s7, $s7, 244
	beqz	$a0, .LBB4_81
# %bb.80:                               #   in Loop: Header=BB4_71 Depth=1
	ld.w	$a0, $fp, 92
	slli.d	$a0, $a0, 1
	addi.d	$a0, $a0, -6
	ld.w	$s4, $s1, 4
	...
	jirl	$ra, $ra, 0
	b	.LBB4_82
.LBB4_81:                               #   in Loop: Header=BB4_71 Depth=1
	ori	$a2, $zero, 244
	move	$a0, $s7
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB4_82:                               #   in Loop: Header=BB4_71 Depth=1
	ld.d	$a4, $sp, 232                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 204
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB4_69
.LBB4_83:                               # %.peel.next444.preheader
                                        #   in Loop: Header=BB4_71 Depth=1
	ori	$s1, $zero, 2
	...
	b	.LBB4_87
	.p2align	4, , 16
.LBB4_84:                               #   in Loop: Header=BB4_87 Depth=2
	ld.w	$a0, $s0, 92
	slli.d	$a0, $a0, 1
	addi.d	$a0, $a0, -6
	ld.w	$s5, $s3, 0
...
.LBB4_85:                               #   in Loop: Header=BB4_87 Depth=2
	...
	ld.d	$a4, $sp, 232                   # 8-byte Folded Reload
.LBB4_86:                               #   in Loop: Header=BB4_87 Depth=2
	addi.d	$fp, $fp, 1
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 204
	addi.w	$s1, $s1, 1
...
# %bb.89:                               #   in Loop: Header=BB4_87 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB4_85
.LBB4_90:                               # %.preheader341
	ori	$a0, $zero, 1
	lu12i.w	$a2, 1
	blt	$a1, $a0, .LBB4_112
.LBB4_91:                               # %.preheader340.lr.ph
	ld.w	$a0, $s3, 204
	ori	$a4, $zero, 1
	blt	$a0, $a4, .LBB4_101
# %bb.92:                               # %.preheader340.preheader
	move	$s2, $zero
	ori	$s0, $a2, 512
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
	b	.LBB4_95
	.p2align	4, , 16
.LBB4_93:                               # %._crit_edge403.loopexit
                                        #   in Loop: Header=BB4_95 Depth=1
	ld.w	$a1, $s8, 200
	move	$s3, $s8
	lu12i.w	$a2, 1
	move	$a3, $fp
.LBB4_94:                               # %._crit_edge403
                                        #   in Loop: Header=BB4_95 Depth=1
	addi.d	$s2, $s2, 1
	add.d	$s1, $s1, $s0
	addi.d	$a3, $a3, 240
	bge	$s2, $a1, .LBB4_100
.LBB4_95:                               # %.preheader340
                                        # =>This Loop Header: Depth=1
...
# %bb.99:                               #   in Loop: Header=BB4_98 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB4_97
.LBB4_100:                              # %.preheader339
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB4_112
.LBB4_101:                              # %.preheader338.lr.ph
	ld.w	$a6, $s3, 204
	ori	$a0, $zero, 1
	blt	$a6, $a0, .LBB4_112
# %bb.102:                              # %.preheader338.preheader
	move	$a4, $a2
	move	$a2, $zero
	lu12i.w	$a3, -2
	ori	$a3, $a3, 3584
	...
	b	.LBB4_105
	.p2align	4, , 16
.LBB4_103:                              # %._crit_edge407.loopexit
                                        #   in Loop: Header=BB4_105 Depth=1
	ld.w	$a1, $s3, 200
.LBB4_104:                              # %._crit_edge407
                                        #   in Loop: Header=BB4_105 Depth=1
	addi.d	$a2, $a2, 1
...
.LBB4_109:                              #   in Loop: Header=BB4_110 Depth=3
	...
	addi.d	$t1, $t1, 4
	beqz	$a6, .LBB4_107
.LBB4_110:                              #   Parent Loop BB4_105 Depth=1
...
.LBB8_29:                               # %vector.body153
	...
	xvaddi.du	$xr5, $xr5, 4
	bnez	$t6, .LBB8_29
# %bb.30:                               # %middle.block156
                                        #   in Loop: Header=BB8_24 Depth=1
	beq	$t4, $t5, .LBB8_23
.LBB8_31:                               # %.lr.ph91.preheader202
                                        #   in Loop: Header=BB8_24 Depth=1
	slli.d	$t4, $t3, 4
	alsl.d	$t4, $t3, $t4, 3
	add.d	$t4, $a0, $t4
...
.LBB8_46:                               # %vector.body170
	...
	xvaddi.du	$xr5, $xr5, 4
	bnez	$t8, .LBB8_46
# %bb.47:                               # %middle.block175
                                        #   in Loop: Header=BB8_37 Depth=1
	beq	$t5, $t7, .LBB8_36
	b	.LBB8_41
.LBB8_48:                               # %._crit_edge95.1
	ld.w	$a1, $a1, 84
	ori	$a5, $zero, 11
	bltu	$a5, $a1, .LBB8_63
# %bb.49:                               # %.lr.ph94.2
	...
	b	.LBB8_52
	.p2align	4, , 16
.LBB8_50:                               # %..loopexit.2_crit_edge
                                        #   in Loop: Header=BB8_52 Depth=1
	addi.d	$a1, $a1, 1
.LBB8_51:                               # %.loopexit.2
                                        #   in Loop: Header=BB8_52 Depth=1
	beq	$a1, $t0, .LBB8_63
.LBB8_52:                               # =>This Loop Header: Depth=1
...
# %bb.53:                               #   in Loop: Header=BB8_52 Depth=1
	...
	ldx.w	$t1, $a4, $t1
	bge	$t5, $t1, .LBB8_51
# %bb.54:                               # %.lr.ph91.preheader.2
                                        #   in Loop: Header=BB8_52 Depth=1
	sub.d	$t2, $t1, $t5
	bgeu	$t2, $a6, .LBB8_58
.LBB8_55:                               #   in Loop: Header=BB8_52 Depth=1
	move	$t3, $t5
.LBB8_56:                               # %.lr.ph91.2.preheader
                                        #   in Loop: Header=BB8_52 Depth=1
	slli.d	$t2, $t3, 4
	alsl.d	$t2, $t3, $t2, 3
	add.d	$t2, $a5, $t2
