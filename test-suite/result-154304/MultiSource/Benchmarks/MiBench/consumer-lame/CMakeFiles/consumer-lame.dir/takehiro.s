...
# %bb.26:                               # %middle.block283
	...
	beq	$t2, $t3, .LBB3_29
.LBB3_27:                               # %scalar.ph269.preheader
	addi.d	$t1, $t1, -4
	.p2align	4, , 16
.LBB3_28:                               # %scalar.ph269
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t2, $t1, 4
	ldx.bu	$t2, $t0, $t2
	addi.d	$t3, $t1, 4
...
# %bb.33:                               # %middle.block303
	...
	beq	$a4, $t1, .LBB3_36
.LBB3_34:                               # %scalar.ph289.preheader
	addi.d	$a4, $t0, -4
	.p2align	4, , 16
.LBB3_35:                               # %scalar.ph289
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a4, 4
	ldx.bu	$t0, $a6, $t0
	addi.d	$t1, $a4, 4
...
# %bb.54:
	...
	move	$t3, $a0
	b	.LBB3_78
.LBB3_55:                               # %vector.main.loop.iter.check157
	ori	$t3, $zero, 120
	bgeu	$t2, $t3, .LBB3_58
# %bb.56:
	move	$t8, $a2
...
# %bb.61:
	...
	b	.LBB3_67
.LBB3_62:                               # %vec.epilog.iter.check215
	andi	$a2, $fp, 12
	ld.d	$t8, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 48                    # 8-byte Folded Reload
...
.LBB3_64:                               # %vec.epilog.ph214
	...
	vrepli.w	$vr5, 15
	.p2align	4, , 16
.LBB3_65:                               # %vec.epilog.vector.body224
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a0, -16
	ld.w	$a3, $a0, -8
	ld.w	$a4, $a0, 0
	...
	addi.d	$a0, $a0, 32
	bnez	$t4, .LBB3_65
# %bb.66:                               # %vec.epilog.middle.block243
