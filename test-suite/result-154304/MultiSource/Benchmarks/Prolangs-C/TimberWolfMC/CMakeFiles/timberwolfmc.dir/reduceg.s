...
# %bb.46:                               #   in Loop: Header=BB0_41 Depth=2
	...
	ori	$a4, $zero, 1
	b	.LBB0_58
.LBB0_47:                               # %vector.main.loop.iter.check1107
                                        #   in Loop: Header=BB0_41 Depth=2
	ori	$a2, $zero, 16
	bgeu	$s2, $a2, .LBB0_49
...
# %bb.52:                               #   in Loop: Header=BB0_41 Depth=2
	...
	b	.LBB0_39
.LBB0_53:                               # %vec.epilog.iter.check1125
                                        #   in Loop: Header=BB0_41 Depth=2
	andi	$a4, $s2, 12
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 80                    # 8-byte Folded Reload
...
.LBB0_54:                               #   in Loop: Header=BB0_41 Depth=2
	...
	sub.d	$a2, $a2, $a5
	.p2align	4, , 16
.LBB0_55:                               # %vec.epilog.vector.body1130
                                        #   Parent Loop BB0_37 Depth=1
                                        #     Parent Loop BB0_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr1, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB0_55
# %bb.56:                               # %vec.epilog.middle.block1136
                                        #   in Loop: Header=BB0_41 Depth=2
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
...
.LBB0_57:                               #   in Loop: Header=BB0_41 Depth=2
	addi.d	$a4, $a2, 1
	.p2align	4, , 16
.LBB0_58:                               # %vec.epilog.scalar.ph1123.preheader
                                        #   in Loop: Header=BB0_41 Depth=2
	addi.d	$a2, $s2, 1
	bstrpick.d	$a2, $a2, 31, 0
	alsl.d	$a1, $a4, $a1, 2
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB0_59:                               # %vec.epilog.scalar.ph1123
                                        #   Parent Loop BB0_37 Depth=1
                                        #     Parent Loop BB0_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a4, $a1, 0
