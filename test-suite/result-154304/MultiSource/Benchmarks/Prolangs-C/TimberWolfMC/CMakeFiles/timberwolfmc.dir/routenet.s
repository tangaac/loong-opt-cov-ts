...
.LBB0_33:                               # %vector.body279
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_33
# %bb.34:                               # %middle.block282
	beq	$a5, $a1, .LBB0_42
# %bb.35:                               # %vec.epilog.iter.check287
	andi	$a4, $a1, 24
	beqz	$a4, .LBB0_39
.LBB0_36:                               # %vec.epilog.ph286
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB0_37:                               # %vec.epilog.vector.body292
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $t0, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB0_37
# %bb.38:                               # %vec.epilog.middle.block296
	bne	$a6, $a1, .LBB0_40
	b	.LBB0_42
.LBB0_39:
	addi.d	$a4, $a5, 1
...
.LBB1_67:                               # %.lr.ph455
	...
	ld.w	$s1, $fp, 0
	bne	$s1, $s4, .LBB1_66
# %bb.68:                               # %.preheader759.preheader
                                        #   in Loop: Header=BB1_67 Depth=4
	move	$s2, $s5
	.p2align	4, , 16
.LBB1_69:                               # %.preheader759
                                        #   Parent Loop BB1_51 Depth=1
                                        #     Parent Loop BB1_57 Depth=2
                                        #       Parent Loop BB1_63 Depth=3
