...
.LBB3_46:                               # %vec.epilog.ph66
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_47:                               # %vec.epilog.vector.body72
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
...
.LBB10_35:                              # %vec.epilog.ph142
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_36:                              # %vec.epilog.vector.body148
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_36
# %bb.37:                               # %vec.epilog.middle.block156
	bne	$a3, $a6, .LBB10_48
	b	.LBB10_49
...
# %bb.45:                               # %middle.block138
	beq	$a3, $a5, .LBB10_49
# %bb.46:                               # %vec.epilog.iter.check143
	andi	$a4, $a3, 8
	bnez	$a4, .LBB10_35
# %bb.47:
	alsl.d	$a4, $a5, $s1, 1
