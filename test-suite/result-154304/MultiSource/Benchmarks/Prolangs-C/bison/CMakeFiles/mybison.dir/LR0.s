...
# %bb.50:                               # %middle.block62
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a5, .LBB3_16
# %bb.51:                               # %vec.epilog.iter.check67
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a4, $a3, 24
	beqz	$a4, .LBB3_62
.LBB3_52:                               # %vec.epilog.ph66
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_53:                               # %vec.epilog.vector.body72
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_53
# %bb.54:                               # %vec.epilog.middle.block80
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a3, $a6, .LBB3_14
	b	.LBB3_16
.LBB3_55:                               # %vector.ph
...
.LBB9_17:
	move	$a2, $a1
.LBB9_18:                               # %vec.epilog.scalar.ph158.preheader
	addi.d	$a1, $a2, 1
	alsl.d	$a3, $a2, $a0, 1
	addi.d	$a3, $a3, 12
	alsl.d	$a2, $a2, $fp, 1
	...
	ori	$a4, $zero, 1
	.p2align	4, , 16
.LBB9_19:                               # %vec.epilog.scalar.ph158
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a5, $a2, 0
	st.h	$a5, $a3, 0
	addi.d	$a1, $a1, -1
...
.LBB9_45:                               # %vec.epilog.ph159
	...
	add.d	$a6, $a6, $fp
	addi.d	$a6, $a6, -4
.LBB9_46:                               # %vec.epilog.vector.body165
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a3, 0
	addi.d	$a5, $a5, 8
...
# %bb.50:                               # %middle.block155
	beq	$a3, $a1, .LBB9_20
# %bb.51:                               # %vec.epilog.iter.check160
	andi	$a2, $a1, 8
	bnez	$a2, .LBB9_45
# %bb.52:
	andi	$a2, $a1, 15
...
# %bb.41:
	move	$a5, $zero
	b	.LBB10_48
.LBB10_42:                              # %vector.main.loop.iter.check104
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 62
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_51
...
.LBB10_52:                              # %vector.body108
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB10_52
# %bb.53:                               # %middle.block115
	beq	$a3, $a5, .LBB10_63
# %bb.54:                               # %vec.epilog.iter.check120
	andi	$a4, $a3, 24
	beqz	$a4, .LBB10_61
.LBB10_55:                              # %vec.epilog.ph119
	move	$a6, $a3
	bstrins.d	$a6, $zero, 2, 0
	alsl.d	$a4, $a6, $s3, 1
	alsl.d	$a2, $a6, $a2, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_56:                              # %vec.epilog.vector.body125
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_56
# %bb.57:                               # %vec.epilog.middle.block133
	bne	$a3, $a6, .LBB10_62
	b	.LBB10_63
.LBB10_58:
	alsl.d	$a4, $a5, $s1, 1
