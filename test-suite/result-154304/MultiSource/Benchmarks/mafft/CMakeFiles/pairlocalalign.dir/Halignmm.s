...
.LBB2_47:                               # %vector.body921
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_47
# %bb.48:                               # %middle.block926
	beq	$a2, $a4, .LBB2_51
.LBB2_49:                               # %scalar.ph916.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $s1, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_50:                               # %scalar.ph916
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
.LBB2_54:                               # %vector.body936
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_54
# %bb.55:                               # %middle.block943
	beq	$a3, $a4, .LBB2_58
.LBB2_56:                               # %scalar.ph929.preheader
	mul.d	$a3, $a0, $a1
	alsl.d	$a4, $a1, $s2, 2
	sub.d	$a1, $a2, $a1
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB2_57:                               # %scalar.ph929
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB2_64:                               # %vector.body954
	...
	addi.d	$a5, $a5, 32
	bnez	$a7, .LBB2_64
# %bb.65:                               # %middle.block960
	beq	$a3, $a4, .LBB2_68
.LBB2_66:                               # %scalar.ph947.preheader
	slli.d	$a3, $a2, 2
...
# %bb.74:                               # %.lr.ph.preheader.i534
	...
	ori	$a1, $zero, 7
	bltu	$a0, $a1, .LBB2_77
# %bb.75:                               # %vector.memcheck963
                                        #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	add.d	$a0, $a4, $a1
	bgeu	$s5, $a0, .LBB2_119
# %bb.76:                               # %vector.memcheck963
                                        #   in Loop: Header=BB2_73 Depth=1
	add.d	$a0, $s5, $a1
	bgeu	$a4, $a0, .LBB2_119
...
.LBB2_127:                              # %vector.body1000
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_127
# %bb.128:                              # %middle.block1007
	beq	$a2, $a4, .LBB2_131
.LBB2_129:                              # %scalar.ph991.preheader
	sub.w	$a2, $s8, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s1, 2
	sub.d	$a1, $a1, $a3
...
.LBB2_134:                              # %vector.body1015
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB2_134
# %bb.135:                              # %middle.block1020
	beq	$a3, $a5, .LBB2_138
.LBB2_136:                              # %scalar.ph1010.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB2_137:                              # %scalar.ph1010
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_216:                              # %vector.body1118
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_216
# %bb.217:                              # %middle.block1124
	beq	$a3, $a4, .LBB2_220
.LBB2_218:                              # %scalar.ph1113.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_219:                              # %scalar.ph1113
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB2_243:                              #   in Loop: Header=BB2_222 Depth=1
	move	$t5, $s1
	move	$t6, $s8
.LBB2_244:                              # %.lr.ph19.i609.preheader1180
                                        #   in Loop: Header=BB2_222 Depth=1
	move	$t7, $t5
	move	$t8, $t6
	.p2align	4, , 16
...
.LBB2_258:                              # %vector.body1043
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_258
# %bb.259:                              # %middle.block1049
	beq	$a4, $a5, .LBB2_262
.LBB2_260:                              # %scalar.ph1038.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_261:                              # %scalar.ph1038
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.270:                              # %.lr.ph29.preheader.i
	...
	ori	$t8, $zero, 8
	bltu	$a6, $t8, .LBB2_274
# %bb.271:                              # %vector.ph1058
                                        #   in Loop: Header=BB2_264 Depth=1
	bstrpick.d	$a6, $s4, 30, 3
	slli.d	$s5, $a6, 3
	sub.d	$s0, $s4, $s5
	sub.d	$t8, $s1, $s5
	sub.d	$fp, $s8, $s5
...
# %bb.281:                              # %.lr.ph19.i.preheader
	...
	sub.d	$a6, $s8, $s1
	bltu	$a6, $a7, .LBB2_285
# %bb.282:                              # %vector.ph1081
                                        #   in Loop: Header=BB2_264 Depth=1
	bstrpick.d	$s6, $fp, 31, 0
	bstrpick.d	$a6, $s6, 31, 4
	slli.d	$a6, $a6, 4
	sub.d	$fp, $fp, $a6
	sub.d	$s0, $s1, $a6
	sub.d	$s4, $s8, $a6
...
.LBB2_285:                              #   in Loop: Header=BB2_264 Depth=1
	move	$s0, $s1
	move	$s4, $s8
.LBB2_286:                              # %.lr.ph19.i.preheader1191
                                        #   in Loop: Header=BB2_264 Depth=1
	move	$s1, $s0
	move	$a6, $s4
	.p2align	4, , 16
