...
.LBB2_68:                               # %iter.check962
	...
	ori	$a3, $zero, 4
	bltu	$a2, $a3, .LBB2_112
# %bb.69:                               # %vector.memcheck958
	sub.d	$a3, $t1, $s1
	addi.d	$a3, $a3, 4
	ori	$a5, $zero, 64
	bltu	$a3, $a5, .LBB2_112
# %bb.70:                               # %vector.main.loop.iter.check964
	ori	$a4, $zero, 16
	lu12i.w	$a3, 287172
	bgeu	$a2, $a4, .LBB2_107
# %bb.71:
	move	$a5, $zero
.LBB2_72:                               # %vec.epilog.ph979
	move	$a6, $a2
	...
	vreplgr2vr.w	$vr2, $a3
	.p2align	4, , 16
.LBB2_73:                               # %vec.epilog.vector.body987
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $s1, $t0
	vstx	$vr1, $a7, $t0
	vfadd.s	$vr3, $vr3, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB2_73
# %bb.74:                               # %vec.epilog.middle.block992
	bne	$a2, $a6, .LBB2_112
	b	.LBB2_114
.LBB2_75:                               # %.lr.ph675
	ld.d	$a1, $sp, 408                   # 8-byte Folded Reload
...
.LBB2_108:                              # %vector.body970
	...
	addi.d	$a4, $a4, 64
	bnez	$a7, .LBB2_108
# %bb.109:                              # %middle.block975
	beq	$a2, $a5, .LBB2_114
# %bb.110:                              # %vec.epilog.iter.check980
	andi	$a4, $a2, 12
	bnez	$a4, .LBB2_72
# %bb.111:
	addi.d	$a4, $a5, 1
.LBB2_112:                              # %vec.epilog.scalar.ph978.preheader
	slli.d	$a2, $a4, 2
	...
	movgr2fr.w	$fa1, $zero
	.p2align	4, , 16
.LBB2_113:                              # %vec.epilog.scalar.ph978
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa2, $a3, $a2
	stx.w	$zero, $a0, $a2
	fadd.s	$fa2, $fa2, $fa1
...
# %bb.120:                              # %iter.check1005
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB2_123
# %bb.121:                              # %vector.memcheck996
                                        #   in Loop: Header=BB2_119 Depth=1
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$s5, $a0, .LBB2_165
# %bb.122:                              # %vector.memcheck996
                                        #   in Loop: Header=BB2_119 Depth=1
	add.d	$a0, $s5, $a1
	bgeu	$a2, $a0, .LBB2_165
...
# %bb.164:                              #   in Loop: Header=BB2_128 Depth=2
	...
	st.w	$s8, $t3, 0
	b	.LBB2_127
.LBB2_165:                              # %vector.main.loop.iter.check1007
                                        #   in Loop: Header=BB2_119 Depth=1
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB2_167
# %bb.166:                              #   in Loop: Header=BB2_119 Depth=1
	move	$a5, $zero
	b	.LBB2_171
.LBB2_167:                              # %vector.body1011.preheader
                                        #   in Loop: Header=BB2_119 Depth=1
	addi.d	$a0, $s5, 32
	addi.d	$a1, $a2, 32
	ld.d	$a4, $sp, 208                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_168:                              # %vector.body1011
                                        #   Parent Loop BB2_119 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a4, .LBB2_168
# %bb.169:                              # %middle.block1020
                                        #   in Loop: Header=BB2_119 Depth=1
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB2_125
# %bb.170:                              # %vec.epilog.iter.check1025
                                        #   in Loop: Header=BB2_119 Depth=1
	ld.d	$a5, $sp, 208                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	beqz	$a0, .LBB2_174
.LBB2_171:                              # %vec.epilog.ph1024
                                        #   in Loop: Header=BB2_119 Depth=1
	...
	add.d	$a5, $a6, $a5
	.p2align	4, , 16
.LBB2_172:                              # %vec.epilog.vector.body1031
                                        #   Parent Loop BB2_119 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a4, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB2_172
# %bb.173:                              # %vec.epilog.middle.block1040
                                        #   in Loop: Header=BB2_119 Depth=1
...
.LBB2_180:                              # %vector.body1058
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_180
# %bb.181:                              # %middle.block1065
	beq	$a2, $a4, .LBB2_184
.LBB2_182:                              # %scalar.ph1049.preheader
	sub.w	$a2, $s8, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s1, 2
	sub.d	$a1, $a1, $a3
...
.LBB2_187:                              # %vector.body1077
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB2_187
# %bb.188:                              # %middle.block1084
	beq	$a3, $a4, .LBB2_191
.LBB2_189:                              # %scalar.ph1068.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB2_190:                              # %scalar.ph1068
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.235:
	move	$a5, $zero
	b	.LBB2_293
.LBB2_236:                              # %vector.main.loop.iter.check1203
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB2_246
# %bb.237:
	move	$a4, $zero
.LBB2_238:                              # %vec.epilog.ph1217
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_239:                              # %vec.epilog.vector.body1226
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB2_239
# %bb.240:                              # %vec.epilog.middle.block1231
	bne	$a3, $a4, .LBB2_250
	b	.LBB2_252
.LBB2_241:                              # %vector.main.loop.iter.check1107
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB2_289
# %bb.242:
	move	$a5, $zero
.LBB2_243:                              # %vec.epilog.ph1121
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_244:                              # %vec.epilog.vector.body1129
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB2_244
# %bb.245:                              # %vec.epilog.middle.block1134
	bne	$a4, $a5, .LBB2_293
	b	.LBB2_295
.LBB2_246:                              # %vector.ph1204
...
.LBB2_247:                              # %vector.body1207
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_247
# %bb.248:                              # %middle.block1213
	beq	$a3, $a4, .LBB2_252
# %bb.249:                              # %vec.epilog.iter.check1218
	andi	$a6, $a5, 12
	bnez	$a6, .LBB2_238
.LBB2_250:                              # %vec.epilog.scalar.ph1216.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_251:                              # %vec.epilog.scalar.ph1216
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB2_275:                              #   in Loop: Header=BB2_254 Depth=1
	move	$t5, $s1
	move	$t6, $s8
.LBB2_276:                              # %.lr.ph19.i609.preheader1287
                                        #   in Loop: Header=BB2_254 Depth=1
	move	$t7, $t5
	move	$t8, $t6
	.p2align	4, , 16
...
.LBB2_290:                              # %vector.body1111
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB2_290
# %bb.291:                              # %middle.block1117
	beq	$a4, $a5, .LBB2_295
# %bb.292:                              # %vec.epilog.iter.check1122
	andi	$a7, $a6, 12
	bnez	$a7, .LBB2_243
.LBB2_293:                              # %vec.epilog.scalar.ph1120.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_294:                              # %vec.epilog.scalar.ph1120
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB2_318:                              #   in Loop: Header=BB2_297 Depth=1
	move	$s0, $s1
	move	$s4, $s8
.LBB2_319:                              # %.lr.ph19.i.preheader1298
                                        #   in Loop: Header=BB2_297 Depth=1
	move	$s1, $s0
	move	$a6, $s4
	.p2align	4, , 16
