...
.LBB3_183:
	addi.d	$a5, $a6, 1
.LBB3_184:                              # %vec.epilog.scalar.ph1220.preheader
	...
	sub.d	$a2, $a2, $a5
	.p2align	4, , 16
.LBB3_185:                              # %vec.epilog.scalar.ph1220
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a4, $a3
	stx.w	$zero, $a1, $a3
...
.LBB3_195:                              # %iter.check1247
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB3_198
# %bb.196:                              # %vector.memcheck1238
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$t2, $a0, .LBB3_209
# %bb.197:                              # %vector.memcheck1238
                                        #   in Loop: Header=BB3_191 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a2, $a0, .LBB3_209
...
# %bb.208:                              #   in Loop: Header=BB3_203 Depth=2
	...
	stx.w	$t6, $s2, $a3
	b	.LBB3_202
.LBB3_209:                              # %vector.main.loop.iter.check1249
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_211
# %bb.210:                              #   in Loop: Header=BB3_191 Depth=1
	move	$a4, $zero
	b	.LBB3_215
.LBB3_211:                              # %vector.body1253.preheader
                                        #   in Loop: Header=BB3_191 Depth=1
	addi.d	$a0, $t2, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_212:                              # %vector.body1253
                                        #   Parent Loop BB3_191 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB3_212
# %bb.213:                              # %middle.block1262
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_200
# %bb.214:                              # %vec.epilog.iter.check1267
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a4, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB3_218
.LBB3_215:                              # %vec.epilog.ph1266
                                        #   in Loop: Header=BB3_191 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB3_216:                              # %vec.epilog.vector.body1273
                                        #   Parent Loop BB3_191 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB3_216
# %bb.217:                              # %vec.epilog.middle.block1282
                                        #   in Loop: Header=BB3_191 Depth=1
...
.LBB3_224:                              # %vector.body1300
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_224
# %bb.225:                              # %middle.block1307
	beq	$a2, $a4, .LBB3_228
.LBB3_226:                              # %scalar.ph1291.preheader
	sub.w	$a2, $s8, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_231:                              # %vector.body1319
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_231
# %bb.232:                              # %middle.block1326
	beq	$a3, $a4, .LBB3_235
.LBB3_233:                              # %scalar.ph1310.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_234:                              # %scalar.ph1310
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.258:
	move	$a5, $zero
	b	.LBB3_268
.LBB3_259:                              # %vector.main.loop.iter.check1349
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_261
# %bb.260:
	move	$a5, $zero
	b	.LBB3_265
.LBB3_261:                              # %vector.ph1350
...
.LBB3_262:                              # %vector.body1353
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_262
# %bb.263:                              # %middle.block1359
	beq	$a4, $a5, .LBB3_270
# %bb.264:                              # %vec.epilog.iter.check1364
	andi	$a7, $a6, 12
	beqz	$a7, .LBB3_268
.LBB3_265:                              # %vec.epilog.ph1363
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_266:                              # %vec.epilog.vector.body1371
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_266
# %bb.267:                              # %vec.epilog.middle.block1376
	beq	$a4, $a5, .LBB3_270
.LBB3_268:                              # %vec.epilog.scalar.ph1362.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_269:                              # %vec.epilog.scalar.ph1362
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_287:                              #   in Loop: Header=BB3_272 Depth=1
	move	$fp, $s5
	move	$s0, $s3
.LBB3_288:                              # %.lr.ph19.i.preheader1427
                                        #   in Loop: Header=BB3_272 Depth=1
	move	$s1, $fp
	move	$s2, $s0
	.p2align	4, , 16
...
# %bb.32:
	move	$t2, $zero
.LBB6_33:                               # %scalar.ph1012.preheader
	slli.d	$t3, $t2, 2
	sub.d	$t1, $t1, $t2
	vldi	$vr1, -912
	vldi	$vr2, -928
...
# %bb.54:                               # %.lr.ph582
	...
	ori	$a6, $zero, 1
	bgeu	$a7, $t0, .LBB6_151
.LBB6_55:                               # %scalar.ph1085.preheader
	alsl.d	$a4, $a6, $a4, 2
	alsl.d	$a3, $a6, $a3, 2
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_56:                               # %scalar.ph1085
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
# %bb.58:                               # %.lr.ph585
	...
	ori	$a5, $zero, 1
	bgeu	$a6, $a7, .LBB6_157
.LBB6_59:                               # %scalar.ph1123.preheader
	alsl.d	$a3, $a5, $a3, 2
	alsl.d	$a6, $a5, $t5, 2
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_60:                               # %scalar.ph1123
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a6, 0
...
.LBB6_65:                               # %vector.body1043
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB6_65
# %bb.66:                               # %middle.block1047
	beq	$a3, $a5, .LBB6_69
.LBB6_67:                               # %scalar.ph1036.preheader
	mul.d	$a3, $a1, $a4
	alsl.d	$a5, $a4, $t5, 2
	sub.d	$a2, $a2, $a4
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_68:                               # %scalar.ph1036
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a5, 0
	movgr2fr.w	$fa2, $a3
	ffint.d.w	$fa2, $fa2
...
.LBB6_72:                               # %vector.body1057
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB6_72
# %bb.73:                               # %middle.block1064
	beq	$a5, $a6, .LBB6_76
.LBB6_74:                               # %scalar.ph1050.preheader
	mul.d	$a5, $a1, $a2
	alsl.d	$a3, $a2, $a3, 2
	sub.d	$a2, $a4, $a2
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_75:                               # %scalar.ph1050
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a3, 0
	movgr2fr.w	$fa2, $a5
	ffint.d.w	$fa2, $fa2
...
.LBB6_114:                              # %vector.memcheck883
	...
	move	$t2, $zero
	bnez	$t4, .LBB6_296
# %bb.115:                              # %vector.memcheck883
	alsl.d	$s0, $t1, $a5, 2
	sltu	$t4, $a2, $s0
	sltu	$t5, $a5, $s2
	and	$t4, $t4, $t5
	bnez	$t4, .LBB6_296
# %bb.116:                              # %vector.memcheck883
	alsl.d	$t5, $t1, $a6, 2
	sltu	$t4, $a2, $t5
	sltu	$t6, $a6, $s2
	and	$t4, $t4, $t6
	bnez	$t4, .LBB6_296
# %bb.117:                              # %vector.memcheck883
	alsl.d	$t4, $t1, $t0, 2
	sltu	$t6, $a2, $t4
	sltu	$t7, $t0, $s2
	and	$t6, $t6, $t7
	bnez	$t6, .LBB6_296
# %bb.118:                              # %vector.memcheck883
	alsl.d	$t6, $t1, $a0, 2
	sltu	$t7, $a2, $t6
	sltu	$t8, $a0, $s2
	and	$t7, $t7, $t8
	bnez	$t7, .LBB6_296
# %bb.119:                              # %vector.memcheck883
	alsl.d	$t7, $t1, $a1, 2
	sltu	$t8, $a2, $t7
	sltu	$fp, $a1, $s2
	and	$t8, $t8, $fp
	bnez	$t8, .LBB6_296
# %bb.120:                              # %vector.memcheck883
	alsl.d	$t8, $t1, $a3, 2
	sltu	$fp, $a2, $t8
	sltu	$s3, $a3, $s2
	and	$fp, $fp, $s3
	bnez	$fp, .LBB6_296
# %bb.121:                              # %vector.memcheck883
	alsl.d	$fp, $t1, $a7, 2
	sltu	$s3, $a2, $fp
	sltu	$s2, $a7, $s2
	and	$s2, $s3, $s2
	bnez	$s2, .LBB6_296
# %bb.122:                              # %vector.memcheck883
	sltu	$s2, $a4, $s0
	sltu	$s3, $a5, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.123:                              # %vector.memcheck883
	sltu	$s2, $a4, $t5
	sltu	$s3, $a6, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.124:                              # %vector.memcheck883
	sltu	$s2, $a4, $t4
	sltu	$s3, $t0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.125:                              # %vector.memcheck883
	sltu	$s2, $a4, $t6
	sltu	$s3, $a0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.126:                              # %vector.memcheck883
	sltu	$s2, $a4, $t7
	sltu	$s3, $a1, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.127:                              # %vector.memcheck883
	sltu	$s2, $a4, $t8
	sltu	$s3, $a3, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.128:                              # %vector.memcheck883
	sltu	$s2, $a4, $fp
	sltu	$s1, $a7, $s1
	and	$s1, $s2, $s1
	bnez	$s1, .LBB6_296
# %bb.129:                              # %vector.memcheck883
	sltu	$s1, $a5, $t5
	sltu	$s2, $a6, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.130:                              # %vector.memcheck883
	sltu	$s1, $a5, $t4
	sltu	$s2, $t0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.131:                              # %vector.memcheck883
	sltu	$s1, $a5, $t6
	sltu	$s2, $a0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.132:                              # %vector.memcheck883
	sltu	$s1, $a5, $t7
	sltu	$s2, $a1, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.133:                              # %vector.memcheck883
	sltu	$s1, $a5, $t8
	sltu	$s2, $a3, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.134:                              # %vector.memcheck883
	sltu	$s1, $a5, $fp
	sltu	$s0, $a7, $s0
	and	$s0, $s1, $s0
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	bnez	$s0, .LBB6_33
# %bb.135:                              # %vector.memcheck883
	sltu	$s0, $a6, $t4
	sltu	$s1, $t0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.136:                              # %vector.memcheck883
	sltu	$s0, $a6, $t6
	sltu	$s1, $a0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.137:                              # %vector.memcheck883
	sltu	$s0, $a6, $t7
	sltu	$s1, $a1, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.138:                              # %vector.memcheck883
	sltu	$s0, $a6, $t8
	sltu	$s1, $a3, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.139:                              # %vector.memcheck883
	sltu	$s0, $a6, $fp
	sltu	$t5, $a7, $t5
	and	$t5, $s0, $t5
	bnez	$t5, .LBB6_33
# %bb.140:                              # %vector.memcheck883
	sltu	$t5, $t0, $t6
	sltu	$t6, $a0, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_33
# %bb.141:                              # %vector.memcheck883
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_33
# %bb.142:                              # %vector.memcheck883
	sltu	$t5, $t0, $t8
	sltu	$t6, $a3, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_33
# %bb.143:                              # %vector.memcheck883
	sltu	$t5, $t0, $fp
	sltu	$t4, $a7, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB6_33
# %bb.144:                              # %vector.ph1014
	bstrpick.d	$t2, $t3, 31, 3
	slli.d	$t2, $t2, 3
	xvreplve0.d	$xr1, $xr0
	lu52i.d	$t3, $zero, 1023
...
# %bb.237:                              # %middle.block1238
	beq	$a3, $a4, .LBB6_244
# %bb.238:                              # %vec.epilog.iter.check1243
	andi	$a6, $a5, 12
	beqz	$a6, .LBB6_242
.LBB6_239:                              # %vec.epilog.ph1242
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_240:                              # %vec.epilog.vector.body1250
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_240
# %bb.241:                              # %vec.epilog.middle.block1255
	beq	$a3, $a4, .LBB6_244
