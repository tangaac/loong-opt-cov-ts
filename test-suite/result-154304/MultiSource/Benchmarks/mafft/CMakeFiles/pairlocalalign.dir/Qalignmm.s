...
.LBB3_199:                              # %.loopexit
	...
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s1, $a0, %pc_lo12(Q__align.ijp)
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_201
# %bb.200:
	st.d	$s7, $sp, 0
...
# %bb.143:                              # %vector.memcheck883
	...
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_32
# %bb.144:                              # %vector.memcheck883
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_32
# %bb.145:                              # %vector.memcheck883
	sltu	$t5, $t0, $t8
	sltu	$t6, $a3, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_32
# %bb.146:                              # %vector.memcheck883
	sltu	$t5, $t0, $fp
	sltu	$t4, $a7, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB6_32
# %bb.147:                              # %vector.ph1014
	bstrpick.d	$t2, $t3, 31, 2
	slli.d	$t2, $t2, 2
	vreplvei.d	$vr1, $vr0, 0
	lu52i.d	$t3, $zero, 1023
...
.LBB6_177:                              # %vector.body1169
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_177
# %bb.178:                              # %middle.block1176
	beq	$a2, $a4, .LBB6_181
.LBB6_179:                              # %scalar.ph1160.preheader
	ld.d	$a2, $sp, 304                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t5, 2
...
.LBB6_184:                              # %vector.body1184
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB6_184
# %bb.185:                              # %middle.block1189
	beq	$a3, $a5, .LBB6_188
.LBB6_186:                              # %scalar.ph1179.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_187:                              # %scalar.ph1179
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
.LBB6_208:                              # %vector.body1090
	...
	addi.d	$t1, $t1, 16
	bnez	$t3, .LBB6_208
# %bb.209:                              # %middle.block1102
	bne	$a7, $t2, .LBB6_54
	b	.LBB6_56
.LBB6_210:                              # %vector.memcheck1105
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
...
.LBB6_214:                              # %vector.body1128
	...
	addi.d	$t0, $t0, 16
	bnez	$t2, .LBB6_214
# %bb.215:                              # %middle.block1140
	bne	$a6, $t1, .LBB6_58
	b	.LBB6_60
.LBB6_216:                              # %vector.ph1194
...
.LBB6_225:                              # %vector.body1212
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_225
# %bb.226:                              # %middle.block1218
	beq	$a3, $a4, .LBB6_229
.LBB6_227:                              # %scalar.ph1207.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_228:                              # %scalar.ph1207
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
