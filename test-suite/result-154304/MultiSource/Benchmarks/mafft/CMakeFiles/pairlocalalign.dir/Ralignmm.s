...
# %bb.1:
	...
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
	ld.w	$s2, $s6, %pc_lo12(R__align.orlgth1)
...
.LBB2_8:
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s8, %pc_lo12(R__align.fgcp2)
	...
	move	$s6, $s0
	st.w	$s2, $s0, %pc_lo12(R__align.orlgth1)
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
...
.LBB2_25:
	...
	ld.d	$a1, $sp, 408                   # 8-byte Folded Reload
	ld.d	$s8, $a1, %pc_lo12(R__align.cpmx1)
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	ld.d	$s0, $a1, %pc_lo12(R__align.floatwork)
	ld.d	$a1, $sp, 352                   # 8-byte Folded Reload
	ld.d	$s1, $a1, %pc_lo12(R__align.intwork)
	ori	$a7, $zero, 1
	ori	$s7, $zero, 1
	st.d	$a0, $sp, 400                   # 8-byte Folded Spill
	move	$a1, $s4
