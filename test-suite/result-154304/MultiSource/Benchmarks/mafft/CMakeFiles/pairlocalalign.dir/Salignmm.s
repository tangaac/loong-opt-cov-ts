...
.LBB3_2:
	...
	move	$s2, $a1
	ld.w	$s3, $a1, %pc_lo12(A__align.orlgth2)
...
# %bb.62:                               # %.lr.ph372
	...
	ld.d	$a3, $a2, %pc_lo12(A__align.fgcp2)
	addi.d	$a2, $t3, 1
	bstrpick.d	$a2, $a2, 31, 0
	addi.d	$a4, $a2, -1
	ori	$a5, $zero, 8
...
# %bb.147:                              # %middle.block789
	beq	$a4, $a5, .LBB3_150
.LBB3_148:                              # %scalar.ph778.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_149:                              # %scalar.ph778
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_167:                              #   in Loop: Header=BB3_152 Depth=1
	move	$s0, $s5
	move	$s1, $s3
.LBB3_168:                              # %.lr.ph19.i.preheader838
                                        #   in Loop: Header=BB3_152 Depth=1
	move	$s2, $s0
	move	$s3, $s1
	.p2align	4, , 16
...
.LBB3_203:                              # %vector.body551
	...
	addi.d	$a4, $a4, 16
	bnez	$a6, .LBB3_203
# %bb.204:                              # %middle.block556
	beq	$a1, $a3, .LBB3_37
	b	.LBB3_35
.LBB3_205:                              # %vector.memcheck616
...
.LBB3_208:                              # %vector.body632
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB3_208
# %bb.209:                              # %middle.block642
	bne	$a4, $a5, .LBB3_59
	b	.LBB3_61
.LBB3_210:                              # %vector.memcheck645
	addi.d	$a5, $s5, 4
	alsl.d	$a6, $a2, $s5, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
...
# %bb.58:                               # %.lr.ph353
	...
	ld.d	$a0, $a0, %pc_lo12(A__align_gapmap.ogcp2)
	ld.d	$a2, $sp, 176                   # 8-byte Folded Reload
	ld.d	$a3, $a2, %pc_lo12(A__align_gapmap.fgcp2)
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	addi.d	$a2, $a2, 1
	bstrpick.d	$a2, $a2, 31, 0
	addi.d	$a4, $a2, -1
...
.LBB6_75:
	...
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	ld.w	$a0, $a0, 0
	ld.d	$fp, $s4, %pc_lo12(A__align_gapmap.lastverticalw)
	sltu	$a1, $zero, $a0
	add.w	$s0, $a1, $t4
	ori	$a1, $zero, 2
	fst.s	$fa0, $fp, 0
...
.LBB6_96:                               # %vector.body664
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_96
# %bb.97:                               # %middle.block671
	beq	$a2, $a4, .LBB6_100
.LBB6_98:                               # %scalar.ph655.preheader
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
...
# %bb.101:                              # %.lr.ph391
	...
	movgr2fr.d	$fa0, $a2
	ffint.d.l	$fa0, $fa0
	ld.d	$a1, $s4, %pc_lo12(A__align_gapmap.lastverticalw)
	addi.d	$a2, $t4, 1
	bstrpick.d	$a2, $a2, 31, 0
	addi.d	$a3, $a2, -1
	ori	$a4, $zero, 2
...
.LBB6_103:                              # %vector.body679
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB6_103
# %bb.104:                              # %middle.block684
	beq	$a3, $a5, .LBB6_107
.LBB6_105:                              # %scalar.ph674.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_106:                              # %scalar.ph674
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
	...
	bnez	$a2, .LBB6_106
.LBB6_107:                              # %.loopexit
	ld.d	$s3, $s4, %pc_lo12(A__align_gapmap.lastverticalw)
...
# %bb.138:                              # %middle.block713
	beq	$a4, $a5, .LBB6_141
.LBB6_139:                              # %scalar.ph702.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_140:                              # %scalar.ph702
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB6_158:                              #   in Loop: Header=BB6_143 Depth=1
	move	$fp, $s3
	move	$s0, $s5
.LBB6_159:                              # %.lr.ph19.i.preheader760
                                        #   in Loop: Header=BB6_143 Depth=1
	move	$s1, $fp
	move	$s2, $s0
	.p2align	4, , 16
.LBB6_160:                              # %.lr.ph19.i
	...
	move	$s2, $s0
	bnez	$t8, .LBB6_160
.LBB6_161:                              # %._crit_edge20.loopexit.i
                                        #   in Loop: Header=BB6_143 Depth=1
	add.d	$t1, $s7, $t1
	add.d	$t1, $t7, $t1
	move	$s5, $s0
	move	$s3, $fp
	bne	$t5, $a2, .LBB6_153
.LBB6_162:                              #   in Loop: Header=BB6_143 Depth=1
	move	$t8, $s5
	move	$t7, $s3
	bne	$t2, $ra, .LBB6_167
	b	.LBB6_169
...
.LBB6_169:                              #   in Loop: Header=BB6_143 Depth=1
	blt	$t2, $a3, .LBB6_174
# %bb.170:                              #   in Loop: Header=BB6_143 Depth=1
	blt	$t4, $a3, .LBB6_174
# %bb.171:                              #   in Loop: Header=BB6_143 Depth=1
	add.d	$t0, $t5, $t0
	addi.d	$s5, $t8, -1
	st.b	$a4, $t8, -1
	addi.d	$s3, $t7, -1
	...
	b	.LBB6_173
	.p2align	4, , 16
.LBB6_172:                              #   in Loop: Header=BB6_143 Depth=1
	addi.d	$t3, $s7, -1
	move	$t5, $a2
	nor	$t7, $t3, $zero
	add.w	$t8, $s7, $t7
...
.LBB6_176:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s1, .LBB6_176
.LBB6_177:                              # %.preheader.i
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 56                    # 8-byte Folded Reload
	blt	$s1, $fp, .LBB6_180
# %bb.178:                              # %.lr.ph52.preheader.i
	move	$fp, $s2
	move	$s0, $s1
	.p2align	4, , 16
.LBB6_179:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB6_179
.LBB6_180:                              # %Atracking_localhom_gapmap.exit
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
...
.LBB6_194:                              # %vector.body531
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB6_194
# %bb.195:                              # %middle.block536
	beq	$a1, $a3, .LBB6_36
	b	.LBB6_34
.LBB6_196:                              # %vector.memcheck568
...
.LBB6_199:                              # %vector.body584
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB6_199
# %bb.200:                              # %middle.block594
	bne	$a4, $a5, .LBB6_55
	b	.LBB6_57
.LBB6_201:                              # %vector.memcheck597
	addi.d	$a5, $s5, 4
	alsl.d	$a6, $a2, $s5, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
