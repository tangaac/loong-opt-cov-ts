...
# %bb.0:
	...
	fst.d	$fs1, $sp, 968                  # 8-byte Folded Spill
	fst.d	$fs2, $sp, 960                  # 8-byte Folded Spill
	fst.d	$fs3, $sp, 952                  # 8-byte Folded Spill
	fst.d	$fs4, $sp, 944                  # 8-byte Folded Spill
	fst.d	$fs5, $sp, 936                  # 8-byte Folded Spill
	fst.d	$fs6, $sp, 928                  # 8-byte Folded Spill
	fst.d	$fs7, $sp, 920                  # 8-byte Folded Spill
	move	$s1, $a0
	pcaddu18i	$ra, %call36(StartStopwatch)
	jirl	$ra, $ra, 0
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
...
.LBB15_25:                              # %.lr.ph
                                        ...
                                        #       Child Loop BB15_80 Depth 3
                                        #       Child Loop BB15_83 Depth 3
	st.d	$ra, $sp, 576                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	st.d	$zero, $a0, %pc_lo12(worst_error)
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ori	$a3, $zero, 2416
...
.LBB15_28:                              # %.preheader.i.i
	...
	fld.d	$fa3, $s1, 64
	fld.d	$fa4, $s1, 72
	fld.d	$fa5, $sp, 616                  # 8-byte Folded Reload
	fmadd.d	$fa0, $fa1, $fa5, $fa0
...
# %bb.29:                               # %do_forward_pass.exit
	...
	vst	$vr3, $sp, 896                  # 16-byte Folded Spill
	fst.d	$fa0, $sp, 688                  # 8-byte Folded Spill
	fmadd.d	$fa0, $fa0, $fa3, $fs0
	...
	fst.d	$fa3, $sp, 664                  # 8-byte Folded Spill
	fmadd.d	$fa0, $fa3, $fa4, $fa0
	...
	fld.d	$fa3, $s8, 240
	fld.d	$fa4, $s8, 248
	fst.d	$fa1, $sp, 464                  # 8-byte Folded Spill
	vld	$vr5, $sp, 832                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa1, $fa5, $fa0
	fst.d	$fa2, $sp, 456                  # 8-byte Folded Spill
	vld	$vr1, $sp, 816                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa2, $fa1, $fa0
	...
	vld	$vr1, $sp, 800                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa3, $fa1, $fa0
	fst.d	$fa4, $sp, 360                  # 8-byte Folded Spill
	vld	$vr1, $sp, 784                  # 16-byte Folded Reload
	fnmadd.d	$fa0, $fa4, $fa1, $fa0
	pcaddu18i	$ra, %call36(exp)
	jirl	$ra, $ra, 0
	...
	vld	$vr1, $sp, 800                  # 16-byte Folded Reload
	fmadd.d	$fa0, $fa3, $fa1, $fa0
	fst.d	$fa4, $sp, 296                  # 8-byte Folded Spill
	vld	$vr1, $sp, 784                  # 16-byte Folded Reload
	fnmadd.d	$fa0, $fa4, $fa1, $fa0
	pcaddu18i	$ra, %call36(exp)
	jirl	$ra, $ra, 0
...
.LBB15_70:                              # %do_out_error.exit.i
	...
	fld.d	$ft9, $sp, 504                  # 8-byte Folded Reload
	...
	fld.d	$ft6, $sp, 456                  # 8-byte Folded Reload
	fmadd.d	$ft6, $ft6, $fa4, $ft7
	fld.d	$ft7, $sp, 448                  # 8-byte Folded Reload
	...
	fld.d	$ft3, $sp, 392                  # 8-byte Folded Reload
	...
	fld.d	$ft5, $sp, 304                  # 8-byte Folded Reload
	fmadd.d	$ft5, $ft5, $fa6, $ft6
	fld.d	$ft6, $sp, 296                  # 8-byte Folded Reload
	...
	fmadd.d	$fa3, $fs1, $fa7, $fa3
	fmadd.d	$fa4, $fs4, $fa7, $fa4
	fmadd.d	$fa5, $fs5, $fa7, $fa5
	fmadd.d	$fa6, $fs2, $fa7, $fa6
	fmadd.d	$ft3, $fs3, $fa7, $ft3
	fmadd.d	$ft4, $fs6, $fa7, $ft4
	fmadd.d	$fa1, $fs7, $fa7, $fa1
	vldi	$vr7, -960
	fmul.d	$fa7, $ft2, $fa7
	slli.d	$a4, $a4, 3
	...
	fstx.d	$ft1, $a1, $a4
	vldi	$vr13, -912
	vld	$vr8, $sp, 896                  # 16-byte Folded Reload
	fsub.d	$fa7, $ft5, $ft0
	fmul.d	$fa7, $ft0, $fa7
	fmul.d	$ft2, $fa7, $fa2
...
# %bb.81:                               # %middle.block111
	...
	sltu	$a1, $zero, $a1
	beq	$a0, $a2, .LBB15_84
.LBB15_82:                              # %.lr.ph.split.i.preheader221
                                        #   in Loop: Header=BB15_25 Depth=2
	sub.d	$a2, $a2, $a0
...
# %bb.91:                               # %middle.block
	...
	sltu	$a1, $zero, $a1
	beq	$a0, $a2, .LBB15_94
.LBB15_92:                              # %.lr.ph.split.us.i.preheader222
                                        #   in Loop: Header=BB15_5 Depth=1
	sub.d	$a2, $a3, $a0
	pcalau12i	$a3, %pc_hi20(tot_out_error)
	addi.d	$a3, $a3, %pc_lo12(tot_out_error)
...
.LBB15_95:                              # %._crit_edge27
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	fld.d	$fs7, $sp, 920                  # 8-byte Folded Reload
	fld.d	$fs6, $sp, 928                  # 8-byte Folded Reload
	fld.d	$fs5, $sp, 936                  # 8-byte Folded Reload
	fld.d	$fs4, $sp, 944                  # 8-byte Folded Reload
	fld.d	$fs3, $sp, 952                  # 8-byte Folded Reload
	fld.d	$fs2, $sp, 960                  # 8-byte Folded Reload
	fld.d	$fs1, $sp, 968                  # 8-byte Folded Reload
	fld.d	$fs0, $sp, 976                  # 8-byte Folded Reload
