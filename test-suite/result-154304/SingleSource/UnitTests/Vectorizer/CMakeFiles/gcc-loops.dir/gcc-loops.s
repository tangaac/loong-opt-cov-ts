...
.LBB24_163:
	alsl.d	$a3, $a2, $fp, 2
.LBB24_164:                             # %.lr.ph.i407.preheader
	addi.d	$a0, $a3, -4
	.p2align	4, , 16
.LBB24_165:                             # %.lr.ph.i407
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a0, 4
	addi.d	$a3, $a0, 4
	add.w	$a1, $a2, $a1
...
.Ltmp34:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp35:                                # EH_LABEL
# %bb.168:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit410.preheader
	beq	$s0, $fp, .LBB24_173
# %bb.169:                              # %.lr.ph.preheader
	move	$s4, $zero
	sub.d	$a0, $s0, $fp
	srai.d	$s2, $a0, 2
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
...
.Ltmp36:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp37:                                # EH_LABEL
# %bb.171:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit414
...
.Ltmp38:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp39:                                # EH_LABEL
# %bb.172:                              # %_ZNSolsEj.exit
                                        #   in Loop: Header=BB24_170 Depth=1
	bstrpick.d	$s4, $s3, 31, 0
	addi.w	$s3, $s3, 1
	bltu	$s4, $s2, .LBB24_170
.LBB24_173:                             # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit410._crit_edge
.Ltmp41:                                # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
