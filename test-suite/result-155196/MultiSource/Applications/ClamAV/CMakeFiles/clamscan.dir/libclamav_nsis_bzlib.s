...
# %bb.463:                              #   in Loop: Header=BB3_4 Depth=1
	move	$s0, $a5
.LBB3_464:                              # %scalar.ph509.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	slli.d	$a5, $s0, 2
	sub.d	$a6, $a4, $s0
	st.d	$t2, $sp, 464                   # 8-byte Folded Spill
.LBB3_465:                              # %scalar.ph509
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a7, $a1
	beqz	$a6, .LBB3_468
...
.LBB3_468:                              #   in Loop: Header=BB3_4 Depth=1
	...
	ld.d	$t0, $sp, 360                   # 8-byte Folded Reload
	b	.LBB3_442
.LBB3_469:                              # %unRLE_obuf_to_output_SMALL.exit.thread.loopexit914
	addi.w	$a0, $zero, -1
...
.LBB3_476:                              # %vec.epilog.vector.body
	...
	addi.w	$a0, $a0, -8
	b	.LBB3_476
.LBB3_477:                              # %vector.body543.preheader
	move	$a1, $s1
.LBB3_478:                              # %vector.body543
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $a5, -1
	bstrpick.d	$a0, $a0, 31, 0
	add.d	$a0, $a1, $a0
