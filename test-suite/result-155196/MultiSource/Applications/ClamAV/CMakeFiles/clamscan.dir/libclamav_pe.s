...
# %bb.578:
	...
	bgeu	$a1, $a0, .LBB0_523
	b	.LBB0_529
.LBB0_579:                              # %vector.main.loop.iter.check3966
	ori	$a0, $zero, 16
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB0_611
# %bb.580:
...
# %bb.600:
	...
	bne	$a0, $a2, .LBB0_751
# %bb.601:                              # %.preheader3349
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 168                   # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_661
# %bb.602:                              # %.lr.ph3449.preheader
...
# %bb.604:                              #   in Loop: Header=BB0_603 Depth=1
	...
	beqz	$a1, .LBB0_606
# %bb.605:                              #   in Loop: Header=BB0_603 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s4, 0
.LBB0_606:                              #   in Loop: Header=BB0_603 Depth=1
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	nor	$a1, $a1, $zero
	add.w	$a1, $s3, $a1
	bltu	$a1, $a0, .LBB0_842
...
.LBB0_615:                              # %vec.epilog.ph3981
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_616:                              # %vec.epilog.vector.body3989
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
...
# %bb.627:
	...
	b	.LBB0_629
.LBB0_628:                              #   in Loop: Header=BB0_629 Depth=1
	addi.w	$s4, $s4, -1
	addi.d	$s0, $s0, -1
	addi.d	$s7, $s7, 36
	beqz	$s0, .LBB0_668
...
# %bb.630:                              #   in Loop: Header=BB0_629 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_634
# %bb.631:                              #   in Loop: Header=BB0_629 Depth=1
	ld.wu	$a0, $s7, 12
	addi.w	$a1, $a0, -1
	bgeu	$a1, $s5, .LBB0_634
# %bb.632:                              #   in Loop: Header=BB0_629 Depth=1
	ld.wu	$a1, $s7, 0
	add.d	$a2, $a1, $a0
	bltu	$s3, $a2, .LBB0_634
# %bb.633:                              #   in Loop: Header=BB0_629 Depth=1
	addi.w	$a2, $a0, 0
	add.d	$a1, $s6, $a1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(cli_readn)
...
# %bb.635:
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_636:                              # %.critedge200.sink.split
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_637:                              # %.critedge200
	ld.d	$a0, $fp, 56
	ld.bu	$a0, $a0, 1
	andi	$a0, $a0, 16
	beqz	$a0, .LBB0_644
...
.LBB0_667:                              # %.critedge3021
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_668:                              # %._crit_edge3483.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_673
...
# %bb.784:
	...
	b	.LBB0_204
.LBB0_785:                              # %._crit_edge3470._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_786:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
.LBB0_804:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a4, $a5, -1
	bltu	$a4, $a2, .LBB0_891
# %bb.805:                              #   in Loop: Header=BB0_804 Depth=1
	ld.w	$a4, $s4, 0
	slli.d	$a5, $a5, 12
	sub.d	$a5, $a5, $a1
	add.w	$a5, $a5, $a3
	...
	bltu	$a5, $a4, .LBB0_890
# %bb.806:                              #   in Loop: Header=BB0_804 Depth=1
	ld.w	$a6, $s4, 4
	sub.w	$a4, $a5, $a4
	bgeu	$a4, $a6, .LBB0_890
# %bb.807:                              #   in Loop: Header=BB0_804 Depth=1
	addi.w	$s7, $s7, 2
	bltu	$s7, $a0, .LBB0_804
	b	.LBB0_891
.LBB0_808:                              # %._crit_edge3474
	ld.wu	$a0, $s5, 12
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
	jirl	$ra, $ra, 0
...
# %bb.852:                              # %middle.block
	beq	$a2, $a3, .LBB0_855
.LBB0_853:                              # %.lr.ph3453.preheader4007
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
...
.LBB0_869:
	move	$s5, $s6
.LBB0_870:                              # %.thread3315.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_644
