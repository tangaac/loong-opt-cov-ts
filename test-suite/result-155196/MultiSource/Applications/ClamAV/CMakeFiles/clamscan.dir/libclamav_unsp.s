...
.LBB1_193:                              # %get_byte.exit.i.i428
	...
	slli.d	$t4, $t6, 8
	b	.LBB1_196
.LBB1_194:                              #   in Loop: Header=BB1_182 Depth=2
	st.w	$s1, $sp, 256
	ori	$t6, $zero, 255
.LBB1_195:                              # %get_byte.exit53.i.i425
                                        #   in Loop: Header=BB1_182 Depth=2
	slli.w	$t1, $t1, 8
	or	$t1, $t6, $t1
	st.w	$t1, $sp, 252
	slli.d	$t4, $t4, 8
.LBB1_196:                              # %getbit_from_table.exit.i421
                                        #   in Loop: Header=BB1_182 Depth=2
	st.w	$t4, $sp, 248
	b	.LBB1_181
.LBB1_197:                              # %.preheader.split.i438
                                        #   in Loop: Header=BB1_15 Depth=1
	ld.d	$t0, $sp, 264
	add.d	$a7, $t0, $a6
	bltu	$t4, $t0, .LBB1_216
# %bb.198:                              # %.preheader.split.i438
                                        #   in Loop: Header=BB1_15 Depth=1
...
# %bb.202:                              #   in Loop: Header=BB1_15 Depth=1
	...
	st.d	$a3, $sp, 232
	b	.LBB1_242
.LBB1_203:                              #   in Loop: Header=BB1_15 Depth=1
	move	$s6, $t3
	move	$s4, $t1
	st.d	$t8, $sp, 176                   # 8-byte Folded Spill
	move	$s5, $t7
...
.LBB1_207:                              # %get_byte.exit.i389
	...
	slli.d	$a0, $a4, 8
	st.w	$a0, $sp, 248
.LBB1_208:                              # %getbit_from_table.exit391
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$s5, $t1
	move	$s0, $t3
	move	$s6, $ra
...
.LBB1_212:                              # %get_byte.exit.i401
	...
	slli.d	$a0, $a2, 8
	st.w	$a0, $sp, 248
.LBB1_213:                              # %getbit_from_table.exit391
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$s5, $ra
	move	$s0, $t3
	move	$s6, $t1
...
.LBB1_216:                              #   in Loop: Header=BB1_15 Depth=1
	...
	ori	$a6, $zero, 255
	b	.LBB1_246
.LBB1_217:                              # %vector.main.loop.iter.check810
                                        #   in Loop: Header=BB1_15 Depth=1
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB1_219
...
.LBB1_223:                              # %vec.epilog.ph825
	...
	vor.v	$vr1, $vr2, $vr1
	sub.d	$a3, $a4, $a5
.LBB1_224:                              # %vec.epilog.vector.body834
                                        #   Parent Loop BB1_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vsll.w	$vr2, $vr5, $vr1
	vor.v	$vr0, $vr2, $vr0
...
# %bb.225:                              # %vec.epilog.middle.block840
	...
	beq	$a2, $a6, .LBB1_227
	.p2align	4, , 16
.LBB1_226:                              # %getbit_from_table.exit.us.i430
                                        #   Parent Loop BB1_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ori	$a5, $zero, 255
	sll.w	$a5, $a5, $a4
...
.LBB1_227:                              # %get_bb.exit
	...
	ld.d	$t1, $sp, 184                   # 8-byte Folded Reload
	b	.LBB1_288
.LBB1_228:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$t5, $sp, 256
	ori	$a1, $zero, 255
.LBB1_229:                              # %get_byte.exit.i377
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.d	$a0, $a0, 8
	or	$a0, $a1, $a0
	st.w	$a0, $sp, 252
	slli.d	$a0, $a2, 8
	st.w	$a0, $sp, 248
.LBB1_230:                              # %getbit_from_table.exit379
                                        #   in Loop: Header=BB1_15 Depth=1
	ori	$s5, $zero, 1
	beqz	$s8, .LBB1_1
...
.LBB1_243:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 256
	ori	$t2, $zero, 255
.LBB1_244:                              # %get_byte.exit53.i.i450
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t2, $a4
	st.w	$a4, $sp, 252
...
.LBB1_246:                              # %getbit_from_table.exit.i445
	...
	alsl.d	$t2, $t3, $t2, 1
	bltu	$t2, $t0, .LBB1_252
# %bb.247:                              # %getbit_from_table.exit.i445
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t4, $t2, 2
	bltu	$a7, $t4, .LBB1_252
...
.LBB1_257:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 256
	ori	$t1, $zero, 255
.LBB1_258:                              # %get_byte.exit.i.i453.1
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$t2, $zero
	slli.w	$a4, $a4, 8
	or	$a4, $t1, $a4
...
.LBB1_259:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 256
	ori	$t4, $zero, 255
.LBB1_260:                              # %get_byte.exit53.i.i450.1
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t4, $a4
	st.w	$a4, $sp, 252
...
.LBB1_262:                              # %getbit_from_table.exit.i445.1
	...
	alsl.d	$t3, $t4, $t3, 1
	bltu	$t3, $t0, .LBB1_268
# %bb.263:                              # %getbit_from_table.exit.i445.1
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t5, $t3, 2
	bltu	$a7, $t5, .LBB1_268
...
.LBB1_273:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 256
	ori	$t1, $zero, 255
.LBB1_274:                              # %get_byte.exit.i.i453.2
                                        #   in Loop: Header=BB1_15 Depth=1
	move	$t3, $zero
	slli.w	$a4, $a4, 8
	or	$a4, $t1, $a4
...
.LBB1_275:                              #   in Loop: Header=BB1_15 Depth=1
	st.w	$s1, $sp, 256
	ori	$t5, $zero, 255
.LBB1_276:                              # %get_byte.exit53.i.i450.2
                                        #   in Loop: Header=BB1_15 Depth=1
	slli.w	$a4, $a4, 8
	or	$a4, $t5, $a4
	st.w	$a4, $sp, 252
...
.LBB1_278:                              # %getbit_from_table.exit.i445.2
	...
	alsl.d	$t4, $t4, $t5, 1
	bltu	$t4, $t0, .LBB1_284
# %bb.279:                              # %getbit_from_table.exit.i445.2
                                        #   in Loop: Header=BB1_15 Depth=1
	addi.d	$t0, $t4, 2
	bltu	$a7, $t0, .LBB1_284
