...
.LBB13_63:                              # %vec.epilog.ph340
	...
	sub.d	$a4, $a4, $a6
	.p2align	4, , 16
.LBB13_64:                              # %vec.epilog.vector.body346
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vsrai.w	$vr1, $vr1, 1
...
.LBB13_80:
	addi.d	$a5, $a4, 1
.LBB13_81:                              # %vec.epilog.scalar.ph339.preheader
	alsl.d	$a2, $a5, $a2, 2
	sub.d	$a3, $s3, $a5
	.p2align	4, , 16
.LBB13_82:                              # %vec.epilog.scalar.ph339
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	slli.d	$a4, $a4, 1
...
# %bb.94:
	move	$a4, $a1
	b	.LBB13_120
.LBB13_95:                              # %vector.main.loop.iter.check362
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB13_97
# %bb.96:
	move	$a3, $zero
	b	.LBB13_101
.LBB13_97:                              # %vector.ph363
	move	$a3, $a2
	bstrins.d	$a3, $zero, 3, 0
	alsl.d	$a4, $a1, $a0, 2
	addi.d	$a4, $a4, 32
...
.LBB13_98:                              # %vector.body366
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB13_98
# %bb.99:                               # %middle.block369
	beq	$a2, $a3, .LBB13_122
# %bb.100:                              # %vec.epilog.iter.check374
	andi	$a4, $a2, 12
	beqz	$a4, .LBB13_119
.LBB13_101:                             # %vec.epilog.ph373
	move	$a5, $a2
	bstrins.d	$a5, $zero, 1, 0
	add.d	$a4, $a5, $a1
	slli.d	$a6, $a3, 2
	...
	vrepli.w	$vr0, -2
	.p2align	4, , 16
.LBB13_102:                             # %vec.epilog.vector.body379
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a1, 0
	addi.d	$a3, $a3, 4
	addi.d	$a1, $a1, 16
	bnez	$a3, .LBB13_102
# %bb.103:                              # %vec.epilog.middle.block383
	bne	$a2, $a5, .LBB13_120
	b	.LBB13_122
.LBB13_104:
	add.d	$a4, $a3, $a1
...
.LBB13_119:
	add.d	$a4, $a3, $a1
.LBB13_120:                             # %vec.epilog.scalar.ph372.preheader
	sub.d	$a1, $s3, $a4
	alsl.d	$a2, $a4, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_121:                             # %vec.epilog.scalar.ph372
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
...
# %bb.23:                               # %.lr.ph.i
	st.w	$s1, $fp, 512
	b	.LBB14_26
.LBB14_24:                              # %._ZN3vecI3LitE5clearEb.exit_crit_edge
	ld.w	$a1, $fp, 496
	ld.w	$a2, $fp, 500
	beq	$a1, $a2, .LBB14_2
	b	.LBB14_3
.LBB14_25:
	move	$a0, $zero
.LBB14_26:                              # %_ZN3vecI3LitE6shrinkEi.exit
