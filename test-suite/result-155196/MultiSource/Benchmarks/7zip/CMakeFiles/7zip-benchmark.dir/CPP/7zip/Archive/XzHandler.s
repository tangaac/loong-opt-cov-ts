...
# %bb.51:                               # %iter.check406
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB11_62
# %bb.52:                               # %vector.main.loop.iter.check408
                                        #   in Loop: Header=BB11_44 Depth=2
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB11_55
...
.LBB11_56:                              # %vector.body412
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB11_56
# %bb.57:                               # %middle.block417
                                        #   in Loop: Header=BB11_44 Depth=2
	beq	$a2, $a1, .LBB11_64
# %bb.58:                               # %vec.epilog.iter.check422
                                        #   in Loop: Header=BB11_44 Depth=2
	andi	$a3, $a1, 48
	beqz	$a3, .LBB11_62
.LBB11_59:                              # %vec.epilog.ph421
                                        #   in Loop: Header=BB11_44 Depth=2
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB11_60:                              # %vec.epilog.vector.body427
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_44 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a5, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_60
# %bb.61:                               # %vec.epilog.middle.block431
                                        #   in Loop: Header=BB11_44 Depth=2
	beq	$a2, $a1, .LBB11_64
.LBB11_62:                              # %vec.epilog.scalar.ph420.preheader
                                        #   in Loop: Header=BB11_44 Depth=2
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s6, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB11_63:                              # %vec.epilog.scalar.ph420
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_44 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.b	$a4, $a2, 0
...
# %bb.76:                               # %iter.check373
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB11_87
# %bb.77:                               # %vector.main.loop.iter.check375
                                        #   in Loop: Header=BB11_41 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB11_80
...
.LBB11_81:                              # %vector.body379
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB11_81
# %bb.82:                               # %middle.block384
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_89
# %bb.83:                               # %vec.epilog.iter.check389
                                        #   in Loop: Header=BB11_41 Depth=1
	andi	$a3, $a1, 48
	beqz	$a3, .LBB11_87
.LBB11_84:                              # %vec.epilog.ph388
                                        #   in Loop: Header=BB11_41 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a4, $s5, $a5
	add.d	$a5, $a0, $a5
.LBB11_85:                              # %vec.epilog.vector.body394
                                        #   Parent Loop BB11_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_85
# %bb.86:                               # %vec.epilog.middle.block398
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_89
.LBB11_87:                              # %vec.epilog.scalar.ph387.preheader
                                        #   in Loop: Header=BB11_41 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s5, $a2
	add.d	$a2, $a0, $a2
.LBB11_88:                              # %vec.epilog.scalar.ph387
                                        #   Parent Loop BB11_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
# %bb.99:                               # %.preheader.i.i.i153
	...
	addi.w	$a1, $s4, 0
	blt	$a1, $s8, .LBB11_104
# %bb.100:                              # %iter.check340
                                        #   in Loop: Header=BB11_41 Depth=1
	move	$a2, $zero
	ori	$a3, $zero, 16
	bltu	$a1, $a3, .LBB11_112
# %bb.101:                              # %iter.check340
                                        #   in Loop: Header=BB11_41 Depth=1
	sub.d	$a3, $s6, $a0
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB11_112
# %bb.102:                              # %vector.main.loop.iter.check342
                                        #   in Loop: Header=BB11_41 Depth=1
	ori	$a2, $zero, 64
...
.LBB11_106:                             # %vector.body346
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB11_106
# %bb.107:                              # %middle.block351
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_114
# %bb.108:                              # %vec.epilog.iter.check356
                                        #   in Loop: Header=BB11_41 Depth=1
	andi	$a3, $a1, 48
	beqz	$a3, .LBB11_112
.LBB11_109:                             # %vec.epilog.ph355
	...
	add.d	$a4, $s6, $a5
	add.d	$a5, $a0, $a5
.LBB11_110:                             # %vec.epilog.vector.body361
                                        #   Parent Loop BB11_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_110
# %bb.111:                              # %vec.epilog.middle.block365
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_114
.LBB11_112:                             # %vec.epilog.scalar.ph354.preheader
                                        #   in Loop: Header=BB11_41 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s6, $a2
	add.d	$a2, $a0, $a2
.LBB11_113:                             # %vec.epilog.scalar.ph354
                                        #   Parent Loop BB11_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
# %bb.146:                              # %.preheader.i.i.i121
	...
	ld.d	$a0, $sp, 96
	blt	$s7, $a1, .LBB11_151
# %bb.147:                              # %iter.check307
                                        #   in Loop: Header=BB11_142 Depth=2
	move	$a1, $zero
	ori	$a2, $zero, 16
	bltu	$s7, $a2, .LBB11_159
# %bb.148:                              # %iter.check307
                                        #   in Loop: Header=BB11_142 Depth=2
	sub.d	$a2, $s5, $a0
	ori	$a3, $zero, 63
	bgeu	$a3, $a2, .LBB11_159
# %bb.149:                              # %vector.main.loop.iter.check309
                                        #   in Loop: Header=BB11_142 Depth=2
	ori	$a1, $zero, 64
...
.LBB11_153:                             # %vector.body313
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB11_153
# %bb.154:                              # %middle.block318
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_161
# %bb.155:                              # %vec.epilog.iter.check323
                                        #   in Loop: Header=BB11_142 Depth=2
	andi	$a2, $s7, 48
	beqz	$a2, .LBB11_159
.LBB11_156:                             # %vec.epilog.ph322
                                        #   in Loop: Header=BB11_142 Depth=2
	move	$a4, $a1
	...
	add.d	$a4, $a0, $a4
	.p2align	4, , 16
.LBB11_157:                             # %vec.epilog.vector.body328
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_142 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB11_157
# %bb.158:                              # %vec.epilog.middle.block332
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_161
.LBB11_159:                             # %vec.epilog.scalar.ph321.preheader
                                        #   in Loop: Header=BB11_142 Depth=2
	sub.d	$a2, $s7, $a1
	add.d	$a3, $s5, $a1
	add.d	$a1, $a0, $a1
	.p2align	4, , 16
.LBB11_160:                             # %vec.epilog.scalar.ph321
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_142 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.b	$a4, $a1, 0
...
# %bb.174:                              # %middle.block285
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_139
# %bb.175:                              # %vec.epilog.iter.check290
                                        #   in Loop: Header=BB11_142 Depth=2
	andi	$a2, $s7, 48
	beqz	$a2, .LBB11_179
.LBB11_176:                             # %vec.epilog.ph289
                                        #   in Loop: Header=BB11_142 Depth=2
	move	$a4, $a1
	bstrpick.d	$a1, $s7, 30, 4
	slli.d	$a1, $a1, 4
	...
	add.d	$a4, $a0, $a4
	.p2align	4, , 16
.LBB11_177:                             # %vec.epilog.vector.body295
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_142 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB11_177
# %bb.178:                              # %vec.epilog.middle.block299
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_139
