...
.LBB6_173:                              # %scalar.ph
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB6_173
.LBB6_174:                              # %._crit_edge626
	addi.w	$a0, $a3, 0
	bltz	$a0, .LBB6_19
# %bb.175:                              # %._crit_edge626
	addi.w	$a1, $a7, 0
	bge	$a0, $a1, .LBB6_19
# %bb.176:
	ld.d	$a2, $sp, 440
	...
	stx.w	$s6, $a2, $a0
	b	.LBB6_19
.LBB6_177:                              # %_ZN7CBufferIhED2Ev.exit360.thread743
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$s7, $zero
...
.LBB6_187:                              # %.thread487
	...
	ori	$s0, $zero, 1
	b	.LBB6_212
.LBB6_188:                              # %._crit_edge615
	ld.d	$a1, $sp, 384
	addi.d	$a1, $a1, -1
	st.d	$a1, $sp, 384
	beqz	$a1, .LBB6_204
# %bb.189:                              # %.preheader.lr.ph
...
.LBB6_190:                              #   in Loop: Header=BB6_191 Depth=1
	...
	bgeu	$a0, $a1, .LBB6_203
	.p2align	4, , 16
.LBB6_191:                              # =>This Loop Header: Depth=1
                                        #     Child Loop BB6_196 Depth 2
                                        #       Child Loop BB6_199 Depth 3
...
# %bb.194:                              #   in Loop: Header=BB6_191 Depth=1
	...
	b	.LBB6_196
	.p2align	4, , 16
.LBB6_195:                              # %_ZL13TestSignaturePKhS0_m.exit
                                        #   in Loop: Header=BB6_196 Depth=2
	addi.d	$a0, $sp, 104
	add.d	$s1, $a0, $s5
	addi.d	$s0, $sp, 104
	ldx.bu	$s5, $s5, $a0
	ori	$a0, $zero, 255
	beq	$s5, $a0, .LBB6_190
.LBB6_196:                              #   Parent Loop BB6_191 Depth=1
...
# %bb.198:                              #   in Loop: Header=BB6_196 Depth=2
	...
	.p2align	4, , 16
.LBB6_199:                              # %.lr.ph.i334
                                        #   Parent Loop BB6_191 Depth=1
                                        #     Parent Loop BB6_196 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a3, $a2, 0
	ld.bu	$a4, $a1, 0
	bne	$a3, $a4, .LBB6_195
# %bb.200:                              #   in Loop: Header=BB6_199 Depth=3
	addi.d	$a0, $a0, -1
	addi.d	$a1, $a1, 1
	addi.d	$a2, $a2, 1
	bnez	$a0, .LBB6_199
# %bb.201:                              #   in Loop: Header=BB6_196 Depth=2
.Ltmp108:                               # EH_LABEL
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector18ReserveOnePositionEv)
	jirl	$ra, $ra, 0
.Ltmp109:                               # EH_LABEL
# %bb.202:                              #   in Loop: Header=BB6_196 Depth=2
	ld.w	$a0, $sp, 404
	ld.d	$a1, $sp, 408
	slli.d	$a0, $a0, 2
	stx.w	$s8, $a1, $a0
	...
	bne	$s5, $a0, .LBB6_196
	b	.LBB6_190
.LBB6_203:                              # %.critedge._crit_edge.loopexit
	ld.w	$a0, $sp, 436
	ld.d	$s6, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 8                     # 8-byte Folded Reload
.LBB6_204:                              # %.critedge._crit_edge
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB6_210
# %bb.205:                              # %.lr.ph620
	move	$s1, $zero
...
.Ltmp111:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp112:                               # EH_LABEL
# %bb.209:                              # %_ZN13CRecordVectorIiE3AddEi.exit339
                                        #   in Loop: Header=BB6_207 Depth=1
	ld.w	$a0, $sp, 404
	ld.d	$a1, $sp, 408
	slli.d	$a0, $a0, 2
	stx.w	$s0, $a1, $a0
...
.LBB6_212:
	...
	jirl	$ra, $ra, 0
	move	$s7, $s0
.LBB6_213:                              # %_ZN7CBufferIhED2Ev.exit
	slti	$s1, $s1, 256
	b	.LBB6_135
.LBB6_214:
.Ltmp91:                                # EH_LABEL
...
# %bb.216:                              # %.thread498
	ld.d	$a0, $sp, 440
	st.w	$s1, $a0, 0
.LBB6_217:                              # %_ZN7CBufferIhED2Ev.exit360
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
...
.Ltmp189:                               # EH_LABEL
	...
	move	$s1, $a0
	bnez	$a1, .LBB6_244
# %bb.242:                              # %_ZN11CStringBaseIwED2Ev.exit424
	ld.d	$a0, $sp, 360
	bnez	$a0, .LBB6_255
.LBB6_243:                              # %_ZN11CStringBaseIwED2Ev.exit425
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_257
	b	.LBB6_275
.LBB6_244:
...
.LBB6_249:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_250:                              # %_ZN7CBufferIhED2Ev.exit342
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB6_280
...
# %bb.252:
	...
	jirl	$ra, $ra, 0
	b	.LBB6_275
.LBB6_253:                              # %.loopexit.split-lp577.loopexit.split-lp
.Ltmp78:                                # EH_LABEL
	b	.LBB6_279
.LBB6_254:
.Ltmp186:                               # EH_LABEL
...
.Ltmp168:                               # EH_LABEL
	b	.LBB6_274
.LBB6_272:                              # %.loopexit.split-lp577.loopexit
.Ltmp69:                                # EH_LABEL
	b	.LBB6_279
.LBB6_273:
.Ltmp171:                               # EH_LABEL
...
.Ltmp139:                               # EH_LABEL
	b	.LBB6_279
.LBB6_278:                              # %.loopexit576
.Ltmp64:                                # EH_LABEL
.LBB6_279:                              # %_ZN7CBufferIhED2Ev.exit361
	move	$s1, $a0
.LBB6_280:                              # %_ZN7CBufferIhED2Ev.exit361
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB6_281:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_282:                              # %_ZN11CStringBaseIwED2Ev.exit452
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB6_284
# %bb.283:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_284:                              # %_ZN11CStringBaseIwED2Ev.exit453
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end6:
