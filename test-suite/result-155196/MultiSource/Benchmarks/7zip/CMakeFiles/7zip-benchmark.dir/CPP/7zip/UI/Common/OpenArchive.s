...
# %bb.60:                               #   in Loop: Header=BB6_22 Depth=1
	move	$s2, $zero
.LBB6_61:                               # %_ZNK10CArcInfoEx13FindExtensionERK11CStringBaseIwE.exit435
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
	b	.LBB6_69
.LBB6_62:                               #   in Loop: Header=BB6_22 Depth=1
.Ltmp178:                               # EH_LABEL
	ori	$a0, $zero, 4
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
...
.LBB6_68:                               #   in Loop: Header=BB6_22 Depth=1
	move	$s2, $zero
.LBB6_69:                               # %_ZNK10CArcInfoEx13FindExtensionERK11CStringBaseIwE.exit435
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $s1, 56
	slli.d	$a1, $s2, 3
	ldx.d	$a2, $a0, $a1
...
# %bb.72:                               #   in Loop: Header=BB6_22 Depth=1
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
	b	.LBB6_83
.LBB6_73:                               # %._ZN11CStringBaseIwEaSERKS0_.exit444_crit_edge
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	bnez	$a0, .LBB6_86
	b	.LBB6_87
.LBB6_74:                               #   in Loop: Header=BB6_22 Depth=1
	slti	$a0, $a0, -1
	slli.d	$a1, $s3, 2
	masknez	$a1, $a1, $a0
	addi.w	$a2, $zero, -1
...
# %bb.75:                               # %.noexc443
	...
	ori	$a0, $zero, 1
	blt	$s0, $a0, .LBB6_81
# %bb.76:                               # %._crit_edge.thread.i.i441
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
# %bb.79:                               # %.noexc419
	...
	ori	$a0, $zero, 1
	blt	$s0, $a0, .LBB6_90
# %bb.80:                               # %._crit_edge.thread.i.i417
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_81:                               #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $zero
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
.LBB6_82:                               #   in Loop: Header=BB6_22 Depth=1
	st.d	$s1, $a1, 24
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s1, $a0
	st.w	$s3, $a1, 36
	move	$s2, $s1
	move	$s3, $a1
.LBB6_83:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i436
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_84:                               #   Parent Loop BB6_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s2, $a1
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB6_84
# %bb.85:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i440
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.w	$a1, $sp, 112
	st.w	$a1, $s3, 32
	beqz	$a0, .LBB6_87
.LBB6_86:                               #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_87:                               # %_ZN11CStringBaseIwED2Ev.exit423
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$s6, $zero
	move	$s1, $zero
.LBB6_88:                               # %.thread524
...
.LBB6_90:                               #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $zero
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
.LBB6_91:                               #   in Loop: Header=BB6_22 Depth=1
	st.d	$s1, $a1, 24
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s1, $a0
	st.w	$s3, $a1, 36
	move	$s2, $s1
	move	$s3, $a1
.LBB6_92:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i413
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_93:                               #   Parent Loop BB6_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s2, $a1
	addi.d	$a1, $a1, 4
...
# %bb.94:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
	...
	st.w	$a1, $s3, 32
	beqz	$a0, .LBB6_96
.LBB6_95:                               #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_96:                               # %_ZN11CStringBaseIwED2Ev.exit421
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 360
	beqz	$a0, .LBB6_98
# %bb.97:                               #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_98:                               # %_ZN11CStringBaseIwED2Ev.exit422
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_86
	b	.LBB6_87
.LBB6_99:                               # %.preheader581
...
# %bb.100:                              # %.lr.ph
	...
	move	$s5, $zero
	.p2align	4, , 16
.LBB6_101:                              # =>This Loop Header: Depth=1
...
# %bb.105:                              #   in Loop: Header=BB6_103 Depth=2
	...
	addi.d	$s3, $s3, 8
	blt	$s8, $a0, .LBB6_103
.LBB6_106:                              # %_ZNK10CArcInfoEx13FindExtensionERK11CStringBaseIwE.exit.thread
                                        #   in Loop: Header=BB6_101 Depth=1
.Ltmp65:                                # EH_LABEL
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector18ReserveOnePositionEv)
	jirl	$ra, $ra, 0
.Ltmp66:                                # EH_LABEL
# %bb.107:                              # %_ZN13CRecordVectorIiE3AddEi.exit330
                                        #   in Loop: Header=BB6_101 Depth=1
	ld.w	$a0, $sp, 436
	ld.d	$a1, $sp, 440
	slli.d	$a0, $a0, 2
	...
	b	.LBB6_110
	.p2align	4, , 16
.LBB6_108:                              # %_ZNK10CArcInfoEx13FindExtensionERK11CStringBaseIwE.exit
                                        #   in Loop: Header=BB6_101 Depth=1
.Ltmp67:                                # EH_LABEL
	addi.d	$a0, $sp, 424
	move	$a1, $s5
...
.LBB6_134:
	move	$s1, $zero
.LBB6_135:                              # %_ZN7CBufferIhED2Ev.exit340
	move	$a0, $s8
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 392
...
# %bb.140:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_141:                              # %_ZN11CStringBaseIwED2Ev.exit367
.Ltmp123:                               # EH_LABEL
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
...
# %bb.144:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_145:                              # %_ZN11CStringBaseIwED2Ev.exit375
	ld.w	$a0, $sp, 436
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB6_19
# %bb.146:                              # %iter.check
...
.LBB6_148:
	lu12i.w	$a0, -524284
	ori	$s8, $a0, 1
.LBB6_149:                              # %_ZN11CStringBaseIwED2Ev.exit450
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
# %bb.150:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_151:                              # %_ZN11CStringBaseIwED2Ev.exit451
	addi.w	$a0, $s8, 0
...
.Ltmp88:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp89:                                # EH_LABEL
# %bb.167:                              # %_ZNK11CStringBaseIwE13CompareNoCaseEPKw.exit357
...
# %bb.170:
	...
	move	$a4, $a7
	b	.LBB6_184
.LBB6_171:                              # %_ZN7CBufferIhED2Ev.exit360.thread743
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$s6, $zero
...
# %bb.176:                              # %.lr.ph614
	...
	move	$a0, $s6
	b	.LBB6_178
.LBB6_177:                              #   in Loop: Header=BB6_178 Depth=1
	addi.d	$a2, $a2, 1
	addi.d	$a1, $a1, 4
	bge	$a2, $a0, .LBB6_194
.LBB6_178:                              # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $sp, 440
	ldx.w	$a5, $a5, $a1
	ld.d	$a6, $s4, 32
	slli.d	$a5, $a5, 3
...
# %bb.186:                              # %vec.epilog.middle.block
	...
	or	$a4, $a3, $a4
	beq	$a2, $a0, .LBB6_189
.LBB6_187:                              # %vec.epilog.scalar.ph.preheader
	alsl.d	$a1, $a2, $a1, 2
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB6_188:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a1, 0
	xor	$a5, $a3, $s5
	sltui	$a5, $a5, 1
	...
	addi.d	$a1, $a1, 4
	bnez	$a0, .LBB6_188
.LBB6_189:                              # %._crit_edge626
	addi.w	$a0, $a4, 0
	bltz	$a0, .LBB6_19
# %bb.190:                              # %._crit_edge626
	addi.w	$a1, $a7, 0
	bge	$a0, $a1, .LBB6_19
# %bb.191:
	ld.d	$a2, $sp, 440
...
.LBB6_193:                              # %.thread487
	...
	ori	$s0, $zero, 1
	b	.LBB6_218
.LBB6_194:                              # %._crit_edge615
	ld.d	$a1, $sp, 384
	addi.d	$a1, $a1, -1
	st.d	$a1, $sp, 384
	beqz	$a1, .LBB6_210
# %bb.195:                              # %.preheader.lr.ph
	...
	st.d	$s2, $sp, 24                    # 8-byte Folded Spill
	b	.LBB6_197
.LBB6_196:                              #   in Loop: Header=BB6_197 Depth=1
	ld.d	$a1, $sp, 384
	...
	bgeu	$a0, $a1, .LBB6_209
	.p2align	4, , 16
.LBB6_197:                              # =>This Loop Header: Depth=1
...
.LBB6_199:                              # %.critedge
	...
	beq	$a1, $s7, .LBB6_209
# %bb.200:                              #   in Loop: Header=BB6_197 Depth=1
	bstrpick.d	$a0, $s6, 31, 0
	st.d	$a0, $sp, 40                    # 8-byte Folded Spill
	ldx.bu	$a0, $s8, $a0
	ldx.bu	$a1, $s8, $s7
	...
	b	.LBB6_202
	.p2align	4, , 16
.LBB6_201:                              # %_ZL13TestSignaturePKhS0_m.exit
	...
	ori	$a0, $zero, 255
	beq	$s5, $a0, .LBB6_196
.LBB6_202:                              #   Parent Loop BB6_197 Depth=1
...
# %bb.206:                              #   in Loop: Header=BB6_205 Depth=3
	...
	addi.d	$a2, $a2, 1
	bnez	$a0, .LBB6_205
# %bb.207:                              #   in Loop: Header=BB6_202 Depth=2
.Ltmp108:                               # EH_LABEL
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector18ReserveOnePositionEv)
	jirl	$ra, $ra, 0
.Ltmp109:                               # EH_LABEL
# %bb.208:                              #   in Loop: Header=BB6_202 Depth=2
	ld.w	$a0, $sp, 404
	ld.d	$a1, $sp, 408
	slli.d	$a0, $a0, 2
	stx.w	$s8, $a1, $a0
	...
	bne	$s5, $a0, .LBB6_202
	b	.LBB6_196
.LBB6_209:                              # %.critedge._crit_edge.loopexit
	ld.w	$a0, $sp, 436
	ld.d	$s7, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 8                     # 8-byte Folded Reload
.LBB6_210:                              # %.critedge._crit_edge
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB6_216
# %bb.211:                              # %.lr.ph620
	move	$s1, $zero
	...
	ori	$s5, $zero, 255
	b	.LBB6_213
.LBB6_212:                              #   in Loop: Header=BB6_213 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s1, $s1, 4
	bge	$s2, $a0, .LBB6_216
.LBB6_213:                              # =>This Inner Loop Header: Depth=1
	...
	ldx.w	$s0, $a1, $s1
	beq	$s0, $s5, .LBB6_212
# %bb.214:                              #   in Loop: Header=BB6_213 Depth=1
.Ltmp111:                               # EH_LABEL
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector18ReserveOnePositionEv)
	jirl	$ra, $ra, 0
.Ltmp112:                               # EH_LABEL
# %bb.215:                              # %_ZN13CRecordVectorIiE3AddEi.exit339
...
# %bb.222:                              # %.thread498
	ld.d	$a0, $sp, 440
	st.w	$s1, $a0, 0
.LBB6_223:                              # %_ZN7CBufferIhED2Ev.exit360
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
...
.Ltmp189:                               # EH_LABEL
	...
	move	$s1, $a0
	bnez	$a1, .LBB6_250
# %bb.248:                              # %_ZN11CStringBaseIwED2Ev.exit424
	ld.d	$a0, $sp, 360
	bnez	$a0, .LBB6_261
.LBB6_249:                              # %_ZN11CStringBaseIwED2Ev.exit425
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_263
	b	.LBB6_281
.LBB6_250:
...
.LBB6_255:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_256:                              # %_ZN7CBufferIhED2Ev.exit342
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB6_286
...
# %bb.258:
	...
	jirl	$ra, $ra, 0
	b	.LBB6_281
.LBB6_259:                              # %.loopexit.split-lp577.loopexit.split-lp
.Ltmp78:                                # EH_LABEL
	b	.LBB6_285
.LBB6_260:
.Ltmp186:                               # EH_LABEL
...
.Ltmp168:                               # EH_LABEL
	b	.LBB6_280
.LBB6_278:                              # %.loopexit.split-lp577.loopexit
.Ltmp69:                                # EH_LABEL
	b	.LBB6_285
.LBB6_279:
.Ltmp171:                               # EH_LABEL
...
.Ltmp139:                               # EH_LABEL
	b	.LBB6_285
.LBB6_284:                              # %.loopexit576
.Ltmp64:                                # EH_LABEL
.LBB6_285:                              # %_ZN7CBufferIhED2Ev.exit361
	move	$s1, $a0
.LBB6_286:                              # %_ZN7CBufferIhED2Ev.exit361
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB6_287:
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_288:                              # %_ZN11CStringBaseIwED2Ev.exit452
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB6_290
# %bb.289:
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_290:                              # %_ZN11CStringBaseIwED2Ev.exit453
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end6:
