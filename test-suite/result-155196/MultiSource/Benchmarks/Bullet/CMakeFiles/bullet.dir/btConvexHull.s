...
# %bb.30:                               # %iter.check608
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB28_42
# %bb.31:                               # %vector.main.loop.iter.check610
                                        #   in Loop: Header=BB28_24 Depth=1
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB28_35
...
.LBB28_36:                              # %vector.body614
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB28_36
# %bb.37:                               # %middle.block619
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$a2, $a1, .LBB28_44
# %bb.38:                               # %vec.epilog.iter.check624
                                        #   in Loop: Header=BB28_24 Depth=1
	andi	$a3, $a1, 12
	beqz	$a3, .LBB28_42
.LBB28_39:                              # %vec.epilog.ph623
                                        #   in Loop: Header=BB28_24 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	...
	alsl.d	$a5, $a5, $s2, 2
	.p2align	4, , 16
.LBB28_40:                              # %vec.epilog.vector.body629
                                        #   Parent Loop BB28_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB28_40
# %bb.41:                               # %vec.epilog.middle.block633
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$a2, $a1, .LBB28_44
.LBB28_42:                              # %vec.epilog.scalar.ph622.preheader
                                        #   in Loop: Header=BB28_24 Depth=1
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s2, 2
	.p2align	4, , 16
.LBB28_43:                              # %vec.epilog.scalar.ph622
                                        #   Parent Loop BB28_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
...
# %bb.53:                               # %iter.check575
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB28_65
# %bb.54:                               # %vector.main.loop.iter.check577
                                        #   in Loop: Header=BB28_24 Depth=1
	ori	$a0, $zero, 16
	bgeu	$s8, $a0, .LBB28_58
...
.LBB28_59:                              # %vector.body581
	...
	addi.d	$a3, $a3, 64
	bnez	$a1, .LBB28_59
# %bb.60:                               # %middle.block586
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$s8, $a0, .LBB28_67
# %bb.61:                               # %vec.epilog.iter.check591
                                        #   in Loop: Header=BB28_24 Depth=1
	andi	$a1, $s8, 12
	beqz	$a1, .LBB28_65
.LBB28_62:                              # %vec.epilog.ph590
                                        #   in Loop: Header=BB28_24 Depth=1
	move	$a1, $s8
	...
	slli.d	$a0, $a4, 2
	.p2align	4, , 16
.LBB28_63:                              # %vec.epilog.vector.body596
                                        #   Parent Loop BB28_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB28_63
# %bb.64:                               # %vec.epilog.middle.block600
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$s8, $a0, .LBB28_67
...
# %bb.11:                               # %iter.check178
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB29_24
# %bb.12:                               # %vector.main.loop.iter.check180
                                        #   in Loop: Header=BB29_4 Depth=1
	ori	$a0, $zero, 16
	bgeu	$s5, $a0, .LBB29_17
...
.LBB29_18:                              # %vector.body184
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB29_18
# %bb.19:                               # %middle.block189
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$a0, $s5, .LBB29_26
# %bb.20:                               # %vec.epilog.iter.check194
                                        #   in Loop: Header=BB29_4 Depth=1
	andi	$a1, $s5, 12
	beqz	$a1, .LBB29_24
.LBB29_21:                              # %vec.epilog.ph193
                                        #   in Loop: Header=BB29_4 Depth=1
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s2, 2
	.p2align	4, , 16
.LBB29_22:                              # %vec.epilog.vector.body199
                                        #   Parent Loop BB29_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB29_22
# %bb.23:                               # %vec.epilog.middle.block203
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$a0, $s5, .LBB29_26
...
# %bb.35:                               # %iter.check144
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB29_45
# %bb.36:                               # %vector.main.loop.iter.check146
                                        #   in Loop: Header=BB29_4 Depth=1
	ori	$a0, $zero, 15
	bgeu	$s5, $a0, .LBB29_38
...
.LBB29_42:                              # %vec.epilog.ph159
	...
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB29_43:                              # %vec.epilog.vector.body165
                                        #   Parent Loop BB29_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB29_43
# %bb.44:                               # %vec.epilog.middle.block169
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$fp, $a0, .LBB29_47
...
# %bb.79:                               # %iter.check211
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB29_93
# %bb.80:                               # %vector.main.loop.iter.check213
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB29_86
# %bb.81:
	move	$a2, $zero
...
.LBB29_87:                              # %vector.body217
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB29_87
# %bb.88:                               # %middle.block222
	beq	$a2, $a1, .LBB29_95
# %bb.89:                               # %vec.epilog.iter.check227
	andi	$a3, $a1, 12
	beqz	$a3, .LBB29_93
.LBB29_90:                              # %vec.epilog.ph226
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB29_91:                              # %vec.epilog.vector.body232
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB29_91
# %bb.92:                               # %vec.epilog.middle.block236
	beq	$a2, $a1, .LBB29_95
.LBB29_93:                              # %vec.epilog.scalar.ph225.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB29_94:                              # %vec.epilog.scalar.ph225
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
...
.LBB29_99:                              # %.loopexit75
	...
	st.w	$s5, $fp, 4
	blt	$s5, $a0, .LBB29_113
# %bb.100:                              # %iter.check244
	ld.d	$a0, $fp, 16
	ori	$a2, $zero, 4
	move	$a1, $zero
	bltu	$s5, $a2, .LBB29_111
# %bb.101:                              # %iter.check244
	sub.d	$a2, $a0, $s2
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB29_111
# %bb.102:                              # %vector.main.loop.iter.check246
	ori	$a1, $zero, 16
	bgeu	$s5, $a1, .LBB29_104
# %bb.103:
	move	$a1, $zero
	b	.LBB29_108
.LBB29_104:                             # %vector.ph247
...
.LBB29_108:                             # %vec.epilog.ph259
	...
	alsl.d	$a4, $a4, $s2, 2
	.p2align	4, , 16
.LBB29_109:                             # %vec.epilog.vector.body265
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB29_109
# %bb.110:                              # %vec.epilog.middle.block269
	beq	$a1, $s5, .LBB29_113
.LBB29_111:                             # %vec.epilog.scalar.ph258.preheader
	alsl.d	$a0, $a1, $a0, 2
	alsl.d	$a2, $a1, $s2, 2
	sub.d	$a1, $s5, $a1
	.p2align	4, , 16
.LBB29_112:                             # %vec.epilog.scalar.ph258
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	st.w	$a3, $a0, 0
	addi.d	$a0, $a0, 4
...
# %bb.41:                               # %iter.check334
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB32_76
# %bb.42:                               # %vector.main.loop.iter.check336
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB32_69
# %bb.43:
	move	$a2, $zero
...
# %bb.68:                               # %_ZNK20btAlignedObjectArrayIjE4copyEiiPj.exit.i.i
	...
	bnez	$a1, .LBB32_98
	b	.LBB32_99
.LBB32_69:                              # %vector.ph337
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	addi.d	$a3, $a0, 32
	addi.d	$a4, $s4, 32
	move	$a5, $a2
.LBB32_70:                              # %vector.body340
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a3, -32
	xvld	$xr1, $a3, 0
	xvst	$xr0, $a4, -32
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB32_70
# %bb.71:                               # %middle.block345
	beq	$a2, $a1, .LBB32_78
# %bb.72:                               # %vec.epilog.iter.check350
	andi	$a3, $a1, 12
	beqz	$a3, .LBB32_76
.LBB32_73:                              # %vec.epilog.ph349
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s4, 2
	.p2align	4, , 16
.LBB32_74:                              # %vec.epilog.vector.body355
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB32_74
# %bb.75:                               # %vec.epilog.middle.block359
	beq	$a2, $a1, .LBB32_78
.LBB32_76:                              # %vec.epilog.scalar.ph348.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s4, 2
	.p2align	4, , 16
.LBB32_77:                              # %vec.epilog.scalar.ph348
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
