...
# %bb.85:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_86:                               # %_ZNSt6vectorIdSaIdEED2Ev.exit230
	beqz	$s3, .LBB4_88
# %bb.87:
	sub.d	$a1, $s7, $s3
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_88:                               # %_ZNSt6vectorIdSaIdEED2Ev.exit232
	beqz	$s2, .LBB4_90
# %bb.89:
	sub.d	$a1, $s0, $s2
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_90:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit234
	beqz	$s1, .LBB4_92
# %bb.91:
	sub.d	$a1, $s8, $s1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_92:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit236
	ld.d	$a0, $sp, 80
	beqz	$a0, .LBB4_94
# %bb.93:
	ld.d	$a1, $sp, 96
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_94:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit238
...
# %bb.98:
	move	$a1, $zero
.LBB4_99:                               # %scalar.ph983.preheader
	addi.w	$a2, $a1, 1
	.p2align	4, , 16
.LBB4_100:                              # %scalar.ph983
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a1, $a1, 2
	ldx.w	$a3, $s1, $a1
	stx.w	$a3, $a0, $a1
...
# %bb.102:                              # %.noexc192
	...
	st.w	$zero, $s6, 0
	beq	$s0, $a0, .LBB4_139
# %bb.103:                              # %.lr.ph.i.preheader.i.i.i.i.i
	addi.d	$a0, $s6, 4
	addi.d	$a2, $s1, -4
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
...
.LBB4_104:                              # %vector.scevcheck1057
	...
	move	$a2, $zero
	beq	$a4, $a5, .LBB4_10
# %bb.105:                              # %vector.scevcheck1057
	srli.d	$a3, $a3, 32
	bnez	$a3, .LBB4_10
# %bb.106:                              # %vector.ph1060
...
.LBB4_107:                              # %vector.body1063
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB4_107
# %bb.108:                              # %middle.block1066
	bne	$a0, $a2, .LBB4_10
	b	.LBB4_12
.LBB4_109:                              # %vector.scevcheck935
	addi.d	$a5, $s6, -1
	...
	move	$a4, $zero
	beq	$a6, $a7, .LBB4_69
# %bb.110:                              # %vector.scevcheck935
	srli.d	$a5, $a5, 32
	bnez	$a5, .LBB4_69
# %bb.111:                              # %vector.memcheck936
	sub.d	$a6, $s4, $s3
	ori	$a5, $zero, 16
	move	$a4, $zero
	bltu	$a6, $a5, .LBB4_69
# %bb.112:                              # %vector.memcheck936
	sub.d	$a6, $s3, $a0
	bltu	$a6, $a5, .LBB4_69
# %bb.113:                              # %vector.memcheck936
	sub.d	$a6, $s3, $a1
	ori	$a5, $zero, 16
	bltu	$a6, $a5, .LBB4_69
# %bb.114:                              # %vector.memcheck936
	sub.d	$a6, $a2, $s3
	bltu	$a6, $a5, .LBB4_69
# %bb.115:                              # %vector.memcheck936
	sub.d	$a6, $a3, $s3
	ori	$a5, $zero, 16
	bltu	$a6, $a5, .LBB4_69
# %bb.116:                              # %vector.memcheck936
	sub.d	$a6, $s4, $a0
	bltu	$a6, $a5, .LBB4_69
# %bb.117:                              # %vector.memcheck936
	sub.d	$a6, $s4, $a1
	ori	$a5, $zero, 16
	bltu	$a6, $a5, .LBB4_69
# %bb.118:                              # %vector.memcheck936
	sub.d	$a6, $s4, $a2
	bltu	$a6, $a5, .LBB4_69
# %bb.119:                              # %vector.memcheck936
	sub.d	$a5, $s4, $a3
	ori	$a6, $zero, 16
	bltu	$a5, $a6, .LBB4_69
# %bb.120:                              # %vector.ph958
...
# %bb.147:                              # %.noexc197
	...
	st.d	$zero, $a0, 0
	beq	$s0, $s7, .LBB4_149
# %bb.148:                              # %_ZNSt6vectorIdSaIdEEC2EmRKS0_.exit
	addi.d	$a1, $a0, 8
	addi.d	$a2, $s1, -8
	move	$s8, $a0
	move	$a0, $a1
	...
	addi.w	$a1, $s0, 0
	blt	$a1, $s7, .LBB4_185
.LBB4_149:                              # %.lr.ph525.preheader
	bstrpick.d	$a1, $s0, 30, 0
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a1, $a3, .LBB4_154
# %bb.150:                              # %.lr.ph525.preheader
	sub.d	$a3, $a0, $s2
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB4_154
# %bb.151:                              # %vector.ph1001
...
.LBB4_152:                              # %vector.body1004
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB4_152
# %bb.153:                              # %middle.block1009
	beq	$a1, $a2, .LBB4_156
.LBB4_154:                              # %.lr.ph525.preheader1084
	alsl.d	$a3, $a2, $s2, 3
	alsl.d	$a4, $a2, $a0, 3
	sub.d	$a2, $a1, $a2
	.p2align	4, , 16
...
.LBB4_161:                              # %vector.body1019
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_161
# %bb.162:                              # %middle.block1024
	beq	$a1, $a3, .LBB4_165
.LBB4_163:                              # %scalar.ph1014.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_164:                              # %scalar.ph1014
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_170:                              # %vector.body1034
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_170
# %bb.171:                              # %middle.block1039
	beq	$a1, $a3, .LBB4_174
.LBB4_172:                              # %scalar.ph1029.preheader
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a4, $a3, $a0, 3
	sub.d	$a3, $a1, $a3
	.p2align	4, , 16
.LBB4_173:                              # %scalar.ph1029
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a2, 0
	fst.d	$fa0, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB4_179:                              # %vector.body1049
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_179
# %bb.180:                              # %middle.block1054
	beq	$a1, $a4, .LBB4_183
.LBB4_181:                              # %scalar.ph1044.preheader
	alsl.d	$a1, $a4, $a3, 3
	alsl.d	$a3, $a4, $a0, 3
	sub.d	$a4, $a2, $a4
	.p2align	4, , 16
.LBB4_182:                              # %scalar.ph1044
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a1, 0
	fst.d	$fa0, $a3, 0
	addi.d	$a1, $a1, 8
...
.LBB4_184:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a3, $a3, 8
	bnez	$a2, .LBB4_184
.LBB4_185:                              # %.preheader477.thread
	move	$a1, $s1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	ld.d	$s7, $sp, 8                     # 8-byte Folded Reload
.LBB4_186:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit
	move	$s0, $zero
	move	$s2, $zero
	move	$s8, $zero
	move	$s1, $zero
...
.LBB4_235:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit224
	...
	move	$s5, $zero
	beqz	$s6, .LBB4_83
.LBB4_236:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit.sink.split
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $s6
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.Ltmp136:                               # EH_LABEL
	b	.LBB4_252
.LBB4_251:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit200.thread813
.Ltmp133:                               # EH_LABEL
.LBB4_252:                              # %.sink.split
	st.d	$s7, $sp, 8                     # 8-byte Folded Spill
	move	$fp, $a0
...
.Ltmp90:                                # EH_LABEL
	b	.LBB4_265
.LBB4_262:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit200
.Ltmp158:                               # EH_LABEL
	st.d	$s7, $sp, 8                     # 8-byte Folded Spill
...
.LBB4_264:
.Ltmp93:                                # EH_LABEL
.LBB4_265:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit240.thread
	move	$fp, $a0
	move	$s0, $zero
	move	$s2, $zero
	st.d	$zero, $sp, 16                  # 8-byte Folded Spill
	move	$s1, $zero
	b	.LBB4_270
.LBB4_266:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit200.thread802
.Ltmp155:                               # EH_LABEL
	st.d	$s8, $sp, 8                     # 8-byte Folded Spill
	st.d	$s7, $sp, 16                    # 8-byte Folded Spill
	move	$fp, $a0
.LBB4_267:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit240
	beqz	$s3, .LBB4_270
# %bb.268:
...
.LBB4_269:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit242
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_270:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit242
	bnez	$s2, .LBB4_274
# %bb.271:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit244
	bnez	$s1, .LBB4_275
.LBB4_272:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit246
	ld.d	$a0, $sp, 80
	bnez	$a0, .LBB4_276
.LBB4_273:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit248
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB4_274:
