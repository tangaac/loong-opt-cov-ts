...
# %bb.25:                               # %middle.block88
	beq	$a5, $a2, .LBB4_20
# %bb.26:                               # %vec.epilog.iter.check93
	andi	$a6, $a2, 12
	beqz	$a6, .LBB4_18
.LBB4_27:                               # %vec.epilog.ph92
	move	$t0, $a5
	...
	vrepli.w	$vr3, 255
	.p2align	4, , 16
.LBB4_28:                               # %vec.epilog.vector.body102
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr4, $t0, 0
	vsub.w	$vr4, $vr4, $vr0
	vmul.w	$vr4, $vr4, $vr3
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB4_28
# %bb.29:                               # %vec.epilog.middle.block106
	beq	$a5, $a2, .LBB4_20
	b	.LBB4_18
.Lfunc_end4:
...
# %bb.51:                               # %vector.main.loop.iter.check344
...
# %bb.55:
	...
	move	$a2, $a0
	b	.LBB18_72
.LBB18_56:                              # %vector.main.loop.iter.check257
	ori	$a1, $zero, 16
	bgeu	$s3, $a1, .LBB18_65
# %bb.57:
	move	$a1, $zero
...
.LBB18_69:                              # %vec.epilog.ph280
	...
	alsl.d	$a2, $a3, $s4, 2
	.p2align	4, , 16
.LBB18_70:                              # %vec.epilog.vector.body290
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a2, 0
	vmax.w	$vr0, $vr2, $vr0
	vmin.w	$vr1, $vr2, $vr1
...
# %bb.75:
	move	$a2, $zero
	b	.LBB18_85
.LBB18_76:                              # %vector.main.loop.iter.check305
	ori	$a2, $zero, 16
	bgeu	$s3, $a2, .LBB18_78
# %bb.77:
	move	$a2, $zero
	b	.LBB18_82
.LBB18_78:                              # %vector.ph306
	move	$a3, $zero
...
.LBB18_79:                              # %vector.body313
	...
	addi.d	$a4, $a4, 64
	bne	$a2, $a3, .LBB18_79
# %bb.80:                               # %middle.block318
	beq	$a2, $s3, .LBB18_201
# %bb.81:                               # %vec.epilog.iter.check323
	andi	$a3, $s3, 12
	beqz	$a3, .LBB18_85
.LBB18_82:                              # %vec.epilog.ph322
	...
	vrepli.w	$vr3, 255
	.p2align	4, , 16
.LBB18_83:                              # %vec.epilog.vector.body332
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr4, $a4, 0
	vsub.w	$vr4, $vr4, $vr0
	vmul.w	$vr4, $vr4, $vr3
	...
	addi.d	$a4, $a4, 16
	bne	$a2, $a3, .LBB18_83
# %bb.84:                               # %vec.epilog.middle.block336
	beq	$a2, $s3, .LBB18_201
...
# %bb.109:                              # %middle.block232
	beq	$a2, $s5, .LBB18_201
# %bb.110:                              # %vec.epilog.iter.check237
	andi	$a3, $s5, 12
	beqz	$a3, .LBB18_100
.LBB18_111:                             # %vec.epilog.ph236
	move	$a3, $a2
	...
	vrepli.w	$vr3, 255
	.p2align	4, , 16
.LBB18_112:                             # %vec.epilog.vector.body246
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr4, $a4, 0
	vsub.w	$vr4, $vr4, $vr0
	vmul.w	$vr4, $vr4, $vr3
	...
	addi.d	$a4, $a4, 16
	bne	$a2, $a3, .LBB18_112
# %bb.113:                              # %vec.epilog.middle.block250
	beq	$a2, $s5, .LBB18_201
	b	.LBB18_100
.LBB18_114:                             # %vector.ph345
	...
	b	.LBB18_116
	.p2align	4, , 16
.LBB18_115:                             # %pred.store.continue414
                                        #   in Loop: Header=BB18_116 Depth=1
	addi.d	$a4, $a4, -32
	addi.d	$a5, $a5, 32
	beqz	$a4, .LBB18_180
.LBB18_116:                             # %vector.body350
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.117:                              # %pred.store.if
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_121
.LBB18_118:                             # %pred.store.continue354
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_122
.LBB18_119:                             # %pred.store.if355
                                        #   in Loop: Header=BB18_116 Depth=1
...
.LBB18_121:                             # %pred.store.if353
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_119
.LBB18_122:                             # %pred.store.continue356
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_124
.LBB18_123:                             # %pred.store.if357
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 3
	stx.b	$zero, $s2, $a6
.LBB18_124:                             # %pred.store.continue358
                                        #   in Loop: Header=BB18_116 Depth=1
	xvsub.d	$xr9, $xr9, $xr0
...
# %bb.125:                              # %pred.store.if359
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_137
.LBB18_126:                             # %pred.store.continue362
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 6
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_138
.LBB18_127:                             # %pred.store.if363
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 2
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_139
.LBB18_128:                             # %pred.store.continue366
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 8
	andi	$a6, $a6, 1
	xvadd.d	$xr11, $xr9, $xr7
	beqz	$a6, .LBB18_140
.LBB18_129:                             # %pred.store.if367
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 0
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_141
.LBB18_130:                             # %pred.store.continue370
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 10
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_142
.LBB18_131:                             # %pred.store.if371
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 2
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_143
.LBB18_132:                             # %pred.store.continue374
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 12
	andi	$a6, $a6, 1
	xvadd.d	$xr11, $xr9, $xr6
	beqz	$a6, .LBB18_144
.LBB18_133:                             # %pred.store.if375
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 0
	stx.b	$zero, $s2, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_145
.LBB18_134:                             # %pred.store.continue378
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 14
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_146
.LBB18_135:                             # %pred.store.if379
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 2
	stx.b	$zero, $s2, $a6
	...
	b	.LBB18_148
	.p2align	4, , 16
.LBB18_136:                             # %pred.store.continue360
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_126
.LBB18_137:                             # %pred.store.if361
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 6
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_127
.LBB18_138:                             # %pred.store.continue364
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 7
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_128
.LBB18_139:                             # %pred.store.if365
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 3
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 8
	...
	xvadd.d	$xr11, $xr9, $xr7
	bnez	$a6, .LBB18_129
.LBB18_140:                             # %pred.store.continue368
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 9
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_130
.LBB18_141:                             # %pred.store.if369
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 10
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_131
.LBB18_142:                             # %pred.store.continue372
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 11
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_132
.LBB18_143:                             # %pred.store.if373
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 3
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 12
	...
	xvadd.d	$xr11, $xr9, $xr6
	bnez	$a6, .LBB18_133
.LBB18_144:                             # %pred.store.continue376
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 13
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_134
.LBB18_145:                             # %pred.store.if377
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 14
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_135
.LBB18_146:                             # %pred.store.continue380
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 15
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_148
.LBB18_147:                             # %pred.store.if381
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 3
	stx.b	$zero, $s2, $a6
.LBB18_148:                             # %pred.store.continue382
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpermi.d	$xr10, $xr10, 14
	vpickve2gr.b	$a6, $vr10, 0
	andi	$a6, $a6, 1
...
# %bb.149:                              # %pred.store.if383
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_165
.LBB18_150:                             # %pred.store.continue386
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_166
.LBB18_151:                             # %pred.store.if387
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 2
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_167
.LBB18_152:                             # %pred.store.continue390
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 4
	andi	$a6, $a6, 1
	xvadd.d	$xr11, $xr9, $xr4
	beqz	$a6, .LBB18_168
.LBB18_153:                             # %pred.store.if391
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 0
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 5
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_169
.LBB18_154:                             # %pred.store.continue394
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 6
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_170
.LBB18_155:                             # %pred.store.if395
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 2
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 7
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_171
.LBB18_156:                             # %pred.store.continue398
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 8
	andi	$a6, $a6, 1
	xvadd.d	$xr11, $xr9, $xr3
	beqz	$a6, .LBB18_172
.LBB18_157:                             # %pred.store.if399
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 0
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 9
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_173
.LBB18_158:                             # %pred.store.continue402
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 10
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_174
.LBB18_159:                             # %pred.store.if403
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 2
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 11
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_175
.LBB18_160:                             # %pred.store.continue406
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 12
	andi	$a6, $a6, 1
	xvadd.d	$xr9, $xr9, $xr2
	beqz	$a6, .LBB18_176
.LBB18_161:                             # %pred.store.if407
                                        #   in Loop: Header=BB18_116 Depth=1
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_177
.LBB18_162:                             # %pred.store.continue410
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 14
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_178
.LBB18_163:                             # %pred.store.if411
                                        #   in Loop: Header=BB18_116 Depth=1
	...
	b	.LBB18_179
	.p2align	4, , 16
.LBB18_164:                             # %pred.store.continue384
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 1
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_150
.LBB18_165:                             # %pred.store.if385
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_151
.LBB18_166:                             # %pred.store.continue388
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_152
.LBB18_167:                             # %pred.store.if389
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 3
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 4
...
.LBB18_171:                             # %pred.store.if397
	...
	xvadd.d	$xr11, $xr9, $xr3
	bnez	$a6, .LBB18_157
.LBB18_172:                             # %pred.store.continue400
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 9
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_158
.LBB18_173:                             # %pred.store.if401
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 1
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 10
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_159
.LBB18_174:                             # %pred.store.continue404
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 11
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_160
.LBB18_175:                             # %pred.store.if405
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr11, 3
	stx.b	$zero, $s2, $a6
	vpickve2gr.b	$a6, $vr10, 12
	...
	xvadd.d	$xr9, $xr9, $xr2
	bnez	$a6, .LBB18_161
.LBB18_176:                             # %pred.store.continue408
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 13
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_162
.LBB18_177:                             # %pred.store.if409
                                        #   in Loop: Header=BB18_116 Depth=1
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB18_163
.LBB18_178:                             # %pred.store.continue412
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a6, $vr10, 15
	andi	$a6, $a6, 1
	beqz	$a6, .LBB18_115
.LBB18_179:                             # %pred.store.if413
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a6, $xr9, 3
	stx.b	$zero, $s2, $a6
	b	.LBB18_115
.LBB18_180:                             # %middle.block416
	beq	$a3, $s5, .LBB18_201
# %bb.181:                              # %vec.epilog.iter.check422
	andi	$a4, $s5, 24
	beqz	$a4, .LBB18_202
.LBB18_182:                             # %vec.epilog.ph421
	...
	b	.LBB18_184
	.p2align	4, , 16
.LBB18_183:                             # %pred.store.continue449
                                        #   in Loop: Header=BB18_184 Depth=1
	addi.d	$a3, $a3, 8
	addi.d	$a0, $a0, 8
	beqz	$a3, .LBB18_200
.LBB18_184:                             # %vec.epilog.vector.body429
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.185:                              # %pred.store.if434
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_189
.LBB18_186:                             # %pred.store.continue437
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 2
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_190
.LBB18_187:                             # %pred.store.if438
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	b	.LBB18_192
	.p2align	4, , 16
.LBB18_188:                             # %pred.store.continue435
                                        #   in Loop: Header=BB18_184 Depth=1
	vilvl.b	$vr3, $vr3, $vr3
	vpickve2gr.h	$a4, $vr3, 1
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_186
.LBB18_189:                             # %pred.store.if436
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_187
.LBB18_190:                             # %pred.store.continue439
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_192
.LBB18_191:                             # %pred.store.if440
                                        #   in Loop: Header=BB18_184 Depth=1
	xvpickve2gr.d	$a4, $xr5, 3
	stx.b	$zero, $s2, $a4
.LBB18_192:                             # %pred.store.continue441
                                        #   in Loop: Header=BB18_184 Depth=1
	xvsub.d	$xr4, $xr4, $xr0
...
# %bb.193:                              # %pred.store.if442
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_197
.LBB18_194:                             # %pred.store.continue445
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 6
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_198
.LBB18_195:                             # %pred.store.if446
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	b	.LBB18_199
	.p2align	4, , 16
.LBB18_196:                             # %pred.store.continue443
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 5
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_194
.LBB18_197:                             # %pred.store.if444
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_195
.LBB18_198:                             # %pred.store.continue447
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 7
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_183
.LBB18_199:                             # %pred.store.if448
                                        #   in Loop: Header=BB18_184 Depth=1
	xvpickve2gr.d	$a4, $xr4, 3
	stx.b	$zero, $s2, $a4
	b	.LBB18_183
.LBB18_200:                             # %vec.epilog.middle.block452
	bne	$a2, $s5, .LBB18_203
...
.LBB18_202:
	add.d	$a1, $s4, $a3
	move	$a2, $a3
.LBB18_203:                             # %vec.epilog.scalar.ph420.preheader
	sub.d	$a0, $a1, $s4
	sub.d	$a2, $s5, $a2
	ori	$a3, $zero, 7
	b	.LBB18_205
...
.LBB18_204:                             #   in Loop: Header=BB18_205 Depth=1
	...
	addi.d	$a0, $a0, 1
	beqz	$a2, .LBB18_201
.LBB18_205:                             # %vec.epilog.scalar.ph420
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a4, $a1, 0
