...
# %bb.0:
	...
	addi.d	$s2, $a0, %pc_lo12(L3psycho_anal.w2_s)
	...
	pcalau12i	$s7, %pc_hi20(L3psycho_anal.npart_s)
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.s3ind_s)
	addi.d	$s3, $a0, %pc_lo12(L3psycho_anal.s3ind_s)
...
.LBB0_9:                                # %vector.ph
	...
	addi.d	$s4, $a2, %pc_lo12(L3psycho_anal.s3_s)
...
# %bb.13:
	...
	addi.w	$a0, $a7, 1
	st.w	$a0, $s7, %pc_lo12(L3psycho_anal.npart_s)
	blt	$t0, $t1, .LBB0_16
# %bb.14:
	bge	$a7, $a5, .LBB0_17
.LBB0_15:
...
.LBB0_16:
	...
	blt	$a7, $a5, .LBB0_15
.LBB0_17:
	st.w	$a5, $s7, %pc_lo12(L3psycho_anal.npart_s)
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	st.w	$a3, $a0, 44
...
.LBB0_54:                               # %.lr.ph1011
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s7, %pc_lo12(L3psycho_anal.npart_s)
	fst.d	$fa0, $s0, 0
	addi.d	$fp, $fp, 1
	addi.d	$s0, $s0, 8
	blt	$fp, $a0, .LBB0_54
...
# %bb.69:                               # %.lr.ph1133
	...
	addi.d	$s4, $a0, %pc_lo12(L3psycho_anal.numlines_s)
	...
	addi.d	$a4, $a0, %pc_lo12(L3psycho_anal.wsamp_L)
	pcalau12i	$a0, %pc_hi20(L3psycho_anal.wsamp_S)
	addi.d	$a5, $a0, %pc_lo12(L3psycho_anal.wsamp_S)
	lu12i.w	$a0, 258048
	vreplgr2vr.w	$vr7, $a0
	movgr2fr.w	$fa0, $zero
	lu12i.w	$a0, -1
...
.LBB0_82:                               # %.loopexit960
	...
	addi.d	$t3, $a5, %pc_lo12(L3psycho_anal.energy)
	fst.s	$fa0, $t3, 0
	addi.d	$a5, $sp, 576
	alsl.d	$a5, $t1, $a5, 2
	ori	$a6, $zero, 4092
...
.LBB0_106:                              # %call.sqrt1991
	...
	fst.s	$ft0, $sp, 432                  # 4-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrtf)
	jirl	$ra, $ra, 0
	fld.s	$ft0, $sp, 432                  # 4-byte Folded Reload
...
# %bb.114:                              # %call.sqrt1992
	...
	vst	$vr8, $sp, 432                  # 16-byte Folded Spill
	pcaddu18i	$ra, %call36(sqrtf)
	jirl	$ra, $ra, 0
...
.LBB0_124:                              # %.preheader955
	...
	addi.d	$s5, $a0, %pc_lo12(L3psycho_anal.eb)
...
.LBB0_140:                              # %._crit_edge1069
	...
	addi.d	$s0, $a1, %pc_lo12(L3psycho_anal.thr)
	blt	$a0, $s8, .LBB0_155
# %bb.141:                              # %.lr.ph1081
                                        #   in Loop: Header=BB0_71 Depth=1
