...
# %bb.10:
	...
	move	$a4, $zero
	b	.LBB8_17
.LBB8_11:                               # %vector.main.loop.iter.check312
...
.LBB8_27:
	move	$t3, $zero
	b	.LBB8_103
.LBB8_28:                               # %vector.main.loop.iter.check187
	ori	$a6, $zero, 16
	bgeu	$t0, $a6, .LBB8_30
# %bb.29:
	move	$t2, $zero
...
.LBB8_34:                               # %vec.epilog.ph204
	...
	alsl.d	$t1, $t1, $a0, 2
	.p2align	4, , 16
.LBB8_35:                               # %vec.epilog.vector.body212
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t1, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$a6, $a6, 4
...
.LBB8_41:                               # %vec.epilog.ph327
	...
	addi.d	$t3, $t3, 132
	.p2align	4, , 16
.LBB8_42:                               # %vec.epilog.vector.body335
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $t3, -44
	ld.w	$t5, $t3, -32
	ld.w	$t6, $t3, -20
...
# %bb.51:
	...
	move	$t5, $a5
	b	.LBB8_120
.LBB8_52:                               # %vector.main.loop.iter.check388
...
# %bb.53:
	...
	move	$t1, $zero
	b	.LBB8_60
.LBB8_54:                               # %vector.main.loop.iter.check349
...
.LBB8_60:                               # %vec.epilog.ph403
	...
	addi.d	$t5, $t5, 132
	.p2align	4, , 16
.LBB8_61:                               # %vec.epilog.vector.body411
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t8, $t5, -44
	ld.w	$fp, $t5, -32
	ld.w	$s0, $t5, -20
...
.LBB8_67:                               # %vec.epilog.ph364
	...
	addi.d	$t3, $t3, 132
	.p2align	4, , 16
.LBB8_68:                               # %vec.epilog.vector.body372
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t6, $t3, -44
	ld.w	$t7, $t3, -32
	ld.w	$t8, $t3, -20
...
.LBB8_70:
	add.d	$t3, $t2, $t1
	move	$t4, $t2
.LBB8_71:                               # %vec.epilog.scalar.ph203.preheader
	alsl.d	$t1, $t3, $a0, 2
	sub.d	$t2, $t0, $t4
	.p2align	4, , 16
.LBB8_72:                               # %vec.epilog.scalar.ph203
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t3, $t1, 0
	slt	$t4, $a6, $t3
	masknez	$a6, $a6, $t4
...
# %bb.75:
	...
	move	$t4, $a5
	b	.LBB8_86
.LBB8_76:                               # %vector.main.loop.iter.check228
	ori	$t1, $zero, 16
	bgeu	$t2, $t1, .LBB8_78
# %bb.77:
	move	$t3, $zero
...
.LBB8_82:                               # %vec.epilog.ph245
	...
	alsl.d	$t3, $t3, $a0, 2
	.p2align	4, , 16
.LBB8_83:                               # %vec.epilog.vector.body253
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t3, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t1, $t1, 4
...
.LBB8_85:
	add.d	$t4, $t3, $a5
	move	$t5, $t3
.LBB8_86:                               # %vec.epilog.scalar.ph244.preheader
	alsl.d	$t3, $t4, $a0, 2
	sub.d	$t4, $t2, $t5
	.p2align	4, , 16
.LBB8_87:                               # %vec.epilog.scalar.ph244
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $t3, 0
	slt	$t6, $t1, $t5
	masknez	$t1, $t1, $t6
...
# %bb.90:
	...
	move	$t2, $a5
	b	.LBB8_101
.LBB8_91:                               # %vector.main.loop.iter.check270
	ori	$t0, $zero, 16
	bgeu	$a7, $t0, .LBB8_93
# %bb.92:
	move	$t0, $zero
...
.LBB8_97:                               # %vec.epilog.ph287
	...
	alsl.d	$a5, $a5, $a0, 2
	.p2align	4, , 16
.LBB8_98:                               # %vec.epilog.vector.body295
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t3, $t3, 4
...
.LBB8_100:
	add.d	$t2, $t0, $a5
	move	$t4, $t0
.LBB8_101:                              # %vec.epilog.scalar.ph286.preheader
	alsl.d	$a0, $t2, $a0, 2
	sub.d	$a5, $a7, $t4
	.p2align	4, , 16
.LBB8_102:                              # %vec.epilog.scalar.ph286
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a7, $a0, 0
	slt	$t0, $t3, $a7
	masknez	$t2, $t3, $t0
...
# %bb.109:
	...
	move	$t6, $a5
	b	.LBB8_126
.LBB8_110:                              # %vector.main.loop.iter.check427
...
.LBB8_116:                              # %vec.epilog.ph442
	...
	addi.d	$a5, $a5, 132
	.p2align	4, , 16
.LBB8_117:                              # %vec.epilog.vector.body450
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $a5, -44
	ld.w	$t7, $a5, -32
	ld.w	$t8, $a5, -20
