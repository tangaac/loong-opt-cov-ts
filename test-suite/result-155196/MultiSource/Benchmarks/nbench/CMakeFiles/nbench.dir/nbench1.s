...
# %bb.63:                               #   in Loop: Header=BB15_25 Depth=2
	...
	bcnez	$fcc0, .LBB15_67
# %bb.64:                               #   in Loop: Header=BB15_25 Depth=2
	ori	$a1, $zero, 2528
	add.d	$a1, $sp, $a1
...
# %bb.77:                               # %middle.block111
	...
	sltu	$a1, $zero, $a1
	beq	$a0, $a2, .LBB15_80
.LBB15_78:                              # %.lr.ph.split.i.preheader221
                                        #   in Loop: Header=BB15_25 Depth=2
	sub.d	$a2, $a2, $a0
...
.LBB15_82:                              #   in Loop: Header=BB15_5 Depth=1
	...
	b	.LBB15_3
	.p2align	4, , 16
.LBB15_83:                              # %.lr.ph.split.us.i.preheader
                                        #   in Loop: Header=BB15_5 Depth=1
	fld.d	$fs1, $sp, 24                   # 8-byte Folded Reload
	ori	$a0, $zero, 8
	bgeu	$a2, $a0, .LBB15_86
...
# %bb.88:                               # %middle.block
	...
	sltu	$a1, $zero, $a1
	beq	$a0, $a2, .LBB15_91
.LBB15_89:                              # %.lr.ph.split.us.i.preheader222
                                        #   in Loop: Header=BB15_5 Depth=1
	sub.d	$a2, $a3, $a0
	pcalau12i	$a3, %pc_hi20(tot_out_error)
	addi.d	$a3, $a3, %pc_lo12(tot_out_error)
