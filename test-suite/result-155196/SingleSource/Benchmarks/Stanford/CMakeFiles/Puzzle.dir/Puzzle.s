...
# %bb.47:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_56
.LBB5_48:                               # %pred.store.continue40
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 2
	andi	$a4, $a4, 1
	vadd.d	$vr3, $vr0, $vr4
	bnez	$a4, .LBB5_57
.LBB5_49:                               # %pred.store.continue42
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_51
.LBB5_50:                               # %pred.store.if43
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.d	$a4, $vr3, 1
	slli.d	$a4, $a4, 2
	stx.w	$zero, $s2, $a4
.LBB5_51:                               # %pred.store.continue44
                                        #   in Loop: Header=BB5_46 Depth=2
	add.d	$a4, $s5, $a2
	vld	$vr2, $a4, 16
	vseqi.w	$vr2, $vr2, 0
	...
	vadd.d	$vr3, $vr1, $vr5
	bnez	$a4, .LBB5_58
# %bb.52:                               # %pred.store.continue46
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 1
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_59
.LBB5_53:                               # %pred.store.continue48
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 2
	andi	$a4, $a4, 1
	vadd.d	$vr3, $vr0, $vr5
	bnez	$a4, .LBB5_60
.LBB5_54:                               # %pred.store.continue50
                                        #   in Loop: Header=BB5_46 Depth=2
	vpickve2gr.w	$a4, $vr2, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_45
