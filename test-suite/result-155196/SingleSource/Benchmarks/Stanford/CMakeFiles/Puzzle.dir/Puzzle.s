...
.LBB5_13:                               # %vector.body59
	...
	xvadd.d	$xr3, $xr1, $xr4
	bnez	$a6, .LBB5_21
# %bb.14:                               # %pred.store.continue64
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 1
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_22
.LBB5_15:                               # %pred.store.continue66
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_23
.LBB5_16:                               # %pred.store.continue68
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_24
.LBB5_17:                               # %pred.store.continue70
                                        #   in Loop: Header=BB5_13 Depth=2
...
.LBB5_49:                               # %pred.store.continue41
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_57
.LBB5_50:                               # %pred.store.continue43
                                        #   in Loop: Header=BB5_46 Depth=2
	xvpickve2gr.w	$a4, $xr2, 4
	andi	$a4, $a4, 1
	xvadd.d	$xr3, $xr0, $xr4
	bnez	$a4, .LBB5_58
.LBB5_51:                               # %pred.store.continue45
                                        #   in Loop: Header=BB5_46 Depth=2
	xvpickve2gr.w	$a4, $xr2, 5
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_59
.LBB5_52:                               # %pred.store.continue47
                                        #   in Loop: Header=BB5_46 Depth=2
	xvpickve2gr.w	$a4, $xr2, 6
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_60
.LBB5_53:                               # %pred.store.continue49
                                        #   in Loop: Header=BB5_46 Depth=2
