...
# %bb.36:
	...
	fmul.d	$fs3, $fa2, $fs2
	fmov.d	$fa0, $fs3
	vst	$vr21, $sp, 1360                # 16-byte Folded Spill
	...
	vldi	$vr2, -1000
	fdiv.d	$fa1, $fa1, $fa2
	vst	$vr1, $sp, 1200                 # 16-byte Folded Spill
	vld	$vr1, $sp, 1536                 # 16-byte Folded Reload
	fdiv.d	$fa0, $fa0, $fa1
	...
	fld.d	$fs3, $sp, 976                  # 8-byte Folded Reload
	fmul.d	$fs0, $fa3, $fs3
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(exp)
	jirl	$ra, $ra, 0
	...
	fdiv.d	$fa1, $fa1, $ft8
	fsub.d	$fa0, $fa0, $fa1
	fld.d	$fa2, $sp, 1424                 # 8-byte Folded Reload
	...
	fsub.d	$fa1, $fa1, $ft3
	fneg.d	$fa1, $fa1
	fld.d	$ft7, $sp, 168                  # 8-byte Folded Reload
	fmul.d	$fa1, $ft7, $fa1
	vldi	$vr12, -1024
	...
	fdiv.d	$fa1, $fa5, $ft5
	vld	$vr9, $sp, 448                  # 16-byte Folded Reload
	fdiv.d	$ft9, $ft1, $ft6
	fsub.d	$fa1, $fa1, $ft9
	vori.b	$vr17, $vr19, 0
	vextrins.d	$vr17, $vr10, 0
	vfmul.d	$vr20, $vr3, $vr17
	vori.b	$vr6, $vr3, 0
	vst	$vr3, $sp, 16                   # 16-byte Folded Spill
	vori.b	$vr17, $vr21, 0
	vextrins.d	$vr17, $vr7, 0
	vfmul.d	$vr21, $vr4, $vr17
	vori.b	$vr3, $vr4, 0
	...
	vfdiv.d	$vr22, $vr2, $vr25
	vfdiv.d	$vr23, $vr12, $vr29
	vfsub.d	$vr22, $vr22, $vr23
	vldi	$vr23, -1008
	vld	$vr4, $sp, 272                  # 16-byte Folded Reload
	vpackev.d	$vr23, $vr23, $vr4
	...
	vfmul.d	$vr24, $vr6, $vr20
	vfmul.d	$vr25, $vr3, $vr21
	vld	$vr5, $sp, 1536                 # 16-byte Folded Reload
	vpackod.d	$vr20, $vr24, $vr5
	vfdiv.d	$vr21, $vr4, $vr20
	vld	$vr6, $sp, 144                  # 16-byte Folded Reload
	vpackod.d	$vr29, $vr25, $vr6
	vfdiv.d	$vr30, $vr8, $vr29
	vfsub.d	$vr21, $vr21, $vr30
	vextrins.d	$vr1, $vr26, 16
	vfmadd.d	$vr1, $vr21, $vr23, $vr1
	vld	$vr30, $sp, 528                 # 16-byte Folded Reload
	fdiv.d	$ft13, $fs6, $ft9
	vld	$vr7, $sp, 608                  # 16-byte Folded Reload
	fdiv.d	$fs2, $fa7, $ft10
	fsub.d	$ft13, $ft13, $fs2
	vextrins.d	$vr30, $vr10, 16
	vextrins.d	$vr7, $vr15, 16
	vfdiv.d	$vr20, $vr30, $vr20
	vfdiv.d	$vr26, $vr7, $vr29
	vfsub.d	$vr20, $vr20, $vr26
	vextrins.d	$vr21, $vr19, 16
	vfmadd.d	$vr23, $vr20, $vr23, $vr21
	vori.b	$vr20, $vr28, 0
	vshuf4i.d	$vr20, $vr0, 1
	vfdiv.d	$vr19, $vr2, $vr20
	vori.b	$vr21, $vr27, 0
	vshuf4i.d	$vr21, $vr0, 1
	vfdiv.d	$vr26, $vr12, $vr21
	...
	vld	$vr3, $sp, 1328                 # 16-byte Folded Reload
	vreplvei.d	$vr29, $vr3, 0
	vld	$vr4, $sp, 1504                 # 16-byte Folded Reload
	vextrins.d	$vr3, $vr4, 16
	vld	$vr4, $sp, 752                  # 16-byte Folded Reload
	...
	fdiv.d	$fa0, $ft0, $ft9
	vld	$vr19, $sp, 880                 # 16-byte Folded Reload
	fdiv.d	$fa1, $ft11, $ft10
	fsub.d	$fa0, $fa0, $fa1
	fdiv.d	$fa1, $ft0, $ft5
	fdiv.d	$ft5, $ft11, $ft6
	fsub.d	$fa1, $fa1, $ft5
	...
	vld	$vr0, $sp, 1392                 # 16-byte Folded Reload
	fmul.d	$fa1, $fa0, $fa3
	vld	$vr10, $sp, 704                 # 16-byte Folded Reload
	fdiv.d	$fa0, $ft2, $fa1
	...
	vfdiv.d	$vr11, $vr10, $vr24
	vfdiv.d	$vr12, $vr7, $vr25
	...
	vld	$vr31, $sp, 1536                # 16-byte Folded Reload
	vfdiv.d	$vr4, $vr10, $vr31
	vfdiv.d	$vr11, $vr7, $vr20
	vfsub.d	$vr4, $vr4, $vr11
	vfmadd.d	$vr0, $vr30, $vr4, $vr0
	vld	$vr30, $sp, 1056                # 16-byte Folded Reload
	fdiv.d	$fa4, $fs6, $ft9
	vld	$vr17, $sp, 1072                # 16-byte Folded Reload
	fdiv.d	$ft3, $ft9, $ft10
	fsub.d	$fa4, $fa4, $ft3
	fmul.d	$fa4, $fa5, $fa4
	...
	vld	$vr7, $sp, 1520                 # 16-byte Folded Reload
	...
	vfmul.d	$vr8, $vr7, $vr8
	vfadd.d	$vr4, $vr4, $vr8
	vld	$vr8, $sp, 1008                 # 16-byte Folded Reload
	vfsub.d	$vr4, $vr4, $vr8
	vld	$vr8, $sp, 656                  # 16-byte Folded Reload
	vfadd.d	$vr4, $vr4, $vr8
	vld	$vr8, $sp, 608                  # 16-byte Folded Reload
	vfsub.d	$vr4, $vr4, $vr8
	fld.d	$ft0, $sp, 1496                 # 8-byte Folded Reload
	fmul.d	$ft0, $ft0, $fs2
	vld	$vr12, $sp, 1120                # 16-byte Folded Reload
	vori.b	$vr9, $vr12, 0
	vld	$vr10, $sp, 1136                # 16-byte Folded Reload
	vextrins.d	$vr9, $vr10, 16
	vld	$vr13, $sp, 1104                # 16-byte Folded Reload
	...
	vfsub.d	$vr5, $vr6, $vr5
	vld	$vr6, $sp, 1472                 # 16-byte Folded Reload
