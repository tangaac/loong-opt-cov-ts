...
# %bb.5:                                # %.loopexit
	...
	vld	$vr2, $t0, %pc_lo12(.LCPI1_2)
	pcalau12i	$t0, %pc_hi20(.LCPI1_3)
	vld	$vr3, $t0, %pc_lo12(.LCPI1_3)
	vst	$vr2, $sp, 24
	vst	$vr3, $sp, 40
	bnez	$a0, .LBB1_10
...
# %bb.7:                                # %vector.ph159
                                        #   in Loop: Header=BB1_2 Depth=1
	bstrpick.d	$a6, $a6, 60, 2
	slli.d	$a6, $a6, 5
	sub.d	$t7, $a2, $a6
	addi.d	$a6, $sp, 8
	.p2align	4, , 16
.LBB1_8:                                # %vector.body162
...
# %bb.20:                               # %vector.ph139
                                        #   in Loop: Header=BB1_2 Depth=1
	bstrpick.d	$a6, $a5, 61, 2
	slli.d	$a7, $a6, 2
	slli.d	$a6, $a6, 5
	sub.d	$a6, $a3, $a6
	addi.d	$t2, $sp, 16
	.p2align	4, , 16
.LBB1_21:                               # %vector.body142
                                        #   Parent Loop BB1_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $t2, 0
	vld	$vr3, $t2, -16
...
# %bb.34:                               # %vector.ph119
                                        #   in Loop: Header=BB1_2 Depth=1
	bstrpick.d	$a5, $s8, 61, 2
	slli.d	$a6, $a5, 2
	slli.d	$a5, $a5, 5
	sub.d	$a5, $a4, $a5
	move	$a7, $a2
	.p2align	4, , 16
.LBB1_35:                               # %vector.body122
                                        #   Parent Loop BB1_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $a7, 0
	vld	$vr3, $a7, -16
