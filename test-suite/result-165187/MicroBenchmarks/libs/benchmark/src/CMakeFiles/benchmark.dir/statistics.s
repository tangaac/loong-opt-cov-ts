...
.LBB4_60:                               # %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE12_M_drop_nodeEPSt13_Rb_tree_nodeISH_E.exit.i.i.i.i
	...
	move	$s3, $fp
	b	.LBB4_62
.LBB4_61:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i.i
                                        #   in Loop: Header=BB4_22 Depth=2
	sub.d	$a0, $s0, $fp
	slt	$a1, $s8, $a0
	maskeqz	$a0, $a0, $a1
...
.LBB4_62:                               # %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit
	...
	srai.d	$a0, $s0, 3
	bgeu	$a0, $s2, .LBB4_21
# %bb.63:                               # %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i120
                                        #   in Loop: Header=BB4_22 Depth=2
	ld.d	$s5, $s3, 88
	slli.d	$a0, $s2, 3
.Ltmp20:                                # EH_LABEL
...
.LBB4_68:                               # %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i124
	...
	st.d	$a0, $s3, 96
	b	.LBB4_21
.LBB4_69:                               #   in Loop: Header=BB4_22 Depth=2
	pcalau12i	$a0, %pc_hi20(_ZGVZN9benchmark8internal18GetNullLogInstanceEvE8null_log)
	...
	addi.w	$a0, $a0, 0
	beqz	$a0, .LBB4_21
# %bb.70:                               #   in Loop: Header=BB4_22 Depth=2
...
.LBB4_87:                               #   in Loop: Header=BB4_74 Depth=1
	...
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	beq	$fp, $a0, .LBB4_208
# %bb.88:                               # %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i140
                                        #   in Loop: Header=BB4_74 Depth=1
	srai.d	$a0, $fp, 3
	ori	$a2, $zero, 1
	sltu	$a1, $a2, $a0
...
# %bb.90:                               #   in Loop: Header=BB4_74 Depth=1
	...
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB4_91:                               # %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i142
                                        #   in Loop: Header=BB4_74 Depth=1
	beqz	$s0, .LBB4_93
# %bb.92:                               # %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i.i.i144
                                        #   in Loop: Header=BB4_74 Depth=1
	move	$a0, $s0
	move	$a1, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_93:                               # %_ZNSt6vectorIdSaIdEE17_M_realloc_appendIJRKdEEEvDpOT_.exit.i145
                                        #   in Loop: Header=BB4_74 Depth=1
	add.d	$a0, $s3, $fp
	addi.d	$a0, $a0, 8
	st.d	$s3, $sp, 760
...
# %bb.97:                               # %.lr.ph.i.i.i151
	...
	b	.LBB4_100
	.p2align	4, , 16
.LBB4_98:                               # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i.i.i.i176
	...
	masknez	$a1, $s6, $a1
	or	$a0, $a0, $a1
.LBB4_99:                               # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i157
                                        #   in Loop: Header=BB4_100 Depth=3
	addi.w	$a0, $a0, 0
	slti	$a1, $a0, 0
	masknez	$a0, $s2, $a1
	...
	or	$fp, $a1, $a0
	beqz	$s2, .LBB4_102
.LBB4_100:                              #   Parent Loop BB4_74 Depth=1
	...
	or	$a2, $a0, $a1
	beqz	$a2, .LBB4_98
# %bb.101:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i155
                                        #   in Loop: Header=BB4_100 Depth=3
	ld.d	$a0, $s2, 32
	move	$a1, $s4
	pcaddu18i	$ra, %call36(memcmp)
	...
	b	.LBB4_98
	.p2align	4, , 16
.LBB4_102:                              # %_ZNKSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt18_Rb_tree_node_baseSP_RS7_.exit.i.i164
                                        #   in Loop: Header=BB4_96 Depth=2
	addi.d	$a2, $sp, 720
	move	$s1, $a2
	beq	$fp, $a2, .LBB4_107
# %bb.103:                              #   in Loop: Header=BB4_96 Depth=2
	...
	or	$a2, $a2, $a1
	beqz	$a2, .LBB4_105
# %bb.104:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i166
                                        #   in Loop: Header=BB4_96 Depth=2
	ld.d	$a1, $a0, 32
	move	$a0, $s4
	pcaddu18i	$ra, %call36(memcmp)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB4_106
.LBB4_105:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.thread.i.i.i.i.i172
                                        #   in Loop: Header=BB4_96 Depth=2
	sub.d	$a0, $s0, $s1
	slt	$a1, $s8, $a0
	maskeqz	$a0, $a0, $a1
	...
	masknez	$a1, $s6, $a1
	or	$a0, $a0, $a1
.LBB4_106:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i168
                                        #   in Loop: Header=BB4_96 Depth=2
	addi.w	$a0, $a0, 0
	slti	$a0, $a0, 0
	masknez	$a1, $fp, $a0
	...
	maskeqz	$a0, $a2, $a0
	or	$s1, $a0, $a1
.LBB4_107:                              # %_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEZN9benchmark12ComputeStatsERKSt6vectorINS6_17BenchmarkReporter3RunESaIS9_EEE11CounterStatSt4lessIS5_ESaISt4pairIKS5_SE_EEE4findERSI_.exit181
                                        #   in Loop: Header=BB4_96 Depth=2
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.b	$a0, $a0, 0
	dbar	20
	beqz	$a0, .LBB4_116
.LBB4_108:                              # %_ZN9benchmark8internal18GetNullLogInstanceEv.exit183
                                        #   in Loop: Header=BB4_96 Depth=2
	ld.d	$a0, $s1, 88
	ld.d	$a1, $s1, 96
	bne	$a0, $a1, .LBB4_94
...
# %bb.112:                              #   in Loop: Header=BB4_96 Depth=2
	...
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB4_113:                              # %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i186
                                        #   in Loop: Header=BB4_96 Depth=2
	beqz	$s0, .LBB4_115
# %bb.114:                              # %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i.i.i188
                                        #   in Loop: Header=BB4_96 Depth=2
	move	$a0, $s0
	move	$a1, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
# %bb.121:                              #   in Loop: Header=BB4_74 Depth=1
	...
	jirl	$ra, $ra, 0
	b	.LBB4_76
.LBB4_122:                              # %._crit_edge343.loopexit
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s1, $a0, 0
.LBB4_123:                              # %._crit_edge343
	ld.d	$s5, $sp, 72                    # 8-byte Folded Reload
	lu12i.w	$s2, 59918
	ld.d	$s6, $sp, 24                    # 8-byte Folded Reload
.LBB4_124:                              # %._crit_edge343
	addi.d	$a0, $sp, 696
	ld.d	$a1, $s1, 328
	ld.d	$fp, $s1, 320
	st.d	$a0, $sp, 680
...
.Ltmp7:                                 # EH_LABEL
	...
	beqz	$a0, .LBB4_237
	b	.LBB4_240
.LBB4_213:                              # %.loopexit.split-lp313
.Ltmp36:                                # EH_LABEL
	b	.LBB4_225
.LBB4_214:                              # %.loopexit312
.Ltmp27:                                # EH_LABEL
	b	.LBB4_225
.LBB4_215:
.Ltmp92:                                # EH_LABEL
