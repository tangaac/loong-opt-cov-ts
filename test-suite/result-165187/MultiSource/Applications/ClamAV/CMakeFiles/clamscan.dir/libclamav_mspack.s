...
.LBB3_142:                              # %vec.epilog.ph
	...
	add.d	$a5, $t1, $a5
	.p2align	4, , 16
.LBB3_143:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB3_1 Depth=1
                                        #     Parent Loop BB3_36 Depth=2
...
# %bb.144:                              # %vec.epilog.middle.block
	...
	bne	$a7, $a2, .LBB3_147
	b	.LBB3_148
.LBB3_145:                              #   in Loop: Header=BB3_137 Depth=3
	move	$a3, $s6
	b	.LBB3_147
.LBB3_146:                              #   in Loop: Header=BB3_137 Depth=3
	move	$a3, $s6
	.p2align	4, , 16
.LBB3_147:                              # %.lr.ph791
                                        #   Parent Loop BB3_1 Depth=1
	...
	move	$a0, $a4
	bnez	$a3, .LBB3_147
.LBB3_148:                              # %._crit_edge792
                                        #   in Loop: Header=BB3_137 Depth=3
	add.w	$t2, $s6, $t2
	lu12i.w	$a1, 8
	st.d	$t2, $sp, 48                    # 8-byte Folded Spill
	bne	$t2, $a1, .LBB3_136
# %bb.149:                              #   in Loop: Header=BB3_137 Depth=3
	ld.d	$a2, $fp, 16
	move	$a0, $fp
	jirl	$ra, $a2, 0
	beqz	$a0, .LBB3_135
...
.LBB7_241:                              # %vec.epilog.ph4208
	...
	add.d	$a4, $a6, $a4
.LBB7_242:                              # %vec.epilog.vector.body4212
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_67 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a4, $a4, 16
	bnez	$t0, .LBB7_242
# %bb.243:                              # %vec.epilog.middle.block4218
                                        #   in Loop: Header=BB7_67 Depth=3
	bne	$a7, $a0, .LBB7_245
	b	.LBB7_268
.LBB7_244:                              #   in Loop: Header=BB7_67 Depth=3
	move	$a5, $a0
.LBB7_245:                              # %.lr.ph3008.preheader
                                        #   in Loop: Header=BB7_67 Depth=3
	addi.d	$a3, $a5, 1
.LBB7_246:                              # %.lr.ph3008
                                        #   Parent Loop BB7_11 Depth=1
...
.LBB7_249:                              # %vector.body4195
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB7_249
# %bb.250:                              # %middle.block4202
                                        #   in Loop: Header=BB7_67 Depth=3
	beq	$a6, $a0, .LBB7_268
# %bb.251:                              # %vec.epilog.iter.check4206
                                        #   in Loop: Header=BB7_67 Depth=3
	bnez	$a5, .LBB7_241
# %bb.252:                              #   in Loop: Header=BB7_67 Depth=3
	sub.d	$a5, $a0, $a6
	add.d	$a1, $a1, $a6
	add.d	$a2, $a2, $a6
	b	.LBB7_245
.LBB7_253:                              #   in Loop: Header=BB7_67 Depth=3
	move	$a6, $a5
.LBB7_254:                              # %.lr.ph3013.preheader4237
                                        #   in Loop: Header=BB7_67 Depth=3
	addi.d	$a4, $a6, 1
.LBB7_255:                              # %.lr.ph3013
                                        #   Parent Loop BB7_11 Depth=1
...
# %bb.258:                              # %iter.check4126
	...
	ori	$a4, $zero, 16
	bltu	$a2, $a4, .LBB7_265
# %bb.259:                              # %iter.check4126
                                        #   in Loop: Header=BB7_67 Depth=3
	sub.d	$a4, $a1, $a3
	ori	$a5, $zero, 32
	bltu	$a4, $a5, .LBB7_265
# %bb.260:                              # %vector.main.loop.iter.check4128
                                        #   in Loop: Header=BB7_67 Depth=3
	bgeu	$a2, $a5, .LBB7_270
# %bb.261:                              #   in Loop: Header=BB7_67 Depth=3
	move	$a7, $zero
.LBB7_262:                              # %vec.epilog.ph4145
                                        #   in Loop: Header=BB7_67 Depth=3
	...
	add.d	$a3, $a3, $a7
	add.d	$a1, $a1, $a7
.LBB7_263:                              # %vec.epilog.vector.body4149
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_67 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a1, $a1, 16
	bnez	$t1, .LBB7_263
# %bb.264:                              # %vec.epilog.middle.block4155
                                        #   in Loop: Header=BB7_67 Depth=3
	bne	$t0, $a2, .LBB7_266
	b	.LBB7_268
...
.LBB7_271:                              # %vector.body4132
	...
	addi.d	$a6, $a6, 32
	bnez	$t0, .LBB7_271
# %bb.272:                              # %middle.block4139
                                        #   in Loop: Header=BB7_67 Depth=3
	beq	$a7, $a2, .LBB7_268
# %bb.273:                              # %vec.epilog.iter.check4143
                                        #   in Loop: Header=BB7_67 Depth=3
	bnez	$a4, .LBB7_262
# %bb.274:                              #   in Loop: Header=BB7_67 Depth=3
	sub.d	$a6, $a2, $a7
	add.d	$a4, $a1, $a7
	add.d	$a5, $a3, $a7
	b	.LBB7_266
...
.LBB7_445:                              # %vec.epilog.ph4100
	...
	ld.d	$a6, $sp, 120                   # 8-byte Folded Reload
	add.d	$a4, $a6, $a4
.LBB7_446:                              # %vec.epilog.vector.body4104
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_307 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a4, $a4, 16
	bnez	$t0, .LBB7_446
# %bb.447:                              # %vec.epilog.middle.block4110
                                        #   in Loop: Header=BB7_307 Depth=3
	bne	$a7, $a0, .LBB7_449
	b	.LBB7_472
.LBB7_448:                              #   in Loop: Header=BB7_307 Depth=3
	move	$a5, $a0
	addi.d	$s4, $fp, 240
.LBB7_449:                              # %.lr.ph3073.preheader
                                        #   in Loop: Header=BB7_307 Depth=3
	addi.d	$a3, $a5, 1
.LBB7_450:                              # %.lr.ph3073
                                        #   Parent Loop BB7_11 Depth=1
	...
	blt	$s3, $a3, .LBB7_450
	b	.LBB7_472
.LBB7_451:                              #   in Loop: Header=BB7_307 Depth=3
	move	$a2, $a0
	addi.d	$s4, $fp, 240
	b	.LBB7_461
.LBB7_452:                              # %vector.ph4084
                                        #   in Loop: Header=BB7_307 Depth=3
	andi	$a5, $a0, 16
	bstrpick.d	$a6, $a0, 15, 5
	slli.d	$a6, $a6, 5
...
.LBB7_453:                              # %vector.body4087
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB7_453
# %bb.454:                              # %middle.block4094
                                        #   in Loop: Header=BB7_307 Depth=3
	beq	$a6, $a0, .LBB7_472
# %bb.455:                              # %vec.epilog.iter.check4098
                                        #   in Loop: Header=BB7_307 Depth=3
	bnez	$a5, .LBB7_445
# %bb.456:                              #   in Loop: Header=BB7_307 Depth=3
	sub.d	$a5, $a0, $a6
	add.d	$a1, $a1, $a6
	add.d	$a2, $a2, $a6
	b	.LBB7_449
.LBB7_457:                              #   in Loop: Header=BB7_307 Depth=3
	move	$a6, $a5
.LBB7_458:                              # %.lr.ph3078.preheader4235
                                        #   in Loop: Header=BB7_307 Depth=3
	addi.d	$a4, $a6, 1
.LBB7_459:                              # %.lr.ph3078
                                        #   Parent Loop BB7_11 Depth=1
	...
	addi.d	$a1, $a1, 1
	bltu	$s3, $a4, .LBB7_459
.LBB7_460:                              #   in Loop: Header=BB7_307 Depth=3
	ld.d	$a3, $sp, 120                   # 8-byte Folded Reload
.LBB7_461:                              # %.loopexit1327
                                        #   in Loop: Header=BB7_307 Depth=3
	blez	$a2, .LBB7_472
# %bb.462:                              # %iter.check
                                        #   in Loop: Header=BB7_307 Depth=3
...
# %bb.464:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB7_307 Depth=3
	bgeu	$a2, $a5, .LBB7_474
# %bb.465:                              #   in Loop: Header=BB7_307 Depth=3
	move	$a7, $zero
.LBB7_466:                              # %vec.epilog.ph
                                        #   in Loop: Header=BB7_307 Depth=3
	bstrpick.d	$a5, $a2, 30, 4
	slli.d	$t0, $a5, 4
	sub.d	$a6, $a2, $t0
	...
	add.d	$a3, $a3, $a7
	add.d	$a1, $a1, $a7
.LBB7_467:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB7_11 Depth=1
                                        #     Parent Loop BB7_62 Depth=2
                                        #       Parent Loop BB7_307 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a1, $a1, 16
	bnez	$t1, .LBB7_467
# %bb.468:                              # %vec.epilog.middle.block
                                        #   in Loop: Header=BB7_307 Depth=3
	bne	$t0, $a2, .LBB7_470
	b	.LBB7_472
.LBB7_469:                              #   in Loop: Header=BB7_307 Depth=3
	move	$a6, $a2
	move	$a4, $a1
	move	$a5, $a3
.LBB7_470:                              # %.lr.ph3084.preheader
                                        #   in Loop: Header=BB7_307 Depth=3
	addi.d	$a1, $a6, 1
.LBB7_471:                              # %.lr.ph3084
                                        #   Parent Loop BB7_11 Depth=1
...
.LBB7_472:                              # %.loopexit
	...
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	st.d	$a1, $sp, 16                    # 8-byte Folded Spill
.LBB7_473:                              #   in Loop: Header=BB7_307 Depth=3
	st.d	$s2, $sp, 56                    # 8-byte Folded Spill
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	st.d	$a0, $sp, 192                   # 8-byte Folded Spill
	bgtz	$a0, .LBB7_307
...
# %bb.476:                              # %middle.block
                                        #   in Loop: Header=BB7_307 Depth=3
	beq	$a7, $a2, .LBB7_472
# %bb.477:                              # %vec.epilog.iter.check
                                        #   in Loop: Header=BB7_307 Depth=3
	bnez	$a4, .LBB7_466
# %bb.478:                              #   in Loop: Header=BB7_307 Depth=3
	sub.d	$a6, $a2, $a7
	add.d	$a4, $a1, $a7
	add.d	$a5, $a3, $a7
	b	.LBB7_470
...
# %bb.36:
	move	$t2, $zero
.LBB9_37:                               # %vec.epilog.ph206
	move	$t3, $t0
	bstrins.d	$t3, $zero, 2, 0
	add.d	$t1, $a7, $t3
.LBB9_38:                               # %vec.epilog.vector.body210
	...
	vstx	$vr0, $a3, $t4
	bne	$t3, $t2, .LBB9_38
# %bb.39:                               # %vec.epilog.middle.block215
	bne	$t0, $t3, .LBB9_41
	b	.LBB9_43
.LBB9_40:
	move	$t1, $a7
.LBB9_41:                               # %.lr.ph.preheader
	ori	$t0, $a0, 4095
	.p2align	4, , 16
.LBB9_42:                               # %.lr.ph
                                        # =>This Inner Loop Header: Depth=1
	...
	stx.h	$t0, $a3, $t2
	bltu	$t3, $a6, .LBB9_42
.LBB9_43:                               # %.preheader104.preheader
	lu12i.w	$a6, 16
	sll.w	$a6, $a6, $a1
	slli.d	$a7, $a7, 16
	addi.w	$a1, $a1, 1
...
.LBB9_44:                               # %.split136.us
	...
	addi.d	$t1, $t1, 1
	beq	$a1, $t3, .LBB9_58
.LBB9_45:                               # %.preheader104.split.us.preheader
                                        # =>This Loop Header: Depth=1
...
.LBB9_46:                               # %._crit_edge130.us
	...
	stx.h	$t4, $a3, $t5
	bltu	$a6, $a7, .LBB9_26
.LBB9_47:                               #   in Loop: Header=BB9_48 Depth=2
	addi.d	$t4, $t4, 1
	bgeu	$t4, $a4, .LBB9_44
.LBB9_48:                               # %.preheader104.split.us
...
# %bb.52:                               #   in Loop: Header=BB9_51 Depth=3
	...
	move	$a5, $t7
	b	.LBB9_50
.LBB9_53:                               # %vector.ph194
	move	$t3, $zero
	andi	$t1, $t0, 8
	move	$t2, $t0
	bstrins.d	$t2, $zero, 3, 0
.LBB9_54:                               # %vector.body197
                                        # =>This Inner Loop Header: Depth=1
	add.d	$t4, $a7, $t3
	bstrpick.d	$t4, $t4, 15, 0
	alsl.d	$t5, $t4, $a3, 1
...
# %bb.55:                               # %middle.block200
	beq	$t0, $t2, .LBB9_43
# %bb.56:                               # %vec.epilog.iter.check204
	bnez	$t1, .LBB9_37
# %bb.57:
	add.d	$t1, $a7, $t2
	b	.LBB9_41
...
.LBB12_25:
	move	$a3, $zero
.LBB12_26:                              # %scalar.ph165.preheader
...
.LBB12_27:                              # %scalar.ph165
	...
	addi.d	$a4, $a4, -1
	bne	$a5, $a3, .LBB12_27
# %bb.28:                               # %qtm_init_model.exit123
	pcalau12i	$a3, %pc_hi20(.LCPI12_9)
	vld	$vr0, $a3, %pc_lo12(.LCPI12_9)
	vst	$vr0, $a0, 1972
	pcalau12i	$a3, %pc_hi20(.LCPI12_10)
	vld	$vr0, $a3, %pc_lo12(.LCPI12_10)
	pcalau12i	$a3, %pc_hi20(.LCPI12_11)
	vld	$vr1, $a3, %pc_lo12(.LCPI12_11)
	pcalau12i	$a3, %pc_hi20(.LCPI12_12)
	vld	$vr2, $a3, %pc_lo12(.LCPI12_12)
	pcalau12i	$a3, %pc_hi20(.LCPI12_13)
	vld	$vr3, $a3, %pc_lo12(.LCPI12_13)
	vst	$vr0, $a0, 1988
	vst	$vr1, $a0, 2004
	vst	$vr2, $a0, 2020
	vst	$vr3, $a0, 2036
	pcalau12i	$a3, %pc_hi20(.LCPI12_14)
	vld	$vr0, $a3, %pc_lo12(.LCPI12_14)
	addi.d	$a3, $a0, 1972
	ori	$a4, $zero, 4
	ori	$a5, $zero, 2052
	vstx	$vr0, $a0, $a5
	pcalau12i	$a5, %pc_hi20(.LCPI12_15)
	vld	$vr0, $a5, %pc_lo12(.LCPI12_15)
	ori	$a5, $zero, 4
	lu32i.d	$a5, 27
	st.d	$a5, $a0, 480
	st.d	$a3, $a0, 488
...
.LBB13_123:                             #   in Loop: Header=BB13_119 Depth=3
	andi	$s0, $s8, 255
	bltu	$t1, $s0, .LBB13_118
# %bb.124:                              #   in Loop: Header=BB13_119 Depth=3
	bltu	$s5, $t2, .LBB13_117
...
.LBB13_132:                             # %.lr.ph1510
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	andi	$s6, $s8, 255
	bltu	$t1, $s6, .LBB13_131
# %bb.133:                              #   in Loop: Header=BB13_132 Depth=3
	bltu	$s5, $t2, .LBB13_130
...
.LBB13_150:                             #   in Loop: Header=BB13_146 Depth=3
	andi	$s0, $s8, 255
	bltu	$t1, $s0, .LBB13_145
# %bb.151:                              #   in Loop: Header=BB13_146 Depth=3
	bltu	$s5, $t2, .LBB13_144
...
.LBB13_160:                             # %.lr.ph1532
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	andi	$s6, $s8, 255
	bltu	$t1, $s6, .LBB13_159
# %bb.161:                              #   in Loop: Header=BB13_160 Depth=3
	bltu	$s5, $t2, .LBB13_158
...
.LBB13_183:                             #   in Loop: Header=BB13_179 Depth=3
	andi	$s0, $s8, 255
	bltu	$t1, $s0, .LBB13_178
# %bb.184:                              #   in Loop: Header=BB13_179 Depth=3
	bltu	$s5, $t2, .LBB13_177
...
.LBB13_191:                             # %.lr.ph1466
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	andi	$s6, $s8, 255
	bltu	$t1, $s6, .LBB13_190
# %bb.192:                              #   in Loop: Header=BB13_191 Depth=3
	bltu	$s5, $t2, .LBB13_189
...
.LBB13_223:                             #   in Loop: Header=BB13_219 Depth=3
	andi	$s0, $s8, 255
	bltu	$t1, $s0, .LBB13_218
# %bb.224:                              #   in Loop: Header=BB13_219 Depth=3
	bltu	$s5, $t2, .LBB13_217
...
.LBB13_233:                             # %.lr.ph1488
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	andi	$s6, $s8, 255
	bltu	$t1, $s6, .LBB13_232
# %bb.234:                              #   in Loop: Header=BB13_233 Depth=3
	bltu	$s5, $t2, .LBB13_231
...
.LBB13_252:                             # %vec.epilog.ph2030
	...
	add.d	$a3, $a5, $a3
.LBB13_253:                             # %vec.epilog.vector.body2034
                                        #   Parent Loop BB13_11 Depth=1
                                        #     Parent Loop BB13_24 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $a3, $a2
	...
	addi.d	$a3, $a3, 16
	bnez	$a7, .LBB13_253
# %bb.254:                              # %vec.epilog.middle.block2040
                                        #   in Loop: Header=BB13_24 Depth=2
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	bne	$a6, $a2, .LBB13_256
	b	.LBB13_279
.LBB13_255:                             #   in Loop: Header=BB13_24 Depth=2
	ld.d	$a4, $sp, 40                    # 8-byte Folded Reload
...
.LBB13_257:                             # %.lr.ph1543
	...
	st.b	$a3, $a0, 0
	move	$a0, $a4
	bltu	$a5, $a2, .LBB13_257
	b	.LBB13_279
.LBB13_258:                             #   in Loop: Header=BB13_24 Depth=2
	move	$s0, $zero
	b	.LBB13_238
.LBB13_259:                             # %vector.ph2014
                                        #   in Loop: Header=BB13_24 Depth=2
	andi	$a4, $a6, 16
...
.LBB13_260:                             # %vector.body2017
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB13_260
# %bb.261:                              # %middle.block2024
                                        #   in Loop: Header=BB13_24 Depth=2
	ld.d	$a6, $sp, 40                    # 8-byte Folded Reload
	beq	$a5, $a6, .LBB13_279
# %bb.262:                              # %vec.epilog.iter.check2028
                                        #   in Loop: Header=BB13_24 Depth=2
	bnez	$a4, .LBB13_252
# %bb.263:                              #   in Loop: Header=BB13_24 Depth=2
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	sub.d	$a4, $a2, $a5
	add.d	$a0, $a0, $a5
	add.d	$a1, $a1, $a5
...
# %bb.269:                              # %iter.check
                                        #   in Loop: Header=BB13_24 Depth=2
	bltu	$a1, $t1, .LBB13_276
# %bb.270:                              # %iter.check
                                        #   in Loop: Header=BB13_24 Depth=2
	sub.d	$a3, $a0, $a2
	bltu	$a3, $a4, .LBB13_276
# %bb.271:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB13_24 Depth=2
	bgeu	$a1, $a4, .LBB13_282
# %bb.272:                              #   in Loop: Header=BB13_24 Depth=2
	move	$a6, $zero
.LBB13_273:                             # %vec.epilog.ph
                                        #   in Loop: Header=BB13_24 Depth=2
	...
	add.d	$a2, $a2, $a6
	add.d	$a0, $a0, $a6
.LBB13_274:                             # %vec.epilog.vector.body
                                        #   Parent Loop BB13_11 Depth=1
                                        #     Parent Loop BB13_24 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a2, 0
	...
	addi.d	$a0, $a0, 16
	bnez	$t0, .LBB13_274
# %bb.275:                              # %vec.epilog.middle.block
                                        #   in Loop: Header=BB13_24 Depth=2
	bne	$a7, $a1, .LBB13_277
	b	.LBB13_279
.LBB13_276:                             #   in Loop: Header=BB13_24 Depth=2
	move	$a5, $a1
	move	$a3, $a0
	move	$a4, $a2
.LBB13_277:                             # %.lr.ph1554.preheader
                                        #   in Loop: Header=BB13_24 Depth=2
	addi.d	$a0, $a5, 1
	ori	$a5, $zero, 1
.LBB13_278:                             # %.lr.ph1554
	...
	st.b	$a1, $a3, 0
	move	$a3, $a2
	bltu	$a5, $a0, .LBB13_278
.LBB13_279:                             #   in Loop: Header=BB13_24 Depth=2
	ori	$a4, $zero, 32
.LBB13_280:                             # %.loopexit
                                        #   in Loop: Header=BB13_24 Depth=2
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
...
.LBB13_283:                             # %vector.body1965
	...
	addi.d	$a5, $a5, 32
	bnez	$a7, .LBB13_283
# %bb.284:                              # %middle.block1970
                                        #   in Loop: Header=BB13_24 Depth=2
	beq	$a6, $a1, .LBB13_279
# %bb.285:                              # %vec.epilog.iter.check
                                        #   in Loop: Header=BB13_24 Depth=2
	bnez	$a3, .LBB13_273
...
.LBB13_294:                             #   Parent Loop BB13_11 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	andi	$s6, $s8, 255
	bltu	$t1, $s6, .LBB13_293
# %bb.295:                              #   in Loop: Header=BB13_294 Depth=2
	bltu	$s5, $t2, .LBB13_292
...
# %bb.9:                                #   in Loop: Header=BB16_4 Depth=2
	...
	b	.LBB16_15
	.p2align	4, , 16
.LBB16_10:                              # %vector.scevcheck
                                        #   in Loop: Header=BB16_4 Depth=2
	bstrins.d	$s6, $s8, 63, 1
	nor	$a6, $s6, $zero
	addi.w	$a6, $a6, 0
	addi.w	$s8, $fp, 0
	sltu	$a6, $a6, $s8
...
.LBB16_18:
	...
	lu12i.w	$t2, 15
	bgeu	$t3, $a7, .LBB16_23
# %bb.19:                               # %.preheader139.preheader
	ori	$t0, $t2, 4095
	move	$t1, $a5
	.p2align	4, , 16
.LBB16_20:                              # %.preheader139
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB16_21 Depth 2
	move	$t4, $zero
	move	$t5, $a1
	.p2align	4, , 16
.LBB16_21:                              #   Parent Loop BB16_20 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a6, $t4
	move	$t4, $t3
	bstrpick.d	$t3, $t3, 31, 1
	addi.w	$t5, $t5, -1
	bstrins.d	$t4, $a6, 63, 1
	bnez	$t5, .LBB16_21
# %bb.22:                               #   in Loop: Header=BB16_20 Depth=1
	bstrpick.d	$a6, $t4, 31, 0
	slli.d	$a6, $a6, 1
	addi.d	$t1, $t1, 1
	bstrpick.d	$t3, $t1, 15, 0
	stx.h	$t0, $a3, $a6
	bltu	$t3, $a7, .LBB16_20
.LBB16_23:                              # %.preheader138.preheader
	lu12i.w	$a6, 16
	sll.w	$a7, $a6, $a1
	slli.d	$a5, $a5, 16
	addi.w	$a0, $a0, 0
...
.LBB16_24:                              # %.split.us
	...
	addi.d	$t1, $t1, 1
	beq	$a0, $t4, .LBB16_37
.LBB16_25:                              # %.preheader138.split.us.preheader
                                        # =>This Loop Header: Depth=1
...
.LBB16_27:                              #   in Loop: Header=BB16_28 Depth=2
	addi.d	$t5, $t5, 1
	bgeu	$t5, $a4, .LBB16_24
.LBB16_28:                              # %.preheader138.split.us
...
# %bb.29:                               #   in Loop: Header=BB16_28 Depth=2
	...
	move	$t6, $a1
	.p2align	4, , 16
.LBB16_30:                              #   Parent Loop BB16_25 Depth=1
...
# %bb.31:                               # %.preheader.us.preheader
	...
	b	.LBB16_33
	.p2align	4, , 16
.LBB16_32:                              #   in Loop: Header=BB16_33 Depth=3
