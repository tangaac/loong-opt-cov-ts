...
.LBB3_106:                              # %BZ2_decompress.exit
	...
	ori	$t8, $zero, 10
	b	.LBB3_349
.LBB3_107:                              # %._crit_edge1859.i
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$t3, $s2
	ld.w	$a0, $s1, 36
	b	.LBB3_172
.LBB3_108:                              # %._crit_edge1852.i
                                        #   in Loop: Header=BB3_4 Depth=1
	st.d	$s2, $sp, 368                   # 8-byte Folded Spill
	move	$s2, $a5
	ld.w	$a0, $s1, 36
	b	.LBB3_113
.LBB3_109:                              # %._crit_edge1847.i
                                        #   in Loop: Header=BB3_4 Depth=1
	st.d	$s2, $sp, 368                   # 8-byte Folded Spill
	move	$s2, $a5
	ld.w	$a1, $s1, 36
...
# %bb.127:                              #   in Loop: Header=BB3_125 Depth=2
	...
	st.w	$a5, $a1, 16
	b	.LBB3_124
.LBB3_128:                              # %._crit_edge1900.i
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$t3, $s2
	move	$s2, $a5
	ld.w	$a0, $s1, 36
	b	.LBB3_320
.LBB3_129:                              # %._crit_edge1890.i
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$s0, $s2
	move	$s2, $a5
	ld.w	$a1, $s1, 36
	b	.LBB3_337
.LBB3_130:                              # %._crit_edge1874.i
                                        #   in Loop: Header=BB3_4 Depth=1
	ld.w	$a1, $s1, 36
	b	.LBB3_137
.LBB3_131:                              # %._crit_edge1882.i
                                        #   in Loop: Header=BB3_4 Depth=1
	ld.w	$a1, $s1, 36
	b	.LBB3_445
...
.LBB3_209:                              #   Parent Loop BB3_4 Depth=1
	...
	ldx.bu	$a1, $a2, $t2
	beqz	$a2, .LBB3_208
# %bb.210:                              # %iter.check575
                                        #   in Loop: Header=BB3_209 Depth=2
	ori	$a3, $zero, 8
	bltu	$a2, $a3, .LBB3_213
# %bb.211:                              # %vector.scevcheck569
                                        #   in Loop: Header=BB3_209 Depth=2
	addi.d	$a3, $a2, -1
	andi	$a4, $a3, 255
	bltu	$a3, $a4, .LBB3_213
...
.LBB3_215:                              # %.lr.ph1525.i
	...
	bnez	$a5, .LBB3_215
	b	.LBB3_208
.LBB3_216:                              # %vector.main.loop.iter.check577
                                        #   in Loop: Header=BB3_209 Depth=2
	bgeu	$a2, $a6, .LBB3_221
# %bb.217:                              #   in Loop: Header=BB3_209 Depth=2
	move	$a6, $zero
.LBB3_218:                              # %vec.epilog.ph593
                                        #   in Loop: Header=BB3_209 Depth=2
	andi	$a7, $a2, 248
	andi	$a5, $a2, 7
	sub.d	$a3, $a2, $a7
	...
	add.d	$a6, $a6, $t1
	add.d	$a4, $t1, $a4
.LBB3_219:                              # %vec.epilog.vector.body597
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_209 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	addi.d	$a4, $a4, -8
	bnez	$t0, .LBB3_219
# %bb.220:                              # %vec.epilog.middle.block604
                                        #   in Loop: Header=BB3_209 Depth=2
	move	$t0, $s5
	move	$t1, $s3
	beq	$a7, $a2, .LBB3_208
	b	.LBB3_214
.LBB3_221:                              # %vector.ph578
                                        #   in Loop: Header=BB3_209 Depth=2
	andi	$a5, $a2, 8
	andi	$a6, $a2, 240
	addi.d	$a7, $sp, 499
...
.LBB3_222:                              # %vector.body581
	...
	addi.d	$a3, $a3, -16
	bnez	$t0, .LBB3_222
# %bb.223:                              # %middle.block587
                                        #   in Loop: Header=BB3_209 Depth=2
	move	$t0, $s5
	move	$t1, $s3
	beq	$a6, $a2, .LBB3_208
# %bb.224:                              # %vec.epilog.iter.check591
                                        #   in Loop: Header=BB3_209 Depth=2
	bnez	$a5, .LBB3_218
...
.LBB3_230:                              # %vector.scevcheck611
	...
	move	$a1, $zero
	beq	$a2, $a3, .LBB3_205
# %bb.231:                              # %vector.scevcheck611
                                        #   in Loop: Header=BB3_4 Depth=1
	ori	$a2, $zero, 255
	bltu	$a2, $a0, .LBB3_205
# %bb.232:                              # %vector.main.loop.iter.check617
                                        #   in Loop: Header=BB3_4 Depth=1
	ori	$a0, $zero, 32
	bgeu	$t6, $a0, .LBB3_236
...
.LBB3_237:                              # %vector.body622
	...
	addi.d	$a3, $a3, 32
	bnez	$a2, .LBB3_237
# %bb.238:                              # %middle.block626
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$t6, $a0, .LBB3_206
# %bb.239:                              # %vec.epilog.iter.check631
                                        #   in Loop: Header=BB3_4 Depth=1
	beqz	$a1, .LBB3_243
.LBB3_240:                              # %vec.epilog.ph633
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a1, $t6, 504
	...
	vadd.b	$vr0, $vr0, $vr1
.LBB3_241:                              # %vec.epilog.vector.body637
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	andi	$a2, $a0, 248
	add.d	$a2, $t2, $a2
	...
	vaddi.bu	$vr0, $vr0, 8
	bne	$a1, $a0, .LBB3_241
# %bb.242:                              # %vec.epilog.middle.block644
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$t6, $a1, .LBB3_205
	b	.LBB3_206
...
.LBB3_272:                              # %.preheader68.i.thread.i
	...
	ori	$s1, $zero, 32
	b	.LBB3_287
.LBB3_273:                              # %vector.body556.preheader
                                        #   in Loop: Header=BB3_269 Depth=2
	move	$a0, $a1
...
# %bb.275:                              # %middle.block564
	...
	move	$a1, $a0
	beq	$a0, $s6, .LBB3_278
.LBB3_276:                              # %scalar.ph551.preheader
                                        #   in Loop: Header=BB3_269 Depth=2
	sub.d	$a0, $s6, $a1
	add.d	$a1, $s3, $a1
	.p2align	4, , 16
.LBB3_277:                              # %scalar.ph551
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_269 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a2, $a1, 0
...
# %bb.417:                              #   in Loop: Header=BB3_4 Depth=1
	...
	ld.d	$a5, $sp, 112                   # 8-byte Folded Reload
	b	.LBB3_349
.LBB3_418:                              # %.preheader1385.i.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a3, $zero
	ori	$a4, $zero, 4080
...
# %bb.430:                              # %.lr.ph1578.i
	...
	addi.w	$a3, $a3, -1
	b	.LBB3_432
.LBB3_431:                              #   in Loop: Header=BB3_432 Depth=2
	addi.w	$a3, $a3, -1
	ld.d	$a5, $sp, 504                   # 8-byte Folded Reload
	bge	$a0, $a5, .LBB3_436
.LBB3_432:                              #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $zero, -1
	beq	$a3, $a4, .LBB3_346
# %bb.433:                              #   in Loop: Header=BB3_432 Depth=2
	...
	st.w	$a5, $a1, 12
	bgez	$a6, .LBB3_431
# %bb.434:                              #   in Loop: Header=BB3_432 Depth=2
	ld.w	$a5, $a1, 16
	addi.d	$a5, $a5, 1
	st.w	$a5, $a1, 16
	b	.LBB3_431
.LBB3_435:                              # %.._crit_edge1579_crit_edge.i
                                        #   in Loop: Header=BB3_4 Depth=1
	ld.w	$a4, $s1, 32
	ld.d	$a5, $sp, 504                   # 8-byte Folded Reload
.LBB3_436:                              # %._crit_edge1579.i
                                        #   in Loop: Header=BB3_4 Depth=1
	sub.w	$a1, $a0, $a5
	srl.w	$a0, $a4, $a1
	addi.d	$a3, $zero, -1
...
.LBB3_445:                              #   in Loop: Header=BB3_4 Depth=1
	...
	st.w	$a0, $s1, 8
	blez	$a1, .LBB3_448
# %bb.446:                              # %.._crit_edge1611_crit_edge.i
                                        #   in Loop: Header=BB3_4 Depth=1
	ld.w	$a4, $s1, 32
.LBB3_447:                              # %._crit_edge1611.i
                                        #   in Loop: Header=BB3_4 Depth=1
	addi.w	$a1, $a1, -1
	srl.w	$a0, $a4, $a1
	andi	$t7, $a0, 1
	...
	ld.d	$s2, $sp, 504                   # 8-byte Folded Reload
	b	.LBB3_441
.LBB3_448:                              # %.lr.ph1610.i
                                        #   in Loop: Header=BB3_4 Depth=1
	ld.d	$a0, $s1, 0
	ld.w	$a3, $a0, 8
	addi.w	$a3, $a3, -1
	b	.LBB3_450
.LBB3_449:                              #   in Loop: Header=BB3_450 Depth=2
	addi.w	$a5, $a1, -8
	addi.w	$a6, $zero, -8
	addi.w	$a3, $a3, -1
	blt	$a6, $a5, .LBB3_447
.LBB3_450:                              #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $zero, -1
	beq	$a3, $a4, .LBB3_346
# %bb.451:                              #   in Loop: Header=BB3_450 Depth=2
	ld.d	$a5, $a0, 0
	ld.w	$a4, $s1, 32
	ld.bu	$a6, $a5, 0
	slli.d	$a4, $a4, 8
	...
	st.w	$a5, $a0, 12
	bgez	$a6, .LBB3_449
# %bb.452:                              #   in Loop: Header=BB3_450 Depth=2
	ld.w	$a5, $a0, 16
	addi.d	$a5, $a5, 1
	st.w	$a5, $a0, 16
	b	.LBB3_449
...
# %bb.466:                              #   in Loop: Header=BB3_4 Depth=1
	move	$s0, $a4
.LBB3_467:                              # %scalar.ph500.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a5, $s0
	slli.d	$a4, $s0, 1
	st.d	$t2, $sp, 464                   # 8-byte Folded Spill
.LBB3_468:                              # %scalar.ph500
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a7, $a1
	bge	$a5, $t1, .LBB3_477
...
# %bb.472:                              #   in Loop: Header=BB3_4 Depth=1
	move	$s0, $a4
.LBB3_473:                              # %scalar.ph489.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a5, $s0
	slli.d	$a4, $s0, 2
	st.d	$t2, $sp, 464                   # 8-byte Folded Spill
.LBB3_474:                              # %scalar.ph489
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a7, $a1
	bge	$a5, $t1, .LBB3_477
# %bb.475:                              #   in Loop: Header=BB3_474 Depth=2
	ldptr.d	$a1, $s1, 3152
	stx.w	$a3, $a1, $a4
	addi.d	$a5, $a5, 1
	addi.w	$a1, $a7, -1
...
.LBB3_476:                              #   in Loop: Header=BB3_4 Depth=1
	...
	ld.d	$t0, $sp, 40                    # 8-byte Folded Reload
	b	.LBB3_353
.LBB3_477:                              #   in Loop: Header=BB3_4 Depth=1
	...
	ld.d	$a5, $sp, 112                   # 8-byte Folded Reload
	b	.LBB3_348
.LBB3_478:                              # %unRLE_obuf_to_output_SMALL.exit.thread.loopexit887
	addi.w	$a0, $zero, -1
.LBB3_479:                              # %unRLE_obuf_to_output_SMALL.exit.thread
...
.LBB3_482:
	move	$a0, $zero
	b	.LBB3_479
.LBB3_483:                              # %vector.main.loop.iter.check
	ld.d	$s2, $sp, 312                   # 8-byte Folded Reload
	ori	$a0, $zero, 16
	bgeu	$a3, $a0, .LBB3_486
# %bb.484:                              # %vec.epilog.vector.body.preheader
	addi.w	$a0, $a6, 0
	move	$a3, $s2
.LBB3_485:                              # %vec.epilog.vector.body
	...
	addi.w	$a0, $a0, -8
	b	.LBB3_485
.LBB3_486:                              # %vector.body521.preheader
	move	$a1, $s2
.LBB3_487:                              # %vector.body521
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $a5, -1
	bstrpick.d	$a0, $a0, 31, 0
	add.d	$a0, $a1, $a0
