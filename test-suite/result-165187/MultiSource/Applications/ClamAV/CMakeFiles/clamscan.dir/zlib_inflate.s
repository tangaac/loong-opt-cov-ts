...
.LBB6_90:                               #   in Loop: Header=BB6_16 Depth=1
	move	$a2, $a3
.LBB6_91:                               # %.lr.ph1933.preheader3803
                                        #   in Loop: Header=BB6_16 Depth=1
	alsl.d	$a0, $a2, $a0, 1
	addi.d	$a1, $a2, 1
.LBB6_92:                               # %.lr.ph1933
...
# %bb.102:                              #   in Loop: Header=BB6_101 Depth=3
	...
	move	$t5, $s8
	bltu	$t4, $t0, .LBB6_101
# %bb.103:                              # %._crit_edge1946.loopexit
                                        #   in Loop: Header=BB6_99 Depth=2
	move	$t5, $s0
	b	.LBB6_105
...
.LBB6_105:                              # %._crit_edge1946
	...
	addi.d	$t4, $s5, 152
	bltu	$t2, $t1, .LBB6_107
# %bb.106:                              #   in Loop: Header=BB6_99 Depth=2
	srl.d	$fp, $fp, $t0
	sub.w	$s1, $a7, $t0
	...
	stx.h	$t1, $t4, $a7
	b	.LBB6_136
.LBB6_107:                              #   in Loop: Header=BB6_99 Depth=2
	ori	$t2, $zero, 16
	beq	$t1, $t2, .LBB6_112
# %bb.108:                              #   in Loop: Header=BB6_99 Depth=2
	ori	$t2, $zero, 17
	bne	$t1, $t2, .LBB6_115
# %bb.109:                              # %.preheader1271
                                        #   in Loop: Header=BB6_99 Depth=2
	addi.d	$t1, $t0, 3
	addi.w	$t2, $a7, 0
	bgeu	$t2, $t1, .LBB6_118
...
# %bb.117:                              #   in Loop: Header=BB6_116 Depth=3
	...
	bltu	$t1, $t2, .LBB6_116
	b	.LBB6_124
.LBB6_118:                              #   in Loop: Header=BB6_99 Depth=2
	move	$t3, $s8
.LBB6_119:                              # %._crit_edge1960
                                        #   in Loop: Header=BB6_99 Depth=2
	move	$t1, $zero
	srl.d	$t4, $fp, $t0
	andi	$t2, $t4, 7
...
.LBB6_120:                              #   in Loop: Header=BB6_99 Depth=2
	move	$s0, $s8
.LBB6_121:                              # %._crit_edge1970
                                        #   in Loop: Header=BB6_99 Depth=2
	srl.d	$fp, $fp, $t0
	sub.w	$s1, $a7, $t0
	beqz	$a6, .LBB6_377
# %bb.122:                              #   in Loop: Header=BB6_99 Depth=2
	addi.d	$a7, $a6, -1
	...
	move	$s8, $s0
	b	.LBB6_126
.LBB6_123:                              #   in Loop: Header=BB6_99 Depth=2
	move	$t3, $s8
.LBB6_124:                              # %._crit_edge1980
                                        #   in Loop: Header=BB6_99 Depth=2
	move	$t1, $zero
	srl.d	$t4, $fp, $t0
	andi	$t2, $t4, 127
...
.LBB6_132:                              #   in Loop: Header=BB6_99 Depth=2
	move	$a7, $t2
	move	$t0, $a6
.LBB6_133:                              # %.preheader.preheader3802
                                        #   in Loop: Header=BB6_99 Depth=2
	move	$a6, $t0
.LBB6_134:                              # %.preheader
                                        #   Parent Loop BB6_16 Depth=1
...
.LBB6_135:                              # %.loopexit
	...
	st.w	$t0, $s5, 140
	move	$a6, $t0
.LBB6_136:                              #   in Loop: Header=BB6_99 Depth=2
	move	$t1, $s4
	move	$t2, $s8
	bltu	$a6, $a3, .LBB6_99
...
.LBB6_387:
	...
	move	$s6, $a6
	b	.LBB6_392
.LBB6_388:                              # %..loopexit1268.loopexit4612_crit_edge
	add.d	$s8, $s8, $s0
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	st.d	$a2, $sp, 64                    # 8-byte Folded Spill
	move	$t5, $s7
...
# %bb.394:
	ori	$a0, $fp, 3922
	st.w	$a0, $s5, 8
.LBB6_395:                              # %inflateStateCheck.exit.thread.loopexit
	addi.w	$s3, $zero, -4
	b	.LBB6_409
.LBB6_396:
	beq	$s0, $ra, .LBB6_400
...
.LBB6_410:
	move	$s0, $s8
	b	.LBB6_415
.LBB6_411:                              # %.loopexit1268.loopexit2948
	move	$s4, $zero
	bstrpick.d	$a3, $a2, 31, 0
	alsl.w	$s1, $a2, $a4, 3
	add.d	$s8, $s0, $a3
...
.LBB6_415:
	...
	move	$s8, $s0
	b	.LBB6_392
.LBB6_416:                              # %.loopexit1268.loopexit3805
	ori	$a2, $zero, 1
	b	.LBB6_391
.LBB6_417:
	move	$s1, $fp
