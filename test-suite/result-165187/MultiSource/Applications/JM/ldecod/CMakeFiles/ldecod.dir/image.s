...
# %bb.0:
	...
	ld.d	$s0, $a0, %pc_lo12(dec_picture)
	lu12i.w	$a1, 77
	ori	$a1, $a1, 1520
...
# %bb.16:                               # %.preheader62
                                        #   in Loop: Header=BB0_4 Depth=1
	blez	$a2, .LBB0_2
# %bb.17:                               # %.preheader.lr.ph.split.us
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$t1, $a0, 0
	move	$t2, $zero
	alsl.d	$t3, $a5, $t1, 3
...
.LBB0_19:                               #   Parent Loop BB0_4 Depth=1
	...
	addi.d	$t8, $t8, 64
	bnez	$t7, .LBB0_19
# %bb.20:                               # %._crit_edge.us80
                                        #   in Loop: Header=BB0_18 Depth=2
	addi.d	$t2, $t2, 1
	addi.d	$t4, $t4, 2
	bne	$t2, $a2, .LBB0_18
# %bb.21:                               # %.preheader61.lr.ph.split.us.1
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$t2, $a0, 8
	move	$t1, $zero
	alsl.d	$t2, $a5, $t2, 3
...
.LBB0_23:                               #   Parent Loop BB0_4 Depth=1
	...
	addi.d	$t5, $t5, 64
	bnez	$t6, .LBB0_23
# %bb.24:                               # %._crit_edge.us.1
                                        #   in Loop: Header=BB0_22 Depth=2
	addi.d	$t1, $t1, 1
	addi.d	$t3, $t3, 2
	bne	$t1, $t0, .LBB0_22
# %bb.25:                               # %.preheader.lr.ph.split.us.1
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a6, $a0, 8
	move	$t0, $zero
	alsl.d	$a5, $a5, $a6, 3
...
.LBB4_17:                               # %.preheader.us
	...
	ldx.d	$a5, $s0, $a4
	bltu	$s1, $a3, .LBB4_20
# %bb.18:                               # %vector.memcheck207
                                        #   in Loop: Header=BB4_17 Depth=1
	add.d	$a4, $s2, $s1
	bgeu	$a5, $a4, .LBB4_23
# %bb.19:                               # %vector.memcheck207
                                        #   in Loop: Header=BB4_17 Depth=1
	add.d	$a4, $a5, $a1
	bgeu	$s2, $a4, .LBB4_23
.LBB4_20:                               #   in Loop: Header=BB4_17 Depth=1
	move	$a6, $zero
	move	$a4, $s2
.LBB4_21:                               # %scalar.ph213.preheader
                                        #   in Loop: Header=BB4_17 Depth=1
	alsl.d	$a5, $a6, $a5, 1
	sub.d	$a6, $s1, $a6
	move	$a7, $a4
	.p2align	4, , 16
.LBB4_22:                               # %scalar.ph213
	...
	b	.LBB4_16
	.p2align	4, , 16
.LBB4_23:                               # %vector.ph215
                                        #   in Loop: Header=BB4_17 Depth=1
	add.d	$a4, $s2, $a2
	move	$a6, $a5
	move	$a7, $a2
	.p2align	4, , 16
.LBB4_24:                               # %vector.body218
                                        #   Parent Loop BB4_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t0, $s2, 0
...
.LBB4_58:                               # %scalar.ph
	...
	b	.LBB4_52
	.p2align	4, , 16
.LBB4_59:                               # %vector.body200.preheader
                                        #   in Loop: Header=BB4_53 Depth=1
	move	$a7, $a5
	move	$t0, $a6
	move	$t1, $a3
	.p2align	4, , 16
.LBB4_60:                               # %vector.body200
                                        #   Parent Loop BB4_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t2, $a7, 0
...
# %bb.18:
	...
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	andi	$a1, $a1, 1
	st.d	$a6, $a0, %pc_lo12(get_block.cur_lineY)
	beqz	$a1, .LBB6_34
# %bb.19:                               # %.preheader454
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	srli.d	$a1, $a1, 1
	...
	srli.d	$a2, $a2, 1
	st.w	$a2, $a1, 60
	st.d	$t1, $a0, %pc_lo12(get_block.cur_lineY)
	b	.LBB6_34
