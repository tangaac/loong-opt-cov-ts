...
# %bb.60:                               #   in Loop: Header=BB4_53 Depth=1
	move	$t6, $zero
	b	.LBB4_65
.LBB4_61:                               # %vector.body204.preheader
                                        #   in Loop: Header=BB4_53 Depth=1
	addi.d	$t4, $t3, 16
	move	$t5, $a6
	move	$t6, $a4
	.p2align	4, , 16
.LBB4_62:                               # %vector.body204
                                        #   Parent Loop BB4_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t5, -8
	ld.d	$t8, $t5, 0
	...
	addi.d	$t5, $t5, 16
	bnez	$t6, .LBB4_62
# %bb.63:                               # %middle.block209
                                        #   in Loop: Header=BB4_53 Depth=1
	beq	$a4, $s1, .LBB4_52
# %bb.64:                               # %vec.epilog.iter.check213
                                        #   in Loop: Header=BB4_53 Depth=1
	move	$t6, $a4
	move	$t4, $a4
	beqz	$a3, .LBB4_57
.LBB4_65:                               # %vec.epilog.ph215
                                        #   in Loop: Header=BB4_53 Depth=1
	add.d	$t4, $a7, $t6
	alsl.d	$t5, $t6, $t3, 1
	add.d	$t6, $t2, $t6
	.p2align	4, , 16
.LBB4_66:                               # %vec.epilog.vector.body218
                                        #   Parent Loop BB4_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, 0
	...
	addi.d	$t6, $t6, 4
	bnez	$t4, .LBB4_66
# %bb.67:                               # %vec.epilog.middle.block222
                                        #   in Loop: Header=BB4_53 Depth=1
	move	$t4, $a5
	beq	$a5, $s1, .LBB4_52
	b	.LBB4_57
