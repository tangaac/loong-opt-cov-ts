...
# %bb.4:                                # %.preheader201
	...
	move	$t5, $a5
	.p2align	4, , 16
.LBB32_5:                               #   Parent Loop BB32_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.d	$t6, $a3, $t4
	ldx.d	$t7, $a4, $t4
	srli.d	$t8, $t6, 63
...
.LBB32_19:                              #   in Loop: Header=BB32_13 Depth=2
	...
	stx.d	$s8, $s7, $t5
	bgez	$s3, .LBB32_18
.LBB32_20:                              #   in Loop: Header=BB32_13 Depth=2
	move	$s3, $zero
...
# %bb.22:                               #   in Loop: Header=BB32_13 Depth=2
	...
	b	.LBB32_24
	.p2align	4, , 16
.LBB32_23:                              #   in Loop: Header=BB32_13 Depth=2
	move	$s4, $zero
.LBB32_24:                              #   in Loop: Header=BB32_13 Depth=2
	ld.d	$s5, $fp, 64
	add.d	$s6, $s5, $a7
	ld.d	$s6, $s6, 24
	ld.d	$ra, $s6, 0
	...
	add.d	$s7, $s5, $t0
	bltz	$s6, .LBB32_26
# %bb.25:                               #   in Loop: Header=BB32_13 Depth=2
	ld.d	$a0, $s7, 0
	ldx.d	$a0, $a0, $s1
	and	$a1, $s2, $t1
	ldx.h	$a0, $a0, $a1
	...
	b	.LBB32_27
	.p2align	4, , 16
.LBB32_26:                              #   in Loop: Header=BB32_13 Depth=2
	move	$ra, $zero
.LBB32_27:                              #   in Loop: Header=BB32_13 Depth=2
	ld.d	$s8, $s7, 24
	ld.d	$a0, $s8, 0
	ldx.d	$a0, $a0, $s0
	stx.d	$ra, $a0, $t5
	bltz	$s4, .LBB32_29
# %bb.28:                               #   in Loop: Header=BB32_13 Depth=2
	ld.d	$a0, $s7, 0
	ldx.d	$a0, $a0, $s1
	and	$a1, $s2, $t1
	ldx.h	$a0, $a0, $a1
	...
	b	.LBB32_30
	.p2align	4, , 16
.LBB32_29:                              #   in Loop: Header=BB32_13 Depth=2
	move	$ra, $zero
.LBB32_30:                              #   in Loop: Header=BB32_13 Depth=2
	ld.d	$a0, $s8, 8
	ldx.d	$a0, $a0, $s0
	addi.w	$s8, $zero, -1
	stx.d	$ra, $a0, $t5
	move	$ra, $s8
	bltz	$s6, .LBB32_32
# %bb.31:                               #   in Loop: Header=BB32_13 Depth=2
	ld.d	$a0, $s7, 0
	ldx.d	$a0, $a0, $s1
	and	$a1, $s2, $t1
	ldx.h	$a0, $a0, $a1
	...
	alsl.d	$a0, $s6, $a0, 3
	ldx.d	$ra, $a0, $t4
.LBB32_32:                              #   in Loop: Header=BB32_13 Depth=2
	ld.d	$a0, $fp, 48
	lu12i.w	$a1, 77
	ori	$a1, $a1, 1576
	ldx.d	$s6, $a0, $a1
	...
	stx.d	$ra, $a0, $t5
	bltz	$s4, .LBB32_12
# %bb.33:                               #   in Loop: Header=BB32_13 Depth=2
	ld.d	$a0, $s7, 0
	ldx.d	$a0, $a0, $s1
	and	$a1, $s2, $t1
	ldx.h	$a0, $a0, $a1
