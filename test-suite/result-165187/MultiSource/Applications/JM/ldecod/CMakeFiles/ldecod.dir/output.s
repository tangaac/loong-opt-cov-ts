...
# %bb.21:
	...
	move	$s1, $s3
	bnez	$a1, .LBB3_10
# %bb.22:                               # %.preheader135.i
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
	blez	$a4, .LBB3_18
# %bb.23:                               # %.preheader135.i
	blez	$s4, .LBB3_18
# %bb.24:                               # %.preheader134.us.preheader.i
	move	$a1, $zero
	slli.d	$a2, $a4, 1
	move	$a3, $s0
	.p2align	4, , 16
.LBB3_25:                               # %.preheader134.us.i
                                        # =>This Loop Header: Depth=1
...
# %bb.27:                               # %._crit_edge.us.i
	...
	addi.d	$a1, $a1, 1
	bne	$a1, $s4, .LBB3_25
# %bb.28:                               # %img2buf.exit.loopexit321
	ld.w	$a1, $s7, 16
	ld.w	$s4, $s7, 20
	sub.d	$s2, $a1, $a0
	b	.LBB3_18
...
.LBB3_54:                               # %.lr.ph.us.i219
	...
	move	$s8, $a4
	.p2align	4, , 16
.LBB3_55:                               #   Parent Loop BB3_54 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a0, $s0, $s7
	move	$a1, $s2
	move	$a2, $s1
...
# %bb.60:
	blt	$t5, $a0, .LBB3_95
# %bb.61:                               # %.preheader.lr.ph.split.us
	ld.d	$a2, $s1, 0
	move	$a0, $zero
	addi.d	$a1, $fp, -1
	sll.w	$a1, $s4, $a1
...
# %bb.64:                               #   in Loop: Header=BB3_63 Depth=1
	...
	b	.LBB3_74
	.p2align	4, , 16
.LBB3_65:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB3_63 Depth=1
	bgeu	$s6, $t1, .LBB3_70
# %bb.66:                               #   in Loop: Header=BB3_63 Depth=1
	move	$t4, $zero
.LBB3_67:                               # %vec.epilog.ph
                                        #   in Loop: Header=BB3_63 Depth=1
	add.d	$t3, $a7, $t4
	alsl.d	$t4, $t4, $t2, 1
	.p2align	4, , 16
.LBB3_68:                               # %vec.epilog.vector.body
...
# %bb.72:                               # %middle.block
                                        #   in Loop: Header=BB3_63 Depth=1
	beq	$a5, $a3, .LBB3_62
# %bb.73:                               # %vec.epilog.iter.check
                                        #   in Loop: Header=BB3_63 Depth=1
	move	$t4, $a5
	move	$t3, $a5
	bnez	$a4, .LBB3_67
	.p2align	4, , 16
.LBB3_74:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB3_63 Depth=1
	alsl.d	$t2, $t3, $t2, 1
	sub.d	$t3, $a3, $t3
	.p2align	4, , 16
.LBB3_75:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB3_63 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a1, $t2, 0
	addi.d	$t3, $t3, -1
...
# %bb.78:                               # %.preheader135.i200
	blez	$s2, .LBB3_85
# %bb.79:                               # %.preheader135.i200
	blez	$s6, .LBB3_85
# %bb.80:                               # %.preheader134.us.preheader.i202
	move	$a0, $zero
	slli.d	$a1, $s2, 1
	move	$a2, $s0
	.p2align	4, , 16
.LBB3_81:                               # %.preheader134.us.i205
                                        # =>This Loop Header: Depth=1
	...
	alsl.d	$a4, $a0, $a4, 3
	.p2align	4, , 16
.LBB3_82:                               #   Parent Loop BB3_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	ldx.b	$a5, $a5, $a3
	st.b	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 1
	bne	$a1, $a3, .LBB3_82
# %bb.83:                               # %._crit_edge.us.i212
                                        #   in Loop: Header=BB3_81 Depth=1
	addi.d	$a0, $a0, 1
	bne	$a0, $s6, .LBB3_81
# %bb.84:                               # %img2buf.exit226.loopexit319
	ld.w	$a0, $s7, 16
	ld.w	$s6, $s7, 20
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	sub.d	$a3, $a0, $a1
.LBB3_85:                               # %img2buf.exit226
	sub.d	$a0, $s6, $s8
	mul.d	$a0, $a0, $s3
	mul.w	$a2, $a0, $a3
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
...
.LBB3_91:                               # %.lr.ph.us.i248
	...
	move	$s6, $a1
	.p2align	4, , 16
.LBB3_92:                               #   Parent Loop BB3_91 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a0, $s0, $s7
	move	$a1, $s2
	move	$a2, $s1
...
.LBB3_100:                              # %.lr.ph.us.i277
	...
	move	$s5, $fp
	.p2align	4, , 16
.LBB3_101:                              #   Parent Loop BB3_100 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a0, $s0, $s4
	move	$a1, $s2
	move	$a2, $s1
...
# %bb.105:
	...
	move	$s1, $s3
	bnez	$a0, .LBB3_88
# %bb.106:                              # %.preheader135.i229
	blez	$s2, .LBB3_113
# %bb.107:                              # %.preheader135.i229
	blez	$s4, .LBB3_113
# %bb.108:                              # %.preheader134.us.preheader.i231
	move	$a0, $zero
	slli.d	$a1, $s2, 1
	move	$a2, $s0
	.p2align	4, , 16
.LBB3_109:                              # %.preheader134.us.i234
                                        # =>This Loop Header: Depth=1
	...
	alsl.d	$a4, $a0, $a4, 3
	.p2align	4, , 16
.LBB3_110:                              #   Parent Loop BB3_109 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a4, 0
	ldx.b	$a5, $a5, $a3
	st.b	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 1
	bne	$a1, $a3, .LBB3_110
# %bb.111:                              # %._crit_edge.us.i241
                                        #   in Loop: Header=BB3_109 Depth=1
	addi.d	$a0, $a0, 1
	bne	$a0, $s4, .LBB3_109
# %bb.112:                              # %img2buf.exit255.loopexit318
	ld.w	$a0, $s7, 16
	ld.w	$s4, $s7, 20
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	sub.d	$s6, $a0, $a1
.LBB3_113:                              # %img2buf.exit255
	sub.d	$a0, $s4, $s8
	mul.d	$a0, $a0, $s3
	mul.w	$a2, $a0, $s6
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
...
# %bb.118:
	...
	move	$s1, $s3
	bnez	$a0, .LBB3_97
# %bb.119:                              # %.preheader135.i258
	ori	$a0, $zero, 2
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
	blt	$t6, $a0, .LBB3_115
# %bb.120:                              # %.preheader135.i258
	blt	$t5, $a0, .LBB3_115
# %bb.121:                              # %.preheader134.us.preheader.i260
	move	$a0, $zero
	move	$a1, $s0
	.p2align	4, , 16
.LBB3_122:                              # %.preheader134.us.i263
                                        # =>This Loop Header: Depth=1
	...
	move	$a4, $s6
	.p2align	4, , 16
.LBB3_123:                              #   Parent Loop BB3_122 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a5, $a3, 0
	ldx.b	$a5, $a5, $a2
	st.b	$a5, $a1, 0
	...
	addi.d	$a2, $a2, 2
	bnez	$a4, .LBB3_123
# %bb.124:                              # %._crit_edge.us.i270
                                        #   in Loop: Header=BB3_122 Depth=1
	addi.d	$a0, $a0, 1
	bne	$a0, $s2, .LBB3_122
# %bb.125:                              # %img2buf.exit284.loopexit316
	ld.w	$t6, $s1, 12
	ld.w	$t5, $s1, 8
	b	.LBB3_115
.Lfunc_end3:
...
# %bb.24:                               #   in Loop: Header=BB6_21 Depth=1
	move	$t7, $zero
.LBB6_25:                               # %vec.epilog.ph97
                                        #   in Loop: Header=BB6_21 Depth=1
	add.d	$t6, $t2, $t7
	alsl.d	$t7, $t7, $t5, 1
	.p2align	4, , 16
.LBB6_26:                               # %vec.epilog.vector.body102
	...
	addi.d	$t7, $t7, 16
	bnez	$t6, .LBB6_26
# %bb.27:                               # %vec.epilog.middle.block105
                                        #   in Loop: Header=BB6_21 Depth=1
	move	$t6, $t1
	beq	$t1, $a3, .LBB6_20
	b	.LBB6_32
...
# %bb.38:                               #   in Loop: Header=BB6_37 Depth=1
	...
	b	.LBB6_48
	.p2align	4, , 16
.LBB6_39:                               # %vector.main.loop.iter.check112
                                        #   in Loop: Header=BB6_37 Depth=1
	bgeu	$a3, $t2, .LBB6_44
# %bb.40:                               #   in Loop: Header=BB6_37 Depth=1
	move	$t5, $zero
.LBB6_41:                               # %vec.epilog.ph127
                                        #   in Loop: Header=BB6_37 Depth=1
	add.d	$t4, $t0, $t5
	alsl.d	$t5, $t5, $t3, 1
	.p2align	4, , 16
.LBB6_42:                               # %vec.epilog.vector.body132
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB6_42
# %bb.43:                               # %vec.epilog.middle.block135
                                        #   in Loop: Header=BB6_37 Depth=1
	move	$t4, $a7
	beq	$a7, $a3, .LBB6_36
	b	.LBB6_48
	.p2align	4, , 16
.LBB6_44:                               # %vector.body118.preheader
                                        #   in Loop: Header=BB6_37 Depth=1
	addi.d	$t4, $t3, 16
	move	$t5, $a6
	.p2align	4, , 16
.LBB6_45:                               # %vector.body118
                                        #   Parent Loop BB6_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $t4, -16
	vst	$vr0, $t4, 0
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB6_45
# %bb.46:                               # %middle.block121
                                        #   in Loop: Header=BB6_37 Depth=1
	beq	$a6, $a3, .LBB6_36
# %bb.47:                               # %vec.epilog.iter.check125
                                        #   in Loop: Header=BB6_37 Depth=1
	move	$t5, $a6
	move	$t4, $a6
	bnez	$a5, .LBB6_41
	.p2align	4, , 16
.LBB6_48:                               # %vec.epilog.scalar.ph124.preheader
                                        #   in Loop: Header=BB6_37 Depth=1
	alsl.d	$t3, $t4, $t3, 1
	sub.d	$t4, $a3, $t4
	.p2align	4, , 16
.LBB6_49:                               # %vec.epilog.scalar.ph124
                                        #   Parent Loop BB6_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a0, $t3, 0
	addi.d	$t4, $t4, -1
...
# %bb.25:                               #   in Loop: Header=BB7_22 Depth=1
	move	$s4, $zero
.LBB7_26:                               # %vec.epilog.ph112
                                        #   in Loop: Header=BB7_22 Depth=1
	add.d	$s2, $t5, $s4
	alsl.d	$s3, $s4, $t8, 1
	.p2align	4, , 16
.LBB7_27:                               # %vec.epilog.vector.body117
	...
	addi.d	$s3, $s3, 16
	bnez	$s2, .LBB7_27
# %bb.28:                               # %vec.epilog.middle.block120
                                        #   in Loop: Header=BB7_22 Depth=1
	move	$s3, $t4
	beq	$t4, $a1, .LBB7_21
	b	.LBB7_33
...
# %bb.31:                               # %middle.block106
                                        #   in Loop: Header=BB7_22 Depth=1
	beq	$t3, $a1, .LBB7_21
# %bb.32:                               # %vec.epilog.iter.check110
                                        #   in Loop: Header=BB7_22 Depth=1
	move	$s4, $t3
	move	$s3, $t3
	bnez	$a2, .LBB7_26
...
# %bb.38:                               #   in Loop: Header=BB7_37 Depth=1
	...
	b	.LBB7_48
	.p2align	4, , 16
.LBB7_39:                               # %vector.main.loop.iter.check127
                                        #   in Loop: Header=BB7_37 Depth=1
	bgeu	$a1, $t2, .LBB7_44
# %bb.40:                               #   in Loop: Header=BB7_37 Depth=1
	move	$t6, $zero
.LBB7_41:                               # %vec.epilog.ph142
                                        #   in Loop: Header=BB7_37 Depth=1
	add.d	$t4, $t0, $t6
	alsl.d	$t5, $t6, $t3, 1
	.p2align	4, , 16
.LBB7_42:                               # %vec.epilog.vector.body147
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB7_42
# %bb.43:                               # %vec.epilog.middle.block150
                                        #   in Loop: Header=BB7_37 Depth=1
	move	$t5, $a6
	beq	$a6, $a1, .LBB7_36
	b	.LBB7_48
	.p2align	4, , 16
.LBB7_44:                               # %vector.body133.preheader
                                        #   in Loop: Header=BB7_37 Depth=1
	addi.d	$t4, $t3, 16
	move	$t5, $a5
	.p2align	4, , 16
.LBB7_45:                               # %vector.body133
                                        #   Parent Loop BB7_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $t4, -16
	vst	$vr0, $t4, 0
...
# %bb.46:                               # %middle.block136
                                        #   in Loop: Header=BB7_37 Depth=1
	beq	$a5, $a1, .LBB7_36
# %bb.47:                               # %vec.epilog.iter.check140
                                        #   in Loop: Header=BB7_37 Depth=1
	move	$t6, $a5
	move	$t5, $a5
	bnez	$a2, .LBB7_41
	.p2align	4, , 16
.LBB7_48:                               # %vec.epilog.scalar.ph139.preheader
                                        #   in Loop: Header=BB7_37 Depth=1
	sub.d	$t4, $a1, $t5
	alsl.d	$t3, $t5, $t3, 1
	.p2align	4, , 16
.LBB7_49:                               # %vec.epilog.scalar.ph139
                                        #   Parent Loop BB7_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a3, $t3, 0
	addi.d	$t4, $t4, -1
...
# %bb.57:                               #   in Loop: Header=BB7_56 Depth=1
	...
	b	.LBB7_67
	.p2align	4, , 16
.LBB7_58:                               # %vector.main.loop.iter.check157
                                        #   in Loop: Header=BB7_56 Depth=1
	bgeu	$a0, $t3, .LBB7_63
...
.LBB7_60:                               # %vec.epilog.ph172
	...
	alsl.d	$t6, $t7, $t4, 1
	.p2align	4, , 16
.LBB7_61:                               # %vec.epilog.vector.body177
	...
	addi.d	$t6, $t6, 16
	bnez	$t5, .LBB7_61
# %bb.62:                               # %vec.epilog.middle.block180
                                        #   in Loop: Header=BB7_56 Depth=1
	move	$t6, $t0
	beq	$t0, $a0, .LBB7_55
	b	.LBB7_67
	.p2align	4, , 16
.LBB7_63:                               # %vector.body163.preheader
                                        #   in Loop: Header=BB7_56 Depth=1
	addi.d	$t5, $t4, 16
	move	$t6, $a7
	.p2align	4, , 16
.LBB7_64:                               # %vector.body163
                                        #   Parent Loop BB7_56 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $t5, -16
	vst	$vr0, $t5, 0
	...
	addi.d	$t5, $t5, 32
	bnez	$t6, .LBB7_64
# %bb.65:                               # %middle.block166
                                        #   in Loop: Header=BB7_56 Depth=1
	beq	$a7, $a0, .LBB7_55
# %bb.66:                               # %vec.epilog.iter.check170
                                        #   in Loop: Header=BB7_56 Depth=1
	move	$t7, $a7
	move	$t6, $a7
	bnez	$a6, .LBB7_60
	.p2align	4, , 16
.LBB7_67:                               # %vec.epilog.scalar.ph169.preheader
                                        #   in Loop: Header=BB7_56 Depth=1
	sub.d	$t5, $a0, $t6
	alsl.d	$t4, $t6, $t4, 1
	.p2align	4, , 16
.LBB7_68:                               # %vec.epilog.scalar.ph169
                                        #   Parent Loop BB7_56 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a4, $t4, 0
	addi.d	$t5, $t5, -1
...
# %bb.74:                               #   in Loop: Header=BB7_73 Depth=1
	...
	b	.LBB7_84
	.p2align	4, , 16
.LBB7_75:                               # %vector.main.loop.iter.check187
                                        #   in Loop: Header=BB7_73 Depth=1
	bgeu	$a2, $t8, .LBB7_80
# %bb.76:                               #   in Loop: Header=BB7_73 Depth=1
	move	$s5, $zero
.LBB7_77:                               # %vec.epilog.ph202
                                        #   in Loop: Header=BB7_73 Depth=1
	add.d	$s3, $t6, $s5
	alsl.d	$s4, $s5, $s2, 1
	.p2align	4, , 16
.LBB7_78:                               # %vec.epilog.vector.body207
	...
	addi.d	$s4, $s4, 16
	bnez	$s3, .LBB7_78
# %bb.79:                               # %vec.epilog.middle.block210
                                        #   in Loop: Header=BB7_73 Depth=1
	move	$s4, $t5
	beq	$t5, $a2, .LBB7_72
	b	.LBB7_84
	.p2align	4, , 16
.LBB7_80:                               # %vector.body193.preheader
                                        #   in Loop: Header=BB7_73 Depth=1
	addi.d	$s3, $s2, 16
	move	$s4, $t4
	.p2align	4, , 16
.LBB7_81:                               # %vector.body193
                                        #   Parent Loop BB7_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s3, -16
	vst	$vr0, $s3, 0
	...
	addi.d	$s3, $s3, 32
	bnez	$s4, .LBB7_81
# %bb.82:                               # %middle.block196
                                        #   in Loop: Header=BB7_73 Depth=1
	beq	$t4, $a2, .LBB7_72
# %bb.83:                               # %vec.epilog.iter.check200
                                        #   in Loop: Header=BB7_73 Depth=1
	move	$s5, $t4
	move	$s4, $t4
	bnez	$a3, .LBB7_77
	.p2align	4, , 16
.LBB7_84:                               # %vec.epilog.scalar.ph199.preheader
                                        #   in Loop: Header=BB7_73 Depth=1
	sub.d	$s3, $a2, $s4
	alsl.d	$s2, $s4, $s2, 1
	.p2align	4, , 16
.LBB7_85:                               # %vec.epilog.scalar.ph199
                                        #   Parent Loop BB7_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$t2, $s2, 0
	addi.d	$s3, $s3, -1
...
# %bb.89:                               #   in Loop: Header=BB7_88 Depth=1
	...
	b	.LBB7_99
	.p2align	4, , 16
.LBB7_90:                               # %vector.main.loop.iter.check217
                                        #   in Loop: Header=BB7_88 Depth=1
	bgeu	$a2, $t3, .LBB7_95
# %bb.91:                               #   in Loop: Header=BB7_88 Depth=1
	move	$t7, $zero
.LBB7_92:                               # %vec.epilog.ph232
                                        #   in Loop: Header=BB7_88 Depth=1
	add.d	$t5, $t1, $t7
	alsl.d	$t6, $t7, $t4, 1
	.p2align	4, , 16
.LBB7_93:                               # %vec.epilog.vector.body237
	...
	addi.d	$t6, $t6, 16
	bnez	$t5, .LBB7_93
# %bb.94:                               # %vec.epilog.middle.block240
                                        #   in Loop: Header=BB7_88 Depth=1
	move	$t6, $a7
	beq	$a7, $a2, .LBB7_87
	b	.LBB7_99
	.p2align	4, , 16
.LBB7_95:                               # %vector.body223.preheader
                                        #   in Loop: Header=BB7_88 Depth=1
	addi.d	$t5, $t4, 16
	move	$t6, $a6
	.p2align	4, , 16
.LBB7_96:                               # %vector.body223
                                        #   Parent Loop BB7_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $t5, -16
	vst	$vr0, $t5, 0
	...
	addi.d	$t5, $t5, 32
	bnez	$t6, .LBB7_96
# %bb.97:                               # %middle.block226
                                        #   in Loop: Header=BB7_88 Depth=1
	beq	$a6, $a2, .LBB7_87
# %bb.98:                               # %vec.epilog.iter.check230
                                        #   in Loop: Header=BB7_88 Depth=1
	move	$t7, $a6
	move	$t6, $a6
	bnez	$a3, .LBB7_92
	.p2align	4, , 16
.LBB7_99:                               # %vec.epilog.scalar.ph229.preheader
                                        #   in Loop: Header=BB7_88 Depth=1
	sub.d	$t5, $a2, $t6
	alsl.d	$t4, $t6, $t4, 1
	.p2align	4, , 16
.LBB7_100:                              # %vec.epilog.scalar.ph229
                                        #   Parent Loop BB7_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.h	$a4, $t4, 0
	addi.d	$t5, $t5, -1
