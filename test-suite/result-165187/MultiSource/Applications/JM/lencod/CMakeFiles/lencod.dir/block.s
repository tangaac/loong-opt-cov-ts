...
.LBB2_2:
	...
	addi.d	$t4, $a4, %pc_lo12(dct_luma_16x16.M1)
	addi.d	$a4, $t4, 32
...
.LBB4_8:
	...
	addi.d	$a2, $a2, %pc_lo12(dct_chroma.m5)
...
.LBB4_30:                               # %.preheader780
	move	$s1, $s7
	ldptr.w	$a4, $s0, 15548
	pcalau12i	$a2, %pc_hi20(dct_chroma.m3)
	addi.d	$a3, $a2, %pc_lo12(dct_chroma.m3)
	blez	$a4, .LBB4_41
...
# %bb.42:                               # %.loopexit778
	...
	sub.d	$t2, $t3, $s5
	add.d	$t3, $t0, $a7
	pcalau12i	$t6, %pc_hi20(dct_chroma.m4)
	addi.d	$t6, $t6, %pc_lo12(dct_chroma.m4)
	st.w	$t3, $t6, 0
	sub.d	$a7, $a7, $t0
	st.w	$a7, $t6, 8
	add.d	$a7, $t1, $t2
...
.LBB4_43:
	...
	addi.d	$s5, $a2, %pc_lo12(SCAN_YUV422+1)
	addi.d	$a4, $zero, -1
	ori	$s6, $zero, 7
...
.LBB4_70:
	...
	ori	$a1, $zero, 1
	blt	$a1, $a0, .LBB4_128
.LBB4_71:                               # %._crit_edge887.thread
	beqz	$ra, .LBB4_194
.LBB4_72:                               # %.preheader
	ldptr.w	$a0, $t4, 15548
	bgtz	$a0, .LBB4_171
	b	.LBB4_215
.LBB4_73:                               # %.preheader786
	bnez	$ra, .LBB4_75
# %bb.74:                               # %.lr.ph820.split.preheader
	ld.w	$a1, $a0, 0
	ld.w	$a2, $a0, 48
	ld.w	$a3, $a0, 16
	ld.w	$a4, $a0, 32
...
.LBB4_76:                               #   in Loop: Header=BB4_78 Depth=1
	beqz	$t6, .LBB4_91
.LBB4_77:                               # %.backedge1187.backedge
                                        #   in Loop: Header=BB4_78 Depth=1
	addi.d	$t6, $t6, -1
	addi.d	$t3, $t3, 2
.LBB4_78:                               # %.backedge1187
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $t3, -1
	ld.bu	$a5, $t3, 0
	alsl.d	$a2, $a2, $a0, 4
...
.LBB4_172:                              # %._crit_edge928
	...
	addi.d	$a5, $a5, 32
	beq	$a6, $a0, .LBB4_184
.LBB4_173:                              # =>This Loop Header: Depth=1
...
# %bb.174:                              # %.lr.ph927
	...
	ldx.d	$fp, $s0, $fp
	bgeu	$a3, $t7, .LBB4_178
.LBB4_175:                              #   in Loop: Header=BB4_173 Depth=1
	move	$s2, $zero
.LBB4_176:                              # %scalar.ph1270.preheader
                                        #   in Loop: Header=BB4_173 Depth=1
	add.d	$a2, $a2, $s2
	alsl.d	$s0, $s2, $a4, 2
	alsl.d	$s1, $s2, $a5, 1
	sub.d	$s2, $a3, $s2
	.p2align	4, , 16
.LBB4_177:                              # %scalar.ph1270
                                        #   Parent Loop BB4_173 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$s3, $s0, 0
	ld.h	$s4, $s1, 0
	add.d	$s3, $s4, $s3
...
# %bb.180:                              # %vector.memcheck
	...
	add.d	$s0, $s1, $s0
	bltu	$s0, $t8, .LBB4_175
# %bb.181:                              # %vector.body1275.preheader
                                        #   in Loop: Header=BB4_173 Depth=1
	move	$s0, $t3
	move	$s1, $t2
	move	$s2, $a2
...
.LBB4_189:                              # %.split896.us
	...
	addi.d	$a7, $a7, 4
	bge	$a0, $a2, .LBB4_192
.LBB4_190:                              # %.preheader771
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a2, $s1, 3
	ld.d	$a3, $sp, 208                   # 8-byte Folded Reload
	ldx.d	$ra, $a3, $a2
	bnez	$a1, .LBB4_188
# %bb.191:                              # %.split896.us.loopexit
                                        #   in Loop: Header=BB4_190 Depth=1
...
# %bb.195:                              # %.preheader770.lr.ph
	...
	b	.LBB4_197
	.p2align	4, , 16
.LBB4_196:                              #   in Loop: Header=BB4_197 Depth=1
	addi.d	$a1, $a1, 4
	addi.d	$a3, $a3, 256
	addi.d	$a5, $a5, 128
	bge	$a1, $a6, .LBB4_201
.LBB4_197:                              # %.preheader770
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB4_199 Depth 2
	blez	$a4, .LBB4_196
# %bb.198:                              # %.preheader769.lr.ph
                                        #   in Loop: Header=BB4_197 Depth=1
	move	$a6, $zero
	move	$a7, $a5
	move	$t0, $a3
	.p2align	4, , 16
.LBB4_199:                              # %.preheader769
                                        #   Parent Loop BB4_197 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $t0, -204
	st.d	$a2, $s3, 0
	ld.d	$a4, $t0, -196
	...
	addi.d	$a7, $a7, 8
	blt	$a6, $a4, .LBB4_199
# %bb.200:                              # %._crit_edge916
                                        #   in Loop: Header=BB4_197 Depth=1
	ori	$a2, $s6, 3260
	ldx.w	$a6, $t4, $a2
	move	$t7, $s1
	b	.LBB4_196
.LBB4_201:                              # %.preheader766
	blez	$a6, .LBB4_215
# %bb.202:                              # %.lr.ph924
	ld.w	$a1, $t4, 188
	ldx.wu	$a0, $t4, $a0
...
# %bb.206:                              #   in Loop: Header=BB4_204 Depth=1
	move	$t8, $zero
.LBB4_207:                              # %scalar.ph1254.preheader
                                        #   in Loop: Header=BB4_204 Depth=1
	add.d	$t6, $t6, $t8
	alsl.d	$t7, $t8, $a3, 2
	sub.d	$t8, $a0, $t8
	.p2align	4, , 16
.LBB4_208:                              # %scalar.ph1254
...
# %bb.210:                              # %vector.scevcheck
                                        #   in Loop: Header=BB4_204 Depth=1
	bnez	$t5, .LBB4_207
# %bb.211:                              # %vector.body1259.preheader
                                        #   in Loop: Header=BB4_204 Depth=1
	move	$t7, $t6
	move	$t8, $t1
	move	$fp, $t0
	.p2align	4, , 16
.LBB4_212:                              # %vector.body1259
                                        #   Parent Loop BB4_204 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t8, -16
	vld	$vr1, $t8, 0
...
# %bb.0:
	...
	addi.d	$t0, $a4, %pc_lo12(QP_SCALE_CR)
	bltz	$a3, .LBB6_2
# %bb.1:
	ldx.bu	$t2, $t0, $t2
	ori	$a3, $zero, 171
...
# %bb.0:
	...
	bltz	$a0, .LBB11_2
# %bb.1:
	pcalau12i	$a5, %pc_hi20(QP_SCALE_CR)
	addi.d	$a5, $a5, %pc_lo12(QP_SCALE_CR)
	ldx.bu	$a0, $a5, $a0
	ori	$a5, $zero, 171
	st.d	$a0, $sp, 72                    # 8-byte Folded Spill
	mul.d	$a5, $a0, $a5
