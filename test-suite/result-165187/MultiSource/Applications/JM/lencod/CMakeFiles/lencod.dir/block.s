...
.LBB4_175:                              #   in Loop: Header=BB4_173 Depth=1
	move	$s0, $zero
.LBB4_176:                              # %scalar.ph1269.preheader
                                        #   in Loop: Header=BB4_173 Depth=1
	add.d	$a2, $a2, $s0
	slli.d	$t8, $s0, 2
	slli.d	$fp, $s0, 1
...
# %bb.180:                              # %vector.memcheck
	...
	add.d	$t8, $fp, $t8
	bltu	$t8, $t6, .LBB4_175
# %bb.181:                              # %vector.body1274.preheader
                                        #   in Loop: Header=BB4_173 Depth=1
	move	$t8, $a2
	move	$fp, $a4
	move	$s0, $a5
