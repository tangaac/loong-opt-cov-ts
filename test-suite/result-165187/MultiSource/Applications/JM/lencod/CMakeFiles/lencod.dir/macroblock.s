...
# %bb.56:                               # %.preheader251
	...
	vld	$vr9, $a0, %pc_lo12(.LCPI38_0)
	vadd.w	$vr1, $vr8, $vr7
	vshuf4i.w	$vr2, $vr1, 27
	vadd.w	$vr10, $vr2, $vr1
	vsub.w	$vr2, $vr2, $vr1
	vori.b	$vr11, $vr9, 0
	...
	vshuf4i.d	$vr10, $vr2, 12
	vadd.w	$vr12, $vr10, $vr11
	vsub.w	$vr10, $vr10, $vr11
	vori.b	$vr2, $vr1, 0
	vshuf.w	$vr2, $vr12, $vr10
	vsub.w	$vr3, $vr3, $vr6
	vsub.w	$vr4, $vr4, $vr5
	vadd.w	$vr5, $vr3, $vr4
