...
# %bb.20:                               # %.loopexit.loopexit
	...
	jirl	$ra, $ra, 0
	b	.LBB8_35
.LBB8_21:                               # %.preheader159.preheader
	alsl.d	$s3, $a5, $t4, 1
	slli.d	$a0, $t4, 5
	bstrins.d	$a0, $t3, 4, 4
	lu12i.w	$a1, 3
...
.LBB8_31:                               #   in Loop: Header=BB8_26 Depth=2
	...
	bne	$a0, $a2, .LBB8_25
	b	.LBB8_27
.LBB8_32:                               #   in Loop: Header=BB8_26 Depth=2
	move	$a0, $fp
	move	$a1, $s0
...
.LBB17_124:                             # %.preheader451
	...
	beqz	$a0, .LBB17_131
	b	.LBB17_140
.LBB17_125:                             # %vector.body816.preheader
                                        #   in Loop: Header=BB17_27 Depth=1
	addi.d	$a0, $sp, 492
	move	$a1, $s5
	move	$a2, $t2
...
.LBB17_126:                             # %vector.body816
	...
	addi.d	$a0, $a0, 48
	bnez	$a1, .LBB17_126
# %bb.127:                              # %middle.block819
                                        #   in Loop: Header=BB17_27 Depth=1
	move	$a2, $s5
	beq	$s5, $t0, .LBB17_130
.LBB17_128:                             # %.lr.ph492.preheader825
                                        #   in Loop: Header=BB17_27 Depth=1
	alsl.d	$a0, $a2, $t1, 1
	sub.d	$a1, $t0, $a2
	slli.d	$a3, $a2, 4
...
.LBB17_132:                             # %._crit_edge495.us
	...
	addi.d	$a1, $a1, 2
	beq	$a0, $ra, .LBB17_140
.LBB17_133:                             # %.preheader449.us
                                        #   Parent Loop BB17_27 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_136 Depth 3
                                        #       Child Loop BB17_139 Depth 3
	ld.d	$a3, $sp, 392                   # 8-byte Folded Reload
	bgeu	$a3, $t3, .LBB17_135
# %bb.134:                              #   in Loop: Header=BB17_133 Depth=2
	move	$a5, $zero
	b	.LBB17_138
	.p2align	4, , 16
.LBB17_135:                             # %vector.body805.preheader
                                        #   in Loop: Header=BB17_133 Depth=2
	move	$a3, $s5
	move	$a4, $a2
	move	$a5, $t2
	.p2align	4, , 16
.LBB17_136:                             # %vector.body805
                                        #   Parent Loop BB17_27 Depth=1
	...
	addi.d	$a4, $a4, 64
	bnez	$a3, .LBB17_136
# %bb.137:                              # %middle.block808
                                        #   in Loop: Header=BB17_133 Depth=2
	move	$a5, $s5
	beq	$s5, $t0, .LBB17_132
.LBB17_138:                             # %scalar.ph800.preheader
                                        #   in Loop: Header=BB17_133 Depth=2
	alsl.d	$a3, $a5, $t1, 1
	slli.d	$a4, $a5, 5
	add.d	$a4, $a1, $a4
...
.LBB17_139:                             # %scalar.ph800
	...
	b	.LBB17_132
	.p2align	4, , 16
.LBB17_140:                             # %._crit_edge497
                                        #   in Loop: Header=BB17_27 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	beqz	$a0, .LBB17_26
# %bb.141:                              #   in Loop: Header=BB17_27 Depth=1
	ld.w	$a0, $sp, 444
	slli.d	$a0, $a0, 3
	ld.w	$a1, $sp, 440
	ldx.d	$a2, $s0, $a0
	...
	mul.d	$a1, $a1, $a3
	blt	$a3, $t3, .LBB17_149
# %bb.142:                              # %.lr.ph501.preheader
                                        #   in Loop: Header=BB17_27 Depth=1
	bne	$a3, $t3, .LBB17_144
# %bb.143:                              #   in Loop: Header=BB17_27 Depth=1
	move	$a6, $zero
	b	.LBB17_147
.LBB17_144:                             # %vector.body790.preheader
                                        #   in Loop: Header=BB17_27 Depth=1
	move	$a3, $zero
	ori	$a4, $zero, 2
...
# %bb.146:                              # %middle.block795
	...
	ori	$t3, $zero, 2
	beq	$a4, $a3, .LBB17_149
.LBB17_147:                             # %.lr.ph501.preheader824
                                        #   in Loop: Header=BB17_27 Depth=1
	slli.d	$a4, $a6, 1
...
.LBB17_152:                             # %._crit_edge508
	...
	ld.d	$a4, $sp, 392                   # 8-byte Folded Reload
	blez	$a4, .LBB17_26
# %bb.153:                              #   in Loop: Header=BB17_27 Depth=1
	alsl.d	$a2, $a2, $a2, 2
	...
	bgtz	$s2, .LBB17_160
	b	.LBB17_26
.LBB17_154:                             # %vector.body778.preheader
                                        #   in Loop: Header=BB17_27 Depth=1
	move	$a4, $zero
	ori	$a5, $zero, 2
...
# %bb.156:                              # %middle.block782
	...
	beq	$a5, $a4, .LBB17_159
.LBB17_157:                             # %.lr.ph507.preheader823
                                        #   in Loop: Header=BB17_27 Depth=1
	slli.d	$a5, $a7, 1
	ld.d	$a4, $sp, 96                    # 8-byte Folded Reload
	alsl.d	$a4, $a7, $a4, 1
...
.LBB17_164:                             # %vector.ph
	...
	vld	$vr2, $t0, %pc_lo12(.LCPI17_0)
	pcalau12i	$t0, %pc_hi20(.LCPI17_1)
	vld	$vr3, $t0, %pc_lo12(.LCPI17_1)
	mul.d	$a7, $a7, $a2
	add.d	$a7, $a5, $a7
	vreplgr2vr.w	$vr4, $a7
	move	$a7, $a0
...
.LBB17_187:                             #   in Loop: Header=BB17_177 Depth=1
	...
	bnez	$a0, .LBB17_174
# %bb.188:                              # %.preheader433.lr.ph.us.us.preheader
                                        #   in Loop: Header=BB17_177 Depth=1
	move	$a0, $zero
	move	$s8, $zero
	ori	$a2, $zero, 1
	.p2align	4, , 16
.LBB17_189:                             # %.preheader433.lr.ph.us.us
	...
	add.d	$s5, $a1, $a0
	.p2align	4, , 16
.LBB17_190:                             # %.preheader433.us.us.us
                                        #   Parent Loop BB17_177 Depth=1
	...
	.p2align	4, , 16
.LBB17_191:                             # %.preheader432.us.us.us
                                        #   Parent Loop BB17_177 Depth=1
                                        #     Parent Loop BB17_189 Depth=2
...
# %bb.192:                              # %._crit_edge524.us.us.us
	...
	ld.d	$a0, $sp, 392                   # 8-byte Folded Reload
	blt	$a2, $a0, .LBB17_190
# %bb.193:                              # %._crit_edge528.split.us.us.us
...
# %bb.0:
	...
	st.d	$s8, $sp, 104                   # 8-byte Folded Spill
	ori	$a4, $zero, 7
	bltu	$a4, $a0, .LBB35_100
# %bb.1:
	pcalau12i	$a4, %got_pc_hi20(img)
	ld.d	$s8, $a4, %got_pc_lo12(img)
	ld.d	$a6, $s8, 0
	ld.w	$a5, $a6, 12
	ldptr.d	$a7, $a6, 14224
	ldptr.d	$a4, $a6, 14216
...
.LBB35_40:
	move	$a0, $zero
	b	.LBB35_16
.LBB35_41:                              # %.thread..thread234.loopexit_crit_edge
	addi.w	$a1, $s3, -1
.LBB35_42:                              # %.thread234
	st.d	$a1, $sp, 40                    # 8-byte Folded Spill
.LBB35_43:                              # %.thread234
...
.LBB35_67:                              # %.lr.ph268
	...
	sub.w	$a6, $a7, $a6
	bgeu	$a6, $a4, .LBB35_99
# %bb.68:                               #   in Loop: Header=BB35_67 Depth=1
...
.LBB35_84:                              # %.lr.ph276.peel.next
	...
	b	.LBB35_87
	.p2align	4, , 16
.LBB35_85:                              #   in Loop: Header=BB35_87 Depth=1
	move	$a1, $s1
	ld.d	$a2, $sp, 56                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(writeSyntaxElement_Level_VLCN)
	jirl	$ra, $ra, 0
.LBB35_86:                              #   in Loop: Header=BB35_87 Depth=1
	srai.d	$a0, $fp, 31
	xor	$a1, $fp, $a0
	slli.d	$a2, $s1, 2
	ldx.w	$a2, $s2, $a2
...
.LBB35_87:                              # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a0, $sp, 64
	bnez	$s1, .LBB35_85
# %bb.88:                               #   in Loop: Header=BB35_87 Depth=1
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	move	$a2, $a3
	pcaddu18i	$ra, %call36(writeSyntaxElement_Level_VLC1)
	jirl	$ra, $ra, 0
...
.LBB35_91:                              # %.lr.ph284
	ori	$s1, $zero, 2
	blt	$s3, $s1, .LBB35_97
# %bb.92:                               # %.lr.ph284.split.preheader
	addi.d	$s2, $fp, 1
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	alsl.d	$s5, $fp, $a0, 2
	ori	$s6, $zero, 7
	b	.LBB35_94
	.p2align	4, , 16
.LBB35_93:                              #   in Loop: Header=BB35_94 Depth=1
	addi.d	$s2, $s2, -1
	addi.d	$s5, $s5, -4
	move	$s3, $a0
	blez	$s2, .LBB35_98
.LBB35_94:                              # %.lr.ph284.split
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$fp, $s5, 0
	st.w	$fp, $sp, 68
	st.w	$s4, $sp, 64
	beqz	$s7, .LBB35_98
# %bb.95:                               #   in Loop: Header=BB35_94 Depth=1
	ori	$a0, $zero, 1
	blt	$s3, $s1, .LBB35_93
# %bb.96:                               #   in Loop: Header=BB35_94 Depth=1
	slti	$a0, $s7, 7
	masknez	$a1, $s6, $a0
	maskeqz	$a0, $s7, $a0
	or	$a0, $a0, $a1
...
.LBB38_55:                              # %.preheader247
	...
	addi.w	$a1, $zero, -256
	.p2align	4, , 16
.LBB38_56:                              #   Parent Loop BB38_41 Depth=1
...
# %bb.58:                               # %.preheader251
	...
	srai.d	$a1, $a1, 2
	ld.w	$a5, $sp, 712
	bstrpick.d	$a2, $a4, 62, 61
	add.w	$a2, $a4, $a2
	srai.d	$a2, $a2, 2
	bstrpick.d	$a4, $a5, 62, 61
	ld.w	$a6, $sp, 524
	add.w	$a4, $a5, $a4
	srai.d	$a5, $a4, 2
	ld.w	$t0, $sp, 588
	bstrpick.d	$a4, $a6, 62, 61
	add.w	$a4, $a6, $a4
	srai.d	$a4, $a4, 2
	...
	srai.d	$a6, $a6, 2
	ld.w	$t2, $sp, 716
	bstrpick.d	$t0, $t1, 62, 61
	add.w	$t0, $t1, $t0
	srai.d	$t0, $t0, 2
	bstrpick.d	$t1, $t2, 62, 61
	ld.w	$t3, $sp, 528
	add.w	$t1, $t2, $t1
	srai.d	$t2, $t1, 2
	ld.w	$t4, $sp, 592
	bstrpick.d	$t1, $t3, 62, 61
	add.w	$t1, $t3, $t1
	srai.d	$t1, $t1, 2
	bstrpick.d	$t3, $t4, 62, 61
	ld.w	$t5, $sp, 656
	add.w	$t3, $t4, $t3
	srai.d	$t3, $t3, 2
	ld.w	$t4, $sp, 720
	...
	add.w	$t5, $t5, $t6
	srai.d	$t5, $t5, 2
	bstrpick.d	$t6, $t4, 62, 61
	ld.w	$s6, $sp, 532
	add.w	$t4, $t4, $t6
	srai.d	$t4, $t4, 2
	ld.w	$t6, $sp, 596
	bstrpick.d	$t7, $s6, 62, 61
	add.w	$t7, $s6, $t7
	srai.d	$t7, $t7, 2
	bstrpick.d	$s6, $t6, 62, 61
	ld.w	$t8, $sp, 660
	add.w	$t6, $t6, $s6
	srai.d	$t6, $t6, 2
	ld.w	$s6, $sp, 724
	...
	ld.d	$t1, $sp, 80                    # 8-byte Folded Reload
	bge	$a0, $a1, .LBB38_40
# %bb.59:                               #   in Loop: Header=BB38_41 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	st.w	$a3, $a1, 0
	st.d	$a0, $sp, 72                    # 8-byte Folded Spill
	b	.LBB38_40
