...
# %bb.6:                                # %.preheader
	...
	bge	$a1, $a0, .LBB34_8
	b	.LBB34_34
.LBB34_7:                               # %.preheader167..preheader_crit_edge
	ld.d	$t1, $fp, 48
	ldptr.w	$a1, $t1, 6396
	ori	$a0, $zero, 4
	blt	$a1, $a0, .LBB34_34
...
.LBB34_19:                              #   in Loop: Header=BB34_13 Depth=2
	...
	stx.d	$t6, $t5, $a4
	bgez	$t1, .LBB34_18
.LBB34_20:                              #   in Loop: Header=BB34_13 Depth=2
	move	$t5, $zero
.LBB34_21:                              #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t1, $fp, 40
	ldptr.d	$t3, $t1, 6504
	ld.d	$t6, $t3, 0
	ldx.d	$t6, $t6, $a7
	stx.d	$t5, $t6, $a4
	bltz	$t2, .LBB34_23
# %bb.22:                               #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t2, $t4, 1872
	b	.LBB34_24
	.p2align	4, , 16
.LBB34_23:                              #   in Loop: Header=BB34_13 Depth=2
	move	$t2, $zero
.LBB34_24:                              #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t4, $fp, 56
	ldptr.d	$t5, $t4, 6512
	ld.d	$t6, $t5, 0
	ldptr.d	$t7, $t1, 6512
	...
	alsl.d	$t3, $t1, $t4, 3
	bltz	$t1, .LBB34_26
# %bb.25:                               #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t6, $t3, 24
	b	.LBB34_27
	.p2align	4, , 16
.LBB34_26:                              #   in Loop: Header=BB34_13 Depth=2
	move	$t6, $zero
.LBB34_27:                              #   in Loop: Header=BB34_13 Depth=2
	ldptr.d	$t5, $t4, 6504
	ld.d	$t7, $t5, 0
	ldx.d	$t7, $t7, $t0
	stx.d	$t6, $t7, $a4
	alsl.d	$t4, $t2, $t4, 3
	bltz	$t2, .LBB34_29
# %bb.28:                               #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t6, $t4, 288
	b	.LBB34_30
	.p2align	4, , 16
.LBB34_29:                              #   in Loop: Header=BB34_13 Depth=2
	move	$t6, $zero
.LBB34_30:                              #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t5, $t5, 8
	ldx.d	$t7, $t5, $t0
	addi.w	$t5, $zero, -1
	stx.d	$t6, $t7, $a4
	move	$t6, $t5
	bltz	$t1, .LBB34_32
# %bb.31:                               #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t6, $t3, 1608
.LBB34_32:                              #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t1, $fp, 40
	ldptr.d	$t1, $t1, 6504
	ld.d	$t3, $t1, 0
	ldx.d	$t3, $t3, $a6
	stx.d	$t6, $t3, $a4
	bltz	$t2, .LBB34_12
# %bb.33:                               #   in Loop: Header=BB34_13 Depth=2
	ld.d	$t5, $t4, 1872
	b	.LBB34_12
.LBB34_34:                              # %._crit_edge175
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ld.d	$ra, $sp, 24                    # 8-byte Folded Reload
	addi.d	$sp, $sp, 32
