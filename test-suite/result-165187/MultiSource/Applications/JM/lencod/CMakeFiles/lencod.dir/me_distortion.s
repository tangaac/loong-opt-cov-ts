...
.LBB15_19:                              # %.loopexit74.split.us
	st.d	$a7, $s1, %pc_lo12(ref2_line)
	st.d	$a6, $s0, %pc_lo12(ref1_line)
	st.d	$a4, $s8, %pc_lo12(src_line)
	b	.LBB15_34
