...
.LBB4_26:                               # %.loopexit553
	...
	move	$fp, $zero
	pcalau12i	$s8, %pc_hi20(img_padded_size_x)
	vrepli.b	$vr12, 0
...
.LBB4_38:                               # %.preheader548
	...
	ld.w	$a5, $s8, %pc_lo12(img_padded_size_x)
...
.LBB4_79:                               # %.preheader549
                                        ...
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_80 Depth 3
	ld.w	$a3, $s8, %pc_lo12(img_padded_size_x)
	move	$t2, $zero
	move	$t3, $zero
	move	$a4, $zero
	move	$a5, $zero
...
# %bb.83:                               # %.preheader551.preheader
	...
	slli.d	$a0, $a0, 3
	pcalau12i	$a1, %got_pc_hi20(get_crline)
	ld.d	$s1, $a1, %got_pc_lo12(get_crline)
	ldx.d	$a3, $s1, $a0
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 8
	ld.d	$a1, $sp, 192                   # 8-byte Folded Reload
...
# %bb.87:                               # %.preheader545.lr.ph
	...
	ld.w	$t3, $a5, %pc_lo12(img_cr_padded_size_x)
	blez	$a7, .LBB4_118
...
.LBB4_93:                               # %vector.body1250
	...
	addi.d	$s0, $s0, 4
	bnez	$s3, .LBB4_93
# %bb.94:                               # %middle.block1261
                                        #   in Loop: Header=BB4_90 Depth=3
	add.d	$t1, $fp, $t1
	move	$fp, $t7
	beq	$t5, $t4, .LBB4_97
.LBB4_95:                               # %scalar.ph1244.preheader
                                        #   in Loop: Header=BB4_90 Depth=3
	move	$a0, $s2
	move	$s0, $t8
	.p2align	4, , 16
.LBB4_96:                               # %scalar.ph1244
                                        #   Parent Loop BB4_28 Depth=1
                                        #     Parent Loop BB4_86 Depth=2
                                        #       Parent Loop BB4_90 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB4_100:                              # %vector.body1226
	...
	addi.d	$s2, $s2, 4
	bnez	$s3, .LBB4_100
# %bb.101:                              # %middle.block1237
                                        #   in Loop: Header=BB4_90 Depth=3
	add.d	$t0, $a0, $t0
	move	$a0, $t7
	beq	$t5, $t4, .LBB4_104
.LBB4_102:                              # %.lr.ph593.us.preheader1275
                                        #   in Loop: Header=BB4_90 Depth=3
	move	$t8, $s0
	move	$s2, $fp
	.p2align	4, , 16
...
.LBB4_107:                              # %vector.body1202
	...
	addi.d	$s0, $s0, 4
	bnez	$s3, .LBB4_107
# %bb.108:                              # %middle.block1213
                                        #   in Loop: Header=BB4_90 Depth=3
	add.d	$a6, $s2, $a6
	move	$s2, $t7
	beq	$t5, $t4, .LBB4_111
.LBB4_109:                              # %.lr.ph601.us.preheader1274
                                        #   in Loop: Header=BB4_90 Depth=3
	move	$fp, $t8
	move	$s0, $a0
	.p2align	4, , 16
...
.LBB4_114:                              # %vector.body1178
	...
	addi.d	$t8, $t8, 4
	bnez	$s3, .LBB4_114
# %bb.115:                              # %middle.block1189
                                        #   in Loop: Header=BB4_90 Depth=3
	add.d	$a5, $s2, $a5
	move	$s2, $t7
	beq	$t5, $t4, .LBB4_89
.LBB4_116:                              # %.lr.ph609.us.preheader1273
                                        #   in Loop: Header=BB4_90 Depth=3
	move	$a0, $s0
	move	$t8, $fp
	.p2align	4, , 16
...
.LBB4_130:                              # %vector.body1154
	...
	addi.d	$s0, $s0, 4
	bnez	$s2, .LBB4_130
# %bb.131:                              # %middle.block1165
                                        #   in Loop: Header=BB4_127 Depth=3
	add.d	$t1, $s1, $t1
	move	$s1, $t7
	beq	$t5, $t4, .LBB4_134
.LBB4_132:                              # %scalar.ph1148.preheader
                                        #   in Loop: Header=BB4_127 Depth=3
	move	$a0, $fp
	move	$s0, $t8
	.p2align	4, , 16
.LBB4_133:                              # %scalar.ph1148
                                        #   Parent Loop BB4_28 Depth=1
                                        #     Parent Loop BB4_123 Depth=2
                                        #       Parent Loop BB4_127 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
