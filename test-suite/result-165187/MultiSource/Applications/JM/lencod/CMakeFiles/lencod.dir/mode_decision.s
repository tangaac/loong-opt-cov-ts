...
# %bb.66:                               # %middle.block
	beq	$a3, $a1, .LBB2_69
.LBB2_67:                               # %.thread176.preheader280
	alsl.d	$a2, $a3, $a2, 3
	.p2align	4, , 16
.LBB2_68:                               # %.thread176
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.77:
	move	$a2, $zero
	b	.LBB2_81
.LBB2_78:                               # %vector.ph268
	bstrpick.d	$a2, $a0, 30, 1
	slli.d	$a2, $a2, 1
	addi.d	$a3, $a1, 8
	move	$a4, $a2
	.p2align	4, , 16
.LBB2_79:                               # %vector.body271
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a3, -8
	ld.d	$a6, $a3, 0
	stptr.w	$zero, $a5, 6424
	...
	addi.d	$a3, $a3, 16
	bnez	$a4, .LBB2_79
# %bb.80:                               # %middle.block274
	beq	$a2, $a0, .LBB2_83
.LBB2_81:                               # %.thread176.1.preheader277
	alsl.d	$a1, $a2, $a1, 3
	.p2align	4, , 16
.LBB2_82:                               # %.thread176.1
                                        # =>This Inner Loop Header: Depth=1
