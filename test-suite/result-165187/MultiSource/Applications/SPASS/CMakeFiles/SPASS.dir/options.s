...
# %bb.220:                              # %.lr.ph62.i271.i.i
                                        #   in Loop: Header=BB14_218 Depth=1
	bltu	$t0, $a4, .LBB14_223
# %bb.221:                              # %vector.memcheck376
                                        #   in Loop: Header=BB14_218 Depth=1
	alsl.d	$a7, $a5, $s8, 3
	add.d	$t1, $a6, $t0
	alsl.d	$t2, $t1, $s8, 3
	alsl.d	$t1, $a6, $s8, 3
	bgeu	$a7, $t2, .LBB14_236
# %bb.222:                              # %vector.memcheck376
                                        #   in Loop: Header=BB14_218 Depth=1
	add.d	$t2, $a5, $t0
	alsl.d	$t2, $t2, $s8, 3
	bgeu	$t1, $t2, .LBB14_236
.LBB14_223:                             #   in Loop: Header=BB14_218 Depth=1
	move	$t2, $zero
.LBB14_224:                             # %scalar.ph382.preheader
                                        #   in Loop: Header=BB14_218 Depth=1
	sub.d	$a7, $t0, $t2
	slli.d	$t1, $t2, 3
	alsl.d	$t0, $a6, $t1, 3
...
# %bb.227:                              # %.lr.ph.preheader.i261.i.i
                                        #   in Loop: Header=BB14_218 Depth=1
	bltu	$a7, $a4, .LBB14_230
# %bb.228:                              # %vector.memcheck395
                                        #   in Loop: Header=BB14_218 Depth=1
	alsl.d	$t1, $a5, $s8, 3
	alsl.d	$t0, $a7, $a3, 3
	bgeu	$t1, $t0, .LBB14_239
# %bb.229:                              # %vector.memcheck395
                                        #   in Loop: Header=BB14_218 Depth=1
	add.d	$t0, $a5, $a7
	alsl.d	$t0, $t0, $s8, 3
	bgeu	$a3, $t0, .LBB14_239
...
# %bb.235:                              # %._crit_edge63.i258.i.i
	...
	blt	$a5, $a1, .LBB14_218
	b	.LBB14_243
.LBB14_236:                             # %vector.ph384
                                        #   in Loop: Header=BB14_218 Depth=1
	bstrpick.d	$t2, $t0, 30, 1
	slli.d	$t2, $t2, 1
	move	$t3, $t2
	.p2align	4, , 16
.LBB14_237:                             # %vector.body387
                                        #   Parent Loop BB14_218 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t1, 0
	vld	$vr1, $a7, 0
	...
	addi.d	$a7, $a7, 16
	bnez	$t3, .LBB14_237
# %bb.238:                              # %middle.block392
                                        #   in Loop: Header=BB14_218 Depth=1
	beq	$t2, $t0, .LBB14_234
	b	.LBB14_224
.LBB14_239:                             # %vector.ph404
                                        #   in Loop: Header=BB14_218 Depth=1
	bstrpick.d	$t0, $a7, 30, 1
	slli.d	$t0, $t0, 1
	move	$t2, $a3
	move	$t3, $t0
	.p2align	4, , 16
.LBB14_240:                             # %vector.body407
                                        #   Parent Loop BB14_218 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t2, 0
	vld	$vr1, $t1, 0
