...
# %bb.21:                               # %.thread
	...
	addi.d	$a0, $t3, 88
	beqz	$a1, .LBB5_42
# %bb.22:                               # %.lr.ph61.i.split.preheader
	move	$s1, $zero
	ld.d	$a3, $t3, 96
	addi.d	$s2, $t3, 96
	bstrpick.d	$a1, $a4, 31, 0
...
.LBB5_36:
	...
	addi.d	$a0, $t3, 88
	beqz	$a2, .LBB5_42
# %bb.37:                               # %.lr.ph61.i.split.us.preheader
	ld.d	$a3, $t3, 96
	move	$s1, $zero
	...
	b	.LBB5_39
	.p2align	4, , 16
.LBB5_38:                               # %.loopexit.i.us
                                        #   in Loop: Header=BB5_39 Depth=1
	addi.d	$s1, $s1, 1
	addi.d	$a4, $a4, 8
	beq	$a1, $s1, .LBB5_47
.LBB5_39:                               # %.lr.ph61.i.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a4, 0
	ld.d	$a6, $a5, 8
	bnez	$a6, .LBB5_38
# %bb.40:                               #   in Loop: Header=BB5_39 Depth=1
	ld.w	$a5, $a5, 16
	bnez	$a5, .LBB5_38
# %bb.41:                               # %.preheader._crit_edge.i
	ld.d	$a1, $fp, 24
	bnez	$a1, .LBB5_30
	b	.LBB5_32
.LBB5_42:                               # %.._crit_edge62_crit_edge.i
	ld.d	$a3, $t3, 96
	move	$a2, $zero
.LBB5_43:                               # %._crit_edge62.i
	st.w	$a2, $fp, 0
	beqz	$a3, .LBB5_51
# %bb.44:
	addi.d	$a1, $t3, 104
