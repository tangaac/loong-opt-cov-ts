...
# %bb.98:                               #   in Loop: Header=BB2_4 Depth=1
	...
	ori	$s4, $zero, 1
	b	.LBB2_42
.LBB2_99:                               # %forlist.exit.i.loopexit
                                        #   in Loop: Header=BB2_4 Depth=1
	addi.w	$s7, $s1, -3
.LBB2_100:                              # %forlist.exit.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 267
	beq	$a0, $a1, .LBB2_102
...
.LBB2_116:                              # %vector.body240
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_116
# %bb.117:                              # %middle.block244
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_120
.LBB2_118:                              # %scalar.ph235.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_119:                              # %scalar.ph235
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_119
.LBB2_120:                              # %._crit_edge.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_121:                              # %removevars.exit.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s1, 13
	beqz	$a0, .LBB2_123
...
.LBB2_127:                              # %vector.body228
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_127
# %bb.128:                              # %middle.block232
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_131
.LBB2_129:                              # %scalar.ph223.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_130:                              # %scalar.ph223
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_130
.LBB2_131:                              # %._crit_edge.i.i.i52
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_132:                              # %removevars.exit.i.i46
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_134
...
.LBB2_143:                              # %vector.body288
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_143
# %bb.144:                              # %middle.block292
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_147
.LBB2_145:                              # %scalar.ph283.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_146:                              # %scalar.ph283
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_146
.LBB2_147:                              # %._crit_edge.i.i28.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_148:                              # %removevars.exit.i23.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_150
...
# %bb.152:                              #   in Loop: Header=BB2_4 Depth=1
	...
	pcaddu18i	$ra, %call36(luaK_exp2nextreg)
	jirl	$ra, $ra, 0
.LBB2_153:                              #   in Loop: Header=BB2_4 Depth=1
	blez	$s4, .LBB2_155
...
.LBB2_158:                              # %vector.body300
	...
	addi.d	$a7, $a7, 4
	bnez	$t0, .LBB2_158
# %bb.159:                              # %middle.block304
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s6, $zero, 19
	ori	$s5, $zero, 59
	beq	$a6, $a5, .LBB2_162
.LBB2_160:                              # %scalar.ph295.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_169:                              # %vector.body252
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_169
# %bb.170:                              # %middle.block256
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_200
.LBB2_171:                              # %scalar.ph247.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_172:                              # %scalar.ph247
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_177:                              # %scalar.ph
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_177
.LBB2_178:                              # %._crit_edge.i.i86
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_179:                              # %removevars.exit.i81
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s1, 13
	beqz	$a0, .LBB2_181
...
.LBB2_184:                              # %vector.body276
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_184
# %bb.185:                              # %middle.block280
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_188
.LBB2_186:                              # %scalar.ph271.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_187:                              # %scalar.ph271
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_187
.LBB2_188:                              # %._crit_edge.i.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_189:                              # %removevars.exit.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_191
...
.LBB2_196:                              # %vector.body264
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_196
# %bb.197:                              # %middle.block268
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_200
.LBB2_198:                              # %scalar.ph259.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_199:                              # %scalar.ph259
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_199
.LBB2_200:                              # %._crit_edge.i.i.i40
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_201:                              # %removevars.exit.i.i35
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_203
