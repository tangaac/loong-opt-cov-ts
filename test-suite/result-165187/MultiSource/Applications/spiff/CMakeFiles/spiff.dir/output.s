...
# %bb.11:                               #   in Loop: Header=BB1_9 Depth=2
	...
	b	.LBB1_20
	.p2align	4, , 16
.LBB1_12:                               # %.preheader201.preheader
                                        #   in Loop: Header=BB1_6 Depth=1
	move	$a0, $s2
	.p2align	4, , 16
.LBB1_13:                               # %.preheader201
...
# %bb.46:                               #   in Loop: Header=BB1_6 Depth=1
	...
	blt	$s0, $s3, .LBB1_52
	b	.LBB1_92
.LBB1_47:                               # %_O_con_line.exit145.thread
                                        #   in Loop: Header=BB1_6 Depth=1
	addi.w	$a1, $s0, 1
	pcalau12i	$a0, %pc_hi20(.L.str.1)
	addi.d	$a0, $a0, %pc_lo12(.L.str.1)
...
# %bb.67:                               #   in Loop: Header=BB1_6 Depth=1
	...
	blt	$s0, $s7, .LBB1_71
	b	.LBB1_75
.LBB1_68:                               # %_O_con_line.exit165.thread
                                        #   in Loop: Header=BB1_6 Depth=1
	addi.w	$a1, $s0, 1
	pcalau12i	$a0, %pc_hi20(.L.str.5)
	addi.d	$a0, $a0, %pc_lo12(.L.str.5)
...
# %bb.1:                                # %.lr.ph74
	...
	masknez	$a1, $a1, $a0
	pcalau12i	$a2, %got_pc_hi20(_K_ato)
	ld.d	$a2, $a2, %got_pc_lo12(_K_ato)
	maskeqz	$a2, $a2, $a0
	or	$s6, $a2, $a1
	addi.w	$a1, $fp, 1
...
.LBB2_8:                                # %_O_pchars.exit
                                        #   in Loop: Header=BB2_4 Depth=1
	pcalau12i	$a0, %pc_hi20(_O_need_init)
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
