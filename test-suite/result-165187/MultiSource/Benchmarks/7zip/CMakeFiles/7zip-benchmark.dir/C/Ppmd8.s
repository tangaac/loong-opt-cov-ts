...
.LBB14_31:                              # %.lr.ph.i
	...
	move	$a0, $a1
	beq	$a4, $s4, .LBB14_31
.LBB14_32:                              # %._crit_edge.i
                                        #   in Loop: Header=BB14_27 Depth=1
	move	$a0, $zero
	st.d	$a1, $fp, 88
	b	.LBB14_34
	.p2align	4, , 16
.LBB14_33:                              # %._crit_edge37.i
...
.LBB14_37:                              # %.loopexit
	...
	ld.wu	$a6, $a5, 0
	.p2align	4, , 16
.LBB14_38:                              #   Parent Loop BB14_27 Depth=1
                                        #     Parent Loop BB14_34 Depth=2
	...
	addi.d	$a6, $a6, 4
	bnez	$a7, .LBB14_36
# %bb.39:                               #   in Loop: Header=BB14_38 Depth=4
	ld.wu	$a6, $a6, 0
	st.w	$a6, $a5, 0
	ld.w	$a7, $a4, 0
	addi.d	$a7, $a7, -1
...
.LBB17_34:
	...
	st.b	$a0, $fp, 3
.LBB17_35:                              # %._crit_edge._crit_edge
	sub.w	$a0, $fp, $a3
.LBB17_36:                              # %SpecialFreeUnit.exit
