...
.LBB23_165:                             # %vector.body423
	...
	addi.d	$a3, $a3, 8
	bnez	$a4, .LBB23_165
# %bb.166:                              # %middle.block430
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a0, .LBB23_169
.LBB23_167:                             # %scalar.ph418.preheader
	sub.d	$a0, $a0, $a2
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB23_168:                             # %scalar.ph418
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a1, 0
	add.d	$a3, $a3, $a2
	addi.d	$a0, $a0, -1
...
.LBB23_180:                             # %vector.body440
	...
	addi.d	$a3, $a3, 8
	bnez	$a4, .LBB23_180
# %bb.181:                              # %middle.block447
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a0, .LBB23_184
.LBB23_182:                             # %scalar.ph435.preheader
	sub.d	$a0, $a0, $a2
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB23_183:                             # %scalar.ph435
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a1, 0
	add.d	$a3, $a3, $a2
	addi.d	$a0, $a0, -1
...
.LBB23_195:                             # %vector.body457
	...
	addi.d	$a3, $a3, 8
	bnez	$a4, .LBB23_195
# %bb.196:                              # %middle.block464
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a0, .LBB23_199
.LBB23_197:                             # %scalar.ph452.preheader
	sub.d	$a0, $a0, $a2
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB23_198:                             # %scalar.ph452
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a1, 0
	add.d	$a3, $a3, $a2
	addi.d	$a0, $a0, -1
...
.LBB23_209:                             # %vector.body474
	...
	addi.d	$a3, $a3, 8
	bnez	$a4, .LBB23_209
# %bb.210:                              # %middle.block481
	vadd.w	$vr0, $vr1, $vr0
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a2, $a0, .LBB23_213
.LBB23_211:                             # %scalar.ph469.preheader
	sub.d	$a0, $a0, $a2
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB23_212:                             # %scalar.ph469
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a1, 0
	add.d	$a3, $a3, $a2
	addi.d	$a0, $a0, -1
