...
.LBB0_217:                              # %vec.epilog.ph505
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_218:                              # %vec.epilog.vector.body508
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_218
# %bb.219:                              # %vec.epilog.middle.block512
	bne	$a2, $a1, .LBB0_228
	b	.LBB0_230
.LBB0_220:
	ext.w.b	$a2, $a1
...
.LBB0_225:                              # %vector.body494
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_225
# %bb.226:                              # %middle.block499
	beq	$a2, $a1, .LBB0_230
# %bb.227:                              # %vec.epilog.iter.check503
	bnez	$a3, .LBB0_217
...
.LBB0_251:                              # %vec.epilog.ph537
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_252:                              # %vec.epilog.vector.body540
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_252
# %bb.253:                              # %vec.epilog.middle.block544
	bne	$a2, $a1, .LBB0_259
	b	.LBB0_261
.LBB0_254:                              # %._crit_edge.i.i133
	bnez	$a0, .LBB0_261
	b	.LBB0_262
.LBB0_255:                              # %vector.ph523
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s0, 16
...
.LBB0_256:                              # %vector.body526
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_256
# %bb.257:                              # %middle.block531
	beq	$a2, $a1, .LBB0_261
# %bb.258:                              # %vec.epilog.iter.check535
	bnez	$a3, .LBB0_251
