...
# %bb.80:                               # %iter.check416
	...
	sub.d	$a3, $s0, $a0
	bltu	$a3, $s7, .LBB0_186
# %bb.81:                               # %vector.main.loop.iter.check418
                                        #   in Loop: Header=BB0_2 Depth=1
	bgeu	$a1, $s7, .LBB0_179
...
# %bb.87:                               # %iter.check448
	...
	sub.d	$a3, $s0, $a0
	bltu	$a3, $s7, .LBB0_199
# %bb.88:                               # %vector.main.loop.iter.check450
                                        #   in Loop: Header=BB0_2 Depth=1
	bgeu	$a1, $s7, .LBB0_192
...
# %bb.143:                              #   in Loop: Header=BB0_2 Depth=1
	st.d	$zero, $s8, 16
.LBB0_144:                              # %vector.body476.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a0, $zero
...
# %bb.169:                              # %middle.block395
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_176
# %bb.170:                              # %vec.epilog.iter.check399
                                        #   in Loop: Header=BB0_2 Depth=1
	beqz	$a3, .LBB0_174
.LBB0_171:                              # %vec.epilog.ph401
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_172:                              # %vec.epilog.vector.body404
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	st.w	$a6, $a4, 0
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB0_172
# %bb.173:                              # %vec.epilog.middle.block408
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_176
...
.LBB0_180:                              # %vector.body422
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_180
# %bb.181:                              # %middle.block427
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_188
# %bb.182:                              # %vec.epilog.iter.check431
                                        #   in Loop: Header=BB0_2 Depth=1
	beqz	$a3, .LBB0_186
.LBB0_183:                              # %vec.epilog.ph433
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_184:                              # %vec.epilog.vector.body436
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	st.w	$a6, $a4, 0
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB0_184
# %bb.185:                              # %vec.epilog.middle.block440
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_188
.LBB0_186:                              # %vec.epilog.scalar.ph430.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_187:                              # %vec.epilog.scalar.ph430
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB0_196:                              # %vec.epilog.ph465
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_197:                              # %vec.epilog.vector.body468
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	st.w	$a6, $a4, 0
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB0_197
# %bb.198:                              # %vec.epilog.middle.block472
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_201
...
# %bb.212:                              # %.preheader.i.i115
	ld.d	$a0, $s5, 0
	blez	$a1, .LBB0_220
# %bb.213:                              # %iter.check488
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_228
# %bb.214:                              # %iter.check488
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB0_228
# %bb.215:                              # %vector.main.loop.iter.check490
	bgeu	$a1, $a3, .LBB0_221
# %bb.216:
	move	$a2, $zero
	b	.LBB0_225
...
.LBB0_222:                              # %vector.body494
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_222
# %bb.223:                              # %middle.block499
	beq	$a2, $a1, .LBB0_230
# %bb.224:                              # %vec.epilog.iter.check503
	beqz	$a3, .LBB0_228
.LBB0_225:                              # %vec.epilog.ph505
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_226:                              # %vec.epilog.vector.body508
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a6, $a5, 0
	st.w	$a6, $a4, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB0_226
# %bb.227:                              # %vec.epilog.middle.block512
	beq	$a2, $a1, .LBB0_230
.LBB0_228:                              # %vec.epilog.scalar.ph502.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_229:                              # %vec.epilog.scalar.ph502
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
...
# %bb.254:                              # %middle.block531
	beq	$a2, $a1, .LBB0_261
# %bb.255:                              # %vec.epilog.iter.check535
	beqz	$a3, .LBB0_259
.LBB0_256:                              # %vec.epilog.ph537
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_257:                              # %vec.epilog.vector.body540
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a6, $a5, 0
	st.w	$a6, $a4, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB0_257
# %bb.258:                              # %vec.epilog.middle.block544
	beq	$a2, $a1, .LBB0_261
.LBB0_259:                              # %vec.epilog.scalar.ph534.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_260:                              # %vec.epilog.scalar.ph534
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
