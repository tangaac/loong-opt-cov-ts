...
# %bb.0:
	...
	st.d	$ra, $sp, 1800                  # 8-byte Folded Spill
	st.d	$fp, $sp, 1792                  # 8-byte Folded Spill
	st.d	$s0, $sp, 1784                  # 8-byte Folded Spill
	st.d	$s1, $sp, 1776                  # 8-byte Folded Spill
	st.d	$s2, $sp, 1768                  # 8-byte Folded Spill
	st.d	$s3, $sp, 1760                  # 8-byte Folded Spill
	st.d	$s4, $sp, 1752                  # 8-byte Folded Spill
	st.d	$s5, $sp, 1744                  # 8-byte Folded Spill
	st.d	$s6, $sp, 1736                  # 8-byte Folded Spill
	st.d	$s7, $sp, 1728                  # 8-byte Folded Spill
	st.d	$s8, $sp, 1720                  # 8-byte Folded Spill
	.cfi_offset 1, -8
	.cfi_offset 22, -16
	.cfi_offset 23, -24
	.cfi_offset 24, -32
...
.LBB29_15:                              # %.lr.ph
	...
	addi.d	$a3, $a3, 1
	bnez	$a1, .LBB29_15
.LBB29_16:                              # %.preheader409.preheader
	move	$a0, $zero
	move	$s3, $zero
	addi.d	$a1, $sp, 232
	ori	$a2, $zero, 1
...
# %bb.19:                               #   in Loop: Header=BB29_18 Depth=1
	...
	stx.b	$a2, $a4, $a1
	b	.LBB29_17
.LBB29_20:                              # %.preheader408.preheader
	move	$a0, $zero
	addi.d	$a1, $sp, 232
	ori	$a2, $zero, 16
	b	.LBB29_22
	.p2align	4, , 16
.LBB29_21:                              # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit337
                                        #   in Loop: Header=BB29_22 Depth=1
	addi.d	$a0, $a0, 1
	beq	$a0, $a2, .LBB29_26
.LBB29_22:                              # %.preheader408
...
.LBB29_23:                              #   in Loop: Header=BB29_24 Depth=2
	...
	move	$a6, $t0
	blez	$a5, .LBB29_21
.LBB29_24:                              #   Parent Loop BB29_22 Depth=1
...
# %bb.25:                               #   in Loop: Header=BB29_24 Depth=2
	...
	st.w	$t0, $a3, 4
	b	.LBB29_23
.LBB29_26:                              # %.preheader407.preheader
	move	$a0, $zero
	addi.d	$a1, $sp, 232
	addi.d	$a2, $sp, 432
	ori	$a3, $zero, 256
	b	.LBB29_28
	.p2align	4, , 16
.LBB29_27:                              # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit342
                                        #   in Loop: Header=BB29_28 Depth=1
	addi.d	$a0, $a0, 1
	beq	$a0, $a3, .LBB29_33
.LBB29_28:                              # %.preheader407
                                        # =>This Loop Header: Depth=1
...
.LBB29_38:                              # %.lr.ph.i
	...
	addi.d	$s6, $s6, -8
	bltu	$t4, $t6, .LBB29_38
# %bb.39:                               # %.preheader.i.loopexit
                                        #   in Loop: Header=BB29_35 Depth=2
	addi.d	$s5, $s6, 3
.LBB29_40:                              # %.preheader.i
                                        #   in Loop: Header=BB29_35 Depth=2
	beqz	$s5, .LBB29_48
# %bb.41:                               # %.lr.ph31.i.preheader
                                        #   in Loop: Header=BB29_35 Depth=2
	bne	$s5, $a4, .LBB29_43
# %bb.42:                               #   in Loop: Header=BB29_35 Depth=2
	move	$s6, $s5
	b	.LBB29_46
	.p2align	4, , 16
.LBB29_43:                              # %vector.ph628
                                        #   in Loop: Header=BB29_35 Depth=2
	addi.w	$s6, $s5, 0
	slti	$s7, $s6, 1
	masknez	$s8, $a4, $s7
	...
	addi.d	$s7, $s6, 1
	bstrpick.d	$s6, $s7, 31, 1
	slli.d	$s8, $s6, 1
	sub.d	$s6, $s5, $s8
	add.d	$s5, $a6, $s5
	move	$ra, $s8
	.p2align	4, , 16
.LBB29_44:                              # %vector.body631
                                        #   Parent Loop BB29_34 Depth=1
                                        #     Parent Loop BB29_35 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$t6, $s5, -1
	...
	addi.d	$s5, $s5, -2
	bnez	$ra, .LBB29_44
# %bb.45:                               # %middle.block634
                                        #   in Loop: Header=BB29_35 Depth=2
	beq	$s7, $s8, .LBB29_48
.LBB29_46:                              # %.lr.ph31.i.preheader764
                                        #   in Loop: Header=BB29_35 Depth=2
	addi.d	$s5, $s6, 1
	add.d	$s6, $t2, $s6
	.p2align	4, , 16
.LBB29_47:                              # %.lr.ph31.i
	...
	move	$s6, $s7
	blt	$a4, $s5, .LBB29_47
.LBB29_48:                              # %_ZN9NCompress12CMtf8Encoder11FindAndMoveEh.exit
                                        #   in Loop: Header=BB29_35 Depth=2
	st.b	$s1, $sp, 1464
	bne	$s0, $a4, .LBB29_50
# %bb.49:                               #   in Loop: Header=BB29_35 Depth=2
	addi.d	$a1, $a1, 1
	addi.w	$t8, $t8, 1
	bne	$a1, $a5, .LBB29_35
	b	.LBB29_56
	.p2align	4, , 16
.LBB29_50:                              # %.preheader406
...
# %bb.52:                               # %._crit_edge
	...
	move	$s0, $s1
	bltu	$t8, $t5, .LBB29_54
.LBB29_53:                              #   in Loop: Header=BB29_34 Depth=1
	addi.w	$s0, $s1, 1
...
.LBB29_54:                              # %.thread
	...
	bne	$a1, $a5, .LBB29_34
	b	.LBB29_59
.LBB29_55:                              #   in Loop: Header=BB29_34 Depth=1
	move	$s1, $a0
	addi.d	$t8, $s0, -1
	ori	$a0, $zero, 1
	move	$s0, $s1
...
.LBB29_58:                              # %.lr.ph431
	...
	addi.d	$a2, $a5, 1
	st.w	$a2, $a4, 0
	bstrpick.d	$t8, $a3, 31, 1
	move	$a2, $a0
	bltu	$a1, $a3, .LBB29_58
.LBB29_59:                              # %._crit_edge432
	addi.w	$t6, $s3, 2
	ori	$s4, $zero, 1
	ori	$a4, $zero, 254
	ori	$a3, $zero, 1
...
.LBB29_61:                              # %vector.ph638
	...
	vst	$vr15, $sp, 80                  # 16-byte Folded Spill
	b	.LBB29_63
	.p2align	4, , 16
.LBB29_62:                              #   in Loop: Header=BB29_63 Depth=1
	addi.w	$a4, $a4, 1
	ori	$a0, $zero, 1
	ori	$a3, $zero, 8
	beq	$a4, $a3, .LBB29_213
.LBB29_63:                              # =>This Loop Header: Depth=1
                                        ...
                                        #         Child Loop BB29_102 Depth 4
                                        #         Child Loop BB29_106 Depth 4
                                        #           Child Loop BB29_109 Depth 5
                                        #           Child Loop BB29_112 Depth 5
                                        #         Child Loop BB29_116 Depth 4
                                        #       Child Loop BB29_120 Depth 3
                                        #         Child Loop BB29_124 Depth 4
                                        #         Child Loop BB29_135 Depth 4
                                        #     Child Loop BB29_145 Depth 2
                                        #     Child Loop BB29_142 Depth 2
                                        #     Child Loop BB29_148 Depth 2
                                        #     Child Loop BB29_151 Depth 2
                                        #       Child Loop BB29_162 Depth 3
                                        #         Child Loop BB29_164 Depth 4
                                        ...
                                        #           Child Loop BB29_182 Depth 5
                                        #           Child Loop BB29_191 Depth 5
                                        #           Child Loop BB29_187 Depth 5
...
.LBB29_65:                              #   in Loop: Header=BB29_63 Depth=1
	...
	b	.LBB29_67
	.p2align	4, , 16
.LBB29_66:                              #   in Loop: Header=BB29_67 Depth=2
	sll.w	$a2, $a5, $a4
	sub.d	$a3, $a3, $a2
	move	$a2, $a6
	blez	$a4, .LBB29_69
.LBB29_67:                              #   Parent Loop BB29_63 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$t0, $a4
	slt	$a4, $a4, $a2
	masknez	$a5, $a2, $a4
	...
	st.w	$a6, $a1, 4
	blt	$t0, $a2, .LBB29_66
# %bb.68:                               #   in Loop: Header=BB29_67 Depth=2
	ld.wu	$a2, $a1, 0
	ld.d	$a6, $a1, 16
	addi.d	$t0, $a2, 1
	st.w	$t0, $a1, 0
	...
	b	.LBB29_66
	.p2align	4, , 16
.LBB29_69:                              # %_ZN9NCompress6NBZip211CThreadInfo10WriteBits2Ejj.exit347
...
.LBB29_70:                              #   in Loop: Header=BB29_71 Depth=2
	...
	move	$a4, $a6
	blez	$a3, .LBB29_73
.LBB29_71:                              #   Parent Loop BB29_63 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$t0, $a3
	slt	$a3, $a3, $a4
	masknez	$a5, $a4, $a3
...
# %bb.72:                               #   in Loop: Header=BB29_71 Depth=2
	...
	b	.LBB29_70
	.p2align	4, , 16
.LBB29_73:                              # %_ZN9NCompress6NBZip211CThreadInfo10WriteBits2Ejj.exit352.preheader
                                        #   in Loop: Header=BB29_63 Depth=1
	move	$a6, $zero
	bstrpick.d	$a1, $a0, 31, 0
	addi.w	$t4, $a0, 0
	...
	b	.LBB29_75
	.p2align	4, , 16
.LBB29_74:                              # %.loopexit753
                                        #   in Loop: Header=BB29_75 Depth=2
	sub.w	$a3, $a3, $a5
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, -258
	beqz	$a1, .LBB29_96
.LBB29_75:                              # %_ZN9NCompress6NBZip211CThreadInfo10WriteBits2Ejj.exit352
                                        #   Parent Loop BB29_63 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB29_78 Depth 3
                                        #       Child Loop BB29_89 Depth 3
                                        #       Child Loop BB29_93 Depth 3
...
.LBB29_78:                              # %.lr.ph438
	...
	addi.w	$a7, $a7, 1
	bltu	$a5, $a6, .LBB29_78
.LBB29_79:                              # %._crit_edge439
                                        #   in Loop: Header=BB29_75 Depth=2
	addi.w	$a6, $a7, -1
	bge	$a4, $a6, .LBB29_83
# %bb.80:                               #   in Loop: Header=BB29_75 Depth=2
	beq	$a1, $t4, .LBB29_83
# %bb.81:                               #   in Loop: Header=BB29_75 Depth=2
	beq	$a1, $s4, .LBB29_83
# %bb.82:                               #   in Loop: Header=BB29_75 Depth=2
	sub.d	$t0, $a0, $a1
	andi	$t0, $t0, 1
	bnez	$t0, .LBB29_85
	.p2align	4, , 16
.LBB29_83:                              #   in Loop: Header=BB29_75 Depth=2
	move	$a6, $a7
	ori	$a7, $zero, 4
	bge	$t6, $a7, .LBB29_86
.LBB29_84:                              #   in Loop: Header=BB29_75 Depth=2
	move	$t2, $zero
	b	.LBB29_95
.LBB29_85:                              #   in Loop: Header=BB29_75 Depth=2
	slli.d	$a7, $a6, 2
	ldx.w	$a7, $a7, $t7
	sub.d	$a5, $a5, $a7
	ori	$a7, $zero, 4
	blt	$t6, $a7, .LBB29_84
	.p2align	4, , 16
.LBB29_86:                              # %vector.main.loop.iter.check715
                                        #   in Loop: Header=BB29_75 Depth=2
	vreplgr2vr.d	$vr0, $a4
	vreplgr2vr.d	$vr1, $a6
	...
	ori	$t1, $zero, 16
	bge	$t6, $t1, .LBB29_88
# %bb.87:                               #   in Loop: Header=BB29_75 Depth=2
	move	$t1, $zero
	b	.LBB29_92
	.p2align	4, , 16
.LBB29_88:                              # %vector.ph716
                                        #   in Loop: Header=BB29_75 Depth=2
...
.LBB29_89:                              # %vector.body723
	...
	addi.d	$t1, $t1, 16
	bnez	$t2, .LBB29_89
# %bb.90:                               # %middle.block728
                                        #   in Loop: Header=BB29_75 Depth=2
	beq	$s5, $t8, .LBB29_74
# %bb.91:                               # %vec.epilog.iter.check732
                                        #   in Loop: Header=BB29_75 Depth=2
	move	$t1, $s5
	move	$t2, $s5
	beqz	$ra, .LBB29_95
.LBB29_92:                              # %vec.epilog.ph734
                                        #   in Loop: Header=BB29_75 Depth=2
	...
	vor.v	$vr3, $vr4, $vr3
	.p2align	4, , 16
.LBB29_93:                              # %vec.epilog.vector.body744
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_75 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vslt.d	$vr4, $vr3, $vr0
	...
	vaddi.du	$vr2, $vr2, 4
	bne	$t3, $t1, .LBB29_93
# %bb.94:                               # %vec.epilog.middle.block749
                                        #   in Loop: Header=BB29_75 Depth=2
	move	$t2, $t3
	beq	$t3, $t8, .LBB29_74
	.p2align	4, , 16
.LBB29_95:                              # %vec.epilog.scalar.ph731
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_75 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	slt	$a7, $t2, $a4
	...
	b	.LBB29_74
	.p2align	4, , 16
.LBB29_96:                              # %.preheader401.preheader
                                        #   in Loop: Header=BB29_63 Depth=1
	move	$a2, $zero
	slt	$a0, $s4, $t4
	masknez	$a1, $s4, $a0
...
.LBB29_98:                              # %.preheader401
	...
	addi.d	$t7, $sp, 232
	.p2align	4, , 16
.LBB29_99:                              # %.preheader400
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_98 Depth=2
	...
	b	.LBB29_102
	.p2align	4, , 16
.LBB29_100:                             #   in Loop: Header=BB29_102 Depth=4
	...
	addi.d	$a4, $a6, 1
	addi.w	$a3, $a3, 1
	bltu	$t0, $a6, .LBB29_104
.LBB29_101:                             #   in Loop: Header=BB29_102 Depth=4
	addi.d	$a5, $a5, 4
	addi.d	$a7, $a2, 1
	move	$a6, $a4
	bgeu	$a1, $s6, .LBB29_104
.LBB29_102:                             #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_98 Depth=2
                                        #       Parent Loop BB29_99 Depth=3
	...
	addi.w	$a7, $a1, 1
	beq	$a4, $s3, .LBB29_100
# %bb.103:                              #   in Loop: Header=BB29_102 Depth=4
	move	$a1, $a7
	st.w	$a4, $a5, 0
	addi.d	$a4, $a6, 1
	addi.w	$a3, $a3, 1
	bgeu	$t0, $a6, .LBB29_101
.LBB29_104:                             # %.preheader
                                        #   in Loop: Header=BB29_99 Depth=3
	move	$a6, $zero
	bstrpick.d	$a5, $a0, 31, 0
	bstrpick.d	$a7, $a4, 30, 1
	slli.d	$a7, $a7, 1
	move	$t0, $a2
...
.LBB29_105:                             #   in Loop: Header=BB29_106 Depth=4
	addi.d	$a6, $a6, 1
	beq	$a6, $s5, .LBB29_115
.LBB29_106:                             #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_98 Depth=2
                                        #       Parent Loop BB29_99 Depth=3
	...
	alsl.d	$t2, $a6, $t2, 1
	add.d	$t2, $s8, $t2
	bgeu	$a3, $ra, .LBB29_108
# %bb.107:                              #   in Loop: Header=BB29_106 Depth=4
	move	$t4, $zero
	move	$t3, $zero
	b	.LBB29_111
	.p2align	4, , 16
.LBB29_108:                             # %vector.body701.preheader
                                        #   in Loop: Header=BB29_106 Depth=4
	move	$t3, $zero
	move	$t4, $zero
	move	$t5, $t0
	move	$t6, $s0
	.p2align	4, , 16
.LBB29_109:                             # %vector.body701
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_98 Depth=2
                                        #       Parent Loop BB29_99 Depth=3
                                        #         Parent Loop BB29_106 Depth=4
	...
	addi.d	$t6, $t6, 8
	bnez	$t5, .LBB29_109
# %bb.110:                              # %middle.block706
                                        #   in Loop: Header=BB29_106 Depth=4
	add.w	$t3, $t4, $t3
	move	$t4, $a7
	addi.d	$t7, $sp, 232
	beq	$a4, $a7, .LBB29_113
.LBB29_111:                             # %scalar.ph696.preheader
                                        #   in Loop: Header=BB29_106 Depth=4
	alsl.d	$t5, $t4, $t7, 2
	.p2align	4, , 16
.LBB29_112:                             # %scalar.ph696
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_98 Depth=2
                                        #       Parent Loop BB29_99 Depth=3
                                        #         Parent Loop BB29_106 Depth=4
...
.LBB29_113:                             # %.loopexit
                                        #   in Loop: Header=BB29_106 Depth=4
	bgeu	$t3, $t1, .LBB29_105
# %bb.114:                              #   in Loop: Header=BB29_106 Depth=4
	stx.b	$a6, $s7, $a5
	move	$t1, $t3
	b	.LBB29_105
	.p2align	4, , 16
.LBB29_115:                             #   in Loop: Header=BB29_99 Depth=3
	ldx.bu	$a3, $s7, $a5
	slli.d	$a4, $a3, 10
	alsl.d	$a3, $a3, $a4, 3
	add.d	$a3, $s1, $a3
	addi.d	$a4, $sp, 232
	.p2align	4, , 16
.LBB29_116:                             #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_98 Depth=2
                                        #       Parent Loop BB29_99 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	ld.wu	$a5, $a4, 0
	...
	addi.d	$a4, $a4, 4
	bnez	$a2, .LBB29_116
# %bb.117:                              #   in Loop: Header=BB29_99 Depth=3
	addi.w	$a0, $a0, 1
	ori	$t0, $zero, 48
	bltu	$a1, $s6, .LBB29_99
# %bb.118:                              # %.preheader399.preheader
                                        #   in Loop: Header=BB29_98 Depth=2
	move	$s0, $zero
	b	.LBB29_120
	.p2align	4, , 16
.LBB29_119:                             # %.loopexit752
                                        #   in Loop: Header=BB29_120 Depth=3
	slli.d	$a0, $s0, 10
	alsl.d	$a0, $s0, $a0, 3
	addi.d	$a1, $fp, 1588
	add.d	$a0, $a1, $a0
...
.LBB29_120:                             # %.preheader399
	...
	ori	$a1, $zero, 4
	bge	$a0, $a1, .LBB29_122
# %bb.121:                              #   in Loop: Header=BB29_120 Depth=3
	move	$a1, $zero
	ld.d	$a3, $sp, 208                   # 8-byte Folded Reload
	b	.LBB29_133
	.p2align	4, , 16
.LBB29_122:                             # %vector.body683.preheader
                                        #   in Loop: Header=BB29_120 Depth=3
	...
	b	.LBB29_124
	.p2align	4, , 16
.LBB29_123:                             # %pred.store.continue691
                                        #   in Loop: Header=BB29_124 Depth=4
	addi.d	$a0, $a0, -4
	addi.d	$a1, $a1, 16
	beqz	$a0, .LBB29_132
.LBB29_124:                             # %vector.body683
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_98 Depth=2
                                        #       Parent Loop BB29_120 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	vld	$vr0, $a1, 0
	vseqi.w	$vr0, $vr0, 0
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_128
# %bb.125:                              # %pred.store.if
                                        #   in Loop: Header=BB29_124 Depth=4
	st.w	$s4, $a1, 0
	vpickve2gr.w	$a2, $vr0, 1
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_129
.LBB29_126:                             # %pred.store.continue687
                                        #   in Loop: Header=BB29_124 Depth=4
	vpickve2gr.w	$a2, $vr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_130
.LBB29_127:                             # %pred.store.if688
                                        #   in Loop: Header=BB29_124 Depth=4
	st.w	$s4, $a1, 8
	...
	b	.LBB29_131
	.p2align	4, , 16
.LBB29_128:                             # %pred.store.continue
                                        #   in Loop: Header=BB29_124 Depth=4
	vpickve2gr.w	$a2, $vr0, 1
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_126
.LBB29_129:                             # %pred.store.if686
                                        #   in Loop: Header=BB29_124 Depth=4
	st.w	$s4, $a1, 4
	vpickve2gr.w	$a2, $vr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_127
.LBB29_130:                             # %pred.store.continue689
                                        #   in Loop: Header=BB29_124 Depth=4
	vpickve2gr.w	$a2, $vr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_123
.LBB29_131:                             # %pred.store.if690
                                        #   in Loop: Header=BB29_124 Depth=4
	st.w	$s4, $a1, 12
	b	.LBB29_123
	.p2align	4, , 16
.LBB29_132:                             # %middle.block693
                                        #   in Loop: Header=BB29_120 Depth=3
	move	$a1, $a4
	beq	$a4, $a3, .LBB29_119
.LBB29_133:                             # %scalar.ph678.preheader
                                        #   in Loop: Header=BB29_120 Depth=3
	slli.d	$a0, $a1, 2
	sub.d	$a1, $a3, $a1
	b	.LBB29_135
	.p2align	4, , 16
.LBB29_134:                             #   in Loop: Header=BB29_135 Depth=4
	addi.d	$a1, $a1, -1
	addi.d	$a0, $a0, 4
	beqz	$a1, .LBB29_119
.LBB29_135:                             # %scalar.ph678
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_98 Depth=2
                                        #       Parent Loop BB29_120 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	ldx.w	$a2, $s1, $a0
	bnez	$a2, .LBB29_134
# %bb.136:                              #   in Loop: Header=BB29_135 Depth=4
	stx.w	$s4, $s1, $a0
	b	.LBB29_134
	.p2align	4, , 16
.LBB29_137:                             # %iter.check
                                        #   in Loop: Header=BB29_63 Depth=1
	addi.d	$t4, $sp, 231
	ori	$a0, $zero, 16
	ld.d	$a2, $sp, 168                   # 8-byte Folded Reload
	bge	$a2, $a0, .LBB29_139
# %bb.138:                              #   in Loop: Header=BB29_63 Depth=1
	move	$a0, $zero
	addi.d	$t7, $sp, 432
	...
	b	.LBB29_148
	.p2align	4, , 16
.LBB29_139:                             # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB29_63 Depth=1
	pcalau12i	$a1, %pc_hi20(.LCPI29_8)
	addi.d	$t7, $sp, 432
	ld.d	$s0, $sp, 128                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 112                   # 8-byte Folded Reload
	vld	$vr15, $sp, 80                  # 16-byte Folded Reload
	ori	$a0, $zero, 32
	bge	$a2, $a0, .LBB29_144
# %bb.140:                              #   in Loop: Header=BB29_63 Depth=1
	move	$a0, $zero
	ld.d	$t8, $sp, 208                   # 8-byte Folded Reload
	addi.d	$a3, $sp, 232
.LBB29_141:                             # %vec.epilog.ph
                                        #   in Loop: Header=BB29_63 Depth=1
	move	$a2, $a0
	vld	$vr0, $a1, %pc_lo12(.LCPI29_8)
	...
	add.d	$a2, $a3, $a2
	.p2align	4, , 16
.LBB29_142:                             # %vec.epilog.vector.body
                                        #   Parent Loop BB29_63 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a2, 0
	vaddi.bu	$vr0, $vr0, 16
...
# %bb.147:                              # %vec.epilog.iter.check
	...
	bnez	$a2, .LBB29_141
	.p2align	4, , 16
.LBB29_148:                             # %vec.epilog.scalar.ph
                                        #   Parent Loop BB29_63 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.b	$a0, $a0, $a3
	addi.d	$a0, $a0, 1
	bne	$s5, $a0, .LBB29_148
.LBB29_149:                             # %.preheader403
                                        #   in Loop: Header=BB29_63 Depth=1
	addi.d	$t5, $sp, 232
	ld.bu	$a0, $sp, 232
	move	$a1, $zero
	b	.LBB29_151
	.p2align	4, , 16
.LBB29_150:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit362._crit_edge
                                        #   in Loop: Header=BB29_151 Depth=2
	addi.d	$t5, $sp, 232
	addi.d	$a1, $a1, 1
	st.b	$a0, $sp, 232
	beq	$a1, $s0, .LBB29_170
.LBB29_151:                             #   Parent Loop BB29_63 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB29_162 Depth 3
                                        #         Child Loop BB29_164 Depth 4
                                        #       Child Loop BB29_155 Depth 3
	...
	ldx.bu	$a0, $s7, $a1
	bne	$a2, $a0, .LBB29_160
# %bb.152:                              #   in Loop: Header=BB29_151 Depth=2
	move	$a2, $zero
.LBB29_153:                             # %._crit_edge447
                                        #   in Loop: Header=BB29_151 Depth=2
	ld.d	$a3, $fp, 32
	ld.w	$a6, $a3, 4
	move	$a4, $zero
	...
	b	.LBB29_155
	.p2align	4, , 16
.LBB29_154:                             #   in Loop: Header=BB29_155 Depth=3
	sll.w	$a6, $a7, $a5
	sub.d	$a4, $a4, $a6
	move	$a6, $t0
	blez	$a5, .LBB29_157
.LBB29_155:                             #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_151 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$t2, $a5
	slt	$a5, $a5, $a6
	masknez	$a7, $a6, $a5
	...
	st.w	$t0, $a3, 4
	blt	$t2, $a6, .LBB29_154
# %bb.156:                              #   in Loop: Header=BB29_155 Depth=3
	ld.wu	$a6, $a3, 0
	ld.d	$t0, $a3, 16
	addi.d	$t2, $a6, 1
	st.w	$t2, $a3, 0
	...
	b	.LBB29_154
	.p2align	4, , 16
.LBB29_157:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit362.preheader
                                        #   in Loop: Header=BB29_151 Depth=2
	addi.w	$a3, $a2, 0
	blez	$a3, .LBB29_150
# %bb.158:                              # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit362.preheader462
                                        #   in Loop: Header=BB29_151 Depth=2
	bne	$a2, $s4, .LBB29_166
# %bb.159:                              #   in Loop: Header=BB29_151 Depth=2
	move	$a3, $a2
	addi.d	$a5, $sp, 232
	b	.LBB29_169
	.p2align	4, , 16
.LBB29_160:                             # %.lr.ph446.preheader
                                        #   in Loop: Header=BB29_151 Depth=2
	move	$a2, $zero
	b	.LBB29_162
	.p2align	4, , 16
.LBB29_161:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit357
                                        #   in Loop: Header=BB29_162 Depth=3
	addi.d	$a2, $a2, 1
	ldx.bu	$a3, $a2, $t5
	beq	$a3, $a0, .LBB29_153
.LBB29_162:                             # %.lr.ph446
	...
	b	.LBB29_164
	.p2align	4, , 16
.LBB29_163:                             #   in Loop: Header=BB29_164 Depth=4
	sll.w	$a6, $a7, $a5
	sub.d	$a4, $a4, $a6
	move	$a6, $t0
	blez	$a5, .LBB29_161
.LBB29_164:                             #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_151 Depth=2
                                        #       Parent Loop BB29_162 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	move	$t2, $a5
	slt	$a5, $a5, $a6
	masknez	$a7, $a6, $a5
	...
	st.w	$t0, $a3, 4
	blt	$t2, $a6, .LBB29_163
# %bb.165:                              #   in Loop: Header=BB29_164 Depth=4
	ld.wu	$a6, $a3, 0
	ld.d	$t0, $a3, 16
	addi.d	$t2, $a6, 1
	st.w	$t2, $a3, 0
...
.LBB29_169:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit362
	...
	stx.b	$a3, $a2, $a5
	addi.d	$a3, $a2, -1
	bltu	$s4, $a2, .LBB29_169
	b	.LBB29_150
	.p2align	4, , 16
.LBB29_170:                             #   in Loop: Header=BB29_63 Depth=1
	move	$a0, $zero
	b	.LBB29_172
	.p2align	4, , 16
.LBB29_171:                             #   in Loop: Header=BB29_172 Depth=2
	addi.d	$a0, $a0, 1
	beq	$a0, $s5, .LBB29_199
.LBB29_172:                             #   Parent Loop BB29_63 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB29_174 Depth 3
                                        #       Child Loop BB29_178 Depth 3
                                        #         Child Loop BB29_180 Depth 4
...
.LBB29_173:                             #   in Loop: Header=BB29_174 Depth=3
	...
	move	$a6, $t0
	blez	$a5, .LBB29_176
.LBB29_174:                             #   Parent Loop BB29_63 Depth=1
...
# %bb.175:                              #   in Loop: Header=BB29_174 Depth=3
	...
	b	.LBB29_173
	.p2align	4, , 16
.LBB29_176:                             # %_ZN9NCompress6NBZip211CThreadInfo10WriteBits2Ejj.exit367.preheader
                                        #   in Loop: Header=BB29_172 Depth=2
	move	$a3, $zero
	b	.LBB29_178
	.p2align	4, , 16
.LBB29_177:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit387
                                        #   in Loop: Header=BB29_178 Depth=3
	addi.d	$a3, $a3, 1
	beq	$a3, $t8, .LBB29_171
.LBB29_178:                             # %_ZN9NCompress6NBZip211CThreadInfo10WriteBits2Ejj.exit367
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_172 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB29_180 Depth 4
...
.LBB29_180:                             # %.lr.ph453
	...
	b	.LBB29_182
	.p2align	4, , 16
.LBB29_181:                             #   in Loop: Header=BB29_182 Depth=5
	sll.w	$t0, $t1, $a7
	sub.d	$a6, $a6, $t0
	move	$t0, $t2
	blez	$a7, .LBB29_184
.LBB29_182:                             #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_172 Depth=2
                                        #       Parent Loop BB29_178 Depth=3
                                        #         Parent Loop BB29_180 Depth=4
                                        # =>        This Inner Loop Header: Depth=5
	move	$t4, $a7
	slt	$a7, $a7, $t0
	masknez	$t1, $t0, $a7
	...
	st.w	$t2, $a5, 4
	blt	$t4, $t0, .LBB29_181
# %bb.183:                              #   in Loop: Header=BB29_182 Depth=5
	ld.wu	$t0, $a5, 0
	ld.d	$t2, $a5, 16
	addi.d	$t4, $t0, 1
	st.w	$t4, $a5, 0
	...
	b	.LBB29_181
	.p2align	4, , 16
.LBB29_184:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit372
                                        #   in Loop: Header=BB29_180 Depth=4
	ld.d	$a5, $fp, 32
	ld.w	$a6, $a5, 4
	bgeu	$a1, $a4, .LBB29_189
# %bb.185:                              # %.preheader612.preheader
                                        #   in Loop: Header=BB29_180 Depth=4
	move	$a7, $zero
	ori	$t0, $zero, 1
	b	.LBB29_187
	.p2align	4, , 16
.LBB29_186:                             #   in Loop: Header=BB29_187 Depth=5
	sll.w	$a6, $t1, $t0
	sub.d	$a7, $a7, $a6
	move	$a6, $t2
	blez	$t0, .LBB29_179
.LBB29_187:                             # %.preheader612
                                        #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_172 Depth=2
                                        #       Parent Loop BB29_178 Depth=3
                                        #         Parent Loop BB29_180 Depth=4
	...
	st.w	$t2, $a5, 4
	blt	$t4, $a6, .LBB29_186
# %bb.188:                              #   in Loop: Header=BB29_187 Depth=5
	ld.wu	$a6, $a5, 0
	ld.d	$t2, $a5, 16
	addi.d	$t4, $a6, 1
	st.w	$t4, $a5, 0
	...
	b	.LBB29_186
	.p2align	4, , 16
.LBB29_189:                             # %.preheader613.preheader
                                        #   in Loop: Header=BB29_180 Depth=4
	ori	$a7, $zero, 1
	ori	$t0, $zero, 1
	b	.LBB29_191
...
# %bb.192:                              #   in Loop: Header=BB29_191 Depth=5
	...
	b	.LBB29_190
	.p2align	4, , 16
.LBB29_193:                             #   in Loop: Header=BB29_180 Depth=4
	addi.d	$a5, $zero, -1
	add.w	$a1, $a1, $a5
	bne	$a1, $a4, .LBB29_180
.LBB29_194:                             #   in Loop: Header=BB29_178 Depth=3
	move	$a1, $a4
.LBB29_195:                             # %._crit_edge454
                                        #   in Loop: Header=BB29_178 Depth=3
	ld.d	$a4, $fp, 32
	ld.w	$a7, $a4, 4
	move	$a5, $zero
...
.LBB29_196:                             #   in Loop: Header=BB29_197 Depth=4
	...
	move	$a7, $t1
	blez	$a6, .LBB29_177
.LBB29_197:                             #   Parent Loop BB29_63 Depth=1
                                        #     Parent Loop BB29_172 Depth=2
                                        #       Parent Loop BB29_178 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	move	$t3, $a6
	...
	st.w	$t1, $a4, 4
	blt	$t3, $a7, .LBB29_196
# %bb.198:                              #   in Loop: Header=BB29_197 Depth=4
	ld.wu	$a7, $a4, 0
	ld.d	$t1, $a4, 16
	addi.d	$t3, $a7, 1
	st.w	$t3, $a4, 0
	...
	b	.LBB29_196
	.p2align	4, , 16
.LBB29_199:                             # %.preheader402.preheader
                                        #   in Loop: Header=BB29_63 Depth=1
	move	$a3, $zero
	move	$a2, $zero
	move	$a1, $zero
	...
	b	.LBB29_201
	.p2align	4, , 16
.LBB29_200:                             # %_ZN9NCompress6NBZip216CMsbfEncoderTemp9WriteBitsEji.exit
                                        #   in Loop: Header=BB29_201 Depth=2
	addi.w	$a3, $a3, -1
	ld.d	$t3, $sp, 200                   # 8-byte Folded Reload
	bgeu	$a0, $s6, .LBB29_210
.LBB29_201:                             # %.preheader402
                                        #   Parent Loop BB29_63 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB29_207 Depth 3
	bstrpick.d	$a5, $a0, 31, 0
...
# %bb.202:                              #   in Loop: Header=BB29_201 Depth=2
	move	$a0, $a5
	bnez	$a3, .LBB29_204
.LBB29_203:                             #   in Loop: Header=BB29_201 Depth=2
...
# %bb.205:                              # %.lr.ph.i388
	...
	b	.LBB29_207
	.p2align	4, , 16
.LBB29_206:                             #   in Loop: Header=BB29_207 Depth=3
	sll.w	$t0, $t1, $a7
	sub.d	$a6, $a6, $t0
	move	$t0, $t2
	blez	$a7, .LBB29_200
.LBB29_207:                             #   Parent Loop BB29_63 Depth=1
	...
	st.w	$t2, $a5, 4
	blt	$t4, $t0, .LBB29_206
# %bb.208:                              #   in Loop: Header=BB29_207 Depth=3
	ld.wu	$t0, $a5, 0
	ld.d	$t2, $a5, 16
	addi.d	$t4, $t0, 1
	st.w	$t4, $a5, 0
	...
	b	.LBB29_206
	.p2align	4, , 16
.LBB29_209:                             #   in Loop: Header=BB29_201 Depth=2
	bstrpick.d	$a5, $a5, 31, 0
	ldx.bu	$a5, $s2, $a5
	addi.w	$a0, $a0, 2
	addi.d	$a6, $a5, 255
	...
	b	.LBB29_203
	.p2align	4, , 16
.LBB29_210:                             #   in Loop: Header=BB29_63 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.bu	$a0, $a0, 0
	ld.d	$a4, $sp, 176                   # 8-byte Folded Reload
	beqz	$a0, .LBB29_213
# %bb.211:                              #   in Loop: Header=BB29_63 Depth=1
	ld.d	$a1, $fp, 32
	ld.w	$a0, $a1, 0
	ld.w	$a2, $a1, 4
	slli.d	$a0, $a0, 3
	...
	bltu	$a3, $a0, .LBB29_62
# %bb.212:                              #   in Loop: Header=BB29_63 Depth=1
	st.d	$a0, $sp, 160                   # 8-byte Folded Spill
	st.d	$a4, $sp, 72                    # 8-byte Folded Spill
	ori	$a0, $zero, 6
	bne	$a4, $a0, .LBB29_62
.LBB29_213:
	ld.d	$s8, $sp, 1720                  # 8-byte Folded Reload
	ld.d	$s7, $sp, 1728                  # 8-byte Folded Reload
	ld.d	$s6, $sp, 1736                  # 8-byte Folded Reload
	ld.d	$s5, $sp, 1744                  # 8-byte Folded Reload
	ld.d	$s4, $sp, 1752                  # 8-byte Folded Reload
	ld.d	$s3, $sp, 1760                  # 8-byte Folded Reload
	ld.d	$s2, $sp, 1768                  # 8-byte Folded Reload
	ld.d	$s1, $sp, 1776                  # 8-byte Folded Reload
	ld.d	$s0, $sp, 1784                  # 8-byte Folded Reload
	ld.d	$fp, $sp, 1792                  # 8-byte Folded Reload
	ld.d	$ra, $sp, 1800                  # 8-byte Folded Reload
	addi.d	$sp, $sp, 1808
	ret
.Lfunc_end29:
...
.LBB31_37:                              # %vec.epilog.ph
	...
	add.w	$t0, $s1, $t0
	.p2align	4, , 16
.LBB31_38:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
