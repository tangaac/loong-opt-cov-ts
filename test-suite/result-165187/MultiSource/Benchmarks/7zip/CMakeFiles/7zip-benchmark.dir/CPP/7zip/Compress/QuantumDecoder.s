...
# %bb.0:                                # %_ZN9NCompress8NQuantum11NRangeCoder13CModelDecoder4InitEj.exit
	...
	lu52i.d	$a6, $a6, 497
	vreplgr2vr.d	$vr8, $a6
	vpackev.d	$vr9, $vr8, $vr7
	vst	$vr9, $a0, 542
	pcalau12i	$a6, %pc_hi20(.LCPI0_4)
	vld	$vr4, $a6, %pc_lo12(.LCPI0_4)
	pcalau12i	$a6, %pc_hi20(.LCPI0_5)
	vld	$vr5, $a6, %pc_lo12(.LCPI0_5)
	...
	pcalau12i	$t0, %pc_hi20(.LCPI0_6)
	vld	$vr7, $t0, %pc_lo12(.LCPI0_6)
	vpackev.d	$vr11, $vr10, $vr8
	vst	$vr11, $a0, 558
	vpickve2gr.d	$t0, $vr8, 0
	vst	$vr7, $a0, 476
	pcalau12i	$t1, %pc_hi20(.LCPI0_7)
	vld	$vr8, $t1, %pc_lo12(.LCPI0_7)
	lu12i.w	$t1, 209699
	ori	$t1, $t1, 304
	lu32i.d	$t1, 406836
	lu52i.d	$t1, $t1, 883
	vreplgr2vr.d	$vr11, $t1
	lu12i.w	$t1, 242595
	ori	$t1, $t1, 2360
	lu32i.d	$t1, -115396
	lu52i.d	$t1, $t1, 1011
	vreplgr2vr.d	$vr12, $t1
	vpackev.d	$vr13, $vr12, $vr11
	vst	$vr13, $a0, 574
	pcalau12i	$t1, %pc_hi20(.LCPI0_8)
	vld	$vr13, $t1, %pc_lo12(.LCPI0_8)
...
# %bb.9:                                # %.lr.ph.i.1
	...
	bltu	$a3, $a6, .LBB0_12
# %bb.10:                               # %vector.memcheck69
	addi.d	$a7, $a0, 1416
	add.d	$a6, $a0, $a4
	addi.d	$a6, $a6, 1546
	addi.d	$t0, $a0, 1546
	bgeu	$a7, $a6, .LBB0_28
# %bb.11:                               # %vector.memcheck69
	alsl.d	$a6, $a4, $a0, 1
	addi.d	$a6, $a6, 1416
	bgeu	$t0, $a6, .LBB0_28
.LBB0_12:
	move	$a6, $zero
.LBB0_13:                               # %scalar.ph75.preheader
	slli.d	$a7, $a6, 1
	addi.d	$a7, $a7, 1416
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
...
# %bb.18:                               # %vector.memcheck92
	...
	addi.d	$a7, $a0, 1750
	bgeu	$a6, $a3, .LBB0_31
# %bb.19:                               # %vector.memcheck92
	alsl.d	$a3, $a4, $a0, 1
	addi.d	$a3, $a3, 1620
	bgeu	$a7, $a3, .LBB0_31
.LBB0_20:
	move	$a3, $zero
.LBB0_21:                               # %scalar.ph98.preheader
	slli.d	$a2, $a3, 1
	addi.d	$a2, $a2, 1620
	sub.d	$a5, $a5, $a3
	.p2align	4, , 16
...
.LBB0_25:                               # %vector.ph60
	...
	vld	$vr2, $a7, %pc_lo12(.LCPI0_10)
	andi	$a7, $a5, 24
	vreplgr2vr.w	$vr3, $a6
	move	$t2, $a7
	.p2align	4, , 16
.LBB0_26:                               # %vector.body61
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr4, $vr3, $vr2
	vsub.w	$vr5, $vr3, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$t2, .LBB0_26
# %bb.27:                               # %middle.block68
	beq	$a7, $a5, .LBB0_8
	b	.LBB0_5
.LBB0_28:                               # %vector.ph77
	pcalau12i	$a6, %pc_hi20(.LCPI0_9)
	vld	$vr0, $a6, %pc_lo12(.LCPI0_9)
	pcalau12i	$a6, %pc_hi20(.LCPI0_10)
	vld	$vr1, $a6, %pc_lo12(.LCPI0_10)
	andi	$a6, $a4, 56
	vreplgr2vr.w	$vr2, $a5
	vreplgr2vr.d	$vr3, $a2
	move	$t1, $a6
	.p2align	4, , 16
.LBB0_29:                               # %vector.body82
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr4, $vr2, $vr1
	vsub.w	$vr5, $vr2, $vr0
	vpickev.h	$vr4, $vr5, $vr4
...
# %bb.30:                               # %middle.block89
	beq	$a6, $a4, .LBB0_16
	b	.LBB0_13
.LBB0_31:                               # %vector.ph100
	pcalau12i	$a3, %pc_hi20(.LCPI0_9)
	vld	$vr0, $a3, %pc_lo12(.LCPI0_9)
	pcalau12i	$a3, %pc_hi20(.LCPI0_10)
	vld	$vr1, $a3, %pc_lo12(.LCPI0_10)
	andi	$a3, $a4, 56
	vreplgr2vr.w	$vr2, $a5
	vreplgr2vr.d	$vr3, $a2
	move	$a2, $a3
	.p2align	4, , 16
.LBB0_32:                               # %vector.body105
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr4, $vr2, $vr1
	vsub.w	$vr5, $vr2, $vr0
	vpickev.h	$vr4, $vr5, $vr4
