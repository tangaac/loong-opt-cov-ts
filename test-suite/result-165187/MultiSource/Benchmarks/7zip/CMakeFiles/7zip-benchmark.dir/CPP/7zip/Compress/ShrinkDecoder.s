...
.LBB0_94:                               # %pred.store.continue362
	...
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_121
.LBB0_95:                               # %pred.store.continue364
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.h	$a0, $vr0, 4
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_122
.LBB0_96:                               # %pred.store.continue366
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.h	$a0, $vr0, 5
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_123
.LBB0_97:                               # %pred.store.continue368
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.h	$a0, $vr0, 6
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_124
.LBB0_98:                               # %pred.store.continue370
                                        #   in Loop: Header=BB0_10 Depth=1
	vpickve2gr.h	$a0, $vr0, 7
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_125
.LBB0_99:                               # %.preheader197
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.bu	$a0, $a3, 8
	beqz	$a0, .LBB0_126
.LBB0_100:                              # %.preheader197.1
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.bu	$a0, $a3, 9
	beqz	$a0, .LBB0_127
.LBB0_101:                              # %.preheader197.2
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.bu	$a0, $a3, 10
	beqz	$a0, .LBB0_128
.LBB0_102:                              # %.preheader197.3
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.bu	$a0, $a3, 11
	beqz	$a0, .LBB0_129
.LBB0_103:                              # %.preheader197.4
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.bu	$a0, $a3, 12
	beqz	$a0, .LBB0_130
.LBB0_104:                              # %.preheader197.5
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.bu	$a0, $a3, 13
	beqz	$a0, .LBB0_131
.LBB0_105:                              # %.preheader197.6
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.bu	$a0, $a3, 14
	bnez	$a0, .LBB0_107
...
# %bb.109:                              # %vector.body
	...
	ori	$a3, $a6, 3808
	bne	$a1, $a3, .LBB0_108
.LBB0_110:                              # %middle.split
                                        #   in Loop: Header=BB0_10 Depth=1
	slli.d	$a1, $a2, 48
	beqz	$a1, .LBB0_132
# %bb.111:                              # %vector.early.exit
                                        #   in Loop: Header=BB0_10 Depth=1
...
.LBB0_118:                              # %pred.store.if357
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_93
.LBB0_119:                              # %pred.store.if359
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s5, $a4, 0
	vpickve2gr.h	$a0, $vr0, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_94
.LBB0_120:                              # %pred.store.if361
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s5, $a4, 1
	vpickve2gr.h	$a0, $vr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_95
.LBB0_121:                              # %pred.store.if363
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s5, $a4, 2
	vpickve2gr.h	$a0, $vr0, 4
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_96
.LBB0_122:                              # %pred.store.if365
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s5, $a4, 3
	vpickve2gr.h	$a0, $vr0, 5
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_97
.LBB0_123:                              # %pred.store.if367
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s5, $a4, 4
	vpickve2gr.h	$a0, $vr0, 6
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_98
.LBB0_124:                              # %pred.store.if369
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s5, $a4, 5
	vpickve2gr.h	$a0, $vr0, 7
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_99
.LBB0_125:                              # %pred.store.if371
                                        #   in Loop: Header=BB0_10 Depth=1
	st.b	$s5, $a4, 6
	ld.bu	$a0, $a3, 8
	bnez	$a0, .LBB0_100
