...
# %bb.58:                               # %iter.check110
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB3_71
# %bb.59:                               # %vector.main.loop.iter.check112
	bgeu	$a1, $a3, .LBB3_64
# %bb.60:
	move	$a2, $zero
	b	.LBB3_68
...
.LBB3_65:                               # %vector.body116
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_65
# %bb.66:                               # %middle.block121
	beq	$a2, $a1, .LBB3_73
# %bb.67:                               # %vec.epilog.iter.check125
	beqz	$a3, .LBB3_71
.LBB3_68:                               # %vec.epilog.ph127
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB3_69:                               # %vec.epilog.vector.body130
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a6, $a5, 0
	st.w	$a6, $a4, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 4
	bnez	$a3, .LBB3_69
# %bb.70:                               # %vec.epilog.middle.block134
	beq	$a2, $a1, .LBB3_73
.LBB3_71:                               # %vec.epilog.scalar.ph124.preheader
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s2, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB3_72:                               # %vec.epilog.scalar.ph124
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	addi.d	$a1, $a1, -1
