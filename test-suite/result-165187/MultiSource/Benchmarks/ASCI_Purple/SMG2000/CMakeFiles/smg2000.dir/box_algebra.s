...
.LBB2_14:                               # %vector.body721
	...
	addi.d	$t8, $t8, -8
	bnez	$fp, .LBB2_14
# %bb.15:                               # %middle.block725
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t6, $t7, .LBB2_18
.LBB2_16:                               # %scalar.ph716.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t6, $t5, $s3, 2
	.p2align	4, , 16
.LBB2_17:                               # %scalar.ph716
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, -4
	addi.d	$t8, $t6, -4
...
.LBB2_28:                               # %vector.body709
	...
	addi.d	$t7, $t7, -8
	bnez	$t8, .LBB2_28
# %bb.29:                               # %middle.block713
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t5, $t6, .LBB2_32
.LBB2_30:                               # %scalar.ph704.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t5, $t2, $s3, 2
	.p2align	4, , 16
.LBB2_31:                               # %scalar.ph704
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t5, -4
	addi.d	$t7, $t5, -4
...
.LBB2_42:                               # %vector.body697
	...
	addi.d	$t8, $t8, -8
	bnez	$fp, .LBB2_42
# %bb.43:                               # %middle.block701
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t6, $t7, .LBB2_46
.LBB2_44:                               # %scalar.ph692.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t6, $t5, $a5, 2
	.p2align	4, , 16
.LBB2_45:                               # %scalar.ph692
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, -4
	addi.d	$t8, $t6, -4
...
.LBB2_56:                               # %vector.body685
	...
	addi.d	$t7, $t7, -8
	bnez	$t8, .LBB2_56
# %bb.57:                               # %middle.block689
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t5, $t6, .LBB2_60
.LBB2_58:                               # %scalar.ph680.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t5, $t2, $a5, 2
	.p2align	4, , 16
.LBB2_59:                               # %scalar.ph680
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t5, -4
	addi.d	$t7, $t5, -4
...
.LBB2_70:                               # %vector.body673
	...
	addi.d	$t7, $t7, -8
	bnez	$t8, .LBB2_70
# %bb.71:                               # %middle.block677
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t5, $t6, .LBB2_74
.LBB2_72:                               # %scalar.ph668.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t5, $t4, $a7, 2
	.p2align	4, , 16
.LBB2_73:                               # %scalar.ph668
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t5, -4
	addi.d	$t7, $t5, -4
...
# %bb.116:                              # %middle.block737
	...
	move	$fp, $t8
	beq	$t6, $t7, .LBB2_112
.LBB2_117:                              # %scalar.ph728.preheader
                                        #   in Loop: Header=BB2_113 Depth=3
	alsl.d	$a5, $fp, $ra, 2
	sub.d	$fp, $t4, $fp
	.p2align	4, , 16
.LBB2_118:                              # %scalar.ph728
                                        #   Parent Loop BB2_94 Depth=1
                                        #     Parent Loop BB2_111 Depth=2
                                        #       Parent Loop BB2_113 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.150:                              #   in Loop: Header=BB2_149 Depth=1
	...
	b	.LBB2_154
	.p2align	4, , 16
.LBB2_151:                              # %vector.body756.preheader
                                        #   in Loop: Header=BB2_149 Depth=1
	move	$a4, $a2
	.p2align	4, , 16
.LBB2_152:                              # %vector.body756
                                        #   Parent Loop BB2_149 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $a4, -2
	bnez	$a4, .LBB2_152
# %bb.153:                              # %middle.block759
                                        #   in Loop: Header=BB2_149 Depth=1
	move	$a4, $a2
	beq	$s0, $a2, .LBB2_148
	.p2align	4, , 16
.LBB2_154:                              # %scalar.ph751
                                        #   Parent Loop BB2_149 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $a4, 1
	blt	$a4, $s0, .LBB2_154
	b	.LBB2_148
.LBB2_155:                              # %vector.ph742
	slt	$a2, $a0, $t8
	masknez	$a0, $a0, $a2
	maskeqz	$a2, $t8, $a2
	or	$a2, $a2, $a0
	...
	move	$a3, $a0
	.p2align	4, , 16
.LBB2_156:                              # %vector.body745
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a3, $a3, -2
	bnez	$a3, .LBB2_156
# %bb.157:                              # %middle.block748
	ld.d	$t6, $sp, 72                    # 8-byte Folded Reload
	beq	$a2, $a0, .LBB2_159
	.p2align	4, , 16
...
.LBB2_174:                              # %vector.ph765
	...
	move	$a2, $a0
	.p2align	4, , 16
.LBB2_175:                              # %vector.body768
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, -2
	bnez	$a2, .LBB2_175
# %bb.176:                              # %middle.block771
	beq	$a1, $a0, .LBB2_178
	.p2align	4, , 16
...
.LBB2_183:                              # %vector.body779
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_183
# %bb.184:                              # %middle.block784
	vadd.w	$vr0, $vr1, $vr0
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a1, $vr0, 0
	beq	$a0, $a3, .LBB2_187
.LBB2_185:                              # %.lr.ph283.preheader787
	alsl.d	$a2, $a0, $s1, 2
	sub.d	$a0, $a3, $a0
	.p2align	4, , 16
.LBB2_186:                              # %.lr.ph283
