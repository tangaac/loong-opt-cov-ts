...
.LBB8_32:                               # %.lr.ph.i
	...
	move	$a0, $a4
	bnez	$a3, .LBB8_32
.LBB8_33:                               # %._crit_edge.i
	move	$a0, $zero
	st.w	$a2, $fp, 48
	beqz	$a2, .LBB8_39
# %bb.34:                               # %._crit_edge.i
	beq	$a2, $s0, .LBB8_39
# %bb.35:                               # %.lr.ph39.preheader.i
	ori	$a1, $zero, 4
	move	$a0, $a2
	pcaddu18i	$ra, %call36(hypre_CAlloc)
	jirl	$ra, $ra, 0
...
# %bb.38:                               #   in Loop: Header=BB8_37 Depth=1
	...
	stx.w	$a1, $a0, $a4
	b	.LBB8_36
.LBB8_39:                               # %hypre_CSRMatrixSetRownnz.exit
	st.d	$a0, $fp, 40
.LBB8_40:
	move	$a0, $fp
...
# %bb.40:                               # %middle.block
	beq	$a3, $s4, .LBB9_43
.LBB9_41:                               # %.lr.ph220.split.preheader488
	alsl.d	$a1, $a3, $s1, 2
	sub.d	$a2, $s4, $a3
	.p2align	4, , 16
