...
.LBB0_11:                               # %vector.body131
	...
	fld.d	$fa4, $t5, -8
	fld.d	$fa5, $t5, 0
	fmadd.d	$fa2, $fa2, $fa4, $fa1
	fmadd.d	$fa3, $fa3, $fa5, $fa1
	frecip.d	$fa2, $fa2
	frecip.d	$fa3, $fa3
	fst.d	$fa2, $t3, -8
	fst.d	$fa3, $t3, 0
...
# %bb.18:                               #   in Loop: Header=BB0_17 Depth=1
	...
	b	.LBB0_22
	.p2align	4, , 16
.LBB0_19:                               # %vector.ph139
                                        #   in Loop: Header=BB0_17 Depth=1
	vreplvei.d	$vr6, $vr5, 0
	move	$s0, $t3
	move	$s1, $t2
	.p2align	4, , 16
.LBB0_20:                               # %vector.body142
	...
	addi.d	$s0, $s0, 32
	bnez	$s1, .LBB0_20
# %bb.21:                               # %middle.block145
                                        #   in Loop: Header=BB0_17 Depth=1
	move	$s1, $t2
	beq	$t2, $a0, .LBB0_16
.LBB0_22:                               # %scalar.ph137.preheader
                                        #   in Loop: Header=BB0_17 Depth=1
	alsl.d	$s0, $s1, $t8, 3
	sub.d	$s1, $a0, $s1
	.p2align	4, , 16
.LBB0_23:                               # %scalar.ph137
                                        #   Parent Loop BB0_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fst.d	$fa5, $s0, 0
	addi.d	$s1, $s1, -1
...
# %bb.25:
	move	$t0, $zero
	b	.LBB0_29
.LBB0_26:                               # %vector.ph150
	move	$t1, $zero
	slli.d	$t0, $t0, 1
	addi.d	$t2, $sp, 208
	move	$t3, $a6
	.p2align	4, , 16
.LBB0_27:                               # %vector.body153
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa1, $t3, 0
	fld.d	$fa2, $t3, 104
	frecip.d	$fa1, $fa1
	...
	addi.d	$t2, $t2, 16
	bne	$t0, $t1, .LBB0_27
# %bb.28:                               # %middle.block156
	beq	$t0, $a0, .LBB0_31
.LBB0_29:                               # %.lr.ph95.preheader159
	addi.d	$t1, $sp, 200
	alsl.d	$t1, $t0, $t1, 3
	ori	$t2, $zero, 104
	mul.d	$t2, $t0, $t2
