...
.Ltmp11:                                # EH_LABEL
	b	.LBB5_2
.LBB5_6:                                # %_ZN28btCompoundCollisionAlgorithm21removeChildAlgorithmsEv.exit
	ld.d	$a0, $fp, 32
	beqz	$a0, .LBB5_9
...
# %bb.29:                               # %.lr.ph160
	...
	b	.LBB7_32
	.p2align	4, , 16
.LBB7_30:                               # %_Z20TestAabbAgainstAabb2RK9btVector3S1_S1_S1_.exit.thread
...
# %bb.40:                               #   in Loop: Header=BB7_32 Depth=1
	...
	beqz	$a0, .LBB7_30
	b	.LBB7_31
.LBB7_41:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit115
...
.LBB7_43:
.Ltmp37:                                # EH_LABEL
.LBB7_44:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit111
	move	$fp, $a0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
...
.Ltmp32:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp33:                                # EH_LABEL
.LBB7_50:                               # %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit111
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB7_51:
...
.Ltmp50:                                # EH_LABEL
	.p2align	4, , 16
.LBB8_4:                                # %_Z9IntersectRK12btDbvtAabbMmS1_.exit.thread
...
.LBB8_23:                               # %scalar.ph129
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB8_23
.LBB8_24:                               # %_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE4copyEiiPS2_.exit.i.i30
                                        #   in Loop: Header=BB8_5 Depth=1
.Ltmp43:                                # EH_LABEL
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp44:                                # EH_LABEL
.LBB8_25:                               # %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE10deallocateEv.exit.i.i33
                                        #   in Loop: Header=BB8_5 Depth=1
	ld.d	$a0, $s0, 40
	addi.w	$a1, $s4, 0
	stx.d	$a0, $s2, $s3
...
.LBB8_33:                               # %scalar.ph
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB8_33
.LBB8_34:                               # %_ZNK20btAlignedObjectArrayIPK10btDbvtNodeE4copyEiiPS2_.exit.thread.i.i64
                                        #   in Loop: Header=BB8_5 Depth=1
.Ltmp47:                                # EH_LABEL
	move	$s1, $s2
	move	$a0, $s2
...
.Ltmp48:                                # EH_LABEL
	move	$s2, $s3
	b	.LBB8_36
.LBB8_35:                               # %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE10deallocateEv.exit.i.i33._ZN20btAlignedObjectArrayIPK10btDbvtNodeE9push_backERKS2_.exit70_crit_edge
                                        #   in Loop: Header=BB8_5 Depth=1
	move	$s7, $s6
.LBB8_36:                               # %_ZN20btAlignedObjectArrayIPK10btDbvtNodeE9push_backERKS2_.exit70
                                        #   in Loop: Header=BB8_5 Depth=1
	ld.d	$a0, $s0, 48
	slli.d	$a1, $s7, 3
	stx.d	$a0, $s2, $a1
...
# %bb.0:
	...
	fld.s	$ft5, $a0, 8
	fld.s	$ft6, $a0, 40
	fmadd.s	$fa0, $ft3, $ft2, $fa0
	fmul.s	$fa1, $fa3, $ft4
	fmadd.s	$fa1, $ft5, $fa6, $fa1
	fmadd.s	$fa1, $ft6, $ft2, $fa1
	vreplvei.w	$vr15, $vr18, 1
	fmul.s	$ft8, $ft7, $fa4
	vreplvei.w	$vr17, $vr18, 0
	fmadd.s	$ft8, $fa5, $ft9, $ft8
	vst	$vr18, $sp, 64                  # 16-byte Folded Spill
	vreplvei.w	$vr18, $vr18, 2
	fmadd.s	$ft8, $fa7, $ft10, $ft8
	fmul.s	$ft11, $ft7, $ft0
	fmadd.s	$ft11, $ft1, $ft9, $ft11
	fmadd.s	$ft11, $ft3, $ft10, $ft11
	fmul.s	$ft12, $ft7, $ft4
	fmadd.s	$ft12, $ft5, $ft9, $ft12
	fmadd.s	$ft12, $ft6, $ft10, $ft12
	vreplvei.w	$vr21, $vr23, 1
	fmul.s	$fa4, $ft13, $fa4
	vreplvei.w	$vr22, $vr23, 0
	fmadd.s	$fa4, $fa5, $ft14, $fa4
	vst	$vr23, $sp, 48                  # 16-byte Folded Spill
	vreplvei.w	$vr5, $vr23, 2
	fmadd.s	$fa4, $fa7, $fa5, $fa4
	fmul.s	$fa7, $ft13, $ft0
	fmadd.s	$fa7, $ft1, $ft14, $fa7
	fmadd.s	$fa7, $ft3, $fa5, $fa7
	fmul.s	$ft0, $ft13, $ft4
	fmadd.s	$ft0, $ft5, $ft14, $ft0
	fld.s	$ft1, $a0, 52
	fld.s	$ft3, $a0, 48
	fld.s	$ft4, $a0, 56
	fmadd.s	$ft0, $ft6, $fa5, $ft0
	fmul.s	$fa3, $fa3, $ft1
	fmadd.s	$fa3, $fa6, $ft3, $fa3
	fmadd.s	$fa3, $ft2, $ft4, $fa3
	vreplvei.w	$vr6, $vr24, 0
	fadd.s	$fa3, $fa6, $fa3
	fmul.s	$fa6, $ft7, $ft1
	fmadd.s	$fa6, $ft9, $ft3, $fa6
	fmadd.s	$fa6, $ft10, $ft4, $fa6
	vreplvei.w	$vr10, $vr24, 1
	fadd.s	$fa6, $ft2, $fa6
	fmul.s	$ft1, $ft13, $ft1
	fmadd.s	$ft1, $ft14, $ft3, $ft1
	fmadd.s	$fa5, $fa5, $ft4, $ft1
	vst	$vr24, $sp, 32                  # 16-byte Folded Spill
	vreplvei.w	$vr9, $vr24, 2
	fadd.s	$fa5, $ft1, $fa5
	movfr2gr.s	$a0, $fa3
	movfr2gr.s	$a1, $fa6
	bstrins.d	$a0, $a1, 63, 32
...
.LBB9_13:
	...
	vst	$vr2, $a0, 104
	vst	$vr3, $a0, 120
.LBB9_14:                               # %_Z20TestAabbAgainstAabb2RK9btVector3S1_S1_S1_.exit.thread
...
.LBB11_2:                               # =>This Inner Loop Header: Depth=1
	...
	fmul.s	$ft3, $ft8, $ft0
	fmadd.s	$ft3, $ft1, $ft7, $ft3
	fmadd.s	$ft3, $ft2, $ft9, $ft3
	vld	$vr19, $sp, 128                 # 16-byte Folded Reload
	fmul.s	$ft4, $ft11, $fa0
	vld	$vr18, $sp, 144                 # 16-byte Folded Reload
	fmadd.s	$ft4, $fa1, $ft10, $ft4
	vld	$vr20, $sp, 112                 # 16-byte Folded Reload
	fmadd.s	$ft4, $fa3, $ft12, $ft4
	fmul.s	$ft5, $ft11, $fa4
	fmadd.s	$ft5, $fa5, $ft10, $ft5
	fmadd.s	$ft5, $fa7, $ft12, $ft5
	fmul.s	$ft6, $ft11, $ft0
	fmadd.s	$ft6, $ft1, $ft10, $ft6
	fmadd.s	$ft6, $ft2, $ft12, $ft6
	vld	$vr22, $sp, 80                  # 16-byte Folded Reload
	fmul.s	$fa0, $ft14, $fa0
	vld	$vr21, $sp, 96                  # 16-byte Folded Reload
	fmadd.s	$fa0, $fa1, $ft13, $fa0
	vld	$vr23, $sp, 64                  # 16-byte Folded Reload
	fmadd.s	$fa0, $fa3, $ft15, $fa0
	fmul.s	$fa1, $ft14, $fa4
	fmadd.s	$fa1, $fa5, $ft13, $fa1
	fmadd.s	$fa1, $fa7, $ft15, $fa1
	fmul.s	$fa3, $ft14, $ft0
	fmadd.s	$fa3, $ft1, $ft13, $fa3
	fld.s	$fa4, $a2, 52
	fld.s	$fa5, $a2, 48
	fld.s	$fa7, $a2, 56
	fmadd.s	$fa3, $ft2, $ft15, $fa3
	fmul.s	$ft0, $ft8, $fa4
	fmadd.s	$ft0, $ft7, $fa5, $ft0
	fmadd.s	$ft0, $ft9, $fa7, $ft0
	vld	$vr9, $sp, 48                   # 16-byte Folded Reload
	fadd.s	$ft0, $ft1, $ft0
	fmul.s	$ft1, $ft11, $fa4
	fmadd.s	$ft1, $ft10, $fa5, $ft1
	fmadd.s	$ft1, $ft12, $fa7, $ft1
	vld	$vr10, $sp, 32                  # 16-byte Folded Reload
	fadd.s	$ft1, $ft2, $ft1
	fmul.s	$fa4, $ft14, $fa4
	fmadd.s	$fa4, $ft13, $fa5, $fa4
	fmadd.s	$fa4, $ft15, $fa7, $fa4
