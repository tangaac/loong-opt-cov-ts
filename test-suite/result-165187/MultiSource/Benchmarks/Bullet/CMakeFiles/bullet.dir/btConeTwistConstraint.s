...
# %bb.37:
	...
	fld.s	$ft1, $a0, 288
	fld.s	$ft2, $a0, 300
	fmadd.s	$fa7, $fa7, $fa4, $ft0
	fld.s	$ft0, $a0, 296
	fmadd.s	$fa7, $ft1, $fa5, $fa7
	fmul.s	$ft1, $ft2, $fa6
	fld.s	$ft2, $a0, 304
	fmadd.s	$ft0, $ft0, $fa4, $ft1
	fld.s	$ft1, $a0, 316
	fld.s	$ft3, $a0, 312
	fmadd.s	$ft0, $ft2, $fa5, $ft0
	fld.s	$ft2, $a0, 320
	fmul.s	$ft1, $ft1, $fa6
	fmadd.s	$ft1, $ft3, $fa4, $ft1
	fld.s	$ft3, $a1, 0
...
# %bb.39:
	...
	fmadd.s	$fa0, $fa0, $fa7, $fa1
	fmul.s	$fa1, $fa2, $fa0
	fmadd.s	$fa2, $fa1, $ft0, $fa3
	movgr2fr.w	$fa1, $zero
	fld.s	$fa4, $fp, 544
	fcmp.clt.s	$fcc0, $fa1, $fa0
	fld.s	$fa0, $fp, 568
