...
.LBB0_63:                               #   Parent Loop BB0_44 Depth=1
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB0_63
.LBB0_64:                               # %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit939
                                        #   in Loop: Header=BB0_44 Depth=1
	ld.w	$a0, $sp, 264
	blez	$a0, .LBB0_68
# %bb.65:                               # %.lr.ph2128.preheader
                                        #   in Loop: Header=BB0_44 Depth=1
	move	$s0, $zero
	move	$s1, $zero
	.p2align	4, , 16
...
.LBB0_81:                               #   in Loop: Header=BB0_44 Depth=1
	beqz	$s2, .LBB0_42
# %bb.82:                               #   in Loop: Header=BB0_44 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
	b	.LBB0_42
.LBB0_83:                               # %.loopexit2049
...
.LBB0_96:                               #   Parent Loop BB0_94 Depth=1
	...
	fmul.s	$fa3, $fa2, $fa3
	vinsgr2vr.d	$vr4, $a4, 0
	vextrins.w	$vr2, $vr2, 16
	vfmul.s	$vr2, $vr4, $vr2
	vfadd.s	$vr1, $vr2, $vr1
	vstelm.w	$vr1, $sp, 224, 0
	vstelm.w	$vr1, $sp, 228, 1
	fadd.s	$fa0, $fa3, $fa0
	fst.s	$fa0, $sp, 232
	addi.d	$a2, $a2, 8
	addi.d	$a1, $a1, -1
...
# %bb.105:                              # %.lr.ph2146
	...
	b	.LBB0_110
.LBB0_106:                              #   in Loop: Header=BB0_110 Depth=1
	vld	$vr0, $a0, 0
	vld	$vr1, $a0, 16
	vld	$vr2, $a0, 32
	vld	$vr3, $a0, 48
	...
	.p2align	4, , 16
.LBB0_107:                              # %_ZNK10btSoftBody4Body5xformEv.exit1397
...
# %bb.112:                              #   in Loop: Header=BB0_110 Depth=1
	...
	dbar	20
	beqz	$a0, .LBB0_123
.LBB0_113:                              # %_ZNK10btSoftBody4Body5xformEv.exit
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $s2, 24
	ld.d	$a1, $s2, 8
	sltui	$a2, $a0, 1
	...
	dbar	20
	beqz	$a0, .LBB0_126
.LBB0_114:                              # %_ZNK10btSoftBody4Body5xformEv.exit1275
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $s2, 48
	ld.d	$a1, $s2, 32
	sltui	$a2, $a0, 1
	...
	dbar	20
	beqz	$a0, .LBB0_129
.LBB0_115:                              # %_ZNK10btSoftBody4Body5xformEv.exit1288
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $s2, 24
	ld.d	$a1, $s2, 8
	sltui	$a2, $a0, 1
	...
	dbar	20
	beqz	$a0, .LBB0_132
.LBB0_116:                              # %_ZNK10btSoftBody4Body5xformEv.exit1294
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $s2, 48
	ld.d	$a1, $s2, 32
	sltui	$a2, $a0, 1
...
.LBB0_117:                              #   in Loop: Header=BB0_110 Depth=1
	...
	dbar	20
	beqz	$a0, .LBB0_135
.LBB0_118:                              # %_ZNK10btSoftBody4Body5xformEv.exit1372
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $s2, 24
	ld.d	$a1, $s2, 8
	sltui	$a2, $a0, 1
	...
	dbar	20
	beqz	$a0, .LBB0_138
.LBB0_119:                              # %_ZNK10btSoftBody4Body5xformEv.exit1378
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $s2, 48
	ld.d	$a1, $s2, 32
	sltui	$a2, $a0, 1
	...
	dbar	20
	beqz	$a0, .LBB0_141
.LBB0_120:                              # %_ZNK10btSoftBody4Body5xformEv.exit1384
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $s2, 24
	ld.d	$a1, $s2, 8
	sltui	$a2, $a0, 1
...
.LBB0_126:                              #   in Loop: Header=BB0_110 Depth=1
	...
	addi.w	$a0, $a0, 0
	beqz	$a0, .LBB0_114
# %bb.127:                              #   in Loop: Header=BB0_110 Depth=1
.Ltmp52:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_ZN11btTransform11getIdentityEv)
	jirl	$ra, $ra, 0
.Ltmp53:                                # EH_LABEL
# %bb.128:                              #   in Loop: Header=BB0_110 Depth=1
	...
	ld.d	$s0, $sp, 128                   # 8-byte Folded Reload
	b	.LBB0_114
.LBB0_129:                              #   in Loop: Header=BB0_110 Depth=1
	pcalau12i	$a0, %pc_hi20(_ZGVZNK10btSoftBody4Body5xformEvE8identity)
	addi.d	$a0, $a0, %pc_lo12(_ZGVZNK10btSoftBody4Body5xformEvE8identity)
	pcaddu18i	$ra, %call36(__cxa_guard_acquire)
	jirl	$ra, $ra, 0
...
.LBB0_135:                              #   in Loop: Header=BB0_110 Depth=1
	...
	addi.w	$a0, $a0, 0
	beqz	$a0, .LBB0_118
# %bb.136:                              #   in Loop: Header=BB0_110 Depth=1
.Ltmp37:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_ZN11btTransform11getIdentityEv)
	jirl	$ra, $ra, 0
.Ltmp38:                                # EH_LABEL
...
.LBB0_141:                              #   in Loop: Header=BB0_110 Depth=1
	...
	addi.w	$a0, $a0, 0
	beqz	$a0, .LBB0_120
# %bb.142:                              #   in Loop: Header=BB0_110 Depth=1
.Ltmp43:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_ZN11btTransform11getIdentityEv)
	jirl	$ra, $ra, 0
.Ltmp44:                                # EH_LABEL
...
.Lttbase3:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.globl	_ZN17btSoftBodyHelpers11CreatePatchER19btSoftBodyWorldInfoRK9btVector3S4_S4_S4_iiib # -- Begin function _ZN17btSoftBodyHelpers11CreatePatchER19btSoftBodyWorldInfoRK9btVector3S4_S4_S4_iiib
	.p2align	5
...
.LBB13_3:                               # %.lr.ph.us
	...
	fdiv.s	$ft9, $ft6, $fa2
	fmadd.s	$ft6, $fa3, $ft9, $fa0
	fmadd.s	$ft7, $fa4, $ft9, $fa1
	fmadd.s	$ft8, $ft1, $ft9, $fa5
	fmadd.s	$ft10, $ft2, $ft9, $fa6
	fmadd.s	$ft11, $ft3, $ft9, $fa7
	fmadd.s	$ft12, $ft4, $ft9, $ft0
	fsub.s	$ft9, $ft10, $ft6
...
.LBB13_4:                               #   Parent Loop BB13_3 Depth=1
	...
	movgr2fr.d	$ft12, $t2
	ffint.s.l	$ft12, $ft12
	fdiv.s	$ft12, $ft12, $ft5
	fmadd.s	$ft13, $ft9, $ft12, $ft6
	fmadd.s	$ft14, $ft10, $ft12, $ft7
	fmadd.s	$ft12, $ft11, $ft12, $ft8
	movfr2gr.s	$t2, $ft13
	movfr2gr.s	$t3, $ft14
...
.LBB13_11:
	...
	pcaddu18i	$ra, %call36(_ZN10btSoftBody7setMassEif)
	jirl	$ra, $ra, 0
.LBB13_12:                              # %.preheader.us.preheader
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $s5
...
.LBB13_14:                              # %.preheader.us
	...
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	bge	$a0, $fp, .LBB13_25
# %bb.15:                               # %.lr.ph.split.us.us.preheader
                                        #   in Loop: Header=BB13_14 Depth=1
	move	$fp, $zero
	add.d	$s6, $s0, $s7
	b	.LBB13_19
	.p2align	4, , 16
.LBB13_16:                              # %.thread.us.us.critedge
                                        #   in Loop: Header=BB13_19 Depth=2
	add.w	$a2, $s6, $s5
	move	$a0, $s2
	move	$a1, $s1
.LBB13_17:                              # %.thread.us.us
                                        #   in Loop: Header=BB13_19 Depth=2
	move	$a3, $zero
	move	$a4, $zero
	pcaddu18i	$ra, %call36(_ZN10btSoftBody10appendLinkEiiPNS_8MaterialEb)
	jirl	$ra, $ra, 0
.LBB13_18:                              # %.thread.us.us
                                        #   in Loop: Header=BB13_19 Depth=2
	beq	$s0, $fp, .LBB13_13
.LBB13_19:                              # %.lr.ph.split.us.us
...
# %bb.22:                               #   in Loop: Header=BB13_19 Depth=2
	...
	b	.LBB13_17
	.p2align	4, , 16
.LBB13_23:                              #   in Loop: Header=BB13_19 Depth=2
	addi.w	$s5, $s4, 1
	move	$a0, $s2
	move	$a1, $s1
	move	$a2, $s3
	...
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB13_18
# %bb.24:                               #   in Loop: Header=BB13_19 Depth=2
	move	$a0, $s2
	move	$a1, $s1
	move	$a2, $s5
	b	.LBB13_17
	.p2align	4, , 16
.LBB13_25:                              # %.lr.ph.split.us196.preheader
                                        #   in Loop: Header=BB13_14 Depth=1
	move	$a0, $zero
	b	.LBB13_27
	.p2align	4, , 16
.LBB13_26:                              # %.thread.us193
                                        #   in Loop: Header=BB13_27 Depth=2
	move	$a0, $fp
	beq	$s0, $fp, .LBB13_13
.LBB13_27:                              # %.lr.ph.split.us196
                                        #   Parent Loop BB13_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$fp, $a0, 1
	bge	$fp, $s0, .LBB13_26
...
.Ltmp82:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp83:                                # EH_LABEL
# %bb.34:                               # %_ZN17btCollisionObjectdlEPv.exit
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB13_35:
...
.Lttbase4:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.globl	_ZN17btSoftBodyHelpers13CreatePatchUVER19btSoftBodyWorldInfoRK9btVector3S4_S4_S4_iiibPf # -- Begin function _ZN17btSoftBodyHelpers13CreatePatchUVER19btSoftBodyWorldInfoRK9btVector3S4_S4_S4_iiibPf
	.p2align	5
...
.LBB14_3:                               # %.lr.ph.us
	...
	fdiv.s	$ft8, $ft5, $fa2
	fmadd.s	$ft5, $fa3, $ft8, $fa0
	fmadd.s	$ft6, $fa4, $ft8, $fa1
	fmadd.s	$ft7, $ft1, $ft8, $fa5
	fmadd.s	$ft9, $ft2, $ft8, $fa6
	fmadd.s	$ft10, $ft3, $ft8, $fa7
	fmadd.s	$ft11, $ft4, $ft8, $ft0
	fsub.s	$ft8, $ft9, $ft5
	fsub.s	$ft9, $ft10, $ft6
	fsub.s	$ft10, $ft11, $ft7
	move	$a7, $s4
...
.LBB14_4:                               #   Parent Loop BB14_3 Depth=1
	...
	movgr2fr.d	$ft11, $t2
	ffint.s.l	$ft11, $ft11
	fdiv.s	$ft11, $ft11, $fs0
	fmadd.s	$ft12, $ft8, $ft11, $ft5
	fmadd.s	$ft13, $ft9, $ft11, $ft6
	fmadd.s	$ft11, $ft10, $ft11, $ft7
	movfr2gr.s	$t2, $ft12
	movfr2gr.s	$t3, $ft13
	bstrins.d	$t2, $t3, 63, 32
	movfr2gr.s	$t3, $ft11
...
.LBB14_16:
	...
	pcaddu18i	$ra, %call36(_ZN10btSoftBody7setMassEif)
	jirl	$ra, $ra, 0
.LBB14_17:                              # %.preheader.us.preheader
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $s7
	...
	b	.LBB14_19
	.p2align	4, , 16
.LBB14_18:                              # %._crit_edge.us260
                                        #   in Loop: Header=BB14_19 Depth=1
	add.d	$s8, $s8, $s4
	ld.d	$s0, $sp, 16                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	beq	$a1, $s0, .LBB14_32
.LBB14_19:                              # %.preheader.us
                                        # =>This Loop Header: Depth=1
...
# %bb.24:                               #   in Loop: Header=BB14_22 Depth=2
	...
	b	.LBB14_27
	.p2align	4, , 16
.LBB14_25:                              # %.thread.us.us.critedge
...
.LBB14_27:                              #   in Loop: Header=BB14_22 Depth=2
	...
	b	.LBB14_21
	.p2align	4, , 16
.LBB14_28:                              # %.lr.ph.split.us259.preheader
                                        #   in Loop: Header=BB14_19 Depth=1
	move	$a0, $zero
	b	.LBB14_30
	.p2align	4, , 16
.LBB14_29:                              # %.thread.us256
                                        #   in Loop: Header=BB14_30 Depth=2
	move	$a0, $s0
	beq	$s4, $s0, .LBB14_18
.LBB14_30:                              # %.lr.ph.split.us259
                                        #   Parent Loop BB14_19 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$s0, $a0, 1
	bge	$s0, $s4, .LBB14_29
...
.Ltmp88:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp89:                                # EH_LABEL
# %bb.42:                               # %_ZN17btCollisionObjectdlEPv.exit
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB14_43:
