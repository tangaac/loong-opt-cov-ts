...
.Ltmp411:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp412:                               # EH_LABEL
# %bb.632:                              # %_ZNSolsEPFRSoS_E.exit376
	ori	$a0, $zero, 2
	st.w	$a0, $s1, 0
	b	.LBB4_129
.LBB4_633:
...
.Ltmp126:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp127:                               # EH_LABEL
.LBB4_635:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i990
.Ltmp128:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp130:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp131:                               # EH_LABEL
# %bb.637:                              # %_ZNSolsEPFRSoS_E.exit378
.Ltmp132:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp133:                               # EH_LABEL
# %bb.638:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit379
.Ltmp134:                               # EH_LABEL
	addi.w	$a1, $s1, -2
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSolsEi)
...
# %bb.639:
	...
	ld.d	$s4, $a0, 240
	beqz	$s4, .LBB4_760
# %bb.640:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i999
	ld.bu	$a0, $s4, 56
	beqz	$a0, .LBB4_642
# %bb.641:
	ld.bu	$a0, $s4, 67
...
.Ltmp138:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp139:                               # EH_LABEL
.LBB4_644:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1001
.Ltmp140:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp142:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp143:                               # EH_LABEL
# %bb.646:                              # %_ZNSolsEPFRSoS_E.exit380
.Ltmp144:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp145:                               # EH_LABEL
# %bb.647:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit381
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.648:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1010
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_650
# %bb.649:
	ld.bu	$a0, $s0, 67
...
.Ltmp148:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp149:                               # EH_LABEL
.LBB4_652:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1012
.Ltmp150:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp152:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp153:                               # EH_LABEL
# %bb.654:                              # %_ZNSolsEPFRSoS_E.exit382
.Ltmp154:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp155:                               # EH_LABEL
# %bb.655:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit383
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.656:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1021
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_658
# %bb.657:
	ld.bu	$a0, $s0, 67
...
.Ltmp158:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp159:                               # EH_LABEL
.LBB4_660:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1023
.Ltmp160:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp162:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp163:                               # EH_LABEL
# %bb.662:                              # %_ZNSolsEPFRSoS_E.exit384
.Ltmp164:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp165:                               # EH_LABEL
# %bb.663:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit385
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.664:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1032
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_666
# %bb.665:
	ld.bu	$a0, $s0, 67
...
.Ltmp168:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp169:                               # EH_LABEL
.LBB4_668:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1034
.Ltmp170:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp172:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp173:                               # EH_LABEL
# %bb.670:                              # %_ZNSolsEPFRSoS_E.exit386
.Ltmp174:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp175:                               # EH_LABEL
# %bb.671:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit387
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.672:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1043
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_674
# %bb.673:
	ld.bu	$a0, $s0, 67
...
.Ltmp178:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp179:                               # EH_LABEL
.LBB4_676:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1045
.Ltmp180:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp182:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp183:                               # EH_LABEL
# %bb.678:                              # %_ZNSolsEPFRSoS_E.exit388
.Ltmp184:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp185:                               # EH_LABEL
# %bb.679:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit389
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.680:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1054
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_682
# %bb.681:
	ld.bu	$a0, $s0, 67
...
.Ltmp188:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp189:                               # EH_LABEL
.LBB4_684:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1056
.Ltmp190:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp192:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp193:                               # EH_LABEL
# %bb.686:                              # %_ZNSolsEPFRSoS_E.exit390
.Ltmp194:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp195:                               # EH_LABEL
# %bb.687:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit391
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.688:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1065
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_690
# %bb.689:
	ld.bu	$a0, $s0, 67
...
.Ltmp198:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp199:                               # EH_LABEL
.LBB4_692:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1067
.Ltmp200:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp202:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp203:                               # EH_LABEL
# %bb.694:                              # %_ZNSolsEPFRSoS_E.exit392
.Ltmp204:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp205:                               # EH_LABEL
# %bb.695:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit393
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.696:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1076
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_698
# %bb.697:
	ld.bu	$a0, $s0, 67
...
.Ltmp208:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp209:                               # EH_LABEL
.LBB4_700:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1078
.Ltmp210:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.LBB4_704:
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a0, $a1
.LBB4_705:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit576
.Ltmp298:                               # EH_LABEL
	move	$a1, $s3
	move	$a2, $s2
...
.Ltmp300:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp301:                               # EH_LABEL
# %bb.707:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit578
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_764
# %bb.708:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1087
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_710
# %bb.709:
	ld.bu	$a0, $s0, 67
...
.Ltmp304:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp305:                               # EH_LABEL
.LBB4_712:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1089
.Ltmp306:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp308:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp309:                               # EH_LABEL
# %bb.714:                              # %_ZNSolsEPFRSoS_E.exit580
.Ltmp310:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp311:                               # EH_LABEL
# %bb.715:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit582
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_764
# %bb.716:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1098
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_718
# %bb.717:
	ld.bu	$a0, $s0, 67
...
.Ltmp314:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp315:                               # EH_LABEL
.LBB4_720:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1100
.Ltmp316:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp318:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp319:                               # EH_LABEL
# %bb.722:                              # %_ZNSolsEPFRSoS_E.exit584
.Ltmp320:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp321:                               # EH_LABEL
# %bb.723:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit586
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_764
# %bb.724:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1109
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_726
# %bb.725:
	ld.bu	$a0, $s0, 67
...
.Ltmp324:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp325:                               # EH_LABEL
.LBB4_728:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1111
.Ltmp326:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp328:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp329:                               # EH_LABEL
# %bb.730:                              # %_ZNSolsEPFRSoS_E.exit588
.Ltmp330:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp331:                               # EH_LABEL
# %bb.731:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit590
	ld.d	$a2, $fp, 96
	ld.d	$a1, $fp, 104
	ld.d	$a0, $fp, 120
	sub.d	$a1, $a2, $a1
...
.LBB4_736:
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a0, $a1
.LBB4_737:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit592
	addi.d	$s1, $sp, 144
	st.d	$s1, $sp, 128
	ld.d	$a1, $a0, 8
	ld.d	$s0, $a0, 0
...
# %bb.739:                              # %.noexc595
	...
	st.d	$a0, $sp, 128
	st.d	$a1, $sp, 144
.LBB4_740:                              # %._crit_edge.i.i.i593
	beq	$a1, $s8, .LBB4_744
# %bb.741:                              # %._crit_edge.i.i.i593
	bnez	$a1, .LBB4_743
# %bb.742:
	ld.b	$a1, $s0, 0
	st.b	$a1, $a0, 0
...
.Ltmp335:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp336:                               # EH_LABEL
# %bb.745:                              # %_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit598
	move	$s0, $a0
	ld.d	$a0, $a0, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s0, $a0
	ld.d	$s3, $a0, 240
	beqz	$s3, .LBB4_766
# %bb.746:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i1120
	ld.bu	$a0, $s3, 56
	beqz	$a0, .LBB4_748
# %bb.747:
	ld.bu	$a0, $s3, 67
...
.Ltmp339:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp340:                               # EH_LABEL
.LBB4_750:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i1122
.Ltmp341:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.Ltmp343:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp344:                               # EH_LABEL
# %bb.752:                              # %_ZNSolsEPFRSoS_E.exit600
	ld.d	$a0, $sp, 128
	beq	$a0, $s1, .LBB4_128
# %bb.753:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i601
	ld.d	$a1, $sp, 144
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.LBB4_811:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit400
	...
	addi.d	$a1, $sp, 176
	beq	$a0, $a1, .LBB4_815
# %bb.812:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i715
	ld.d	$a1, $sp, 176
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.LBB11_141:                             #   in Loop: Header=BB11_5 Depth=1
	...
	addi.d	$a1, $sp, 168
	beq	$a0, $a1, .LBB11_143
.LBB11_142:                             # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i156
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 168
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB12_177:                             # %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB12_189
# %bb.178:                              # %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit245.thread.thread585
                                        #   in Loop: Header=BB12_126 Depth=2
	ori	$a0, $zero, 2
	beq	$fp, $a0, .LBB12_196
