...
# %bb.48:                               # %.lr.ph495
	...
	b	.LBB6_52
	.p2align	4, , 16
.LBB6_49:                               #   in Loop: Header=BB6_52 Depth=1
	ldx.w	$t5, $s1, $t7
	slli.d	$t5, $t5, 2
	ldx.w	$t5, $s1, $t5
	st.w	$t5, $a5, 0
...
# %bb.62:                               #   in Loop: Header=BB6_52 Depth=1
	ldx.w	$t5, $s2, $t7
.LBB6_63:                               #   in Loop: Header=BB6_52 Depth=1
	st.w	$t5, $a6, 0
	ld.w	$t5, $t0, 0
	ld.w	$t6, $t1, 0
	slli.d	$t5, $t5, 2
...
# %bb.64:                               #   in Loop: Header=BB6_52 Depth=1
	st.w	$t4, $t2, 0
	b	.LBB6_67
.LBB6_65:                               #   in Loop: Header=BB6_52 Depth=1
	ld.w	$t5, $a5, 0
	slli.d	$t5, $t5, 2
	ldx.w	$t5, $s1, $t5
.LBB6_66:                               #   in Loop: Header=BB6_52 Depth=1
	slli.d	$t5, $t5, 2
	ldx.w	$t5, $s2, $t5
	st.w	$t5, $t2, 0
.LBB6_67:                               #   in Loop: Header=BB6_52 Depth=1
	ld.w	$t5, $t0, 0
	slli.d	$t5, $t5, 2
	ldx.w	$t6, $a3, $t5
	ld.w	$t7, $t1, 0
	addi.w	$t6, $t6, -1
	bne	$t7, $t6, .LBB6_73
# %bb.68:                               #   in Loop: Header=BB6_52 Depth=1
	ld.w	$t6, $a7, 0
	ldx.w	$t7, $a1, $t5
	move	$t5, $t4
	beq	$t6, $t7, .LBB6_70
# %bb.69:                               #   in Loop: Header=BB6_52 Depth=1
	ld.w	$t5, $t2, 0
	slli.d	$t5, $t5, 2
	ld.d	$t6, $sp, 88                    # 8-byte Folded Reload
	ldx.w	$t5, $t6, $t5
	slli.d	$t5, $t5, 2
	ldx.w	$t5, $s3, $t5
.LBB6_70:                               #   in Loop: Header=BB6_52 Depth=1
	st.w	$t5, $a5, 0
	ld.w	$t5, $t0, 0
	ld.w	$t6, $a7, 0
	slli.d	$t5, $t5, 2
	ldx.w	$t5, $a2, $t5
	bne	$t6, $t5, .LBB6_72
# %bb.71:                               #   in Loop: Header=BB6_52 Depth=1
	st.w	$t4, $t3, 0
	b	.LBB6_73
	.p2align	4, , 16
.LBB6_72:                               #   in Loop: Header=BB6_52 Depth=1
	...
	ldx.w	$t5, $s3, $t5
	st.w	$t5, $t3, 0
.LBB6_73:                               #   in Loop: Header=BB6_52 Depth=1
	ld.w	$t6, $t0, 0
	slli.d	$t5, $t6, 2
	ldx.w	$t7, $a4, $t5
	ld.w	$t8, $t1, 0
	addi.w	$t7, $t7, 1
	bne	$t8, $t7, .LBB6_51
# %bb.74:                               #   in Loop: Header=BB6_52 Depth=1
	ld.w	$t7, $a6, 0
	slli.d	$t7, $t7, 2
	...
	ldx.w	$t8, $t8, $t7
	blt	$t8, $t6, .LBB6_49
# %bb.75:                               #   in Loop: Header=BB6_52 Depth=1
	ld.w	$t6, $a7, 0
	ldx.w	$t8, $a1, $t5
	move	$t5, $t4
	beq	$t6, $t8, .LBB6_77
# %bb.76:                               #   in Loop: Header=BB6_52 Depth=1
	ldx.w	$t5, $s1, $t7
.LBB6_77:                               #   in Loop: Header=BB6_52 Depth=1
	st.w	$t5, $a5, 0
	ld.w	$t5, $t0, 0
	ld.w	$t6, $a7, 0
	slli.d	$t5, $t5, 2
	ldx.w	$t5, $a2, $t5
	bne	$t6, $t5, .LBB6_79
# %bb.78:                               #   in Loop: Header=BB6_52 Depth=1
	st.w	$t4, $t3, 0
	b	.LBB6_51
.LBB6_79:                               #   in Loop: Header=BB6_52 Depth=1
	ld.w	$t5, $a6, 0
	slli.d	$t5, $t5, 2
	ldx.w	$t5, $s2, $t5
	b	.LBB6_50
.LBB6_80:                               # %._crit_edge496
	ld.d	$a0, $sp, 104
	ld.d	$a1, $sp, 112
	pcalau12i	$a2, %pc_hi20(save_ncells)
	st.w	$s6, $a2, %pc_lo12(save_ncells)
