...
.LBB5_581:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB5_582:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit520
	ld.d	$fp, $sp, 136                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 120                   # 8-byte Folded Reload
.LBB5_583:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit520
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	bnez	$a0, .LBB5_603
# %bb.584:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit522
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
	bnez	$a2, .LBB5_604
.LBB5_585:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit524
...
.LBB5_594:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit536.thread
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB5_595:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit540
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	sub.d	$a1, $s0, $a0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB5_596:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit540.thread
	sub.d	$a1, $fp, $s5
	move	$a0, $s5
.LBB5_597:
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB5_598:
	...
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB5_599:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit528.thread1341
...
.LBB5_600:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB5_601:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit532
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	beqz	$a0, .LBB5_592
.LBB5_602:
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
...
.LBB5_603:
	...
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
	beqz	$a2, .LBB5_585
.LBB5_604:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit522.thread1331
...
.LBB5_605:
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB5_606:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit526
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
	bnez	$a0, .LBB5_587
	b	.LBB5_588
