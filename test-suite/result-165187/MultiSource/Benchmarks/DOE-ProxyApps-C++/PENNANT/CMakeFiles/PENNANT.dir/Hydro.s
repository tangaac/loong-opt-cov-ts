...
.LBB5_18:                               # %.lr.ph.i167
	...
	addi.d	$a3, $a3, 8
	bnez	$s1, .LBB5_18
.LBB5_19:                               # %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit
                                        #   in Loop: Header=BB5_14 Depth=1
	vldi	$vr4, -928
	bge	$s0, $s5, .LBB5_22
# %bb.20:                               # %.lr.ph.i171
...
.LBB5_21:                               #   Parent Loop BB5_14 Depth=1
	...
	addi.d	$a5, $a5, 4
	bnez	$a1, .LBB5_21
.LBB5_22:                               # %_ZN5Hydro12calcCrnrMassEPKdS1_S1_Pdii.exit
                                        #   in Loop: Header=BB5_14 Depth=1
	ld.d	$a0, $fp, 8
	ld.d	$a1, $fp, 304
	ld.d	$a4, $fp, 320
...
# %bb.23:                               # %.lr.ph.i176
	...
	alsl.d	$t0, $s0, $t0, 2
	.p2align	4, , 16
.LBB5_24:                               #   Parent Loop BB5_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t1, $t0, 0
	slli.d	$t1, $t1, 4
	vld	$vr0, $a7, 0
...
# %bb.29:                               # %.lr.ph226
	...
	b	.LBB5_31
	.p2align	4, , 16
.LBB5_30:                               # %_ZN5Hydro10advPosFullEPK7double2S2_S2_dPS0_S3_ii.exit
...
# %bb.41:                               # %.lr.ph230
	...
	b	.LBB5_43
	.p2align	4, , 16
.LBB5_42:                               # %_ZN5Hydro8calcWorkEPK7double2S2_S2_S2_S2_dPdS3_ii.exit
...
# %bb.44:                               # %.lr.ph.i191.preheader
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB5_45:                               # %_ZSt9__fill_a1IPddEvT_S1_RKT0_.exit
                                        #   in Loop: Header=BB5_43 Depth=1
	bge	$s0, $s1, .LBB5_42
# %bb.46:                               # %.lr.ph.i192
                                        #   in Loop: Header=BB5_43 Depth=1
	...
	alsl.d	$t0, $s0, $t0, 2
	.p2align	4, , 16
.LBB5_47:                               #   Parent Loop BB5_43 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $a7, -8
	fld.d	$fa1, $a5, -8
	ld.w	$t1, $a4, 0
...
# %bb.49:                               # %.lr.ph234
	...
	b	.LBB5_51
	.p2align	4, , 16
.LBB5_50:                               # %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit215
