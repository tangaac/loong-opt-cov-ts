...
.LBB1_6:                                # %vector.body163
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_6
# %bb.7:                                # %middle.block168
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a4, .LBB1_10
.LBB1_8:                                # %.lr.ph.i.preheader174
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a4, $s7, $s2, 3
	.p2align	4, , 16
.LBB1_9:                                # %.lr.ph.i
...
.LBB1_12:                               # %vector.body149
	...
	addi.d	$a1, $a1, 32
	bnez	$a4, .LBB1_12
# %bb.13:                               # %middle.block153
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a3, .LBB1_16
.LBB1_14:                               # %.lr.ph.i77.preheader173
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a0, $s7, $s3, 3
	.p2align	4, , 16
.LBB1_15:                               # %.lr.ph.i77
...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s6
.LBB5_19:                               # %.lr.ph.i167.preheader340
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB5_67:                               # %.lr.ph.i211
	...
	b	.LBB5_57
	.p2align	4, , 16
.LBB5_68:                               # %vector.memcheck311
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $s8
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_60
# %bb.69:                               # %vector.memcheck311
                                        #   in Loop: Header=BB5_58 Depth=1
	ld.d	$a6, $sp, 264                   # 8-byte Folded Reload
	sub.d	$a7, $a3, $a6
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_60
# %bb.70:                               # %vector.memcheck311
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_60
# %bb.71:                               # %vector.memcheck311
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s7, .LBB5_60
...
.LBB5_73:                               # %vector.body324
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB5_73
# %bb.74:                               # %middle.block336
                                        #   in Loop: Header=BB5_58 Depth=1
	bne	$a0, $a7, .LBB5_60
	b	.LBB5_62
	.p2align	4, , 16
.LBB5_75:                               # %vector.memcheck293
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_63
# %bb.76:                               # %vector.memcheck293
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_63
...
.LBB5_78:                               # %vector.body302
	...
	addi.d	$t2, $t2, 16
	bnez	$t3, .LBB5_78
# %bb.79:                               # %middle.block308
                                        #   in Loop: Header=BB5_58 Depth=1
	bne	$a0, $a7, .LBB5_63
	b	.LBB5_65
	.p2align	4, , 16
.LBB5_80:                               # %vector.memcheck275
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_66
# %bb.81:                               # %vector.memcheck275
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a6, $a2, $s8
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_66
