...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s6
.LBB5_19:                               # %.lr.ph.i167.preheader346
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB5_67:                               # %.lr.ph.i211
	...
	b	.LBB5_57
	.p2align	4, , 16
.LBB5_68:                               # %vector.memcheck317
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $s8
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
# %bb.69:                               # %vector.memcheck317
                                        #   in Loop: Header=BB5_58 Depth=1
	ld.d	$a6, $sp, 264                   # 8-byte Folded Reload
	sub.d	$a7, $a3, $a6
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
# %bb.70:                               # %vector.memcheck317
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
# %bb.71:                               # %vector.memcheck317
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_60
...
.LBB5_73:                               # %vector.body330
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB5_73
# %bb.74:                               # %middle.block342
                                        #   in Loop: Header=BB5_58 Depth=1
	bne	$a0, $a7, .LBB5_60
	b	.LBB5_62
	.p2align	4, , 16
.LBB5_75:                               # %vector.memcheck297
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_63
# %bb.76:                               # %vector.memcheck297
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s5, .LBB5_63
...
.LBB5_78:                               # %vector.body306
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB5_78
# %bb.79:                               # %middle.block314
                                        #   in Loop: Header=BB5_58 Depth=1
	bne	$a0, $a7, .LBB5_63
	b	.LBB5_65
	.p2align	4, , 16
.LBB5_80:                               # %vector.memcheck277
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s5, .LBB5_66
# %bb.81:                               # %vector.memcheck277
                                        #   in Loop: Header=BB5_58 Depth=1
	sub.d	$a6, $a2, $s8
	move	$a3, $a4
	bltu	$a6, $s5, .LBB5_66
