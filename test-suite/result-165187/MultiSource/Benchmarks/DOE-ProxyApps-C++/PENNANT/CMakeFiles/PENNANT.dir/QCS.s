...
.LBB3_12:                               #   in Loop: Header=BB3_10 Depth=1
	...
	vfadd.d	$vr13, $vr22, $vr13
	vfmul.d	$vr17, $vr17, $vr23
	vfmul.d	$vr21, $vr13, $vr23
	fst.d	$ft11, $fp, 0
	fsub.d	$ft5, $fs7, $fa0
	fsub.d	$ft7, $fs6, $fa1
	fmul.d	$ft7, $ft7, $ft8
...
.LBB3_13:                               # %.split
	...
	vfadd.d	$vr2, $vr21, $vr2
	vfsub.d	$vr1, $vr1, $vr20
	vfsub.d	$vr2, $vr2, $vr22
	vshuf4i.d	$vr3, $vr0, 1
	vfsub.d	$vr1, $vr1, $vr3
	vshuf4i.d	$vr21, $vr0, 1
	vfsub.d	$vr2, $vr2, $vr21
	vfmul.d	$vr2, $vr2, $vr2
...
.LBB3_14:                               # %call.sqrt
	...
	vst	$vr30, $sp, 80                  # 16-byte Folded Spill
