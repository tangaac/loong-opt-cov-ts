...
.LBB0_53:                               # %vector.body616
	...
	addi.d	$a5, $a5, 16
	bnez	$s4, .LBB0_53
# %bb.54:                               # %middle.block623
	bne	$a2, $s1, .LBB0_37
	b	.LBB0_39
.LBB0_55:                               # %vector.memcheck626
	sub.d	$a5, $a6, $t6
	ori	$a2, $zero, 16
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_41
# %bb.56:                               # %vector.memcheck626
	sub.d	$a5, $a6, $t4
	bltu	$a5, $a2, .LBB0_41
# %bb.57:                               # %vector.memcheck626
	sub.d	$a5, $a6, $t7
	ori	$a2, $zero, 16
	bltu	$a5, $a2, .LBB0_41
# %bb.58:                               # %vector.memcheck626
	sub.d	$a5, $a6, $a0
	bltu	$a5, $a2, .LBB0_41
# %bb.59:                               # %vector.memcheck626
	sub.d	$a5, $a6, $t0
	ori	$a2, $zero, 16
	bltu	$a5, $a2, .LBB0_41
# %bb.60:                               # %vector.memcheck626
	sub.d	$a5, $a6, $t5
	bltu	$a5, $a2, .LBB0_41
# %bb.61:                               # %vector.memcheck626
	sub.d	$a5, $a6, $t3
	ori	$a2, $zero, 16
	bltu	$a5, $a2, .LBB0_41
# %bb.62:                               # %vector.memcheck626
	sub.d	$a5, $a6, $t2
	bltu	$a5, $a2, .LBB0_41
# %bb.63:                               # %vector.memcheck626
	sub.d	$a2, $a6, $fp
	ori	$a5, $zero, 16
	bltu	$a2, $a5, .LBB0_41
# %bb.64:                               # %vector.ph647
...
.LBB0_70:                               # %.lr.ph353.preheader
	ori	$a1, $zero, 8
	bltu	$a7, $a1, .LBB0_73
# %bb.71:                               # %vector.memcheck686
	alsl.d	$a1, $s1, $t8, 2
	bgeu	$s3, $a1, .LBB0_127
# %bb.72:                               # %vector.memcheck686
	alsl.d	$a1, $s1, $s3, 2
	bgeu	$t8, $a1, .LBB0_127
.LBB0_73:
	move	$a1, $zero
.LBB0_74:                               # %.lr.ph353.preheader824
	alsl.d	$a2, $a1, $s3, 2
	alsl.d	$a5, $a1, $t8, 2
	sub.d	$a1, $s1, $a1
	.p2align	4, , 16
...
.LBB0_96:                               # %._crit_edge364
	...
	addi.d	$sp, $sp, 128
	ret
.LBB0_97:                               # %vector.memcheck707
	sub.d	$a5, $a3, $t6
	ori	$a2, $zero, 16
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_78
# %bb.98:                               # %vector.memcheck707
	sub.d	$a5, $a3, $t0
	bltu	$a5, $a2, .LBB0_78
# %bb.99:                               # %vector.memcheck707
	sub.d	$a2, $a3, $t7
	ori	$a5, $zero, 16
	bltu	$a2, $a5, .LBB0_78
# %bb.100:                              # %vector.ph715
...
.LBB0_101:                              # %vector.body718
	...
	addi.d	$a2, $a2, 16
	bnez	$t8, .LBB0_101
# %bb.102:                              # %middle.block724
	bne	$a1, $s1, .LBB0_78
	b	.LBB0_80
.LBB0_103:                              # %vector.memcheck727
	sub.d	$a5, $a4, $t3
	ori	$a2, $zero, 16
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_82
# %bb.104:                              # %vector.memcheck727
	sub.d	$a5, $a4, $t4
	bltu	$a5, $a2, .LBB0_82
# %bb.105:                              # %vector.memcheck727
	sub.d	$a5, $a4, $t0
	ori	$a2, $zero, 16
	bltu	$a5, $a2, .LBB0_82
# %bb.106:                              # %vector.memcheck727
	sub.d	$a5, $a4, $t5
	bltu	$a5, $a2, .LBB0_82
# %bb.107:                              # %vector.ph737
	bstrpick.d	$a1, $s1, 30, 2
...
.LBB0_108:                              # %vector.body742
	...
	addi.d	$a2, $a2, 16
	bnez	$t7, .LBB0_108
# %bb.109:                              # %middle.block749
	bne	$a1, $s1, .LBB0_82
	b	.LBB0_84
.LBB0_110:                              # %vector.memcheck752
	sub.d	$a5, $s0, $fp
	ori	$a2, $zero, 32
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_86
# %bb.111:                              # %vector.memcheck752
	sub.d	$a5, $s0, $t2
	bltu	$a5, $a2, .LBB0_86
# %bb.112:                              # %vector.ph758
	bstrpick.d	$a1, $s1, 30, 3
...
.LBB0_113:                              # %vector.body763
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_113
# %bb.114:                              # %middle.block770
	bne	$a1, $s1, .LBB0_86
	b	.LBB0_88
.LBB0_115:                              # %vector.memcheck773
	sub.d	$a5, $s2, $a0
	ori	$a2, $zero, 32
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_90
# %bb.116:                              # %vector.memcheck773
	sub.d	$a5, $s2, $t0
	bltu	$a5, $a2, .LBB0_90
# %bb.117:                              # %vector.ph779
	bstrpick.d	$a1, $s1, 30, 3
...
.LBB0_118:                              # %vector.body782
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_118
# %bb.119:                              # %middle.block789
	bne	$a1, $s1, .LBB0_90
	b	.LBB0_92
.LBB0_120:                              # %vector.memcheck792
	sub.d	$a5, $a0, $a3
	ori	$a2, $zero, 32
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_94
# %bb.121:                              # %vector.memcheck792
	sub.d	$a5, $a0, $a4
	bltu	$a5, $a2, .LBB0_94
# %bb.122:                              # %vector.memcheck792
	sub.d	$a5, $a0, $s0
	ori	$a2, $zero, 32
	bltu	$a5, $a2, .LBB0_94
# %bb.123:                              # %vector.memcheck792
	sub.d	$a5, $a0, $s2
	bltu	$a5, $a2, .LBB0_94
# %bb.124:                              # %vector.ph802
	bstrpick.d	$a1, $s1, 30, 3
...
.LBB0_125:                              # %vector.body805
	...
	addi.d	$t1, $t1, 32
	bnez	$a5, .LBB0_125
# %bb.126:                              # %middle.block816
	bne	$a1, $s1, .LBB0_94
	b	.LBB0_96
.LBB0_127:                              # %vector.ph694
	bstrpick.d	$a1, $s1, 30, 3
	slli.d	$a1, $a1, 3
	addi.d	$a2, $s3, 16
	addi.d	$a5, $t8, 16
...
.Lfunc_end5:
	.size	attenuate_FSR_fluxes, .Lfunc_end5-attenuate_FSR_fluxes
                                        # -- End function
	.globl	two_way_transport_sweep         # -- Begin function two_way_transport_sweep
	.p2align	5
...
# %bb.33:                               # %.lr.ph.i
	...
	move	$a7, $zero
	bgeu	$a0, $t7, .LBB6_38
.LBB6_34:                               # %scalar.ph643.preheader
                                        #   in Loop: Header=BB6_29 Depth=5
	sub.d	$t0, $a0, $a7
...
.LBB6_37:                               #   in Loop: Header=BB6_29 Depth=5
	vld	$vr7, $sp, 304                  # 16-byte Folded Reload
	b	.LBB6_58
.LBB6_38:                               # %vector.memcheck637
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 176                   # 8-byte Folded Reload
	ori	$t1, $zero, 32
	bltu	$a3, $t7, .LBB6_34
# %bb.39:                               # %vector.memcheck637
                                        #   in Loop: Header=BB6_29 Depth=5
	sub.d	$t0, $t6, $a6
	bltu	$t0, $t1, .LBB6_34
# %bb.40:                               # %vector.memcheck637
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 216                   # 8-byte Folded Reload
	sub.d	$t0, $a3, $a6
	bltu	$t0, $t1, .LBB6_34
...
# %bb.49:                               #   in Loop: Header=BB6_29 Depth=5
	move	$a5, $zero
.LBB6_50:                               # %scalar.ph619.preheader
                                        #   in Loop: Header=BB6_29 Depth=5
	sub.d	$a6, $a0, $a5
...
.LBB6_52:                               # %.lr.ph85.i.preheader
                                        #   in Loop: Header=BB6_29 Depth=5
	bltu	$a0, $t7, .LBB6_55
# %bb.53:                               # %vector.memcheck561
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 248                   # 8-byte Folded Reload
	alsl.d	$a3, $a0, $a3, 2
	bgeu	$a2, $a3, .LBB6_70
# %bb.54:                               # %vector.memcheck561
                                        #   in Loop: Header=BB6_29 Depth=5
	alsl.d	$a3, $a0, $a2, 2
	bgeu	$fp, $a3, .LBB6_70
.LBB6_55:                               #   in Loop: Header=BB6_29 Depth=5
	move	$a3, $zero
.LBB6_56:                               # %.lr.ph85.i.preheader658
                                        #   in Loop: Header=BB6_29 Depth=5
	sub.d	$a0, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
...
# %bb.63:                               # %vector.memcheck583
	...
	and	$a7, $t3, $a7
	bnez	$a7, .LBB6_50
# %bb.64:                               # %vector.memcheck583
                                        #   in Loop: Header=BB6_29 Depth=5
	sltu	$a7, $a4, $t0
	sltu	$t0, $a3, $a6
	and	$a7, $a7, $t0
	bnez	$a7, .LBB6_50
# %bb.65:                               # %vector.memcheck583
                                        #   in Loop: Header=BB6_29 Depth=5
	sltu	$a7, $a4, $t1
...
.LBB6_68:                               # %vector.body626
	...
	addi.d	$a6, $a6, 16
	bnez	$t3, .LBB6_68
# %bb.69:                               # %middle.block634
                                        #   in Loop: Header=BB6_29 Depth=5
	bne	$a5, $a0, .LBB6_50
	b	.LBB6_52
.LBB6_70:                               # %vector.ph570
                                        #   in Loop: Header=BB6_29 Depth=5
...
# %bb.86:                               # %.lr.ph.i325
	...
	move	$a6, $zero
	bgeu	$a0, $t6, .LBB6_90
.LBB6_87:                               # %scalar.ph546.preheader
                                        #   in Loop: Header=BB6_82 Depth=4
	sub.d	$a7, $a0, $a6
...
# %bb.89:                               #   in Loop: Header=BB6_82 Depth=4
	...
	move	$t1, $a0
	b	.LBB6_98
.LBB6_90:                               # %vector.memcheck541
                                        #   in Loop: Header=BB6_82 Depth=4
	ld.d	$a7, $sp, 176                   # 8-byte Folded Reload
	ori	$t0, $zero, 32
	bltu	$a7, $t6, .LBB6_87
# %bb.91:                               # %vector.memcheck541
                                        #   in Loop: Header=BB6_82 Depth=4
	sub.d	$a7, $t5, $a5
	bltu	$a7, $t0, .LBB6_87
# %bb.92:                               # %vector.memcheck541
                                        #   in Loop: Header=BB6_82 Depth=4
...
.LBB6_107:                              #   in Loop: Header=BB6_82 Depth=4
	move	$a2, $zero
	ld.d	$a4, $sp, 240                   # 8-byte Folded Reload
.LBB6_108:                              # %.lr.ph85.i347.preheader659
                                        #   in Loop: Header=BB6_82 Depth=4
	sub.d	$a0, $a0, $a2
	alsl.d	$a1, $a2, $a1, 2
	ld.d	$a3, $sp, 248                   # 8-byte Folded Reload
...
# %bb.131:                              # %middle.block
                                        #   in Loop: Header=BB6_15 Depth=2
	beq	$a1, $s2, .LBB6_14
.LBB6_132:                              # %.lr.ph398.split.us.preheader660
                                        #   in Loop: Header=BB6_15 Depth=2
	slli.d	$a2, $a1, 5
	alsl.d	$a2, $a1, $a2, 3
	add.d	$a0, $a0, $a2
...
# %bb.136:                              # %middle.block471
                                        #   in Loop: Header=BB6_15 Depth=2
	beq	$a1, $s2, .LBB6_14
.LBB6_137:                              # %.lr.ph398.split.preheader661
                                        #   in Loop: Header=BB6_15 Depth=2
	slli.d	$a2, $a1, 5
	alsl.d	$a2, $a1, $a2, 3
	add.d	$a0, $a0, $a2
