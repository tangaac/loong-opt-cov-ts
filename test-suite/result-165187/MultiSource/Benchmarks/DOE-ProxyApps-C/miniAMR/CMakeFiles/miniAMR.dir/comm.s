...
.Lfunc_end1:
	...
	.p2align	4, 0x0                          # -- Begin function on_proc_comm_diff
.LCPI2_0:
	.dword	1                               # 0x1
	.dword	2                               # 0x2
	.text
...
# %bb.26:                               # %vector.memcheck1466
	...
	addi.d	$t0, $t0, -8
	bgeu	$a2, $t0, .LBB2_28
# %bb.27:                               # %vector.memcheck1466
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	add.d	$a2, $t3, $a2
	addi.d	$t0, $a6, 8
	bltu	$t0, $a2, .LBB2_31
.LBB2_28:                               # %vector.body1479.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	vld	$vr2, $a1, %pc_lo12(.LCPI2_0)
	addi.d	$a1, $s0, 24
	add.d	$t4, $t3, $a1
	ld.d	$t5, $sp, 32                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_29:                               # %vector.body1479
                                        #   Parent Loop BB2_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vslli.d	$vr3, $vr2, 4
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB2_29
# %bb.30:                               # %middle.block1486
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	beq	$a4, $a2, .LBB2_33
	.p2align	4, , 16
.LBB2_31:                               # %scalar.ph1474.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $t3, $s0
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a6, $a1, $a6, 4
...
# %bb.49:                               # %vector.memcheck1443
	...
	addi.d	$t0, $t0, -8
	bgeu	$a2, $t0, .LBB2_51
# %bb.50:                               # %vector.memcheck1443
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	add.d	$a2, $a6, $a2
	addi.d	$t0, $a0, 8
	bltu	$t0, $a2, .LBB2_54
.LBB2_51:                               # %vector.body1456.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	vld	$vr2, $a1, %pc_lo12(.LCPI2_0)
	addi.d	$a1, $s0, 24
...
.LBB2_52:                               # %vector.body1456
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB2_52
# %bb.53:                               # %middle.block1463
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	beq	$a4, $a2, .LBB2_17
	.p2align	4, , 16
.LBB2_54:                               # %scalar.ph1451.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $a6, $s0
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a0, $a1, $a0, 4
...
.LBB2_64:                               #   Parent Loop BB2_62 Depth=1
	...
	addi.d	$s4, $s4, 16
	bnez	$s5, .LBB2_64
# %bb.65:                               # %._crit_edge1220
                                        #   in Loop: Header=BB2_63 Depth=2
	addi.d	$t8, $t8, 1
	bne	$t8, $a4, .LBB2_63
# %bb.66:                               # %._crit_edge1223.split
...
# %bb.78:                               #   in Loop: Header=BB2_73 Depth=1
	...
	bgtz	$t1, .LBB2_80
	b	.LBB2_88
.LBB2_79:                               #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a1, $s8, 0
	fld.d	$fa2, $a6, 0
	ldx.d	$a2, $a1, $a0
	fst.d	$fa2, $a2, 0
...
# %bb.81:                               # %vector.memcheck1420
	...
	addi.d	$t0, $t0, -8
	bgeu	$a4, $t0, .LBB2_83
# %bb.82:                               # %vector.memcheck1420
                                        #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a4, $sp, 16                    # 8-byte Folded Reload
	add.d	$a4, $a2, $a4
	addi.d	$t0, $a6, 8
	bltu	$t0, $a4, .LBB2_86
.LBB2_83:                               # %vector.body1433.preheader
                                        #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	vld	$vr2, $a1, %pc_lo12(.LCPI2_0)
	addi.d	$a1, $s2, 24
...
.LBB2_84:                               # %vector.body1433
	...
	addi.d	$t0, $t0, 32
	bnez	$t5, .LBB2_84
# %bb.85:                               # %middle.block1440
                                        #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a4, $sp, 32                    # 8-byte Folded Reload
	beq	$s3, $a4, .LBB2_88
	.p2align	4, , 16
.LBB2_86:                               # %scalar.ph1428.preheader
                                        #   in Loop: Header=BB2_73 Depth=1
	add.d	$a2, $a2, $s2
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $a6, 4
...
.LBB2_87:                               # %scalar.ph1428
	...
	addi.d	$a4, $a4, 16
	bnez	$a1, .LBB2_87
.LBB2_88:                               # %.loopexit1102
                                        #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	blez	$a1, .LBB2_96
# %bb.89:                               # %.lr.ph1152.preheader
                                        #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	alsl.d	$t0, $a1, $s8, 3
	ori	$a6, $zero, 1
...
# %bb.92:                               #   in Loop: Header=BB2_91 Depth=2
	...
	b	.LBB2_90
	.p2align	4, , 16
.LBB2_93:                               #   in Loop: Header=BB2_91 Depth=2
	ldx.d	$s4, $t2, $s0
	fld.d	$fa2, $a4, 0
	fld.d	$fa3, $s4, 0
	ldx.d	$a1, $a1, $a0
...
.LBB2_99:                               # %._crit_edge1158
	...
	ori	$a6, $zero, 1
	bne	$a4, $a6, .LBB2_72
# %bb.100:                              #   in Loop: Header=BB2_73 Depth=1
	ldx.d	$a6, $a2, $s0
	beqz	$a3, .LBB2_102
# %bb.101:                              #   in Loop: Header=BB2_73 Depth=1
	ldx.d	$a1, $s8, $a1
	fldx.d	$fa2, $a6, $s5
	ldx.d	$a0, $a1, $a0
	fstx.d	$fa2, $a0, $s5
	bgtz	$t1, .LBB2_103
	b	.LBB2_72
.LBB2_102:                              #   in Loop: Header=BB2_73 Depth=1
	ldx.d	$a1, $s8, $a1
	fld.d	$fa2, $a6, 0
	ldx.d	$a0, $a1, $a0
	fst.d	$fa2, $a0, 0
...
# %bb.105:                              # %vector.memcheck
	...
	addi.d	$a4, $a6, 8
	bltu	$a4, $a2, .LBB2_109
.LBB2_106:                              # %vector.body.preheader
                                        #   in Loop: Header=BB2_73 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	vld	$vr2, $a1, %pc_lo12(.LCPI2_0)
	addi.d	$a1, $s2, 24
...
# %bb.120:                              # %.lr.ph1112
	...
	move	$a4, $t1
	.p2align	4, , 16
.LBB2_121:                              #   Parent Loop BB2_115 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a6, $a0, -8
	ld.d	$t4, $a0, 0
	fldx.d	$fa1, $a6, $ra
	...
	addi.d	$a0, $a0, 16
	bnez	$a4, .LBB2_121
.LBB2_122:                              # %.loopexit1105
                                        #   in Loop: Header=BB2_115 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	blez	$a0, .LBB2_130
# %bb.123:                              # %.lr.ph1121.preheader
                                        #   in Loop: Header=BB2_115 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	alsl.d	$a1, $a0, $a1, 3
...
# %bb.135:                              # %.lr.ph1131
	...
	move	$a2, $t1
	.p2align	4, , 16
.LBB2_136:                              #   Parent Loop BB2_115 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a4, $a0, -8
	ld.d	$a6, $a0, 0
	fldx.d	$fa1, $a4, $ra
...
.LBB2_138:
	blez	$a6, .LBB2_157
# %bb.139:                              # %.preheader1093.lr.ph
	pcalau12i	$a0, %pc_hi20(x_block_half)
	ld.w	$a4, $a0, %pc_lo12(x_block_half)
	blez	$a4, .LBB2_157
# %bb.140:                              # %.preheader1093.lr.ph
	pcalau12i	$a0, %pc_hi20(z_block_half)
	ld.w	$a7, $a0, %pc_lo12(z_block_half)
	blez	$a7, .LBB2_157
# %bb.141:                              # %.preheader1093.lr.ph.split.split
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	mul.w	$a0, $a4, $a0
	mul.w	$t4, $a7, $a3
	add.w	$a1, $a6, $a5
...
.LBB2_142:                              # %.preheader1093
	...
	ori	$t6, $zero, 1
	.p2align	4, , 16
.LBB2_143:                              # %.preheader1092
                                        #   Parent Loop BB2_142 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB2_144 Depth 3
	slli.d	$t7, $t6, 3
	ldx.d	$t7, $t5, $t7
	...
	move	$s3, $a7
	.p2align	4, , 16
.LBB2_144:                              #   Parent Loop BB2_142 Depth=1
	...
	addi.d	$s2, $s2, 16
	bnez	$s3, .LBB2_144
# %bb.145:                              # %._crit_edge1210
                                        #   in Loop: Header=BB2_143 Depth=2
	addi.d	$t6, $t6, 1
	bne	$t6, $a4, .LBB2_143
# %bb.146:                              # %._crit_edge1213.split
...
.LBB2_148:
	blez	$a6, .LBB2_157
# %bb.149:                              # %.preheader1096.lr.ph
	pcalau12i	$a0, %pc_hi20(x_block_half)
	ld.w	$a4, $a0, %pc_lo12(x_block_half)
	blez	$a4, .LBB2_157
# %bb.150:                              # %.preheader1096.lr.ph
	pcalau12i	$a0, %pc_hi20(y_block_half)
	ld.w	$a7, $a0, %pc_lo12(y_block_half)
	blez	$a7, .LBB2_157
# %bb.151:                              # %.preheader1096.lr.ph.split.split
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	mul.w	$a0, $a4, $a0
	mul.w	$t4, $a7, $a3
	add.w	$a1, $a6, $a5
...
.LBB2_152:                              # %.preheader1096
	...
	ori	$t6, $zero, 1
	.p2align	4, , 16
.LBB2_153:                              # %.preheader1095
                                        #   Parent Loop BB2_152 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB2_154 Depth 3
	slli.d	$t7, $t6, 3
	ldx.d	$t7, $t5, $t7
...
.LBB2_154:                              #   Parent Loop BB2_152 Depth=1
	...
	addi.d	$fp, $fp, 16
	bnez	$s0, .LBB2_154
# %bb.155:                              # %._crit_edge1200
                                        #   in Loop: Header=BB2_153 Depth=2
	addi.d	$t6, $t6, 1
	bne	$t6, $a4, .LBB2_153
# %bb.156:                              # %._crit_edge1203.split
