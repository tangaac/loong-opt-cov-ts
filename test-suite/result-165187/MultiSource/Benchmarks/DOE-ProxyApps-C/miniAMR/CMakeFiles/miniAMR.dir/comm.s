...
# %bb.10:                               #   in Loop: Header=BB1_9 Depth=2
	move	$s2, $zero
.LBB1_11:                               # %scalar.ph437.preheader
                                        #   in Loop: Header=BB1_9 Depth=2
	alsl.d	$s1, $s2, $s1, 3
	alsl.d	$s0, $s2, $s0, 3
	alsl.d	$fp, $s2, $fp, 3
...
.LBB1_12:                               # %scalar.ph437
	...
	b	.LBB1_8
	.p2align	4, , 16
.LBB1_13:                               # %vector.memcheck427
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $s1, $fp
	move	$s2, $zero
	bltu	$s3, $t2, .LBB1_11
# %bb.14:                               # %vector.memcheck427
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $fp, $t8
	bltu	$s3, $t2, .LBB1_11
# %bb.15:                               # %vector.memcheck427
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $s0, $fp
	bltu	$s3, $t2, .LBB1_11
# %bb.16:                               # %vector.memcheck427
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $s1, $t8
	bltu	$s3, $t2, .LBB1_11
# %bb.17:                               # %vector.memcheck427
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $s1, $s0
	bltu	$s3, $t2, .LBB1_11
# %bb.18:                               # %vector.body442.preheader
                                        #   in Loop: Header=BB1_9 Depth=2
	move	$s2, $t8
	move	$s3, $fp
	move	$s4, $s0
...
.LBB1_29:                               # %.preheader
	...
	ori	$s3, $zero, 1
	bgeu	$a5, $t2, .LBB1_32
.LBB1_30:                               # %scalar.ph483.preheader
                                        #   in Loop: Header=BB1_29 Depth=2
	alsl.d	$s2, $s3, $s2, 3
	alsl.d	$s1, $s3, $s1, 3
	alsl.d	$s0, $s3, $s0, 3
...
.LBB1_31:                               # %scalar.ph483
	...
	b	.LBB1_28
	.p2align	4, , 16
.LBB1_32:                               # %vector.memcheck473
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s2, $s0
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.33:                               # %vector.memcheck473
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s0, $fp
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.34:                               # %vector.memcheck473
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s1, $s0
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.35:                               # %vector.memcheck473
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s2, $fp
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.36:                               # %vector.memcheck473
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s2, $s1
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.37:                               # %vector.body488.preheader
                                        #   in Loop: Header=BB1_29 Depth=2
	addi.d	$s3, $fp, 8
	addi.d	$s4, $s0, 8
	addi.d	$s5, $s1, 8
...
.LBB1_70:                               # %.preheader241
	...
	ori	$s4, $zero, 1
	bgeu	$a6, $t3, .LBB1_73
.LBB1_71:                               # %scalar.ph460.preheader
                                        #   in Loop: Header=BB1_70 Depth=2
	alsl.d	$s3, $s4, $s3, 3
	alsl.d	$s2, $s4, $s2, 3
	alsl.d	$s1, $s4, $s1, 3
...
.LBB1_72:                               # %scalar.ph460
	...
	b	.LBB1_69
	.p2align	4, , 16
.LBB1_73:                               # %vector.memcheck450
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s3, $s1
	bltu	$s5, $t4, .LBB1_71
# %bb.74:                               # %vector.memcheck450
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s1, $s0
	bltu	$s5, $t4, .LBB1_71
# %bb.75:                               # %vector.memcheck450
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s2, $s1
	bltu	$s5, $t4, .LBB1_71
# %bb.76:                               # %vector.memcheck450
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s3, $s0
	bltu	$s5, $t4, .LBB1_71
# %bb.77:                               # %vector.memcheck450
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s3, $s2
	bltu	$s5, $t4, .LBB1_71
# %bb.78:                               # %vector.body465.preheader
                                        #   in Loop: Header=BB1_70 Depth=2
	addi.d	$s4, $s0, 8
	addi.d	$s5, $s1, 8
	addi.d	$s6, $s2, 8
