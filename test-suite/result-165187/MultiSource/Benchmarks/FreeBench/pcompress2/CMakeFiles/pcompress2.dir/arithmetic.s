...
# %bb.0:                                # %vector.ph
	...
	pcalau12i	$a6, %pc_hi20(ari_pos)
	st.w	$zero, $a6, %pc_lo12(ari_pos)
	pcalau12i	$a0, %pc_hi20(char_to_index)
	addi.d	$s5, $a0, %pc_lo12(char_to_index)
	addi.d	$a0, $s5, 4
	ori	$a1, $zero, 2
	pcalau12i	$a2, %pc_hi20(index_to_char)
	addi.d	$s6, $a2, %pc_lo12(index_to_char)
	move	$a2, $zero
	ori	$a3, $zero, 256
	.p2align	4, , 16
.LBB0_1:                                # %vector.body
