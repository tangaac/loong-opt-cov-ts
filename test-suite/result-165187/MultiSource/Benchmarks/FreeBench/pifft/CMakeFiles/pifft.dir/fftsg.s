...
.LBB8_32:                               # %vector.body134
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB8_32
# %bb.33:                               # %middle.block138
	beq	$a1, $a2, .LBB8_36
.LBB8_34:                               # %.lr.ph117.preheader141
	alsl.d	$a1, $a0, $s0, 3
	.p2align	4, , 16
.LBB8_35:                               # %.lr.ph117
                                        # =>This Inner Loop Header: Depth=1
...
.LBB12_27:                              # =>This Loop Header: Depth=1
	...
	addi.w	$s3, $s4, 0
	bstrpick.d	$s6, $s4, 31, 1
	bltu	$s3, $t6, .LBB12_32
# %bb.28:                               # %.lr.ph.preheader.i245
...
# %bb.31:                               #   in Loop: Header=BB12_27 Depth=1
	...
	b	.LBB12_33
	.p2align	4, , 16
.LBB12_32:                              #   in Loop: Header=BB12_27 Depth=1
	addi.w	$s8, $s6, 0
	fld.d	$fa0, $t0, 0
	slli.d	$a0, $s8, 3
	fldx.d	$fa1, $s0, $a0
...
# %bb.34:                               # %.lr.ph267
	...
	move	$a6, $t4
	.p2align	4, , 16
.LBB12_35:                              #   Parent Loop BB12_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $a6, -8
	fld.d	$fa1, $a6, 0
	fsub.d	$fa0, $fa0, $fa1
...
.LBB12_40:                              #   in Loop: Header=BB12_27 Depth=1
	...
	ori	$a0, $zero, 5
	bne	$s3, $a0, .LBB12_42
# %bb.41:                               #   in Loop: Header=BB12_27 Depth=1
	ld.d	$ra, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a3, $sp, 80                    # 8-byte Folded Reload
	ld.d	$t0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$t1, $sp, 64                    # 8-byte Folded Reload
...
# %bb.44:                               #   in Loop: Header=BB12_27 Depth=1
	...
	ori	$t6, $zero, 4
	b	.LBB12_33
.LBB12_45:                              # %._crit_edge272.thread
	add.w	$a1, $s6, $s4
	slli.d	$a1, $a1, 3
	fldx.d	$fa0, $s0, $a1
	fst.d	$fa0, $s7, 0
	move	$s2, $a0
.LBB12_46:                              # %._crit_edge276
	fld.d	$fa0, $s0, 0
	slli.d	$a0, $s2, 3
	fstx.d	$fa0, $fp, $a0
	fld.d	$fa0, $s0, 16
...
.LBB13_45:                              # %rftfsub.exit234
	...
	add.w	$a0, $s6, $s7
	bltu	$t7, $s5, .LBB13_29
# %bb.46:                               # %._crit_edge244.thread
	slli.w	$s3, $s3, 1
.LBB13_47:                              # %._crit_edge252.loopexit
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $s0, $a0
	fst.d	$fa0, $s0, 0
	b	.LBB13_49
.LBB13_48:                              # %.preheader.._crit_edge252_crit_edge
	fld.d	$fa0, $s0, 0
	ori	$s3, $zero, 2
.LBB13_49:                              # %._crit_edge252
	slli.d	$a0, $s3, 3
	fstx.d	$fa0, $fp, $a0
.LBB13_50:
	st.d	$zero, $fp, 0
