...
.LBB3_41:                               # %.thread.i
	...
	jirl	$ra, $ra, 0
.LBB3_42:                               # %abs_select_restricted.exit
	ld.w	$a0, $fp, 12
	ld.w	$a1, $fp, 4
	pcaddu18i	$ra, %call36(sf_new)
	jirl	$ra, $ra, 0
...
.LBB4_42:                               # %.lr.ph123
	...
	alsl.d	$a6, $a6, $a0, 2
	.p2align	4, , 16
.LBB4_43:                               #   Parent Loop BB4_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a7, $a6, 0
	ld.w	$t0, $a5, 0
	andn	$a7, $a7, $t0
...
.LBB4_45:
	...
	jr	$t8
.LBB4_46:                               # %._crit_edge124
	beqz	$a0, .LBB4_48
.LBB4_47:                               # %._crit_edge124.thread
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB4_48:
	pcalau12i	$a0, %got_pc_hi20(debug)
