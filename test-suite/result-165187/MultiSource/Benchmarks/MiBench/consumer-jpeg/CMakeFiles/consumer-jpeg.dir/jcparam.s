...
.LBB0_6:                                # %vector.body
	...
	bne	$a1, $t0, .LBB0_6
	b	.LBB0_9
.LBB0_7:                                # %vector.body38.preheader
	ori	$a6, $zero, 128
	.p2align	4, , 16
.LBB0_8:                                # %vector.body38
                                        # =>This Inner Loop Header: Depth=1
	ld.wu	$a7, $a2, -4
	ld.wu	$t0, $a2, 0
	mul.d	$a7, $a7, $fp
...
.LBB1_4:
	...
	lu12i.w	$s2, 7
	lu12i.w	$s4, 6
	pcalau12i	$a1, %pc_hi20(jpeg_set_linear_quality.std_luminance_quant_tbl+4)
	addi.d	$a1, $a1, %pc_lo12(jpeg_set_linear_quality.std_luminance_quant_tbl+4)
	move	$a2, $zero
	ori	$a3, $s3, 1803
	lu32i.d	$a3, 461373
	lu52i.d	$a3, $a3, -1475
...
# %bb.12:
	...
	st.d	$a0, $s1, 96
.LBB1_13:
	pcalau12i	$a1, %pc_hi20(jpeg_set_linear_quality.std_chrominance_quant_tbl+4)
	addi.d	$a1, $a1, %pc_lo12(jpeg_set_linear_quality.std_chrominance_quant_tbl+4)
	move	$a2, $zero
	ori	$a3, $s3, 1803
	lu32i.d	$a3, 461373
	lu52i.d	$a3, $a3, -1475
	...
	ori	$a5, $s2, 4095
	beqz	$s0, .LBB1_16
# %bb.14:                               # %vector.body38.preheader
	ori	$a6, $s4, 973
	ori	$a7, $zero, 255
	ori	$t0, $zero, 128
	.p2align	4, , 16
.LBB1_15:                               # %vector.body38
                                        # =>This Inner Loop Header: Depth=1
	ld.wu	$t1, $a1, -4
	ld.wu	$t2, $a1, 0
	mul.d	$t1, $t1, $fp
	...
	bne	$a2, $t0, .LBB1_15
	b	.LBB1_18
.LBB1_16:                               # %vector.body43.preheader
	ori	$a6, $zero, 128
	.p2align	4, , 16
.LBB1_17:                               # %vector.body43
                                        # =>This Inner Loop Header: Depth=1
	ld.wu	$a7, $a1, -4
	ld.wu	$t0, $a1, 0
	mul.d	$a7, $a7, $fp
