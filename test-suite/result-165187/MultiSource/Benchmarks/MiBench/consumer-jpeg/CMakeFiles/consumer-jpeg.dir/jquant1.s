...
.Lfunc_end0:
	...
	.p2align	4, 0x0                          # -- Begin function start_pass_1_quant
.LCPI1_0:
	.word	3                               # 0x3
	.word	7                               # 0x7
...
# %bb.14:                               # %.lr.ph26.i
	...
	addi.d	$s1, $a0, 80
	ori	$s2, $zero, 1024
	pcalau12i	$a0, %pc_hi20(base_dither_matrix+31)
	addi.d	$s3, $a0, %pc_lo12(base_dither_matrix+31)
	pcalau12i	$a0, %pc_hi20(.LCPI1_0)
	vld	$vr9, $a0, %pc_lo12(.LCPI1_0)
	pcalau12i	$a0, %pc_hi20(.LCPI1_1)
	vld	$vr10, $a0, %pc_lo12(.LCPI1_1)
	move	$s4, $zero
	vrepli.b	$vr11, 0
	vrepli.w	$vr12, 255
...
.LBB1_21:                               # %vector.body
	...
	vdiv.d	$vr3, $vr1, $vr0
	vdiv.d	$vr1, $vr2, $vr0
	vstelm.w	$vr1, $a3, 64, 2
	vstelm.w	$vr3, $a3, 128, 0
	vstelm.w	$vr3, $a3, 192, 2
	ld.b	$a4, $a2, -30
	ld.b	$a5, $a2, -14
	ld.b	$a6, $a2, 2
	ld.b	$a7, $a2, 18
	...
	vilvl.b	$vr2, $vr11, $vr2
	vilvl.h	$vr2, $vr11, $vr2
	vslli.w	$vr2, $vr2, 1
	vsub.w	$vr2, $vr12, $vr2
	vmul.w	$vr2, $vr2, $vr12
	...
	vdiv.d	$vr4, $vr2, $vr0
	vdiv.d	$vr2, $vr3, $vr0
	vstelm.w	$vr2, $a3, 68, 2
	vstelm.w	$vr4, $a3, 132, 0
	vstelm.w	$vr4, $a3, 196, 2
	ld.b	$a4, $a2, -29
	ld.b	$a5, $a2, -13
	ld.b	$a6, $a2, 3
	ld.b	$a7, $a2, 19
	...
	vilvl.b	$vr3, $vr11, $vr3
	vilvl.h	$vr3, $vr11, $vr3
	vslli.w	$vr3, $vr3, 1
	vsub.w	$vr3, $vr12, $vr3
	vmul.w	$vr3, $vr3, $vr12
	...
	vilvl.b	$vr4, $vr11, $vr4
	vilvl.h	$vr4, $vr11, $vr4
	vslli.w	$vr4, $vr4, 1
	vsub.w	$vr4, $vr12, $vr4
	vmul.w	$vr4, $vr4, $vr12
	vshuf4i.w	$vr5, $vr4, 50
	vslli.d	$vr5, $vr5, 32
	vsrai.d	$vr5, $vr5, 32
	...
	vpackod.w	$vr8, $vr7, $vr3
	vshuf4i.d	$vr8, $vr4, 12
	vst	$vr8, $a3, 72
	...
	vdiv.d	$vr1, $vr1, $vr0
	vdiv.d	$vr2, $vr2, $vr0
	vstelm.w	$vr2, $a3, 88, 2
	vstelm.w	$vr1, $a3, 152, 0
	vstelm.w	$vr1, $a3, 216, 2
	ld.b	$a4, $a2, -24
	ld.b	$a5, $a2, -8
	ld.b	$a6, $a2, 8
	ld.b	$a7, $a2, 24
	...
	vshuf.w	$vr4, $vr3, $vr2
	vst	$vr4, $a3, 16
	vstelm.w	$vr3, $a3, 92, 2
	vstelm.w	$vr1, $a3, 156, 0
	vstelm.w	$vr1, $a3, 220, 2
	ld.b	$a4, $a2, -23
	ld.b	$a5, $a2, -7
	ld.b	$a6, $a2, 9
	ld.b	$a7, $a2, 25
	...
	vdiv.d	$vr3, $vr1, $vr0
	vdiv.d	$vr1, $vr2, $vr0
	vstelm.w	$vr1, $a3, 96, 2
	vstelm.w	$vr3, $a3, 160, 0
	vstelm.w	$vr3, $a3, 224, 2
	ld.b	$a4, $a2, -22
	ld.b	$a5, $a2, -6
	ld.b	$a6, $a2, 10
	ld.b	$a7, $a2, 26
	...
	vdiv.d	$vr2, $vr2, $vr0
	vdiv.d	$vr3, $vr3, $vr0
	vstelm.w	$vr3, $a3, 100, 2
	vstelm.w	$vr2, $a3, 164, 0
	vstelm.w	$vr2, $a3, 228, 2
	ld.b	$a4, $a2, -21
	ld.b	$a5, $a2, -5
	ld.b	$a6, $a2, 11
	ld.b	$a7, $a2, 27
	...
	vdiv.d	$vr2, $vr2, $vr0
	vdiv.d	$vr4, $vr4, $vr0
	vstelm.w	$vr4, $a3, 104, 2
	vstelm.w	$vr2, $a3, 168, 0
	vstelm.w	$vr2, $a3, 232, 2
	ld.b	$a4, $a2, -20
	ld.b	$a5, $a2, -4
	ld.b	$a6, $a2, 12
	ld.b	$a7, $a2, 28
	...
	vshuf.w	$vr3, $vr5, $vr1
	vst	$vr3, $a3, 32
	vstelm.w	$vr5, $a3, 108, 2
	vstelm.w	$vr2, $a3, 172, 0
	vstelm.w	$vr2, $a3, 236, 2
	ld.b	$a4, $a2, -19
	ld.b	$a5, $a2, -3
	ld.b	$a6, $a2, 13
	ld.b	$a7, $a2, 29
	...
	vdiv.d	$vr3, $vr1, $vr0
	vdiv.d	$vr1, $vr2, $vr0
	vstelm.w	$vr1, $a3, 112, 2
	vstelm.w	$vr3, $a3, 176, 0
	vstelm.w	$vr3, $a3, 240, 2
	ld.b	$a4, $a2, -18
	ld.b	$a5, $a2, -2
	ld.b	$a6, $a2, 14
	ld.b	$a7, $a2, 30
	...
	vdiv.d	$vr2, $vr2, $vr0
	vdiv.d	$vr3, $vr3, $vr0
	vstelm.w	$vr3, $a3, 116, 2
	vstelm.w	$vr2, $a3, 180, 0
	vstelm.w	$vr2, $a3, 244, 2
	ld.b	$a4, $a2, -17
	ld.b	$a5, $a2, -1
	ld.b	$a6, $a2, 15
	ld.b	$a7, $a2, 31
	...
	vdiv.d	$vr2, $vr2, $vr0
	vdiv.d	$vr4, $vr4, $vr0
	vstelm.w	$vr4, $a3, 120, 2
	vstelm.w	$vr2, $a3, 184, 0
	vstelm.w	$vr2, $a3, 248, 2
	ld.b	$a4, $a2, -16
	ld.b	$a5, $a2, 0
	ld.b	$a6, $a2, 16
	ld.b	$a7, $a2, 32
	...
	vshuf.w	$vr3, $vr5, $vr1
	vst	$vr3, $a3, 48
	vstelm.w	$vr5, $a3, 124, 2
	vstelm.w	$vr2, $a3, 188, 0
	vstelm.w	$vr2, $a3, 252, 2
	addi.d	$a1, $a1, 256
	addi.d	$a2, $a2, 64
	bne	$a1, $s2, .LBB1_21
