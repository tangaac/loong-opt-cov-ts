...
# %bb.28:                               #   in Loop: Header=BB6_22 Depth=1
	blez	$a0, .LBB6_20
# %bb.29:                               # %.preheader114.us.preheader
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a3, $zero
	slli.d	$t7, $a2, 1
	sub.d	$a5, $zero, $t7
...
# %bb.41:                               # %vec.epilog.iter.check
	...
	bnez	$a6, .LBB6_35
	.p2align	4, , 16
.LBB6_42:                               # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB6_31 Depth=2
	slli.d	$t4, $t5, 1
	sub.d	$t5, $a0, $t5
	.p2align	4, , 16
.LBB6_43:                               # %vec.epilog.scalar.ph
                                        #   Parent Loop BB6_22 Depth=1
                                        #     Parent Loop BB6_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.h	$t6, $t2, $t4
...
.LBB6_47:                               # %vector.body181
	...
	addi.d	$t3, $t3, 4
	bnez	$t2, .LBB6_47
# %bb.48:                               # %middle.block184
	beq	$a1, $s2, .LBB6_51
.LBB6_49:                               # %.lr.ph133.preheader188
	alsl.d	$a2, $a1, $s3, 2
	addi.d	$a2, $a2, 2
	alsl.d	$a3, $a1, $a0, 1
	alsl.d	$t0, $a1, $s4, 1
