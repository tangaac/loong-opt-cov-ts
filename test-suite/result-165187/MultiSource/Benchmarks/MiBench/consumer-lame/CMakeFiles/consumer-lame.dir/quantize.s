...
.LBB4_20:                               #   in Loop: Header=BB4_21 Depth=3
	...
	bge	$s4, $a0, .LBB4_29
.LBB4_21:                               #   Parent Loop BB4_11 Depth=1
...
# %bb.25:                               #   in Loop: Header=BB4_21 Depth=3
	...
	fcmp.cult.d	$fcc0, $fs0, $fa0
	bcnez	$fcc0, .LBB4_27
# %bb.26:                               #   in Loop: Header=BB4_21 Depth=3
	ld.w	$s3, $s7, 0
	ori	$a0, $zero, 3160
	add.d	$a0, $sp, $a0
	ori	$a2, $zero, 244
...
# %bb.33:                               # %._crit_edge369
	...
	blez	$a0, .LBB4_36
# %bb.34:                               # %.lr.ph376.preheader
	addi.d	$a1, $sp, 356
	pcalau12i	$a2, %pc_hi20(.LCPI4_2)
	fld.d	$fa0, $a2, %pc_lo12(.LCPI4_2)
	vldi	$vr1, -928
	vldi	$vr2, -912
	ori	$a2, $zero, 125
...
.LBB4_38:
	move	$fp, $zero
.LBB4_39:                               # %.loopexit348.thread
	ld.w	$a0, $s6, 208
	ld.w	$a1, $s6, 212
	bge	$a0, $a1, .LBB4_44
.LBB4_40:                               # %.lr.ph380.preheader
	addi.d	$a2, $sp, 260
	alsl.d	$a2, $a0, $a2, 2
	.p2align	4, , 16
.LBB4_41:                               # %.lr.ph380
...
# %bb.45:                               # %.preheader346
	blez	$a1, .LBB4_103
# %bb.46:                               # %.preheader345.lr.ph
	ld.w	$a0, $s6, 204
	blez	$a0, .LBB4_57
# %bb.47:                               # %.preheader345.lr.ph.split.us
	ld.w	$a3, $s6, 220
	move	$a2, $zero
	slli.d	$a3, $a3, 2
	addi.d	$a4, $sp, 260
	...
	b	.LBB4_49
	.p2align	4, , 16
.LBB4_48:                               # %._crit_edge387.us
                                        #   in Loop: Header=BB4_49 Depth=1
	addi.d	$a2, $a2, 1
	addi.d	$a6, $a6, 8
	addi.d	$a5, $a5, 8
	bgeu	$a2, $a1, .LBB4_57
.LBB4_49:                               # %.preheader345.us
                                        # =>This Loop Header: Depth=1
...
.LBB4_56:                               # %.loopexit
	blez	$a1, .LBB4_103
.LBB4_57:                               # %.preheader342.lr.ph
	ld.w	$a0, $s6, 204
	addi.d	$a2, $s3, 48
	st.d	$a2, $sp, 224                   # 8-byte Folded Spill
	lu12i.w	$a2, 1
	blez	$a0, .LBB4_82
# %bb.58:                               # %.preheader342.preheader
	move	$s0, $zero
	addi.d	$a4, $s3, 288
	move	$a3, $a2
	lu12i.w	$a2, 2
	...
	b	.LBB4_61
	.p2align	4, , 16
.LBB4_59:                               # %._crit_edge399.loopexit
...
# %bb.66:                               # %.peel.next.thread
	...
	bnez	$a0, .LBB4_70
	.p2align	4, , 16
# %bb.67:                               #   in Loop: Header=BB4_61 Depth=1
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 204
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB4_59
	b	.LBB4_74
.LBB4_68:                               #   in Loop: Header=BB4_61 Depth=1
	ori	$a2, $zero, 244
	move	$a0, $s7
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB4_69:                               #   in Loop: Header=BB4_61 Depth=1
	ld.w	$a0, $s6, 204
...
.LBB4_70:                               # %.peel.next
	...
	addi.d	$s7, $s7, 244
	beqz	$a0, .LBB4_72
# %bb.71:                               #   in Loop: Header=BB4_61 Depth=1
	ld.w	$a0, $fp, 92
	slli.d	$a0, $a0, 1
	addi.d	$a0, $a0, -6
	ld.w	$s6, $s1, 4
	...
	jirl	$ra, $ra, 0
	b	.LBB4_73
.LBB4_72:                               #   in Loop: Header=BB4_61 Depth=1
	ori	$a2, $zero, 244
	move	$a0, $s7
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB4_73:                               #   in Loop: Header=BB4_61 Depth=1
	ld.d	$fp, $sp, 208                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 232                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 204
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB4_59
.LBB4_74:                               # %.peel.next444.preheader
                                        #   in Loop: Header=BB4_61 Depth=1
	ori	$s1, $zero, 2
	...
	b	.LBB4_78
	.p2align	4, , 16
.LBB4_75:                               #   in Loop: Header=BB4_78 Depth=2
	ld.w	$a0, $fp, 92
	slli.d	$a0, $a0, 1
	addi.d	$a0, $a0, -6
	ld.w	$s5, $s3, 0
...
# %bb.80:                               #   in Loop: Header=BB4_78 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB4_76
.LBB4_81:                               # %.preheader341
	lu12i.w	$a2, 1
	blez	$a1, .LBB4_103
.LBB4_82:                               # %.preheader340.lr.ph
	ld.w	$a0, $s6, 204
	blez	$a0, .LBB4_92
# %bb.83:                               # %.preheader340.preheader
	move	$s2, $zero
	ori	$fp, $a2, 512
	move	$s0, $s7
	b	.LBB4_86
	.p2align	4, , 16
.LBB4_84:                               # %._crit_edge403.loopexit
                                        #   in Loop: Header=BB4_86 Depth=1
	ld.w	$a1, $s8, 200
	move	$s6, $s8
	lu12i.w	$a2, 1
.LBB4_85:                               # %._crit_edge403
                                        #   in Loop: Header=BB4_86 Depth=1
	addi.d	$s2, $s2, 1
...
# %bb.90:                               #   in Loop: Header=BB4_89 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB4_88
.LBB4_91:                               # %.preheader339
	blez	$a1, .LBB4_103
.LBB4_92:                               # %.preheader338.lr.ph
	ld.w	$a5, $s6, 204
	blez	$a5, .LBB4_103
# %bb.93:                               # %.preheader338.preheader
	move	$a0, $zero
	move	$a3, $a2
	lu12i.w	$a2, -2
	ori	$a2, $a2, 3584
	...
	b	.LBB4_96
	.p2align	4, , 16
.LBB4_94:                               # %._crit_edge407.loopexit
                                        #   in Loop: Header=BB4_96 Depth=1
	ld.w	$a1, $s6, 200
.LBB4_95:                               # %._crit_edge407
                                        #   in Loop: Header=BB4_96 Depth=1
	addi.d	$a0, $a0, 1
