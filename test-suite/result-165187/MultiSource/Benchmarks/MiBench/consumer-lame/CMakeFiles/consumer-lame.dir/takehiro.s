...
# %bb.12:
	...
	addi.d	$a6, $a3, %pc_lo12(cb_esc_buf)
	move	$a3, $zero
	move	$t2, $zero
	move	$t1, $a0
	.p2align	4, , 16
...
# %bb.17:                               # %vector.ph159
	srli.d	$t2, $t3, 2
	addi.d	$t3, $t2, 1
	bstrpick.d	$t2, $t3, 62, 1
	slli.d	$t4, $t2, 1
	pcalau12i	$t5, %pc_hi20(cb_esc_buf)
	addi.d	$t6, $t5, %pc_lo12(cb_esc_buf)
	move	$t5, $zero
	alsl.d	$t2, $t2, $t6, 3
	addi.d	$t6, $t6, 4
	move	$t8, $t4
...
.LBB1_18:                               # %vector.body162
	...
	addi.d	$t6, $t6, 8
	bnez	$t8, .LBB1_18
# %bb.19:                               # %middle.block170
	add.w	$t5, $t5, $t7
	beq	$t3, $t4, .LBB1_21
	.p2align	4, , 16
.LBB1_20:                               # %scalar.ph157
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t3, $t2, 0
	ldx.bu	$t3, $t1, $t3
	addi.d	$t4, $t2, 4
...
.LBB1_24:                               # %vector.body183
	...
	addi.d	$t3, $t3, 8
	bnez	$t4, .LBB1_24
# %bb.25:                               # %middle.block191
	add.w	$a3, $t2, $a3
	beq	$a1, $t1, .LBB1_27
	.p2align	4, , 16
.LBB1_26:                               # %scalar.ph178
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, 0
	ldx.bu	$a1, $a7, $a1
	addi.d	$t1, $a0, 4
...
# %bb.63:                               # %vector.ph139
	...
	addi.d	$t1, $t0, %pc_lo12(cb_esc_buf)
	move	$t0, $zero
	alsl.d	$a0, $a0, $t1, 3
	addi.d	$t1, $t1, 4
	move	$t2, $a7
	.p2align	4, , 16
.LBB1_64:                               # %vector.body142
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t3, $t1, -4
	ld.w	$t4, $t1, 0
	ldx.bu	$t3, $a4, $t3
	...
	addi.d	$t1, $t1, 8
	bnez	$t2, .LBB1_64
# %bb.65:                               # %middle.block150
	add.w	$a3, $t0, $a3
	beq	$a1, $a7, .LBB1_67
	.p2align	4, , 16
.LBB1_66:                               # %scalar.ph137
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, 0
	ldx.bu	$a1, $a4, $a1
	addi.d	$a7, $a0, 4
	...
	move	$a0, $a7
	bltu	$a7, $a6, .LBB1_66
.LBB1_67:                               # %count_bit_noESC2.exit72
	slt	$a0, $a3, $a5
	ori	$a1, $zero, 13
	masknez	$a1, $a1, $a0
	ori	$a4, $zero, 15
...
# %bb.12:
	...
	ld.d	$t1, $a3, 16
	pcalau12i	$a3, %pc_hi20(cb_esc_buf)
	addi.d	$t2, $a3, %pc_lo12(cb_esc_buf)
	move	$a3, $zero
	move	$t0, $zero
	.p2align	4, , 16
...
.LBB3_16:
	...
	addi.d	$t3, $t1, %pc_lo12(cb_esc_buf)
	alsl.d	$t1, $a5, $t3, 2
	move	$t4, $a3
	bgeu	$t3, $t1, .LBB3_20
# %bb.17:                               # %vector.ph148
	...
	srli.d	$t1, $t1, 2
	addi.d	$t1, $t1, 1
	bstrpick.d	$t3, $t1, 61, 1
	slli.d	$t2, $t3, 1
	pcalau12i	$t4, %pc_hi20(cb_esc_buf)
	addi.d	$t5, $t4, %pc_lo12(cb_esc_buf)
	move	$t4, $zero
	alsl.d	$t3, $t3, $t5, 3
	addi.d	$t5, $t5, 4
	move	$t7, $t2
...
.LBB3_18:                               # %vector.body151
	...
	addi.d	$t5, $t5, 8
	bnez	$t7, .LBB3_18
# %bb.19:                               # %middle.block159
	add.w	$t4, $t4, $t6
	beq	$t1, $t2, .LBB3_22
.LBB3_20:                               # %scalar.ph146.preheader
	addi.d	$t1, $t3, -4
	.p2align	4, , 16
.LBB3_21:                               # %scalar.ph146
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t2, $t1, 4
	ldx.bu	$t2, $t0, $t2
	addi.d	$t3, $t1, 4
...
.LBB3_25:                               # %vector.body170
	...
	addi.d	$t3, $t3, 8
	bnez	$t4, .LBB3_25
# %bb.26:                               # %middle.block178
	add.w	$a3, $t2, $a3
	beq	$a5, $t1, .LBB3_29
.LBB3_27:                               # %scalar.ph165.preheader
	addi.d	$a5, $t0, -4
	.p2align	4, , 16
.LBB3_28:                               # %scalar.ph165
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t0, $a5, 4
	ldx.bu	$t0, $a6, $t0
	addi.d	$t1, $a5, 4
...
.LBB3_57:                               # %vector.body133
	...
	addi.d	$t1, $t1, 8
	bnez	$t2, .LBB3_57
# %bb.58:                               # %middle.block141
	add.w	$a3, $t0, $a3
	beq	$a5, $a7, .LBB3_61
.LBB3_59:                               # %scalar.ph128.preheader
	addi.d	$a5, $a6, -4
	.p2align	4, , 16
.LBB3_60:                               # %scalar.ph128
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a6, $a5, 4
	ldx.bu	$a6, $a4, $a6
	addi.d	$a7, $a5, 4
	...
	move	$a5, $a7
	bltu	$a7, $a1, .LBB3_60
.LBB3_61:                               # %count_bit_noESC2.exit73
	slt	$a1, $a3, $a0
	ori	$a4, $zero, 13
	masknez	$a4, $a4, $a1
	ori	$a5, $zero, 15
