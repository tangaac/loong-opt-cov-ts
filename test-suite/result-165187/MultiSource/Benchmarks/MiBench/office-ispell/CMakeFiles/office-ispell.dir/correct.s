...
# %bb.28:
	move	$a1, $zero
	b	.LBB10_37
.LBB10_29:                              # %vector.body259.preheader
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	addi.d	$a1, $sp, 145
	.p2align	4, , 16
.LBB10_30:                              # %vector.body259
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a1, -1
	ld.bu	$a3, $a1, 0
	addi.d	$a4, $s8, 754
	...
	addi.d	$a1, $a1, 2
	bnez	$a0, .LBB10_30
# %bb.31:                               # %middle.block262
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	beq	$a2, $a0, .LBB10_39
.LBB10_32:                              # %.lr.ph168.preheader269
	addi.d	$a0, $sp, 144
	add.d	$a0, $a0, $a1
...
.LBB10_33:                              # %.lr.ph168
	...
	bnez	$a1, .LBB10_33
	b	.LBB10_39
.LBB10_34:                              # %vector.body248.preheader
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	addi.d	$a1, $sp, 145
	.p2align	4, , 16
.LBB10_35:                              # %vector.body248
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a1, -1
	ld.bu	$a3, $a1, 0
	addi.d	$a4, $s8, 526
	...
	addi.d	$a1, $a1, 2
	bnez	$a0, .LBB10_35
# %bb.36:                               # %middle.block251
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	beq	$a2, $a0, .LBB10_39
.LBB10_37:                              # %.lr.ph170.preheader268
	addi.d	$a0, $sp, 144
	add.d	$a0, $a0, $a1
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	sub.d	$a1, $a2, $a1
...
# %bb.40:
	...
	ori	$s5, $zero, 120
	bge	$a1, $a0, .LBB10_54
# %bb.41:                               # %.lr.ph174.preheader
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a2, $sp, 56                    # 8-byte Folded Reload
	beqz	$a2, .LBB10_45
# %bb.42:                               # %vector.body234.preheader
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_43:                              # %vector.body234
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a1, -1
	ld.bu	$a3, $a1, 0
	addi.d	$a4, $s8, 754
	...
	addi.d	$a1, $a1, 2
	bnez	$a0, .LBB10_43
# %bb.44:                               # %middle.block239
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a3, $sp, 72                    # 8-byte Folded Reload
	beq	$a2, $a3, .LBB10_54
.LBB10_45:                              # %.lr.ph174.preheader266
...
# %bb.51:                               # %middle.block
	...
	ld.d	$a3, $sp, 72                    # 8-byte Folded Reload
	beq	$a2, $a3, .LBB10_54
.LBB10_52:                              # %.lr.ph178.preheader265
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	sub.d	$a1, $a2, $a1
	.p2align	4, , 16
.LBB10_53:                              # %.lr.ph178
...
# %bb.62:                               # %.lr.ph161
	...
	move	$a2, $s0
	beqz	$fp, .LBB10_66
# %bb.63:                               # %.lr.ph161.split
	bnez	$s3, .LBB10_73
	b	.LBB10_80
.LBB10_64:                              #   in Loop: Header=BB10_66 Depth=1
	beqz	$a4, .LBB10_84
.LBB10_65:                              # %.backedge.us
                                        #   in Loop: Header=BB10_66 Depth=1
	slli.d	$a3, $a3, 33
	bgez	$a3, .LBB10_12
.LBB10_66:                              # %.lr.ph161.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a2, 0
	ld.d	$a3, $a2, 16
	and	$a4, $a3, $a0
...
# %bb.67:                               #   in Loop: Header=BB10_66 Depth=1
	beqz	$s3, .LBB10_69
# %bb.68:                               #   in Loop: Header=BB10_66 Depth=1
	ld.h	$a5, $s3, 16
	srl.d	$a5, $a3, $a5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_65
.LBB10_69:                              #   in Loop: Header=BB10_66 Depth=1
	ld.d	$a5, $sp, 136                   # 8-byte Folded Reload
	beqz	$a5, .LBB10_64
# %bb.70:                               #   in Loop: Header=BB10_66 Depth=1
	bne	$a4, $a1, .LBB10_65
	b	.LBB10_59
...
# %bb.75:                               #   in Loop: Header=BB10_73 Depth=1
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB10_72
# %bb.76:                               #   in Loop: Header=BB10_73 Depth=1
	ld.d	$a5, $sp, 136                   # 8-byte Folded Reload
	beqz	$a5, .LBB10_71
# %bb.77:                               #   in Loop: Header=BB10_73 Depth=1
	bne	$a4, $a1, .LBB10_72
	b	.LBB10_59
.LBB10_78:                              #   in Loop: Header=BB10_80 Depth=1
	beqz	$a4, .LBB10_84
.LBB10_79:                              # %.backedge.us165
                                        #   in Loop: Header=BB10_80 Depth=1
	slli.d	$a3, $a3, 33
	bgez	$a3, .LBB10_12
.LBB10_80:                              # %.lr.ph161.split.split.us
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a2, 0
	ld.d	$a3, $a2, 16
	and	$a4, $a3, $a0
