...
.LBB0_117:                              #   in Loop: Header=BB0_75 Depth=3
	move	$a4, $s8
.LBB0_118:                              # %.lr.ph516.preheader776
                                        #   in Loop: Header=BB0_75 Depth=3
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a2, $s3, 1
...
.LBB0_156:                              #   in Loop: Header=BB0_53 Depth=2
	move	$a3, $a7
	move	$a4, $s8
.LBB0_157:                              # %.lr.ph543.preheader777
                                        #   in Loop: Header=BB0_53 Depth=2
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a3, $s3, 1
...
.LBB0_192:                              #   in Loop: Header=BB0_186 Depth=1
	ori	$a3, $zero, 1
.LBB0_193:                              # %.lr.ph572.preheader774
                                        #   in Loop: Header=BB0_186 Depth=1
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a0, $a3, $a0, 1
	sub.d	$a2, $a2, $a3
...
.LBB0_194:                              # %.lr.ph572
	...
	bnez	$a2, .LBB0_194
	b	.LBB0_185
.LBB0_195:                              # %.split.loop.exit702
	move	$fp, $s1
.LBB0_196:                              # %.split.loop.exit
	ld.d	$a0, $sp, 320
	beqz	$a0, .LBB0_198
	.p2align	4, , 16
.LBB0_197:                              # %.preheader423
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $sp, 320
	addi.d	$a1, $sp, 344
	addi.d	$a2, $sp, 412
