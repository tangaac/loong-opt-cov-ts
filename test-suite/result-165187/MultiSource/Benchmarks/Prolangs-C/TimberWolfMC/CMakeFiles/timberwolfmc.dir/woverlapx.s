...
# %bb.0:
	...
	vsub.w	$vr0, $vr0, $vr1
	pcalau12i	$a0, %got_pc_hi20(binWidthY)
	ld.d	$a0, $a0, %got_pc_lo12(binWidthY)
	ld.w	$a0, $a0, 0
	...
	vslti.w	$vr2, $vr0, 1
	vrepli.w	$vr3, 1
	pcalau12i	$a3, %got_pc_hi20(numBinsY)
	ld.d	$a3, $a3, %got_pc_lo12(numBinsY)
	ld.w	$a3, $a3, 0
...
# %bb.2:                                # %.lr.ph379.split.preheader
	...
	b	.LBB0_4
	.p2align	4, , 16
.LBB0_3:                                # %..loopexit352_crit_edge
                                        #   in Loop: Header=BB0_4 Depth=1
	addi.d	$a1, $a1, 1
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beq	$a1, $a0, .LBB0_50
.LBB0_4:                                # %.lr.ph379.split
...
# %bb.29:                               # %.lr.ph
	...
	bge	$a1, $a6, .LBB0_37
# %bb.30:                               # %.lr.ph.split.us.preheader
                                        #   in Loop: Header=BB0_28 Depth=4
	ld.d	$t0, $sp, 216                   # 8-byte Folded Reload
	b	.LBB0_32
	.p2align	4, , 16
.LBB0_31:                               #   in Loop: Header=BB0_32 Depth=5
	ld.d	$s1, $s1, 0
	beqz	$s1, .LBB0_27
.LBB0_32:                               # %.lr.ph.split.us
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_8 Depth=2
                                        #       Parent Loop BB0_15 Depth=3
...
# %bb.33:                               # %.lr.ph.split.us
	...
	add.w	$a1, $a1, $fp
	bge	$s7, $a1, .LBB0_31
# %bb.34:                               # %.lr.ph.split.us
                                        #   in Loop: Header=BB0_32 Depth=5
	ld.w	$a2, $s1, 64
	add.w	$a2, $a2, $a7
	bge	$a2, $s2, .LBB0_31
# %bb.35:                               # %.lr.ph.split.us
                                        #   in Loop: Header=BB0_32 Depth=5
	ld.w	$a3, $s1, 68
	add.w	$a3, $a3, $a7
	bge	$t1, $a3, .LBB0_31
# %bb.36:                               #   in Loop: Header=BB0_32 Depth=5
	slt	$a4, $a0, $s7
	masknez	$a0, $a0, $a4
	maskeqz	$a4, $s7, $a4
	or	$a0, $a4, $a0
...
.LBB0_39:                               # %.lr.ph.split
	...
	add.w	$s6, $a4, $a7
	blt	$a1, $a6, .LBB0_41
# %bb.40:                               #   in Loop: Header=BB0_39 Depth=5
	fld.d	$fa0, $s1, 8
	move	$a0, $s3
	move	$a1, $s4
	move	$a2, $s6
	...
	ld.w	$a1, $a1, 0
	add.w	$s6, $a0, $s6
.LBB0_41:                               #   in Loop: Header=BB0_39 Depth=5
	bge	$s3, $s8, .LBB0_38
# %bb.42:                               #   in Loop: Header=BB0_39 Depth=5
	bge	$s7, $s5, .LBB0_38
# %bb.43:                               #   in Loop: Header=BB0_39 Depth=5
	bge	$s4, $s2, .LBB0_38
# %bb.44:                               #   in Loop: Header=BB0_39 Depth=5
	bge	$t1, $s6, .LBB0_38
# %bb.45:                               #   in Loop: Header=BB0_39 Depth=5
	slt	$a0, $s3, $s7
	masknez	$a2, $s3, $a0
	maskeqz	$a0, $s7, $a0
	or	$a0, $a0, $a2
