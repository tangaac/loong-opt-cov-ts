...
# %bb.56:                               # %middle.block700
	...
	beq	$a3, $a1, .LBB7_59
.LBB7_57:                               # %scalar.ph690.preheader
                                        #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a1, 141
	ori	$a1, $a1, 872
	add.d	$a1, $sp, $a1
...
# %bb.85:                               #   in Loop: Header=BB7_31 Depth=2
	...
	b	.LBB7_29
	.p2align	4, , 16
.LBB7_86:                               # %vector.body684.preheader
                                        #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 912
	add.d	$a0, $sp, $a0
...
.LBB7_87:                               # %vector.body684
	...
	addi.d	$a0, $a0, 32
	bnez	$a1, .LBB7_87
# %bb.88:                               # %middle.block687
                                        #   in Loop: Header=BB7_31 Depth=2
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	move	$a1, $a3
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	beq	$a3, $a0, .LBB7_91
.LBB7_89:                               # %scalar.ph679.preheader
                                        #   in Loop: Header=BB7_31 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 896
	add.d	$a0, $sp, $a0
