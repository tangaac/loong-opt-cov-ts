...
# %bb.28:                               # %vec.epilog.iter.check
	beqz	$a2, .LBB9_32
.LBB9_29:                               # %vec.epilog.ph
	move	$a3, $a1
	bstrpick.d	$a1, $s4, 14, 2
	slli.d	$a1, $a1, 2
	sub.d	$a2, $a3, $a1
	slli.d	$a3, $a3, 1
	addi.d	$a4, $a3, 12
	...
	add.d	$a4, $fp, $a4
	.p2align	4, , 16
.LBB9_30:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a4, 0
	st.d	$a5, $a3, 0
	addi.d	$a2, $a2, 4
...
# %bb.34:
	move	$a5, $zero
	b	.LBB10_41
.LBB10_35:                              # %vector.main.loop.iter.check
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 30
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_46
...
.LBB10_38:                              # %vector.body131
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB10_38
# %bb.39:                               # %middle.block138
	beq	$a3, $a5, .LBB10_45
# %bb.40:                               # %vec.epilog.iter.check142
	beqz	$a4, .LBB10_56
.LBB10_41:                              # %vec.epilog.ph144
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	alsl.d	$a4, $a6, $s1, 1
	alsl.d	$a2, $a6, $a2, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_42:                              # %vec.epilog.vector.body147
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t1, $t0, 0
	st.d	$t1, $a7, 0
	addi.d	$a7, $a7, 8
	...
	addi.d	$t0, $t0, 8
	bnez	$a5, .LBB10_42
# %bb.43:                               # %vec.epilog.middle.block155
	beq	$a3, $a6, .LBB10_45
	.p2align	4, , 16
.LBB10_44:                              # %.lr.ph.i43
                                        # =>This Inner Loop Header: Depth=1
...
.LBB10_50:                              # %vec.epilog.ph
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_51:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t1, $t0, 0
	st.d	$t1, $a7, 0
	addi.d	$a7, $a7, 8
