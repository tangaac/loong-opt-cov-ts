...
.LBB9_23:                               # %vec.epilog.ph
	...
	add.d	$a4, $fp, $a4
	.p2align	4, , 16
.LBB9_24:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 8
...
# %bb.31:                               # %vec.epilog.iter.check
	bnez	$a2, .LBB9_23
.LBB9_32:                               # %vec.epilog.scalar.ph.preheader
	slli.d	$a2, $a1, 1
	addi.d	$a3, $a2, 12
	add.d	$a2, $fp, $a3
	add.d	$a3, $a0, $a3
...
# %bb.0:
	...
	pcalau12i	$s5, %pc_hi20(kernel_base)
	ld.d	$a1, $s5, %pc_lo12(kernel_base)
	pcalau12i	$s6, %pc_hi20(kernel_end)
	ld.d	$a2, $s6, %pc_lo12(kernel_end)
	move	$fp, $a0
	slli.d	$s4, $a0, 3
	ldx.d	$s1, $a1, $s4
	ldx.d	$s0, $a2, $s4
...
.LBB10_8:                               # %._crit_edge.loopexit
	...
	sub.w	$a1, $a1, $a2
.LBB10_9:                               # %._crit_edge
	pcalau12i	$s3, %pc_hi20(state_table)
	ld.d	$a2, $s3, %pc_lo12(state_table)
	slli.d	$s2, $a1, 3
	ldx.d	$a2, $a2, $s2
	srli.d	$s8, $a0, 1
	beqz	$a2, .LBB10_18
# %bb.10:                               # %.preheader
	ld.d	$a0, $s5, %pc_lo12(kernel_base)
	alsl.d	$a0, $fp, $a0, 3
	addi.w	$a1, $s8, 0
	b	.LBB10_13
	.p2align	4, , 16
...
# %bb.32:
	move	$a4, $s3
	b	.LBB10_55
.LBB10_33:                              # %vector.main.loop.iter.check126
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 30
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_43
...
.LBB10_35:                              # %vec.epilog.ph143
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_36:                              # %vec.epilog.vector.body146
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_36
# %bb.37:                               # %vec.epilog.middle.block154
	bne	$a3, $a6, .LBB10_48
	b	.LBB10_49
...
.LBB10_44:                              # %vector.body130
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB10_44
# %bb.45:                               # %middle.block137
	beq	$a3, $a5, .LBB10_49
# %bb.46:                               # %vec.epilog.iter.check141
	bnez	$a4, .LBB10_35
# %bb.47:
	alsl.d	$a4, $a5, $s1, 1
	alsl.d	$a2, $a5, $a2, 1
...
.LBB10_49:                              # %new_state.exit46
	...
	st.d	$a0, $a3, 0
	ld.d	$a3, $s3, %pc_lo12(state_table)
