...
# %bb.3:                                # %.preheader
	...
	ld.d	$s3, $sp, 32                    # 8-byte Folded Reload
	b	.LBB14_8
.LBB14_4:                               #   in Loop: Header=BB14_8 Depth=2
	...
	or	$a3, $a0, $a1
	bnez	$a5, .LBB14_21
# %bb.5:                                #   in Loop: Header=BB14_8 Depth=2
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	move	$a2, $s0
.LBB14_6:                               # %notsupported.exit
                                        #   in Loop: Header=BB14_8 Depth=2
	pcaddu18i	$ra, %call36(fprintf)
	jirl	$ra, $ra, 0
.LBB14_7:                               # %notsupported.exit
                                        #   in Loop: Header=BB14_8 Depth=2
	addi.d	$s7, $s7, 1
	addi.w	$s4, $s4, 1
	addi.d	$s3, $s3, 16
...
.LBB14_22:                              #   in Loop: Header=BB14_8 Depth=2
	...
	jirl	$ra, $ra, 0
	b	.LBB14_7
.LBB14_23:                              #   in Loop: Header=BB14_8 Depth=2
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	pcalau12i	$a1, %pc_hi20(.L.str.65)
	addi.d	$a1, $a1, %pc_lo12(.L.str.65)
	...
	jirl	$ra, $ra, 0
	b	.LBB14_7
.LBB14_24:                              #   in Loop: Header=BB14_8 Depth=2
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	pcalau12i	$a1, %pc_hi20(.L.str.65)
	addi.d	$a1, $a1, %pc_lo12(.L.str.65)
...
.LBB17_3:
	...
	addi.d	$s6, $a2, %pc_lo12(yycrank)
	addi.w	$s7, $s6, 0
	pcalau12i	$a2, %pc_hi20(yysvec)
	addi.d	$t1, $a2, %pc_lo12(yysvec)
...
.LBB17_10:                              #   in Loop: Header=BB17_8 Depth=2
	...
	st.w	$a0, $s4, %pc_lo12(yytchar)
	bne	$a0, $a7, .LBB17_12
.LBB17_11:                              #   in Loop: Header=BB17_8 Depth=2
	ld.w	$a1, $s5, %pc_lo12(yylineno)
	addi.d	$a1, $a1, 1
	st.w	$a1, $s5, %pc_lo12(yylineno)
.LBB17_12:                              #   in Loop: Header=BB17_8 Depth=2
	addi.d	$a1, $a0, 1
	sltui	$a1, $a1, 1
	masknez	$a1, $a0, $a1
	stx.b	$a1, $t0, $t2
...
.LBB17_16:                              #   in Loop: Header=BB17_14 Depth=3
	bge	$a3, $s7, .LBB17_21
# %bb.17:                               #   in Loop: Header=BB17_14 Depth=3
	sub.d	$a3, $s6, $s0
	add.d	$a3, $s6, $a3
	alsl.d	$a4, $a1, $a3, 1
	bltu	$a2, $a4, .LBB17_19
# %bb.18:                               #   in Loop: Header=BB17_14 Depth=3
	ld.bu	$a5, $a4, 0
	slli.d	$a6, $a5, 4
	alsl.d	$a5, $a5, $a6, 3
	add.d	$a5, $t1, $a5
	beq	$a5, $s8, .LBB17_24
.LBB17_19:                              #   in Loop: Header=BB17_14 Depth=3
	pcalau12i	$a4, %pc_hi20(yymatch)
	addi.d	$a4, $a4, %pc_lo12(yymatch)
	ldx.b	$a4, $a4, $a1
	alsl.d	$a3, $a4, $a3, 1
	bltu	$a2, $a3, .LBB17_21
.LBB17_20:                              #   in Loop: Header=BB17_14 Depth=3
	ld.bu	$a4, $a3, 0
	slli.d	$a5, $a4, 4
	alsl.d	$a4, $a4, $a5, 3
	add.d	$a4, $t1, $a4
	beq	$a4, $s8, .LBB17_23
.LBB17_21:                              #   in Loop: Header=BB17_14 Depth=3
	ld.d	$s8, $s8, 8
	beqz	$s8, .LBB17_26
# %bb.22:                               #   in Loop: Header=BB17_14 Depth=3
	ld.d	$s0, $s8, 0
	bne	$s0, $s6, .LBB17_14
	b	.LBB17_26
.LBB17_23:                              #   in Loop: Header=BB17_8 Depth=2
	ld.bu	$a2, $a3, 1
	bnez	$a2, .LBB17_25
	b	.LBB17_26
.LBB17_24:                              #   in Loop: Header=BB17_8 Depth=2
	ld.bu	$a2, $a4, 1
	beqz	$a2, .LBB17_26
.LBB17_25:                              #   in Loop: Header=BB17_8 Depth=2
	move	$a1, $zero
	slli.d	$a0, $a2, 4
	alsl.d	$a0, $a2, $a0, 3
	add.d	$s8, $t1, $a0
...
.LBB17_26:                              #   in Loop: Header=BB17_4 Depth=1
	...
	bne	$a0, $a7, .LBB17_28
# %bb.27:                               # %.loopexit.sink.split.sink.split
                                        #   in Loop: Header=BB17_4 Depth=1
	ld.w	$a1, $s5, %pc_lo12(yylineno)
	addi.d	$a1, $a1, -1
	st.w	$a1, $s5, %pc_lo12(yylineno)
.LBB17_28:                              # %.loopexit.sink.split
                                        #   in Loop: Header=BB17_4 Depth=1
...
.LBB17_37:                              #   in Loop: Header=BB17_34 Depth=2
	ld.b	$a2, $fp, 0
	andi	$a0, $a2, 255
	st.w	$a2, $s4, %pc_lo12(yytchar)
	bne	$a0, $a7, .LBB17_33
# %bb.38:                               #   in Loop: Header=BB17_34 Depth=2
	ld.w	$a2, $s5, %pc_lo12(yylineno)
	addi.d	$a2, $a2, -1
	st.w	$a2, $s5, %pc_lo12(yylineno)
	b	.LBB17_33
	.p2align	4, , 16
...
.LBB17_40:                              #   in Loop: Header=BB17_4 Depth=1
	...
	addi.d	$a1, $a1, 1
	st.w	$a1, $s5, %pc_lo12(yylineno)
.LBB17_41:                              #   in Loop: Header=BB17_4 Depth=1
	move	$a1, $zero
	move	$t2, $zero
	addi.d	$a2, $a0, 1
	sltui	$a2, $a2, 1
...
# %bb.47:                               # %.preheader.i.preheader
	...
	sub.w	$a4, $zero, $a4
	.p2align	4, , 16
.LBB17_48:                              # %.preheader.i
                                        #   Parent Loop BB17_46 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	beqz	$a6, .LBB17_50
# %bb.49:                               #   in Loop: Header=BB17_48 Depth=2
	addi.d	$a5, $a5, 4
	bne	$a6, $a4, .LBB17_48
	b	.LBB17_54
	.p2align	4, , 16
.LBB17_50:                              # %yyback.exit
                                        #   in Loop: Header=BB17_46 Depth=1
	bgeu	$s3, $a1, .LBB17_54
# %bb.51:                               #   in Loop: Header=BB17_46 Depth=1
	ld.b	$a4, $fp, 0
	andi	$a3, $a4, 255
	st.w	$a4, $s4, %pc_lo12(yytchar)
	bne	$a3, $a0, .LBB17_45
# %bb.52:                               #   in Loop: Header=BB17_46 Depth=1
	ld.w	$a4, $s5, %pc_lo12(yylineno)
	addi.d	$a4, $a4, -1
	st.w	$a4, $s5, %pc_lo12(yylineno)
	b	.LBB17_45
.LBB17_53:
	ld.d	$a7, $sp, 16                    # 8-byte Folded Reload
.LBB17_54:                              # %yyback.exit.thread
	ld.b	$a0, $fp, 0
