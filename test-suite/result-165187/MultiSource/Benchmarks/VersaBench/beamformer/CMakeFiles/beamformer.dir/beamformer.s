...
.Lfunc_end0:
	.size	main, .Lfunc_end0-main
                                        # -- End function
	.globl	begin_StrictFP                  # -- Begin function begin_StrictFP
	.p2align	5
...
.LBB1_168:                              # %.preheader95
	...
	lu12i.w	$a1, -1
	.p2align	4, , 16
.LBB1_169:                              #   Parent Loop BB1_168 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fs1, $a0, -48
	fld.s	$fs2, $a0, -44
	add.d	$a2, $a4, $a1
...
.LBB1_175:                              # %._crit_edge.i74
	...
	maskeqz	$a1, $a1, $a3
	bne	$a2, $s4, .LBB1_171
# %bb.176:                              # %._crit_edge.i74
                                        #   in Loop: Header=BB1_172 Depth=2
	blez	$s6, .LBB1_171
# %bb.177:                              # %.lr.ph63.preheader.i77
                                        #   in Loop: Header=BB1_172 Depth=2
	move	$a0, $s1
	move	$a1, $zero
	move	$a2, $s2
...
.LBB1_179:                              # %vector.body
	...
	addi.d	$a0, $a0, 16
	bne	$a2, $a3, .LBB1_179
# %bb.180:                              # %Magnitude_StrictFP.exit
                                        #   in Loop: Header=BB1_168 Depth=1
	addi.d	$a1, $sp, 224
	ori	$a2, $zero, 2048
...
.Lfunc_end1:
	...
	.p2align	3, 0x0                          # -- Begin function begin
.LCPI2_0:
...
.LBB2_172:                              #   Parent Loop BB2_3 Depth=1
	...
	fneg.s	$fs0, $fs1
	fmul.s	$fs0, $fa1, $fs0
	fmadd.s	$fs3, $fa0, $fs2, $fs0
	movgr2fr.w	$fs0, $zero
	fadd.s	$fs3, $fs3, $fs0
	fmul.s	$fs2, $fs2, $fa1
	fld.s	$fs4, $a0, -36
	fmadd.s	$fs1, $fa0, $fs1, $fs2
	fld.s	$fs2, $a0, -40
	fadd.s	$fs1, $fs1, $fs0
	fneg.s	$fs5, $fs4
	fmul.s	$fs5, $fa3, $fs5
	fmadd.s	$fs5, $fa2, $fs2, $fs5
	fadd.s	$fs3, $fs3, $fs5
	fmul.s	$fs2, $fs2, $fa3
	fld.s	$fs5, $a0, -28
	fmadd.s	$fs2, $fa2, $fs4, $fs2
	fld.s	$fs4, $a0, -32
	fadd.s	$fs1, $fs1, $fs2
	fneg.s	$fs2, $fs5
	fmul.s	$fs2, $fa5, $fs2
	fmadd.s	$fs2, $fa4, $fs4, $fs2
	fadd.s	$fs2, $fs3, $fs2
	fmul.s	$fs3, $fs4, $fa5
	fld.s	$fs4, $a0, -20
	fmadd.s	$fs3, $fa4, $fs5, $fs3
	fld.s	$fs5, $a0, -24
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs4
	fmul.s	$fs3, $fa7, $fs3
	fmadd.s	$fs3, $fa6, $fs5, $fs3
	fadd.s	$fs2, $fs2, $fs3
	fmul.s	$fs3, $fs5, $fa7
	fld.s	$fs5, $a0, -12
	fmadd.s	$fs3, $fa6, $fs4, $fs3
	fld.s	$fs4, $a0, -16
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs5
	fmul.s	$fs3, $ft1, $fs3
	fmadd.s	$fs3, $ft0, $fs4, $fs3
	fadd.s	$fs2, $fs2, $fs3
	fmul.s	$fs3, $fs4, $ft1
	fld.s	$fs4, $a0, -4
	fmadd.s	$fs3, $ft0, $fs5, $fs3
	fld.s	$fs5, $a0, -8
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs4
	fmul.s	$fs3, $ft3, $fs3
	fmadd.s	$fs3, $ft2, $fs5, $fs3
	fadd.s	$fs2, $fs2, $fs3
	fmul.s	$fs3, $fs5, $ft3
	fld.s	$fs5, $a0, 4
	fmadd.s	$fs3, $ft2, $fs4, $fs3
	fld.s	$fs4, $a0, 0
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs5
	fmul.s	$fs3, $ft5, $fs3
	...
	fmul.s	$fs3, $fs4, $ft5
	fld.s	$fs4, $a0, 12
	fmadd.s	$fs3, $ft4, $fs5, $fs3
	fld.s	$fs5, $a0, 8
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs4
	fmul.s	$fs3, $ft7, $fs3
	fmadd.s	$fs3, $ft6, $fs5, $fs3
	fadd.s	$fs2, $fs2, $fs3
	fmul.s	$fs3, $fs5, $ft7
	fld.s	$fs5, $a0, 20
	fmadd.s	$fs3, $ft6, $fs4, $fs3
	fld.s	$fs4, $a0, 16
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs5
	fmul.s	$fs3, $ft9, $fs3
	fmadd.s	$fs3, $ft8, $fs4, $fs3
	fadd.s	$fs2, $fs2, $fs3
	fmul.s	$fs3, $fs4, $ft9
	fld.s	$fs4, $a0, 28
	fmadd.s	$fs3, $ft8, $fs5, $fs3
	fld.s	$fs5, $a0, 24
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs4
	fmul.s	$fs3, $ft11, $fs3
	fmadd.s	$fs3, $ft10, $fs5, $fs3
	fadd.s	$fs2, $fs2, $fs3
	fmul.s	$fs3, $fs5, $ft11
	fld.s	$fs5, $a0, 36
	fmadd.s	$fs3, $ft10, $fs4, $fs3
	fld.s	$fs4, $a0, 32
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs5
	fmul.s	$fs3, $ft13, $fs3
	fmadd.s	$fs3, $ft12, $fs4, $fs3
	fadd.s	$fs2, $fs2, $fs3
	fmul.s	$fs3, $fs4, $ft13
	fld.s	$fs4, $a0, 44
	fmadd.s	$fs3, $ft12, $fs5, $fs3
	fld.s	$fs5, $a0, 40
	fadd.s	$fs1, $fs1, $fs3
	fneg.s	$fs3, $fs4
	fmul.s	$fs3, $ft15, $fs3
	fmadd.s	$fs3, $ft14, $fs5, $fs3
	fadd.s	$fs2, $fs2, $fs3
	fmul.s	$fs3, $fs5, $ft15
...
.LBB2_178:                              # %._crit_edge.i86
	...
	ori	$a3, $zero, 512
	bne	$a2, $a3, .LBB2_174
# %bb.179:                              # %._crit_edge.i86
                                        #   in Loop: Header=BB2_175 Depth=3
	blez	$fp, .LBB2_174
# %bb.180:                              # %.lr.ph63.preheader.i89
                                        #   in Loop: Header=BB2_175 Depth=3
	move	$a0, $s1
	move	$a1, $zero
	move	$a2, $s2
