...
.LBB1_68:                               # %vector.body685
	...
	addi.d	$t4, $t4, 32
	bnez	$t2, .LBB1_68
# %bb.69:                               # %middle.block688
                                        #   in Loop: Header=BB1_65 Depth=1
	beq	$a3, $a7, .LBB1_64
.LBB1_70:                               # %scalar.ph680.preheader
                                        #   in Loop: Header=BB1_65 Depth=1
	alsl.d	$t1, $a7, $t1, 2
	alsl.d	$t0, $a7, $t0, 2
	.p2align	4, , 16
.LBB1_71:                               # %scalar.ph680
                                        #   Parent Loop BB1_65 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$zero, $t0, 0
	st.w	$zero, $t1, 0
...
.LBB1_100:                              # %vector.body696
	...
	addi.d	$a5, $a5, 32
	bnez	$a7, .LBB1_100
# %bb.101:                              # %middle.block699
	beq	$a1, $a3, .LBB1_104
.LBB1_102:                              # %scalar.ph691.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB1_103:                              # %scalar.ph691
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a0, 0
	st.w	$zero, $a2, 0
	addi.d	$a2, $a2, 4
...
# %bb.132:
	move	$t1, $zero
	b	.LBB1_136
.LBB1_133:                              # %vector.ph704
	bstrpick.d	$a4, $a5, 31, 1
	slli.d	$t1, $a4, 1
	addi.d	$a4, $a3, 8
	move	$a5, $t1
	.p2align	4, , 16
.LBB1_134:                              # %vector.body707
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a6, $a4, -8
	ld.d	$a7, $a4, 0
	addi.d	$t0, $a2, -1
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB1_134
# %bb.135:                              # %middle.block710
	beq	$a0, $t1, .LBB1_138
.LBB1_136:                              # %scalar.ph702.preheader
	alsl.d	$a2, $t1, $a3, 3
	sub.d	$a0, $a0, $t1
	addi.d	$a5, $t1, 1
	.p2align	4, , 16
.LBB1_137:                              # %scalar.ph702
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	st.w	$a5, $a4, 0
	addi.d	$a2, $a2, 8
...
.LBB1_142:                              # %vector.body718
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_142
# %bb.143:                              # %middle.block721
	beq	$a6, $a2, .LBB1_146
.LBB1_144:                              # %scalar.ph713.preheader
	nor	$a4, $a2, $zero
	alsl.d	$a0, $a2, $a0, 2
	sub.d	$a2, $a6, $a2
	.p2align	4, , 16
.LBB1_145:                              # %scalar.ph713
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a4, $a4, -1
	addi.d	$a2, $a2, -1
