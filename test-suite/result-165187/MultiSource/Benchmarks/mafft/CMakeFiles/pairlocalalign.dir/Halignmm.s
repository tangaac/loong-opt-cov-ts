...
# %bb.0:
	...
	ld.w	$s0, $s7, %pc_lo12(H__align.orlgth1)
	ld.w	$s8, $a0, 0
...
.LBB2_2:
	...
	ld.w	$s3, $a1, %pc_lo12(H__align.orlgth2)
	st.d	$a0, $sp, 184                   # 8-byte Folded Spill
	addi.w	$s6, $a0, 0
	pcalau12i	$s2, %pc_hi20(H__align.w1)
	...
	pcalau12i	$s1, %pc_hi20(H__align.diaf1)
...
# %bb.5:
	blez	$s3, .LBB2_7
# %bb.6:
	ld.d	$a0, $s2, %pc_lo12(H__align.w1)
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s1, %pc_lo12(H__align.diaf1)
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	...
	ld.w	$s3, $a0, %pc_lo12(H__align.orlgth2)
.LBB2_7:
	...
	jirl	$ra, $ra, 0
	st.d	$a0, $s2, %pc_lo12(H__align.w1)
	move	$a0, $s4
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s1, %pc_lo12(H__align.diaf1)
	move	$a0, $s4
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	...
	st.w	$s0, $s7, %pc_lo12(H__align.orlgth1)
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
	st.w	$s3, $a0, %pc_lo12(H__align.orlgth2)
...
.LBB2_24:
	...
	ld.d	$a0, $sp, 320                   # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(H__align.initverticalw)
	ld.d	$a0, $sp, 344                   # 8-byte Folded Reload
	ld.d	$s7, $a0, %pc_lo12(H__align.cpmx2)
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	ld.d	$s4, $a0, %pc_lo12(H__align.cpmx1)
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	ld.d	$s2, $a0, %pc_lo12(H__align.floatwork)
	ld.d	$a0, $sp, 280                   # 8-byte Folded Reload
...
# %bb.67:                               # %.lr.ph705
	...
	st.d	$a0, $sp, 224                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$s0, $a0, %pc_lo12(H__align.gappat2)
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(H__align.diaf1)
	st.d	$a0, $sp, 216                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
...
# %bb.129:                              # %vector.ph1012
	...
	pcalau12i	$a5, %pc_hi20(.LCPI2_1)
	vld	$vr3, $a5, %pc_lo12(.LCPI2_1)
	vreplvei.d	$vr4, $vr1, 0
	addi.d	$a5, $a1, 4
	vldi	$vr5, -800
	move	$a6, $a4
	.p2align	4, , 16
.LBB2_130:                              # %vector.body1019
                                        # =>This Inner Loop Header: Depth=1
	vpickve2gr.w	$a7, $vr3, 1
...
# %bb.194:
	move	$a3, $zero
	b	.LBB2_206
.LBB2_195:                              # %vector.ph1055
	bstrpick.d	$a3, $a3, 31, 1
	slli.d	$a3, $a3, 1
	addi.d	$a5, $s0, 8
	move	$a6, $a3
	.p2align	4, , 16
.LBB2_196:                              # %vector.body1058
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a5, -8
	ld.d	$t0, $a5, 0
	addi.d	$t1, $a4, -1
...
# %bb.202:
	move	$a4, $zero
	b	.LBB2_214
.LBB2_203:                              # %vector.ph1031
	bstrpick.d	$a3, $a3, 31, 1
	slli.d	$a3, $a3, 1
	addi.d	$a5, $t2, 8
	move	$a6, $a3
	.p2align	4, , 16
.LBB2_204:                              # %vector.body1034
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a5, -8
	ld.d	$t0, $a5, 0
	addi.d	$t1, $a4, -1
...
.LBB2_212:                              # %vector.body1069
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_212
# %bb.213:                              # %middle.block1075
	beq	$a3, $a4, .LBB2_216
.LBB2_214:                              # %scalar.ph1064.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_215:                              # %scalar.ph1064
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB2_221:                              #   in Loop: Header=BB2_218 Depth=1
	...
	add.w	$t0, $s6, $t0
	bnez	$t0, .LBB2_225
.LBB2_222:                              #   in Loop: Header=BB2_218 Depth=1
	move	$t0, $s8
	move	$t1, $s1
	b	.LBB2_227
	.p2align	4, , 16
.LBB2_223:                              #   in Loop: Header=BB2_218 Depth=1
	addi.d	$a4, $s6, -1
.LBB2_224:                              #   in Loop: Header=BB2_218 Depth=1
	move	$a7, $a1
	nor	$t0, $a4, $zero
	add.w	$t0, $s6, $t0
	beqz	$t0, .LBB2_222
.LBB2_225:                              # %.lr.ph19.i609.preheader
                                        #   in Loop: Header=BB2_218 Depth=1
	sub.d	$t0, $a4, $s6
	addi.w	$t2, $t0, 1
	.p2align	4, , 16
.LBB2_226:                              # %.lr.ph19.i609
	...
	move	$s8, $t0
	bgez	$t3, .LBB2_226
.LBB2_227:                              # %._crit_edge20.i610
                                        #   in Loop: Header=BB2_218 Depth=1
	beq	$a7, $a1, .LBB2_231
# %bb.228:                              # %.lr.ph29.preheader.i612
                                        #   in Loop: Header=BB2_218 Depth=1
	nor	$t2, $a7, $zero
	addi.w	$t3, $a7, 1
	.p2align	4, , 16
.LBB2_229:                              # %.lr.ph29.i613
                                        #   Parent Loop BB2_218 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a3, $t0, -1
	addi.d	$t0, $t0, -1
	...
	addi.d	$t1, $t1, -1
	bgez	$t4, .LBB2_229
# %bb.230:                              # %._crit_edge30.loopexit.i614
                                        #   in Loop: Header=BB2_218 Depth=1
	add.d	$t5, $t5, $t2
.LBB2_231:                              # %._crit_edge30.i615
                                        #   in Loop: Header=BB2_218 Depth=1
	blez	$a5, .LBB2_235
# %bb.232:                              # %._crit_edge30.i615
                                        #   in Loop: Header=BB2_218 Depth=1
	blez	$a6, .LBB2_235
# %bb.233:                              #   in Loop: Header=BB2_218 Depth=1
	add.d	$s4, $a7, $s4
	addi.d	$s8, $t0, -1
	st.b	$a2, $t0, -1
	addi.d	$s1, $t1, -1
...
.LBB2_235:
	...
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	blez	$a0, .LBB2_238
.LBB2_236:                              # %.lr.ph50.preheader.i627
	move	$fp, $s4
	ld.d	$s0, $sp, 128                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_237:                              # %.lr.ph50.i629
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s8
	...
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB2_237
.LBB2_238:                              # %.preheader.i620
	ld.d	$s2, $sp, 336                   # 8-byte Folded Reload
	blez	$s3, .LBB2_274
# %bb.239:                              # %.lr.ph52.preheader.i621
	move	$fp, $s5
	move	$s0, $s3
	.p2align	4, , 16
.LBB2_240:                              # %.lr.ph52.i623
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s7, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s1
...
.LBB2_242:                              # %vector.body1045
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_242
# %bb.243:                              # %middle.block1050
	beq	$a4, $a5, .LBB2_246
.LBB2_244:                              # %scalar.ph1040.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_245:                              # %scalar.ph1040
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.249:                              #   in Loop: Header=BB2_248 Depth=1
	beqz	$t2, .LBB2_253
# %bb.250:                              #   in Loop: Header=BB2_248 Depth=1
	sub.d	$a7, $s6, $t2
	b	.LBB2_254
	.p2align	4, , 16
.LBB2_251:                              #   in Loop: Header=BB2_248 Depth=1
	addi.d	$a7, $s6, -1
	nor	$t5, $a7, $zero
	add.w	$t5, $s6, $t5
	bnez	$t5, .LBB2_255
.LBB2_252:                              #   in Loop: Header=BB2_248 Depth=1
	move	$t5, $s8
	move	$t6, $s1
	b	.LBB2_257
	.p2align	4, , 16
.LBB2_253:                              #   in Loop: Header=BB2_248 Depth=1
	addi.d	$a7, $s6, -1
.LBB2_254:                              #   in Loop: Header=BB2_248 Depth=1
	move	$t2, $a3
	nor	$t5, $a7, $zero
	add.w	$t5, $s6, $t5
	beqz	$t5, .LBB2_252
.LBB2_255:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_248 Depth=1
	sub.d	$t5, $a7, $s6
	addi.w	$t7, $t5, 1
	.p2align	4, , 16
.LBB2_256:                              # %.lr.ph19.i
                                        #   Parent Loop BB2_248 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$t5, $s8, -1
	st.b	$a4, $s8, -1
	addi.d	$t6, $s1, -1
...
.LBB2_259:                              # %.lr.ph29.i
	...
	addi.d	$t6, $t6, -1
	bgez	$fp, .LBB2_259
# %bb.260:                              # %._crit_edge30.loopexit.i
                                        #   in Loop: Header=BB2_248 Depth=1
	add.d	$a1, $a1, $t7
	ld.d	$fp, $sp, 368                   # 8-byte Folded Reload
.LBB2_261:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_248 Depth=1
	beq	$t0, $ra, .LBB2_264
# %bb.262:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_248 Depth=1
	addi.w	$t7, $s4, 0
	beq	$t1, $t7, .LBB2_264
# %bb.263:                              #   in Loop: Header=BB2_248 Depth=1
	ld.d	$t7, $sp, 160                   # 8-byte Folded Reload
	ld.d	$t7, $t7, %pc_lo12(impmtx)
	ldx.d	$t3, $t7, $t3
	fldx.s	$fa0, $t3, $t4
	fld.s	$fa1, $a2, 0
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a2, 0
.LBB2_264:                              #   in Loop: Header=BB2_248 Depth=1
	blez	$t0, .LBB2_268
# %bb.265:                              #   in Loop: Header=BB2_248 Depth=1
	blez	$t1, .LBB2_268
# %bb.266:                              #   in Loop: Header=BB2_248 Depth=1
	add.d	$a6, $t2, $a6
	addi.d	$s8, $t5, -1
	st.b	$a4, $t5, -1
	addi.d	$s1, $t6, -1
...
.LBB2_270:                              # %.lr.ph50.i
	...
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB2_270
.LBB2_271:                              # %.preheader.i585
	ld.d	$s2, $sp, 336                   # 8-byte Folded Reload
	blez	$s3, .LBB2_274
# %bb.272:                              # %.lr.ph52.preheader.i
	move	$fp, $s5
	move	$s0, $s3
	.p2align	4, , 16
.LBB2_273:                              # %.lr.ph52.i
	...
	addi.d	$s7, $s7, 8
	bnez	$s0, .LBB2_273
.LBB2_274:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 360                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s6
	...
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	blt	$a2, $a3, .LBB2_276
# %bb.275:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	blt	$a3, $a0, .LBB2_277
.LBB2_276:
