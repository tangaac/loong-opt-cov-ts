...
.LBB2_7:
	...
	pcaddu18i	$ra, %call36(AllocateFloatVec)
	jirl	$ra, $ra, 0
	st.d	$a0, $s2, %pc_lo12(H__align.diaf2)
	ori	$a1, $zero, 8
	move	$a0, $s6
...
# %bb.67:                               # %.lr.ph705
	...
	st.d	$a0, $sp, 200                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$s2, $a0, %pc_lo12(H__align.diaf2)
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(H__align.gapf1)
	st.d	$a0, $sp, 192                   # 8-byte Folded Spill
	fcvt.d.s	$fs1, $ft2
...
.LBB2_212:                              # %vector.body1063
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_212
# %bb.213:                              # %middle.block1069
	beq	$a3, $a4, .LBB2_216
.LBB2_214:                              # %scalar.ph1058.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_215:                              # %scalar.ph1058
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB2_242:                              # %vector.body1039
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_242
# %bb.243:                              # %middle.block1044
	move	$a7, $t0
	beq	$a4, $a5, .LBB2_246
.LBB2_244:                              # %scalar.ph1034.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_245:                              # %scalar.ph1034
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
