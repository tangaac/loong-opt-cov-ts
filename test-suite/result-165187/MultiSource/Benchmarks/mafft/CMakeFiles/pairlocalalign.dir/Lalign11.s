...
.LBB0_62:                               # %vector.body297
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_62
# %bb.63:                               # %middle.block300
	beq	$a2, $a3, .LBB0_66
.LBB0_64:                               # %scalar.ph292.preheader
	sub.d	$a2, $a2, $a3
	alsl.d	$a1, $a3, $a1, 2
	.p2align	4, , 16
.LBB0_65:                               # %scalar.ph292
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s7, $a1, 0
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 4
...
.LBB0_74:                               # %.lr.ph9.i
	...
	addi.d	$a1, $a1, 1
	bnez	$a6, .LBB0_74
.LBB0_75:                               # %._crit_edge10.i
                                        #   in Loop: Header=BB0_68 Depth=1
	add.w	$a6, $a5, $s3
	beq	$a5, $a2, .LBB0_79
# %bb.76:                               # %.lr.ph14.preheader.i
                                        #   in Loop: Header=BB0_68 Depth=1
	nor	$a5, $a5, $zero
	move	$a7, $a5
	.p2align	4, , 16
