...
# %bb.58:                               # %middle.block379
	addi.d	$a5, $a0, -1
	beq	$a5, $a4, .LBB0_61
.LBB0_59:                               # %.lr.ph29.i.preheader533
	sub.d	$a4, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a3, $a3, $s3, 2
	.p2align	4, , 16
...
.LBB0_126:                              # %.lr.ph82.i
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa0, $a2, 0
	fcmp.clt.s	$fcc1, $fs0, $fa0
	fsel	$fs0, $fs0, $fa0, $fcc1
	movcf2gr	$a4, $fcc1
	masknez	$a5, $s8, $a4
	maskeqz	$a4, $a1, $a4
	or	$s8, $a4, $a5
...
.LBB0_142:                              # %.preheader2.i
	...
	.p2align	4, , 16
.LBB0_143:                              #   Parent Loop BB0_142 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa0, $a2, 0
	fdiv.s	$fa0, $fa0, $fs0
	fst.s	$fa0, $a3, 0
	...
	addi.d	$a2, $a2, 4
	bnez	$a4, .LBB0_143
# %bb.144:                              # %._crit_edge109.i
                                        #   in Loop: Header=BB0_142 Depth=1
	addi.d	$a5, $a5, 1
	bne	$a5, $a1, .LBB0_142
# %bb.145:                              # %._crit_edge112.i
	move	$fp, $t7
...
.LBB0_159:                              # %vector.body271
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB0_159
# %bb.160:                              # %middle.block276
	beq	$a0, $a1, .LBB0_25
	b	.LBB0_23
.LBB0_161:                              # %vector.memcheck308
	addi.d	$a0, $s1, 4
	alsl.d	$a1, $s0, $s1, 2
	sltu	$a2, $a0, $s5
	sltu	$a3, $s7, $a1
...
.LBB0_164:                              # %vector.body324
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_164
# %bb.165:                              # %middle.block333
	bne	$a0, $a1, .LBB0_47
	b	.LBB0_49
.LBB0_166:                              # %vector.memcheck336
	addi.d	$a3, $s3, 4
	sltu	$a4, $a3, $a4
	sltu	$a5, $s8, $a1
	and	$a4, $a4, $a5
	bnez	$a4, .LBB0_50
# %bb.167:                              # %vector.memcheck336
	alsl.d	$a4, $a0, $a7, 2
	addi.d	$a4, $a4, -4
	sltu	$a3, $a3, $a4
	sltu	$a4, $a7, $a1
...
.LBB0_169:                              # %vector.body353
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_169
# %bb.170:                              # %middle.block363
	addi.d	$a4, $a0, -1
	bne	$a4, $a3, .LBB0_50
	b	.LBB0_52
.LBB0_171:                              # %vector.memcheck382
	alsl.d	$a3, $a0, $t0, 2
	addi.d	$a1, $a1, -4
	sltu	$a1, $a5, $a1
	sltu	$a4, $s3, $a3
...
.LBB0_174:                              # %vector.body399
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_174
# %bb.175:                              # %middle.block407
	addi.d	$a3, $a0, -1
	bne	$a3, $a1, .LBB0_62
	b	.LBB0_64
.LBB0_176:                              # %vector.memcheck410
	slli.d	$a0, $a1, 2
	move	$t3, $a1
	alsl.d	$a1, $a1, $s4, 2
	addi.d	$a3, $a0, 4
...
.LBB0_179:                              # %vector.body426
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_179
# %bb.180:                              # %middle.block435
	move	$a4, $a5
	bne	$a0, $t3, .LBB0_91
	b	.LBB0_93
.LBB0_181:                              # %vector.memcheck438
	addi.d	$a4, $s6, 4
	add.d	$a3, $t1, $a4
	sltu	$a3, $s3, $a3
	sltu	$a5, $a0, $a1
...
.LBB0_184:                              # %vector.body455
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_184
# %bb.185:                              # %middle.block464
	bne	$a3, $t7, .LBB0_95
	b	.LBB0_97
.LBB0_186:                              # %vector.memcheck467
	alsl.d	$a4, $t7, $a2, 2
	addi.d	$a5, $s6, 4
	add.d	$a3, $t1, $a5
	sltu	$a3, $a2, $a3
...
.LBB0_189:                              # %vector.body484
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_189
# %bb.190:                              # %middle.block493
	bne	$a3, $t7, .LBB0_101
	b	.LBB0_103
.LBB0_191:                              # %vector.memcheck496
	sub.d	$a5, $a5, $t2
	nor	$a5, $a5, $zero
...
# %bb.58:                               # %middle.block383
	addi.d	$a5, $a0, -1
	beq	$a5, $a4, .LBB1_61
.LBB1_59:                               # %.lr.ph29.i.preheader537
	sub.d	$a4, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a3, $a3, $s6, 2
	.p2align	4, , 16
...
.LBB1_142:                              # %.preheader2.i
	...
	ld.d	$a4, $sp, 360                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB1_143:                              #   Parent Loop BB1_142 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa0, $a2, 0
	fdiv.s	$fa0, $fa0, $fs0
	fst.s	$fa0, $a3, 0
...
.LBB1_159:                              # %vector.body275
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB1_159
# %bb.160:                              # %middle.block280
	beq	$a0, $a1, .LBB1_25
	b	.LBB1_23
.LBB1_161:                              # %vector.memcheck312
	addi.d	$a0, $s4, 4
	alsl.d	$a1, $s0, $s4, 2
	sltu	$a2, $a0, $s5
	sltu	$a3, $s7, $a1
...
.LBB1_164:                              # %vector.body328
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_164
# %bb.165:                              # %middle.block337
	bne	$a0, $a1, .LBB1_47
	b	.LBB1_49
.LBB1_166:                              # %vector.memcheck340
	addi.d	$a3, $s6, 4
	sltu	$a4, $a3, $a4
	sltu	$a5, $s8, $a1
	and	$a4, $a4, $a5
	bnez	$a4, .LBB1_50
# %bb.167:                              # %vector.memcheck340
	alsl.d	$a4, $a0, $a7, 2
	addi.d	$a4, $a4, -4
	sltu	$a3, $a3, $a4
	sltu	$a4, $a7, $a1
...
.LBB1_169:                              # %vector.body357
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_169
# %bb.170:                              # %middle.block367
	addi.d	$a4, $a0, -1
	bne	$a4, $a3, .LBB1_50
	b	.LBB1_52
.LBB1_171:                              # %vector.memcheck386
	alsl.d	$a3, $a0, $t1, 2
	addi.d	$a1, $a1, -4
	sltu	$a1, $a7, $a1
	sltu	$a4, $s6, $a3
...
.LBB1_174:                              # %vector.body403
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_174
# %bb.175:                              # %middle.block411
	addi.d	$a3, $a0, -1
	bne	$a3, $a1, .LBB1_62
	b	.LBB1_64
.LBB1_176:                              # %vector.memcheck414
	slli.d	$a0, $a1, 2
	move	$t3, $a1
	alsl.d	$a1, $a1, $s4, 2
	addi.d	$a3, $a0, 4
...
.LBB1_179:                              # %vector.body430
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_179
# %bb.180:                              # %middle.block439
	move	$a4, $a5
	bne	$a0, $t3, .LBB1_91
	b	.LBB1_93
.LBB1_181:                              # %vector.memcheck442
	addi.d	$a4, $t8, 4
	add.d	$a3, $t1, $a4
	sltu	$a3, $s3, $a3
	sltu	$a5, $a0, $a1
...
.LBB1_184:                              # %vector.body459
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_184
# %bb.185:                              # %middle.block468
	bne	$a3, $t7, .LBB1_95
	b	.LBB1_97
.LBB1_186:                              # %vector.memcheck471
	alsl.d	$a4, $t7, $a2, 2
	addi.d	$a5, $t8, 4
	add.d	$a3, $t1, $a5
	sltu	$a3, $a2, $a3
...
.LBB1_189:                              # %vector.body488
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_189
# %bb.190:                              # %middle.block497
	bne	$a3, $t7, .LBB1_101
	b	.LBB1_103
.LBB1_191:                              # %vector.memcheck500
	sub.d	$a5, $a5, $t2
	nor	$a5, $a5, $zero
	bstrpick.d	$a5, $a5, 31, 0
	slli.d	$a5, $a5, 2
