...
# %bb.57:                               # %middle.block379
	addi.d	$a5, $a0, -1
	beq	$a5, $a4, .LBB0_60
.LBB0_58:                               # %.lr.ph29.i.preheader520
	sub.d	$a4, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a3, $a3, $s3, 2
	.p2align	4, , 16
...
# %bb.88:
	...
	addi.d	$fp, $s8, 4
.LBB0_89:                               # %scalar.ph421.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a3, $s2, $a0
	alsl.d	$a0, $a0, $s8, 2
	addi.d	$a0, $a0, 4
	.p2align	4, , 16
.LBB0_90:                               # %scalar.ph421
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a0, 0
	fld.s	$fa2, $a2, 0
...
# %bb.92:
	move	$a2, $zero
.LBB0_93:                               # %scalar.ph450.preheader
	alsl.d	$a3, $a2, $s3, 2
	sub.d	$a4, $t8, $a2
	alsl.d	$a2, $a2, $a6, 2
	addi.d	$a2, $a2, 4
	.p2align	4, , 16
.LBB0_94:                               # %scalar.ph450
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
# %bb.98:
	move	$a2, $zero
	move	$t4, $t8
.LBB0_99:                               # %scalar.ph479.preheader
	alsl.d	$a1, $a2, $a1, 2
	sub.d	$a3, $t4, $a2
	alsl.d	$a2, $a2, $a6, 2
	addi.d	$a2, $a2, 4
	.p2align	4, , 16
.LBB0_100:                              # %scalar.ph479
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a1, 0
...
# %bb.140:                              # %.preheader2.i
	...
	sub.d	$a7, $a6, $a5
	bltu	$a7, $a4, .LBB0_144
# %bb.141:                              # %vector.body505.preheader
                                        #   in Loop: Header=BB0_139 Depth=1
	move	$a7, $a5
	move	$t0, $a6
	move	$t1, $a2
	.p2align	4, , 16
.LBB0_142:                              # %vector.body505
	...
	addi.d	$a7, $a7, 16
	bnez	$t1, .LBB0_142
# %bb.143:                              # %middle.block509
                                        #   in Loop: Header=BB0_139 Depth=1
	move	$t0, $a2
	beq	$ra, $a2, .LBB0_138
.LBB0_144:                              # %scalar.ph498.preheader
                                        #   in Loop: Header=BB0_139 Depth=1
	sub.d	$a7, $ra, $t0
	alsl.d	$a6, $t0, $a6, 2
	alsl.d	$a5, $t0, $a5, 2
	.p2align	4, , 16
.LBB0_145:                              # %scalar.ph498
                                        #   Parent Loop BB0_139 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa1, $a5, 0
	fdiv.s	$fa1, $fa1, $fa2
...
.LBB0_175:                              # %vector.body399
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_175
# %bb.176:                              # %middle.block407
	addi.d	$a3, $a0, -1
	bne	$a3, $a1, .LBB0_61
	b	.LBB0_63
.LBB0_177:                              # %vector.memcheck410
	slli.d	$a0, $a2, 2
	move	$s2, $a2
	alsl.d	$a2, $a2, $s4, 2
	addi.d	$a3, $a0, 4
...
.LBB0_180:                              # %vector.body426
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_180
# %bb.181:                              # %middle.block435
	move	$a4, $a5
	bne	$a0, $s2, .LBB0_89
	b	.LBB0_91
.LBB0_182:                              # %vector.memcheck438
	alsl.d	$a3, $t8, $s3, 2
	addi.d	$a4, $s5, 4
	add.d	$a2, $a7, $a4
	sltu	$a2, $s3, $a2
...
.LBB0_185:                              # %vector.body455
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_185
# %bb.186:                              # %middle.block464
	bne	$a2, $t8, .LBB0_93
	b	.LBB0_95
.LBB0_187:                              # %vector.memcheck467
	move	$t4, $t8
	alsl.d	$a3, $t8, $a1, 2
	addi.d	$a4, $s5, 4
	add.d	$a2, $a7, $a4
...
# %bb.58:                               # %middle.block383
	addi.d	$a5, $a0, -1
	beq	$a5, $a4, .LBB1_61
.LBB1_59:                               # %.lr.ph29.i.preheader524
	sub.d	$a4, $a0, $a3
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a3, $a3, $s3, 2
	.p2align	4, , 16
...
# %bb.93:
	move	$a2, $zero
.LBB1_94:                               # %scalar.ph454.preheader
	alsl.d	$a3, $a2, $s3, 2
	sub.d	$a4, $t8, $a2
	alsl.d	$a2, $a2, $a6, 2
	addi.d	$a2, $a2, 4
	.p2align	4, , 16
.LBB1_95:                               # %scalar.ph454
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a3, 0
...
# %bb.99:
	move	$a2, $zero
	move	$t4, $t8
.LBB1_100:                              # %scalar.ph483.preheader
	alsl.d	$a1, $a2, $a1, 2
	sub.d	$a3, $t4, $a2
	alsl.d	$a2, $a2, $a6, 2
	addi.d	$a2, $a2, 4
	.p2align	4, , 16
.LBB1_101:                              # %scalar.ph483
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a1, 0
...
# %bb.104:                              # %.lr.ph104.i
	...
	b	.LBB1_107
	.p2align	4, , 16
.LBB1_105:                              #   in Loop: Header=BB1_107 Depth=1
	move	$a0, $t8
	move	$a1, $a5
	move	$a2, $s8
	ld.d	$a4, $sp, 296                   # 8-byte Folded Reload
...
.LBB1_113:                              #   in Loop: Header=BB1_109 Depth=2
	beqz	$a6, .LBB1_116
# %bb.114:                              #   in Loop: Header=BB1_109 Depth=2
...
.LBB1_119:                              # %._crit_edge75.i
	...
	bne	$ra, $a1, .LBB1_121
# %bb.120:                              #   in Loop: Header=BB1_107 Depth=1
	fld.s	$fa0, $t0, 0
	fadd.s	$fa0, $fs0, $fa0
	fst.s	$fa0, $t0, 0
.LBB1_121:                              #   in Loop: Header=BB1_107 Depth=1
	addi.w	$a0, $s3, -1
...
.LBB1_125:                              # %.lr.ph88.i
	...
	addi.d	$a2, $a2, 4
	bnez	$a3, .LBB1_125
# %bb.126:                              # %._crit_edge89.i
                                        #   in Loop: Header=BB1_107 Depth=1
	slli.d	$a1, $s8, 2
	fldx.s	$fa0, $a7, $a1
	addi.w	$a5, $s8, -1
	blez	$s8, .LBB1_131
# %bb.127:                              #   in Loop: Header=BB1_107 Depth=1
	slli.d	$a2, $a5, 2
	fldx.s	$fa1, $a6, $a2
	fcmp.cule.s	$fcc1, $fa1, $fa0
	move	$a2, $a5
	bcnez	$fcc1, .LBB1_129
# %bb.128:                              #   in Loop: Header=BB1_107 Depth=1
	ld.d	$a2, $sp, 176                   # 8-byte Folded Reload
	ldx.w	$a2, $a2, $a1
	fmov.s	$fa0, $fa1
.LBB1_129:                              #   in Loop: Header=BB1_107 Depth=1
	fldx.s	$fa1, $t0, $a1
	fcmp.cule.s	$fcc1, $fa1, $fa0
	bcnez	$fcc1, .LBB1_132
.LBB1_130:                              #   in Loop: Header=BB1_107 Depth=1
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
	ldx.w	$t8, $a2, $a1
	b	.LBB1_133
.LBB1_131:                              #   in Loop: Header=BB1_107 Depth=1
	move	$a2, $a5
	fldx.s	$fa1, $t0, $a1
	fcmp.cule.s	$fcc1, $fa1, $fa0
	bceqz	$fcc1, .LBB1_130
.LBB1_132:                              #   in Loop: Header=BB1_107 Depth=1
	move	$t8, $a0
	move	$a5, $a2
.LBB1_133:                              #   in Loop: Header=BB1_107 Depth=1
	movcf2gr	$a1, $fcc0
	ld.d	$a2, $sp, 280                   # 8-byte Folded Reload
	masknez	$a2, $a2, $a1
	maskeqz	$a1, $s2, $a1
	...
	or	$t6, $a1, $a2
	bne	$ra, $a3, .LBB1_105
# %bb.134:                              #   in Loop: Header=BB1_107 Depth=1
	ld.d	$a4, $sp, 296                   # 8-byte Folded Reload
	beqz	$s8, .LBB1_137
# %bb.135:                              #   in Loop: Header=BB1_107 Depth=1
	move	$a1, $t4
	move	$a2, $a4
	bge	$s8, $a4, .LBB1_106
# %bb.136:                              #   in Loop: Header=BB1_107 Depth=1
	slli.d	$a0, $a5, 2
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	ldx.w	$s3, $a1, $a0
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	...
	move	$a1, $a5
	b	.LBB1_106
.LBB1_137:                              #   in Loop: Header=BB1_107 Depth=1
	move	$a1, $zero
	addi.w	$a0, $t6, -1
	ori	$a2, $zero, 1
	move	$s3, $t6
	b	.LBB1_106
.LBB1_138:                              # %.preheader2.preheader.i
	move	$t2, $zero
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	bstrpick.d	$a1, $a1, 30, 0
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
	...
	b	.LBB1_140
	.p2align	4, , 16
.LBB1_139:                              # %._crit_edge109.i
                                        #   in Loop: Header=BB1_140 Depth=1
	addi.d	$t2, $t2, 1
	beq	$t2, $a1, .LBB1_147
.LBB1_140:                              # %.preheader2.i
                                        # =>This Loop Header: Depth=1
...
# %bb.141:                              # %.preheader2.i
	...
	sub.d	$a7, $a6, $a5
	bltu	$a7, $a4, .LBB1_145
# %bb.142:                              # %vector.body509.preheader
                                        #   in Loop: Header=BB1_140 Depth=1
	move	$a7, $a5
	move	$t0, $a6
	move	$t1, $a2
	.p2align	4, , 16
.LBB1_143:                              # %vector.body509
	...
	addi.d	$a7, $a7, 16
	bnez	$t1, .LBB1_143
# %bb.144:                              # %middle.block513
                                        #   in Loop: Header=BB1_140 Depth=1
	move	$t0, $a2
	beq	$t4, $a2, .LBB1_139
.LBB1_145:                              # %scalar.ph502.preheader
                                        #   in Loop: Header=BB1_140 Depth=1
	sub.d	$a7, $t4, $t0
	alsl.d	$a6, $t0, $a6, 2
	alsl.d	$a5, $t0, $a5, 2
	.p2align	4, , 16
.LBB1_146:                              # %scalar.ph502
                                        #   Parent Loop BB1_140 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa1, $a5, 0
	fdiv.s	$fa1, $fa1, $fa2
...
.LBB1_161:                              # %vector.body275
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB1_161
# %bb.162:                              # %middle.block280
	beq	$a0, $a1, .LBB1_25
	b	.LBB1_23
.LBB1_163:                              # %vector.memcheck312
	addi.d	$a0, $s6, 4
	alsl.d	$a1, $t7, $s6, 2
	sltu	$a2, $a0, $t6
	sltu	$a3, $s8, $a1
...
.LBB1_166:                              # %vector.body328
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_166
# %bb.167:                              # %middle.block337
	bne	$a0, $a1, .LBB1_47
	b	.LBB1_49
.LBB1_168:                              # %vector.memcheck340
	addi.d	$a3, $s3, 4
	sltu	$a4, $a3, $a4
	sltu	$a5, $a7, $a1
	and	$a4, $a4, $a5
...
.LBB1_171:                              # %vector.body357
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_171
# %bb.172:                              # %middle.block367
	addi.d	$a4, $a0, -1
	bne	$a4, $a3, .LBB1_50
	b	.LBB1_52
.LBB1_173:                              # %vector.memcheck386
	alsl.d	$a3, $a0, $t1, 2
	addi.d	$a1, $a1, -4
	sltu	$a1, $a7, $a1
	sltu	$a4, $s3, $a3
...
.LBB1_176:                              # %vector.body403
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_176
# %bb.177:                              # %middle.block411
	addi.d	$a3, $a0, -1
	bne	$a3, $a1, .LBB1_62
	b	.LBB1_64
.LBB1_178:                              # %vector.memcheck414
	slli.d	$a0, $ra, 2
	alsl.d	$a2, $ra, $s4, 2
	addi.d	$a3, $a0, 4
	add.d	$a0, $a4, $a3
...
.LBB1_181:                              # %vector.body430
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB1_181
# %bb.182:                              # %middle.block439
	move	$a4, $a5
	bne	$a0, $ra, .LBB1_90
	b	.LBB1_92
.LBB1_183:                              # %vector.memcheck442
	alsl.d	$a3, $t8, $s3, 2
	addi.d	$a4, $s5, 4
	add.d	$a2, $a7, $a4
	sltu	$a2, $s3, $a2
...
.LBB1_186:                              # %vector.body459
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_186
# %bb.187:                              # %middle.block468
	bne	$a2, $t8, .LBB1_94
	b	.LBB1_96
.LBB1_188:                              # %vector.memcheck471
	move	$t4, $t8
	alsl.d	$a3, $t8, $a1, 2
	addi.d	$a4, $s5, 4
	add.d	$a2, $a7, $a4
