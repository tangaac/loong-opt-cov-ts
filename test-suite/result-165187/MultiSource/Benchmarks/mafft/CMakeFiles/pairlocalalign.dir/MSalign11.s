...
# %bb.83:                               # %middle.block477
	beq	$a2, $a3, .LBB2_86
.LBB2_84:                               # %scalar.ph469.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB2_85:                               # %scalar.ph469
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB2_94:                               # %.lr.ph9.i
	...
	addi.d	$a2, $a2, 1
	bnez	$t1, .LBB2_94
.LBB2_95:                               # %._crit_edge10.i
                                        #   in Loop: Header=BB2_88 Depth=1
	add.w	$a0, $t0, $a0
	beq	$t0, $a3, .LBB2_99
# %bb.96:                               # %.lr.ph14.preheader.i
                                        #   in Loop: Header=BB2_88 Depth=1
	nor	$t0, $t0, $zero
	move	$t1, $t0
	.p2align	4, , 16
