...
.LBB1_40:                               # %.lr.ph15.i
	...
	bge	$a6, $a4, .LBB1_59
.LBB1_41:                               # %scalar.ph259.preheader
	sub.d	$a1, $a0, $a3
...
.LBB1_57:                               # %vector.body234
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_57
# %bb.58:                               # %middle.block244
	bne	$a1, $a2, .LBB1_38
	b	.LBB1_40
.LBB1_59:                               # %vector.memcheck247
	addi.d	$a4, $t2, 4
	alsl.d	$a5, $a0, $t2, 2
	alsl.d	$a6, $a0, $t1, 2
	addi.d	$a6, $a6, -4
...
.LBB1_68:                               # %vector.body279
	...
	addi.d	$a3, $a3, 16
	bnez	$a5, .LBB1_68
# %bb.69:                               # %middle.block282
	bne	$a2, $a0, .LBB1_163
	b	.LBB1_165
.LBB1_70:                               # %vector.memcheck187
	ld.d	$a3, $sp, 512                   # 8-byte Folded Reload
	addi.d	$a2, $a3, 4
	alsl.d	$a3, $a0, $a3, 2
	addi.d	$a4, $s0, 4
...
.LBB1_100:                              # %scalar.ph115.preheader
	move	$t6, $s8
	move	$t8, $fp
	ld.d	$fp, $sp, 496                   # 8-byte Folded Reload
	ld.d	$t1, $sp, 408                   # 8-byte Folded Reload
.LBB1_101:                              # %scalar.ph115.preheader
	slli.d	$a4, $a2, 2
	alsl.d	$a3, $a2, $t4, 2
	sub.d	$a1, $a1, $a2
	alsl.d	$a2, $a6, $a4, 2
...
.LBB1_105:                              # %scalar.ph144.preheader
	slli.d	$a4, $a2, 2
	alsl.d	$a3, $a2, $t6, 2
	sub.d	$a1, $a1, $a2
	alsl.d	$a2, $a7, $a4, 2
...
.LBB1_147:                              # %vector.body94
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB1_147
# %bb.148:                              # %middle.block101
	bne	$a1, $a2, .LBB1_83
	b	.LBB1_85
.LBB1_149:                              # %vector.memcheck104
	alsl.d	$a3, $a1, $s4, 2
	ld.d	$a6, $sp, 160                   # 8-byte Folded Reload
	add.d	$a2, $a6, $a1
	slli.d	$a2, $a2, 2
...
.LBB1_152:                              # %vector.body120
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_152
# %bb.153:                              # %middle.block129
	bne	$a2, $a1, .LBB1_101
	b	.LBB1_103
.LBB1_154:                              # %vector.memcheck132
	alsl.d	$a3, $a1, $t6, 2
	add.d	$a2, $a7, $s3
	alsl.d	$a2, $a2, $t3, 2
	addi.d	$a2, $a2, 4
...
.LBB1_168:                              # %vector.body290
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB1_168
# %bb.169:                              # %middle.block293
	beq	$a3, $a2, .LBB1_172
.LBB1_170:                              # %scalar.ph285.preheader
	alsl.d	$a0, $a3, $a0, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB1_171:                              # %scalar.ph285
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $a2, -1
...
.LBB1_220:                              # %vector.body166
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB1_220
# %bb.221:                              # %middle.block171
	ld.d	$a2, $sp, 304                   # 8-byte Folded Reload
	beq	$a1, $a2, .LBB1_224
.LBB1_222:                              # %scalar.ph161.preheader
	alsl.d	$a2, $a1, $s3, 3
	ld.d	$a3, $sp, 304                   # 8-byte Folded Reload
	sub.d	$a1, $a3, $a1
	.p2align	4, , 16
.LBB1_223:                              # %scalar.ph161
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
...
.LBB1_228:                              # %vector.body179
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB1_228
# %bb.229:                              # %middle.block184
	beq	$a1, $s4, .LBB1_232
.LBB1_230:                              # %scalar.ph174.preheader
	alsl.d	$a2, $a1, $s1, 3
	sub.d	$a1, $s4, $a1
	.p2align	4, , 16
.LBB1_231:                              # %scalar.ph174
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	add.d	$a3, $a3, $a0
	st.d	$a3, $a2, 0
...
.LBB2_8:                                # %.loopexit
	...
	vst	$vr11, $sp, 224                 # 16-byte Folded Spill
	...
	vst	$vr16, $sp, 336                 # 16-byte Folded Spill
...
.LBB2_9:                                # %vector.body
	...
	vld	$vr22, $t6, 416
	vffint.s.w	$vr21, $vr21
	vfmadd.s	$vr20, $vr21, $vr4, $vr20
	vld	$vr21, $t6, 520
	vffint.s.w	$vr22, $vr22
	vfmadd.s	$vr20, $vr22, $vr5, $vr20
	vld	$vr22, $t6, 624
	vffint.s.w	$vr21, $vr21
	...
	vld	$vr22, $t6, 1040
	vffint.s.w	$vr21, $vr21
	vfmadd.s	$vr20, $vr21, $vr10, $vr20
	vld	$vr21, $t6, 1144
	vffint.s.w	$vr22, $vr22
	vfmadd.s	$vr20, $vr22, $vr26, $vr20
	vld	$vr22, $t6, 1248
	vffint.s.w	$vr21, $vr21
