...
# %bb.0:
	...
	pcalau12i	$s4, %pc_hi20(Q__align.mseq1)
...
# %bb.1:
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $fp, 0
	st.d	$a0, $s4, %pc_lo12(Q__align.mseq1)
	move	$a0, $a1
	move	$a1, $zero
	pcaddu18i	$ra, %call36(AllocateCharMtx)
	jirl	$ra, $ra, 0
...
.LBB3_2:
	...
	pcalau12i	$s3, %pc_hi20(Q__align.mp)
...
# %bb.6:
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s3, %pc_lo12(Q__align.mp)
...
.LBB3_7:
	...
	jirl	$ra, $ra, 0
	st.d	$a0, $s3, %pc_lo12(Q__align.mp)
	pcalau12i	$a0, %got_pc_hi20(njob)
...
# %bb.9:                                # %.lr.ph
	ld.d	$a0, $s0, %pc_lo12(Q__align.mseq)
	ld.d	$a1, $s4, %pc_lo12(Q__align.mseq1)
	move	$a2, $s2
...
.LBB3_166:                              # %vector.body973
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_166
# %bb.167:                              # %middle.block978
	beq	$a4, $a5, .LBB3_170
.LBB3_168:                              # %scalar.ph968.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_169:                              # %scalar.ph968
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_176:                              # %.lr.ph19.i
	...
	move	$s8, $t4
	bgez	$t7, .LBB3_176
# %bb.177:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_172 Depth=1
	bne	$t1, $fp, .LBB3_181
.LBB3_178:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_172 Depth=1
	bne	$a7, $ra, .LBB3_184
	b	.LBB3_186
	.p2align	4, , 16
...
.LBB3_182:                              # %.lr.ph29.i
	...
	addi.d	$t5, $t5, -1
	bgez	$t8, .LBB3_182
# %bb.183:                              # %._crit_edge30.loopexit.i
                                        #   in Loop: Header=BB3_172 Depth=1
	add.d	$a2, $a2, $t6
	ld.d	$t8, $sp, 424                   # 8-byte Folded Reload
	beq	$a7, $ra, .LBB3_186
.LBB3_184:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_172 Depth=1
	addi.w	$t6, $a0, 0
	beq	$t0, $t6, .LBB3_186
# %bb.185:                              #   in Loop: Header=BB3_172 Depth=1
	ld.d	$t6, $s0, %pc_lo12(impmtx)
	ldx.d	$t2, $t6, $t2
	fldx.s	$fa0, $t2, $t3
	fld.s	$fa1, $a1, 0
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a1, 0
.LBB3_186:                              #   in Loop: Header=BB3_172 Depth=1
	blez	$a7, .LBB3_191
# %bb.187:                              #   in Loop: Header=BB3_172 Depth=1
	blez	$t0, .LBB3_191
# %bb.188:                              #   in Loop: Header=BB3_172 Depth=1
	add.d	$a5, $t1, $a5
	addi.d	$s8, $t4, -1
	st.b	$a3, $t4, -1
	addi.d	$s4, $t5, -1
	...
	b	.LBB3_190
	.p2align	4, , 16
.LBB3_189:                              #   in Loop: Header=BB3_172 Depth=1
	addi.d	$a6, $s6, -1
	move	$t1, $fp
	nor	$t4, $a6, $zero
	add.w	$t4, $s6, $t4
...
.LBB3_193:                              # %.lr.ph50.i
	...
	addi.d	$s5, $s5, 8
	bnez	$s0, .LBB3_193
.LBB3_194:                              # %.preheader.i
	blez	$s7, .LBB3_197
# %bb.195:                              # %.lr.ph52.preheader.i
	move	$fp, $s1
	move	$s0, $s7
	.p2align	4, , 16
.LBB3_196:                              # %.lr.ph52.i
	...
	addi.d	$s3, $s3, 8
	bnez	$s0, .LBB3_196
.LBB3_197:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 416                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
...
.LBB6_156:                              # %vector.body902
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_156
# %bb.157:                              # %middle.block907
	beq	$a3, $a4, .LBB6_160
.LBB6_158:                              # %scalar.ph897.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_159:                              # %scalar.ph897
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
