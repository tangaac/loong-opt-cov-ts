...
.LBB3_2:
	...
	pcalau12i	$a6, %pc_hi20(Q__align.mseq)
...
.LBB3_7:
	...
	st.w	$s6, $s4, %pc_lo12(Q__align.orlgth1)
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
...
.LBB3_8:
	...
	blez	$s5, .LBB3_11
# %bb.9:                                # %.lr.ph
	ld.d	$a0, $a6, %pc_lo12(Q__align.mseq)
...
.LBB3_11:                               # %.preheader561
	blez	$s7, .LBB3_14
# %bb.12:                               # %.lr.ph568
	ld.d	$a1, $a6, %pc_lo12(Q__align.mseq)
...
.LBB3_24:
	...
	addi.w	$s8, $zero, -1
	vld	$vr18, $sp, 352                 # 16-byte Folded Reload
	fcvt.d.s	$fa0, $ft10
	move	$ra, $s1
	blt	$s1, $s8, .LBB3_29
# %bb.25:                               # %.lr.ph571
...
# %bb.226:                              # %middle.block1183
	bne	$a5, $t0, .LBB3_129
	b	.LBB3_131
.LBB3_227:                              # %vector.ph1271
	bstrpick.d	$a3, $a3, 31, 1
	slli.d	$a3, $a3, 1
	addi.d	$a5, $t8, 8
	move	$a6, $a3
	.p2align	4, , 16
.LBB3_228:                              # %vector.body1274
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a5, -8
	ld.d	$t0, $a5, 0
	addi.d	$t1, $a4, -1
...
.LBB3_236:                              # %vector.body1285
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_236
# %bb.237:                              # %middle.block1290
	beq	$a4, $a5, .LBB3_240
.LBB3_238:                              # %scalar.ph1280.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_239:                              # %scalar.ph1280
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB3_246:                              # %.lr.ph19.i
	...
	move	$s3, $t4
	bgez	$t7, .LBB3_246
# %bb.247:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_242 Depth=1
	bne	$t1, $fp, .LBB3_251
.LBB3_248:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_242 Depth=1
	bne	$a7, $ra, .LBB3_254
	b	.LBB3_256
	.p2align	4, , 16
...
.LBB3_252:                              # %.lr.ph29.i
	...
	addi.d	$t5, $t5, -1
	bgez	$t8, .LBB3_252
# %bb.253:                              # %._crit_edge30.loopexit.i
                                        #   in Loop: Header=BB3_242 Depth=1
	add.d	$a2, $a2, $t6
	ld.d	$t8, $sp, 432                   # 8-byte Folded Reload
	beq	$a7, $ra, .LBB3_256
.LBB3_254:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB3_242 Depth=1
	addi.w	$t6, $a0, 0
	beq	$t0, $t6, .LBB3_256
# %bb.255:                              #   in Loop: Header=BB3_242 Depth=1
...
.LBB3_256:                              #   in Loop: Header=BB3_242 Depth=1
	blez	$a7, .LBB3_261
# %bb.257:                              #   in Loop: Header=BB3_242 Depth=1
	blez	$t0, .LBB3_261
# %bb.258:                              #   in Loop: Header=BB3_242 Depth=1
	add.d	$a5, $t1, $a5
	addi.d	$s3, $t4, -1
	st.b	$a3, $t4, -1
	addi.d	$s5, $t5, -1
	...
	b	.LBB3_260
	.p2align	4, , 16
.LBB3_259:                              #   in Loop: Header=BB3_242 Depth=1
	addi.d	$a6, $s7, -1
	move	$t1, $fp
	nor	$t4, $a6, $zero
	add.w	$t4, $s7, $t4
...
.LBB3_263:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB3_263
.LBB3_264:                              # %.preheader.i
	ld.d	$s7, $sp, 72                    # 8-byte Folded Reload
	blez	$s7, .LBB3_267
# %bb.265:                              # %.lr.ph52.preheader.i
	move	$fp, $s2
	move	$s0, $s7
	.p2align	4, , 16
.LBB3_266:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB3_266
.LBB3_267:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 424                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s8
...
.LBB6_2:
	...
	pcalau12i	$a0, %pc_hi20(Q__align_gapmap.mseq)
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
...
# %bb.7:
	...
	pcaddu18i	$ra, %call36(FreeFloatVec)
	jirl	$ra, $ra, 0
	ld.d	$a0, $s8, %pc_lo12(Q__align_gapmap.cpmx1)
	pcaddu18i	$ra, %call36(FreeFloatMtx)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
...
.LBB6_8:
	...
	pcaddu18i	$ra, %call36(AllocateFloatMtx)
	jirl	$ra, $ra, 0
	st.d	$a0, $s8, %pc_lo12(Q__align_gapmap.cpmx1)
	ori	$a0, $zero, 26
	move	$a1, $s4
...
.LBB6_20:
	...
	ld.d	$s2, $sp, 416                   # 8-byte Folded Reload
.LBB6_21:
	ld.d	$a1, $s8, %pc_lo12(Q__align_gapmap.cpmx1)
	ffint.s.w	$fa0, $fs0
	vst	$vr0, $sp, 304                  # 16-byte Folded Spill
	pcalau12i	$fp, %pc_hi20(Q__align_gapmap.ijp)
	st.d	$a0, $fp, %pc_lo12(Q__align_gapmap.ijp)
	move	$a0, $s2
	move	$a2, $s4
...
# %bb.120:
	...
	ld.d	$a4, $a3, %pc_lo12(Q__align_gapmap.initverticalw)
	movgr2fr.w	$fa7, $zero
	fmadd.s	$fa0, $fa0, $fa1, $fa7
	fld.s	$fa1, $a2, 0
	fld.s	$fa7, $a4, 0
...
# %bb.156:                              # %.lr.ph626
	...
	ld.d	$a3, $sp, 272                   # 8-byte Folded Reload
	ld.d	$t7, $a3, %pc_lo12(Q__align_gapmap.initverticalw)
...
# %bb.216:                              # %middle.block1140
	bne	$a7, $t2, .LBB6_126
	b	.LBB6_128
.LBB6_217:                              # %vector.ph1200
	bstrpick.d	$a4, $a4, 31, 1
	slli.d	$a4, $a4, 1
	addi.d	$a6, $s3, 8
	move	$a7, $a4
	.p2align	4, , 16
.LBB6_218:                              # %vector.body1203
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t0, $a6, -8
	ld.d	$t1, $a6, 0
	addi.d	$t2, $a5, -1
...
.LBB6_226:                              # %vector.body1214
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB6_226
# %bb.227:                              # %middle.block1219
	beq	$a3, $a4, .LBB6_230
.LBB6_228:                              # %scalar.ph1209.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB6_229:                              # %scalar.ph1209
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.241:                              #   in Loop: Header=BB6_239 Depth=1
	...
	add.w	$t7, $s7, $t7
	beqz	$t7, .LBB6_249
.LBB6_242:                              # %.preheader3.preheader.i
                                        #   in Loop: Header=BB6_239 Depth=1
	ld.d	$s7, $sp, 152                   # 8-byte Folded Reload
	b	.LBB6_244
	.p2align	4, , 16
.LBB6_243:                              # %._crit_edge29.i
                                        #   in Loop: Header=BB6_244 Depth=2
	addi.d	$t7, $t7, -1
	addi.d	$a4, $a4, 1
	ld.d	$s2, $sp, 416                   # 8-byte Folded Reload
	beqz	$t7, .LBB6_250
.LBB6_244:                              # %.preheader3.i
...
.LBB6_247:                              # %.lr.ph28.i
	...
	b	.LBB6_243
	.p2align	4, , 16
.LBB6_248:                              #   in Loop: Header=BB6_239 Depth=1
	addi.w	$t2, $s7, -1
	nor	$t7, $t2, $zero
	add.w	$t7, $s7, $t7
	bnez	$t7, .LBB6_242
.LBB6_249:                              #   in Loop: Header=BB6_239 Depth=1
	ld.d	$s7, $sp, 152                   # 8-byte Folded Reload
...
.LBB6_256:                              # %.lr.ph37.i
	...
	b	.LBB6_252
	.p2align	4, , 16
.LBB6_257:                              # %._crit_edge41.loopexit.i
                                        #   in Loop: Header=BB6_239 Depth=1
	add.d	$a4, $a4, $t6
	ld.d	$s2, $sp, 416                   # 8-byte Folded Reload
...
.LBB6_268:                              #   Parent Loop BB6_239 Depth=1
	...
	b	.LBB6_238
	.p2align	4, , 16
.LBB6_269:                              #   in Loop: Header=BB6_239 Depth=1
	addi.w	$t2, $s7, -1
	ld.d	$t6, $sp, 296                   # 8-byte Folded Reload
	nor	$t7, $t2, $zero
	add.w	$t7, $s7, $t7
...
.LBB6_271:                              # %Atracking_localhom_gapmap.exit
	ld.d	$fp, $sp, 96                    # 8-byte Folded Reload
.LBB6_272:                              # %Atracking_localhom_gapmap.exit
	ld.d	$a0, $s4, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
	...
	blt	$a2, $a3, .LBB6_282
# %bb.273:                              # %Atracking_localhom_gapmap.exit
	ori	$a0, $a4, 2881
	bge	$a3, $a0, .LBB6_282
# %bb.274:
