...
.LBB2_126:                              # %.loopexit
	...
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$s2, $a0, %pc_lo12(R__align.ijp)
...
.LBB2_185:                              # %.lr.ph19.i538.preheader
	...
	bltu	$t4, $a4, .LBB2_190
# %bb.186:                              # %.lr.ph19.i538.preheader
                                        #   in Loop: Header=BB2_178 Depth=1
	sub.d	$t2, $s8, $s4
	bltu	$t2, $a4, .LBB2_190
# %bb.187:                              # %vector.ph1048
                                        #   in Loop: Header=BB2_178 Depth=1
...
# %bb.189:                              # %middle.block1061
	...
	b	.LBB2_193
	.p2align	4, , 16
.LBB2_190:                              #   in Loop: Header=BB2_178 Depth=1
	move	$t2, $s4
	move	$t3, $s8
.LBB2_191:                              # %.lr.ph19.i538.preheader1073
                                        #   in Loop: Header=BB2_178 Depth=1
	add.d	$a5, $a5, $t4
	.p2align	4, , 16
.LBB2_192:                              # %.lr.ph19.i538
                                        #   Parent Loop BB2_178 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a1, $t3, -1
	addi.d	$t3, $t3, -1
	...
	addi.d	$t2, $t2, -1
	bnez	$t4, .LBB2_192
.LBB2_193:                              # %._crit_edge20.i539
                                        #   in Loop: Header=BB2_178 Depth=1
	beq	$t1, $a0, .LBB2_203
# %bb.194:                              # %.lr.ph29.preheader.i541
                                        #   in Loop: Header=BB2_178 Depth=1
	addi.w	$t5, $zero, -17
	nor	$t4, $t1, $zero
	bltu	$t5, $t1, .LBB2_199
# %bb.195:                              # %.lr.ph29.preheader.i541
                                        #   in Loop: Header=BB2_178 Depth=1
	sub.d	$t5, $t3, $t2
	bltu	$t5, $a3, .LBB2_199
# %bb.196:                              # %vector.ph1026
                                        #   in Loop: Header=BB2_178 Depth=1
...
.LBB2_199:                              #   in Loop: Header=BB2_178 Depth=1
	...
	move	$t6, $t2
	move	$t7, $t3
.LBB2_200:                              # %.lr.ph29.i542.preheader
                                        #   in Loop: Header=BB2_178 Depth=1
	move	$t2, $t6
	move	$t3, $t7
	.p2align	4, , 16
.LBB2_201:                              # %.lr.ph29.i542
                                        #   Parent Loop BB2_178 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$t7, $t3, -1
	st.b	$a2, $t3, -1
	...
	move	$t3, $t7
	bnez	$t5, .LBB2_201
.LBB2_202:                              # %._crit_edge30.loopexit.i543
                                        #   in Loop: Header=BB2_178 Depth=1
	add.d	$a5, $a5, $t4
	move	$t3, $t7
	move	$t2, $t6
...
.LBB2_223:                              #   in Loop: Header=BB2_220 Depth=1
	...
	add.w	$fp, $s7, $t7
	bnez	$fp, .LBB2_227
.LBB2_224:                              #   in Loop: Header=BB2_220 Depth=1
	move	$t8, $s8
	move	$t7, $s4
	b	.LBB2_235
	.p2align	4, , 16
.LBB2_225:                              #   in Loop: Header=BB2_220 Depth=1
	addi.d	$t1, $s7, -1
.LBB2_226:                              #   in Loop: Header=BB2_220 Depth=1
	move	$t4, $a1
	nor	$t7, $t1, $zero
	add.w	$fp, $s7, $t7
	beqz	$fp, .LBB2_224
.LBB2_227:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_220 Depth=1
	bltu	$fp, $a6, .LBB2_232
# %bb.228:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB2_220 Depth=1
	sub.d	$t7, $s8, $s4
	bltu	$t7, $a6, .LBB2_232
# %bb.229:                              # %vector.ph973
...
# %bb.231:                              # %middle.block985
	...
	b	.LBB2_235
	.p2align	4, , 16
.LBB2_232:                              #   in Loop: Header=BB2_220 Depth=1
	move	$t7, $s4
	move	$t8, $s8
.LBB2_233:                              # %.lr.ph19.i.preheader1083
                                        #   in Loop: Header=BB2_220 Depth=1
	add.d	$t0, $t0, $fp
	.p2align	4, , 16
.LBB2_234:                              # %.lr.ph19.i
	...
	addi.d	$t7, $t7, -1
	bnez	$fp, .LBB2_234
.LBB2_235:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_220 Depth=1
	beq	$t4, $a1, .LBB2_245
# %bb.236:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_220 Depth=1
	addi.w	$s0, $zero, -17
	nor	$fp, $t4, $zero
	bltu	$s0, $t4, .LBB2_241
# %bb.237:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_220 Depth=1
	sub.d	$s0, $t8, $t7
	ori	$s1, $zero, 16
	bltu	$s0, $s1, .LBB2_241
...
.LBB2_243:                              # %.lr.ph29.i
	...
	move	$t8, $s2
	bnez	$s0, .LBB2_243
.LBB2_244:                              # %._crit_edge30.loopexit.i
                                        #   in Loop: Header=BB2_220 Depth=1
	add.d	$t0, $t0, $fp
	move	$t8, $s2
	move	$t7, $s1
	move	$s2, $a0
.LBB2_245:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_220 Depth=1
	move	$s0, $a5
	beq	$t2, $ra, .LBB2_248
# %bb.246:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_220 Depth=1
	addi.w	$fp, $s6, 0
	beq	$t3, $fp, .LBB2_248
