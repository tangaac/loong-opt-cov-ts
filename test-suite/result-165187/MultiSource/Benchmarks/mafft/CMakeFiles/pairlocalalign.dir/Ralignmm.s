...
.LBB2_25:
	...
	ld.d	$a0, $a0, %pc_lo12(R__align.initverticalw)
	ld.d	$a1, $sp, 384                   # 8-byte Folded Reload
	ld.d	$s0, $a1, %pc_lo12(R__align.cpmx2)
	ld.d	$a1, $sp, 392                   # 8-byte Folded Reload
...
.LBB2_126:                              # %.loopexit
	...
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s0, $a0, %pc_lo12(R__align.ijp)
...
# %bb.154:
	move	$a3, $zero
	b	.LBB2_166
.LBB2_155:                              # %vector.ph942
	bstrpick.d	$a3, $a3, 31, 1
	slli.d	$a3, $a3, 1
	addi.d	$a5, $s0, 8
	move	$a6, $a3
	.p2align	4, , 16
.LBB2_156:                              # %vector.body945
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a5, -8
	ld.d	$t0, $a5, 0
	addi.d	$t1, $a4, -1
...
.LBB2_172:                              # %vector.body956
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_172
# %bb.173:                              # %middle.block962
	beq	$a3, $a4, .LBB2_176
.LBB2_174:                              # %scalar.ph951.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_175:                              # %scalar.ph951
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB2_202:                              # %vector.body932
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_202
# %bb.203:                              # %middle.block937
	beq	$a4, $a5, .LBB2_206
.LBB2_204:                              # %scalar.ph927.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_205:                              # %scalar.ph927
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
