...
.LBB2_2:
	...
	pcalau12i	$s5, %pc_hi20(R__align.cpmx2)
...
.LBB2_8:
	...
	st.d	$a0, $s5, %pc_lo12(R__align.cpmx2)
	slt	$a0, $s8, $s3
	masknez	$a1, $s8, $a0
	maskeqz	$a0, $s3, $a0
	or	$a0, $a0, $a1
...
.LBB2_22:
	...
	jirl	$ra, $ra, 0
	ld.d	$a1, $s5, %pc_lo12(R__align.cpmx2)
	move	$a0, $s7
	move	$s5, $s4
...
.LBB2_25:
	...
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	ld.d	$s7, $a1, %pc_lo12(R__align.floatwork)
	ld.d	$a1, $sp, 352                   # 8-byte Folded Reload
...
# %bb.154:
	move	$a3, $zero
	b	.LBB2_166
.LBB2_155:                              # %vector.ph948
	bstrpick.d	$a3, $a3, 31, 1
	slli.d	$a3, $a3, 1
	addi.d	$a5, $t6, 8
	move	$a6, $a3
	.p2align	4, , 16
.LBB2_156:                              # %vector.body951
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a5, -8
	ld.d	$t0, $a5, 0
	addi.d	$t1, $a4, -1
...
# %bb.162:
	move	$a4, $zero
	b	.LBB2_174
.LBB2_163:                              # %vector.ph924
	bstrpick.d	$a3, $a3, 31, 1
	slli.d	$a3, $a3, 1
	addi.d	$a5, $ra, 8
	move	$a6, $a3
	.p2align	4, , 16
.LBB2_164:                              # %vector.body927
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a5, -8
	ld.d	$t0, $a5, 0
	addi.d	$t1, $a4, -1
...
.LBB2_172:                              # %vector.body962
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB2_172
# %bb.173:                              # %middle.block968
	beq	$a3, $a4, .LBB2_176
.LBB2_174:                              # %scalar.ph957.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB2_175:                              # %scalar.ph957
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB2_181:                              #   in Loop: Header=BB2_178 Depth=1
	...
	add.w	$t0, $s7, $t0
	bnez	$t0, .LBB2_185
.LBB2_182:                              #   in Loop: Header=BB2_178 Depth=1
	move	$t0, $s8
	move	$t1, $s5
	b	.LBB2_187
	.p2align	4, , 16
.LBB2_183:                              #   in Loop: Header=BB2_178 Depth=1
	addi.d	$a4, $s7, -1
.LBB2_184:                              #   in Loop: Header=BB2_178 Depth=1
	move	$a7, $a1
	nor	$t0, $a4, $zero
	add.w	$t0, $s7, $t0
	beqz	$t0, .LBB2_182
.LBB2_185:                              # %.lr.ph19.i538.preheader
                                        #   in Loop: Header=BB2_178 Depth=1
	sub.d	$t0, $a4, $s7
	addi.w	$t2, $t0, 1
	.p2align	4, , 16
.LBB2_186:                              # %.lr.ph19.i538
	...
	move	$s8, $t0
	bgez	$t3, .LBB2_186
.LBB2_187:                              # %._crit_edge20.i539
                                        #   in Loop: Header=BB2_178 Depth=1
	beq	$a7, $a1, .LBB2_191
# %bb.188:                              # %.lr.ph29.preheader.i541
                                        #   in Loop: Header=BB2_178 Depth=1
	nor	$t2, $a7, $zero
	addi.w	$t3, $a7, 1
	.p2align	4, , 16
.LBB2_189:                              # %.lr.ph29.i542
                                        #   Parent Loop BB2_178 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a3, $t0, -1
	addi.d	$t0, $t0, -1
	...
	addi.d	$t1, $t1, -1
	bgez	$t4, .LBB2_189
# %bb.190:                              # %._crit_edge30.loopexit.i543
                                        #   in Loop: Header=BB2_178 Depth=1
	add.d	$t5, $t5, $t2
.LBB2_191:                              # %._crit_edge30.i544
                                        #   in Loop: Header=BB2_178 Depth=1
	blez	$a5, .LBB2_195
# %bb.192:                              # %._crit_edge30.i544
                                        #   in Loop: Header=BB2_178 Depth=1
	blez	$a6, .LBB2_195
# %bb.193:                              #   in Loop: Header=BB2_178 Depth=1
	add.d	$s6, $a7, $s6
	addi.d	$s8, $t0, -1
	st.b	$a2, $t0, -1
	addi.d	$s5, $t1, -1
...
.LBB2_195:
	...
	ld.d	$s6, $sp, 104                   # 8-byte Folded Reload
	blez	$s6, .LBB2_198
.LBB2_196:                              # %.lr.ph50.preheader.i556
	ld.d	$fp, $sp, 112                   # 8-byte Folded Reload
	move	$s0, $s6
	.p2align	4, , 16
.LBB2_197:                              # %.lr.ph50.i558
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s3, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s8
	...
	addi.d	$s3, $s3, 8
	bnez	$s0, .LBB2_197
.LBB2_198:                              # %.preheader.i549
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	blez	$s1, .LBB2_234
# %bb.199:                              # %.lr.ph52.preheader.i550
	move	$fp, $s2
	move	$s0, $s1
	.p2align	4, , 16
.LBB2_200:                              # %.lr.ph52.i552
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s4, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s5
...
.LBB2_202:                              # %vector.body938
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB2_202
# %bb.203:                              # %middle.block943
	beq	$a4, $a5, .LBB2_206
.LBB2_204:                              # %scalar.ph933.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB2_205:                              # %scalar.ph933
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.209:                              #   in Loop: Header=BB2_208 Depth=1
	beqz	$t2, .LBB2_213
# %bb.210:                              #   in Loop: Header=BB2_208 Depth=1
	sub.d	$a7, $s7, $t2
	b	.LBB2_214
	.p2align	4, , 16
.LBB2_211:                              #   in Loop: Header=BB2_208 Depth=1
	addi.d	$a7, $s7, -1
	nor	$t5, $a7, $zero
	add.w	$t5, $s7, $t5
	bnez	$t5, .LBB2_215
.LBB2_212:                              #   in Loop: Header=BB2_208 Depth=1
	move	$t5, $s8
	move	$t6, $s5
	b	.LBB2_217
	.p2align	4, , 16
.LBB2_213:                              #   in Loop: Header=BB2_208 Depth=1
	addi.d	$a7, $s7, -1
.LBB2_214:                              #   in Loop: Header=BB2_208 Depth=1
	move	$t2, $a3
	nor	$t5, $a7, $zero
	add.w	$t5, $s7, $t5
	beqz	$t5, .LBB2_212
.LBB2_215:                              # %.lr.ph19.i.preheader
...
.LBB2_216:                              # %.lr.ph19.i
	...
	move	$s8, $t5
	bgez	$t8, .LBB2_216
.LBB2_217:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB2_208 Depth=1
	beq	$t2, $a3, .LBB2_221
# %bb.218:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB2_208 Depth=1
	nor	$t7, $t2, $zero
	addi.w	$t8, $t2, 1
	.p2align	4, , 16
.LBB2_219:                              # %.lr.ph29.i
	...
	addi.d	$t6, $t6, -1
	bgez	$fp, .LBB2_219
# %bb.220:                              # %._crit_edge30.loopexit.i
                                        #   in Loop: Header=BB2_208 Depth=1
	add.d	$a1, $a1, $t7
	move	$fp, $s0
.LBB2_221:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_208 Depth=1
	beq	$t0, $s2, .LBB2_224
# %bb.222:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB2_208 Depth=1
	addi.w	$t7, $s6, 0
	beq	$t1, $t7, .LBB2_224
# %bb.223:                              #   in Loop: Header=BB2_208 Depth=1
	ld.d	$t7, $s1, %pc_lo12(impmtx)
	ldx.d	$t3, $t7, $t3
	fldx.s	$fa0, $t3, $t4
	fld.s	$fa1, $a2, 0
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a2, 0
.LBB2_224:                              #   in Loop: Header=BB2_208 Depth=1
	blez	$t0, .LBB2_228
# %bb.225:                              #   in Loop: Header=BB2_208 Depth=1
	blez	$t1, .LBB2_228
# %bb.226:                              #   in Loop: Header=BB2_208 Depth=1
	add.d	$a6, $t2, $a6
	addi.d	$s8, $t5, -1
	st.b	$a4, $t5, -1
	addi.d	$s5, $t6, -1
...
.LBB2_230:                              # %.lr.ph50.i
	...
	addi.d	$s3, $s3, 8
	bnez	$s0, .LBB2_230
.LBB2_231:                              # %.preheader.i
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	blez	$s1, .LBB2_234
# %bb.232:                              # %.lr.ph52.preheader.i
	move	$fp, $s2
	move	$s0, $s1
	.p2align	4, , 16
.LBB2_233:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB2_233
.LBB2_234:                              # %Atracking_localhom.exit
	move	$a0, $s7
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 424                   # 8-byte Folded Reload
	...
	blt	$a2, $a3, .LBB2_236
# %bb.235:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	blt	$a3, $a0, .LBB2_237
.LBB2_236:
