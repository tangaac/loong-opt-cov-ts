...
.LBB0_77:                               # %vector.body352
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_77
# %bb.78:                               # %middle.block355
	beq	$a2, $a3, .LBB0_81
.LBB0_79:                               # %scalar.ph347.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_80:                               # %scalar.ph347
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB0_94:                               #   in Loop: Header=BB0_90 Depth=1
	...
	bnez	$t3, .LBB0_98
	.p2align	4, , 16
.LBB0_95:                               # %._crit_edge32.i
                                        #   in Loop: Header=BB0_90 Depth=1
	add.w	$a0, $t2, $a0
	beq	$t2, $a5, .LBB0_108
# %bb.96:                               # %.preheader1.preheader.i
                                        #   in Loop: Header=BB0_90 Depth=1
	nor	$t2, $t2, $zero
	move	$t3, $t2
	b	.LBB0_103
	.p2align	4, , 16
.LBB0_97:                               # %._crit_edge.i
...
.LBB0_101:                              # %.lr.ph29.i
	...
	b	.LBB0_97
	.p2align	4, , 16
.LBB0_102:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB0_103 Depth=2
	addi.d	$t3, $t3, -1
	beqz	$t3, .LBB0_107
.LBB0_103:                              # %.preheader1.i
                                        #   Parent Loop BB0_90 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB0_104 Depth 3
                                        #       Child Loop BB0_106 Depth 3
...
.LBB0_106:                              # %.lr.ph37.i
	...
	b	.LBB0_102
	.p2align	4, , 16
.LBB0_107:                              # %._crit_edge41.loopexit.i
                                        #   in Loop: Header=BB0_90 Depth=1
	add.d	$a2, $a2, $t2
.LBB0_108:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB0_90 Depth=1
	blez	$t1, .LBB0_116
# %bb.109:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB0_90 Depth=1
	blez	$t0, .LBB0_116
# %bb.110:                              # %.preheader5.i
                                        #   in Loop: Header=BB0_90 Depth=1
...
# %bb.111:                              # %.lr.ph44.i
	...
	move	$t2, $a3
	.p2align	4, , 16
.LBB0_112:                              #   Parent Loop BB0_90 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t0, 0
	ld.d	$t4, $t1, 0
	ldx.b	$t3, $t3, $a7
...
# %bb.114:                              # %.lr.ph46.i
	...
	move	$t2, $a4
	.p2align	4, , 16
.LBB0_115:                              #   Parent Loop BB0_90 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t0, 0
	ld.d	$t4, $t1, 0
	ldx.b	$t3, $t3, $a0
