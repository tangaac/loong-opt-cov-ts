...
.LBB3_172:                              #   in Loop: Header=BB3_164 Depth=1
	...
	add.w	$fp, $s7, $t7
	bnez	$fp, .LBB3_167
.LBB3_173:                              #   in Loop: Header=BB3_164 Depth=1
	move	$t8, $s3
	move	$t7, $s5
	b	.LBB3_177
	.p2align	4, , 16
.LBB3_174:                              #   in Loop: Header=BB3_164 Depth=1
	move	$t7, $s5
	move	$t8, $s3
.LBB3_175:                              # %.lr.ph19.i.preheader838
                                        #   in Loop: Header=BB3_164 Depth=1
	add.d	$t0, $t0, $fp
	.p2align	4, , 16
.LBB3_176:                              # %.lr.ph19.i
	...
	addi.d	$t7, $t7, -1
	bnez	$fp, .LBB3_176
.LBB3_177:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB3_164 Depth=1
	beq	$t4, $a2, .LBB3_187
# %bb.178:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_164 Depth=1
	addi.w	$s0, $zero, -17
	nor	$fp, $t4, $zero
	bltu	$s0, $t4, .LBB3_183
# %bb.179:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB3_164 Depth=1
	sub.d	$s0, $t8, $t7
	bltu	$s0, $a5, .LBB3_183
# %bb.180:                              # %vector.ph797
                                        #   in Loop: Header=BB3_164 Depth=1
	bstrpick.d	$s0, $fp, 30, 4
	slli.d	$s3, $s0, 4
	sub.d	$s0, $fp, $s3
	sub.d	$s1, $t7, $s3
	sub.d	$s2, $t8, $s3
...
.LBB3_185:                              # %.lr.ph29.i
	...
	move	$t8, $s2
	bnez	$s0, .LBB3_185
.LBB3_186:                              # %._crit_edge30.loopexit.i
                                        #   in Loop: Header=BB3_164 Depth=1
	add.d	$t0, $t0, $fp
	move	$t8, $s2
	move	$t7, $s1
...
.LBB6_29:                               # %._crit_edge341
	...
	ld.d	$s3, $s4, %pc_lo12(A__align_gapmap.cpmx1)
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
...
.LBB6_32:                               # =>This Inner Loop Header: Depth=1
	...
	move	$a2, $a4
	bnez	$a1, .LBB6_32
.LBB6_33:                               # %imp_match_out_vead_tate_gapmap.exit
	ori	$a7, $zero, 1
	ori	$s0, $zero, 1
	move	$a0, $s5
	ld.d	$a1, $sp, 256                   # 8-byte Folded Reload
...
.LBB6_36:                               # %.critedge
	...
	ld.d	$t3, $sp, 64                    # 8-byte Folded Reload
	move	$s2, $s1
.LBB6_37:                               # %imp_match_out_vead_gapmap.exit
	pcalau12i	$a0, %got_pc_hi20(outgap)
	ld.d	$a0, $a0, %got_pc_lo12(outgap)
	ld.w	$a0, $a0, 0
	ori	$a1, $zero, 1
...
.LBB6_44:                               # %scalar.ph
	...
	bnez	$a1, .LBB6_44
	b	.LBB6_54
.LBB6_45:                               # %imp_match_out_vead_gapmap.exit.thread
	pcalau12i	$a0, %got_pc_hi20(outgap)
	ld.d	$a0, $a0, %got_pc_lo12(outgap)
	ld.w	$a0, $a0, 0
	bne	$a0, $s0, .LBB6_54
.LBB6_46:                               # %.preheader323
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	blez	$a0, .LBB6_50
# %bb.47:                               # %.lr.ph350
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB6_184
.LBB6_48:                               # %scalar.ph541.preheader
	alsl.d	$a2, $a3, $a2, 2
	addi.d	$a2, $a2, -4
...
# %bb.51:                               # %.lr.ph353
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB6_189
.LBB6_52:                               # %scalar.ph571.preheader
	alsl.d	$a2, $a3, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB6_53:                               # %scalar.ph571
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a4, 0
...
.LBB6_57:                               # %vector.body525
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_57
# %bb.58:                               # %middle.block532
	beq	$a2, $a4, .LBB6_61
.LBB6_59:                               # %scalar.ph518.preheader
	mul.d	$a2, $a0, $a3
	ld.d	$a4, $sp, 280                   # 8-byte Folded Reload
	alsl.d	$a4, $a3, $a4, 2
	sub.d	$a1, $a1, $a3
...
.LBB6_62:                               # %.lr.ph357
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a7, .LBB6_108
.LBB6_63:                               # %scalar.ph601.preheader
	alsl.d	$a5, $a4, $s5, 2
	addi.d	$a5, $a5, -4
	alsl.d	$a1, $a4, $a1, 2
	alsl.d	$a2, $a4, $a2, 2
...
.LBB6_74:                               # %.lr.ph.i312
	...
	move	$a3, $a5
	bnez	$a2, .LBB6_74
.LBB6_75:                               # %imp_match_out_vead_gapmap.exit317
                                        #   in Loop: Header=BB6_71 Depth=1
	ld.d	$a1, $sp, 280                   # 8-byte Folded Reload
	fldx.s	$fa0, $a1, $a0
	fst.s	$fa0, $s3, 0
...
# %bb.79:                               #   in Loop: Header=BB6_78 Depth=2
	...
	st.w	$t3, $a4, 0
	fmov.s	$fs0, $fa4
.LBB6_80:                               #   in Loop: Header=BB6_78 Depth=2
	fld.s	$fa5, $t0, 0
	fld.s	$fa4, $a6, 0
	fadd.s	$fa6, $fa0, $fa5
	fcmp.cule.s	$fcc0, $fa6, $fs0
	bcnez	$fcc0, .LBB6_82
# %bb.81:                               #   in Loop: Header=BB6_78 Depth=2
	ld.w	$t3, $a7, 0
	sub.d	$t3, $s4, $t3
	st.w	$t3, $a4, 0
	fmov.s	$fs0, $fa6
.LBB6_82:                               #   in Loop: Header=BB6_78 Depth=2
	fadd.s	$fa6, $fa1, $fa3
	fcmp.cult.s	$fcc0, $fa6, $fa5
	bcnez	$fcc0, .LBB6_77
...
.LBB6_84:
	...
	bnez	$a0, .LBB6_100
	b	.LBB6_86
.LBB6_85:                               # %._crit_edge383.loopexit
...
.LBB6_89:                               # %vector.body626
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_89
# %bb.90:                               # %middle.block633
	beq	$a2, $a4, .LBB6_93
.LBB6_91:                               # %scalar.ph617.preheader
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
...
.LBB6_96:                               # %vector.body641
	...
	addi.w	$a4, $a4, 2
	bnez	$a7, .LBB6_96
# %bb.97:                               # %middle.block646
	beq	$a3, $a5, .LBB6_100
.LBB6_98:                               # %scalar.ph636.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_99:                               # %scalar.ph636
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
.LBB6_111:                              # %vector.body606
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB6_111
# %bb.112:                              # %middle.block614
	bne	$a5, $a6, .LBB6_63
	b	.LBB6_65
.LBB6_113:                              # %.preheader2.i
	blez	$a2, .LBB6_118
# %bb.114:                              # %.lr.ph7.i
	slli.d	$a1, $s7, 32
	srai.d	$a1, $a1, 29
	...
	b	.LBB6_116
	.p2align	4, , 16
.LBB6_115:                              #   in Loop: Header=BB6_116 Depth=1
	addi.d	$a4, $a4, -1
	addi.d	$a5, $a5, 1
	addi.d	$s5, $s5, 4
	beqz	$a4, .LBB6_118
.LBB6_116:                              # =>This Inner Loop Header: Depth=1
	...
	fcmp.cult.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB6_115
# %bb.117:                              #   in Loop: Header=BB6_116 Depth=1
	ldx.d	$a6, $s2, $a1
	stx.w	$a5, $a6, $a3
	fmov.s	$fa0, $fa1
	b	.LBB6_115
...
.LBB6_122:                              # %vector.body654
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB6_122
# %bb.123:                              # %middle.block661
	beq	$a1, $a3, .LBB6_126
.LBB6_124:                              # %.lr.ph10.i.preheader
	alsl.d	$a4, $a3, $s2, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
...
.LBB6_130:                              # %vector.body669
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB6_130
# %bb.131:                              # %middle.block675
	beq	$a4, $a5, .LBB6_134
.LBB6_132:                              # %scalar.ph664.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_133:                              # %scalar.ph664
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB6_139:                              #   in Loop: Header=BB6_136 Depth=1
	...
	add.w	$t8, $s7, $t6
	bnez	$t8, .LBB6_143
.LBB6_140:                              #   in Loop: Header=BB6_136 Depth=1
	move	$t7, $s3
	move	$t6, $s5
	b	.LBB6_151
	.p2align	4, , 16
.LBB6_141:                              #   in Loop: Header=BB6_136 Depth=1
	addi.d	$t1, $s7, -1
.LBB6_142:                              #   in Loop: Header=BB6_136 Depth=1
	...
	add.w	$t8, $s7, $t6
	beqz	$t8, .LBB6_140
.LBB6_143:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB6_136 Depth=1
	bltu	$t8, $a6, .LBB6_148
# %bb.144:                              # %.lr.ph19.i.preheader
                                        #   in Loop: Header=BB6_136 Depth=1
	sub.d	$t6, $s3, $s5
	bltu	$t6, $a6, .LBB6_148
# %bb.145:                              # %vector.ph703
	...
	vori.b	$vr4, $vr2, 0
	.p2align	4, , 16
.LBB6_146:                              # %vector.body707
                                        #   Parent Loop BB6_136 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vstelm.w	$vr1, $t0, 0, 0
	vstelm.w	$vr1, $t0, -4, 0
	vstelm.w	$vr0, $s1, 0, 0
...
.LBB6_148:                              #   in Loop: Header=BB6_136 Depth=1
	move	$t6, $s5
	move	$t7, $s3
.LBB6_149:                              # %.lr.ph19.i.preheader722
                                        #   in Loop: Header=BB6_136 Depth=1
	add.d	$t0, $t0, $t8
	.p2align	4, , 16
.LBB6_150:                              # %.lr.ph19.i
	...
	addi.d	$t6, $t6, -1
	bnez	$t8, .LBB6_150
.LBB6_151:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB6_136 Depth=1
	beq	$t4, $a2, .LBB6_161
# %bb.152:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB6_136 Depth=1
	addi.w	$fp, $zero, -17
	nor	$t8, $t4, $zero
	bltu	$fp, $t4, .LBB6_157
# %bb.153:                              # %.lr.ph29.preheader.i
                                        #   in Loop: Header=BB6_136 Depth=1
	sub.d	$fp, $t7, $t6
	bltu	$fp, $a5, .LBB6_157
# %bb.154:                              # %vector.ph683
...
.LBB6_155:                              # %vector.body686
	...
	addi.d	$t6, $t6, -16
	bnez	$s3, .LBB6_155
# %bb.156:                              # %middle.block692
                                        #   in Loop: Header=BB6_136 Depth=1
	bne	$s2, $t8, .LBB6_158
	b	.LBB6_160
	.p2align	4, , 16
.LBB6_157:                              #   in Loop: Header=BB6_136 Depth=1
	move	$fp, $t8
	move	$s0, $t6
	move	$s1, $t7
.LBB6_158:                              # %.lr.ph29.i.preheader
                                        #   in Loop: Header=BB6_136 Depth=1
	move	$t6, $s0
	move	$t7, $s1
	.p2align	4, , 16
.LBB6_159:                              # %.lr.ph29.i
	...
	move	$t7, $s1
	bnez	$fp, .LBB6_159
.LBB6_160:                              # %._crit_edge30.loopexit.i
                                        #   in Loop: Header=BB6_136 Depth=1
	add.d	$t0, $t0, $t8
	move	$t7, $s1
	move	$t6, $s0
	move	$s2, $a0
.LBB6_161:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB6_136 Depth=1
	beq	$t2, $ra, .LBB6_164
# %bb.162:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB6_136 Depth=1
	ld.d	$t8, $sp, 272                   # 8-byte Folded Reload
	addi.w	$t8, $t8, 0
	beq	$t3, $t8, .LBB6_164
# %bb.163:                              #   in Loop: Header=BB6_136 Depth=1
	slli.d	$t8, $t2, 2
...
# %bb.165:                              #   in Loop: Header=BB6_136 Depth=1
	blez	$t3, .LBB6_168
# %bb.166:                              #   in Loop: Header=BB6_136 Depth=1
	add.d	$a7, $t4, $a7
	addi.d	$s3, $t7, -1
	st.b	$a3, $t7, -1
	addi.d	$s5, $t6, -1
...
.LBB6_170:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB6_170
.LBB6_171:                              # %.preheader.i
	ld.d	$s1, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 80                    # 8-byte Folded Reload
	blez	$s1, .LBB6_174
# %bb.172:                              # %.lr.ph52.preheader.i
	move	$fp, $s7
	move	$s0, $s1
	.p2align	4, , 16
.LBB6_173:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB6_173
.LBB6_174:                              # %Atracking_localhom_gapmap.exit
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
