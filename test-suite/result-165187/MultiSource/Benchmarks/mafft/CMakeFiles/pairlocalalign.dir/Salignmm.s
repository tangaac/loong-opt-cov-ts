...
.LBB3_73:                               # %.lr.ph376
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a7, $a0, %pc_lo12(A__align.ogcp1)
	addi.d	$a0, $a7, 4
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
...
# %bb.83:                               # %.lr.ph.preheader.i326
	...
	ori	$a2, $zero, 7
	bltu	$a0, $a2, .LBB3_86
# %bb.84:                               # %vector.memcheck702
                                        #   in Loop: Header=BB3_82 Depth=1
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	add.d	$a0, $a4, $a2
	bgeu	$s3, $a0, .LBB3_97
# %bb.85:                               # %vector.memcheck702
                                        #   in Loop: Header=BB3_82 Depth=1
	add.d	$a0, $s3, $a2
	bgeu	$a4, $a0, .LBB3_97
...
.LBB3_105:                              # %vector.body739
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_105
# %bb.106:                              # %middle.block746
	beq	$a2, $a4, .LBB3_109
.LBB3_107:                              # %scalar.ph730.preheader
	sub.w	$a2, $t1, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
...
# %bb.111:                              # %vector.ph751
	...
	pcalau12i	$a5, %pc_hi20(.LCPI3_1)
	vld	$vr3, $a5, %pc_lo12(.LCPI3_1)
	vreplvei.d	$vr4, $vr1, 0
	addi.d	$a5, $a1, 4
	vldi	$vr5, -800
	move	$a6, $a4
	.p2align	4, , 16
.LBB3_112:                              # %vector.body758
                                        # =>This Inner Loop Header: Depth=1
	vpickve2gr.w	$a7, $vr3, 1
	...
	vfmadd.d	$vr6, $vr4, $vr6, $vr8
	vfmadd.d	$vr7, $vr4, $vr7, $vr10
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_112
# %bb.113:                              # %middle.block765
	beq	$a3, $a4, .LBB3_116
.LBB3_114:                              # %scalar.ph749.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_115:                              # %scalar.ph749
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.136:
	move	$a3, $zero
	b	.LBB3_140
.LBB3_137:                              # %vector.ph770
	bstrpick.d	$a3, $a3, 31, 1
	slli.d	$a3, $a3, 1
	addi.d	$a5, $s0, 8
	move	$a6, $a3
	.p2align	4, , 16
.LBB3_138:                              # %vector.body773
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a5, -8
	ld.d	$t0, $a5, 0
	addi.d	$t1, $a4, -1
...
.LBB3_146:                              # %vector.body784
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB3_146
# %bb.147:                              # %middle.block789
	beq	$a4, $a5, .LBB3_150
.LBB3_148:                              # %scalar.ph779.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_149:                              # %scalar.ph779
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB6_22:
	...
	ld.d	$s5, $s3, %pc_lo12(A__align_gapmap.cpmx1)
	ld.d	$a1, $s7, 0
	...
	ld.d	$s5, $s4, %pc_lo12(A__align_gapmap.cpmx2)
	ld.d	$a0, $s1, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
	...
	ld.d	$a0, $fp, %pc_lo12(A__align_gapmap.fgcp2)
	move	$a1, $s2
	move	$a2, $s1
	move	$a3, $s0
	move	$a4, $s8
...
# %bb.30:                               # %.lr.ph340
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(A__align_gapmap.ogcp2)
	ld.d	$a2, $fp, %pc_lo12(A__align_gapmap.fgcp2)
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	bstrpick.d	$a1, $a1, 30, 0
	ori	$a3, $zero, 4
	bltu	$a1, $a3, .LBB6_33
# %bb.31:                               # %vector.memcheck520
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB6_181
...
.LBB6_33:
	move	$a3, $zero
.LBB6_34:                               # %scalar.ph526.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -912
...
.LBB6_36:                               # %._crit_edge341
	...
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(A__align_gapmap.initverticalw)
	ld.d	$fp, $s4, %pc_lo12(A__align_gapmap.cpmx2)
	ld.d	$s6, $s3, %pc_lo12(A__align_gapmap.cpmx1)
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
...
.LBB6_48:                               # %vector.body544
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_48
# %bb.49:                               # %middle.block548
	beq	$a2, $a4, .LBB6_61
.LBB6_50:                               # %scalar.ph539.preheader
	mul.d	$a2, $a0, $a3
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
	vldi	$vr0, -800
	.p2align	4, , 16
.LBB6_51:                               # %scalar.ph539
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a4, 0
	movgr2fr.w	$fa2, $a2
	ffint.d.w	$fa2, $fa2
...
# %bb.54:                               # %.lr.ph350
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB6_184
.LBB6_55:                               # %scalar.ph579.preheader
	alsl.d	$a2, $a3, $a2, 2
	addi.d	$a2, $a2, -4
...
# %bb.58:                               # %.lr.ph353
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(A__align_gapmap.ogcp2)
	ld.d	$a2, $t3, %pc_lo12(A__align_gapmap.fgcp2)
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	addi.d	$a1, $a1, 1
	bstrpick.d	$a1, $a1, 31, 0
	addi.d	$a4, $a1, -1
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB6_189
.LBB6_59:                               # %scalar.ph609.preheader
	alsl.d	$a2, $a3, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a4, $a3, $s5, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB6_60:                               # %scalar.ph609
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a4, 0
...
.LBB6_64:                               # %vector.body558
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_64
# %bb.65:                               # %middle.block565
	beq	$a2, $a4, .LBB6_68
.LBB6_66:                               # %scalar.ph551.preheader
	mul.d	$a2, $a0, $a3
	ld.d	$a4, $sp, 280                   # 8-byte Folded Reload
	alsl.d	$a4, $a3, $a4, 2
	sub.d	$a1, $a1, $a3
...
.LBB6_69:                               # %.lr.ph357
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a7, $a0, %pc_lo12(A__align_gapmap.ogcp1)
	addi.d	$a0, $a7, 4
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB6_115
.LBB6_70:                               # %scalar.ph639.preheader
	alsl.d	$a5, $a4, $s5, 2
	addi.d	$a5, $a5, -4
	alsl.d	$a1, $a4, $a1, 2
	alsl.d	$a2, $a4, $a2, 2
...
.LBB6_91:
	...
	bnez	$a0, .LBB6_107
	b	.LBB6_93
.LBB6_92:                               # %._crit_edge383.loopexit
...
.LBB6_96:                               # %vector.body663
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_96
# %bb.97:                               # %middle.block670
	beq	$a2, $a4, .LBB6_100
.LBB6_98:                               # %scalar.ph654.preheader
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	sub.w	$a2, $a2, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s5, 2
...
# %bb.102:                              # %vector.ph675
	...
	vreplvei.d	$vr2, $vr0, 0
	pcalau12i	$a5, %pc_hi20(.LCPI6_1)
	vld	$vr3, $a5, %pc_lo12(.LCPI6_1)
	vreplvei.d	$vr4, $vr1, 0
	addi.d	$a5, $a1, 4
	vldi	$vr5, -800
	move	$a6, $a4
	.p2align	4, , 16
.LBB6_103:                              # %vector.body682
                                        # =>This Inner Loop Header: Depth=1
	vpickve2gr.w	$a7, $vr3, 1
	bstrpick.d	$a7, $a7, 31, 0
	movgr2fr.d	$fa6, $a7
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB6_103
# %bb.104:                              # %middle.block689
	beq	$a3, $a4, .LBB6_107
.LBB6_105:                              # %scalar.ph673.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB6_106:                              # %scalar.ph673
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $a0, 31, 0
	movgr2fr.d	$fa3, $a3
	fld.s	$fa4, $a1, 0
...
# %bb.127:
	move	$a3, $zero
	b	.LBB6_131
.LBB6_128:                              # %vector.ph694
	bstrpick.d	$a3, $a3, 31, 1
	slli.d	$a3, $a3, 1
	addi.d	$a5, $ra, 8
	move	$a6, $a3
	.p2align	4, , 16
.LBB6_129:                              # %vector.body697
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a7, $a5, -8
	ld.d	$t0, $a5, 0
	addi.d	$t1, $a4, -1
...
.LBB6_137:                              # %vector.body708
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB6_137
# %bb.138:                              # %middle.block713
	beq	$a4, $a5, .LBB6_141
.LBB6_139:                              # %scalar.ph703.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB6_140:                              # %scalar.ph703
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.144:                              #   in Loop: Header=BB6_143 Depth=1
	beqz	$t2, .LBB6_160
# %bb.145:                              #   in Loop: Header=BB6_143 Depth=1
	sub.d	$a7, $s7, $t2
	move	$t2, $a3
	nor	$t4, $a7, $zero
	add.w	$t4, $s7, $t4
	beqz	$t4, .LBB6_151
.LBB6_146:                              # %.lr.ph19.i.preheader
...
.LBB6_147:                              # %.lr.ph19.i
	...
	move	$s3, $t4
	bgez	$t7, .LBB6_147
# %bb.148:                              # %._crit_edge20.i
                                        #   in Loop: Header=BB6_143 Depth=1
	bne	$t2, $a3, .LBB6_152
.LBB6_149:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB6_143 Depth=1
	bne	$t0, $s8, .LBB6_155
	b	.LBB6_157
	.p2align	4, , 16
...
.LBB6_153:                              # %.lr.ph29.i
	...
	addi.d	$t5, $t5, -1
	bgez	$t8, .LBB6_153
# %bb.154:                              # %._crit_edge30.loopexit.i
                                        #   in Loop: Header=BB6_143 Depth=1
	add.d	$a2, $a2, $t6
	beq	$t0, $s8, .LBB6_157
.LBB6_155:                              # %._crit_edge30.i
                                        #   in Loop: Header=BB6_143 Depth=1
	addi.w	$t6, $a0, 0
	beq	$t1, $t6, .LBB6_157
# %bb.156:                              #   in Loop: Header=BB6_143 Depth=1
	slli.d	$t6, $t0, 2
	...
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a1, 0
.LBB6_157:                              #   in Loop: Header=BB6_143 Depth=1
	blez	$t0, .LBB6_162
# %bb.158:                              #   in Loop: Header=BB6_143 Depth=1
	blez	$t1, .LBB6_162
# %bb.159:                              #   in Loop: Header=BB6_143 Depth=1
	add.d	$a6, $t2, $a6
	addi.d	$s3, $t4, -1
	st.b	$a4, $t4, -1
	addi.d	$s5, $t5, -1
	...
	b	.LBB6_161
	.p2align	4, , 16
.LBB6_160:                              #   in Loop: Header=BB6_143 Depth=1
	addi.d	$a7, $s7, -1
	move	$t2, $a3
	nor	$t4, $a7, $zero
	add.w	$t4, $s7, $t4
...
.LBB6_164:                              # %.lr.ph50.i
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB6_164
.LBB6_165:                              # %.preheader.i
	blez	$s2, .LBB6_168
# %bb.166:                              # %.lr.ph52.preheader.i
	move	$fp, $s1
	move	$s0, $s2
	.p2align	4, , 16
.LBB6_167:                              # %.lr.ph52.i
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB6_167
.LBB6_168:                              # %Atracking_localhom_gapmap.exit
	ld.d	$a0, $sp, 280                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
...
.LBB6_182:                              # %vector.body531
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB6_182
# %bb.183:                              # %middle.block536
	beq	$a1, $a3, .LBB6_36
	b	.LBB6_34
.LBB6_184:                              # %vector.memcheck568
	ld.d	$a6, $sp, 280                   # 8-byte Folded Reload
	addi.d	$a5, $a6, 4
	alsl.d	$a6, $a1, $a6, 2
	addi.d	$a7, $a0, 4
...
.LBB6_187:                              # %vector.body584
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB6_187
# %bb.188:                              # %middle.block594
	bne	$a4, $a5, .LBB6_55
	b	.LBB6_57
.LBB6_189:                              # %vector.memcheck597
	addi.d	$a5, $s5, 4
	alsl.d	$a6, $a1, $s5, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
