...
.LBB35_27:                              # %vector.ph107
	bstrpick.d	$a0, $fp, 30, 1
	slli.d	$a0, $a0, 1
	pcalau12i	$a1, %pc_hi20(counteff_simple_float.rootnode+8)
	addi.d	$a1, $a1, %pc_lo12(counteff_simple_float.rootnode+8)
	addi.d	$a2, $s0, 8
	move	$a3, $a0
	.p2align	4, , 16
...
.LBB36_27:                              # %vector.ph107
	bstrpick.d	$a0, $fp, 30, 1
	slli.d	$a0, $a0, 1
	pcalau12i	$a1, %pc_hi20(counteff_simple.rootnode+8)
	addi.d	$a1, $a1, %pc_lo12(counteff_simple.rootnode+8)
	addi.d	$a2, $s0, 8
	move	$a3, $a0
	.p2align	4, , 16
