...
.LBB4_42:                               # %._crit_edge655
	...
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	ld.d	$s5, $a0, %pc_lo12(partQ__align.intwork)
	ori	$a7, $zero, 1
...
# %bb.178:                              # %vector.ph1305
	...
	vld	$vr3, $a5, %pc_lo12(.LCPI4_1)
	vreplvei.d	$vr4, $vr1, 0
	addi.d	$a5, $a1, 4
	vldi	$vr5, -800
	move	$a6, $a4
	.p2align	4, , 16
.LBB4_179:                              # %vector.body1312
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.203:
	move	$a5, $zero
	b	.LBB4_207
.LBB4_204:                              # %vector.ph1348
	bstrpick.d	$a5, $a5, 31, 1
	slli.d	$a5, $a5, 1
	addi.d	$a7, $s7, 8
	move	$t0, $a5
	.p2align	4, , 16
.LBB4_205:                              # %vector.body1351
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t1, $a7, -8
	ld.d	$t2, $a7, 0
	addi.d	$t3, $a6, -1
...
.LBB4_230:                              #   in Loop: Header=BB4_226 Depth=1
	...
	bnez	$t8, .LBB4_234
	.p2align	4, , 16
.LBB4_231:                              # %._crit_edge32.i
                                        #   in Loop: Header=BB4_226 Depth=1
	add.w	$t2, $t7, $t2
	beq	$t7, $t0, .LBB4_244
# %bb.232:                              # %.preheader1.preheader.i
                                        #   in Loop: Header=BB4_226 Depth=1
	nor	$t7, $t7, $zero
	move	$t8, $t7
	b	.LBB4_239
	.p2align	4, , 16
.LBB4_233:                              # %._crit_edge29.i
...
.LBB4_237:                              # %.lr.ph28.i
	...
	b	.LBB4_233
	.p2align	4, , 16
.LBB4_238:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB4_239 Depth=2
	addi.d	$t8, $t8, -1
	ld.d	$s2, $sp, 400                   # 8-byte Folded Reload
	beqz	$t8, .LBB4_243
.LBB4_239:                              # %.preheader1.i
                                        #   Parent Loop BB4_226 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_240 Depth 3
                                        #       Child Loop BB4_242 Depth 3
...
.LBB4_242:                              # %.lr.ph37.i
	...
	b	.LBB4_238
	.p2align	4, , 16
.LBB4_243:                              # %._crit_edge41.loopexit.i
                                        #   in Loop: Header=BB4_226 Depth=1
	add.d	$a4, $a4, $t7
	ld.d	$s1, $sp, 392                   # 8-byte Folded Reload
.LBB4_244:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB4_226 Depth=1
	beq	$t4, $a2, .LBB4_247
# %bb.245:                              # %._crit_edge41.i
                                        #   in Loop: Header=BB4_226 Depth=1
	addi.w	$t7, $a0, 0
	beq	$t5, $t7, .LBB4_247
# %bb.246:                              #   in Loop: Header=BB4_226 Depth=1
	slli.d	$t7, $t4, 2
	...
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a3, 0
.LBB4_247:                              #   in Loop: Header=BB4_226 Depth=1
	blez	$t4, .LBB4_327
# %bb.248:                              #   in Loop: Header=BB4_226 Depth=1
	blez	$t5, .LBB4_327
# %bb.249:                              # %.preheader5.i
                                        #   in Loop: Header=BB4_226 Depth=1
	blez	$s2, .LBB4_252
# %bb.250:                              # %.lr.ph44.i
	...
	move	$t6, $a6
	.p2align	4, , 16
.LBB4_251:                              #   Parent Loop BB4_226 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t4, 0
	ld.d	$t8, $t5, 0
	ldx.b	$t7, $t7, $t3
...
# %bb.253:                              # %.lr.ph46.i
	...
	move	$t6, $a7
	.p2align	4, , 16
.LBB4_254:                              #   Parent Loop BB4_226 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t4, 0
	ld.d	$t8, $t5, 0
	ldx.b	$t7, $t7, $t2
...
# %bb.256:                              # %.lr.ph14.i619
	...
	b	.LBB4_258
	.p2align	4, , 16
.LBB4_257:                              #   in Loop: Header=BB4_258 Depth=1
	addi.d	$a6, $a6, -1
	addi.d	$a7, $a7, 1
	addi.d	$s5, $s5, 4
	beqz	$a6, .LBB4_260
...
# %bb.259:                              #   in Loop: Header=BB4_258 Depth=1
	...
	fmov.s	$fa0, $fa1
	b	.LBB4_257
.LBB4_260:                              # %.loopexit.i541
	bltz	$a2, .LBB4_284
# %bb.261:                              # %.lr.ph17.preheader.i543
	addi.d	$a4, $s4, 1
...
.LBB4_264:                              # %vector.body852
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB4_264
# %bb.265:                              # %middle.block857
	beq	$a2, $s8, .LBB4_22
	b	.LBB4_20
.LBB4_266:                              # %vector.memcheck1190
...
.LBB4_270:                              # %vector.body1213
	...
	addi.d	$t1, $t1, 16
	bnez	$t3, .LBB4_270
# %bb.271:                              # %middle.block1225
	bne	$a7, $t2, .LBB4_53
	b	.LBB4_55
.LBB4_272:                              # %vector.memcheck1228
	addi.d	$t0, $t6, 4
	alsl.d	$t2, $a5, $t6, 2
	addi.d	$t1, $a2, 8
	sltu	$t1, $t0, $t1
...
.LBB4_276:                              # %vector.body1251
	...
	addi.d	$t1, $t1, 16
	bnez	$t3, .LBB4_276
# %bb.277:                              # %middle.block1263
	bne	$a7, $t2, .LBB4_57
	b	.LBB4_59
.LBB4_278:
	movgr2fr.w	$fa0, $zero
	b	.LBB4_152
.LBB4_279:                              # %vector.ph1324
	bstrpick.d	$a4, $a4, 31, 1
	slli.d	$a4, $a4, 1
	addi.d	$a6, $s7, 8
	move	$a7, $a4
	.p2align	4, , 16
.LBB4_280:                              # %vector.body1327
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t0, $a6, -8
	ld.d	$t1, $a6, 0
	addi.d	$t2, $a5, -1
	...
	addi.d	$a6, $a6, 16
	bnez	$a7, .LBB4_280
# %bb.281:                              # %middle.block1330
	beq	$a2, $a4, .LBB4_284
.LBB4_282:                              # %.lr.ph17.i545.preheader
	alsl.d	$a5, $a4, $s7, 3
	sub.d	$a2, $a2, $a4
	addi.d	$a4, $a4, 1
	.p2align	4, , 16
.LBB4_283:                              # %.lr.ph17.i545
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a6, $a5, 0
	st.w	$a4, $a6, 0
	addi.d	$a5, $a5, 8
...
.LBB4_288:                              # %vector.body1338
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_288
# %bb.289:                              # %middle.block1343
	beq	$a3, $a4, .LBB4_292
.LBB4_290:                              # %scalar.ph1333.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_291:                              # %scalar.ph1333
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
# %bb.299:                              # %.lr.ph53.i558
	...
	b	.LBB4_301
	.p2align	4, , 16
.LBB4_300:                              # %._crit_edge47.i584
                                        #   in Loop: Header=BB4_301 Depth=1
	addi.w	$a2, $a2, 2
	move	$s4, $a6
	blt	$a1, $a2, .LBB4_327
.LBB4_301:                              # =>This Loop Header: Depth=1
	...
	ldx.w	$t1, $a6, $t1
	bltz	$t1, .LBB4_304
# %bb.302:                              #   in Loop: Header=BB4_301 Depth=1
	beqz	$t1, .LBB4_305
# %bb.303:                              #   in Loop: Header=BB4_301 Depth=1
	sub.w	$a6, $s4, $t1
	move	$t1, $ra
	nor	$t2, $a6, $zero
	add.w	$t2, $s4, $t2
	...
	b	.LBB4_306
	.p2align	4, , 16
.LBB4_304:                              #   in Loop: Header=BB4_301 Depth=1
	addi.w	$a6, $s4, -1
	nor	$t2, $a6, $zero
	add.w	$t2, $s4, $t2
	bnez	$t2, .LBB4_309
	b	.LBB4_306
	.p2align	4, , 16
.LBB4_305:                              #   in Loop: Header=BB4_301 Depth=1
	addi.w	$a6, $s4, -1
	move	$t1, $ra
	nor	$t2, $a6, $zero
	add.w	$t2, $s4, $t2
	bnez	$t2, .LBB4_309
	.p2align	4, , 16
.LBB4_306:                              # %._crit_edge32.i572
                                        #   in Loop: Header=BB4_301 Depth=1
	add.w	$a0, $t1, $a0
	beq	$t1, $ra, .LBB4_319
# %bb.307:                              # %.preheader1.preheader.i573
                                        #   in Loop: Header=BB4_301 Depth=1
	nor	$t1, $t1, $zero
	move	$t2, $t1
	b	.LBB4_314
...
.LBB4_312:                              # %.lr.ph28.i601
	...
	b	.LBB4_308
	.p2align	4, , 16
.LBB4_313:                              # %._crit_edge38.i577
                                        #   in Loop: Header=BB4_314 Depth=2
	addi.d	$t2, $t2, -1
	beqz	$t2, .LBB4_318
.LBB4_314:                              # %.preheader1.i574
                                        #   Parent Loop BB4_301 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_315 Depth 3
                                        #       Child Loop BB4_317 Depth 3
	...
	blez	$s2, .LBB4_316
	.p2align	4, , 16
.LBB4_315:                              # %.lr.ph35.i597
                                        #   Parent Loop BB4_301 Depth=1
                                        #     Parent Loop BB4_314 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t5, $t3, 0
	addi.d	$t6, $t5, -1
	st.d	$t6, $t3, 0
...
.LBB4_317:                              # %.lr.ph37.i593
	...
	b	.LBB4_313
	.p2align	4, , 16
.LBB4_318:                              # %._crit_edge41.loopexit.i579
                                        #   in Loop: Header=BB4_301 Depth=1
	add.d	$a2, $a2, $t1
.LBB4_319:                              # %._crit_edge41.i580
                                        #   in Loop: Header=BB4_301 Depth=1
	blez	$a7, .LBB4_327
# %bb.320:                              # %._crit_edge41.i580
                                        #   in Loop: Header=BB4_301 Depth=1
	blez	$t0, .LBB4_327
# %bb.321:                              # %.preheader5.i582
                                        #   in Loop: Header=BB4_301 Depth=1
	blez	$s2, .LBB4_324
# %bb.322:                              # %.lr.ph44.i589
                                        #   in Loop: Header=BB4_301 Depth=1
	...
	move	$t1, $a3
	.p2align	4, , 16
.LBB4_323:                              #   Parent Loop BB4_301 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t2, $a7, 0
	ld.d	$t3, $t0, 0
	ldx.b	$t2, $t2, $a6
...
# %bb.325:                              # %.lr.ph46.i585
	...
	move	$t1, $a4
	.p2align	4, , 16
.LBB4_326:                              #   Parent Loop BB4_301 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t2, $a7, 0
	ld.d	$t3, $t0, 0
	ldx.b	$t2, $t2, $a0
	...
	bnez	$t1, .LBB4_326
	b	.LBB4_300
.LBB4_327:                              # %Atracking_localhom.exit
	ld.d	$a0, $s3, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
	...
	blt	$a2, $a3, .LBB4_336
# %bb.328:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	bge	$a3, $a0, .LBB4_336
# %bb.329:
	blez	$s2, .LBB4_332
