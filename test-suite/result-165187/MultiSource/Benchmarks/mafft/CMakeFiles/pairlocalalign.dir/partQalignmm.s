...
.LBB4_143:                              # %vector.body1060
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_143
# %bb.144:                              # %middle.block1066
	beq	$a4, $a5, .LBB4_147
.LBB4_145:                              # %scalar.ph1055.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_146:                              # %scalar.ph1055
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_218:                              # %vector.body1030
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_218
# %bb.219:                              # %middle.block1036
	beq	$a3, $a4, .LBB4_222
.LBB4_220:                              # %scalar.ph1025.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_221:                              # %scalar.ph1025
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
