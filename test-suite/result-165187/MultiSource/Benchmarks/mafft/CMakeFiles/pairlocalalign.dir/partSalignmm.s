...
.LBB4_2:
	...
	st.d	$a0, $sp, 112                   # 8-byte Folded Spill
	pcalau12i	$a7, %pc_hi20(partA__align.mseq)
...
.LBB4_8:
	...
	st.w	$s4, $s0, %pc_lo12(partA__align.orlgth1)
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
...
.LBB4_9:
	blez	$s1, .LBB4_17
# %bb.10:                               # %.lr.ph
	ld.d	$a0, $a7, %pc_lo12(partA__align.mseq)
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
...
.LBB4_46:                               # %._crit_edge469
	...
	ld.d	$a2, $s7, %pc_lo12(partA__align.cpmx1)
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	ld.d	$s7, $a1, %pc_lo12(partA__align.floatwork)
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	ld.d	$s3, $a1, %pc_lo12(partA__align.intwork)
	ori	$a7, $zero, 1
	st.d	$a0, $sp, 264                   # 8-byte Folded Spill
	move	$a1, $s0
...
# %bb.56:                               # %.lr.ph478
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB4_209
.LBB4_57:                               # %scalar.ph734.preheader
	alsl.d	$a2, $a3, $a2, 2
	addi.d	$a2, $a2, -4
	ld.d	$a4, $sp, 264                   # 8-byte Folded Reload
	alsl.d	$a4, $a3, $a4, 2
...
# %bb.60:                               # %.lr.ph481
	...
	ori	$a3, $zero, 1
	bgeu	$a4, $a5, .LBB4_214
.LBB4_61:                               # %scalar.ph764.preheader
	alsl.d	$a2, $a3, $a2, 2
	addi.d	$a2, $a2, -4
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB4_62:                               # %scalar.ph764
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a0, 0
	fld.s	$fa1, $a2, 0
	fld.s	$fa2, $a4, 0
...
.LBB4_78:                               # %.lr.ph485
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a7, $a0, %pc_lo12(partA__align.ogcp1)
	addi.d	$a0, $a7, 4
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	...
	ori	$a4, $zero, 1
	bgeu	$a5, $a6, .LBB4_82
.LBB4_79:                               # %scalar.ph794.preheader
	alsl.d	$a5, $a4, $s6, 2
	addi.d	$a5, $a5, -4
	alsl.d	$a1, $a4, $a1, 2
	alsl.d	$a2, $a4, $a2, 2
...
.LBB4_109:                              # %vector.body818
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_109
# %bb.110:                              # %middle.block825
	beq	$a2, $a4, .LBB4_113
.LBB4_111:                              # %scalar.ph809.preheader
	sub.w	$a2, $t3, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
...
# %bb.115:                              # %vector.ph830
	...
	vld	$vr3, $a4, %pc_lo12(.LCPI4_1)
	vreplvei.d	$vr4, $vr1, 0
	addi.d	$a4, $s4, 4
	vldi	$vr5, -800
	move	$a5, $a3
	.p2align	4, , 16
.LBB4_116:                              # %vector.body837
                                        # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB4_116
# %bb.117:                              # %middle.block844
	beq	$a2, $a3, .LBB4_120
.LBB4_118:                              # %scalar.ph828.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_119:                              # %scalar.ph828
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.140:
	move	$a5, $zero
	b	.LBB4_144
.LBB4_141:                              # %vector.ph873
	bstrpick.d	$a5, $a5, 31, 1
	slli.d	$a5, $a5, 1
	addi.d	$a7, $ra, 8
	move	$t0, $a5
	.p2align	4, , 16
.LBB4_142:                              # %vector.body876
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t1, $a7, -8
	ld.d	$t2, $a7, 0
	addi.d	$t3, $a6, -1
...
.LBB4_150:                              # %vector.body887
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_150
# %bb.151:                              # %middle.block893
	beq	$a4, $a5, .LBB4_154
.LBB4_152:                              # %scalar.ph882.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_153:                              # %scalar.ph882
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.165:                              #   in Loop: Header=BB4_163 Depth=1
	...
	b	.LBB4_168
	.p2align	4, , 16
.LBB4_166:                              #   in Loop: Header=BB4_163 Depth=1
	addi.w	$t3, $s8, -1
	nor	$t8, $t3, $zero
	add.w	$t8, $s8, $t8
	bnez	$t8, .LBB4_171
	b	.LBB4_168
	.p2align	4, , 16
.LBB4_167:                              #   in Loop: Header=BB4_163 Depth=1
	addi.w	$t3, $s8, -1
	move	$t7, $t0
	nor	$t8, $t3, $zero
	add.w	$t8, $s8, $t8
	bnez	$t8, .LBB4_171
	.p2align	4, , 16
.LBB4_168:                              # %._crit_edge32.i
                                        #   in Loop: Header=BB4_163 Depth=1
	add.w	$t2, $t7, $t2
	beq	$t7, $t0, .LBB4_181
# %bb.169:                              # %.preheader1.preheader.i
                                        #   in Loop: Header=BB4_163 Depth=1
	nor	$t7, $t7, $zero
	move	$t8, $t7
	b	.LBB4_176
	.p2align	4, , 16
.LBB4_170:                              # %._crit_edge29.i
                                        #   in Loop: Header=BB4_171 Depth=2
	addi.d	$t8, $t8, -1
	addi.d	$a4, $a4, 1
	ld.d	$s4, $sp, 272                   # 8-byte Folded Reload
	beqz	$t8, .LBB4_168
.LBB4_171:                              # %.preheader3.i
                                        #   Parent Loop BB4_163 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_172 Depth 3
                                        #       Child Loop BB4_174 Depth 3
	move	$s0, $s4
...
.LBB4_174:                              # %.lr.ph28.i
	...
	b	.LBB4_170
	.p2align	4, , 16
.LBB4_175:                              # %._crit_edge38.i
                                        #   in Loop: Header=BB4_176 Depth=2
	addi.d	$t8, $t8, -1
	beqz	$t8, .LBB4_180
.LBB4_176:                              # %.preheader1.i
                                        #   Parent Loop BB4_163 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_177 Depth 3
                                        #       Child Loop BB4_179 Depth 3
...
.LBB4_179:                              # %.lr.ph37.i
	...
	b	.LBB4_175
	.p2align	4, , 16
.LBB4_180:                              # %._crit_edge41.loopexit.i
                                        #   in Loop: Header=BB4_163 Depth=1
	add.d	$a4, $a4, $t7
	ld.d	$s4, $sp, 272                   # 8-byte Folded Reload
...
# %bb.182:                              # %._crit_edge41.i
	...
	addi.w	$t7, $a0, 0
	beq	$t5, $t7, .LBB4_184
# %bb.183:                              #   in Loop: Header=BB4_163 Depth=1
	slli.d	$t7, $t4, 2
	...
	fadd.s	$fa0, $fa0, $fa1
	fst.s	$fa0, $a3, 0
.LBB4_184:                              #   in Loop: Header=BB4_163 Depth=1
	blez	$t4, .LBB4_267
# %bb.185:                              #   in Loop: Header=BB4_163 Depth=1
	blez	$t5, .LBB4_267
# %bb.186:                              # %.preheader5.i
                                        #   in Loop: Header=BB4_163 Depth=1
	blez	$s1, .LBB4_189
# %bb.187:                              # %.lr.ph44.i
	...
	move	$t6, $a6
	.p2align	4, , 16
.LBB4_188:                              #   Parent Loop BB4_163 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t4, 0
	ld.d	$t8, $t5, 0
	ldx.b	$t7, $t7, $t3
...
# %bb.190:                              # %.lr.ph46.i
	...
	move	$t6, $a7
	.p2align	4, , 16
.LBB4_191:                              #   Parent Loop BB4_163 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t4, 0
	ld.d	$t8, $t5, 0
	ldx.b	$t7, $t7, $t2
...
# %bb.218:                              # %middle.block779
	bne	$a4, $a5, .LBB4_61
	b	.LBB4_78
.LBB4_219:                              # %vector.ph849
	bstrpick.d	$a4, $a4, 31, 1
	slli.d	$a4, $a4, 1
	addi.d	$a6, $s5, 8
	move	$a7, $a4
	.p2align	4, , 16
.LBB4_220:                              # %vector.body852
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t0, $a6, -8
	ld.d	$t1, $a6, 0
	addi.d	$t2, $a5, -1
...
# %bb.229:                              # %middle.block868
	beq	$a3, $a4, .LBB4_232
.LBB4_230:                              # %scalar.ph858.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_231:                              # %scalar.ph858
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
...
.LBB4_245:                              #   in Loop: Header=BB4_241 Depth=1
	...
	bnez	$t3, .LBB4_249
	.p2align	4, , 16
.LBB4_246:                              # %._crit_edge32.i386
                                        #   in Loop: Header=BB4_241 Depth=1
	add.w	$a0, $t2, $a0
	beq	$t2, $a5, .LBB4_259
# %bb.247:                              # %.preheader1.preheader.i387
                                        #   in Loop: Header=BB4_241 Depth=1
	nor	$t2, $t2, $zero
	move	$t3, $t2
	b	.LBB4_254
	.p2align	4, , 16
.LBB4_248:                              # %._crit_edge29.i384
                                        #   in Loop: Header=BB4_249 Depth=2
	addi.d	$t3, $t3, -1
	addi.d	$a2, $a2, 1
	beqz	$t3, .LBB4_246
.LBB4_249:                              # %.preheader3.i381
...
.LBB4_250:                              # %.lr.ph26.i419
	...
	addi.d	$t4, $t4, 8
	bnez	$t6, .LBB4_250
.LBB4_251:                              # %.preheader2.i383
                                        #   in Loop: Header=BB4_249 Depth=2
	move	$t4, $s7
	move	$t5, $a4
	blez	$fp, .LBB4_248
	.p2align	4, , 16
.LBB4_252:                              # %.lr.ph28.i415
                                        #   Parent Loop BB4_241 Depth=1
                                        #     Parent Loop BB4_249 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t6, $t4, 0
	...
	b	.LBB4_248
	.p2align	4, , 16
.LBB4_253:                              # %._crit_edge38.i391
                                        #   in Loop: Header=BB4_254 Depth=2
	addi.d	$t3, $t3, -1
	beqz	$t3, .LBB4_258
.LBB4_254:                              # %.preheader1.i388
                                        #   Parent Loop BB4_241 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_255 Depth 3
                                        #       Child Loop BB4_257 Depth 3
	...
	blez	$s1, .LBB4_256
	.p2align	4, , 16
.LBB4_255:                              # %.lr.ph35.i411
                                        #   Parent Loop BB4_241 Depth=1
                                        #     Parent Loop BB4_254 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t6, $t4, 0
	addi.d	$t7, $t6, -1
	st.d	$t7, $t4, 0
...
.LBB4_257:                              # %.lr.ph37.i407
	...
	b	.LBB4_253
	.p2align	4, , 16
.LBB4_258:                              # %._crit_edge41.loopexit.i393
                                        #   in Loop: Header=BB4_241 Depth=1
	add.d	$a2, $a2, $t2
.LBB4_259:                              # %._crit_edge41.i394
                                        #   in Loop: Header=BB4_241 Depth=1
	blez	$t0, .LBB4_267
# %bb.260:                              # %._crit_edge41.i394
                                        #   in Loop: Header=BB4_241 Depth=1
	blez	$t1, .LBB4_267
# %bb.261:                              # %.preheader5.i396
                                        #   in Loop: Header=BB4_241 Depth=1
	blez	$s1, .LBB4_264
# %bb.262:                              # %.lr.ph44.i403
                                        #   in Loop: Header=BB4_241 Depth=1
	...
	move	$t2, $a3
	.p2align	4, , 16
.LBB4_263:                              #   Parent Loop BB4_241 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t0, 0
	ld.d	$t4, $t1, 0
	ldx.b	$t3, $t3, $a7
...
# %bb.265:                              # %.lr.ph46.i399
	...
	move	$t2, $a4
	.p2align	4, , 16
.LBB4_266:                              #   Parent Loop BB4_241 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t3, $t0, 0
	ld.d	$t4, $t1, 0
	ldx.b	$t3, $t3, $a0
	...
	bnez	$t2, .LBB4_266
	b	.LBB4_240
.LBB4_267:                              # %Atracking_localhom.exit
	ld.d	$a0, $s3, 0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a3, $a0, 0
	...
	blt	$a2, $a3, .LBB4_276
# %bb.268:                              # %Atracking_localhom.exit
	ori	$a0, $a4, 2881
	bge	$a3, $a0, .LBB4_276
# %bb.269:
	blez	$s1, .LBB4_272
