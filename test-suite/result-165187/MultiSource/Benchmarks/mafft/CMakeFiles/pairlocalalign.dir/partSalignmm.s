...
.LBB4_109:                              # %vector.body819
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB4_109
# %bb.110:                              # %middle.block826
	beq	$a2, $a4, .LBB4_113
.LBB4_111:                              # %scalar.ph810.preheader
	sub.w	$a2, $t3, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $s6, 2
	sub.d	$a1, $a1, $a3
...
.LBB4_116:                              # %vector.body834
	...
	addi.w	$a3, $a3, 2
	bnez	$a6, .LBB4_116
# %bb.117:                              # %middle.block839
	beq	$a2, $a4, .LBB4_120
.LBB4_118:                              # %scalar.ph829.preheader
	alsl.d	$a2, $a0, $s4, 2
	sub.d	$a1, $a1, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB4_119:                              # %scalar.ph829
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.140:
	move	$a5, $zero
	b	.LBB4_144
.LBB4_141:                              # %vector.ph868
	bstrpick.d	$a5, $a5, 31, 1
	slli.d	$a5, $a5, 1
	addi.d	$a7, $ra, 8
	move	$t0, $a5
	.p2align	4, , 16
.LBB4_142:                              # %vector.body871
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t1, $a7, -8
	ld.d	$t2, $a7, 0
	addi.d	$t3, $a6, -1
...
.LBB4_150:                              # %vector.body882
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB4_150
# %bb.151:                              # %middle.block888
	beq	$a4, $a5, .LBB4_154
.LBB4_152:                              # %scalar.ph877.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB4_153:                              # %scalar.ph877
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
.LBB4_228:                              # %vector.body858
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_228
# %bb.229:                              # %middle.block863
	beq	$a3, $a4, .LBB4_232
.LBB4_230:                              # %scalar.ph853.preheader
	alsl.d	$a2, $a4, $a2, 2
	nor	$a5, $a4, $zero
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB4_231:                              # %scalar.ph853
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a5, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, -1
