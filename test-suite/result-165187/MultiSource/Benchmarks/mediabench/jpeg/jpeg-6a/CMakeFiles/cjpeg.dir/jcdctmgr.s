...
# %bb.14:                               #   in Loop: Header=BB1_4 Depth=1
	...
	vldi	$vr2, -992
	st.d	$a0, $s6, 0
.LBB1_15:                               # %vector.ph109
                                        #   in Loop: Header=BB1_4 Depth=1
	move	$a1, $zero
	addi.d	$a0, $a0, 4
	.p2align	4, , 16
.LBB1_16:                               # %vector.body110
                                        #   Parent Loop BB1_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $s4, $a1
	ldx.hu	$a3, $s4, $a1
	ld.hu	$a2, $a2, 2
	pcalau12i	$a4, %pc_hi20(start_pass_fdctmgr.aanscales)
	addi.d	$a4, $a4, %pc_lo12(start_pass_fdctmgr.aanscales)
	add.d	$a5, $a4, $a1
	ldx.h	$a4, $a4, $a1
	ld.h	$a5, $a5, 2
	mul.d	$a3, $a4, $a3
...
.LBB3_2:                                # %.preheader
	...
	vpickev.h	$vr0, $vr0, $vr0
	vadd.h	$vr0, $vr0, $vr4
	vstelm.d	$vr0, $s4, 48, 0
	vfmul.s	$vr0, $vr1, $vr2
	vfadd.s	$vr0, $vr0, $vr3
	vftintrz.w.s	$vr0, $vr0
	vpickev.h	$vr0, $vr0, $vr0
	vadd.h	$vr0, $vr0, $vr4
	vstelm.d	$vr0, $s4, 56, 0
	addi.w	$fp, $fp, 8
	addi.d	$s3, $s3, -1
	addi.d	$s4, $s4, 128
	bnez	$s3, .LBB3_2
