...
.LJTI1_0:
	...
	.word	.LBB1_21-.LJTI1_0
                                        # -- End function
	.text
	.globl	DoEmFloatIteration              # -- Begin function DoEmFloatIteration
	.p2align	5
...
.LBB2_22:                               #   in Loop: Header=BB2_23 Depth=3
	...
	bstrpick.d	$ra, $s7, 15, 1
	slli.d	$a7, $s7, 15
	or	$s7, $t2, $ra
	bstrpick.d	$t2, $s4, 15, 1
	slli.d	$a5, $s4, 15
	or	$s4, $a7, $t2
	bstrpick.d	$a4, $a4, 15, 1
	or	$a4, $a5, $a4
	st.h	$a2, $fp, 4
	bstrpick.d	$a5, $a6, 15, 1
	slli.d	$a7, $t8, 15
	slli.d	$t2, $a6, 15
	or	$a6, $a7, $a5
	st.h	$a6, $fp, 6
	bstrpick.d	$a5, $t1, 15, 1
	slli.d	$a7, $t1, 15
	or	$t1, $t2, $a5
	st.h	$t1, $fp, 8
	bstrpick.d	$a5, $t7, 15, 1
	or	$t2, $a7, $a5
	st.h	$t2, $fp, 10
	bstrpick.d	$a5, $t6, 15, 1
	slli.d	$a7, $t7, 15
	or	$ra, $a7, $a5
	bstrpick.d	$a5, $t5, 15, 1
	slli.d	$a7, $t6, 15
	or	$t7, $a7, $a5
	bstrpick.d	$a5, $t4, 15, 1
	slli.d	$a7, $t5, 15
	or	$t8, $a7, $a5
...
.LBB2_26:                               # %.lr.ph.i.us
                                        ...
                                        #     Parent Loop BB2_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bstrpick.d	$a0, $a1, 15, 15
	slli.d	$a1, $a1, 1
	slli.d	$a4, $t8, 1
	bstrpick.d	$a5, $t8, 15, 15
	or	$t8, $a4, $a0
	slli.d	$a0, $t7, 1
	bstrpick.d	$a4, $t7, 15, 15
	or	$t7, $a0, $a5
	slli.d	$a0, $ra, 1
	bstrpick.d	$a5, $ra, 15, 15
	or	$ra, $a0, $a4
	slli.d	$a0, $t2, 1
	bstrpick.d	$a4, $t2, 15, 15
	or	$t2, $a0, $a5
	slli.d	$a0, $t1, 1
	bstrpick.d	$a5, $t1, 15, 15
	or	$t1, $a0, $a4
	slli.d	$a0, $a6, 1
