...
.LBB0_10:                               # %pred.store.continue
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB0_12
# %bb.11:                               # %pred.store.if156
                                        #   in Loop: Header=BB0_8 Depth=2
	vpickve2gr.d	$a6, $vr4, 1
	add.d	$a6, $a4, $a6
	st.d	$a2, $a6, 8
.LBB0_12:                               # %pred.store.continue157
                                        #   in Loop: Header=BB0_8 Depth=2
	vaddi.du	$vr4, $vr3, 2
	vand.v	$vr5, $vr4, $vr2
	vseqi.d	$vr5, $vr5, 8
