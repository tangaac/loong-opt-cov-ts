...
.LBB7_20:                               # %vector.ph99
	...
	bstrpick.d	$t3, $a5, 62, 2
	slli.d	$t3, $t3, 2
	move	$t5, $a4
	.p2align	4, , 16
.LBB7_21:                               # %vector.body100
...
# %bb.29:                               #   in Loop: Header=BB7_18 Depth=1
	...
	addi.d	$a6, $a6, 8
	bne	$a3, $t1, .LBB7_18
# %bb.30:                               # %.preheader29.i34.preheader
	move	$a3, $zero
	addi.d	$a4, $s0, 16
	ori	$a5, $zero, 1
	ori	$a6, $a0, 192
...
# %bb.33:                               #   in Loop: Header=BB7_32 Depth=1
	...
	b	.LBB7_37
	.p2align	4, , 16
.LBB7_34:                               # %vector.ph128
                                        #   in Loop: Header=BB7_32 Depth=1
	move	$t5, $a5
	bstrins.d	$t5, $zero, 1, 0
	bstrpick.d	$t4, $a5, 62, 2
	slli.d	$t4, $t4, 2
	move	$t6, $a4
	.p2align	4, , 16
.LBB7_35:                               # %vector.body131
	...
	addi.d	$t6, $t6, 32
	bnez	$t5, .LBB7_35
# %bb.36:                               # %middle.block136
                                        #   in Loop: Header=BB7_32 Depth=1
	beq	$a5, $t4, .LBB7_39
.LBB7_37:                               # %scalar.ph126.preheader
                                        #   in Loop: Header=BB7_32 Depth=1
	alsl.d	$t5, $t4, $t3, 3
	.p2align	4, , 16
.LBB7_38:                               # %scalar.ph126
                                        #   Parent Loop BB7_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa3, $t5, 0
	fmul.d	$fa3, $fa3, $fa0
...
.LBB7_44:                               # %vector.body117
	...
	addi.d	$s7, $s7, 16
	bnez	$s6, .LBB7_44
# %bb.45:                               # %middle.block123
                                        #   in Loop: Header=BB7_41 Depth=2
	move	$s7, $t8
	beq	$a5, $t8, .LBB7_40
.LBB7_46:                               # %scalar.ph112.preheader
                                        #   in Loop: Header=BB7_41 Depth=2
	mul.d	$s6, $s7, $a1
	slli.d	$s7, $s7, 3
	.p2align	4, , 16
.LBB7_47:                               # %scalar.ph112
                                        #   Parent Loop BB7_32 Depth=1
                                        #     Parent Loop BB7_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fld.d	$fa3, $s5, 0
	...
	bnez	$s8, .LBB7_47
	b	.LBB7_40
.LBB7_48:                               # %.preheader.i53.preheader
