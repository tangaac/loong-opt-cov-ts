...
# %bb.29:                               #   in Loop: Header=BB0_25 Depth=2
	srli.d	$a0, $s3, 60
	bnez	$a0, .LBB0_163
# %bb.30:                               # %.lr.ph.preheader.i.i.i.i.i.i
                                        #   in Loop: Header=BB0_25 Depth=2
	slli.d	$s2, $s3, 3
.Ltmp11:                                # EH_LABEL
	move	$a0, $s2
...
# %bb.60:                               #   in Loop: Header=BB0_25 Depth=2
	srli.d	$a0, $s3, 60
	bnez	$a0, .LBB0_163
# %bb.61:                               # %.lr.ph.preheader.i.i.i.i.i.i173
                                        #   in Loop: Header=BB0_25 Depth=2
	slli.d	$s2, $s3, 3
.Ltmp15:                                # EH_LABEL
	move	$a0, $s2
...
# %bb.62:                               # %.noexc198
	...
	add.d	$a0, $s0, $s2
	beq	$s4, $s1, .LBB0_74
# %bb.63:                               # %.lr.ph66.i176.preheader
                                        #   in Loop: Header=BB0_25 Depth=2
	move	$a2, $zero
	b	.LBB0_65
	.p2align	4, , 16
.LBB0_64:                               # %_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEC2EmRKS8_RKS9_.exit.i191
                                        #   in Loop: Header=BB0_65 Depth=3
	addi.d	$a2, $a2, 1
	beq	$a2, $s7, .LBB0_73
.LBB0_65:                               # %.lr.ph66.i176
                                        #   Parent Loop BB0_20 Depth=1
                                        #     Parent Loop BB0_25 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB0_69 Depth 4
...
.LBB0_69:                               # %.lr.ph.i180
	...
	ld.bu	$a5, $a7, 0
	beqz	$a5, .LBB0_67
# %bb.70:                               # %.lr.ph.i.i.i.i.i183.preheader
                                        #   in Loop: Header=BB0_69 Depth=4
	move	$a6, $zero
	addi.d	$a7, $a7, 1
	.p2align	4, , 16
.LBB0_71:                               # %.lr.ph.i.i.i.i.i183
                                        #   Parent Loop BB0_20 Depth=1
                                        #     Parent Loop BB0_25 Depth=2
                                        #       Parent Loop BB0_65 Depth=3
...
.LBB0_72:                               #   in Loop: Header=BB0_25 Depth=2
	...
	move	$a0, $s4
	b	.LBB0_76
.LBB0_73:                               # %_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEC2EmRKS8_RKS9_.exit._crit_edge.thread.i193
                                        #   in Loop: Header=BB0_25 Depth=2
	ld.d	$a2, $sp, 80
	st.d	$s0, $sp, 64
	st.d	$a0, $sp, 72
	st.d	$a1, $sp, 80
	b	.LBB0_75
.LBB0_74:                               # %_ZNSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EEC2EmRKS8_RKS9_.exit._crit_edge.i194
                                        #   in Loop: Header=BB0_25 Depth=2
	ld.d	$a2, $sp, 80
	st.d	$s0, $sp, 64
	st.d	$a0, $sp, 72
...
# %bb.100:                              # %.noexc49
	...
	st.d	$a0, $sp, 128
	b	.LBB0_102
.LBB0_101:                              # %.loopexit216.loopexit
	ld.w	$a1, $s5, 16
.LBB0_102:                              # %.loopexit216
.Ltmp27:                                # EH_LABEL
...
# %bb.110:                              # %.noexc101
	...
	st.d	$a0, $sp, 128
	b	.LBB0_112
.LBB0_111:                              # %.loopexit215.loopexit
	ld.w	$a1, $s8, 16
.LBB0_112:                              # %.loopexit215
.Ltmp36:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSolsEi)
	jirl	$ra, $ra, 0
...
# %bb.120:                              # %.noexc119
	...
	st.d	$a0, $sp, 88
	b	.LBB0_122
.LBB0_121:                              # %.loopexit214.loopexit
	ld.w	$a1, $s7, 16
.LBB0_122:                              # %.loopexit214
.Ltmp45:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSolsEi)
	jirl	$ra, $ra, 0
...
.LBB3_11:                               # %.lr.ph.i.i.i.i
	...
	addi.d	$a2, $a2, 8
	bne	$a1, $s4, .LBB3_11
.LBB3_12:                               # %_ZSt22__uninitialized_move_aIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEES9_SaIS8_EET0_T_SC_SB_RT1_.exit
	alsl.d	$a1, $s1, $s4, 3
	st.d	$a1, $s0, 8
	sub.d	$a2, $a0, $fp
	srai.d	$a1, $a2, 3
...
# %bb.13:
	...
	jirl	$ra, $ra, 0
.LBB3_14:                               # %_ZSt13move_backwardIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEES9_ET0_T_SB_SA_.exit
	addi.d	$a1, $s3, -8
	ori	$a2, $zero, 24
	move	$a0, $fp
	bltu	$a1, $a2, .LBB3_18
...
# %bb.25:                               # %middle.block214
	beq	$s1, $a3, .LBB3_27
	.p2align	4, , 16
.LBB3_26:                               # %.lr.ph.i.i.i85
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a2, $a2, -1
	st.d	$a1, $a0, 0
	addi.d	$a0, $a0, 8
	bnez	$a2, .LBB3_26
.LBB3_27:                               # %_ZSt24__uninitialized_fill_n_aIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEmS8_S8_ET_SA_T0_RKT1_RSaIT2_E.exit90
	move	$a0, $s3
	beq	$s2, $fp, .LBB3_34
...
.LBB3_33:                               # %.lr.ph.i.i.i.i92
	...
	addi.d	$a0, $a0, 8
	bne	$a1, $fp, .LBB3_33
.LBB3_34:                               # %_ZSt34__uninitialized_move_if_noexcept_aIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEES9_SaIS8_EET0_T_SC_SB_RT1_.exit
	alsl.d	$s7, $s1, $a0, 3
	beq	$s4, $fp, .LBB3_54
...
.LBB3_42:                               # %.lr.ph.i.i.i
	...
	addi.d	$a1, $a1, 8
	bnez	$a2, .LBB3_42
.LBB3_43:                               # %_ZSt24__uninitialized_fill_n_aIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEEmS8_S8_ET_SA_T0_RKT1_RSaIT2_E.exit
	beq	$s4, $fp, .LBB3_49
...
# %bb.48:                               # %middle.block150
	bne	$a2, $a6, .LBB3_59
	b	.LBB3_60
.LBB3_49:                               # %_ZSt22__uninitialized_move_aIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEES9_SaIS8_EET0_T_SC_SB_RT1_.exit75.thread
	add.d	$a0, $a1, $a0
	st.d	$a0, $s0, 8
	b	.LBB3_57
.LBB3_50:                               # %vector.ph243
	srli.d	$a1, $a1, 3
	addi.d	$a2, $a1, 1
	slli.d	$a4, $s1, 3
...
.LBB3_53:                               # %.lr.ph.i.i.i.i98
	...
	addi.d	$s7, $s7, 8
	bne	$a1, $s4, .LBB3_53
.LBB3_54:                               # %_ZSt34__uninitialized_move_if_noexcept_aIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEES9_SaIS8_EET0_T_SC_SB_RT1_.exit103
	beqz	$s2, .LBB3_56
# %bb.55:
	sub.d	$a1, $s5, $s2
	move	$a0, $s2
...
.LBB3_56:                               # %_ZNSt12_Vector_baseIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE13_M_deallocateEPS8_m.exit
	...
	alsl.d	$a0, $s6, $s3, 3
	st.d	$a0, $s0, 16
.LBB3_57:                               # %_ZSt4fillIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEES8_EvT_SA_RKT0_.exit68
...
.LBB3_59:                               # %.lr.ph.i.i.i.i70
	...
	addi.d	$a5, $a5, 8
	bne	$a4, $s4, .LBB3_59
.LBB3_60:                               # %_ZSt22__uninitialized_move_aIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEES9_SaIS8_EET0_T_SC_SB_RT1_.exit75
	add.d	$a0, $a1, $a0
	ori	$a1, $zero, 24
	st.d	$a0, $s0, 8
	move	$a0, $fp
...
.LBB3_65:
	...
	pcaddu18i	$ra, %call36(_ZSt20__throw_length_errorPKc)
	jirl	$ra, $ra, 0
.LBB3_66:                               # %_ZSt9__advanceIPPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEElEvRT_T0_St26random_access_iterator_tag.exit.thread.i
	ori	$a1, $zero, 8
	bne	$a2, $a1, .LBB3_14
# %bb.67:
	ld.d	$a1, $fp, 0
