...
.LBB1_8:                                # %._crit_edge.us.us.us.us.1
	...
	vrepli.b	$vr0, 0
	vldi	$vr3, -912
	vfcmp.clt.d	$vr1, $vr3, $vr5
	fcmp.clt.d	$fcc0, $fa3, $fs0
	fsel	$fa2, $fs0, $fa3, $fcc0
	vldi	$vr4, -944
	fmul.d	$fa2, $fa2, $fa4
...
.LBB1_12:                               #   in Loop: Header=BB1_13 Depth=4
	...
	fadd.d	$fa5, $fa5, $fs5
	fmul.d	$fa6, $fa2, $fa2
	fmadd.d	$fa6, $fa1, $fa1, $fa6
	fmadd.d	$fa6, $fa0, $fa0, $fa6
	frsqrt.d	$fa6, $fa6
	fmul.d	$fa1, $fa1, $fa6
	fmul.d	$fa2, $fa2, $fa6
	fmul.d	$fa0, $fa0, $fa6
