...
# %bb.0:
	...
	add.d	$a4, $a2, $a3
	srli.d	$a5, $a4, 16
	pcalau12i	$a2, %pc_hi20(sE)
	addi.d	$a2, $a2, %pc_lo12(sE)
	st.b	$a5, $a2, 0
	mul.d	$a4, $a4, $a1
	add.d	$a4, $a4, $a3
	srli.d	$a5, $a4, 16
...
# %bb.0:
	...
	add.d	$a4, $a2, $a3
	srli.d	$a5, $a4, 16
	pcalau12i	$a2, %pc_hi20(sF)
	addi.d	$a2, $a2, %pc_lo12(sF)
	st.b	$a5, $a2, 0
	mul.d	$a4, $a4, $a1
	add.d	$a4, $a4, $a3
	srli.d	$a5, $a4, 16
...
# %bb.0:
	...
	add.d	$a4, $a2, $a3
	srli.d	$a5, $a4, 16
	pcalau12i	$a2, %pc_hi20(sO)
	addi.d	$a2, $a2, %pc_lo12(sO)
	st.b	$a5, $a2, 0
	mul.d	$a4, $a4, $a1
	add.d	$a4, $a4, $a3
	srli.d	$a5, $a4, 16
...
# %bb.0:
	...
	add.d	$a4, $a2, $a3
	srli.d	$a5, $a4, 16
	pcalau12i	$a2, %pc_hi20(sP)
	addi.d	$a2, $a2, %pc_lo12(sP)
	st.b	$a5, $a2, 0
	mul.d	$a4, $a4, $a1
	add.d	$a4, $a4, $a3
	srli.d	$a5, $a4, 16
...
# %bb.0:
	...
	add.d	$a4, $a2, $a3
	srli.d	$a5, $a4, 16
	pcalau12i	$a2, %pc_hi20(sR)
	addi.d	$a2, $a2, %pc_lo12(sR)
	st.b	$a5, $a2, 0
	mul.d	$a4, $a4, $a1
	add.d	$a4, $a4, $a3
	srli.d	$a5, $a4, 16
...
# %bb.0:
	...
	ori	$a2, $a2, 941
	mul.d	$a2, $a0, $a2
	pcalau12i	$a0, %pc_hi20(sW)
	addi.d	$a0, $a0, %pc_lo12(sW)
	lu12i.w	$a3, 517897
	ori	$a3, $a3, 2473
	add.d	$a3, $a2, $a3
	srli.d	$a2, $a3, 16
