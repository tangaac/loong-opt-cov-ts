...
.Ltmp224:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp225:                               # EH_LABEL
.LBB1_28:                               # %vector.body1239.preheader
	ori	$a0, $zero, 4080
	ori	$a1, $zero, 2032
	ld.d	$a3, $sp, 176                   # 8-byte Folded Reload
	move	$a2, $a3
	.p2align	4, , 16
.LBB1_29:                               # %vector.body1239
...
.Ltmp251:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp252:                               # EH_LABEL
.LBB1_41:                               # %vector.body1251.preheader
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	vreplgr2vr.w	$vr0, $a0
	ori	$fp, $s2, 16
	ld.d	$a1, $sp, 176                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB1_42:                               # %vector.body1251
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $a1, $s3
	vstx	$vr0, $a0, $s2
	addi.d	$s3, $s3, 32
...
.Ltmp278:                               # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp279:                               # EH_LABEL
.LBB1_54:                               # %vector.body1257.preheader
	lu12i.w	$a0, -1
	vldi	$vr0, -3456
	ld.d	$a2, $sp, 176                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB1_55:                               # %vector.body1257
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a2, $a0
	vstx	$vr0, $a1, $s2
	addi.d	$a0, $a0, 32
