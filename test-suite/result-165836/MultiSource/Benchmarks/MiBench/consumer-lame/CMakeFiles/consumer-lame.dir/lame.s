...
# %bb.27:                               #   in Loop: Header=BB5_18 Depth=1
	...
	st.w	$a2, $s6, %pc_lo12(mf_size)
	sub.d	$a3, $a3, $t2
	st.w	$a3, $a4, %pc_lo12(mf_samples_to_encode)
	blez	$a1, .LBB5_16
...
# %bb.23:                               # %.lr.ph119
	...
	ori	$a1, $zero, 8
	blt	$s0, $a1, .LBB6_26
# %bb.24:                               # %vector.memcheck176
                                        #   in Loop: Header=BB6_22 Depth=1
	alsl.d	$a4, $a3, $s4, 1
	alsl.d	$a1, $a0, $s3, 2
	bgeu	$a4, $a1, .LBB6_48
# %bb.25:                               # %vector.memcheck176
                                        #   in Loop: Header=BB6_22 Depth=1
	add.d	$a1, $a3, $a0
	alsl.d	$a1, $a1, $s4, 1
	add.d	$a1, $a1, $fp
...
.LBB6_29:                               # %._crit_edge
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.w	$a0, $s6, %pc_lo12(mf_samples_to_encode)
	add.w	$a3, $a3, $s0
	st.w	$a3, $s5, %pc_lo12(mf_size)
	add.d	$a0, $a0, $s0
	st.w	$a0, $s6, %pc_lo12(mf_samples_to_encode)
...
# %bb.31:                               #   in Loop: Header=BB6_22 Depth=1
	...
	st.w	$a3, $s5, %pc_lo12(mf_size)
	sub.d	$a4, $a4, $a2
	st.w	$a4, $s6, %pc_lo12(mf_samples_to_encode)
	blez	$a1, .LBB6_20
...
.LBB6_54:                               # %vector.body194
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB6_54
# %bb.55:                               # %middle.block199
	beq	$a1, $s2, .LBB6_58
.LBB6_56:                               # %.lr.ph133.preheader203
	alsl.d	$a2, $a1, $s3, 2
	addi.d	$a2, $a2, 2
	alsl.d	$a3, $a1, $a0, 1
	alsl.d	$a4, $a1, $s4, 1
