...
# %bb.316:                              #   in Loop: Header=BB0_315 Depth=2
	bne	$a3, $s0, .LBB0_313
	b	.LBB0_318
.LBB0_317:                              # %.loopexit3349.loopexit
                                        #   in Loop: Header=BB0_302 Depth=1
	addi.w	$a1, $s8, 1
	move	$a0, $s8
	move	$s8, $a1
.LBB0_318:                              # %.loopexit3349
                                        #   in Loop: Header=BB0_302 Depth=1
	bstrpick.d	$a0, $a0, 31, 0
	slli.d	$a0, $a0, 2
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
...
.LBB0_336:                              # %.critedge81
	...
	and	$a0, $a0, $a1
	beqz	$a0, .LBB0_360
# %bb.337:                              # %.preheader3348
	move	$s8, $zero
	addi.d	$a0, $s2, -1
	beqz	$a0, .LBB0_360
# %bb.338:                              # %.lr.ph3442.preheader
	move	$s3, $zero
	bstrpick.d	$a1, $a0, 31, 0
	ori	$a2, $zero, 36
	mul.d	$a1, $a1, $a2
...
# %bb.572:
	...
	bgeu	$s2, $a1, .LBB0_522
	b	.LBB0_528
.LBB0_573:                              # %vector.main.loop.iter.check3988
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB0_605
# %bb.574:
	move	$a0, $zero
...
# %bb.594:
	...
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	bne	$a0, $a2, .LBB0_751
# %bb.595:                              # %.preheader3346
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 72                    # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_655
# %bb.596:                              # %.lr.ph3446.preheader
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	addi.d	$a0, $a0, 8
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	ori	$s3, $zero, 12
...
# %bb.607:                              # %middle.block3998
	...
	beq	$a0, $s2, .LBB0_614
# %bb.608:                              # %vec.epilog.iter.check4005
	beqz	$a1, .LBB0_612
.LBB0_609:                              # %vec.epilog.ph4007
	move	$a2, $a0
	andi	$a0, $s2, 124
	vreplgr2vr.w	$vr0, $s0
	sub.d	$a1, $a2, $a0
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_610:                              # %vec.epilog.vector.body4012
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_610
# %bb.611:                              # %vec.epilog.middle.block4016
	vbsrl.v	$vr1, $vr0, 8
	vmax.wu	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.wu	$vr0, $vr1, $vr0
...
.LBB0_661:                              # %.critedge3021
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_662:                              # %._crit_edge3480.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_685
...
# %bb.784:
	...
	b	.LBB0_202
.LBB0_785:                              # %._crit_edge3467._crit_edge
	bstrpick.d	$a0, $a1, 31, 0
.LBB0_786:
	ori	$a1, $zero, 1
	pcaddu18i	$ra, %call36(cli_calloc)
...
# %bb.849:                              # %middle.block
	beq	$a2, $a3, .LBB0_852
.LBB0_850:                              # %.lr.ph3450.preheader4033
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
...
.LBB0_866:
	move	$s0, $s5
.LBB0_867:                              # %.thread3312.sink.split
	move	$a0, $s0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_638
...
# %bb.893:                              # %vector.memcheck3935
	...
	move	$a1, $zero
	bnez	$a4, .LBB0_922
# %bb.894:                              # %vector.memcheck3935
	alsl.d	$a4, $a0, $s6, 1
	sltu	$a2, $a2, $a4
	sltu	$a3, $s6, $a3
	and	$a2, $a2, $a3
	bnez	$a2, .LBB0_922
# %bb.895:                              # %vector.ph3949
...
.LBB0_921:
	move	$a1, $zero
.LBB0_922:                              # %scalar.ph3947.preheader
	slli.d	$a2, $a1, 1
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $a1, 3
	slli.d	$a1, $a1, 2
