...
# %bb.14:
	...
	move	$s0, $zero
	b	.LBB0_21
.LBB0_15:                               # %vector.main.loop.iter.check419
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB0_67
# %bb.16:
	move	$a2, $zero
...
# %bb.36:                               #   in Loop: Header=BB0_34 Depth=2
	...
	b	.LBB0_39
	.p2align	4, , 16
.LBB0_37:                               # %.loopexit214.split.loop.exit
                                        #   in Loop: Header=BB0_32 Depth=1
	st.d	$zero, $sp, 88                  # 8-byte Folded Spill
	add.d	$s6, $s7, $a1
	b	.LBB0_39
	.p2align	4, , 16
.LBB0_38:                               # %.loopexit214.loopexit.split.loop.exit
                                        #   in Loop: Header=BB0_32 Depth=1
	add.d	$s6, $s7, $a1
	ori	$a0, $zero, 1
...
# %bb.69:                               # %middle.block431
	...
	beq	$a1, $a2, .LBB0_76
# %bb.70:                               # %vec.epilog.iter.check438
	beqz	$a3, .LBB0_74
.LBB0_71:                               # %vec.epilog.ph440
	move	$a3, $a2
	bstrpick.d	$a0, $a0, 31, 2
	slli.d	$a2, $a0, 2
	vrepli.b	$vr0, 0
	...
	vrepli.w	$vr2, 1
	.p2align	4, , 16
.LBB0_72:                               # %vec.epilog.vector.body443
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	vinsgr2vr.w	$vr3, $a4, 0
	vseq.b	$vr3, $vr3, $vr1
	...
	addi.d	$a3, $a3, 4
	bnez	$a0, .LBB0_72
# %bb.73:                               # %vec.epilog.middle.block448
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a4, $vr0, 0
	beq	$a1, $a2, .LBB0_76
.LBB0_74:                               # %.lr.ph268.preheader
	add.d	$a0, $s5, $a2
	sub.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB0_75:                               # %.lr.ph268
