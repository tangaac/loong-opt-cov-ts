...
.LBB3_9:                                # %.preheader235
	...
	slli.d	$a0, $a0, 3
	ldx.d	$s7, $a4, $a0
	pcalau12i	$a4, %got_pc_hi20(LevelOffset4x4Luma)
	ld.d	$a4, $a4, %got_pc_lo12(LevelOffset4x4Luma)
	ld.d	$a4, $a4, 0
	ldx.d	$a4, $a4, $a6
	slli.d	$a7, $a7, 3
	ldx.d	$s8, $a4, $a7
	...
	sub.w	$a6, $a6, $a7
	sub.d	$t0, $t2, $t3
	pcalau12i	$a7, %pc_hi20(dct_luma.m4)
	addi.d	$s2, $a7, %pc_lo12(dct_luma.m4)
	alsl.d	$a0, $a6, $a4, 1
	st.d	$a0, $sp, 136                   # 8-byte Folded Spill
	slli.d	$a4, $a4, 1
	sub.d	$s6, $a6, $a4
