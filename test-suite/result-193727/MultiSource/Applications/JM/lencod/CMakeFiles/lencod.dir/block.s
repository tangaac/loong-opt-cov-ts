...
.LBB6_6:                                # %.preheader669
	...
	addi.d	$a0, $sp, 520
	xvstelm.w	$xr6, $a0, 0, 1
	ori	$a0, $a2, 1232
	xvldx	$xr7, $ra, $a0
	addi.d	$a3, $sp, 552
	xvstelm.w	$xr6, $a3, 0, 2
	addi.d	$a3, $sp, 584
	xvstelm.w	$xr6, $a3, 0, 3
	addi.d	$a3, $sp, 616
	...
	vldx	$vr7, $ra, $a0
	addi.d	$a0, $sp, 648
	xvstelm.w	$xr6, $a0, 0, 5
	addi.d	$a0, $sp, 680
	xvstelm.w	$xr6, $a0, 0, 6
	addi.d	$a0, $sp, 712
