...
.LBB17_124:                             # %.preheader451
	...
	beqz	$a0, .LBB17_131
	b	.LBB17_146
.LBB17_125:                             # %vector.body841.preheader
                                        #   in Loop: Header=BB17_27 Depth=1
	addi.d	$a0, $sp, 572
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	addi.d	$a2, $sp, 938
	.p2align	4, , 16
.LBB17_126:                             # %vector.body841
                                        #   Parent Loop BB17_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a0, -24
	ld.w	$a4, $a0, 0
	...
	addi.d	$a0, $a0, 48
	bnez	$a1, .LBB17_126
# %bb.127:                              # %middle.block844
                                        #   in Loop: Header=BB17_27 Depth=1
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a0
	beq	$a0, $ra, .LBB17_130
.LBB17_128:                             # %.lr.ph492.preheader850
                                        #   in Loop: Header=BB17_27 Depth=1
	alsl.d	$a0, $a2, $fp, 1
	sub.d	$a1, $ra, $a2
	slli.d	$a3, $a2, 4
...
# %bb.139:                              # %vec.epilog.middle.block
	...
	b	.LBB17_144
	.p2align	4, , 16
.LBB17_140:                             # %vector.body823.preheader
                                        #   in Loop: Header=BB17_133 Depth=2
	ld.d	$a4, $sp, 464                   # 8-byte Folded Reload
	move	$a5, $a2
	addi.d	$a6, $sp, 952
	.p2align	4, , 16
.LBB17_141:                             # %vector.body823
                                        #   Parent Loop BB17_27 Depth=1
                                        #     Parent Loop BB17_133 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$a7, $a6, -16
...
# %bb.153:                              # %middle.block812
	...
	beq	$a5, $a3, .LBB17_156
.LBB17_154:                             # %.lr.ph501.preheader849
                                        #   in Loop: Header=BB17_27 Depth=1
	slli.d	$a5, $a7, 1
...
.LBB17_156:                             # %._crit_edge502
	...
	ori	$a5, $zero, 2
	blt	$t2, $a5, .LBB17_159
# %bb.157:                              # %.lr.ph507.preheader
                                        #   in Loop: Header=BB17_27 Depth=1
	ori	$a5, $zero, 9
	bgeu	$t2, $a5, .LBB17_161
# %bb.158:                              #   in Loop: Header=BB17_27 Depth=1
	move	$a7, $zero
	b	.LBB17_164
.LBB17_159:                             # %._crit_edge508
                                        #   in Loop: Header=BB17_27 Depth=1
	blez	$s6, .LBB17_26
...
# %bb.163:                              # %middle.block790
	...
	beq	$a5, $a2, .LBB17_166
.LBB17_164:                             # %.lr.ph507.preheader848
                                        #   in Loop: Header=BB17_27 Depth=1
	slli.d	$a5, $a7, 1
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	alsl.d	$a2, $a7, $a2, 1
...
.LBB17_165:                             # %.lr.ph507
	...
	addi.d	$a7, $a7, 1
	bnez	$a6, .LBB17_165
.LBB17_166:                             # %._crit_edge508.thread
                                        #   in Loop: Header=BB17_27 Depth=1
	...
	sra.w	$a2, $a2, $a4
	blez	$s2, .LBB17_26
.LBB17_167:                             # %.preheader448.lr.ph.split.us
                                        #   in Loop: Header=BB17_27 Depth=1
	move	$a4, $zero
	...
	b	.LBB17_169
	.p2align	4, , 16
.LBB17_168:                             # %._crit_edge512.us
                                        #   in Loop: Header=BB17_169 Depth=2
	addi.d	$a4, $a4, 1
	addi.d	$a0, $a0, 32
	add.d	$a6, $a6, $a2
	beq	$a4, $s6, .LBB17_26
.LBB17_169:                             # %.preheader448.us
                                        #   Parent Loop BB17_27 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_172 Depth 3
                                        #       Child Loop BB17_175 Depth 3
	ori	$a7, $zero, 8
	bgeu	$s2, $a7, .LBB17_171
...
.LBB17_180:                             # %.preheader434
	...
	b	.LBB17_184
.LBB17_181:                             #   in Loop: Header=BB17_184 Depth=1
	move	$s3, $zero
.LBB17_182:                             # %.split537.us
                                        #   in Loop: Header=BB17_184 Depth=1
	...
	ori	$a7, $zero, 2
	ori	$t0, $zero, 4
.LBB17_183:                             #   in Loop: Header=BB17_184 Depth=1
	addi.d	$a3, $a3, 1
	...
	addi.d	$a5, $a5, 512
	beq	$a3, $t0, .LBB17_203
.LBB17_184:                             # =>This Loop Header: Depth=1
                                        #     Child Loop BB17_196 Depth 2
                                        #       Child Loop BB17_197 Depth 3
                                        #     Child Loop BB17_200 Depth 2
                                        #       Child Loop BB17_201 Depth 3
	ld.d	$a0, $s7, 0
	ld.w	$a1, $a0, 20
	ld.d	$a0, $s2, 0
	bne	$a1, $a7, .LBB17_188
# %bb.185:                              #   in Loop: Header=BB17_184 Depth=1
	ldptr.w	$a1, $a0, 4048
	beqz	$a1, .LBB17_188
# %bb.186:                              #   in Loop: Header=BB17_184 Depth=1
	bne	$a3, $a7, .LBB17_190
# %bb.187:                              #   in Loop: Header=BB17_184 Depth=1
	beqz	$a2, .LBB17_183
	b	.LBB17_190
	.p2align	4, , 16
.LBB17_188:                             #   in Loop: Header=BB17_184 Depth=1
	ldptr.w	$a0, $a0, 4072
	addi.d	$a0, $a0, -1
	sltui	$a0, $a0, 1
	sltu	$a1, $zero, $a3
	and	$a0, $a1, $a0
	bnez	$a0, .LBB17_183
# %bb.189:                              #   in Loop: Header=BB17_184 Depth=1
	addi.d	$a0, $a3, -2
	sltu	$a0, $zero, $a0
	ld.d	$a1, $sp, 200                   # 8-byte Folded Reload
	or	$a0, $a0, $a1
	beqz	$a0, .LBB17_183
.LBB17_190:                             #   in Loop: Header=BB17_184 Depth=1
	ori	$a0, $zero, 3
	beq	$a3, $a0, .LBB17_193
# %bb.191:                              #   in Loop: Header=BB17_184 Depth=1
	ori	$a0, $zero, 1
	bne	$a3, $a0, .LBB17_194
# %bb.192:                              #   in Loop: Header=BB17_184 Depth=1
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	beqz	$a0, .LBB17_183
	b	.LBB17_194
.LBB17_193:                             #   in Loop: Header=BB17_184 Depth=1
	ld.d	$a0, $sp, 376                   # 8-byte Folded Reload
	beqz	$a0, .LBB17_183
.LBB17_194:                             #   in Loop: Header=BB17_184 Depth=1
	...
	ld.d	$a0, $sp, 392                   # 8-byte Folded Reload
	bnez	$a0, .LBB17_181
# %bb.195:                              # %.preheader433.lr.ph.us.us
                                        #   in Loop: Header=BB17_184 Depth=1
	...
	.p2align	4, , 16
.LBB17_196:                             # %.preheader433.us.us.us
                                        #   Parent Loop BB17_184 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_197 Depth 3
	...
	add.d	$s0, $a2, $a0
	.p2align	4, , 16
.LBB17_197:                             # %.preheader432.us.us.us
                                        #   Parent Loop BB17_184 Depth=1
	...
	ld.d	$a0, $sp, 496                   # 8-byte Folded Reload
	blt	$s4, $a0, .LBB17_197
# %bb.198:                              # %._crit_edge524.us.us.us
                                        #   in Loop: Header=BB17_196 Depth=2
	...
	ld.d	$a0, $sp, 456                   # 8-byte Folded Reload
	blt	$a1, $a0, .LBB17_196
# %bb.199:                              # %._crit_edge528.split.us.us.us
                                        #   in Loop: Header=BB17_184 Depth=1
	ld.d	$a0, $sp, 384                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(imgUV_org)
	ld.d	$s8, $a0, 8
	...
	.p2align	4, , 16
.LBB17_200:                             # %.preheader433.us.us.us.1
                                        #   Parent Loop BB17_184 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_201 Depth 3
	st.d	$a1, $sp, 440                   # 8-byte Folded Spill
	...
	add.d	$s7, $a2, $a0
	.p2align	4, , 16
.LBB17_201:                             # %.preheader432.us.us.us.1
                                        #   Parent Loop BB17_184 Depth=1
	...
	ld.d	$a0, $sp, 496                   # 8-byte Folded Reload
	blt	$s4, $a0, .LBB17_201
# %bb.202:                              # %._crit_edge524.us.us.us.1
