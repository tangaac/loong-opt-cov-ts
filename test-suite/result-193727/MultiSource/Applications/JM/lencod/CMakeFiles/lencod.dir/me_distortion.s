...
.LBB10_14:                              #   Parent Loop BB10_13 Depth=1
	...
	ld.w	$a4, $a3, %pc_lo12(wp_luma_round)
	ld.d	$a3, $sp, 64                    # 8-byte Folded Reload
	ld.wu	$a5, $a3, %pc_lo12(luma_log_weight_denom)
	ld.d	$a3, $sp, 56                    # 8-byte Folded Reload
	ld.w	$a3, $a3, %pc_lo12(offset_luma)
	mul.d	$a6, $a1, $a6
	add.d	$a6, $a6, $a4
	sra.w	$a6, $a6, $a5
	ldptr.w	$a2, $a2, 15520
