...
.LBB2_118:                              # %vector.body242
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_118
# %bb.119:                              # %middle.block248
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_122
.LBB2_120:                              # %scalar.ph237.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_121:                              # %scalar.ph237
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_145:                              # %vector.body298
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_145
# %bb.146:                              # %middle.block304
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_149
.LBB2_147:                              # %scalar.ph293.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_148:                              # %scalar.ph293
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_160:                              # %vector.body312
	...
	addi.d	$a7, $a7, 16
	bnez	$t0, .LBB2_160
# %bb.161:                              # %middle.block317
                                        #   in Loop: Header=BB2_5 Depth=1
	ori	$s7, $zero, 19
	beq	$a6, $a5, .LBB2_164
.LBB2_162:                              # %scalar.ph307.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_171:                              # %vector.body256
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_171
# %bb.172:                              # %middle.block262
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_173:                              # %scalar.ph251.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_174:                              # %scalar.ph251
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_186:                              # %vector.body284
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_186
# %bb.187:                              # %middle.block290
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_190
.LBB2_188:                              # %scalar.ph279.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_189:                              # %scalar.ph279
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_198:                              # %vector.body270
	...
	addi.d	$a7, $a7, -16
	bnez	$t0, .LBB2_198
# %bb.199:                              # %middle.block276
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_200:                              # %scalar.ph265.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_201:                              # %scalar.ph265
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
