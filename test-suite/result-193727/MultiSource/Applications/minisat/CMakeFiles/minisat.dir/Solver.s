...
# %bb.68:
	move	$a4, $zero
	b	.LBB13_93
.LBB13_69:                              # %vec.epilog.iter.check333
	ld.d	$t4, $sp, 56                    # 8-byte Folded Reload
	beqz	$a6, .LBB13_73
.LBB13_70:                              # %vec.epilog.ph335
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB13_71:                              # %vec.epilog.vector.body338
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vsrai.w	$vr1, $vr1, 1
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB13_71
# %bb.72:                               # %vec.epilog.middle.block343
	vbsrl.v	$vr1, $vr0, 8
	vor.v	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vor.v	$vr0, $vr1, $vr0
	vpickve2gr.w	$s2, $vr0, 0
	beq	$a3, $a6, .LBB13_75
.LBB13_73:                              # %vec.epilog.scalar.ph332.preheader
	alsl.d	$a2, $a4, $a2, 2
	sub.d	$a3, $s3, $a4
	.p2align	4, , 16
.LBB13_74:                              # %vec.epilog.scalar.ph332
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	slli.d	$a4, $a4, 1
...
# %bb.86:
	move	$a3, $a1
	b	.LBB13_117
.LBB13_87:                              # %vector.main.loop.iter.check349
	ori	$a3, $zero, 16
...
.LBB13_111:                             # %vector.body354
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB13_111
# %bb.112:                              # %middle.block358
	beq	$a2, $a4, .LBB13_119
# %bb.113:                              # %vec.epilog.iter.check364
	beqz	$a5, .LBB13_117
.LBB13_114:                             # %vec.epilog.ph366
	move	$a5, $a2
	bstrins.d	$a5, $zero, 1, 0
	add.d	$a3, $a5, $a1
	slli.d	$a6, $a4, 2
	...
	vrepli.w	$vr0, -2
	.p2align	4, , 16
.LBB13_115:                             # %vec.epilog.vector.body369
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a1, 0
	addi.d	$a4, $a4, 4
	addi.d	$a1, $a1, 16
	bnez	$a4, .LBB13_115
# %bb.116:                              # %vec.epilog.middle.block372
	beq	$a2, $a5, .LBB13_119
.LBB13_117:                             # %vec.epilog.scalar.ph363.preheader
	sub.d	$a1, $s3, $a3
	alsl.d	$a2, $a3, $a0, 2
	addi.w	$a3, $zero, -2
	lu32i.d	$a3, 0
	.p2align	4, , 16
.LBB13_118:                             # %vec.epilog.scalar.ph363
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a2, 0
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 4
