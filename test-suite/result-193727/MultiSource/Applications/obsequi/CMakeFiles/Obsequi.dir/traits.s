...
.LBB0_7:                                # %vector.body
	...
	xvand.v	$xr5, $xr5, $xr7
	xvand.v	$xr6, $xr6, $xr9
	xvxori.b	$xr7, $xr4, 255
	xvxori.b	$xr8, $xr0, 255
	xvsrli.w	$xr9, $xr5, 1
	xvsrli.w	$xr10, $xr6, 1
	xvand.v	$xr5, $xr9, $xr5
...
.LBB0_45:                               # %scalar.ph119.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a2, $a2, $s3, 2
	add.d	$a0, $a2, $a0
	addi.d	$a0, $a0, 4
...
.LBB0_50:
	move	$a3, $zero
	b	.LBB0_62
.LBB0_51:                               # %vector.main.loop.iter.check142
	ori	$a2, $zero, 15
	bgeu	$a1, $a2, .LBB0_53
# %bb.52:
	move	$a1, $zero
...
# %bb.55:                               # %middle.block154
	...
	xvpickve2gr.d	$a3, $xr0, 0
	beq	$a1, $a0, .LBB0_62
# %bb.56:                               # %vec.epilog.iter.check161
	beqz	$a2, .LBB0_60
.LBB0_57:                               # %vec.epilog.ph163
	...
	ld.d	$a4, $a4, %got_pc_lo12(countbits16)
	.p2align	4, , 16
.LBB0_58:                               # %vec.epilog.vector.body166
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a2, 0
	vsrli.w	$vr3, $vr2, 1
	vbitclri.w	$vr2, $vr2, 31
	vxor.v	$vr2, $vr3, $vr2
	vand.v	$vr3, $vr2, $vr1
	vext2xv.du.wu	$xr3, $xr3
	xvpickve2gr.d	$a5, $xr3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a3, .LBB0_58
# %bb.59:                               # %vec.epilog.middle.block171
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a3, $vr0, 0
	beq	$a1, $a0, .LBB0_62
.LBB0_60:                               # %vec.epilog.scalar.ph160.preheader
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $s3, 2
	pcalau12i	$a2, %got_pc_hi20(g_board)
	ld.d	$a2, $a2, %got_pc_lo12(g_board)
	...
	ori	$a4, $a4, 4092
	.p2align	4, , 16
.LBB0_61:                               # %vec.epilog.scalar.ph160
                                        # =>This Inner Loop Header: Depth=1
	ld.wu	$a5, $a1, 0
	srli.d	$a6, $a5, 1
