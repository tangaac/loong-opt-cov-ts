...
.LBB4_29:                               # %vec.epilog.ph127
	...
	xvrepli.w	$xr2, -48
	.p2align	4, , 16
.LBB4_30:                               # %vec.epilog.vector.body130
                                        # =>This Inner Loop Header: Depth=1
	ldx.d	$a6, $a4, $a0
	...
	addi.d	$a4, $a4, -8
	bnez	$a3, .LBB4_30
# %bb.31:                               # %vec.epilog.middle.block137
...
# %bb.34:                               # %middle.block118
	...
	xvpickve2gr.d	$a6, $xr0, 0
	beq	$a0, $a4, .LBB4_37
# %bb.35:                               # %vec.epilog.iter.check125
	bnez	$a5, .LBB4_29
	.p2align	4, , 16
.LBB4_36:                               # %.lr.ph65
                                        # =>This Inner Loop Header: Depth=1
