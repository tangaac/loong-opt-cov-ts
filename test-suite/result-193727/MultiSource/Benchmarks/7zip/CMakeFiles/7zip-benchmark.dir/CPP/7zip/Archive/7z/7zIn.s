...
.LBB14_9:                               # %.preheader.preheader.i
	...
	vshuf.b	$vr0, $vr0, $vr4, $vr1
	vextrins.h	$vr0, $vr2, 48
	ld.w	$a0, $s1, 83
...
# %bb.157:                              # %.noexc254
	...
	bnez	$s2, .LBB34_156
	b	.LBB34_102
.LBB34_158:                             # %.preheader310
	addi.w	$a0, $s6, 0
	beqz	$a0, .LBB34_161
# %bb.159:                              # %iter.check496
	ld.d	$a1, $sp, 216
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	add.w	$a2, $s6, $a2
...
.LBB34_161:
	...
	bnez	$t0, .LBB34_173
	b	.LBB34_180
.LBB34_162:                             # %vector.main.loop.iter.check479
	ori	$a2, $zero, 16
...
# %bb.166:                              # %middle.block491
	...
	beq	$a0, $a5, .LBB34_172
# %bb.167:                              # %vec.epilog.iter.check498
	beqz	$a4, .LBB34_171
.LBB34_168:                             # %vec.epilog.ph500
	bstrins.d	$s6, $zero, 1, 0
	vld	$vr1, $sp, 128                  # 16-byte Folded Reload
	vinsgr2vr.w	$vr1, $a3, 0
	addi.w	$a4, $s6, 0
	.p2align	4, , 16
.LBB34_169:                             # %vec.epilog.vector.body503
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a3, $a2, 0
	ldx.w	$a3, $a1, $a3
	...
	vadd.w	$vr1, $vr1, $vr0
	bne	$a4, $a2, .LBB34_169
# %bb.170:                              # %vec.epilog.middle.block508
	...
	beq	$a0, $a4, .LBB34_172
	.p2align	4, , 16
.LBB34_171:                             # %vec.epilog.scalar.ph497
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a4, $a2, 0
	ldx.bu	$a4, $a1, $a4
	addi.w	$a2, $a2, 1
...
.LBB34_181:
	...
	jirl	$ra, $ra, 0
	move	$s1, $zero
.LBB34_182:                             # %_ZN8NArchive3N7z10CInArchive6ReadIDEv.exit
...
.Ltmp242:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB34_213
.LBB34_204:                             # %.loopexit.split-lp332
.Ltmp190:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB34_236
.LBB34_205:
...
.Ltmp147:                               # EH_LABEL
	b	.LBB34_238
.LBB34_219:                             # %.loopexit.split-lp339
.Ltmp150:                               # EH_LABEL
	b	.LBB34_238
.LBB34_220:                             # %.loopexit
.Ltmp239:                               # EH_LABEL
