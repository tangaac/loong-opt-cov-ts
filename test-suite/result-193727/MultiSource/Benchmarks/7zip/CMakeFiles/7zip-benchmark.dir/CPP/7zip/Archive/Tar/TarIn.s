...
# %bb.49:                               # %iter.check396
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB0_174
# %bb.50:                               # %vector.main.loop.iter.check383
                                        #   in Loop: Header=BB0_2 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_167
...
# %bb.80:                               # %iter.check427
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB0_186
# %bb.81:                               # %vector.main.loop.iter.check414
                                        #   in Loop: Header=BB0_2 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_179
...
# %bb.87:                               # %iter.check458
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB0_199
# %bb.88:                               # %vector.main.loop.iter.check445
                                        #   in Loop: Header=BB0_2 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_192
...
# %bb.143:                              #   in Loop: Header=BB0_2 Depth=1
	st.d	$zero, $s8, 16
.LBB0_144:                              # %vector.body473.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a0, $zero
...
.LBB0_168:                              # %vector.body388
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_168
# %bb.169:                              # %middle.block393
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_176
# %bb.170:                              # %vec.epilog.iter.check398
                                        #   in Loop: Header=BB0_2 Depth=1
	beqz	$a3, .LBB0_174
.LBB0_171:                              # %vec.epilog.ph400
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_172:                              # %vec.epilog.vector.body403
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_172
# %bb.173:                              # %vec.epilog.middle.block407
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_176
.LBB0_174:                              # %vec.epilog.scalar.ph397.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_175:                              # %vec.epilog.scalar.ph397
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB0_180:                              # %vector.body419
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_180
# %bb.181:                              # %middle.block424
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_188
# %bb.182:                              # %vec.epilog.iter.check429
                                        #   in Loop: Header=BB0_2 Depth=1
	beqz	$a3, .LBB0_186
.LBB0_183:                              # %vec.epilog.ph431
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_184:                              # %vec.epilog.vector.body434
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_184
# %bb.185:                              # %vec.epilog.middle.block438
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_188
.LBB0_186:                              # %vec.epilog.scalar.ph428.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s0, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_187:                              # %vec.epilog.scalar.ph428
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB0_193:                              # %vector.body450
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_193
# %bb.194:                              # %middle.block455
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_201
# %bb.195:                              # %vec.epilog.iter.check460
                                        #   in Loop: Header=BB0_2 Depth=1
	beqz	$a3, .LBB0_199
.LBB0_196:                              # %vec.epilog.ph462
                                        #   in Loop: Header=BB0_2 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_197:                              # %vec.epilog.vector.body465
                                        #   Parent Loop BB0_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_197
# %bb.198:                              # %vec.epilog.middle.block469
                                        #   in Loop: Header=BB0_2 Depth=1
	beq	$a2, $a1, .LBB0_201
...
.LBB0_222:                              # %vector.body489
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_222
# %bb.223:                              # %middle.block494
	beq	$a2, $a1, .LBB0_230
# %bb.224:                              # %vec.epilog.iter.check499
	beqz	$a3, .LBB0_228
.LBB0_225:                              # %vec.epilog.ph501
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_226:                              # %vec.epilog.vector.body504
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_226
# %bb.227:                              # %vec.epilog.middle.block508
	beq	$a2, $a1, .LBB0_230
...
# %bb.254:                              # %middle.block525
	beq	$a2, $a1, .LBB0_261
# %bb.255:                              # %vec.epilog.iter.check530
	beqz	$a3, .LBB0_259
.LBB0_256:                              # %vec.epilog.ph532
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_257:                              # %vec.epilog.vector.body535
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_257
# %bb.258:                              # %vec.epilog.middle.block539
	beq	$a2, $a1, .LBB0_261
