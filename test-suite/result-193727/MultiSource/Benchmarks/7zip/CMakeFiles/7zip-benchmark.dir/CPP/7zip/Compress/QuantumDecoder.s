...
.LBB2_41:
	move	$a4, $a3
.LBB2_42:                               # %vec.epilog.scalar.ph134.preheader
	addi.d	$a1, $a4, 1
	alsl.d	$a2, $a4, $fp, 1
	addi.d	$a2, $a2, 8
	.p2align	4, , 16
.LBB2_43:                               # %vec.epilog.scalar.ph134
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a3, $a2, 0
...
.LBB2_47:                               # %vec.epilog.ph137
	...
	addi.d	$a2, $a2, -6
	.p2align	4, , 16
.LBB2_48:                               # %vec.epilog.vector.body140
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, -16
	bnez	$a7, .LBB2_48
# %bb.49:                               # %vec.epilog.middle.block148
	bne	$a1, $a6, .LBB2_42
	b	.LBB2_44
...
.LBB2_51:                               # %vector.body120
	...
	addi.d	$a7, $a7, -32
	bnez	$t1, .LBB2_51
# %bb.52:                               # %middle.block129
	beq	$a1, $a5, .LBB2_44
# %bb.53:                               # %vec.epilog.iter.check135
	beqz	$a6, .LBB2_42
	b	.LBB2_47
.Lfunc_end2:
