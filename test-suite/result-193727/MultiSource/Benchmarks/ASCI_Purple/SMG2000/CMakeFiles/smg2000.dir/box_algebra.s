...
.LBB2_14:                               # %vector.body737
	...
	addi.d	$t8, $t8, -32
	bnez	$fp, .LBB2_14
# %bb.15:                               # %middle.block744
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t6, $t7, .LBB2_18
.LBB2_16:                               # %scalar.ph732.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t6, $t5, $s3, 2
	.p2align	4, , 16
.LBB2_17:                               # %scalar.ph732
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, -4
	addi.d	$t8, $t6, -4
...
.LBB2_28:                               # %vector.body722
	...
	addi.d	$t7, $t7, -32
	bnez	$t8, .LBB2_28
# %bb.29:                               # %middle.block729
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t5, $t6, .LBB2_32
.LBB2_30:                               # %scalar.ph717.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t5, $t2, $s3, 2
	.p2align	4, , 16
.LBB2_31:                               # %scalar.ph717
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t5, -4
	addi.d	$t7, $t5, -4
...
.LBB2_42:                               # %vector.body707
	...
	addi.d	$t8, $t8, -32
	bnez	$fp, .LBB2_42
# %bb.43:                               # %middle.block714
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t6, $t7, .LBB2_46
.LBB2_44:                               # %scalar.ph702.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t6, $t5, $a5, 2
	.p2align	4, , 16
.LBB2_45:                               # %scalar.ph702
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t7, $t6, -4
	addi.d	$t8, $t6, -4
...
.LBB2_56:                               # %vector.body692
	...
	addi.d	$t7, $t7, -32
	bnez	$t8, .LBB2_56
# %bb.57:                               # %middle.block699
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$t5, $t6, .LBB2_60
.LBB2_58:                               # %scalar.ph687.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$t5, $t2, $a5, 2
	.p2align	4, , 16
.LBB2_59:                               # %scalar.ph687
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t5, -4
	addi.d	$t7, $t5, -4
...
# %bb.115:                              #   in Loop: Header=BB2_113 Depth=3
	...
	b	.LBB2_120
	.p2align	4, , 16
.LBB2_116:                              # %vector.ph750
                                        #   in Loop: Header=BB2_113 Depth=3
	move	$t2, $ra
	move	$a4, $t7
	.p2align	4, , 16
.LBB2_117:                              # %vector.body753
                                        #   Parent Loop BB2_94 Depth=1
                                        #     Parent Loop BB2_111 Depth=2
...
# %bb.167:                              #   in Loop: Header=BB2_166 Depth=1
	...
	b	.LBB2_171
	.p2align	4, , 16
.LBB2_168:                              # %vector.body784.preheader
                                        #   in Loop: Header=BB2_166 Depth=1
	move	$a4, $a2
	.p2align	4, , 16
.LBB2_169:                              # %vector.body784
                                        #   Parent Loop BB2_166 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $a4, -2
	bnez	$a4, .LBB2_169
# %bb.170:                              # %middle.block787
                                        #   in Loop: Header=BB2_166 Depth=1
	move	$a4, $a2
	beq	$t7, $a2, .LBB2_165
	.p2align	4, , 16
.LBB2_171:                              # %scalar.ph779
                                        #   Parent Loop BB2_166 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a4, $a4, 1
	blt	$a4, $t7, .LBB2_171
...
# %bb.173:
	move	$a0, $zero
	b	.LBB2_182
.LBB2_174:                              # %vector.ph770
	bstrpick.d	$a0, $s2, 30, 1
	slli.w	$a0, $a0, 1
	move	$a2, $a0
	.p2align	4, , 16
.LBB2_175:                              # %vector.body773
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, -2
	bnez	$a2, .LBB2_175
# %bb.176:                              # %middle.block776
	beq	$s2, $a0, .LBB2_178
	.p2align	4, , 16
...
.LBB2_179:                              # %vector.ph793
	...
	move	$a2, $a0
	.p2align	4, , 16
.LBB2_180:                              # %vector.body796
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, -2
	bnez	$a2, .LBB2_180
# %bb.181:                              # %middle.block799
	beq	$a1, $a0, .LBB2_183
	.p2align	4, , 16
...
.LBB2_186:
	move	$a1, $zero
	b	.LBB2_198
.LBB2_187:                              # %vector.main.loop.iter.check804
	ori	$a0, $zero, 16
	bgeu	$a4, $a0, .LBB2_189
# %bb.188:
	move	$a0, $zero
...
# %bb.191:                              # %middle.block815
	...
	beq	$a0, $a4, .LBB2_198
# %bb.192:                              # %vec.epilog.iter.check820
	beqz	$a2, .LBB2_196
.LBB2_193:                              # %vec.epilog.ph822
	move	$a2, $a0
	...
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB2_194:                              # %vec.epilog.vector.body825
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a2, 0
	vseqi.w	$vr1, $vr1, 0
	vadd.w	$vr0, $vr0, $vr1
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB2_194
# %bb.195:                              # %vec.epilog.middle.block830
