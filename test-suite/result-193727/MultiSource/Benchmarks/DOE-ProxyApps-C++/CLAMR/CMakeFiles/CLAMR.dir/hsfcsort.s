...
# %bb.15:                               # %vector.ph153
	move	$s6, $s3
	bstrpick.d	$a1, $s3, 29, 3
	slli.w	$a2, $a1, 3
	slli.w	$a0, $a1, 5
	pcalau12i	$a3, %pc_hi20(.LCPI2_2)
	xvld	$xr0, $a3, %pc_lo12(.LCPI2_2)
	pcalau12i	$a3, %pc_hi20(.LCPI2_1)
	xvld	$xr1, $a3, %pc_lo12(.LCPI2_1)
	slli.d	$a1, $a1, 4
	addi.w	$a1, $a1, 1
	xvrepli.w	$xr2, 32
	move	$a3, $a2
	.p2align	4, , 16
.LBB2_16:                               # %vector.body156
                                        # =>This Inner Loop Header: Depth=1
	xvpermi.q	$xr3, $xr1, 1
	vext2xv.d.w	$xr3, $xr3
	vext2xv.d.w	$xr4, $xr1
...
.LBB2_18:                               # %.loopexit
	...
	jirl	$ra, $ra, 0
	beqz	$s3, .LBB2_23
# %bb.19:                               # %.lr.ph119.preheader
	ori	$a1, $zero, 8
	ori	$a0, $zero, 3
	bgeu	$s3, $a1, .LBB2_28
.LBB2_20:
	move	$a1, $zero
.LBB2_21:                               # %.lr.ph119.preheader188
	sub.d	$a2, $s3, $a1
	.p2align	4, , 16
.LBB2_22:                               # %.lr.ph119
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_31:                               # %vector.body177
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB2_31
# %bb.32:                               # %middle.block182
	bne	$s3, $a1, .LBB2_21
	b	.LBB2_23
.LBB2_33:                               # %vector.scevcheck
	addi.d	$a1, $s3, -1
	bstrpick.d	$a3, $a1, 31, 29
	move	$a2, $zero
	bnez	$a3, .LBB2_38
