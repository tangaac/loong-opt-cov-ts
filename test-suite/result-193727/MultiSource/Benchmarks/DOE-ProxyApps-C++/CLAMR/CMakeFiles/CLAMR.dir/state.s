...
# %bb.89:                               # %vector.memcheck
	...
	move	$a2, $t1
	bltu	$a3, $a0, .LBB6_33
# %bb.90:                               # %vector.main.loop.iter.check568
	ori	$a0, $zero, 16
	bgeu	$a1, $a0, .LBB6_97
# %bb.91:
	move	$a0, $zero
...
.LBB6_98:                               # %vector.body573
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_98
# %bb.99:                               # %middle.block576
	beq	$a1, $a0, .LBB6_35
# %bb.100:                              # %vec.epilog.iter.check581
	beqz	$a3, .LBB6_33
.LBB6_101:                              # %vec.epilog.ph583
	move	$a3, $a1
	...
	vrepli.b	$vr0, -1
	.p2align	4, , 16
.LBB6_102:                              # %vec.epilog.vector.body586
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB6_102
# %bb.103:                              # %vec.epilog.middle.block589
	bne	$a1, $a3, .LBB6_33
	b	.LBB6_35
...
# %bb.24:                               # %middle.block
	bne	$a0, $a4, .LBB12_3
	b	.LBB12_5
.LBB12_25:                              # %vector.ph106
	bstrpick.d	$a2, $a1, 30, 3
	slli.d	$a2, $a2, 3
	addi.d	$a3, $s1, 16
	move	$a4, $a2
	.p2align	4, , 16
.LBB12_26:                              # %vector.body109
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, -16
	vld	$vr1, $a3, 0
	vext2xv.d.w	$xr0, $xr0
...
# %bb.27:                               # %middle.block113
	beq	$a2, $a1, .LBB12_30
.LBB12_28:                              # %scalar.ph104.preheader
	alsl.d	$a3, $a2, $s1, 2
	sub.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB12_29:                              # %scalar.ph104
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a3, 0
	slli.d	$a2, $a2, 3
	fstx.d	$fs0, $a0, $a2
...
.LBB17_176:                             # %call.sqrt1362
	...
	move	$a1, $s0
	b	.LBB17_152
.LBB17_177:                             # %._crit_edge1181.._crit_edge1185_crit_edge
