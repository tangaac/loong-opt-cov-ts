...
.LBB11_17:                              # %.preheader176.us.us.us
	...
	vor.v	$vr4, $vr3, $vr5
	vst	$vr4, $sp, 496                  # 16-byte Folded Spill
	...
	vreplgr2vr.w	$vr3, $s5
	vor.v	$vr7, $vr3, $vr5
	vst	$vr7, $sp, 464                  # 16-byte Folded Spill
	vadd.w	$vr3, $vr3, $vr6
	vmul.w	$vr3, $vr3, $vr4
	vst	$vr3, $sp, 448                  # 16-byte Folded Spill
	st.d	$a5, $sp, 280                   # 8-byte Folded Spill
	vreplgr2vr.w	$vr3, $a5
	vor.v	$vr5, $vr3, $vr5
	vst	$vr5, $sp, 432                  # 16-byte Folded Spill
	vadd.w	$vr3, $vr3, $vr6
	vmul.w	$vr3, $vr3, $vr4
	vst	$vr3, $sp, 416                  # 16-byte Folded Spill
	alsl.w	$fp, $s0, $s0, 1
	vslli.w	$vr2, $vr2, 31
	vsrai.w	$vr2, $vr2, 31
...
.LBB14_31:                              # =>This Loop Header: Depth=1
	...
	stx.w	$a1, $s5, $t5
	bge	$t3, $t4, .LBB14_30
# %bb.32:                               # %.lr.ph280.preheader
                                        #   in Loop: Header=BB14_31 Depth=1
	sub.d	$t5, $t4, $t3
	addi.w	$a1, $a1, 0
	bgeu	$t5, $t0, .LBB14_35
.LBB14_33:                              # %.lr.ph280.preheader488
                                        #   in Loop: Header=BB14_31 Depth=1
	alsl.d	$t5, $a1, $s1, 2
	alsl.d	$t6, $a1, $s3, 3
	alsl.d	$t7, $t3, $a3, 2
...
# %bb.55:                               # %.lr.ph301
	...
	move	$a1, $s6
	bgeu	$a3, $a7, .LBB14_68
.LBB14_56:                              # %scalar.ph447.preheader
	slli.d	$a7, $a1, 3
	alsl.d	$a3, $a1, $a6, 3
	slli.d	$a6, $a1, 2
	alsl.d	$a2, $a1, $a2, 2
...
# %bb.67:
	move	$a1, $zero
	b	.LBB14_77
.LBB14_68:                              # %vector.memcheck443
	alsl.d	$a1, $s6, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 32
	move	$a1, $s6
	bltu	$a7, $t0, .LBB14_56
# %bb.69:                               # %vector.memcheck443
	alsl.d	$a1, $s6, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 64
	move	$a1, $s6
...
.LBB14_71:                              # %vector.body452
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB14_71
# %bb.72:                               # %middle.block460
	bne	$a3, $a7, .LBB14_56
	b	.LBB14_58
.LBB14_73:                              # %vector.ph468
	andi	$a3, $a2, 12
...
# %bb.83:                               #   in Loop: Header=BB15_69 Depth=1
	move	$a2, $zero
	b	.LBB15_94
.LBB15_84:                              # %vector.body506.preheader
                                        #   in Loop: Header=BB15_69 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	addi.d	$a1, $s0, 32
	move	$a2, $s6
...
.LBB15_85:                              # %vector.body506
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_85
# %bb.86:                               # %middle.block511
                                        #   in Loop: Header=BB15_69 Depth=1
	move	$a2, $s6
	beq	$s5, $s6, .LBB15_89
.LBB15_87:                              # %.lr.ph.i183.preheader533
                                        #   in Loop: Header=BB15_69 Depth=1
	sub.d	$a0, $s5, $a2
	alsl.d	$a1, $a2, $s0, 3
...
.LBB15_92:                              # %vector.body521
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_92
# %bb.93:                               # %middle.block528
                                        #   in Loop: Header=BB15_69 Depth=1
	move	$a2, $s6
	beq	$s5, $s6, .LBB15_96
.LBB15_94:                              # %.lr.ph.i201.preheader534
                                        #   in Loop: Header=BB15_69 Depth=1
	sub.d	$a0, $s5, $a2
	alsl.d	$a1, $a2, $s0, 3
	ld.d	$a3, $sp, 168                   # 8-byte Folded Reload
...
# %bb.140:                              # %vector.memcheck482
                                        #   in Loop: Header=BB15_69 Depth=1
	alsl.d	$a3, $a1, $s0, 3
	bgeu	$a0, $a3, .LBB15_155
# %bb.141:                              # %vector.memcheck482
                                        #   in Loop: Header=BB15_69 Depth=1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB15_149:                             # %vector.body472
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_149
# %bb.150:                              # %middle.block479
                                        #   in Loop: Header=BB15_69 Depth=1
	move	$a2, $s6
	beq	$s5, $s6, .LBB15_153
.LBB15_151:                             # %.lr.ph.i256.preheader532
                                        #   in Loop: Header=BB15_69 Depth=1
	sub.d	$a0, $s5, $a2
	alsl.d	$a1, $a2, $s1, 3
	ld.d	$a3, $sp, 168                   # 8-byte Folded Reload
...
.LBB15_156:                             # %vector.body491
	...
	addi.d	$a3, $a3, 64
	bnez	$a5, .LBB15_156
# %bb.157:                              # %middle.block498
                                        #   in Loop: Header=BB15_69 Depth=1
	beq	$a1, $a2, .LBB15_145
	b	.LBB15_143
.LBB15_158:                             # %call.sqrt703
                                        #   in Loop: Header=BB15_69 Depth=1
	fmov.d	$fa0, $fs1
...
# %bb.162:
	...
	b	.LBB15_177
.LBB15_163:                             # %vector.memcheck447
	sub.d	$a5, $s6, $a0
	ori	$a4, $zero, 64
	move	$a2, $zero
	bltu	$a5, $a4, .LBB15_49
# %bb.164:                              # %vector.memcheck447
	sub.d	$a5, $s6, $s1
	bltu	$a5, $a4, .LBB15_49
# %bb.165:                              # %vector.ph454
	bstrpick.d	$a2, $a3, 30, 3
...
.Ltmp977:                               # EH_LABEL
	b	.LBB15_202
.LBB15_195:                             # %.loopexit.split-lp361
.Ltmp971:                               # EH_LABEL
	b	.LBB15_202
.LBB15_196:
.Ltmp983:                               # EH_LABEL
...
.Ltmp980:                               # EH_LABEL
	b	.LBB15_202
.LBB15_200:                             # %.loopexit359
.Ltmp943:                               # EH_LABEL
	b	.LBB15_202
.LBB15_201:                             # %.loopexit360
.Ltmp956:                               # EH_LABEL
.LBB15_202:
	move	$s2, $a0
	bnez	$s1, .LBB15_206
...
# %bb.83:                               #   in Loop: Header=BB16_69 Depth=1
	move	$a2, $zero
	b	.LBB16_94
.LBB16_84:                              # %vector.body506.preheader
                                        #   in Loop: Header=BB16_69 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	addi.d	$a1, $s0, 32
	move	$a2, $s6
...
# %bb.86:                               # %middle.block511
	...
	move	$a2, $s6
	beq	$s5, $s6, .LBB16_89
.LBB16_87:                              # %.lr.ph.i183.preheader533
                                        #   in Loop: Header=BB16_69 Depth=1
	sub.d	$a0, $s5, $a2
	alsl.d	$a1, $a2, $s0, 3
	ld.d	$a3, $sp, 168                   # 8-byte Folded Reload
...
# %bb.93:                               # %middle.block528
	...
	move	$a2, $s6
	beq	$s5, $s6, .LBB16_96
.LBB16_94:                              # %.lr.ph.i201.preheader534
                                        #   in Loop: Header=BB16_69 Depth=1
	sub.d	$a0, $s5, $a2
	alsl.d	$a1, $a2, $s0, 3
	ld.d	$a3, $sp, 168                   # 8-byte Folded Reload
...
# %bb.150:                              # %middle.block479
	...
	move	$a2, $s6
	beq	$s5, $s6, .LBB16_153
.LBB16_151:                             # %.lr.ph.i256.preheader532
                                        #   in Loop: Header=BB16_69 Depth=1
	sub.d	$a0, $s5, $a2
	alsl.d	$a1, $a2, $s1, 3
	ld.d	$a3, $sp, 168                   # 8-byte Folded Reload
...
.Ltmp1080:                              # EH_LABEL
	b	.LBB16_202
.LBB16_195:                             # %.loopexit.split-lp361
.Ltmp1074:                              # EH_LABEL
	b	.LBB16_202
.LBB16_196:
.Ltmp1086:                              # EH_LABEL
...
.Ltmp1083:                              # EH_LABEL
	b	.LBB16_202
.LBB16_200:                             # %.loopexit359
.Ltmp1046:                              # EH_LABEL
	b	.LBB16_202
.LBB16_201:                             # %.loopexit360
.Ltmp1059:                              # EH_LABEL
.LBB16_202:
	move	$s2, $a0
	bnez	$s1, .LBB16_206
...
.Ltmp1096:                              # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp1097:                              # EH_LABEL
# %bb.48:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit143
.Ltmp1098:                              # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
	fmov.d	$fa0, $fs0
...
.Ltmp1100:                              # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp1101:                              # EH_LABEL
# %bb.50:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit147
	ld.d	$a0, $s1, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s1, $a0
	ld.d	$s2, $a0, 240
	beqz	$s2, .LBB17_123
# %bb.51:                               # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i185
	ld.bu	$a0, $s2, 56
	bnez	$a0, .LBB17_104
# %bb.52:
.Ltmp1102:                              # EH_LABEL
...
.Ltmp1110:                              # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp1111:                              # EH_LABEL
# %bb.77:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit114
	ld.d	$a0, $s1, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s1, $a0
	ld.d	$s2, $a0, 240
