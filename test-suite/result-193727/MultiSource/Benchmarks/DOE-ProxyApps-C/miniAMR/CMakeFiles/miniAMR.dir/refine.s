...
.LBB2_202:
	move	$a5, $zero
	b	.LBB2_214
.LBB2_203:                              # %vector.main.loop.iter.check
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB2_205
# %bb.204:
	move	$a3, $zero
...
.LBB2_209:                              # %vec.epilog.ph
	...
	ori	$a6, $zero, 192
	.p2align	4, , 16
.LBB2_210:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a7, $a5, -16
	ld.w	$t0, $a5, -8
	ld.w	$t1, $a5, 0
	...
	addi.d	$a5, $a5, 32
	bnez	$a4, .LBB2_210
# %bb.211:                              # %vec.epilog.middle.block
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a5, $vr0, 0
	beq	$a3, $a2, .LBB2_214
.LBB2_212:                              # %vec.epilog.scalar.ph.preheader
	alsl.d	$a0, $a3, $a0, 3
	addi.d	$a0, $a0, 4
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB2_213:                              # %vec.epilog.scalar.ph
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a0, 0
	alsl.d	$a3, $a3, $a3, 1
	slli.d	$a3, $a3, 6
