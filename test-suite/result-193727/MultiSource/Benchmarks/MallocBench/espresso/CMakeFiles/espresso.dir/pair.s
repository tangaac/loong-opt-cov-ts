...
.LBB1_79:
	move	$a2, $zero
.LBB1_80:                               # %vec.epilog.scalar.ph336.preheader
	slli.d	$a3, $a2, 2
	alsl.d	$a3, $s0, $a3, 2
	add.d	$a0, $a0, $a3
	add.w	$a1, $a1, $a2
	sub.d	$a2, $s6, $a2
	.p2align	4, , 16
.LBB1_81:                               # %vec.epilog.scalar.ph336
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a0, 0
	slli.d	$a4, $a1, 2
	stx.w	$a3, $s3, $a4
...
# %bb.90:                               # %vector.memcheck
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB1_79
# %bb.91:                               # %vector.main.loop.iter.check322
	ori	$a2, $zero, 16
	bgeu	$s6, $a2, .LBB1_123
# %bb.92:
	move	$a2, $zero
...
# %bb.100:                              # %.lr.ph236
	...
	move	$a5, $t3
	bgeu	$a3, $a4, .LBB1_116
.LBB1_101:                              # %scalar.ph354.preheader
	slli.d	$a3, $a0, 1
	alsl.d	$a0, $a5, $s1, 3
	add.d	$a2, $a2, $a3
	add.d	$a2, $a2, $a5
...
# %bb.125:                              # %middle.block332
	beq	$a2, $s6, .LBB1_82
# %bb.126:                              # %vec.epilog.iter.check337
	beqz	$a3, .LBB1_80
.LBB1_127:                              # %vec.epilog.ph339
	move	$a5, $a2
	...
	add.w	$a5, $a1, $a5
	.p2align	4, , 16
.LBB1_128:                              # %vec.epilog.vector.body342
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	slli.d	$a6, $a5, 2
	vstx	$vr0, $s3, $a6
	...
	addi.w	$a5, $a5, 4
	bnez	$a3, .LBB1_128
# %bb.129:                              # %vec.epilog.middle.block346
	bne	$a2, $s6, .LBB1_80
	b	.LBB1_82
.Lfunc_end1:
