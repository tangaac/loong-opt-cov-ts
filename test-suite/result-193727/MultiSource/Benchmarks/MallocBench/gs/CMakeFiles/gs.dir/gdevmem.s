...
# %bb.37:                               #   in Loop: Header=BB11_23 Depth=1
	move	$a6, $zero
.LBB11_38:                              # %vec.epilog.ph491
                                        #   in Loop: Header=BB11_23 Depth=1
	add.d	$a7, $t7, $s7
	add.d	$a4, $ra, $s7
	.p2align	4, , 16
.LBB11_39:                              # %vec.epilog.vector.body497
                                        #   Parent Loop BB11_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$t2, $ra, $a6
	vld	$vr2, $t2, 1
...
.LBB11_41:                              # %vector.memcheck509
	...
	and	$a4, $a7, $a4
	bnez	$a4, .LBB11_30
# %bb.42:                               # %vector.memcheck509
                                        #   in Loop: Header=BB11_23 Depth=1
	bltz	$a3, .LBB11_30
# %bb.43:                               # %vector.main.loop.iter.check522
                                        #   in Loop: Header=BB11_23 Depth=1
	ld.d	$a4, $sp, 144                   # 8-byte Folded Reload
	move	$s1, $zero
	ori	$a7, $zero, 248
...
# %bb.47:                               #   in Loop: Header=BB11_23 Depth=1
	...
	b	.LBB11_32
.LBB11_48:                              # %vector.ph469
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$a6, $zero
	add.d	$a7, $t7, $s2
	add.d	$a4, $ra, $s2
	.p2align	4, , 16
.LBB11_49:                              # %vector.body475
                                        #   Parent Loop BB11_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$t2, $ra, $a6
	xvld	$xr2, $t2, 1
...
# %bb.51:                               #   in Loop: Header=BB11_23 Depth=1
	...
	b	.LBB11_32
.LBB11_52:                              # %vec.epilog.iter.check546
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$s1, $s5
	ld.d	$t2, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s4, $sp, 48                    # 8-byte Folded Reload
	beqz	$s4, .LBB11_31
.LBB11_53:                              # %vec.epilog.ph548
                                        #   in Loop: Header=BB11_23 Depth=1
	add.d	$a7, $t7, $s8
	add.d	$a4, $ra, $s8
	.p2align	4, , 16
.LBB11_54:                              # %vec.epilog.vector.body556
                                        #   Parent Loop BB11_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$t2, $ra, $s1
	ld.d	$t2, $t2, 1
	...
	vstelm.d	$vr2, $t7, 0, 0
	bne	$s8, $s1, .LBB11_54
# %bb.55:                               # %vec.epilog.middle.block563
                                        #   in Loop: Header=BB11_23 Depth=1
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a6, $sp, 96                    # 8-byte Folded Reload
	bne	$s8, $a6, .LBB11_31
	b	.LBB11_32
.LBB11_56:                              # %vec.epilog.iter.check489
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$a6, $s2
	ld.d	$t2, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s4, $sp, 40                    # 8-byte Folded Reload
...
# %bb.83:                               # %vec.epilog.middle.block
	...
	bne	$a4, $t7, .LBB11_70
	b	.LBB11_76
.LBB11_84:                              # %vector.main.loop.iter.check402
                                        #   in Loop: Header=BB11_61 Depth=1
	ld.d	$a5, $sp, 152                   # 8-byte Folded Reload
	ori	$a7, $zero, 248
	bgeu	$a5, $a7, .LBB11_90
