...
# %bb.180:                              # %.preheader431
	...
	bge	$t1, $a1, .LBB0_182
	b	.LBB0_189
.LBB0_181:                              #   in Loop: Header=BB0_64 Depth=2
	ori	$s7, $zero, 1
	ori	$a1, $zero, 2
	ld.d	$t1, $sp, 200                   # 8-byte Folded Reload
	blt	$t1, $a1, .LBB0_189
.LBB0_182:                              # %iter.check767
                                        #   in Loop: Header=BB0_64 Depth=2
	bstrpick.d	$a5, $s7, 31, 0
	ori	$a1, $zero, 9
	bltu	$t1, $a1, .LBB0_185
...
# %bb.184:                              # %vector.memcheck738
	...
	addi.d	$a2, $a2, -2
	bgeu	$a2, $a1, .LBB0_200
.LBB0_185:                              #   in Loop: Header=BB0_64 Depth=2
	move	$a1, $a5
	move	$a3, $t1
	move	$a4, $s7
.LBB0_186:                              # %.lr.ph543.preheader
                                        #   in Loop: Header=BB0_64 Depth=2
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a3, $s3, 1
...
.LBB0_187:                              # %.lr.ph543
	...
	addi.d	$a2, $a2, -2
	bnez	$a3, .LBB0_187
.LBB0_188:                              # %._crit_edge544.loopexit
                                        #   in Loop: Header=BB0_64 Depth=2
	move	$s7, $a1
.LBB0_189:                              # %._crit_edge544
                                        #   in Loop: Header=BB0_64 Depth=2
	addi.d	$a0, $sp, 304
	addi.d	$a1, $sp, 312
	addi.d	$a2, $sp, 388
...
# %bb.194:                              # %vector.memcheck
	...
	addi.d	$t1, $t2, 2
	bltu	$t0, $t1, .LBB0_209
.LBB0_195:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB0_64 Depth=2
	ori	$a6, $zero, 16
	bgeu	$a7, $a6, .LBB0_205
# %bb.196:                              #   in Loop: Header=BB0_64 Depth=2
	move	$a7, $zero
.LBB0_197:                              # %vec.epilog.ph
                                        #   in Loop: Header=BB0_64 Depth=2
	bstrpick.d	$a6, $a5, 31, 3
	slli.d	$t0, $a6, 3
	srli.d	$t1, $a5, 3
	...
	sub.d	$a7, $a7, $t0
	.p2align	4, , 16
.LBB0_198:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_64 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t1, 0
...
# %bb.199:                              # %vec.epilog.middle.block
	...
	bne	$t0, $a5, .LBB0_209
	b	.LBB0_211
.LBB0_200:                              # %vector.main.loop.iter.check750
                                        #   in Loop: Header=BB0_64 Depth=2
	addi.d	$a1, $t1, -1
	bstrpick.d	$a2, $a1, 31, 0
	ori	$a1, $zero, 17
	bgeu	$t1, $a1, .LBB0_214
# %bb.201:                              #   in Loop: Header=BB0_64 Depth=2
	move	$a6, $zero
.LBB0_202:                              # %vec.epilog.ph771
                                        #   in Loop: Header=BB0_64 Depth=2
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB0_203:                              # %vec.epilog.vector.body775
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_64 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t0, 0
	...
	addi.d	$t0, $t0, -16
	bnez	$a6, .LBB0_203
# %bb.204:                              # %vec.epilog.middle.block780
                                        #   in Loop: Header=BB0_64 Depth=2
	bne	$a7, $a2, .LBB0_186
	b	.LBB0_188
.LBB0_205:                              # %vector.ph
...
# %bb.207:                              # %middle.block
                                        #   in Loop: Header=BB0_64 Depth=2
	beq	$a7, $a5, .LBB0_211
# %bb.208:                              # %vec.epilog.iter.check
                                        #   in Loop: Header=BB0_64 Depth=2
	bnez	$t1, .LBB0_197
	.p2align	4, , 16
.LBB0_209:                              # %vec.epilog.scalar.ph.preheader
                                        #   in Loop: Header=BB0_64 Depth=2
	slli.d	$a5, $a6, 1
	sub.d	$a4, $a4, $a5
	add.d	$a1, $a1, $a4
...
.LBB0_211:                              # %.loopexit925
	...
	sub.w	$s0, $fp, $a0
	blez	$s0, .LBB0_62
# %bb.212:                              # %.preheader428.preheader
                                        #   in Loop: Header=BB0_64 Depth=2
	st.d	$a0, $sp, 208                   # 8-byte Folded Spill
	move	$fp, $zero
	.p2align	4, , 16
.LBB0_213:                              # %.preheader428
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_64 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	addi.d	$a0, $sp, 336
...
.LBB0_215:                              # %vector.body755
	...
	addi.d	$t1, $t1, -32
	bnez	$t2, .LBB0_215
# %bb.216:                              # %middle.block762
                                        #   in Loop: Header=BB0_64 Depth=2
	beq	$a6, $a2, .LBB0_188
# %bb.217:                              # %vec.epilog.iter.check769
                                        #   in Loop: Header=BB0_64 Depth=2
	beqz	$t0, .LBB0_186
	b	.LBB0_202
.LBB0_218:                              #   in Loop: Header=BB0_30 Depth=1
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
.LBB0_219:                              # %._crit_edge557
                                        #   in Loop: Header=BB0_30 Depth=1
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	ld.w	$fp, $a0, 0
	bge	$fp, $s3, .LBB0_223
# %bb.220:                              # %.preheader437.preheader
                                        #   in Loop: Header=BB0_30 Depth=1
	sub.d	$s0, $s3, $fp
	.p2align	4, , 16
.LBB0_221:                              # %.preheader437
                                        #   Parent Loop BB0_30 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a0, $sp, 320
	addi.d	$a1, $sp, 328
	...
	addi.w	$s0, $s0, -1
	bnez	$s0, .LBB0_221
# %bb.222:                              #   in Loop: Header=BB0_30 Depth=1
	move	$s3, $fp
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
.LBB0_223:                              # %.loopexit438
                                        #   in Loop: Header=BB0_30 Depth=1
	ld.d	$a0, $sp, 336
	ld.d	$fp, $sp, 8                     # 8-byte Folded Reload
	beqz	$a0, .LBB0_225
	.p2align	4, , 16
.LBB0_224:                              # %.preheader435
                                        #   Parent Loop BB0_30 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a0, $sp, 336
	addi.d	$a1, $sp, 328
	...
	ld.d	$a0, $sp, 328
	bnez	$a0, .LBB0_224
.LBB0_225:                              # %.loopexit436
                                        #   in Loop: Header=BB0_30 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	bne	$a0, $s4, .LBB0_230
# %bb.226:                              #   in Loop: Header=BB0_30 Depth=1
	ld.d	$a0, $sp, 280                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ldx.d	$a1, $a0, $s0
	beqz	$a1, .LBB0_230
...
.LBB0_227:                              # %.lr.ph566
	...
	alsl.d	$a2, $a2, $a0, 3
	.p2align	4, , 16
.LBB0_228:                              #   Parent Loop BB0_30 Depth=1
...
.LBB0_230:                              # %.outer
	...
	bne	$a0, $fp, .LBB0_30
.LBB0_231:                              # %.outer._crit_edge.preheader
	pcalau12i	$a0, %got_pc_hi20(pathArray)
	...
	b	.LBB0_233
	.p2align	4, , 16
.LBB0_232:                              # %._crit_edge573
                                        #   in Loop: Header=BB0_233 Depth=1
	ld.w	$a0, $s5, 0
	addi.d	$fp, $fp, 1
	bge	$s2, $a0, .LBB0_242
.LBB0_233:                              # %.outer._crit_edge
                                        # =>This Loop Header: Depth=1
...
.LBB0_237:                              # %vector.body917
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB0_237
# %bb.238:                              # %middle.block922
                                        #   in Loop: Header=BB0_233 Depth=1
	beq	$a4, $a5, .LBB0_232
.LBB0_239:                              # %.lr.ph572.preheader927
                                        #   in Loop: Header=BB0_233 Depth=1
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a0, $a3, $a0, 1
	sub.d	$a2, $a2, $a3
...
.LBB0_240:                              # %.lr.ph572
	...
	bnez	$a2, .LBB0_240
	b	.LBB0_232
.LBB0_241:                              # %.split.loop.exit702
	move	$fp, $s2
.LBB0_242:                              # %.split.loop.exit
	ld.d	$a0, $sp, 304
	beqz	$a0, .LBB0_244
	.p2align	4, , 16
.LBB0_243:                              # %.preheader423
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $sp, 304
	addi.d	$a1, $sp, 328
	addi.d	$a2, $sp, 396
