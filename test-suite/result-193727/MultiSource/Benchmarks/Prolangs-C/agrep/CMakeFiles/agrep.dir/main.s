...
.LBB3_7:
	move	$a5, $zero
.LBB3_8:                                # %.lr.ph.split.us.preheader226
	add.d	$a6, $fp, $a5
	sub.d	$a3, $a3, $a5
	ori	$a5, $zero, 89
...
.LBB3_17:
	move	$a5, $zero
.LBB3_18:                               # %.lr.ph.split.split.preheader228
	add.d	$a6, $fp, $a5
	sub.d	$a3, $a3, $a5
	ori	$a5, $zero, 89
...
# %bb.58:                               # %.lr.ph63
	...
	bnez	$a6, .LBB3_56
	b	.LBB3_55
.LBB3_59:                               # %vector.main.loop.iter.check
	ori	$a3, $zero, 16
	vrepli.b	$vr0, 116
	vrepli.b	$vr1, 97
	vrepli.b	$vr2, 99
...
.LBB3_68:                               #   in Loop: Header=BB3_69 Depth=1
	...
	addi.d	$a4, $a4, 4
	beqz	$a0, .LBB3_71
.LBB3_69:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a4, 0
...
# %bb.70:                               #   in Loop: Header=BB3_69 Depth=1
	st.w	$zero, $a2, 0
	b	.LBB3_68
.LBB3_71:                               # %vec.epilog.middle.block
	beq	$a1, $a3, .LBB3_38
	b	.LBB3_54
.LBB3_72:
	pcalau12i	$a0, %got_pc_hi20(stderr)
