...
.LBB3_49:                               # %vector.body54
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB3_49
# %bb.50:                               # %middle.block63
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a4, $a6, .LBB3_16
# %bb.51:                               # %vec.epilog.iter.check69
                                        #   in Loop: Header=BB3_4 Depth=1
	beqz	$a7, .LBB3_14
.LBB3_52:                               # %vec.epilog.ph71
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a7, $a4
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB3_53:                               # %vec.epilog.vector.body74
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vst	$vr0, $a5, 0
...
.LBB10_41:                              # %.loopexit
	...
	addi.d	$sp, $sp, 96
	ret
.LBB10_42:                              # %vector.main.loop.iter.check141
	srli.d	$a3, $a2, 1
	ori	$a6, $zero, 62
	addi.d	$a4, $a3, 1
	bgeu	$a2, $a6, .LBB10_46
...
.LBB10_47:                              # %vector.body146
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB10_47
# %bb.48:                               # %middle.block155
	beq	$a4, $a6, .LBB10_31
# %bb.49:                               # %vec.epilog.iter.check161
	beqz	$a7, .LBB10_30
.LBB10_50:                              # %vec.epilog.ph163
	move	$a7, $a4
	bstrins.d	$a7, $zero, 2, 0
	alsl.d	$a2, $a7, $s1, 1
	alsl.d	$a3, $a7, $a5, 1
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB10_51:                              # %vec.epilog.vector.body166
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a5, 0
	addi.d	$a5, $a5, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB10_51
# %bb.52:                               # %vec.epilog.middle.block172
	bne	$a4, $a7, .LBB10_30
	b	.LBB10_31
...
# %bb.55:                               # %middle.block116
	beq	$a4, $a6, .LBB10_40
# %bb.56:                               # %vec.epilog.iter.check122
	beqz	$a7, .LBB10_39
.LBB10_57:                              # %vec.epilog.ph124
	move	$a7, $a4
	bstrins.d	$a7, $zero, 2, 0
	alsl.d	$a2, $a7, $s3, 1
	alsl.d	$a3, $a7, $a5, 1
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB10_58:                              # %vec.epilog.vector.body127
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a5, 0
	addi.d	$a5, $a5, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB10_58
# %bb.59:                               # %vec.epilog.middle.block133
	bne	$a4, $a7, .LBB10_39
	b	.LBB10_40
.Lfunc_end10:
