...
# %bb.31:
	st.b	$a3, $a2, 0
.LBB16_32:                              # %_one_mult.exit
	ori	$a2, $zero, 1
	beq	$a1, $a2, .LBB16_41
# %bb.33:                               # %_one_mult.exit
	beqz	$a1, .LBB16_40
# %bb.34:
...
# %bb.38:
	st.b	$a2, $a1, 0
	b	.LBB16_41
.LBB16_39:                              # %_one_mult.exit.thread
	move	$a0, $s0
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
...
.LBB16_41:                              # %_one_mult.exit245
	...
	b	.LBB16_44
	.p2align	4, , 16
.LBB16_42:                              #   in Loop: Header=BB16_44 Depth=1
	move	$fp, $zero
.LBB16_43:                              # %.thread
...
# %bb.56:                               #   in Loop: Header=BB16_44 Depth=1
	st.b	$a1, $a0, 0
	.p2align	4, , 16
.LBB16_57:                              # %_one_mult.exit258
                                        #   in Loop: Header=BB16_44 Depth=1
	beqz	$t1, .LBB16_43
# %bb.58:                               # %.lr.ph327.preheader
                                        #   in Loop: Header=BB16_44 Depth=1
	add.d	$a0, $s0, $s5
...
# %bb.60:                               # %._crit_edge328
                                        #   in Loop: Header=BB16_44 Depth=1
	bgez	$a4, .LBB16_43
# %bb.61:                               #   in Loop: Header=BB16_44 Depth=1
	addi.d	$fp, $fp, -1
	beqz	$s7, .LBB16_43
# %bb.62:                               # %.lr.ph335.preheader
                                        #   in Loop: Header=BB16_44 Depth=1
	move	$a3, $zero
...
# %bb.64:                               # %._crit_edge336
                                        #   in Loop: Header=BB16_44 Depth=1
	blt	$a4, $t3, .LBB16_43
# %bb.65:                               #   in Loop: Header=BB16_44 Depth=1
	ld.b	$a1, $a0, 0
	addi.d	$a1, $a1, 1
...
# %bb.71:                               #   in Loop: Header=BB16_70 Depth=1
	...
	blt	$a1, $a0, .LBB16_70
	b	.LBB16_78
.LBB16_72:                              # %is_zero.exit268
	beqz	$a1, .LBB16_78
.LBB16_73:                              # %is_zero.exit268.thread290
	ori	$a1, $zero, 2
	blt	$s4, $a1, .LBB16_79
.LBB16_74:                              # %.lr.ph.preheader.i271
	addi.d	$a0, $s4, 15
	bstrpick.d	$a0, $a0, 31, 0
	add.d	$a0, $s3, $a0
	move	$a2, $t3
...
# %bb.77:
	...
	bgtz	$a1, .LBB16_81
	b	.LBB16_86
.LBB16_78:                              # %is_zero.exit268.thread
	st.w	$zero, $s3, 0
	ori	$a1, $zero, 2
	bge	$s4, $a1, .LBB16_74
.LBB16_79:
...
.LBB21_40:                              # %iter.check337
	...
	bltu	$s0, $a0, .LBB21_43
# %bb.41:                               # %vector.memcheck309
	bgeu	$a4, $fp, .LBB21_124
# %bb.42:                               # %vector.memcheck309
	addi.d	$a0, $s0, -1
	bstrpick.d	$a0, $a0, 31, 0
	add.d	$a1, $t4, $a0
	addi.d	$a1, $a1, 17
...
.LBB21_95:                              #   in Loop: Header=BB21_81 Depth=1
	...
	ori	$a0, $zero, 16
	bltu	$s5, $a0, .LBB21_98
.LBB21_96:                              # %vector.memcheck357
                                        #   in Loop: Header=BB21_81 Depth=1
	bgeu	$a4, $s2, .LBB21_110
# %bb.97:                               # %vector.memcheck357
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a0, $s5, -1
	bstrpick.d	$a0, $a0, 31, 0
	add.d	$a1, $t2, $a0
...
.LBB21_98:                              #   in Loop: Header=BB21_81 Depth=1
	...
	move	$a0, $a4
	move	$a3, $s2
.LBB21_99:                              # %vec.epilog.scalar.ph388.preheader
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a1, $a2, 1
	addi.d	$a2, $a3, -1
	.p2align	4, , 16
.LBB21_100:                             # %vec.epilog.scalar.ph388
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a2, 0
	st.b	$a3, $a0, 0
...
.LBB21_109:                             # %out_long.exit141
	...
	b	.LBB21_80
	.p2align	4, , 16
.LBB21_110:                             # %vector.main.loop.iter.check368
                                        #   in Loop: Header=BB21_81 Depth=1
...
.LBB21_113:                             # %vec.epilog.vector.body395
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB21_113
# %bb.114:                              # %vec.epilog.middle.block402
                                        #   in Loop: Header=BB21_81 Depth=1
	bne	$a6, $a1, .LBB21_99
	b	.LBB21_101
.LBB21_115:                             # %vector.ph370
                                        #   in Loop: Header=BB21_81 Depth=1
	andi	$a6, $a1, 16
...
# %bb.123:                              # %vec.epilog.middle.block
	bne	$a6, $a1, .LBB21_31
	b	.LBB21_33
.LBB21_124:                             # %vector.main.loop.iter.check318
	ori	$a0, $zero, 32
	bstrpick.d	$a1, $s0, 31, 0
	bgeu	$s0, $a0, .LBB21_143
# %bb.125:
	move	$a5, $zero
.LBB21_126:                             # %vec.epilog.ph341
	bstrpick.d	$a0, $a1, 31, 4
	slli.d	$a6, $a0, 4
	sub.d	$a2, $s0, $a6
	alsl.d	$a0, $a0, $a4, 4
	...
	addi.d	$a5, $a5, 16
	.p2align	4, , 16
.LBB21_127:                             # %vec.epilog.vector.body345
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a7, 0
	vshuf4i.w	$vr0, $vr0, 27
	vshuf4i.b	$vr0, $vr0, 27
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB21_127
# %bb.128:                              # %vec.epilog.middle.block352
	bne	$a6, $a1, .LBB21_44
	b	.LBB21_46
.LBB21_129:
	ld.d	$s8, $sp, 168                   # 8-byte Folded Reload
...
.LBB21_144:                             # %vector.body324
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB21_144
# %bb.145:                              # %middle.block332
	beq	$a5, $a1, .LBB21_46
# %bb.146:                              # %vec.epilog.iter.check339
	beqz	$a6, .LBB21_44
	b	.LBB21_126
.Lfunc_end21:
