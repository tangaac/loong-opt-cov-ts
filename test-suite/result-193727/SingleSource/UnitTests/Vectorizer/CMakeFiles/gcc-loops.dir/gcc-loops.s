...
# %bb.162:                              # %vec.epilog.middle.block
	...
	beq	$a0, $a4, .LBB24_165
.LBB24_163:                             # %.lr.ph.i407.preheader
	addi.d	$a0, $a1, -4
	.p2align	4, , 16
.LBB24_164:                             # %.lr.ph.i407
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, 4
	addi.d	$a2, $a0, 4
	add.d	$a3, $a1, $a3
...
.Ltmp34:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp35:                                # EH_LABEL
# %bb.167:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit410.preheader
	beq	$s0, $fp, .LBB24_172
...
.Ltmp36:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp37:                                # EH_LABEL
# %bb.170:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit414
...
.LBB24_172:                             # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit410._crit_edge
.Ltmp41:                                # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
