...
# %bb.151:                              # %vector.ph
	...
	b	.LBB24_153
	.p2align	4, , 16
.LBB24_152:                             # %pred.load.continue657
...
# %bb.154:                              # %pred.load.if
	...
	andi	$a5, $a4, 1
	bnez	$a5, .LBB24_158
.LBB24_155:                             # %pred.load.continue645
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$a5, $xr6, 2
	andi	$a6, $a5, 1
	beqz	$a6, .LBB24_159
.LBB24_156:                             # %pred.load.if646
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a6, $a2, -8
...
.LBB24_158:                             # %pred.load.if644
	...
	andi	$a6, $a5, 1
	bnez	$a6, .LBB24_156
.LBB24_159:                             # %pred.load.continue647
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$a6, $xr6, 3
	andi	$a7, $a6, 1
	beqz	$a7, .LBB24_161
.LBB24_160:                             # %pred.load.if648
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a7, $a2, -4
	xvinsgr2vr.w	$xr4, $a7, 3
.LBB24_161:                             # %pred.load.continue649
                                        #   in Loop: Header=BB24_153 Depth=1
	xvor.v	$xr5, $xr5, $xr1
...
# %bb.162:                              # %pred.load.if650
	...
	andi	$t1, $t0, 1
	bnez	$t1, .LBB24_166
.LBB24_163:                             # %pred.load.continue653
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$t1, $xr5, 2
	andi	$t2, $t1, 1
	beqz	$t2, .LBB24_167
.LBB24_164:                             # %pred.load.if654
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t2, $a2, 8
	...
	b	.LBB24_168
	.p2align	4, , 16
.LBB24_165:                             # %pred.load.continue651
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$t0, $xr5, 1
	andi	$t1, $t0, 1
	beqz	$t1, .LBB24_163
.LBB24_166:                             # %pred.load.if652
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t1, $a2, 4
	...
	andi	$t2, $t1, 1
	bnez	$t2, .LBB24_164
.LBB24_167:                             # %pred.load.continue655
                                        #   in Loop: Header=BB24_153 Depth=1
	xvpickve2gr.d	$t2, $xr5, 3
	andi	$t3, $t2, 1
	beqz	$t3, .LBB24_152
.LBB24_168:                             # %pred.load.if656
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t3, $a2, 12
