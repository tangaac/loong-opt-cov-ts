...
# %bb.151:                              # %.lr.ph.i407.preheader
	...
	b	.LBB24_153
	.p2align	4, , 16
.LBB24_152:                             # %pred.load.continue655
...
# %bb.156:                              # %pred.load.if642
	...
	andi	$a5, $a4, 1
	bnez	$a5, .LBB24_163
.LBB24_157:                             # %pred.load.continue645
                                        #   in Loop: Header=BB24_153 Depth=1
	vpickve2gr.h	$a5, $vr4, 3
	andi	$a6, $a5, 1
	beqz	$a6, .LBB24_164
.LBB24_158:                             # %pred.load.if646
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a6, $a2, -4
	...
	andi	$a7, $a6, 1
	bnez	$a7, .LBB24_165
.LBB24_159:                             # %pred.load.continue649
                                        #   in Loop: Header=BB24_153 Depth=1
	vpickve2gr.h	$a7, $vr4, 5
	andi	$t0, $a7, 1
	beqz	$t0, .LBB24_166
.LBB24_160:                             # %pred.load.if650
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t0, $a2, 4
	...
	andi	$t1, $t0, 1
	bnez	$t1, .LBB24_167
.LBB24_161:                             # %pred.load.continue653
                                        #   in Loop: Header=BB24_153 Depth=1
	...
	b	.LBB24_168
	.p2align	4, , 16
.LBB24_162:                             # %pred.load.continue643
                                        #   in Loop: Header=BB24_153 Depth=1
	vpickve2gr.h	$a4, $vr4, 2
	andi	$a5, $a4, 1
	beqz	$a5, .LBB24_157
.LBB24_163:                             # %pred.load.if644
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a5, $a2, -8
	...
	andi	$a6, $a5, 1
	bnez	$a6, .LBB24_158
.LBB24_164:                             # %pred.load.continue647
                                        #   in Loop: Header=BB24_153 Depth=1
	vpickve2gr.h	$a6, $vr4, 4
	andi	$a7, $a6, 1
	beqz	$a7, .LBB24_159
.LBB24_165:                             # %pred.load.if648
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$a7, $a2, 0
	...
	andi	$t0, $a7, 1
	bnez	$t0, .LBB24_160
.LBB24_166:                             # %pred.load.continue651
                                        #   in Loop: Header=BB24_153 Depth=1
	vpickve2gr.h	$t0, $vr4, 6
	andi	$t1, $t0, 1
	beqz	$t1, .LBB24_161
.LBB24_167:                             # %pred.load.if652
                                        #   in Loop: Header=BB24_153 Depth=1
	ld.w	$t1, $a2, 8
...
.Ltmp34:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp35:                                # EH_LABEL
# %bb.172:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit410.preheader
	beq	$s0, $fp, .LBB24_177
...
.Ltmp36:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp37:                                # EH_LABEL
# %bb.175:                              # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit414
...
.LBB24_177:                             # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit410._crit_edge
.Ltmp41:                                # EH_LABEL
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
